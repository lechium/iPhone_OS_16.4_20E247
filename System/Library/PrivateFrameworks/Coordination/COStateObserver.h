...
- (void)notify:(id)arg1;	// IMP=0x000000000000d1a0
- (id)description;	// IMP=0x000000000000d12f
- (id)initWithDispatchQueue:(id)arg1 predicate:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d042
