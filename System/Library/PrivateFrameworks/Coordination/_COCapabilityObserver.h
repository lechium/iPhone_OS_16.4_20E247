...
- (void).cxx_destruct;	// IMP=0x0000000000024264
...
- (void)notify:(_Bool)arg1;	// IMP=0x0000000000024005
- (id)description;	// IMP=0x0000000000023f12
- (id)initWithCapability:(id)arg1 cluster:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000023d5a
