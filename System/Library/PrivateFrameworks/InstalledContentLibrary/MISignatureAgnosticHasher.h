...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x00600000000061fc
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x00600000000061da
- (void).cxx_destruct;	// IMP=0x0000000000006275
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x000000000000580d
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x0000000000004451
- (void)dealloc;	// IMP=0x00000000000043f5
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x0000000000004355
