...
- (void).cxx_destruct;	// IMP=0x00000000000417c5
@property(retain, nonatomic) MIStashMetadata *stashMetadata; // @synthesize stashMetadata=_stashMetadata;
- (_Bool)saveStashMetadata:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000000416d4
- (id)stashMetadataWithError:(id *)arg1;	// IMP=0x000000000004150d
- (id)newStashMetadata;	// IMP=0x00000000000414b1
