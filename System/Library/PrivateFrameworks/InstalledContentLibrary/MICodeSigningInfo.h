...
- (void).cxx_destruct;	// IMP=0x00000000000138b2
...
- (id)initWithDictionaryRepresentation:(id)arg1 fromSource:(unsigned long long)arg2;	// IMP=0x0000000000012cc7
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000012cb3
- (id)initWithSignerIdentity:(id)arg1 signerOrganization:(id)arg2 codeInfoIdentifier:(id)arg3 teamIdentifier:(id)arg4 signatureVersion:(id)arg5 entitlements:(id)arg6 signerType:(unsigned long long)arg7 profileType:(unsigned long long)arg8 signingInfoSource:(unsigned long long)arg9;	// IMP=0x0000000000012b78
- (id)initForTesting;	// IMP=0x0000000000012b49
