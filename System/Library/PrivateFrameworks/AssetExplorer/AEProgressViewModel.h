...
- (void).cxx_destruct;	// IMP=0x00000000000216fb
...
- (id)sectionedDataSourceManagerInterestingObjectReferences:(id)arg1;	// IMP=0x00000000000216d1
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000021305
- (id)mutableChangeObject;	// IMP=0x00000000000212fc
- (void)cancelProgressForAssetUUIDs:(id)arg1;	// IMP=0x000000000002101b
- (void)setProgress:(id)arg1 forAssetReference:(id)arg2;	// IMP=0x0000000000020edf
- (id)_createSnapshot;	// IMP=0x0000000000020b43
@property(readonly, nonatomic) AEProgressViewModelSnapshot *progressSnapshot;
- (id)initWithDataSourceManager:(id)arg1;	// IMP=0x00000000000209ea
