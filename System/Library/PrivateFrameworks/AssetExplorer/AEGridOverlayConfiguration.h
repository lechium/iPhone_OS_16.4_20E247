...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ccb7
- (id)initWithShowCloudDecoration:(_Bool)arg1 showVideoDecoration:(_Bool)arg2 showLoopDecoration:(_Bool)arg3;	// IMP=0x000000000000cc66
