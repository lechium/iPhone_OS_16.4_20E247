...
+ (id)backgroundAssertionWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000008549c
- (void).cxx_destruct;	// IMP=0x0000000000085039
...
- (void)end;	// IMP=0x0000000000084e96
- (id)initWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000084af9
