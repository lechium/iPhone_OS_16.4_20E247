...
- (void).cxx_destruct;	// IMP=0x0000000000008e22
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000008df8
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x0000000000008de4
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x0000000000008bfd
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x0000000000008b8e
