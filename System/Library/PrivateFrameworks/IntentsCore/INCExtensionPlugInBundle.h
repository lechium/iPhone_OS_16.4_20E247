...
- (void).cxx_destruct;	// IMP=0x0000000000002af7
...
- (id)initWithPrincipalClass:(Class)arg1 intentsSupported:(id)arg2 intentsRestrictedWhileLocked:(id)arg3;	// IMP=0x0000000000002a0e
