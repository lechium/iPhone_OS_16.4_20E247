...
@interface GTReplayQueryShaderInfoReplyStream : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000013d6f
@property unsigned long long dispatcherId; // @synthesize dispatcherId;
- (void)dispatchMessage:(id)arg1 replyConnection:(id)arg2;	// IMP=0x0000000000013ca4
- (id)initWithCallback:(CDUnknownBlockType)arg1 bulkDataProxy:(id)arg2;	// IMP=0x0000000000013bd7
