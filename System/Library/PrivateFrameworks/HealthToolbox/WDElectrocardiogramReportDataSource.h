...
- (void)_fetchDemographicInformation;	// IMP=0x000000000001ff67
- (id)initWithSample:(id)arg1 healthStore:(id)arg2 activeAlgorithmVersion:(long long)arg3;	// IMP=0x000000000001fe97
