...
- (void).cxx_destruct;	// IMP=0x0000000000007781
...
- (struct CGSize)extentOfData:(id)arg1;	// IMP=0x00000000000074b9
- (id)tachogramSeriesWithData:(id)arg1 unit:(id)arg2 maximumY:(double)arg3 axis:(id)arg4 irregularBeatStyle:(_Bool)arg5;	// IMP=0x0000000000006e18
- (void)viewDidLoad;	// IMP=0x0000000000006d67
- (id)initWithIrregularBeatData:(id)arg1 normalData:(id)arg2 visibleRange:(id)arg3 profile:(id)arg4;	// IMP=0x00000000000068aa
