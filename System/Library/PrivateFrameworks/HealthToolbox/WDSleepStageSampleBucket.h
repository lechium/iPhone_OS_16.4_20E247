...
- (void).cxx_destruct;	// IMP=0x000000000002b808
...
- (id)source;	// IMP=0x000000000002b7ca
...
- (void)removeAllSamples;	// IMP=0x000000000002b3cc
- (void)removeSample:(id)arg1;	// IMP=0x000000000002b3b6
- (void)addSample:(id)arg1;	// IMP=0x000000000002b30b
- (id)initWithSleepStage:(long long)arg1 timePeriod:(id)arg2 sourceRevision:(id)arg3 device:(id)arg4;	// IMP=0x000000000002b1d6
