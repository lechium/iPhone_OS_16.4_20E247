...
- (void)activityQueryTest:(id)arg1;	// IMP=0x0000000000004665
- (id)cellForRow:(unsigned long long)arg1 table:(id)arg2;	// IMP=0x00000000000045ad
- (unsigned long long)numberOfRows;	// IMP=0x0000000000004590
- (id)_audiogramSampleForDate:(id)arg1 sensitivityData:(id)arg2;	// IMP=0x0000000000003fdb
- (void)updateTachogram:(id)arg1;	// IMP=0x0000000000003dfd
- (id)_buildHeartSequenceDataFromString:(id)arg1;	// IMP=0x0000000000003a86
- (id)_localDateFromString:(id)arg1;	// IMP=0x0000000000003a03
- (id)_dateFormatter;	// IMP=0x0000000000003988
- (void)setUpWithTableViewController:(id)arg1;	// IMP=0x0000000000003611
- (id)titleForHeader;	// IMP=0x0000000000003604
