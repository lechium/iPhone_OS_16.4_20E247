...
+ (id)defaultReuseIdentifier;	// IMP=0x001000000007de22
- (void).cxx_destruct;	// IMP=0x000000000007f6ad
...
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x000000000007f540
...
- (void)setBodyText:(id)arg1 URLText:(id)arg2 URL:(id)arg3;	// IMP=0x000000000007f115
@property(copy, nonatomic) NSString *titleText;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000007ef7b
- (void)updateBodyTextView;	// IMP=0x000000000007ed83
- (void)updateConstraintConstants;	// IMP=0x000000000007ec16
- (void)setUpUI;	// IMP=0x000000000007df1a
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x000000000007de2c
