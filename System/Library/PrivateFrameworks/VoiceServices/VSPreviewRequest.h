...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000016d7c
- (void).cxx_destruct;	// IMP=0x0000000000016f89
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016e21
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016d84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016ca6
