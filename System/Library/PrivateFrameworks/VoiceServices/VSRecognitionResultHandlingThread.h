...
- (void)_handleRequests;	// IMP=0x000000000002c281
- (void)_notifyRequestHandled:(id)arg1;	// IMP=0x000000000002c207
- (void)invalidate;	// IMP=0x000000000002c1c0
- (void)handleResults:(id)arg1 withHandler:(id)arg2;	// IMP=0x000000000002c0e6
- (void)setDelegate:(id)arg1;	// IMP=0x000000000002c0ae
- (void)dealloc;	// IMP=0x000000000002c064
- (id)init;	// IMP=0x000000000002bfff
