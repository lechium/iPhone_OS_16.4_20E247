...
+ (_Bool)isDirectMessagingRequested:(id)arg1;	// IMP=0x006000000000d8ad
- (void).cxx_destruct;	// IMP=0x0000000000013ee6
...
- (void)logConnectionStatisticsInPowerDictionary;	// IMP=0x000000000001388b
- (void)startPowerLogReportTimer;	// IMP=0x000000000001375e
- (void)clearPowerAssertion;	// IMP=0x0000000000013703
- (void)getPowerAssertion;	// IMP=0x000000000001357c
- (void)dequeueMessages;	// IMP=0x0000000000013105
- (void)sendMessageWithParameters:(id)arg1 options:(id)arg2;	// IMP=0x000000000001234e
- (void)failedToSendMessage:(id)arg1 responseCode:(long long)arg2;	// IMP=0x00000000000120fb
- (void)suspendPendingAckTimer;	// IMP=0x00000000000120d3
- (void)resumePendingAckTimer;	// IMP=0x00000000000120ab
- (void)cancelPendingAckTimer;	// IMP=0x000000000001206a
- (id)createDispatchDataForMessageSend:(id)arg1 isAck:(_Bool)arg2 ackMessageId:(unsigned int)arg3;	// IMP=0x00000000000115f3
- (unsigned char)getMessageTypeForFirstMessage;	// IMP=0x000000000001144a
- (void)sendAppAckWithGUID:(id)arg1;	// IMP=0x0000000000010b46
- (void)sendAckForMessageID:(unsigned int)arg1 guidToAck:(id)arg2;	// IMP=0x0000000000010869
- (void)processIncomingMessage:(id)arg1 messageType:(unsigned char)arg2 messageIdentifier:(unsigned int)arg3;	// IMP=0x000000000000f81f
- (void)receiveMessages;	// IMP=0x000000000000f2f8
- (void)setupConnectionIfApplicable;	// IMP=0x000000000000f2a5
- (void)receivedDirectMessagingSocketWithContext:(id)arg1;	// IMP=0x000000000000eede
- (void)setupIDSDeviceConnection;	// IMP=0x000000000000ea5c
- (void)updateTrafficClass:(unsigned short)arg1;	// IMP=0x000000000000ea44
- (void)updateConnection:(id)arg1;	// IMP=0x000000000000e77a
- (void)resetConnection;	// IMP=0x000000000000e676
- (void)updateMetadata:(id)arg1;	// IMP=0x000000000000e194
- (void)updateConnectedDevices:(id)arg1;	// IMP=0x000000000000dd43
- (_Bool)isMessageEligible:(id)arg1 options:(id)arg2 destinationDevice:(id)arg3;	// IMP=0x000000000000d98f
- (_Bool)canUseDirectMessaging;	// IMP=0x000000000000d896
- (void)setDestinationDevice:(id)arg1;	// IMP=0x000000000000d728
- (void)invalidate;	// IMP=0x000000000000d62c
- (void)cancel;	// IMP=0x000000000000d569
- (id)description;	// IMP=0x000000000000d4d6
- (void)dealloc;	// IMP=0x000000000000d3d4
- (void)parseDirectMessagingState;	// IMP=0x000000000000d24c
- (id)initWithServiceName:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000000cf4c
