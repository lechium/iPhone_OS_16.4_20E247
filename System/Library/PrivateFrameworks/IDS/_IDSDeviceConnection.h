...
- (void).cxx_destruct;	// IMP=0x000000000007d4d3
- (id)deviceConnectionKey;	// IMP=0x000000000007d4a6
- (void)_daemonDied:(id)arg1;	// IMP=0x000000000007d36c
- (void)_cleanupCompletionBlock;	// IMP=0x000000000007d31c
- (void)xpcObject:(id)arg1 objectContext:(id)arg2;	// IMP=0x000000000007ccad
- (void)_close;	// IMP=0x000000000007c817
- (void)close;	// IMP=0x000000000007c76b
- (_Bool)updateConnectionWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007c3b6
- (void)setStreamPairWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x000000000007c1eb
...
- (void)_connect;	// IMP=0x000000000007bc7b
- (void)dealloc;	// IMP=0x000000000007bb59
- (id)initWithDevice:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 queue:(id)arg4;	// IMP=0x000000000007ac72
