...
- (void).cxx_destruct;	// IMP=0x00000000000e635d
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x00000000000e6271
- (void)_setAccount:(id)arg1;	// IMP=0x00000000000e618f
- (void)_stateChanged;	// IMP=0x00000000000e601d
- (void)_cloudConnectedStateChanged;	// IMP=0x00000000000e5ede
- (void)_connectedStateChanged;	// IMP=0x00000000000e5d9f
- (void)_nearbyStateChanged;	// IMP=0x00000000000e5c60
- (_Bool)isTinker;	// IMP=0x00000000000e5c48
- (void)_addIdentity:(id)arg1;	// IMP=0x00000000000e58f4
...
- (id)compactDescription;	// IMP=0x00000000000e3c01
- (id)description;	// IMP=0x00000000000e3777
- (id)fullDescription;	// IMP=0x00000000000e32c3
...
- (void)dealloc;	// IMP=0x00000000000e2bb5
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000e23e8
