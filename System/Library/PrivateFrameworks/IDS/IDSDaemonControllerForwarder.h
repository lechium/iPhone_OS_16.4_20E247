...
- (void).cxx_destruct;	// IMP=0x000000000000a465
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000009a6c
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000009a4f
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000000995e
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3;	// IMP=0x0000000000009949
