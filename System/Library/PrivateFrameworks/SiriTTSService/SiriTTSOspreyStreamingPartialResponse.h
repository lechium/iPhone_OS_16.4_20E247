...
+ (void)processServerLogs:(id)arg1;	// IMP=0x006000000002ad15
- (void).cxx_destruct;	// IMP=0x000000000002b877
...
- (id)initWithOspreyPartialResponse:(id)arg1;	// IMP=0x000000000002aa42
