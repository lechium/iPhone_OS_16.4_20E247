...
- (id)flatbuffData;	// IMP=0x0000000000021fb0
- (Offset_afb4d078)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000021c4d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002178a
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000215ad
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2;	// IMP=0x0000000000021597
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000002157c
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000021564
