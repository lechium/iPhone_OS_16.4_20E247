...
- (void)dequeueObject:(id)arg1 buffer:(id)arg2;	// IMP=0x0000000000035ca2
- (void)enqueueObject:(id)arg1 replaceIfExists:(_Bool)arg2 buffer:(id)arg3;	// IMP=0x0000000000035b9a
@property(readonly, nonatomic) NSString *descriptionType;
- (id)initWithCapacity:(unsigned long long)arg1 batchHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000035b03
