...
@interface _TtC19ContactlessReaderUI12TapViewModel : _TtCs12_SwiftObject
{
    ...
    MISSING_TYPE *rotationManager;	// 1935892319 = 0x73635f5f
...
- (void)closeUIImmediate;	// IMP=0x0000000000086630
- (void)closeUI;	// IMP=0x0000000000086600
- (void)requiresCardPIN:(id)arg1;	// IMP=0x0000000000085d70
- (void)vasReadSuccessWithMerchantNames:(id)arg1;	// IMP=0x00000000000852d0
- (void)updateWithTransactionEvent:(long long)arg1;	// IMP=0x0000000000084e70
