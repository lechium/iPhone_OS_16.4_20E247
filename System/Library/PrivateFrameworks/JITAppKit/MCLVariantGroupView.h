...
- (void)selectItemAtIndex:(long long)arg1;	// IMP=0x000000000001e0f0
- (void)selectVariant:(id)arg1;	// IMP=0x000000000001df50
- (id)createVariantButton:(Class)arg1 type:(long long)arg2;	// IMP=0x000000000001de50
- (void)clearVariants;	// IMP=0x000000000001dd50
- (void)reloadData;	// IMP=0x000000000001d0d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001cf80
