...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000018d60
- (void)layoutSubviews;	// IMP=0x0000000000018c20
@property(nonatomic) double spacing;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000017950
