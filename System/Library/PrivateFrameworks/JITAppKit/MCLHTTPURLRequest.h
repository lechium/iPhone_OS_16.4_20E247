...
- (void).cxx_destruct;	// IMP=0x000000000001c0c0
...
- (void)handleCompletion:(id)arg1;	// IMP=0x000000000001bc70
- (void)loadRequest:(id)arg1;	// IMP=0x000000000001ba50
- (void)cancel;	// IMP=0x000000000001b9d0
- (void)sendText:(id)arg1;	// IMP=0x000000000001b940
- (void)sendData:(id)arg1;	// IMP=0x000000000001b7b0
- (void)send;	// IMP=0x000000000001b780
