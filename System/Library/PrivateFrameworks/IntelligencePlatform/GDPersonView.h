...
- (void).cxx_destruct;	// IMP=0x000000000002c000
- (void)enumeratePeopleWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002bf8f
- (id)initWithAccessAssertion:(id)arg1 database:(id)arg2;	// IMP=0x000000000002be80
