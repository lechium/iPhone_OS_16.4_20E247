...
- (void).cxx_destruct;	// IMP=0x000000000002fc80
...
- (void)dealloc;	// IMP=0x000000000002fb58
- (id)initWithViewName:(id)arg1 extensionToken:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002f829
