...
- (void).cxx_destruct;	// IMP=0x000000000003772d
- (void)dealloc;	// IMP=0x0000000000037631
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000003759f
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000003758e
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000374cd
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x000000000003746d
- (id)originalObject;	// IMP=0x000000000003745f
@property(readonly) id <MTLDepthStencilState> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x0000000000037373
