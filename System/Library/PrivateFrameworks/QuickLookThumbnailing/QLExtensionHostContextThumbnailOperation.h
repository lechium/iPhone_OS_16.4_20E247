...
- (void).cxx_destruct;	// IMP=0x0000000000028de5
...
- (void)finish;	// IMP=0x0000000000028b72
- (void)main;	// IMP=0x0000000000027dbb
- (id)initWithThumbnailHostContext:(id)arg1 item:(id)arg2 size:(struct CGSize)arg3 minimumSize:(double)arg4 scale:(double)arg5 badgeType:(unsigned long long)arg6 iconFlavor:(int)arg7 generatorData:(id)arg8 interpolationQuality:(int)arg9 completionHandler:(CDUnknownBlockType)arg10 serviceErrorHandler:(CDUnknownBlockType)arg11;	// IMP=0x0000000000027b53
