...
+ (id)_extensionAuxiliaryHostProtocol;	// IMP=0x0010000000020f14
+ (id)_extensionAuxiliaryVendorProtocol;	// IMP=0x0010000000020d4c
- (void).cxx_destruct;	// IMP=0x0000000000021e6c
@property(retain, nonatomic) QLThumbnailProvider *thumbnailProvider; // @synthesize thumbnailProvider=_thumbnailProvider;
- (id)_thumbnailGenerationQueue;	// IMP=0x0000000000021deb
- (void)generateThumbnailOfSize:(struct CGSize)arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 iconFlavor:(int)arg5 contentType:(id)arg6 interpolationQuality:(int)arg7 withFileURLHandler:(id)arg8 additionalResourcesWrapper:(id)arg9 generatorData:(id)arg10 completionHandler:(CDUnknownBlockType)arg11;	// IMP=0x000000000002192c
- (void)provideThumbnailForRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000021618
- (void)generateThumbnailOfSize:(struct CGSize)arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 iconFlavor:(int)arg5 contentType:(id)arg6 interpolationQuality:(int)arg7 withContents:(id)arg8 additionalResourcesWrapper:(id)arg9 generatorData:(id)arg10 completionHandler:(CDUnknownBlockType)arg11;	// IMP=0x0000000000021487
- (void)ioSurfaceForRequest:(id)arg1 withSize:(struct CGSize)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000021193
- (id)protocolHostWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000021039
- (id)protocolHost;	// IMP=0x0000000000020f80
