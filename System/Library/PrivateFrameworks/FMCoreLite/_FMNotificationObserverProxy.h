...
- (void)invalidate;	// IMP=0x000000000000f1e7
- (void)performObserverBlock;	// IMP=0x000000000000f18e
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ef46
