...
- (void).cxx_destruct;	// IMP=0x000000000002361c
...
- (void)setUpSectionHeightConstraints;	// IMP=0x00000000000230c0
- (void)setUpSections;	// IMP=0x00000000000227ee
@property(getter=isDarkened) _Bool darkened;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000221b5
- (id)initWithDataPoint:(id)arg1 useVibrancy:(_Bool)arg2;	// IMP=0x0000000000021f2f
