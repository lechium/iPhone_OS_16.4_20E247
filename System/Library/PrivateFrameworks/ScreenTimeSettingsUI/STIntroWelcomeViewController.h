...
- (void)_notNow:(id)arg1;	// IMP=0x000000000006f491
- (void)_turnOnScreenTime:(id)arg1;	// IMP=0x000000000006f45e
- (void)loadView;	// IMP=0x000000000006ee52
- (id)initWithChildName:(id)arg1 forceParentalControls:(_Bool)arg2 continueHandler:(CDUnknownBlockType)arg3 endHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000006eb12
