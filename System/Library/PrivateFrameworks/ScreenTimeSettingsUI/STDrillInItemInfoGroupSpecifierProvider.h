...
- (void).cxx_destruct;	// IMP=0x000000000005694b
...
- (void)_didFetchAppInfo:(id)arg1;	// IMP=0x000000000005687b
- (id)developer:(id)arg1;	// IMP=0x00000000000567a9
- (id)ageRating:(id)arg1;	// IMP=0x0000000000056693
- (id)category:(id)arg1;	// IMP=0x0000000000056620
- (id)usageItem:(id)arg1;	// IMP=0x000000000005660e
- (id)initWithUsageItem:(id)arg1;	// IMP=0x0000000000055e68
