...
- (void).cxx_destruct;	// IMP=0x0000000000008bf7
...
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x0000000000008440
- (void)tableView:(id)arg1 didDeselectRowAtIndexPath:(id)arg2;	// IMP=0x0000000000008240
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000000008040
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x0000000000007e53
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000007663
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000000000761f
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000007569
- (void)viewDidLoad;	// IMP=0x0000000000007492
