...
- (void)refreshUsageData;	// IMP=0x000000000008dd7d
- (void)stopRefreshingUsageData;	// IMP=0x000000000008dd77
- (void)startRefreshingUsageData;	// IMP=0x000000000008dd71
- (id)_introUsageItemsWithStartDate:(id)arg1;	// IMP=0x000000000008cf7f
- (id)categoryConfigByIdentifier;	// IMP=0x000000000008cebb
- (id)appConfigByIdentifier;	// IMP=0x000000000008ceae
- (id)init;	// IMP=0x000000000008cbe3
