...
- (void).cxx_destruct;	// IMP=0x000000000003f635
...
- (_Bool)shouldEnableRestriction:(id)arg1;	// IMP=0x000000000003f3b8
- (id)defaultValueForRestriction:(id)arg1;	// IMP=0x000000000003f2a3
- (id)visibleRestrictionWithConfiguration:(id)arg1 key:(id)arg2;	// IMP=0x000000000003f126
- (id)init;	// IMP=0x000000000003f0ab
- (id)defaultValueForRestrictionIdentifier:(id)arg1;	// IMP=0x000000000006c406
