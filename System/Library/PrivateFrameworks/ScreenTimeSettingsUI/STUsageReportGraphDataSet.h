...
- (void).cxx_destruct;	// IMP=0x00000000000c1d2b
...
- (id)initEmptyDataSetWithTimePeriod:(unsigned long long)arg1 referenceDate:(id)arg2;	// IMP=0x00000000000c17d4
- (id)initWithTimePeriod:(unsigned long long)arg1 itemType:(unsigned long long)arg2 total:(id)arg3 max:(id)arg4 average:(id)arg5 averageAsPercentageOfMax:(double)arg6 dataPoints:(id)arg7;	// IMP=0x00000000000c16a6
