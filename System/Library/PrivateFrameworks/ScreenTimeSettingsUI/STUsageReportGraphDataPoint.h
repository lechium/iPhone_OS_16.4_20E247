...
- (void).cxx_destruct;	// IMP=0x00000000000c20d6
...
- (id)description;	// IMP=0x00000000000c1ebd
- (id)initWithTimePeriod:(unsigned long long)arg1 itemType:(unsigned long long)arg2 dateInterval:(id)arg3 total:(id)arg4 totalAsPercentageOfMax:(double)arg5 segments:(id)arg6;	// IMP=0x00000000000c1db9
