...
- (void).cxx_destruct;	// IMP=0x0000000000057b8b
...
- (id)notifications:(id)arg1;	// IMP=0x000000000005796c
- (id)dailyAverage:(id)arg1;	// IMP=0x00000000000573c3
- (id)weeklyPickupTotal:(id)arg1;	// IMP=0x00000000000571e1
- (id)selectedUsageReport:(id)arg1;	// IMP=0x00000000000570f3
- (id)initWithUsageItem:(id)arg1 coordinator:(id)arg2;	// IMP=0x00000000000569a0
