...
- (void).cxx_destruct;	// IMP=0x0000000000055145
...
- (void)tableView:(id)arg1 willDisplayFooterView:(id)arg2 forSection:(long long)arg3;	// IMP=0x0000000000054f19
- (void)_didFetchAppInfo:(id)arg1;	// IMP=0x0000000000054eaa
- (void)viewDidLoad;	// IMP=0x0000000000054d5b
- (_Bool)canBeShownFromSuspendedState;	// IMP=0x0000000000054d18
- (id)initWithUsageItem:(id)arg1 coordinator:(id)arg2;	// IMP=0x00000000000549cc
