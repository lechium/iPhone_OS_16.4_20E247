...
- (void).cxx_destruct;	// IMP=0x00000000000a67cc
...
- (void)_reportCoreAnalyticsEventWithUser:(id)arg1 currentDate:(id)arg2 calendar:(id)arg3;	// IMP=0x00000000000a6439
@property(getter=isDatePickerHidden) _Bool datePickerHidden;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000a5ff2
- (void)_rightDatePickerBarButtonTapped:(id)arg1;	// IMP=0x00000000000a5e5b
- (void)_leftDatePickerBarButtonTapped:(id)arg1;	// IMP=0x00000000000a5ce8
- (void)_setSelectedDeviceIdentifier:(id)arg1;	// IMP=0x00000000000a5ba0
- (id)_getUIActionForDevice:(id)arg1 deviceIndentifier:(id)arg2 weakSelf:(id)arg3;	// IMP=0x00000000000a59e8
- (id)_getDevicesDropDownMenu;	// IMP=0x00000000000a54ff
- (void)_setSelectedUsageReportType:(unsigned long long)arg1;	// IMP=0x00000000000a53ca
- (void)_selectedUsageReportDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x00000000000a49f8
- (void)_devicesDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x00000000000a47cd
- (void)_hasUsageDataDidChange:(_Bool)arg1;	// IMP=0x00000000000a428c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000a3e51
- (void)setCoordinator:(id)arg1;	// IMP=0x00000000000a3bca
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000a3a48
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000a39ad
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000a38a5
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000a3787
- (void)viewDidLoad;	// IMP=0x00000000000a314b
- (void)dealloc;	// IMP=0x00000000000a307f
