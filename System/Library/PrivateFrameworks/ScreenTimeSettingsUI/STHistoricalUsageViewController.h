...
+ (id)historicalUsageViewControllerOfType:(unsigned long long)arg1 graphHeight:(double)arg2;	// IMP=0x0010000000060118
- (void).cxx_destruct;	// IMP=0x0000000000062659
...
- (id)_dataSetFromUsageReport:(id)arg1;	// IMP=0x000000000006238f
- (id)_dayGraphViewControllerForDay:(unsigned long long)arg1 week:(unsigned long long)arg2 usageReport:(id)arg3;	// IMP=0x000000000006216c
- (id)_weekGraphViewControllerForWeek:(unsigned long long)arg1 usageReport:(id)arg2;	// IMP=0x0000000000061ef0
- (void)pageViewController:(id)arg1 didFinishAnimating:(_Bool)arg2 previousViewControllers:(id)arg3 transitionCompleted:(_Bool)arg4;	// IMP=0x0000000000061bcf
- (void)pageViewController:(id)arg1 willTransitionToViewControllers:(id)arg2;	// IMP=0x0000000000061a05
- (id)_nextGraphViewControllerForPageViewController:(id)arg1 currentGraphViewController:(id)arg2 direction:(long long)arg3;	// IMP=0x0000000000061578
- (id)pageViewController:(id)arg1 viewControllerAfterViewController:(id)arg2;	// IMP=0x0000000000061475
- (id)pageViewController:(id)arg1 viewControllerBeforeViewController:(id)arg2;	// IMP=0x000000000006136f
- (void)_selectedBarViewDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x00000000000611c7
- (void)_selectedDayUsageReportDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x0000000000060dd0
- (void)_selectedWeekUsageReportDidChange:(id)arg1;	// IMP=0x0000000000060b11
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000607bf
- (void)prepareForSegue:(id)arg1 sender:(id)arg2;	// IMP=0x00000000000603b3
- (void)viewDidLoad;	// IMP=0x0000000000060284
- (void)dealloc;	// IMP=0x00000000000601db
