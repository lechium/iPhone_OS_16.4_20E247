...
- (void).cxx_destruct;	// IMP=0x00000000000a1d5c
...
- (void)_didFetchAppInfoOrIcon:(id)arg1;	// IMP=0x00000000000a1cbb
- (void)refreshCellContentsWithSpecifier:(id)arg1;	// IMP=0x00000000000a1b86
- (void)setValue:(id)arg1;	// IMP=0x00000000000a1791
- (id)value;	// IMP=0x00000000000a1753
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x00000000000a0935
