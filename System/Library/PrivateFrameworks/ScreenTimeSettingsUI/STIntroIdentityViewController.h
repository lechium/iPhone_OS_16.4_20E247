...
- (void).cxx_destruct;	// IMP=0x000000000006d764
...
- (void)_myChildsDevice:(id)arg1;	// IMP=0x000000000006d6c1
- (void)_myDevice:(id)arg1;	// IMP=0x000000000006d64d
- (void)loadView;	// IMP=0x000000000006d435
- (id)initWithIntroductionModel:(id)arg1 continueHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000006d1fb
