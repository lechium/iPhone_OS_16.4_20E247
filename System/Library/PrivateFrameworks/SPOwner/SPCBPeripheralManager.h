...
+ (id)remoteInterface;	// IMP=0x001000000003f9f1
- (void).cxx_destruct;	// IMP=0x00000000000409a9
...
- (id)_enforceRateLimit;	// IMP=0x00000000000405df
- (void)fetch;	// IMP=0x000000000003fd5b
- (void)timerFiredForActivity:(id)arg1;	// IMP=0x000000000003fbb2
- (double)timeIntervalToNextFireDateFromDate:(id)arg1;	// IMP=0x000000000003fb3c
- (id)descriptionForVendorIdentifierList:(id)arg1;	// IMP=0x000000000003fa5d
- (void)invalidationHandler:(id)arg1;	// IMP=0x000000000003f60b
- (void)interruptionHandler:(id)arg1;	// IMP=0x000000000003f566
- (void)successfulConnectionForPeripheral:(id)arg1 leMAC:(id)arg2 ltk:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000003ef85
- (void)enableSystemWakesForUpdate:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ed9a
- (void)stopSessionForUserIdentifier:(id)arg1 bundleId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003e74d
- (void)startSessionForUserIdentifier:(id)arg1 bundleId:(id)arg2 vendorIdentifierList:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000003e18e
- (id)init;	// IMP=0x000000000003de58
- (void)handleDarwinNotificationNamed:(id)arg1;	// IMP=0x000000000003dd9c
