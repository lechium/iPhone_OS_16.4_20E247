...
- (void).cxx_destruct;	// IMP=0x000000000004521e
...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x00000000000450b7
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x000000000004503c
- (void)startMonitoring;	// IMP=0x0000000000044f2b
- (id)init;	// IMP=0x0000000000044eef
