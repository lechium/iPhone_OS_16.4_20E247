...
- (void).cxx_destruct;	// IMP=0x0000000000012f39
...
- (void)resume;	// IMP=0x0000000000012e17
- (void)pause;	// IMP=0x0000000000012d9f
- (void)stop;	// IMP=0x0000000000012d38
- (void)start;	// IMP=0x0000000000012bba
- (unsigned long long)powerState;	// IMP=0x0000000000012bb2
- (_Bool)isNetworkUp;	// IMP=0x0000000000012b6e
- (id)initWithBeaconManager:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000012a93
