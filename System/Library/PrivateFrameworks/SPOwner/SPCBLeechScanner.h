...
+ (id)remoteInterface;	// IMP=0x001000000001f04f
...
- (void)centralManager:(id)arg1 didDiscoverPeripheral:(id)arg2 advertisementData:(id)arg3 RSSI:(id)arg4;	// IMP=0x000000000001f0fc
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000001f0bb
- (void)invalidationHandler:(id)arg1;	// IMP=0x000000000001ec69
- (void)interruptionHandler:(id)arg1;	// IMP=0x000000000001ebc4
- (void)stopScanning;	// IMP=0x000000000001eae8
- (void)startScanning;	// IMP=0x000000000001e932
- (void)handleStateChange:(unsigned long long)arg1;	// IMP=0x000000000001e4a0
- (id)init;	// IMP=0x000000000001e170
