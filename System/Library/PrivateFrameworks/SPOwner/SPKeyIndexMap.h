...
- (void).cxx_destruct;	// IMP=0x0000000000038f7c
...
- (id)headerString;	// IMP=0x0000000000038ec1
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x0000000000038e40
- (void)dealloc;	// IMP=0x0000000000038e06
- (id)init;	// IMP=0x0000000000038ddb
