...
+ (Class)eaProtocolStringsType;	// IMP=0x000000000000696b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006092
- (unsigned long long)hash;	// IMP=0x0000000000005464
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004d19
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004692
- (void)copyTo:(id)arg1;	// IMP=0x000000000000420c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003cb8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002cd0
- (id)dictionaryRepresentation;	// IMP=0x0000000000002236
- (id)description;	// IMP=0x0000000000002187
...
- (id)eaProtocolStringsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000020cb
- (unsigned long long)eaProtocolStringsCount;	// IMP=0x00000000000020ae
- (void)addEaProtocolStrings:(id)arg1;	// IMP=0x0000000000002044
- (void)clearEaProtocolStrings;	// IMP=0x0000000000002027
