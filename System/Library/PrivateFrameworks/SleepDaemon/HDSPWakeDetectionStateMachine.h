...
- (void).cxx_destruct;	// IMP=0x0000000000068aba
...
- (id)detectionWindowForType:(unsigned long long)arg1;	// IMP=0x0000000000068a06
...
- (void)postWakeDetectionNotification:(unsigned long long)arg1;	// IMP=0x00000000000686fb
- (void)stopWakeDetection;	// IMP=0x00000000000686cd
- (void)startWakeDetection:(unsigned long long)arg1;	// IMP=0x0000000000068662
- (void)earlyWakeUpWasNotifiedRemotely;	// IMP=0x0000000000068625
- (void)wakeupEventDetected:(unsigned long long)arg1 date:(id)arg2;	// IMP=0x00000000000685ad
- (unsigned long long)loggingCategory;	// IMP=0x00000000000685a2
- (id)allStates;	// IMP=0x00000000000684fb
- (id)initWithIdentifier:(id)arg1 persistence:(id)arg2 delegate:(id)arg3 infoProvider:(id)arg4 currentDateProvider:(CDUnknownBlockType)arg5;	// IMP=0x000000000006820c
