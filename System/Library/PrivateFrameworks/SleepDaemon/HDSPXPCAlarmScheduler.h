...
- (void).cxx_destruct;	// IMP=0x0000000000058018
...
- (id)notificationListener:(id)arg1 didReceiveNotificationWithName:(id)arg2;	// IMP=0x0000000000057e5e
- (void)unschedule;	// IMP=0x0000000000057e12
- (void)scheduleEventForDate:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000057ccc
- (id)initWithCurrentDateProvider:(CDUnknownBlockType)arg1;	// IMP=0x0000000000057c42
