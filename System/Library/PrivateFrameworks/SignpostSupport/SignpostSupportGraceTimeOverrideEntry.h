...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x0000000000003e43
- (id)debugDescription;	// IMP=0x0000000000003e2a
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x0000000000003dc9
