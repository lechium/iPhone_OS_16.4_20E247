...
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x00000000000140c1
- (void)waitUntilComplete;	// IMP=0x00000000000140bb
- (_Bool)isPurgeable;	// IMP=0x00000000000140b3
- (_Bool)isComplete;	// IMP=0x00000000000140ab
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x000000000001407b
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000014066
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000001404e
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x0000000000013efd
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000013e61
- (void)makeAliasable;	// IMP=0x0000000000013dc3
- (_Bool)isAliasable;	// IMP=0x0000000000013dba
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x0000000000013d63
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x0000000000013c98
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x0000000000013bfb
