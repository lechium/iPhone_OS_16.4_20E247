...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000096ea
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x00000000000096e2
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x00000000000096da
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x00000000000095fc
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x0000000000009596
