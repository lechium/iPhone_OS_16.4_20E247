...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001dc6
- (unsigned long long)alignment;	// IMP=0x0000000000001db5
- (unsigned long long)encodedLength;	// IMP=0x0000000000001da4
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x0000000000001d94
- (void)dealloc;	// IMP=0x0000000000001cbf
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x0000000000001c20
