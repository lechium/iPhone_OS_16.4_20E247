...
- (unsigned int)depthStencilRef;	// IMP=0x00000000000138cb
- (void)dealloc;	// IMP=0x0000000000013801
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x00000000000137b9
