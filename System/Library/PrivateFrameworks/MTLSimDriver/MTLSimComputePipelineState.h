...
- (id)pipelineBinaries;	// IMP=0x000000000000ef48
- (unsigned int)pipelineRef;	// IMP=0x000000000000ef38
- (void)dealloc;	// IMP=0x000000000000ee5e
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000ec65
