...
- (void).cxx_destruct;	// IMP=0x00000000002eda6b
...
- (void)beginUserInteractionWithFirstTouchGestureRecognizer:(id)arg1;	// IMP=0x00000000002ed9d0
- (id)intrinsicSizeDescriptorForControlSize:(unsigned long long)arg1;	// IMP=0x00000000002ed9b7
- (id)initWithProfile:(id)arg1;	// IMP=0x00000000002ed89b
