...
- (id)initWithDelegate:(id)arg1 sourceItem:(id)arg2;	// IMP=0x0000000000051350
- (id)_itemsToHideInSet:(id)arg1;	// IMP=0x00000000000512b0
- (id)_buildSectionsWithDisplayedItems:(id)arg1;	// IMP=0x0000000000050cd0
- (id)_buildItemProvidersForHome:(id)arg1;	// IMP=0x0000000000050af0
