...
@interface FlexMLSummary : NSObject
{
    ...
    NSDictionary *_videoCues;	// 24 = 0x18
    NSArray *_allBeats;	// 32 = 0x20
    NSArray *_allBars;	// 40 = 0x28
    NSArray *_loopPoints;	// 48 = 0x30
    double _lkfsValue;	// 56 = 0x38
    CDStruct_1b6d18a9 _duration;	// 64 = 0x40
}

+ (id)summaryFromSummaries:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x00600000000142dd
- (void).cxx_destruct;	// IMP=0x00000000000166d4
...
- (id)initWithDictionary:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x0000000000015b27
