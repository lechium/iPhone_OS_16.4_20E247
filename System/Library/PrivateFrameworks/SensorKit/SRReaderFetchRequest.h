...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000011cba
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000011db4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011cc2
@property(retain, nonatomic) NSString *deviceIdentifier;
@property(retain, nonatomic) NSString *bundleIdentifier;
@property(retain, nonatomic) NSString *sensor;
- (void)dealloc;	// IMP=0x0000000000011bf3
- (id)init;	// IMP=0x0000000000011ba7
