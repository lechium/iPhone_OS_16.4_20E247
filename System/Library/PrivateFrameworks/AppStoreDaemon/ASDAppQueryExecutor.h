...
- (void).cxx_destruct;	// IMP=0x000000000003508c
@property(nonatomic) long long queryOptions; // @synthesize queryOptions=_queryOptions;
- (void)executeQueryWithPredicate:(id)arg1 onPairedDevice:(id)arg2 withResultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000033df0
- (id)initWithServiceBroker:(id)arg1;	// IMP=0x0000000000033d37
- (id)init;	// IMP=0x0000000000033d23
