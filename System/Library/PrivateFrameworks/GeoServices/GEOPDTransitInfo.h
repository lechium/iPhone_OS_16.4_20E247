...
+ (id)transitInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a6f01b
- (void).cxx_destruct;	// IMP=0x0000000000d26990
- (unsigned long long)hash;	// IMP=0x0000000000d2685a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d265de
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d25de0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d2545a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d2544b
- (id)jsonRepresentation;	// IMP=0x0000000000d25271
- (id)dictionaryRepresentation;	// IMP=0x0000000000d24549
- (id)description;	// IMP=0x0000000000d2449a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d22402
- (id)init;	// IMP=0x0000000000d223a6
