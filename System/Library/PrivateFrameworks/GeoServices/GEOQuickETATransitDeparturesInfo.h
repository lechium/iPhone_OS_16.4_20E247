...
- (void).cxx_destruct;	// IMP=0x00000000013333c8
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x000000000133323e
- (id)description;	// IMP=0x0000000001333184
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x00000000013330df
