...
- (void).cxx_destruct;	// IMP=0x0000000000777ab8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007776aa
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x00000000007775b4
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x0000000000777442
...
- (id)calloutTitle;	// IMP=0x00000000007770a3
- (id)queryLine;	// IMP=0x0000000000776f84
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x0000000000776f35
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x000000000077590c
