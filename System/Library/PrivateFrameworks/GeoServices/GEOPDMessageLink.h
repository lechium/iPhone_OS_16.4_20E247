...
+ (id)messageLinkForPlaceData:(id)arg1;	// IMP=0x0010000000a76169
- (void).cxx_destruct;	// IMP=0x0000000000c93c5f
- (unsigned long long)hash;	// IMP=0x0000000000c93b3f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c93922
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c93526
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c931b1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c931a2
- (id)jsonRepresentation;	// IMP=0x0000000000c92fc8
- (id)dictionaryRepresentation;	// IMP=0x0000000000c92972
- (id)description;	// IMP=0x0000000000c928c3
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c91476
- (id)init;	// IMP=0x0000000000c9141a
