...
- (void).cxx_destruct;	// IMP=0x0000000000dad0ad
- (unsigned long long)hash;	// IMP=0x0000000000dace79
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000dacafd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dac761
- (void)writeTo:(id)arg1;	// IMP=0x0000000000dac1a3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000dac196
- (id)jsonRepresentation;	// IMP=0x0000000000dabf26
- (id)dictionaryRepresentation;	// IMP=0x0000000000dab7bf
- (id)description;	// IMP=0x0000000000dab710
- (id)initWithData:(id)arg1;	// IMP=0x0000000000daa388
- (id)init;	// IMP=0x0000000000daa32c
