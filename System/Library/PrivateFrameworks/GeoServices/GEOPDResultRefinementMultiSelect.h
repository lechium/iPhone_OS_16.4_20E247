...
- (void).cxx_destruct;	// IMP=0x0000000000e6879a
- (unsigned long long)hash;	// IMP=0x0000000000e68694
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e684b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e680fd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e67da8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e67d99
- (id)jsonRepresentation;	// IMP=0x0000000000e67a18
- (id)dictionaryRepresentation;	// IMP=0x0000000000e6740a
- (id)description;	// IMP=0x0000000000e6735b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e6615e
- (id)init;	// IMP=0x0000000000e66102
