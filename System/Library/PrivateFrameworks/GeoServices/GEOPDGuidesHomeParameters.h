...
- (void).cxx_destruct;	// IMP=0x00000000005542bd
- (unsigned long long)hash;	// IMP=0x00000000005541fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055407f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000553e43
- (void)writeTo:(id)arg1;	// IMP=0x0000000000553acb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000553abc
- (id)jsonRepresentation;	// IMP=0x000000000055373b
- (id)dictionaryRepresentation;	// IMP=0x00000000005530f7
- (id)description;	// IMP=0x0000000000553048
- (void)dealloc;	// IMP=0x0000000000551daa
- (id)initWithData:(id)arg1;	// IMP=0x0000000000551d4e
- (id)init;	// IMP=0x0000000000551cf2
