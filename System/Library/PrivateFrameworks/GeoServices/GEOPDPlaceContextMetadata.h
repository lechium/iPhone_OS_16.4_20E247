...
- (void).cxx_destruct;	// IMP=0x0000000000ccd370
- (unsigned long long)hash;	// IMP=0x0000000000ccd0b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cccf84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cccd79
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cccb3b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cccb2c
- (id)jsonRepresentation;	// IMP=0x0000000000cca0f7
- (id)dictionaryRepresentation;	// IMP=0x0000000000cc9c43
- (id)description;	// IMP=0x0000000000cc9b94
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cc931e
- (id)init;	// IMP=0x0000000000cc92c2
