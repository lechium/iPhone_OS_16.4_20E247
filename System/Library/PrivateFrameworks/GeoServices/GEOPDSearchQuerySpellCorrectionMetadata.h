...
- (void).cxx_destruct;	// IMP=0x0000000000b215b6
- (unsigned long long)hash;	// IMP=0x0000000000b212c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b20f40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b208ed
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b2032b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b2031c
- (id)jsonRepresentation;	// IMP=0x0000000000b2030d
- (id)dictionaryRepresentation;	// IMP=0x0000000000b1f67c
- (id)description;	// IMP=0x0000000000b1f5cd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b1df8e
- (id)init;	// IMP=0x0000000000b1df32
