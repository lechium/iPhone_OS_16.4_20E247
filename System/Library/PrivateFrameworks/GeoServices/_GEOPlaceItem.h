...
- (void).cxx_destruct;	// IMP=0x000000000089b42d
...
- (id)_placecardLayoutConfiguration;	// IMP=0x000000000089b405
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x000000000089b3fd
...
- (id)_businessClaim;	// IMP=0x000000000089b3b5
- (_Bool)_hasBusinessClaim;	// IMP=0x000000000089b3ad
- (id)_mapItemByStrippingOptionalData;	// IMP=0x000000000089b3a4
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x000000000089b34c
...
- (id)_yelpID;	// IMP=0x000000000089b0f2
...
- (id)_urlForWritingAReview;	// IMP=0x000000000089b0da
- (id)_urlForReview:(id)arg1;	// IMP=0x000000000089b0d2
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x000000000089b0ca
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000089b047
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000089b03f
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x000000000089aca2
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x000000000089ac60
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x000000000089ac1e
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x000000000089ac01
- (int)_recommendedTransportType;	// IMP=0x000000000089abf6
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x000000000089abd9
...
- (id)weatherDisplayName;	// IMP=0x000000000089ab31
- (id)addressObject;	// IMP=0x000000000089aa7e
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x000000000089a4ae
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x000000000089a3f1
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x000000000089a20d
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x000000000089a134
