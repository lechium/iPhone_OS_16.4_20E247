...
- (void).cxx_destruct;	// IMP=0x000000000120b0bd
...
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x0000000001209336
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000012091ab
...
- (double)startTime;	// IMP=0x000000000120902e
- (double)elapsed;	// IMP=0x0000000001208fde
- (void)clearAllRelatedOperations;	// IMP=0x0000000001208fac
- (void)cancel;	// IMP=0x0000000001208dff
- (void)start;	// IMP=0x00000000012087cc
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000001207ede
- (id)init;	// IMP=0x0000000001207ed0
