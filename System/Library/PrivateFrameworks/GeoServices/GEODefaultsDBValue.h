...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0060000000295092
- (void).cxx_destruct;	// IMP=0x0000000000295187
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0000000000294fe0
