...
- (void).cxx_destruct;	// IMP=0x0000000001164b0e
@property(readonly, nonatomic) GEOTileLoader *tileLoader; // @synthesize tileLoader=_tileLoader;
- (void)cancel;	// IMP=0x00000000011648da
- (void)addTileRequest:(id)arg1;	// IMP=0x000000000116482d
- (id)initWithTileLoader:(id)arg1;	// IMP=0x000000000116477d
