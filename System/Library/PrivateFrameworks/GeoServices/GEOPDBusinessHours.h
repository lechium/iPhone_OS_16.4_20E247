...
+ (id)businessHoursForPlaceData:(id)arg1;	// IMP=0x0010000000a77592
- (void).cxx_destruct;	// IMP=0x0000000000b92041
- (unsigned long long)hash;	// IMP=0x0000000000b91d33
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b91b5b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b91782
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b91297
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b91288
- (id)jsonRepresentation;	// IMP=0x0000000000b8fa4b
- (id)dictionaryRepresentation;	// IMP=0x0000000000b8f322
- (id)description;	// IMP=0x0000000000b8f273
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b8e0e3
- (id)init;	// IMP=0x0000000000b8e087
