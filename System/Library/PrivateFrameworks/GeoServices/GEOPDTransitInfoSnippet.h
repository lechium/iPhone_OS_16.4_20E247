...
+ (id)transitInfoSnippetForPlaceData:(id)arg1;	// IMP=0x0010000000a6f157
- (void).cxx_destruct;	// IMP=0x0000000000d2ae25
- (unsigned long long)hash;	// IMP=0x0000000000d2acfb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d2aaac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d2a4a1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d29ea4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d29e95
- (id)jsonRepresentation;	// IMP=0x0000000000d29299
- (id)dictionaryRepresentation;	// IMP=0x0000000000d28a3c
- (id)description;	// IMP=0x0000000000d2898d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d26ec9
- (id)init;	// IMP=0x0000000000d26e6d
