...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000011e2e99
- (void).cxx_destruct;	// IMP=0x00000000011e3063
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011e2fc3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011e2ea1
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x00000000011e29b4
