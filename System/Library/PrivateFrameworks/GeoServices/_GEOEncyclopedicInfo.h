...
- (void).cxx_destruct;	// IMP=0x00000000007861d8
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x000000000078607b
- (id)factoidAtIndex:(int)arg1;	// IMP=0x0000000000785fcb
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000785a40
