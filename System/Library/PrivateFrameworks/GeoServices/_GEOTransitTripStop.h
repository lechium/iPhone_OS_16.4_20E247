...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x001000000116b6f3
- (void).cxx_destruct;	// IMP=0x000000000116bebc
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x000000000116bb90
