...
- (id).cxx_construct;	// IMP=0x0000000000353acb
- (void).cxx_destruct;	// IMP=0x0000000000353a9a
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000353a18
- (id)findStation:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000353830
- (id)findStops:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000353828
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003537e4
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x0000000000353761
...
- (id)initWithMap:(id)arg1 accessPoint:(shared_ptr_4792c490)arg2;	// IMP=0x00000000003535dd
