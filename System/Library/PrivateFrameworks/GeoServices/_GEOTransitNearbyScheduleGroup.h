...
+ (id)lineSectionsForNearbyTransitGroup:(id)arg1 departureSequenceContainers:(id)arg2 departureSequences:(id)arg3;	// IMP=0x00100000011e5f78
- (void).cxx_destruct;	// IMP=0x00000000011e62d5
...
- (id)initWithTransitScheduleGroup:(id)arg1 departureSequenceContainers:(id)arg2 scheduledDepartureSequences:(id)arg3 incidentsMap:(id)arg4;	// IMP=0x00000000011e5d4c
