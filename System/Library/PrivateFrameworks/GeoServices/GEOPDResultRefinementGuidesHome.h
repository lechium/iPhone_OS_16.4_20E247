...
- (void).cxx_destruct;	// IMP=0x0000000000e601b6
- (unsigned long long)hash;	// IMP=0x0000000000e600bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e5fed8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e5fc3d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e5f9b1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e5f9a2
- (id)jsonRepresentation;	// IMP=0x0000000000e5f3a2
- (id)dictionaryRepresentation;	// IMP=0x0000000000e5ed02
- (id)description;	// IMP=0x0000000000e5ec53
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e5dbfe
- (id)init;	// IMP=0x0000000000e5dba2
