...
- (void).cxx_destruct;	// IMP=0x0000000000419424
- (unsigned long long)hash;	// IMP=0x0000000000418a71
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000418679
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004182a8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000417f14
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000417f07
- (id)jsonRepresentation;	// IMP=0x0000000000417a80
- (id)dictionaryRepresentation;	// IMP=0x0000000000416fe3
- (id)description;	// IMP=0x0000000000416f34
- (id)initWithData:(id)arg1;	// IMP=0x0000000000415ff0
- (id)init;	// IMP=0x0000000000415f94
