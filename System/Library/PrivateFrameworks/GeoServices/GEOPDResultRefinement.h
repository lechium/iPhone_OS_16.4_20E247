...
- (void).cxx_destruct;	// IMP=0x0000000000e59f04
- (unsigned long long)hash;	// IMP=0x0000000000e595e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e59432
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e591be
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e58d33
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e58d24
- (id)jsonRepresentation;	// IMP=0x0000000000e539cf
- (id)dictionaryRepresentation;	// IMP=0x0000000000e534aa
- (id)description;	// IMP=0x0000000000e533fb
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e5243f
- (id)init;	// IMP=0x0000000000e523e3
