...
- (id).cxx_construct;	// IMP=0x0000000000a6a2c6
- (void).cxx_destruct;	// IMP=0x0000000000a6a293
...
- (id)description;	// IMP=0x0000000000a6a0a1
- (double)_oldestEventInJulianDay;	// IMP=0x0000000000a6a03d
- (int)_numberOfEvents;	// IMP=0x0000000000a6a027
...
- (id)_dateFromOffset:(double)arg1;	// IMP=0x0000000000a69ed8
- (id)initWithJulianDay:(double)arg1 riseTransitSet:(struct CAARiseTransitSetDetails)arg2;	// IMP=0x0000000000a69e7a
