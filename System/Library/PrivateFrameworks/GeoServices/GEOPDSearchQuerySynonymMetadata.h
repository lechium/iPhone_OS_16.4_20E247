...
- (void).cxx_destruct;	// IMP=0x0000000000b2599f
- (unsigned long long)hash;	// IMP=0x0000000000b256c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b25301
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b24c58
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b24698
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b24689
- (id)jsonRepresentation;	// IMP=0x0000000000b237aa
- (id)dictionaryRepresentation;	// IMP=0x0000000000b22c08
- (id)description;	// IMP=0x0000000000b22b59
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b21676
- (id)init;	// IMP=0x0000000000b2161a
