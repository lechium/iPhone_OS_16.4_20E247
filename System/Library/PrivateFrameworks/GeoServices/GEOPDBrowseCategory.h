...
- (void).cxx_destruct;	// IMP=0x0000000000e462cb
- (unsigned long long)hash;	// IMP=0x0000000000e45e5b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e45b94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e4572d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e4533a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e4532b
- (id)jsonRepresentation;	// IMP=0x0000000000e44706
- (id)dictionaryRepresentation;	// IMP=0x0000000000e43e67
- (id)description;	// IMP=0x0000000000e43db8
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e424e5
- (id)init;	// IMP=0x0000000000e42489
