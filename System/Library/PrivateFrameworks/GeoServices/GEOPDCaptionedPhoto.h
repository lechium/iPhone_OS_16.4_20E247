...
+ (id)captionedPhotosForPlaceData:(id)arg1;	// IMP=0x0010000000a74bd4
- (void).cxx_destruct;	// IMP=0x0000000000b9bf0d
- (unsigned long long)hash;	// IMP=0x0000000000b9b655
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b9b2e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b9af3e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b9ac0f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b9ac00
- (id)jsonRepresentation;	// IMP=0x0000000000b996c6
- (id)dictionaryRepresentation;	// IMP=0x0000000000b98fcf
- (id)description;	// IMP=0x0000000000b98f20
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b97463
- (id)init;	// IMP=0x0000000000b97407
