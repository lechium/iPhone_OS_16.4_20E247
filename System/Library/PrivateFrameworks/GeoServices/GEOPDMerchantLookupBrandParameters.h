...
- (void).cxx_destruct;	// IMP=0x000000000057dee5
- (unsigned long long)hash;	// IMP=0x000000000057ddb5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057dbd3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000057d935
- (void)writeTo:(id)arg1;	// IMP=0x000000000057d6ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000057d69e
- (id)jsonRepresentation;	// IMP=0x000000000057d099
- (id)dictionaryRepresentation;	// IMP=0x000000000057c7ff
- (id)description;	// IMP=0x000000000057c750
- (id)initWithData:(id)arg1;	// IMP=0x000000000057bceb
- (id)init;	// IMP=0x000000000057bc8f
