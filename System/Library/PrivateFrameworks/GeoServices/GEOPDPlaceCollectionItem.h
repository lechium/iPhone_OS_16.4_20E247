...
- (void).cxx_destruct;	// IMP=0x0000000000cc87d7
- (unsigned long long)hash;	// IMP=0x0000000000cc8635
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cc8398
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cc7bc3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cc753b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cc752c
- (id)jsonRepresentation;	// IMP=0x0000000000cc624b
- (id)dictionaryRepresentation;	// IMP=0x0000000000cc54b2
- (id)description;	// IMP=0x0000000000cc5403
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cc358a
- (id)init;	// IMP=0x0000000000cc352e
- (id)punchOutText;	// IMP=0x0000000000a76ba1
- (id)itemHTMLDescription;	// IMP=0x0000000000a76b4b
- (id)itemDescription;	// IMP=0x0000000000a76af5
