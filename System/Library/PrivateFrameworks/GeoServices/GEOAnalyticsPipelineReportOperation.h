...
- (void).cxx_destruct;	// IMP=0x0000000000a2f889
- (_Bool)isFinished;	// IMP=0x0000000000a2f879
- (_Bool)isExecuting;	// IMP=0x0000000000a2f869
- (void)_completeOperation;	// IMP=0x0000000000a2f7a5
- (void)start;	// IMP=0x0000000000a2f6f7
- (id)initWithRemoteProxy:(id)arg1 runQueue:(id)arg2 completionQueue:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000a2f5bc
