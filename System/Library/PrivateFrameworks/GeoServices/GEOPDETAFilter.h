...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x0010000000a789c3
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x0010000000a787a3
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x0010000000a7857d
- (void).cxx_destruct;	// IMP=0x0000000000c42ea3
- (unsigned long long)hash;	// IMP=0x0000000000c42d58
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c42b06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c4283c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c42598
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c42589
- (id)jsonRepresentation;	// IMP=0x0000000000c41c7b
- (id)dictionaryRepresentation;	// IMP=0x0000000000c413bf
- (id)description;	// IMP=0x0000000000c41310
- (void)dealloc;	// IMP=0x0000000000c3ff9e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c3ff42
- (id)init;	// IMP=0x0000000000c3fee6
