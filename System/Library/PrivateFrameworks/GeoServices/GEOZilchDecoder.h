...
+ (_Bool)decodingSupported;	// IMP=0x0060000000d5c180
- (id).cxx_construct;	// IMP=0x0000000000d5c523
- (void).cxx_destruct;	// IMP=0x0000000000d5c4d4
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000d5c40a
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000d5c37e
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d5c26b
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000d5c257
- (id)requestQueue;	// IMP=0x0000000000d5c242
- (id)init;	// IMP=0x0000000000d5c199
