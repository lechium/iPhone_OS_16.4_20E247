...
- (void).cxx_destruct;	// IMP=0x000000000063ae85
- (unsigned long long)hash;	// IMP=0x000000000063ad05
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000063aa43
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000063a51a
- (void)writeTo:(id)arg1;	// IMP=0x000000000063a098
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000063a089
- (id)jsonRepresentation;	// IMP=0x0000000000639f77
- (id)dictionaryRepresentation;	// IMP=0x0000000000639492
- (id)description;	// IMP=0x00000000006393e3
- (id)initWithData:(id)arg1;	// IMP=0x0000000000637de0
- (id)init;	// IMP=0x0000000000637d84
