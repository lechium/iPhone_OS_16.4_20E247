...
- (id).cxx_construct;	// IMP=0x00000000012062a5
- (void).cxx_destruct;	// IMP=0x000000000120626d
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outSegmentCoordinate:(struct PolylineCoordinate *)arg2;	// IMP=0x0000000001205fc7
...
- (id)initWithMap:(id)arg1 edge:(shared_ptr_035a2da2)arg2;	// IMP=0x0000000001205ea7
