...
- (void).cxx_destruct;	// IMP=0x0000000000ce011d
- (unsigned long long)hash;	// IMP=0x0000000000ce000f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cdfe32
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cdf988
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cdf586
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cdf577
- (id)jsonRepresentation;	// IMP=0x0000000000cdecca
- (id)dictionaryRepresentation;	// IMP=0x0000000000cde371
- (id)description;	// IMP=0x0000000000cde2c2
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cdcf44
- (id)init;	// IMP=0x0000000000cdcee8
- (id)publisherDescription;	// IMP=0x0000000000a76a9f
