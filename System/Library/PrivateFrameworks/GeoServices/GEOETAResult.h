...
- (void).cxx_destruct;	// IMP=0x000000000149eec6
- (unsigned long long)hash;	// IMP=0x000000000149edbe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000149ebec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000149e767
- (void)writeTo:(id)arg1;	// IMP=0x000000000149e1cb
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000149e1bc
- (id)jsonRepresentation;	// IMP=0x000000000149cfec
- (id)dictionaryRepresentation;	// IMP=0x000000000149c7af
- (id)description;	// IMP=0x000000000149c700
- (id)initWithData:(id)arg1;	// IMP=0x000000000149b4de
- (id)init;	// IMP=0x000000000149b482
