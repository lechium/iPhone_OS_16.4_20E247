...
- (id).cxx_construct;	// IMP=0x000000000108613a
- (void).cxx_destruct;	// IMP=0x00000000010860a4
...
- (void)cancel;	// IMP=0x0000000001085fab
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000108528d
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x0000000001085101
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x0000000001084f10
