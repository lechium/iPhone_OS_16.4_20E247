...
- (void).cxx_destruct;	// IMP=0x0000000000574269
- (unsigned long long)hash;	// IMP=0x0000000000574030
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000573e49
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000573bae
- (void)writeTo:(id)arg1;	// IMP=0x0000000000573918
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000573909
- (id)jsonRepresentation;	// IMP=0x0000000000573092
- (id)dictionaryRepresentation;	// IMP=0x0000000000572bc8
- (id)description;	// IMP=0x0000000000572b19
- (id)initWithData:(id)arg1;	// IMP=0x00000000005719ca
- (id)init;	// IMP=0x000000000057196e
