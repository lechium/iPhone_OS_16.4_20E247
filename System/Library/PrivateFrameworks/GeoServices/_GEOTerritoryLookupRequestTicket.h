...
- (void).cxx_destruct;	// IMP=0x000000000077205d
- (void)submitWithHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 timeout:(long long)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000007711ca
- (id)initWithLatLngs:(id)arg1 shiftLocationsIfNeeded:(_Bool)arg2 traits:(id)arg3;	// IMP=0x0000000000770ee3
