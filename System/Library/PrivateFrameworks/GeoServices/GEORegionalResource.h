...
- (void).cxx_destruct;	// IMP=0x00000000006f96b0
- (unsigned long long)hash;	// IMP=0x00000000006f95aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006f93cf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006f8e33
- (void)writeTo:(id)arg1;	// IMP=0x00000000006f8914
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006f8905
- (id)jsonRepresentation;	// IMP=0x00000000006f8584
- (id)dictionaryRepresentation;	// IMP=0x00000000006f7f64
- (id)description;	// IMP=0x00000000006f7eb5
- (void)dealloc;	// IMP=0x00000000006f6c02
- (id)initWithData:(id)arg1;	// IMP=0x00000000006f6ba6
- (id)init;	// IMP=0x00000000006f6b4a
