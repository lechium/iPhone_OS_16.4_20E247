...
- (void).cxx_destruct;	// IMP=0x0000000000b06de3
- (unsigned long long)hash;	// IMP=0x0000000000b06d1a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b06b6c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b06536
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b04f57
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b04f48
- (id)jsonRepresentation;	// IMP=0x0000000000afebb3
- (id)dictionaryRepresentation;	// IMP=0x0000000000afe16e
- (id)description;	// IMP=0x0000000000afe0bf
- (id)initWithData:(id)arg1;	// IMP=0x0000000000afcca5
- (id)init;	// IMP=0x0000000000afcc49
