...
- (void).cxx_destruct;	// IMP=0x000000000061fef2
- (unsigned long long)hash;	// IMP=0x000000000061fc68
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000061f9ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000061f6a2
- (void)writeTo:(id)arg1;	// IMP=0x000000000061f379
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000061f36a
- (id)jsonRepresentation;	// IMP=0x000000000061e75c
- (id)dictionaryRepresentation;	// IMP=0x000000000061de35
- (id)description;	// IMP=0x000000000061dd86
- (void)dealloc;	// IMP=0x000000000061c87b
- (id)initWithData:(id)arg1;	// IMP=0x000000000061c81f
- (id)init;	// IMP=0x000000000061c7c3
