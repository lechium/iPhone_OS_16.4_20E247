...
- (void).cxx_destruct;	// IMP=0x000000000051a037
- (unsigned long long)hash;	// IMP=0x0000000000519ddc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005199c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005192f5
- (void)writeTo:(id)arg1;	// IMP=0x00000000005185b6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005185a7
- (id)jsonRepresentation;	// IMP=0x0000000000517bf6
- (id)dictionaryRepresentation;	// IMP=0x0000000000516d1e
- (id)description;	// IMP=0x0000000000516c6f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000514d1e
- (id)init;	// IMP=0x0000000000514cc2
