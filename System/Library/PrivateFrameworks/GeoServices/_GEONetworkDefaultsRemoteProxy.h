...
- (void).cxx_destruct;	// IMP=0x0000000000d59a7a
@property(nonatomic) __weak id <_GEONetworkDefaultsServerProxyDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateNetworkDefaultsWithReason:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d593e7
- (void)updateNetworkDefaults:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d593cd
- (void)_networkDefaultsDidChange;	// IMP=0x0000000000d592f3
- (void)dealloc;	// IMP=0x0000000000d592ba
- (id)init;	// IMP=0x0000000000d59176
