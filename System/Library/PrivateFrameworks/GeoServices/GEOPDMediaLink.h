...
- (void).cxx_destruct;	// IMP=0x0000000000c90d47
- (unsigned long long)hash;	// IMP=0x0000000000c90c57
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c90aba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c90721
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c903e7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c903d8
- (id)jsonRepresentation;	// IMP=0x0000000000c8fabc
- (id)dictionaryRepresentation;	// IMP=0x0000000000c8f4d5
- (id)description;	// IMP=0x0000000000c8f426
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8e3cc
- (id)init;	// IMP=0x0000000000c8e370
