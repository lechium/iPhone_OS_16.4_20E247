...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000eec110
- (id).cxx_construct;	// IMP=0x0000000000eec806
- (void).cxx_destruct;	// IMP=0x0000000000eec7af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000eec6a3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000eec118
