...
- (void).cxx_destruct;	// IMP=0x0000000000334612
...
- (id)initWithKey:(struct _GEOTileKey)arg1 data:(id)arg2 edition:(unsigned int)arg3 set:(unsigned int)arg4 provider:(unsigned int)arg5 etag:(id)arg6;	// IMP=0x00000000003344d7
