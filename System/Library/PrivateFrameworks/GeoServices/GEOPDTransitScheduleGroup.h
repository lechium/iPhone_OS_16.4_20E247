...
- (void).cxx_destruct;	// IMP=0x0000000000d3910f
- (unsigned long long)hash;	// IMP=0x0000000000d38fb8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d38d99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d38af7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d387fe
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d387ef
- (id)jsonRepresentation;	// IMP=0x0000000000d386dd
- (id)dictionaryRepresentation;	// IMP=0x0000000000d3819d
- (id)description;	// IMP=0x0000000000d380ee
- (void)dealloc;	// IMP=0x0000000000d36a1b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d369bf
- (id)init;	// IMP=0x0000000000d36963
