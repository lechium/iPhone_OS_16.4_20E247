...
- (void).cxx_destruct;	// IMP=0x00000000005448fa
- (unsigned long long)hash;	// IMP=0x00000000005447b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000054457c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005442bc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000543f92
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000543f83
- (id)jsonRepresentation;	// IMP=0x0000000000543c02
- (id)dictionaryRepresentation;	// IMP=0x000000000054349f
- (id)description;	// IMP=0x00000000005433f0
- (void)dealloc;	// IMP=0x0000000000542187
- (id)initWithData:(id)arg1;	// IMP=0x000000000054212b
- (id)init;	// IMP=0x00000000005420cf
