...
- (void).cxx_destruct;	// IMP=0x0000000000c371ca
- (unsigned long long)hash;	// IMP=0x0000000000c36d8e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c36ac3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c36543
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c35ecb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c35ebc
- (id)jsonRepresentation;	// IMP=0x0000000000c348b4
- (id)dictionaryRepresentation;	// IMP=0x0000000000c33e12
- (id)description;	// IMP=0x0000000000c33d63
- (void)dealloc;	// IMP=0x0000000000c31db2
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c31d56
- (id)init;	// IMP=0x0000000000c31cfa
