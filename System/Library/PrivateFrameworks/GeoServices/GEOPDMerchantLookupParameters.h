...
- (void).cxx_destruct;	// IMP=0x000000000058300f
- (unsigned long long)hash;	// IMP=0x0000000000582b70
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005826d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000582229
- (void)writeTo:(id)arg1;	// IMP=0x0000000000581c31
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000581c22
- (id)jsonRepresentation;	// IMP=0x00000000005818a1
- (id)dictionaryRepresentation;	// IMP=0x00000000005809cf
- (id)description;	// IMP=0x0000000000580920
- (id)initWithData:(id)arg1;	// IMP=0x000000000057eb99
- (id)init;	// IMP=0x000000000057eb3d
