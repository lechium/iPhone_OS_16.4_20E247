...
- (void).cxx_destruct;	// IMP=0x0000000000ac6e30
- (unsigned long long)hash;	// IMP=0x0000000000ac6d17
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac6b0e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ac6876
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ac65cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ac65c0
- (id)jsonRepresentation;	// IMP=0x0000000000ac6342
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac5d07
- (id)description;	// IMP=0x0000000000ac5c58
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ac52e5
- (id)init;	// IMP=0x0000000000ac5289
