...
- (id).cxx_construct;	// IMP=0x0000000000352905
- (void).cxx_destruct;	// IMP=0x00000000003528df
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000003528a0
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x0000000000352865
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003525c5
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x000000000035249b
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x00000000003523ac
