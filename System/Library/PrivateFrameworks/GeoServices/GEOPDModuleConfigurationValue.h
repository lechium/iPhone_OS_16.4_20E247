...
- (void).cxx_destruct;	// IMP=0x0000000000ca2ae5
- (unsigned long long)hash;	// IMP=0x0000000000ca29cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ca2782
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ca249b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ca21d7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ca21c8
- (id)jsonRepresentation;	// IMP=0x0000000000c9e1dd
- (id)dictionaryRepresentation;	// IMP=0x0000000000c9db1f
- (id)description;	// IMP=0x0000000000c9da70
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c9c3ab
- (id)init;	// IMP=0x0000000000c9c34f
