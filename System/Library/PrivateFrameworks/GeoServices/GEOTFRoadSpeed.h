...
- (void).cxx_destruct;	// IMP=0x000000000031ff0d
- (unsigned long long)hash;	// IMP=0x000000000031fa7f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000031f798
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000031f347
- (void)writeTo:(id)arg1;	// IMP=0x000000000031ee71
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000031ee62
- (id)jsonRepresentation;	// IMP=0x000000000031ebe4
- (id)dictionaryRepresentation;	// IMP=0x000000000031e2aa
- (id)description;	// IMP=0x000000000031e1fb
- (void)dealloc;	// IMP=0x000000000031ce3f
- (id)initWithData:(id)arg1;	// IMP=0x000000000031cde3
- (id)init;	// IMP=0x000000000031cd87
