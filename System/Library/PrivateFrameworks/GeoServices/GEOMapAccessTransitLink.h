...
- (id).cxx_construct;	// IMP=0x0000000000354270
- (void).cxx_destruct;	// IMP=0x0000000000354216
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x0000000000353fad
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x0000000000353adb
