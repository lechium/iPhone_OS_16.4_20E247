...
- (void).cxx_destruct;	// IMP=0x0000000000c2a588
- (unsigned long long)hash;	// IMP=0x0000000000c2a039
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c29e87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c29c13
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c29923
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c29914
- (id)jsonRepresentation;	// IMP=0x0000000000c2758a
- (id)dictionaryRepresentation;	// IMP=0x0000000000c27114
- (id)description;	// IMP=0x0000000000c27065
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c260cb
- (id)init;	// IMP=0x0000000000c2606f
- (id)locationName;	// IMP=0x0000000000a76ff1
- (id)categoryName;	// IMP=0x0000000000a76f76
