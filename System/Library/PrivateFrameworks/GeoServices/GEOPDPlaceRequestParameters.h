...
- (void).cxx_destruct;	// IMP=0x00000000005f9fb9
- (unsigned long long)hash;	// IMP=0x00000000005f9a04
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005f8f32
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005f85ac
- (void)writeTo:(id)arg1;	// IMP=0x00000000005f654d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005f653e
- (id)jsonRepresentation;	// IMP=0x00000000005e1ab8
- (id)dictionaryRepresentation;	// IMP=0x00000000005df555
- (id)description;	// IMP=0x00000000005df4a6
- (id)initWithData:(id)arg1;	// IMP=0x00000000005d7e90
- (id)init;	// IMP=0x00000000005d7e34
- (id)initWithSearchURLQuery:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4;	// IMP=0x00000000013df9f5
- (id)initWithSearchURLQuery:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 muid:(unsigned long long)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5;	// IMP=0x00000000013df910
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x00000000013df851
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 filters:(id)arg7 traits:(id)arg8 routeInfo:(id)arg9 error:(id *)arg10;	// IMP=0x00000000013df556
- (id)initWithBrandMUID:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x00000000013df3ea
- (id)initWithCanonicalLocationSearchQueryString:(id)arg1;	// IMP=0x00000000013df350
- (id)initWithVendorSpecificPlaceRefinementParameters:(id)arg1 traits:(id)arg2;	// IMP=0x00000000013df2d9
- (id)initWithPlaceRefinementParameters:(id)arg1 traits:(id)arg2;	// IMP=0x00000000013df262
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 traits:(id)arg3;	// IMP=0x00000000013df1ac
- (id)initWithMapItemToRefine:(id)arg1 traits:(id)arg2;	// IMP=0x00000000013df12f
- (id)initWithForwardGeocodeAddressString:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3;	// IMP=0x00000000013df066
- (id)initWithForwardGeocodeAddress:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3;	// IMP=0x00000000013def9d
- (id)initWithBatchReverseGeocodeLocations:(id)arg1 additionalPlaceTypes:(int *)arg2 additionalPlaceTypesCount:(unsigned long long)arg3 traits:(id)arg4;	// IMP=0x00000000013deea3
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1 preserveOriginalLocation:(_Bool)arg2;	// IMP=0x00000000013dee8c
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1;	// IMP=0x00000000013dee78
- (id)initWithReverseGeocodeLocation:(id)arg1 preserveOriginalLocation:(_Bool)arg2 placeTypeLimit:(int)arg3;	// IMP=0x00000000013ded7b
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1 preserveOriginalLocation:(_Bool)arg2 floorOrdinal:(int)arg3;	// IMP=0x00000000013dec83
- (id)initWithExternalTransitStationCodes:(id)arg1 sourceID:(id)arg2 transactionDate:(id)arg3 transactionLocation:(id)arg4;	// IMP=0x00000000013de9f2
- (id)initWithAirportCode:(id)arg1 terminalCode:(id)arg2 gateCode:(id)arg3 traits:(id)arg4;	// IMP=0x00000000013de913
- (id)initWithMerchantCode:(id)arg1 rawMerchantCode:(id)arg2 relyingPartyIdentifier:(id)arg3 industryCategory:(id)arg4 industryCode:(id)arg5 paymentNetwork:(id)arg6 transactionDate:(id)arg7 transactionLocation:(id)arg8 terminalId:(id)arg9 transactionCurrencyCode:(id)arg10 transactionType:(int)arg11 transactionId:(id)arg12 warsawMerchantDomain:(id)arg13 warsawMerchantName:(id)arg14 warsawMerchantId:(id)arg15 adamId:(id)arg16 merchantId:(id)arg17 merchantDoingBizAsName:(id)arg18 merchantEnhancedName:(id)arg19 merchantCity:(id)arg20 merchantRawCity:(id)arg21 merchantState:(id)arg22 merchantRawState:(id)arg23 merchantZip:(id)arg24 merchantAddress:(id)arg25 merchantRawAddress:(id)arg26 merchantCountryCode:(id)arg27 merchantType:(id)arg28 merchantCleanConfidenceLevel:(id)arg29 merchantAdditionalData:(id)arg30 merchantCanl:(id)arg31 brandFallbackSupported:(_Bool)arg32 isSettlement:(_Bool)arg33 isRefund:(_Bool)arg34 fuzzyMatched:(id)arg35 coarseLocationUsed:(id)arg36;	// IMP=0x00000000013ddc05
- (id)initWithExternalBusinessID:(id)arg1 contentProvider:(id)arg2;	// IMP=0x00000000013ddb46
- (id)initWithIdentifiers:(id)arg1 resultProviderID:(int)arg2;	// IMP=0x00000000013dda9e
- (void)clearLocations;	// IMP=0x000000000140d5a6
