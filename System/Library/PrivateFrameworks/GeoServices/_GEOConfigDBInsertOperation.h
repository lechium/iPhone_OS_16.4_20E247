...
- (void).cxx_destruct;	// IMP=0x000000000029a733
- (_Bool)performOperation;	// IMP=0x000000000029a68c
- (id)init:(id)arg1 rowId:(long long)arg2 type:(id)arg3 key:(id)arg4 value:(id)arg5 parentId:(long long)arg6;	// IMP=0x000000000029a57b
