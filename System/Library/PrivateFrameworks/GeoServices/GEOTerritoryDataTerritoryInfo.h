...
- (void).cxx_destruct;	// IMP=0x0000000000db53d2
- (unsigned long long)hash;	// IMP=0x0000000000db52e7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000db5136
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000db4ef3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000db4c2c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000db4c1f
- (id)jsonRepresentation;	// IMP=0x0000000000db49af
- (id)dictionaryRepresentation;	// IMP=0x0000000000db44c3
- (id)description;	// IMP=0x0000000000db4414
- (void)dealloc;	// IMP=0x0000000000db3345
- (id)initWithData:(id)arg1;	// IMP=0x0000000000db32e9
- (id)init;	// IMP=0x0000000000db328d
