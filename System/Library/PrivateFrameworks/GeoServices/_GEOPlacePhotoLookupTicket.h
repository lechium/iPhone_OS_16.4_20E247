...
- (void).cxx_destruct;	// IMP=0x0000000000773586
- (void)cancel;	// IMP=0x0000000000773500
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x0000000000773233
- (id)initWithVendorIdentifier:(id)arg1 mapItemIdentifier:(id)arg2 range:(struct _NSRange)arg3 traits:(id)arg4;	// IMP=0x00000000007730f0
