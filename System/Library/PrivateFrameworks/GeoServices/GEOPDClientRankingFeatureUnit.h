...
- (void).cxx_destruct;	// IMP=0x00000000006867dd
- (unsigned long long)hash;	// IMP=0x00000000006866ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000686547
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006862d9
- (void)writeTo:(id)arg1;	// IMP=0x00000000006860b3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006860a4
- (id)jsonRepresentation;	// IMP=0x0000000000685d23
- (id)dictionaryRepresentation;	// IMP=0x000000000068588b
- (id)description;	// IMP=0x00000000006857dc
- (id)initWithData:(id)arg1;	// IMP=0x00000000006849a6
- (id)init;	// IMP=0x000000000068494a
