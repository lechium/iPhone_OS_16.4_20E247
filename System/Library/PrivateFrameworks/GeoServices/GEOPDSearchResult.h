...
- (void).cxx_destruct;	// IMP=0x000000000063144c
- (unsigned long long)hash;	// IMP=0x00000000006310bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000630ac3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000062fda8
- (void)writeTo:(id)arg1;	// IMP=0x000000000062f2dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000062f2ce
- (id)jsonRepresentation;	// IMP=0x000000000062f1bc
- (id)dictionaryRepresentation;	// IMP=0x000000000062d4f2
- (id)description;	// IMP=0x000000000062d443
- (id)initWithData:(id)arg1;	// IMP=0x000000000062939f
- (id)init;	// IMP=0x0000000000629343
