...
- (void).cxx_destruct;	// IMP=0x00000000006cc530
- (unsigned long long)hash;	// IMP=0x00000000006cc458
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006cc2ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006cbad5
- (void)writeTo:(id)arg1;	// IMP=0x00000000006cb29a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006cb28d
- (id)jsonRepresentation;	// IMP=0x00000000006cb01d
- (id)dictionaryRepresentation;	// IMP=0x00000000006ca6cc
- (id)description;	// IMP=0x00000000006ca61d
- (id)initWithData:(id)arg1;	// IMP=0x00000000006c9164
- (id)init;	// IMP=0x00000000006c9108
