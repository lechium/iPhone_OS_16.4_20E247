...
- (void).cxx_destruct;	// IMP=0x0000000001056f53
- (unsigned long long)hash;	// IMP=0x0000000001056e49
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001056c32
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001056760
- (void)writeTo:(id)arg1;	// IMP=0x0000000001056295
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001056286
- (id)jsonRepresentation;	// IMP=0x0000000001055f05
- (id)dictionaryRepresentation;	// IMP=0x00000000010554bf
- (id)description;	// IMP=0x0000000001055410
- (void)dealloc;	// IMP=0x0000000001054212
- (id)initWithData:(id)arg1;	// IMP=0x00000000010541b6
- (id)init;	// IMP=0x000000000105415a
