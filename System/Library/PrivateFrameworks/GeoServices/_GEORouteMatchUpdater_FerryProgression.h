...
- (void).cxx_destruct;	// IMP=0x0000000001204ec2
- (unsigned long long)priority;	// IMP=0x0000000001204eb7
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x0000000001204cb0
- (id)initWithRoute:(id)arg1 tripSegment:(id)arg2;	// IMP=0x0000000001204ae6
