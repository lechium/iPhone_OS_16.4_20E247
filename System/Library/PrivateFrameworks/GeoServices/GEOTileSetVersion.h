...
- (void).cxx_destruct;	// IMP=0x0000000001400b57
- (unsigned long long)hash;	// IMP=0x0000000001400a80
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001400920
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014006ef
- (void)writeTo:(id)arg1;	// IMP=0x00000000014003d2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014003c3
- (id)jsonRepresentation;	// IMP=0x00000000014002b1
- (id)dictionaryRepresentation;	// IMP=0x00000000013ffd5c
- (id)description;	// IMP=0x00000000013ffcad
- (void)dealloc;	// IMP=0x00000000013fee8e
- (id)initWithData:(id)arg1;	// IMP=0x00000000013fee32
- (id)init;	// IMP=0x00000000013fedd6
