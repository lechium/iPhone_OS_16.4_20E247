...
- (void).cxx_destruct;	// IMP=0x0000000000e97292
- (unsigned long long)hash;	// IMP=0x0000000000e96e91
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e96afe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e96605
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e9615b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e9614c
- (id)jsonRepresentation;	// IMP=0x0000000000e9413c
- (id)dictionaryRepresentation;	// IMP=0x0000000000e937ac
- (id)description;	// IMP=0x0000000000e936fd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e919a0
- (id)init;	// IMP=0x0000000000e91944
