...
+ (id)placeInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a70150
- (void).cxx_destruct;	// IMP=0x0000000000ccfd48
- (unsigned long long)hash;	// IMP=0x0000000000ccfb5b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ccf92d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ccf66c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ccf3fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ccf3ec
- (id)jsonRepresentation;	// IMP=0x0000000000cceafe
- (id)dictionaryRepresentation;	// IMP=0x0000000000cce4fa
- (id)description;	// IMP=0x0000000000cce44b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ccd41f
- (id)init;	// IMP=0x0000000000ccd3c3
