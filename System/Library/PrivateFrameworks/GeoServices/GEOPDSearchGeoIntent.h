...
- (void).cxx_destruct;	// IMP=0x0000000000adaa30
- (unsigned long long)hash;	// IMP=0x0000000000ada8b5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ada604
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ada2c8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ad9fbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ad9fae
- (id)jsonRepresentation;	// IMP=0x0000000000ad9d30
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad946d
- (id)description;	// IMP=0x0000000000ad93be
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ad84f1
- (id)init;	// IMP=0x0000000000ad8495
