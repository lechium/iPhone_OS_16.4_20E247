...
- (void).cxx_destruct;	// IMP=0x0000000001241011
...
- (id)description;	// IMP=0x0000000001240eb1
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outCoordinateOnSegment:(CDStruct_c3b9c2ee *)arg2 outRouteCoordinate:(struct PolylineCoordinate *)arg3;	// IMP=0x0000000001240d3c
