...
- (void).cxx_destruct;	// IMP=0x0000000000b36042
- (unsigned long long)hash;	// IMP=0x0000000000b35884
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b35486
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b34f9d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b34afd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b34aee
- (id)jsonRepresentation;	// IMP=0x0000000000b34adf
- (id)dictionaryRepresentation;	// IMP=0x0000000000b34047
- (id)description;	// IMP=0x0000000000b33f98
- (void)dealloc;	// IMP=0x0000000000b32e0c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b32db0
- (id)init;	// IMP=0x0000000000b32d54
