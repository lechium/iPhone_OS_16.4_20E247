...
- (void).cxx_destruct;	// IMP=0x0000000001223a5f
...
- (id)initWithCoordinate:(CDStruct_071ac149)arg1 angle:(double)arg2 road:(id)arg3 startCoordinate:(CDStruct_071ac149)arg4 endCoordinate:(CDStruct_071ac149)arg5;	// IMP=0x0000000001223550
