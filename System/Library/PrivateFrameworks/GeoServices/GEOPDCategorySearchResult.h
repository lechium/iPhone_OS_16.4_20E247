...
- (void).cxx_destruct;	// IMP=0x000000000053995d
- (unsigned long long)hash;	// IMP=0x00000000005396c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000539299
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000538987
- (void)writeTo:(id)arg1;	// IMP=0x0000000000537da1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000537d92
- (id)jsonRepresentation;	// IMP=0x0000000000537289
- (id)dictionaryRepresentation;	// IMP=0x0000000000536059
- (id)description;	// IMP=0x0000000000535faa
- (id)initWithData:(id)arg1;	// IMP=0x000000000053311a
- (id)init;	// IMP=0x00000000005330be
