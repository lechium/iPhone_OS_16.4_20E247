...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x0010000000a642f0
+ (Class)_resourceLoaderClass;	// IMP=0x0010000000a642df
- (void).cxx_destruct;	// IMP=0x0000000000a67ed7
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x0000000000a66d05
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a66488
- (void)removeOldData:(id)arg1;	// IMP=0x0000000000a65b9e
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000000a656af
- (void)cancel;	// IMP=0x0000000000a65490
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000a64349
- (id)_resourcesDirectory;	// IMP=0x0000000000a64321
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x0000000000a64029
- (id)init;	// IMP=0x0000000000a63fff
