...
- (void).cxx_destruct;	// IMP=0x0000000000b1a865
- (unsigned long long)hash;	// IMP=0x0000000000b1a3fa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b19d4b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b194ff
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b18ca7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b18c98
- (id)jsonRepresentation;	// IMP=0x0000000000b0bcb3
- (id)dictionaryRepresentation;	// IMP=0x0000000000b09884
- (id)description;	// IMP=0x0000000000b097d5
- (void)dealloc;	// IMP=0x0000000000b06f21
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b06ec5
- (id)init;	// IMP=0x0000000000b06e69
