...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x002000000000f8d6
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x002000000000f864
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x002000000000f7f7
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x002000000000f785
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x0010000000008f1e
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x0010000000008eb9
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x0010000000008e97
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x0010000000008de5
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x0010000000008d33
...
- (id)nldaConfigFile;	// IMP=0x0010000000008b96
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x0010000000008a9c
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000011e9e
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000000eb35
@property(readonly, nonatomic) NSString *flexKwdThresholdFile;
@property(readonly, nonatomic) NSString *flexKwdConfigFile;
- (id)_sha256:(id)arg1;	// IMP=0x001000000005543b
- (id)_sha1:(id)arg1;	// IMP=0x001000000005534a
- (id)localeMapWithName:(id)arg1;	// IMP=0x00100000000551a1
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000005516d
- (id)remoraRTModelLocaleMap;	// IMP=0x0010000000055154
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000005513b
- (id)hearstRTModelLocaleMap;	// IMP=0x0010000000055122
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x0010000000055105
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x00100000000550e5
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x00100000000548c1
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x00100000000544f3
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000005448d
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x0010000000054459
...
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000880f8
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00100000000b4e78
