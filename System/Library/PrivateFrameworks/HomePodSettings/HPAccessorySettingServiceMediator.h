...
- (void).cxx_destruct;	// IMP=0x000000000000c38c
...
- (void)didUpdateHH2State:(_Bool)arg1;	// IMP=0x000000000000c1ef
- (void)notifyDidUpdateSetting:(id)arg1 forKeyPath:(id)arg2;	// IMP=0x000000000000c169
- (id)initWithInterface:(id)arg1;	// IMP=0x000000000000c105
