...
- (void).cxx_destruct;	// IMP=0x0000000000684520
- (id)init;	// IMP=0x0000000000684420
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000684390
