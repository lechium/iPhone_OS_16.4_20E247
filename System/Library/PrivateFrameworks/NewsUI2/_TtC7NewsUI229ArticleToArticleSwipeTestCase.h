...
- (void).cxx_destruct;	// IMP=0x0000000000c3a370
- (id)init;	// IMP=0x0000000000c3a270
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c3a1e0
