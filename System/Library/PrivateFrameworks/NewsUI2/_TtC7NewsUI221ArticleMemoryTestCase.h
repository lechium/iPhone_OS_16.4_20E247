...
- (void).cxx_destruct;	// IMP=0x00000000003a94e0
- (id)init;	// IMP=0x00000000003a93e0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003a9220
