...
- (void).cxx_destruct;	// IMP=0x00000000009f40e0
- (id)init;	// IMP=0x00000000009f4080
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000009f3f30
