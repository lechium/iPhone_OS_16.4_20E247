...
- (void).cxx_destruct;	// IMP=0x0000000000a0dd90
- (id)init;	// IMP=0x0000000000a0dc90
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a0dc00
