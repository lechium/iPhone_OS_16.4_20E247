...
- (void).cxx_destruct;	// IMP=0x0000000000bab9c0
- (id)init;	// IMP=0x0000000000bab8c0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bab830
