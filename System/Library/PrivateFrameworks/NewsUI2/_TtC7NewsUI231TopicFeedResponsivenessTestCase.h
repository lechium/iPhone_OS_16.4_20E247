...
- (void).cxx_destruct;	// IMP=0x000000000098b150
- (id)init;	// IMP=0x000000000098b050
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000098afc0
