...
- (void).cxx_destruct;	// IMP=0x000000000085be90
- (id)init;	// IMP=0x000000000085bd90
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000085bd00
