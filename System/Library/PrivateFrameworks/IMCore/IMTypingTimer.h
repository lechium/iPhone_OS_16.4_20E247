...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x00600000000694b0
- (void).cxx_destruct;	// IMP=0x00000000000698b2
...
- (void)invalidate;	// IMP=0x00000000000697b3
- (void)triggerTimeout;	// IMP=0x0000000000069716
- (void)timerCallback;	// IMP=0x0000000000069681
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x00000000000694b8
