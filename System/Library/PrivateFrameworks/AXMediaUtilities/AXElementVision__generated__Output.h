...
- (void).cxx_destruct;	// IMP=0x000000000002710b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000002703c
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithConfidence:(id)arg1 coordinates:(id)arg2;	// IMP=0x0000000000026faa
