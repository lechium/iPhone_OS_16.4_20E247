...
- (void).cxx_destruct;	// IMP=0x00000000000acacd
...
- (void)clearFilters;	// IMP=0x00000000000ac97b
- (void)addFilter:(id)arg1;	// IMP=0x00000000000ac61c
- (void)_updateReplyLineColor;	// IMP=0x00000000000ac509
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000ac457
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000ac3c3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ac2c8
