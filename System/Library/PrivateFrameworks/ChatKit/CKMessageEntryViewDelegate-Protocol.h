...
@class CKMediaObject, CKMessageEntryView, IMPluginPayload, NSArray, UITextView, UIWindow;
...
- (void)messageEntryView:(CKMessageEntryView *)arg1 shouldShowAppsWithItems:(NSArray *)arg2;
