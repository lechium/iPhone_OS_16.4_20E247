...
- (void).cxx_destruct;	// IMP=0x000000000049ebfa
...
- (void)_loadCachedPayloadIntoBrowser;	// IMP=0x000000000049e9e8
- (void)_doInitialization;	// IMP=0x000000000049e497
- (void)_flushHandwritingWindowCacheIfNeeded;	// IMP=0x000000000049e381
- (void)_updateVisibilityState;	// IMP=0x000000000049d417
- (void)_handleApplicationDidEnterBackground:(id)arg1;	// IMP=0x000000000049d3e7
- (void)_handleApplicationWillEnterForeground:(id)arg1;	// IMP=0x000000000049d3d0
- (_Bool)isHandwritingLandscape;	// IMP=0x000000000049d354
@property(readonly) NSString *pluginBundleID;
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000049d2af
...
- (void)dealloc;	// IMP=0x000000000049d01b
- (id)init;	// IMP=0x000000000049ced6
