...
- (void).cxx_destruct;	// IMP=0x000000000030fe07
...
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x000000000030fb4b
@property(readonly, nonatomic) double aspectRatio;
- (struct CGSize)size;	// IMP=0x000000000030fabd
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x000000000030fa96
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030f837
@property(readonly, nonatomic) _Bool isInSharedLibrary;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x000000000030f795
...
- (id)initWithMomentShare:(id)arg1;	// IMP=0x000000000030f5b8
- (id)init;	// IMP=0x000000000030f5af
