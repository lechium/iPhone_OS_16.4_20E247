...
- (void).cxx_destruct;	// IMP=0x000000000047a3ba
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000047a236
- (id)createAvatarCutOutView;	// IMP=0x000000000047a0f6
- (void)addConstraints;	// IMP=0x0000000000479319
- (id)initWithSize:(struct CGSize)arg1 avatarViews:(id)arg2;	// IMP=0x0000000000478e20
