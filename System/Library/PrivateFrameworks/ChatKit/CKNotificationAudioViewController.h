...
- (void).cxx_destruct;	// IMP=0x000000000015c13f
@property(nonatomic) __weak NSObject<CKNotificationAudioViewControllerDelegate> *delegate; // @synthesize delegate=_delegate;
- (void)_audioMessageToggled;	// IMP=0x000000000015c070
- (void)buttonTapped:(id)arg1;	// IMP=0x000000000015c05e
- (void)playOrPauseAudioMessage;	// IMP=0x000000000015c04c
- (void)loadMessage:(id)arg1;	// IMP=0x000000000015be66
