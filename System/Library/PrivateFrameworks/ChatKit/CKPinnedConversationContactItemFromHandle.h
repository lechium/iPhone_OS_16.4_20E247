...
- (void).cxx_destruct;	// IMP=0x00000000003b1f9c
...
- (id)contactItemView;	// IMP=0x00000000003b1e53
- (id)cnContactWithKeys:(id)arg1;	// IMP=0x00000000003b1e3d
@property(readonly, nonatomic) NSString *contactItemIdentifier;
- (id)initWithEntity:(id)arg1;	// IMP=0x00000000003b1dbc
