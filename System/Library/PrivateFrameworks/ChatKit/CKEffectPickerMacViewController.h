...
- (void).cxx_destruct;	// IMP=0x000000000030a78c
...
- (void)startAnimationPreviewForIdentifier:(id)arg1;	// IMP=0x000000000030a18b
- (id)_defaultSendAnimationContextForAnimationPreview;	// IMP=0x000000000030a141
- (void)handleTouchMoved:(struct CGPoint)arg1;	// IMP=0x000000000030a13b
- (void)handleTouchUp:(struct CGPoint)arg1;	// IMP=0x000000000030a135
- (void)updateHintTransition:(double)arg1;	// IMP=0x000000000030a12f
- (void)updateColor:(BOOL)arg1;	// IMP=0x000000000030a129
- (void)setCloseButtonYPosition:(double)arg1;	// IMP=0x000000000030a123
- (void)presentPicker;	// IMP=0x000000000030a11d
- (void)effectCollectionViewController:(id)arg1 willDisplayEffect:(id)arg2;	// IMP=0x000000000030a117
- (_Bool)effectShouldDisplayOverBalloon:(id)arg1;	// IMP=0x000000000030a03e
- (void)effectSelectionViewController:(id)arg1 didSelectEffectWithIdentifier:(id)arg2;	// IMP=0x0000000000309978
- (void)closeButtonPressed:(id)arg1;	// IMP=0x000000000030992c
- (void)touchUpInsideSendButton:(id)arg1;	// IMP=0x0000000000309893
- (void)keyCommandReturn:(id)arg1;	// IMP=0x000000000030987e
- (id)keyCommands;	// IMP=0x0000000000309791
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000003096f0
- (void)viewDidLoad;	// IMP=0x0000000000307e95
- (id)initWithComposition:(id)arg1 balloonViewOrigin:(struct CGPoint)arg2 color:(BOOL)arg3;	// IMP=0x0000000000307db1
