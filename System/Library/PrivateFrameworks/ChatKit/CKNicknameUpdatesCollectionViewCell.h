...
+ (id)reuseIdentifier;	// IMP=0x0010000000115b35
+ (void)setRecalculateUsesStackedButtonLayout:(_Bool)arg1;	// IMP=0x0010000000115b29
+ (_Bool)recalculateUsesStackedButtonLayout;	// IMP=0x0010000000115b1d
+ (void)setUsesStackedButtonLayout:(_Bool)arg1;	// IMP=0x0010000000115b11
+ (_Bool)usesStackedButtonLayout;	// IMP=0x0010000000115b05
- (void).cxx_destruct;	// IMP=0x00000000001187e4
...
- (void)_ignoreButtonTapped:(id)arg1;	// IMP=0x0000000000118584
- (void)_updateButtonTapped:(id)arg1;	// IMP=0x000000000011850e
- (void)updateInterfaceSelectedAction:(unsigned long long)arg1;	// IMP=0x000000000011848e
- (void)updateSeparatorsForOrder:(unsigned long long)arg1;	// IMP=0x0000000000118337
- (void)configureWithNicknameUpdate:(id)arg1 order:(unsigned long long)arg2;	// IMP=0x0000000000117e7a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000115b42
