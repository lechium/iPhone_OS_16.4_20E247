...
- (void).cxx_destruct;	// IMP=0x00000000002ef33a
...
- (void)_checkForCover:(id)arg1;	// IMP=0x00000000002ef12a
- (void)recordTouchAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000002eee03
- (void)reset;	// IMP=0x00000000002eecd7
- (void)dealloc;	// IMP=0x00000000002eeb4d
- (id)initWithSize:(struct CGSize)arg1 touchLifetime:(double)arg2;	// IMP=0x00000000002eeade
