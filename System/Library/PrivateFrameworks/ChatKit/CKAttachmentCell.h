...
- (void).cxx_destruct;	// IMP=0x00000000000a468c
...
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000a44fa
- (void)animationTimerFired:(unsigned long long)arg1;	// IMP=0x00000000000a4467
- (void)updateAnimationTimerObserving;	// IMP=0x00000000000a43c9
- (struct CGImage *)_cgImageForUIImage:(id)arg1;	// IMP=0x00000000000a4326
@property(retain, nonatomic) UIImage *iconImage;
- (void)saveAttachment:(id)arg1;	// IMP=0x00000000000a3e56
- (void)more:(id)arg1;	// IMP=0x00000000000a3e05
- (void)delete:(id)arg1;	// IMP=0x00000000000a3db4
- (void)copy:(id)arg1;	// IMP=0x00000000000a3d63
- (void)tapGestureRecognized:(id)arg1;	// IMP=0x00000000000a3d17
- (void)prepareForReuse;	// IMP=0x00000000000a3c60
- (void)layoutSubviews;	// IMP=0x00000000000a3849
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000000a366b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a34ee
- (void)dealloc;	// IMP=0x00000000000a346d
