...
+ (id)placeholderImage;	// IMP=0x0010000000310098
+ (id)sharedInstance;	// IMP=0x001000000030fe2f
- (void).cxx_destruct;	// IMP=0x000000000031028f
@property(readonly, nonatomic) float audioScore; // @synthesize audioScore=_audioScore;
@property(readonly, nonatomic) double aspectRatio;
- (struct CGSize)size;	// IMP=0x00000000003101f6
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x000000000031014c
@property(readonly, nonatomic) UIImage *placeholderImage;
@property(readonly, nonatomic) NSString *uuid;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000310080
@property(readonly, nonatomic) _Bool isInSharedLibrary;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000310025
...
- (id)init;	// IMP=0x000000000030fe84
