...
- (void).cxx_destruct;	// IMP=0x000000000037c419
...
- (void)configureForEffectIsDark:(_Bool)arg1;	// IMP=0x000000000037c2af
- (void)setTitle:(id)arg1;	// IMP=0x000000000037c146
- (void)setImage:(id)arg1;	// IMP=0x000000000037c0d4
- (void)layoutSubviews;	// IMP=0x000000000037be7e
- (_Bool)canBecomeFirstResponder;	// IMP=0x000000000037be76
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000037bd5d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000037ac66
