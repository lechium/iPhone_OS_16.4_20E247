...
+ (id)reuseIdentifier;	// IMP=0x00400000003d84c6
+ (id)itemIdentifier;	// IMP=0x00400000003d84b9
- (void).cxx_destruct;	// IMP=0x00000000003d8648
...
- (void)_focusFilterToggleButtonSelected:(id)arg1;	// IMP=0x00000000003d8461
- (void)contentSizeCategoryDidChange;	// IMP=0x00000000003d8419
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000003d83d8
- (void)_updateFilterToggleButtonConfiguration;	// IMP=0x00000000003d829c
- (void)_updateSizeClassDependentConstraints;	// IMP=0x00000000003d7a38
- (void)_updateKeylineAlignmentConstraints;	// IMP=0x00000000003d7713
- (void)_updateKeylineHeightConstraints;	// IMP=0x00000000003d763d
- (void)_updateTitle;	// IMP=0x00000000003d70db
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003d6929
