...
- (void).cxx_destruct;	// IMP=0x0000000000543e87
...
- (void)_notNowButtonPressed;	// IMP=0x0000000000543d2c
- (void)_acceptButtonPressed;	// IMP=0x0000000000543bb4
- (void)_messageButtonPressed;	// IMP=0x0000000000543aea
- (void)addButtonsToTray;	// IMP=0x00000000005436fd
- (void)configureSecondReceiveScreen;	// IMP=0x0000000000543478
- (void)configureSecondSendScreen;	// IMP=0x00000000005431f3
- (id)initSecondReceivingEDUScreenWithItemIndexPath:(id)arg1;	// IMP=0x00000000005430b6
- (id)initSecondSendingEDUScreenWithComposition:(id)arg1 withSensitiveMediaObjects:(id)arg2 withIdentifiersOfShelvedImages:(id)arg3;	// IMP=0x0000000000542ef7
