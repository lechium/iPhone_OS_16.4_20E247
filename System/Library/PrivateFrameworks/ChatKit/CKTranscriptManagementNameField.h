...
+ (double)preferredHeight;	// IMP=0x00100000000a1554
- (void).cxx_destruct;	// IMP=0x00000000000a2624
...
- (void)commitGroupName;	// IMP=0x00000000000a24e1
@property(copy, nonatomic) NSString *groupName;
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000000000a203b
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x00000000000a2023
- (void)layoutMarginsDidChange;	// IMP=0x00000000000a2011
- (void)layoutSubviews;	// IMP=0x00000000000a1b69
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a15a4
- (void)dealloc;	// IMP=0x00000000000a1562
