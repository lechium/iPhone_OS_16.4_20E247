...
- (void).cxx_destruct;	// IMP=0x000000000015c7f7
...
- (void)updateBackgroundVisualEffect;	// IMP=0x000000000015c6b8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015c582
