...
- (void).cxx_destruct;	// IMP=0x00000000004fe675
...
- (void)stopAnimation;	// IMP=0x00000000004fe55b
- (void)startAnimation;	// IMP=0x00000000004fe2cb
- (void)bannerPressed:(id)arg1;	// IMP=0x00000000004fe103
- (void)layoutSubviews;	// IMP=0x00000000004fdebb
- (id)init;	// IMP=0x00000000004fce49
