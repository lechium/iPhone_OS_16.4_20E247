...
+ (id)reuseIdentifier;	// IMP=0x00100000002ae424
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000002ae44c
- (void)forceUnreadIndicatorVisibility:(_Bool)arg1 forConversation:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000002ae446
- (id)avatarView;	// IMP=0x00000000002ae43e
- (_Bool)avatarView:(id)arg1 shouldShowContact:(id)arg2;	// IMP=0x00000000002ae436
