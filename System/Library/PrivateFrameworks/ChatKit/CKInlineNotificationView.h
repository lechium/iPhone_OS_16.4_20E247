...
- (void).cxx_destruct;	// IMP=0x000000000009a705
...
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000009a428
@property(nonatomic) _Bool visible;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000009a3ab
- (void)layoutSubviews;	// IMP=0x0000000000099ffb
- (void)dealloc;	// IMP=0x0000000000099f86
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000099d39
- (void)_invalidateContentViewHeight;	// IMP=0x000000000009a779
@property(readonly, nonatomic) _Bool _shouldSuppressLayout;
- (struct CGSize)contentViewSizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000009a871
