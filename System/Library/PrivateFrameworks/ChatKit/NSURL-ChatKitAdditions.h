...
+ (id)ckSMSURLFromBusinessChatURL:(id)arg1;	// IMP=0x002000000016a30c
+ (id)ckURLForChatIdentifier:(id)arg1 entryBody:(id)arg2;	// IMP=0x002000000016a2f3
+ (id)ckURLForResource:(id)arg1 withExtension:(id)arg2;	// IMP=0x002000000016a23b
+ (id)__ck_appleMapsURLForCoordinate:(struct CLLocationCoordinate2D)arg1 coordinateName:(id)arg2;	// IMP=0x00200000001c5c3b
...
- (_Bool)ckIsSMSPrivateURLScheme;	// IMP=0x001000000016a9c8
...
- (id)ckWillNotLaunchComposeUIURL;	// IMP=0x001000000016a575
@end
