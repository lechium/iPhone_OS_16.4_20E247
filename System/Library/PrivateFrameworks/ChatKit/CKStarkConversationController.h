...
- (void).cxx_destruct;	// IMP=0x000000000012aa1b
...
- (void)_resortAndReloadData;	// IMP=0x000000000012a5c6
- (void)conversationListDidChange:(id)arg1;	// IMP=0x000000000012a5b4
- (void)templateWillAppear:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000012a5a2
- (id)initWithInterfaceController:(id)arg1;	// IMP=0x000000000012a2f9
