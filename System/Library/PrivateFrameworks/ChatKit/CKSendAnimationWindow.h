...
- (void).cxx_destruct;	// IMP=0x00000000000a53fd
...
- (_Bool)_canAffectStatusBarAppearance;	// IMP=0x00000000000a53d0
- (id)initWithWindowScene:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x00000000000a529f
