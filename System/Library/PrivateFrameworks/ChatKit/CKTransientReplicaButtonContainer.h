...
- (void).cxx_destruct;	// IMP=0x000000000046024c
...
- (id)_glyphLayerForButtonAnimationWithImage:(id)arg1;	// IMP=0x00000000004600eb
- (id)_invertedCircularFillGlyph:(id)arg1;	// IMP=0x000000000045fe07
- (id)initWithFrame:(struct CGRect)arg1 hasDarkVibrancy:(_Bool)arg2 isInDarkMode:(_Bool)arg3 color:(id)arg4 sendColor:(BOOL)arg5;	// IMP=0x000000000045f819
