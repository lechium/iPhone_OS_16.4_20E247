...
+ (id)sharedCryptographer;	// IMP=0x006000000011a634
- (void).cxx_destruct;	// IMP=0x000000000011adb8
...
- (id)stringDigestForName:(id)arg1;	// IMP=0x000000000011aa37
@property(readonly, nonatomic) NSData *deviceSalt;
- (void)prewarmDeviceSalt;	// IMP=0x000000000011a6e1
- (id)init;	// IMP=0x000000000011a689
