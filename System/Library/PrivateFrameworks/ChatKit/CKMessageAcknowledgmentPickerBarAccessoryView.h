...
- (void).cxx_destruct;	// IMP=0x00000000004830a0
...
- (struct CGPoint)attachmentOffsetWithReferenceFrame:(struct CGRect)arg1;	// IMP=0x0000000000482d9b
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000482d0b
- (id)initWithChatItem:(id)arg1 layoutBounds:(struct CGRect)arg2;	// IMP=0x0000000000482ac6
