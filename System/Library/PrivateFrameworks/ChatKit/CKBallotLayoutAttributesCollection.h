...
- (void).cxx_destruct;	// IMP=0x000000000048e94b
...
- (void)_applyAlphaToAllAttributesAlpha:(double)arg1;	// IMP=0x000000000048e6cc
- (void)_setContainerAttributes:(id)arg1 forLayoutMode:(unsigned long long)arg2;	// IMP=0x000000000048d3d9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000048d286
