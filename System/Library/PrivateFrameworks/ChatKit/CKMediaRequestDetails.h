...
- (void).cxx_destruct;	// IMP=0x000000000050259a
...
- (id)initWithRequestID:(long long)arg1 transferGUID:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005024d0
