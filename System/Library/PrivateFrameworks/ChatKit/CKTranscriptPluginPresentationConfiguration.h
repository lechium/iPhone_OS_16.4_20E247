...
- (void).cxx_destruct;	// IMP=0x00000000003ad840
...
- (id)initWithSourceView:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 shouldDisableSnapshotView:(_Bool)arg3;	// IMP=0x00000000003ad79d
