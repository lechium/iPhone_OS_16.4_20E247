...
- (void).cxx_destruct;	// IMP=0x000000000000aabf
...
- (void)layoutSubviews;	// IMP=0x0000000000009fc1
@property(retain, nonatomic) NSString *subheadingText;
@property(retain, nonatomic) NSString *mainText;
- (void)prepareForReuse;	// IMP=0x0000000000009d3d
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000099a1
