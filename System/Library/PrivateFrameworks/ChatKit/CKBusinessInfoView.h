...
- (void).cxx_destruct;	// IMP=0x00000000003cac99
...
- (void)infoButtonTapped:(id)arg1;	// IMP=0x00000000003caa13
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003ca65a
- (void)layoutSubviews;	// IMP=0x00000000003c9c87
- (void)setup;	// IMP=0x00000000003c980b
- (id)initWithLayoutType:(long long)arg1;	// IMP=0x00000000003c97ad
