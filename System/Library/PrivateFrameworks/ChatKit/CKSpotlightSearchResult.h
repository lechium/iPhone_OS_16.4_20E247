...
- (void).cxx_destruct;	// IMP=0x00000000003d52a9
...
- (long long)compare:(id)arg1;	// IMP=0x00000000003d5155
- (id)initWithMessageGUID:(id)arg1 chatGUID:(id)arg2 messageTime:(id)arg3 summery:(id)arg4;	// IMP=0x00000000003d5064
