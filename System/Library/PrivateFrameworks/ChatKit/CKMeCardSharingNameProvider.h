...
+ (id)nameContactForPrimaryAccount;	// IMP=0x00100000003b4f4a
+ (id)nameProviderForPrimaryAccount;	// IMP=0x00100000003b4ea9
+ (id)nameProviderForAccount:(id)arg1;	// IMP=0x00100000003b4d88
+ (id)nameProviderForNickname:(id)arg1;	// IMP=0x00100000003b4c95
+ (id)nameProviderForContact:(id)arg1;	// IMP=0x00100000003b4b44
- (void).cxx_destruct;	// IMP=0x00000000003b50b3
