...
+ (id)identifier;	// IMP=0x00400000002ce5ba
- (void).cxx_destruct;	// IMP=0x00000000002ce5d8
@property(retain, nonatomic) TPKContentView *tipKitContentView; // @synthesize tipKitContentView=_tipKitContentView;
- (void)prepareForReuse;	// IMP=0x00000000002ce2bb
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000002ce241
