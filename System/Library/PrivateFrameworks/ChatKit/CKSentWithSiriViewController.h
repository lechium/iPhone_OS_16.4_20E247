...
- (void).cxx_destruct;	// IMP=0x0000000000107a5e
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000001077f6
- (id)inputAccessoryViewController;	// IMP=0x00000000001077ee
- (_Bool)canBecomeFirstResponder;	// IMP=0x00000000001077e6
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000010776f
- (id)localizedStringWithLanguageCode:(id)arg1 format:(id)arg2;	// IMP=0x0000000000107614
- (id)_titleLabelText;	// IMP=0x0000000000107201
- (void)viewDidLoad;	// IMP=0x00000000001059d3
- (id)initWithConversation:(id)arg1;	// IMP=0x0000000000105965
