...
+ (id)reuseIdentifier;	// IMP=0x0060000000360bb5
...
- (void)layoutSubviews;	// IMP=0x00000000003611eb
- (id)formattedTitleFromPreviewTitle:(id)arg1;	// IMP=0x00000000003610c4
- (double)cornerRadius;	// IMP=0x0000000000360cd5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000360bc2
