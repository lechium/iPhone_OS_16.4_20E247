...
- (void).cxx_destruct;	// IMP=0x000000000033b339
...
- (void)animateTransition:(id)arg1;	// IMP=0x000000000033ad6b
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000033ad1b
- (id)initWithDirection:(_Bool)arg1;	// IMP=0x000000000033abdb
