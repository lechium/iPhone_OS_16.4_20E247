...
- (void).cxx_destruct;	// IMP=0x000000000000ea34
...
- (id)description;	// IMP=0x000000000000e94b
- (void)reset;	// IMP=0x000000000000e929
- (void)close;	// IMP=0x000000000000e8ff
- (void)dealloc;	// IMP=0x000000000000e8c1
