...
- (void).cxx_destruct;	// IMP=0x0000000000013c1f
...
- (void)updateOutput;	// IMP=0x0000000000013bba
- (void)invalidateOutput;	// IMP=0x0000000000013ba3
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013b13
- (void)setState:(long long)arg1;	// IMP=0x0000000000013a95
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000013a2a
- (id)init;	// IMP=0x0000000000013a16
