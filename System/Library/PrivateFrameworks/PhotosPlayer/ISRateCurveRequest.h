...
- (void).cxx_destruct;	// IMP=0x0000000000002db8
...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002d03
- (void)dealloc;	// IMP=0x0000000000002cc5
- (void)cancel;	// IMP=0x0000000000002caf
- (void)_didReachTargetTime;	// IMP=0x0000000000002b1b
- (void)_stepDownRate;	// IMP=0x0000000000002859
- (void)start;	// IMP=0x0000000000002566
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000002491
