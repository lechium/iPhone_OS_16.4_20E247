...
- (void).cxx_destruct;	// IMP=0x0000000000025932
...
- (void)inputDidChange;	// IMP=0x000000000002575c
- (void)_invalidateOutput;	// IMP=0x0000000000025745
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x000000000002566d
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000255dd
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000025572
- (id)init;	// IMP=0x000000000002555e
