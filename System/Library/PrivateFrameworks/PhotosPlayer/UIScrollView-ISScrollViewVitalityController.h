...
- (id)is_scrollViewDelegate;	// IMP=0x00300000000246c4
- (void)is_didLayoutPlayerViews;	// IMP=0x0030000000024687
- (id)is_vitalityControllerCreateIfNeeded:(_Bool)arg1;	// IMP=0x003000000002460b
