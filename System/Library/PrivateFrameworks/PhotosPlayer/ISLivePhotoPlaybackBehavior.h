...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d5d2
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d53e
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d4df
- (void)_didFinishPreparing;	// IMP=0x000000000000d48d
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d47b
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d399
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000d2f5
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000d0ae
- (void)startPlayback;	// IMP=0x000000000000d023
- (void)activeDidChange;	// IMP=0x000000000000cfa3
- (void)videoDidPlayToEnd;	// IMP=0x000000000000cf5f
- (void)_handleDidFinish;	// IMP=0x000000000000cef0
- (void)videoWillPlayToEnd;	// IMP=0x000000000000cd6b
- (long long)behaviorType;	// IMP=0x000000000000cd60
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000cc23
