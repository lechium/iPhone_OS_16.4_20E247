...
- (void).cxx_destruct;	// IMP=0x0000000000013899
...
- (void)cancelSettleToPhoto;	// IMP=0x00000000000136f0
- (void)_didReachTransitionToPhotoTime;	// IMP=0x00000000000134b6
- (void)_didReachTransitionTime;	// IMP=0x000000000001339e
- (void)_startVideoPlayback;	// IMP=0x000000000001326f
- (void)videoReadyForDisplayDidChange;	// IMP=0x0000000000013206
- (void)playVitality;	// IMP=0x0000000000013175
- (long long)behaviorType;	// IMP=0x000000000001316a
- (void)_handleDidFinishPreroll;	// IMP=0x0000000000013111
- (void)_handleDidSeekToStartTime;	// IMP=0x0000000000012fe6
- (void)_stopObservingVideo;	// IMP=0x0000000000012f49
- (void)_startObservingVideo;	// IMP=0x0000000000012ae7
- (void)prepareForVitality;	// IMP=0x00000000000127dd
- (void)activeDidChange;	// IMP=0x0000000000012743
- (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(_Bool)arg6 assetOptions:(unsigned long long)arg7;	// IMP=0x000000000001268d
- (void)dealloc;	// IMP=0x00000000000125d0
