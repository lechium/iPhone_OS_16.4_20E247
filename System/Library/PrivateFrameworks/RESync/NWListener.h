...
- (void).cxx_destruct;	// IMP=0x000000000003e423
- (void)waitForReady;	// IMP=0x000000000003e40e
- (void)setListener:(id)arg1;	// IMP=0x000000000003df2c
- (void)stopListening;	// IMP=0x000000000003de99
- (id)initWithLayer:(void *)arg1;	// IMP=0x000000000003de36
