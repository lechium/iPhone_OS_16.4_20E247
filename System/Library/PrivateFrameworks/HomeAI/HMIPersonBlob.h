...
- (void).cxx_destruct;	// IMP=0x0000000000032dc3
...
- (id)shortDescription;	// IMP=0x0000000000032aa6
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000032a30
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x000000000003224d
- (void)trackPersonBlob:(id)arg1;	// IMP=0x00000000000321fe
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000031fc9
