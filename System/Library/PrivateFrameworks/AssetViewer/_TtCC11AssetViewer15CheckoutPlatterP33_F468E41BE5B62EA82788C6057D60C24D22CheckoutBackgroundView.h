...
- (id)initWithFrame:(struct CGRect)arg1 backgroundStyle:(long long)arg2 controlStyle:(long long)arg3;	// IMP=0x000000000006aaa0
- (void)layoutSubviews;	// IMP=0x000000000006aa70
