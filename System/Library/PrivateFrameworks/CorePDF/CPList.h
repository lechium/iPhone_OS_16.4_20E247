...
- (_Bool)isMultilevel;	// IMP=0x000000000000d20d
- (_Bool)containsParagraph:(id)arg1;	// IMP=0x000000000000d193
- (void)addItem:(id)arg1;	// IMP=0x000000000000d163
- (id)itemAtIndex:(unsigned int)arg1;	// IMP=0x000000000000d153
- (unsigned int)itemCount;	// IMP=0x000000000000d145
- (void)dealloc;	// IMP=0x000000000000d0fd
- (void)finalize;	// IMP=0x000000000000d0bf
- (void)dispose;	// IMP=0x000000000000d099
- (id)init;	// IMP=0x000000000000d046
