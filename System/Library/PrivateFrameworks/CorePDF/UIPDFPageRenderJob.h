...
- (void)sendImageTo:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x00000000000805f0
- (void)sendImage;	// IMP=0x00000000000804b4
- (void)renderImage;	// IMP=0x000000000007fe21
@property(readonly, retain) UIImage *image; // @dynamic image;
- (void)releaseOperation;	// IMP=0x000000000007fdc3
@property UIPDFPageRenderOperation *operation; // @dynamic operation;
- (void)setTarget:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000007fc0b
- (void)cancelOperationForTarget:(id)arg1;	// IMP=0x000000000007fa85
- (void)cancelOperation;	// IMP=0x000000000007f91d
- (void)cancel;	// IMP=0x000000000007f79b
- (void)dealloc;	// IMP=0x000000000007f743
- (id)initWithPage:(id)arg1 maxSize:(struct CGSize)arg2 queuePriority:(long long)arg3;	// IMP=0x000000000007f664
- (_Bool)hasPage;	// IMP=0x000000000007f637
