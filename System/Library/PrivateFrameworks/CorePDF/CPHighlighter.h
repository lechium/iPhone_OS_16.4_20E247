...
+ (_Bool)reconstructHighlightFor:(id)arg1;	// IMP=0x00600000000562f1
...
- (void)highlight;	// IMP=0x0000000000056020
- (id)initWithTextLine:(id)arg1 inZone:(id)arg2 ofColor:(struct CGColor *)arg3;	// IMP=0x0000000000055fcd
