...
- (void).cxx_destruct;	// IMP=0x0000000000004e1a
...
- (void)updateWithMeasurement:(id)arg1;	// IMP=0x0000000000003908
- (void)dealloc;	// IMP=0x00000000000038a5
- (id)initWithContainer:(id)arg1 metric:(id)arg2 unitString:(id)arg3;	// IMP=0x0000000000003737
