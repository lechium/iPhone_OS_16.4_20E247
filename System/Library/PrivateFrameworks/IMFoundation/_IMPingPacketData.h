...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000455b3
- (void)_returnPacketArrived;	// IMP=0x0000000000045595
- (void)_markPacketAsTimedOut:(double)arg1;	// IMP=0x0000000000045509
- (id)initWithSequeneceNumber:(int)arg1 timesent:(struct timeval *)arg2 error:(int)arg3;	// IMP=0x00000000000454b4
