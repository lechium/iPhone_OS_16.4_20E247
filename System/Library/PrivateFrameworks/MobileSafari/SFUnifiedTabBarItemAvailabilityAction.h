...
- (void).cxx_destruct;	// IMP=0x000000000003d4db
...
- (void)performAction;	// IMP=0x000000000003d4a7
- (id)initWithTitle:(id)arg1 image:(id)arg2 buttonType:(long long)arg3 action:(CDUnknownBlockType)arg4;	// IMP=0x000000000003d3b4
