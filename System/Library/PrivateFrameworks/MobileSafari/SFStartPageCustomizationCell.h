...
- (void).cxx_destruct;	// IMP=0x0000000000048553
@property(nonatomic) __weak id <SFStartPageCustomizationCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void)valueDidChange:(id)arg1;	// IMP=0x00000000000484cf
- (void)setAccessories:(id)arg1;	// IMP=0x00000000000483e3
@property(nonatomic, getter=isOn) _Bool on;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000482ba
