...
- (void).cxx_destruct;	// IMP=0x00000000000b4346
...
- (void)_updateDocumentSizeLabel;	// IMP=0x00000000000b40ce
- (void)_updatePropertiesDefinedByContentSizeCategory;	// IMP=0x00000000000b3fef
- (void)_configureOrientationBasedConstraints:(long long)arg1;	// IMP=0x00000000000b3f5a
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000b3e97
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b374f
