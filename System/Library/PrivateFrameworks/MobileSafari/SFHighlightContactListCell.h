...
- (void)_didReceiveTap:(id)arg1;	// IMP=0x000000000003d2a6
- (void)_updateMaskedCorners;	// IMP=0x000000000003d238
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000003d136
- (id)initWithContact:(id)arg1;	// IMP=0x000000000003c080
