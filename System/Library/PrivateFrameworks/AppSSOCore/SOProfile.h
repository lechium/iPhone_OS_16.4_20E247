...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000088ac
+ (id)stringWithAuthenticationMethod:(long long)arg1;	// IMP=0x0010000000008607
+ (id)stringWithScreenLockedBehavior:(long long)arg1;	// IMP=0x00100000000085bf
+ (id)stringWithProfileType:(long long)arg1;	// IMP=0x0010000000008577
- (void).cxx_destruct;	// IMP=0x000000000000919c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008fe1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000008d33
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000088b4
- (id)description;	// IMP=0x0000000000008660
