...
- (void).cxx_destruct;	// IMP=0x000000000000fe86
...
- (void)authorization:(id)arg1 didCompleteWithHTTPAuthorizationHeaders:(id)arg2;	// IMP=0x000000000000fc0b
- (void)authorization:(id)arg1 didCompleteWithHTTPResponse:(id)arg2 httpBody:(id)arg3;	// IMP=0x000000000000f9a6
- (void)authorization:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x000000000000f7d3
- (void)authorizationDidComplete:(id)arg1;	// IMP=0x000000000000f6ce
- (void)authorizationDidCancel:(id)arg1;	// IMP=0x000000000000f5c9
- (void)authorizationDidNotHandle:(id)arg1;	// IMP=0x000000000000f4c4
