...
- (void).cxx_destruct;	// IMP=0x000000000032d030
- (id)init;	// IMP=0x000000000032cfd0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000032ceb0
