...
- (void).cxx_destruct;	// IMP=0x000000000003ce73
- (id)captureState;	// IMP=0x000000000003ce37
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003bd1e
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x0000000000038f5f
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000000038f46
- (id)init;	// IMP=0x0000000000030405
