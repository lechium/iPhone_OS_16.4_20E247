...
- (void).cxx_destruct;	// IMP=0x0000000000047f81
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000047cdb
- (void)_adjustFont;	// IMP=0x0000000000047862
- (void)_setupSubviews;	// IMP=0x00000000000463c6
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000046293
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000046196
