...
+ (id)reuseIdentifier;	// IMP=0x0060000000046084
...
- (void)clickToggle:(id)arg1;	// IMP=0x0000000000046091
@property(nonatomic, getter=isOn) _Bool on;
- (void)setDisplayText:(id)arg1;	// IMP=0x000000000004602d
- (void)_setupUI;	// IMP=0x0000000000045a1b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000459cf
