...
- (void).cxx_destruct;	// IMP=0x000000000007f987
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x000000000007f816
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000007f65d
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x000000000007f618
- (void)layoutSubviews;	// IMP=0x000000000007f100
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000007ef35
