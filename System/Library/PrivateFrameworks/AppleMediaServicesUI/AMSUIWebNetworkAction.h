...
- (void).cxx_destruct;	// IMP=0x00000000000aac55
...
- (id)_createSession;	// IMP=0x00000000000aa961
- (id)runAction;	// IMP=0x00000000000a9579
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a8f06
