...
- (void).cxx_destruct;	// IMP=0x0000000000090be7
...
- (void)_showCancelButtonIfNeeded;	// IMP=0x000000000009076a
- (void)_applyAppearance;	// IMP=0x0000000000090600
- (void)willPresentPageModel:(id)arg1 appearance:(id)arg2;	// IMP=0x00000000000903f3
- (void)viewWillLayoutSubviews;	// IMP=0x000000000009032a
- (void)loadView;	// IMP=0x000000000008f618
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000008f421
- (id)initWithContext:(id)arg1;	// IMP=0x000000000008f3c4
