...
+ (void)_screenCapFromView:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00600000000bdf0c
+ (id)_imageViewForImage:(id)arg1;	// IMP=0x00600000000bdebf
- (void).cxx_destruct;	// IMP=0x00000000000be60d
...
- (_Bool)_visibilityUnmodified;	// IMP=0x00000000000be567
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000be23f
- (void)layoutSubviews;	// IMP=0x00000000000bda63
- (void)_updateSnapshot:(id)arg1;	// IMP=0x00000000000bd9cd
- (id)initWithView:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000bd7d0
