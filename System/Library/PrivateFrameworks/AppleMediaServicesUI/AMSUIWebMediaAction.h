...
- (void).cxx_destruct;	// IMP=0x00000000000a660d
...
- (id)_runMediaRequestWithType:(long long)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x00000000000a6225
- (id)_runMediaRequestWithURL:(id)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x00000000000a5dc2
- (id)runAction;	// IMP=0x00000000000a5aee
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a5783
