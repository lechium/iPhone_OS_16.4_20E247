...
- (id)loadPage;	// IMP=0x00000000000a3990
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000a3903
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a3314
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000a32a9
