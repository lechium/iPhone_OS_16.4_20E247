...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x006000000009a2d4
- (void).cxx_destruct;	// IMP=0x000000000009ab1c
...
- (void)reset;	// IMP=0x000000000009a958
- (void)pause;	// IMP=0x000000000009a729
- (void)start;	// IMP=0x000000000009a35c
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000009a21d
