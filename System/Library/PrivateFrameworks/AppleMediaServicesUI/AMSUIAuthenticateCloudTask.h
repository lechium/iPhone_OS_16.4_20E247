...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x00000000000101b1
- (id)performAuthenticate;	// IMP=0x000000000000fb57
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000000fab5
