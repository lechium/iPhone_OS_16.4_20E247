...
- (void).cxx_destruct;	// IMP=0x000000000005c854
...
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000005c69a
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000005c5f5
- (void)loadView;	// IMP=0x000000000005c560
- (void)_setup;	// IMP=0x000000000005c4db
- (id)initWithPaymentSetupRequest:(id)arg1;	// IMP=0x000000000005c45d
