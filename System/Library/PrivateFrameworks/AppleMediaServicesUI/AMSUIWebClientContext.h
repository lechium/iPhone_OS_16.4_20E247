...
+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x0060000000084cf6
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x0060000000084c8c
- (void).cxx_destruct;	// IMP=0x000000000008539b
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x0000000000084c7a
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000008467b
- (id)loadSnapshot;	// IMP=0x000000000008438a
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x0000000000083daf
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x0000000000083c95
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x00000000000837da
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x0000000000083581
