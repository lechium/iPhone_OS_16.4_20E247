...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x0060000000082de6
- (void).cxx_destruct;	// IMP=0x0000000000082ee3
...
- (id)runAction;	// IMP=0x0000000000082423
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000081f4f
