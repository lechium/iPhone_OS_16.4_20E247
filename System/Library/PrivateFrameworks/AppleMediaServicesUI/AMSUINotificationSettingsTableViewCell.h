...
- (void).cxx_destruct;	// IMP=0x000000000004e5e3
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000004e457
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000004e1df
