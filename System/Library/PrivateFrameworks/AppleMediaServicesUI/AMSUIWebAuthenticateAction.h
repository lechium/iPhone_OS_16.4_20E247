...
- (void).cxx_destruct;	// IMP=0x0000000000077341
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x0000000000077150
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x0000000000077023
- (id)runAction;	// IMP=0x000000000007693d
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000076084
