...
- (void).cxx_destruct;	// IMP=0x000000000007a2df
...
- (id)makeBusinessChatDeeplink;	// IMP=0x0000000000079f23
- (id)runAction;	// IMP=0x0000000000079d9c
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000079b7a
