...
+ (id)_createContentControllerWithScheme:(id)arg1 data:(id)arg2 messageHandler:(id)arg3;	// IMP=0x00100000000bc835
- (void).cxx_destruct;	// IMP=0x00000000000bceb1
...
- (void)webView:(id)arg1 stopURLSchemeTask:(id)arg2;	// IMP=0x00000000000bc677
- (void)webView:(id)arg1 startURLSchemeTask:(id)arg2;	// IMP=0x00000000000bc173
- (void)userContentController:(id)arg1 didReceiveScriptMessage:(id)arg2 replyHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000bbe5a
@property(nonatomic) double topInset;
- (id)initWithAppearance:(id)arg1 scheme:(id)arg2 data:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000000bbad5
