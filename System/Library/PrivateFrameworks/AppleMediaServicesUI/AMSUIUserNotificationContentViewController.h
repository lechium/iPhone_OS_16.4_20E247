...
- (void).cxx_destruct;	// IMP=0x0000000000070c96
...
- (void)viewTapped:(id)arg1;	// IMP=0x0000000000070b2e
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000070aab
- (void)mediaPause;	// IMP=0x00000000000709d2
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000006fd93
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000006fca3
- (void)viewWillLayoutSubviews;	// IMP=0x000000000006f348
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x000000000006f2c3
- (void)loadView;	// IMP=0x000000000006eea2
- (void)dealloc;	// IMP=0x000000000006ede0
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000006df9c
