...
+ (id)_messageFromError:(id)arg1;	// IMP=0x001000000008f03a
- (void).cxx_destruct;	// IMP=0x000000000008f339
...
- (id)loadPage;	// IMP=0x000000000008f021
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000008efb0
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008e766
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000008e3eb
