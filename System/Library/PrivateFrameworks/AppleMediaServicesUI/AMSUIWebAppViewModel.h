...
+ (_Bool)validateJSObject:(id)arg1;	// IMP=0x0010000000075f9d
- (void).cxx_destruct;	// IMP=0x0000000000076046
...
- (id)iconWithSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x0000000000075b50
- (id)createBarButtonItem;	// IMP=0x00000000000755ae
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000751cb
