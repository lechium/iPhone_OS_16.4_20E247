...
- (void).cxx_destruct;	// IMP=0x00000000000b5ee9
...
- (id)_webPageViewController;	// IMP=0x00000000000b5c50
- (id)loadPage;	// IMP=0x00000000000b5c37
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000b5c1d
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000b569f
