...
- (void).cxx_destruct;	// IMP=0x0000000000079614
...
- (void)_fetchValuesForKeys:(id)arg1 bag:(id)arg2 startingAtIndex:(long long)arg3 valuesArray:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000078e82
- (id)runAction;	// IMP=0x00000000000787d8
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000781b5
