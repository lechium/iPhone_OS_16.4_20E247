...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x00100000000bfd43
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x00100000000bfbe8
- (void).cxx_destruct;	// IMP=0x00000000000bfeb8
...
- (id)runAction;	// IMP=0x00000000000bf6ed
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000beead
