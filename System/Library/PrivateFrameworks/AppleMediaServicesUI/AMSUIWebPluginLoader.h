...
- (void).cxx_destruct;	// IMP=0x00000000000b4986
...
- (id)_loadInstalledPlugins;	// IMP=0x00000000000b45f6
- (id)pluginForBundleIdentifier:(id)arg1;	// IMP=0x00000000000b3d3c
@property(readonly, nonatomic) NSArray *loadedPlugins;
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000b3c43
