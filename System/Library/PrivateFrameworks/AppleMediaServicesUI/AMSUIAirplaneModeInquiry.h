...
+ (id)settingsURL;	// IMP=0x001000000000aee5
- (void).cxx_destruct;	// IMP=0x000000000000afbf
...
- (void)airplaneModeChanged;	// IMP=0x000000000000af42
@property(readonly, nonatomic) _Bool isEnabled;
- (id)init;	// IMP=0x000000000000ae7b
