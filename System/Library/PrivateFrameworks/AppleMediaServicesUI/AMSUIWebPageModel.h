...
- (void).cxx_destruct;	// IMP=0x00000000000afad9
...
- (id)loadPage;	// IMP=0x00000000000af71d
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000af6c1
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000af3b2
