...
+ (id)resultFromURL:(id)arg1 error:(id)arg2;	// IMP=0x00100000000ad3d2
- (void).cxx_destruct;	// IMP=0x00000000000ae39a
...
- (void)_safariDataUpdate:(id)arg1;	// IMP=0x00000000000adeae
- (_Bool)_presentViewContoller:(id)arg1;	// IMP=0x00000000000adcbd
- (id)runAction;	// IMP=0x00000000000ad520
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000ad1d6
