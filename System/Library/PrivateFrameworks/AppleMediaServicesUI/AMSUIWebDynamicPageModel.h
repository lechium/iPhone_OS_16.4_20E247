...
- (void).cxx_destruct;	// IMP=0x000000000008d226
...
- (id)loadPage;	// IMP=0x000000000008cd8c
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000008cbf2
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008c842
