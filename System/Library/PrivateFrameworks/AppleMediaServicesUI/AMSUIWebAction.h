...
- (void).cxx_destruct;	// IMP=0x00000000000731da
...
- (id)runAction;	// IMP=0x00000000000730c0
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000072f3b
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000072ed0
