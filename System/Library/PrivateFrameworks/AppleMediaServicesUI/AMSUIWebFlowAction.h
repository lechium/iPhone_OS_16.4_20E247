...
- (void).cxx_destruct;	// IMP=0x0000000000095bea
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x000000000009573f
- (id)runAction;	// IMP=0x000000000009532a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000094d27
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000094ce4
