...
- (void).cxx_destruct;	// IMP=0x0000000000059846
...
- (void)_toggleChanged:(id)arg1;	// IMP=0x0000000000059748
- (long long)selectionStyle;	// IMP=0x0000000000059740
- (void)_setup;	// IMP=0x0000000000059632
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000595e6
