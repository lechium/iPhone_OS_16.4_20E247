...
+ (_Bool)_hasRequiredTelephonyEntitlement;	// IMP=0x00100000000a2376
+ (_Bool)_hasCellularTelephonyCapability;	// IMP=0x00100000000a2365
- (void).cxx_destruct;	// IMP=0x00000000000a326d
...
- (void)phoneNumberChanged:(id)arg1;	// IMP=0x00000000000a3197
- (void)phoneNumberAvailable:(id)arg1;	// IMP=0x00000000000a314b
- (void)operatorNameChanged:(id)arg1 name:(id)arg2;	// IMP=0x00000000000a30ff
- (id)formattedPhoneNumber:(id)arg1;	// IMP=0x00000000000a30dc
...
- (void)invalidate;	// IMP=0x00000000000a2351
- (void)dealloc;	// IMP=0x00000000000a230d
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000a1dcc
- (id)init;	// IMP=0x00000000000a1db8
