...
@class HMDAccessory, HMDAppleMediaAccessorySensorManager, HMDService, HMFFuture, HMSetupAccessoryDescription, NSArray, NSNotificationCenter, NSObject, NSString, NSUUID;
