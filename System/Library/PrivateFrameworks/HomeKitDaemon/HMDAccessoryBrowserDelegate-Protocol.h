...
- (void)accessoryBrowser:(HMDAccessoryBrowser *)arg1 accessoryServer:(HAPAccessoryServer *)arg2 didUpdateConnectionState:(_Bool)arg3 sessionInfo:(HAP2AccessorySessionInfo *)arg4 withError:(NSError *)arg5;
