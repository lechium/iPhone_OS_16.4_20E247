...
+ (id)logCategory;	// IMP=0x0010000000b1743a
- (void).cxx_destruct;	// IMP=0x0000000000b173c0
...
- (id)logIdentifier;	// IMP=0x0000000000b17314
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x0000000000b17149
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x0000000000b17060
- (id)shortDescription;	// IMP=0x0000000000b16fe6
- (void)dealloc;	// IMP=0x0000000000b16f29
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x0000000000b16e8e
