...
- (void).cxx_destruct;	// IMP=0x00000000009c72fe
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x00000000009c726a
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x00000000009c7137
- (id)initWithName:(id)arg1;	// IMP=0x00000000009c7081
