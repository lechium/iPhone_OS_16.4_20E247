...
+ (id)logCategory;	// IMP=0x00100000007e3ab2
+ (double)timeout;	// IMP=0x00100000007e39d4
- (void).cxx_destruct;	// IMP=0x00000000007e3800
...
- (id)logIdentifier;	// IMP=0x00000000007e36d1
- (void)main;	// IMP=0x00000000007e34e6
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000007e339b
