...
+ (_Bool)allowsReverseTransformation;	// IMP=0x00600000000020a9
+ (Class)transformedValueClass;	// IMP=0x0060000000002098
@property(nonatomic) struct CGSize preferredSize; // @synthesize preferredSize=_preferredSize;
- (id)transformedValue:(id)arg1;	// IMP=0x00000000000020b1
