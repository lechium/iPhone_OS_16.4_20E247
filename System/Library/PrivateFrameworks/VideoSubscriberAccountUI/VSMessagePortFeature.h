...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x00100000000150ac
- (void).cxx_destruct;	// IMP=0x0000000000015377
...
- (void)messagePort:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00000000000152bb
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000151ed
