...
- (void).cxx_destruct;	// IMP=0x0000000000045e47
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000045d29
- (double)preferredHeightForWidth:(double)arg1;	// IMP=0x0000000000045cfb
- (void)dealloc;	// IMP=0x0000000000045cc5
- (id)initWithSpecifier:(id)arg1;	// IMP=0x0000000000045290
