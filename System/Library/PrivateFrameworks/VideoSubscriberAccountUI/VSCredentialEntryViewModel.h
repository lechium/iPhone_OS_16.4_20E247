...
- (void)clearFieldsAfterUsername;	// IMP=0x0000000000046a19
- (void)pickerDidSelectRow:(unsigned long long)arg1;	// IMP=0x00000000000469c8
- (void)buttonTappedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000046977
- (void)validateCredentialEntryFields;	// IMP=0x0000000000046795
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000004640e
- (void)_bindField:(id)arg1;	// IMP=0x000000000004620d
- (void)_unbindField:(id)arg1;	// IMP=0x00000000000461b6
