...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x001000000003ed41
- (void).cxx_destruct;	// IMP=0x000000000003f098
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003ef09
- (id)toVSSubscription;	// IMP=0x000000000003ebdb
- (id)init;	// IMP=0x000000000003eafd
