...
- (void).cxx_destruct;	// IMP=0x000000000004381f
...
- (_Bool)_shouldInsetListView;	// IMP=0x00000000000433ae
- (void)_updateSectionContentInsetWithAnimation:(_Bool)arg1;	// IMP=0x0000000000042fa5
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000042f62
- (void)willMoveToParentViewController:(id)arg1;	// IMP=0x0000000000042ecf
- (void)viewDidLoad;	// IMP=0x0000000000042a7f
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000429ec
- (void)didInvalidateIntrinsicContentSizeForTableHeaderFooterView:(id)arg1;	// IMP=0x000000000004287a
- (void)deselectSelectedProviderAnimated:(_Bool)arg1;	// IMP=0x000000000004270d
- (void)tableViewDidFinishReload:(id)arg1;	// IMP=0x000000000004258a
- (double)tableView:(id)arg1 estimatedHeightForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000042579
- (double)tableView:(id)arg1 heightForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000042567
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000000000423a3
- (void)_performSelectionForIdentityProvider:(id)arg1;	// IMP=0x00000000000422aa
- (void)_showAboutPrivacy:(id)arg1;	// IMP=0x000000000004225e
- (void)_cancelButtonPressed:(id)arg1;	// IMP=0x0000000000042201
- (void)_dismissSearchController;	// IMP=0x000000000004210d
- (void)_didPickStorefront:(id)arg1;	// IMP=0x0000000000042063
- (void)_didPickAdditionalIdentityProviders;	// IMP=0x0000000000041f91
- (void)_didPickIdentityProvider:(id)arg1;	// IMP=0x0000000000041f17
- (id)_titleForViewController;	// IMP=0x0000000000041e6d
- (id)titleForTableFooterView;	// IMP=0x0000000000041dec
- (id)_titleForTableHeaderView;	// IMP=0x0000000000041bd7
- (void)_updateTableHeaderTitle;	// IMP=0x0000000000041a2e
- (void)setRequestedStorefrontCountryCode:(id)arg1 defaultToDeveloperProviders:(_Bool)arg2;	// IMP=0x000000000004169e
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000000410fd
