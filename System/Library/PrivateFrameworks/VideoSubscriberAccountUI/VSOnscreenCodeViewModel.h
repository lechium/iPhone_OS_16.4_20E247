...
- (id)formattedWebsiteURL;	// IMP=0x000000000000cb92
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000000c677
- (void)generateQRCode;	// IMP=0x000000000000c671
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000000c60d
