...
- (void).cxx_destruct;	// IMP=0x00000000000400a7
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000003ff1c
- (void)didSelectManualSignInButton;	// IMP=0x000000000003fed0
- (id)init;	// IMP=0x000000000003fe0c
