...
- (void)cancel;	// IMP=0x0000000000012604
- (void)executionDidBegin;	// IMP=0x00000000000125f2
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x000000000001227e
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000011c52
- (void)_checkSupportedProviders;	// IMP=0x0000000000011572
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x0000000000010ccf
- (void)_checkAvailability;	// IMP=0x0000000000010b4c
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x00000000000109ad
- (void)_checkPrivacy;	// IMP=0x00000000000101cb
- (void)_checkEntitlement;	// IMP=0x0000000000010083
- (void)_finishWithError:(id)arg1;	// IMP=0x000000000000ff6d
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000feea
- (void)dealloc;	// IMP=0x000000000000fea1
- (id)init;	// IMP=0x000000000000fc4e
