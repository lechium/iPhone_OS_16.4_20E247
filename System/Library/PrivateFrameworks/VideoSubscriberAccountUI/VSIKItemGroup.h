...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x001000000000ade1
+ (void)registerFeature;	// IMP=0x001000000000adaf
- (void).cxx_destruct;	// IMP=0x000000000000b1e5
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000000ae78
