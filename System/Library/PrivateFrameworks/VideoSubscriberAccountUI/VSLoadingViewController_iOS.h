...
- (void).cxx_destruct;	// IMP=0x0000000000048f9f
...
- (void)_cancelButtonPressed:(id)arg1;	// IMP=0x0000000000048e4b
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000048d35
- (void)viewDidLoad;	// IMP=0x0000000000048a4b
