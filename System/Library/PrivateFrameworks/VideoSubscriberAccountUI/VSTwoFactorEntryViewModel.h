...
- (void).cxx_destruct;	// IMP=0x0000000000032d6a
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000032c50
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000032a86
- (id)init;	// IMP=0x00000000000326ee
