...
- (void)cancel;	// IMP=0x0000000000006c6b
- (void)_registerSubscriptions:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x00000000000068b1
- (void)_removeSubscriptionsForBundleIdentifiers:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x0000000000006279
- (id)_authorizedBundleIdsFromAppDescriptions:(id)arg1;	// IMP=0x00000000000060d8
- (void)executionDidBegin;	// IMP=0x000000000000549d
- (id)initWithRegistrationCenter:(id)arg1 andDeveloperSettingsFetchOperation:(id)arg2;	// IMP=0x0000000000005402
- (id)init;	// IMP=0x0000000000005319
