...
- (void).cxx_destruct;	// IMP=0x000000000004eab1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004e85e
- (unsigned long long)hash;	// IMP=0x000000000004e7c5
- (id)description;	// IMP=0x000000000004e6a9
