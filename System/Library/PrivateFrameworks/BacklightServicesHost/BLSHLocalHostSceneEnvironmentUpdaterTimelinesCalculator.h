...
- (void).cxx_destruct;	// IMP=0x000000000005e144
- (void)requestDatesOperation:(id)arg1 didTimeoutPendingEnvironments:(id)arg2;	// IMP=0x000000000005e0d3
- (void)requestDatesOperation:(id)arg1 environment:(id)arg2 didProvideSpecifiers:(id)arg3 forPresentationInterval:(id)arg4 isComplete:(_Bool)arg5;	// IMP=0x000000000005de47
- (void)lock_completeAllTimelineEntries;	// IMP=0x000000000005dc5b
- (void)callCompletionIfDone;	// IMP=0x000000000005dba3
- (void)calculateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000005d670
