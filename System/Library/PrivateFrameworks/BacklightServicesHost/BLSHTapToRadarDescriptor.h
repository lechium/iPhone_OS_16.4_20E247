...
- (void).cxx_destruct;	// IMP=0x0000000000062ad5
...
- (id)toURL;	// IMP=0x00000000000625a7
- (id)initWithDesignation:(unsigned long long)arg1 radarTitle:(id)arg2 radarDescription:(id)arg3;	// IMP=0x0000000000062410
