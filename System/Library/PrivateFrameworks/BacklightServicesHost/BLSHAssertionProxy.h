...
- (void).cxx_destruct;	// IMP=0x0000000000035047
...
- (oneway void)serviceDidResume;	// IMP=0x0000000000034f03
- (oneway void)serviceDidPause;	// IMP=0x0000000000034ecf
- (oneway void)serviceDidCancelWithError:(id)arg1;	// IMP=0x0000000000034e62
- (oneway void)serviceWillCancel;	// IMP=0x0000000000034e2e
- (oneway void)serviceFailedToAcquireWithError:(id)arg1;	// IMP=0x0000000000034de7
- (oneway void)serviceDidAcquire;	// IMP=0x0000000000034d99
...
- (void)invalidate;	// IMP=0x0000000000034d32
- (id)initWithIdentifier:(id)arg1 descriptor:(id)arg2 remoteTarget:(id)arg3;	// IMP=0x0000000000034c39
