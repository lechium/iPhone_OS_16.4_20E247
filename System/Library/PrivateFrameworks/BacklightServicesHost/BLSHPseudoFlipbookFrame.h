...
- (id)bls_shortLoggingString;	// IMP=0x000000000000330c
- (id)bls_loggingString;	// IMP=0x00000000000031f4
...
- (id)initWithPresentationTime:(unsigned long long)arg1 frameId:(unsigned long long)arg2 specifier:(id)arg3 memoryUsage:(unsigned long long)arg4;	// IMP=0x0000000000003112
