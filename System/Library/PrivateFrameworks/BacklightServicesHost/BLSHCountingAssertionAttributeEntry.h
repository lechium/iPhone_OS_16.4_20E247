...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x00100000000369eb
- (void).cxx_destruct;	// IMP=0x0000000000036ec1
...
- (void)invalidate;	// IMP=0x0000000000036c8c
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000036c5b
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0000000000036b7e
