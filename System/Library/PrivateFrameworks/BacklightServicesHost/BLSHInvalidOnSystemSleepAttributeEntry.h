...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000000b2bf
- (void).cxx_destruct;	// IMP=0x000000000000b829
...
- (void)systemSleepMonitor:(id)arg1 prepareForSleepWithCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000b7b6
- (void)systemSleepMonitor:(id)arg1 sleepRequestedWithResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000000b773
- (void)invalidate;	// IMP=0x000000000000b6b5
- (_Bool)reactivateIfPossible;	// IMP=0x000000000000b6ad
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000000b354
