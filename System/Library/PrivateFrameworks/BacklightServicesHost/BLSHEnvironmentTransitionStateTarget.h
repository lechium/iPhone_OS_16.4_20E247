...
- (void).cxx_destruct;	// IMP=0x000000000000edaa
...
- (_Bool)isEqualToVisualState:(id)arg1 presentationDate:(id)arg2;	// IMP=0x000000000000ecfc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ead9
- (unsigned long long)hash;	// IMP=0x000000000000ea39
- (id)debugDescription;	// IMP=0x000000000000e8d9
- (id)description;	// IMP=0x000000000000e7f4
- (_Bool)setAndTestDidPerformBacklightRamp;	// IMP=0x000000000000e7bd
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2 visualState:(id)arg3 presentationDate:(id)arg4;	// IMP=0x000000000000e704
- (id)initWithTarget:(id)arg1 visualState:(id)arg2 presentationDate:(id)arg3;	// IMP=0x000000000000e64d
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2;	// IMP=0x000000000000e635
