...
- (void).cxx_destruct;	// IMP=0x0000000000067c80
...
- (void)_invalidate;	// IMP=0x0000000000067b28
- (void)_reset;	// IMP=0x0000000000067a98
- (void)_resume;	// IMP=0x0000000000067a14
- (void)_pause;	// IMP=0x0000000000067990
- (void)_setShouldNotifyOfUnidle:(_Bool)arg1;	// IMP=0x00000000000678df
- (void)_setIdleTimeout:(double)arg1 shouldReset:(_Bool)arg2;	// IMP=0x0000000000067552
- (void)invalidate;	// IMP=0x00000000000674f5
- (void)reset;	// IMP=0x0000000000067498
- (void)pause;	// IMP=0x000000000006743b
- (void)resume;	// IMP=0x00000000000673de
- (void)setIdleTimeout:(double)arg1 shouldReset:(_Bool)arg2;	// IMP=0x0000000000067306
- (id)init;	// IMP=0x0000000000066f54
