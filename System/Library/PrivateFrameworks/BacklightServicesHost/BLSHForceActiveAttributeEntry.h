...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000004eac8
- (void).cxx_destruct;	// IMP=0x000000000004ed9d
...
- (void)invalidate;	// IMP=0x000000000004ed55
- (_Bool)reactivateIfPossible;	// IMP=0x000000000004ed4d
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000004ec96
