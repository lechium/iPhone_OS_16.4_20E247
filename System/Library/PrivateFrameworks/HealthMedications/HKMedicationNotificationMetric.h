...
+ (id)eventName;	// IMP=0x004000000001279b
- (void).cxx_destruct;	// IMP=0x0000000000012b76
...
- (id)description;	// IMP=0x0000000000012ab7
- (id)interactionTypeValue;	// IMP=0x00000000000127c5
- (id)typeValue;	// IMP=0x00000000000127a8
- (id)initWithType:(long long)arg1 areHealthNotificationsAuthorized:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000000126d0
