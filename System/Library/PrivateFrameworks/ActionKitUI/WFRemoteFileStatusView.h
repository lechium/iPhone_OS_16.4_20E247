...
- (void)setError:(id)arg1;	// IMP=0x0000000000055ad5
- (void)setLoading;	// IMP=0x0000000000055960
- (void)setEmptyWithLabel:(_Bool)arg1;	// IMP=0x000000000005579f
- (void)recoveryButtonTapped;	// IMP=0x0000000000055753
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000055023
