...
- (void).cxx_destruct;	// IMP=0x00000000000374de
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000037193
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000036ea4
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000036e37
- (void)didMoveToWindow;	// IMP=0x0000000000036dc4
- (void)layoutSubviews;	// IMP=0x0000000000036d35
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000036882
