...
- (void)updateButtons;	// IMP=0x000000000003c47f
- (void)updateFlipButton;	// IMP=0x000000000003c3cf
- (void)flashValueChanged;	// IMP=0x000000000003c31f
- (void)cancelPressed;	// IMP=0x000000000003c217
- (void)flipPressed;	// IMP=0x000000000003c178
- (void)updatePhotosLabel;	// IMP=0x000000000003beb8
- (void)shutterPressed;	// IMP=0x000000000003bdc6
- (void)layoutSubviews;	// IMP=0x000000000003bc28
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003a5a9
