...
- (void).cxx_destruct;	// IMP=0x0000000000064572
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000064385
- (void)updateColors;	// IMP=0x00000000000642ee
- (void)layoutSubviews;	// IMP=0x0000000000064081
- (id)initWithFrame:(struct CGRect)arg1 isRootNode:(_Bool)arg2;	// IMP=0x0000000000063cdd
