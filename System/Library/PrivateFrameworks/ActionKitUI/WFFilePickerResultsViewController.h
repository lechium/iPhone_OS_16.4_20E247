...
- (void).cxx_destruct;	// IMP=0x0000000000058cdb
...
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000058bc6
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000058b85
- (void)updateContentInset;	// IMP=0x000000000005899a
- (void)loadView;	// IMP=0x0000000000058831
- (void)dealloc;	// IMP=0x00000000000587af
- (id)initWithFileListDelegate:(id)arg1;	// IMP=0x00000000000586d9
