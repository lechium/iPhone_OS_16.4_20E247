...
- (void).cxx_destruct;	// IMP=0x000000000003238f
...
- (void)tick;	// IMP=0x0000000000031e68
- (void)stop;	// IMP=0x0000000000031e16
- (void)start;	// IMP=0x0000000000031c91
- (void)releaseNode:(id)arg1;	// IMP=0x0000000000031c31
- (void)fixNode:(id)arg1 atPosition:(struct CGPoint)arg2;	// IMP=0x0000000000031b83
- (void)unlinkNode:(id)arg1 fromNode:(id)arg2;	// IMP=0x0000000000031b2a
- (void)linkNode:(id)arg1 toNode:(id)arg2;	// IMP=0x00000000000319ab
- (void)removeAllNodes;	// IMP=0x0000000000031970
- (void)removeNode:(id)arg1;	// IMP=0x000000000003189b
- (void)addNode:(id)arg1;	// IMP=0x000000000003173b
@property(nonatomic) double lineWidth;
@property(copy, nonatomic) UIColor *lineColor;
- (id)initWithReferenceView:(id)arg1;	// IMP=0x0000000000031384
- (id)init;	// IMP=0x0000000000031370
