...
- (void).cxx_destruct;	// IMP=0x000000000003a56d
...
- (void)updateWithTranscription:(id)arg1;	// IMP=0x000000000003a434
- (void)stopButtonTapped;	// IMP=0x000000000003a367
- (void)dealloc;	// IMP=0x000000000003a2e5
- (id)initWithFrame:(struct CGRect)arg1 padded:(_Bool)arg2;	// IMP=0x0000000000039d3b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000039d27
