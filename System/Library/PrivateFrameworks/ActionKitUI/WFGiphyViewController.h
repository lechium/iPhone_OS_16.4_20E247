...
- (void).cxx_destruct;	// IMP=0x000000000006bb7f
...
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000000006b9f8
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000000006b9b4
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000000006b97d
- (void)searchBarSearchButtonClicked:(id)arg1;	// IMP=0x000000000006b8fe
- (void)searchBar:(id)arg1 textDidChange:(id)arg2;	// IMP=0x000000000006b8b3
- (_Bool)accessibilityPerformEscape;	// IMP=0x000000000006b89e
- (void)cancel;	// IMP=0x000000000006b801
- (void)done;	// IMP=0x000000000006b58b
- (void)updateResults;	// IMP=0x000000000006b46b
- (void)setQuery:(id)arg1;	// IMP=0x000000000006b38b
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000006af0e
- (void)loadView;	// IMP=0x000000000006a21d
- (id)initWithQuery:(id)arg1 selectMultiple:(_Bool)arg2;	// IMP=0x0000000000069da3
