...
- (void).cxx_destruct;	// IMP=0x00000000000312e9
...
- (void)didTapNextButton;	// IMP=0x0000000000031192
- (void)didTapCancelButton;	// IMP=0x0000000000031155
- (void)didTapOpacityButton;	// IMP=0x000000000003106d
- (void)didTapRotationButton;	// IMP=0x0000000000030f83
- (void)didTapResetButton;	// IMP=0x0000000000030f46
- (id)init;	// IMP=0x000000000002ff42
