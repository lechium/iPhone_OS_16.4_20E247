...
- (void).cxx_destruct;	// IMP=0x000000000004607c
...
- (void)cancelEditingImage;	// IMP=0x0000000000045ea6
- (void)finishEditingImage;	// IMP=0x0000000000045968
- (void)resetOverlayImageViewTransformations;	// IMP=0x000000000004592b
@property(nonatomic) _Bool rotationEnabled;
@property(nonatomic) _Bool opacitySliderVisible;
- (void)didChangeOpacity:(id)arg1;	// IMP=0x00000000000456a0
- (_Bool)prefersStatusBarHidden;	// IMP=0x0000000000044a60
- (id)editorBackgroundColor;	// IMP=0x0000000000044a27
- (void)viewDidLoad;	// IMP=0x0000000000044923
- (void)loadView;	// IMP=0x000000000004446f
- (id)initWithFileRepresentations:(id)arg1 overlayImage:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000044338
