...
- (void).cxx_destruct;	// IMP=0x00000000000088d1
...
- (struct CGPoint)finalFingerPosition;	// IMP=0x00000000000086e8
- (struct CGPoint)initialFingerPosition;	// IMP=0x0000000000008653
- (void)scrollWithComposer:(id)arg1 fromPoint:(struct CGPoint)arg2 toPoint:(struct CGPoint)arg3 duration:(double)arg4;	// IMP=0x0000000000008393
- (CDUnknownBlockType)composerBlock;	// IMP=0x0000000000007fad
- (struct CGPoint)_incrementPoint:(struct CGPoint)arg1 final:(_Bool)arg2;	// IMP=0x0000000000007f31
- (id)initWithTestName:(id)arg1 iterations:(unsigned long long)arg2 scrollingBounds:(struct CGRect)arg3 useFlicks:(_Bool)arg4 preventDismissalGestures:(_Bool)arg5 initialAmplitude:(double)arg6 amplitudeVariationPerIteration:(double)arg7 initialDirection:(long long)arg8 iterationDuration:(double)arg9 finishWithHalfIteration:(_Bool)arg10 completionHandler:(CDUnknownBlockType)arg11;	// IMP=0x0000000000007dd8
- (id)initWithTestName:(id)arg1 iterations:(unsigned long long)arg2 scrollingBounds:(struct CGRect)arg3 useFlicks:(_Bool)arg4 preventDismissalGestures:(_Bool)arg5 initialAmplitude:(double)arg6 amplitudeVariationPerIteration:(double)arg7 initialDirection:(long long)arg8 iterationDuration:(double)arg9 finishWithHalfIteration:(_Bool)arg10;	// IMP=0x0000000000007d90
- (void)prepareWithComposer:(id)arg1;	// IMP=0x0000000000007d8a
