...
- (void)webui_applySafariCookieAcceptPolicy;	// IMP=0x0030000000002893
- (id)webui_safariCookieAcceptPolicy;	// IMP=0x003000000000283b
@property(readonly) unsigned long long webui_safariCookieAcceptPolicyEnumValue;
- (float)_safariCookieAcceptPolicyFloatValue;	// IMP=0x003000000000273c
@end
