...
+ (id)sharedConnectionState;	// IMP=0x006000000000a643
- (void).cxx_destruct;	// IMP=0x000000000000adf0
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x000000000000ad6a
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000abfd
- (id)init;	// IMP=0x000000000000a710
- (void)cleanupState;	// IMP=0x000000000000a698
