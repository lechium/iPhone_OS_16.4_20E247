...
+ (id)sharedConnectionState;	// IMP=0x00600000000010fd
- (void).cxx_destruct;	// IMP=0x0000000000001a42
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001818
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000001634
- (id)init;	// IMP=0x00000000000011ca
- (void)cleanupState;	// IMP=0x0000000000001152
