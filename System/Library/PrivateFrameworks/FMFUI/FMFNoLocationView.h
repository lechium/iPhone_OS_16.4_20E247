...
- (id)accessibilityLabel;	// IMP=0x000000000000ce68
- (void)updatePersonImageViewImage;	// IMP=0x000000000000ccf6
- (void)setAlpha:(double)arg1;	// IMP=0x000000000000cc8b
- (void)updateLabel;	// IMP=0x000000000000c7c8
- (void)updateLabelNotification:(id)arg1;	// IMP=0x000000000000c753
- (void)updateConstriantsForInsets;	// IMP=0x000000000000c682
- (void)addLayoutConstraints;	// IMP=0x000000000000bf7e
- (void)dealloc;	// IMP=0x000000000000bece
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000ba62
