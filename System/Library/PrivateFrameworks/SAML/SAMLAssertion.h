...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b80c
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c15f
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bfb8
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bf65
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000be48
