...
- (id)gc_snapshot;	// IMP=0x0020000000019e97
- (id)debugDescription;	// IMP=0x00200000000235d8
- (id)valueForKey:(id)arg1;	// IMP=0x00200000000234b5
- (id)valueForElementKey:(id)arg1;	// IMP=0x0020000000023388
