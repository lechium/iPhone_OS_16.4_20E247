...
- (void).cxx_destruct;	// IMP=0x00000000000230c8
@property(readonly) NSString *configurationType; // @synthesize configurationType=_configurationType;
- (void)_assetDidChange:(id)arg1;	// IMP=0x00000000000230a1
- (void)_filesystemDidChange:(id)arg1;	// IMP=0x0000000000022ddc
- (id)fetchBundles;	// IMP=0x0000000000022871
- (void)dealloc;	// IMP=0x00000000000227b6
- (id)init;	// IMP=0x000000000002278b
- (id)initWithConfigurationType:(id)arg1 provider:(id)arg2;	// IMP=0x0000000000021ab8
