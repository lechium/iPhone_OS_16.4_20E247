...
- (id)debugDescription;	// IMP=0x0000000000015968
- (id)redactedDescription;	// IMP=0x00000000000158d5
- (id)description;	// IMP=0x0000000000015842
@property(readonly) NSString *identifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015825
- (id)init;	// IMP=0x00000000000157fa
- (id)initWithPath:(id)arg1;	// IMP=0x00000000000157e6
- (id)initWithPath:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000148d0
