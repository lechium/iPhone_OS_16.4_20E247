...
- (void).cxx_destruct;	// IMP=0x0000000000031723
...
- (id)personalities;	// IMP=0x000000000003168b
- (id)init;	// IMP=0x0000000000031660
- (id)initWithBundle:(id)arg1 dictionary:(id)arg2 error:(out id *)arg3;	// IMP=0x000000000003058e
