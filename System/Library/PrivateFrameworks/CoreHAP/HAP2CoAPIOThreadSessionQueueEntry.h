...
- (void).cxx_destruct;	// IMP=0x00000000001806aa
...
- (_Bool)reapSession:(id)arg1;	// IMP=0x00000000001805ee
- (id)initWithSession:(struct coap_session_t *)arg1 startTime:(id)arg2;	// IMP=0x0000000000180578
