...
@optional
- (void)accessoryServer:(HAPAccessoryServer *)arg1 didUpdateConnectionState:(_Bool)arg2 sessionInfo:(HAP2AccessorySessionInfo *)arg3 withError:(NSError *)arg4;
- (void)accessoryServer:(HAPAccessoryServer *)arg1 didUpdateConnectionState:(_Bool)arg2 withError:(NSError *)arg3;
