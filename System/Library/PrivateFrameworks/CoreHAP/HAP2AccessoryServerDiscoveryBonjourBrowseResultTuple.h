...
- (void).cxx_destruct;	// IMP=0x000000000011d18e
...
- (id)initWithPreviousResult:(id)arg1 currentResult:(id)arg2 changes:(unsigned long long)arg3;	// IMP=0x000000000011d0cb
