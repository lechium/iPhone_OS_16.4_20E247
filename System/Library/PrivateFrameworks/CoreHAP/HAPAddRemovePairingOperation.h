...
- (void).cxx_destruct;	// IMP=0x0000000000195c79
...
- (id)initWith:(long long)arg1 identifier:(id)arg2 publicKey:(id)arg3 admin:(_Bool)arg4 queue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x0000000000195a81
