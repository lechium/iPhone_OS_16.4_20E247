...
- (void).cxx_destruct;	// IMP=0x00000000000ab927
...
- (void)reset;	// IMP=0x00000000000ab4e3
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000ab30e
- (id)init;	// IMP=0x00000000000ab266
