...
+ (float)getMemoryUsage:(id)arg1 logType:(id)arg2 timeDelta:(double)arg3;	// IMP=0x00600000000e08f0
- (void).cxx_destruct;	// IMP=0x00000000000e0e60
...
- (double)getTime;	// IMP=0x00000000000e0880
- (id)initWithSwitch:(_Bool)arg1 atLevel:(BOOL)arg2;	// IMP=0x00000000000e06f0
