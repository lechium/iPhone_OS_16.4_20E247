...
- (void).cxx_destruct;	// IMP=0x000000000003ecd0
...
- (void)_configureHighlightDotForRanges:(id)arg1;	// IMP=0x000000000003e4d4
- (void)performHighlightForRanges:(id)arg1 animated:(_Bool)arg2 isReplacingResults:(_Bool)arg3;	// IMP=0x000000000003de0a
- (void)beginHighlightWithRanges:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000003dc9d
- (void)layoutSubviews;	// IMP=0x000000000003dc5c
- (struct CGAffineTransform)transformForHighlightLayerInCurrentBounds;	// IMP=0x000000000003dc01
- (struct CGRect)currentContentsRectInLayerCoordinates;	// IMP=0x000000000003db3f
- (void)updateHighlightLayerGeometry;	// IMP=0x000000000003d6c9
- (void)updateHighlightLayerGeometryIfVisible;	// IMP=0x000000000003d64f
- (void)clearHighlightsAnimated:(_Bool)arg1 hideLayers:(_Bool)arg2;	// IMP=0x000000000003d4b3
- (void)clearHighlightsAnimated:(_Bool)arg1;	// IMP=0x000000000003d49c
- (void)normalizedVisibleRectDidChange;	// IMP=0x000000000003d416
@property(readonly, nonatomic) UIColor *highlightColor;
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000003d29e
