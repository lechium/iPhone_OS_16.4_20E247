...
- (void).cxx_destruct;	// IMP=0x0000000000055227
...
- (_Bool)isInteractableView:(id)arg1 atPoint:(struct CGPoint)arg2;	// IMP=0x0000000000054ede
- (_Bool)containsInteractableItemAtPoint:(struct CGPoint)arg1;	// IMP=0x0000000000054d3e
- (id)createContainerForView:(id)arg1;	// IMP=0x00000000000548ab
- (struct CGSize)sizeForView:(id)arg1 scale:(double)arg2;	// IMP=0x00000000000544fc
- (id)configureView:(id)arg1 isLeading:(_Bool)arg2 container:(id)arg3 layoutContext:(id)arg4;	// IMP=0x000000000005420c
- (void)processView:(id)arg1 hasContent:(_Bool)arg2 isLeading:(_Bool)arg3 layoutContext:(id)arg4;	// IMP=0x000000000005407b
- (void)updateFramesForContext:(id)arg1;	// IMP=0x00000000000536d2
- (void)updateMoreButtonMenuForContext:(id)arg1;	// IMP=0x00000000000536cc
- (void)adjustContextToFitWidth:(id)arg1;	// IMP=0x0000000000052d23
- (void)layoutContainerView;	// IMP=0x00000000000524fa
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000524b9
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000052439
- (void)layoutSubviews;	// IMP=0x00000000000523e4
@property(readonly, nonatomic) NSArray *allViews;
- (void)_applyConfigurationUpdateHandlerToQuickActions;	// IMP=0x0000000000051a42
- (void)showMoreButtonMenu:(id)arg1;	// IMP=0x00000000000518ab
- (id)buildMoreButtonMenuFromQuickActions:(id)arg1 moreButton:(id)arg2;	// IMP=0x00000000000511c8
- (void)updateLayoutIfNecessary;	// IMP=0x0000000000050f26
- (void)setHidden:(_Bool)arg1;	// IMP=0x0000000000050ee5
@property(readonly, nonatomic) struct CGRect visibleImageRect;
- (id)initWithLiveTextButton:(id)arg1 cornerView:(id)arg2;	// IMP=0x0000000000050b8b
