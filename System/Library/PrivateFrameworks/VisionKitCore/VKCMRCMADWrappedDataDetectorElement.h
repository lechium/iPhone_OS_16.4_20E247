...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000056b4c
- (void).cxx_destruct;	// IMP=0x0000000000056d82
...
- (id)boundingQuads;	// IMP=0x0000000000056cc7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000056c02
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000056b54
- (id)initWithScannerResult:(id)arg1 quad:(id)arg2;	// IMP=0x0000000000056a21
- (id)initWithMADMRCResultItem:(id)arg1 scannerResult:(id)arg2;	// IMP=0x00000000000568cc
