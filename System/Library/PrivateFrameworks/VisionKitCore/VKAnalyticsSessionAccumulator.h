...
- (void).cxx_destruct;	// IMP=0x0000000000056849
...
- (id)description;	// IMP=0x0000000000056379
- (void)send;	// IMP=0x0000000000056373
@property(readonly, nonatomic) NSDictionary *coreAnalyticsDictionary;
- (void)calculateDidActivateRegex;	// IMP=0x0000000000055d6f
- (void)calculateDidHighlightAll;	// IMP=0x0000000000055cf3
- (void)calculateAverageSelectedLengthFromTextEvents;	// IMP=0x0000000000055ac4
- (void)close;	// IMP=0x0000000000055791
- (void)addEvent:(id)arg1;	// IMP=0x0000000000055425
- (id)initWithAnalysis:(id)arg1 customIdentifier:(id)arg2;	// IMP=0x00000000000552e0
