...
- (void).cxx_destruct;	// IMP=0x0000000000003cce
...
- (void)_didDismissVisualResultsPane:(id)arg1;	// IMP=0x0000000000003935
- (void)showLookupUIPaneForResultItem;	// IMP=0x000000000000357a
- (id)queryForProcessingResult;	// IMP=0x0000000000002ca9
- (id)_queryString;	// IMP=0x0000000000002c51
- (void)didDismissVisualResultsPane;	// IMP=0x0000000000002beb
- (void)showVisualSearchResultView;	// IMP=0x0000000000002b5e
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x0000000000002a55
- (void)didTap;	// IMP=0x0000000000002a34
- (void)updateIndicatorDotForState;	// IMP=0x00000000000029a0
- (void)_updateImage;	// IMP=0x0000000000002936
- (double)contentSizeScaleFactor;	// IMP=0x00000000000028de
- (double)cornerButtonSize;	// IMP=0x000000000000289f
- (void)_setupButton;	// IMP=0x000000000000266d
- (id)_backgroundColorBehindText;	// IMP=0x0000000000002654
- (id)_defaultSymbolName;	// IMP=0x0000000000002647
- (id)_symbolNameForItem;	// IMP=0x00000000000025f7
- (id)imageForButton;	// IMP=0x0000000000002519
- (void)_setupGestures;	// IMP=0x00000000000024c3
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000002465
- (void)didMoveToWindow;	// IMP=0x0000000000002324
- (id)initWithFrame:(struct CGRect)arg1 resultItem:(id)arg2;	// IMP=0x00000000000021ac
- (void)dealloc;	// IMP=0x0000000000002060
