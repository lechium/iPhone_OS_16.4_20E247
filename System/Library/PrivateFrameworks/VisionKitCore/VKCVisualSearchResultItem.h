...
- (void).cxx_destruct;	// IMP=0x0000000000048099
...
- (_Bool)_hasFocalPoint;	// IMP=0x0000000000047bf6
...
- (id)initWithSearchResultItem:(id)arg1;	// IMP=0x0000000000047a3a
- (id)initWithGatingResultItem:(id)arg1 domain:(id)arg2;	// IMP=0x00000000000479a1
