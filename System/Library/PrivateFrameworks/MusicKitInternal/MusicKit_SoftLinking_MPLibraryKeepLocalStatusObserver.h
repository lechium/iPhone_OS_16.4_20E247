...
- (void).cxx_destruct;	// IMP=0x0000000000007b35
...
- (void)_handleUpdatedUnderlyingActiveKeepLocalStatus:(struct MPLibraryActiveKeepLocalStatus)arg1;	// IMP=0x0000000000007a99
- (struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus)_activeKeepLocalStatusFromUnderlyingStatus:(struct MPLibraryActiveKeepLocalStatus)arg1 underlyingDownloadPauseReasons:(unsigned long long)arg2;	// IMP=0x0000000000007a72
- (void)calculateDownloadProgressWithChildren:(id)arg1;	// IMP=0x00000000000077f5
@property(readonly, nonatomic) struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x00000000000072f9
