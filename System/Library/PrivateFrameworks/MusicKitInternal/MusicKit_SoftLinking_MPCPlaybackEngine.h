...
- (void).cxx_destruct;	// IMP=0x0000000000003116
...
- (void)restoreStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000030d3
- (void)becomeActive;	// IMP=0x00000000000030bd
- (void)start;	// IMP=0x00000000000030a7
- (void)setStateRestorationSupported:(_Bool)arg1;	// IMP=0x0000000000003091
- (void)setVideoSupported:(_Bool)arg1;	// IMP=0x0000000000003065
- (void)setPictureInPictureSupported:(_Bool)arg1;	// IMP=0x0000000000003039
- (void)setAudioAnalyzerEnabled:(_Bool)arg1;	// IMP=0x000000000000300d
- (void)setSystemMusicApplication:(_Bool)arg1;	// IMP=0x0000000000002fe1
@property(readonly, nonatomic, getter=isStarted) _Bool started;
@property(readonly, copy, nonatomic) NSString *playerID;
- (id)initWithPlayerID:(id)arg1 options:(unsigned long long)arg2 fallbackPlaybackIntent:(id)arg3;	// IMP=0x0000000000002d87
