...
- (void).cxx_destruct;	// IMP=0x000000000000b3a3
...
- (long long)_libraryAddStatusFromUnderlyingStatus:(long long)arg1;	// IMP=0x000000000000b36c
- (void)_handleUpdatedUnderlyingLibraryAddStatus:(long long)arg1;	// IMP=0x000000000000b337
@property(readonly, nonatomic) long long currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x000000000000af13
