...
- (void).cxx_destruct;	// IMP=0x000000000000478c
...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000043fd
- (id)initWithModelObject:(id)arg1 children:(id)arg2;	// IMP=0x0000000000004352
