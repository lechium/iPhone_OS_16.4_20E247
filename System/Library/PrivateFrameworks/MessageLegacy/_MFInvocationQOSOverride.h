...
- (_Bool)removeOverride;	// IMP=0x00000000000183e6
- (void)applyOverrideWhileForeground:(_Bool)arg1;	// IMP=0x0000000000018339
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000182ce
- (unsigned long long)hash;	// IMP=0x00000000000182bc
- (void)dealloc;	// IMP=0x000000000001827e
- (id)initWithPthread:(struct _opaque_pthread_t *)arg1 desiredQoS:(unsigned int)arg2 lowPriority:(_Bool)arg3;	// IMP=0x000000000001822b
