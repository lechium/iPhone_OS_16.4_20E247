...
- (void).cxx_destruct;	// IMP=0x00000000000e8650
- (id)init;	// IMP=0x00000000000e8600
- (id)initWithTitle:(id)arg1 image:(id)arg2 actionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e8550
