...
@protocol SBScenePresenting <NSObject, BSCancellable>
- (NSError *)presentScene:(FBScene *)arg1 viewControllerBuilderBlock:(SBTraitsOrientedContentViewController * (^)(void))arg2;
