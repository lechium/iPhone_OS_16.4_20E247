...
+ (id)fetchRequest;	// IMP=0x006000000001a52a
+ (id)predicateForKey:(id)arg1;	// IMP=0x006000000001a505
+ (id)insertIntoManagedObjectContext:(id)arg1;	// IMP=0x006000000001a46a
