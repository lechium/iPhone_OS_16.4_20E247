...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001386e
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000137f7
- (id)initWithCacheContainer:(id)arg1 persistentContainer:(id)arg2;	// IMP=0x0000000000013779
