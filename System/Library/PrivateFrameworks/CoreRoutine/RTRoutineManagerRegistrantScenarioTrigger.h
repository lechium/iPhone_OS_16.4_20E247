...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x000000000001e118
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000001e04a
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001de7f
- (id)init;	// IMP=0x000000000001de22
