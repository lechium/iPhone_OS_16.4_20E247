...
- (void).cxx_destruct;	// IMP=0x000000000009bda0
- (id)computeCaptionForImageWithInputs:(id)arg1 genderOption:(int)arg2;	// IMP=0x000000000009aed0
- (void)extractBeamID:(id *)arg1 tokenID:(id *)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 fromFollowup:(id)arg5;	// IMP=0x000000000009ac90
- (id)packBeamID:(id)arg1 tokenID:(id)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 softmax:(CDStruct_0a65202a *)arg5;	// IMP=0x000000000009a9a0
- (void)dealloc;	// IMP=0x000000000009a900
- (id)initWithOptions:(id)arg1 runTimeParams:(id)arg2;	// IMP=0x0000000000099c40
