...
- (id).cxx_construct;	// IMP=0x00000000000713e0
- (void).cxx_destruct;	// IMP=0x00000000000712f0
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000070920
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070780
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070560
- (void)copyOutputState:(id)arg1;	// IMP=0x000000000006f640
- (void)copyInputState:(id)arg1;	// IMP=0x000000000006e9b0
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x000000000006b160
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x0000000000069ea0
- (void)dealloc;	// IMP=0x0000000000069d80
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x0000000000069b60
