...
+ (id)_getQueue;	// IMP=0x0060000000067a80
+ (void)applyWordLanguageModelProbabilityToPath:(id)arg1 stemmedFromPath:(id)arg2 isCommittingToken:(_Bool)arg3;	// IMP=0x0060000000066280
- (id).cxx_construct;	// IMP=0x0000000000067dd0
- (void).cxx_destruct;	// IMP=0x0000000000067cd0
...
- (float)_wordLanguageModelLogProbabilityForString:(id)arg1 originalWordRanges:(id)arg2 originalWordIDs:(vector_3b74075b)arg3 wordRanges:(id)arg4 wordIDs:(vector_3b74075b)arg5;	// IMP=0x0000000000066d60
- (void)_updateLexiconLogProbabilityForString:(id)arg1 stemmingFromPath:(id)arg2;	// IMP=0x00000000000658a0
- (void)_updateCharacterLanguageModelLogProbabilityForString:(id)arg1 stemmingFromPath:(id)arg2 normalizedCodepoint:(unsigned int)arg3;	// IMP=0x0000000000065630
- (id)pathByExtendingWithString:(id)arg1 extendedPathString:(id)arg2 blankLogProb:(double)arg3 nonBlankLogProb:(double)arg4 timestep:(long long)arg5 commitAction:(long long)arg6 symbolLogProb:(double)arg7;	// IMP=0x0000000000064c10
- (id)childPathWithBlankLogProb:(double)arg1;	// IMP=0x0000000000064550
- (void)updateLastTokenWithMaxActivation:(long long)arg1 totalLogProbability:(double)arg2 tokenBoundaryLogProbability:(double)arg3;	// IMP=0x0000000000064500
- (void)merge:(id)arg1 logProbCumulator:(CDUnknownBlockType)arg2;	// IMP=0x00000000000642b0
- (long long)compare:(id)arg1;	// IMP=0x0000000000064250
- (id)debugDescription;	// IMP=0x0000000000064110
- (id)description;	// IMP=0x0000000000063fe0
- (id)tokensWithTimestep:(long long)arg1 isFinalTimestep:(_Bool)arg2;	// IMP=0x0000000000063a90
- (void)commitTokenAtTimestep:(long long)arg1 currentSymbolLogProbability:(double)arg2 commitAction:(long long)arg3 string:(id)arg4 stemmingFromPath:(id)arg5;	// IMP=0x0000000000063320
- (unsigned long long)_currentTokenStringLength;	// IMP=0x0000000000063280
...
- (double)scoreForTokenIndex:(long long)arg1;	// IMP=0x0000000000063190
@property double lastTokenBoundaryLogProbability;
- (_Bool)hasProblematicMixedScriptWords;	// IMP=0x00000000000630f0
- (double)lexiconScore;	// IMP=0x00000000000630d0
@property(readonly) double normalizedTotalLogProbability;
- (double)modelLogProbability;	// IMP=0x0000000000063030
- (long long)tokenCount;	// IMP=0x0000000000063010
- (long long)pseudoSpaceCount;	// IMP=0x0000000000062ff0
- (long long)characterCount;	// IMP=0x0000000000062fd0
- (void)setPseudoSpaceCount:(long long)arg1;	// IMP=0x0000000000062f50
- (void)setCharacterCount:(long long)arg1;	// IMP=0x0000000000062f30
- (void)setWordLanguageModelLogProbability:(double)arg1;	// IMP=0x0000000000062f10
- (void)setCharacterLanguageModelLogProbability:(double)arg1;	// IMP=0x0000000000062ef0
- (void)dealloc;	// IMP=0x0000000000062e60
- (id)initWithLanguageResourceBundle:(id)arg1 scoringFunction:(CDUnknownBlockType)arg2 initialCharacterLMState:(struct CVNLPLanguageModelWithState *)arg3 characterTokenIDs:(vector_3b74075b)arg4 wordTokenIDs:(vector_3b74075b)arg5 optimizingAlignment:(_Bool)arg6 hasContext:(_Bool)arg7;	// IMP=0x0000000000062c80
