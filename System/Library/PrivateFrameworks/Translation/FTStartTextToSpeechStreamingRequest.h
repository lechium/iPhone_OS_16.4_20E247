...
- (void).cxx_destruct;	// IMP=0x0000000000109f5c
- (id)flatbuffData;	// IMP=0x0000000000109de4
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000001092e1
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000108981
- (unsigned long long)context_info_count;	// IMP=0x00000000001088dc
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001087e4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000108359
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000001081a5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000010818f
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000108174
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000010815c
