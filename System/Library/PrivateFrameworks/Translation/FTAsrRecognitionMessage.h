...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000072a72
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000072a38
- (void).cxx_destruct;	// IMP=0x0000000000073a80
- (id)flatbuffData;	// IMP=0x0000000000073908
- (Offset_b5e03a40)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000072e46
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000071361
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000071193
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2;	// IMP=0x000000000007117d
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000071162
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000007114a
