...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017596a
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x0010000000175930
- (void).cxx_destruct;	// IMP=0x00000000001760ff
- (id)flatbuffData;	// IMP=0x0000000000175f87
- (Offset_3fe3bcde)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000175b08
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000174ff5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000174e27
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingResponse *)arg2;	// IMP=0x0000000000174e11
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000174df6
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000174dde
