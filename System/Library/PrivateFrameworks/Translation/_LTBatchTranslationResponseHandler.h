...
@interface _LTBatchTranslationResponseHandler : NSObject
{
    ...
    NSString *_logIdentifier;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0000000000035d0f
...
- (void)callCompletionHandlersWithError:(id)arg1;	// IMP=0x0000000000035761
- (void)streamFailVerifyBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x000000000003563f
- (void)streamDidReceiveBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x00000000000347a0
