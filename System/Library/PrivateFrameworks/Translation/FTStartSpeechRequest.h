...
- (void).cxx_destruct;	// IMP=0x00000000000be672
- (id)flatbuffData;	// IMP=0x00000000000be4fa
- (Offset_b7f57b05)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000bda9f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bd032
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000bce7e
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2;	// IMP=0x00000000000bce68
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bce4d
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bce35
