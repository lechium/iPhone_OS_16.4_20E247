...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007a83a
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x001000000007a800
- (void).cxx_destruct;	// IMP=0x000000000007b2d2
- (id)flatbuffData;	// IMP=0x000000000007b15a
- (Offset_a99fc554)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000007aaa6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000799f0
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000079822
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2;	// IMP=0x000000000007980c
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000797f1
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000797d9
