...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017180a
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x00100000001717d0
- (void).cxx_destruct;	// IMP=0x00000000001720d7
- (id)flatbuffData;	// IMP=0x0000000000171f5f
- (Offset_3f5da55c)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000001719fe
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000170ca7
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000170ad9
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2;	// IMP=0x0000000000170ac3
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000170aa8
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000170a90
