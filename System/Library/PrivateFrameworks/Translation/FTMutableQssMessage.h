...
+ (long long)container_message_typeForObject:(id)arg1;	// IMP=0x00600000000ab2f9
+ (long long)container_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000aaead
+ (Class)container_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000aae73
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a9136
- (id)init;	// IMP=0x00000000000a90a8
