...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018dcad
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018da91
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018da57
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018cc34
- (id)init;	// IMP=0x000000000018cba6
