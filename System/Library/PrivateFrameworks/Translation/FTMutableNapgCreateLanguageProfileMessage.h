...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00000000000a5c4e
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00000000000a5bc1
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00000000000a5b81
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a5754
- (id)init;	// IMP=0x00000000000a56c6
