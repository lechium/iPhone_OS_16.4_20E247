...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001866fe
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018650a
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x00600000001864d0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001857ac
- (id)init;	// IMP=0x000000000018571e
