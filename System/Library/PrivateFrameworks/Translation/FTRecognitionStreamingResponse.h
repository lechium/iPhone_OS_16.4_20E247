...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000172f72
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x0010000000172f38
- (void).cxx_destruct;	// IMP=0x00000000001738d8
- (id)flatbuffData;	// IMP=0x0000000000173760
- (Offset_48f69b49)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017318e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000172316
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000172148
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2;	// IMP=0x0000000000172132
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000172117
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001720ff
