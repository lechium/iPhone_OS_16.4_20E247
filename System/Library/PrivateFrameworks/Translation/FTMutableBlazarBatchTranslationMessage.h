...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a3840
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a36ec
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a36b2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a2d8a
- (id)init;	// IMP=0x00000000000a2cfc
