...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018adfb
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018ac85
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018ac4b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018a224
- (id)init;	// IMP=0x000000000018a196
