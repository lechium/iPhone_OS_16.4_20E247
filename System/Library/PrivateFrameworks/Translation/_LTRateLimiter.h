...
- (void)markPageLoaded;	// IMP=0x000000000004385c
- (_Bool)allowedForRequests:(unsigned long long)arg1;	// IMP=0x0000000000043842
- (id)initWithMaximumPageLoadRequest:(unsigned long long)arg1 maximumDynamicContentRequests:(long long)arg2;	// IMP=0x00000000000437d2
