...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a0845
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a05d9
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a059f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009f57e
- (id)init;	// IMP=0x000000000009f4f0
