...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000e384
+ (id)GetDefaultEndpointerFeaturesForEndpointer:(id)arg1;	// IMP=0x001000000000e298
- (void).cxx_destruct;	// IMP=0x000000000000e40d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000e1cc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000dfff
- (id)initWithResponse:(id)arg1;	// IMP=0x000000000000df08
