...
- (void).cxx_destruct;	// IMP=0x00000000000ec39b
- (id)flatbuffData;	// IMP=0x00000000000ec223
- (Offset_adec5a97)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000ebd9a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eb79f
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000eb5eb
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2;	// IMP=0x00000000000eb5d5
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000eb5ba
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000eb5a2
