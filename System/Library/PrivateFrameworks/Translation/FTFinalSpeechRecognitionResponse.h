...
- (void).cxx_destruct;	// IMP=0x00000000000bc3a4
- (id)flatbuffData;	// IMP=0x00000000000bc22c
- (Offset_53990046)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000bbe0e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bb87e
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000bb6ca
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2;	// IMP=0x00000000000bb6b4
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bb699
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bb681
