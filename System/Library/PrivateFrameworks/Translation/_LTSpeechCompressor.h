...
- (void).cxx_destruct;	// IMP=0x0000000000047e48
- (void)addAudioSampleData:(id)arg1;	// IMP=0x0000000000047b07
- (void)reset;	// IMP=0x0000000000047ac8
- (void)startCompressionNarrowband:(_Bool)arg1;	// IMP=0x0000000000047a0f
- (void)dealloc;	// IMP=0x00000000000479d1
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000047956
