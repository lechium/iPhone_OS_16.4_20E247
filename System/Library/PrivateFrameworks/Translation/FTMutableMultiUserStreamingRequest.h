...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000188dfd
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000188c31
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000188bf7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000187fd2
- (id)init;	// IMP=0x0000000000187f44
