...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a48af
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a47d9
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a479f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a4174
- (id)init;	// IMP=0x00000000000a40e6
