...
- (void)profile_blob:(CDUnknownBlockType)arg1;	// IMP=0x000000000013ff9f
@property(copy, nonatomic) NSData *profile_blob;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013fe88
- (id)init;	// IMP=0x000000000013fdfa
