...
- (id)flatbuffData;	// IMP=0x000000000010488a
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000103dfd
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000010349d
- (unsigned long long)context_info_count;	// IMP=0x00000000001033f8
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000103300
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000102ee3
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000102d2f
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x0000000000102d19
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000102cfe
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000102ce6
