...
- (void).cxx_destruct;	// IMP=0x0000000000052f0d
...
- (double)score;	// IMP=0x0000000000052edd
- (id)initWithLocale:(id)arg1 confidence:(double)arg2 wordCount:(long long)arg3;	// IMP=0x0000000000052d1a
