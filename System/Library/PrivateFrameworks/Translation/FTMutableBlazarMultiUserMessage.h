...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009ef1e
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009ebea
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009ebb0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009d694
- (id)init;	// IMP=0x000000000009d606
