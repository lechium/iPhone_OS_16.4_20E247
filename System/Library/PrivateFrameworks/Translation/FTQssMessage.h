...
+ (long long)container_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000008743e
+ (Class)container_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000087404
- (void).cxx_destruct;	// IMP=0x00000000000886cf
- (id)flatbuffData;	// IMP=0x0000000000088557
- (Offset_eabeea59)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000008788a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000085899
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000856cb
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2;	// IMP=0x00000000000856b5
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000008569a
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000085682
