...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a7916
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a7818
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a77de
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a70b4
- (id)init;	// IMP=0x00000000000a7026
