...
- (void).cxx_destruct;	// IMP=0x000000000000572d
...
- (void)writeToURL:(id)arg1;	// IMP=0x000000000000550d
- (_Bool)_populateWithOpusData:(id)arg1;	// IMP=0x00000000000052ae
- (id)initWithASBD:(struct AudioStreamBasicDescription)arg1 rawData:(id)arg2 wordTimingInfo:(id)arg3;	// IMP=0x0000000000005193
