...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007c932
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x001000000007c8f8
- (void).cxx_destruct;	// IMP=0x000000000007d766
- (id)flatbuffData;	// IMP=0x000000000007d5ee
- (Offset_a55c7777)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000007cc8e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007b511
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000007b343
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2;	// IMP=0x000000000007b32d
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000007b312
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000007b2fa
