...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017a1a6
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017a16c
- (void).cxx_destruct;	// IMP=0x000000000017ab0c
- (id)flatbuffData;	// IMP=0x000000000017a994
- (Offset_3523418e)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017a3c2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000179549
- (id)initWithFlatbuffData:(id)arg1 root:(const struct SpeechTranslationStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017937b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct SpeechTranslationStreamingResponse *)arg2;	// IMP=0x0000000000179365
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017934a
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000179332
