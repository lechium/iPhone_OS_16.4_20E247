...
- (void)_manageSharingOfTouchesBetweenClientAndHostContext;	// IMP=0x000000000000ce56
- (void)didMoveToWindow;	// IMP=0x000000000000ce44
@property(retain, nonatomic) PGHostedWindowHostingHandle *hostedWindowHostingHandle;
- (void)dealloc;	// IMP=0x000000000000cd0d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000cc7b
