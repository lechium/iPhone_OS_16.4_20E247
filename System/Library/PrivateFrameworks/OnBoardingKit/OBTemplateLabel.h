...
- (void)updateTextAlignment;	// IMP=0x0000000000018b13
- (void)setTitleTrailingSymbol:(id)arg1;	// IMP=0x00000000000188e2
- (void)setText:(id)arg1;	// IMP=0x000000000001887b
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000187c0
- (id)init;	// IMP=0x000000000001875d
