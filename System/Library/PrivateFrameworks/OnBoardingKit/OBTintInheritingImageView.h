...
- (void)tintColorDidChange;	// IMP=0x000000000002f90a
- (void)setImage:(id)arg1;	// IMP=0x000000000002f8a8
- (id)initWithImage:(id)arg1 highlightedImage:(id)arg2 tintColor:(id)arg3;	// IMP=0x000000000002f7ba
