...
- (void).cxx_destruct;	// IMP=0x000000000000a92b
@property(retain, nonatomic) NSURL *destinationLink; // @synthesize destinationLink=_destinationLink;
@property(retain, nonatomic) UITapGestureRecognizer *tapRecognizer; // @synthesize tapRecognizer=_tapRecognizer;
- (void)setLearnMoreURL:(id)arg1;	// IMP=0x000000000000a564
- (void)_linkTapped:(id)arg1;	// IMP=0x000000000000a4e4
- (id)init;	// IMP=0x000000000000a450
