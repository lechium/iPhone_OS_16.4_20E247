...
- (void).cxx_destruct;	// IMP=0x00000000000065e6
...
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000006221
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x0000000000005feb
- (id)init;	// IMP=0x0000000000005f85
