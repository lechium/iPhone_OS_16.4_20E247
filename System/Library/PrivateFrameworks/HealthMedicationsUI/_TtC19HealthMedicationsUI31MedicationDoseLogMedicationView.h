...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000362d0
- (void)didTapUnitTime:(id)arg1;	// IMP=0x0000000000035b10
- (void)didTapRecord:(id)arg1;	// IMP=0x0000000000035a90
- (void)didTapSkip:(id)arg1;	// IMP=0x00000000000359a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000035860
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000035840
