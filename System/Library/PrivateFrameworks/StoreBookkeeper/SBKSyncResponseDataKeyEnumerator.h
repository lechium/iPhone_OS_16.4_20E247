...
- (void).cxx_destruct;	// IMP=0x000000000001d375
...
- (void)_processNextKey;	// IMP=0x000000000001d1bb
- (void)_processDeletedKey:(id)arg1 isDirty:(_Bool *)arg2;	// IMP=0x000000000001d13f
- (void)_processUpdatedKey:(id)arg1 isConflict:(_Bool)arg2 isDirty:(_Bool *)arg3;	// IMP=0x000000000001d087
- (void)enumerateKeysInResponseForTransaction:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000001cf40
- (id)initWithResponseData:(id)arg1;	// IMP=0x000000000001ced5
