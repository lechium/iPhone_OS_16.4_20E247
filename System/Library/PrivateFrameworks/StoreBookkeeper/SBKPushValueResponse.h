...
+ (id)responseWithResponse:(id)arg1 transaction:(id)arg2;	// IMP=0x006000000001ba52
- (void).cxx_destruct;	// IMP=0x000000000001bc95
...
- (void)deserializeResponseBodyWithTransaction:(id)arg1;	// IMP=0x000000000001bac6
