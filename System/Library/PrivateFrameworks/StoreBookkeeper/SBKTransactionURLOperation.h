...
+ (id)operationWithRequest:(id)arg1 delegate:(id)arg2;	// IMP=0x006000000000d3dd
- (void).cxx_destruct;	// IMP=0x000000000000d3ca
@property(retain, nonatomic) SBKRequest *SBKRequest; // @synthesize SBKRequest=_SBKRequest;
- (id)description;	// IMP=0x000000000000d2f6
@property(nonatomic) _Bool shouldAuthenticate; // @synthesize shouldAuthenticate=_shouldAuthenticate;
- (id)_init;	// IMP=0x000000000000d127
- (id)init;	// IMP=0x000000000000d0a0
