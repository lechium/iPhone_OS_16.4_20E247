...
+ (id)readValueFromKeyValuePair:(id)arg1;	// IMP=0x00100000000163c4
+ (int)keyValuePairType;	// IMP=0x00100000000163b9
- (void)writeToKeyValuePair:(id)arg1;	// IMP=0x00100000000163d9
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000153f5
