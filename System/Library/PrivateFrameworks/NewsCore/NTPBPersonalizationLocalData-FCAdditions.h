...
+ (id)readValueFromKeyValuePair:(id)arg1;	// IMP=0x00200000002b42bf
+ (int)keyValuePairType;	// IMP=0x00200000002b42b4
...
- (void)writeToKeyValuePair:(id)arg1;	// IMP=0x00100000002b42d4
@end
