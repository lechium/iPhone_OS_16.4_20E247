...
- (void)sendAceCommand:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005ab9
- (id)initWithIntent:(id)arg1 extensionProxy:(id)arg2 queue:(id)arg3;	// IMP=0x0000000000005a09
- (id)initWithVoiceShortcutClient:(id)arg1 intent:(id)arg2;	// IMP=0x0000000000005970
