...
+ (Class)layerClass;	// IMP=0x00600000000165ed
- (void).cxx_destruct;	// IMP=0x00000000000171df
...
- (void)updateConstraints;	// IMP=0x0000000000016960
- (void)_updateReplicatorLayer;	// IMP=0x00000000000167fa
- (void)updateInstanceCount:(unsigned long long)arg1 replicationPaddingX:(double)arg2;	// IMP=0x00000000000166f6
- (id)initWithFrame:(struct CGRect)arg1 targetView:(id)arg2;	// IMP=0x00000000000165fe
