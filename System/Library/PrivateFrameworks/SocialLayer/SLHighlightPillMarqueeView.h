...
- (void).cxx_destruct;	// IMP=0x0000000000018810
...
- (void)_deactivateMarqueeAnimationIfNecessary;	// IMP=0x00000000000185fd
- (void)_activateMarqueeAnimationIfNecessary;	// IMP=0x0000000000018330
- (void)updateConstraints;	// IMP=0x00000000000178e2
- (void)layoutSubviews;	// IMP=0x00000000000175ed
- (id)initWithFrame:(struct CGRect)arg1 pillView:(id)arg2;	// IMP=0x0000000000017243
