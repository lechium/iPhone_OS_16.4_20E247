...
- (id).cxx_construct;	// IMP=0x000000000075015e
- (void).cxx_destruct;	// IMP=0x0000000000750136
...
- (id)detailedDescription;	// IMP=0x000000000074ff52
...
- (void)projectFromLocation:(id)arg1 routeMatch:(id)arg2 speedMultiplier:(double)arg3 routeLine:(id)arg4;	// IMP=0x000000000074f776
- (void)_updateCourseAndPositionFromRouteMatch:(id)arg1;	// IMP=0x000000000074f4f6
- (void)reset;	// IMP=0x000000000074f49a
- (void)dealloc;	// IMP=0x000000000074f427
- (id)init;	// IMP=0x000000000074f3ab
