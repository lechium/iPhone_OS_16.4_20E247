...
- (id).cxx_construct;	// IMP=0x00000000007932ea
- (void).cxx_destruct;	// IMP=0x00000000007932bb
...
- (id)description;	// IMP=0x000000000079317e
- (id)displayGroup;	// IMP=0x0000000000792fcc
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000792fbb
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000792f89
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x0000000000792e48
