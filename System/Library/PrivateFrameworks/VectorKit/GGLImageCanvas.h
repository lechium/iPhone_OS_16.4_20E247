...
- (id).cxx_construct;	// IMP=0x0000000000564a32
- (void).cxx_destruct;	// IMP=0x00000000005648a3
...
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x0000000000564722
- (void)didDrawView;	// IMP=0x0000000000564718
- (void)willDrawView;	// IMP=0x00000000005646bc
- (void)renderWithTimestamp:(double)arg1 presentAtTime:(double)arg2 completion:(function_2e574590)arg3;	// IMP=0x000000000056420c
- (_Bool)hasRenderTarget;	// IMP=0x00000000005641fb
- (void)destroyRenderTarget;	// IMP=0x000000000056404b
- (void)createRenderTarget;	// IMP=0x00000000005634e7
- (struct __IOSurface *)flipImage;	// IMP=0x0000000000563331
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x0000000000563131
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x00000000005630c7
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 signpostId:(unsigned long long)arg7;	// IMP=0x0000000000562446
- (void *)_internalRenderTarget;	// IMP=0x000000000056243c
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void)willDealloc;	// IMP=0x0000000000562033
- (void *)finalSurface;	// IMP=0x0000000000562029
