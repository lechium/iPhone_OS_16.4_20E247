...
- (id).cxx_construct;	// IMP=0x0000000000630e65
- (void).cxx_destruct;	// IMP=0x0000000000630e3d
...
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x0000000000630d4f
