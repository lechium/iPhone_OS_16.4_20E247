...
- (id).cxx_construct;	// IMP=0x00000000006c5c7a
- (void).cxx_destruct;	// IMP=0x00000000006c5c00
- (void)purgeExpired:(double)arg1;	// IMP=0x00000000006c5b7b
- (void)reportCorruptTile:(const struct _GEOTileKey *)arg1;	// IMP=0x00000000006c5b65
- (void)cancelRequests;	// IMP=0x00000000006c5aaf
- (void)updateJobPriority:(void *)arg1;	// IMP=0x00000000006c59f8
- (void)cancelJob:(void *)arg1;	// IMP=0x00000000006c5938
- (void)fetchDataForJob:(void *)arg1;	// IMP=0x00000000006c507f
- (shared_ptr_97fa0047)getJobForKey:(const struct _GEOTileKey *)arg1;	// IMP=0x00000000006c5005
- (id)initWithToken:(id)arg1;	// IMP=0x00000000006c4e4a
