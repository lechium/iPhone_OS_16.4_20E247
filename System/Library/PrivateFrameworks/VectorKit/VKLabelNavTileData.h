...
- (id).cxx_construct;	// IMP=0x000000000079ad5a
- (void).cxx_destruct;	// IMP=0x000000000079ad00
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x000000000079a4ea
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x000000000079a360
- (void)initializeJunctionInfos;	// IMP=0x000000000079a001
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000799e38
- (void)_findTileEdgeJunctions;	// IMP=0x0000000000799d1e
- (void)addJunction:(id)arg1;	// IMP=0x0000000000799c8a
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000799af4
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x0000000000799ade
- (id)initWithTile:(const void *)arg1;	// IMP=0x00000000007999e4
