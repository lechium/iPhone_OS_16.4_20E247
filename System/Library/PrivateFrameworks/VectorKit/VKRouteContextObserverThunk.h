...
- (id).cxx_construct;	// IMP=0x00000000004fdef2
- (void).cxx_destruct;	// IMP=0x00000000004fded8
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x00000000004fde2e
- (void)dealloc;	// IMP=0x00000000004fddb2
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x00000000004fdcfb
