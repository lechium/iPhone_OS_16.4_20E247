...
- (id).cxx_construct;	// IMP=0x000000000032cb2f
- (void).cxx_destruct;	// IMP=0x000000000032cadc
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000032c839
- (void)resumeAnimation;	// IMP=0x000000000032c73e
- (void)pauseAnimation;	// IMP=0x000000000032c6dd
- (_Bool)isAnimating;	// IMP=0x000000000032c679
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x000000000032c5e3
- (void)stopTrackingAnnotation;	// IMP=0x000000000032c47b
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x000000000032c0da
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x000000000032c0d4
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x000000000032c0ce
- (void)updateFramerate;	// IMP=0x000000000032bfb4
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x000000000032be5c
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x000000000032bdff
