...
- (id).cxx_construct;	// IMP=0x00000000007581fc
- (void).cxx_destruct;	// IMP=0x00000000007581d8
@property(nonatomic) __weak id <VKMercatorTerrainHeightProvider> heightProvider; // @synthesize heightProvider=_heightProvider;
- (void)invalidateRect:(const void *)arg1;	// IMP=0x00000000007580d1
- (void)removeCachedValueForAnchor:(void *)arg1;	// IMP=0x0000000000758075
- (double)heightForAnchor:(void *)arg1;	// IMP=0x0000000000757efe
