...
- (id).cxx_construct;	// IMP=0x000000000075666f
- (void).cxx_destruct;	// IMP=0x00000000007563a8
...
- (struct __IOSurface *)flipImage;	// IMP=0x000000000075635c
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000007562a1
- (struct CGPoint)convertPoint:(struct CGPoint)arg1 toLayer:(id)arg2;	// IMP=0x000000000075628b
@property(readonly, nonatomic) float averageFPS;
- (void)renderWithTimestamp:(double)arg1 presentAtTime:(double)arg2 completion:(function_2e574590)arg3;	// IMP=0x0000000000755c2f
- (_Bool)hasRenderTarget;	// IMP=0x0000000000755c21
- (void)destroyRenderTarget;	// IMP=0x0000000000755b6a
- (void)createRenderTarget;	// IMP=0x0000000000755a95
...
- (void)didEnterBackground;	// IMP=0x00000000007558a4
- (void)didReceiveMemoryWarning;	// IMP=0x000000000075589e
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x000000000075581e
- (void)_didReadPixels:(void *)arg1;	// IMP=0x00000000007556f3
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000007550bd
- (void)setBackgroundColor:(struct CGColor *)arg1;	// IMP=0x00000000007550a7
- (void)setContentsGravity:(id)arg1;	// IMP=0x0000000000755091
- (void)setOpaque:(_Bool)arg1;	// IMP=0x000000000075507b
- (void)setNeedsDisplayOnBoundsChange:(_Bool)arg1;	// IMP=0x0000000000755065
- (void)expandedPerformanceHUD:(id)arg1;	// IMP=0x0000000000754fff
- (void)disablePerformanceHUD:(id)arg1;	// IMP=0x0000000000754fe8
- (void)enablePerformanceHUD:(id)arg1;	// IMP=0x0000000000754fce
@property(readonly, nonatomic) void *renderer;
- (void)didPresent;	// IMP=0x0000000000754db7
- (void)willPresent;	// IMP=0x0000000000754d13
- (void)didUpdateFrameTexture;	// IMP=0x0000000000754c6f
- (void)willUpdateFrameTexture;	// IMP=0x0000000000754bcb
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000007547a4
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2;	// IMP=0x000000000075478f
- (void *)_renderQueueForTimestamp:(double)arg1 prepareHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000007546f9
- (void *)renderQueueForTimestamp:(double)arg1;	// IMP=0x00000000007546cd
- (_Bool)isDelayedRenderQueueConsumptionSupported;	// IMP=0x0000000000754682
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x0000000000753c80
- (void)prepareTargetsForPlatormsWithFramebufferFetch:(const void *)arg1;	// IMP=0x000000000075395c
- (void)_prepareTexture:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000007538a9
- (void)prepareTexture:(const void *)arg1;	// IMP=0x0000000000753892
- (void)dealloc;	// IMP=0x000000000075361a
- (id)initWithContentScale:(double)arg1 useMultisampling:(_Bool)arg2 extraColorFormats:(const void *)arg3 shouldRasterize:(_Bool)arg4 allowBlitToDrawable:(_Bool)arg5 taskContext:(const void *)arg6 device:(void *)arg7 sharedResources:(id)arg8 signpostId:(unsigned long long)arg9;	// IMP=0x0000000000752cce
