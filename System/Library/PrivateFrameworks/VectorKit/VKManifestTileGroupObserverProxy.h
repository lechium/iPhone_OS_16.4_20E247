...
- (id).cxx_construct;	// IMP=0x000000000085e934
- (void).cxx_destruct;	// IMP=0x000000000085e8b7
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x000000000085e3c0
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x000000000085e2bd
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x000000000085e237
- (void)dealloc;	// IMP=0x000000000085e106
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000085dfee
