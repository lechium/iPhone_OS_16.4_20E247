...
- (id).cxx_construct;	// IMP=0x00000000000917d2
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000009158b
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000913df
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x000000000009133f
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x0000000000091223
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x0000000000091018
- (void)computeFromCamera:(id)arg1;	// IMP=0x0000000000090a01
