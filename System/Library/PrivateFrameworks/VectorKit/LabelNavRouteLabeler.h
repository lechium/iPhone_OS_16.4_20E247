...
- (id).cxx_construct;	// IMP=0x0000000000630c24
- (void).cxx_destruct;	// IMP=0x0000000000630abc
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x00000000006309c0
- (_Bool)_updateActiveRouteRange;	// IMP=0x000000000062fb32
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x000000000062f92f
- (void)_updateCurrentRoadInfo;	// IMP=0x000000000062f5ff
- (void)_initalizeCurrentRoadInfo;	// IMP=0x000000000062f5e2
- (void)_dedupOffRouteRoads;	// IMP=0x000000000062ed5f
- (void)_updatePreferredLabelPlacements;	// IMP=0x000000000062ea44
- (void)_updateRoadsInGuidance;	// IMP=0x000000000062e4ee
- (void)_updateRoadStarts;	// IMP=0x000000000062e056
- (void)_updateUniqueOffRouteRoads;	// IMP=0x000000000062dac2
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x000000000062ca65
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x000000000062bc43
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x000000000062b625
- (void)_addVisibleSigns;	// IMP=0x000000000062b561
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x0000000000628c68
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000628af2
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x00000000006289a7
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000062890f
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x0000000000627e04
- (void)styleManagerDidFinishAnimating;	// IMP=0x0000000000627df7
- (void)styleManagerDidStartAnimating;	// IMP=0x0000000000627de8
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x0000000000627dd1
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x000000000062759b
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x00000000006262cf
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x0000000000625e34
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x0000000000625cc4
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000625b4c
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x000000000062582d
- (void)_refreshGuidanceRoadNames;	// IMP=0x00000000006255a0
- (void)_reloadRouteJunctions;	// IMP=0x000000000062529b
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x00000000006251a8
- (_Bool)isNavMode;	// IMP=0x0000000000625190
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x000000000062500d
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x0000000000624e36
- (id)init;	// IMP=0x00000000006248a0
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000514378
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000005134f5
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000513382
- (_Bool)needsDebugDraw;	// IMP=0x000000000051328c
