...
- (id).cxx_construct;	// IMP=0x00000000005b1e2f
- (void).cxx_destruct;	// IMP=0x00000000005b1d67
...
- (double)boundsUnitsPerMeter;	// IMP=0x00000000005b1bb6
- (Matrix_08d701e4)maneuverTransform;	// IMP=0x00000000005b1b24
- (Matrix_08d701e4)inverseManeuverTransform;	// IMP=0x00000000005b1ad0
- (vector_9022e479)maneuverPoints;	// IMP=0x00000000005b1776
- (void)_updateBounds:(id)arg1 boundsInflation:(float)arg2;	// IMP=0x00000000005b0db9
- (void)forEachSection:(CDUnknownBlockType)arg1;	// IMP=0x00000000005b0cf3
- (void)splitRouteLineAtAnnotation:(id)arg1;	// IMP=0x00000000005b04b0
- (optional_db527fce)snapRouteMatch:(id)arg1;	// IMP=0x00000000005af8bd
- (_Bool)needsUpdateForViewingScale:(double)arg1;	// IMP=0x00000000005af79e
- (_Bool)isTrafficUptoDate:(double)arg1;	// IMP=0x00000000005af76f
- (_Bool)isTrafficUpToDate;	// IMP=0x00000000005af738
- (void)createMeshIfNecessary:(long long)arg1;	// IMP=0x00000000005af660
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2;	// IMP=0x00000000005af055
- (_Bool)buildRouteLine:(id)arg1 matchToRoads:(_Bool)arg2 shouldGenerateSnapPath:(_Bool)arg3 viewUnitsPerPoint:(double)arg4 force:(_Bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(_Bool)arg7 currentLegIndex:(unsigned int)arg8;	// IMP=0x00000000005ac71d
- (void)_updateTilesCovered:(id)arg1;	// IMP=0x00000000005ac4fa
@property(readonly, nonatomic) GEOComposedRoute *composedRoute;
- (void)dealloc;	// IMP=0x00000000005ac42e
- (id)initWithPolylineOverlay:(id)arg1;	// IMP=0x00000000005ac2fc
