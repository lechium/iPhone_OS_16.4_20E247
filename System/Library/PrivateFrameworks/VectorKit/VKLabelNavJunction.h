...
- (id).cxx_construct;	// IMP=0x0000000000745517
- (void).cxx_destruct;	// IMP=0x00000000007454bd
...
- (void)createLabelWithNavContext:(struct NavContext *)arg1 isDrivingSideRight:(_Bool)arg2 artworkCache:(void *)arg3;	// IMP=0x0000000000744d9a
- (void)prepareStyleVarsWithContext:(struct NavContext *)arg1;	// IMP=0x0000000000744b26
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible=_isVisible;
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000744abf
- (void)_updateWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000744aaa
- (void)_updateWithNavContext:(struct NavContext *)arg1 threshold:(double)arg2;	// IMP=0x0000000000744a2c
- (Mercator3_d8bb135c)_anchorCoordinateForSignOrientation:(unsigned char)arg1;	// IMP=0x0000000000744872
- (unsigned char)_signOrientationWithDrivingSide:(_Bool)arg1;	// IMP=0x00000000007444d0
...
- (void)evaluateCrossStreetsUsingRouteJunction:(id)arg1;	// IMP=0x00000000007437d0
- (void)evaluateCrossStreets;	// IMP=0x00000000007437bb
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge *)arg1 atA:(_Bool)arg2;	// IMP=0x0000000000743562
- (void)findRoads;	// IMP=0x0000000000742fbe
...
- (_Bool)matchesLocationForJunction:(id)arg1;	// IMP=0x00000000007428f9
- (id)description;	// IMP=0x0000000000742851
- (void)dealloc;	// IMP=0x00000000007427d8
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge *)arg1 atA:(_Bool)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const void *)arg4;	// IMP=0x0000000000742592
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction *)arg1 routeOffset:(struct PolylineCoordinate)arg2 tile:(const void *)arg3;	// IMP=0x0000000000742342
