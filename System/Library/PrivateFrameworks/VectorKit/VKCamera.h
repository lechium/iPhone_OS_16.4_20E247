...
- (id).cxx_construct;	// IMP=0x000000000008d1b7
- (void).cxx_destruct;	// IMP=0x000000000008d161
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x000000000008ce5b
- (CameraFrame_b765d6d7)cameraFrame;	// IMP=0x000000000008cce3
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x000000000008cc39
...
- (void)adjustClipPlanes;	// IMP=0x000000000008ca46
- (float)zoomAtCentrePoint;	// IMP=0x000000000008ca29
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x000000000008c97b
- (double)depthForViewWidth:(double)arg1;	// IMP=0x000000000008c94a
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x000000000008c921
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x000000000008c869
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x000000000008c6b1
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x000000000008c68f
- (void)updateIfNeeded;	// IMP=0x000000000008bc2f
- (void)setNeedsUpdate;	// IMP=0x000000000008bc00
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000008bbea
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x000000000008bbd4
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x000000000008bad5
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x000000000008b813
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x000000000008b232
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x000000000008b0d0
- (void)_setPosition:(const void *)arg1;	// IMP=0x000000000008b0a5
- (id)descriptionDictionaryRepresentation;	// IMP=0x000000000008ad84
- (id)description;	// IMP=0x000000000008abab
- (id)detailedDescription;	// IMP=0x000000000008ab99
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x000000000008aa10
