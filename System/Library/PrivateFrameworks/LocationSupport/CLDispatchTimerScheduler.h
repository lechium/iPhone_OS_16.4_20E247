...
- (void).cxx_destruct;	// IMP=0x000000000001905a
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000018f4a
- (void)dealloc;	// IMP=0x0000000000018ef9
- (id)initWithDispatchSilo:(id)arg1;	// IMP=0x0000000000018c76
