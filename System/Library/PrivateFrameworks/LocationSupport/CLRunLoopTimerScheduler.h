...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000008f87
- (void)dealloc;	// IMP=0x0000000000008f45
- (id)initWithRunLoopSilo:(id)arg1;	// IMP=0x0000000000008d20
