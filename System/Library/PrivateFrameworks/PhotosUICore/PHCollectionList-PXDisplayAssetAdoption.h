...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x0010000000887844
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x00100000008869c5
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x00100000008868fd
+ (id)px_mediaTypesCollectionList;	// IMP=0x00100000008868cd
+ (id)px_sharedAlbumsAndActivityCollectionList;	// IMP=0x001000000088689d
+ (id)px_sharedAlbumsCollectionList;	// IMP=0x001000000088686d
+ (id)px_rootAlbumCollectionList;	// IMP=0x0010000000886806
+ (id)px_rootProjectCollectionList;	// IMP=0x001000000088679f
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000885876
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x001000000088574a
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000885543
