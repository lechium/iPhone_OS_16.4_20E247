...
+ (id)px_fetchAssetCollectionsWithAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x0010000000888e0a
+ (id)px_fetchSmartAlbumCollectionsBySubtypeForAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000008889da
+ (id)px_contentSyndicationVirtualCollection;	// IMP=0x00100000008889aa
+ (id)px_importHistoryAssetCollection;	// IMP=0x001000000088897a
+ (id)px_sharedActivityVirtualCollection;	// IMP=0x001000000088894a
+ (id)px_completeMyMomentVirtualCollection;	// IMP=0x001000000088891a
+ (id)px_prototypeVirtualCollection;	// IMP=0x00100000008888ea
+ (id)px_searchVirtualCollection;	// IMP=0x00100000008888ba
+ (id)px_sharedAlbumsVirtualCollection;	// IMP=0x001000000088888a
+ (id)px_myAlbumsVirtualCollection;	// IMP=0x001000000088885a
+ (id)px_allAlbumsVirtualCollection;	// IMP=0x001000000088882a
+ (id)px_forYouVirtualCollection;	// IMP=0x00100000008887fa
+ (id)px_memoriesVirtualCollection;	// IMP=0x00100000008887ca
+ (id)px_peopleVirtualCollection;	// IMP=0x001000000088879a
+ (id)px_photosVirtualCollection;	// IMP=0x001000000088876a
+ (id)px_momentsVirtualCollection;	// IMP=0x001000000088873a
+ (id)px_fetchSmartAlbumWithSubtype:(long long)arg1;	// IMP=0x00100000008885d0
+ (id)px_smartAlbumWithSubtype:(long long)arg1;	// IMP=0x0010000000888580
+ (id)px_regularAlbumWithTitle:(id)arg1;	// IMP=0x001000000088847d
+ (id)px_otherAlbumsSubtypes;	// IMP=0x001000000088841a
+ (id)px_mediaTypeSmartAlbumSubtypes;	// IMP=0x00100000008883b7
+ (void)px_getType:(long long *)arg1 subtype:(long long *)arg2 forBuiltInAlbumName:(id)arg3;	// IMP=0x0010000000888050
+ (id)px_builtInAlbumNameForSubtype:(long long)arg1;	// IMP=0x0010000000887eb3
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x001000000063be56
...
- (void)px_assignStoryTitleCategoryIfNeeded;	// IMP=0x0010000000886799
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000886719
...
- (id)px_debugDictionary;	// IMP=0x0010000000885d81
- (unsigned long long)px_assetsDropMode;	// IMP=0x0010000000885ce4
- (_Bool)px_shouldUseFacesRectForSmartCropping;	// IMP=0x0010000000885cdc
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000885b99
