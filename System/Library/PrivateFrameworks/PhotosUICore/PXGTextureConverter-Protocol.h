...
- (PXGImageTexture *)createTextureFromCVPixelBuffer:(struct __CVBuffer *)arg1 transform:(CDStruct_0dd72924)arg2 options:(id *)arg3 error: /* Error: Ran out of types for this method. */;
- (PXGImageTexture *)createTextureFromCGImage:(struct CGImage *)arg1 transform:(CDStruct_0dd72924)arg2 options: /* Error: Ran out of types for this method. */;
@end
