...
+ (void)px_generateResourceFilesForAssets:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000003cbf9e
+ (id)addressWithoutUnitedStatesZipCode:(id)arg1;	// IMP=0x00100000003cbe30
+ (id)px_orderedAssetsFromAssets:(id)arg1 sortDescriptors:(id)arg2;	// IMP=0x00100000003cbbd9
+ (id)px_fetchPlacesAssetsInAssetCollection:(id)arg1 options:(id)arg2;	// IMP=0x00100000003cb8af
+ (id)px_fetchAssetsInArray:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000003cb7fd
@property(readonly, nonatomic) struct CGPoint positionOffset;
@property(readonly, nonatomic) struct CGAffineTransform transform;
- (float)px_playbackScore;	// IMP=0x00100000001316e8
- (double)weightUsingWeightingScheme:(long long)arg1;	// IMP=0x0010000000131456
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x00100000001313ff
@property(readonly, nonatomic) double weight;
@property(readonly, nonatomic) struct CGSize size;
- (_Bool)px_isRecommendationSeenForVariationType:(long long)arg1;	// IMP=0x0010000000303d14
- (_Bool)px_isVariationTypeRecommended:(long long)arg1;	// IMP=0x0010000000303bf1
- (id)px_coreDataBrowserURL;	// IMP=0x00100000003cae43
- (id)_userFeedbackScoreInfo;	// IMP=0x00100000003caa54
- (id)_imageProcessingFlags;	// IMP=0x00100000003ca7f5
@property(readonly, nonatomic) _Bool px_shotWithNightMode;
- (id)_videoDeferredProcessingNeededString:(unsigned short)arg1;	// IMP=0x00100000003ca72a
- (id)_deferredProcessingStringWithEnum:(unsigned short)arg1;	// IMP=0x00100000003ca705
- (id)_junkClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003ca112
- (id)_sdClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003c9e92
- (id)_sceneClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003c9933
- (id)_ocrStrings;	// IMP=0x00100000003c9926
- (id)stringMinutesTimeRangeFromTimeRange:(CDStruct_3c1748cc)arg1;	// IMP=0x00100000003c9833
@property(readonly, nonatomic) PXDebugValueList *px_curationDebugValues;
- (id)px_detailedDebugDescriptionInLibrary:(id)arg1;	// IMP=0x00100000003c6fd3
...
- (id)px_slHighlightWithError:(id *)arg1;	// IMP=0x00100000003c63e5
...
- (id)px_singleLineMailingAddress;	// IMP=0x00100000003c5e9b
...
- (struct CGRect)bestCropRectForAspectRatioV2:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x001000000063b53c
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x001000000063b272
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x001000000063b24b
@property(readonly, nonatomic) unsigned long long thumbnailVersion;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x001000000063b15f
@property(readonly, nonatomic) Class defaultImageProviderClass;
- (id)localizedDetailedGeoDescriptionForRTL:(_Bool)arg1;	// IMP=0x001000000063af6f
...
- (id)_faceNamesStringForAsset;	// IMP=0x00100000007189c3
- (id)px_accessibilityLabelForStyles:(unsigned long long)arg1;	// IMP=0x001000000071853f
@property(readonly, nonatomic) _Bool requiresConfidentiality;
- (_Bool)px_isSupportedApp:(id)arg1;	// IMP=0x001000000088a492
...
- (id)_px_currentRAWResource;	// IMP=0x001000000089db19
