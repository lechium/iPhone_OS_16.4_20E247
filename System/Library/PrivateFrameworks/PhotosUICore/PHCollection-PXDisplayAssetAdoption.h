...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00200000008852e9
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x002000000088517b
- (_Bool)px_fetchIsEmpty;	// IMP=0x0020000000885100
- (id)px_fetchContainedAssetCollections;	// IMP=0x0020000000885043
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x0020000000884ea0
