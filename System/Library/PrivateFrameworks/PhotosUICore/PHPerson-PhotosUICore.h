...
+ (id)px_localizedNameFromContact:(id)arg1;	// IMP=0x0010000000267272
+ (void)px_loadRepresentativeFacesForPersons:(id)arg1;	// IMP=0x00100000003dc138
+ (id)px_fetchPersonsForSuggestion:(id)arg1 options:(id)arg2;	// IMP=0x00100000009077ec
@property(readonly, nonatomic) NSPersonNameComponents *px_nameComponents;
- (id)_px_localizedNameWithStyle:(long long)arg1;	// IMP=0x001000000026711a
...
- (void)requestFaceTileImageWithTargetSize:(struct CGSize)arg1 cropFactor:(unsigned long long)arg2 style:(unsigned long long)arg3 cacheResult:(_Bool)arg4 boundFaceRect:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000003dbdbf
