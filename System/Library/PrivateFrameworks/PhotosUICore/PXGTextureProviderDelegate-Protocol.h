...
- (void)textureProvider:(PXGTextureProvider *)arg1 didProvidePixelBuffer:(struct __CVBuffer *)arg2 options:(CDStruct_d55ca1ec)arg3 forRequestID:(int)arg4;
...
- (void)textureProvider:(PXGTextureProvider *)arg1 didProvideCGImage:(struct CGImage *)arg2 options:(CDStruct_d55ca1ec)arg3 isDegraded:(_Bool)arg4 forRequestID:(int)arg5;
