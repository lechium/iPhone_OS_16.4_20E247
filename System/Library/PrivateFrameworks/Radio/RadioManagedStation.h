...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001f0e
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x0000000000005268
- (id)streamCertificateURL;	// IMP=0x00000000000051c7
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x00000000000048bd
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x00000000000047cf
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x00000000000023ec
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000002001
