...
- (void).cxx_destruct;	// IMP=0x000000000001739b
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000172d3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017233
