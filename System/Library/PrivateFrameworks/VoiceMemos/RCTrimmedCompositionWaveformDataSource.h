...
- (void).cxx_destruct;	// IMP=0x0000000000029e6b
@property(readonly, nonatomic) NSURL *destinationWaveformURL; // @synthesize destinationWaveformURL=_destinationWaveformURL;
- (id)generatedWaveformOutputURL;	// IMP=0x0000000000029e45
- (_Bool)preferLoadingFragmentWaveforms;	// IMP=0x0000000000029e3d
- (id)initWithSourceComposition:(id)arg1 destinationWaveformURL:(id)arg2;	// IMP=0x0000000000029db0
