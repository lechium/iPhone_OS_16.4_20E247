...
- (id)decryptData:(id)arg1 keyID:(id)arg2 seqNum:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x002000000000da3c
- (id)encryptData:(id)arg1 seqNum:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x002000000000da2a
