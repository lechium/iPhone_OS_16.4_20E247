...
- (void).cxx_destruct;	// IMP=0x000000000002be28
...
- (void)executeCallbackwithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000002bbea
- (id)initWithAQIScaleRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002bb6c
- (id)initWithForecastRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002baf5
