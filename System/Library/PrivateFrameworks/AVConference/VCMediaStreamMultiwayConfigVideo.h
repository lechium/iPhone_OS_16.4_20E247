...
- (id)streamIds;	// IMP=0x00000000002df584
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x00000000002df567
- (void)addPayload:(int)arg1;	// IMP=0x00000000002df527
- (void)dealloc;	// IMP=0x00000000002df4ac
- (id)init;	// IMP=0x00000000002df41f
