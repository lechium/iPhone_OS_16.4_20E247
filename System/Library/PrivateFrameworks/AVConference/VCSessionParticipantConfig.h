...
@interface VCSessionParticipantConfig : NSObject
{
    ...
    NSObject<OS_nw_activity> *_nwActivity;	// 184 = 0xb8
}
...
- (void)cleanupNwActivity;	// IMP=0x00000000003238cd
@property(nonatomic) void *spatialMetadata;
- (id)description;	// IMP=0x00000000003237b4
- (void)dealloc;	// IMP=0x00000000003236d7
