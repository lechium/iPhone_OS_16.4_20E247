...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e40f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e3b3e
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000e39fc
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000e37db
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000e377e
- (void)resetCodecs;	// IMP=0x00000000000e3768
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000e372f
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000e36f6
- (void)resetPayloads;	// IMP=0x00000000000e36e0
- (void)addPayload:(int)arg1;	// IMP=0x00000000000e36a7
- (void)dealloc;	// IMP=0x00000000000e363a
- (id)init;	// IMP=0x00000000000e35b4
