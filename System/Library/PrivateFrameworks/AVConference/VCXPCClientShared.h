...
- (void)deregisterWithUUID:(id)arg1 service:(char *)arg2;	// IMP=0x00000000002e3bf1
- (void)registerBlockWithUUID:(id)arg1 service:(char *)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002e3493
- (void)deregisterFromNotifications;	// IMP=0x00000000002e3344
- (void)dealloc;	// IMP=0x00000000002e32bc
- (id)init;	// IMP=0x00000000002e319d
