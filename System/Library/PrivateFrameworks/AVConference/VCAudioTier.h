...
+ (_Bool)bundlingAppliedByCodecForPayload:(int)arg1 mode:(int)arg2;	// IMP=0x00600000003834e5
+ (id)newAudioTierForPayloadConfig:(id)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 headerSize:(unsigned int)arg6;	// IMP=0x00600000003833b0
...
- (_Bool)isEqualTo:(id)arg1;	// IMP=0x000000000038381b
- (id)dictionary;	// IMP=0x00000000003836ad
- (id)description;	// IMP=0x00000000003835e6
- (id)initWithNetworkBitrate:(unsigned int)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 payloadSize:(unsigned int)arg6 headerSize:(unsigned int)arg7 payloadConfig:(id)arg8;	// IMP=0x000000000038351a
