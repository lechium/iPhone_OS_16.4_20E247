...
- (id)description;	// IMP=0x00000000003e2215
- (id)className;	// IMP=0x00000000003e2203
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x00000000003e2121
- (void)dealloc;	// IMP=0x00000000003e20b4
- (id)initWithConfigDict:(id)arg1;	// IMP=0x00000000003e202c
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x00000000003e1c47
- (void)createSupportedBitratesForEVS;	// IMP=0x00000000003e1c26
- (void)createSupportedBitratesForAMR16k;	// IMP=0x00000000003e1c05
- (void)createSupportedBitratesForAMR8k;	// IMP=0x00000000003e1be4
- (void)createSupportedBitratesForOpus;	// IMP=0x00000000003e1bc3
- (void)createSupportedBitratesForAACELD48;	// IMP=0x00000000003e1ba2
- (void)createSupportedBitratesForAACELD;	// IMP=0x00000000003e1b81
- (void)createSupportedBitrates;	// IMP=0x00000000003e1b02
- (unsigned int)aacBitrate;	// IMP=0x00000000003e19d4
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x00000000003e1959
- (_Bool)configure:(id)arg1;	// IMP=0x00000000003e12c0
