...
- (void)dealloc;	// IMP=0x00000000000fd776
@property(nonatomic) struct OpaqueCMBlockBuffer *spatialMetadata;
- (id)initWithAudioSessionId:(unsigned int)arg1 maxChannelCountMic:(unsigned int)arg2 maxChannelCountSpeaker:(unsigned int)arg3 spatialMetadata:(struct OpaqueCMBlockBuffer *)arg4;	// IMP=0x00000000000fd696
