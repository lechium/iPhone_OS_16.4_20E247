...
- (void)runUntilTime:(double)arg1;	// IMP=0x000000000007bc8b
- (id)copyPacketFromPop;	// IMP=0x000000000007bc3b
- (void)push:(id)arg1;	// IMP=0x000000000007bc02
- (void)dealloc;	// IMP=0x000000000007bb7e
- (id)initWithPolicies:(id)arg1;	// IMP=0x000000000007ba8f
