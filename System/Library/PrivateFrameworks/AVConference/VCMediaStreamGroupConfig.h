...
- (void)setupStreams;	// IMP=0x00000000001544b6
...
- (_Bool)addMediaStreamInfo:(id)arg1;	// IMP=0x0000000000154263
- (void)unlock;	// IMP=0x0000000000154214
- (void)lock;	// IMP=0x0000000000154203
- (void)dealloc;	// IMP=0x0000000000154120
- (id)init;	// IMP=0x0000000000154090
