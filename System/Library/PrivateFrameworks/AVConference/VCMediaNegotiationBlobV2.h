...
+ (Class)streamGroupsType;	// IMP=0x00100000000b83e3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000b93ef
- (unsigned long long)hash;	// IMP=0x00000000000b9317
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b9183
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b8f10
- (void)copyTo:(id)arg1;	// IMP=0x00000000000b8db9
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b8c11
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b8c04
- (id)dictionaryRepresentation;	// IMP=0x00000000000b848e
- (id)description;	// IMP=0x00000000000b83f4
- (id)streamGroupsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000b83c6
- (unsigned long long)streamGroupsCount;	// IMP=0x00000000000b83a9
- (void)addStreamGroups:(id)arg1;	// IMP=0x00000000000b835c
- (void)clearStreamGroups;	// IMP=0x00000000000b833f
...
- (void)dealloc;	// IMP=0x00000000000b81fc
- (void)printWithTitle:(id)arg1 logFile:(void *)arg2;	// IMP=0x000000000012592f
