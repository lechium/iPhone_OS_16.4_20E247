...
- (void)updateRedundancyPercentage;	// IMP=0x00000000002119fb
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000021197a
- (id)init;	// IMP=0x000000000021190e
