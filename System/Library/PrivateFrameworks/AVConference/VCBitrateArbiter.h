...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x00600000003c1624
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x00000000003c164f
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x00000000003c15b8
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x00000000003c14d4
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x00000000003c1312
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x00000000003c1219
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x00000000003c1120
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x00000000003c0e91
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x00000000003c0e7c
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x00000000003c0d4d
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x00000000003c0d34
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x00000000003c0d13
- (void)readCarrierBundleValues;	// IMP=0x00000000003c0d0d
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x00000000003c0d07
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x00000000003c0bc8
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x00000000003c0b2b
- (void)readHardwareValues;	// IMP=0x00000000003c0b25
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x00000000003c0ab8
- (void)createSupportedBitrateRuleSets;	// IMP=0x00000000003c0a82
- (void)dealloc;	// IMP=0x00000000003c0a24
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x00000000003c088d
