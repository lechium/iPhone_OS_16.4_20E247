...
- (void)flushRealTimeReportingStats;	// IMP=0x000000000032b7ef
- (void)deregisterPeriodicTask;	// IMP=0x000000000032b7d0
- (void)periodicTask:(void *)arg1;	// IMP=0x000000000032b59a
- (void)registerPeriodicTask;	// IMP=0x000000000032b54a
@property(readonly) id reportingAgent;
- (void)resetHealthPrintCounters;	// IMP=0x000000000032b512
- (void)healthPrintForServerStats;	// IMP=0x000000000032b2f9
- (void)calculateInterCallbackDurationWithTime:(double)arg1;	// IMP=0x000000000032b2bb
- (void)handleRemoteSessionStats:(CDStruct_a2e45a7d *)arg1;	// IMP=0x000000000032ae87
- (void)statsReceiveStatsPayload;	// IMP=0x000000000032ad17
- (void)triggerRateControlWithLocalSessionStats:(CDStruct_b5e1e8f2)arg1 time:(double)arg2 forUplink:(_Bool)arg3 forDownlink:(_Bool)arg4 fromVCRCExternalThread:(_Bool)arg5;	// IMP=0x000000000032aada
- (unsigned short)translateTimestampFromMicro:(double)arg1;	// IMP=0x000000000032aac1
- (_Bool)isRemoteSessionStatsTooLateWithStatsId:(unsigned short)arg1;	// IMP=0x000000000032a9a0
- (void)updateRemoteSessionStats:(CDStruct_2756d7ac)arg1;	// IMP=0x000000000032a2df
- (void)stopLocalSessionStatsUpdate;	// IMP=0x000000000032a115
- (void)startLocalSessionStatsSend;	// IMP=0x0000000000329e88
- (void)startLocalSessionStatsReceive;	// IMP=0x0000000000329c46
- (void)startLocalSessionStatsUpdate;	// IMP=0x0000000000329c18
- (void)sendLocalStats;	// IMP=0x0000000000329b7b
- (void)reset;	// IMP=0x0000000000329aa0
- (void)dealloc;	// IMP=0x0000000000329915
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 uplinkStatsCollector:(id)arg3 downlinkStatsCollector:(id)arg4 reportingAgent:(struct opaqueRTCReporting *)arg5 transportSessionID:(unsigned int)arg6 streamID:(unsigned short)arg7 mediaQueue:(struct tagVCMediaQueue *)arg8;	// IMP=0x000000000032969a
