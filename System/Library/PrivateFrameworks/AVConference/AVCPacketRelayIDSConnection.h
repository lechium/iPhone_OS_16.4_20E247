...
- (void)dealloc;	// IMP=0x000000000032f119
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000032edd9
- (void)readyToRead;	// IMP=0x000000000032eda1
- (int)stop;	// IMP=0x000000000032ec81
- (int)start;	// IMP=0x000000000032e53d
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x000000000032e334
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x000000000032e12a
