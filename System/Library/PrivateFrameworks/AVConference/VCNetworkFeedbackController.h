...
- (void)cleanupWRMClient;	// IMP=0x0000000000183224
- (void)setupWRMClientWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001830cb
- (void)cleanupWCMClient;	// IMP=0x00000000001830c5
- (void)setupWCMClient;	// IMP=0x00000000001830bf
- (void)wcmGetCallConfig:(unsigned int *)arg1 targetBitrate:(unsigned int *)arg2;	// IMP=0x0000000000182fa6
- (void)wcmSetCallConfig:(unsigned int)arg1 interferenceLevel:(unsigned int)arg2;	// IMP=0x0000000000182e5a
- (void)setPreWarmState:(_Bool)arg1;	// IMP=0x0000000000182e1b
- (void)setWRMCoexMetrics:(id)arg1;	// IMP=0x0000000000182d0a
- (void)setWRMNotification:(CDStruct_cd8cfafa *)arg1;	// IMP=0x0000000000182bcb
- (void)setWRMMetricConfig:(CDStruct_69d7cc99 *)arg1;	// IMP=0x0000000000182b66
- (void)reportWRMMetrics:(const CDStruct_dea828ac *)arg1;	// IMP=0x0000000000182b45
- (void)reportImmediateWRMMetric:(int)arg1 value:(unsigned long long)arg2;	// IMP=0x0000000000182b24
- (void)requestWRMNotification;	// IMP=0x0000000000182a51
- (void)sendStatusUpdate:(const CDStruct_8aeecdac *)arg1;	// IMP=0x0000000000182a3b
- (void)sendFeedbackControllerReport:(CDStruct_4b4d87a1)arg1;	// IMP=0x000000000018294a
- (void)cleanupWRMData;	// IMP=0x000000000018290e
- (void)setRSSIThresholdEnabled:(_Bool)arg1;	// IMP=0x00000000001828f8
- (void)updateMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001828e2
@property(readonly) unsigned int recommendedTargetBitrateCap;
- (id)strongDelegate;	// IMP=0x000000000018288e
- (void)stop;	// IMP=0x0000000000182772
- (void)startWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x000000000018265a
- (void)initializeWRMInfo;	// IMP=0x0000000000182537
- (void)dealloc;	// IMP=0x00000000001824a1
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2;	// IMP=0x0000000000182408
