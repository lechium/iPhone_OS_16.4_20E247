...
- (id)description;	// IMP=0x000000000038e259
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x000000000038e1b1
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x000000000038e007
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x000000000038db60
- (void)mergeProbingResults:(id)arg1;	// IMP=0x000000000038db4c
- (void)dealloc;	// IMP=0x000000000038dad1
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x000000000038d9c5
