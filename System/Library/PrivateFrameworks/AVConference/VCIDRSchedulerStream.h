...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00600000002acc2a
...
- (id)description;	// IMP=0x00000000002acd3d
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x00000000002acce6
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00000000002acc72
