...
- (unsigned long long)hash;	// IMP=0x000000000023a094
...
- (id)description;	// IMP=0x000000000023a002
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000239f5b
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x0000000000239ebc
- (id)init;	// IMP=0x0000000000239eae
