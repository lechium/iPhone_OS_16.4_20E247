...
- (unsigned long long)hash;	// IMP=0x000000000026246a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002623d5
- (id)description;	// IMP=0x0000000000262380
- (void)dealloc;	// IMP=0x000000000026231c
- (id)initWithStreamToken:(long long)arg1 format:(struct AudioStreamBasicDescription)arg2 bufferLength:(double)arg3;	// IMP=0x00000000002620e9
