...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(double *)arg1;	// IMP=0x00000000003a2aaa
- (void)computeRedundancyInfo;	// IMP=0x00000000003a2a37
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000003a2910
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000003a2876
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000003a2849
- (id)init;	// IMP=0x00000000003a27d1
