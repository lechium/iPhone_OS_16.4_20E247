...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018aa23
- (void)dealloc;	// IMP=0x000000000018a9c5
- (void)addSecondaryPayload:(int)arg1;	// IMP=0x000000000018a98c
@property(readonly, nonatomic) NSArray *secondaryPayloads;
- (id)init;	// IMP=0x000000000018a8f2
