...
- (id)initWithPacketID:(unsigned int)arg1 datagram:(char *)arg2 datagramSize:(unsigned int)arg3;	// IMP=0x00000000000e6956
- (id)initWithPacketID:(unsigned int)arg1;	// IMP=0x00000000000e68f8
