...
- (id)description;	// IMP=0x0000000000067c58
- (long long)compareBudget:(id)arg1;	// IMP=0x0000000000067c01
- (void)addStream:(id)arg1;	// IMP=0x0000000000067b9c
- (void)dealloc;	// IMP=0x0000000000067b3e
- (id)init;	// IMP=0x0000000000067ac8
