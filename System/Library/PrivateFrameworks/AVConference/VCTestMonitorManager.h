...
+ (id)sharedManager;	// IMP=0x00600000003b5fca
...
- (void)registerBlocksForService;	// IMP=0x00000000003b633d
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x00000000003b6019
- (void)dealloc;	// IMP=0x00000000003b5f5a
- (id)init;	// IMP=0x00000000003b5eb8
