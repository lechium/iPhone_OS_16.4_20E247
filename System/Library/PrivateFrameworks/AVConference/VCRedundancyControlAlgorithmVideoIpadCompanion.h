...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x000000000005bda2
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x000000000005bd78
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x000000000005bd2c
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000005bc7e
