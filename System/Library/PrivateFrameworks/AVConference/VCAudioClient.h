...
- (void)didServerDie;	// IMP=0x0000000000184b0d
- (void)didResumeAudioIO:(id)arg1;	// IMP=0x0000000000184b07
- (void)didSuspendAudioIO:(id)arg1;	// IMP=0x0000000000184b01
@property(retain, nonatomic) AVAudioDevice *outputDevice;
@property(retain, nonatomic) AVAudioDevice *inputDevice;
- (_Bool)setCurrentAudioDevice:(id)arg1 type:(_Bool)arg2;	// IMP=0x0000000000184add
- (id)getCurrentAudioDeviceWithType:(_Bool)arg1;	// IMP=0x0000000000184ad5
- (void)stopAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000184acf
- (void)startAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000184ac9
- (_Bool)stopAudioSessionWithError:(id *)arg1;	// IMP=0x0000000000184ac1
- (_Bool)startAudioSessionWithError:(id *)arg1;	// IMP=0x0000000000184ab9
- (_Bool)stopWithError:(id *)arg1;	// IMP=0x00000000001845a8
- (_Bool)startWithError:(id *)arg1;	// IMP=0x000000000018411e
- (void)setAudioSessionProperties:(id)arg1;	// IMP=0x00000000001840a3
- (_Bool)resetAudioSessionOutputPortOverride:(id *)arg1;	// IMP=0x000000000018409b
- (_Bool)unmuteWithError:(id *)arg1;	// IMP=0x0000000000184042
- (_Bool)muteWithError:(id *)arg1;	// IMP=0x000000000018401d
- (void)unlock;	// IMP=0x000000000018400f
- (void)lock;	// IMP=0x0000000000184001
- (void)dealloc;	// IMP=0x0000000000183f9a
- (id)initWithProcessId:(int)arg1;	// IMP=0x0000000000183f00
