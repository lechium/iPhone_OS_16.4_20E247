...
- (void)dealloc;	// IMP=0x000000000005d837
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x000000000005d77c
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x000000000005d6e9
