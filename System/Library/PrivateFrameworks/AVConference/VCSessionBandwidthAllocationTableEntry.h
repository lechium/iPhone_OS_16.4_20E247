...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x006000000019adc2
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x006000000019a9bd
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x006000000019a81c
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x006000000019a5da
...
- (long long)compare:(id)arg1;	// IMP=0x000000000019a666
- (id)description;	// IMP=0x000000000019a4c6
- (void)dealloc;	// IMP=0x000000000019a468
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x000000000019a3b8
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x000000000019a283
