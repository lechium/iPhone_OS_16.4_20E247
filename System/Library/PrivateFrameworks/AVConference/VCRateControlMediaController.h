...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x0000000000112374
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x00000000001122bb
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x0000000000111fe6
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x0000000000111e20
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x0000000000111d1c
- (void)increaseBasebandFlushCountInternallyWithSuggestion:(struct VCRateControlMediaSuggestion *)arg1;	// IMP=0x0000000000111c74
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x0000000000111c03
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x0000000000111b70
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x00000000001119b3
...
- (_Bool)rampUpAudioFraction;	// IMP=0x00000000001116fb
- (_Bool)rampDownAudioFraction;	// IMP=0x000000000011165e
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000011148f
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x000000000011135d
@property(readonly, nonatomic) _Bool isVideoStopped;
- (void)resumeVideoByVCRateControl;	// IMP=0x000000000011109e
- (void)stopVideoByVCRateControl;	// IMP=0x0000000000110f52
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x0000000000110d99
- (void)updateAudioStallInMediaSuggestion:(struct VCRateControlMediaSuggestion *)arg1 isSuggestionNeeded:(_Bool *)arg2 atTime:(double)arg3;	// IMP=0x0000000000110cab
- (void)updateBasebandSuggestionWithStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000110541
- (void)computePacketLossWithRemoteInfo:(struct VCRCMediaPLPFromRemoteInfo *)arg1;	// IMP=0x0000000000110411
- (void)getMediaQueueRateChangeCounter:(unsigned int *)arg1 rateChangeTime:(double *)arg2;	// IMP=0x000000000011036d
- (void)getMediaQueueInVideoBitrate:(double *)arg1 outVideoBitrate:(double *)arg2 inAudioBitrate:(double *)arg3 outAudioBitrate:(double *)arg4;	// IMP=0x000000000011029a
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000010feaf
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000010fea2
- (void)dealloc;	// IMP=0x000000000010fe20
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x000000000010fce2
