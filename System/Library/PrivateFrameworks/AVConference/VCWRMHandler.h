...
- (unsigned char)processRemoteWRMSuggestion:(int)arg1 isRemoteDuplicating:(_Bool)arg2;	// IMP=0x00000000001344d5
- (unsigned char)processLocalWRMNotification:(CDStruct_cd8cfafa *)arg1 isAudioOnly:(_Bool)arg2;	// IMP=0x0000000000134379
- (void)updateWRMNotificationRequestTime:(double)arg1;	// IMP=0x000000000013436e
- (_Bool)shouldRequestWRMNotificationWithDuplicationReason:(unsigned char)arg1 isDuplicationEnabled:(_Bool)arg2 isLocalUsingCellular:(_Bool)arg3 atTime:(double)arg4;	// IMP=0x000000000013417c
- (_Bool)shouldForceWRMRecommendationUsingUserDefaults;	// IMP=0x000000000013406f
- (id)init;	// IMP=0x0000000000134010
