...
- (id)entryForQualityIndex:(unsigned int)arg1;	// IMP=0x00000000003e7896
- (_Bool)addTableEntry:(id)arg1;	// IMP=0x00000000003e7753
- (void)dealloc;	// IMP=0x00000000003e76e6
- (id)init;	// IMP=0x00000000003e7667
