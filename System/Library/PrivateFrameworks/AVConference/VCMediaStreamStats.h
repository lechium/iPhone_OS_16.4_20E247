...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x000000000016d83f
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x000000000016d7c6
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x000000000016d763
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x000000000016d6ac
- (void)dealloc;	// IMP=0x000000000016d645
- (id)init;	// IMP=0x000000000016d56e
