...
- (int)getRemainingAQMBudgetWithPacket:(id)arg1;	// IMP=0x00000000000619d8
- (void)addPacketToBudgetBuffer:(id)arg1;	// IMP=0x0000000000061936
- (_Bool)shouldDropPacketWithCurrentAQMBudget:(id)arg1;	// IMP=0x00000000000618c3
- (void)process:(id)arg1;	// IMP=0x0000000000061622
- (double)computeNetworkServiceRate;	// IMP=0x0000000000061551
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x000000000006122e
- (id)init;	// IMP=0x00000000000611d0
