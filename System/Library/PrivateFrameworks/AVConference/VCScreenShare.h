...
- (void)setConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c26e3
- (void)updateScreenShareWith:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c26d1
- (void)dealloc;	// IMP=0x00000000003c2657
- (id)initWithConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c25d4
