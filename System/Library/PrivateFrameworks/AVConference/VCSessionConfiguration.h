...
- (void)cleanupNwActivity;	// IMP=0x000000000004aba6
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x000000000004a9b8
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x000000000004a812
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x000000000004a665
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000004a626
- (id)init;	// IMP=0x000000000004a5c7
