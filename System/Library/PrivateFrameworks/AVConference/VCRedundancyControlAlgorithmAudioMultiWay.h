...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x000000000026cefb
- (void)computeRedundancyInfo;	// IMP=0x000000000026ce88
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000026cd5b
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000026ccc1
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000026cc94
