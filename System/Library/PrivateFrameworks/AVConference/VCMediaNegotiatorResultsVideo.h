...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ef140
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x00000000002ef12a
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x00000000002ef114
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002ef0ca
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002ef080
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x00000000002ef06a
- (void)dealloc;	// IMP=0x00000000002eefe8
- (id)init;	// IMP=0x00000000002eef39
