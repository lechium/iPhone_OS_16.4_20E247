...
- (void)dealloc;	// IMP=0x000000000032dfb2
- (id)description;	// IMP=0x000000000032dee6
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000032dc44
- (void)receiveDataOnSocket:(unsigned short)arg1;	// IMP=0x000000000032d9ed
- (void)readyToRead;	// IMP=0x000000000032d9d7
- (int)stop;	// IMP=0x000000000032d8da
- (int)start;	// IMP=0x000000000032d785
- (id)initWithSocket:(unsigned short)arg1 remoteAddress:(id)arg2 packetFilter:(id)arg3;	// IMP=0x000000000032d383
