...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000002ebb34
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000002ebaff
- (void)dealloc;	// IMP=0x00000000002eba8b
- (id)init;	// IMP=0x00000000002eba0b
