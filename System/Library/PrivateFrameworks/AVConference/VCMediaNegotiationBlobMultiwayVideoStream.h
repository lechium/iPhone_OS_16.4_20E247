...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x0010000000351812
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00100000003517f4
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x0010000000351664
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x0010000000351508
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000a9cf
- (unsigned long long)hash;	// IMP=0x000000000000a883
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000a6d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a5a0
- (void)copyTo:(id)arg1;	// IMP=0x000000000000a4a6
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a321
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a314
- (id)dictionaryRepresentation;	// IMP=0x000000000000982c
- (id)description;	// IMP=0x0000000000009792
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003512a6
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x0000000000351037
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x0000000000350e35
