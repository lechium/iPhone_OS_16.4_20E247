...
- (struct tagVCStatisticsMessage)getVCStatisticsWithType:(int)arg1 time:(double)arg2;	// IMP=0x000000000003aa9a
- (_Bool)shouldProcessAtTime:(double)arg1;	// IMP=0x000000000003aa5b
- (void)unregisterAllStatisticsChangeHandlers;	// IMP=0x000000000003a652
- (_Bool)unregisterStatisticsChangeHandlerWithType:(int)arg1 handlerIndex:(int)arg2;	// IMP=0x000000000003a420
- (int)registerStatisticsChangeHandlerWithType:(int)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003a250
@property(readonly, nonatomic) _Bool isStarted;
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000003a22f
- (id)getStatistics:(id)arg1;	// IMP=0x0000000000039f6e
- (void)setStatistics:(id)arg1;	// IMP=0x0000000000039d8e
- (void)stop;	// IMP=0x0000000000039bfe
- (void)start;	// IMP=0x0000000000038e20
- (void)dealloc;	// IMP=0x0000000000038ae6
- (id)initForSimulation:(_Bool)arg1 useExternalThread:(_Bool)arg2;	// IMP=0x0000000000038912
- (id)init;	// IMP=0x00000000000388fc
