...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003e877
- (unsigned long long)hash;	// IMP=0x000000000003e684
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003e524
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e418
- (void)copyTo:(id)arg1;	// IMP=0x000000000003e34a
- (void)writeTo:(id)arg1;	// IMP=0x000000000003e21d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003e210
- (id)dictionaryRepresentation;	// IMP=0x000000000003d9ca
- (id)description;	// IMP=0x000000000003d930
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x0000000000350c35
- (id)newMultiwayAudioStream;	// IMP=0x0000000000350a92
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x000000000035091e
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x0000000000350773
