...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000019a0e7
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000199fa1
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x0000000000199f92
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x0000000000199f78
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x0000000000199d45
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000199c42
- (void)dealloc;	// IMP=0x0000000000199aa0
- (id)init;	// IMP=0x0000000000199a31
