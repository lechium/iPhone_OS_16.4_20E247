...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x0000000000269d47
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x0000000000269d2f
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x0000000000269d03
