...
- (void)resetAggregatedProbingResults;	// IMP=0x000000000039e326
- (void)probingLockdownEnded;	// IMP=0x000000000039e205
- (void)updateLinkPreferenceOrder;	// IMP=0x000000000039de73
- (void)queryProbingResults;	// IMP=0x000000000039db90
- (void)setLinkProbingResultConfig;	// IMP=0x000000000039db52
- (void)loadStorebagValues;	// IMP=0x000000000039d6bd
- (id)getProbingResultsForLinkID:(id)arg1;	// IMP=0x000000000039d668
- (void)removeProbingResultsForLinks:(id)arg1;	// IMP=0x000000000039d513
- (_Bool)isValidProbingResult:(id)arg1;	// IMP=0x000000000039d4a8
- (void)flushProbingResults:(id)arg1;	// IMP=0x000000000039d3ec
- (void)dispatchedUpdateProbingResults:(id)arg1;	// IMP=0x000000000039ce5e
- (void)updateProbingResults:(id)arg1;	// IMP=0x000000000039cdcf
- (void)stopActiveProbingOnLinks:(id)arg1 resetStats:(_Bool)arg2;	// IMP=0x000000000039ca44
- (void)startActiveProbingOnLinks:(id)arg1;	// IMP=0x000000000039c7a1
@property(readonly) _Bool isLinkProbingActive;
@property id <VCLinkProbingHandlerDelegate> linkProbingHandlerDelegate;
- (void)dealloc;	// IMP=0x000000000039c698
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000039c487
