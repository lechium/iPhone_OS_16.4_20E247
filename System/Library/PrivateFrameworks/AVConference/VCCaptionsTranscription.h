...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016cf6f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016d3e5
- (unsigned long long)hash;	// IMP=0x000000000016d39d
- (id)description;	// IMP=0x000000000016d330
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016d00d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016cf77
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016cdd3
- (void)addSegment:(id)arg1;	// IMP=0x000000000016cda0
@property(readonly, nonatomic) NSString *formattedText;
- (void)dealloc;	// IMP=0x000000000016ccef
- (id)initWithSFTranscription:(id)arg1 utteranceNumber:(unsigned int)arg2 updateNumber:(unsigned int)arg3 isLocal:(_Bool)arg4 isFinal:(_Bool)arg5 streamToken:(long long)arg6;	// IMP=0x000000000016ca9b
- (id)initWithUtteranceNumber:(unsigned int)arg1 updateNumber:(unsigned int)arg2 isLocal:(_Bool)arg3 isFinal:(_Bool)arg4 streamToken:(long long)arg5;	// IMP=0x000000000016c9f8
