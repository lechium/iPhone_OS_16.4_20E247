...
- (void)computeRedundancyInfo;	// IMP=0x000000000039be04
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000039bd86
