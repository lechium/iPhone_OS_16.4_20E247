...
- (id)className;	// IMP=0x0000000000055a97
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x0000000000055670
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000055237
- (void)resetLossEventBuffer;	// IMP=0x0000000000055226
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x00000000000551fe
- (int)lossEventCount;	// IMP=0x00000000000551e4
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x0000000000055194
- (_Bool)shouldRampUp;	// IMP=0x00000000000550ce
- (_Bool)shouldRampDown;	// IMP=0x000000000005501a
- (unsigned short)rampDownTier;	// IMP=0x0000000000054ff0
- (unsigned short)rampUpTier;	// IMP=0x0000000000054fd1
- (void)stateEnter;	// IMP=0x0000000000054fb2
- (void)stateExit;	// IMP=0x0000000000054fac
- (void)stateChange:(int)arg1;	// IMP=0x0000000000054e53
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x0000000000054d33
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000054d21
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000054b24
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x0000000000054a6e
- (id)init;	// IMP=0x000000000005485e
