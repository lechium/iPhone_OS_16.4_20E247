...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b4f2
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b2e9
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b115
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x000000000004b10c
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x000000000004afa5
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004af56
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x000000000004aeaf
- (id)initWithCodecType:(long long)arg1;	// IMP=0x000000000004ae16
