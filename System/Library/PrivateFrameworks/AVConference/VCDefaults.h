...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f4e90
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00600000003f4e6d
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f4e52
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00600000003f4d05
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f4cea
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00600000003f4b95
+ (id)sharedInstance;	// IMP=0x00600000003f4ab6
...
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x00000000003f6cc8
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x00000000003f6964
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x00000000003f6638
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x00000000003f6616
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x00000000003f6376
- (_Bool)forceWifiAssist;	// IMP=0x00000000003f6356
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000003f5466
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000003f5159
...
- (id)autorelease;	// IMP=0x00000000003f4f52
- (oneway void)release;	// IMP=0x00000000003f4f4c
- (unsigned long long)retainCount;	// IMP=0x00000000003f4f3f
- (id)retain;	// IMP=0x00000000003f4f36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f4f2d
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f4f20
- (id)init;	// IMP=0x00000000003f4ece
