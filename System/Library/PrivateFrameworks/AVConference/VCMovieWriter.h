...
- (void)setupInputs;	// IMP=0x0000000000367368
- (void)startWritingAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000367230
- (void)appendMetaData;	// IMP=0x0000000000366d55
- (void)processSampleQueue:(struct opaqueCMBufferQueue *)arg1 input:(id)arg2 lastPresentationTime:(CDStruct_1b6d18a9 *)arg3;	// IMP=0x00000000003669f6
- (void)setupInput:(id)arg1 queue:(struct opaqueCMBufferQueue *)arg2 dispatchGroup:(id)arg3 lastPresentationTime:(CDStruct_1b6d18a9 *)arg4;	// IMP=0x0000000000366820
- (id)setupAssetWriterWithWidth:(int)arg1 height:(int)arg2 transactionID:(id)arg3;	// IMP=0x0000000000365d65
- (void)finishWritingWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003658b1
- (void)setStillImageTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000036578b
- (_Bool)shouldFinishWritingSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000365233
- (_Bool)shouldAppendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000365090
- (void)setEndRTPTimestampWithTimestamp:(unsigned int)arg1;	// IMP=0x000000000036507d
- (void)appendAudioSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 mediaType:(unsigned char)arg2;	// IMP=0x0000000000364f51
- (void)appendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 cameraStatus:(unsigned char)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000364f4b
- (void)setupContectRect:(struct CGRect)arg1 withCaptureHeight:(int)arg2;	// IMP=0x0000000000364e58
- (void)setupWriterWithMode:(unsigned char)arg1;	// IMP=0x0000000000364e4c
- (void)dealloc;	// IMP=0x0000000000364cfc
- (id)initWithOutputURL:(id)arg1 transactionID:(id)arg2 videoCodec:(unsigned int)arg3;	// IMP=0x0000000000364b8e
