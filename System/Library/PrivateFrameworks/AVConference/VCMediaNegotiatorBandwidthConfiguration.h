...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002913b
- (id)initWithMode:(int)arg1 connectionType:(int)arg2 maxBandwidth:(unsigned int)arg3;	// IMP=0x00000000000290c7
- (id)initWithConnectionType:(int)arg1 maxBandwidth:(unsigned int)arg2;	// IMP=0x0000000000029053
