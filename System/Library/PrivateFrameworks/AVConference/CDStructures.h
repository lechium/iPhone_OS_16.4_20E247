...
@class AVCRateController, AVCStatisticsCollector, NSArray, NSMutableDictionary, NSObject, VCAudioStream, VCRateControlMediaController, VCRedundancyControllerAudio, VCRedundancyControllerVideo, VCStreamOutput, VCSwitchManager;
...
struct tagVCAudioReceiver {
    ...
    int _field65;
    struct tagVCAudioDump *_field66;
    struct tagVCAudioDumpPayloadInfo _field67;
};
...
struct tagVCMediaStreamRateAdaptationParams {
    id _field1;
    struct opaqueRTCReporting *_field2;
    int _field3;
    struct tagVCMediaStreamRateAdaptationConfig _field4;
};
