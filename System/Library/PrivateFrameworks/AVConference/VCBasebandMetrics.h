...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001999e7
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x00000000001998db
- (void)resetBBNoteHistoryList;	// IMP=0x00000000001998c0
- (void)resetBDCDList;	// IMP=0x00000000001998a5
- (void)normalizeBDCD:(double)arg1;	// IMP=0x000000000019964c
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001995dd
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x0000000000199326
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000199263
- (struct tagVCStatisticsMessage)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000198ff5
- (void)dealloc;	// IMP=0x0000000000198f97
- (id)init;	// IMP=0x0000000000198ef0
