...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x006000000039ec63
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000039ec56
- (void)setUserAgent:(id)arg1;	// IMP=0x000000000039eb1f
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x000000000039eabe
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000039e8d6
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x000000000039e817
- (id)init;	// IMP=0x000000000039e64d
