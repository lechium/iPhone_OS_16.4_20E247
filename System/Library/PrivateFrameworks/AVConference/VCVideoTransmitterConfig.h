...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x000000000027ec57
- (void)dealloc;	// IMP=0x000000000027ebb0
- (id)description;	// IMP=0x000000000027ea77
- (id)init;	// IMP=0x000000000027e99e
