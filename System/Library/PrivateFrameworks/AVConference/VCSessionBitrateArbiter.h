...
- (void)readStoreBagValues;	// IMP=0x0000000000258441
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x0000000000258233
- (void)readHardwareValues;	// IMP=0x0000000000258209
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x0000000000258190
- (void)dealloc;	// IMP=0x0000000000258132
- (id)init;	// IMP=0x00000000002580ae
