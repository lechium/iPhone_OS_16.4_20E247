...
- (void)updateQualificationParameters;	// IMP=0x000000000033c940
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000033c933
- (void)dealloc;	// IMP=0x000000000033ba97
- (id)init;	// IMP=0x000000000033b9e5
