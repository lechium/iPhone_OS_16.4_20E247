...
- (void).cxx_destruct;	// IMP=0x000000000018f863
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000018f5b6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000018ef19
- (id)generateRequestOperations;	// IMP=0x000000000018eb0d
- (id)requestOperationClasses;	// IMP=0x000000000018eaa1
- (id)initWithOperation:(id)arg1 subscriptionIDs:(id)arg2;	// IMP=0x000000000018e9d6
