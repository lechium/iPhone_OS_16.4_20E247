...
- (void).cxx_destruct;	// IMP=0x0000000000334f05
...
- (void)requestDidComplete;	// IMP=0x0000000000334760
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003341b2
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003333b8
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000332dca
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000331cb8
- (id)generateRequestOperations;	// IMP=0x000000000032f545
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x000000000032f533
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000032f52b
- (int)isolationLevel;	// IMP=0x000000000032f50e
- (id)requestOperationClasses;	// IMP=0x000000000032f3f4
- (id)zoneIDsToLock;	// IMP=0x000000000032f099
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000032f07f
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x000000000032ee56
