...
- (void).cxx_destruct;	// IMP=0x00000000002c5ef5
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002c5b3e
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002c525e
- (id)generateRequestOperations;	// IMP=0x00000000002c4b35
- (id)anonymousUserIDForHTTPHeader;	// IMP=0x00000000002c4abb
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002c4ab3
- (int)isolationLevel;	// IMP=0x00000000002c4aa8
- (id)requestOperationClasses;	// IMP=0x00000000002c4a3c
- (id)zoneIDsToLock;	// IMP=0x00000000002c4972
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002c4958
- (id)initWithOperation:(id)arg1 mergeableValueIDs:(id)arg2 continuationTokens:(id)arg3;	// IMP=0x00000000002c487d
