...
+ (Class)clientConfigType;	// IMP=0x0010000000335c68
- (void).cxx_destruct;	// IMP=0x0000000000337e06
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000033790b
- (unsigned long long)hash;	// IMP=0x000000000033775f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033745e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003370a0
- (void)copyTo:(id)arg1;	// IMP=0x0000000000336e60
- (Class)responseClass;	// IMP=0x0000000000336e4f
- (unsigned int)requestTypeCode;	// IMP=0x0000000000336e44
- (void)writeTo:(id)arg1;	// IMP=0x0000000000336bbc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003365c7
- (id)dictionaryRepresentation;	// IMP=0x000000000033600a
- (id)description;	// IMP=0x0000000000335f5b
- (void)clearOneofValuesForDataProtection;	// IMP=0x0000000000335efb
- (int)StringAsDataProtection:(id)arg1;	// IMP=0x0000000000335e69
- (id)dataProtectionAsString:(int)arg1;	// IMP=0x0000000000335e20
...
- (id)clientConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000335c4b
- (unsigned long long)clientConfigsCount;	// IMP=0x0000000000335c2e
- (void)addClientConfig:(id)arg1;	// IMP=0x0000000000335bc4
- (void)clearClientConfigs;	// IMP=0x0000000000335ba7
- (int)StringAsSerializationFormat:(id)arg1;	// IMP=0x0000000000335b40
- (id)serializationFormatAsString:(int)arg1;	// IMP=0x0000000000335aea
