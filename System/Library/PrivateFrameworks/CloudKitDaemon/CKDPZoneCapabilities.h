...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000027de0a
- (unsigned long long)hash;	// IMP=0x000000000027dd51
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027dbc2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027dae1
- (void)copyTo:(id)arg1;	// IMP=0x000000000027da23
- (void)writeTo:(id)arg1;	// IMP=0x000000000027d931
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000027d924
- (id)dictionaryRepresentation;	// IMP=0x000000000027d1ab
- (id)description;	// IMP=0x000000000027d0fc
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x000000000027cfc9
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x000000000027cf7e
