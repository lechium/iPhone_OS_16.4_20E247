...
- (void).cxx_destruct;	// IMP=0x000000000024dad4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000024d958
- (unsigned long long)hash;	// IMP=0x000000000024d8b5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000024d755
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024d63d
- (void)copyTo:(id)arg1;	// IMP=0x000000000024d57a
- (void)writeTo:(id)arg1;	// IMP=0x000000000024d4c6
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000024d4b9
- (id)dictionaryRepresentation;	// IMP=0x000000000024d23b
- (id)description;	// IMP=0x000000000024d18c
