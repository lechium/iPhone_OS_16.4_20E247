...
- (void).cxx_destruct;	// IMP=0x00000000002bf0fd
...
- (id)relevantZoneIDs;	// IMP=0x00000000002bee27
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002bec98
- (void)main;	// IMP=0x00000000002be7e6
- (int)operationType;	// IMP=0x00000000002be7db
- (void)_handleRecordVersionsFetchedForID:(id)arg1 isDeleted:(_Bool)arg2 versions:(id)arg3 responseCode:(id)arg4;	// IMP=0x00000000002bdacc
- (_Bool)hasDecryptOperation;	// IMP=0x00000000002bda8b
@property(readonly, nonatomic) CKDDecryptRecordsOperation *recordDecryptOperation;
- (id)activityCreate;	// IMP=0x00000000002bd811
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002bd617
