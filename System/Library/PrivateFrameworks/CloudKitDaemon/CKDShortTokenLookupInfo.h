...
- (void).cxx_destruct;	// IMP=0x00000000001117f5
...
- (unsigned long long)hash;	// IMP=0x00000000001116c1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000111385
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011121e
