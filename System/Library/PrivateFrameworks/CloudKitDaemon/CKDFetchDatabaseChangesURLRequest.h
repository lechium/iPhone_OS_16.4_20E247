...
- (void).cxx_destruct;	// IMP=0x000000000026b2ae
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000026a53c
- (id)generateRequestOperations;	// IMP=0x000000000026a339
- (id)requestOperationClasses;	// IMP=0x000000000026a2cd
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000026a2c5
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000026a2ab
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x000000000026a1a1
