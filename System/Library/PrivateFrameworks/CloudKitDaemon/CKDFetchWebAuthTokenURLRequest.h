...
- (void).cxx_destruct;	// IMP=0x0000000000255069
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000254f74
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000254e5d
- (id)generateRequestOperations;	// IMP=0x0000000000254cfa
- (id)requestOperationClasses;	// IMP=0x0000000000254c8e
