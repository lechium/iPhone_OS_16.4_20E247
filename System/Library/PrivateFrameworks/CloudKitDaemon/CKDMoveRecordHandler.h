...
+ (id)moveHandlerWithMoveChange:(id)arg1 operation:(id)arg2;	// IMP=0x00600000001b0e55
- (void).cxx_destruct;	// IMP=0x00000000001b0f7f
...
- (id)record;	// IMP=0x00000000001b0ec1
- (id)_initWithMoveChange:(id)arg1 operation:(id)arg2;	// IMP=0x00000000001b0dcb
