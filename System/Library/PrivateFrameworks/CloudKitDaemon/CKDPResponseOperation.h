...
- (void).cxx_destruct;	// IMP=0x0000000000147dcd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000014725b
- (unsigned long long)hash;	// IMP=0x0000000000146d09
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001462ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000145af3
- (void)copyTo:(id)arg1;	// IMP=0x00000000001454d0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000144f3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000144f30
- (id)dictionaryRepresentation;	// IMP=0x0000000000142e7a
- (id)description;	// IMP=0x0000000000142dcb
