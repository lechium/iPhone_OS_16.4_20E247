...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000323ed3
+ (id)dataWithRecord:(id)arg1;	// IMP=0x00100000003239ea
- (void).cxx_destruct;	// IMP=0x0000000000324596
...
- (void)dealloc;	// IMP=0x00000000003243c7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000324137
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000323edb
- (id)CKPropertiesDescription;	// IMP=0x0000000000323d8b
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x0000000000323a80
- (_Bool)shouldEncodePCSData;	// IMP=0x0000000000323a4d
- (id)itemID;	// IMP=0x0000000000323a3b
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000003236e5
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000032366d
