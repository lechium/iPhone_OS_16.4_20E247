...
- (void).cxx_destruct;	// IMP=0x00000000001efaa3
...
- (void)main;	// IMP=0x00000000001ef971
- (void)_updateMissingAssetStatus;	// IMP=0x00000000001ef432
- (int)operationType;	// IMP=0x00000000001ef427
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000001ef3d7
- (_Bool)makeStateTransition;	// IMP=0x00000000001ef332
- (id)activityCreate;	// IMP=0x00000000001ef309
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001ef1ee
