...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003259aa
+ (id)dataWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x001000000032552b
+ (id)dataWithShare:(id)arg1 serviceType:(unsigned long long)arg2;	// IMP=0x0010000000325283
- (void).cxx_destruct;	// IMP=0x000000000032633f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000325e53
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000325bf4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003259b2
- (id)CKPropertiesDescription;	// IMP=0x00000000003257c8
@property(nonatomic) struct _OpaquePCSShareProtection *invitedPCS;
- (void)dealloc;	// IMP=0x00000000003255a1
- (id)initWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x000000000032520b
