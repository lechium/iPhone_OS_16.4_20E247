...
- (void).cxx_destruct;	// IMP=0x00000000000e10a4
...
- (void)main;	// IMP=0x00000000000e0f4d
- (void)_verifyOONParticipant;	// IMP=0x00000000000e071c
- (void)_reconstructShareURL;	// IMP=0x00000000000e04d0
- (void)_forceFetchShareMetadata;	// IMP=0x00000000000dfd9e
- (void)_performAuthKitVerification;	// IMP=0x00000000000df7a5
- (void)_reconstructShortToken;	// IMP=0x00000000000df239
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x00000000000df224
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x00000000000df128
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000df040
- (_Bool)makeStateTransition;	// IMP=0x00000000000deee4
- (id)activityCreate;	// IMP=0x00000000000deebb
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000dec94
