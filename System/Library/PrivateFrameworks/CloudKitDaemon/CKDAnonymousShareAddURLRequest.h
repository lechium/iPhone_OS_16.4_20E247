...
- (void).cxx_destruct;	// IMP=0x00000000002d2a72
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d28c1
- (id)generateRequestOperations;	// IMP=0x00000000002d24c6
- (id)requestOperationClasses;	// IMP=0x00000000002d245a
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToAdd:(id)arg2;	// IMP=0x00000000002d23c1
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002d23b9
