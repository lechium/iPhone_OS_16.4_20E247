...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002815e0
- (void).cxx_destruct;	// IMP=0x0000000000281ad8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000281744
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002815e8
