...
- (void).cxx_destruct;	// IMP=0x00000000000e6738
...
- (void)requestDidComplete;	// IMP=0x00000000000e6529
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000e625c
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000e5991
- (id)generateRequestOperations;	// IMP=0x00000000000e4d45
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000000e4ce3
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000000e4cdb
- (id)zoneIDsToLock;	// IMP=0x00000000000e4c1f
- (_Bool)requestGETPreAuth;	// IMP=0x00000000000e4bb2
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000e4b98
- (id)requestOperationClasses;	// IMP=0x00000000000e4b2c
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x00000000000e49ad
