...
- (void).cxx_destruct;	// IMP=0x0000000000365370
...
- (id)initWithCertificate:(id)arg1 applicationEnclaveQuote:(id)arg2 quotingEnclaveQuote:(id)arg3 routingToken:(id)arg4;	// IMP=0x0000000000365222
