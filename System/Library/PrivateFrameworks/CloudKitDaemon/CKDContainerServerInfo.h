...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000e1de4
- (void).cxx_destruct;	// IMP=0x00000000000e2298
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e1fee
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e1dec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1b22
- (unsigned long long)hash;	// IMP=0x00000000000e198d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e133f
- (id)description;	// IMP=0x00000000000e132d
- (id)CKPropertiesDescription;	// IMP=0x00000000000e11aa
- (id)init;	// IMP=0x00000000000e116e
