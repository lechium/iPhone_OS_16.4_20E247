...
+ (unsigned long long)_sizeForItem:(id)arg1;	// IMP=0x0060000000342c34
- (void).cxx_destruct;	// IMP=0x00000000003437f4
...
- (double)updateProgressWithItem:(id)arg1 progress:(double)arg2;	// IMP=0x00000000003434e5
- (unsigned long long)_updateTotalCompletedBytes;	// IMP=0x0000000000343413
- (unsigned long long)_updateTotalBytes;	// IMP=0x000000000034333a
- (void)stopTrackingItems:(id)arg1;	// IMP=0x000000000034308f
- (void)startTrackingItems:(id)arg1;	// IMP=0x0000000000342dde
- (id)initWithTrackingID:(id)arg1;	// IMP=0x0000000000342d84
- (id)init;	// IMP=0x0000000000342d1e
