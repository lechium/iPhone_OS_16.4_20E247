...
+ (long long)isPredominatelyDownload;	// IMP=0x0060000000298b27
- (void).cxx_destruct;	// IMP=0x00000000002992e3
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002991ec
- (void)main;	// IMP=0x0000000000298b3a
- (int)operationType;	// IMP=0x0000000000298b2f
- (void)_handleNotificationID:(id)arg1 withResponse:(id)arg2;	// IMP=0x000000000029883a
- (id)activityCreate;	// IMP=0x0000000000298811
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000298742
