...
- (void).cxx_destruct;	// IMP=0x0000000000261c19
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000261607
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000026121f
- (id)_handleRecords:(id)arg1;	// IMP=0x0000000000260f0e
- (id)generateRequestOperations;	// IMP=0x00000000002607c6
- (id)requestOperationClasses;	// IMP=0x000000000026075a
- (id)zoneIDsToLock;	// IMP=0x0000000000260748
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x0000000000260593
