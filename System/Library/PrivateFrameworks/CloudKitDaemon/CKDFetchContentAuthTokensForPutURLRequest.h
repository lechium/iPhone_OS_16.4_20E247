...
- (void).cxx_destruct;	// IMP=0x00000000000dec4f
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000de49f
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000dcae4
- (id)generateRequestOperations;	// IMP=0x00000000000db77c
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000db762
- (id)requestOperationClasses;	// IMP=0x00000000000db6f6
- (id)initWithOperation:(id)arg1 assetTokenRequest:(id)arg2 headers:(id)arg3;	// IMP=0x00000000000db64c
