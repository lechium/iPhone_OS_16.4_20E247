...
- (void).cxx_destruct;	// IMP=0x000000000028748b
...
- (id)analyticsPayload;	// IMP=0x0000000000287164
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002870c9
- (void)main;	// IMP=0x0000000000286efc
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x0000000000286330
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000002846cd
- (int)operationType;	// IMP=0x00000000002846c2
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000002841b0
- (id)activityCreate;	// IMP=0x0000000000284187
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x0000000000283ff3
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000283d74
