...
- (void).cxx_destruct;	// IMP=0x00000000002702aa
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000026fd84
- (id)generateRequestOperations;	// IMP=0x000000000026fb2c
- (id)requestOperationClasses;	// IMP=0x000000000026fac0
- (id)initWithOperation:(id)arg1 serverChangeTokenData:(id)arg2;	// IMP=0x000000000026fa27
