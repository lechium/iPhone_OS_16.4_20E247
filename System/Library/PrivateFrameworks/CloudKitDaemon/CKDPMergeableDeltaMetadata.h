...
+ (Class)replacedDeltaIdentifiersType;	// IMP=0x00100000003206f2
- (void).cxx_destruct;	// IMP=0x00000000003216f6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003213ed
- (unsigned long long)hash;	// IMP=0x000000000032132f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032119b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000320f23
- (void)copyTo:(id)arg1;	// IMP=0x0000000000320dc1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000320c01
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000320bf4
- (id)dictionaryRepresentation;	// IMP=0x00000000003207b2
- (id)description;	// IMP=0x0000000000320703
- (id)replacedDeltaIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003206d5
- (unsigned long long)replacedDeltaIdentifiersCount;	// IMP=0x00000000003206b8
- (void)addReplacedDeltaIdentifiers:(id)arg1;	// IMP=0x000000000032064e
- (void)clearReplacedDeltaIdentifiers;	// IMP=0x0000000000320631
