...
- (void).cxx_destruct;	// IMP=0x000000000018e950
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000018e7ab
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000018e445
- (id)generateRequestOperations;	// IMP=0x000000000018df38
- (_Bool)requestGETPreAuth;	// IMP=0x000000000018deed
- (id)requestOperationClasses;	// IMP=0x000000000018de81
- (long long)databaseScope;	// IMP=0x000000000018dde2
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000018ddc8
- (id)initWithOperation:(id)arg1 serviceName:(id)arg2 functionName:(id)arg3 serializedParameters:(id)arg4 attestationEntropy:(id)arg5 pccWrappedInvocationKeys:(id)arg6 trustedTargetWrappedInvocationKey:(id)arg7;	// IMP=0x000000000018dc7e
