...
- (void).cxx_destruct;	// IMP=0x000000000032d2bc
...
- (id)CKPropertiesDescription;	// IMP=0x000000000032d1d0
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x000000000032d0bf
- (long long)compareStartTime:(id)arg1;	// IMP=0x000000000032d03f
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x000000000032cf40
