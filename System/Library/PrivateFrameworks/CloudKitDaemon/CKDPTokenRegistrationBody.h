...
- (void).cxx_destruct;	// IMP=0x0000000000167f9d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000167ea3
- (unsigned long long)hash;	// IMP=0x0000000000167e07
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000167ce0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000167c05
- (void)copyTo:(id)arg1;	// IMP=0x0000000000167b65
- (void)writeTo:(id)arg1;	// IMP=0x0000000000167ab9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000167aac
- (id)dictionaryRepresentation;	// IMP=0x0000000000167675
- (id)description;	// IMP=0x00000000001675c6
@property(nonatomic) _Bool hasSkipBundleIDCheck;
- (int)StringAsApnsEnv:(id)arg1;	// IMP=0x000000000016751b
- (id)apnsEnvAsString:(int)arg1;	// IMP=0x00000000001674c6
