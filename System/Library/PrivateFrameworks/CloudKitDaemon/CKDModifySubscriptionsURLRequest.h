...
- (void).cxx_destruct;	// IMP=0x0000000000163a27
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000016382b
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001636e6
- (id)generateRequestOperations;	// IMP=0x0000000000162bf9
- (id)requestOperationClasses;	// IMP=0x0000000000162b12
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000162b0a
- (id)initWithOperation:(id)arg1 subscriptionsToSave:(id)arg2 subscriptionIDsToDelete:(id)arg3;	// IMP=0x0000000000162a3f
