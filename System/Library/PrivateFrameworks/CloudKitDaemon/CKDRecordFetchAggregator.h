...
- (void).cxx_destruct;	// IMP=0x000000000021219f
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000211f2e
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000211e6d
- (void)_finishRecordFetchAggregator;	// IMP=0x0000000000211a65
- (void)finishIfAppropriate;	// IMP=0x00000000002118db
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002115d6
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002109a4
- (void)main;	// IMP=0x00000000002106fd
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x00000000002102a0
- (void)_recordFetchesAvailable;	// IMP=0x00000000002101d6
- (void)_lockedSendFetchRequest;	// IMP=0x000000000020e5c5
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x000000000020e555
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x000000000020e393
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x000000000020e132
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x000000000020dec5
- (int)operationType;	// IMP=0x000000000020debd
- (id)description;	// IMP=0x000000000020deab
- (id)CKPropertiesDescription;	// IMP=0x000000000020d936
- (void)dealloc;	// IMP=0x000000000020d8db
- (id)activityCreate;	// IMP=0x000000000020d8b2
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000020d2d0
