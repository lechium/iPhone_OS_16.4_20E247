...
- (void).cxx_destruct;	// IMP=0x000000000035238e
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000352279
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000035205a
- (id)generateRequestOperations;	// IMP=0x0000000000351be7
- (id)requestOperationClasses;	// IMP=0x0000000000351b7b
- (id)initWithOperation:(id)arg1 assetOrPackageMetadata:(id)arg2 writeRepairRecord:(_Bool)arg3;	// IMP=0x0000000000351af1
