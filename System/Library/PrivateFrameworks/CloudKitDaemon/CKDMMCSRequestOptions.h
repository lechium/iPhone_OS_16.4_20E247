...
- (void).cxx_destruct;	// IMP=0x00000000002bb0d3
...
- (id)MMCSOptions;	// IMP=0x00000000002ba1d7
- (_Bool)usesBackgroundSession;	// IMP=0x00000000002ba186
- (id)description;	// IMP=0x00000000002ba174
- (id)CKPropertiesDescription;	// IMP=0x00000000002b9cca
- (id)initWithOperation:(id)arg1;	// IMP=0x00000000002b98eb
