...
- (id)encryptedDataContextString;	// IMP=0x00000000000a3339
- (id)assetContextString;	// IMP=0x00000000000a2f13
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2 mergeableDeltaID:(id)arg3 fileSignature:(id)arg4 referenceSignature:(id)arg5;	// IMP=0x00000000000a2cf8
