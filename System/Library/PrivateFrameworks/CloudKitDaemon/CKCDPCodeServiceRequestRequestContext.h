...
- (void).cxx_destruct;	// IMP=0x000000000034ba45
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000034b754
- (unsigned long long)hash;	// IMP=0x000000000034b5dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000034b34b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000034b159
- (void)copyTo:(id)arg1;	// IMP=0x000000000034afd5
- (void)writeTo:(id)arg1;	// IMP=0x000000000034ae5d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000034ae50
- (id)dictionaryRepresentation;	// IMP=0x000000000034a682
- (id)description;	// IMP=0x000000000034a5d3
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000034a420
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000034a3d7
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x000000000034a30b
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000034a2b6
