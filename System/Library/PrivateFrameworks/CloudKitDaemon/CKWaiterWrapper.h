...
- (void).cxx_destruct;	// IMP=0x000000000006f31a
...
- (id)CKPropertiesDescription;	// IMP=0x000000000006f272
- (id)description;	// IMP=0x000000000006f260
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x000000000006f14c
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x000000000006f03f
