...
- (void).cxx_destruct;	// IMP=0x0000000000365212
...
- (void)dealloc;	// IMP=0x0000000000365194
- (void)clear;	// IMP=0x000000000036518e
- (id)data;	// IMP=0x0000000000365164
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x0000000000364946
