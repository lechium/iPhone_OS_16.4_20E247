...
- (void).cxx_destruct;	// IMP=0x00000000002d2300
...
- (void)requestDidComplete;	// IMP=0x00000000002d20b2
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002d1bbd
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d1338
- (id)_handleRecordChanges:(id)arg1 deltaChanges:(id)arg2 forZoneID:(id)arg3;	// IMP=0x00000000002cf595
- (id)generateRequestOperations;	// IMP=0x00000000002ce2ec
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002ce2e4
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002ce277
- (id)requestOperationClasses;	// IMP=0x00000000002ce20b
- (id)zoneIDsToLock;	// IMP=0x00000000002ce1f9
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002ce1df
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002cdff9
