...
- (void).cxx_destruct;	// IMP=0x000000000022fe2e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000022fc7e
- (unsigned long long)hash;	// IMP=0x000000000022fb9e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000022fa1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022f8fb
- (void)copyTo:(id)arg1;	// IMP=0x000000000022f818
- (void)writeTo:(id)arg1;	// IMP=0x000000000022f731
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000022f724
- (id)dictionaryRepresentation;	// IMP=0x000000000022f068
- (id)description;	// IMP=0x000000000022efb9
...
- (int)StringAsDeleteType:(id)arg1;	// IMP=0x000000000022eea7
- (id)deleteTypeAsString:(int)arg1;	// IMP=0x000000000022ee5c
@property(nonatomic) _Bool hasDeleteType;
@property(nonatomic) int deleteType; // @synthesize deleteType=_deleteType;
- (int)StringAsChangeType:(id)arg1;	// IMP=0x000000000022ed8a
- (id)changeTypeAsString:(int)arg1;	// IMP=0x000000000022ed34
