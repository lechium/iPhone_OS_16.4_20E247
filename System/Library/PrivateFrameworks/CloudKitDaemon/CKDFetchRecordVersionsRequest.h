...
- (void).cxx_destruct;	// IMP=0x0000000000309d09
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000309ac6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000309647
- (id)generateRequestOperations;	// IMP=0x000000000030909c
- (id)requestOperationClasses;	// IMP=0x0000000000309030
- (id)zoneIDsToLock;	// IMP=0x0000000000308e6e
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x0000000000308d66
