...
- (void).cxx_destruct;	// IMP=0x00000000001aca8f
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001ac5e0
- (id)generateRequestOperations;	// IMP=0x00000000001ac512
- (id)requestOperationClasses;	// IMP=0x00000000001ac4a6
