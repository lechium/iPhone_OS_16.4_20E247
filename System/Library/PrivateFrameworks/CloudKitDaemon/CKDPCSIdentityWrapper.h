...
- (void).cxx_destruct;	// IMP=0x00000000002f5abe
...
- (void)dealloc;	// IMP=0x00000000002f56cb
- (id)initWithIdentitySet:(struct _PCSIdentitySetData *)arg1 withPrimaryServiceName:(id)arg2;	// IMP=0x00000000002f5648
