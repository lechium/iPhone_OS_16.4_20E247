...
- (void).cxx_destruct;	// IMP=0x000000000028823d
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x0000000000287ca8
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x0000000000287b86
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x00000000002879c4
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 packageIndexSets:(id)arg5 assetURLInfosToFillOut:(id)arg6;	// IMP=0x0000000000287534
