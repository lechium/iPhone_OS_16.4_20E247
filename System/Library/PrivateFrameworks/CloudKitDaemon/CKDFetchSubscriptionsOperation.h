...
- (void).cxx_destruct;	// IMP=0x000000000019319b
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001930a9
- (void)main;	// IMP=0x00000000001929d8
- (int)operationType;	// IMP=0x00000000001929cd
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x0000000000192765
- (id)activityCreate;	// IMP=0x000000000019273c
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000019266c
