...
- (void).cxx_destruct;	// IMP=0x00000000001621c6
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001620aa
- (void)_sendRequest:(_Bool)arg1;	// IMP=0x00000000001615e6
- (int)operationType;	// IMP=0x00000000001615db
- (void)main;	// IMP=0x000000000016129a
- (id)_addSelfIdentityToShareMetadataPublicPCS:(id)arg1 forShareWithURL:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001607e7
- (id)_encryptedKeyDataWithShareMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x000000000016057b
- (void)_handleVettingInitiationProgress:(id)arg1;	// IMP=0x000000000016043a
- (id)activityCreate;	// IMP=0x0000000000160411
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000160324
