...
- (void).cxx_destruct;	// IMP=0x00000000001204f6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000120173
- (unsigned long long)hash;	// IMP=0x000000000011ffb6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011fcb6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011fa8f
- (void)copyTo:(id)arg1;	// IMP=0x000000000011f8d9
- (void)writeTo:(id)arg1;	// IMP=0x000000000011f71d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000011f710
- (id)dictionaryRepresentation;	// IMP=0x000000000011ec86
- (id)description;	// IMP=0x000000000011ebd7
