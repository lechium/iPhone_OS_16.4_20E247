...
+ (id)options;	// IMP=0x0010000000176348
- (void).cxx_destruct;	// IMP=0x0000000000177534
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001772be
- (unsigned long long)hash;	// IMP=0x00000000001771b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000176fbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000176e3d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000176d1d
- (Class)responseClass;	// IMP=0x0000000000176d0c
- (unsigned int)requestTypeCode;	// IMP=0x0000000000176d01
- (void)writeTo:(id)arg1;	// IMP=0x0000000000176be1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000176bd4
- (id)dictionaryRepresentation;	// IMP=0x0000000000176575
- (id)description;	// IMP=0x00000000001764c6
