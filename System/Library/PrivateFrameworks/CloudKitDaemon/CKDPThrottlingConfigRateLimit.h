...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016d120
- (unsigned long long)hash;	// IMP=0x000000000016d088
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016cf66
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016ce9a
- (void)copyTo:(id)arg1;	// IMP=0x000000000016cdf1
- (void)writeTo:(id)arg1;	// IMP=0x000000000016cd21
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000016cd14
- (id)dictionaryRepresentation;	// IMP=0x000000000016c6d0
- (id)description;	// IMP=0x000000000016c621
