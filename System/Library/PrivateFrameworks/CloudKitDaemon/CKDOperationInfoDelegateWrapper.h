...
- (void).cxx_destruct;	// IMP=0x000000000025ac22
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x000000000025aaf2
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000025aa74
