...
- (void).cxx_destruct;	// IMP=0x000000000028156b
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000002813e1
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x0000000000281367
- (void)_noteOperationEnding;	// IMP=0x00000000002812ed
- (void)_noteOperationBeginning;	// IMP=0x0000000000281273
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x00000000002811f9
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x000000000028117c
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x00000000002810ff
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x0000000000281085
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x000000000028100b
- (id)activityCreate;	// IMP=0x0000000000280f8e
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x0000000000280f09
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000280ea5
- (void)main;	// IMP=0x0000000000280323
- (id)_possiblyWrapError:(id)arg1 forRecordWithID:(id)arg2 withCode:(long long)arg3 format:(id)arg4;	// IMP=0x000000000028010d
- (void)_sendFetchChangesRequestForZoneIDs:(id)arg1 withOptions:(id)arg2 previousRequestSchedulerInfo:(id)arg3;	// IMP=0x000000000027f1d9
- (void)_handleRecordDelete:(id)arg1 recordType:(id)arg2 perRequestSchedulerInfo:(id)arg3;	// IMP=0x000000000027ef2c
- (void)_handleChangedRecords:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000027e118
- (void)_handleFetchChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000027e09d
- (id)relevantZoneIDs;	// IMP=0x000000000027e088
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000027df18
