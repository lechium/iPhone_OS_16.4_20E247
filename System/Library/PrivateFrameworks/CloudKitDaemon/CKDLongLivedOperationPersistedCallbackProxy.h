...
- (void).cxx_destruct;	// IMP=0x0000000000230ca5
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000230af1
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000230943
- (id)initWithOperationID:(id)arg1 callbackProtocol:(id)arg2 completionSelector:(SEL)arg3 operationInfoCache:(id)arg4;	// IMP=0x00000000002308a8
