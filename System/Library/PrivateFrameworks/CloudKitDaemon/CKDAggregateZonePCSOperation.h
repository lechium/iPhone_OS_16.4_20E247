...
- (void).cxx_destruct;	// IMP=0x0000000000252c2f
...
- (void)_setPermanentFailure;	// IMP=0x000000000025286a
- (void)_handleZoneSavedWithID:(id)arg1 responseCode:(id)arg2;	// IMP=0x0000000000251c68
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x0000000000251a57
- (void)_sychronizeUserKeyRegistryIfNeeded;	// IMP=0x0000000000251563
- (int)operationType;	// IMP=0x0000000000251558
- (_Bool)_saveTargetZone;	// IMP=0x0000000000250df8
- (void)_prepareTargetZonePCS;	// IMP=0x0000000000250661
- (void)_fetchPCSDataForZoneID:(id)arg1;	// IMP=0x0000000000250077
- (void)_fetchZonePCS;	// IMP=0x000000000024fdd2
- (void)main;	// IMP=0x000000000024fdbe
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000024fd68
- (_Bool)makeStateTransition;	// IMP=0x000000000024fb54
- (id)relevantZoneIDs;	// IMP=0x000000000024fa61
- (id)activityCreate;	// IMP=0x000000000024fa38
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024f914
