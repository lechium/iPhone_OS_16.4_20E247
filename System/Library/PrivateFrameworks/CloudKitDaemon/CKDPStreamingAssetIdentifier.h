...
- (void).cxx_destruct;	// IMP=0x00000000000a2c91
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000a2b9f
- (unsigned long long)hash;	// IMP=0x00000000000a2b32
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a2a3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a2976
- (void)copyTo:(id)arg1;	// IMP=0x00000000000a28f3
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a2879
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a286c
- (id)dictionaryRepresentation;	// IMP=0x00000000000a2613
- (id)description;	// IMP=0x00000000000a2564
