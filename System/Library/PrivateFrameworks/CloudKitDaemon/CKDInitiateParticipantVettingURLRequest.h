...
- (void).cxx_destruct;	// IMP=0x00000000000fd42d
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000fd2cd
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000fd0b0
- (id)generateRequestOperations;	// IMP=0x00000000000fce42
- (id)requestOperationClasses;	// IMP=0x00000000000fcdd6
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x00000000000fccdb
