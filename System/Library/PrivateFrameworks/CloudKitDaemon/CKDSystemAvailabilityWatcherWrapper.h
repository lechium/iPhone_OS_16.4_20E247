...
- (void).cxx_destruct;	// IMP=0x00000000000fbcdb
...
- (id)description;	// IMP=0x00000000000fbb9f
- (unsigned long long)hash;	// IMP=0x00000000000fbb95
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fbb10
- (void)postSystemAvailabilityChanged:(unsigned long long)arg1;	// IMP=0x00000000000fba86
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000fb9f4
