...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001aa56b
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001aa46f
+ (Class)localizedArgumentsType;	// IMP=0x00100000001aa31f
- (void).cxx_destruct;	// IMP=0x00000000001ac3ba
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001abd59
- (unsigned long long)hash;	// IMP=0x00000000001abbd2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ab8d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ab2f5
- (void)copyTo:(id)arg1;	// IMP=0x00000000001aafd4
- (void)writeTo:(id)arg1;	// IMP=0x00000000001aabc1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001aabb4
- (id)dictionaryRepresentation;	// IMP=0x00000000001aa62b
- (id)description;	// IMP=0x00000000001aa57c
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001aa54e
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x00000000001aa531
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001aa4c7
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000001aa4aa
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001aa452
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x00000000001aa435
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001aa3cb
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000001aa3ae
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001aa302
- (unsigned long long)localizedArgumentsCount;	// IMP=0x00000000001aa2e5
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x00000000001aa27b
- (void)clearLocalizedArguments;	// IMP=0x00000000001aa25e
