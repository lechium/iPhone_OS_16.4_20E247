...
- (void).cxx_destruct;	// IMP=0x00000000002f55dc
...
- (void)cancel;	// IMP=0x00000000002f54f2
...
- (id)activityCreate;	// IMP=0x00000000002f5288
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x00000000002f50e2
