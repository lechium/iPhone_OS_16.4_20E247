...
- (void).cxx_destruct;	// IMP=0x0000000000346640
...
- (void)cancelAllOperations;	// IMP=0x000000000034626a
- (void)requestFetchOfZoneWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000034600d
- (void)requestFetchOfShareWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000345c60
- (void)requestFetchOfRecordWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000034582f
- (_Bool)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2;	// IMP=0x00000000003452ad
- (id)_lockedGetQueuedFetchForOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x0000000000344c18
- (void)_lockedRescheduleFetchTimer;	// IMP=0x0000000000344923
- (void)_lockedTearDownFetchTimer;	// IMP=0x000000000034489e
- (void)_lockedFetchesAreReady;	// IMP=0x0000000000343b7c
- (void)dealloc;	// IMP=0x0000000000343b3d
- (id)initWithContainer:(id)arg1;	// IMP=0x000000000034387c
- (id)init;	// IMP=0x000000000034381c
