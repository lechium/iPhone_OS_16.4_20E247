...
- (void).cxx_destruct;	// IMP=0x000000000034f99d
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000034f776
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000034f4b8
- (id)generateRequestOperations;	// IMP=0x000000000034eb9d
- (id)requestOperationClasses;	// IMP=0x000000000034eab6
- (id)zoneIDsToLock;	// IMP=0x000000000034e7f9
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000034e7f1
- (id)initWithOperation:(id)arg1 recordZonesToSave:(id)arg2 recordZoneIDsToDelete:(id)arg3;	// IMP=0x000000000034e726
