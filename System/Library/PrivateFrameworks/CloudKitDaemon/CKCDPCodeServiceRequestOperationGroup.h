...
- (void).cxx_destruct;	// IMP=0x00000000001f4274
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001f4150
- (unsigned long long)hash;	// IMP=0x00000000001f40ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f3f91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f3eac
- (void)copyTo:(id)arg1;	// IMP=0x00000000001f3e08
- (void)writeTo:(id)arg1;	// IMP=0x00000000001f3d69
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001f3d5c
- (id)dictionaryRepresentation;	// IMP=0x00000000001f39f0
- (id)description;	// IMP=0x00000000001f3941
