...
- (void).cxx_destruct;	// IMP=0x0000000000088993
...
- (void)start;	// IMP=0x00000000000879e2
- (void)createFetchOperationForItemIDs:(id)arg1 operationQueue:(id)arg2 operationConfigurationBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000087968
- (_Bool)dependentOperationListContainsOperationID:(id)arg1;	// IMP=0x00000000000878b0
- (_Bool)dependentOperationListContainsRunningFetch:(id)arg1;	// IMP=0x000000000008773f
- (_Bool)canBeUsedForPendingFetch:(id)arg1;	// IMP=0x0000000000087675
- (_Bool)canBeUsedForOperation:(id)arg1;	// IMP=0x00000000000875c4
- (id)description;	// IMP=0x00000000000875b2
- (id)CKPropertiesDescription;	// IMP=0x0000000000087483
- (void)cancelFetchOperation;	// IMP=0x00000000000873ea
- (void)finishFetchOperationWithError:(id)arg1;	// IMP=0x0000000000086f30
- (void)performCallbacksForItemWithID:(id)arg1 withItem:(id)arg2 error:(id)arg3;	// IMP=0x0000000000086aec
- (id)allItemIDs;	// IMP=0x0000000000086a28
- (id)callbacksForItemWithID:(id)arg1;	// IMP=0x0000000000086935
- (void)removeCallbacksForItemWithID:(id)arg1;	// IMP=0x0000000000086636
- (void)addCallbackForItemWithID:(id)arg1 operation:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000008626f
- (int)numberOfCallbacks;	// IMP=0x0000000000086082
@property(nonatomic) _Bool isCancelled; // @synthesize isCancelled=_isCancelled;
@property(nonatomic) _Bool isFinished; // @synthesize isFinished=_isFinished;
- (id)initWithOperation:(id)arg1 container:(id)arg2 operationQueue:(id)arg3;	// IMP=0x0000000000085a27
- (id)init;	// IMP=0x00000000000859c7
