...
- (void).cxx_destruct;	// IMP=0x00000000002787e3
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002784b6
- (void)main;	// IMP=0x00000000002784a2
- (id)checkPreconditions;	// IMP=0x00000000002783dd
- (id)assetOrPackageForFetchedRecord;	// IMP=0x0000000000278227
- (id)repairContainer;	// IMP=0x0000000000277ded
- (void)_markAssetBroken;	// IMP=0x00000000002769c9
- (int)operationType;	// IMP=0x00000000002769be
- (void)_breakAsset;	// IMP=0x0000000000275c17
- (void)_touchCreateRepairZone;	// IMP=0x0000000000275311
- (void)_touchFetchRepairZone;	// IMP=0x00000000002749e5
- (void)_fetchRecord;	// IMP=0x00000000002741e2
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000027418c
- (_Bool)makeStateTransition;	// IMP=0x0000000000273d1e
- (id)activityCreate;	// IMP=0x0000000000273cf5
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000273b94
