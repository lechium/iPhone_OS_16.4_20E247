...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000557f1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x000000000005571a
- (id)initWithIn:(id)arg1;	// IMP=0x0000000000055703
