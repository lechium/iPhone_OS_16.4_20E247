...
- (void).cxx_destruct;	// IMP=0x0000000000054991
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000547ea
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x0000000000054713
- (id)initWithIn:(id)arg1;	// IMP=0x00000000000546fc
