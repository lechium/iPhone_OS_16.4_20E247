...
- (void).cxx_destruct;	// IMP=0x000000000005764b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000574a4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x00000000000573cd
- (id)initWithIn:(id)arg1;	// IMP=0x00000000000573b6
