...
- (void)didChangeContentsOfBottomTray:(id)arg1;	// IMP=0x00000000000094e6
@property(copy, nonatomic) NSArray *actionButtons;
@property(readonly, copy, nonatomic) NSArray *auxiliaryViews;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000901b
- (void)removeBottomTray;	// IMP=0x0000000000008fde
- (void)scrollToBottom;	// IMP=0x0000000000008b89
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000008b26
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000008a09
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3;	// IMP=0x0000000000008986
- (void)layoutSubviews;	// IMP=0x000000000000854e
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000006a6e
