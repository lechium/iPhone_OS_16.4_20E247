...
- (void).cxx_destruct;	// IMP=0x000000000000e4b8
...
- (void)dealloc;	// IMP=0x000000000000e3a0
- (id)initWithViewController:(id)arg1 edge:(unsigned long long)arg2;	// IMP=0x000000000000e319
