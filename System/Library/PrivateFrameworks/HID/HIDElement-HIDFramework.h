...
- (double)scaleValue:(long long)arg1;	// IMP=0x0030000000005158
- (unsigned int)cookie;	// IMP=0x003000000000514e
- (void)setValueRef:(struct __IOHIDValue *)arg1;	// IMP=0x0030000000005141
- (struct __IOHIDValue *)valueRef;	// IMP=0x0030000000005137
- (id)description;	// IMP=0x0030000000005078
@end
