...
- (void).cxx_destruct;	// IMP=0x0000000000125170
- (id)initWithDOMObjectProvider:(id)arg1 viewport:(id)arg2 presentationDelegateProvider:(id)arg3 componentStyleRendererFactory:(id)arg4;	// IMP=0x0000000000125110
- (id)componentViewForComponent:(id)arg1;	// IMP=0x00000000001250c0
