...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000651c
- (void).cxx_destruct;	// IMP=0x00000000000066e3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000065e8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006524
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000063e3
