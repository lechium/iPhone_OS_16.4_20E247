...
@class NSArray, NSData, NSOrderedSet, NSString, PKAddSecureElementPassConfiguration, PKCatalog, PKDisplayProfile, PKGroupsControllerSnapshotFetchOptions, PKPaymentMarket, PKPaymentSetupConfiguration;
