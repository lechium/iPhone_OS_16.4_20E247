...
- (void).cxx_destruct;	// IMP=0x000000000004ceee
...
- (void)performActivity;	// IMP=0x000000000004cc65
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x000000000004caae
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x000000000004c981
- (id)activityImage;	// IMP=0x000000000004c86e
- (id)activityTitle;	// IMP=0x000000000004c844
- (id)activityType;	// IMP=0x000000000004c837
- (id)initFromView:(id)arg1 presentingViewController:(id)arg2 frameBlock:(CDUnknownBlockType)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000004c737
