...
- (void).cxx_destruct;	// IMP=0x00000000000499bc
...
- (_Bool)writeURL:(id)arg1 isDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000049212
- (_Bool)open:(id *)arg1;	// IMP=0x0000000000048fe2
- (_Bool)finish:(id *)arg1;	// IMP=0x0000000000048e75
- (_Bool)writeURLs:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000048a28
- (void)dealloc;	// IMP=0x00000000000489de
- (id)initWithDestinationURL:(id)arg1 baseURL:(id)arg2;	// IMP=0x0000000000048905
