...
- (id)incrementalPathInDirectory:(id)arg1 withFilename:(id)arg2 andExtension:(id)arg3;	// IMP=0x000000000001bfb3
- (_Bool)moveContentsOfDirectory:(id)arg1 toDirectory:(id)arg2 resultURLs:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001b9f8
- (_Bool)unarchiveSourcePath:(id)arg1 toDestinationPath:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001b0e0
- (id)temporaryDirectory;	// IMP=0x000000000001afc8
- (_Bool)unarchiveResultURLs:(id *)arg1 error:(id *)arg2;	// IMP=0x000000000001ae19
- (id)initWithSourceURL:(id)arg1 destinationURL:(id)arg2;	// IMP=0x000000000001ad4c
