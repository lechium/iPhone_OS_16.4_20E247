...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000302a0
- (void).cxx_destruct;	// IMP=0x00000000000308ff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000030620
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000302a8
- (void)dealloc;	// IMP=0x0000000000030262
- (void)relinquish;	// IMP=0x000000000002ffd6
- (id)initWithFileURL:(id)arg1;	// IMP=0x000000000002ff45
