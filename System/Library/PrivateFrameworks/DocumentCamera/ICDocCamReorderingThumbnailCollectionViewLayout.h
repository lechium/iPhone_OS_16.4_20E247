...
+ (double)effectiveAspectRatioForSize:(struct CGSize)arg1;	// IMP=0x0010000000025021
- (void).cxx_destruct;	// IMP=0x0000000000027510
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)arg1;	// IMP=0x00000000000271d6
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)arg1;	// IMP=0x00000000000270f0
- (void)finalizeCollectionViewUpdates;	// IMP=0x0000000000027096
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x0000000000026dbd
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x0000000000026db5
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000026bfb
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000026b0b
- (struct CGSize)collectionViewContentSize;	// IMP=0x0000000000026add
- (void)updateLayoutCacheIfNecessary;	// IMP=0x00000000000262d0
- (void)prepareLayout;	// IMP=0x00000000000262be
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1 withScrollingVelocity:(struct CGPoint)arg2;	// IMP=0x0000000000026079
- (void)setCurrentItem:(unsigned long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000025e84
- (void)setContentOffsetForItem:(unsigned long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000025d88
- (double)horizontalContentOffsetForItem:(unsigned long long)arg1;	// IMP=0x0000000000025c69
- (double)horizontalContentOffsetAdjustmentForItem:(unsigned long long)arg1;	// IMP=0x0000000000025ad7
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x00000000000256fa
- (void)setInterPageScrollPosition:(double)arg1;	// IMP=0x0000000000025289
@property(readonly, nonatomic) double extraSpacingForCurrentItem;
- (struct CGSize)itemSizeForImageSize:(struct CGSize)arg1;	// IMP=0x0000000000025059
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000024f4e
