...
- (void)handleReturnedURL:(id)arg1;	// IMP=0x000000000002d435
- (void)presentMarkupViewControllerFromView:(id)arg1;	// IMP=0x000000000002d056
- (void)dismissMarkupViewController;	// IMP=0x000000000002cf88
- (void)markupDoneAction:(id)arg1;	// IMP=0x000000000002cd5b
- (void)markupCancelAction:(id)arg1;	// IMP=0x000000000002cd49
- (void)presentMarkupFromView:(id)arg1;	// IMP=0x000000000002cd37
