...
- (void).cxx_destruct;	// IMP=0x000000000001cbfe
...
- (void)_cancelFireRequests;	// IMP=0x000000000001cad0
- (void)cancelPreviousFireRequests;	// IMP=0x000000000001ca49
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x000000000001c800
- (void)fireImmediately;	// IMP=0x000000000001c705
- (void)requestFire;	// IMP=0x000000000001c3e3
- (void)dealloc;	// IMP=0x000000000001c33e
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x000000000001c221
