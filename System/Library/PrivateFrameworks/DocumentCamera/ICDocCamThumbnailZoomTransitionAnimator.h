...
- (_Bool)_shouldCrossFadeNavigationBar;	// IMP=0x00000000000a70b5
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000a5551
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000a553f
- (id)initWithImage:(id)arg1 indexPath:(id)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a546e
