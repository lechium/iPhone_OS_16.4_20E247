...
- (void).cxx_destruct;	// IMP=0x0000000000039791
...
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000003971f
- (id)activityTypesThatInhibitPDFGeneration;	// IMP=0x00000000000396b5
- (_Bool)writeGalleryPDFDataToPasteboardIfNecessaryForActivity:(id)arg1 documentInfoCollection:(id)arg2;	// IMP=0x0000000000039544
- (_Bool)inhibitPDFGenerationForActivityType:(id)arg1;	// IMP=0x00000000000394a5
- (void)_performActivity:(id)arg1;	// IMP=0x0000000000039254
