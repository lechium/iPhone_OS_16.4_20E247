...
+ (void)setMainWindow:(id)arg1;	// IMP=0x0010000000038084
- (void).cxx_destruct;	// IMP=0x00000000000391d4
...
- (void)willDismissProgressViewController:(id)arg1;	// IMP=0x000000000003901f
- (void)closeProgressDialog;	// IMP=0x0000000000038f04
- (void)openProgressDialog;	// IMP=0x0000000000038999
- (void)updateProgress;	// IMP=0x000000000003862e
- (void)completeTaskIfNecessary;	// IMP=0x0000000000038435
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000038397
- (void)startTask:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000038098
- (id)initWithWindow:(id)arg1 intervalBeforeOpeningProgressDialog:(double)arg2;	// IMP=0x0000000000037ffd
- (id)init;	// IMP=0x0000000000037fdc
