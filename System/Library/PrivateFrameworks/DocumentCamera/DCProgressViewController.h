...
- (void).cxx_destruct;	// IMP=0x00000000000ad977
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000ad8a2
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000ad6c9
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000ad65f
- (void)viewDidLoad;	// IMP=0x00000000000ad55e
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000ad4aa
