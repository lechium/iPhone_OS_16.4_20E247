...
- (void).cxx_destruct;	// IMP=0x000000000003a201
...
- (void)hide;	// IMP=0x0000000000039db9
- (void)show;	// IMP=0x00000000000399e7
- (id)initWithView:(id)arg1 minimumDuration:(double)arg2;	// IMP=0x00000000000397c2
