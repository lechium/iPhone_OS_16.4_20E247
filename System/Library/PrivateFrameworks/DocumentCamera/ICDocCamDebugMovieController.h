...
- (void).cxx_destruct;	// IMP=0x000000000009ab55
...
- (struct CGAffineTransform)transformFromCurrentVideoOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009a7dc
- (double)angleOffsetFromPortraitOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009a7bc
- (void)removeFile:(id)arg1;	// IMP=0x000000000009a6a6
- (void)video:(id)arg1 didFinishSavingWithError:(id)arg2 contextInfo:(void *)arg3;	// IMP=0x000000000009a567
- (void)saveMovieToCameraRoll;	// IMP=0x000000000009a45e
- (void)resumeCaptureSessionForMovieRecording;	// IMP=0x000000000009a421
- (void)pauseCaptureSessionForMovieRecording;	// IMP=0x000000000009a3e4
- (_Bool)inputsReadyToRecord;	// IMP=0x000000000009a3ab
- (void)stopRecording;	// IMP=0x000000000009a112
- (void)startRecording;	// IMP=0x0000000000099f01
- (_Bool)setupAssetWriterMetadataInputAndMetadataAdaptor;	// IMP=0x0000000000099aec
- (_Bool)setupAssetWriterVideoInput:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x00000000000995a2
- (_Bool)writeMetaDataAtFrame:(long long)arg1 intrinsicMatrix:(CDStruct_d80e62f2)arg2;	// IMP=0x0000000000099126
- (void)writeSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 ofType:(id)arg2 atFrame:(long long)arg3;	// IMP=0x0000000000098e2b
- (void)recordingDidStop;	// IMP=0x0000000000098c65
- (void)recordingWillStop;	// IMP=0x0000000000098b3a
- (void)recordingDidStart;	// IMP=0x0000000000098a4e
- (void)recordingWillStart;	// IMP=0x000000000009884f
- (void)recordFrame:(struct opaqueCMSampleBuffer *)arg1 fromConnection:(id)arg2;	// IMP=0x0000000000098508
- (id)initWithDelegate:(id)arg1 videoConnection:(id)arg2 referenceOrientation:(long long)arg3;	// IMP=0x0000000000098394
