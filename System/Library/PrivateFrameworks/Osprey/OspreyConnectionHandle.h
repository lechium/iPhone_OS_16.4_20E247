...
- (void).cxx_destruct;	// IMP=0x000000000000f029
@property(readonly, nonatomic) id connectionKey; // @synthesize connectionKey=_connectionKey;
- (void)dealloc;	// IMP=0x000000000000efdf
- (id)initWithConnectionKey:(id)arg1 willRelease:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ef26
