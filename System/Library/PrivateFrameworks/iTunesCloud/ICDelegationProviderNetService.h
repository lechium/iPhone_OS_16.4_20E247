...
- (void).cxx_destruct;	// IMP=0x00000000001c3d5d
@property(readonly, nonatomic) NSNetService *netService; // @synthesize netService=_netService;
- (void)_updateTXTRecordProperties;	// IMP=0x00000000001c3bd9
- (void)_setState:(long long)arg1;	// IMP=0x00000000001c3a90
- (void)_resolveWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c39af
...
- (void)getResolvedStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c3681
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000001c358a
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x00000000001c34bc
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x00000000001c33ee
- (void)dealloc;	// IMP=0x00000000001c33aa
- (id)initWithNetService:(id)arg1;	// IMP=0x00000000001c327c
