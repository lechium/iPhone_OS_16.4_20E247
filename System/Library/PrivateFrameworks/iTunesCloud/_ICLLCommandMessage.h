...
- (void).cxx_destruct;	// IMP=0x0000000000089a37
- (unsigned long long)hash;	// IMP=0x00000000000898be
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000895ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000893b7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000089255
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000089248
- (id)dictionaryRepresentation;	// IMP=0x0000000000088e6b
- (id)description;	// IMP=0x0000000000088dbc
