...
- (void).cxx_destruct;	// IMP=0x000000000003e88b
...
- (void)_updateNetServiceStatus;	// IMP=0x000000000003e38c
- (void)stop;	// IMP=0x000000000003e341
- (void)publish;	// IMP=0x000000000003e2f6
@property(readonly, nonatomic) ICDelegationServiceSecuritySettings *securitySettings;
- (void)netService:(id)arg1 didNotPublish:(id)arg2;	// IMP=0x000000000003dfd1
- (void)netServiceDidPublish:(id)arg1;	// IMP=0x000000000003df18
- (void)netService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000003dd92
- (void)dealloc;	// IMP=0x000000000003dcd1
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1;	// IMP=0x000000000003dc06
