...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x001000000018e805
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x001000000018e7b6
- (void).cxx_destruct;	// IMP=0x000000000018b8c3
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x000000000018b083
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018ace8
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018ab92
- (void)_renewUserPseudonym;	// IMP=0x000000000018a9e0
- (void)_beginPseudonymAutoRenewal;	// IMP=0x000000000018a847
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018a01d
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000189f6c
- (void)dealloc;	// IMP=0x0000000000189eba
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x0000000000189dc2
