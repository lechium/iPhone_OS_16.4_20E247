...
- (void).cxx_destruct;	// IMP=0x0000000000018dc3
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000018ae1
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x000000000001896a
