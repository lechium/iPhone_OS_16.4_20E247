...
- (void).cxx_destruct;	// IMP=0x00000000001b1c04
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x00000000001b17ef
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001b13a1
- (void)endEvent:(id)arg1;	// IMP=0x00000000001b138d
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x00000000001b122b
- (void)startEvent:(id)arg1;	// IMP=0x00000000001b1217
- (id)init;	// IMP=0x00000000001b1192
