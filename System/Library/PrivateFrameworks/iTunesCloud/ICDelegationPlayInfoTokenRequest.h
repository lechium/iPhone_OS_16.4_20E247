...
- (void).cxx_destruct;	// IMP=0x0000000000159958
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015985b
@property(readonly, copy, nonatomic) NSMutableDictionary *propertyListRepresentation;
- (id)initWithDSID:(id)arg1 SICData:(id)arg2;	// IMP=0x000000000015970d
