...
@interface ICPAPlayActivityEvent : PBCodable
{
    ...
    _Bool _internalBuild;	// 492 = 0x1ec
    _Bool _offline;	// 493 = 0x1ed
    _Bool _privateListeningEnabled;	// 494 = 0x1ee
    _Bool _sBEnabled;	// 495 = 0x1ef
    _Bool _siriInitiated;	// 496 = 0x1f0
    struct {
...
- (void).cxx_destruct;	// IMP=0x0000000000134eb4
- (unsigned long long)hash;	// IMP=0x0000000000133f5a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013310f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000132595
- (void)writeTo:(id)arg1;	// IMP=0x0000000000131c38
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000013012c
- (id)dictionaryRepresentation;	// IMP=0x000000000012ee88
- (id)description;	// IMP=0x000000000012edd9
