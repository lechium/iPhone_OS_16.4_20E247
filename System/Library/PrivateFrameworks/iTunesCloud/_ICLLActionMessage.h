...
- (void).cxx_destruct;	// IMP=0x000000000003bf38
- (unsigned long long)hash;	// IMP=0x000000000003bd1d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003b91f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003b604
- (void)writeTo:(id)arg1;	// IMP=0x000000000003b3e0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003b3d3
- (id)dictionaryRepresentation;	// IMP=0x000000000003ae37
- (id)description;	// IMP=0x000000000003ad88
