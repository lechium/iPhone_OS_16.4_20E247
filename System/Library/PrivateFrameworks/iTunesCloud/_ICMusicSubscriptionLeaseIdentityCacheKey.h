...
- (void).cxx_destruct;	// IMP=0x00000000001a1657
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a1588
- (unsigned long long)hash;	// IMP=0x00000000001a152e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a1523
- (id)initWithDSID:(id)arg1 carrierBundleDeviceIdentifier:(id)arg2 delegatedDSID:(id)arg3;	// IMP=0x00000000001a143d
