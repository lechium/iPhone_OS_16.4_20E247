...
- (void).cxx_destruct;	// IMP=0x000000000012dd89
- (unsigned long long)hash;	// IMP=0x000000000012dc49
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012da1d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012d897
- (void)writeTo:(id)arg1;	// IMP=0x000000000012d755
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012d748
- (id)dictionaryRepresentation;	// IMP=0x000000000012d4e2
- (id)description;	// IMP=0x000000000012d433
