...
- (void).cxx_destruct;	// IMP=0x000000000015c4bb
...
- (id)_analyticSignature;	// IMP=0x000000000015c242
- (id)description;	// IMP=0x000000000015c158
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x000000000015bf7a
- (id)_actionType;	// IMP=0x000000000015bf44
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015be6c
