...
- (void).cxx_destruct;	// IMP=0x0000000000181393
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000180ed4
- (id)description;	// IMP=0x0000000000180d2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000180c69
- (unsigned long long)hash;	// IMP=0x0000000000180c1f
- (id)initWithTXTRecordData:(id)arg1;	// IMP=0x0000000000180897
