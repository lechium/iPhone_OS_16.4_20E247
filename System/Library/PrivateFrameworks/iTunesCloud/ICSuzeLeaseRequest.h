...
- (void).cxx_destruct;	// IMP=0x000000000012c8b9
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012c74f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012c685
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x000000000012c57e
