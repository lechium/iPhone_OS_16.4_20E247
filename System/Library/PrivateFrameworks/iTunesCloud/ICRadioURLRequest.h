...
- (void).cxx_destruct;	// IMP=0x00000000001ad1df
...
- (void)_decorateHeaderPropertiesForURLRequest:(id)arg1 withBuilderProperties:(id)arg2;	// IMP=0x00000000001acec4
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001accb9
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000001acc76
