...
- (void).cxx_destruct;	// IMP=0x0000000000187bff
...
- (void)_stop;	// IMP=0x0000000000187a2a
- (void)_handleTimeout;	// IMP=0x0000000000187948
- (void)stop;	// IMP=0x00000000001878fd
- (void)start;	// IMP=0x00000000001878b2
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x000000000018759c
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x0000000000187511
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x0000000000187486
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x00000000001873bc
- (void)dealloc;	// IMP=0x000000000018737e
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000187219
