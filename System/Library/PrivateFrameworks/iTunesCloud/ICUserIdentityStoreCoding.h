...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c9eb5
- (void).cxx_destruct;	// IMP=0x00000000000c9e77
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c9d3a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c9b8b
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c9b21
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000c9ad0
- (id)_initCommon;	// IMP=0x00000000000c9a95
