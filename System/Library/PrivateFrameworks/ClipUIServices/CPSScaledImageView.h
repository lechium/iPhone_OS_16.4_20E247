...
- (void).cxx_destruct;	// IMP=0x0000000000011741
@property(retain, nonatomic) NSString *textStyleForScaling; // @synthesize textStyleForScaling=_textStyleForScaling;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000115a9
- (void)invalidateIntrinsicContentSize;	// IMP=0x000000000001156d
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001147a
