...
- (void).cxx_destruct;	// IMP=0x000000000001f870
...
- (id)_textScaleUpSpringAnimation;	// IMP=0x000000000001f78b
- (id)_backdropEffectRemovalAnimationForKeyPath:(id)arg1;	// IMP=0x000000000001f73d
- (id)_basicAnimationToDecreaseOpacity;	// IMP=0x000000000001f700
- (id)_springAnimationToDecreaseOpacity;	// IMP=0x000000000001f6ab
- (id)_animationForTranslationY:(double)arg1;	// IMP=0x000000000001f60f
- (void)_reloadTapped:(id)arg1;	// IMP=0x000000000001f5f5
- (void)_showCompletionAnimation:(CDUnknownBlockType)arg1;	// IMP=0x000000000001f3c0
- (void)_updateConicGradientRotation;	// IMP=0x000000000001f26c
- (void)_revealBackgroundAndLabels;	// IMP=0x000000000001f038
- (void)_startAnimationIfNeeded;	// IMP=0x000000000001ef11
- (void)_updateLoadingProgress;	// IMP=0x000000000001ee3b
- (_Bool)_loadingIsComplete;	// IMP=0x000000000001ee1f
- (void)finishLoadingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e8a9
- (void)setLoadingProgress:(float)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000001e670
- (void)setBackgroundImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000001e447
@property(readonly, nonatomic) UIImage *backgroundImage;
- (void)setLoadingHasFailed:(_Bool)arg1 animated:(_Bool)arg2 reason:(id)arg3 reloadHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000001e12f
- (void)layoutSubviews;	// IMP=0x000000000001d735
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d6e8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001ca62
