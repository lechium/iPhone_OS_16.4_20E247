...
+ (id)logCategory;	// IMP=0x00100000009c7b33
- (void).cxx_destruct;	// IMP=0x00000000009c7ab9
...
- (id)logIdentifier;	// IMP=0x00000000009c7a0d
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x00000000009c7842
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x00000000009c7759
- (id)shortDescription;	// IMP=0x00000000009c76df
- (void)dealloc;	// IMP=0x00000000009c7622
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x00000000009c7587
