...
+ (id)logCategory;	// IMP=0x001000000071e8b1
+ (double)timeout;	// IMP=0x001000000071e7d3
- (void).cxx_destruct;	// IMP=0x000000000071e377
...
- (id)logIdentifier;	// IMP=0x000000000071e248
- (void)main;	// IMP=0x000000000071ddea
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000000071dc9f
