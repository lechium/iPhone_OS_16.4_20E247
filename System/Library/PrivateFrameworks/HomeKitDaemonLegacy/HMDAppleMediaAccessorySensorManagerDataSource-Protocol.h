...
@class HMDAccessory, HMDAppleMediaAccessorySensorManager, HMDService, HMSetupAccessoryDescription, NAFuture, NSArray, NSNotificationCenter, NSObject, NSString, NSUUID;
