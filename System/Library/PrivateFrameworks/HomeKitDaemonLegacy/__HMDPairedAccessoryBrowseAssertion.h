...
- (void).cxx_destruct;	// IMP=0x00000000008bab90
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x00000000008baafc
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x00000000008ba9c9
- (id)initWithName:(id)arg1;	// IMP=0x00000000008ba913
