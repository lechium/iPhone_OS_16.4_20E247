...
@class HAPAccessoryServer, HMDMediaBrowser, HMDUnassociatedAccessory, HMDUnpairedHAPAccessory, HMDUnpairedHAPAccessoryConfiguration, HMSetupAccessoryDescription, NSArray, NSData, NSDictionary, NSError, NSSet, NSString, NSUUID;
