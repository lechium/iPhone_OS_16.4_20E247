...
- (void)removeWatchers;	// IMP=0x000000000000c47f
- (void)installWatchers;	// IMP=0x000000000000c1ba
- (void)cancel;	// IMP=0x000000000000bf40
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000b9d0
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000b2b9
- (void)dealloc;	// IMP=0x000000000000b182
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ad27
