...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00200000000bcbd8
- (id)af_assistedSelectionItem;	// IMP=0x00200000000bc579
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00200000000bc2d3
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00200000000bc21c
