...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x0000000000001fbc
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x0000000000001e30
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001b59
