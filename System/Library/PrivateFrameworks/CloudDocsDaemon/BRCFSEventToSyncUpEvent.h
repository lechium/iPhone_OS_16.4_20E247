...
- (void).cxx_destruct;	// IMP=0x0000000000053a6e
...
- (id)associatedAppTelemetryEvent;	// IMP=0x0000000000053949
- (id)subDescription;	// IMP=0x0000000000053891
- (id)additionalPayload;	// IMP=0x000000000005374f
