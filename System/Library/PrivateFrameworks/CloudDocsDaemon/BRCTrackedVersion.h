...
+ (id)trackedVersionFor:(id)arg1 withEtagIfLoser:(id)arg2;	// IMP=0x001000000000e51c
- (void).cxx_destruct;	// IMP=0x000000000000e6b8
...
- (unsigned long long)hash;	// IMP=0x000000000000e665
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e5a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e59a
