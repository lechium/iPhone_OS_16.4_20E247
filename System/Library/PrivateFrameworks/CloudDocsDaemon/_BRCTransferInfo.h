...
- (void).cxx_destruct;	// IMP=0x000000000016a8d0
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x000000000016a7df
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000016a701
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x00000000003815a6
- (void)updateUnitCount;	// IMP=0x000000000016a1b5
- (id)description;	// IMP=0x0000000000169e6b
- (id)init;	// IMP=0x0000000000169d50
