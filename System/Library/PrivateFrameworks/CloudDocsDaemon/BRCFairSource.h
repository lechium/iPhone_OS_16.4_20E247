...
- (void).cxx_destruct;	// IMP=0x0000000000277fb9
@property(copy, nonatomic) CDUnknownBlockType eventHandler; // @synthesize eventHandler=_eventHandler;
@property(retain, nonatomic) NSObject<OS_dispatch_workloop> *workloop; // @synthesize workloop=_workloop;
- (void)resume;	// IMP=0x0000000000277e66
- (void)suspend;	// IMP=0x0000000000277e35
- (void)cancel;	// IMP=0x0000000000277e03
- (void)_runEventHandler;	// IMP=0x0000000000277d75
- (void)signal;	// IMP=0x0000000000277d0a
- (id)description;	// IMP=0x0000000000277c9b
- (id)initWithName:(id)arg1 scheduler:(id)arg2;	// IMP=0x0000000000277be8
