...
- (void).cxx_destruct;	// IMP=0x0000000000059e64
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x000000000005791f
- (void)generateReportWithSession:(id)arg1;	// IMP=0x0000000000054e31
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x0000000000054d61
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x0000000000054a55
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x0000000000054a13
- (id)init;	// IMP=0x0000000000054959
