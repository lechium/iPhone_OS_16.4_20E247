...
- (_Bool)setUpForRelPath:(id)arg1 session:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000752b
@property(readonly, nonatomic) NSNumber *totalSize;
@property(readonly, nonatomic) NSNumber *freeSize;
- (id)description;	// IMP=0x00000000000072f0
@property(readonly, nonatomic) NSString *fsTypeName;
- (int)_setUpForStatfs:(struct statfs)arg1;	// IMP=0x00000000000071c1
