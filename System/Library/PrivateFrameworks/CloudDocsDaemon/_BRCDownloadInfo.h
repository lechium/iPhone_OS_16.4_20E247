...
- (void).cxx_destruct;	// IMP=0x000000000016b400
...
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000016b2db
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x000000000016b01b
- (id)init;	// IMP=0x000000000016af6c
