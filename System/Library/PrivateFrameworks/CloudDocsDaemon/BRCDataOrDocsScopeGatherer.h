...
- (void).cxx_destruct;	// IMP=0x000000000007e56a
...
- (void)dealloc;	// IMP=0x000000000007e511
- (void)invalidate;	// IMP=0x000000000007e32d
- (void)done;	// IMP=0x000000000007e140
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x000000000007e0d3
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000007c8f8
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x000000000007c568
