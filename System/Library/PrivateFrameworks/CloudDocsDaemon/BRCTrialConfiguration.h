...
+ (id)defaultConfiguration;	// IMP=0x00600000001b72f0
- (void).cxx_destruct;	// IMP=0x00000000001b7aa5
...
- (_Bool)boolForFactor:(id)arg1 client:(id)arg2 namespace:(id)arg3 byDefault:(_Bool)arg4;	// IMP=0x00000000001b7984
- (long long)longLongForFactor:(id)arg1 client:(id)arg2 namespace:(id)arg3 min:(long long)arg4 max:(long long)arg5 byDefault:(long long)arg6;	// IMP=0x00000000001b77a0
- (void)refresh;	// IMP=0x00000000001b7391
- (id)init;	// IMP=0x00000000001b7345
