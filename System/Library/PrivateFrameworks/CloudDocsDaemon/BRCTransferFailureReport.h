...
- (void).cxx_destruct;	// IMP=0x000000000005491b
...
- (_Bool)isEqualToTransferFailureReport:(id)arg1;	// IMP=0x00000000000546eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000054688
- (unsigned long long)hash;	// IMP=0x00000000000545e7
- (id)description;	// IMP=0x0000000000054599
- (void)encounteredErrors:(unsigned long long)arg1 atDate:(id)arg2;	// IMP=0x0000000000054492
- (void)encounteredErrorWithPCSState:(unsigned int)arg1 privateDB:(_Bool)arg2 atDate:(id)arg3;	// IMP=0x0000000000054343
- (void)setLastFailureDate:(id)arg1;	// IMP=0x0000000000054288
- (id)initWithError:(id)arg1;	// IMP=0x00000000000541e8
