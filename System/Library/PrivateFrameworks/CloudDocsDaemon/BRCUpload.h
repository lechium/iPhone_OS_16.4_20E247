...
- (void).cxx_destruct;	// IMP=0x00000000000fa0ed
...
- (void)dealloc;	// IMP=0x00000000000fa027
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x00000000000f9e98
- (id)description;	// IMP=0x00000000000f9e6b
