...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x006000000005a74f
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x006000000005a2b1
- (void).cxx_destruct;	// IMP=0x000000000005b1aa
...
- (id)telemetryEvent;	// IMP=0x000000000005b09c
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x000000000005a00b
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000059f2e
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000059ec3
