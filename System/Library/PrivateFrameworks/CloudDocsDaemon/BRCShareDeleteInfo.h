...
- (void).cxx_destruct;	// IMP=0x0000000000261fed
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000261f4b
- (unsigned long long)hash;	// IMP=0x0000000000261f35
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x0000000000261e9c
