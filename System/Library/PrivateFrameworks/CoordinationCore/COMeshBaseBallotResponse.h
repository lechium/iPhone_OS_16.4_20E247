...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000663bd
- (void).cxx_destruct;	// IMP=0x0000000000066409
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000662d9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000661ec
- (id)initWithBallot:(id)arg1 generation:(unsigned long long)arg2 variant:(long long)arg3;	// IMP=0x00000000000661bf
- (id)initWithBallot:(id)arg1 generation:(unsigned long long)arg2;	// IMP=0x0000000000066124
