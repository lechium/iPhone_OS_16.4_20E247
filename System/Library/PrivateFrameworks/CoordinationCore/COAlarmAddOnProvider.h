...
- (void).cxx_destruct;	// IMP=0x000000000004cdb1
...
- (id)serviceAddOn;	// IMP=0x000000000004ccdc
- (id)init;	// IMP=0x000000000004cc38
- (id)initWithAlarmManager:(id)arg1 homekitAdapter:(id)arg2 hubAdapter:(id)arg3;	// IMP=0x000000000004cb81
