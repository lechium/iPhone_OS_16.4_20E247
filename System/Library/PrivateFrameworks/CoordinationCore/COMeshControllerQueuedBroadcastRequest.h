...
- (void).cxx_destruct;	// IMP=0x00000000000365a0
...
- (void)invokeCallbackWithError:(id)arg1;	// IMP=0x000000000003648a
- (id)command;	// IMP=0x0000000000036478
- (id)initWithRequest:(id)arg1 destination:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000363ae
