...
- (void).cxx_destruct;	// IMP=0x0000000000026874
...
- (id)initWithTopic:(id)arg1 cluster:(id)arg2 handledClasses:(id)arg3 client:(id)arg4 activateCompletionHanlder:(CDUnknownBlockType)arg5;	// IMP=0x00000000000266dc
