...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000660c5
- (void).cxx_destruct;	// IMP=0x0000000000066111
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000065fe1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000065ef4
- (id)initWithBallot:(id)arg1 generation:(unsigned long long)arg2 variant:(long long)arg3;	// IMP=0x0000000000065ec7
- (id)initWithBallot:(id)arg1 generation:(unsigned long long)arg2;	// IMP=0x0000000000065e2c
