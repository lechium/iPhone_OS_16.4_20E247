...
- (void).cxx_destruct;	// IMP=0x000000000008ff51
@property __weak id <COEndpointMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_activateLink;	// IMP=0x000000000008fddf
- (void)startMonitoring;	// IMP=0x000000000008fd99
- (id)init;	// IMP=0x000000000008fd17
