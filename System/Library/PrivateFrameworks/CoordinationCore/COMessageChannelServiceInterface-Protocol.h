...
@class COClusterMember, NSData, NSObject, NSSet, NSString;
...
- (void)activateMessageChannelForTopic:(NSString *)arg1 cluster:(id)arg2 handlers:(NSSet *)arg3 withCompletion:(void (^)(NSError *, unsigned long long, unsigned long long))arg4;
@end
