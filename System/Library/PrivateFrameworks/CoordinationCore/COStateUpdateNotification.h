...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000051ba9
- (void).cxx_destruct;	// IMP=0x0000000000051bd3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051ad5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000512e4
- (id)initWithUpdates:(id)arg1 removals:(id)arg2;	// IMP=0x0000000000051242
