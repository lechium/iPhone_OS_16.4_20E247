...
- (void).cxx_destruct;	// IMP=0x0000000000004635
...
- (id)initWithMipmapLevelCount:(unsigned long long)arg1 arrayLength:(unsigned long long)arg2 cubemap:(_Bool)arg3;	// IMP=0x0000000000004512
