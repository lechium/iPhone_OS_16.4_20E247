...
- (void)removeConversationLinkDescriptorsWithPredicate:(NSPredicate *)arg1 userInteraction:(_Bool)arg2 completion:(void (^)(unsigned long long, NSError *))arg3;
- (unsigned long long)removeConversationLinkDescriptorsWithPredicate:(NSPredicate *)arg1 userInteraction:(_Bool)arg2 error:(id *)arg3;
