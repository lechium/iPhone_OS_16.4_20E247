...
+ (_Bool)sourceTypeIsFoundOnServers:(unsigned long long)arg1;	// IMP=0x00600000000c75e4
+ (_Bool)sourceTypeIsFoundInMail:(unsigned long long)arg1;	// IMP=0x00600000000c75d5
- (void).cxx_destruct;	// IMP=0x00000000000c7669
...
- (void)addResult:(id)arg1;	// IMP=0x00000000000c74d4
- (id)init;	// IMP=0x00000000000c7436
- (id)searchResults;	// IMP=0x00000000000c76a5
