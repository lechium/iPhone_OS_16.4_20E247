...
- (void)fetchAllAssetsWithCompletionHandler:(void (^)(NSError *))arg1;	// IMP=0x003000000002aec0
- (void)fetchNextAssetsWithCompletionHandler:(void (^)(NSError *))arg1;	// IMP=0x003000000002a940
