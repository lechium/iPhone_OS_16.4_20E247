...
- (void).cxx_destruct;	// IMP=0x00000000000712bb
@property(readonly, nonatomic) NSBundle *bundle; // @synthesize bundle=_bundle;
- (id)debugDescription;	// IMP=0x0000000000071181
- (id)description;	// IMP=0x00000000000710de
- (_Bool)principalObjectRespondsToSelector:(SEL)arg1;	// IMP=0x00000000000710a9
...
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000000070c92
- (id)init;	// IMP=0x0000000000070c67
