...
- (void).cxx_destruct;	// IMP=0x000000000001e270
- (id)init;	// IMP=0x000000000001e220
- (void)cancel;	// IMP=0x000000000001c6d0
- (void)receiveCompletion:(id)arg1;	// IMP=0x000000000001c660
- (long long)receiveInput:(id)arg1;	// IMP=0x000000000001c5a0
- (void)receiveSubscription:(id)arg1;	// IMP=0x000000000001c580
