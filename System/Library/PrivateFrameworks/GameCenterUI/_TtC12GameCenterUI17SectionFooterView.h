...
- (void).cxx_destruct;	// IMP=0x00000000004679f0
...
- (void)prepareForReuse;	// IMP=0x0000000000466320
- (void)handleTapWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000465f90
- (void)layoutSubviews;	// IMP=0x0000000000465ea0
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000004655e0
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004651e0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000464fa0
