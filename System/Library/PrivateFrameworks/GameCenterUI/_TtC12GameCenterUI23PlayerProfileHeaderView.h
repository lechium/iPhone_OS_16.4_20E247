...
- (void).cxx_destruct;	// IMP=0x0000000000481290
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000480300
- (void)layoutSubviews;	// IMP=0x00000000004801c0
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000000047fe50
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000047f7f0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000047f7d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000047f510
