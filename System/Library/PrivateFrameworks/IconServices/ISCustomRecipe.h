...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000252d8
- (void).cxx_destruct;	// IMP=0x00000000000257ac
...
- (id)resourceNamed:(id)arg1;	// IMP=0x00000000000255fc
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x00000000000254f5
