...
+ (id)descriptorFromGraphicIconConfiguration:(id)arg1;	// IMP=0x006000000002485a
+ (id)descriptorFromGraphicSymbolRecipe:(id)arg1;	// IMP=0x00600000000243ee
- (void).cxx_destruct;	// IMP=0x0000000000024d59
