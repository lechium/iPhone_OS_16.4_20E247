...
+ (id)localeSpecificStorageForLocale:(id)arg1;	// IMP=0x00600000002bb3e8
- (void).cxx_destruct;	// IMP=0x00000000002bb6f6
...
- (id)initWithLocale:(id)arg1;	// IMP=0x00000000002baeb8
