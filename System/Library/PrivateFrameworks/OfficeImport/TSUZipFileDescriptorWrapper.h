...
- (void).cxx_destruct;	// IMP=0x00000000002b0f0a
...
- (void)waitForAccessToEnd;	// IMP=0x00000000002b0ee2
- (void)endAccess;	// IMP=0x00000000002b0ed4
- (void)beginAccess;	// IMP=0x00000000002b0ec6
- (void)dealloc;	// IMP=0x00000000002b0e84
- (id)initWithFileDescriptor:(int)arg1 queue:(id)arg2;	// IMP=0x00000000002b0d63
- (id)init;	// IMP=0x00000000002b0c3a
