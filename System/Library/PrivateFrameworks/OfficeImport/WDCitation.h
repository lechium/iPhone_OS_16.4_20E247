...
+ (id)stringValuesForNodesAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2 trimStyle:(_Bool)arg3;	// IMP=0x00600000004160fc
+ (id)stringValueForNodeAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2 trimStyle:(_Bool)arg3;	// IMP=0x0060000000416040
+ (id)subStringOf:(struct _xmlNode *)arg1 forPath:(id)arg2;	// IMP=0x0060000000415f83
+ (struct _xmlNode *)trimStyle:(struct _xmlNode *)arg1;	// IMP=0x0060000000415f51
+ (struct _xmlNode *)nodeAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2;	// IMP=0x0060000000415db8
+ (id)wordStringForRefType:(int)arg1;	// IMP=0x0060000000415b82
+ (int)refTypeForWordString:(id)arg1;	// IMP=0x0060000000415af6
+ (id)endNoteStringForRefType:(int)arg1;	// IMP=0x0060000000415a83
+ (id)refTypeEnumMap;	// IMP=0x00600000004158d9
+ (id)wordRefTypeEnumMap;	// IMP=0x0060000000415825
- (void).cxx_destruct;	// IMP=0x000000000041646a
...
- (id)description;	// IMP=0x00000000004162ed
- (id)initWithDocument:(id)arg1;	// IMP=0x000000000041598d
