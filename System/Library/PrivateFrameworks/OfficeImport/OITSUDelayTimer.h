...
- (void)cancel;	// IMP=0x000000000029abe3
- (void)_reallyCancel;	// IMP=0x000000000029aba1
- (void)afterDelay:(double)arg1 processBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000029a9a7
- (void)dealloc;	// IMP=0x000000000029a952
- (id)initWithTargetSerialQueue:(id)arg1;	// IMP=0x000000000029a840
- (id)init;	// IMP=0x000000000029a82c
