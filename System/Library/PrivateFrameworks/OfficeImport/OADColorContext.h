...
+ (id)colorContextWithScheme:(id)arg1 map:(id)arg2 palette:(id)arg3;	// IMP=0x0060000000308841
- (void).cxx_destruct;	// IMP=0x0000000000308af5
...
- (void)applyThemeOverrides:(id)arg1 colorMapOverride:(id)arg2;	// IMP=0x0000000000308a12
- (unsigned long long)hash;	// IMP=0x00000000003089a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003088ec
- (id)initWithScheme:(id)arg1 map:(id)arg2 palette:(id)arg3;	// IMP=0x0000000000033e06
