...
+ (id)fontMetadataWithSig:(id)arg1 charSet:(int)arg2 panose1:(id)arg3 pitch:(int)arg4 genericFamily:(int)arg5 altNames:(id)arg6;	// IMP=0x006000000036e5ba
- (void).cxx_destruct;	// IMP=0x000000000036e6be
...
- (id)initWithSig:(id)arg1 charSet:(int)arg2 panose1:(id)arg3 pitch:(int)arg4 genericFamily:(int)arg5 altNames:(id)arg6;	// IMP=0x000000000036e4a6
