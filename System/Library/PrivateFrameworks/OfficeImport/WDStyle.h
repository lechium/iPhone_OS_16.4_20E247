...
- (void).cxx_destruct;	// IMP=0x00000000003feb17
...
- (id)description;	// IMP=0x00000000003feac0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003fe8f8
@property __weak WDStyle *baseStyle; // @synthesize baseStyle=mBaseStyle;
- (id)id;	// IMP=0x000000000019dbfe
- (int)type;	// IMP=0x00000000000ce866
- (void)setName:(id)arg1;	// IMP=0x00000000000cc03b
- (id)name;	// IMP=0x00000000000ce872
- (id)tableStyleOverrideForPart:(int)arg1;	// IMP=0x0000000000162968
- (id)tableCellProperties;	// IMP=0x00000000001625cf
- (id)tableRowProperties;	// IMP=0x00000000001624db
- (id)tableProperties;	// IMP=0x000000000019ddb3
- (_Bool)isAnythingOverridden;	// IMP=0x00000000003fe8b5
- (void)setHidden:(_Bool)arg1;	// IMP=0x00000000000cc643
- (_Bool)hidden;	// IMP=0x00000000003fe8a9
- (id)characterProperties;	// IMP=0x00000000000cd589
- (id)paragraphProperties;	// IMP=0x00000000000cc749
- (id)initWithStyleSheet:(id)arg1 id:(id)arg2 type:(int)arg3;	// IMP=0x00000000000cbdbc
