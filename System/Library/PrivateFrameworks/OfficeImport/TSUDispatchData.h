...
- (void).cxx_destruct;	// IMP=0x00000000002aeb55
...
- (void)defragmentData;	// IMP=0x00000000002aea18
- (void)append:(id)arg1;	// IMP=0x00000000002ae972
- (id)initWithData:(id)arg1;	// IMP=0x00000000002ae8b2
- (id)init;	// IMP=0x00000000002ae899
