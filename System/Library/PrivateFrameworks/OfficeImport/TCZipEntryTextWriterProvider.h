...
- (void).cxx_destruct;	// IMP=0x00000000002e6849
...
- (_Bool)setUp;	// IMP=0x00000000002e679b
- (id)initWithEntryName:(id)arg1 outputStream:(id)arg2 isCompressed:(_Bool)arg3;	// IMP=0x00000000002e66bb
