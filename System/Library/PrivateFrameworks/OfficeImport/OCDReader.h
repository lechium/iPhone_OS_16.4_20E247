...
- (void).cxx_destruct;	// IMP=0x00000000003780be
...
- (void)setStartErrorMessageFromException:(id)arg1;	// IMP=0x0000000000378024
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x0000000000377f90
- (_Bool)verifyFileFormat;	// IMP=0x000000000037811d
- (id)read;	// IMP=0x0000000000378115
- (_Bool)start;	// IMP=0x000000000037810d
- (_Bool)isBinaryReader;	// IMP=0x0000000000378105
