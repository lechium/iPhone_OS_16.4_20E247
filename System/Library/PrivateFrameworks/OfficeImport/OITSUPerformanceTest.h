...
+ (id)csvHeader;	// IMP=0x0060000000264b66
...
- (id)csvString;	// IMP=0x0000000000264b73
- (void)report;	// IMP=0x00000000002648d1
- (void)run;	// IMP=0x000000000026443b
- (void)dealloc;	// IMP=0x00000000002643f1
- (id)initWithName:(id)arg1 selector:(SEL)arg2 target:(id)arg3 goalTime:(double)arg4;	// IMP=0x000000000026433c
