...
+ (id)stringForTextWrappingModeType:(int)arg1;	// IMP=0x00600000003e3b81
- (void).cxx_destruct;	// IMP=0x00000000003e3c4b
...
- (id)description;	// IMP=0x00000000003e3ba2
- (id)init;	// IMP=0x0000000000157bfa
