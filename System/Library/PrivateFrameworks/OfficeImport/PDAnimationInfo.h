...
- (void).cxx_destruct;	// IMP=0x000000000043e48d
...
- (id)description;	// IMP=0x000000000043e419
- (id)exitData;	// IMP=0x000000000043e40b
- (void)setExitData:(id)arg1;	// IMP=0x000000000043e3fa
- (id)entranceData;	// IMP=0x000000000043e3ec
- (void)setEntranceData:(id)arg1;	// IMP=0x000000000043e3db
