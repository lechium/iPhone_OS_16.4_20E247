...
- (void).cxx_destruct;	// IMP=0x0000000000472fdc
@property __weak EDSheet *currentSheet; // @synthesize currentSheet=_currentSheet;
- (void)setHyperlink:(id)arg1 forRow:(unsigned long long)arg2 column:(unsigned long long)arg3;	// IMP=0x0000000000472efd
- (id)hyperlinkForRow:(unsigned long long)arg1 column:(unsigned long long)arg2;	// IMP=0x0000000000472e74
