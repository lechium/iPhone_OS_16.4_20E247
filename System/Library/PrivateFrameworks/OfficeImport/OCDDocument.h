...
- (void).cxx_destruct;	// IMP=0x000000000034ee6b
...
- (id)bulletBlips;	// IMP=0x000000000034ee20
- (void)setTheme:(id)arg1;	// IMP=0x000000000034ee0f
- (id)theme;	// IMP=0x000000000034ee01
- (void)removeUnnecessaryOverrides;	// IMP=0x000000000034edfb
- (void)setUpPropertyHierarchyPreservingEffectiveValues;	// IMP=0x000000000034edf5
- (void)setEncryptionInfo:(id)arg1;	// IMP=0x000000000034ede4
- (id)encryptionInfo;	// IMP=0x000000000034edd6
- (_Bool)isFromBinaryFile;	// IMP=0x000000000034edc0
- (id)init;	// IMP=0x0000000000009aa4
