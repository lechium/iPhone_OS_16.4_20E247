...
- (_Bool)chartAutoStrokeIsHollow;	// IMP=0x00000000003b42a9
- (_Bool)chartAutoFillIsHollow;	// IMP=0x00000000003b4299
- (void)readClientDataFromNode:(struct _xmlNode *)arg1 toDrawable:(id)arg2 state:(id)arg3;	// IMP=0x000000000021a4a3
