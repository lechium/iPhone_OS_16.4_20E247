...
+ (id)styleWithResources:(id)arg1;	// IMP=0x00100000003a78b9
- (void).cxx_destruct;	// IMP=0x00000000003a7caf
...
- (void)setDoNotModify:(_Bool)arg1;	// IMP=0x000000000011a096
- (unsigned long long)index;	// IMP=0x000000000013210b
- (void)setParent:(id)arg1;	// IMP=0x00000000003a7b89
- (id)parent;	// IMP=0x00000000003a7af6
...
- (_Bool)isCenterAcrossAligned;	// IMP=0x00000000003a7a7a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023077d
- (_Bool)isEqualToStyle:(id)arg1;	// IMP=0x00000000002307f9
- (_Bool)isEquivalentToStyle:(id)arg1;	// IMP=0x0000000000230898
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022f34d
- (id)initWithResources:(id)arg1;	// IMP=0x0000000000118726
@property(readonly, copy) NSString *description;
- (void)setAlignmentInfoIndex:(unsigned long long)arg1;	// IMP=0x00000000003a7d07
- (unsigned long long)alignmentInfoIndex;	// IMP=0x00000000003a7cfd
- (void)setFillIndex:(unsigned long long)arg1;	// IMP=0x00000000001bab59
- (unsigned long long)fillIndex;	// IMP=0x00000000003a7cf3
- (void)setBordersIndex:(unsigned long long)arg1;	// IMP=0x00000000001bab43
- (unsigned long long)bordersIndex;	// IMP=0x00000000003a7ce9
- (void)setParentIndex:(unsigned long long)arg1;	// IMP=0x0000000000118982
- (unsigned long long)parentIndex;	// IMP=0x00000000003a7cdf
- (void)setContentFormatId:(unsigned long long)arg1;	// IMP=0x0000000000119fa6
- (unsigned long long)contentFormatId;	// IMP=0x00000000001331cd
- (void)setFontIndex:(unsigned long long)arg1;	// IMP=0x00000000001189c2
- (unsigned long long)fontIndex;	// IMP=0x00000000003a7cd5
- (void)setIndex:(unsigned long long)arg1;	// IMP=0x000000000011a09f
