...
- (void)invalidate;	// IMP=0x0000000000286bf4
- (id)value;	// IMP=0x0000000000286a30
- (void)p_setValue:(id)arg1;	// IMP=0x0000000000286961
- (void)dealloc;	// IMP=0x0000000000286902
- (id)initForReentrant:(_Bool)arg1 withGenerator:(CDUnknownBlockType)arg2;	// IMP=0x0000000000286882
