...
+ (id)differentialStyle;	// IMP=0x001000000014cab6
- (void).cxx_destruct;	// IMP=0x00000000003a0502
...
- (id)description;	// IMP=0x00000000003a0484
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a0381
