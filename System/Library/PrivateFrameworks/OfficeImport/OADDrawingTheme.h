...
- (void).cxx_destruct;	// IMP=0x000000000034557a
...
- (id)description;	// IMP=0x000000000034540a
...
- (unsigned long long)hash;	// IMP=0x000000000034535b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003452a2
- (void)applyThemeOverrides:(id)arg1 colorMapOverride:(id)arg2;	// IMP=0x0000000000345180
- (id)initWithTheme:(id)arg1 colorMap:(id)arg2 colorPalette:(id)arg3;	// IMP=0x0000000000344f81
- (id)initWithStyleMatrix:(id)arg1 fontScheme:(id)arg2 colorScheme:(id)arg3 colorMap:(id)arg4 colorPalette:(id)arg5;	// IMP=0x0000000000344e38
