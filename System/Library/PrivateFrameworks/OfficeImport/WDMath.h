...
- (void).cxx_destruct;	// IMP=0x000000000041554e
...
- (id)description;	// IMP=0x00000000004154ba
- (void)clearProperties;	// IMP=0x0000000000415499
- (int)runType;	// IMP=0x000000000041548e
- (id)initWithParagraph:(id)arg1 xmlBlob:(id)arg2;	// IMP=0x00000000004153b6
