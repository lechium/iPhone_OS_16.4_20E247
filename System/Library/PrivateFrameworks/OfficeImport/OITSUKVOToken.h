...
- (unsigned long long)hash;	// IMP=0x000000000026b674
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026b5c9
- (void)dealloc;	// IMP=0x000000000026b58e
- (id)initWithObserver:(id)arg1 target:(id)arg2 keyPath:(id)arg3 context:(void *)arg4;	// IMP=0x000000000026b516
- (id)init;	// IMP=0x000000000026b43c
