...
+ (id)fontSubfamilyWithName:(id)arg1 metadata:(id)arg2;	// IMP=0x006000000036e7c0
- (void).cxx_destruct;	// IMP=0x000000000036e861
@property(readonly, nonatomic) OCFontMetadata *metadata; // @synthesize metadata=_metadata;
@property(readonly, nonatomic) NSString *name; // @synthesize name=_name;
- (id)initWithName:(id)arg1 metadata:(id)arg2;	// IMP=0x000000000036e6f1
