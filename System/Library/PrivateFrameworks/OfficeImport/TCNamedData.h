...
+ (id)namedDataWithData:(id)arg1 named:(id)arg2;	// IMP=0x00600000002de523
- (void).cxx_destruct;	// IMP=0x00000000002de67b
...
- (id)initWithData:(id)arg1 named:(id)arg2;	// IMP=0x00000000002de5b0
