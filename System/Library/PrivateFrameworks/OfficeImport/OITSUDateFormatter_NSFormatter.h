...
- (void).cxx_destruct;	// IMP=0x000000000024ef30
...
- (id)stringForObjectValue:(id)arg1;	// IMP=0x000000000024ec4f
- (_Bool)getObjectValue:(out id *)arg1 forString:(id)arg2 errorDescription:(out id *)arg3;	// IMP=0x000000000024eb0f
- (id)init;	// IMP=0x000000000024e9db
