...
+ (id)customFormatData;	// IMP=0x00100000002b4dec
- (void).cxx_destruct;	// IMP=0x00000000002b5834
...
- (unsigned long long)hash;	// IMP=0x00000000002b5678
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b51b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b51ad
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b515a
- (void)p_copySelfTo:(id)arg1;	// IMP=0x00000000002b4ec0
- (id)init;	// IMP=0x00000000002b4e6d
- (id)initWithCustomFormatData:(id)arg1;	// IMP=0x00000000002b4e05
