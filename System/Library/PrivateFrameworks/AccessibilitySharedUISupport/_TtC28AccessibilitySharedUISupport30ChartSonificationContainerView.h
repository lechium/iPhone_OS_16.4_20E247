...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000f030
@property(nonatomic, retain) NSAttributedString *accessibilityAttributedLabel;
- (void)updatePlayhead:(double)arg1;	// IMP=0x000000000000ebc0
- (void)_accessibilitySonificationPlaybackStatusChanged:(unsigned long long)arg1;	// IMP=0x000000000000e9b0
- (void)_accessibilityDidChangeSonificationPlaybackPosition:(double)arg1;	// IMP=0x000000000000e7a0
