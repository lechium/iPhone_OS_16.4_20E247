...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001037
- (void).cxx_destruct;	// IMP=0x0000000000001006
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000000f72
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000000f00
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000000e39
