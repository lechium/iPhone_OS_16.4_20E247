...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0060000000001c95
- (void).cxx_destruct;	// IMP=0x0000000000001c62
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x0000000000001b68
