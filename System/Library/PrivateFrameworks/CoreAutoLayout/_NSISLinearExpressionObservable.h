...
+ (id)observableForExpression:(id)arg1 inEngine:(id)arg2;	// IMP=0x0060000000005f3c
- (id)addObserver:(id)arg1;	// IMP=0x00000000000065f6
- (id)addObserverBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000065b6
- (_Bool)_overrideUseFastBlockObservers;	// IMP=0x00000000000065ae
- (void)dealloc;	// IMP=0x0000000000005fe1
