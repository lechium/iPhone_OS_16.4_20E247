...
+ (Class)internalTestConfigType;	// IMP=0x001000000002dc6e
- (void).cxx_destruct;	// IMP=0x000000000002f3ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002efd8
- (unsigned long long)hash;	// IMP=0x000000000002ee97
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ec21
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002e905
- (void)copyTo:(id)arg1;	// IMP=0x000000000002e723
- (void)writeTo:(id)arg1;	// IMP=0x000000000002e4e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002e4d8
- (id)dictionaryRepresentation;	// IMP=0x000000000002dd2e
- (id)description;	// IMP=0x000000000002dc7f
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002dc51
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000002dc34
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x000000000002dbca
- (void)clearInternalTestConfigs;	// IMP=0x000000000002dbad
