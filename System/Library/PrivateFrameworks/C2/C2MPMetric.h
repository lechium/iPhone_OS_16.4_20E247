...
- (void).cxx_destruct;	// IMP=0x000000000002a638
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002a2a9
- (unsigned long long)hash;	// IMP=0x000000000002a100
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000029e05
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000029bd8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000029a21
- (void)writeTo:(id)arg1;	// IMP=0x0000000000029865
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000029858
- (id)dictionaryRepresentation;	// IMP=0x0000000000028ce3
- (id)description;	// IMP=0x0000000000028c34
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000028996
- (id)metricTypeAsString:(int)arg1;	// IMP=0x000000000002892a
