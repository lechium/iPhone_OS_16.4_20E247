...
+ (Class)networkPathInfoType;	// IMP=0x0010000000008532
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000d973
- (unsigned long long)hash;	// IMP=0x000000000000d21d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c80c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000bfe4
- (void)copyTo:(id)arg1;	// IMP=0x000000000000b9a4
- (void)writeTo:(id)arg1;	// IMP=0x000000000000b2b1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000b2a4
- (id)dictionaryRepresentation;	// IMP=0x0000000000008cc9
- (id)description;	// IMP=0x0000000000008c1a
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000008515
- (unsigned long long)networkPathInfosCount;	// IMP=0x00000000000084f8
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x000000000000848e
- (void)clearNetworkPathInfos;	// IMP=0x0000000000008471
