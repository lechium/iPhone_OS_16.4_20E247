...
+ (Class)clientOperationType;	// IMP=0x00100000000127f7
+ (Class)operationGroupType;	// IMP=0x001000000001268d
- (void).cxx_destruct;	// IMP=0x0000000000014e8c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001489e
- (unsigned long long)hash;	// IMP=0x000000000001469b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001430f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013e0f
- (void)copyTo:(id)arg1;	// IMP=0x0000000000013b01
- (void)writeTo:(id)arg1;	// IMP=0x000000000001372d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000013720
- (id)dictionaryRepresentation;	// IMP=0x0000000000012947
- (id)description;	// IMP=0x0000000000012898
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000127da
- (unsigned long long)clientOperationsCount;	// IMP=0x00000000000127bd
- (void)addClientOperation:(id)arg1;	// IMP=0x0000000000012753
- (void)clearClientOperations;	// IMP=0x0000000000012736
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000012670
- (unsigned long long)operationGroupsCount;	// IMP=0x0000000000012653
- (void)addOperationGroup:(id)arg1;	// IMP=0x00000000000125e9
- (void)clearOperationGroups;	// IMP=0x00000000000125cc
