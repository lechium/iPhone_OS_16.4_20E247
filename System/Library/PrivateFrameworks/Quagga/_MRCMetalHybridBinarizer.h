...
- (void).cxx_destruct;	// IMP=0x000000000004ce82
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000004c690
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004c51e
- (id)init;	// IMP=0x000000000004c508
