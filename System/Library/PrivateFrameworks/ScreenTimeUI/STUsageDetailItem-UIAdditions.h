...
+ (void)iconImageForBundleIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x002000000001d572
- (void)_didFindIconImage:(id)arg1;	// IMP=0x001000000001d477
- (id)_monogramUsingDarkColors:(_Bool)arg1;	// IMP=0x001000000001d19b
