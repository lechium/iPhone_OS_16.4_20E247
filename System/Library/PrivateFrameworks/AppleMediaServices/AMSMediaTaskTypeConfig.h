...
+ (id)configForType:(long long)arg1;	// IMP=0x006000000027c3fe
- (void).cxx_destruct;	// IMP=0x000000000027cadd
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x000000000027c334
