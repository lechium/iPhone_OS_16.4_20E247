...
- (void).cxx_destruct;	// IMP=0x000000000027eeb5
...
- (id)_devicePlatform;	// IMP=0x000000000027eb69
- (void)_addSearchTerm:(id)arg1;	// IMP=0x000000000027e984
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x000000000027e75b
- (void)_addCharts:(id)arg1;	// IMP=0x000000000027e63c
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x000000000027e492
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x000000000027dc9a
- (id)_pathPromise;	// IMP=0x000000000027d737
- (id)_languagePromise;	// IMP=0x000000000027d345
- (id)_hostPromise;	// IMP=0x000000000027d280
- (id)_verifyConfiguration;	// IMP=0x000000000027cf65
- (id)build;	// IMP=0x000000000027cbe5
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x000000000027cb10
