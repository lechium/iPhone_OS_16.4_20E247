...
- (void).cxx_destruct;	// IMP=0x00000000002f1f12
...
- (id)nextPurchase;	// IMP=0x00000000002f1e6d
- (_Bool)finishPurchase:(id)arg1 withResult:(id)arg2;	// IMP=0x00000000002f1b22
- (_Bool)finishPurchase:(id)arg1 withError:(id)arg2;	// IMP=0x00000000002f16ab
- (id)purchaseForPurchaseId:(id)arg1;	// IMP=0x00000000002f15ed
- (id)initWithPurchases:(id)arg1 weakPromise:(id)arg2;	// IMP=0x00000000002f134d
