...
- (void).cxx_destruct;	// IMP=0x00000000002a7a2c
...
- (_Bool)_shouldClearEventsDespiteError:(id)arg1 result:(id)arg2;	// IMP=0x00000000002a778e
- (id)_postBatch:(id)arg1;	// IMP=0x00000000002a6d24
- (id)_nextBatchWithConfig:(id)arg1 topic:(id)arg2 maxBatchSize:(long long)arg3;	// IMP=0x00000000002a6017
- (id)_mescalSignatureWithBodyData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002a5e71
- (id)_flushNextBatchWithMaxRequestCount:(unsigned long long)arg1 topic:(id)arg2 maxBatchSize:(long long)arg3 requestCount:(unsigned long long)arg4 flushedEventCount:(unsigned long long)arg5 config:(id)arg6;	// IMP=0x00000000002a5527
- (id)performFlush;	// IMP=0x00000000002a5218
- (_Bool)cancel;	// IMP=0x00000000002a507f
@property(readonly, nonatomic) AMSURLSession *URLSession; // @synthesize URLSession=_URLSession;
- (id)initWithDataSource:(id)arg1 bag:(id)arg2;	// IMP=0x00000000002a4ea3
