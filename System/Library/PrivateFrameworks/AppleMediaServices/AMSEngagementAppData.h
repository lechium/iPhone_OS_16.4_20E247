...
- (void).cxx_destruct;	// IMP=0x000000000020cb87
...
- (id)exportObject;	// IMP=0x000000000020c6d1
- (id)initWithIdentifier:(id)arg1 cacheObject:(id)arg2;	// IMP=0x000000000020c168
