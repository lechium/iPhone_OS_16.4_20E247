...
- (void).cxx_destruct;	// IMP=0x00000000002e6ba8
...
- (id)description;	// IMP=0x00000000002e69f3
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x00000000002e6931
