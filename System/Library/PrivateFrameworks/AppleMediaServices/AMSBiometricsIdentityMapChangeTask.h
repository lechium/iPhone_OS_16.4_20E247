...
- (void).cxx_destruct;	// IMP=0x00000000001a459e
...
- (id)perform;	// IMP=0x00000000001a3a2b
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x00000000001a3965
