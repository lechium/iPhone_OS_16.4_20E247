...
- (void).cxx_destruct;	// IMP=0x0000000000185d47
...
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 originalData:(id)arg3 originalExpirationDate:(id)arg4 updatedData:(id)arg5 loadedBagIdentifier:(id)arg6 loadedBagPartialIdentifier:(id)arg7 accountIdentifier:(id)arg8;	// IMP=0x0000000000185941
