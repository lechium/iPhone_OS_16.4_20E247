...
- (void).cxx_destruct;	// IMP=0x00000000001dcffa
...
- (void)invalidate;	// IMP=0x00000000001dcfaa
- (id)initWithDeallocGuardBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001dcf2c
- (void)dealloc;	// IMP=0x00000000001dcea7
