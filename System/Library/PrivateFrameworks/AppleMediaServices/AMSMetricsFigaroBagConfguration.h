...
+ (id)configurationPromiseWithBag:(id)arg1;	// IMP=0x00600000002a1969
- (void).cxx_destruct;	// IMP=0x00000000002a22ee
...
- (id)_generateModifiersIfNeeded;	// IMP=0x00000000002a1ef0
@property(readonly, nonatomic) NSArray *overrides; // @synthesize overrides=_overrides;
- (id)modifierForEvent:(id)arg1;	// IMP=0x00000000002a1bcc
- (void)prepareForFlush;	// IMP=0x00000000002a1ac1
- (id)initWithMetricsDictionary:(id)arg1;	// IMP=0x00000000002a18b2
