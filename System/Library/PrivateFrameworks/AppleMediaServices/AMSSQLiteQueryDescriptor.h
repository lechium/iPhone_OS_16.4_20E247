...
- (void).cxx_destruct;	// IMP=0x000000000032792f
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000003271d3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003270e1
