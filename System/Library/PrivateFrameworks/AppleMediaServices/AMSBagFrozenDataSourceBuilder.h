...
- (void).cxx_destruct;	// IMP=0x0000000000187b1e
...
- (id)createFrozenDataSource;	// IMP=0x0000000000187786
- (id)createFrozenBag;	// IMP=0x0000000000186e19
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x0000000000186bca
