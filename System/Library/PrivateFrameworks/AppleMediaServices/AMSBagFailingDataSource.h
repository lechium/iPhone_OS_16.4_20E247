...
- (void).cxx_destruct;	// IMP=0x00000000002bb4d0
...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000002bb453
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000002bb44b
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000002bb443
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002bb24a
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x00000000002bb13d
