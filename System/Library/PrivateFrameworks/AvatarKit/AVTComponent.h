...
- (void).cxx_destruct;	// IMP=0x0000000000036da9
...
- (id)description;	// IMP=0x0000000000036bdf
- (id)initWithType:(long long)arg1 assets:(id)arg2 morphVariant:(id)arg3 imageVariant:(id)arg4 materialVariant:(id)arg5 bodyPoseVariant:(id)arg6 morphVariantIntensity:(float)arg7 bodyPoseVariantIntensity:(float)arg8 textureAssetPresence:(float)arg9 mirrored:(_Bool)arg10;	// IMP=0x0000000000036aa4
- (id)materialAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000036a32
- (void)setMaterial:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000000369d3
