...
- (void).cxx_destruct;	// IMP=0x0000000000009186
...
- (_Bool)_predicateRequiresCurrentDevice:(id)arg1;	// IMP=0x0000000000008fc7
- (id)initWithPredicate:(id)arg1;	// IMP=0x0000000000008f17
