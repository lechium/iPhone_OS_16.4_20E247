...
- (void).cxx_destruct;	// IMP=0x0000000000079e75
...
- (_Bool)isImpressionable;	// IMP=0x0000000000079e40
- (int)analyticsModuleType;	// IMP=0x0000000000079e35
- (id)draggableContent;	// IMP=0x0000000000079e2d
- (void)webContentViewControllerDidStopLoading:(id)arg1;	// IMP=0x0000000000079de1
- (void)webContentViewController:(id)arg1 performHeightChangeWithBlock:(CDUnknownBlockType)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000079b35
- (void)removeWebContentViewController:(id)arg1 arguments:(id)arg2;	// IMP=0x0000000000079a7d
- (_Bool)isWebContentViewControllerParentPlacecardLoading:(id)arg1;	// IMP=0x0000000000079a75
@property(readonly, nonatomic, getter=isLoading) _Bool loading;
@property(readonly, nonatomic) _Bool hasContent;
@property(readonly, nonatomic) UIView *sectionView;
@property(readonly, nonatomic) UIViewController *sectionViewController;
- (void)_setupWebContentViewController;	// IMP=0x0000000000079851
- (id)initWithMapItem:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000079533
