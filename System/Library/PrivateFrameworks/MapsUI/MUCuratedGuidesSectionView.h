...
- (void).cxx_destruct;	// IMP=0x00000000000bd88a
...
- (void)refreshCollections;	// IMP=0x00000000000bd7d0
- (void)displayCollectionsIfNeeded;	// IMP=0x00000000000bd73b
@property(readonly, nonatomic) long long carouselContext;
- (void)_setupSubviews;	// IMP=0x00000000000bd545
- (id)initCollectionsCarouselViewWithPlaceCollections:(id)arg1 usingSyncCoordinator:(id)arg2 withRoutingDelegate:(id)arg3 withScrollViewDelegate:(id)arg4 withAnalyticsDelegate:(id)arg5 exploreGuides:(id)arg6;	// IMP=0x00000000000bd3dc
