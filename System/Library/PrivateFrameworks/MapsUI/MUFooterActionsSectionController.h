...
- (void).cxx_destruct;	// IMP=0x00000000000f5518
...
- (id)revealedAnalyticsModule;	// IMP=0x00000000000f5486
- (id)analyticsModule;	// IMP=0x00000000000f5452
- (int)analyticsModuleType;	// IMP=0x00000000000f5447
- (id)infoCardChildUnactionableUIElements;	// IMP=0x00000000000f543a
- (id)infoCardChildPossibleActions;	// IMP=0x00000000000f5230
@property(readonly, nonatomic) MUPlaceSectionFooterViewModel *sectionFooterViewModel;
- (id)draggableContent;	// IMP=0x00000000000f5220
- (void)reloadData;	// IMP=0x00000000000f4db3
@property(readonly, nonatomic) _Bool hasContent;
@property(readonly, nonatomic) NSArray *sectionViews;
@property(readonly, nonatomic) UIView *sectionView;
- (void)_setupFooterView;	// IMP=0x00000000000f4c71
- (id)initWithActionManager:(id)arg1;	// IMP=0x00000000000f4b2f
