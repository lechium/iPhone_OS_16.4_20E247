...
- (void).cxx_destruct;	// IMP=0x00000000000c937c
...
- (id)initWithContactLabeledValue:(id)arg1 type:(long long)arg2;	// IMP=0x00000000000c9207
- (id)glyphName;	// IMP=0x00000000000c91de
