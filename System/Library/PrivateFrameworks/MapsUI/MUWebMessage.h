...
- (void).cxx_destruct;	// IMP=0x000000000006e785
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006e4ad
- (id)description;	// IMP=0x000000000006f497
@property(readonly, copy, nonatomic) NSDictionary *JSONObject;
- (id)initWithJSONObject:(id)arg1;	// IMP=0x000000000006e7fa
