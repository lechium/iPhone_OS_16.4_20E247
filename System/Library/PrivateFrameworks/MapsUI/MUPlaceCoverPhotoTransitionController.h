...
- (void).cxx_destruct;	// IMP=0x000000000003d739
...
- (double)_logoImageAlphaForVerticalDrag;	// IMP=0x000000000003d5a7
@property(readonly, nonatomic) double logoImageAlpha;
- (void)_updateWithOldProgress:(double)arg1;	// IMP=0x000000000003d54b
- (double)coverPhotoHeightForProposedWidth:(double)arg1;	// IMP=0x000000000003d50c
@property(readonly, nonatomic) double coverPhotoAlpha;
@property(readonly, nonatomic) _Bool hideLogo;
- (id)initWithMetrics:(struct MUPlaceHeaderMetrics)arg1 updateHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003d419
