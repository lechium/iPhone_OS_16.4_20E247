...
- (void).cxx_destruct;	// IMP=0x00000000000f487e
...
- (void)transitLineIncidentsViewController:(id)arg1 didSelectDetailsForIncidents:(id)arg2;	// IMP=0x00000000000f47dc
@property(readonly, nonatomic) _Bool hasContent;
@property(readonly, nonatomic) UIView *sectionView;
@property(readonly, nonatomic) UIViewController *sectionViewController;
- (void)_setupSection;	// IMP=0x00000000000f45b2
- (id)initWithTransitLineItem:(id)arg1;	// IMP=0x00000000000f4566
