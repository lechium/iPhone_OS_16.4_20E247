...
- (void).cxx_destruct;	// IMP=0x0000000000075849
- (_Bool)isImpressionable;	// IMP=0x0000000000075841
@property(readonly, nonatomic) UIView *sectionView;
@property(readonly, nonatomic) UIViewController *sectionViewController;
- (id)initWithMapItem:(id)arg1 viewController:(id)arg2;	// IMP=0x000000000007571d
