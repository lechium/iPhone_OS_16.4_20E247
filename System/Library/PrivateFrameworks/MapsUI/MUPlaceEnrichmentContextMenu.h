...
- (void).cxx_destruct;	// IMP=0x000000000009cf09
...
- (id)contextMenuInteraction:(id)arg1 configurationForMenuAtLocation:(struct CGPoint)arg2;	// IMP=0x000000000009c994
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009c918
