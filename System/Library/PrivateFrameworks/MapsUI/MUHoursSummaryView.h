...
- (void).cxx_destruct;	// IMP=0x00000000000ffdf5
@property(copy, nonatomic) CDUnknownBlockType actionHandler; // @synthesize actionHandler=_actionHandler;
@property(readonly, nonatomic) MUHoursSummaryViewModel *viewModel; // @synthesize viewModel=_viewModel;
- (void)_contentSizeDidChange;	// IMP=0x00000000000ffdb0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000ffcc5
- (void)_updateAppearance;	// IMP=0x00000000000ffb18
- (void)_handleServiceHoursAnimation;	// IMP=0x00000000000ffa3e
- (void)_handleNormalHoursAnimation;	// IMP=0x00000000000ff9a7
- (void)handleAnimation;	// IMP=0x00000000000ff95e
- (void)_handleAnimationStartForNormalHours;	// IMP=0x00000000000ff931
- (void)handleAnimationStart;	// IMP=0x00000000000ff8ef
- (void)_updateExpandButton;	// IMP=0x00000000000ff7df
- (void)expandButtonTapped;	// IMP=0x00000000000ff754
- (void)_setupConstraints;	// IMP=0x00000000000fed01
- (void)_setupSubviews;	// IMP=0x00000000000fe855
- (id)initWithViewModel:(id)arg1;	// IMP=0x00000000000fe783
