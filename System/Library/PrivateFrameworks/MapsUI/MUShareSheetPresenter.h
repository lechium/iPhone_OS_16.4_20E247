...
- (void).cxx_destruct;	// IMP=0x0000000000106e25
...
- (void)mapkitActivityViewController:(id)arg1 postCompletedActivityOfType:(id)arg2 completed:(_Bool)arg3;	// IMP=0x0000000000106d6f
- (void)mapkitActivityViewController:(id)arg1 preCompletedActivityOfType:(id)arg2 completed:(_Bool)arg3;	// IMP=0x0000000000106cf4
- (void)present;	// IMP=0x00000000001068de
- (id)initWithPlaceItem:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x0000000000106845
