...
- (void).cxx_destruct;	// IMP=0x000000000003a8e8
...
- (void)_downloadImageWithURL:(id)arg1 variant:(unsigned long long)arg2 uniqueIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000003a51c
- (id)_buildMenuElementForViewModel:(id)arg1 presentationOptions:(id)arg2 isSingleProvider:(_Bool)arg3;	// IMP=0x0000000000039add
- (id)buildMenuElementsWithPresentationOptions:(id)arg1;	// IMP=0x00000000000394ef
- (id)initWithExternalActionController:(id)arg1 iconCache:(id)arg2;	// IMP=0x0000000000039456
