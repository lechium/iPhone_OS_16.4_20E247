...
- (void).cxx_destruct;	// IMP=0x00000000000de20b
...
- (void)addExternalActionsAsSupportedActions:(id)arg1;	// IMP=0x00000000000dd651
- (void)contextMenuAction:(id)arg1;	// IMP=0x00000000000dd5d9
- (void)getAppAction:(id)arg1;	// IMP=0x00000000000dd52c
- (void)addPhotoAction:(id)arg1;	// IMP=0x00000000000dd475
- (void)ratePlaceAction:(id)arg1;	// IMP=0x00000000000dd3c1
- (void)directionsAction:(id)arg1;	// IMP=0x00000000000dd314
- (void)layoutActionsUsingArguments:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000dcb59
- (void)performActionUsingArguments:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000db0ba
- (id)adamIDForAppCategory:(id)arg1;	// IMP=0x00000000000daf4f
- (void)configureWithEnrichmentDataProvider:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x00000000000dadd1
- (id)dictionaryForAction:(id)arg1;	// IMP=0x00000000000dadbc
- (id)supportedPlaceEnrichmentActions;	// IMP=0x00000000000da858
- (id)initWithPlaceActionManager:(id)arg1 mapItem:(id)arg2 dataAvailability:(id)arg3 amsResultProvider:(id)arg4 callToActionDelegate:(id)arg5 contextMenuDelegate:(id)arg6 externalActionHandler:(id)arg7 analyticsDelegate:(id)arg8 onActionUpdate:(CDUnknownBlockType)arg9;	// IMP=0x00000000000da698
