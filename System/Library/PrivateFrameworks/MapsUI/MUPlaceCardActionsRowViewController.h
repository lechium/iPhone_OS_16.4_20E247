...
- (void).cxx_destruct;	// IMP=0x00000000000b2de4
...
- (void)viewDidLoad;	// IMP=0x00000000000b28c9
@property(readonly, nonatomic) NSArray *actionButtons;
- (void)updateActionsRowView;	// IMP=0x00000000000b27d7
- (id)initWithStyle:(unsigned long long)arg1;	// IMP=0x00000000000b270d
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000b2705
