...
- (void).cxx_destruct;	// IMP=0x00000000001067f4
...
- (id)revealedAnalyticsModule;	// IMP=0x0000000000106799
- (_Bool)isImpressionable;	// IMP=0x0000000000106791
- (int)analyticsModuleType;	// IMP=0x0000000000106774
- (id)analyticsModule;	// IMP=0x0000000000106757
- (id)infoCardChildUnactionableUIElements;	// IMP=0x000000000010673a
- (id)infoCardChildPossibleActions;	// IMP=0x000000000010671d
@property(nonatomic) __weak id <MUInfoCardAnalyticsDelegate> analyticsDelegate;
- (void)headerButtonsSectionControllerWillPresentMenu:(id)arg1;	// IMP=0x00000000001066c4
- (void)headerButtonsSectionController:(id)arg1 didSelectPrimaryType:(unsigned long long)arg2 withPresentationOptions:(id)arg3;	// IMP=0x0000000000106649
- (void)headerButtonsSectionControllerDidUpdateContent:(id)arg1;	// IMP=0x00000000001065fd
...
- (id)initWithPlaceItem:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000105fc7
