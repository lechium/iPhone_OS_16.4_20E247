...
- (void).cxx_destruct;	// IMP=0x00000000000fe5b7
...
- (_Bool)_hasAppleRatingsCategories;	// IMP=0x00000000000fdafa
...
- (id)initWithMapItem:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000fd42c
