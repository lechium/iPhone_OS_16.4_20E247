...
+ (struct CGSize)preferredSizeForViewModels:(id)arg1 cellConfiguration:(id)arg2 usingMeasurements:(id)arg3;	// IMP=0x00100000000ab657
+ (id)reuseIdentifier;	// IMP=0x00100000000ab645
- (void).cxx_destruct;	// IMP=0x00000000000ab73d
@property(retain, nonatomic) MUPlaceTileCellConfiguration *cellConfiguration; // @synthesize cellConfiguration=_cellConfiguration;
- (void)_updateTemplateViewWithOldCellConfiguration:(id)arg1;	// IMP=0x00000000000ab4db
