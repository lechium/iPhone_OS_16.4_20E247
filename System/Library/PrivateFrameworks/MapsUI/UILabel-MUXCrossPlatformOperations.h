...
+ (id)_mapsui_defaultLabel;	// IMP=0x00100000000bcab1
+ (double)_mapsui_maximumHeightWithFont:(id)arg1 numberOfLines:(long long)arg2 displayScale:(double)arg3;	// IMP=0x00100000000d9793
