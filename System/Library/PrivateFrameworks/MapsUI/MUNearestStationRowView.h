...
- (void)_updateFonts;	// IMP=0x00000000000c8e26
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000c8d54
@property(retain, nonatomic) NSString *distanceString;
- (void)layoutSubviews;	// IMP=0x00000000000c8cd1
- (void)_setupConstraints;	// IMP=0x00000000000c872d
- (void)_setupSubviews;	// IMP=0x00000000000c8410
- (void)_updateAppearance;	// IMP=0x00000000000c82ab
- (void)configureWithNearestStation:(id)arg1;	// IMP=0x00000000000c8234
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c81ae
