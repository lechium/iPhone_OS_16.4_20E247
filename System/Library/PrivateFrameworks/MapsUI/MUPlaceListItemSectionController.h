...
- (void).cxx_destruct;	// IMP=0x00000000001024ed
- (_Bool)isImpressionable;	// IMP=0x00000000001024e5
- (int)analyticsModuleType;	// IMP=0x00000000001024da
- (void)_captureUserAction:(int)arg1;	// IMP=0x00000000001024c3
- (void)_performPunchout;	// IMP=0x0000000000102382
...
- (void)_setupSubviews;	// IMP=0x0000000000101e85
- (id)initWithMapItem:(id)arg1 annotatedList:(id)arg2;	// IMP=0x0000000000101d33
