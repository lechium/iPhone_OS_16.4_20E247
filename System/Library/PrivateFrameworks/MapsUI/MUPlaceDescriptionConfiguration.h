...
+ (id)configurationWithEncyclopedicInfo:(id)arg1;	// IMP=0x00600000000ccecb
- (void).cxx_destruct;	// IMP=0x00000000000ccfc9
...
- (id)initWithTitle:(id)arg1 descriptionText:(id)arg2 attribution:(id)arg3;	// IMP=0x00000000000cce0f
