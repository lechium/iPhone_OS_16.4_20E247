...
- (void).cxx_destruct;	// IMP=0x00000000000ceec1
...
- (id)initWithAppIdentifier:(id)arg1;	// IMP=0x00000000000cedfc
- (void)addExtensionIfMatchedAppIdentifier:(id)arg1;	// IMP=0x00000000000ced13
