...
- (void).cxx_destruct;	// IMP=0x000000000001b62c
...
- (unsigned long long)hash;	// IMP=0x000000000001b5ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b5e3
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001b100
