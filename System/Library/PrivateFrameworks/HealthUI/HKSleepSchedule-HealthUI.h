...
- (id)hk_localizedWeekdaysListWithGregorianCalendar:(id)arg1 standaloneFormatter:(id)arg2 listItemFormatter:(id)arg3;	// IMP=0x003000000019464b
@property(readonly, nonatomic) NSString *hk_localizedWeekdaysList;
- (void)addDetailValuesToSection:(id)arg1;	// IMP=0x00300000002d0766
@end
