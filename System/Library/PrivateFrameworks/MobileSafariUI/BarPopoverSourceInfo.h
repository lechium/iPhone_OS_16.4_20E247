...
- (void).cxx_destruct;	// IMP=0x000000000019838f
...
- (id)_sourceInfo;	// IMP=0x0000000000197f1c
- (id)initWithBrowserController:(id)arg1 barItem:(long long)arg2;	// IMP=0x0000000000197e80
