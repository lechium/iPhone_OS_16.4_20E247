...
- (void).cxx_destruct;	// IMP=0x00000000001e5842
...
- (id)debugDescription;	// IMP=0x00000000001e55dc
- (id)initWithIdentifier:(id)arg1 isGroup:(_Bool)arg2;	// IMP=0x00000000001e551c
