...
- (void).cxx_destruct;	// IMP=0x00000000000a498d
- (void)_readingListContentsDidChange:(id)arg1;	// IMP=0x00000000000a4976
- (void)retrieveRecommendationsMatchingTopic:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a412c
- (void)dealloc;	// IMP=0x00000000000a40b7
- (id)initWithBookmarkProvider:(id)arg1 accessQueue:(id)arg2 imageCache:(id)arg3;	// IMP=0x00000000000a3f31
