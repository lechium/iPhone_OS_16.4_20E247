...
- (void).cxx_destruct;	// IMP=0x00000000000be008
...
- (double)framesPerSecond;	// IMP=0x00000000000bdd78
- (double)renderDuration;	// IMP=0x00000000000bdd54
- (void)finishRenderTime:(id)arg1;	// IMP=0x00000000000bdd43
- (void)startRenderTime:(id)arg1;	// IMP=0x00000000000bdcfd
- (void)finishRenderFps:(id)arg1;	// IMP=0x00000000000bdcd4
- (void)startRenderFps:(id)arg1;	// IMP=0x00000000000bdc81
- (void)setTimer:(id)arg1;	// IMP=0x00000000000bdc43
- (id)timer;	// IMP=0x00000000000bdc35
- (id)statusString;	// IMP=0x00000000000bdc16
- (int)status;	// IMP=0x00000000000bdc0d
- (void)setStatus:(int)arg1;	// IMP=0x00000000000bdc04
- (id)description;	// IMP=0x00000000000bd914
- (void)dealloc;	// IMP=0x00000000000bd8d2
- (id)initWithURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x00000000000bd852
