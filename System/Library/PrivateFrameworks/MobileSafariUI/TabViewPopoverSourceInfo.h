...
- (void).cxx_destruct;	// IMP=0x0000000000016fb3
@property(readonly, nonatomic) UIView *popoverSourceView;
@property(readonly, nonatomic) struct CGRect popoverSourceRect;
- (long long)_tabOverviewBarButton;	// IMP=0x0000000000016dc6
@property(readonly, copy) NSString *description;
- (id)initWithBrowserController:(id)arg1 barItem:(long long)arg2;	// IMP=0x0000000000016cac
