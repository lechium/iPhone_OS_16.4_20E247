...
- (void).cxx_destruct;	// IMP=0x0000000000075a1f
...
- (id)emailCompatibleMargin;	// IMP=0x0000000000075767
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007557e
- (id)init;	// IMP=0x0000000000075450
