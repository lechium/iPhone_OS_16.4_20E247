...
- (void).cxx_destruct;	// IMP=0x0000000000072d25
...
- (id)adjustedForString:(id)arg1;	// IMP=0x0000000000072b6e
- (void)_adjustForString:(id)arg1;	// IMP=0x0000000000072aaf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007297d
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x000000000007280f
