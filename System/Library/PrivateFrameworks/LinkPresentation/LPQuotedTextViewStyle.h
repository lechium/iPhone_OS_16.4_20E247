...
- (void).cxx_destruct;	// IMP=0x000000000007370b
...
- (id)adjustedForString:(id)arg1;	// IMP=0x000000000007360d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000073568
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x0000000000072d9a
