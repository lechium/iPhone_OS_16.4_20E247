...
- (void).cxx_destruct;	// IMP=0x00000000000742bd
...
- (void)applyToAllTextViewStyles:(CDUnknownBlockType)arg1;	// IMP=0x00000000000741ae
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000073962
