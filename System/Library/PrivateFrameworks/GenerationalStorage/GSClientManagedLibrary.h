...
- (void).cxx_destruct;	// IMP=0x00000000000110e7
- (_Bool)generationsRemove:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000010e71
- (id)initWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000010bdb
