...
- (void)endEncoding;	// IMP=0x0000000000038738
- (void)setLabel:(id)arg1;	// IMP=0x0000000000038712
- (void)popDebugGroup;	// IMP=0x00000000000386a3
- (void)pushDebugGroup:(id)arg1;	// IMP=0x000000000003867d
- (void)insertDebugSignpost:(id)arg1;	// IMP=0x0000000000038482
- (id)init:(struct BinaryBuffer *)arg1 flags:(unsigned long long)arg2;	// IMP=0x0000000000038424
