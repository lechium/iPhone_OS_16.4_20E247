...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000089935
- (unsigned long long)hash;	// IMP=0x0000000000089927
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x0000000000089791
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x00000000000895fc
