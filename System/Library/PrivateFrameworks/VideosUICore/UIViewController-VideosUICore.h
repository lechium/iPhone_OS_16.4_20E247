...
- (void)vui_setContentScrollView:(id)arg1 forEdge:(unsigned long long)arg2;	// IMP=0x00200000000130c7
- (id)vui_contentScrollViewForEdge:(unsigned long long)arg1;	// IMP=0x00200000000130b5
- (_Bool)vui_addSubview:(id)arg1 oldView:(id)arg2;	// IMP=0x002000000001302a
- (void)vui_updateViewConstraints;	// IMP=0x0020000000013024
- (void)vui_didMoveToParentViewController:(id)arg1;	// IMP=0x002000000001301e
- (void)vui_willMoveToParentViewController:(id)arg1;	// IMP=0x0020000000013018
- (void)vui_setOverrideTraitCollection:(id)arg1 forChildViewController:(id)arg2;	// IMP=0x0020000000013006
- (void)vui_endAppearanceTransition;	// IMP=0x0020000000012ff4
- (void)vui_beginAppearanceTransition:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0020000000012fe2
- (void)vui_removeFromParentViewController;	// IMP=0x0020000000012fd0
- (void)vui_addChildViewController:(id)arg1;	// IMP=0x0020000000012fbe
- (void)vui_showViewController:(id)arg1 sender:(id)arg2;	// IMP=0x0020000000012fac
- (void)vui_dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0020000000012f9a
- (void)vui_presentViewController:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0020000000012f88
- (void)vui_viewDidLayoutSubviews;	// IMP=0x0020000000012f82
- (void)vui_viewWillLayoutSubviews;	// IMP=0x0020000000012f7c
- (void)vui_viewDidDisappear:(_Bool)arg1;	// IMP=0x0020000000012f76
- (void)vui_viewWillDisappear:(_Bool)arg1;	// IMP=0x0020000000012f70
- (void)vui_viewDidAppear:(_Bool)arg1;	// IMP=0x0020000000012f6a
- (void)vui_viewWillAppear:(_Bool)arg1;	// IMP=0x0020000000012f64
- (void)vui_viewDidLoad;	// IMP=0x0020000000012f5e
- (void)vui_loadView;	// IMP=0x0020000000012f58
- (id)vui_initWithCoder:(id)arg1;	// IMP=0x0020000000012f28
- (id)vui_initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0020000000012ef3
...
- (void)vui_setOverrideUserInterfaceStyle:(unsigned long long)arg1;	// IMP=0x0020000000012ce1
...
- (void)presentAlertWithTitle:(id)arg1 message:(id)arg2 actions:(id)arg3 animated:(_Bool)arg4;	// IMP=0x002000000002507d
- (void)presentViewController:(id)arg1 modalPresentationStyle:(long long)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0020000000024ff9
