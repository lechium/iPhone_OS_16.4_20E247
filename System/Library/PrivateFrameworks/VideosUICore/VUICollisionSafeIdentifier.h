...
- (id)description;	// IMP=0x000000000001339c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000013201
- (unsigned long long)hash;	// IMP=0x000000000001319f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013157
- (id)initWithRootIdentifier:(id)arg1 collisionCount:(unsigned long long)arg2;	// IMP=0x00000000000130d9
