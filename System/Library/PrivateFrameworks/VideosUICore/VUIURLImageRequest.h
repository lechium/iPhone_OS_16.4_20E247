...
- (void).cxx_destruct;	// IMP=0x0000000000025a08
...
- (id)initWithURL:(id)arg1 headers:(id)arg2 decrypter:(id)arg3;	// IMP=0x0000000000025954
- (id)initWithURL:(id)arg1 headers:(id)arg2 identifier:(id)arg3 decrypter:(id)arg4;	// IMP=0x0000000000025872
