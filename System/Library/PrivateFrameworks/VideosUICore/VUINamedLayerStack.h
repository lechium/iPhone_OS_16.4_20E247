...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x001000000000d0e4
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x001000000000cd31
- (void).cxx_destruct;	// IMP=0x000000000000dabe
...
- (id)_init;	// IMP=0x000000000000cd02
- (id)init;	// IMP=0x000000000000ccf4
