...
+ (id)_humanReadableStringForGroupType:(long long)arg1;	// IMP=0x0060000000024e77
- (void).cxx_destruct;	// IMP=0x0000000000024fbb
...
- (id)_manifestFilePath;	// IMP=0x0000000000024e96
- (void)_saveManifest;	// IMP=0x0000000000024d16
- (void)_updateManifestWithChange:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024b36
- (id)description;	// IMP=0x0000000000024a5a
- (void)updateAssetsFromFiles;	// IMP=0x0000000000023fd5
- (void)_removeAssetInfoForKey:(id)arg1 removeFile:(_Bool)arg2;	// IMP=0x0000000000023b55
- (void)_removeAssetInfoForKey:(id)arg1;	// IMP=0x0000000000023b3e
- (id)infoForAllAssetsWithTags:(id)arg1 queue:(id)arg2;	// IMP=0x00000000000235b9
- (id)infoForAllAssetsWithQueue:(id)arg1;	// IMP=0x0000000000023406
- (void)removeAllAssetsWithQueue:(id)arg1;	// IMP=0x000000000002321e
- (void)removeAssetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000023118
- (id)assetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000022bbe
- (void)setAssetInfo:(id)arg1 forKey:(id)arg2 queue:(id)arg3;	// IMP=0x00000000000221bf
- (id)initWithGroupType:(long long)arg1 baseCachePath:(id)arg2 folderName:(id)arg3 maxCacheSize:(unsigned long long)arg4 purgeOnLoad:(_Bool)arg5;	// IMP=0x0000000000021e2e
