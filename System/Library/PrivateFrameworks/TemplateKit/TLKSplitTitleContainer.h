...
+ (double)widthForString:(id)arg1 font:(id)arg2;	// IMP=0x0060000000011488
- (void).cxx_destruct;	// IMP=0x000000000001169d
...
- (id)titleFont;	// IMP=0x000000000001158c
- (_Bool)titleLabelsFitInWidth:(double)arg1 pointSize:(double)arg2;	// IMP=0x00000000000112cf
- (void)layoutSubviews;	// IMP=0x0000000000010c6e
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000010c1c
