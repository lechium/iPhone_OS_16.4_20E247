...
+ (id)detailsLabel;	// IMP=0x006000000002838f
- (void).cxx_destruct;	// IMP=0x00000000000288cb
...
- (void)updateWithTitle:(id)arg1 contents:(id)arg2;	// IMP=0x0000000000028405
- (id)init;	// IMP=0x000000000002827b
