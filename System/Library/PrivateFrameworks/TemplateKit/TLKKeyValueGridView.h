...
- (void).cxx_destruct;	// IMP=0x000000000003913e
...
- (void)updateWithTuples:(id)arg1 valueColumnIsTrailing:(_Bool)arg2 truncateKey:(_Bool)arg3;	// IMP=0x0000000000038999
- (id)init;	// IMP=0x00000000000388c6
