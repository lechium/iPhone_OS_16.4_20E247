...
- (void).cxx_destruct;	// IMP=0x0000000000015012
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000014ed8
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000014d0b
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000014be9
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x00000000000147e3
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x000000000001475c
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000146e3
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x000000000001462f
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x00000000000145e1
- (void)_addMonitor;	// IMP=0x0000000000014521
- (void)dealloc;	// IMP=0x00000000000144dd
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x000000000001435a
