...
- (void).cxx_destruct;	// IMP=0x00000000000164fb
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x00000000000163c4
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000016274
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016152
...
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000015a46
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000159cd
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000015919
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x00000000000158cb
@property(readonly, nonatomic) struct __CFString *wwanInterfaceName;
@property(readonly, nonatomic) int currentRAT; // @synthesize currentRAT=_currentRAT;
- (id)_currentDataSimContext;	// IMP=0x0000000000015600
...
- (_Bool)_isCurrentDataSimContextOnIvarQueue:(id)arg1;	// IMP=0x000000000001557a
- (void)_adjustInterfaceNameForWWANContextID:(int)arg1 interfaceName:(id)arg2 forContext:(id)arg3;	// IMP=0x0000000000015335
- (void)_setupWWANMonitor;	// IMP=0x000000000001525f
- (void)dealloc;	// IMP=0x0000000000015201
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000015066
