...
- (void).cxx_destruct;	// IMP=0x000000000007bb84
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000007ba32
- (void)start;	// IMP=0x000000000007b900
- (id)initWithConnectionInterface:(id)arg1 typeIdentifier:(long long)arg2 entityIdentifiers:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000007b678
