...
- (void).cxx_destruct;	// IMP=0x00000000000918f6
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000009177f
- (void)start;	// IMP=0x00000000000915d2
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000913a5
