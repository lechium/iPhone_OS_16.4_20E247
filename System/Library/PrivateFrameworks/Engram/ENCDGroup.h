...
+ (id)predicateForStableGroupID:(id)arg1;	// IMP=0x00600000000073a6
+ (id)predicateForGroupIDs:(id)arg1;	// IMP=0x0060000000007321
+ (id)predicateForGroupID:(id)arg1;	// IMP=0x006000000000729c
+ (id)groupFromGroup:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x006000000000711b
+ (id)insertIntoManagedObjectContext:(id)arg1;	// IMP=0x006000000000704a
+ (id)fetchRequest;	// IMP=0x0060000000006fcd
