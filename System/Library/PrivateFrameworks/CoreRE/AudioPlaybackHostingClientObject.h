...
- (void).cxx_destruct;	// IMP=0x000000000035741b
...
- (void)start;	// IMP=0x00000000003573f7
- (id)initWithConnection:(id)arg1 connectionIdentifier:(unsigned long long)arg2;	// IMP=0x000000000035736d
