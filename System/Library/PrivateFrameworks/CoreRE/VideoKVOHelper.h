...
- (void).cxx_destruct;	// IMP=0x000000000061f23e
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000061f02c
- (void)dealloc;	// IMP=0x000000000061ee8e
- (void)addAVPlayerRateObserverWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000061ee24
- (void)addAVPlayerItemObserverWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000061edb7
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000061ed3a
