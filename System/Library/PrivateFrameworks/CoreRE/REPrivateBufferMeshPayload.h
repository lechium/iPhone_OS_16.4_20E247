...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000306e21
- (void).cxx_destruct;	// IMP=0x0000000000307989
...
- (id)redactedDescription;	// IMP=0x00000000003078b0
- (id)description;	// IMP=0x000000000030789e
@property(readonly, nonatomic, getter=isShareable) _Bool shareable;
@property(readonly, nonatomic) unsigned long long bufferSize;
- (id)bufferWithDevice:(id)arg1;	// IMP=0x00000000003075ef
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003073db
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000307085
- (id)initWithBuffer:(id)arg1 parts:(id)arg2 models:(id)arg3 instances:(id)arg4;	// IMP=0x0000000000306e29
