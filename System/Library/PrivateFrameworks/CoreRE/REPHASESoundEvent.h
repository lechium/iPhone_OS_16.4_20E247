...
+ (void)eventWithEngine:(id)arg1 streamUUID:(id)arg2 prepareState:(id)arg3 maximumFramesToRender:(unsigned int)arg4 audioSession:(id)arg5 callback:(CDUnknownBlockType)arg6;	// IMP=0x001000000032ec4f
+ (void)eventWithEngine:(id)arg1 streamUUID:(id)arg2 mixerDefinition:(id)arg3 source:(id)arg4 listener:(id)arg5 normalizationMode:(int)arg6 calibrationMode:(int)arg7 calibrationLevel:(double)arg8 audioSession:(id)arg9 callback:(CDUnknownBlockType)arg10;	// IMP=0x001000000032e95e
+ (void)controllerWithEngine:(id)arg1 streamUUID:(id)arg2 mixerDefinition:(id)arg3 source:(id)arg4 listener:(id)arg5 normalizationMode:(int)arg6 calibrationMode:(int)arg7 calibrationLevel:(double)arg8 callback:(CDUnknownBlockType)arg9;	// IMP=0x001000000032e7b5
- (id).cxx_construct;	// IMP=0x00000000003316a6
- (void).cxx_destruct;	// IMP=0x0000000000331528
...
- (id)description;	// IMP=0x000000000033122e
- (id)paramForKey:(id)arg1;	// IMP=0x00000000003310e2
@property(readonly) unsigned long long state;
- (_Bool)seekToTime:(double)arg1;	// IMP=0x0000000000330fcd
- (void)stopAndDestroy;	// IMP=0x0000000000330f9b
- (void)resume;	// IMP=0x0000000000330f69
- (void)pause;	// IMP=0x0000000000330f37
- (void)prepareWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000033094c
- (void)updateCommandQueue;	// IMP=0x0000000000330834
- (_Bool)_seekToTime:(double)arg1;	// IMP=0x00000000003302da
- (_Bool)_stopAndDestroy;	// IMP=0x000000000033013e
- (_Bool)_pause;	// IMP=0x0000000000330022
- (_Bool)_resume;	// IMP=0x000000000032fe15
- (_Bool)_startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000032f519
- (unsigned long long)changeToState:(unsigned long long)arg1;	// IMP=0x000000000032f32b
- (void)stream:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x000000000032f27e
- (id)initWithEngine:(id)arg1 rootNode:(id)arg2 source:(id)arg3 listener:(id)arg4 mixerParameters:(id)arg5 audioSession:(id)arg6 outError:(id *)arg7;	// IMP=0x000000000032e5e1
- (id)initWithAudioSession:(id)arg1;	// IMP=0x000000000032e503
- (id)initWithSoundEventFactory:(CDUnknownBlockType)arg1;	// IMP=0x000000000032e454
