...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000014e6b
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000014d97
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x0000000000014b66
- (void)_cancelAllImageLoads;	// IMP=0x0000000000014ad2
- (void)_loadImagesIfNecessary;	// IMP=0x000000000001403c
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000013c02
- (void)invalidate;	// IMP=0x0000000000013bed
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000013800
