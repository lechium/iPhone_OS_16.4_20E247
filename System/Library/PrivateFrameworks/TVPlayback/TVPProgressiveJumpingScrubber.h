...
- (void).cxx_destruct;	// IMP=0x0000000000003aac
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000038a2
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000037bc
- (void)cancelScrub;	// IMP=0x000000000000378a
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000036aa
