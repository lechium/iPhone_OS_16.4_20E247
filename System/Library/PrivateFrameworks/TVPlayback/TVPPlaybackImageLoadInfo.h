...
- (void).cxx_destruct;	// IMP=0x0000000000004091
...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x0000000000003e51
- (id)description;	// IMP=0x0000000000003d9a
