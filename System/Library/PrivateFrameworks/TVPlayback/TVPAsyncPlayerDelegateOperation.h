...
- (void).cxx_destruct;	// IMP=0x000000000005a210
@property(copy, nonatomic) CDUnknownBlockType block; // @synthesize block=_block;
@property(readonly, nonatomic) NSNumber *identifier; // @synthesize identifier=_identifier;
- (unsigned long long)hash;	// IMP=0x000000000005a1a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005a0fb
- (id)init;	// IMP=0x000000000005a083
