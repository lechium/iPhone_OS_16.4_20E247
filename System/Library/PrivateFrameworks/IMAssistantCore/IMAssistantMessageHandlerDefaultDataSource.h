...
+ (id)sharedInstance;	// IMP=0x001000000001cda5
- (void).cxx_destruct;	// IMP=0x000000000001ce5f
...
- (_Bool)screentimeAllowedToShowConversationWithHandleIDs:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001cb80
- (_Bool)screentimeAllowedToShowChat:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001c9e3
@property(readonly, nonatomic) _Bool isInternationalSpamFilteringEnabled;
- (void)registerForContactStoreChangeNotificationsIfNecessary;	// IMP=0x000000000001c958
- (void)contactStoreDidChange:(id)arg1;	// IMP=0x000000000001c886
