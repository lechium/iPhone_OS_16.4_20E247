...
- (void).cxx_destruct;	// IMP=0x0000000000024771
...
- (_Bool)matchesPerson:(id)arg1 withUnifiedContactIdentifiers:(id)arg2;	// IMP=0x00000000000243ae
- (id)initWithHandle:(id)arg1 contactIdentifiers:(id)arg2 isMe:(_Bool)arg3;	// IMP=0x0000000000024252
