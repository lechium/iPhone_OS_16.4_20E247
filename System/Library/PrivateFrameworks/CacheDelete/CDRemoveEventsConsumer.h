...
- (void).cxx_destruct;	// IMP=0x00000000000299e3
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x0000000000029445
- (void)callback:(id)arg1;	// IMP=0x00000000000286f9
- (void)dealloc;	// IMP=0x0000000000028682
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x0000000000028595
