...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024c15
- (void).cxx_destruct;	// IMP=0x0000000000024ead
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000024d43
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024c3a
