...
- (void).cxx_destruct;	// IMP=0x00000000000e18e7
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e181d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1812
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e1574
- (unsigned long long)hash;	// IMP=0x00000000000e1530
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e141d
