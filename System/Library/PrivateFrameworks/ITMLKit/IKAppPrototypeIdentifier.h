...
- (void).cxx_destruct;	// IMP=0x00000000000e06bb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e0424
- (unsigned long long)hash;	// IMP=0x00000000000e03e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e03d5
- (id)initWithIdentifier:(id)arg1 selector:(id)arg2 groupingValues:(id)arg3;	// IMP=0x00000000000e02ef
