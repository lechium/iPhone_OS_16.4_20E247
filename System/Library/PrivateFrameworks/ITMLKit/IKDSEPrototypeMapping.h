...
+ (id)prototypeMappingFromAppPrototype:(id)arg1 dataSourceElement:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000000026b9
- (void).cxx_destruct;	// IMP=0x0000000000002a76
...
- (id)initWithIdentifier:(id)arg1 viewElement:(id)arg2 usageIndexes:(id)arg3;	// IMP=0x000000000000298e
