...
- (void).cxx_destruct;	// IMP=0x000000000001191d
@property(readonly, copy, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly, nonatomic) __weak IKDOMElement *domElement; // @synthesize domElement=_domElement;
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x0000000000011816
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x000000000001150e
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000010fb5
