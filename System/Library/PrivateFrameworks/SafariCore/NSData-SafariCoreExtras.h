...
+ (id)safari_dataWithHexString:(id)arg1;	// IMP=0x0020000000013700
- (id)safari_dataByAppendingData:(id)arg1;	// IMP=0x001000000001369a
@property(readonly, nonatomic) NSString *safari_descriptionWithoutSpaces;
- (id)safari_scryptHashWithSalt:(id)arg1 N:(unsigned long long)arg2 r:(unsigned int)arg3 p:(unsigned int)arg4 keyLength:(unsigned long long)arg5;	// IMP=0x001000000001336f
