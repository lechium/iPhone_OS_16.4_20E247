...
- (void).cxx_destruct;	// IMP=0x00000000000ae640
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ae2d3
@property(readonly, copy) NSString *description;
- (id)initWithRemovedObjects:(id)arg1 indexes:(id)arg2;	// IMP=0x00000000000ae138
