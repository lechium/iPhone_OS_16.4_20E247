...
- (void).cxx_destruct;	// IMP=0x00000000000aeed3
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ae87d
@property(readonly, copy) NSString *description;
- (id)initWithOriginalObjects:(id)arg1 replacementObjects:(id)arg2 indexes:(id)arg3;	// IMP=0x00000000000ae682
