...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007898d
- (void).cxx_destruct;	// IMP=0x0000000000078df3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000078b5e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000078a7b
- (id)initWithContents:(id)arg1 contentsTimestamp:(id)arg2 modificationDate:(id)arg3;	// IMP=0x0000000000078995
- (id)init;	// IMP=0x0000000000078963
