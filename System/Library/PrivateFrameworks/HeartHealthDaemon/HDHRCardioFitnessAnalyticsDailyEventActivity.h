...
- (void).cxx_destruct;	// IMP=0x000000000003a76d
...
- (void)_queue_submitAnalyticsWithActivityCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003a3b4
- (void)performPeriodicActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039cd9
- (_Bool)periodicActivityRequiresProtectedData:(id)arg1;	// IMP=0x0000000000039cd1
- (void)periodicActivity:(id)arg1 configureXPCActivityCriteria:(id)arg2;	// IMP=0x0000000000039c64
- (void)daemonReady:(id)arg1;	// IMP=0x0000000000039bd6
- (void)dealloc;	// IMP=0x0000000000039b94
- (id)initWithProfile:(id)arg1;	// IMP=0x0000000000039a03
