...
+ (id)eventName;	// IMP=0x00400000000138cb
- (void).cxx_destruct;	// IMP=0x0000000000013aac
...
- (void)submit;	// IMP=0x00000000000139b9
- (id)eventPayload;	// IMP=0x00000000000138d8
- (id)initWithNotificationType:(id)arg1;	// IMP=0x0000000000013815
