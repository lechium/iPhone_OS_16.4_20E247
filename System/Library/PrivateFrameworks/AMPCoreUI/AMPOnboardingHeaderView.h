...
- (void)updateContentSize;	// IMP=0x0000000000006d81
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000006d2f
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000006b53
- (void)adjustedContentInsetDidChange;	// IMP=0x0000000000006afd
- (void)layoutSubviews;	// IMP=0x0000000000006436
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000629f
