...
- (void).cxx_destruct;	// IMP=0x0000000000005f96
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000563d
- (void)mediaPause;	// IMP=0x00000000000054b0
- (void)imageViewTapped:(id)arg1;	// IMP=0x0000000000005473
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000004c56
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000004b66
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000000047c6
- (void)loadView;	// IMP=0x00000000000043fa
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000000360b
