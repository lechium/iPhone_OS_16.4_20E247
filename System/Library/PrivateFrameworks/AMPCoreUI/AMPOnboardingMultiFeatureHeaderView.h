...
- (void).cxx_destruct;	// IMP=0x0000000000009025
...
- (void)updateContentSize;	// IMP=0x0000000000008a51
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000089ff
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000000880d
- (void)adjustedContentInsetDidChange;	// IMP=0x00000000000087b7
- (void)layoutSubviews;	// IMP=0x0000000000008047
