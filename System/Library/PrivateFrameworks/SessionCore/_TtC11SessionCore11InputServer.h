...
@interface _TtC11SessionCore11InputServer : NSObject
{
    ...
    MISSING_TYPE *clients;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0000000000002010
- (id)init;	// IMP=0x0000000000001fb0
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x0000000000001f30
