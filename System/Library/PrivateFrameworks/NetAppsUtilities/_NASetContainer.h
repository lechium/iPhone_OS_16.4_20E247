...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x0060000000004e4a
- (void).cxx_destruct;	// IMP=0x000000000000516f
...
- (unsigned long long)hash;	// IMP=0x0000000000005049
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004f16
