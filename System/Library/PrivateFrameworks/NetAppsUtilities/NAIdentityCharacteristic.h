...
- (void).cxx_destruct;	// IMP=0x000000000001ef8e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ec62
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001eb1e
- (id)init;	// IMP=0x000000000001ea9d
