...
- (void).cxx_destruct;	// IMP=0x00000000000040c9
...
- (id)allObjects;	// IMP=0x0000000000004000
- (id)nextObject;	// IMP=0x0000000000003f2d
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003e78
