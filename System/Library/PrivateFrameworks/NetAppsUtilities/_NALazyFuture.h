...
- (void).cxx_destruct;	// IMP=0x0000000000004a1b
...
- (void)willAddCompletionBlock;	// IMP=0x0000000000004739
- (id)initWithBlock:(CDUnknownBlockType)arg1 scheduler:(id)arg2;	// IMP=0x0000000000004628
