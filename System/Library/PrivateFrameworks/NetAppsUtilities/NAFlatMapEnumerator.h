...
- (id)allObjects;	// IMP=0x0000000000004252
- (id)nextObject;	// IMP=0x00000000000041af
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x00000000000040fa
