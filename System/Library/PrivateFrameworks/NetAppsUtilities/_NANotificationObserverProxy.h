...
- (void).cxx_destruct;	// IMP=0x0000000000018368
...
- (void)invalidate;	// IMP=0x000000000001829a
- (void)performObserverBlock;	// IMP=0x0000000000018241
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000017ff9
