...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000012406
- (void).cxx_destruct;	// IMP=0x000000000001244a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001237e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001223e
@property(readonly, copy, nonatomic) NSString *extraPreviewText;
@property(readonly, nonatomic) long long type;
- (id)initWithInvalidDataType:(long long)arg1 invalidContents:(id)arg2;	// IMP=0x000000000001219d
