...
- (void).cxx_destruct;	// IMP=0x0000000000006310
...
- (void)start;	// IMP=0x0000000000006041
- (void)finishExecuting;	// IMP=0x0000000000005f3e
- (void)cancel;	// IMP=0x0000000000005e7d
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000005e0f
