...
+ (id)mtURLForScheme:(id)arg1;	// IMP=0x002000000005a1c1
+ (id)mtURLForClockAppSection:(int)arg1 timerManager:(id)arg2;	// IMP=0x0020000000059f61
+ (id)mtURLForClockAppSection:(int)arg1;	// IMP=0x0020000000059f4d
