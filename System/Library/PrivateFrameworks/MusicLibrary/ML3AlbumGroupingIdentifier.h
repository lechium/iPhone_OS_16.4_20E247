...
- (void).cxx_destruct;	// IMP=0x000000000014fd72
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014fbf5
- (unsigned long long)hash;	// IMP=0x000000000014fb90
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014f9f1
- (id)description;	// IMP=0x000000000014f93a
- (id)initWithAlbumArtistPersistentID:(long long)arg1 groupingKey:(id)arg2 feedURL:(id)arg3 seasonNumber:(long long)arg4 compilation:(_Bool)arg5;	// IMP=0x000000000014f863
