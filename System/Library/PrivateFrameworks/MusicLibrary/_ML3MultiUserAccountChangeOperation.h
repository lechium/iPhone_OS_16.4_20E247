...
- (void).cxx_destruct;	// IMP=0x00000000000bc955
...
- (void)execute;	// IMP=0x00000000000bc7ef
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000bc741
