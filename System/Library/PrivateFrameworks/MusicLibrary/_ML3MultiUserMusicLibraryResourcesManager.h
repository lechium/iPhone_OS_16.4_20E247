...
- (void).cxx_destruct;	// IMP=0x00000000001b2f38
...
- (void)terminateForFailureToPerformDatabasePathChange;	// IMP=0x00000000001b2ee8
- (void)emergencyDisconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b2de1
- (void)performDatabasePathChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001b2ce3
...
- (id)libraryContainerPath;	// IMP=0x00000000001b2708
- (id)initWithLibraryResourcesService:(id)arg1;	// IMP=0x00000000001b2636
