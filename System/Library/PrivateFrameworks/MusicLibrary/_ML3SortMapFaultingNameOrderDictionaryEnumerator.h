...
- (void).cxx_destruct;	// IMP=0x0000000000094e57
- (id)nextObject;	// IMP=0x0000000000094c58
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000094bb6
