...
- (id).cxx_construct;	// IMP=0x000000000014c6d7
- (void).cxx_destruct;	// IMP=0x000000000014c687
...
- (_Bool)unregister;	// IMP=0x000000000014c428
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x000000000014c151
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x000000000014c0d0
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x000000000014bf4e
