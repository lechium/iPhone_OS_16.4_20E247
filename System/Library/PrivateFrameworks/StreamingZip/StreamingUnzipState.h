...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00600000000223d6
- (void).cxx_destruct;	// IMP=0x000000000002276d
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e6a7
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001e2d7
- (id)finishStream;	// IMP=0x000000000001e1ae
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001e199
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001dece
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001dc0b
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001d56e
- (id)serializeState;	// IMP=0x000000000001c7e5
- (void)markResumptionPoint;	// IMP=0x000000000001c7df
- (void)clearSavedState;	// IMP=0x000000000001c6f0
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001c3ae
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001c343
