...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x006000000000acd9
- (void).cxx_destruct;	// IMP=0x000000000000b4cb
...
- (_Bool)isDataLoaded;	// IMP=0x000000000000b05f
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x000000000000aea6
- (_Bool)isDataValid;	// IMP=0x000000000000ae02
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x000000000000ad51
