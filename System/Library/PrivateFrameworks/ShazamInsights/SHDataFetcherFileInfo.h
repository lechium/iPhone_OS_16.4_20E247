...
+ (id)dataFetcherForSourceURL:(id)arg1;	// IMP=0x006000000000dabe
- (void).cxx_destruct;	// IMP=0x000000000000debd
...
- (id)initWithDataURL:(id)arg1;	// IMP=0x000000000000dc29
- (id)initWithDataURL:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000db90
- (id)initWithData:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000daf7
