...
- (void).cxx_destruct;	// IMP=0x00000000000087cd
@property(readonly, nonatomic) id <SHDataFetcher> dataFetcher; // @synthesize dataFetcher=_dataFetcher;
- (void)affinityGroupsFromData:(id)arg1 atLocation:(id)arg2 onDate:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000008344
