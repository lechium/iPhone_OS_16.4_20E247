...
- (void)cancelCallbacks;	// IMP=0x000000000013a9c7
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x000000000013a9b5
- (void)start;	// IMP=0x000000000013a96c
@property(readonly, nonatomic) NSObject *observedObject;
- (void)dealloc;	// IMP=0x000000000013a8ba
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x000000000013a6d8
