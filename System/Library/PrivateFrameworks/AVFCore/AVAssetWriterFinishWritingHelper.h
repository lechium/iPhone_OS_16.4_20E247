...
- (long long)status;	// IMP=0x000000000009b534
- (void)cancelWriting;	// IMP=0x000000000009b41d
- (void)_finishWritingOperationsDidFinish;	// IMP=0x000000000009b34a
- (void)dealloc;	// IMP=0x000000000009b2af
- (id)initWithConfigurationState:(id)arg1 finishWritingOperations:(id)arg2 figAssetWriterCallbackContextToken:(void *)arg3;	// IMP=0x000000000009b03d
