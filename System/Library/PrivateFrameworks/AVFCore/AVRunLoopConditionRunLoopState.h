...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000000e1da6
...
- (void)dealloc;	// IMP=0x00000000000e1e42
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000e1ddd
