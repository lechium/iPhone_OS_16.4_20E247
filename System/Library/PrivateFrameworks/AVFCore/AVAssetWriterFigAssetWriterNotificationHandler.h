...
- (void)_handleFailedNotificationWithError:(id)arg1;	// IMP=0x0000000000097093
- (void)_handleCompletedWritingNotification;	// IMP=0x000000000009705e
- (void)_teardownNotificationHandlers;	// IMP=0x0000000000096fad
- (void)_callDelegateIfNotCalledWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x0000000000096f4a
- (void)dealloc;	// IMP=0x0000000000096ee5
- (id)initWithFigAssetWriter:(struct OpaqueFigAssetWriter *)arg1;	// IMP=0x0000000000096cbe
