...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000117196
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x000000000011703e
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000116cfb
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x0000000000116c30
- (void)_bringUpToDate;	// IMP=0x0000000000116b78
- (id)_fetchApplicableOutputDataRates;	// IMP=0x0000000000116ad9
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x0000000000116535
- (void)_buildAvailableSampleRates;	// IMP=0x00000000001163fc
- (void)_buildAudioConverter;	// IMP=0x0000000000116334
- (void)dealloc;	// IMP=0x00000000001162cb
- (id)init;	// IMP=0x0000000000116270
