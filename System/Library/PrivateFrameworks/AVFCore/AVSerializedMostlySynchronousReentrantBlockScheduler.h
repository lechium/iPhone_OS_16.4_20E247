...
+ (void)initialize;	// IMP=0x00100000000fac63
- (void)scheduleBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000fad93
- (void)dealloc;	// IMP=0x00000000000fad46
- (id)init;	// IMP=0x00000000000facca
