...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000c5a94
- (void)invalidate;	// IMP=0x00000000000c59ec
- (_Bool)_isInvalidatePending;	// IMP=0x00000000000c59c4
- (void)_setInvalidatePending;	// IMP=0x00000000000c599f
- (void)startRequestingMediaData;	// IMP=0x00000000000c593e
- (void)dealloc;	// IMP=0x00000000000c58e9
- (id)init;	// IMP=0x00000000000c58d0
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c572f
