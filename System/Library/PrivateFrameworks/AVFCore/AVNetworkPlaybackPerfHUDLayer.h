...
- (void).cxx_destruct;	// IMP=0x00000000000584ec
...
- (void)_hudUpdateTrigger;	// IMP=0x0000000000058214
- (void)copyPropertiesFromStringGenerator:(id)arg1;	// IMP=0x0000000000058141
- (id)displayStringGenerator;	// IMP=0x000000000005808d
- (void)updateHudWithDisplayString:(id)arg1;	// IMP=0x0000000000057c77
- (_Bool)valueLoadedForKey:(id)arg1 onObject:(id)arg2;	// IMP=0x0000000000057b3f
- (void)currentItemTracksChanged;	// IMP=0x00000000000579c3
- (void)currentItemChanged;	// IMP=0x0000000000057943
- (float)getScaleFactorForDisplaySize:(struct CGSize)arg1;	// IMP=0x0000000000057886
- (void)dealloc;	// IMP=0x00000000000577f4
- (void)startDispatchTimer;	// IMP=0x00000000000576e1
- (void)readHudSettingsAndCallCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000057660
- (void)getHudSetting;	// IMP=0x0000000000057444
- (void)setColor:(int)arg1;	// IMP=0x000000000005731c
- (void)updateBounds:(struct CGRect)arg1;	// IMP=0x000000000005722c
- (id)init;	// IMP=0x0000000000057139
- (_Bool)hudEnabled;	// IMP=0x0000000000057129
