...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x00600000000553fe
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x00600000000553d3
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x0060000000055368
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x0060000000055064
- (void).cxx_destruct;	// IMP=0x000000000005711b
...
- (void)update;	// IMP=0x00000000000568e2
- (void)updateFromPlayerItem;	// IMP=0x0000000000055c25
- (void)updateFromPlayer;	// IMP=0x000000000005570c
- (void)dealloc;	// IMP=0x0000000000054f30
