...
- (void).cxx_destruct;	// IMP=0x00000000000cc3da
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (_Bool)supportsFitnessDataDestination;	// IMP=0x00000000000cc3b3
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000cc376
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cc350
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cc30d
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000cc2da
...
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cc244
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cc23e
- (void)setVolume:(float)arg1;	// IMP=0x00000000000cc238
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cc1ea
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000cc1e4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000cc093
