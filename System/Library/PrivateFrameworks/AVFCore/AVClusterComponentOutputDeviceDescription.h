...
- (void)dealloc;	// IMP=0x00000000000cc9d1
- (id)initWithDeviceID:(id)arg1 deviceName:(id)arg2 deviceSubType:(long long)arg3 isClusterLeader:(_Bool)arg4 modelID:(id)arg5;	// IMP=0x00000000000cc907
