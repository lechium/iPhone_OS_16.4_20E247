...
- (void)dealloc;	// IMP=0x0000000000133efc
- (id)init;	// IMP=0x0000000000133ee3
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000133e03
