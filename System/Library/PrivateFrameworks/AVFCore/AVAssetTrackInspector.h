...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00100000000effb9
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x00000000000f0a1b
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x00000000000f0992
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x00000000000f0909
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000f07f6
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000f0708
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000f04ad
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000f04a5
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f0172
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f015b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f0150
- (void)dealloc;	// IMP=0x00000000000f00ea
- (id)_weakReference;	// IMP=0x00000000000f00d9
- (id)init;	// IMP=0x00000000000f00bc
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x00000000000f00a5
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x00000000000f008c
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000000f000f
