...
+ (void)initialize;	// IMP=0x001000000012eb7a
...
- (void)cancelAllPendingVideoCompositionRequests;	// IMP=0x000000000012f17e
- (void)startVideoCompositionRequest:(id)arg1;	// IMP=0x000000000012ef42
- (id)defaultCIContext;	// IMP=0x000000000012ee0f
...
- (void)renderContextChanged:(id)arg1;	// IMP=0x000000000012ed90
@property(readonly, nonatomic) NSDictionary *requiredPixelBufferAttributesForRenderContext;
@property(readonly, nonatomic) NSDictionary *sourcePixelBufferAttributes;
- (void)dealloc;	// IMP=0x000000000012ec10
- (void)_willDeallocOrFinalize;	// IMP=0x000000000012ebe2
- (id)init;	// IMP=0x000000000012eb8b
