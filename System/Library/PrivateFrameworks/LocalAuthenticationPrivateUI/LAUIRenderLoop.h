...
- (void).cxx_destruct;	// IMP=0x00000000000143c8
...
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x000000000001428e
- (void)_applicationWillEnterForeground:(id)arg1;	// IMP=0x0000000000014279
- (void)_applicationDidEnterBackground:(id)arg1;	// IMP=0x00000000000141b8
- (void)_didDraw;	// IMP=0x0000000000013fdc
- (void)_willDraw;	// IMP=0x0000000000013fd6
- (_Bool)_isForcingPause;	// IMP=0x0000000000013fce
- (void)_didInvalidate;	// IMP=0x0000000000013fc8
- (void)invalidate;	// IMP=0x0000000000013f5f
- (_Bool)attachToScreen:(id)arg1;	// IMP=0x0000000000013bdb
- (void)dealloc;	// IMP=0x0000000000013b04
- (id)init;	// IMP=0x00000000000138f0
