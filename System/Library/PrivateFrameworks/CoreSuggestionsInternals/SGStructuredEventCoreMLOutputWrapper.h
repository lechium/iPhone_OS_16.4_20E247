...
- (void).cxx_destruct;	// IMP=0x000000000016418e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000163f69
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLocation:(id)arg1 time:(id)arg2 title:(id)arg3 core:(id)arg4 bi_lstm_0_h_out:(id)arg5 bi_lstm_0_c_out:(id)arg6 bi_lstm_0_h_out_rev:(id)arg7 bi_lstm_0_c_out_rev:(id)arg8;	// IMP=0x0000000000163e0d
