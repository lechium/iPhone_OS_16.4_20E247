...
- (void).cxx_destruct;	// IMP=0x0000000000019614
...
- (void)writeNode:(CDStruct_ef06dbdc)arg1;	// IMP=0x00000000000194ea
- (void)writeCharacter:(unsigned char)arg1;	// IMP=0x000000000001948e
- (void)dealloc;	// IMP=0x0000000000019433
- (id)init;	// IMP=0x0000000000019326
