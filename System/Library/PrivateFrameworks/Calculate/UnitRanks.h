...
+ (id)unitRanksWithUnitsInfo:(id)arg1;	// IMP=0x006000000001643d
- (void).cxx_destruct;	// IMP=0x00000000000163f7
...
- (void)addUnitRank:(id)arg1;	// IMP=0x0000000000016159
@property(readonly) _Bool isAmbiguous;
- (void)sort;	// IMP=0x00000000000160c7
- (id)init;	// IMP=0x0000000000016018
- (id)initWithUnitsInfo:(id)arg1;	// IMP=0x0000000000015f4f
