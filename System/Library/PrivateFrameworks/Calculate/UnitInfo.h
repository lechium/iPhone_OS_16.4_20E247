...
- (id)compactNameForLocalization:(id)arg1;	// IMP=0x000000000001669e
- (unsigned long long)hash;	// IMP=0x0000000000016651
- (long long)compare:(id)arg1;	// IMP=0x00000000000165c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016544
- (id)init;	// IMP=0x000000000001648e
