...
+ (id)logCategory;	// IMP=0x00600000000564c7
- (void).cxx_destruct;	// IMP=0x00000000000563f9
...
- (void)main;	// IMP=0x00000000000562e7
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000056253
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000561b8
