...
- (void).cxx_destruct;	// IMP=0x0000000000054eea
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054d92
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2 modelClassName:(id)arg3;	// IMP=0x0000000000054b4f
