...
- (void).cxx_destruct;	// IMP=0x0000000000053fcb
...
- (id)description;	// IMP=0x0000000000053eea
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000053e37
