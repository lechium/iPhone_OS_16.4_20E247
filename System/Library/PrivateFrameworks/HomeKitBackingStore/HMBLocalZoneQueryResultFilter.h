...
- (void).cxx_destruct;	// IMP=0x00000000000559ef
...
- (id)fetchRowFromStatement:(struct sqlite3_stmt *)arg1 skip:(_Bool *)arg2 updatedSequence:(unsigned long long *)arg3 error:(id *)arg4;	// IMP=0x0000000000055707
- (id)initWithLocalZone:(id)arg1 statement:(id)arg2 columns:(id)arg3 filter:(CDUnknownBlockType)arg4;	// IMP=0x00000000000555f9
