...
- (void).cxx_destruct;	// IMP=0x0000000000054b3c
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054a55
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x00000000000548df
