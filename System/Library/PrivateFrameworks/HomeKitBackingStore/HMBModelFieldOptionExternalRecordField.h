...
- (void).cxx_destruct;	// IMP=0x000000000009d986
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009d8d6
- (id)initWithExternalRecordField:(id)arg1 encrypted:(_Bool)arg2;	// IMP=0x000000000009d856
