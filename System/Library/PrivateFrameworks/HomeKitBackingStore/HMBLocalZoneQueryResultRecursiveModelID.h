...
- (void).cxx_destruct;	// IMP=0x00000000000555b7
...
- (id)nextObject;	// IMP=0x00000000000552d1
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005520b
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000054f1b
