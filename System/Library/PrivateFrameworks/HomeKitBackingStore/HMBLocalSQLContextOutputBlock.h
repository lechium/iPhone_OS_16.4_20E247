...
+ (id)logCategory;	// IMP=0x0010000000071e4a
- (void).cxx_destruct;	// IMP=0x0000000000071be3
...
- (id)logIdentifier;	// IMP=0x0000000000071b22
- (id)abort;	// IMP=0x0000000000071690
- (id)commit:(id)arg1;	// IMP=0x0000000000071161
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x0000000000070e11
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x0000000000070b8b
