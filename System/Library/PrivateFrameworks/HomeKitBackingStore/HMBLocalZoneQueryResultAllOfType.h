...
- (void).cxx_destruct;	// IMP=0x00000000000548cc
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x00000000000547e5
- (id)initWithLocalZone:(id)arg1 modelClassName:(id)arg2;	// IMP=0x000000000005466f
