...
- (void).cxx_destruct;	// IMP=0x000000000001f801
...
- (void)finalize;	// IMP=0x000000000001f3dc
- (void)dealloc;	// IMP=0x000000000001f274
- (unsigned long long)_updateQueryForZoneRow:(unsigned long long)arg1 recordRow:(unsigned long long)arg2 encodedColumns:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001f146
- (id)buildQueriableFieldsForModel:(id)arg1;	// IMP=0x000000000001effb
- (unsigned long long)_deleteAllQueriesForZoneRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001ef47
- (unsigned long long)_deleteQueryForRecordRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001ee69
- (id)performQueryOn:(id)arg1 properties:(id)arg2 filter:(CDUnknownBlockType)arg3;	// IMP=0x000000000001ecdd
- (id)initWithContext:(id)arg1 queryModel:(Class)arg2 prepareOnly:(_Bool)arg3;	// IMP=0x000000000001d14c
