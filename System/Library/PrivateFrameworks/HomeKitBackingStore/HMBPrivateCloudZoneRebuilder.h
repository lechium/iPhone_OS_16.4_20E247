...
+ (id)logCategory;	// IMP=0x001000000003b140
- (void).cxx_destruct;	// IMP=0x0000000000034381
...
- (id)logIdentifier;	// IMP=0x000000000003421f
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000033f95
- (void)handleZoneChanged;	// IMP=0x0000000000033cff
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x0000000000033b20
- (void)handleIdentityLost;	// IMP=0x0000000000033984
- (id)zoneStartUp;	// IMP=0x0000000000033827
- (id)initWithCloudZone:(id)arg1;	// IMP=0x0000000000033760
