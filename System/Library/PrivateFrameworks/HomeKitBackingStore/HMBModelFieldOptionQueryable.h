...
- (void).cxx_destruct;	// IMP=0x000000000009df6a
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009dd13
- (id)initWithEncodingBlock:(CDUnknownBlockType)arg1 decodingBlock:(CDUnknownBlockType)arg2 descriptionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000009dc2e
