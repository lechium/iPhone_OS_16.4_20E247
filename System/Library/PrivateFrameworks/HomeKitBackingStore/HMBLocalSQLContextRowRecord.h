...
- (void).cxx_destruct;	// IMP=0x0000000000065b8f
...
- (id)attributeDescriptions;	// IMP=0x00000000000653be
- (id)initWithStatement:(struct sqlite3_stmt *)arg1 returning:(unsigned long long)arg2;	// IMP=0x000000000006515a
- (id)initWithRecordRow:(unsigned long long)arg1 externalID:(id)arg2 externalData:(id)arg3 modelID:(id)arg4 modelEncoding:(unsigned long long)arg5 modelData:(id)arg6 modelSchema:(id)arg7 modelType:(id)arg8 pushEncoding:(unsigned long long)arg9 pushData:(id)arg10 pushBlockRow:(id)arg11;	// IMP=0x0000000000064f9c
