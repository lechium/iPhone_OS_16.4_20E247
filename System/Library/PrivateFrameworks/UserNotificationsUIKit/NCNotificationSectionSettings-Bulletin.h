...
+ (id)notificationSectionSettingsForBBSectionInfo:(id)arg1;	// IMP=0x0020000000048ddb
- (unsigned long long)_groupingSettingFromBBGroupingSetting:(long long)arg1;	// IMP=0x001000000004a173
- (unsigned long long)_contentPreviewSettingFromBBContentPreviewSetting:(long long)arg1;	// IMP=0x001000000004a121
...
- (unsigned long long)contentPreviewSettingForRequestWithSubSectionIdentifiers:(id)arg1;	// IMP=0x0010000000049c6a
- (id)_notificationSectionSettingsForSubSectionWithIdentifier:(id)arg1;	// IMP=0x0010000000049a74
