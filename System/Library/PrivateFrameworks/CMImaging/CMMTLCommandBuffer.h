...
- (void).cxx_destruct;	// IMP=0x00000000000089fe
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000008952
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000008902
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000088cd
- (void)commit;	// IMP=0x00000000000082c6
- (id)initWithCMMTLCommandQueue:(id)arg1 unretained:(_Bool)arg2;	// IMP=0x000000000000819d
- (void)waitUntilScheduled;	// IMP=0x0000000000008187
- (void)waitUntilCompleted;	// IMP=0x0000000000008171
