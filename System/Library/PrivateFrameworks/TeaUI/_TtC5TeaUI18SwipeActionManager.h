...
- (void).cxx_destruct;	// IMP=0x00000000002c72d0
- (void)handleTapGestureWithRecognizer:(id)arg1;	// IMP=0x00000000002c6270
- (void)handlePanGestureWithRecognizer:(id)arg1;	// IMP=0x00000000002c6020
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000002c4780
- (id)init;	// IMP=0x00000000002c12d0
