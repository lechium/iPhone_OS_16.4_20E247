...
- (void).cxx_destruct;	// IMP=0x0000000000002e75
...
- (void)uninstallProfile;	// IMP=0x0000000000002c59
- (void)main;	// IMP=0x0000000000002c47
- (void)cancel;	// IMP=0x0000000000002b88
- (_Bool)isAsynchronous;	// IMP=0x0000000000002b80
- (id)initWithProfileInstallationPrimitives:(id)arg1 profileIdentifier:(id)arg2;	// IMP=0x0000000000002ade
