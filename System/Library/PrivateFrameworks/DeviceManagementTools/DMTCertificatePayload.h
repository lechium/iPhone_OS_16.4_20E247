...
+ (id)supportedPayloadTypes;	// IMP=0x0010000000001b74
- (void).cxx_destruct;	// IMP=0x0000000000001d79
...
- (id)initWithDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000001bc8
