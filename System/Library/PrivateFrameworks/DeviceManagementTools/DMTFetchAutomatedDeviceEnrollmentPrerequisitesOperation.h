...
+ (_Bool)validateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x00600000000070bb
- (void).cxx_destruct;	// IMP=0x0000000000007372
...
- (void)runWithRequest:(id)arg1;	// IMP=0x0000000000007160
- (id)initWithRequest:(id)arg1 deviceInformationPrimitives:(id)arg2;	// IMP=0x0000000000007043
