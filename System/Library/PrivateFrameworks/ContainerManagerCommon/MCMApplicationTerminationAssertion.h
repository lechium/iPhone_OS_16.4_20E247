...
- (void).cxx_destruct;	// IMP=0x000000000009e6eb
@property(retain, nonatomic) RBSTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000000009e5ed
- (void)invalidate;	// IMP=0x000000000009e524
- (id)initWithBundleIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x000000000009de63
