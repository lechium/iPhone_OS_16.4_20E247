...
+ (Class)incomingMessageClass;	// IMP=0x0010000000094736
+ (unsigned long long)command;	// IMP=0x0010000000094700
- (void).cxx_destruct;	// IMP=0x00000000000946ac
...
- (void)execute;	// IMP=0x0000000000093d03
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000093cd0
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000093b5f
