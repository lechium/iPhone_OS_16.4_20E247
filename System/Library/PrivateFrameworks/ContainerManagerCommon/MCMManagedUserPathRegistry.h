...
- (void).cxx_destruct;	// IMP=0x0000000000039024
...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x0000000000038c1a
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0000000000038a7a
