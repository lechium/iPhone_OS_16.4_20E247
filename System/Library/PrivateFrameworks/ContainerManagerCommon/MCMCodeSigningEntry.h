...
- (void).cxx_destruct;	// IMP=0x00000000000c00d8
...
- (id)description;	// IMP=0x00000000000bfcfa
- (unsigned long long)hash;	// IMP=0x00000000000bfba7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bf8a1
- (id)serialize;	// IMP=0x00000000000bf5e0
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x00000000000bf3b5
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000000000bf376
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x00000000000bf2c0
