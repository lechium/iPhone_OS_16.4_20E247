...
- (void).cxx_destruct;	// IMP=0x000000000006a3b9
...
- (unsigned int)disposition;	// IMP=0x000000000006a2a8
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000069e47
