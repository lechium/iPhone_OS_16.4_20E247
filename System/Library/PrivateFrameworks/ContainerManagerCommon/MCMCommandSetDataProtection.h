...
+ (Class)incomingMessageClass;	// IMP=0x001000000009d89b
+ (unsigned long long)command;	// IMP=0x001000000009d865
- (void).cxx_destruct;	// IMP=0x000000000009d62a
...
- (void)execute;	// IMP=0x000000000009cdf6
- (_Bool)preflightClientAllowed;	// IMP=0x000000000009cd5d
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000009cc58
