...
- (void).cxx_destruct;	// IMP=0x00000000000b6493
...
- (void)dealloc;	// IMP=0x00000000000b6320
- (id)initWithPath:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b6255
- (id)initWithURL:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b6194
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000b5ff1
