...
+ (Class)incomingMessageClass;	// IMP=0x00100000000366d8
+ (unsigned long long)command;	// IMP=0x00100000000366a2
- (void).cxx_destruct;	// IMP=0x00000000000365f9
...
- (void)execute;	// IMP=0x0000000000035b17
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000035a7e
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000035949
