...
- (void).cxx_destruct;	// IMP=0x000000000004daeb
...
- (id)initWithContainers:(id)arg1 clientIdentity:(id)arg2 issueSandboxExtensions:(_Bool)arg3 resolvedLinks:(id)arg4 includePath:(_Bool)arg5 includeInfo:(_Bool)arg6 legacyPersonaPolicy:(_Bool)arg7 legacyExtensionPolicy:(_Bool)arg8;	// IMP=0x000000000004d7dd
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000004d42b
- (void)_compileContainerDataForIndex:(unsigned long long)arg1 container:(struct container_object_s **)arg2 infos:(id)arg3 tokens:(id)arg4;	// IMP=0x000000000004ceee
