...
+ (Class)incomingMessageClass;	// IMP=0x0010000000013ede
+ (unsigned long long)command;	// IMP=0x0010000000013ea8
...
- (id)_resolveUserIdentity;	// IMP=0x00000000000138f4
- (void)execute;	// IMP=0x0000000000012d95
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000012cfc
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000012bb7
