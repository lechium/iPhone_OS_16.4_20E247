...
- (void).cxx_destruct;	// IMP=0x00000000000925da
@property(retain, nonatomic) NSObject<OS_xpc_object> *xpcToMerge; // @synthesize xpcToMerge=_xpcToMerge;
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000923b2
- (void)mergeWithXPCResult:(id)arg1;	// IMP=0x0000000000092375
