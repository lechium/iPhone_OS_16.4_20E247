...
- (id)initWithContainers:(id)arg1 resolvedLinks:(id)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 clientIdentity:(id)arg5 skipSandboxExtensions:(_Bool)arg6;	// IMP=0x0000000000094e02
- (id)initWithContainerPaths:(id)arg1 containerIdentities:(id)arg2 includePath:(_Bool)arg3 clientIdentity:(id)arg4 skipSandboxExtensions:(_Bool)arg5;	// IMP=0x0000000000094cb9
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000948fe
