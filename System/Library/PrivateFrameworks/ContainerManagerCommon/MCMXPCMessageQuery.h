...
- (void).cxx_destruct;	// IMP=0x000000000008e1a2
...
- (unsigned int)disposition;	// IMP=0x000000000008dc65
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000008d263
