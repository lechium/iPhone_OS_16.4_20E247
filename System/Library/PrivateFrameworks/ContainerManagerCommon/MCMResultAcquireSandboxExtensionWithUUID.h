...
- (void).cxx_destruct;	// IMP=0x000000000006ef94
...
- (void)dealloc;	// IMP=0x000000000006ee5c
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000006ed0a
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x000000000006ec0c
