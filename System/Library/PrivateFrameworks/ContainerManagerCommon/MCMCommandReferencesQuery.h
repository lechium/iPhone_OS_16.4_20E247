...
+ (Class)incomingMessageClass;	// IMP=0x0010000000068916
+ (unsigned long long)command;	// IMP=0x00100000000688e0
- (void).cxx_destruct;	// IMP=0x00000000000686b4
...
- (void)execute;	// IMP=0x0000000000068171
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000680d8
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000067fba
