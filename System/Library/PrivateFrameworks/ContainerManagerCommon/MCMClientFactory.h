...
- (void).cxx_destruct;	// IMP=0x0000000000051542
...
- (id)initWithUserIdentityCache:(id)arg1 clientCodeSignInfoCache:(id)arg2 clientIdentityCache:(id)arg3;	// IMP=0x00000000000513c9
- (id)_codeSignInfoWithClient:(struct container_client *)arg1 CDHash:(id)arg2 identifier:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000052c53
- (id)_clientIdentityWithClient:(struct container_client *)arg1 realAuditToken:(CDStruct_4c969caf)arg2 error:(id *)arg3;	// IMP=0x00000000000522c4
- (id)_clientIdentityWithClientConnectionContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000051fb5
- (id)clientIdentityWithClientConnectionContext:(id)arg1 clientMessageContext:(id)arg2 xpcMessage:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000051598
