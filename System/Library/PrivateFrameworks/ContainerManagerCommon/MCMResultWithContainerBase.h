...
- (void).cxx_destruct;	// IMP=0x0000000000093aa5
...
- (void)dealloc;	// IMP=0x0000000000093753
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 resolvedLinks:(id)arg5;	// IMP=0x000000000009346e
- (id)initWithContainerPath:(id)arg1 containerIdentity:(id)arg2 uuid:(id)arg3 sandboxToken:(const char *)arg4 includePath:(_Bool)arg5;	// IMP=0x000000000009324f
- (id)initWithUUID:(id)arg1 containerPathIdentifier:(id)arg2 identifier:(id)arg3 containerClass:(unsigned long long)arg4 POSIXUser:(id)arg5 personaUniqueString:(id)arg6 sandboxToken:(const char *)arg7 existed:(_Bool)arg8 url:(id)arg9 info:(id)arg10 resolvedLinks:(id)arg11 transient:(_Bool)arg12;	// IMP=0x0000000000093031
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x0000000000092abf
