...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000016f342
+ (id)loadFromClientStateInSession:(id)arg1 options:(id)arg2;	// IMP=0x006000000016efbb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016f252
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016f159
- (id)init;	// IMP=0x000000000016f0ff
- (id)description;	// IMP=0x000000000016f0b5
...
- (unsigned long long)allocatePackageItemRank;	// IMP=0x000000000016ee77
@property(nonatomic) unsigned long long nextNotifRank;
- (unsigned long long)allocateNotifRank;	// IMP=0x000000000016edaf
- (unsigned long long)allocateItemRowID;	// IMP=0x000000000016ed57
