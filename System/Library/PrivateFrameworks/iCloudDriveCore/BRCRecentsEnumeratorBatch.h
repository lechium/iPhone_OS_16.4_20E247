...
- (void).cxx_destruct;	// IMP=0x00000000001a5f7e
@property(nonatomic) unsigned long long rank; // @synthesize rank=_rank;
- (void)listItems:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a5edb
- (id)description;	// IMP=0x00000000001a5e5c
- (unsigned long long)batchCount;	// IMP=0x00000000001a5dc0
- (void)addDeletionOfFileObjectID:(id)arg1 rank:(unsigned long long)arg2;	// IMP=0x00000000001a5d7f
- (void)addIndexOfItem:(id)arg1;	// IMP=0x00000000001a5a88
- (id)init;	// IMP=0x00000000001a59eb
