...
- (void).cxx_destruct;	// IMP=0x00000000001c0516
...
- (id)initWithItemID:(id)arg1 parentID:(id)arg2 structuralCKInfo:(id)arg3 contentCKInfo:(id)arg4 itemType:(BOOL)arg5 aliasTargetZoneIsShared:(_Bool)arg6 chainState:(unsigned int)arg7;	// IMP=0x00000000001c0372
