...
- (void).cxx_destruct;	// IMP=0x0000000000067c46
...
- (void)dealloc;	// IMP=0x0000000000067bed
- (void)invalidate;	// IMP=0x0000000000067a09
- (void)done;	// IMP=0x000000000006781c
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x00000000000677af
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000066081
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x0000000000065cf1
