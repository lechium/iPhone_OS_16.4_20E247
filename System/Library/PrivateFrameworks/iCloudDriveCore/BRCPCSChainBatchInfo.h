...
- (void)chainPreparedRecordBatch:(id)arg1;	// IMP=0x00000000001c181f
- (void)_chainPreppedRecordToParent:(id)arg1;	// IMP=0x00000000001c1552
- (void)addFullyChainedRecordInfo:(id)arg1;	// IMP=0x00000000001c09bb
- (void)prepareFirstPhaseRecordBatch;	// IMP=0x00000000001c0814
- (_Bool)containsRecordInfo:(id)arg1;	// IMP=0x00000000001c06b0
- (id)initWithAppLibrary:(id)arg1;	// IMP=0x00000000001c0554
