...
@interface BRCImportObject : NSObject
{
    ...
    BRCAccountSessionFPFS *_session;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x000000000008c800
...
- (int)_resolveAgainstFileDescriptor:(int)arg1;	// IMP=0x000000000008ba94
- (id)initWithURL:(id)arg1 logicalName:(id)arg2 quarantineInfo:(id)arg3 parentItem:(id)arg4 error:(id *)arg5;	// IMP=0x000000000008b881
- (id)initAsNewDirectoryWithLogicalName:(id)arg1 parentItem:(id)arg2;	// IMP=0x000000000008b7c3
- (void)_resolveParentBasedPropertiesWithParent:(id)arg1 logicalName:(id)arg2;	// IMP=0x000000000008b3c2
- (id)initWithURL:(id)arg1 existingItem:(id)arg2 quarantineInfo:(id)arg3 error:(id *)arg4;	// IMP=0x000000000008afc3
- (id)initAsSymlinkWithTarget:(id)arg1 parentItem:(id)arg2 logicalName:(id)arg3 error:(id *)arg4;	// IMP=0x000000000008ae2c
...
- (_Bool)isFileWithFinderInfoAliasBit;	// IMP=0x000000000008ad97
...
- (id)initWithURL:(id)arg1 packageRoot:(id)arg2 error:(id *)arg3;	// IMP=0x000000000008c87b
