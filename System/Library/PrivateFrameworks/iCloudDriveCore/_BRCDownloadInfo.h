...
- (void).cxx_destruct;	// IMP=0x000000000015f17c
...
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000015f057
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x000000000015ed97
- (id)init;	// IMP=0x000000000015ece8
