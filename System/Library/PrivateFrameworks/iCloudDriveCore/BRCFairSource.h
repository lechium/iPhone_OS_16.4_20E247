...
- (void).cxx_destruct;	// IMP=0x00000000002248a9
@property(copy, nonatomic) CDUnknownBlockType eventHandler; // @synthesize eventHandler=_eventHandler;
@property(retain, nonatomic) NSObject<OS_dispatch_workloop> *workloop; // @synthesize workloop=_workloop;
- (void)resume;	// IMP=0x0000000000224756
- (void)suspend;	// IMP=0x0000000000224725
- (void)cancel;	// IMP=0x00000000002246f3
- (void)_runEventHandler;	// IMP=0x0000000000224665
- (void)signal;	// IMP=0x00000000002245fa
- (id)description;	// IMP=0x000000000022458b
- (id)initWithName:(id)arg1 scheduler:(id)arg2;	// IMP=0x00000000002244d8
