...
- (void).cxx_destruct;	// IMP=0x0000000000046491
...
- (void)associateWithCompletedOperation:(id)arg1;	// IMP=0x0000000000046377
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000004636f
- (id)additionalPayload;	// IMP=0x0000000000046362
- (id)subDescription;	// IMP=0x0000000000046355
- (double)duration;	// IMP=0x00000000000462d2
- (id)description;	// IMP=0x000000000004623e
- (id)initWithEventName:(id)arg1;	// IMP=0x00000000000461cf
