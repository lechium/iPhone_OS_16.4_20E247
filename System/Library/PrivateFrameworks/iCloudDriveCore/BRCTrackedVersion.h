...
+ (id)trackedVersionFor:(id)arg1 withEtagIfLoser:(id)arg2;	// IMP=0x001000000000b6c4
- (void).cxx_destruct;	// IMP=0x000000000000b860
...
- (unsigned long long)hash;	// IMP=0x000000000000b80d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b74d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b742
