...
- (void).cxx_destruct;	// IMP=0x000000000004c014
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x0000000000049acf
- (void)generateReportWithSession:(id)arg1;	// IMP=0x0000000000047b95
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x0000000000047ae1
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x00000000000477d5
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x0000000000047793
- (id)init;	// IMP=0x00000000000476d9
