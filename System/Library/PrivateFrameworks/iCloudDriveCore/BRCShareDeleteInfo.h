...
- (void).cxx_destruct;	// IMP=0x00000000002170f4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000217052
- (unsigned long long)hash;	// IMP=0x000000000021703c
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x0000000000216fa3
