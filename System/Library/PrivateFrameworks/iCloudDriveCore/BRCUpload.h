...
- (void).cxx_destruct;	// IMP=0x00000000000cb9c6
...
- (void)dealloc;	// IMP=0x00000000000cb900
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x00000000000cb771
- (id)description;	// IMP=0x00000000000cb744
