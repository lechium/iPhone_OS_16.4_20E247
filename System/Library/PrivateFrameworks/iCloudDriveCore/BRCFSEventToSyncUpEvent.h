...
- (void).cxx_destruct;	// IMP=0x00000000000467ee
...
- (id)associatedAppTelemetryEvent;	// IMP=0x00000000000466c9
- (id)subDescription;	// IMP=0x0000000000046611
- (id)additionalPayload;	// IMP=0x00000000000464cf
