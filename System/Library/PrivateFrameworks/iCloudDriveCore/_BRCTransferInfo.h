...
- (void).cxx_destruct;	// IMP=0x000000000015e64c
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x000000000015e55b
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000015e47d
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x00000000002ebde6
- (void)updateUnitCount;	// IMP=0x000000000015df31
- (id)description;	// IMP=0x000000000015dbe7
- (id)init;	// IMP=0x000000000015dacc
