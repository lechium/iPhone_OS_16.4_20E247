...
- (void).cxx_destruct;	// IMP=0x0000000000003507
...
- (_Bool)isAntiAliasedAtPointHelper:(struct VTKPoint)arg1 leftContext:(id)arg2 rightContext:(id)arg3;	// IMP=0x000000000000304b
- (_Bool)isAntiAliasedAtPoint:(struct VTKPoint)arg1;	// IMP=0x0000000000003031
- (id)initWithLeftContext:(id)arg1 rightContext:(id)arg2 strategy:(id)arg3;	// IMP=0x0000000000002f7a
