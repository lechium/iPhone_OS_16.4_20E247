...
- (void).cxx_destruct;	// IMP=0x0000000000006d69
...
- (void)assertView:(id)arg1 identifier:(id)arg2 filePath:(id)arg3 lineNumber:(unsigned long long)arg4;	// IMP=0x00000000000064a4
@property(readonly, nonatomic) NSArray *drawItems;
@property(readonly, nonatomic) NSString *referenceImagesDirectory;
- (id)initWithTestCase:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000006360
- (id)initWithTestCase:(id)arg1;	// IMP=0x00000000000062fc
