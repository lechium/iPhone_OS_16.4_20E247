...
+ (id)_comparatorForStrategy:(unsigned long long)arg1 comparisonOptions:(unsigned long long)arg2;	// IMP=0x0010000000003b02
+ (id)_referenceItemsSourceForType:(unsigned long long)arg1;	// IMP=0x00100000000039f6
- (void).cxx_destruct;	// IMP=0x0000000000004018
...
- (void)addExclusionAreaAt:(struct CGRect)arg1;	// IMP=0x0000000000003ee7
- (void)addSquareGuideAt:(struct CGRect)arg1 withColor:(id)arg2;	// IMP=0x0000000000003e59
- (void)addHorozontalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003dcd
- (void)addVerticalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003d44
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003837
- (id)initWithReferenceItemsSource:(id)arg1 storeManager:(id)arg2 imageComparator:(id)arg3;	// IMP=0x000000000000374d
- (id)init;	// IMP=0x0000000000003734
