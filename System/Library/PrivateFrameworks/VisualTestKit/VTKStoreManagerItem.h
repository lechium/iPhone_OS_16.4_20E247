...
+ (id)itemWithView:(id)arg1;	// IMP=0x0010000000002c7a
- (void).cxx_destruct;	// IMP=0x0000000000002f52
...
- (id)attachWithThestID:(id)arg1;	// IMP=0x0000000000002e51
- (id)fileNameWithTestID:(id)arg1;	// IMP=0x0000000000002dc0
- (id)initWithData:(id)arg1 itemType:(unsigned long long)arg2;	// IMP=0x0000000000002d30
