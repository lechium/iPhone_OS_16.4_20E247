...
+ (id)itemWithImage:(id)arg1 itemType:(unsigned long long)arg2;	// IMP=0x00100000000028bb
- (void).cxx_destruct;	// IMP=0x0000000000002c47
...
- (id)attachWithThestID:(id)arg1;	// IMP=0x0000000000002b34
- (id)fileNameWithTestID:(id)arg1;	// IMP=0x00000000000029e9
- (id)initWithData:(id)arg1 itemType:(unsigned long long)arg2;	// IMP=0x000000000000293f
