...
- (void).cxx_destruct;	// IMP=0x0000000000002d58
...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000002cc6
- (void)clearAllTransfers;	// IMP=0x0000000000002cb0
- (void)addTransfers:(id)arg1;	// IMP=0x0000000000002c9a
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x0000000000002bb8
