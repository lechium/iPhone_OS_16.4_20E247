...
- (void)layoutSubviews;	// IMP=0x0000000000001936
- (void)creatScene;	// IMP=0x00000000000010d3
- (id)initWithExtensionProcess:(id)arg1 sessionUUID:(id)arg2 role:(id)arg3;	// IMP=0x0000000000000fce
