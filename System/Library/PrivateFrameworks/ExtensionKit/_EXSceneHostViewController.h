...
- (void).cxx_destruct;	// IMP=0x0000000000001d21
...
- (void)loadView;	// IMP=0x0000000000001bdc
- (id)initWithExtensionProcess:(id)arg1 sessionUUID:(id)arg2 role:(id)arg3;	// IMP=0x0000000000001b16
