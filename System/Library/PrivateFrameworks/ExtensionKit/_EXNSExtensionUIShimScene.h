...
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x000000000000844c
- (void)connectToSession:(id)arg1;	// IMP=0x00000000000082aa
- (id)makePrincipalObjectForExtension:(id)arg1;	// IMP=0x00000000000081ad
