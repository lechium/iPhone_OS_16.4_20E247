...
- (unsigned long long)countOfNotesWithCollaborationStatus:(long long)arg1 collaborationType:(long long)arg2;	// IMP=0x000000000000ad3a
- (unsigned long long)countOfNotesWithFactor:(long long)arg1 andFactor:(long long)arg2;	// IMP=0x000000000000acf0
- (void)completeTwoFactorMatrixReportingForCurrentNote;	// IMP=0x000000000000ac9f
- (void)updateNoteCollaborationMatrixWithCollaborationStatus:(id)arg1 collaborationType:(id)arg2;	// IMP=0x000000000000abee
- (void)updateNoteTwoFactorMatrixWithIndex:(long long)arg1;	// IMP=0x000000000000ab74
- (id)init;	// IMP=0x000000000000ab25
