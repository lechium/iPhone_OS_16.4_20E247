...
- (id)accountTypeSummary;	// IMP=0x000000000000b9ed
- (void)reportAccountType:(long long)arg1 noteCount:(unsigned long long)arg2;	// IMP=0x000000000000b793
- (id)init;	// IMP=0x000000000000b71e
