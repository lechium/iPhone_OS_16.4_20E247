...
- (void).cxx_destruct;	// IMP=0x000000000034b6aa
...
- (id)_componentWithContext:(id)arg1;	// IMP=0x000000000034b56e
- (void)_setChildComponents:(id)arg1 forIndex:(long long)arg2;	// IMP=0x000000000034b548
- (long long)componentType;	// IMP=0x000000000034b53d
- (id)titleForIndex:(long long)arg1;	// IMP=0x000000000034b520
- (id)sortURLForIndex:(long long)arg1;	// IMP=0x000000000034b4b7
@property(readonly, nonatomic) long long numberOfItems;
- (id)childComponentsForIndex:(long long)arg1;	// IMP=0x000000000034b43d
@property(readonly, nonatomic) NSArray *allTitles;
- (id)initWithViewElement:(id)arg1;	// IMP=0x000000000034b355
- (id)initWithRoomSortData:(id)arg1;	// IMP=0x000000000034af06
- (id)initWithCustomPageContext:(id)arg1;	// IMP=0x000000000034a671
