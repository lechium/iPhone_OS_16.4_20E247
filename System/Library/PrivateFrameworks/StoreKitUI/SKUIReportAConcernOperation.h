...
- (void).cxx_destruct;	// IMP=0x00000000002b928b
...
- (id)_httpBody;	// IMP=0x00000000002b8ff3
- (void)run;	// IMP=0x00000000002b8d79
- (id)initWithMetadata:(id)arg1;	// IMP=0x00000000002b8d0b
