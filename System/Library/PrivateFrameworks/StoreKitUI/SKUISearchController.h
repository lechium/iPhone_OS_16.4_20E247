...
- (void).cxx_destruct;	// IMP=0x0000000000284f0c
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000284e5a
@property(readonly, nonatomic) SKUISearchBar *searchBar;
- (void)setActive:(_Bool)arg1;	// IMP=0x0000000000284b8a
- (void)_setSuffix:(id)arg1;	// IMP=0x000000000028425b
