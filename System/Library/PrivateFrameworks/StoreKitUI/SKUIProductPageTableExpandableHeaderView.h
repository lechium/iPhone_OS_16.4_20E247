...
- (void).cxx_destruct;	// IMP=0x00000000001e3308
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001e32e9
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001e325b
- (void)layoutSubviews;	// IMP=0x00000000001e2f41
