...
- (void).cxx_destruct;	// IMP=0x00000000000807b8
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000000802c2
- (id)accessibilityText;	// IMP=0x0000000000080246
@property(readonly, nonatomic) long long badgeType;
@property(readonly, nonatomic) NSAttributedString *attributedString;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000007fd1a
