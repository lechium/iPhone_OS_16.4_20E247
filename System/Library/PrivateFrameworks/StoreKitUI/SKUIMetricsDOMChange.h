...
- (id)description;	// IMP=0x00000000001a2421
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a22ba
- (unsigned long long)hash;	// IMP=0x00000000001a21b1
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a1f46
- (id)initWithReportDomBuildTimesMessagePayload:(id)arg1;	// IMP=0x00000000001a1de1
