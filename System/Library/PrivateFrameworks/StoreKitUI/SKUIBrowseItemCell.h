...
- (void).cxx_destruct;	// IMP=0x0000000000027dbe
...
- (void)_reloadHighlightState;	// IMP=0x0000000000027ab6
- (void)layoutSubviews;	// IMP=0x000000000002752c
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000000274eb
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000274aa
@property(retain, nonatomic) NSString *subtitle;
@property(retain, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000026ee3
