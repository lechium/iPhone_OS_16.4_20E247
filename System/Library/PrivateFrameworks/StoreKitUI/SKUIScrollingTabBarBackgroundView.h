...
- (void).cxx_destruct;	// IMP=0x00000000001a6df1
...
- (void)_updateTopHairlineColor;	// IMP=0x00000000001a6d1b
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001a6855
- (void)layoutSubviews;	// IMP=0x00000000001a65df
