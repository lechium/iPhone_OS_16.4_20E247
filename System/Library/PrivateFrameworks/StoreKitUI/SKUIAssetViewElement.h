...
- (void).cxx_destruct;	// IMP=0x0000000000356a31
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000356802
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000356487
