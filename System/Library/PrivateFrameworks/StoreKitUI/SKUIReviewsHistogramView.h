...
- (void).cxx_destruct;	// IMP=0x00000000001fea50
...
- (id)_countLabelString;	// IMP=0x00000000001fe725
- (id)_histogramImageForValues:(id)arg1;	// IMP=0x00000000001fdd51
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001fdbf0
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001fdb3a
- (void)layoutSubviews;	// IMP=0x00000000001fd174
...
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001fba7d
