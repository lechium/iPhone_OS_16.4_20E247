...
- (void).cxx_destruct;	// IMP=0x000000000022e36a
...
- (_Bool)isEnabled;	// IMP=0x000000000022e2f3
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000022e217
@property(readonly, nonatomic) SKUIImageViewElement *thumbnailImage; // @synthesize thumbnailImage=_thumbnailImage;
@property(readonly, nonatomic) NSArray *assets;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000022dc7c
