...
+ (id)supportedFeatures;	// IMP=0x00600000001171f8
- (void).cxx_destruct;	// IMP=0x00000000001174ff
@property(readonly, nonatomic) long long preferredDisplayMode; // @synthesize preferredDisplayMode=_preferredDisplayMode;
- (id)_splitElementForIndex:(long long)arg1;	// IMP=0x00000000001172f2
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000011726a
...
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000116f44
