...
- (void).cxx_destruct;	// IMP=0x00000000000b7467
...
- (void)prepareLayout;	// IMP=0x00000000000b7297
- (id)layoutAttributesForDecorationViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x00000000000b6f77
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000000000b6c90
- (id)init;	// IMP=0x00000000000b6c00
