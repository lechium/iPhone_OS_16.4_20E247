...
- (void).cxx_destruct;	// IMP=0x00000000001ba032
...
- (void)_setDocument:(id)arg1;	// IMP=0x00000000001b9d71
- (id)initWithDocument:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x00000000001b9cd4
- (id)init;	// IMP=0x00000000001b9cbe
