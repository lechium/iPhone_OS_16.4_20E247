...
- (void).cxx_destruct;	// IMP=0x0000000000264993
...
- (void)_reloadFonts;	// IMP=0x0000000000264877
- (id)_newLinkButtonWithTitle:(id)arg1;	// IMP=0x00000000002647cf
- (void)_layoutTwoRows;	// IMP=0x00000000002642c5
- (void)_layoutOneRow;	// IMP=0x0000000000263c13
- (void)tintColorDidChange;	// IMP=0x0000000000263b7e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002639dd
- (void)layoutSubviews;	// IMP=0x0000000000263984
...
- (_Bool)isRedeemHidden;	// IMP=0x0000000000263692
- (_Bool)isEcommerceHidden;	// IMP=0x0000000000263619
@property(copy, nonatomic) NSString *ECommerceLinkTitle;
- (void)dealloc;	// IMP=0x00000000002634ad
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000263157
