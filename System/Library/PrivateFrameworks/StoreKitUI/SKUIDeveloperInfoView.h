...
- (void).cxx_destruct;	// IMP=0x000000000005ef4c
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005ed97
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000005ec02
- (void)layoutSubviews;	// IMP=0x000000000005e885
- (id)initWithDeveloperInfo:(id)arg1 clientContext:(id)arg2;	// IMP=0x000000000005de39
