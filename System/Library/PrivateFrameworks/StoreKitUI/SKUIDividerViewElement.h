...
- (void).cxx_destruct;	// IMP=0x000000000022865a
...
- (long long)pageComponentType;	// IMP=0x000000000022852d
- (_Bool)isEnabled;	// IMP=0x0000000000228518
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000022842f
