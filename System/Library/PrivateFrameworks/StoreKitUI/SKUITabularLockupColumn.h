...
- (void).cxx_destruct;	// IMP=0x00000000002d8681
...
- (id)description;	// IMP=0x00000000002d8583
- (void)_addChildViewElement:(id)arg1;	// IMP=0x00000000002d856d
- (id)initWithColumnIdentifier:(long long)arg1;	// IMP=0x00000000002d850c
