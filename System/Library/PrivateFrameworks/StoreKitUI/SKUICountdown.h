...
- (void).cxx_destruct;	// IMP=0x000000000022b9ce
...
- (_Bool)isLoaded;	// IMP=0x000000000022b845
- (void)updateWithDictionary:(id)arg1;	// IMP=0x000000000022b61a
- (id)initWithCountdownDictionary:(id)arg1;	// IMP=0x000000000022ad4e
