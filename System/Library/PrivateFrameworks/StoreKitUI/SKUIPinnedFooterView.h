...
- (void).cxx_destruct;	// IMP=0x0000000000028c46
...
- (void)_initializeTextView;	// IMP=0x0000000000028a4f
- (void)_configureTextViewTextStyling;	// IMP=0x0000000000028947
- (void)layoutSubviews;	// IMP=0x000000000002875d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000028700
