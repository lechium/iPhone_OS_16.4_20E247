...
- (void).cxx_destruct;	// IMP=0x00000000001e9e20
...
- (void)_setTitles:(id)arg1 forSegmentedControl:(id)arg2;	// IMP=0x00000000001e9cc7
- (void)_configureSegmentedControl:(id)arg1 withTitles:(id)arg2 boundingSize:(struct CGSize)arg3;	// IMP=0x00000000001e989d
- (void)_valueChangeAction:(id)arg1;	// IMP=0x00000000001e971a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001e9663
- (void)layoutSubviews;	// IMP=0x00000000001e947f
...
- (struct CGRect)frameForSegmentWithIndex:(long long)arg1;	// IMP=0x00000000001e911e
- (void)cancelMoreList;	// IMP=0x00000000001e90e3
- (void)dealloc;	// IMP=0x00000000001e908f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e8f9e
