...
- (void).cxx_destruct;	// IMP=0x000000000020e3d2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020e2f6
- (id)initWithURL:(id)arg1 likeStatusDictionary:(id)arg2;	// IMP=0x000000000020dfde
