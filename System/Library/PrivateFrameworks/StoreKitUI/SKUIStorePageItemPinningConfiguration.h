...
- (void)invalidatePinningTransitionStyle;	// IMP=0x00000000002af6fa
- (void)invalidatePinningGroup;	// IMP=0x00000000002af6e8
- (void)invalidatePinningStyle;	// IMP=0x00000000002af6d6
- (void)invalidatePinningContentInset;	// IMP=0x00000000002af6b6
