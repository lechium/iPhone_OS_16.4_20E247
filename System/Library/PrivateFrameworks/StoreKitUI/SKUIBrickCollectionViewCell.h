...
- (void).cxx_destruct;	// IMP=0x0000000000138e28
...
- (void)_removeOverlay;	// IMP=0x0000000000138d57
- (void)_reloadHighlight;	// IMP=0x0000000000138ae3
- (void)layoutSubviews;	// IMP=0x0000000000138980
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001388f2
@property(copy, nonatomic) NSString *title;
@property(retain, nonatomic) UIImage *itemImage;
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000013844f
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000013840e
@property(retain, nonatomic) SKUICountdown *countdown;
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x0000000000138251
