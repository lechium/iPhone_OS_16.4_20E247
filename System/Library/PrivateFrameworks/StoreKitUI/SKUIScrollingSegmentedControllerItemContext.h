...
- (void).cxx_destruct;	// IMP=0x000000000032e14d
...
- (void)_applyNewContentInset:(struct UIEdgeInsets)arg1 withOldContentInset:(struct UIEdgeInsets)arg2 toContentScrollView:(id)arg3;	// IMP=0x000000000032df0e
- (void)updateAppliedContentInsetsAdjustment;	// IMP=0x000000000032ddce
- (void)applyNewContentInset:(struct UIEdgeInsets)arg1;	// IMP=0x000000000032dd7e
- (id)initWithViewController:(id)arg1;	// IMP=0x000000000032dd01
- (id)init;	// IMP=0x000000000032dced
