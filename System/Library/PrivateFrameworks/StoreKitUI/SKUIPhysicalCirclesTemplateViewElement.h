...
+ (id)supportedFeatures;	// IMP=0x00600000001612f9
- (void).cxx_destruct;	// IMP=0x0000000000161371
...
- (void)dispatchRemovedEventWithChildViewElement:(id)arg1;	// IMP=0x0000000000160d27
@property(readonly, nonatomic) NSArray *circleItemElements;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000160bcd
