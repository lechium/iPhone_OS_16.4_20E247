...
- (long long)pageComponentType;	// IMP=0x000000000034275e
- (_Bool)isDisabled;	// IMP=0x0000000000342756
@property(readonly, nonatomic) SKUILabelViewElement *text;
@property(readonly, nonatomic) double period;
@property(readonly, nonatomic) SKUIImageViewElement *image;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000342647
