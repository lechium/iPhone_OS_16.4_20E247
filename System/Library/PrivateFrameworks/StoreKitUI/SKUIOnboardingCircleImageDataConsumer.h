...
- (void).cxx_destruct;	// IMP=0x00000000001a65cc
...
- (id)_saturationBackgroundImageWithSize:(struct CGSize)arg1;	// IMP=0x00000000001a6468
- (id)imageForImage:(id)arg1;	// IMP=0x00000000001a602e
