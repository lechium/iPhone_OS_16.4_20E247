...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000fcf01
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000fd234
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000fcf09
- (id)init;	// IMP=0x00000000000fcead
