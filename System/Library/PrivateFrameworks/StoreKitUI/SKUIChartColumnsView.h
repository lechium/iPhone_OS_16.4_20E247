...
- (void).cxx_destruct;	// IMP=0x00000000002b4f0a
...
- (void)_reloadColumnViews;	// IMP=0x00000000002b43c0
- (id)_headerViewWithViewControllers:(id)arg1;	// IMP=0x00000000002b416e
- (void)segmentedControl:(id)arg1 didSelectSegmentIndex:(long long)arg2;	// IMP=0x00000000002b4117
- (void)_headerViewAction:(id)arg1;	// IMP=0x00000000002b4071
- (void)layoutSubviews;	// IMP=0x00000000002b3922
- (void)endColumnChangeAnimation;	// IMP=0x00000000002b37c6
- (void)beginColumnChangeAnimationToNumberOfVisibleColumns:(long long)arg1;	// IMP=0x00000000002b3750
- (void)dealloc;	// IMP=0x00000000002b3705
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002b346b
