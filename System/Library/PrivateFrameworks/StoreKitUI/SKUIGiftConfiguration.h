...
- (void).cxx_destruct;	// IMP=0x00000000002f208a
...
- (void)_setLogoImage:(id)arg1 forCharity:(id)arg2;	// IMP=0x00000000002f1dca
- (void)_setHeaderImage:(id)arg1 forTheme:(id)arg2;	// IMP=0x00000000002f1bc3
- (void)_loadThemeImages;	// IMP=0x00000000002f176a
- (void)_finishLoadAccountInfoWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002f15a8
- (void)_finishLoadWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002f04c7
- (void)removeObserver:(id)arg1;	// IMP=0x00000000002f048f
- (id)logoImageForCharity:(id)arg1;	// IMP=0x00000000002f042c
- (void)loadLogoForCharity:(id)arg1;	// IMP=0x00000000002f0107
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002efcd3
- (_Bool)loadCachedConfiguration;	// IMP=0x00000000002efccb
- (id)charityForIdentifier:(id)arg1;	// IMP=0x00000000002efb06
- (void)addObserver:(id)arg1;	// IMP=0x00000000002efa5f
- (id)initWithOperationQueue:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000002ef9c6
