...
- (void).cxx_destruct;	// IMP=0x0000000000118f96
...
- (id)_viewForSettingDescription:(id)arg1;	// IMP=0x0000000000118e94
- (void)_reloadSettingDescription:(id)arg1;	// IMP=0x0000000000118e06
- (void)attachSettingDescription:(id)arg1;	// IMP=0x0000000000118d74
