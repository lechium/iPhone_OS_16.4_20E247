...
- (void).cxx_destruct;	// IMP=0x000000000016466b
@property(readonly, nonatomic) SKUILockupSwooshCellLayout *layout; // @synthesize layout=_layout;
- (void)configureForItem:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000001643c1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000164324
