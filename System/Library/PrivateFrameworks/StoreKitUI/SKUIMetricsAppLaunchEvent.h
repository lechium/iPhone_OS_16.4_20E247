...
+ (double)processStartTime;	// IMP=0x00100000002b1a85
+ (id)consumePendingLaunchEvent;	// IMP=0x00100000002b1a42
+ (void)withPendingLaunchEvent:(CDUnknownBlockType)arg1;	// IMP=0x00100000002b1a26
+ (void)createPendingLaunchEvent;	// IMP=0x00100000002b19ec
+ (void)resetPendingLaunchEventForTesting;	// IMP=0x00100000002b19c8
- (void).cxx_destruct;	// IMP=0x00000000002b3458
@property(readonly, copy, nonatomic) NSDictionary *templateMetrics; // @synthesize templateMetrics=_templateMetrics;
- (void)populateObjectInspector:(id)arg1;	// IMP=0x00000000002b2c14
@property(readonly, copy) NSString *description;
- (void)appendPropertiesToBody:(id)arg1;	// IMP=0x00000000002b258b
...
- (void)addTemplateLoadTimingMetric:(id)arg1 forURL:(id)arg2;	// IMP=0x00000000002b1d90
...
- (id)init;	// IMP=0x00000000002b18d4
