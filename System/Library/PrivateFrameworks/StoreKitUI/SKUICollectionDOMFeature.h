...
+ (id)featureName;	// IMP=0x00100000000cc097
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x00100000000cc000
- (void).cxx_destruct;	// IMP=0x00000000000cc225
...
- (void)setEditing:(_Bool)arg1 options:(id)arg2;	// IMP=0x00000000000cc0a4
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000cbf30
