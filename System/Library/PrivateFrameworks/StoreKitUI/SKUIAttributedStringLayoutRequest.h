...
- (void).cxx_destruct;	// IMP=0x00000000002d7889
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d77d2
- (id)initWithAttributedString:(id)arg1;	// IMP=0x00000000002d775f
