...
- (void).cxx_destruct;	// IMP=0x0000000000204b15
@property(readonly, nonatomic) long long giftType; // @synthesize giftType=_giftType;
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000204a2e
@property(readonly, nonatomic) SKUIItem *productItem;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000203e68
