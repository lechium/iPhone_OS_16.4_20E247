...
- (void).cxx_destruct;	// IMP=0x0000000000209103
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000208f27
- (unsigned long long)hash;	// IMP=0x0000000000208e6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000208daa
