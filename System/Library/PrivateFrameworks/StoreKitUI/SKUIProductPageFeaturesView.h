...
- (void).cxx_destruct;	// IMP=0x00000000001b4b20
...
- (id)_gameCenterStringWithFeatures:(unsigned long long)arg1;	// IMP=0x00000000001b438d
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b415a
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b3fbc
- (void)layoutSubviews;	// IMP=0x00000000001b3b33
@property(copy, nonatomic) NSString *title;
- (void)setFeatures:(long long)arg1 gameCenterFeatures:(unsigned long long)arg2;	// IMP=0x00000000001b3206
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b30c0
