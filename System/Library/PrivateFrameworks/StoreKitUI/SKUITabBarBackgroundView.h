...
- (void).cxx_destruct;	// IMP=0x000000000033b1e5
...
- (void)updateBackgroundImage;	// IMP=0x000000000033b0fd
- (void)_setIsContainedInPopover:(_Bool)arg1;	// IMP=0x000000000033b0f7
- (void)_setFrame:(struct CGRect)arg1 forceUpdateBackgroundImage:(_Bool)arg2;	// IMP=0x000000000033b0e5
- (id)_currentCustomBackgroundRespectOversize_legacy:(_Bool *)arg1;	// IMP=0x000000000033b0dd
- (id)_currentCustomBackground;	// IMP=0x000000000033b0d5
- (void)layoutSubviews;	// IMP=0x000000000033afbc
@property(copy, nonatomic) NSString *backdropGroupName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000033ad41
