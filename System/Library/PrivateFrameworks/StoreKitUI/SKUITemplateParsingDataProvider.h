...
+ (id)templateParsingRegularExpression;	// IMP=0x00600000002072cd
- (void).cxx_destruct;	// IMP=0x000000000020795f
@property(readonly, nonatomic) NSRegularExpression *regularExpression; // @synthesize regularExpression=_regularExpression;
- (id)objectForData:(id)arg1 response:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000207383
- (id)initWithRegularExpression:(id)arg1;	// IMP=0x0000000000207315
