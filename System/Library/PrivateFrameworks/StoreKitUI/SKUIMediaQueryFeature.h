...
+ (_Bool)supportsFeatureName:(id)arg1;	// IMP=0x006000000020dfa4
- (void).cxx_destruct;	// IMP=0x000000000020dfce
...
- (_Bool)evaluateWithValues:(id)arg1;	// IMP=0x000000000020dfac
- (id)initWithFeatureName:(id)arg1 value:(id)arg2;	// IMP=0x000000000020df31
