...
- (void).cxx_destruct;	// IMP=0x0000000000382337
...
- (id)getResponseHeader:(id)arg1;	// IMP=0x00000000003820b8
- (id)getAllResponseHeaders;	// IMP=0x0000000000381fcb
- (id)initWithAppContext:(id)arg1 data:(id)arg2 URLResponse:(id)arg3 performanceMetrics:(id)arg4;	// IMP=0x0000000000381ef4
