...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b27b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b215
- (unsigned long long)hash;	// IMP=0x000000000001b1fd
- (id)initWithNavigationControllerOperation:(long long)arg1 operationDidComplete:(_Bool)arg2;	// IMP=0x000000000001b1b5
