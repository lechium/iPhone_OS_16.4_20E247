...
- (void).cxx_destruct;	// IMP=0x000000000020aa61
...
- (void)_reloadView;	// IMP=0x000000000020a880
- (void)_setTrendingResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000020a82a
- (void)_reloadData;	// IMP=0x000000000020a652
- (void)layoutSubviews;	// IMP=0x000000000020a5c2
