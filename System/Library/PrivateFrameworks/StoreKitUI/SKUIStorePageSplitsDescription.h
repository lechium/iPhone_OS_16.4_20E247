...
- (void).cxx_destruct;	// IMP=0x000000000020b171
...
- (id)description;	// IMP=0x000000000020b079
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020afeb
- (void)sizeSplitsToFitWidth:(double)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000020ad60
@property(readonly, nonatomic) long long numberOfSplits;
@property(readonly, nonatomic) SKUIStorePageSplit *firstSplit;
- (void)enumerateSplitsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000020aab2
