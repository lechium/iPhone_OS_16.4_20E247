...
- (void).cxx_destruct;	// IMP=0x000000000009184d
...
- (id)_newLabel;	// IMP=0x00000000000916f1
- (id)_labelForDate:(id)arg1;	// IMP=0x000000000009159a
- (id)_labelColor;	// IMP=0x000000000009155b
- (void)_datePickerEditingDidBegin;	// IMP=0x00000000000914bf
- (void)_datePickerDateDidChange;	// IMP=0x000000000009140e
- (void)layoutSubviews;	// IMP=0x0000000000090dc6
@property(copy, nonatomic) NSString *placeholder;
@property(copy, nonatomic) NSString *label;
@property(retain, nonatomic) NSDate *date;
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000903de
