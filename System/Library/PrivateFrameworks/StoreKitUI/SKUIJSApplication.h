...
- (void).cxx_destruct;	// IMP=0x00000000001652b1
...
- (void)sendDocumentMessage:(id)arg1:(id)arg2:(id)arg3;	// IMP=0x0000000000164f9a
- (void)launchComplete:(id)arg1;	// IMP=0x0000000000164f1e
- (void)launchFailed;	// IMP=0x0000000000164ed5
@property(readonly, nonatomic) _Bool pageRenderMetricsEnabled;
- (id)initWithAppContext:(id)arg1 applicationController:(id)arg2;	// IMP=0x0000000000164d49
