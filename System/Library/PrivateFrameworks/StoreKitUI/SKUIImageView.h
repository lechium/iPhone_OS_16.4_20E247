...
+ (Class)layerClass;	// IMP=0x0060000000128929
- (void).cxx_destruct;	// IMP=0x00000000001291d2
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000129085
- (void)layoutSubviews;	// IMP=0x0000000000128ede
- (void)setContents:(id)arg1;	// IMP=0x0000000000128e42
