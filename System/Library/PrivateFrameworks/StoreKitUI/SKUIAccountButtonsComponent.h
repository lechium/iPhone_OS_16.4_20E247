...
- (void).cxx_destruct;	// IMP=0x000000000029fd64
...
- (long long)componentType;	// IMP=0x000000000029fd14
- (id)initWithViewElement:(id)arg1;	// IMP=0x000000000029fce5
- (id)initWithFeaturedContentContext:(id)arg1 kind:(long long)arg2;	// IMP=0x000000000029fbd7
- (id)initWithCustomPageContext:(id)arg1;	// IMP=0x000000000029faf7
