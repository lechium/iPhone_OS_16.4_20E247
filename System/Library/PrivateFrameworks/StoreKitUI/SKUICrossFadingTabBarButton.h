...
- (void).cxx_destruct;	// IMP=0x0000000000307282
...
- (void)_positionBadge;	// IMP=0x0000000000307032
- (void)_setBadgeValue:(id)arg1;	// IMP=0x0000000000306e77
- (void)tintColorDidChange;	// IMP=0x0000000000306a8b
- (void)layoutSubviews;	// IMP=0x0000000000306700
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003063d1
