...
- (void).cxx_destruct;	// IMP=0x00000000000ac2fb
- (id)_termsButton;	// IMP=0x00000000000ac057
- (id)_newLightLabelWithSize:(double)arg1 alpha:(double)arg2;	// IMP=0x00000000000abf3d
- (id)_newBoldLabelWithSize:(double)arg1;	// IMP=0x00000000000abe4f
- (void)layoutSubviews;	// IMP=0x00000000000aa5df
@property(readonly, nonatomic) UIButton *termsButton;
- (id)initWithGift:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000a9254
