...
+ (id)sharedCenter;	// IMP=0x00100000002b0243
- (void).cxx_destruct;	// IMP=0x00000000002b0cb3
...
- (void)statusBarAlertViewControllerWasTapped:(id)arg1;	// IMP=0x00000000002b0bf0
- (void)dismiss;	// IMP=0x00000000002b0a59
- (void)scheduleDismiss;	// IMP=0x00000000002b0a16
- (void)unscheduleDismiss;	// IMP=0x00000000002b09f0
- (void)showMessage:(id)arg1 withStyle:(long long)arg2 forDuration:(double)arg3 actionBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000002b04c6
@property(readonly, copy, nonatomic) NSString *message;
@property(nonatomic, getter=isVisible) _Bool visible;
- (id)init;	// IMP=0x00000000002b0298
