...
- (void).cxx_destruct;	// IMP=0x000000000000b7ff
...
- (id)imageForImage:(id)arg1;	// IMP=0x000000000000b4d7
- (id)imageForColor:(id)arg1 orientation:(unsigned long long)arg2;	// IMP=0x000000000000b309
