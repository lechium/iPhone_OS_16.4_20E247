...
- (void).cxx_destruct;	// IMP=0x0000000000301310
...
- (void)layoutSubviews;	// IMP=0x0000000000300cf1
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000300c3d
@property(nonatomic) double progress;
@property(retain, nonatomic) UIImage *image;
- (id)init;	// IMP=0x00000000003003f3
