...
- (void).cxx_destruct;	// IMP=0x00000000001d29dc
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001d28d9
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001d27d2
