...
- (void).cxx_destruct;	// IMP=0x0000000000287c3b
...
- (id)_resourceImageForImageElement:(id)arg1;	// IMP=0x0000000000287abf
- (id)contextActions;	// IMP=0x0000000000287723
- (id)initWithDialogTemplate:(id)arg1;	// IMP=0x00000000002876b8
