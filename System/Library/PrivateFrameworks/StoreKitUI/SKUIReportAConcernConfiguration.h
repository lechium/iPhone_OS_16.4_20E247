...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x00100000002c6955
- (void).cxx_destruct;	// IMP=0x00000000002c703d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002c6e21
