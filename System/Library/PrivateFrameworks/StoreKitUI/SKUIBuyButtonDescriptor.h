...
- (void).cxx_destruct;	// IMP=0x0000000000313a46
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x000000000031392a
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x00000000003137f0
