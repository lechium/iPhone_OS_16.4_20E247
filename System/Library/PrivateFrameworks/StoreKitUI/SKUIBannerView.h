...
- (void).cxx_destruct;	// IMP=0x0000000000059f98
...
- (void)_reloadItemState;	// IMP=0x0000000000059a6c
- (id)_newDefaultLabel;	// IMP=0x000000000005999b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005992e
- (void)layoutSubviews;	// IMP=0x00000000000584a5
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000005837a
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000057452
