...
- (void).cxx_destruct;	// IMP=0x00000000002b7574
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000002b7489
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000002b71e4
