...
- (void).cxx_destruct;	// IMP=0x00000000000e1559
- (void)run;	// IMP=0x00000000000e121d
@property(readonly) NSDictionary *responseDictionary;
- (id)initWithRating:(long long)arg1 forItemID:(id)arg2 reviewConfiguration:(id)arg3;	// IMP=0x00000000000e1126
