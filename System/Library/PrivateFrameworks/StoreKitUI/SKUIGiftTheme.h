...
- (void).cxx_destruct;	// IMP=0x00000000000a7c15
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a7a7e
- (id)description;	// IMP=0x00000000000a79ec
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x00000000000a76f7
