...
- (void).cxx_destruct;	// IMP=0x00000000002e4822
@property(nonatomic) long long spacingStyle; // @synthesize spacingStyle=_spacingStyle;
@property(readonly, nonatomic) UIButton *button; // @synthesize button=_button;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002e451e
- (void)layoutSubviews;	// IMP=0x00000000002e3ed7
@property(retain, nonatomic) UIImage *image;
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000002e3758
