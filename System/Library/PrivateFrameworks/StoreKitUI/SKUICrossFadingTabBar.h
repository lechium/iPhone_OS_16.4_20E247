...
- (void).cxx_destruct;	// IMP=0x000000000020ff20
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000020fb08
- (void)layoutSubviews;	// IMP=0x000000000020f82a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020f732
