...
- (void).cxx_destruct;	// IMP=0x00000000002a34f7
...
- (void)_reloadSize;	// IMP=0x00000000002a31b0
- (void)_reloadPageControl;	// IMP=0x00000000002a313d
- (void)_setImage:(id)arg1 atIndex:(long long)arg2;	// IMP=0x00000000002a306e
- (id)_placeholderImageAtIndex:(long long)arg1;	// IMP=0x00000000002a2c1e
- (id)_imageAtIndex:(long long)arg1;	// IMP=0x00000000002a2b84
- (void)_doneAction:(id)arg1;	// IMP=0x00000000002a2b0e
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x00000000002a2a30
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x00000000002a2a13
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000002a2a01
@property(nonatomic) long long currentIndex;
- (void)reloadData;	// IMP=0x00000000002a218e
- (void)viewDidLayoutSubviews;	// IMP=0x00000000002a208d
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x00000000002a2054
- (void)loadView;	// IMP=0x00000000002a1769
- (void)dealloc;	// IMP=0x00000000002a15dd
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000002a149f
