...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000adf1c
- (id)description;	// IMP=0x00000000000ade91
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000adc94
