...
- (void).cxx_destruct;	// IMP=0x00000000002ebe0b
...
- (id)_itemsWithDictionary:(id)arg1;	// IMP=0x00000000002eba58
- (id)objectForData:(id)arg1 response:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002eb98c
