...
- (void).cxx_destruct;	// IMP=0x00000000002a825e
...
- (void)_requestItems:(id)arg1 withReason:(long long)arg2;	// IMP=0x00000000002a80e6
- (id)_existingRequestIDForItemID:(id)arg1;	// IMP=0x00000000002a7f3c
- (void)itemRequest:(id)arg1 didFinishWithItems:(id)arg2 invalidItemIdentifiers:(id)arg3;	// IMP=0x00000000002a7e49
- (void)loadItemsWithIdentifiers:(id)arg1 reason:(long long)arg2;	// IMP=0x00000000002a7b2d
- (void)loadItemsForPageComponent:(id)arg1 startIndex:(long long)arg2 reason:(long long)arg3;	// IMP=0x00000000002a79f7
- (id)initWithResourceLoader:(id)arg1;	// IMP=0x00000000002a7957
- (id)init;	// IMP=0x00000000002a7943
