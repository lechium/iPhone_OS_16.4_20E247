...
- (void).cxx_destruct;	// IMP=0x000000000001b17a
- (struct __CTServerConnection *)_telephonyServer;	// IMP=0x000000000001af61
- (void)sendSMSWithBodyText:(id)arg1:(id)arg2:(id)arg3;	// IMP=0x000000000001ae47
...
- (id)formattedPhoneNumber:(id)arg1;	// IMP=0x000000000001abc8
@property(readonly, nonatomic) NSString *countryCode;
- (void)beginObserving;	// IMP=0x000000000001aad9
- (void)dealloc;	// IMP=0x000000000001a9fe
- (id)initWithAppContext:(id)arg1;	// IMP=0x000000000001a99f
