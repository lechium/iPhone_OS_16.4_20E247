...
- (void).cxx_destruct;	// IMP=0x00000000001c47c5
@property(nonatomic) struct UIEdgeInsets contentInsets; // @synthesize contentInsets=_contentInsets;
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001c4770
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001c476a
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001c46c8
- (void)layoutSubviews;	// IMP=0x00000000001c436a
