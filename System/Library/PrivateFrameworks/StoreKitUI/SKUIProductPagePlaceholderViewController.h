...
- (void).cxx_destruct;	// IMP=0x00000000001dd227
...
- (void)_addHeaderView;	// IMP=0x00000000001dcfa7
@property(readonly, nonatomic) UIScrollView *scrollView;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000001dca1e
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000001dc9d5
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000001dc98c
- (void)loadView;	// IMP=0x00000000001dc931
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001dc8ed
