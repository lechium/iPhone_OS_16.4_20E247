...
- (void)layoutSubviews;	// IMP=0x00000000001edb90
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001eda88
- (id)description;	// IMP=0x00000000001ed9d1
@property(readonly, nonatomic) UILabel *titleLabel;
- (void)setBackgroundImageAlpha:(double)arg1;	// IMP=0x00000000001ed771
- (void)setBackgroundImage:(id)arg1;	// IMP=0x00000000001ed6d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001ed5ec
