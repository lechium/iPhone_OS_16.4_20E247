...
- (void).cxx_destruct;	// IMP=0x00000000000b7db8
...
- (void)_finishImageLoadWithImage:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b7cde
- (void)loadItemArtworkWithArtworkContext:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b792f
@property(readonly, nonatomic) SKUIGift *gift; // @synthesize gift=_gift;
- (void)finishGiftingWithResult:(_Bool)arg1;	// IMP=0x00000000000b780d
- (id)initWithGift:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000b775f
