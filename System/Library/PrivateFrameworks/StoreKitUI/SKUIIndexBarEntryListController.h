...
+ (id)entryListControllerForEntryListViewElement:(id)arg1;	// IMP=0x006000000031677f
+ (id)entryListControllerForEntryViewElement:(id)arg1;	// IMP=0x0060000000316732
- (void).cxx_destruct;	// IMP=0x00000000003168da
...
- (void)_didInvalidate;	// IMP=0x0000000000316815
- (id)targetIndexBarEntryIDForEntryDescriptorAtIndex:(long long)arg1 returningRelativeSectionIndex:(out long long *)arg2;	// IMP=0x000000000031680d
- (void)reloadViewElementData;	// IMP=0x0000000000316807
- (id)entryDescriptorAtIndex:(long long)arg1;	// IMP=0x00000000003167ff
