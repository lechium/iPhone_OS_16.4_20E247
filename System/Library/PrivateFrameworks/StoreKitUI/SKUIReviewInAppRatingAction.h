...
+ (id)actionWithCustomContentViewController:(id)arg1;	// IMP=0x00600000002d7074
- (void).cxx_destruct;	// IMP=0x00000000002d7248
...
- (void)setCustomEnabledState:(_Bool)arg1;	// IMP=0x00000000002d712a
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000002d70df
