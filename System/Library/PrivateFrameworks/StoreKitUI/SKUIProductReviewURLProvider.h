...
- (void).cxx_destruct;	// IMP=0x0000000000146371
...
- (id)_urlByAppendingItemId:(id)arg1;	// IMP=0x00000000001461f8
- (void)fetchURLsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000145eb5
- (id)initWithClientContext:(id)arg1 itemID:(id)arg2;	// IMP=0x0000000000145e09
- (id)init;	// IMP=0x0000000000145dc2
