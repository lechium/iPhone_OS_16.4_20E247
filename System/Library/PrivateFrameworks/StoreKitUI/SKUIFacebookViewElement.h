...
- (void).cxx_destruct;	// IMP=0x000000000013909c
...
- (long long)pageComponentType;	// IMP=0x000000000013906f
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000138fa5
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000138eae
