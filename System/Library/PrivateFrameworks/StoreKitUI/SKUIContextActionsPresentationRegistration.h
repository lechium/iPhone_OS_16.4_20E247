...
- (void).cxx_destruct;	// IMP=0x00000000000dc429
...
- (void)_presentFromGestureRecognizer:(id)arg1;	// IMP=0x00000000000dc147
- (void)longPressGestureRecognizerTriggered:(id)arg1;	// IMP=0x00000000000dc00c
- (void)cleanupPreviewInteraction:(id)arg1;	// IMP=0x00000000000dbee0
- (void)previewInteractionDidCancel:(id)arg1;	// IMP=0x00000000000dbe3e
- (void)previewInteraction:(id)arg1 didUpdatePreviewTransition:(double)arg2 ended:(_Bool)arg3;	// IMP=0x00000000000dbbb9
- (_Bool)previewInteractionShouldBegin:(id)arg1;	// IMP=0x00000000000da61d
- (void)dealloc;	// IMP=0x00000000000da594
- (id)initWithViewController:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000da4ed
