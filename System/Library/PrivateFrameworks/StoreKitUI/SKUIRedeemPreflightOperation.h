...
- (void).cxx_destruct;	// IMP=0x00000000001e775b
...
- (id)_redeemCodeMetadataWithClientContext:(id)arg1;	// IMP=0x00000000001e7297
- (id)_authenticationContext;	// IMP=0x00000000001e71cc
- (void)main;	// IMP=0x00000000001e6b13
@property(retain) SKUIRedeemConfiguration *redeemConfiguration;
@property(copy) CDUnknownBlockType outputBlock;
@property _Bool loadsRedeemCodeMetadata;
- (id)initWithClientContext:(id)arg1 redeemCode:(id)arg2 forcesAuthentication:(_Bool)arg3;	// IMP=0x00000000001e6581
- (id)init;	// IMP=0x00000000001e656f
- (id)_initSKUIRedeemPreflightOperation;	// IMP=0x00000000001e64cc
