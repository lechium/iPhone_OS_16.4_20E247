...
- (void).cxx_destruct;	// IMP=0x00000000002b546a
...
- (void)_addSelectedViewController;	// IMP=0x00000000002b527a
- (void)layoutSubviews;	// IMP=0x00000000002b51ba
- (void)setSelectedViewControllerIndex:(long long)arg1;	// IMP=0x00000000002b5101
