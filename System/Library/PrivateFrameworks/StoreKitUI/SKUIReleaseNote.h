...
+ (id)dateFormatter;	// IMP=0x00600000001f3eea
- (void).cxx_destruct;	// IMP=0x00000000001f3f42
...
- (id)initWithReleaseNoteDictionary:(id)arg1 dateFormatter:(id)arg2;	// IMP=0x00000000001f3d35
