...
- (void).cxx_destruct;	// IMP=0x0000000000375fbd
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000375ea4
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000375e16
- (void)layoutSubviews;	// IMP=0x0000000000375bcd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000375a4a
