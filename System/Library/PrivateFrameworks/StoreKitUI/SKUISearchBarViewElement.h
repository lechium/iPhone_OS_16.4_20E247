...
- (long long)pageComponentType;	// IMP=0x0000000000028f3d
- (unsigned long long)elementType;	// IMP=0x0000000000028f32
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000028dd8
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000028c77
