...
- (void).cxx_destruct;	// IMP=0x00000000000b4418
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000000b4149
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000000b3f94
