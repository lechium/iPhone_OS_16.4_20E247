...
- (void).cxx_destruct;	// IMP=0x00000000001b9b5b
...
- (void)_getBottomLayoutProperties:(struct **)arg1 origins:(double **)arg2 height:(double *)arg3 forWidth:(double)arg4;	// IMP=0x00000000001b9948
- (void)_getTopLayoutProperties:(struct **)arg1 origins:(double **)arg2 height:(double *)arg3 forWidth:(double)arg4;	// IMP=0x00000000001b970f
- (void)_reloadItemOfferButton:(_Bool)arg1;	// IMP=0x00000000001b94f5
- (void)_finishButtonAnimation;	// IMP=0x00000000001b94a1
- (void)_showConfirmationAction:(id)arg1;	// IMP=0x00000000001b9454
- (void)_cancelConfirmationAction:(id)arg1;	// IMP=0x00000000001b940a
- (void)contentRatingArtworkLoader:(id)arg1 didLoadImage:(id)arg2 forContentRating:(id)arg3;	// IMP=0x00000000001b9347
- (void)itemOfferButtonWillAnimateTransition:(id)arg1;	// IMP=0x00000000001b909b
- (void)itemOfferButtonDidAnimateTransition:(id)arg1;	// IMP=0x00000000001b9089
- (void)sizeToFit;	// IMP=0x00000000001b8c55
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b89d2
- (void)layoutSubviews;	// IMP=0x00000000001b7b77
@property(copy, nonatomic) NSString *title;
- (void)setItemState:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001b722a
...
- (id)contentRatingName;	// IMP=0x00000000001b5a63
- (void)dealloc;	// IMP=0x00000000001b5997
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001b57d5
