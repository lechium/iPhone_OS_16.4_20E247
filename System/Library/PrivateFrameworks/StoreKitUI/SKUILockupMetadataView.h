...
+ (double)maximumHeightWithVisibleFields:(unsigned long long)arg1;	// IMP=0x006000000004c755
- (void).cxx_destruct;	// IMP=0x000000000004ec2d
...
- (void)_reloadUserRatingViews;	// IMP=0x000000000004e7c9
- (id)_newDefaultLabel;	// IMP=0x000000000004e6bf
- (id)_decimalNumberFormatter;	// IMP=0x000000000004e651
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000004e346
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000004e1fb
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000004d516
...
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x000000000004cc9a
@property(copy, nonatomic) NSString *categoryString;
@property(copy, nonatomic) NSString *editorialBadgeString;
@property(copy, nonatomic) NSString *artistName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004c6f3
