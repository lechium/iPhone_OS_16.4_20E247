...
- (void).cxx_destruct;	// IMP=0x00000000001bc1fa
@property(retain, nonatomic) SKUIResourceLoader *resourceLoader; // @synthesize resourceLoader=_resourceLoader;
@property(copy, nonatomic) CDUnknownBlockType actionBlock; // @synthesize actionBlock=_actionBlock;
- (id)_swooshViewController;	// IMP=0x00000000001bc08a
- (id)_missingItemLoader;	// IMP=0x00000000001bbfeb
- (id)_artworkLoader;	// IMP=0x00000000001bbf39
- (id)swoosh:(id)arg1 imageForCellAtIndex:(long long)arg2;	// IMP=0x00000000001bbded
- (void)swoosh:(id)arg1 didSelectCellAtIndex:(long long)arg2;	// IMP=0x00000000001bbd29
- (void)missingItemLoader:(id)arg1 didLoadItems:(id)arg2 invalidItemIdentifiers:(id)arg3;	// IMP=0x00000000001bbc47
- (id)headerViewForTableView:(id)arg1;	// IMP=0x00000000001bbb7e
@property(readonly, nonatomic) UIViewController *swooshViewController;
@property(retain, nonatomic) SKUIColorScheme *colorScheme;
- (void)dealloc;	// IMP=0x00000000001bba3d
- (id)initWithLockups:(id)arg1 title:(id)arg2;	// IMP=0x00000000001bb98d
- (id)initWithItems:(id)arg1 title:(id)arg2;	// IMP=0x00000000001bb8a3
