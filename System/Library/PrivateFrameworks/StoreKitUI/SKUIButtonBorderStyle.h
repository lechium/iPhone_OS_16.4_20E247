...
- (void).cxx_destruct;	// IMP=0x00000000000eb0e7
...
- (_Bool)_usesBackgroundWithAlpha:(id)arg1;	// IMP=0x00000000000eafc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eaeeb
- (id)bezierPathWithBounds:(struct CGRect)arg1;	// IMP=0x00000000000eaa6d
- (id)initWithElementStyle:(id)arg1;	// IMP=0x00000000000ea696
