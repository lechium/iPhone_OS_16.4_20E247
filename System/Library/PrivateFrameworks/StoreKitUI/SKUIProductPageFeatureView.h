...
- (void).cxx_destruct;	// IMP=0x00000000001b5782
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b5670
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b55ce
- (void)layoutSubviews;	// IMP=0x00000000001b53b7
