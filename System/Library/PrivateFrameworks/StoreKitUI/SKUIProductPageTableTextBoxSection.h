...
- (void).cxx_destruct;	// IMP=0x00000000001eb063
...
- (id)tableViewCellForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001ead56
- (id)selectionActionForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001eacb4
- (long long)numberOfRowsInSection;	// IMP=0x00000000001eaca9
- (double)heightForCellInTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001eac31
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001eabc3
