...
- (void).cxx_destruct;	// IMP=0x00000000001f56c8
@property(readonly, nonatomic) NSArray *reviews; // @synthesize reviews=_reviews;
@property(readonly, nonatomic) NSMutableDictionary *cacheRepresentation;
- (id)initWithCacheRepresentation:(id)arg1;	// IMP=0x00000000001f520e
...
- (void)addReviews:(id)arg1;	// IMP=0x00000000001f4e09
- (id)initWithReviewListDictionary:(id)arg1;	// IMP=0x00000000001f4b48
