...
- (void).cxx_destruct;	// IMP=0x00000000001c3893
...
- (id)learnMoreAlertView;	// IMP=0x00000000001c37f6
- (id)initWithITunesPassDictionary:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000001c2ce0
