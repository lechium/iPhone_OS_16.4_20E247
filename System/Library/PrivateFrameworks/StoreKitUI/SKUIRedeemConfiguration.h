...
- (void).cxx_destruct;	// IMP=0x00000000002fd221
...
- (void)_setSuccessImage:(id)arg1;	// IMP=0x00000000002fd158
- (void)_setLandingImage:(id)arg1;	// IMP=0x00000000002fd0d5
- (void)_setInputImage:(id)arg1;	// IMP=0x00000000002fd052
- (id)_redeemPreflightRequestBodyData;	// IMP=0x00000000002fce89
- (void)_loadDefaultImages;	// IMP=0x00000000002fcda1
- (void)_loadConfigurationWithURLBagDictionary:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002fc93a
- (void)_didLoadWithResponseDictionary:(id)arg1;	// IMP=0x00000000002fbfed
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002fbdd2
- (id)initWithOperationQueue:(id)arg1 category:(long long)arg2 clientContext:(id)arg3;	// IMP=0x00000000002fbd2d
