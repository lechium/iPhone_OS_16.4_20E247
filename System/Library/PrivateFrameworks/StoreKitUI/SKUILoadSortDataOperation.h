...
- (void).cxx_destruct;	// IMP=0x00000000002d7fa9
@property __weak SSVLoadURLOperation *underlyingOperation; // @synthesize underlyingOperation=_underlyingOperation;
- (void)cancel;	// IMP=0x00000000002d7f0f
- (void)main;	// IMP=0x00000000002d78c8
- (id)initWithResourceRequest:(id)arg1;	// IMP=0x00000000002d7899
