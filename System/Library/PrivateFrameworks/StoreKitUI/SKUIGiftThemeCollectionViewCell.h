...
- (void).cxx_destruct;	// IMP=0x000000000009deaf
...
- (void)_setSenderName:(id)arg1;	// IMP=0x000000000009d983
- (void)_setPrice:(id)arg1;	// IMP=0x000000000009d752
- (void)_setMessage:(id)arg1;	// IMP=0x000000000009d522
- (void)_setHeaderImage:(id)arg1;	// IMP=0x000000000009d3e8
- (void)_reloadItemView;	// IMP=0x000000000009d1e6
- (id)_itemView;	// IMP=0x000000000009d0fe
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000009d060
- (void)layoutSubviews;	// IMP=0x000000000009c924
@property(retain, nonatomic) UIImage *itemImage;
- (void)reloadThemeHeaderImage;	// IMP=0x000000000009c352
