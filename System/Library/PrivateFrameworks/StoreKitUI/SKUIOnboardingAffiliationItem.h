...
- (void).cxx_destruct;	// IMP=0x0000000000153de2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000153c8d
- (unsigned long long)hash;	// IMP=0x0000000000153c77
- (id)description;	// IMP=0x0000000000153bed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000153b2c
