...
- (void).cxx_destruct;	// IMP=0x00000000002fbb07
@property(readonly, nonatomic) SKUIEditorialLockupCellLayout *layout; // @synthesize layout=_layout;
- (void)configureForItem:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000002fb720
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002fb69f
