...
- (void).cxx_destruct;	// IMP=0x00000000000722b0
...
- (void)artworkRequest:(id)arg1 didLoadImage:(id)arg2;	// IMP=0x0000000000072020
- (id)loadDataRepresentationForTypeIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000071f05
- (id)initWithURL:(id)arg1 usingResourceLoader:(id)arg2;	// IMP=0x0000000000071d34
