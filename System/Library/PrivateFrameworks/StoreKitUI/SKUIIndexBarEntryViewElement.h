...
- (void).cxx_destruct;	// IMP=0x00000000001f7b8c
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001f7984
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001f7868
