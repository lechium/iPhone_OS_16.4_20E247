...
- (void).cxx_destruct;	// IMP=0x00000000002e4f80
...
- (void)dealloc;	// IMP=0x00000000002e4aa5
- (id)initWithAppContext:(id)arg1 navigationController:(id)arg2 tabBarItem:(id)arg3 owner:(id)arg4;	// IMP=0x00000000002e4875
