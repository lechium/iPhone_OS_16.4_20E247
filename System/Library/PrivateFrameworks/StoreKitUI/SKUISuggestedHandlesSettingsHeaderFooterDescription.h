...
- (void).cxx_destruct;	// IMP=0x00000000002afa87
...
- (Class)_viewClassForSettingsHeaderFooterDescription:(id)arg1;	// IMP=0x00000000002afa49
- (id)suggestedHandles;	// IMP=0x00000000002afa24
- (void)selectedHandleAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002af958
- (id)helpText;	// IMP=0x00000000002af898
- (id)initWithSuggestedHandles:(id)arg1 clientContext:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000002af7d4
