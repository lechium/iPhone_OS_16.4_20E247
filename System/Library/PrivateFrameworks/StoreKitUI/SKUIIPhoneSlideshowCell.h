...
- (void).cxx_destruct;	// IMP=0x00000000002a47f1
@property(nonatomic) struct CGSize imageSize; // @synthesize imageSize=_imageSize;
- (void)prepareForReuse;	// IMP=0x00000000002a47ba
- (void)layoutSubviews;	// IMP=0x00000000002a4511
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000002a4416
@property(nonatomic, getter=isVideo) _Bool video;
@property(retain, nonatomic) UIImage *image;
@property(readonly, nonatomic) struct CGRect imageFrame;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002a40ab
