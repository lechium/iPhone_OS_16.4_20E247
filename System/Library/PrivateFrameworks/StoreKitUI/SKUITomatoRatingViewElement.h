...
- (void).cxx_destruct;	// IMP=0x000000000005f3d4
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000005f2e6
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000005efb0
