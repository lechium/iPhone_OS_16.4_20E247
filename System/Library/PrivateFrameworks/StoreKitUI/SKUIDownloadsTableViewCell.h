...
- (void).cxx_destruct;	// IMP=0x000000000008f72c
@property(readonly, nonatomic) SKUIDownloadsCellView *cellView; // @synthesize cellView=_cellView;
- (void)layoutSubviews;	// IMP=0x000000000008f671
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000008f5ca
