...
- (void).cxx_destruct;	// IMP=0x00000000002b16ec
...
- (void)handleLabelTap:(id)arg1;	// IMP=0x00000000002b13fe
- (void)endAllAnimations;	// IMP=0x00000000002b13b6
- (void)updateLabelFrame;	// IMP=0x00000000002b1213
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000002b1134
- (void)viewDidLoad;	// IMP=0x00000000002b0ee4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000002b0e80
