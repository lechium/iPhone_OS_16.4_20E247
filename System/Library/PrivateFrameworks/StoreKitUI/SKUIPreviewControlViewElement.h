...
- (void).cxx_destruct;	// IMP=0x0000000000179a8f
...
- (_Bool)isEnabled;	// IMP=0x0000000000179a29
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000179951
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001797f0
