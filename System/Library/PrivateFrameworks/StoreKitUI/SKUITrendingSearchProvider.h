...
- (void).cxx_destruct;	// IMP=0x0000000000293f0a
...
- (void)clearCache;	// IMP=0x0000000000293e96
- (void)trendingSearchPageWithURL:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000293d3a
- (void)requestTrendingSearchPageWithURL:(id)arg1;	// IMP=0x00000000002939af
@property(readonly, nonatomic) NSOperationQueue *callbackQueue;
- (id)requestOperationWithPageURL:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002938ee
- (void)dealloc;	// IMP=0x0000000000293879
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000002936ed
