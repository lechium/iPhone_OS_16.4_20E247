...
- (id)_createConnectProxyConfig;	// IMP=0x0000000000002605
- (id)connectProxyConfig;	// IMP=0x0000000000002571
- (void)addProtocolClasses:(id)arg1;	// IMP=0x00000000000023e9
- (id)initWithDefaultProxyURL:(id)arg1;	// IMP=0x000000000000234b
