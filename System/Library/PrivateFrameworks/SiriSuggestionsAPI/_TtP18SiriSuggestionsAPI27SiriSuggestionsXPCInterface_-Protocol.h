...
- (void)getSuggestionsForAppWithAppBundleId:(NSString *)arg1 placementId:(NSString *)arg2 entities:(NSData *)arg3 bridge:(id <_TtP18SiriSuggestionsAPI15XPCClientBridge_>)arg4;
