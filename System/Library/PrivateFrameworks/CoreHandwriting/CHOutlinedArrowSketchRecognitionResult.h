...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(double)arg3 center:(struct CGPoint)arg4 size:(struct CGSize)arg5 controlPointLocation:(struct CGPoint)arg6;	// IMP=0x00000000000b2b70
