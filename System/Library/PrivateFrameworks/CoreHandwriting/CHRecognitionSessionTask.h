...
- (void).cxx_destruct;	// IMP=0x00000000000ffe40
...
- (id)newGroupingManager;	// IMP=0x00000000000ffba0
- (id)newStrokeClassifier;	// IMP=0x00000000000ffab0
- (id)clutterFilter;	// IMP=0x00000000000ffa30
- (id)_recognitionResultsForNonTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000ff740
- (id)_tokenizedTextResultForDrawing:(id)arg1 usingRecognizer:(id)arg2 isRemoteRecognizer:(_Bool)arg3 locale:(id)arg4 strokeLimit:(long long)arg5 recognitionError:(id *)arg6;	// IMP=0x00000000000fde40
- (id)_textRecognitionResultsForTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000fd040
- (id)textCorrectionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000fd030
- (id)recognitionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000fc590
- (void)_logResultsIfAppropriateWithStrokeProvider:(id)arg1;	// IMP=0x00000000000fc1b0
- (_Bool)_isTransitionValidFromStatus:(long long)arg1 toStatus:(long long)arg2;	// IMP=0x00000000000fc180
- (void)cancel;	// IMP=0x00000000000fc070
- (void)main;	// IMP=0x00000000000f9d30
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 subjectStrokeIdentifiers:(id)arg10 partialResultBlock:(CDUnknownBlockType)arg11;	// IMP=0x00000000000f9c80
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 partialResultBlock:(CDUnknownBlockType)arg10;	// IMP=0x00000000000f99e0
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6;	// IMP=0x00000000000f9990
- (id)init;	// IMP=0x00000000000f9900
