...
- (void).cxx_destruct;	// IMP=0x00000000001acf90
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001acaa0
- (id)process:(id)arg1 withProcessor:(id)arg2 options:(id)arg3;	// IMP=0x00000000001ac9f0
- (id)initProcessorDefault:(id)arg1 processorDigits:(id)arg2 processorPhone:(id)arg3 processorUsername:(id)arg4 processorEmail:(id)arg5 processorURL:(id)arg6 processorASCII:(id)arg7 processorEquation:(id)arg8;	// IMP=0x00000000001ac810
