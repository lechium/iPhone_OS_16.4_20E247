...
- (void).cxx_destruct;	// IMP=0x00000000001be750
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001bd350
- (id)initWithPatternFst:(id)arg1 patternType:(long long)arg2 capitalizationToSplit:(_Bool)arg3 convertToLowercase:(_Bool)arg4;	// IMP=0x00000000001bd290
