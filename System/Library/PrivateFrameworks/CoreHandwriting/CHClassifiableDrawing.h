...
- (id)initWithDrawing:(id)arg1 characterSet:(id)arg2 expandCodePoints:(_Bool)arg3 normalizationContext:(struct CGRect)arg4 maxCandidateCount:(unsigned long long)arg5;	// IMP=0x0000000000001e50
