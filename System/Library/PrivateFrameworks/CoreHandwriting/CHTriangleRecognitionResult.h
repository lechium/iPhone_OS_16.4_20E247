...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(double)arg3 vertex1:(struct CGPoint)arg4 vertex2:(struct CGPoint)arg5 vertex3:(struct CGPoint)arg6;	// IMP=0x00000000000b2ef0
