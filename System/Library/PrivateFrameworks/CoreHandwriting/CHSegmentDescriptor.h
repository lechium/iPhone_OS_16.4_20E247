...
+ (long long)indexForSegmentID:(id)arg1 fromSegments:(id)arg2;	// IMP=0x0060000000065f10
+ (struct CGRect)boundingBoxFromSegmentID:(long long)arg1 toSegmentID:(long long)arg2 withSegments:(id)arg3 withSourceDrawing:(id)arg4;	// IMP=0x0060000000065d90
+ (id)generateSegmentsFromDrawing:(id)arg1;	// IMP=0x0060000000065b90
...
- (_Bool)isSinglePointSegment;	// IMP=0x0000000000065af0
- (long long)strokeCount;	// IMP=0x0000000000065aa0
- (id)strokeIndexSet;	// IMP=0x00000000000659e0
- (id)initWithSegmentID:(id)arg1 startCutPoint:(id)arg2 endCutPoint:(id)arg3 referenceDrawing:(id)arg4;	// IMP=0x00000000000657d0
