...
+ (id)loadFromFile:(id)arg1;	// IMP=0x001000000009de70
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000009dac0
- (void).cxx_destruct;	// IMP=0x000000000009f900
...
- (id)description;	// IMP=0x000000000009f390
- (unsigned long long)hash;	// IMP=0x000000000009f0d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009f050
- (_Bool)isEqualToRemoteRecognitionRequest:(id)arg1;	// IMP=0x000000000009ea50
- (id)recognizerConfigurationKeyWithLocale:(id)arg1;	// IMP=0x000000000009df20
@property(readonly, nonatomic) _Bool shouldRemoveUnnaturalGaps;
- (id)writeToFileInFolder:(id)arg1 basename:(id)arg2;	// IMP=0x000000000009dad0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009d860
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009d030
- (id)initWithLocales:(id)arg1 recognitionMode:(int)arg2 drawing:(id)arg3 options:(id)arg4 priority:(long long)arg5;	// IMP=0x000000000009ce00
