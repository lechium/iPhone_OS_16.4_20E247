...
- (void).cxx_destruct;	// IMP=0x00000000001b5c20
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001b4870
- (id)initWithShouldAddAlternatives:(_Bool)arg1;	// IMP=0x00000000001b46d0
