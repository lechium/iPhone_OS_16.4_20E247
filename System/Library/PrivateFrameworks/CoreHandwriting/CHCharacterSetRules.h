...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x0060000000178030
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x0060000000177ee0
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x0060000000177d90
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0060000000177c40
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0060000000177af0
+ (id)sharedCharacterSetRules;	// IMP=0x0060000000177a80
- (id).cxx_construct;	// IMP=0x000000000017a630
- (void).cxx_destruct;	// IMP=0x000000000017a450
...
- (unsigned long long)_expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x0000000000179d30
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x0000000000179650
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x00000000001790b0
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x00000000001788c0
- (id)init;	// IMP=0x0000000000178180
