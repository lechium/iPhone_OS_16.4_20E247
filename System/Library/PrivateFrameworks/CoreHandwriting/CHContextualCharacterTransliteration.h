...
- (_Bool)isValidForLocale:(id)arg1;	// IMP=0x00000000001aa2e0
- (_Bool)meetsContextRequirementWithLeftContext:(id)arg1 rightContext:(id)arg2;	// IMP=0x00000000001aa150
- (id)initWithConfusion:(id)arg1 correction:(id)arg2 locales:(id)arg3 leftContext:(id)arg4 rightContext:(id)arg5 requiresLexiconMatch:(_Bool)arg6;	// IMP=0x00000000001aa040
