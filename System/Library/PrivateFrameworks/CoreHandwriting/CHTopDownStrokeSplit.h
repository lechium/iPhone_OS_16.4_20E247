...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00600000000f1c60
- (void).cxx_destruct;	// IMP=0x00000000000f2090
...
- (long long)_substrokeCountForStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00000000000f19e0
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3;	// IMP=0x00000000000f14a0
