...
- (void).cxx_destruct;	// IMP=0x00000000000ec2d0
...
- (void)dealloc;	// IMP=0x00000000000ec150
- (id)initWithModelName:(id)arg1 featureIndex:(long long)arg2;	// IMP=0x00000000000eb180
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000eb160
