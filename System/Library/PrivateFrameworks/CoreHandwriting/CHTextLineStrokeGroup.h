...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000ab7a0
- (id).cxx_construct;	// IMP=0x00000000000ab830
- (void).cxx_destruct;	// IMP=0x00000000000ab7d0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000aad20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000aa870
- (struct CGPath *)newEstimatedBaselineForSubStrokes:(id)arg1 tokens:(id)arg2 tokenSubStrokeIndexes:(id)arg3 estimatedDescenderLocations:(id)arg4;	// IMP=0x00000000000a88c0
- (const struct CGPath *)newEstimatedBaselineForStrokesWithTokens:(id)arg1 tokenStrokeIdentifiers:(id)arg2;	// IMP=0x00000000000a7b20
- (id)coalescedLastSubstrokes;	// IMP=0x00000000000a7b00
- (long long)lastSubstrokeIndexBeforeMerge;	// IMP=0x00000000000a7ae0
- (struct CGVector)averageStrokeDeviation;	// IMP=0x00000000000a7ac0
- (struct CGVector)averageWritingOrientation;	// IMP=0x00000000000a7aa0
- (struct CGVector)localWritingOrientationAtStrokeIndex:(long long)arg1;	// IMP=0x00000000000a7a80
- (void *)localStrokeWritingOrientations;	// IMP=0x00000000000a7a70
- (id)writingDirectionSortedSubstrokes;	// IMP=0x00000000000a7a50
- (id)groupByAddingStrokeIdentifiers:(id)arg1 removingStrokeIdentifiers:(id)arg2 firstStrokeIdentifier:(id)arg3 lastStrokeIdentifier:(id)arg4 bounds:(struct CGRect)arg5 writingDirectionSortedSubstrokes:(id)arg6 averageWritingOrientation:(struct CGVector)arg7 averageStrokeDeviation:(struct CGVector)arg8 writingDirectionSortedStrokeIdentifiers:(id)arg9 localStrokeWritingOrientations:(const void *)arg10 coalescedLastSubstrokes:(id)arg11 groupingConfidence:(double)arg12 lastSubstrokeIndexBeforeMerge:(long long)arg13 firstStrokeOrigin:(struct CGPoint)arg14;	// IMP=0x00000000000a7840
