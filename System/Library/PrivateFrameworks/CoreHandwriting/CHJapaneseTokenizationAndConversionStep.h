...
- (void).cxx_destruct;	// IMP=0x00000000001ccaf0
...
- (void)dealloc;	// IMP=0x00000000001cc980
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001c9c90
- (id)_extendedConversionCandidates:(id)arg1 withPhraseCandidates:(id)arg2;	// IMP=0x00000000001c9970
- (id)_updatedTokenFromToken:(id)arg1 withString:(id)arg2;	// IMP=0x00000000001c96b0
- (id)initWithMecabra:(id)arg1 wordLanguageModel:(void *)arg2 ovsStringChecker:(id)arg3 promoteKanaConversion:(_Bool)arg4;	// IMP=0x00000000001c95a0
