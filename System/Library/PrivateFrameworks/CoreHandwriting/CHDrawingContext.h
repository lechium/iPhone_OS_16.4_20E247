...
- (id).cxx_construct;	// IMP=0x000000000004e560
- (void).cxx_destruct;	// IMP=0x000000000004e530
...
- (id)initWithEdgeIndex:(unsigned long long)arg1 numberOfSubstrokes:(long long)arg2 numberOfSegments:(long long)arg3 classifiableDrawing:(id)arg4 strokeGroup:(set_f63680ae)arg5;	// IMP=0x000000000004e3c0
