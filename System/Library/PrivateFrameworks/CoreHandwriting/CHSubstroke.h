...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000010d4c0
+ (id)substrokesForStroke:(id)arg1;	// IMP=0x001000000010b980
- (id).cxx_construct;	// IMP=0x000000000010d8d0
- (void).cxx_destruct;	// IMP=0x000000000010d890
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010d7b0
- (_Bool)isEqualToSubstroke:(id)arg1;	// IMP=0x000000000010d4d0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010d0d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010cee0
- (void *)convexHull;	// IMP=0x000000000010ced0
- (id)initWithStrokeIdentifier:(id)arg1 bounds:(struct CGRect)arg2 startTimestamp:(double)arg3 endTimestamp:(double)arg4 convexHull:(const void *)arg5 curvature:(double)arg6;	// IMP=0x000000000010b880
