...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001baa90
- (id)initWithShouldKeepOutOfPatternCandidates:(_Bool)arg1 shouldKeepDuplicateTokenIDs:(_Bool)arg2 shouldKeepOutOfLexiconAlternatives:(_Bool)arg3 shouldKeepAlternativeLengths:(_Bool)arg4 shouldKeepSubstrings:(_Bool)arg5 shouldKeepOriginalSpelling:(_Bool)arg6;	// IMP=0x00000000001baa00
