...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x00600000000395ac
+ (void)initialize;	// IMP=0x006000000003959b
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000039814
...
- (void)dealloc;	// IMP=0x00000000000396f6
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x00000000000395f7
