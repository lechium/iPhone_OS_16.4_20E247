...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00600000000823b7
...
- (void)dealloc;	// IMP=0x0000000000082457
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000823ee
