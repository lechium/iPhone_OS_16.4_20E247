...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x000000000008112f
- (id)uniqueConnections:(id)arg1;	// IMP=0x00000000000810b7
- (id)uniqueOutputs:(id)arg1;	// IMP=0x000000000008103f
- (id)uniqueInputs:(id)arg1;	// IMP=0x0000000000080fc7
- (void)dealloc;	// IMP=0x0000000000080f6f
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x0000000000080ecb
