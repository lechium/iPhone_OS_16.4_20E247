...
+ (id)prepareBracketRequestWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x0060000000043e87
...
- (void)dealloc;	// IMP=0x0000000000043f2e
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x0000000000043ec3
