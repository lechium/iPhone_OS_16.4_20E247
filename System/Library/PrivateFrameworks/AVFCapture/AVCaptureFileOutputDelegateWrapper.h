...
+ (id)wrapperWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x006000000000317e
...
- (void)dealloc;	// IMP=0x000000000000327a
- (id)initWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x00000000000031ce
