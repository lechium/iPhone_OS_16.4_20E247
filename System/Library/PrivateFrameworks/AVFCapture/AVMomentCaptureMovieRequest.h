...
+ (id)requestWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x0060000000049087
...
- (void)dealloc;	// IMP=0x000000000004918b
- (id)_initWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x00000000000490d2
