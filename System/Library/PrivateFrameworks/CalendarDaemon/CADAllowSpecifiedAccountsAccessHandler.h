...
- (_Bool)isActionAllowed:(unsigned long long)arg1 forStore:(const void *)arg2 inDatabase:(struct CalDatabase *)arg3;	// IMP=0x00000000000051bb
- (id)initWithAllowedSourceIdentifiers:(id)arg1 databaseDataProvider:(id)arg2;	// IMP=0x0000000000005128
