...
- (void).cxx_destruct;	// IMP=0x0000000000036393
...
- (void)addExpandedNotification:(id)arg1;	// IMP=0x000000000003629c
@property(readonly, nonatomic) NSArray *expandedNotifications;
@property(readonly, nonatomic) _Bool expanded;
- (id)initWithType:(int)arg1 objectID:(id)arg2 occurrenceDate:(double)arg3 expirationDate:(double)arg4;	// IMP=0x00000000000361e2
