...
- (void).cxx_destruct;	// IMP=0x000000000003ce70
...
- (id)_fetchedObjectDictionaryForEntity:(void *)arg1;	// IMP=0x000000000003cbe7
- (id)_properties:(id)arg1 forEntityIfNotSeen:(void *)arg2 objectExists:(_Bool *)arg3;	// IMP=0x000000000003c4c4
@property(readonly, nonatomic) NSArray *fetchedObjectWrappers;
- (id)addEntity:(void *)arg1;	// IMP=0x000000000003c13f
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2 relatedObjectPropertiesToLoad:(id)arg3;	// IMP=0x000000000003c012
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2;	// IMP=0x000000000003bffd
