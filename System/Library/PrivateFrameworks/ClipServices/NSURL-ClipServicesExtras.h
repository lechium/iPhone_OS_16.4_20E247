...
+ (id)cps_preIngestedURLWithBundleIdentifier:(id)arg1;	// IMP=0x002000000000cd6d
+ (id)cps_resolvedURLWithStoreIconURLString:(id)arg1 iconSize:(unsigned long long)arg2;	// IMP=0x002000000000caad
