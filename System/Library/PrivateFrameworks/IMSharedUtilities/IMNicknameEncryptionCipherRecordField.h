...
+ (id)cipherRecordFieldWithFieldName:(id)arg1 dataRepresentation:(id)arg2 error:(id *)arg3;	// IMP=0x0060000000010265
- (void).cxx_destruct;	// IMP=0x0000000000010820
...
- (id)description;	// IMP=0x00000000000106b0
- (id)dataRepresentationWithError:(id *)arg1;	// IMP=0x000000000001057a
- (id)initWithFieldName:(id)arg1 cipherData:(id)arg2 IV:(id)arg3 tag:(id)arg4;	// IMP=0x0000000000010498
