...
- (void).cxx_destruct;	// IMP=0x0000000000005530
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (id)initWithAccessibilityServerPrimitives:(id)arg1 queue:(id)arg2;	// IMP=0x00000000000052ba
- (void)dealloc;	// IMP=0x0000000000005246
