...
- (void).cxx_destruct;	// IMP=0x0000000000052ea8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000052ddf
- (unsigned long long)hash;	// IMP=0x0000000000052d78
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000052c91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000052be2
- (void)copyTo:(id)arg1;	// IMP=0x0000000000052b60
- (void)writeTo:(id)arg1;	// IMP=0x0000000000052ad0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000052ac3
- (id)dictionaryRepresentation;	// IMP=0x00000000000526f0
- (id)description;	// IMP=0x0000000000052641
