...
- (void).cxx_destruct;	// IMP=0x0000000000055952
...
- (id)description;	// IMP=0x0000000000055888
- (id)initWithStatusPayload:(id)arg1 invitation:(id)arg2;	// IMP=0x00000000000557ef
