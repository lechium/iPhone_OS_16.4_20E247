...
- (void).cxx_destruct;	// IMP=0x0000000000040c2c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000040ad4
- (unsigned long long)hash;	// IMP=0x0000000000040a3e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000040915
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000040830
- (void)copyTo:(id)arg1;	// IMP=0x000000000004078c
- (void)writeTo:(id)arg1;	// IMP=0x00000000000406ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000406e0
- (id)dictionaryRepresentation;	// IMP=0x0000000000040294
- (id)description;	// IMP=0x00000000000401e5
