...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002c8e9
- (void)setTruncated;	// IMP=0x000000000002c8e1
- (void)setPublic;	// IMP=0x000000000002c8c0
- (void)_initBlob;	// IMP=0x000000000002c812
