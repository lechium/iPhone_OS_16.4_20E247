...
- (void).cxx_destruct;	// IMP=0x000000000001b574
@property(readonly, nonatomic) NSMutableArray *oversizeChunks; // @synthesize oversizeChunks=_oversizeChunks;
- (void)enumerateTracepointsInRange:(struct os_timesync_range_s *)arg1 timesync:(struct _os_timesync_db_s *)arg2 options:(unsigned int)arg3 usingBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000019ba2
- (void)_initTimesyncBounds:(CDStruct_42ec109f *)arg1;	// IMP=0x00000000000199af
- (void)dealloc;	// IMP=0x0000000000019913
- (id)initWithIndex:(id)arg1 metadata:(CDStruct_42ec109f *)arg2 fileBootList:(id)arg3 catalogFilter:(id)arg4;	// IMP=0x0000000000019780
