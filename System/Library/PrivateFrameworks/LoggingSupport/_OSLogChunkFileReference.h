...
- (void).cxx_destruct;	// IMP=0x0000000000016b31
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x0000000000016a05
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x00000000000167aa
- (void)dealloc;	// IMP=0x0000000000016770
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x00000000000166f2
