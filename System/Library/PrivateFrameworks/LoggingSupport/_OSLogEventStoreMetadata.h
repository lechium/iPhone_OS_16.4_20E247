...
- (void).cxx_destruct;	// IMP=0x000000000004a73f
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x000000000004a70b
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x000000000004a43d
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000049e95
