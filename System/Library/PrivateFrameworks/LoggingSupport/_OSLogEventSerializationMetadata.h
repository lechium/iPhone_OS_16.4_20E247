...
- (void).cxx_destruct;	// IMP=0x000000000003e5e8
...
- (id)stringForIndex:(id)arg1;	// IMP=0x000000000003e4a2
- (id)indexForString:(id)arg1;	// IMP=0x000000000003e396
- (id)dataRepresentation;	// IMP=0x000000000003df70
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x000000000003dadd
- (id)init;	// IMP=0x000000000003da77
