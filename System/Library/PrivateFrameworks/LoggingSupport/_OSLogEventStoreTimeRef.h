...
+ (id)timeRef;	// IMP=0x0060000000049c78
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000049d2d
- (id)initWithUUID:(unsigned char [16])arg1 continuous:(unsigned long long)arg2;	// IMP=0x0000000000049cfe
