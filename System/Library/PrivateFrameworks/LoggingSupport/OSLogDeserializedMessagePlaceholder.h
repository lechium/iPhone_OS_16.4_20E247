...
- (void).cxx_destruct;	// IMP=0x0000000000049c47
...
- (id)type;	// IMP=0x0000000000049a69
- (id)typeNamespace;	// IMP=0x00000000000498a3
- (id)rawString;	// IMP=0x00000000000496dd
- (id)tokens;	// IMP=0x00000000000493a8
- (int)precision;	// IMP=0x0000000000049282
- (int)width;	// IMP=0x000000000004915c
- (id)initWithDict:(id)arg1 metadata:(id)arg2;	// IMP=0x00000000000490ba
