...
- (void).cxx_destruct;	// IMP=0x0000000000139c60
...
- (id)createDataContainer;	// IMP=0x0000000000139840
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x00000000001396d0
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001395b0
- (id)jsonDescription;	// IMP=0x0000000000139360
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000138fc0
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x0000000000138f20
- (void)keepTensors:(id)arg1;	// IMP=0x0000000000138c30
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x0000000000138830
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x0000000000137e40
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x0000000000137c70
- (id)checkForValidity;	// IMP=0x0000000000137a30
