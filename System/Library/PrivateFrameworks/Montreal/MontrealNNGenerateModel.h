...
- (void).cxx_destruct;	// IMP=0x0000000000212590
...
- (id)networkOutputs;	// IMP=0x0000000000212280
- (id)networkInputs;	// IMP=0x0000000000211fe0
- (void)removeOutput:(id)arg1;	// IMP=0x0000000000211e90
- (void)addOutputs:(id)arg1;	// IMP=0x0000000000211ba0
- (void)removeInput:(id)arg1;	// IMP=0x0000000000211a50
- (void)addInputs:(id)arg1;	// IMP=0x0000000000211760
- (id)modelContainerPath;	// IMP=0x0000000000211420
- (void *)generateModelContainer;	// IMP=0x0000000000211260
- (void)merge:(id)arg1;	// IMP=0x0000000000211000
@property struct MontrealNeuralNetwork *nnObject; // @synthesize nnObject=_nnObject;
- (void)dealloc;	// IMP=0x0000000000210f40
- (id)initWithWeightFormat:(unsigned long long)arg1;	// IMP=0x0000000000210e50
