...
- (void).cxx_destruct;	// IMP=0x000000000020e540
...
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000020e370
- (id)initWithOptimizerType:(unsigned long long)arg1 learningRate:(float)arg2 momentum:(float)arg3 gradientClipMin:(id)arg4 gradientClipMax:(id)arg5;	// IMP=0x000000000020e250
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000020e090
