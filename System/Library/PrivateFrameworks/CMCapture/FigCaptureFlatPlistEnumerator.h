...
- (id)nextObject;	// IMP=0x0000000000004d0e
- (id)allObjects;	// IMP=0x0000000000004c01
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000000004b5c
