...
- (void).cxx_destruct;	// IMP=0x000000000001bb84
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001ba08
- (unsigned long long)hash;	// IMP=0x000000000001b965
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b805
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b6ed
- (void)copyTo:(id)arg1;	// IMP=0x000000000001b62a
- (void)writeTo:(id)arg1;	// IMP=0x000000000001b576
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001b569
- (id)dictionaryRepresentation;	// IMP=0x000000000001b471
- (id)description;	// IMP=0x000000000001b3c2
