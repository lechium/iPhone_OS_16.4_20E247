...
+ (id)visibilityProviderKeyPaths;	// IMP=0x006000000000e221
- (void).cxx_destruct;	// IMP=0x000000000000e917
...
- (void)connectToDaemon;	// IMP=0x000000000000e87b
- (void)reloadVisibilityState;	// IMP=0x000000000000e7c8
- (void)updatePaneStatus;	// IMP=0x000000000000e65c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000e53f
- (void)stopObservingVisibilityProvider;	// IMP=0x000000000000e3ee
- (void)startObservingVisibilityProvider;	// IMP=0x000000000000e293
