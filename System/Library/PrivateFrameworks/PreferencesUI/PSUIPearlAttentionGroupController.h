...
- (void).cxx_destruct;	// IMP=0x00000000000033b5
...
- (_Bool)isPeriocularEnabled;	// IMP=0x0000000000003344
- (_Bool)useAlternateFooterTextForAttention;	// IMP=0x000000000000333c
- (id)specifiers;	// IMP=0x00000000000032fe
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000000326c
