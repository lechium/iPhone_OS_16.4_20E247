...
+ (id)na_identity;	// IMP=0x006000000002cc5d
- (void).cxx_destruct;	// IMP=0x000000000002cec1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002cbe7
- (unsigned long long)hash;	// IMP=0x000000000002cb8c
- (id)initWithVisibilityStyle:(unsigned long long)arg1 connectivityState:(unsigned long long)arg2;	// IMP=0x000000000002ca40
