...
- (void).cxx_destruct;	// IMP=0x000000000003e4c8
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000003e3f0
- (_Bool)isLocalParticipant;	// IMP=0x000000000003e39e
@property(readonly, nonatomic) _Bool _inviteDelivered;
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) IMAVChat *avChat;
- (id)initWithDictionary:(id)arg1 chat:(id)arg2;	// IMP=0x000000000003e285
