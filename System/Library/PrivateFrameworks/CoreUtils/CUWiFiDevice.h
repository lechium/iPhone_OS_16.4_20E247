...
- (void).cxx_destruct;	// IMP=0x00000000000c3507
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000c2971
- (id)description;	// IMP=0x00000000000c27da
