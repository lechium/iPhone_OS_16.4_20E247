...
- (id)description;	// IMP=0x000000000006077f
- (void)dealloc;	// IMP=0x0000000000060745
- (id)initWithCursor:(struct _LXCursor *)arg1 replacementsCount:(unsigned long long)arg2 insertionsCount:(unsigned long long)arg3 deletionsCount:(unsigned long long)arg4 transpositionsCount:(unsigned long long)arg5 advancementLength:(unsigned long long)arg6;	// IMP=0x00000000000606c5
