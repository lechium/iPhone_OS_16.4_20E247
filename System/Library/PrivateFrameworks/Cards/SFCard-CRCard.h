...
+ (id)_interactionsByIntentDataHashes;	// IMP=0x001000000000a7c4
- (id)_interactionDataKey;	// IMP=0x001000000000aeea
- (id)underlyingInteraction;	// IMP=0x001000000000ae9a
@property(readonly, nonatomic) unsigned long long cardFormat;
@property(readonly, copy, nonatomic) NSString *cardIdentifier;
- (id)interaction;	// IMP=0x001000000000a9ce
@property(readonly, nonatomic) NSSet *interactions;
@property(readonly, nonatomic) SFCard *backingCard;
- (void)loadCardWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a853
