...
struct Function<void (WebCore::PolicyAction, WebCore::ProcessQualified<WTF::ObjectIdentifier<WebCore::LocalPolicyCheckIdentifierType>>)> {
...
struct ObjectIdentifier<WebCore::LocalPolicyCheckIdentifierType> {
...
struct ProcessQualified<WTF::ObjectIdentifier<WebCore::LocalPolicyCheckIdentifierType>> {
    struct ObjectIdentifier<WebCore::LocalPolicyCheckIdentifierType> m_object;
