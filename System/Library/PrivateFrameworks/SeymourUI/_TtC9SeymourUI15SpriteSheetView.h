...
- (void).cxx_destruct;	// IMP=0x00000000002143b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000214330
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002142e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000213560
