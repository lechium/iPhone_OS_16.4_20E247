...
- (void).cxx_destruct;	// IMP=0x0000000000408390
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000004082a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000408280
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000407e50
