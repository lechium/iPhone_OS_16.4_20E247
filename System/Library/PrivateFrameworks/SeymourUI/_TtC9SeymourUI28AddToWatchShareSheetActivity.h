...
+ (long long)activityCategory;	// IMP=0x0040000000077b60
- (void).cxx_destruct;	// IMP=0x00000000000780c0
- (id)init;	// IMP=0x0000000000078060
- (void)performActivity;	// IMP=0x0000000000078030
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000077e80
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000077d00
