...
- (void).cxx_destruct;	// IMP=0x00000000005859a0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000585620
- (void)tintColorDidChange;	// IMP=0x0000000000585420
- (void)layoutSubviews;	// IMP=0x00000000005853f0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000585210
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000584e70
- (id)viewForBaselineLayout;	// IMP=0x0000000000584e50
