...
- (void).cxx_destruct;	// IMP=0x00000000006595c0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000006582e0
- (void)tintColorDidChange;	// IMP=0x00000000006582b0
- (void)layoutSubviews;	// IMP=0x00000000006580a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000657dc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000657a40
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x0000000000657080
