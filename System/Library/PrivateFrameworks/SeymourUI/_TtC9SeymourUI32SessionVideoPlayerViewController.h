...
- (void).cxx_destruct;	// IMP=0x000000000050a7c0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000050a740
- (void)viewSafeAreaInsetsDidChange;	// IMP=0x000000000050a6e0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000050a380
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000050a2d0
- (void)viewDidLoad;	// IMP=0x000000000050a2a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000509f90
