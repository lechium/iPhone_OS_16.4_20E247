...
- (void).cxx_destruct;	// IMP=0x0000000000238ee0
- (void)textSizeUpdated:(id)arg1;	// IMP=0x0000000000238af0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000238940
- (void)layoutSubviews;	// IMP=0x0000000000238660
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000238460
