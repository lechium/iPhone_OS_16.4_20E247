...
- (void).cxx_destruct;	// IMP=0x0000000000656720
- (void)panGestureRecognized:(id)arg1;	// IMP=0x0000000000656590
- (void)layoutSubviews;	// IMP=0x0000000000655e40
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000655c60
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000006558d0
