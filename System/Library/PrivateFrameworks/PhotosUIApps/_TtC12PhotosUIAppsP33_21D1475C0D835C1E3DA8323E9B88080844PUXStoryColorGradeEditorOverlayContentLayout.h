...
- (void).cxx_destruct;	// IMP=0x000000000009b050
- (id)init;	// IMP=0x000000000009afd0
- (id)initWithComposition:(id)arg1;	// IMP=0x000000000009afa0
- (struct CGSize)layout:(id)arg1 estimatedContentSizeForSublayoutAtIndex:(long long)arg2 referenceSize:(struct CGSize)arg3;	// IMP=0x000000000009af90
- (id)layout:(id)arg1 createSublayoutAtIndex:(long long)arg2;	// IMP=0x000000000009af20
@property(nonatomic, readonly) long long scrollableAxis;
- (long long)sublayoutIndexForObjectReference:(id)arg1 options:(unsigned long long)arg2 updatedObjectReference:(id *)arg3;	// IMP=0x0000000000098d80
- (void)referenceSizeDidChange;	// IMP=0x00000000000989a0
- (void)update;	// IMP=0x0000000000098970
