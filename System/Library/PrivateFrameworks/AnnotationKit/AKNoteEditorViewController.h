...
- (void).cxx_destruct;	// IMP=0x0000000000064c63
...
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000064b72
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000064ace
- (void)viewDidLoad;	// IMP=0x0000000000064994
