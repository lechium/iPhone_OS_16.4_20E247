...
- (void).cxx_destruct;	// IMP=0x0000000000051e07
...
- (void)motionEnded:(long long)arg1 withEvent:(id)arg2;	// IMP=0x0000000000051ba4
- (id)undoManager;	// IMP=0x0000000000051b2d
- (void)_updateSignatureDescriptionWithStringValue:(id)arg1;	// IMP=0x00000000000519f7
- (void)_removeSignatureDescription;	// IMP=0x000000000005192a
- (void)showEditCustomDescriptionAlert;	// IMP=0x000000000005133f
- (void)_showSignatureDescriptionSelectionAlert;	// IMP=0x0000000000050a9b
- (long long)positionForBar:(id)arg1;	// IMP=0x0000000000050a90
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x00000000000509ea
- (void)_notifyDidDismiss;	// IMP=0x000000000005098d
- (void)_done:(id)arg1;	// IMP=0x0000000000050657
- (void)_clear:(id)arg1;	// IMP=0x000000000005061a
- (void)_cancel:(id)arg1;	// IMP=0x00000000000504e4
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000504dc
- (void)_validateButtons;	// IMP=0x00000000000502aa
- (_Bool)prefersStatusBarHidden;	// IMP=0x00000000000502a2
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000004fff5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004fea1
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000004fc6b
- (void)didReceiveMemoryWarning;	// IMP=0x000000000004fc3c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000004fba3
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000004fb4e
- (_Bool)becomeFirstResponder;	// IMP=0x000000000004fa85
- (_Bool)canBecomeFirstResponder;	// IMP=0x000000000004fa7d
- (void)viewDidLoad;	// IMP=0x000000000004e14c
- (void)loadView;	// IMP=0x000000000004e0df
- (void)dealloc;	// IMP=0x000000000004e06a
- (id)initWithController:(id)arg1;	// IMP=0x000000000004df13
