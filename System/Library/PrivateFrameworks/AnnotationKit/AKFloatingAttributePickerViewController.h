...
- (void).cxx_destruct;	// IMP=0x000000000006704b
...
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x0000000000066f07
- (id)convertTextAttributes:(id)arg1;	// IMP=0x0000000000066dc1
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000066c3d
- (void)setRightButtonItems:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000066b10
- (void)valueChanged:(id)arg1;	// IMP=0x0000000000066925
- (void)viewDidLoad;	// IMP=0x00000000000662ed
- (id)initWithController:(id)arg1;	// IMP=0x0000000000066281
