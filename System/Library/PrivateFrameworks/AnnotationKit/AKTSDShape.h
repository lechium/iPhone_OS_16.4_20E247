...
- (void).cxx_destruct;	// IMP=0x000000000004b5f3
...
- (id)_newClippedPath;	// IMP=0x000000000004b321
- (void)p_computeAngle:(double *)arg1 point:(struct CGPoint *)arg2 cutSegment:(long long *)arg3 cutT:(double *)arg4 forLineEndAtHead:(_Bool)arg5;	// IMP=0x000000000004aed8
- (void)p_validateTailLineEnd;	// IMP=0x000000000004ae94
- (void)p_validateHeadLineEnd;	// IMP=0x000000000004ae3f
- (void)p_validateHeadAndTail;	// IMP=0x000000000004adcf
- (void)p_invalidateClippedPath;	// IMP=0x000000000004adab
- (void)p_invalidateTail;	// IMP=0x000000000004ad93
- (void)p_invalidateHead;	// IMP=0x000000000004ad7d
- (id)clippedPathForLineEnds;	// IMP=0x000000000004ad34
- (double)tailLineEndAngle;	// IMP=0x000000000004ad12
- (double)headLineEndAngle;	// IMP=0x000000000004acf0
- (struct CGPoint)tailLineEndPoint;	// IMP=0x000000000004acc9
- (struct CGPoint)headLineEndPoint;	// IMP=0x000000000004aca2
- (double)lineEndScale;	// IMP=0x000000000004ac1a
- (id)strokeTailLineEnd;	// IMP=0x000000000004ab5e
- (id)strokeHeadLineEnd;	// IMP=0x000000000004aaa2
- (void)p_drawLineEndForHead:(_Bool)arg1 withDelta:(struct CGPoint)arg2 inContext:(struct CGContext *)arg3 useFastDrawing:(_Bool)arg4;	// IMP=0x000000000004a951
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000004a871
- (id)init;	// IMP=0x000000000004a837
