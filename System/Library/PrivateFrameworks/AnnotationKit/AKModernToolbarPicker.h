...
- (void).cxx_destruct;	// IMP=0x000000000007877a
...
- (void)revalidateItems:(id)arg1;	// IMP=0x0000000000078711
- (id)initWithFrame:(struct CGRect)arg1 controller:(id)arg2;	// IMP=0x00000000000782d8
