...
- (void).cxx_destruct;	// IMP=0x0000000000002d96
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000002cce
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000002c4a
