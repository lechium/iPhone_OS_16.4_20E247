...
- (void).cxx_destruct;	// IMP=0x000000000006585f
@property __weak AKTextAttributesViewController *parentController; // @synthesize parentController=_parentController;
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x00000000000657c6
- (id)convertTextAttributes:(id)arg1;	// IMP=0x0000000000065743
- (long long)tag;	// IMP=0x0000000000065738
