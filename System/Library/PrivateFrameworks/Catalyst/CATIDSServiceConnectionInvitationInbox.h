...
+ (id)acknowledgeTimerIdentifier;	// IMP=0x00600000000091bc
...
- (void)acknowledgeTimerFiredWithInvitationIdentifier:(id)arg1;	// IMP=0x000000000000903b
- (void)receiveAcknowledgeForInvitationIdentifier:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x0000000000008d1c
- (void)receiveInvitationWithIdentifier:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 messagingVersion:(unsigned long long)arg4 userInfo:(id)arg5;	// IMP=0x000000000000871f
- (id)initWithTimerSource:(id)arg1 assertionProvider:(id)arg2 workQueue:(id)arg3 acknowledgeTimeout:(double)arg4;	// IMP=0x0000000000008621
- (void)dealloc;	// IMP=0x00000000000084c1
