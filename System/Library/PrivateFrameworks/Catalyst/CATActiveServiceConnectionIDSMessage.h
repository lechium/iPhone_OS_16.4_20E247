...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000dbf9
- (void).cxx_destruct;	// IMP=0x000000000000de3d
...
- (id)initWithConnectionIdentifier:(id)arg1 receivedSequenceNumber:(id)arg2 content:(id)arg3;	// IMP=0x000000000000d965
