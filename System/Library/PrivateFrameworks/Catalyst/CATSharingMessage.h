...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000004a0a6
- (void).cxx_destruct;	// IMP=0x000000000004a251
...
- (id)initWithMessageType:(long long)arg1 contentDictionary:(id)arg2;	// IMP=0x0000000000049f2f
- (id)initWithContentMessage:(id)arg1;	// IMP=0x0000000000049ea3
