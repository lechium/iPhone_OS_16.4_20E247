...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000be31
- (void).cxx_destruct;	// IMP=0x000000000000bf00
@property(nonatomic) __weak id <CATIDSServiceConnectionDataAggregatorDelegate> delegate; // @synthesize delegate=_delegate;
- (id)description;	// IMP=0x000000000000be8b
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000bc9f
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000bbcf
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000b869
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b733
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b644
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000b568
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000b444
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000b39b
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000b2b5
