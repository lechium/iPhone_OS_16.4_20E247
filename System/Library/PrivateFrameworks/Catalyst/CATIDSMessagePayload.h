...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000d042
- (void).cxx_destruct;	// IMP=0x000000000000d2cf
...
- (id)messageContent;	// IMP=0x000000000000d20f
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000cea5
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000ce14
