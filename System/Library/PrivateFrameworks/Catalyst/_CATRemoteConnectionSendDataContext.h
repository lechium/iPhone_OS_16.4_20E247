...
- (void).cxx_destruct;	// IMP=0x000000000001bfa5
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001bf10
- (unsigned long long)headerLength;	// IMP=0x000000000001beae
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (id)initWithData:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000000001bcb0
