...
- (void).cxx_destruct;	// IMP=0x0000000000022a30
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x0000000000022a09
- (void)sendMessages;	// IMP=0x0000000000022530
- (void)main;	// IMP=0x000000000002251e
- (_Bool)isAsynchronous;	// IMP=0x0000000000022516
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x0000000000022386
