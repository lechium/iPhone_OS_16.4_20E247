...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000041e8c
- (void).cxx_destruct;	// IMP=0x0000000000041f02
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041d4f
