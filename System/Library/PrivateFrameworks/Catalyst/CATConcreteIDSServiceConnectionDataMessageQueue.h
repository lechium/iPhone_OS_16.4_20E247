...
+ (id)flushTimerIdentifier;	// IMP=0x0010000000041629
- (void).cxx_destruct;	// IMP=0x00000000000419c4
@property(nonatomic) __weak id <CATIDSServiceConnectionDataMessageQueueDelegate> delegate; // @synthesize delegate=_delegate;
- (void)retransmitContent:(id)arg1;	// IMP=0x000000000004185d
- (void)flushTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x00000000000417cc
- (void)scheduleFlushTimer;	// IMP=0x000000000004164e
- (void)retransmitSequenceNumbers:(id)arg1;	// IMP=0x000000000004151d
- (void)receiveRemoteSequenceNumber:(unsigned long long)arg1;	// IMP=0x00000000000413e6
- (void)receiveData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000040f6a
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 dataChunker:(id)arg3 flushPromptInterval:(double)arg4 supportsRetransmit:(_Bool)arg5;	// IMP=0x0000000000040e7e
