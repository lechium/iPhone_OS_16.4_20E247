...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000049cab
- (void).cxx_destruct;	// IMP=0x0000000000049e7b
...
- (id)initWithInvitationIdentifier:(id)arg1 content:(id)arg2;	// IMP=0x0000000000049a7c
