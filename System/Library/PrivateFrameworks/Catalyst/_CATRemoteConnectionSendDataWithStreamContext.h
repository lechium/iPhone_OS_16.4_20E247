...
- (void).cxx_destruct;	// IMP=0x000000000001c54d
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001c251
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (void)dealloc;	// IMP=0x000000000001c14c
- (id)initWithStream:(id)arg1 length:(unsigned long long)arg2 bufferSize:(unsigned long long)arg3 userInfo:(id)arg4;	// IMP=0x000000000001bfd8
