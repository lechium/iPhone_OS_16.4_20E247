...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000041bef
- (void).cxx_destruct;	// IMP=0x0000000000041d27
...
- (id)initWithConnectionIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x0000000000041a42
