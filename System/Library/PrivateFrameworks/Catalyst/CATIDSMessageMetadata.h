...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000001fb6
- (void).cxx_destruct;	// IMP=0x000000000000216c
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x0000000000001dd4
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x0000000000001d53
