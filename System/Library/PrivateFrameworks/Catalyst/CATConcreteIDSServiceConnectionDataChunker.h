...
- (void).cxx_destruct;	// IMP=0x000000000002bca2
- (id)chunkDataIntoMessageContent:(id)arg1;	// IMP=0x000000000002baa7
- (id)initWithWorkQueue:(id)arg1 maxDataLength:(long long)arg2;	// IMP=0x000000000002ba31
