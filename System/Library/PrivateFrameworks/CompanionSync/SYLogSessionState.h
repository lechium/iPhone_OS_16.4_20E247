...
+ (Class)peerType;	// IMP=0x0010000000053c0e
+ (Class)transportOptionsType;	// IMP=0x0010000000053b3c
- (void).cxx_destruct;	// IMP=0x000000000005624c
...
- (unsigned long long)hash;	// IMP=0x000000000005599d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000055688
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055224
- (void)copyTo:(id)arg1;	// IMP=0x0000000000054f9f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000054c15
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000054c08
- (id)dictionaryRepresentation;	// IMP=0x0000000000053ce3
- (id)description;	// IMP=0x0000000000053c34
@property(readonly, nonatomic) _Bool hasReason;
- (id)peerAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000053bf1
- (unsigned long long)peersCount;	// IMP=0x0000000000053bd4
- (void)addPeer:(id)arg1;	// IMP=0x0000000000053b6a
- (void)clearPeers;	// IMP=0x0000000000053b4d
- (id)transportOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000053b1f
- (unsigned long long)transportOptionsCount;	// IMP=0x0000000000053b02
- (void)addTransportOptions:(id)arg1;	// IMP=0x0000000000053a98
- (void)clearTransportOptions;	// IMP=0x0000000000053a7b
...
- (int)StringAsState:(id)arg1;	// IMP=0x0000000000053735
- (id)stateAsString:(int)arg1;	// IMP=0x00000000000536ec
