...
- (void).cxx_destruct;	// IMP=0x00000000001460bf
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000145f7d
- (unsigned long long)hash;	// IMP=0x0000000000145f3e
- (id)description;	// IMP=0x0000000000145ef0
