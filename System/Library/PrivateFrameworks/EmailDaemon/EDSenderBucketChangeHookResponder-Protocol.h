...
- (void)persistenceDidChangeSenderBucketForSenders:(NSArray *)arg1 toBucket:(long long)arg2 generation:(long long)arg3;
- (void)persistenceWillChangeSenderBucketForSenders:(NSArray *)arg1 toBucket:(long long)arg2;
