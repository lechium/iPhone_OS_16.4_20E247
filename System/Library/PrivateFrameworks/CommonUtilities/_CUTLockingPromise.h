...
- (void).cxx_destruct;	// IMP=0x00000000000097d3
...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000009678
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x0000000000009459
- (id)init;	// IMP=0x00000000000093cb
