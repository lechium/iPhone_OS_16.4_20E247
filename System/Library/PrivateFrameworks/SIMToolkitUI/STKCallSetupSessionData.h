...
- (void).cxx_destruct;	// IMP=0x00000000000126c8
...
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x00000000000125e0
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x0000000000012550
- (id)initWithText:(id)arg1 simLabel:(id)arg2 phoneNumber:(id)arg3;	// IMP=0x00000000000124ce
