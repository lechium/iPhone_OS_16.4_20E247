...
- (void).cxx_destruct;	// IMP=0x0000000000010297
...
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x0000000000010156
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x0000000000010077
- (id)initWithText:(id)arg1 simLabel:(id)arg2;	// IMP=0x0000000000010025
