...
+ (id)currentTraitCollection:(id)arg1;	// IMP=0x006000000002a3ee
+ (id)traitEnvironment:(id)arg1 willTransitionToTraitCollection:(id)arg2 fromPreviousTraitCollection:(id)arg3;	// IMP=0x0060000000029e54
+ (id)defaultCollection;	// IMP=0x006000000002978d
- (void).cxx_destruct;	// IMP=0x000000000002a4ee
...
- (void)applyToTraitEnvironment:(id)arg1;	// IMP=0x0000000000029ca7
@property(readonly, nonatomic) UITraitCollection *traitCollection;
- (void)setTMLValue:(id)arg1 forKeyPath:(id)arg2;	// IMP=0x000000000002984f
- (void)tmlDispose;	// IMP=0x000000000002971e
- (id)init;	// IMP=0x00000000000296b2
