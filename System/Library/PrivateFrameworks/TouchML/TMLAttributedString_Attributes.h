...
- (void).cxx_destruct;	// IMP=0x00000000000104a6
...
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x000000000000f5f9
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x000000000000f5de
- (void)setAXAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000f5bf
- (void)setAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000f510
- (void)tmlObjectCompleted;	// IMP=0x000000000000f4b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000f46e
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000f3d3
- (id)init;	// IMP=0x000000000000f3bf
