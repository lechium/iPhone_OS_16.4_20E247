...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x001000000005f015
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x000000000005ebb1
- (_Bool)mergeFromClassDescriptor:(id)arg1;	// IMP=0x000000000005e78c
- (_Bool)canMergeFromClassDescriptor:(id)arg1;	// IMP=0x000000000005e244
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005de84
- (void)addChildClass:(id)arg1;	// IMP=0x000000000005de17
- (void)addMethod:(id)arg1;	// IMP=0x000000000005ddaa
- (void)addSignal:(id)arg1;	// IMP=0x000000000005dd3d
- (id)propertyForName:(id)arg1;	// IMP=0x000000000005dcb2
- (void)addProperty:(id)arg1;	// IMP=0x000000000005dc45
@property(readonly, nonatomic) Class objcClass; // @synthesize objcClass=_objcClass;
- (id)initWithName:(id)arg1 superClassName:(id)arg2 initializer:(id)arg3 optional:(_Bool)arg4;	// IMP=0x000000000005da91
