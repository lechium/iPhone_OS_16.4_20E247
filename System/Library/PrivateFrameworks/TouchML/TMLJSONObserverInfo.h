...
- (void).cxx_destruct;	// IMP=0x000000000002f462
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f321
- (unsigned long long)hash;	// IMP=0x000000000002f317
- (void)notify:(id)arg1;	// IMP=0x000000000002f2bd
- (id)initWithObserver:(id)arg1 keyPath:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000002f1e8
