...
+ (void)initializeJSContext:(id)arg1;	// IMP=0x0010000000017642
...
- (id)CGAffineTransformValue;	// IMP=0x0000000000017603
- (id)initWithAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x00000000000175b4
