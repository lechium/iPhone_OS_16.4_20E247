...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x0060000000039173
- (void).cxx_destruct;	// IMP=0x000000000003939c
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x0000000000038f4e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000038d9c
@property(readonly, nonatomic) Protocol *objcProtocol; // @synthesize objcProtocol=_objcProtocol;
- (void)addSignal:(id)arg1;	// IMP=0x0000000000038ccf
- (id)initWithName:(id)arg1 implementsProtocols:(id)arg2;	// IMP=0x0000000000038bff
