...
+ (void)initializeJSContext:(id)arg1;	// IMP=0x001000000002a7ee
...
- (id)CATransform3DValue;	// IMP=0x000000000002a77c
- (id)initWithTransform3D:(struct CATransform3D)arg1;	// IMP=0x000000000002a705
