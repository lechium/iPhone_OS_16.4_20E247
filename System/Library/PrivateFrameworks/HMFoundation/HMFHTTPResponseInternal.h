...
- (void).cxx_destruct;	// IMP=0x00000000000204fc
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x00000000000203a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020295
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x00000000000201c0
- (id)init;	// IMP=0x0000000000020118
