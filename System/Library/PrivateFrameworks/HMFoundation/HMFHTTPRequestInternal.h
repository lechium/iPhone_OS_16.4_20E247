...
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x0000000000045ede
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000045e9c
- (id)init;	// IMP=0x0000000000045ded
