...
+ (id)animationWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0010000000013de3
- (void).cxx_destruct;	// IMP=0x000000000001413b
...
- (void)completeAnimation;	// IMP=0x0000000000014068
- (_Bool)isAnimating;	// IMP=0x0000000000014051
- (void)update:(double)arg1;	// IMP=0x0000000000013fb8
- (void)dealloc;	// IMP=0x0000000000013f5a
- (id)initWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0000000000013e79
