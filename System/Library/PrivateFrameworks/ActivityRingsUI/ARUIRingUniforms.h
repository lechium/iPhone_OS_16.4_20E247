...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001e341
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001dea4
- (void *)uniformsBytes;	// IMP=0x000000000001de97
- (void *)vertexAttributesBytes;	// IMP=0x000000000001de8d
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001dde9
