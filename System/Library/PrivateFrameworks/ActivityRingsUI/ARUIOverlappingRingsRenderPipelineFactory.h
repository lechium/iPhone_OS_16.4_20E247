...
- (void).cxx_destruct;	// IMP=0x000000000001ca69
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x000000000001c920
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x000000000001c7f5
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x000000000001c6a3
