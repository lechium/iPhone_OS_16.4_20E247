...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001bd60
...
- (void)completeAnimation;	// IMP=0x000000000001c03d
- (_Bool)isAnimating;	// IMP=0x000000000001c02c
- (void)update:(double)arg1;	// IMP=0x000000000001bf29
- (void)dealloc;	// IMP=0x000000000001becb
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001bdf4
