...
- (void).cxx_destruct;	// IMP=0x0000000000014b48
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x0000000000014a72
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x0000000000014971
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000014852
