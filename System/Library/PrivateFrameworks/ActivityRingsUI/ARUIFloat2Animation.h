...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000f09e
...
- (void)completeAnimation;	// IMP=0x000000000000f34c
- (_Bool)isAnimating;	// IMP=0x000000000000f335
- (void)update:(double)arg1;	// IMP=0x000000000000f273
- (void)dealloc;	// IMP=0x000000000000f215
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000f134
