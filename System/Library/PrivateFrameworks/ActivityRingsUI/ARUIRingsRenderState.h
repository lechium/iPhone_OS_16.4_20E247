...
- (_Bool)shouldRunStateForRing:(id)arg1;	// IMP=0x0000000000019060
- (void)didInitialize;	// IMP=0x000000000001904f
- (id)name;	// IMP=0x0000000000019047
- (id)initWithPipelineLibrary:(id)arg1;	// IMP=0x0000000000018f73
- (id)renderPipelineDescriptorFromLibrary:(id)arg1;	// IMP=0x0000000000018f6b
@property(retain, nonatomic) id <MTLRenderPipelineState> renderPipelineState;
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000018e5c
