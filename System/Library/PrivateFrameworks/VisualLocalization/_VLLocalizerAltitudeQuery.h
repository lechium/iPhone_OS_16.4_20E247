...
- (void).cxx_destruct;	// IMP=0x00000000000188c0
...
- (id)initWithLocation:(id)arg1 callbackQueue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x0000000000018770
- (id)init;	// IMP=0x0000000000018740
