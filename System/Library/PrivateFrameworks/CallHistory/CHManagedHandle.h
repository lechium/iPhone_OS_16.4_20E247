...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000bcb8
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000ba4f
+ (id)fetchRequest;	// IMP=0x008000000000d3b2
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000bf8a
