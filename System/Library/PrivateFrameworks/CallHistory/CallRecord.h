...
+ (id)fetchRequest;	// IMP=0x008000000001af8c
...
- (_Bool)supportsJunkConfidence;	// IMP=0x0000000000008ab9
...
- (id)compositeVerificationStatusForContext:(id)arg1;	// IMP=0x00000000000088e2
- (id)compositeServiceProviderForContext:(id)arg1;	// IMP=0x0000000000008844
- (id)compositeRemoteParticipantHandlesForContext:(id)arg1;	// IMP=0x00000000000085b6
- (id)compositeParticipantGroupUUIDForContext:(id)arg1;	// IMP=0x0000000000008572
- (id)compositeOutgoingLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x000000000000852e
- (id)compositeLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x00000000000084ea
- (id)compositeJunkConfidenceForContext:(id)arg1;	// IMP=0x000000000000848a
- (id)compositeHandleTypeForContext:(id)arg1;	// IMP=0x0000000000008455
- (id)compositeCallCategoryForContext:(id)arg1;	// IMP=0x00000000000083a1
