...
- (void).cxx_destruct;	// IMP=0x0000000000011d61
...
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 placeholder:(id)arg3 contentType:(unsigned long long)arg4;	// IMP=0x0000000000011c9d
