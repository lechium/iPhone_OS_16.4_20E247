...
+ (id)defaultConfiguration;	// IMP=0x006000000001c2a5
- (void).cxx_destruct;	// IMP=0x000000000001c655
...
- (id)initWithSubsystem:(id)arg1 category:(id)arg2;	// IMP=0x000000000001c1d8
