...
- (void).cxx_destruct;	// IMP=0x000000000001fc11
...
- (id)_bodyTextFontStyle;	// IMP=0x000000000001fa96
- (id)_createBodyTextFontForTraitCollection:(id)arg1;	// IMP=0x000000000001f9fe
- (id)_bodyTitleFontStyle;	// IMP=0x000000000001f9ea
- (id)_createBodyTitleFontForTraitCollection:(id)arg1;	// IMP=0x000000000001f952
- (id)_subtitleFontStyle;	// IMP=0x000000000001f93e
- (id)_createSubtitleFontForTraitCollection:(id)arg1;	// IMP=0x000000000001f8a6
- (id)_titleFontStyle;	// IMP=0x000000000001f892
- (id)_createTitleFontForTraitCollection:(id)arg1;	// IMP=0x000000000001f7fa
@property(readonly, nonatomic) double primaryButtonCornerRadius;
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x000000000001f49f
