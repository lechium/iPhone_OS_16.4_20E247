...
- (void).cxx_destruct;	// IMP=0x000000000011638f
@property(nonatomic) __weak NSError *expectedError; // @synthesize expectedError=_expectedError;
- (_Bool)attemptRecoveryFromError:(id)arg1 optionIndex:(unsigned long long)arg2;	// IMP=0x0000000000115e5d
- (id)initWithBlock:(CDUnknownBlockType)arg1 operationService:(id)arg2;	// IMP=0x0000000000115dc1
