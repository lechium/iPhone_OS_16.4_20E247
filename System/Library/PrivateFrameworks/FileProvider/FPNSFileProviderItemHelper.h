...
- (void).cxx_destruct;	// IMP=0x000000000011ca06
...
- (id)fp_sharingCurrentUserPermissions;	// IMP=0x000000000011c960
- (id)fp_sharingCurrentUserRole;	// IMP=0x000000000011c827
- (_Bool)fp_isWritable;	// IMP=0x000000000011c7f0
- (_Bool)fp_isReadable;	// IMP=0x000000000011c7bc
- (id)fp_downloadingStatus;	// IMP=0x000000000011c737
