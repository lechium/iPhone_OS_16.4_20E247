...
+ (id)objectFromString:(id)arg1;	// IMP=0x0010000000099b17
+ (id)stringFromObject:(id)arg1;	// IMP=0x001000000009988e
- (void).cxx_destruct;	// IMP=0x00000000001229c2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000012287f
- (unsigned long long)hash;	// IMP=0x0000000000122621
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001224d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001223d4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000122310
- (void)writeTo:(id)arg1;	// IMP=0x0000000000122241
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000122234
- (id)dictionaryRepresentation;	// IMP=0x0000000000121d83
- (id)description;	// IMP=0x0000000000121cd4
