...
- (void).cxx_destruct;	// IMP=0x00000000000c3969
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000000c3808
- (void)main;	// IMP=0x00000000000c2100
- (id)initWithIndexer:(id)arg1 isInitialIndexing:(_Bool)arg2 isOutOfBandIndexing:(_Bool)arg3 queue:(id)arg4;	// IMP=0x00000000000c1e37
