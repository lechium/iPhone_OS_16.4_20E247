...
- (void).cxx_destruct;	// IMP=0x000000000015026e
...
- (id)debugDescription;	// IMP=0x000000000015003e
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x000000000014f96b
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x000000000014f86c
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x000000000014f66e
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x000000000014f655
- (id)init;	// IMP=0x000000000014f099
