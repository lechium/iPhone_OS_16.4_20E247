...
- (void).cxx_destruct;	// IMP=0x00000000001f0a1c
...
- (id)description;	// IMP=0x00000000001f09e8
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2 invalidationCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000000001f08c9
