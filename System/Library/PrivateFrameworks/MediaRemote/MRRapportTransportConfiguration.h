...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000021ae4
- (void).cxx_destruct;	// IMP=0x0000000000021d0f
...
- (id)description;	// IMP=0x0000000000021c76
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000021b5a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021aec
