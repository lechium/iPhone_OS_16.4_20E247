...
- (void).cxx_destruct;	// IMP=0x00000000000604f0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006033c
- (id)description;	// IMP=0x0000000000060200
- (id)initWithEntry:(id)arg1;	// IMP=0x000000000006009d
- (id)initWithPattern:(id)arg1 withFormat:(id)arg2 withLeadingDigitsPatterns:(id)arg3 withNationalPrefixFormattingRule:(id)arg4 whenFormatting:(_Bool)arg5 withDomesticCarrierCodeFormattingRule:(id)arg6;	// IMP=0x000000000005ff92
