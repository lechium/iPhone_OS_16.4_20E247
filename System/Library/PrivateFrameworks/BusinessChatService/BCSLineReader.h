...
- (void).cxx_destruct;	// IMP=0x0000000000049416
...
- (void)dealloc;	// IMP=0x0000000000049332
- (_Bool)hasValidURL;	// IMP=0x00000000000492ee
- (void)refillReadBuffer;	// IMP=0x000000000004918a
- (id)readLine;	// IMP=0x0000000000048c23
- (id)initWithFileURL:(id)arg1 bufferSize:(unsigned long long)arg2 maxLineSize:(unsigned long long)arg3;	// IMP=0x0000000000048b14
- (id)initWithFileURL:(id)arg1;	// IMP=0x0000000000048af7
