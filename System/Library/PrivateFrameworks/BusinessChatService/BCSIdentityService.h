...
- (void).cxx_destruct;	// IMP=0x000000000002b413
- (void)refreshIDStatusForBizID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000002ac03
- (id)businessChatAccount;	// IMP=0x000000000002a930
