...
- (void).cxx_destruct;	// IMP=0x000000000003ebe6
...
- (id)mostExplicitMatchingResultFromResults:(id)arg1;	// IMP=0x000000000003e96f
- (void)matchPatternForURL:(id)arg1 forClientBundleID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003de72
- (id)initWithCacheManager:(id)arg1 metricFactory:(id)arg2;	// IMP=0x000000000003ddd9
