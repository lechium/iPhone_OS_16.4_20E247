...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000009934
- (void).cxx_destruct;	// IMP=0x00000000000099a5
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000097b2
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000009762
- (id)succinctDescriptionBuilder;	// IMP=0x0000000000009581
- (id)succinctDescription;	// IMP=0x0000000000009531
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) _Bool matchFound;
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithOriginalURL:(id)arg1 extractedURL:(id)arg2 totalConsecutivePrefixMatches:(unsigned long long)arg3 totalExactMatches:(unsigned long long)arg4 totalAnyMatches:(unsigned long long)arg5 bundleID:(id)arg6 pattern:(id)arg7 expirationDate:(id)arg8 dateHelper:(id)arg9;	// IMP=0x00000000000092d5
