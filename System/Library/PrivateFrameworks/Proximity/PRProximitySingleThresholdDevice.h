...
- (id).cxx_construct;	// IMP=0x0000000000024d50
- (void).cxx_destruct;	// IMP=0x0000000000024cfa
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (long long)deviceProximity;	// IMP=0x0000000000024cdc
- (_Bool)proxReady;	// IMP=0x0000000000024c69
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x0000000000024be4
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x00000000000248a4
- (id)init;	// IMP=0x0000000000024866
