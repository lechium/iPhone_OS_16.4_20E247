...
- (void).cxx_destruct;	// IMP=0x0000000000013f61
...
- (id)initWithFilter:(void *)arg1 sampleSize:(unsigned long long)arg2 rssiImmediate:(id)arg3 rssiNear:(id)arg4;	// IMP=0x0000000000013e55
