...
- (void).cxx_destruct;	// IMP=0x000000000044be00
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000000044b690
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000044b040
- (void)startThrottlePolicyEventListener;	// IMP=0x000000000044aff0
- (_Bool)startXPCListener;	// IMP=0x000000000044aa70
- (void)registerHelperFunctions;	// IMP=0x0000000000449ee0
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(int)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000000449060
