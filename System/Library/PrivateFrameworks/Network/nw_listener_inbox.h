...
- (void).cxx_destruct;	// IMP=0x000000000064e550
...
- (_Bool)cancel;	// IMP=0x000000000064e2b0
- (_Bool)resume;	// IMP=0x000000000064e180
- (_Bool)isSuspended;	// IMP=0x000000000064e170
- (_Bool)suspend;	// IMP=0x000000000064e040
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000064dd90
- (id)start;	// IMP=0x000000000064dd80
