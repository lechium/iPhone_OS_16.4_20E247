...
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000002facb0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000002fa790
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000002fa1a0
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000002f9770
- (void)dealloc;	// IMP=0x00000000002f9740
- (id)init;	// IMP=0x00000000002f94c0
