...
- (void).cxx_destruct;	// IMP=0x000000000011d760
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000011d6a0
- (id)initWithType:(int)arg1 member:(id)arg2 groupID:(unsigned char [16])arg3;	// IMP=0x000000000011d130
