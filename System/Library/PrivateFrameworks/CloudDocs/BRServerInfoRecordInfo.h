...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000003392
- (unsigned long long)hash;	// IMP=0x000000000000328f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000308f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002f08
- (void)copyTo:(id)arg1;	// IMP=0x0000000000002de4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002cd1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002cc4
- (id)dictionaryRepresentation;	// IMP=0x0000000000002838
- (id)description;	// IMP=0x0000000000002789
