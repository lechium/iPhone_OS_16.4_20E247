...
- (void).cxx_destruct;	// IMP=0x0000000000080d73
...
- (id)centralizedTrashItemID;	// IMP=0x0000000000080ce3
- (id)appLibraryIDToURLMapOfSuppliedURLs;	// IMP=0x000000000008093a
- (id)appLibraryIDToURLMapOfSuppliedAppIDs;	// IMP=0x00000000000805b9
- (id)initWithScopes:(id)arg1 predicate:(id)arg2;	// IMP=0x000000000008011f
