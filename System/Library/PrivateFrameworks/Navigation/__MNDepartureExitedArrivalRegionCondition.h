...
- (void).cxx_destruct;	// IMP=0x00000000000db30e
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000dad83
- (id)initWithUpdater:(id)arg1 arrivalRegions:(id)arg2;	// IMP=0x00000000000dac9e
