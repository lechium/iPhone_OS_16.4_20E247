...
- (void).cxx_destruct;	// IMP=0x00000000000eaf85
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000eaf51
- (void)addObserver:(id)arg1;	// IMP=0x00000000000eaf4b
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000eaefd
