...
- (void).cxx_destruct;	// IMP=0x0000000000016235
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000015e5e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000015cac
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015886
