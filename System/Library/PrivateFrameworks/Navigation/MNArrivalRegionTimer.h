...
- (void)updateForLocation:(id)arg1;	// IMP=0x000000000001f842
- (void)dealloc;	// IMP=0x000000000001f800
- (id)initWithArrivalRegion:(id)arg1;	// IMP=0x000000000001f749
- (id)init;	// IMP=0x000000000001f71f
