...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a3c04
- (void).cxx_destruct;	// IMP=0x00000000000a3f56
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a3df7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a3c0c
