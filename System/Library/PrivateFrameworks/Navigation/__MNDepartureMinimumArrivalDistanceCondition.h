...
- (void).cxx_destruct;	// IMP=0x00000000000da566
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000da19d
- (id)initWithUpdater:(id)arg1 distanceThreshold:(double)arg2;	// IMP=0x00000000000da105
