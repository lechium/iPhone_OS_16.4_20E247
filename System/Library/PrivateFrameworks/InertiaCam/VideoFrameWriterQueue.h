...
- (void).cxx_destruct;	// IMP=0x000000000001df64
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x000000000001dc12
- (void)StartWatchingForFrames;	// IMP=0x000000000001db4f
- (void)FrameRequestCallback;	// IMP=0x000000000001d6c6
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x000000000001d5ee
- (_Bool)WaitForFinish;	// IMP=0x000000000001d39f
- (unsigned long long)FramesInQueue;	// IMP=0x000000000001d350
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000001d2c7
- (void)dealloc;	// IMP=0x000000000001d298
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x000000000001ce79
