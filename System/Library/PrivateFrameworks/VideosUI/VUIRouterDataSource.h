...
- (void).cxx_destruct;	// IMP=0x00000000000960c8
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x0000000000095f53
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000095da3
- (id)initWithLibraryMediaEntity:(id)arg1;	// IMP=0x00000000000960fb
