...
- (void).cxx_destruct;	// IMP=0x0000000000150d22
...
- (id)_prefixForString:(id)arg1;	// IMP=0x0000000000150baa
- (void)recordLog:(id)arg1;	// IMP=0x0000000000150a22
- (id)cacheDownloadedFileFromLocation:(id)arg1;	// IMP=0x0000000000150841
- (id)cachePath;	// IMP=0x00000000001507d0
- (void)cancelDownload;	// IMP=0x0000000000150781
- (void)startDownloadWithSession:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001506d9
- (id)initWithRemoteURL:(id)arg1 shareURL:(id)arg2 fileName:(id)arg3;	// IMP=0x000000000015055a
