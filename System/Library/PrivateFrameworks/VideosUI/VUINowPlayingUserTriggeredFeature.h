...
- (void).cxx_destruct;	// IMP=0x000000000002f20f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f138
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000002efd5
- (id)init;	// IMP=0x000000000002efbc
