...
+ (id)sharedInstance;	// IMP=0x00600000000d0972
- (void).cxx_destruct;	// IMP=0x00000000000d1813
...
- (void)performAgeGateVerificationWithRatingValue:(id)arg1 ratingDomain:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d0ad3
- (void)configureAgeVerification:(id)arg1;	// IMP=0x00000000000d09c7
