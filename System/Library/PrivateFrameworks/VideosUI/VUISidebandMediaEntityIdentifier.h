...
- (void).cxx_destruct;	// IMP=0x00000000001147aa
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000114674
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000114625
- (id)init;	// IMP=0x00000000001145b6
- (id)initWithManagedObjectID:(id)arg1 mediaEntityType:(id)arg2;	// IMP=0x00000000001144d8
