...
- (void).cxx_destruct;	// IMP=0x0000000000157aa8
...
- (void)_locationAuthorizationStatusDidChange:(id)arg1;	// IMP=0x00000000001579ac
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000015773d
- (id)initWithContextData:(id)arg1;	// IMP=0x0000000000157562
