...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x006000000007a6c5
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x006000000007a523
- (void).cxx_destruct;	// IMP=0x000000000007aaab
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x000000000007a6cd
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x000000000007a2dc
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000007a1a7
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x0000000000079f72
