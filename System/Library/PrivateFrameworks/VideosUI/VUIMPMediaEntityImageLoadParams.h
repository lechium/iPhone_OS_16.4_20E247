...
- (void).cxx_destruct;	// IMP=0x000000000012166a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012130f
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x0000000000121151
- (id)initWithMediaItem:(id)arg1 andImageType:(unsigned long long)arg2;	// IMP=0x00000000001210a4
