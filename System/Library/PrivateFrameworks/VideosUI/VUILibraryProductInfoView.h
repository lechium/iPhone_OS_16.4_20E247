...
- (void).cxx_destruct;	// IMP=0x00000000000552c0
...
- (unsigned long long)_columnCount;	// IMP=0x00000000000550da
...
- (double)_sectionInfoWidth;	// IMP=0x0000000000054dfe
- (void)_layouCellContentView:(id)arg1 inCellBounds:(struct CGRect)arg2;	// IMP=0x0000000000054b66
- (double)_maxWidthForGroupInfos:(id)arg1;	// IMP=0x0000000000054b54
- (id)_getNormalizedGroupedInfos;	// IMP=0x0000000000054b06
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000054a80
- (void)layoutSubviews;	// IMP=0x000000000005349a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000526f9
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000526a2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000051ca3
