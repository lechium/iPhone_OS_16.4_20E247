...
- (void).cxx_destruct;	// IMP=0x000000000008d8f8
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x000000000008d73f
- (void)_fetchNext;	// IMP=0x000000000008d387
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x000000000008ce70
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000008cc2e
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000008ca75
- (void)stopAnimation;	// IMP=0x000000000008ca0c
- (void)startAnimation;	// IMP=0x000000000008c94b
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x000000000008c87c
- (id)init;	// IMP=0x000000000008c83a
