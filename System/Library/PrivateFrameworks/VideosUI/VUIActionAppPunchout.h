...
- (void)_openPunchoutURL:(id)arg1;	// IMP=0x00000000001c40ad
- (id)_addMusicAppMetricsToUrl:(id)arg1;	// IMP=0x00000000001c3ee8
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001c3d68
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000001c3c08
