...
- (void).cxx_destruct;	// IMP=0x0000000000468200
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004681a0
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000468120
- (void)contentDidChange;	// IMP=0x0000000000467f60
- (void)layoutSubviews;	// IMP=0x0000000000467f30
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000467960
