...
- (void).cxx_destruct;	// IMP=0x000000000010c914
...
- (void)toggleDefaultBoolValue;	// IMP=0x000000000010c835
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 domain:(id)arg3 defaultName:(id)arg4 boolType:(_Bool)arg5;	// IMP=0x000000000010c71d
