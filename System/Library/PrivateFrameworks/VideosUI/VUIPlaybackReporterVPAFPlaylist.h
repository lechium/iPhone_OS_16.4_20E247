...
- (void).cxx_destruct;	// IMP=0x000000000022dc76
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x000000000022da0d
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x000000000022d834
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000022c839
