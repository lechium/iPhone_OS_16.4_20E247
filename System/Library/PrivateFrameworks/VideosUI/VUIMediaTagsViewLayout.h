...
@interface VUIMediaTagsViewLayout : NSObject
{
    ...
    struct UIEdgeInsets _margin;	// 112 = 0x70
    struct UIEdgeInsets _groupMargin;	// 144 = 0x90
    struct UIEdgeInsets _commonSenseMargin;	// 176 = 0xb0
    struct UIEdgeInsets _tomatoMeterMargin;	// 208 = 0xd0
    struct UIEdgeInsets _badgeMargin;	// 240 = 0xf0
    struct UIEdgeInsets _textBadgeMargin;	// 272 = 0x110
}

- (void).cxx_destruct;	// IMP=0x0000000000068a4d
...
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x0000000000066cc4
- (id)init;	// IMP=0x0000000000066cb0
