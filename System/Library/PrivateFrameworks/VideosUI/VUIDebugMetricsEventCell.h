...
- (void).cxx_destruct;	// IMP=0x000000000001a42d
...
- (void)prepareForReuse;	// IMP=0x000000000001a172
- (void)layoutSubviews;	// IMP=0x0000000000019a08
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x0000000000019949
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x000000000001992c
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x000000000001990f
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000019022
