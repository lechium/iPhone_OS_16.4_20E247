...
+ (id)sharedInstance;	// IMP=0x006000000006947e
- (void).cxx_destruct;	// IMP=0x0000000000069a1c
...
- (void)sendRequestForDeleteID:(id)arg1 isContinueWatching:(_Bool)arg2;	// IMP=0x000000000006958a
- (id)init;	// IMP=0x0000000000069549
- (id)_init;	// IMP=0x00000000000694e3
