...
- (void).cxx_destruct;	// IMP=0x000000000019d891
...
- (long long)_getFallbackVisibilityType;	// IMP=0x000000000019d7e8
- (id)_createVisibilityDictionary;	// IMP=0x000000000019d6a3
- (id)init;	// IMP=0x000000000019d622
