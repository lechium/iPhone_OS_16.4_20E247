...
- (void).cxx_destruct;	// IMP=0x0000000000101390
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x000000000010027c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000ff71c
- (void)_calculateColumnSpacing;	// IMP=0x00000000000ff471
- (_Bool)_useAbbreviationsUI;	// IMP=0x00000000000ff459
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000ff41a
- (void)invalidateData;	// IMP=0x00000000000ff3b2
