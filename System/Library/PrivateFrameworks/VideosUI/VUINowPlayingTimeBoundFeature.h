...
- (void).cxx_destruct;	// IMP=0x000000000002f597
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f40c
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000002f243
- (id)init;	// IMP=0x000000000002f21f
