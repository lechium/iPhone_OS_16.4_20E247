...
- (void).cxx_destruct;	// IMP=0x0000000000253dc6
...
- (id)description;	// IMP=0x0000000000253cba
- (void)loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000253ad4
@property(readonly, nonatomic) NSString *subHeader;
@property(readonly, nonatomic) NSString *title;
- (id)initWithElement:(id)arg1 prev:(id)arg2;	// IMP=0x00000000002538b5
