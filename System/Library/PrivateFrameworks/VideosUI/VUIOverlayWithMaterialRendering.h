...
- (void).cxx_destruct;	// IMP=0x00000000001d2534
@property(nonatomic) struct CGRect croppedRect; // @synthesize croppedRect=_croppedRect;
@property(nonatomic) struct CGRect rect; // @synthesize rect=_rect;
@property(copy, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
- (id)init;	// IMP=0x00000000001d2450
- (id)initWithIdentifier:(id)arg1 rect:(struct CGRect)arg2 croppedRect:(struct CGRect)arg3;	// IMP=0x00000000001d23a9
