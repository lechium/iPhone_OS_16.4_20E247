...
- (void).cxx_destruct;	// IMP=0x000000000015b35e
...
- (void)_applicationDidEnterBackground:(id)arg1;	// IMP=0x000000000015b2fb
- (void)_cleanupPreviewInteraction;	// IMP=0x000000000015b254
- (void)animateTransition:(id)arg1;	// IMP=0x000000000015b05f
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000015b051
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x000000000015afbe
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x000000000015afb5
- (void)previewInteractionDidCancel:(id)arg1;	// IMP=0x000000000015af27
- (void)previewInteraction:(id)arg1 didUpdatePreviewTransition:(double)arg2 ended:(_Bool)arg3;	// IMP=0x000000000015ae38
- (_Bool)previewInteractionShouldBegin:(id)arg1;	// IMP=0x0000000000159cc9
- (void)dismissConfirmation;	// IMP=0x0000000000159c31
- (void)dealloc;	// IMP=0x0000000000159baf
- (id)initWithPresentingViewController:(id)arg1 collectionView:(id)arg2 controllerToPresent:(id)arg3;	// IMP=0x0000000000159a69
