...
- (void).cxx_destruct;	// IMP=0x000000000012ea78
...
- (void)_updateDownloadStateAndNotifyDelegates;	// IMP=0x000000000012de75
- (void)_updateObservedDownload;	// IMP=0x000000000012da90
- (void)download:(id)arg1 progressDidChange:(double)arg2;	// IMP=0x000000000012da7e
- (void)download:(id)arg1 didChangeStateTo:(long long)arg2;	// IMP=0x000000000012da6c
- (void)downloadManagerDownloadsDidChange:(id)arg1;	// IMP=0x000000000012da3e
- (void)cancelKeyFetch;	// IMP=0x000000000012d7b4
- (void)cancelAndRemoveDownload;	// IMP=0x000000000012d46f
- (void)resumeDownload;	// IMP=0x000000000012d1c2
- (void)pauseDownload;	// IMP=0x000000000012cf15
- (void)fetchNewKeysForDownloadedVideo;	// IMP=0x000000000012cd4c
- (void)deleteAndRedownloadAllowingCellular:(_Bool)arg1 quality:(long long)arg2 shouldMarkAsDeletedOnCancellationOrFailure:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000012cd3a
- (void)startDownloadAllowingCellular:(_Bool)arg1 quality:(long long)arg2 shouldMarkAsDeletedOnCancellationOrFailure:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000012ca6d
- (void)invalidate;	// IMP=0x000000000012ca67
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000012bdf9
- (void)dealloc;	// IMP=0x000000000012bda6
- (id)initWithVideoManagedObject:(id)arg1 mediaEntityIdentifier:(id)arg2;	// IMP=0x000000000012bbf4
