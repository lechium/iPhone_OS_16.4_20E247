...
- (void).cxx_destruct;	// IMP=0x0000000000290fe0
...
- (void)_updateForStyleChange;	// IMP=0x0000000000290d53
- (id)_maskImageForProgressBar;	// IMP=0x0000000000290b81
- (void)_layoutMaterialView;	// IMP=0x0000000000290a70
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000002905b5
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000290269
- (void)layoutSubviews;	// IMP=0x000000000028ff37
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000028fc62
