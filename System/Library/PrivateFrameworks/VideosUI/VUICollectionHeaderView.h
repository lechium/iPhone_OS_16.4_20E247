...
+ (id)configureCollectionHeaderViewWithTitle:(id)arg1 subtitle:(id)arg2 buttonString:(id)arg3 existingView:(id)arg4;	// IMP=0x00600000001f1d33
- (void).cxx_destruct;	// IMP=0x00000000001f3589
...
- (void)_selectButtonAction:(id)arg1;	// IMP=0x00000000001f348f
- (id)_buttonWithString:(id)arg1 existingButton:(id)arg2;	// IMP=0x00000000001f32b2
- (void)tintColorDidChange;	// IMP=0x00000000001f3209
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x00000000001f23b2
- (void)layoutSubviews;	// IMP=0x00000000001f2367
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001f2350
