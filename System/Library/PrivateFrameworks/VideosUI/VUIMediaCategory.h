...
+ (id)mediaCatgeoryForType:(unsigned long long)arg1;	// IMP=0x00600000000d3f18
- (void).cxx_destruct;	// IMP=0x00000000000d46d4
...
- (id)description;	// IMP=0x00000000000d42ea
- (id)_initWithType:(unsigned long long)arg1;	// IMP=0x00000000000d4263
- (id)init;	// IMP=0x00000000000d41f4
