...
- (void).cxx_destruct;	// IMP=0x00000000001e5337
...
- (void)_layoutLabels:(id)arg1 withOrigin:(struct CGPoint)arg2 maxWidth:(double)arg3;	// IMP=0x00000000001e4e9e
- (double)_subscribeButtonHeight;	// IMP=0x00000000001e4d1e
- (_Bool)_isSubscribed;	// IMP=0x00000000001e4cbd
- (struct CGSize)_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001e2b61
@property(readonly, nonatomic) double topThreshold;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001e2afe
- (void)setVuiBackgroundColor:(id)arg1;	// IMP=0x00000000001e2457
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e2316
