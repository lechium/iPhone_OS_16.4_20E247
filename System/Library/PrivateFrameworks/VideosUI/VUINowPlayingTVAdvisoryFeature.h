...
- (void).cxx_destruct;	// IMP=0x000000000002fb3d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f9ce
@property(readonly) unsigned long long hash;
@property(nonatomic, getter=isSkippable) _Bool skippable;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000002f94b
