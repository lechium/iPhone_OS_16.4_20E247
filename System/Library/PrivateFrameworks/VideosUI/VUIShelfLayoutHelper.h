...
- (void).cxx_destruct;	// IMP=0x00000000000832f7
...
- (void)_freeBuffers;	// IMP=0x0000000000083243
- (void)_compute;	// IMP=0x0000000000082617
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000082579
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x000000000008253e
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000082503
- (void)dealloc;	// IMP=0x00000000000824c5
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000082451
