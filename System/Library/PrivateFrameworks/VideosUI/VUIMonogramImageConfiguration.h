...
- (void).cxx_destruct;	// IMP=0x000000000017ff40
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017fd47
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000017fc67
