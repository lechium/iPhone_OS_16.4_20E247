...
- (void).cxx_destruct;	// IMP=0x00000000000ce7dd
...
- (id)accountsForAccountManager:(id)arg1;	// IMP=0x00000000000ce6fc
- (void)presentFamilySetupScreenWithBuyParams:(id)arg1;	// IMP=0x00000000000ce57b
- (void)presentFamilySetupScreenIfEligible:(id)arg1 checkEligibility:(_Bool)arg2;	// IMP=0x00000000000cdf42
- (id)init;	// IMP=0x00000000000cde78
