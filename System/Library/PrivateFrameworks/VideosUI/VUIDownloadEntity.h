...
- (void).cxx_destruct;	// IMP=0x000000000008447d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000841b6
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084100
- (void)mediaEntityAssetController:(id)arg1 stateDidChange:(id)arg2;	// IMP=0x0000000000083feb
- (void)_clearAssetControllers;	// IMP=0x0000000000083ec0
- (void)_configureWithMediaEntities:(id)arg1;	// IMP=0x00000000000839b9
- (void)dealloc;	// IMP=0x000000000008344c
- (id)initWithMediaEntities:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x00000000000833bf
- (id)initWithMediaEntity:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x0000000000083308
