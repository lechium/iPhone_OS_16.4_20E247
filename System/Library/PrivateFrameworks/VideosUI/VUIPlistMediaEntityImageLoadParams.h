...
- (void).cxx_destruct;	// IMP=0x000000000028cbf6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000028c755
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x000000000028c57f
- (id)initWithImageURL:(id)arg1 baseImageIdentifier:(id)arg2 imageType:(unsigned long long)arg3;	// IMP=0x000000000028c45a
