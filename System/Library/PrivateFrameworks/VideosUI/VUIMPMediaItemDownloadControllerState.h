...
- (void).cxx_destruct;	// IMP=0x000000000028f8bb
...
- (id)description;	// IMP=0x000000000028f3d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000028f215
- (unsigned long long)hash;	// IMP=0x000000000028f129
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000028f0d1
- (id)init;	// IMP=0x000000000028f06d
