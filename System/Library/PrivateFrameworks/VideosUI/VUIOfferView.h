...
- (void).cxx_destruct;	// IMP=0x00000000000797fa
...
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000000795a9
- (struct CGSize)computeSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000794f1
- (void)layoutOfferSubviewsWithSize:(struct CGSize)arg1;	// IMP=0x000000000007878f
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000078759
- (double)_chinHeightForSize:(struct CGSize)arg1;	// IMP=0x000000000007817b
- (_Bool)_shouldDisplaySeparator;	// IMP=0x0000000000078137
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x0000000000078089
- (void)prepareForCellReuse;	// IMP=0x0000000000077b98
