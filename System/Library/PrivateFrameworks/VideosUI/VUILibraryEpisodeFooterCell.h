...
- (void).cxx_destruct;	// IMP=0x0000000000180b71
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000180727
- (void)layoutSubviews;	// IMP=0x0000000000180389
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000018028b
