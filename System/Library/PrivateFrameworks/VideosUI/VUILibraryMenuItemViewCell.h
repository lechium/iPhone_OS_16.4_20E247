...
- (void).cxx_destruct;	// IMP=0x00000000001c0c42
...
- (void)layoutSubviews;	// IMP=0x00000000001c0504
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001c039d
- (_Bool)hasImage;	// IMP=0x00000000001c02f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001bfd9e
