...
+ (int)_textBlendMode;	// IMP=0x0060000000210889
+ (id)_textColor:(long long)arg1;	// IMP=0x006000000021082a
+ (id)scoreboardCLayoutWithInnerMargin:(double)arg1;	// IMP=0x0060000000210627
+ (id)scoreboardBLayout;	// IMP=0x00600000002103f7
+ (id)scoreboardALayout;	// IMP=0x00600000002101b6
- (void).cxx_destruct;	// IMP=0x0000000000210929
