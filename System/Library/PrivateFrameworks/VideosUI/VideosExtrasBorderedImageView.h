...
- (void)replicateStateFromImageView:(id)arg1;	// IMP=0x000000000000e478
@property(nonatomic) double borderWidth;
@property(copy, nonatomic) UIColor *borderColor;
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x000000000000e249
- (void)setTransform:(struct CGAffineTransform)arg1;	// IMP=0x000000000000e1d4
