...
- (void).cxx_destruct;	// IMP=0x000000000006da8b
...
- (void)prepareForReuse;	// IMP=0x000000000006d9a9
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000006d7b3
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000006d6e3
