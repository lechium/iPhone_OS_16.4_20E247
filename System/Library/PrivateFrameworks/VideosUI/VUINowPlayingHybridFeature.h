...
- (void).cxx_destruct;	// IMP=0x000000000002f93b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f79c
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000002f5cb
- (id)init;	// IMP=0x000000000002f5a7
