...
- (void).cxx_destruct;	// IMP=0x000000000003b3ba
...
- (void)_handleSingleTap:(id)arg1;	// IMP=0x000000000003b0ee
- (void)_handlePinch:(id)arg1;	// IMP=0x000000000003afb6
- (void)_handleDoubleTap:(id)arg1;	// IMP=0x000000000003aedd
...
- (void)finalizeZoomingImageTransitionWithContext:(id)arg1 transitionFinished:(_Bool)arg2;	// IMP=0x000000000003a851
- (void)performZoomingImageTransitionWithContext:(id)arg1;	// IMP=0x000000000003a7df
- (void)prepareZoomingImageTransitionWithContext:(id)arg1;	// IMP=0x000000000003a738
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000003a6a5
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000003a65f
- (void)updateViewConstraints;	// IMP=0x0000000000039c2a
- (void)viewDidLoad;	// IMP=0x0000000000039249
- (_Bool)prefersStatusBarHidden;	// IMP=0x0000000000039205
- (void)dealloc;	// IMP=0x00000000000390ad
