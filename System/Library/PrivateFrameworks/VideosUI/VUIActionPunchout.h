...
- (void).cxx_destruct;	// IMP=0x0000000000284e76
...
- (_Bool)isAccountRequired;	// IMP=0x0000000000284cc9
- (_Bool)_isValidAppInstalled;	// IMP=0x00000000002849f7
- (void)_openPunchoutURL:(CDUnknownBlockType)arg1;	// IMP=0x0000000000283bbc
- (void)_showErrorMessageAlert:(id)arg1;	// IMP=0x0000000000283636
- (void)_openAirplayPicker:(CDUnknownBlockType)arg1;	// IMP=0x0000000000283356
- (void)_startAppInstallFlow:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000282e97
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000282a23
- (_Bool)canPerformNow;	// IMP=0x00000000002829ec
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000002826c7
