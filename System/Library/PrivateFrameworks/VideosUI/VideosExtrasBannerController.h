...
- (void).cxx_destruct;	// IMP=0x00000000001a3a91
...
- (void)_updateVignetteImage;	// IMP=0x00000000001a3950
- (void)installBannerOnView:(id)arg1 anchoredToScrollView:(id)arg2;	// IMP=0x00000000001a38d9
- (void)_doAllSetup;	// IMP=0x00000000001a3304
- (void)_configureBanner;	// IMP=0x00000000001a3076
- (id)initWithBannerElement:(id)arg1;	// IMP=0x00000000001a2f9c
