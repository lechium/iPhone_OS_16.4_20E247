...
- (void).cxx_destruct;	// IMP=0x000000000022358b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002234cb
- (id)initWithMainMenuItems:(id)arg1 genreMenuItems:(id)arg2;	// IMP=0x0000000000223432
