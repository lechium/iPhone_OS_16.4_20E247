...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x006000000006a91c
+ (id)_pieImagesMemoryPool;	// IMP=0x006000000006a86e
...
- (id)_maskImage;	// IMP=0x000000000006b1af
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000006b025
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000006af4f
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000006ada8
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000006acc2
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000006a6ac
- (void)_clearDisplayLink;	// IMP=0x000000000006a674
- (void)_ensureDisplayLink;	// IMP=0x000000000006a5c1
- (void)_onDisplayLink:(id)arg1;	// IMP=0x000000000006a4b9
- (void)_clearTransitionIfComplete:(id *)arg1;	// IMP=0x000000000006a482
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000006a399
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000006a292
- (void)_updatePausedTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000006a226
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x000000000006a07a
- (_Bool)_hasActiveTransitions;	// IMP=0x000000000006a047
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x0000000000069f4f
- (void)dealloc;	// IMP=0x0000000000069eae
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000069e2a
