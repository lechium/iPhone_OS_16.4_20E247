...
- (void).cxx_destruct;	// IMP=0x00000000000d3eda
...
- (void)dealloc;	// IMP=0x00000000000d3e69
- (void)removeManagedReferences;	// IMP=0x00000000000d3d36
- (id)description;	// IMP=0x00000000000d3cb4
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000d3b04
