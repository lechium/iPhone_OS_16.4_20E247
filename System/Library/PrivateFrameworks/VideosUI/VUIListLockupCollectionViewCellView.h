...
- (void).cxx_destruct;	// IMP=0x000000000006f600
...
- (void)vui_prepareForReuse;	// IMP=0x000000000006f48d
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000006e117
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000006e0b5
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000006e06a
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000006dfe4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006dc5d
