...
- (void).cxx_destruct;	// IMP=0x00000000000bb083
...
- (id)_resultWithResponses:(id)arg1;	// IMP=0x00000000000baf1d
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x00000000000bac9e
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000baaea
- (void)_startMediaLibraryFetchOperation;	// IMP=0x00000000000ba89d
- (void)cancel;	// IMP=0x00000000000ba81f
- (void)executionDidBegin;	// IMP=0x00000000000ba80d
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2 requests:(id)arg3;	// IMP=0x00000000000ba740
