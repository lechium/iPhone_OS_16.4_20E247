...
- (void).cxx_destruct;	// IMP=0x000000000045fd80
@property(nonatomic, readonly) VUILabel *accessibilityTitleLabel;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000045fca0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000045e930
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000045e8f0
