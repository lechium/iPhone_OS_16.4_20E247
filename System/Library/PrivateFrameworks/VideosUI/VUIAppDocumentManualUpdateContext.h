...
- (void).cxx_destruct;	// IMP=0x0000000000005851
...
- (void)updateCurrentUpdateRequestWithAppContext:(id)arg1 documentRef:(id)arg2;	// IMP=0x0000000000005694
- (void)updateRequestCompletedWithViewElements:(id)arg1 documentRef:(id)arg2;	// IMP=0x000000000000568e
- (id)initWithContextDictionary:(id)arg1 viewElement:(id)arg2;	// IMP=0x00000000000055f5
- (id)init;	// IMP=0x0000000000005586
