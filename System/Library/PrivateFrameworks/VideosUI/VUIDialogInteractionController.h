...
- (void).cxx_destruct;	// IMP=0x00000000000367ba
...
- (void)_cleanup;	// IMP=0x00000000000366d2
- (void)interactionController:(id)arg1 didEndForIndexPath:(id)arg2;	// IMP=0x00000000000366c0
- (void)interactionController:(id)arg1 didBeginForIndexPath:(id)arg2;	// IMP=0x0000000000036664
- (_Bool)interactionController:(id)arg1 shouldInteractionControllerBeginForIndexPath:(id)arg2;	// IMP=0x00000000000365e7
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000363f2
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000363e4
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x0000000000036351
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000000036348
- (void)presentViewController:(id)arg1;	// IMP=0x0000000000035b1f
- (void)longPressGestureRecognizerPressed:(id)arg1;	// IMP=0x0000000000035a75
- (void)dismissConfirmation;	// IMP=0x00000000000358d8
- (id)initWithPresentingViewController:(id)arg1 collectionView:(id)arg2 controllerToPresent:(id)arg3;	// IMP=0x00000000000356f8
