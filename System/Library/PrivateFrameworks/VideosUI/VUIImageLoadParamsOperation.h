...
- (void).cxx_destruct;	// IMP=0x0000000000228613
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x0000000000228441
- (id)init;	// IMP=0x00000000002283d2
