...
- (void).cxx_destruct;	// IMP=0x0000000000228859
...
- (id)previewController:(id)arg1 previewItemAtIndex:(long long)arg2;	// IMP=0x0000000000228760
- (long long)numberOfPreviewItemsInPreviewController:(id)arg1;	// IMP=0x0000000000228755
- (id)initWithQuickLookWebKitItem:(id)arg1;	// IMP=0x00000000002286d5
- (id)initWithQuickLookPreviewItem:(id)arg1;	// IMP=0x0000000000228655
