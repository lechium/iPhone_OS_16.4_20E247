...
+ (id)productLockupViewWithMedia:(id)arg1;	// IMP=0x0010000000207589
- (void).cxx_destruct;	// IMP=0x000000000020bf9a
...
- (id)_contentDescriptionFont;	// IMP=0x000000000020bc39
- (struct CGSize)_layoutForStacked:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x000000000020aeb1
- (struct CGSize)_layoutForCompact:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x000000000020a25f
- (struct CGSize)_layoutForCategoryAccessibility:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000209c4f
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000209a37
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x00000000002099b4
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x00000000002098f3
- (struct CGSize)_sizeOfDescriptionLabel:(double)arg1;	// IMP=0x000000000020975b
- (id)_contentDescriptionAttributedString;	// IMP=0x000000000020947f
- (void)_updateSubtitleLabelForWindowWidth:(double)arg1;	// IMP=0x00000000002093d2
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x00000000002093a1
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000002090e6
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002090cf
- (void)layoutSubviews;	// IMP=0x000000000020903c
- (void)setCoverArtImageProxy:(id)arg1 placeholderImage:(id)arg2;	// IMP=0x000000000020876f
- (void)updateWithMediaEntity:(id)arg1;	// IMP=0x0000000000207717
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020760a
