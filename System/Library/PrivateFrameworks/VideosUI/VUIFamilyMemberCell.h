...
+ (id)_monogramViewForFamilyMemberCell:(id)arg1;	// IMP=0x001000000027929c
+ (double)maxMonogramHeight;	// IMP=0x0010000000279271
+ (void)configureVUIFamilyMemberCell:(id)arg1 withFamilyMember:(id)arg2 metricsOnly:(_Bool)arg3;	// IMP=0x00100000002785f5
- (void).cxx_destruct;	// IMP=0x0000000000279fa2
...
- (struct CGSize)_iOS_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000002796ea
- (void)configureMonogramImageLayoutForWindowWidth:(double)arg1;	// IMP=0x000000000027966b
@property(readonly, nonatomic) struct CGSize monogramSize;
- (void)familyMember:(id)arg1 photoRequestDidCompleteWithImage:(id)arg2;	// IMP=0x0000000000279095
- (void)layoutSubviews;	// IMP=0x000000000027902c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000279015
- (void)prepareForReuse;	// IMP=0x0000000000278c67
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000278949
