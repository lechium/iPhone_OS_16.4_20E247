...
- (void).cxx_destruct;	// IMP=0x000000000014cf24
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000014c667
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000014c589
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014c4c2
- (unsigned long long)hash;	// IMP=0x000000000014c454
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x000000000014c398
