...
- (void).cxx_destruct;	// IMP=0x00000000001b4f57
- (void)configureForHeaderElement:(id)arg1 headerStyle:(id)arg2;	// IMP=0x00000000001b4a0f
- (void)_configureConstraintsForInsets:(struct UIEdgeInsets)arg1;	// IMP=0x00000000001b4918
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b46a4
