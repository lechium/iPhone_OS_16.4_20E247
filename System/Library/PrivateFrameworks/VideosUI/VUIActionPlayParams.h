...
+ (id)playParamsWithMediaInfo:(id)arg1 watchType:(long long)arg2 isRentAndWatchNow:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000001a9a71
- (void).cxx_destruct;	// IMP=0x00000000001a9b83
