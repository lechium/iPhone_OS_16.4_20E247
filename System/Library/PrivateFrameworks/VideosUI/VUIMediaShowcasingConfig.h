...
@interface VUIMediaShowcasingConfig : NSObject
{
    ...
    _Bool _shouldShowFullScreenButton;	// 13 = 0xd
    _Bool _gradientUsesImageColor;	// 14 = 0xe
    ...
    double _hideMuteButtonDelayDuration;	// 136 = 0x88
    double _hidePageIndicatorsDelayDuration;	// 144 = 0x90
}
...
- (id)init;	// IMP=0x000000000019d0a6
