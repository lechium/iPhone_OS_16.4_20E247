...
+ (void)initialize;	// IMP=0x001000000008d929
- (void).cxx_destruct;	// IMP=0x000000000008f9d8
...
- (void)_registerStateMachineHandlers;	// IMP=0x000000000008e34b
- (void)downloadManagerDownloadsDidChange:(id)arg1;	// IMP=0x000000000008df23
- (void)downloadManager:(id)arg1 downloadStatesDidChange:(id)arg2;	// IMP=0x000000000008dc2d
- (void)waitForDownloadToBecomePlayableWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000008db3c
- (void)dealloc;	// IMP=0x000000000008daf7
- (id)initWithDownload:(id)arg1 downloadManager:(id)arg2;	// IMP=0x000000000008d979
