...
+ (id)sharedInstance;	// IMP=0x0060000000115314
...
- (id)_trimHistoryArray:(id)arg1 forMaxCount:(unsigned long long)arg2 inDurationWindow:(double)arg3 atCurrentDate:(id)arg4;	// IMP=0x0000000000116a1d
- (_Bool)_isHistoryArrayFull:(id)arg1 forMaxCount:(unsigned long long)arg2 inDurationWindow:(double)arg3;	// IMP=0x00000000001168f1
- (id)_cleanupHistory:(id)arg1 atCurrentDate:(id)arg2 isShow:(_Bool)arg3;	// IMP=0x00000000001165f1
- (void)_recordUpsellHistoryForShowId:(id)arg1 onChannelId:(id)arg2;	// IMP=0x0000000000116235
- (_Bool)_isFullScreenPlaybackUIShown;	// IMP=0x00000000001161ea
- (_Bool)canShowUpsellForMediaItem:(id)arg1 withElapsedTime:(double)arg2;	// IMP=0x0000000000115a3f
- (void)setChannelLevelUpsellRateOfMaxCount:(unsigned long long)arg1 inHours:(double)arg2;	// IMP=0x0000000000115948
- (void)setShowLevelUpsellRateOfMaxCount:(unsigned long long)arg1 inHours:(double)arg2;	// IMP=0x0000000000115851
- (void)setMinPlaybackProgressPercentageForUpsellOnExit:(double)arg1;	// IMP=0x00000000001157a0
- (void)enableUpsellOnPIPPlaybackExit:(_Bool)arg1;	// IMP=0x00000000001156ef
- (void)disableUpsellOnPlaybackExit:(_Bool)arg1;	// IMP=0x000000000011563e
- (void)configureUsingDictionary:(id)arg1;	// IMP=0x00000000001153cc
