...
- (void).cxx_destruct;	// IMP=0x00000000002cfcb8
...
- (id)getCanonicalID;	// IMP=0x00000000002cfbd6
@property(readonly, nonatomic) NSArray *videosPlayables;
- (id)notificationBody;	// IMP=0x00000000002cfbab
- (id)notificationTitle;	// IMP=0x00000000002cfb8e
@property(readonly, nonatomic) NSString *title;
@property(readonly, nonatomic) NSString *buyParams;
@property(readonly, nonatomic) _Bool playWhenDone;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002cf8d2
