...
- (struct CGRect)lastItemFrame;	// IMP=0x000000000007f5ed
- (struct CGRect)firstItemFrame;	// IMP=0x000000000007f5c2
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x000000000007f5a3
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x000000000007f582
- (void)dealloc;	// IMP=0x000000000007f4f8
