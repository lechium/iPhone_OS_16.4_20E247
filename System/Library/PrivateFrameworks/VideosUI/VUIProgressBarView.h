...
- (void).cxx_destruct;	// IMP=0x000000000029185d
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x000000000029163b
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000002910c8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000291066
