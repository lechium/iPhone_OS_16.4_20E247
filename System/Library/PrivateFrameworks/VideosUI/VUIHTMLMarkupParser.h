...
+ (void)initialize;	// IMP=0x0060000000182e08
- (void).cxx_destruct;	// IMP=0x0000000000183633
...
- (void)parse;	// IMP=0x00000000001830b4
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x0000000000182f73
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x0000000000182eed
- (id)init;	// IMP=0x0000000000182ec2
- (id)initWithString:(id)arg1;	// IMP=0x0000000000182e4f
