...
+ (id)_actionForKey:(id)arg1 eventDict:(id)arg2 appContext:(id)arg3;	// IMP=0x00600000002f7d13
+ (id)_documentDataSourceWithDict:(id)arg1;	// IMP=0x00600000002f7cfa
+ (id)attachPrefetchedDict:(id)arg1 eventDict:(id)arg2;	// IMP=0x00600000002f7c03
+ (id)eventDataSourceWithEventDict:(id)arg1 appContext:(id)arg2;	// IMP=0x00600000002f7946
+ (id)selectEventDataSourceWithLibraryMediaEntity:(id)arg1;	// IMP=0x00600000002f7f2a
- (void).cxx_destruct;	// IMP=0x00000000002f7e60
...
- (id)_initWithLibraryMediaEntity:(id)arg1;	// IMP=0x00000000002f7ebf
