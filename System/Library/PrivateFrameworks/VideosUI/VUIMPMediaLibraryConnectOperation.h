...
- (void).cxx_destruct;	// IMP=0x0000000000292575
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x0000000000292372
- (void)_stopProgressTimer;	// IMP=0x000000000029231f
- (void)_startProgressTimer;	// IMP=0x00000000002921cb
- (void)executionDidBegin;	// IMP=0x0000000000291e9c
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x0000000000291df7
- (id)init;	// IMP=0x0000000000291d88
