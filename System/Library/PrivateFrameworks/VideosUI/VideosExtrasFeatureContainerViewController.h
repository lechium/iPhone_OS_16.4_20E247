...
- (void).cxx_destruct;	// IMP=0x000000000007be1c
...
- (void)_menuBarHeightChange:(id)arg1;	// IMP=0x000000000007bb19
- (id)childViewControllerForHomeIndicatorAutoHidden;	// IMP=0x000000000007b44d
- (void)viewDidLoad;	// IMP=0x000000000007b3e1
- (void)dealloc;	// IMP=0x000000000007b36c
- (id)initWithContext:(id)arg1;	// IMP=0x000000000007b2a9
