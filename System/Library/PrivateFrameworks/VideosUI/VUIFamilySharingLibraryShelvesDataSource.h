...
- (void).cxx_destruct;	// IMP=0x0000000000275bb2
...
- (id)_dataSourceForShelves;	// IMP=0x00000000002758cd
- (void)dataSourceDidFinishFetching:(id)arg1;	// IMP=0x00000000002756ed
- (void)startFetch;	// IMP=0x000000000027567b
- (void)dealloc;	// IMP=0x0000000000275632
- (id)initWithValidShelfTypes:(id)arg1 withFamilyMember:(id)arg2;	// IMP=0x00000000002755ba
