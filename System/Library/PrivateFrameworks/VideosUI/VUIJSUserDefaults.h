...
- (void).cxx_destruct;	// IMP=0x00000000001ff7e4
...
- (void)removeData:(id)arg1;	// IMP=0x00000000001ff745
- (void)setData:(id)arg1:(id)arg2;	// IMP=0x00000000001ff570
- (id)getData:(id)arg1;	// IMP=0x00000000001ff41f
- (id)initWithAppContext:(id)arg1 userDefaultsStorage:(id)arg2;	// IMP=0x00000000001ff3ae
