...
- (void).cxx_destruct;	// IMP=0x0000000000232c4d
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x0000000000232a0c
...
- (id)_sortKeys:(id)arg1;	// IMP=0x0000000000232755
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000000231a72
