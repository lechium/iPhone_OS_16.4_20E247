...
+ (void)configureEpisodeFrameView:(id)arg1 withMedia:(id)arg2 layout:(long long)arg3 imageSize:(struct CGSize)arg4;	// IMP=0x00600000001a6d21
- (void).cxx_destruct;	// IMP=0x00000000001a85e4
...
- (void)_playButtonPressed;	// IMP=0x00000000001a84f4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001a848d
- (void)layoutSubviews;	// IMP=0x00000000001a810a
