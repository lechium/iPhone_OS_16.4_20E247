...
- (void).cxx_destruct;	// IMP=0x000000000010c521
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010c419
...
- (id)initWithVideoManagedObject:(id)arg1 imageType:(unsigned long long)arg2;	// IMP=0x000000000010be9a
