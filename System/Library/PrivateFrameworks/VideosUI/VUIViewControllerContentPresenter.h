...
- (void).cxx_destruct;	// IMP=0x00000000000afc70
...
- (id)_logNameForContentViewType:(unsigned long long)arg1;	// IMP=0x00000000000afb6c
- (id)_createAlertViewWithTitle:(id)arg1 description:(id)arg2;	// IMP=0x00000000000af9e1
- (void)configureCurrentViewFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000000af482
- (void)setRootViewForViewController:(id)arg1;	// IMP=0x00000000000af3d9
