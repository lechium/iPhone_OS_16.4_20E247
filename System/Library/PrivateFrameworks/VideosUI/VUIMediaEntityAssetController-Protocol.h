...
@class NSObject, OS_dispatch_queue, VUIMediaEntityAssetControllerState, VUIMediaEntityType;
...
@property(retain, nonatomic) OS_dispatch_queue *completionDispatchQueue;
