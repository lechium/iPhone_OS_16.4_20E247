...
+ (void)configureEpisodeDetailView:(id)arg1 withMedia:(id)arg2 viewSize:(struct CGSize)arg3;	// IMP=0x001000000023a2d4
+ (struct CGSize)_episodeFrameImageSizeForDetailView:(id)arg1 withViewSize:(struct CGSize)arg2;	// IMP=0x001000000023a273
- (void).cxx_destruct;	// IMP=0x000000000023c9a1
...
- (double)_seasonMargin;	// IMP=0x000000000023c81d
- (void)_configureViewElementsForAX;	// IMP=0x000000000023c794
- (void)didTapButtonForEpisodeFrameView:(id)arg1;	// IMP=0x000000000023c760
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x000000000023c6dd
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x000000000023c61c
- (void)_configureDotSeparator;	// IMP=0x000000000023c4ce
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000023c1ad
- (void)layoutSubviews;	// IMP=0x000000000023b361
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000023ad72
