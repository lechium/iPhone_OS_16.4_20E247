...
+ (id)overlayViewFromMediaItem:(id)arg1 overlayType:(long long)arg2 existingView:(id)arg3;	// IMP=0x006000000003205e
- (void).cxx_destruct;	// IMP=0x0000000000033c2b
...
- (struct UIEdgeInsets)_overlayPadding;	// IMP=0x0000000000033b1c
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000032b45
