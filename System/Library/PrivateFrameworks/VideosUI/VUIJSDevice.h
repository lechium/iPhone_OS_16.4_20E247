...
+ (id)getMobileGestaltString:(struct __CFString *)arg1;	// IMP=0x00100000002506ca
- (void).cxx_destruct;	// IMP=0x0000000000250746
...
- (void)dealloc;	// IMP=0x00000000002503e7
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000000250082
