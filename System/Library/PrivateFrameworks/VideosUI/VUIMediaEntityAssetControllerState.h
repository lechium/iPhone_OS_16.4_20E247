...
- (void).cxx_destruct;	// IMP=0x0000000000070364
...
- (id)description;	// IMP=0x000000000006fba7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006f8e5
- (unsigned long long)hash;	// IMP=0x000000000006f788
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006f707
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x000000000006f6a0
