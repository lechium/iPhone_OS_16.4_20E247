...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x001000000021684a
- (void).cxx_destruct;	// IMP=0x0000000000216a4c
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x000000000021690c
- (id)description;	// IMP=0x0000000000216226
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000216137
- (id)init;	// IMP=0x0000000000215df4
