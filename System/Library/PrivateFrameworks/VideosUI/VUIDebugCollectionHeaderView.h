...
- (void).cxx_destruct;	// IMP=0x0000000000026080
...
- (void)layoutSubviews;	// IMP=0x0000000000025df6
- (void)configureHeaderViewWithTitle:(id)arg1;	// IMP=0x0000000000025dbb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000025bca
