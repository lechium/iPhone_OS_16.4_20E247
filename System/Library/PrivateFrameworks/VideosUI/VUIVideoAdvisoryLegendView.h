...
- (void).cxx_destruct;	// IMP=0x0000000000107b6c
...
- (void)layoutSubviews;	// IMP=0x00000000001070e6
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000107063
- (struct CGSize)legendNameSizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000106ee1
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000106e5c
