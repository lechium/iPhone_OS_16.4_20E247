...
- (void).cxx_destruct;	// IMP=0x00000000001e1d84
...
- (id)_textColorForDarkMode;	// IMP=0x00000000001e1c52
- (void)_configureLabels;	// IMP=0x00000000001e18b5
- (void)_configureAgeRatingBadge;	// IMP=0x00000000001e167a
- (_Bool)canBecomeFocused;	// IMP=0x00000000001e1633
@property(readonly, nonatomic) VUIAppInstallView *installView;
- (void)_layoutForIos;	// IMP=0x00000000001e0df4
- (void)_layoutForTvos;	// IMP=0x00000000001e0891
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e0527
