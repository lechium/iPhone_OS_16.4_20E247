...
- (void).cxx_destruct;	// IMP=0x00000000000af143
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000aea2e
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000000ae98c
