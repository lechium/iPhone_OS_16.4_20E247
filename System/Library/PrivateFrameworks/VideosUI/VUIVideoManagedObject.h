...
+ (id)keyPathsForValuesAffectingExpirationDate;	// IMP=0x0080000000113697
+ (id)keyPathsForValuesAffectingLocalPlaybackURL;	// IMP=0x0080000000113677
+ (id)fetchRequest;	// IMP=0x008000000011721b
