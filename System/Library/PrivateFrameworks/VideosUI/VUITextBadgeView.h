...
+ (_Bool)_viewBackgroundImageNeedsUpdatingWithFrame:(struct CGRect)arg1 currentBackgroundImage:(id)arg2;	// IMP=0x00600000001f6d30
+ (id)badgeWithLayout:(id)arg1 existing:(id)arg2;	// IMP=0x00600000001f4fea
- (void).cxx_destruct;	// IMP=0x00000000001f70eb
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000001f6dd1
- (_Bool)_textBadgeBackgroundImageNeedsUpdating;	// IMP=0x00000000001f6c70
- (void)_cancelPendingOperation;	// IMP=0x00000000001f6b16
- (void)_redrawView:(id)arg1 withDuration:(double)arg2;	// IMP=0x00000000001f6a1d
- (void)_redrawTextBadgeWithDuration:(double)arg1;	// IMP=0x00000000001f6a08
- (void)_updateBackgroundImagesWithCompletedOperation:(id)arg1;	// IMP=0x00000000001f68f0
- (void)_updateBackgroundMaterialImagesWithBackgroundImageSize:(struct CGSize)arg1 performSynchronously:(_Bool)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x00000000001f6478
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x00000000001f63e1
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3 operationQueue:(id)arg4;	// IMP=0x00000000001f631a
- (void)_setBackgroundImageForMaterialRendering:(id)arg1;	// IMP=0x00000000001f62d8
- (void)_imageLoaded;	// IMP=0x00000000001f62aa
- (struct CGSize)_textSize;	// IMP=0x00000000001f60f3
- (void)_invalidateTimer;	// IMP=0x00000000001f60bb
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001f595f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001f5839
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001f5810
- (void)dealloc;	// IMP=0x00000000001f572f
- (void)reset;	// IMP=0x00000000001f5640
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x00000000001f55be
- (void)_configureWithLayout:(id)arg1;	// IMP=0x00000000001f50bf
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001f4f1d
