...
- (void).cxx_destruct;	// IMP=0x0000000000994300
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000992fd0
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000992d70
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000992d20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000992cf0
