...
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000169f32
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000169a8d
- (id)initWithTransitionType:(long long)arg1 andDuration:(double)arg2;	// IMP=0x0000000000169a41
