...
- (void).cxx_destruct;	// IMP=0x00000000002b3048
...
- (id)description;	// IMP=0x00000000002b2e7c
- (id)initWithMediaItemEntityTypesChangeSet:(id)arg1 localMediaItemsAvailableDidChange:(_Bool)arg2;	// IMP=0x00000000002b2e06
- (id)init;	// IMP=0x00000000002b2d97
