...
- (void).cxx_destruct;	// IMP=0x0000000000027058
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000026f18
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000026ea0
- (void)_defaultsSwitchPressed:(id)arg1;	// IMP=0x0000000000026e83
- (void)layoutSubviews;	// IMP=0x000000000002689c
- (void)configureCellWithDefaults:(id)arg1;	// IMP=0x00000000000265eb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000260c2
