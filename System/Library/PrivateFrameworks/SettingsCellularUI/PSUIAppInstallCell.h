...
+ (id)specifierForAppWithDescription:(id)arg1 target:(id)arg2 action:(SEL)arg3;	// IMP=0x0060000000017b03
...
- (id)getLogger;	// IMP=0x000000000001944e
- (void)_updateCellWithInstallState;	// IMP=0x0000000000019268
- (void)layoutSubviews;	// IMP=0x00000000000190a3
- (void)updateConstraints;	// IMP=0x0000000000018ef3
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x0000000000017d20
