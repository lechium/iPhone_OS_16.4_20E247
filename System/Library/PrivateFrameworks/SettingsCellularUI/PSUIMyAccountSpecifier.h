...
- (void).cxx_destruct;	// IMP=0x00000000000602eb
...
- (id)getLogger;	// IMP=0x000000000006020a
- (void)launchMyAccountInSafari:(id)arg1;	// IMP=0x00000000000600d6
- (void)launchMyAccountInWebView:(id)arg1;	// IMP=0x000000000005ff4c
- (id)initWithContext:(id)arg1 cbCache:(id)arg2;	// IMP=0x000000000005fd58
