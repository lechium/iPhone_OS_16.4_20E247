...
- (void).cxx_destruct;	// IMP=0x00000000000385be
...
- (id)getLogger;	// IMP=0x0000000000038505
- (id)dataUsageString;	// IMP=0x0000000000038494
- (unsigned long long)dataUsage;	// IMP=0x0000000000038060
- (id)initWithType:(unsigned long long)arg1 subSpecifiers:(id)arg2;	// IMP=0x0000000000037b90
