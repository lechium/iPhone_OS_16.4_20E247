...
- (void).cxx_destruct;	// IMP=0x0000000000029154
...
- (id)getLogger;	// IMP=0x0000000000028f0f
- (_Bool)planManagerCacheHasMoreThanOnePlanItem;	// IMP=0x0000000000028e3c
- (id)specifiers;	// IMP=0x000000000002823e
- (void)viewWillAppear;	// IMP=0x0000000000028228
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x00000000000281d2
- (id)initWithFactory:(id)arg1;	// IMP=0x0000000000027e7c
