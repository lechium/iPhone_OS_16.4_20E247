...
- (void).cxx_destruct;	// IMP=0x0000000000021d95
...
- (id)getLogger;	// IMP=0x0000000000021cf1
- (void)operatorNameChanged:(id)arg1 name:(id)arg2;	// IMP=0x0000000000021b4e
- (void)networkSelected:(id)arg1 success:(_Bool)arg2 mode:(id)arg3;	// IMP=0x00000000000219ab
- (void)reloadCellularNetworkSpecifier;	// IMP=0x00000000000218c0
- (id)localizedCellularNetworkName:(id)arg1;	// IMP=0x0000000000021778
- (id)specifiers;	// IMP=0x00000000000214cc
- (void)willEnterForeground;	// IMP=0x00000000000214ba
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000021464
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000021324
