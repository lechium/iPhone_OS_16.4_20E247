...
- (void).cxx_destruct;	// IMP=0x000000000000fa61
...
- (id)getLogger;	// IMP=0x000000000000f9e9
- (id)specifiers;	// IMP=0x000000000000f44f
- (void)viewWillAppear;	// IMP=0x000000000000f2e8
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000000f292
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x000000000000f19e
