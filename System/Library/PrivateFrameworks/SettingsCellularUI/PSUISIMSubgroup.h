...
- (void).cxx_destruct;	// IMP=0x0000000000020d07
...
- (id)specifiers;	// IMP=0x00000000000208dd
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000020887
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x00000000000207f5
