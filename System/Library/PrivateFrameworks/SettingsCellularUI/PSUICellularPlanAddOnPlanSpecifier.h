...
- (void).cxx_destruct;	// IMP=0x000000000006dbb8
@property(readonly, nonatomic) UIButton *addButton; // @synthesize addButton=_addButton;
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000006d0f0
- (id)initWithTarget:(id)arg1 action:(SEL)arg2 displayPlan:(id)arg3;	// IMP=0x000000000006cf36
