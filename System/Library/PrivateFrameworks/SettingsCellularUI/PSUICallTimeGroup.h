...
- (void).cxx_destruct;	// IMP=0x000000000007984a
...
- (id)getLogger;	// IMP=0x0000000000079797
- (id)lifetimeCallTime:(id)arg1;	// IMP=0x0000000000079783
- (id)callTime:(id)arg1;	// IMP=0x000000000007976c
- (id)callTimeDurationRestrictedToCurrentPeriod:(_Bool)arg1;	// IMP=0x00000000000795fb
- (void)handleCallTimersChanged;	// IMP=0x00000000000793c3
- (id)specifiers;	// IMP=0x00000000000792a5
- (id)initWithListController:(id)arg1;	// IMP=0x0000000000078f58
