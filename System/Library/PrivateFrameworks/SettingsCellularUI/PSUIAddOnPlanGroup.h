...
- (void).cxx_destruct;	// IMP=0x000000000005e87c
...
- (id)getLogger;	// IMP=0x000000000005e812
- (void)simSetupFlowCompleted:(unsigned long long)arg1;	// IMP=0x000000000005e6ee
- (void)_handleAddRemotePlan:(id)arg1;	// IMP=0x000000000005e0a6
- (void)_addButtonPressed:(id)arg1;	// IMP=0x000000000005db2e
- (id)specifiersForRemotePlans;	// IMP=0x000000000005d734
- (id)specifiers;	// IMP=0x000000000005d54e
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 planManager:(id)arg3 ctPlanManager:(id)arg4;	// IMP=0x000000000005d44e
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000005d38e
- (id)init;	// IMP=0x000000000005d351
