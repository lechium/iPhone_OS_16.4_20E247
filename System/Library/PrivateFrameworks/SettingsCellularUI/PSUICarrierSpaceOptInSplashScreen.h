...
- (void).cxx_destruct;	// IMP=0x000000000004b6e5
...
- (id)getLogger;	// IMP=0x000000000004b651
- (void)continueButtonPressed;	// IMP=0x000000000004b587
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000004b558
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000004b50a
- (id)initWithParent:(id)arg1;	// IMP=0x000000000004b13d
