...
- (void).cxx_destruct;	// IMP=0x0000000000050c4d
...
- (id)specifiers;	// IMP=0x0000000000050777
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000050721
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x000000000005068f
