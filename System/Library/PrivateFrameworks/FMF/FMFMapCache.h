...
- (void).cxx_destruct;	// IMP=0x000000000001b299
...
- (double)pruneIntervalInSeconds;	// IMP=0x000000000001b01e
- (double)cacheExpiryInSeconds;	// IMP=0x000000000001af2a
- (id)noLocationKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ae28
- (id)gridKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ad26
- (void)pruneCacheIfNeeded;	// IMP=0x000000000001a68e
- (void)flushCache;	// IMP=0x000000000001a424
- (void)saveMetaData;	// IMP=0x0000000000019e29
- (void)readMetaData;	// IMP=0x00000000000198b1
- (_Bool)pendingMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000019803
- (_Bool)pendingMapImageForRequest:(id)arg1;	// IMP=0x00000000000194c9
- (void)cacheMapImage:(id)arg1 forLocation:(id)arg2 altitude:(double)arg3 pitch:(double)arg4 width:(double)arg5 andHeight:(double)arg6;	// IMP=0x0000000000019408
- (void)cacheMapImage:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000000018d96
- (id)cachedMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000018cdc
- (id)cachedMapImageForRequest:(id)arg1;	// IMP=0x0000000000018b64
- (void)cacheNoLocationImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x0000000000018705
- (id)cachedNoLocationImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x00000000000185aa
- (void)cacheGridImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x000000000001814b
- (id)cachedGridImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000017ff0
- (id)init;	// IMP=0x0000000000017ae9
