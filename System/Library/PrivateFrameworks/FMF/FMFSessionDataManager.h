...
+ (id)sharedInstance;	// IMP=0x006000000000cf1f
- (void).cxx_destruct;	// IMP=0x000000000000dcbf
...
- (id)favoritesOrdered;	// IMP=0x000000000000db57
- (void)abPreferencesDidChange;	// IMP=0x000000000000da98
- (void)abDidChange;	// IMP=0x000000000000d9d9
- (id)offerExpirationForHandle:(id)arg1 groupId:(id)arg2;	// IMP=0x000000000000d87d
- (id)locationForHandle:(id)arg1;	// IMP=0x000000000000d63d
- (id)followingForHandle:(id)arg1;	// IMP=0x000000000000d5ba
- (id)followerForHandle:(id)arg1;	// IMP=0x000000000000d537
