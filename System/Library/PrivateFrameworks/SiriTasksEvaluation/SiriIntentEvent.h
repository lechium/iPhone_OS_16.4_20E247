...
- (void).cxx_destruct;	// IMP=0x000000000000244c
...
- (id)initWithIntentId:(id)arg1 eventType:(long long)arg2 eventData:(id)arg3 createdAt:(id)arg4;	// IMP=0x0000000000002345
