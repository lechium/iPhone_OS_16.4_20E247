...
- (void).cxx_destruct;	// IMP=0x0000000000052ba7
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000052927
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000052646
