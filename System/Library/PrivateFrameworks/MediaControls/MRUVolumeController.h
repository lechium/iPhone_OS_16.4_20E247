...
- (void)restoreDelegate;	// IMP=0x000000000005120e
- (void)finishEqualization;	// IMP=0x00000000000511be
- (void)beginEqualization;	// IMP=0x000000000005116e
- (void)setVolumeValue:(float)arg1;	// IMP=0x0000000000050daf
- (float)volumeValue;	// IMP=0x0000000000050d5b
@property(nonatomic) __weak id <MRUVolumeControllerDelegate> delegate; // @dynamic delegate;
- (id)description;	// IMP=0x0000000000050c7a
