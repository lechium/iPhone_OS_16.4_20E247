...
- (void).cxx_destruct;	// IMP=0x000000000002234a
...
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x0000000000021f47
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;	// IMP=0x0000000000021dc8
- (void)launchNowPlayingAppButtonPressed;	// IMP=0x0000000000021dab
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000021d99
- (void)_handleContentSizeCategoryDidChangeNotification:(id)arg1;	// IMP=0x0000000000021d87
- (void)_updateRTL;	// IMP=0x0000000000021bdd
- (void)clearOverrideSize;	// IMP=0x00000000000218ac
- (void)tintColorDidChange;	// IMP=0x00000000000212c2
- (void)didMoveToWindow;	// IMP=0x000000000002123f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000211e4
- (void)updateArtworkStyle;	// IMP=0x0000000000020af8
- (void)_updateStyle;	// IMP=0x000000000002060f
- (struct CGSize)layoutTextInAvailableBounds:(struct CGRect)arg1 setFrames:(_Bool)arg2;	// IMP=0x000000000001f303
- (void)layoutSubviews;	// IMP=0x000000000001e663
- (void)dealloc;	// IMP=0x000000000001e5e1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001d774
