...
- (void).cxx_destruct;	// IMP=0x000000000004bed4
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004be2a
- (void)_updateVolumeCapabilities;	// IMP=0x000000000004bd29
- (void)_updateVolumeStyle;	// IMP=0x000000000004bc41
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000004baba
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000004b930
- (void)didMoveToWindow;	// IMP=0x000000000004b7f5
- (void)didMoveToSuperview;	// IMP=0x000000000004b7b4
- (void)layoutSubviews;	// IMP=0x000000000004b3a0
- (void)dealloc;	// IMP=0x000000000004b31e
- (id)initWithFrame:(struct CGRect)arg1 slider:(id)arg2;	// IMP=0x000000000004b1b1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004b132
