...
- (void).cxx_destruct;	// IMP=0x0000000000054966
...
- (void)handleHoverGestureRecognizer:(id)arg1;	// IMP=0x000000000005483d
@property(retain, nonatomic) UIView *routingView;
- (void)_setInitialFrameForRoutingView:(id)arg1;	// IMP=0x0000000000054660
- (void)_toggleRoutingPickerAnimated:(_Bool)arg1;	// IMP=0x00000000000542ca
- (void)_updateTimeControlVisibility:(id)arg1;	// IMP=0x00000000000540a6
- (void)_updateRoutingPickerVisibilityAnimated:(_Bool)arg1;	// IMP=0x0000000000053fe1
...
- (void)setSelectedMode:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000053f0c
- (void)didMoveToWindow;	// IMP=0x0000000000053e04
- (void)layoutSubviews;	// IMP=0x0000000000053960
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000536bc
