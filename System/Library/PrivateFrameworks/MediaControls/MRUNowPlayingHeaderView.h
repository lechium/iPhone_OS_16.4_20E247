...
- (void).cxx_destruct;	// IMP=0x00000000000106d3
...
- (void)updateVisibility;	// IMP=0x00000000000103b3
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000001011c
- (void)layoutSubviews;	// IMP=0x000000000000f7ee
- (id)initWithWaveformView:(id)arg1;	// IMP=0x000000000000f584
- (id)init;	// IMP=0x000000000000f570
