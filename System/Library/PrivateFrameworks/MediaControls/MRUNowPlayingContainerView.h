...
- (void).cxx_destruct;	// IMP=0x000000000004f616
...
- (void)updateVisibility;	// IMP=0x000000000004f572
- (void)updateVisualStyling;	// IMP=0x000000000004f542
- (void)visualStylingProviderDidChange:(id)arg1;	// IMP=0x000000000004f530
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000004f290
- (void)layoutSubviews;	// IMP=0x000000000004eee2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004ede7
