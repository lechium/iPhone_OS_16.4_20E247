...
- (void).cxx_destruct;	// IMP=0x000000000009913e
...
- (void)transitionToVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000990aa
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000099003
- (void)viewDidLoad;	// IMP=0x0000000000098e21
