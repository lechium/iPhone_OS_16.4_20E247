...
- (void).cxx_destruct;	// IMP=0x00000000000a1de8
...
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000000a1c3a
- (void)_updateLabelVisualStyling;	// IMP=0x00000000000a1b18
- (void)providedStylesDidChangeForProvider:(id)arg1;	// IMP=0x00000000000a1b06
- (void)showMessage:(id)arg1;	// IMP=0x00000000000a1953
- (void)setGlyphState:(id)arg1;	// IMP=0x00000000000a1878
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a16dc
- (void)layoutSubviews;	// IMP=0x00000000000a10d6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a0e51
