...
- (void).cxx_destruct;	// IMP=0x00000000000bc295
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x00000000000bc1c9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000bbf5c
