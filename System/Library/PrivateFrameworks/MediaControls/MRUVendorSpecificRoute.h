...
- (void).cxx_destruct;	// IMP=0x00000000000c0160
...
- (long long)moreCapableTypeBetween:(long long)arg1 otherType:(long long)arg2;	// IMP=0x00000000000c0052
- (void)addSubRoute:(id)arg1;	// IMP=0x00000000000bff87
@property(readonly, nonatomic) NSString *protocolIdentifier;
- (_Bool)isKnown;	// IMP=0x00000000000bfbdd
- (_Bool)isDisplayedAsPicked;	// IMP=0x00000000000bfa2a
- (_Bool)supportsAirPlayGrouping;	// IMP=0x00000000000bf9d5
- (_Bool)isAirPlayRoute;	// IMP=0x00000000000bf9c0
...
- (long long)routeSubtype;	// IMP=0x00000000000bf6a4
- (long long)routeType;	// IMP=0x00000000000bf4c6
@property(readonly, nonatomic) long long vendorSpecificRouteType;
- (id)routeUID;	// IMP=0x00000000000bf264
- (id)routeName;	// IMP=0x00000000000befa8
- (id)initWithDevice:(id)arg1;	// IMP=0x00000000000bebf5
