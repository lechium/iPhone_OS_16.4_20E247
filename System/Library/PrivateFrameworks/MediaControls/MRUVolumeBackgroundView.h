...
- (void).cxx_destruct;	// IMP=0x0000000000042baf
...
- (void)updateVisibility;	// IMP=0x0000000000042623
- (void)collapseExpandableButtons;	// IMP=0x0000000000042566
- (void)expandButton:(id)arg1;	// IMP=0x00000000000424ab
@property(readonly, nonatomic) _Bool hasExpandedButtons;
- (void)layoutSubviewsHorizontal;	// IMP=0x00000000000418d4
- (void)layoutSubviewsVertical;	// IMP=0x0000000000040f5c
- (void)layoutSubviews;	// IMP=0x0000000000040f03
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000040c87
