...
- (void).cxx_destruct;	// IMP=0x0000000000055f61
...
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000055e01
- (void)layoutSubviews;	// IMP=0x0000000000055bb8
- (void)cancelTrackingWithEvent:(id)arg1;	// IMP=0x0000000000055b5a
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000055abd
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000557e4
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000055655
- (void)shrinkThumbAfterDelay:(double)arg1;	// IMP=0x000000000005538f
- (void)handleLongPress:(id)arg1;	// IMP=0x00000000000552ba
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000550b8
- (id)createThumbView;	// IMP=0x000000000005503f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000054de8
