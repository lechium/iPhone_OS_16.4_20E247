...
- (void).cxx_destruct;	// IMP=0x000000000009ecf7
...
- (void)updateVisualStyling;	// IMP=0x000000000009ebfc
- (void)visualStylingProviderDidChange:(id)arg1;	// IMP=0x000000000009ebea
- (void)setTintColor:(id)arg1;	// IMP=0x000000000009eb60
- (void)layoutSubviews;	// IMP=0x000000000009e82d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009e73e
