...
- (void).cxx_destruct;	// IMP=0x000000000003a980
...
- (long long)numberOfColumns;	// IMP=0x000000000003a8e7
- (long long)numberOfRows;	// IMP=0x000000000003a8be
- (double)itemHeightForItemWidth:(double)arg1;	// IMP=0x000000000003a7c7
- (double)itemWidthForWidth:(double)arg1;	// IMP=0x000000000003a5a8
- (_Bool)acuis_wantsPriorityOverTargetOfGestureRecognizer:(id)arg1;	// IMP=0x000000000003a5a0
- (void)updateCollectionViewLayout;	// IMP=0x0000000000039f71
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000039e40
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000039dcf
- (void)layoutSubviews;	// IMP=0x0000000000039d4e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000039c22
