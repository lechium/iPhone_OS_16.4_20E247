...
- (void).cxx_destruct;	// IMP=0x000000000002b1b7
...
- (void)configureCatalog;	// IMP=0x000000000002a3a7
- (struct CGSize)scaledFittingSize;	// IMP=0x000000000002a1aa
- (_Bool)vendCachedImageIfPossible;	// IMP=0x0000000000029e95
- (void)updateFittingSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x0000000000029b6e
- (void)updateCatalog:(id)arg1;	// IMP=0x000000000002991f
- (_Bool)wouldLoadNewImageForCatalog:(id)arg1;	// IMP=0x0000000000029587
- (void)dealloc;	// IMP=0x000000000002947d
- (id)initWithDestination:(id)arg1 imageHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002933c
