...
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x0000000000091688
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;	// IMP=0x0000000000091672
- (void)_updateGlyph;	// IMP=0x000000000009160e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009135a
