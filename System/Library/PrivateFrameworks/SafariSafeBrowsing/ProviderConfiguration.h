...
- (void).cxx_destruct;	// IMP=0x000000000003ae70
...
- (_Bool)isEqualToConfiguration:(id)arg1;	// IMP=0x000000000003adf4
- (void)_parseConfiguration:(id)arg1;	// IMP=0x000000000003ab68
- (id)_currentRegionCode;	// IMP=0x000000000003ab11
- (void)_configureToBeOff;	// IMP=0x000000000003ab01
- (void)_configureToUseDefaultValues;	// IMP=0x000000000003aaf1
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000003aa2e
