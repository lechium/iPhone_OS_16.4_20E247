...
- (id).cxx_construct;	// IMP=0x000000000002b490
- (void).cxx_destruct;	// IMP=0x000000000002b40b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b1e2
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ad3a
@property(readonly, nonatomic) void *irProgram;
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002a6eb
- (id)initWithMessageStream:(struct CodedInputStream *)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002a244
- (id)initWithSpecificationData:(id)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002a100
