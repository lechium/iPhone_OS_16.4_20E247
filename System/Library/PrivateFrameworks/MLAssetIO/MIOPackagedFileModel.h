...
- (void).cxx_destruct;	// IMP=0x000000000002f273
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002eeee
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002d61a
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002d59b
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002be50
