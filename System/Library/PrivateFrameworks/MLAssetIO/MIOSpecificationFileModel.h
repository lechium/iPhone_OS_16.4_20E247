...
- (void).cxx_destruct;	// IMP=0x000000000002be24
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002bcfb
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002bbb7
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002b7ed
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002b76e
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002b5bb
