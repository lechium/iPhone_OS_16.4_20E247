...
- (_Bool)isEarliestNotificationScheduledAfterDate:(id)arg1 gregorianCalendar:(id)arg2;	// IMP=0x003000000002f215
- (id)hdmc_fertileWindowDidUpdateDueToSensorDataNotificationForNotificationFireDate:(id)arg1 lastFiredDate:(id)arg2 fertileWindowNotificationTimeOfDay:(id)arg3;	// IMP=0x003000000002ed93
...
- (id)_hdmc_firstPeriodStartProjection;	// IMP=0x003000000002e83c
@end
