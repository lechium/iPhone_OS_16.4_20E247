...
- (void).cxx_destruct;	// IMP=0x000000000001b5f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001b590
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001b510
- (void)didTapRightButton;	// IMP=0x000000000001b4e0
- (void)didTapLeftButton;	// IMP=0x000000000001b440
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b370
