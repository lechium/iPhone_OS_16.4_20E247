...
- (void).cxx_destruct;	// IMP=0x000000000022a8f0
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x000000000022a74f
- (void)powerModeDidChange:(_Bool)arg1;	// IMP=0x000000000022a5ef
- (void)processInfoPowerStateDidChange:(id)arg1;	// IMP=0x000000000022a5ba
- (id)evaluation;	// IMP=0x000000000022a4ba
- (void)reset;	// IMP=0x000000000022a4b4
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithPowerModeMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000022a36f
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000022a2d8
