...
- (void).cxx_destruct;	// IMP=0x00000000002c7e0a
...
- (void)_onQueue_flush;	// IMP=0x00000000002c75fb
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c728d
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c7276
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002c7085
- (void)cancelSubscription;	// IMP=0x00000000002c6f0a
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000002c6c9f
