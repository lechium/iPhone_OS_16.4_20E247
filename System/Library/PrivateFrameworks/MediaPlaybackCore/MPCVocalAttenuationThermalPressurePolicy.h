...
- (void).cxx_destruct;	// IMP=0x000000000022a252
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x000000000022a087
- (void)thermalStateDidChange:(long long)arg1;	// IMP=0x0000000000229e31
- (void)environmentMonitorDidChangeThermalLevel:(id)arg1;	// IMP=0x0000000000229dd8
- (id)evaluation;	// IMP=0x0000000000229cd7
- (void)reset;	// IMP=0x0000000000229cd1
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithThermalMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000000229bb9
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000229b22
