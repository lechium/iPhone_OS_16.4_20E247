...
- (void).cxx_destruct;	// IMP=0x0000000000312988
...
- (unsigned long long)reportingEventType;	// IMP=0x0000000000312952
- (_Bool)isValidReportingEvent;	// IMP=0x0000000000312944
