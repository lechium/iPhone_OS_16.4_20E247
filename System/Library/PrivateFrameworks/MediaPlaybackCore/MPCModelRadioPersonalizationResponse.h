...
- (void).cxx_destruct;	// IMP=0x000000000024f1d3
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x000000000024f11c
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x000000000024efbb
