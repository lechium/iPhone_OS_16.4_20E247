...
+ (id)enumeratorWithMusicBehavior:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x00600000001f897c
- (void).cxx_destruct;	// IMP=0x00000000001f8850
...
- (void)_buildEnumerator;	// IMP=0x00000000001f823f
- (id)_init;	// IMP=0x00000000001f8210
- (id)nextObject;	// IMP=0x00000000001f8157
