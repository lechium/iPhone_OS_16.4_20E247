...
- (void).cxx_destruct;	// IMP=0x00000000002ae41c
- (unsigned long long)hash;	// IMP=0x00000000002adfe7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002adbc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ad8e1
- (void)writeTo:(id)arg1;	// IMP=0x00000000002ad65c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002ad64f
- (id)dictionaryRepresentation;	// IMP=0x00000000002ad10e
- (id)description;	// IMP=0x00000000002ad05f
