...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x0060000000344001
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x006000000034121a
- (void).cxx_destruct;	// IMP=0x00000000003407a5
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000003406de
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x000000000033fa9c
- (void)addSessionActivationTimesWithScopedCursor:(id)arg1;	// IMP=0x000000000033f7ae
- (void)addNetworkTimesWithScopedCursor:(id)arg1;	// IMP=0x000000000033f523
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x000000000033f435
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x000000000033f24b
- (void)addQueueMetadata:(id)arg1;	// IMP=0x000000000033f19d
- (id)jsonObject;	// IMP=0x000000000033dead
- (id)description;	// IMP=0x000000000033dc9f
- (id)dictionaryRepresentation;	// IMP=0x000000000033dc57
...
- (id)init;	// IMP=0x000000000033d177
