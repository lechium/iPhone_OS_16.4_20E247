...
+ (id)infoWithIdentifier:(id)arg1 account:(id)arg2 supported:(_Bool)arg3 supportedReason:(id)arg4 exportable:(_Bool)arg5 exportableReason:(id)arg6;	// IMP=0x0060000000305d7f
- (void).cxx_destruct;	// IMP=0x0000000000305d41
