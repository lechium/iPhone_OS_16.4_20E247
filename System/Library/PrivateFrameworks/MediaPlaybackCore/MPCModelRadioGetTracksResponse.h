...
- (void).cxx_destruct;	// IMP=0x00000000002d8367
...
- (id)description;	// IMP=0x00000000002d8269
- (id)initWithTracks:(id)arg1 tracklistAction:(long long)arg2;	// IMP=0x00000000002d81eb
