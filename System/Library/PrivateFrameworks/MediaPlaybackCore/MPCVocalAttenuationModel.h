...
+ (id)_filePathsForModelAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0060000000237400
+ (id)_plistForModelAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00600000002370f0
- (void).cxx_destruct;	// IMP=0x00000000002370b2
...
- (id)description;	// IMP=0x0000000000236c29
