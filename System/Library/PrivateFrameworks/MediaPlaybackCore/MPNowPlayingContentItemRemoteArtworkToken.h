...
- (void).cxx_destruct;	// IMP=0x00000000002087c4
...
- (id)stringRepresentation;	// IMP=0x000000000020875e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002086ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002085f4
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x000000000020850e
