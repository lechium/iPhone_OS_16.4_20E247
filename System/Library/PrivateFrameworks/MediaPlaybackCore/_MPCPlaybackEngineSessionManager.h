...
+ (id)archivesAtURL:(id)arg1;	// IMP=0x0010000000346cfe
- (void).cxx_destruct;	// IMP=0x0000000000345ef9
...
- (id)_playbackSessionsDirectory;	// IMP=0x0000000000345dc5
@property(retain, nonatomic) NSString *stateRestorationSessionIdentifier;
- (void)deleteSessionWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000345ad7
- (void)saveSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000034520e
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x0000000000345084
