...
- (void).cxx_destruct;	// IMP=0x00000000001b1d29
- (unsigned long long)hash;	// IMP=0x00000000001b1c1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b1a44
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b18e3
- (void)writeTo:(id)arg1;	// IMP=0x00000000001b17ba
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001b17ad
- (id)dictionaryRepresentation;	// IMP=0x00000000001b153e
- (id)description;	// IMP=0x00000000001b148f
