...
- (void).cxx_destruct;	// IMP=0x000000000027ceb1
...
- (void)_applyAttenuationLevelToAudioUnit;	// IMP=0x000000000027cb4e
- (_Bool)_initializeAudioUnit:(id *)arg1;	// IMP=0x000000000027c885
- (_Bool)_setupAudioUnitWithModel:(id)arg1 error:(id *)arg2;	// IMP=0x000000000027ac96
- (_Bool)_createAudioUnit:(id *)arg1;	// IMP=0x000000000027a93a
- (void)_prepareWithModel:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000027a68c
- (void)resetAudioUnit;	// IMP=0x000000000027a665
- (_Bool)processAudioBuffer:(struct AudioBufferList *)arg1 sampleIndex:(long long)arg2 numberFrames:(unsigned int)arg3 error:(id *)arg4;	// IMP=0x0000000000279b75
- (_Bool)isCompatibleWithAudioFormat:(struct AudioStreamBasicDescription)arg1 maxFrames:(unsigned int)arg2;	// IMP=0x0000000000279925
...
- (void)tearDownWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002795c6
- (void)prepareWithModel:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000279406
- (id)initWithMaxAttenuationLevel:(float)arg1 audioFormat:(struct AudioStreamBasicDescription)arg2 maxFrames:(unsigned int)arg3;	// IMP=0x0000000000279342
- (id)init;	// IMP=0x00000000002792a3
