...
+ (id)identifier;	// IMP=0x0010000000181a15
- (void).cxx_destruct;	// IMP=0x000000000018478a
...
- (id)_playbackBarWithElapsedTime:(double)arg1 duration:(double)arg2;	// IMP=0x00000000001845a5
- (_Bool)_logAccountEvent:(id)arg1 subscription:(id)arg2 cursor:(id)arg3;	// IMP=0x0000000000183da1
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x0000000000183d68
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x0000000000181a22
