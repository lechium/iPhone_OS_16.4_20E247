...
- (void).cxx_destruct;	// IMP=0x00000000002901a1
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x000000000028fc03
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x000000000028fbec
- (id)clearUpNextItems;	// IMP=0x000000000028fa96
- (id)clear;	// IMP=0x000000000028f8b4
