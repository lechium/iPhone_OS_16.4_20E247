...
+ (id)infoWithIdentifier:(id)arg1 account:(id)arg2 supported:(_Bool)arg3 supportedReason:(id)arg4 exportable:(_Bool)arg5 exportableReason:(id)arg6;	// IMP=0x00600000001fc6e8
- (void).cxx_destruct;	// IMP=0x00000000001fc6aa
