...
- (void).cxx_destruct;	// IMP=0x00000000002058e1
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)modelRadioStationForMetadata:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000020544f
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x00000000002053dc
