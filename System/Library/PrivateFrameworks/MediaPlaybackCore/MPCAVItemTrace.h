...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x006000000031eca5
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x006000000031ebc1
- (void).cxx_destruct;	// IMP=0x000000000031eb9b
...
- (void)cancel;	// IMP=0x000000000031e98b
- (void)endInterval;	// IMP=0x000000000031e7fb
- (void)dealloc;	// IMP=0x000000000031e7bd
