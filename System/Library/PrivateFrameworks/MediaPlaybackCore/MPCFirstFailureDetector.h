...
- (void).cxx_destruct;	// IMP=0x00000000001aaca7
...
- (_Bool)processSample:(id)arg1;	// IMP=0x00000000001aa9d4
- (id)initWithSamplingTime:(double)arg1 renderingLimit:(double)arg2;	// IMP=0x00000000001aa97a
