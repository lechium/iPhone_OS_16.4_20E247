...
- (void).cxx_destruct;	// IMP=0x00000000001ab216
...
- (id)flushSamplesToCSVDataWithHeader:(_Bool)arg1;	// IMP=0x00000000001ab0b4
- (id)dictionaryRepresentation;	// IMP=0x00000000001aafaf
- (id)description;	// IMP=0x00000000001aaef6
@property(readonly, nonatomic) int numberOfSamples;
- (void)recordSample:(id)arg1;	// IMP=0x00000000001aae62
- (id)initWithRecordID:(id)arg1 modelID:(id)arg2 firstFailureDetector:(id)arg3 shouldStoreSamples:(_Bool)arg4 delegate:(id)arg5;	// IMP=0x00000000001aaccf
