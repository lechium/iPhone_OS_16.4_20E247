...
- (void).cxx_destruct;	// IMP=0x0000000000312c5f
...
- (id)_stateDumpObject;	// IMP=0x0000000000312ac1
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x0000000000312a05
- (id)operationsForRequest:(id)arg1;	// IMP=0x0000000000312998
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x0000000000312c92
