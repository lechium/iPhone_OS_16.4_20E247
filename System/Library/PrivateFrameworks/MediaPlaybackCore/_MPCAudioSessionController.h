...
- (void).cxx_destruct;	// IMP=0x0000000000148e81
...
- (void)tearDownObservations;	// IMP=0x0000000000148d20
- (void)setupObservations;	// IMP=0x0000000000148b00
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x0000000000148a92
- (void)snapshotSessionSettings;	// IMP=0x00000000001489a5
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x0000000000148916
- (void)dealloc;	// IMP=0x00000000001488d8
- (id)init;	// IMP=0x000000000014884b
