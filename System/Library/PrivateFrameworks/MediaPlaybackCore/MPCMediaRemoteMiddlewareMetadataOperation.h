...
- (void).cxx_destruct;	// IMP=0x000000000015bd6e
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x000000000015b6d1
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x000000000015b1ba
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x000000000015b196
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x000000000015afeb
- (void)execute;	// IMP=0x000000000015af24
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000015ad06
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000015a77a
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x000000000015a6d8
