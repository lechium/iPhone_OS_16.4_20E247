...
+ (id)metadataIdentifiers;	// IMP=0x004000000034a0cf
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000034a0c7
- (void).cxx_destruct;	// IMP=0x00000000003480d8
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000347f97
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000347f08
- (id)initWithGenericObject:(id)arg1 timedMetadataGroups:(id)arg2 storeRequestContext:(id)arg3;	// IMP=0x0000000000347e16
