...
+ (id)assetLoadResultWithStoreAssetPlaybackResponse:(id)arg1 assetLoadProperties:(id)arg2 source:(long long)arg3 error:(id *)arg4;	// IMP=0x00600000001bb4ff
- (void).cxx_destruct;	// IMP=0x00000000001bd2b6
...
- (id)descriptionDictionary;	// IMP=0x00000000001bc7d7
- (id)description;	// IMP=0x00000000001bc74f
