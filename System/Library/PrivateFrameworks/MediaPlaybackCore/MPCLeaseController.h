...
- (void).cxx_destruct;	// IMP=0x00000000003197c2
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003194a1
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000031918c
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x00000000003190f3
