...
- (void).cxx_destruct;	// IMP=0x00000000001a8480
...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x00000000001a83c5
- (void)dealloc;	// IMP=0x00000000001a8330
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x00000000001a81dc
