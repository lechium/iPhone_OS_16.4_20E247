...
- (void).cxx_destruct;	// IMP=0x00000000002aa436
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x00000000002aa1d9
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x00000000002aa197
