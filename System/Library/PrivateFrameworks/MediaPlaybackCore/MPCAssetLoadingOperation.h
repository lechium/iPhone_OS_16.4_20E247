...
- (void).cxx_destruct;	// IMP=0x0000000000207ed4
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x000000000020797b
- (void)main;	// IMP=0x0000000000207182
- (_Bool)isFinished;	// IMP=0x0000000000207172
- (_Bool)isExecuting;	// IMP=0x0000000000207162
- (void)start;	// IMP=0x0000000000206f54
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x0000000000206d92
