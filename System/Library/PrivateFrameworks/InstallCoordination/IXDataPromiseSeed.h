...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000048dcb
- (void).cxx_destruct;	// IMP=0x0000000000048f2f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048dd3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000048c85
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048b1b
