...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005af9e
- (void).cxx_destruct;	// IMP=0x000000000005b685
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005b4d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005b2fe
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005afa6
