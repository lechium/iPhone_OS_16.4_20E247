...
- (void).cxx_destruct;	// IMP=0x00000000000303d1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000301a8
- (unsigned long long)hash;	// IMP=0x0000000000030068
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002fe38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002fcb2
- (void)copyTo:(id)arg1;	// IMP=0x000000000002fb73
- (void)writeTo:(id)arg1;	// IMP=0x000000000002fa31
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002fa24
- (id)dictionaryRepresentation;	// IMP=0x000000000002f338
- (id)description;	// IMP=0x000000000002f289
...
- (int)StringAsSystemReleaseType:(id)arg1;	// IMP=0x000000000002f0cd
- (id)systemReleaseTypeAsString:(int)arg1;	// IMP=0x000000000002f084
