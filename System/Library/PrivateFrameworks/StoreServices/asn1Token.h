...
+ (id)readOpaqueTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f700a
+ (id)readTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f6fef
+ (id)readTokenFromBuffer:(const char *)arg1 opaque:(_Bool)arg2;	// IMP=0x00600000000f6ea3
...
- (id)_initWithID:(unsigned long long)arg1 class:(unsigned char)arg2 length:(unsigned long long)arg3 content:(const char *)arg4 opaque:(_Bool)arg5;	// IMP=0x00000000000f6e45
