...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000016f826
...
- (id)description;	// IMP=0x000000000016f9f2
- (void)dealloc;	// IMP=0x000000000016f7eb
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000016f785
