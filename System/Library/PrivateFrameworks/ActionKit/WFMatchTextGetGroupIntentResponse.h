...
+ (id)rangeErrorIntentResponseWithRangeErrorGroupNumber:(id)arg1 rangeErrorGroupCount:(id)arg2;	// IMP=0x00600000003c31b1
+ (id)noMatchIntentResponseWithNoMatchIndex:(id)arg1;	// IMP=0x00600000003c3143
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x00000000003c30a7
