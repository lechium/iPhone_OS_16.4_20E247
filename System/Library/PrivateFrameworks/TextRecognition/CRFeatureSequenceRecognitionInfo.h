...
+ (id)infoForFeature:(id)arg1 scale:(float)arg2 bounds:(struct CGRect)arg3 featureImageSize:(struct CGSize)arg4 rotatedROI:(struct CGRect)arg5;	// IMP=0x00100000001182ab
- (void).cxx_destruct;	// IMP=0x00000000001185a0
