...
- (void).cxx_destruct;	// IMP=0x000000000001a446
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001a3af
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithOutput_label_prob_map:(id)arg1;	// IMP=0x000000000001a34b
