...
- (void).cxx_destruct;	// IMP=0x000000000001a323
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001a28c
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImg_input:(id)arg1 featureInfo:(id)arg2;	// IMP=0x000000000001a1fa
