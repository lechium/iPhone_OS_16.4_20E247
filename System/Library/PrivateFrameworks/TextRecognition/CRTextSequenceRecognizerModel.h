...
+ (id)defaultURLOfModelInThisBundle;	// IMP=0x0010000000119c2a
- (void).cxx_destruct;	// IMP=0x0000000000119e62
...
- (void)releaseIntermediateBuffers;	// IMP=0x0000000000119ded
- (_Bool)preheatWithError:(id *)arg1;	// IMP=0x0000000000119de5
- (id)inputBatchFromTextFeatures:(id)arg1 image:(id)arg2 featureWidth:(double)arg3 configuration:(id)arg4;	// IMP=0x0000000000119ddd
- (id)predictFromInputs:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000119dd0
- (id)initWithConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000119da1
- (_Bool)supportCharacterBoxes;	// IMP=0x0000000000119d99
@property(readonly) NSURL *modelURL;
- (id)populateInputBatchData:(float *)arg1 textFeatures:(id)arg2 image:(id)arg3 batchSize:(long long)arg4 width:(double)arg5 configuration:(id)arg6;	// IMP=0x0000000000118d0f
- (void)dealloc;	// IMP=0x0000000000118cc8
