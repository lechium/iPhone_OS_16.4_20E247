...
@class ACUISActivityMetricsRequest, CHSWidget, CHSWidgetMetrics, CHSWidgetMetricsSpecification, NSString, UISDeviceContext, UISDisplayContext;
...
- (ACUISActivityMetricsRequest *)metricsForLiveActivities;
@end
