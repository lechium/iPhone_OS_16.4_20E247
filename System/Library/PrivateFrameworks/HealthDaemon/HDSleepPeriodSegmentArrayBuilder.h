...
- (void).cxx_destruct;	// IMP=0x0000000000404878
- (id)sleepPeriodSegmentsFromSamples:(id)arg1;	// IMP=0x0000000000403e25
- (id)initProfile:(id)arg1 morningIndex:(long long)arg2 options:(unsigned long long)arg3 calendarCache:(id)arg4 sourceOrderProvider:(id)arg5;	// IMP=0x0000000000403597
