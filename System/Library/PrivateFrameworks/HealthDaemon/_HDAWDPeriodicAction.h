...
- (void).cxx_destruct;	// IMP=0x0000000000374a49
- (void)performPeriodicActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000037478d
- (void)periodicActivity:(id)arg1 configureXPCActivityCriteria:(id)arg2;	// IMP=0x00000000003746ed
- (void)dealloc;	// IMP=0x0000000000373708
