...
- (void).cxx_destruct;	// IMP=0x0000000000003326
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000003245
- (unsigned long long)hash;	// IMP=0x00000000000031f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003130
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003092
- (void)copyTo:(id)arg1;	// IMP=0x000000000000302f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002fd2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002fc5
- (id)dictionaryRepresentation;	// IMP=0x0000000000002d0c
- (id)description;	// IMP=0x0000000000002c5d
