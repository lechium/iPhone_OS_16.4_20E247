...
- (void)_invokeDelegateForResponseFlags:(unsigned long long)arg1;	// IMP=0x0000000000001be3
- (void)present;	// IMP=0x0000000000001a9a
- (void)invalidate;	// IMP=0x0000000000001a2b
- (id)initWithAlert:(id)arg1 forDestination:(long long)arg2;	// IMP=0x000000000000197b
