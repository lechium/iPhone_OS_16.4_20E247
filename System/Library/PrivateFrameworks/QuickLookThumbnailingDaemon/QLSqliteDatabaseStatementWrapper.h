...
- (void).cxx_destruct;	// IMP=0x0000000000009bad
@property(nonatomic) struct sqlite3_stmt *stmt; // @synthesize stmt=_stmt;
@property(copy, nonatomic) NSString *key; // @synthesize key=_key;
- (void)dealloc;	// IMP=0x0000000000009b51
@property(nonatomic, getter=isInUse) _Bool inUse;
- (id)initWithStatement:(struct sqlite3_stmt *)arg1 key:(id)arg2 inUseTable:(id)arg3;	// IMP=0x0000000000009a2d
