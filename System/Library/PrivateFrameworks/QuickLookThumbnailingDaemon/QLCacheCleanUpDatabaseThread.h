...
- (void).cxx_destruct;	// IMP=0x000000000002c022
...
- (void)_threadMain;	// IMP=0x000000000002bc68
- (void)cleanUpForReset;	// IMP=0x000000000002b891
- (void)_writeAndCleanUp;	// IMP=0x000000000002b26e
- (_Bool)_updateHitCount;	// IMP=0x000000000002b10c
- (void)_stopWriteAndCleanUpThreadRunLoop;	// IMP=0x000000000002b0c0
@property(readonly, nonatomic) unsigned long long hitToSaveCount;
- (void)addHitWithThumbnailData:(id)arg1;	// IMP=0x000000000002adac
- (void)pause;	// IMP=0x000000000002acd0
- (void)stop;	// IMP=0x000000000002a9ff
- (void)startCleanUp;	// IMP=0x000000000002a890
- (void)dealloc;	// IMP=0x000000000002a7fb
- (id)initWithCacheThread:(id)arg1;	// IMP=0x000000000002a753
