...
- (void).cxx_destruct;	// IMP=0x00000000000176c2
- (id)nextThumbnailData;	// IMP=0x00000000000170ba
- (void)_createNewCacheIndexDatabaseEnumeratorWithFileIdentifier:(id)arg1;	// IMP=0x0000000000016fd3
- (id)initWithDiskCache:(id)arg1 fileIdentifier:(id)arg2;	// IMP=0x0000000000016f2e
