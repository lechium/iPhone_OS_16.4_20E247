...
+ (id)diskStores;	// IMP=0x0060000000018087
+ (id)diskStoreForURL:(id)arg1;	// IMP=0x0060000000017d12
...
- (void)executeBlock:(CDUnknownBlockType)arg1 onQueue:(id)arg2;	// IMP=0x0000000000017ef9
- (id)description;	// IMP=0x0000000000017eba
- (id)initWithURL:(id)arg1;	// IMP=0x00000000000178cf
