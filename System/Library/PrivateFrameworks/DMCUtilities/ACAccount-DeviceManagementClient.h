...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x0020000000001420
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x001000000000224d
- (id)dmc_accountQuotaString;	// IMP=0x0010000000001cc7
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000001c7c
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x0010000000001bf2
