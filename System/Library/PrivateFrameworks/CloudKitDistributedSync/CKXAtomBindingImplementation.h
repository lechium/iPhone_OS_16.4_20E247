...
- (void).cxx_destruct;	// IMP=0x00000000000c39c3
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (id)orcHelpers;	// IMP=0x00000000000c3911
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000c3803
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000c36f5
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000c350a
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000c3500
- (id)init;	// IMP=0x00000000000c3486
