...
- (id).cxx_construct;	// IMP=0x0000000000078038
- (void).cxx_destruct;	// IMP=0x0000000000077fcb
...
- (void)dealloc;	// IMP=0x0000000000077e5c
- (int)getPlanPhase;	// IMP=0x0000000000077e4e
- (void *)getEspressoContext;	// IMP=0x0000000000077e38
- (int)softmax;	// IMP=0x0000000000077d79
- (void)normalization:(float *)arg1;	// IMP=0x0000000000077b5a
- (int)espressoForwardInputs:(vector_aebc2d99)arg1;	// IMP=0x0000000000077adf
- (int)espressoForward:(float *)arg1;	// IMP=0x0000000000077aaf
- (int)prepareModelInputs:(vector_aebc2d99)arg1;	// IMP=0x00000000000779fe
- (int)prepareModelInput:(float *)arg1;	// IMP=0x00000000000779a8
- (int)prepareModelWithConfig:(id)arg1;	// IMP=0x00000000000775dc
- (id)initWithParameters:(id)arg1 inputNames:(id)arg2 outputNames:(id)arg3 properties:(id)arg4;	// IMP=0x0000000000077130
