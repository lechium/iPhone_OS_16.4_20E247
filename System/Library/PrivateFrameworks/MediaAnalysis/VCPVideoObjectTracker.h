...
- (void).cxx_destruct;	// IMP=0x0000000000178d34
...
- (int)trackObjectInFrame:(struct __CVBuffer *)arg1;	// IMP=0x00000000001788fd
- (id)initWithObjectBounds:(struct CGRect)arg1 inFrame:(struct __CVBuffer *)arg2 timestamp:(CDStruct_1b6d18a9)arg3;	// IMP=0x0000000000178610
