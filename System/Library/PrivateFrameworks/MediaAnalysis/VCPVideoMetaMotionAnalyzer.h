...
- (id).cxx_construct;	// IMP=0x0000000000076112
- (void).cxx_destruct;	// IMP=0x00000000000760d6
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x0000000000075c67
- (void)mergeSimilarSegments;	// IMP=0x0000000000075af1
- (int)processFrameMetadata:(id)arg1;	// IMP=0x000000000007585c
- (_Bool)decideSegmentPointBasedOn:(float)arg1;	// IMP=0x00000000000757c6
- (id)init;	// IMP=0x000000000007568f
