...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000107b44
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d0721
- (unsigned long long)hash;	// IMP=0x00000000000d06ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d05c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d0520
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d04a0
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d03f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d03ec
- (id)dictionaryRepresentation;	// IMP=0x00000000000cfeb4
- (id)description;	// IMP=0x00000000000cfe05
@property(nonatomic) _Bool hasLoopStart;
@property(nonatomic) _Bool hasLoopPeriod;
@property(nonatomic) _Bool hasLoopFadeLen;
- (id)exportToLegacyDictionary;	// IMP=0x0000000000107d63
