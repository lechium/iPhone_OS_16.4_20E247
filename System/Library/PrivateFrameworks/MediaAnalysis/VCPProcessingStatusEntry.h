...
+ (id)entryWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x00600000000cfc37
- (void).cxx_destruct;	// IMP=0x00000000000cfd03
...
- (id)initWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x00000000000cfb76
