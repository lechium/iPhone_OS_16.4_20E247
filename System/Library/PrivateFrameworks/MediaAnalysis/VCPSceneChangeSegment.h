...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000277980
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000277881
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000002777fd
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000277793
- (id)init;	// IMP=0x000000000027771f
