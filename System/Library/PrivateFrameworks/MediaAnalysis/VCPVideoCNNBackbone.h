...
+ (id)sharedModel:(id)arg1 outputNames:(id)arg2 properties:(id)arg3;	// IMP=0x0060000000105dc1
- (void).cxx_destruct;	// IMP=0x00000000001063b6
...
- (int)inference:(float *)arg1;	// IMP=0x000000000010629d
- (id)initWithConfig:(id)arg1;	// IMP=0x0000000000105f78
