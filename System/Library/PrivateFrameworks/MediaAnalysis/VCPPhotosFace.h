...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x001000000005b8f1
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x001000000005b78c
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andHumanObservation:(id)arg2;	// IMP=0x001000000005b67c
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000005ad9c
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000005a170
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x00100000000579db
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x00100000000553a3
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x001000000005533e
...
- (double)photosFaceRepresentationQuality;	// IMP=0x000000000005bfaf
- (double)photosFaceRepresentationRoll;	// IMP=0x000000000005bf9d
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x000000000005bf8b
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x000000000005bf79
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x000000000005bf67
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x000000000005bf55
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x000000000005bf43
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x000000000005bf31
- (double)photosFaceRepresentationBlurScore;	// IMP=0x000000000005bf1f
- (double)photosFaceRepresentationSize;	// IMP=0x000000000005bf0d
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000005befb
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000005bee9
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000005bed7
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x000000000005bec5
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x000000000005bd69
- (id)gist;	// IMP=0x000000000005b47a
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000005b3fa
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000005b35b
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000005afd6
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000055214
