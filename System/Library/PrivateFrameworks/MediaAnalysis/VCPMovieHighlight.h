...
- (void).cxx_destruct;	// IMP=0x00000000000a3108
...
- (void)checkAutoPlayable;	// IMP=0x00000000000a2e6e
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000a2d07
- (_Bool)isShort;	// IMP=0x00000000000a2cbc
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000a27bd
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000a2738
