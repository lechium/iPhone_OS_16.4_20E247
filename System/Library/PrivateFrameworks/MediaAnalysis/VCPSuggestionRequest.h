...
+ (id)requestWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000025e49
- (void).cxx_destruct;	// IMP=0x0000000000025f8a
...
- (id)initWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000025b0b
