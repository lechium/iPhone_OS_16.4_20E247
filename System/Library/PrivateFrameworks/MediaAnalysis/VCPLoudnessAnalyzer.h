...
- (id).cxx_construct;	// IMP=0x0000000000107393
- (void).cxx_destruct;	// IMP=0x0000000000107335
- (id)results;	// IMP=0x00000000001072bf
- (int)finalizeAnalysisAtTime:(const CDStruct_1b6d18a9 *)arg1;	// IMP=0x0000000000106bb2
- (int)processAudioSamples:(struct AudioBufferList *)arg1 timestamp:(struct AudioTimeStamp)arg2;	// IMP=0x0000000000106668
- (void)dealloc;	// IMP=0x00000000001065f0
- (int)setupWithSample:(struct opaqueCMSampleBuffer *)arg1 andSampleBatchSize:(int)arg2;	// IMP=0x0000000000106483
- (id)init;	// IMP=0x00000000001063de
