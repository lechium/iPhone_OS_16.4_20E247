...
+ (id)sharedNotifier;	// IMP=0x00400000000014a7
- (void).cxx_destruct;	// IMP=0x0000000000001c5f
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001644
- (id)_remoteConnection;	// IMP=0x00000000000014fc
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x00000000000011fd
