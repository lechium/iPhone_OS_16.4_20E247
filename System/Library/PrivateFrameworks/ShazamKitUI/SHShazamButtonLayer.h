...
- (struct CGPath *)bottomStrokePath;	// IMP=0x0000000000004048
- (struct CGPath *)topStrokePath;	// IMP=0x0000000000003f30
- (struct CGPath *)bottomStrokeLongPath;	// IMP=0x0000000000003d30
- (struct CGPath *)topStrokeLongPath;	// IMP=0x0000000000003b30
- (id)strokeLayerWithPath:(struct CGPath *)arg1 color:(struct CGColor *)arg2;	// IMP=0x0000000000003a63
- (void)drawSolidShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000032e3
- (void)drawSolidShape;	// IMP=0x0000000000003130
- (void)removeTransparentShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000002d5d
- (void)drawTransparentShape;	// IMP=0x0000000000002998
- (void)removeTransparentShape;	// IMP=0x00000000000028f9
- (void)performFadeInIntroAnimation:(double)arg1 delay:(double)arg2;	// IMP=0x00000000000025aa
- (void)performSDrawingAnimationWithDuration:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000002442
- (void)performSDrawingIntroAnimation;	// IMP=0x00000000000023eb
- (void)skipIntroAnimation;	// IMP=0x00000000000023b8
- (void)layoutSublayers;	// IMP=0x0000000000002010
- (void)setup;	// IMP=0x0000000000001c5e
