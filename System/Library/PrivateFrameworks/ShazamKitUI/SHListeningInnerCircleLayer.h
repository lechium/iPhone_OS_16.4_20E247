...
- (void).cxx_destruct;	// IMP=0x00000000000065df
...
- (struct CGPath *)circlePathForRect:(struct CGRect)arg1;	// IMP=0x0000000000006557
- (void)layoutSublayers;	// IMP=0x0000000000006302
- (void)setup;	// IMP=0x000000000000610f
