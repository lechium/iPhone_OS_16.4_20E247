...
- (void).cxx_destruct;	// IMP=0x00000000000060e7
...
- (void)presentMediaItem:(id)arg1 presentationSettings:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000005f10
- (void)presentMediaItem:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005dc3
- (void)tearDownConnection;	// IMP=0x0000000000005cce
- (void)attachDefaultConnectionHandlers;	// IMP=0x00000000000059fc
@property(readonly, nonatomic) NSXPCConnection *connection; // @synthesize connection=_connection;
- (id)initWithConnectionProvider:(id)arg1;	// IMP=0x00000000000058cf
- (void)dealloc;	// IMP=0x0000000000005891
