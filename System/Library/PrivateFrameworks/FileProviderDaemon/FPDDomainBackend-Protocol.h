...
@class FPCTLTermDumper, FPDDomain, FPDDomainCleanupResult, FPDDomainIndexer, FPDExtension, FPDRequest, FPExtensionEnumerationSettings, FPItem, FPItemID, FPSandboxingURLWrapper, NSArray, NSData, NSDictionary, NSError, NSFileProviderDomain, NSFileProviderDomainVersion, NSFileProviderItemVersion, NSProgress, NSString, NSURL;
...
- (void)fetchThumbnailsAtURL:(NSURL *)arg1 versions:(NSArray *)arg2 size:(struct CGSize)arg3 perThumbnailCompletionHandler:(void (^)(NSString *, NSFileProviderItemVersion *, NSData *, NSString *, NSData *, NSError *))arg4 completionHandler:(void (^)(NSError *))arg5;
