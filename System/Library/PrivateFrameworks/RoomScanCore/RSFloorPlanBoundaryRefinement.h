...
- (id).cxx_construct;	// IMP=0x000000000013b487
- (void).cxx_destruct;	// IMP=0x000000000013b449
- (void)reset;	// IMP=0x000000000013b326
- (id)runWithFloorPlan:(id)arg1 rsFrame:(id)arg2;	// IMP=0x000000000013a23d
- (void)setupRefinementProcessor:(id)arg1;	// IMP=0x0000000000139e6a
- (id)init;	// IMP=0x0000000000139dca
