...
- (void).cxx_destruct;	// IMP=0x000000000000561a
...
- (void)DDRemoteActionDidTerminateWithError:(id)arg1;	// IMP=0x0000000000005576
- (void)showErrorView;	// IMP=0x0000000000004c92
- (void)removeLoadingViewToShowView:(id)arg1;	// IMP=0x0000000000004ab1
- (void)showLoadingView;	// IMP=0x00000000000042cf
- (id)controllerVerticalMargin;	// IMP=0x00000000000041d7
- (void)unloadRemoteAction;	// IMP=0x0000000000004119
- (void)updatePreviewMode;	// IMP=0x0000000000003f6a
- (void)addHitOverlay;	// IMP=0x0000000000003d1c
- (void)presentRemoteViewController;	// IMP=0x00000000000037d6
- (void)showRemoteController;	// IMP=0x0000000000003739
- (void)loadRemoteAction:(id)arg1;	// IMP=0x00000000000031a2
- (void)loadTitleBarIfNeeded;	// IMP=0x0000000000002afb
- (void)dismissViewController;	// IMP=0x0000000000002abf
- (void)loadNavigationControllerIfNeeded;	// IMP=0x0000000000002714
- (id)emptyViewcontroller;	// IMP=0x0000000000002675
- (id)doneButton;	// IMP=0x0000000000002636
- (id)initWithAction:(id)arg1;	// IMP=0x00000000000023dd
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000002350
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000002316
- (void)dealloc;	// IMP=0x00000000000022d8
