...
+ (id)rangeWithDOMRange:(id)arg1;	// IMP=0x00600000000285e3
- (void).cxx_destruct;	// IMP=0x00000000000286d3
...
- (id)description;	// IMP=0x000000000002865b
- (void)dealloc;	// IMP=0x000000000002862c
- (id)initWithDOMRange:(id)arg1;	// IMP=0x000000000002853a
