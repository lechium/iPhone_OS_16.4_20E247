...
+ (id)eventName;	// IMP=0x0040000000007ce3
...
- (id)description;	// IMP=0x0000000000007f2d
- (id)initWithCategory:(id)arg1 areHealthNotificationsAuthorized:(id)arg2;	// IMP=0x0000000000007cf0
