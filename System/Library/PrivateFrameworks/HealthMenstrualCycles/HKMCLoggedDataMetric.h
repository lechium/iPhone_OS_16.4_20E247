...
+ (id)eventName;	// IMP=0x004000000001a788
- (void).cxx_destruct;	// IMP=0x000000000001a9ae
...
- (id)description;	// IMP=0x000000000001a8c4
- (id)initWithMethod:(id)arg1;	// IMP=0x000000000001a795
