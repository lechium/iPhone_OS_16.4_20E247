...
- (void).cxx_destruct;	// IMP=0x000000000000ead3
...
- (void)_ensureConnection;	// IMP=0x000000000000e744
- (void)activateNotesWithUserActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000e2e9
- (id)init;	// IMP=0x000000000000e265
