...
- (void).cxx_destruct;	// IMP=0x000000000000ff44
...
- (void)_finishProcessingAndNotify;	// IMP=0x000000000000fc3a
- (void)_showOrHideBacklinkIndicatorForDomainIdentifiers:(id)arg1 linkedIdentifiers:(id)arg2;	// IMP=0x000000000000f970
- (void)_searchBacklinksForInputUserActivity;	// IMP=0x000000000000f4c6
- (void)beginProcessing;	// IMP=0x000000000000f3f9
@property(readonly, nonatomic) long long type;
- (id)description;	// IMP=0x000000000000f2d9
- (id)initWithDelegate:(id)arg1 processingQueue:(id)arg2 inputUserActivityInfo:(id)arg3 processIdentifier:(int)arg4;	// IMP=0x000000000000f1fb
