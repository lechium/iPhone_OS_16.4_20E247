...
- (void)invalidate;	// IMP=0x0000000000025ba0
- (void)runWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025b2e
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (id)initWithDomainIdentifiers:(id)arg1 linkIdentifiers:(id)arg2;	// IMP=0x0000000000025a31
