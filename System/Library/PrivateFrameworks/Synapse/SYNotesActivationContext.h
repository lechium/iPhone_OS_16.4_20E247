...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000004a05
- (void).cxx_destruct;	// IMP=0x0000000000004d1e
...
- (id)initWithUserActivityData:(id)arg1 contextID:(unsigned int)arg2 renderID:(unsigned long long)arg3;	// IMP=0x0000000000004c3c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004b45
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004a38
- (id)init;	// IMP=0x0000000000004a0d
