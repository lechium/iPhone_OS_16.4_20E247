...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000a85ed
+ (Class)__class;	// IMP=0x00600000000a859d
- (void).cxx_destruct;	// IMP=0x00000000000a865a
