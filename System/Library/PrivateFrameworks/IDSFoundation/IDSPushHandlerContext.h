...
- (void).cxx_destruct;	// IMP=0x00000000000a18af
...
- (id)initWithQueue:(id)arg1 wakingTopics:(id)arg2 opportunisticTopics:(id)arg3 nonWakingTopics:(id)arg4 commands:(id)arg5;	// IMP=0x00000000000a16d5
