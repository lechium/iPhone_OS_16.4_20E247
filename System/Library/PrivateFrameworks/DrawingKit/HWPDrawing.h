...
- (void).cxx_destruct;	// IMP=0x0000000000016b2e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000016971
- (unsigned long long)hash;	// IMP=0x0000000000016854
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016689
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016511
- (void)copyTo:(id)arg1;	// IMP=0x00000000000163f8
- (void)writeTo:(id)arg1;	// IMP=0x00000000000162b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000162ac
- (id)dictionaryRepresentation;	// IMP=0x0000000000015ab7
- (id)description;	// IMP=0x0000000000015a08
...
- (int)StringAsCompressionAlgorithm:(id)arg1;	// IMP=0x0000000000015826
- (id)compressionAlgorithmAsString:(int)arg1;	// IMP=0x00000000000157dd
