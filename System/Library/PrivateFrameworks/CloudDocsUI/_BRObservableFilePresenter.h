...
- (void)accommodatePresentedItemDeletionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000020661
- (void)presentedItemDidMoveToURL:(id)arg1;	// IMP=0x0000000000020614
- (void)presentedItemUbiquityDidChange;	// IMP=0x00000000000205d7
- (void)presentedItemDidChange;	// IMP=0x000000000002059a
