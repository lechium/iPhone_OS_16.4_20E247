...
+ (id)sharedFontManager;	// IMP=0x0060000000001ff0
- (void).cxx_destruct;	// IMP=0x00000000000021e9
...
- (void)cacheFonts;	// IMP=0x0000000000002079
- (id)init;	// IMP=0x000000000000202d
