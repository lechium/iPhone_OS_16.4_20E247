...
- (void).cxx_destruct;	// IMP=0x0000000000011772
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000010c29
- (void)_fontSizeDidChange:(id)arg1;	// IMP=0x0000000000010c15
- (id)_buttonBackgroundImageForState:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x0000000000010a24
- (void)_buttonPressed:(id)arg1;	// IMP=0x00000000000109ac
- (void)dealloc;	// IMP=0x000000000001092a
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000f0ca
