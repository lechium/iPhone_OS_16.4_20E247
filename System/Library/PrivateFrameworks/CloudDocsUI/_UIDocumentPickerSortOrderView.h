...
- (void).cxx_destruct;	// IMP=0x000000000000b0cf
...
- (void)_toggleListMode:(id)arg1;	// IMP=0x000000000000af9b
- (void)valueChanged:(id)arg1;	// IMP=0x000000000000af0a
@property(nonatomic) int value;
- (void)updateForListMode;	// IMP=0x000000000000ae21
- (void)layoutSubviews;	// IMP=0x000000000000a3a6
- (void)setNeedsLayout;	// IMP=0x000000000000a377
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000009e90
