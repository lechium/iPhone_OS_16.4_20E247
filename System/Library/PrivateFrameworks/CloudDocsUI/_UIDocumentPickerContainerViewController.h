...
+ (id)userDefaults;	// IMP=0x0010000000032936
- (void).cxx_destruct;	// IMP=0x0000000000032f35
...
- (long long)displayMode;	// IMP=0x0000000000032e42
- (long long)defaultDisplayMode;	// IMP=0x0000000000032cd9
- (void)setDefaultDisplayMode:(long long)arg1;	// IMP=0x0000000000032b85
- (int)sortOrder;	// IMP=0x0000000000032a8b
- (void)setSortOrder:(int)arg1;	// IMP=0x0000000000032966
@property(nonatomic) struct CGPoint contentOffset;
@property(retain, nonatomic) NSArray *indexPathsForSelectedItems;
- (_Bool)isEditing;	// IMP=0x0000000000032816
- (void)setEditing:(_Bool)arg1;	// IMP=0x00000000000327f9
- (void)setEditing:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000032742
- (void)_sortOrderViewChanged:(id)arg1;	// IMP=0x00000000000325e7
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000325a6
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000032563
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000324e1
- (void)setChildViewController:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000003219a
- (void)_startSearchWithQueryString:(id)arg1 becomeFirstResponder:(_Bool)arg2;	// IMP=0x0000000000031fc6
- (void)setupSearchController;	// IMP=0x0000000000031dc1
- (void)_updateTraitCollection;	// IMP=0x0000000000031a36
- (void)ensureChildViewController;	// IMP=0x00000000000317bd
- (void)displayModeChanged;	// IMP=0x000000000003178f
- (void)dealloc;	// IMP=0x0000000000031745
- (void)invalidate;	// IMP=0x0000000000031708
- (id)initWithModel:(id)arg1;	// IMP=0x00000000000314fd
