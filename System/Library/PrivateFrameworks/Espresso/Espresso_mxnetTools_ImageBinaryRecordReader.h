...
- (void).cxx_destruct;	// IMP=0x000000000078b6a2
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x000000000078b551
- (id)labels;	// IMP=0x000000000078b456
- (id)imageData;	// IMP=0x000000000078b2ed
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x000000000078adf0
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x000000000078acf3
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000078aa27
