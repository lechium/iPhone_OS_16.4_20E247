...
- (id).cxx_construct;	// IMP=0x00000000007f7a9c
- (void).cxx_destruct;	// IMP=0x00000000007f7a6f
...
- (float *)dataAtIndex:(unsigned long long)arg1 key:(const void *)arg2;	// IMP=0x00000000007f7802
- (id)initWithBlobShapes:(const void *)arg1 numberOfDataPoints:(unsigned long long)arg2 batchSize:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x00000000007f75c7
- (id)dataPointAtIndex:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x00000000007f6d70
- (unsigned long long)numberOfDataPoints;	// IMP=0x00000000007f6d66
