...
- (void).cxx_destruct;	// IMP=0x0000000000015cf0
...
- (id)description;	// IMP=0x0000000000015bb8
- (id)initWithFetchType:(unsigned long long)arg1 identifier:(id)arg2 limit:(unsigned long long)arg3 retryCount:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000015ad0
