...
- (void).cxx_destruct;	// IMP=0x000000000001013d
...
- (void)_invalidate;	// IMP=0x000000000000ffe2
- (void)invalidate;	// IMP=0x000000000000fef9
- (id)remoteObjectProxy;	// IMP=0x000000000000fea9
- (void)addFailureBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000fc23
- (id)initWithFMNSXPCConnection:(id)arg1;	// IMP=0x000000000000fb85
