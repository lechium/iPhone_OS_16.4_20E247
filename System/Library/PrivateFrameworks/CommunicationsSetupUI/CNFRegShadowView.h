...
- (void).cxx_destruct;	// IMP=0x0000000000071374
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000007111b
- (id)initWithFrame:(struct CGRect)arg1 shadowImage:(id)arg2;	// IMP=0x000000000007108b
