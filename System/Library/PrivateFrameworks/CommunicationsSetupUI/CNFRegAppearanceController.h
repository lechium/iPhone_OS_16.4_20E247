...
+ (id)modernTransparentDarkAppearanceController;	// IMP=0x0060000000008e89
+ (id)modernTransparentLightAppearanceController;	// IMP=0x0060000000008e4c
+ (id)modernAppearanceController;	// IMP=0x0060000000008e0f
+ (id)gradientAppearanceController;	// IMP=0x0060000000008dd2
+ (id)stripedAppearanceController;	// IMP=0x0060000000008d95
+ (id)defaultAppearanceController;	// IMP=0x0060000000008d83
+ (id)appearanceControllerForStyle:(long long)arg1;	// IMP=0x0060000000008d46
+ (id)globalAppearanceController;	// IMP=0x0060000000008d1f
