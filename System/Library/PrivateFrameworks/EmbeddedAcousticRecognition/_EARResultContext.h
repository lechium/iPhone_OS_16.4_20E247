...
- (id).cxx_construct;	// IMP=0x00000000000aa099
- (void).cxx_destruct;	// IMP=0x00000000000aa024
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000a9bbf
- (id)description;	// IMP=0x00000000000a9ae1
- (void)resetPartialResultContext;	// IMP=0x00000000000a9a8e
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000a99ac
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000a99a2
