...
- (id).cxx_construct;	// IMP=0x000000000005d21c
- (void).cxx_destruct;	// IMP=0x000000000005d1e2
- (unsigned long long)drawNoise;	// IMP=0x000000000005d0ea
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x000000000005c9d4
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x000000000005c85e
- (id)init;	// IMP=0x000000000005c850
