...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052ab48
- (void)incrementCost;	// IMP=0x000000000052ab3e
- (void)incrementSubstitutions;	// IMP=0x000000000052ab34
- (void)incrementDeletions;	// IMP=0x000000000052ab2a
- (void)incrementInsertions;	// IMP=0x000000000052ab20
