...
- (void).cxx_destruct;	// IMP=0x00000000000275dd
...
- (id)coerceObject:(id)arg1 toObjectOfClass:(Class)arg2 outError:(id *)arg3;	// IMP=0x0000000000027247
- (_Bool)canCoerceToObjectOfClass:(Class)arg1;	// IMP=0x0000000000027105
- (id)availableClasses;	// IMP=0x00000000000270ef
- (void)addCoercionToClass:(Class)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000002705e
- (id)initWithClass:(Class)arg1;	// IMP=0x0000000000026fb2
