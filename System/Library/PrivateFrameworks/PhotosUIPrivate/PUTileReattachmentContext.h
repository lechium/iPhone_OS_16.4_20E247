...
- (void).cxx_destruct;	// IMP=0x00000000004ac3d0
...
- (void)setVelocity:(struct PUDisplayVelocity)arg1 forTileController:(id)arg2;	// IMP=0x00000000004ac2b9
- (struct PUDisplayVelocity)velocityForTileController:(id)arg1;	// IMP=0x00000000004ac1fc
