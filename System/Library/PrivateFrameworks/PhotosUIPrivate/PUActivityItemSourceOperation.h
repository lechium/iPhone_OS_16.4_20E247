...
- (void).cxx_destruct;	// IMP=0x000000000050cba3
...
- (void)pu_cancel;	// IMP=0x000000000050cb18
- (void)main;	// IMP=0x000000000050caa7
- (id)initWithDelegate:(id)arg1 activityType:(id)arg2;	// IMP=0x000000000050c9dc
