...
- (void).cxx_destruct;	// IMP=0x00000000001f4786
...
- (id)initWithInitialFrame:(struct CGRect)arg1 snapshotImage:(id)arg2 importItem:(id)arg3 indexPath:(struct PXSimpleIndexPath)arg4;	// IMP=0x00000000001f45cf
