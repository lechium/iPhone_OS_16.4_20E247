...
+ (void)updateChangeRequestForRevert:(id)arg1;	// IMP=0x0010000000315f7a
- (void).cxx_destruct;	// IMP=0x0000000000315e23
...
- (void)_setHidden:(_Bool)arg1 explicit:(_Bool)arg2 supportable:(_Bool)arg3;	// IMP=0x0000000000315cf6
- (id)newViewModelChange;	// IMP=0x0000000000315ce5
@property(readonly, nonatomic) PUPhotoEditIrisModelChange *currentChange;
- (_Bool)_hasLegacyIrisConflicts;	// IMP=0x0000000000315b12
- (void)_updateAutoDisableStateIfNeeded;	// IMP=0x0000000000315a85
- (void)compositionDidChange;	// IMP=0x0000000000315a4c
- (void)updateChangeRequestForSave:(id)arg1;	// IMP=0x00000000003159e3
@property(readonly, nonatomic) _Bool hasUnsavedChanges;
- (_Bool)reenablingLivePhotoShouldRemoveEdits;	// IMP=0x000000000031591c
- (void)notifyCannotSupportVideoEdits;	// IMP=0x00000000003158d0
- (void)dealloc;	// IMP=0x0000000000315809
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000315736
- (id)initWithIrisVisibilityState:(unsigned short)arg1 hasAdjustments:(_Bool)arg2 compositionController:(id)arg3;	// IMP=0x000000000031563d
- (id)initWithAsset:(id)arg1 compositionController:(id)arg2;	// IMP=0x0000000000315575
- (id)init;	// IMP=0x000000000031555f
