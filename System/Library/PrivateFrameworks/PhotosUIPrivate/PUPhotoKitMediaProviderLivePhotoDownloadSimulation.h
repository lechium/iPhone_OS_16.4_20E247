...
- (void).cxx_destruct;	// IMP=0x0000000000376dec
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000376bd6
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000376b2d
- (void)_handleResultLivePhoto:(id)arg1 info:(id)arg2;	// IMP=0x00000000003769b1
- (id)init;	// IMP=0x0000000000376902
