...
- (void).cxx_destruct;	// IMP=0x0000000000177007
...
- (void)px_finishIfPossible;	// IMP=0x0000000000176d79
- (_Bool)px_shouldWaitForCancel;	// IMP=0x0000000000176d71
- (void)cancel;	// IMP=0x0000000000176d04
- (void)_handleExportCompletion:(id)arg1;	// IMP=0x0000000000176b33
- (_Bool)_exportFromDirectory;	// IMP=0x00000000001767ef
- (_Bool)_canExportFromDirectory;	// IMP=0x000000000017647f
- (_Bool)_tryExportFromDirectory;	// IMP=0x0000000000176446
- (void)px_start;	// IMP=0x0000000000175dde
