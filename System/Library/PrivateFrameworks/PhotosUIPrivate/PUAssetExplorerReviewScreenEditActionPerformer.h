...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000000ce5cb
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000000ce563
- (void).cxx_destruct;	// IMP=0x00000000000cea2a
...
- (void)_presentEditViewControllerForReviewAsset:(id)arg1;	// IMP=0x00000000000ce76e
- (void)performUserInteractionTask;	// IMP=0x00000000000ce624
