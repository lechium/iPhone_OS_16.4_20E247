...
- (void).cxx_destruct;	// IMP=0x000000000037bfc7
...
- (id)controller:(id)arg1 willSetToolbarItems:(id)arg2;	// IMP=0x000000000037bcad
- (void)unregisterObserver:(id)arg1;	// IMP=0x000000000037bc90
- (void)registerObserver:(id)arg1;	// IMP=0x000000000037bc73
- (void)_notifyObserversDidFinishWithSavedAsset:(id)arg1;	// IMP=0x000000000037ba9c
- (void)_handleDoneButton:(id)arg1;	// IMP=0x000000000037b688
- (void)_handleCancelButton:(id)arg1;	// IMP=0x000000000037b674
- (void)viewDidLoad;	// IMP=0x000000000037b0e3
- (id)initWithReviewAsset:(id)arg1 mediaProvider:(id)arg2;	// IMP=0x000000000037afa5
