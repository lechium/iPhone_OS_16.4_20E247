...
+ (id)settingsControllerModule;	// IMP=0x0060000000477ee9
+ (id)sharedInstance;	// IMP=0x0060000000477eb9
- (void).cxx_destruct;	// IMP=0x0000000000477c9d
...
- (void)setDefaultValues;	// IMP=0x0000000000477a1e
- (void)setDefaultPresetTransitionValues;	// IMP=0x00000000004772b2
- (void)saveInteractiveSlideshowSettingsInUserDefaults;	// IMP=0x0000000000476fa7
- (_Bool)transitionSettingsAreDefaults;	// IMP=0x0000000000476b8d
- (void)restoreCurrentInteractiveTransitionValuesFromUserDefaults;	// IMP=0x0000000000476969
- (void)removeTransitionTimingCustomizationsFromUserDefaults;	// IMP=0x00000000004768aa
@property(retain, nonatomic) OKProducerPreset *currentPreset; // @synthesize currentPreset=_currentPreset;
- (id)archiveValueForKey:(id)arg1;	// IMP=0x00000000004764d5
- (void)applyArchiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000476448
- (void)performPostSaveActions;	// IMP=0x0000000000476407
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004763a6
- (id)parentSettings;	// IMP=0x000000000047638d
