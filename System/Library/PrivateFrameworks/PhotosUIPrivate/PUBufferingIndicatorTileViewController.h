...
+ (struct CGSize)bufferingIndicatorTileSize;	// IMP=0x0010000000109e11
+ (_Bool)canShowBufferingIndicatorTileForAsset:(id)arg1;	// IMP=0x0010000000109d9e
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000109a60
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x000000000010994b
- (void)_updateIndicator;	// IMP=0x00000000001096d6
- (void)_handleErrorButton:(id)arg1;	// IMP=0x000000000010952e
- (void)_setIndicatorStyle:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000108eff
- (void)becomeReusable;	// IMP=0x0000000000108c6f
