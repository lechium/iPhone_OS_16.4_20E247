...
- (void).cxx_destruct;	// IMP=0x0000000000403073
...
- (void)dealloc;	// IMP=0x0000000000402fca
- (id)initWithBrowsingViewModel:(id)arg1 isPresentedForSecondScreen:(_Bool)arg2;	// IMP=0x0000000000402f3c
