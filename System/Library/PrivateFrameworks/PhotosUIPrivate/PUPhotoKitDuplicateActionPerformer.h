...
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x006000000036b1cb
- (void).cxx_destruct;	// IMP=0x000000000036b13c
...
- (void)performBackgroundTask;	// IMP=0x000000000036afb2
- (void)performUserInteractionTask;	// IMP=0x000000000036ad76
