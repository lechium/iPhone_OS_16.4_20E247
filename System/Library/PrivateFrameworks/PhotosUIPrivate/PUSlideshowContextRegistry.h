...
- (void).cxx_destruct;	// IMP=0x000000000047184b
...
- (_Bool)removeDisplayContext:(id)arg1;	// IMP=0x00000000004716ef
- (_Bool)addDisplayContext:(id)arg1;	// IMP=0x0000000000471646
- (id)init;	// IMP=0x00000000004715c6
