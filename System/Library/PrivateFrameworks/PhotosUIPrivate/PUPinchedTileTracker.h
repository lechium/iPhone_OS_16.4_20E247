...
- (void).cxx_destruct;	// IMP=0x00000000003e9edd
...
- (void)_updateTargetLayoutInfoIfNeeded;	// IMP=0x00000000003e9cae
- (id)tileControllerToTrack;	// IMP=0x00000000003e9a2f
- (void)configureTileReattachmentContext:(id)arg1;	// IMP=0x00000000003e998d
- (void)completeTracking;	// IMP=0x00000000003e98f4
- (void)updateTileControllerTracking;	// IMP=0x00000000003e9581
- (void)startTileControllerTracking;	// IMP=0x00000000003e9113
- (void)updateGestureRecognizerTracking;	// IMP=0x00000000003e8f9c
- (void)setDelegate:(id)arg1;	// IMP=0x00000000003e8ef0
- (id)initWithPinchGestureRecognizer:(id)arg1 tilingView:(id)arg2 direction:(long long)arg3;	// IMP=0x00000000003e8d5e
- (id)initWithTilingView:(id)arg1;	// IMP=0x00000000003e8d44
