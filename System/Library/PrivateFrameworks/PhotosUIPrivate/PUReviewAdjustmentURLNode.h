...
- (void).cxx_destruct;	// IMP=0x00000000003fea57
...
- (void)run;	// IMP=0x00000000003fe86e
- (id)initWithReviewAsset:(id)arg1 directory:(id)arg2 contentEditingOutput:(id)arg3;	// IMP=0x00000000003fe712
