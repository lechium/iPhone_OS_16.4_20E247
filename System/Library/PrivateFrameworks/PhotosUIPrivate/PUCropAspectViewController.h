...
- (void).cxx_destruct;	// IMP=0x000000000012684f
...
- (void)aspectButtonPressed:(id)arg1;	// IMP=0x0000000000126481
- (void)updateAspectConstraints;	// IMP=0x0000000000124eef
- (void)updateAspectButtons;	// IMP=0x0000000000124882
- (id)matchingCropAspectTo:(id)arg1;	// IMP=0x0000000000124523
- (void)updateAspectButtonSelection;	// IMP=0x0000000000124375
- (void)viewDidLoad;	// IMP=0x0000000000123ec6
- (id)initWithLayoutOrientation:(long long)arg1 originalSize:(struct CGSize)arg2 currentSize:(struct CGSize)arg3 currentCropAspect:(id)arg4 spec:(id)arg5;	// IMP=0x0000000000123db5
