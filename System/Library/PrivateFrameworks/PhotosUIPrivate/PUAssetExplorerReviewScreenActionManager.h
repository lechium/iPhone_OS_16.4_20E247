...
- (void).cxx_destruct;	// IMP=0x00000000000c961d
...
- (id)actionPerformerForSimpleActionType:(unsigned long long)arg1 onAssetsByAssetCollection:(id)arg2;	// IMP=0x00000000000c8fc2
- (_Bool)shouldEnableActionType:(unsigned long long)arg1 onAsset:(id)arg2 inAssetCollection:(id)arg3;	// IMP=0x00000000000c8e87
- (_Bool)canPerformActionType:(unsigned long long)arg1 onAsset:(id)arg2 inAssetCollection:(id)arg3;	// IMP=0x00000000000c8d18
- (unsigned long long)_reviewScreenActionTypeForAssetActionType:(unsigned long long)arg1;	// IMP=0x00000000000c8b26
- (_Bool)_hasReviewScreenActionTypeForAssetActionType:(unsigned long long)arg1;	// IMP=0x00000000000c8b15
- (Class)_actionPerformerClassForActionType:(unsigned long long)arg1;	// IMP=0x00000000000c8ae0
- (id)initWithSourceType:(unsigned long long)arg1;	// IMP=0x00000000000c8a0d
