...
+ (struct CGSize)playbackTimeIndicatorTileSize;	// IMP=0x00100000003ee50d
- (void).cxx_destruct;	// IMP=0x00000000003ee410
...
- (void)_cancelFlashTimeIndicator;	// IMP=0x00000000003ee37e
- (void)_flashTimeIndicator;	// IMP=0x00000000003ee323
- (void)_handleViewModel:(id)arg1 change:(id)arg2;	// IMP=0x00000000003ee1d0
- (void)_handleVideoPlayer:(id)arg1 change:(id)arg2;	// IMP=0x00000000003ee175
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003ee0be
- (void)videoPlayer:(id)arg1 desiredSeekTimeDidChange:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000003ee0ac
- (void)videoPlayer:(id)arg1 currentTimeDidChange:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000003ee09a
- (void)_updateIndicatorDisplayStyle;	// IMP=0x00000000003edf02
- (void)_updateIndicatorValueWithTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000003ede2a
- (void)_setIndicatorVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000003edbc7
- (void)_setIndicatorFormat:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000003edb15
- (void)becomeReusable;	// IMP=0x00000000003ed89a
- (void)viewDidLoad;	// IMP=0x00000000003ed71c
