...
+ (id)settingsControllerModule;	// IMP=0x00600000004386dc
+ (id)sharedInstance;	// IMP=0x00600000004386ac
...
- (void)setDefaultValues;	// IMP=0x000000000043860d
- (id)parentSettings;	// IMP=0x00000000004385f4
