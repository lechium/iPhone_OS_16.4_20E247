...
- (void).cxx_destruct;	// IMP=0x00000000003772b1
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x000000000037709b
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000376ff2
- (void)_handleResultAnimatedImage:(id)arg1 info:(id)arg2;	// IMP=0x0000000000376f2c
- (id)init;	// IMP=0x0000000000376e7d
