...
- (void).cxx_destruct;	// IMP=0x000000000052d7ce
...
- (void)pu_endBackgroundTask:(id)arg1 completionStatus:(long long)arg2;	// IMP=0x000000000052d561
- (id)pu_beginBackgroundTaskForReason:(id)arg1;	// IMP=0x000000000052d559
@property(readonly, nonatomic) _Bool pu_isDepthEffectDisallowed;
- (void)pu_requestDismissalWithAction:(long long)arg1;	// IMP=0x000000000052d526
- (void)updateActions;	// IMP=0x000000000052d45c
@property(readonly, copy, nonatomic) id <PUWallpaperEditingLook> pu_currentLook;
- (void)pu_updateLuminanceValuesForLooks;	// IMP=0x000000000052d3ea
- (void)pu_updateLookProperties;	// IMP=0x000000000052d3d8
- (void)pu_updateLooks;	// IMP=0x000000000052d3c6
- (void)pu_updatePreferences:(CDUnknownBlockType)arg1;	// IMP=0x000000000052d350
@property(readonly, nonatomic) _Bool pu_canApplyParallaxToViews;
- (void)presentColorPickerWithConfiguration:(id)arg1 changeHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000052d1a6
- (void)colorPickerViewControllerDidFinish:(id)arg1;	// IMP=0x000000000052d192
- (void)colorPickerViewController:(id)arg1 didSelectColor:(id)arg2 continuously:(_Bool)arg3;	// IMP=0x000000000052d112
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000052cd80
- (void)_handlePageControlSelectedPage:(id)arg1;	// IMP=0x000000000052cc9c
- (void)_dismissAndCancel:(id)arg1;	// IMP=0x000000000052cc58
- (void)_dismissAndSave:(id)arg1;	// IMP=0x000000000052cbd7
- (void)viewDidLayoutSubviews;	// IMP=0x000000000052ca32
- (_Bool)prefersStatusBarHidden;	// IMP=0x000000000052ca2a
- (void)_setupSimulatedControls;	// IMP=0x000000000052bb3a
- (void)_setupEditorViews;	// IMP=0x000000000052b7ac
- (void)_updateLookControls;	// IMP=0x000000000052b59f
- (void)_updateLooks;	// IMP=0x000000000052b3db
- (void)_updateLookProperties;	// IMP=0x000000000052b235
- (void)_setupPosterEditorController;	// IMP=0x000000000052b1ad
- (void)viewDidLoad;	// IMP=0x000000000052b0ac
- (id)initWithAssets:(id)arg1 posterType:(long long)arg2 photoLibrary:(id)arg3;	// IMP=0x000000000052af6b
- (id)initWithExistingConfiguration:(id)arg1 assetDirectory:(id)arg2 overrideConfiguration:(id)arg3 photoLibrary:(id)arg4;	// IMP=0x000000000052ae52
- (id)initWithMigratorOfLegacyConfigurationType:(unsigned long long)arg1 photoLibrary:(id)arg2;	// IMP=0x000000000052ac57
- (id)initWithPosterType:(long long)arg1 photoLibrary:(id)arg2;	// IMP=0x000000000052ac38
- (id)initWithAsset:(id)arg1 posterType:(long long)arg2;	// IMP=0x000000000052ab59
- (id)initWithAsset:(id)arg1;	// IMP=0x000000000052aa7e
