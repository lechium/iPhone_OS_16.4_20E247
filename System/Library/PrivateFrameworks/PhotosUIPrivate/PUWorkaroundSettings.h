...
+ (id)settingsControllerModule;	// IMP=0x006000000050c776
+ (id)sharedInstance;	// IMP=0x006000000050c746
...
- (void)setDefaultValues;	// IMP=0x000000000050c964
- (id)parentSettings;	// IMP=0x000000000050c94b
