...
- (void).cxx_destruct;	// IMP=0x00000000001d53aa
...
- (void)setVideoComposition:(id)arg1 withSeekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000001d518e
- (void)setNeedsLayerTransformsUpdateAnimated:(_Bool)arg1;	// IMP=0x00000000001d5188
- (void)setImageCropRectFromViewCropRect:(struct CGRect)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001d5182
- (struct CGRect)validateViewCropRectAgainstModelCropRect:(struct CGRect)arg1;	// IMP=0x00000000001d516a
- (struct CGRect)viewCropRectForImageRect:(struct CGRect)arg1;	// IMP=0x00000000001d5152
- (struct CGRect)imageCropRectForViewRect:(struct CGRect)arg1;	// IMP=0x00000000001d513a
- (void)_resetCropRect;	// IMP=0x00000000001d50c8
- (struct CGRect)_imageBounds;	// IMP=0x00000000001d508b
@property(nonatomic, getter=isMuted) _Bool muted;
- (void)setModelCropRect:(struct CGRect)arg1 viewCropRect:(struct CGRect)arg2;	// IMP=0x00000000001d4fe2
- (id)cropModel;	// IMP=0x00000000001d4fda
- (void)_setCropModel:(id)arg1;	// IMP=0x00000000001d4fd4
- (void)_setTracking:(_Bool)arg1;	// IMP=0x00000000001d4f13
