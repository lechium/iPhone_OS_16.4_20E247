...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000000ceb40
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000000ceb27
- (void).cxx_destruct;	// IMP=0x00000000000cee27
...
- (void)_presentFunEffectsViewControllerForAsset:(id)arg1;	// IMP=0x00000000000ceca3
- (void)performUserInteractionTask;	// IMP=0x00000000000ceb59
