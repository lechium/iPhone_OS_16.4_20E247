...
- (void).cxx_destruct;	// IMP=0x00000000000cca6e
...
- (id)description;	// IMP=0x00000000000cc9b8
- (id)initWithOriginalAssetReference:(id)arg1 asset:(id)arg2 dataSourceIdentifier:(id)arg3;	// IMP=0x00000000000cc8a7
