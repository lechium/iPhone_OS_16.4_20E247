...
- (void).cxx_destruct;	// IMP=0x00000000003ed375
...
- (void)_handleVideoPlayer:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003ed1f0
- (void)_handleViewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003ed188
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003ed0d1
- (void)_updateCurrentPlaybackTimeAndDurationIfNeeded;	// IMP=0x00000000003ecfa7
- (void)_invalidateCurrentPlaybackTimeAndDuration;	// IMP=0x00000000003ecf74
- (void)_updateAVPlayerIfNeeded;	// IMP=0x00000000003ececa
- (void)_invalidateAVPlayer;	// IMP=0x00000000003ece97
- (void)_updatePlayPauseStateIfNeeded;	// IMP=0x00000000003ecdba
- (void)_invalidatePlayPauseState;	// IMP=0x00000000003ecd87
- (void)_updateVideoPlayerIfNeeded;	// IMP=0x00000000003ecc9b
- (void)_invalidateVideoPlayer;	// IMP=0x00000000003ecc68
- (void)_setNeedsUpdate;	// IMP=0x00000000003ecbbc
- (_Bool)_needsUpdate;	// IMP=0x00000000003ecb5b
- (void)_updateIfNeeded;	// IMP=0x00000000003eca49
- (void)_performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000003ec99f
- (void)_assertInsideUpdate;	// IMP=0x00000000003ec907
- (void)_assertInsideChangeBlock;	// IMP=0x00000000003ec86f
- (void)_publishChanges;	// IMP=0x00000000003ec5f8
@property(readonly, nonatomic) PUPlayPauseBarItemsControllerChange *_currentChange; // @synthesize _currentChange=__currentChange;
- (void)_stopObservingAVPlayer;	// IMP=0x00000000003ec34b
- (void)_startObservingAVPlayer;	// IMP=0x00000000003ec13a
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x00000000003ebe43
- (void)registerChangeObserver:(id)arg1;	// IMP=0x00000000003ebd91
- (id)init;	// IMP=0x00000000003ebd0a
