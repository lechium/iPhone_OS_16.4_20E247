...
- (void).cxx_destruct;	// IMP=0x000000000032b46e
...
- (void)_transitionToState:(long long)arg1;	// IMP=0x000000000032b35f
@property(readonly, nonatomic) double progress;
@property(readonly, nonatomic) _Bool supportsProgress;
- (_Bool)_requiresVideoRender;	// IMP=0x000000000032b222
- (void)_finishWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000032b0db
- (void)cancelSaveOperation;	// IMP=0x000000000032b066
- (void)_performRevertToOriginalOperation;	// IMP=0x000000000032ae8f
- (void)_performSaveContentEditingOutput;	// IMP=0x000000000032ad8e
- (void)_performSaveEditsOperation;	// IMP=0x000000000032a233
- (long long)_videoRequestVersion;	// IMP=0x000000000032a18c
- (long long)_imageRequestVersion;	// IMP=0x000000000032a0bb
- (void)beginSaveOperationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000329fe6
- (id)initWithPhoto:(id)arg1 compositionController:(id)arg2 contentEditingOutput:(id)arg3 workImageVersion:(long long)arg4 irisEditModel:(id)arg5 originalComposition:(id)arg6 useRawIfAvailable:(_Bool)arg7;	// IMP=0x0000000000329ebc
- (id)initWithPhoto:(id)arg1 contentEditingOutput:(id)arg2 workImageVersion:(long long)arg3 irisEditModel:(id)arg4 useRawIfAvailable:(_Bool)arg5;	// IMP=0x0000000000329dae
- (id)initWithPhotoToRevertToOriginal:(id)arg1;	// IMP=0x0000000000329d79
- (id)init;	// IMP=0x0000000000329cf2
