...
- (void).cxx_destruct;	// IMP=0x00000000001f2817
...
- (void)installDismissGestureRecognizersOnView:(id)arg1;	// IMP=0x00000000001f2699
- (_Bool)continuousGestureRecognizerIsActive:(id)arg1;	// IMP=0x00000000001f2636
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000001f240f
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000001f2407
- (void)maybeInitiateInteractiveDismiss:(id)arg1;	// IMP=0x00000000001f2352
@property(readonly, nonatomic) _Bool wantsInteractiveStart;
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x00000000001f21be
- (id)interactionControllerForDismissal:(id)arg1;	// IMP=0x00000000001f2173
- (id)interactionControllerForPresentation:(id)arg1;	// IMP=0x00000000001f2128
- (void)animationEnded:(_Bool)arg1;	// IMP=0x00000000001f20e5
- (id)interruptibleAnimatorForTransition:(id)arg1;	// IMP=0x00000000001f2095
- (id)initWithPresentingViewController:(id)arg1 pinchGestureRecognizer:(id)arg2;	// IMP=0x00000000001f1f27
