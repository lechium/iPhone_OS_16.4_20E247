...
- (void).cxx_destruct;	// IMP=0x00000000001cfe00
...
- (void)_handleRenderCompletedWithJpegData:(id)arg1 baseSize:(struct CGSize)arg2 editedSize:(struct CGSize)arg3;	// IMP=0x00000000001cfcfd
- (void)run;	// IMP=0x00000000001cfadd
- (id)_editSource;	// IMP=0x00000000001cf855
- (_Bool)_isInputValid;	// IMP=0x00000000001cf721
- (id)initWithImageInfoNode:(id)arg1 videoURLNode:(id)arg2 compositionController:(id)arg3 livePhotoPairingIdentifier:(id)arg4 jpegCompression:(double)arg5;	// IMP=0x00000000001cf41f
