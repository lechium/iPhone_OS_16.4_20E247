...
- (void).cxx_destruct;	// IMP=0x00000000004714e8
...
- (id)_layoutInfoWithDefaultDisappearance:(id)arg1;	// IMP=0x0000000000471416
- (id)finalLayoutInfoForDisappearingTileController:(id)arg1 fromLayoutInfo:(id)arg2;	// IMP=0x0000000000471401
- (id)initialLayoutInfoForAppearingTileController:(id)arg1 toLayoutInfo:(id)arg2;	// IMP=0x00000000004713ec
