...
- (void).cxx_destruct;	// IMP=0x00000000004713bb
...
- (struct CGRect)visibleRectForScrollingToItemAtIndexPath:(id)arg1 scrollPosition:(long long)arg2;	// IMP=0x00000000004712d9
- (id)layoutInfoForTileWithIndexPath:(id)arg1 kind:(id)arg2;	// IMP=0x0000000000470fac
- (id)layoutInfosForTilesInRect:(struct CGRect)arg1;	// IMP=0x0000000000470e80
- (struct CGRect)contentBounds;	// IMP=0x0000000000470e36
- (void)_invalidateSingleAssetLayout;	// IMP=0x0000000000470b77
