...
- (void).cxx_destruct;	// IMP=0x00000000001cd739
...
- (_Bool)hasReferenceIndexPath;	// IMP=0x00000000001cd6d0
- (void)invalidate;	// IMP=0x00000000001cd64b
- (id)init;	// IMP=0x00000000001cd5a9
