...
+ (id)settingsControllerModule;	// IMP=0x0060000000098ab8
+ (id)sharedInstance;	// IMP=0x0060000000098a88
...
- (void)setDefaultValues;	// IMP=0x0000000000098954
- (id)parentSettings;	// IMP=0x000000000009893b
