...
+ (id)settingsControllerModule;	// IMP=0x006000000008f43f
+ (id)sharedInstance;	// IMP=0x006000000008f40f
...
- (id)debugDescription;	// IMP=0x000000000008f0e5
- (void)setDefaultValues;	// IMP=0x000000000008f008
- (id)parentSettings;	// IMP=0x000000000008efef
