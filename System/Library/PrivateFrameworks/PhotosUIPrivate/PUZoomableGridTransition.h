...
- (void).cxx_destruct;	// IMP=0x0000000000510120
...
- (void)cancelInteractiveTransitionAnimated;	// IMP=0x000000000050feed
- (void)finishInteractiveTransitionAnimated;	// IMP=0x000000000050fea3
- (void)updateInteractiveTransitionForProgress:(double)arg1 centerOffset:(struct CGSize)arg2;	// IMP=0x000000000050fd50
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x000000000050fa04
- (id)initWithOriginLevel:(unsigned long long)arg1 targetLevel:(unsigned long long)arg2 zoomLevelManager:(id)arg3 interactive:(_Bool)arg4;	// IMP=0x000000000050f807
