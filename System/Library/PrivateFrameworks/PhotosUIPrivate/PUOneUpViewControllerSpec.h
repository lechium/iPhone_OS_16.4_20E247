...
- (void).cxx_destruct;	// IMP=0x00000000002dfd3d
...
- (void)_setHideBadgesWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002df9a4
- (void)_setHideStatusBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002df936
- (void)_setPrefersSquareImageInDetails:(_Bool)arg1;	// IMP=0x00000000002df8c8
- (void)_setHideScrubberWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002df85a
- (void)_setHideNavigationBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002df7ec
- (void)_setShouldDisplaySyndicationAttribution:(_Bool)arg1;	// IMP=0x00000000002df77e
- (void)_setRenderIndicatorSize:(struct CGSize)arg1;	// IMP=0x00000000002df39c
@property(readonly, nonatomic) struct CGSize playButtonSize;
- (void)updateIfNeeded;	// IMP=0x00000000002de360
...
- (id)spotlightBackgroundColor;	// IMP=0x00000000002de19e
@property(readonly, nonatomic) _Bool shouldUseSpotlightStyling;
- (_Bool)_shouldForceBlackBackground;	// IMP=0x00000000002de16c
...
- (_Bool)_isAssetExplorerReviewScreen;	// IMP=0x00000000002de0a4
@property(readonly, nonatomic) PUOneUpViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x00000000002de04c
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x00000000002ddfec
