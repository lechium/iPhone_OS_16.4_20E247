...
- (_Bool)embedsActivityViewForBounds:(struct CGRect)arg1 horizontalSizeClass:(long long)arg2 verticalSizeClass:(long long)arg3;	// IMP=0x00000000003d8642
...
- (double)interItemSpacingForWidth:(double)arg1;	// IMP=0x00000000003d858e
@property(readonly, nonatomic) double interItemSpacing;
- (_Bool)maximizeImageHeightForBounds:(struct CGRect)arg1;	// IMP=0x00000000003d8543
