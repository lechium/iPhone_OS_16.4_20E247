...
- (void).cxx_destruct;	// IMP=0x0000000000376237
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000376021
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000375f78
- (void)_handleResultPlayerItem:(id)arg1 info:(id)arg2;	// IMP=0x0000000000375eb2
- (id)init;	// IMP=0x0000000000375dd5
