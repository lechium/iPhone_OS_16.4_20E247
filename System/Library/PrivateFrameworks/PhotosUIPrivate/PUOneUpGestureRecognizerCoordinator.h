...
- (void).cxx_destruct;	// IMP=0x000000000029b1eb
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000029af4c
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x000000000029acec
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x000000000029aba6
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000029a9da
- (void)_updateGestureRecognizersIfNeeded;	// IMP=0x000000000029a829
- (void)invalidateViewHostingGestureRecognizers;	// IMP=0x000000000029a7fb
- (void)_invalidateGestureRecognizers;	// IMP=0x000000000029a7e4
- (id)longPressGestureRecognizer;	// IMP=0x000000000029a7bf
@property(readonly, nonatomic) PUTouchingGestureRecognizer *touchingGestureRecognizer;
- (void)addIrisGestureRecognizer:(id)arg1;	// IMP=0x000000000029a661
