...
- (void).cxx_destruct;	// IMP=0x00000000005265e7
...
- (void)_endScroll;	// IMP=0x000000000052644a
- (void)_incrementScroll;	// IMP=0x000000000052634f
- (void)scrollWithStartHandler:(CDUnknownBlockType)arg1 incrementHandler:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000526196
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000000526132
- (id)init;	// IMP=0x00000000005260b8
