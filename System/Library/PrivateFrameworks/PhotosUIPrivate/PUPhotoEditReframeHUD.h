...
- (void).cxx_destruct;	// IMP=0x0000000000455031
...
- (void)showStatsForPhoto:(id)arg1;	// IMP=0x0000000000451a8c
@property(copy, nonatomic) NSString *detailText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000451975
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000451931
