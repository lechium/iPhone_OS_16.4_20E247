...
- (void).cxx_destruct;	// IMP=0x000000000042ee2d
...
- (id)description;	// IMP=0x000000000042ecd2
- (id)concatenatedSynonyms;	// IMP=0x000000000042ec5d
- (id)initWithKeyword:(id)arg1 synonyms:(id)arg2 sceneIdentifier:(unsigned int)arg3 indexed:(_Bool)arg4 threshold:(double)arg5;	// IMP=0x000000000042eb85
