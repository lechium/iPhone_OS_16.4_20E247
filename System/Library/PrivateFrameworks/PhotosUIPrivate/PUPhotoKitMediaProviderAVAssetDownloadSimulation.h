...
- (void).cxx_destruct;	// IMP=0x0000000000376802
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000376588
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003764df
- (void)_handleResultAVAsset:(id)arg1 audioMix:(id)arg2 info:(id)arg3;	// IMP=0x00000000003763ee
- (id)init;	// IMP=0x0000000000376311
