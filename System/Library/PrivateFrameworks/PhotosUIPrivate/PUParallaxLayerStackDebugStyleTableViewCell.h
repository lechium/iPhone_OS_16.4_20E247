...
- (void).cxx_destruct;	// IMP=0x00000000002a8292
...
- (void)updateDelegate:(id)arg1;	// IMP=0x00000000002a813b
- (void)updateSlider:(id)arg1;	// IMP=0x00000000002a7fa4
- (void)updateColor:(id)arg1;	// IMP=0x00000000002a7e9e
- (void)applyToStyle:(id)arg1;	// IMP=0x00000000002a7b09
- (void)rebuildControlsViewForStyle:(id)arg1;	// IMP=0x00000000002a71fb
- (id)intensitySliderWithWidth:(double)arg1;	// IMP=0x00000000002a7086
- (id)colorButtonWithColor:(id)arg1 title:(id)arg2;	// IMP=0x00000000002a6fa2
- (id)newTonalityControl;	// IMP=0x00000000002a6f40
