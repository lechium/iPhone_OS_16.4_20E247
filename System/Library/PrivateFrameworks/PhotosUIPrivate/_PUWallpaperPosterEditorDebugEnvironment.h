...
- (void).cxx_destruct;	// IMP=0x000000000052a924
...
- (id)initWithSourcePosterConfiguration:(id)arg1;	// IMP=0x000000000052a6ca
- (id)initWithPosterDescriptor:(id)arg1;	// IMP=0x000000000052a670
- (id)init;	// IMP=0x000000000052a572
