...
- (void).cxx_destruct;	// IMP=0x0000000000217724
...
- (void)_updateBorderColor;	// IMP=0x0000000000217579
- (void)prepareForReuse;	// IMP=0x00000000002172c7
- (void)layoutSubviews;	// IMP=0x0000000000217231
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000217141
