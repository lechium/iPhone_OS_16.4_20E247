...
- (void).cxx_destruct;	// IMP=0x00000000001273fb
...
- (void)aspectRatioButtonPressed:(id)arg1;	// IMP=0x000000000012729f
- (id)initWithLayoutOrientation:(long long)arg1;	// IMP=0x0000000000126906
