...
- (struct CGRect)viewFrameForLayerFrame:(struct CGRect)arg1;	// IMP=0x0000000000028703
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000284a8
- (id)initWithVisibleFrame:(struct CGRect)arg1 containerFrame:(struct CGRect)arg2 canApplyParallax:(_Bool)arg3 parallaxVector:(struct CGPoint)arg4 parallaxAmount:(double)arg5 visibilityAmount:(double)arg6 visibilityEdge:(unsigned long long)arg7;	// IMP=0x0000000000028364
