...
+ (id)allHandles;	// IMP=0x00600000001288c2
- (void).cxx_destruct;	// IMP=0x0000000000128880
...
- (id)_createCornerOverlayView;	// IMP=0x0000000000128608
- (id)_createLineView;	// IMP=0x0000000000128580
- (id)initForHandle:(unsigned long long)arg1;	// IMP=0x000000000012763d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000127626
