...
+ (void)unregisterTransitionEndPoint:(id)arg1 forViewController:(id)arg2;	// IMP=0x00100000004c6710
+ (void)registerTransitionEndPoint:(id)arg1 forViewController:(id)arg2;	// IMP=0x00100000004c6676
+ (id)transitionEndPointWithViewController:(id)arg1;	// IMP=0x00100000004c61cd
- (void).cxx_destruct;	// IMP=0x00000000004c5069
...
- (long long)_barStyleForEndPoint:(id)arg1;	// IMP=0x00000000004c4bfa
- (_Bool)_endPointUsesTransientTilingView:(id)arg1;	// IMP=0x00000000004c4b9d
- (_Bool)_validateTransitionFromEndPoint:(id)arg1 toEndPoint:(id)arg2;	// IMP=0x00000000004c4a76
- (void)animateTransitionWithOperation:(long long)arg1 startedInteractively:(_Bool)arg2;	// IMP=0x00000000004c37e4
- (void)_getTransitionProgress:(double *)arg1 backgroundProgress:(double *)arg2 chromeProgress:(double *)arg3;	// IMP=0x00000000004c3507
- (void)resumeTransition:(_Bool)arg1;	// IMP=0x00000000004c3334
- (void)updatePausedTransitionWithProgress:(double)arg1 interactionProgress:(double)arg2;	// IMP=0x00000000004c31d2
- (void)pauseTransitionWithOptions:(unsigned long long)arg1;	// IMP=0x00000000004c2f46
- (void)pauseTransition;	// IMP=0x00000000004c2f32
- (id)initWithPresentationDuration:(double)arg1 dismissalDuration:(double)arg2;	// IMP=0x00000000004c2de0
- (id)init;	// IMP=0x00000000004c2dc8
