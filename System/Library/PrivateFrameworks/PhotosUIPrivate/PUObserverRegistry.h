...
- (void).cxx_destruct;	// IMP=0x000000000027cab0
...
- (void)enumerateObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000027c979
- (void)unregisterObserver:(id)arg1;	// IMP=0x000000000027c8ea
- (void)registerObserver:(id)arg1;	// IMP=0x000000000027c85b
- (id)init;	// IMP=0x000000000027c7d4
