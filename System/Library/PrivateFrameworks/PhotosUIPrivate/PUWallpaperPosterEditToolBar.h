...
- (void).cxx_destruct;	// IMP=0x00000000002338f5
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000002337f3
- (void)_setupView;	// IMP=0x000000000023304f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000232ff2
