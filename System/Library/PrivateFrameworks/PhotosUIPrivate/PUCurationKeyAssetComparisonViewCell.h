...
+ (double)cellHeightWithCellWidth:(double)arg1;	// IMP=0x0060000000049077
- (void).cxx_destruct;	// IMP=0x0000000000049035
...
- (void)prepareForReuse;	// IMP=0x0000000000048f52
- (void)layoutSubviews;	// IMP=0x0000000000048e72
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000048d90
