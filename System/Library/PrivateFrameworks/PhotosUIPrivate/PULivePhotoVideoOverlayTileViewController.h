...
+ (id)srlCompensationLoadingQueue;	// IMP=0x0010000000201a2c
...
- (void)_handleLoadedSRLCompensationAmount:(id)arg1 forAsset:(id)arg2;	// IMP=0x0000000000200fbd
- (void)_updateSRLCompensation;	// IMP=0x0000000000200d84
- (void)_updatePlaybackEnabled;	// IMP=0x0000000000200aef
- (void)_videoCurrentTimeDidChange:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000020087b
- (void)_updateMergedVideo;	// IMP=0x00000000002007b1
- (void)_updateLivePhotoViewModulatorInput;	// IMP=0x0000000000200733
- (void)_updateLivePhotoViewModulator;	// IMP=0x0000000000200586
- (void)_updateLivePhotoViewPhoto;	// IMP=0x0000000000200210
- (void)_updateLivePhotoViewFrame;	// IMP=0x000000000020004d
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000001ffbea
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000001ff977
- (double)livePhotoView:(id)arg1 extraMinimumTouchDurationForTouch:(id)arg2 withStyle:(long long)arg3;	// IMP=0x00000000001ff8f9
- (void)livePhotoView:(id)arg1 didEndPlaybackWithStyle:(long long)arg2;	// IMP=0x00000000001ff85c
- (void)livePhotoView:(id)arg1 willBeginPlaybackWithStyle:(long long)arg2;	// IMP=0x00000000001ff5ec
- (_Bool)livePhotoView:(id)arg1 canBeginPlaybackWithStyle:(long long)arg2;	// IMP=0x00000000001ff54e
- (id)gestureRecognizers;	// IMP=0x00000000001ff53c
- (id)loadView;	// IMP=0x00000000001ff27b
- (void)dealloc;	// IMP=0x00000000001ff227
- (void)setMergedVideo:(id)arg1;	// IMP=0x00000000001fef45
