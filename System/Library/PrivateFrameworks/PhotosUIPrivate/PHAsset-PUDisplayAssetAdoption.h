...
+ (id)pu_typeStringForMediaType:(long long)arg1;	// IMP=0x00100000000399c0
+ (long long)_pu_mediaTypeForAssets:(id)arg1;	// IMP=0x0010000000039845
+ (long long)pu_commonMediaTypeForPhotoCount:(long long)arg1 videoCount:(long long)arg2 otherCount:(long long)arg3;	// IMP=0x0010000000039800
+ (id)pu_typeStringForAssets:(id)arg1;	// IMP=0x0010000000039754
...
- (unsigned long long)contentChangeFromDisplayAsset:(id)arg1;	// IMP=0x001000000003907f
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x0010000000039011
@property(readonly, nonatomic) _Bool isTemporaryPlaceholder;
@property(readonly, nonatomic) NSString *localizedGeoDescription;
- (CDStruct_d80e62f2)pu_vitalityPerspectiveTransform;	// IMP=0x00100000001fec27
