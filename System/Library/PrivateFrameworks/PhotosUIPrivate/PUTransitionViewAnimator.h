...
- (void).cxx_destruct;	// IMP=0x00000000004d1c5b
...
- (void)_endWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4 finish:(_Bool)arg5 animated:(_Bool)arg6;	// IMP=0x00000000004d0fff
- (void)_autoUpdate:(id)arg1;	// IMP=0x00000000004d0fed
- (void)_updateAutoUpdateDisplayLink;	// IMP=0x00000000004d0ed0
- (void)_update;	// IMP=0x00000000004d0937
- (void)cancelWithoutAnimation;	// IMP=0x00000000004d0905
- (void)cancelWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x00000000004d08e8
- (void)finishWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x00000000004d08c8
- (void)updateWithTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3;	// IMP=0x00000000004d0821
- (id)initWithView:(id)arg1 sourceFrame:(struct CGRect)arg2 targetFrame:(struct CGRect)arg3 anchorPoint:(struct CGPoint)arg4 shouldUseTargetAspectRatio:(_Bool)arg5 rampUpDuration:(double)arg6 direction:(unsigned long long)arg7;	// IMP=0x00000000004d0161
