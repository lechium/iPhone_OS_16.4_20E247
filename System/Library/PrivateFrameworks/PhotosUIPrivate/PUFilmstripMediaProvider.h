...
- (void).cxx_destruct;	// IMP=0x00000000001a6308
...
- (void)_deliverPlaceholderImage;	// IMP=0x00000000001a6145
- (void)_deliverResult:(id)arg1;	// IMP=0x00000000001a5f44
- (void)_deliverPendingResults;	// IMP=0x00000000001a5b14
- (void)_didGenerateImage:(id)arg1 error:(id)arg2 requestedTime:(CDStruct_1b6d18a9)arg3 actualTime:(CDStruct_1b6d18a9)arg4 generatorResult:(long long)arg5 forResult:(id)arg6;	// IMP=0x00000000001a58b1
- (void)_generateImageForResult:(id)arg1;	// IMP=0x00000000001a5667
- (void)dealloc;	// IMP=0x00000000001a561e
- (void)cancelAllRequests;	// IMP=0x00000000001a55ad
- (void)cancelImageRequest:(int)arg1;	// IMP=0x00000000001a547e
- (void)_handleSourceTimeLoadedForAsset:(id)arg1 time:(double)arg2 targetSize:(struct CGSize)arg3 contentMode:(long long)arg4 requestNumber:(long long)arg5;	// IMP=0x00000000001a5336
- (int)requestImageForAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000001a500e
- (void)_performIvarWrite:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a4ec8
- (void)_performIvarRead:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a4eb0
- (id)init;	// IMP=0x00000000001a4e9a
- (id)initWithAVAsset:(id)arg1 videoComposition:(id)arg2;	// IMP=0x00000000001a4b75
