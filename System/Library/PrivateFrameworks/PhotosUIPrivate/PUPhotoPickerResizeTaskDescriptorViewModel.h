...
- (void).cxx_destruct;	// IMP=0x0000000000374682
...
- (void)infoUpdaterDidUpdate:(id)arg1;	// IMP=0x00000000003743ff
- (id)_infoDictionaryForLocalizedTitle:(id)arg1 localizedFileSizeDescription:(id)arg2;	// IMP=0x0000000000374333
- (id)requestInfoOfKind:(id)arg1 withResultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000374090
- (void)invalidateAssetsForResizing;	// IMP=0x0000000000374053
- (void)setFileSizeMenu:(id)arg1;	// IMP=0x0000000000373ff7
- (void)setResizeTaskDescriptor:(id)arg1;	// IMP=0x0000000000373f50
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000373f21
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000000373dc4
