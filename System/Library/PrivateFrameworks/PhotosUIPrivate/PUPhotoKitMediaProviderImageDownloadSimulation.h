...
- (void).cxx_destruct;	// IMP=0x0000000000375804
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000003755ee
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000375545
- (void)_handleResultImage:(id)arg1 info:(id)arg2;	// IMP=0x00000000003753ce
- (id)init;	// IMP=0x000000000037531f
