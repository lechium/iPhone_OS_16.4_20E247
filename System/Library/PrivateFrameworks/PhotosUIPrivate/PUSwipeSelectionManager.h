...
- (void).cxx_destruct;	// IMP=0x000000000048d867
...
- (void)updateSelectionWithCurrentIndexPath:(id)arg1 leftClosestIndexPath:(id)arg2 aboveClosestIndexPath:(id)arg3;	// IMP=0x000000000048d34b
- (void)endSelection;	// IMP=0x000000000048d270
- (void)beginSelectionFromIndexPath:(id)arg1;	// IMP=0x000000000048d1e1
- (long long)_selectionModeForRestoringStateOfIndexPath:(id)arg1;	// IMP=0x000000000048d0f6
- (id)_indexesPathsRangeForIndexPath:(id)arg1;	// IMP=0x000000000048cbd6
- (void)dealloc;	// IMP=0x000000000048caea
- (id)initWithSelectionMode:(long long)arg1 photoSelectionManager:(id)arg2;	// IMP=0x000000000048ca6c
- (id)init;	// IMP=0x000000000048ca28
