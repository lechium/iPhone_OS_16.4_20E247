...
- (void)px_finishIfPossible;	// IMP=0x0000000000178963
- (_Bool)px_shouldWaitForCancel;	// IMP=0x000000000017895b
- (void)cancel;	// IMP=0x00000000001788cb
- (void)_handleLayerStackResponse:(id)arg1;	// IMP=0x0000000000178618
- (_Bool)_loadLayerStackFromDirectory;	// IMP=0x0000000000178436
- (_Bool)_canLoadLayerStackFromDirectory;	// IMP=0x00000000001781ff
- (_Bool)tryLoadLayerStackFromDirectory;	// IMP=0x00000000001781c6
- (void)px_start;	// IMP=0x0000000000177bfa
- (id)initWithPosterMedia:(id)arg1 editConfiguration:(id)arg2 assetDirectory:(id)arg3 style:(id)arg4 persistedStyle:(id)arg5 isPreloading:(_Bool)arg6;	// IMP=0x0000000000177a82
