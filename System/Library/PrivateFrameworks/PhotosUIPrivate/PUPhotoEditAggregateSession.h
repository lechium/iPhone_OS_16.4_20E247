...
- (void).cxx_destruct;	// IMP=0x00000000001dd161
...
- (void)finishSessionWithEnd:(long long)arg1;	// IMP=0x00000000001dd080
- (id)finishSessionWithEnd:(long long)arg1 newCompositionController:(id)arg2 oldCompositionController:(id)arg3;	// IMP=0x00000000001dcc6c
- (void)_recordKeys:(id)arg1;	// IMP=0x00000000001dcb39
- (id)_sessionKeysWithEnd:(long long)arg1;	// IMP=0x00000000001dc9d4
@property(readonly, nonatomic) __weak NSArray *_autoCropKeys;
- (void)notifyDidAdjustCrop;	// IMP=0x00000000001dc899
- (void)notifyDidResetCrop;	// IMP=0x00000000001dc84b
- (void)notifyDidApplyPerspectiveAutoCrop;	// IMP=0x00000000001dc834
- (void)notifyDidApplyAutoCrop;	// IMP=0x00000000001dc7f0
- (struct __CFString *)_keyForSessionEnd:(long long)arg1;	// IMP=0x00000000001dc770
