...
+ (void)_setVisualImageAnalysis:(id)arg1 forAssetViewModel:(id)arg2;	// IMP=0x0010000000030098
- (void).cxx_destruct;	// IMP=0x000000000002ed03
...
- (void)_cancelVKImageAnalysisForAssetViewModel:(id)arg1;	// IMP=0x000000000002eb8a
- (void)_requestVKImageAnalysisByCurrentVideoFrameForAssetViewModel:(id)arg1;	// IMP=0x000000000002e9e3
- (void)_requestVKImageAnalysisForAssetViewModel:(id)arg1;	// IMP=0x000000000002e793
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x000000000002e3bb
- (id)initWithBrowsingViewModel:(id)arg1;	// IMP=0x000000000002e253
- (id)init;	// IMP=0x000000000002e1d9
