...
- (void).cxx_destruct;	// IMP=0x000000000033415b
...
- (void)accessibilityLongPressChanged:(id)arg1;	// IMP=0x0000000000333dd4
- (void)_updateBackgroundAnimated:(_Bool)arg1;	// IMP=0x0000000000333805
- (void)_addCenterConstraintsWithMetrics:(id)arg1 verticalLayout:(_Bool)arg2;	// IMP=0x0000000000331c64
- (void)_addTrailingConstraintsWithMetrics:(id)arg1 verticalLayout:(_Bool)arg2;	// IMP=0x00000000003318c7
- (void)_addLeadingConstraintsWithMetrics:(id)arg1 verticalLayout:(_Bool)arg2;	// IMP=0x0000000000331517
- (void)updateConstraints;	// IMP=0x0000000000330f0d
- (void)_invalidateAllConstraints;	// IMP=0x0000000000330e2d
@property(readonly, nonatomic) double shortSideSize;
- (double)tabBarHeight;	// IMP=0x0000000000330d27
- (void)setBackgroundStyle:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000330cff
- (void)_setToolButtons:(id)arg1 buttonSpacing:(long long)arg2 mainActionButton:(id)arg3 secondaryActionButton:(id)arg4 stretchableView:(id)arg5;	// IMP=0x000000000033044b
- (void)setToolButtons:(id)arg1 buttonSpacing:(long long)arg2 mainActionButton:(id)arg3 secondaryActionButton:(id)arg4;	// IMP=0x0000000000330428
- (void)setToolButtons:(id)arg1 mainActionButton:(id)arg2 secondaryActionButton:(id)arg3 stretchableView:(id)arg4;	// IMP=0x0000000000330314
- (void)setupWithLayoutOrientation:(long long)arg1;	// IMP=0x000000000033026d
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000003301ff
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003301bc
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000330173
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000330124
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000032fc44
