...
@interface PUSuggestionsSettings : PXSettings
{
    ...
    PUWallpaperShortcutsPlaygroundSettings *_shortcutsPlaygroundSettings;	// 40 = 0x28
}

+ (id)sharedInstance;	// IMP=0x00600000004ccf15
- (void).cxx_destruct;	// IMP=0x00000000004ccf02
...
- (void)createChildren;	// IMP=0x00000000004cc9b2
- (void)setDefaultValues;	// IMP=0x00000000004cc8de
- (id)parentSettings;	// IMP=0x00000000004cc8c5
