...
- (void).cxx_destruct;	// IMP=0x0000000000375d2d
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000375a99
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003759f0
- (void)_handleResultImageData:(id)arg1 dataUTI:(id)arg2 orientation:(long long)arg3 info:(id)arg4;	// IMP=0x0000000000375944
- (id)init;	// IMP=0x0000000000375895
