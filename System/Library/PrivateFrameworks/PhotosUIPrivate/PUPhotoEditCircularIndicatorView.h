...
- (void).cxx_destruct;	// IMP=0x00000000003132ad
...
- (void)resetToDefaults;	// IMP=0x00000000003131ac
- (void)_updateProgressLayer;	// IMP=0x0000000000312ed7
@property(retain, nonatomic) UIColor *ringColor;
- (void)_layoutSubLayers;	// IMP=0x00000000003129c3
- (void)layoutSubviews;	// IMP=0x0000000000312982
- (void)_setupLayers;	// IMP=0x00000000003126f1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000312541
