...
- (void).cxx_destruct;	// IMP=0x000000000015d641
...
- (void)_handleLoadedImageData:(id)arg1 imageUTI:(id)arg2 imageOrientation:(long long)arg3 info:(id)arg4;	// IMP=0x000000000015d3d1
- (void)run;	// IMP=0x000000000015d225
- (void)didCancel;	// IMP=0x000000000015d1d2
- (id)initWithAsset:(id)arg1 mediaProvider:(id)arg2 version:(long long)arg3;	// IMP=0x000000000015d11b
