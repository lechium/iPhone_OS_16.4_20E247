...
+ (id)settingsControllerModule;	// IMP=0x006000000043ab0c
+ (id)sharedInstance;	// IMP=0x006000000043aadc
...
- (void)setDefaultValues;	// IMP=0x000000000043a565
- (id)parentSettings;	// IMP=0x000000000043a54c
