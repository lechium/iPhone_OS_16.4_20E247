...
- (void).cxx_destruct;	// IMP=0x000000000042575a
...
- (void)settings:(id)arg1 changedValueForKeyPath:(id)arg2;	// IMP=0x0000000000425601
- (void)_hideToast;	// IMP=0x0000000000425523
- (void)_showReminderToQuitAfterChange;	// IMP=0x0000000000425399
- (void)_clearSettingsOverride;	// IMP=0x0000000000425269
- (void)_warnForSettingsOverride;	// IMP=0x000000000042513a
- (void)handleEllipsisBarButtonItem:(id)arg1;	// IMP=0x0000000000424d05
...
- (void)_updateNavigationItemOfViewController:(id)arg1;	// IMP=0x0000000000424b3e
- (void)pushViewController:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000424ac6
- (void)_invalidateNavigationItems;	// IMP=0x000000000042498c
- (void)callOnViewDidDisappearBlock;	// IMP=0x000000000042485b
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000042481a
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000042476d
@property(readonly, nonatomic) PXSettings *currentSettings;
- (id)initWithRootSettings:(id)arg1;	// IMP=0x0000000000424636
