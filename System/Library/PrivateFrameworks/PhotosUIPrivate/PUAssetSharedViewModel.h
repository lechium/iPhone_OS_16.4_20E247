...
- (void).cxx_destruct;	// IMP=0x00000000000d6f6b
...
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x00000000000d6b89
- (void)registerChangeObserver:(id)arg1;	// IMP=0x00000000000d6b5a
@property(readonly, nonatomic) PUAssetSharedViewModelChange *currentChange;
- (id)newViewModelChange;	// IMP=0x00000000000d6b02
- (id)initWithAsset:(id)arg1;	// IMP=0x00000000000d69b4
- (id)init;	// IMP=0x00000000000d693a
