...
- (void).cxx_destruct;	// IMP=0x00000000001d4611
...
- (void)_handleResultOfFullsizeImageDataRequestWithID:(int)arg1 imageData:(id)arg2 imageURL:(id)arg3 dataUTI:(id)arg4 orientation:(long long)arg5 info:(id)arg6;	// IMP=0x00000000001d400b
- (void)_handleResultOfImageRequestWithID:(int)arg1 image:(id)arg2 info:(id)arg3;	// IMP=0x00000000001d3e9e
- (void)cancelAllImageRequests;	// IMP=0x00000000001d3d99
- (void)_update;	// IMP=0x00000000001d3454
- (void)_setImageIsHigherQuality:(_Bool)arg1;	// IMP=0x00000000001d1f42
- (void)handlePreloadedImage:(id)arg1;	// IMP=0x00000000001d1c65
- (void)setAsset:(id)arg1;	// IMP=0x00000000001d1aa3
- (void)_assertInsideChangesBlock;	// IMP=0x00000000001d19f6
- (void)_publishChange:(id)arg1;	// IMP=0x00000000001d1859
- (void)_didChange;	// IMP=0x00000000001d17c0
- (void)_willChange;	// IMP=0x00000000001d16d3
- (void)updateIfNeeded;	// IMP=0x00000000001d168a
- (void)_invalidateImageRequest;	// IMP=0x00000000001d1673
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000001d15a7
- (void)unregisterObserver:(id)arg1;	// IMP=0x00000000001d14c2
- (void)registerObserver:(id)arg1;	// IMP=0x00000000001d13d5
- (void)dealloc;	// IMP=0x00000000001d139b
- (id)initWithMediaProvider:(id)arg1 asset:(id)arg2 requiresFullQualityImage:(_Bool)arg3;	// IMP=0x00000000001d11c2
- (id)init;	// IMP=0x00000000001d1148
- (id)imageByAddingWallpaperCropRectDiagnosticsForAsset:(id)arg1 sourceImage:(id)arg2;	// IMP=0x00000000003f9c8a
