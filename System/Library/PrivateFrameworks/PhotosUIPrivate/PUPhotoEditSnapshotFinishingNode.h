...
- (void).cxx_destruct;	// IMP=0x000000000032c407
...
- (void)run;	// IMP=0x000000000032c056
- (id)initWithAdjustmentNode:(id)arg1 baseMediaNode:(id)arg2 currentImageNode:(id)arg3 currentVideoNode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000032beae
