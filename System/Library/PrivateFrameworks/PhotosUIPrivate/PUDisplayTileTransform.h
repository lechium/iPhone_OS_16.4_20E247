...
+ (id)displayTileTransformWithModelTileTransform:(id)arg1 initialScale:(double)arg2 initialSize:(struct CGSize)arg3 displaySize:(struct CGSize)arg4 secondaryDisplayTileTransform:(id)arg5;	// IMP=0x0010000000147c61
...
- (id)description;	// IMP=0x000000000014762a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014761f
- (id)init;	// IMP=0x00000000001475bf
- (id)newDisplayTileTransformWithUserAffineTransform:(struct CGAffineTransform)arg1 userInputOriginIdentifier:(id)arg2;	// IMP=0x0000000000147b60
