...
- (void).cxx_destruct;	// IMP=0x00000000001ac1b3
...
- (id)indexPathForAsset:(id)arg1;	// IMP=0x00000000001ac152
- (id)assetAtIndexPath:(id)arg1;	// IMP=0x00000000001abfd8
- (double)_normalizedTimeForIndexPath:(id)arg1;	// IMP=0x00000000001abf03
- (long long)numberOfSubItemsAtIndexPath:(id)arg1;	// IMP=0x00000000001abe44
- (id)initWithAsset:(id)arg1 numberOfIndexes:(long long)arg2 indicatorInfos:(id)arg3;	// IMP=0x00000000001abd1d
- (id)init;	// IMP=0x00000000001abd04
