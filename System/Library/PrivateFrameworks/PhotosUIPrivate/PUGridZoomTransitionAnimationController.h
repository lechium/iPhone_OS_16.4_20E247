...
- (void).cxx_destruct;	// IMP=0x000000000051085d
- (void)animationEnded:(_Bool)arg1;	// IMP=0x000000000051064e
@property(readonly, nonatomic) PUZoomableGridTransition *gridTransitionInfo;
- (void)animateTransition:(id)arg1;	// IMP=0x00000000005103f6
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000051019f
