...
+ (struct CGSize)playButtonTileSize;	// IMP=0x00100000003ebc6f
- (void).cxx_destruct;	// IMP=0x00000000003ebba6
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003eb930
- (void)_setShouldShowPlayButton:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000003eb7d8
- (void)_updateButtonAnimated:(_Bool)arg1;	// IMP=0x00000000003eb494
- (void)_playButtonTapped:(id)arg1;	// IMP=0x00000000003eb40d
@property(readonly, nonatomic) _Bool showPlayButtonWhileActivated;
@property(readonly, nonatomic) _Bool canShowPauseButton;
- (void)becomeReusable;	// IMP=0x00000000003eb06d
- (void)dealloc;	// IMP=0x00000000003eaffe
- (id)loadView;	// IMP=0x00000000003eaeb3
