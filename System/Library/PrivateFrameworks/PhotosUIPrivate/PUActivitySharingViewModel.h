...
- (void).cxx_destruct;	// IMP=0x00000000004d00db
...
- (void)setActionSheet:(_Bool)arg1;	// IMP=0x00000000004d0018
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000004cffe9
- (id)mutableChangeObject;	// IMP=0x00000000004cffe0
- (id)init;	// IMP=0x00000000004cfec6
- (id)initWithActivitySharingConfiguration:(id)arg1;	// IMP=0x00000000004cfce7
