...
- (void).cxx_destruct;	// IMP=0x000000000015e351
...
- (void)_handleDidLoadAdjustmentData:(id)arg1 error:(id)arg2;	// IMP=0x000000000015e216
- (void)run;	// IMP=0x000000000015e0c3
- (void)didCancel;	// IMP=0x000000000015e070
- (id)initWithAsset:(id)arg1 mediaProvider:(id)arg2;	// IMP=0x000000000015dfcc
