...
- (void).cxx_destruct;	// IMP=0x00000000000efeb9
...
- (void)_centersButtonsIfNeeded:(id)arg1 identifiers:(id)arg2;	// IMP=0x00000000000efc16
- (id)_arrangedBarButtonItems:(id)arg1 identifiers:(id)arg2;	// IMP=0x00000000000ef9b0
- (id)_newEntryForIdentifiers:(id)arg1;	// IMP=0x00000000000ef89d
- (id)orderedBarButtonsItemsForIdentifiers:(id)arg1;	// IMP=0x00000000000ef663
- (long long)identifierForCustomButton:(id)arg1;	// IMP=0x00000000000ef557
- (long long)identifierForBarButtonItem:(id)arg1;	// IMP=0x00000000000ef44b
- (id)barButtonItemForIdentifier:(long long)arg1;	// IMP=0x00000000000ef301
@property(readonly, nonatomic) NSDictionary *barButtonItems;
- (void)_resetSet;	// IMP=0x00000000000ef222
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x00000000000ef115
- (id)init;	// IMP=0x00000000000ef101
