...
- (void).cxx_destruct;	// IMP=0x0000000000491ef5
...
- (id)tileControllerToTrack;	// IMP=0x0000000000491c86
- (void)completeTracking;	// IMP=0x0000000000491c2c
- (void)updateTileControllerTracking;	// IMP=0x00000000004917d5
- (void)startTileControllerTracking;	// IMP=0x0000000000491432
- (void)updateGestureRecognizerTracking;	// IMP=0x00000000004912c9
- (id)initWithPanGestureRecognizer:(id)arg1 tilingView:(id)arg2;	// IMP=0x00000000004911c1
- (id)initWithTilingView:(id)arg1;	// IMP=0x00000000004911aa
