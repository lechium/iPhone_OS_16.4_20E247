...
- (void).cxx_destruct;	// IMP=0x00000000003f03da
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000003f02f6
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000003f00ca
