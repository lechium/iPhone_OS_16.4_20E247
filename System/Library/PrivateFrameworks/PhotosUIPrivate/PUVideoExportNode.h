...
- (void).cxx_destruct;	// IMP=0x00000000004fd38f
...
- (void)_handleExportCompletedWithSuccess:(_Bool)arg1 editedSize:(struct CGSize)arg2 error:(id)arg3;	// IMP=0x00000000004fd2b1
- (void)didCancel;	// IMP=0x00000000004fd274
@property(readonly, nonatomic) double progress;
- (void)run;	// IMP=0x00000000004fcfbe
- (id)_editSource;	// IMP=0x00000000004fce57
- (id)_newOutputURL;	// IMP=0x00000000004fcd6e
- (id)_exportPresetName;	// IMP=0x00000000004fcd36
- (id)initWithVideoURLNode:(id)arg1 imageURLNode:(id)arg2 quality:(unsigned long long)arg3 livePhotoPairingIdentifier:(id)arg4 compositionController:(id)arg5;	// IMP=0x00000000004fcb1c
