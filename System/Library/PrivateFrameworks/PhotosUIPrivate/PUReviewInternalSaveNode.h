...
#import <PhotosUIPrivate/PUReviewImageURLNode-Protocol.h>
...
@interface PUReviewInternalSaveNode : PXRunNode <PUReviewImageURLNode>
{
...
- (void).cxx_destruct;	// IMP=0x000000000040cd39
...
- (void)run;	// IMP=0x000000000040bcca
- (id)_exportProperties;	// IMP=0x000000000040bc05
- (long long)_adjustmentBaseVersion;	// IMP=0x000000000040bb6a
- (double)_baseDuration;	// IMP=0x000000000040ba87
- (long long)_baseExifOrientation;	// IMP=0x000000000040b9f7
- (id)initWithDirectory:(id)arg1 imageDataNode:(id)arg2 imageRenderNode:(id)arg3 videoURLNode:(id)arg4 videoRenderNode:(id)arg5 livePhotoModel:(id)arg6;	// IMP=0x000000000040b812
