...
- (id)clone;	// IMP=0x0000000000046af9
- (_Bool)isGeometryEqualToLayoutInfo:(id)arg1;	// IMP=0x0000000000046941
- (id)initWithTileIdentifier:(id)arg1 center:(struct CGPoint)arg2 size:(struct CGSize)arg3 alpha:(double)arg4 transform:(struct CGAffineTransform)arg5 zPosition:(double)arg6 coordinateSystem:(id)arg7 untransformedContentFrame:(struct CGRect)arg8 contentInsets:(struct UIEdgeInsets)arg9 minimumVisibleHeight:(double)arg10;	// IMP=0x00000000000468a5
- (id)initWithTileIdentifier:(id)arg1 center:(struct CGPoint)arg2 size:(struct CGSize)arg3 alpha:(double)arg4 transform:(struct CGAffineTransform)arg5 zPosition:(double)arg6 coordinateSystem:(id)arg7;	// IMP=0x000000000004683b
