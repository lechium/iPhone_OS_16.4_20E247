...
- (void).cxx_destruct;	// IMP=0x000000000032be39
...
- (void)runNode:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x000000000032bd38
- (void)run;	// IMP=0x000000000032baab
- (id)initWithAdjustmentNode:(id)arg1;	// IMP=0x000000000032b9df
