...
- (void).cxx_destruct;	// IMP=0x000000000007a41c
@property(nonatomic) __weak PUAdjustmentsDataSource *dataSource; // @synthesize dataSource=_dataSource;
- (void)dataSource:(id)arg1 adjustmentInfo:(id)arg2 setEnabled:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000007a0af
