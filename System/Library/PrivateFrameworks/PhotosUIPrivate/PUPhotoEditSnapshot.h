...
+ (void)captureSnapshotForAsset:(id)arg1 mediaProvider:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x006000000032ca64
- (void).cxx_destruct;	// IMP=0x000000000032ca1b
...
- (void)_copySourceData:(id)arg1 destinationData:(out id *)arg2 destinationURL:(out id *)arg3;	// IMP=0x000000000032c7e1
- (id)_copyDataAtURL:(id)arg1;	// IMP=0x000000000032c72a
- (id)_copyData:(id)arg1;	// IMP=0x000000000032c6e9
- (id)_copyAsset:(id)arg1;	// IMP=0x000000000032c661
- (id)init;	// IMP=0x000000000032c57d
