...
- (void).cxx_destruct;	// IMP=0x00000000000d0ec5
...
- (void)_startPulseAnimation;	// IMP=0x00000000000d0d12
- (void)setShape:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000d0c07
- (void)layoutSubviews;	// IMP=0x00000000000d09e5
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000d0993
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000d0849
