...
- (void)updateIfNeeded;	// IMP=0x00000000004808ce
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000000048088a
- (id)init;	// IMP=0x0000000000480876
@property(readonly, nonatomic) PUSlideshowViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x000000000048081e
