...
- (void).cxx_destruct;	// IMP=0x00000000001f0417
...
- (struct CGSize)sizeForImportItemViewModel:(id)arg1;	// IMP=0x00000000001f0288
- (void)updatePreferredContentSize;	// IMP=0x00000000001f018a
- (void)viewDidLoad;	// IMP=0x00000000001f002c
- (id)initWithImportItemViewModel:(id)arg1 startingImage:(id)arg2 mediaProvider:(id)arg3;	// IMP=0x00000000001eff31
