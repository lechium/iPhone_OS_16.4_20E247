...
+ (Class)_contentViewClass;	// IMP=0x0060000000170771
+ (long long)_videoOverlayButtonStyle;	// IMP=0x0060000000170766
+ (void)preloadResources;	// IMP=0x006000000017070e
- (void).cxx_destruct;	// IMP=0x00000000001703bf
...
- (void)_handleCommentButton:(id)arg1;	// IMP=0x0000000000170022
- (void)_handlePlayButton:(id)arg1;	// IMP=0x000000000016ffc5
- (id)_imageCellDelegate;	// IMP=0x000000000016ffb3
- (void)_updateRoundedCornersOverlayView;	// IMP=0x000000000016fe85
- (void)_invalidateOverlayPlayButtonBackground;	// IMP=0x000000000016fe19
- (void)_updateCommentButton;	// IMP=0x000000000016fcd2
- (void)_updateOverlays;	// IMP=0x000000000016f6e8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000016f68e
- (void)layoutSubviews;	// IMP=0x000000000016ec87
- (void)_layoutImageView;	// IMP=0x000000000016ebf7
- (void)_updateVideoViewContentMode;	// IMP=0x000000000016ea98
- (void)_updateVideoPlayerContents;	// IMP=0x000000000016e8c0
- (void)setAudioSession:(id)arg1;	// IMP=0x000000000016e82d
- (void)setImage:(id)arg1 withTag:(long long)arg2;	// IMP=0x000000000016e469
- (void)setParallaxOffset:(struct CGPoint)arg1;	// IMP=0x000000000016e40c
- (id)focusEffect;	// IMP=0x000000000016e38f
- (void)prepareForReuse;	// IMP=0x000000000016e307
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000016e19a
