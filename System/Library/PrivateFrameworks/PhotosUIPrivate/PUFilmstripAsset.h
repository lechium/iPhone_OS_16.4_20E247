...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a3c77
- (long long)compare:(id)arg1;	// IMP=0x00000000001a3c36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a3bb9
...
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x00000000001a3b01
...
- (void)loadSourceTimeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a390b
- (id)initWithNormalizedTime:(double)arg1 asset:(id)arg2;	// IMP=0x00000000001a37e5
- (id)init;	// IMP=0x00000000001a37ce
