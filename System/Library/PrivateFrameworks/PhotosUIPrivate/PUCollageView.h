...
+ (long long)maximumNumberOfItems;	// IMP=0x0060000000119f37
- (void).cxx_destruct;	// IMP=0x0000000000119e1f
...
- (void)_updateRoundedCornerOverlayView;	// IMP=0x0000000000119bc8
- (void)_updateImageViews;	// IMP=0x0000000000119859
- (void)setHasRoundedCorners:(_Bool)arg1 withCornersBackgroundColor:(id)arg2;	// IMP=0x00000000001197de
- (void)setImage:(id)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x00000000001196c7
- (void)setImageSize:(struct CGSize)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x000000000011961a
- (struct CGSize)imageSizeForItemAtIndex:(long long)arg1;	// IMP=0x0000000000119566
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001194c2
- (void)layoutSubviews;	// IMP=0x0000000000118dfd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000118c03
