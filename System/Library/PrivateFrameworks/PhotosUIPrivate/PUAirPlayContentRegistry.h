...
- (void).cxx_destruct;	// IMP=0x000000000008a2b7
...
- (void)clearContent;	// IMP=0x000000000008a259
- (id)contentForController:(id)arg1;	// IMP=0x000000000008a1aa
- (void)_updateCurrentContentProvider;	// IMP=0x000000000008a0af
- (void)_invalidateCurrentContent;	// IMP=0x000000000008a09b
- (unsigned long long)_indexOfContentProvider:(id)arg1;	// IMP=0x0000000000089fbd
- (void)removeContentProvider:(id)arg1;	// IMP=0x0000000000089ee6
- (void)addContentProvider:(id)arg1;	// IMP=0x0000000000089e47
- (id)init;	// IMP=0x0000000000089dc7
