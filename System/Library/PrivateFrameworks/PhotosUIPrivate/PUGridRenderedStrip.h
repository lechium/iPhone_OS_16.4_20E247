...
- (void).cxx_destruct;	// IMP=0x00000000001bbf9e
...
- (_Bool)_disableRasterizeInAnimations;	// IMP=0x00000000001bbe51
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00000000001bbd87
- (void)_updateExtendedContents;	// IMP=0x00000000001bbc9d
- (void)_render;	// IMP=0x00000000001bb44b
@property(readonly, nonatomic) long long numberOfColumns;
- (void)setVisualSectionIndex:(long long)arg1 andVisualItemRange:(struct _NSRange)arg2;	// IMP=0x00000000001bb22a
- (void)setNeedsRendering;	// IMP=0x00000000001bb045
- (void)layoutSubviews;	// IMP=0x00000000001bab6a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001baade
