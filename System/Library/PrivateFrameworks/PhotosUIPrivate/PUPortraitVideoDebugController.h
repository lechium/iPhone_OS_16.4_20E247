...
- (void).cxx_destruct;	// IMP=0x00000000003203cb
...
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000000032025b
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000320142
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000000003200fe
- (void)loadView;	// IMP=0x000000000031f9bf
