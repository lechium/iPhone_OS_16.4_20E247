...
- (void).cxx_destruct;	// IMP=0x00000000003cb155
...
- (void)setFloatingOffset:(struct UIOffset)arg1;	// IMP=0x00000000003cafcf
- (void)prepareSublayout;	// IMP=0x00000000003ca9d1
@property(nonatomic) struct CGSize optionBadgeSize;
@property(nonatomic) struct CGSize selectionBadgeSize;
- (id)initWithIndexPath:(id)arg1 itemFrame:(struct CGRect)arg2;	// IMP=0x00000000003ca861
