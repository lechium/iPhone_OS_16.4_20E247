...
+ (struct CGRect)rectWithAspectRatio:(double)arg1 fillingRect:(struct CGRect)arg2 parallaxOffset:(struct CGPoint)arg3 edgeParallaxOffset:(struct CGPoint)arg4;	// IMP=0x0010000000164493
- (void).cxx_destruct;	// IMP=0x0000000000164442
...
- (_Bool)shouldRecognizerTap:(id)arg1;	// IMP=0x000000000016432e
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000016428e
- (void)_handleTap:(id)arg1;	// IMP=0x0000000000164231
- (void)_updateTapGestureRecognizer;	// IMP=0x0000000000164135
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000163fe7
- (void)dealloc;	// IMP=0x0000000000163f79
