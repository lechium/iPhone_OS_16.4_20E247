...
- (void).cxx_destruct;	// IMP=0x0000000000306d8c
...
- (void)oneUpPresentationHelper:(id)arg1 shouldDisableScroll:(_Bool)arg2;	// IMP=0x0000000000306d4f
- (void)oneUpPresentationHelper:(id)arg1 scrollAssetReferenceToVisible:(id)arg2;	// IMP=0x0000000000306cc7
- (void)oneUpPresentationHelper:(id)arg1 shouldHideAssetReferences:(id)arg2;	// IMP=0x0000000000306ada
- (id)oneUpPresentationHelper:(id)arg1 currentImageForAssetReference:(id)arg2;	// IMP=0x000000000030696b
- (id)oneUpPresentationHelper:(id)arg1 regionOfInterestForAssetReference:(id)arg2 cropInsets:(struct UIEdgeInsets *)arg3;	// IMP=0x00000000003066b8
- (id)_photoTokenForAssetReference:(id)arg1;	// IMP=0x00000000003061ba
