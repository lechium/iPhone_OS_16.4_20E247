...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000003752d0
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003752ca
- (void)_updateSimulatedDownload;	// IMP=0x00000000003750d1
- (void)beginSimulation;	// IMP=0x00000000003750a0
- (id)init;	// IMP=0x0000000000375000
