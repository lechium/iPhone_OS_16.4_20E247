...
- (void).cxx_destruct;	// IMP=0x0000000000086d30
- (id)init;	// IMP=0x0000000000086ce0
- (_Bool)createDestinationInstancesForSourceInstance:(id)arg1 entityMapping:(id)arg2 manager:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000868b0
