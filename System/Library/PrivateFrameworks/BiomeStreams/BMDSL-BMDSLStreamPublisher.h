...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x00300000000527e6
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x003000000008e741
@end
