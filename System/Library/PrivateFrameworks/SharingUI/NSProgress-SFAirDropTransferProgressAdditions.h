...
+ (id)sf_transferStateAsString:(long long)arg1;	// IMP=0x002000000002deb7
+ (id)sf_publishingKeyForApp:(id)arg1 sessionID:(id)arg2;	// IMP=0x002000000002d984
@property(readonly, nonatomic) NSString *sf_error;
- (void)sf_failedWithError:(id)arg1;	// IMP=0x001000000002e039
@property(nonatomic) long long sf_transferState;
@property(nonatomic) unsigned int sf_initiator;
- (id)sf_initWithFileURL:(id)arg1;	// IMP=0x001000000002dd54
...
- (id)sf_initWithAppBundle:(id)arg1 sessionID:(id)arg2 andPersonRealName:(id)arg3;	// IMP=0x001000000002d9ac
@end
