...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000a32c
- (void).cxx_destruct;	// IMP=0x000000000000a718
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000a3ed
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000a13f
- (id)init;	// IMP=0x000000000000a015
