...
- (void).cxx_destruct;	// IMP=0x000000000002e1db
...
- (id)initWithRequestID:(int)arg1 peopleSuggestion:(id)arg2 type:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000002e0ca
