...
- (void).cxx_destruct;	// IMP=0x0000000000034b89
...
- (void)eventDismiss:(id)arg1;	// IMP=0x0000000000034a6a
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000349e6
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000003482d
