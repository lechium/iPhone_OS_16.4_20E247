...
- (void).cxx_destruct;	// IMP=0x000000000002c5f4
...
- (id)initWithRequestID:(int)arg1 activity:(id)arg2 contentSizeCategory:(id)arg3 imageSymbolConfiguration:(id)arg4 synchronous:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000002c474
- (id)initWithRequestID:(int)arg1 identifier:(id)arg2 activityCategory:(long long)arg3 contentSizeCategory:(id)arg4 synchronous:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000002c3d8
