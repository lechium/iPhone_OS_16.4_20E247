...
- (void).cxx_destruct;	// IMP=0x000000000003193b
...
- (void)_updateDeviceVisual:(id)arg1;	// IMP=0x00000000000315a3
- (void)eventCancel:(id)arg1;	// IMP=0x0000000000031520
- (void)eventConfirm:(id)arg1;	// IMP=0x000000000003146c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000031423
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000003139f
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000030f5c
