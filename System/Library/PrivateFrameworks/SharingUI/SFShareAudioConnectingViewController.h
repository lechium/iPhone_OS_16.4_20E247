...
- (void).cxx_destruct;	// IMP=0x00000000000347a7
...
- (void)_updateDeviceVisual:(id)arg1;	// IMP=0x000000000003436f
- (void)_updateForDeviceInfo;	// IMP=0x00000000000340f1
- (void)sessionProgressEvent:(int)arg1 info:(id)arg2;	// IMP=0x0000000000033fe5
- (void)eventCancel:(id)arg1;	// IMP=0x0000000000033f62
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000033f19
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000033e7b
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000033d3c
