...
- (void)fetchFPItem:(CDUnknownBlockType)arg1;	// IMP=0x002000000000bcd1
- (void)fetchURL:(CDUnknownBlockType)arg1;	// IMP=0x002000000000bc01
- (void)fetchParents:(CDUnknownBlockType)arg1;	// IMP=0x002000000000bb13
- (void)fetchParent:(CDUnknownBlockType)arg1;	// IMP=0x002000000000b9b5
- (void)encodeNodeWithCoder:(id)arg1;	// IMP=0x002000000000b953
- (long long)localizedStandardTagsCompareNode:(id)arg1;	// IMP=0x002000000000b8fd
- (long long)_doc_fileTypeCompare:(id)arg1;	// IMP=0x002000000000b86c
