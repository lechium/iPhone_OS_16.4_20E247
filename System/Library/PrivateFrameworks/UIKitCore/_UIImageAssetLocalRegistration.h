...
+ (id)registrationWithImage:(id)arg1 configuration:(id)arg2;	// IMP=0x00600000008f075c
- (void).cxx_destruct;	// IMP=0x00000000008f0a7c
@property(retain, nonatomic) UIImageConfiguration *configuration; // @synthesize configuration=_configuration;
@property(retain, nonatomic) UIImage *image; // @synthesize image=_image;
- (_Bool)matchesConfiguration:(id)arg1;	// IMP=0x00000000008f08c5
