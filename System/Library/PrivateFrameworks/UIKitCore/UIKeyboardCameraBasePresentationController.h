...
- (void)postNotificationsForType:(unsigned long long)arg1 forStart:(_Bool)arg2;	// IMP=0x00000000010822dc
- (void)postNotificationsForType:(unsigned long long)arg1 from:(struct CGRect)arg2 to:(struct CGRect)arg3 forStart:(_Bool)arg4;	// IMP=0x0000000001082134
