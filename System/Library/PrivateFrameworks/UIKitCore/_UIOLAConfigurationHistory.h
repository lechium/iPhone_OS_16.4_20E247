...
- (void).cxx_destruct;	// IMP=0x00000000013560a6
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x0000000001355f29
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x0000000001355e62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001355d2c
