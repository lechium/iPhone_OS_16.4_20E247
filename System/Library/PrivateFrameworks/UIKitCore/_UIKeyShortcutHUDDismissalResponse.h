...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000db6cce
- (void).cxx_destruct;	// IMP=0x0000000000db6e8a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000db6d44
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000db6cd6
