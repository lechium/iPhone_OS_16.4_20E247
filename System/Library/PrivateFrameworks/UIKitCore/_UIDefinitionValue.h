...
- (void).cxx_destruct;	// IMP=0x00000000004be2cf
...
- (id)description;	// IMP=0x00000000004be1e4
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x00000000004be0d7
