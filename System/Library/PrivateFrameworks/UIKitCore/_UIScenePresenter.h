...
- (void).cxx_destruct;	// IMP=0x00000000007cea22
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000007ce9c2
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000007ce972
- (id)succinctDescriptionBuilder;	// IMP=0x00000000007ce8c5
- (id)succinctDescription;	// IMP=0x00000000007ce875
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) UIView<UIScenePresentation> *presentationView;
- (id)newSnapshotPresentationView;	// IMP=0x00000000007ce768
- (id)newSnapshotContext;	// IMP=0x00000000007ce646
- (id)newSnapshot;	// IMP=0x00000000007ce5b4
- (void)modifyPresentationContext:(CDUnknownBlockType)arg1;	// IMP=0x00000000007ce22f
@property(readonly, nonatomic, getter=isActive) _Bool active;
@property(readonly, copy, nonatomic) NSString *identifier;
@property(readonly, nonatomic) __weak FBScene *scene;
- (void)invalidate;	// IMP=0x00000000007ce0d0
- (void)deactivate;	// IMP=0x00000000007ce04e
- (void)activate;	// IMP=0x00000000007ce018
@property(readonly, nonatomic, getter=isInvalidated) _Bool invalidated;
- (long long)compare:(id)arg1;	// IMP=0x00000000007cdf69
- (void)dealloc;	// IMP=0x00000000007cdec2
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 sortContext:(id)arg3;	// IMP=0x00000000007cdd97
- (id)init;	// IMP=0x00000000007cdcfe
