...
- (void).cxx_destruct;	// IMP=0x00000000003d2de6
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003d2cc1
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000003d2c4f
@property(readonly, copy) NSString *description;
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2 placeholderConfiguration:(id)arg3;	// IMP=0x00000000003d2962
- (id)initWithDragItem:(id)arg1 target:(id)arg2;	// IMP=0x00000000003d2821
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2;	// IMP=0x00000000003d26f0
