...
- (void).cxx_destruct;	// IMP=0x00000000000f5419
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000f530d
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000f51f7
- (void)layoutSubviews;	// IMP=0x00000000000f50f1
- (void)enumerateTextAttachmentViewsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f4f34
@property(readonly, nonatomic) struct CGRect clipFrame;
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f4e54
- (void)_updateGeometry;	// IMP=0x00000000000f4c28
- (id)initWithLayoutFragment:(id)arg1 containerOrigin:(struct CGPoint)arg2 containerSize:(struct CGSize)arg3 clipRect:(struct CGRect)arg4;	// IMP=0x00000000000f49b5
