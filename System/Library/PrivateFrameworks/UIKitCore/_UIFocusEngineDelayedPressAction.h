...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x006000000071a0b8
- (void).cxx_destruct;	// IMP=0x000000000071a51f
...
- (void)_sendPressEvent;	// IMP=0x000000000071a1aa
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x0000000000719fbf
