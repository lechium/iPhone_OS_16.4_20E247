...
- (void).cxx_destruct;	// IMP=0x00000000012ce390
...
- (void)performAllCompletions:(_Bool)arg1;	// IMP=0x00000000012ce12a
- (void)performAllAnimations;	// IMP=0x00000000012cdf46
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000012cdeba
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000012cde2e
