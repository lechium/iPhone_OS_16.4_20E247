...
- (void).cxx_destruct;	// IMP=0x0000000000c9443f
...
- (id)init;	// IMP=0x0000000000c94346
- (void)reset;	// IMP=0x0000000000c942c4
- (void)addTypingTouchTime:(double)arg1;	// IMP=0x0000000000c9427d
- (void)logUserTyping:(id)arg1;	// IMP=0x0000000000c94203
- (void)typingCadence:(double)arg1;	// IMP=0x0000000000c93f34
- (void)updateConfidenceWithGap:(double)arg1;	// IMP=0x0000000000c93e86
- (id)recognizer:(id)arg1 confidenceWhenSettingTouchInfo:(id)arg2;	// IMP=0x0000000000c93e7e
- (id)recognizer:(id)arg1 confidenceWhenPendingTouchInfo:(id)arg2;	// IMP=0x0000000000c93df9
