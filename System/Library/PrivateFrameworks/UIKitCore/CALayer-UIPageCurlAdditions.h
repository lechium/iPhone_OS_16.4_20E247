...
- (_Bool)uiHasFilterWithName:(id)arg1;	// IMP=0x003000000049a6cc
- (void)setPerspectiveDistance:(double)arg1;	// IMP=0x0030000000ce21a4
- (long long)compareTextEffectsOrdering:(id)arg1;	// IMP=0x00300000012041ad
...
- (void)_setLabelMasksToBoundsForAnimation:(_Bool)arg1;	// IMP=0x00300000013d0c6d
