...
- (void).cxx_destruct;	// IMP=0x0000000000965c6b
...
- (_Bool)_wantsKeyCommandsWhenDeferred;	// IMP=0x0000000000965b8e
- (long long)_focusItemDeferralMode;	// IMP=0x0000000000965b75
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000965ad2
- (_Bool)canBecomeFocused;	// IMP=0x0000000000965ac0
- (void)setDirectionalLayoutMargins:(struct NSDirectionalEdgeInsets)arg1;	// IMP=0x0000000000965a21
- (void)addObscuringMaterialViewWithGroupName:(id)arg1;	// IMP=0x00000000009658eb
- (void)setBackgroundMaterialGroupName:(id)arg1;	// IMP=0x00000000009655a4
- (void)didMoveToWindow;	// IMP=0x00000000009654ae
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000096502d
