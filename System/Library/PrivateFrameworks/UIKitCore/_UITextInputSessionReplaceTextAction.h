...
@interface _UITextInputSessionReplaceTextAction
{
    ...
    unsigned long long _insertedTextLength;	// 112 = 0x70
    unsigned long long _options;	// 120 = 0x78
    unsigned long long _removedEmojiCount;	// 128 = 0x80
    unsigned long long _insertedEmojiCount;	// 136 = 0x88
    unsigned long long _removedPunctuationCount;	// 144 = 0x90
    unsigned long long _insertedPunctuationCount;	// 152 = 0x98
}
...
- (id)description;	// IMP=0x00000000011aa323
- (_Bool)changedContent;	// IMP=0x00000000011aa31b
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x00000000011a9fac
