...
- (void).cxx_destruct;	// IMP=0x000000000144e562
...
- (void)runActionForKey:(id)arg1 object:(id)arg2 arguments:(id)arg3;	// IMP=0x000000000144d02e
- (id)initWithPendingAnimation:(id)arg1 withAnimationObject:(id)arg2 forView:(id)arg3;	// IMP=0x000000000144cf65
