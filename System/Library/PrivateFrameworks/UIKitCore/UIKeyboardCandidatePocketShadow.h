...
+ (id)leftShadowImage;	// IMP=0x006000000096476e
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x00600000009646f1
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000964f72
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000096486d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009647e5
