...
- (void).cxx_destruct;	// IMP=0x000000000004efd2
...
- (void)_gestureChanged:(id)arg1;	// IMP=0x000000000004ee85
- (void)reset;	// IMP=0x000000000004ee42
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000004ed3d
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000004eca6
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x000000000004ec02
