...
+ (id)_observationKeys;	// IMP=0x00100000012f1dd1
- (void).cxx_destruct;	// IMP=0x00000000012f37ea
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000012f35f0
- (void)_updateOutputs;	// IMP=0x00000000012f27cc
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x00000000012f2640
- (id)candidates;	// IMP=0x00000000012f262f
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x00000000012f25c8
- (id)description;	// IMP=0x00000000012f22e7
- (void)dealloc;	// IMP=0x00000000012f2184
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000012f2001
- (id)init;	// IMP=0x00000000012f1e56
