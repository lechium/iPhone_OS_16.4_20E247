...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0010000000727860
- (void).cxx_destruct;	// IMP=0x0000000000728637
...
- (id)takeSnapshot;	// IMP=0x0000000000727abc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000727999
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00000000007278cc
