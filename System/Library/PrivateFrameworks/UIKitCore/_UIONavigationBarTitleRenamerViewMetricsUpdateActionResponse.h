...
- (id)initWithRenderID:(unsigned long long)arg1 contextID:(unsigned int)arg2 intrinsicContentSize:(struct CGSize)arg3 bounds:(struct CGRect)arg4 horizontalTextInset:(double)arg5;	// IMP=0x0000000000798288
