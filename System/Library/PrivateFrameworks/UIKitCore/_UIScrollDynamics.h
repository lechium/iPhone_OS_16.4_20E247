...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x000000000141f10e
- (void)calculateToReachDecelerationTarget;	// IMP=0x000000000141f108
- (void)calculateDecelerationTarget;	// IMP=0x000000000141f102
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x000000000141f0fa
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x000000000141f0e4
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x000000000141f0d8
- (double)speedAfterDuration:(double)arg1;	// IMP=0x000000000141f0cf
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x000000000141efba
- (id)init;	// IMP=0x000000000141ef4f
