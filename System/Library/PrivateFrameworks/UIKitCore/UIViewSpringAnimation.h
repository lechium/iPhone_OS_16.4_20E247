...
- (void).cxx_destruct;	// IMP=0x000000000139a715
...
- (_Bool)isStable;	// IMP=0x000000000139a52e
@property(retain, nonatomic) id <UIVectorOperatable> velocity;
- (id)stepWithDelta:(double)arg1;	// IMP=0x000000000139a2a3
- (id)initWithCurrent:(id)arg1 targetValue:(id)arg2;	// IMP=0x000000000139a1fc
- (void)updateWithDescription:(id)arg1 initial:(_Bool)arg2;	// IMP=0x0000000001399c51
- (void)updateWithDescription:(id)arg1;	// IMP=0x0000000001399c3d
- (id)initWithDescription:(id)arg1 current:(id)arg2 targetValue:(id)arg3;	// IMP=0x0000000001399a18
