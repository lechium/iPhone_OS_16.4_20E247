...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000ba6f85
+ (id)_standardGlyphColor;	// IMP=0x0060000000ba6f4c
- (void).cxx_destruct;	// IMP=0x0000000000ba7717
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000ba738e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ba7074
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000ba6f9e
