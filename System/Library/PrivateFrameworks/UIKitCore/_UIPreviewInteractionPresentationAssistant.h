...
- (void).cxx_destruct;	// IMP=0x0000000001398bf2
...
- (void)_createpresentationAnimatorIfNecessary:(id)arg1;	// IMP=0x0000000001398a69
- (void)_postInteractionCleanup;	// IMP=0x00000000013988bd
- (void)animateTransition:(id)arg1;	// IMP=0x0000000001397b72
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000001397b49
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000001397b27
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x0000000001397b02
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x000000000139749b
- (id)_sourcePreviewPortal;	// IMP=0x00000000013972fc
- (void)_applyStashedParentViewControllerIfNecessary;	// IMP=0x0000000001396fec
- (void)_stashParentViewControllerIfNecessary;	// IMP=0x0000000001396ebb
- (void)dismissViewController;	// IMP=0x0000000001396b98
- (void)presentFromViewController:(id)arg1 sourcePreview:(id)arg2 dismissalCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000001396a76
- (id)initWithViewControllerPresentation:(id)arg1;	// IMP=0x0000000001396a0e
