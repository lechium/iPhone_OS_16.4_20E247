...
- (void).cxx_destruct;	// IMP=0x00000000008f5139
...
- (id)imageWithConfiguration:(id)arg1;	// IMP=0x00000000008f4f29
- (id)initWithData:(id)arg1;	// IMP=0x00000000008f4f20
- (id)initWithContentsOfFile:(id)arg1;	// IMP=0x00000000008f4e01
