...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000dbda31
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000dbda04
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000dbd9d3
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000dbd96a
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000dbd958
- (void)reset;	// IMP=0x0000000000dbd76c
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000dbd3ac
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000dbd282
- (id)description;	// IMP=0x0000000000dbd1af
- (void)dealloc;	// IMP=0x0000000000dbd12d
- (id)init;	// IMP=0x0000000000dbd01b
