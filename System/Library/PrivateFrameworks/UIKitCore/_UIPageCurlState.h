...
- (void).cxx_destruct;	// IMP=0x000000000049b51e
...
- (_Bool)isCompatibleWithCurlOfType:(long long)arg1 inDirection:(long long)arg2;	// IMP=0x000000000049b3e8
- (long long)_effectiveTransitionDirection;	// IMP=0x000000000049b3b6
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000049b329
- (void)cleanup;	// IMP=0x000000000049b301
- (void)cleanupWithFinishedState:(_Bool)arg1 completedState:(_Bool)arg2;	// IMP=0x000000000049b28b
- (void)finally;	// IMP=0x000000000049b258
- (void)incrementCompletionCount;	// IMP=0x000000000049b247
@property(readonly, nonatomic, getter=hasPendingAnimations) _Bool pendingAnimations;
- (void)setCurlState:(long long)arg1 willComplete:(_Bool)arg2;	// IMP=0x000000000049b152
- (void)addBackPageContent;	// IMP=0x000000000049b0a1
- (void)addFrontPageContent;	// IMP=0x000000000049aff0
@property(readonly, nonatomic) UIView *backPageView;
@property(readonly, nonatomic) UIView *frontPageView;
- (struct CGRect)_pageViewFrame;	// IMP=0x000000000049a9a2
- (void)invalidatePageCurl;	// IMP=0x000000000049a981
- (void)dealloc;	// IMP=0x000000000049a943
- (id)initWithPageCurl:(id)arg1 andCurlType:(long long)arg2 fromLocation:(struct CGPoint)arg3 withReferenceLocation:(struct CGPoint)arg4 inDirection:(long long)arg5 withView:(id)arg6 revealingView:(id)arg7 completion:(CDUnknownBlockType)arg8 finally:(CDUnknownBlockType)arg9;	// IMP=0x000000000049a794
