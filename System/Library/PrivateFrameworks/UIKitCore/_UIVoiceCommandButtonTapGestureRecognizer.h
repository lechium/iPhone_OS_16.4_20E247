...
- (id)voiceCommandButtonTapDuration;	// IMP=0x0000000000af459c
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000af450f
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000af4482
- (void)reset;	// IMP=0x0000000000af4439
