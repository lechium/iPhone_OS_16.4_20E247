...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x000000000066d7c3
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x000000000066d716
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x000000000066d6cf
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x000000000066d673
- (id)init;	// IMP=0x000000000066d634
