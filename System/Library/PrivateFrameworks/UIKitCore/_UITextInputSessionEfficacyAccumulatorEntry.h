...
+ (id)generateAccumulatorEntryFromAction:(id)arg1;	// IMP=0x0060000001290178
...
- (_Bool)isAllZeroes;	// IMP=0x00000000012904cf
- (void)increaseWithEntry:(id)arg1;	// IMP=0x0000000001290441
