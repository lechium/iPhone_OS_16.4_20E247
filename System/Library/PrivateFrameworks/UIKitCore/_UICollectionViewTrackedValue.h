...
- (void).cxx_destruct;	// IMP=0x00000000003ba996
...
- (double)speed;	// IMP=0x00000000003ba85a
- (void)addValue:(double)arg1;	// IMP=0x00000000003ba796
- (id)init;	// IMP=0x00000000003ba639
