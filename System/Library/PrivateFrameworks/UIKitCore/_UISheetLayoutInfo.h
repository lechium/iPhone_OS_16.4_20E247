...
- (void).cxx_destruct;	// IMP=0x0000000000431bec
...
- (id)_descendantDescription;	// IMP=0x00000000004315cd
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x0000000000430034
...
- (void)_invalidateCurrentOffset;	// IMP=0x0000000000429902
- (void)_invalidateDetents;	// IMP=0x000000000042911e
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x000000000042877f
- (void)_invalidatePreferredSize;	// IMP=0x000000000042872c
- (id)initWithMetrics:(id)arg1;	// IMP=0x0000000000428457
