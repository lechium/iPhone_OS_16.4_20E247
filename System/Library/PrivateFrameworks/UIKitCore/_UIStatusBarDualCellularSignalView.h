...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0000000000f90b80
- (void).cxx_destruct;	// IMP=0x0000000000f91715
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f91239
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f910f7
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f910cc
- (void)_iconSizeDidChange;	// IMP=0x0000000000f90f80
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f90f39
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f90ee1
- (void)_commonInit;	// IMP=0x0000000000f90ba0
