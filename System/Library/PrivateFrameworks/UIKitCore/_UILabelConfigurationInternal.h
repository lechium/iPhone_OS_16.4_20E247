...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016a5ad
- (void).cxx_destruct;	// IMP=0x000000000016ae00
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016aaba
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016a6ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016a5b5
- (unsigned long long)hash;	// IMP=0x000000000016a53d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016a07a
- (id)init;	// IMP=0x000000000016a01c
