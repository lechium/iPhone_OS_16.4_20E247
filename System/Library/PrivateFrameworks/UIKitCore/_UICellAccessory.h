...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x006000000106dc61
- (void).cxx_destruct;	// IMP=0x000000000106dea8
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000106de50
- (id)description;	// IMP=0x000000000106dd85
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000106dcb3
- (id)init;	// IMP=0x000000000106dc25
