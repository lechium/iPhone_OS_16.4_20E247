...
- (void).cxx_destruct;	// IMP=0x00000000003bc22a
...
- (_Bool)isNOOP;	// IMP=0x00000000003bc180
- (id)description;	// IMP=0x00000000003bc057
- (void)commitTargetIndexPath;	// IMP=0x00000000003bc020
- (id)expectedCellIndexPath;	// IMP=0x00000000003bbf1a
- (id)initWithCell:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000003bbe84
