...
- (void).cxx_destruct;	// IMP=0x0000000000af50eb
...
- (void)dismiss;	// IMP=0x0000000000af4fe5
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000af4d4c
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000af4d44
