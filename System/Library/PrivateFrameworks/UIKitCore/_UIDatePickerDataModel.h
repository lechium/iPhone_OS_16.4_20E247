...
- (void).cxx_destruct;	// IMP=0x000000000156a4eb
...
- (id)createDatePickerRepresentingDataModelForMode:(long long)arg1 style:(long long)arg2;	// IMP=0x000000000156a26d
- (id)createDatePickerRepresentingDataModel;	// IMP=0x000000000156a220
...
- (id)_dateForRoundingDateToMinuteInterval:(id)arg1;	// IMP=0x0000000001569c1c
@property(readonly, nonatomic) NSDate *effectiveDate;
- (void)resetForCurrentLocaleOrCalendarChange;	// IMP=0x0000000001569985
...
- (void)_setupDerivedLocaleAndCalendars;	// IMP=0x00000000015692f1
- (id)init;	// IMP=0x0000000001569284
