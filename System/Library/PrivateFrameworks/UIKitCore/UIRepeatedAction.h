...
+ (id)actionWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x00600000012e2f47
+ (id)_invocationForTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x00600000012e2df1
- (void).cxx_destruct;	// IMP=0x00000000012e3af3
...
- (void)dealloc;	// IMP=0x00000000012e39f8
- (void)reset;	// IMP=0x00000000012e38cc
- (void)_resetInternalState;	// IMP=0x00000000012e38a9
- (void)invalidate;	// IMP=0x00000000012e3831
- (void)schedule;	// IMP=0x00000000012e365f
- (void)_repeatedTimerFire;	// IMP=0x00000000012e35fc
- (void)_invocationTimerFire;	// IMP=0x00000000012e3591
- (void)_preInvocationTimerFire;	// IMP=0x00000000012e3526
- (_Bool)_shouldInvokeRepeatedActionForPhase:(unsigned long long)arg1;	// IMP=0x00000000012e34c4
- (void)_adjustInvocationForPhase:(unsigned long long)arg1;	// IMP=0x00000000012e330b
- (_Bool)invoke;	// IMP=0x00000000012e31df
- (void)scheduleWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x00000000012e3112
- (id)initWithInvocation:(id)arg1;	// IMP=0x00000000012e308b
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x00000000012e2fc2
