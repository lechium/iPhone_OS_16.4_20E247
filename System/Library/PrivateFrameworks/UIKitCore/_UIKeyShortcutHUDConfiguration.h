...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001020fee
- (void).cxx_destruct;	// IMP=0x0000000001021251
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000010210ab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001020ff6
