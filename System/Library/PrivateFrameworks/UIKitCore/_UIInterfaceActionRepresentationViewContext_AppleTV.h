...
- (void).cxx_destruct;	// IMP=0x0000000000035852
...
- (id)_newMotionEffectsGroupForHighlightedAction;	// IMP=0x0000000000035628
- (void)_removeMotionEffects;	// IMP=0x0000000000035533
- (void)_insertMotionEffects;	// IMP=0x000000000003542e
- (struct CATransform3D)_enlargedTransformForSize:(struct CGSize)arg1 pressed:(_Bool)arg2;	// IMP=0x0000000000035360
- (void)_applyHighlightTransform;	// IMP=0x0000000000034f2b
- (id)initWithHighlightTransformTargetView:(id)arg1;	// IMP=0x0000000000034e8f
