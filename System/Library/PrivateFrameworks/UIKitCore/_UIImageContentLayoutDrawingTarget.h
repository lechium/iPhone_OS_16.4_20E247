...
- (id)_symbolConfigurationForSource:(id)arg1;	// IMP=0x0000000000982ba6
- (long long)_effectiveRenderingModeForSource:(id)arg1 symbolConfiguration:(id)arg2;	// IMP=0x0000000000982b8e
- (id)_renditionForSource:(id)arg1 size:(struct CGSize)arg2 symbolConfiguration:(id)arg3 withRenditionResult:(id)arg4 lazy:(_Bool)arg5;	// IMP=0x0000000000982980
- (id)_effectForRenderingSource:(id)arg1;	// IMP=0x0000000000982977
