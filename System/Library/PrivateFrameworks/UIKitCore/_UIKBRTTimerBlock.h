...
- (void).cxx_destruct;	// IMP=0x0000000000ca5008
...
- (void)timerFired:(id)arg1;	// IMP=0x0000000000ca4c11
- (void)invalidate;	// IMP=0x0000000000ca4b70
- (void)fireNow;	// IMP=0x0000000000ca4a81
- (void)dealloc;	// IMP=0x0000000000ca4a43
- (id)initWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3 owner:(id)arg4;	// IMP=0x0000000000ca48d8
