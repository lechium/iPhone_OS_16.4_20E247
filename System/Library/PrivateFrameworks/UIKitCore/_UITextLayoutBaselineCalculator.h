...
- (void).cxx_destruct;	// IMP=0x0000000000704361
- (double)_convertOffset:(double)arg1;	// IMP=0x0000000000704281
...
- (double)_baselineOffsetAtPosition:(id)arg1;	// IMP=0x0000000000703b16
- (id)initWithTextLayoutController:(id)arg1 typingAttributes:(id)arg2 usesLineFragmentOrigin:(_Bool)arg3 coordinateSpace:(id)arg4 scale:(double)arg5 fallbackTextContainerOrigin:(struct CGPoint)arg6;	// IMP=0x0000000000703a24
