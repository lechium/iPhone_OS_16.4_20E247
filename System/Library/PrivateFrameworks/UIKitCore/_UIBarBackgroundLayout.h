...
- (void).cxx_destruct;	// IMP=0x000000000082ebc2
...
- (id)description;	// IMP=0x000000000082ea84
- (void)describeInto:(id)arg1;	// IMP=0x000000000082e9b5
...
- (_Bool)bg2HasHeight;	// IMP=0x000000000082e94c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000082e838
- (id)initWithLayout:(id)arg1;	// IMP=0x000000000082e775
- (id)init;	// IMP=0x000000000082e761
