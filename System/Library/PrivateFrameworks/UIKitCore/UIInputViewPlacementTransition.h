...
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000b6fe75
- (void).cxx_destruct;	// IMP=0x0000000000b7013a
...
- (void)dealloc;	// IMP=0x0000000000b70013
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000b6ff2d
