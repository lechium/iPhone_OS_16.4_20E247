...
+ (id)_eventWithInput:(id)arg1 inputFlags:(int)arg2;	// IMP=0x0010000000ef7f77
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000ef58f1
- (void).cxx_destruct;	// IMP=0x0000000000ef838d
...
- (long long)modifierFlags;	// IMP=0x0000000000ef80a7
- (void)_privatize;	// IMP=0x0000000000ef8033
- (id)_cloneEvent;	// IMP=0x0000000000ef7c35
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ef7b10
- (_Bool)_shouldAttemptSecurePasteAuthentication;	// IMP=0x0000000000ef784a
- (_Bool)_matchesKeyCommand:(id)arg1 usesPrivateShiftModifiedInput:(_Bool)arg2;	// IMP=0x0000000000ef7073
- (void)_setHIDEvent:(struct __IOHIDEvent *)arg1 keyboard:(struct __GSKeyboard *)arg2;	// IMP=0x0000000000ef655e
@property(readonly, nonatomic) _Bool _isARepeat;
@property(readonly, nonatomic) _Bool _isModifierKey;
- (_Bool)_isPhysicalKeyEvent;	// IMP=0x0000000000ef64be
...
- (long long)type;	// IMP=0x0000000000ef6333
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000ef5e83
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000ef58f9
