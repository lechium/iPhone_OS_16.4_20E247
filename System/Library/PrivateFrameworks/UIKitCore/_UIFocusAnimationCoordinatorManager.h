...
- (void).cxx_destruct;	// IMP=0x00000000006de0d2
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000006ddfe5
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000006ddf21
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000006dd9aa
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000006dd80f
- (id)init;	// IMP=0x00000000006dd7a4
