...
- (void).cxx_destruct;	// IMP=0x0000000000c3348b
...
- (void)resetTimer;	// IMP=0x0000000000c331f3
- (void)invalidate;	// IMP=0x0000000000c33133
- (_Bool)isValid;	// IMP=0x0000000000c3307f
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000c32e03
- (void)timerFired:(id)arg1;	// IMP=0x0000000000c32d33
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x0000000000c32bcd
- (void)dealloc;	// IMP=0x0000000000c32b72
