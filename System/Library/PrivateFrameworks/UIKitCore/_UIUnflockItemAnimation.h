...
+ (id)animationWithPlatterView:(id)arg1 destination:(id)arg2 positionReferenceView:(id)arg3 type:(long long)arg4;	// IMP=0x006000000118b742
- (void).cxx_destruct;	// IMP=0x000000000118cfa8
...
- (void)complete;	// IMP=0x000000000118ce71
- (void)play;	// IMP=0x000000000118b8ef
