...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x00600000009be4a0
- (void).cxx_destruct;	// IMP=0x00000000009be788
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000009be54f
- (void)dealloc;	// IMP=0x00000000009be4e9
