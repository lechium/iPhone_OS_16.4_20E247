...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008fbe6c
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x00000000008fbdf2
- (void)dealloc;	// IMP=0x00000000008fbd99
