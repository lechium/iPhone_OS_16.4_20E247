...
- (_Bool)coalesceScrollForNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000014e2302
- (void)dealloc;	// IMP=0x00000000014e22c7
- (id)initWithNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000014e224e
