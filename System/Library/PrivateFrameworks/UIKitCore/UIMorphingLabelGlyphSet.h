...
- (void).cxx_destruct;	// IMP=0x0000000000d2a222
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000d2a0a1
- (void)placeGlyphs;	// IMP=0x0000000000d29ee3
- (void)removeGlyphs;	// IMP=0x0000000000d29d7c
- (void)buildGlyphViews;	// IMP=0x0000000000d28b4f
- (void)dealloc;	// IMP=0x0000000000d28ae6
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000d288e0
