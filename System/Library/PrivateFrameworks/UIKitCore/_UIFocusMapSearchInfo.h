...
- (void).cxx_destruct;	// IMP=0x00000000007389ee
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x00000000007388d4
- (void)addSnapshot:(id)arg1;	// IMP=0x0000000000738851
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x0000000000738748
