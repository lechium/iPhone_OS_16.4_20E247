...
- (void).cxx_destruct;	// IMP=0x00000000005f84d7
- (void)refreshControl:(id)arg1 didChangeToState:(long long)arg2 fromState:(long long)arg3;	// IMP=0x00000000005f83d0
- (void)incrementInsetHeight:(double)arg1;	// IMP=0x00000000005f8395
- (void)decrementInsetHeight:(double)arg1;	// IMP=0x00000000005f835a
...
- (id)initWithScrollView:(id)arg1;	// IMP=0x00000000005f82d8
