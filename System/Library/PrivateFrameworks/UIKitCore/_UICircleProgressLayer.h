...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0060000000589866
- (void).cxx_destruct;	// IMP=0x0000000000589bd0
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000005898d8
- (id)initWithLayer:(id)arg1;	// IMP=0x0000000000589696
- (id)init;	// IMP=0x000000000058955c
