...
- (void).cxx_destruct;	// IMP=0x00000000009c6b5a
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000009c5dcc
- (void)layoutSubviews;	// IMP=0x00000000009c5c3e
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000009c5b47
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009c588b
