...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x006000000139d095
- (void).cxx_destruct;	// IMP=0x000000000139d137
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x000000000139cffc
