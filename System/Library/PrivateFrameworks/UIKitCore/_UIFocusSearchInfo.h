...
+ (id)defaultInfo;	// IMP=0x0060000000feab59
- (void).cxx_destruct;	// IMP=0x0000000000feacb8
...
- (_Bool)shouldIncludeFocusItem:(id)arg1;	// IMP=0x0000000000feabf0
- (id)initWithFocusEvaluator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000feab84
