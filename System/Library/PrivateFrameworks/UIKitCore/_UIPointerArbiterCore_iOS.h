...
- (void).cxx_destruct;	// IMP=0x00000000007e0cde
...
- (void)backgroundLumaView:(id)arg1 didTransitionToLevel:(unsigned long long)arg2;	// IMP=0x00000000007e0932
- (void)_getPointerRegion:(inout id *)arg1 andStyle:(inout id *)arg2 atLocation:(struct CGPoint)arg3 inWindow:(id)arg4;	// IMP=0x00000000007e04cc
- (id)_psPointerShapeFromUIPointerShape:(id)arg1 atScale:(double)arg2;	// IMP=0x00000000007e02d4
- (id)_pointerShapeForStyle:(id)arg1 region:(id)arg2;	// IMP=0x00000000007e014f
- (id)_hoverRegionWithStyle:(id)arg1 forRegion:(id)arg2;	// IMP=0x00000000007df21b
- (id)_coordinateSpaceSourceViewForRegion:(id)arg1 withStyle:(id)arg2;	// IMP=0x00000000007df0de
- (void)_preparePointerPortalSourceCollectionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007de858
- (void)_prepareContentMatchMoveSourceForPointerRegion:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000007de2cc
- (void)_performTransactionUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000007de1c6
- (void)_performNextTransaction;	// IMP=0x00000000007de033
- (void)pointerClientControllerClientInteractionStateDidChange:(id)arg1;	// IMP=0x00000000007ddeec
- (void)pointerClientControllerWillDecelerate:(id)arg1 targetPointerPosition:(inout struct CGPoint *)arg2 velocity:(struct CGPoint)arg3 inContextID:(unsigned int)arg4 cursorRegionLookupRadius:(double)arg5 cursorRegionLookupResolution:(double)arg6 lookupConeAngle:(double)arg7;	// IMP=0x00000000007dd663
- (void)pointerClientController:(id)arg1 didInvalidatePortalSourceCollections:(id)arg2 matchMoveSources:(id)arg3;	// IMP=0x00000000007dd4d3
- (void)endScrollingWithRegion:(id)arg1;	// IMP=0x00000000007dd10b
- (void)beginScrollingWithRegion:(id)arg1;	// IMP=0x00000000007dce19
@property(readonly, nonatomic) long long pointerState;
- (void)_clearMatchMoveSourceForRegion:(id)arg1 immediately:(_Bool)arg2;	// IMP=0x00000000007dcb43
- (void)_setActiveHoverRegion:(id)arg1 style:(id)arg2 forPointerRegion:(id)arg3 transactionID:(unsigned long long)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000007dc7b8
- (void)exitRegion:(id)arg1 removeStyle:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000007dc598
- (void)applyStyle:(id)arg1 forRegion:(id)arg2 effectSourceHandler:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000007dbb70
- (id)init;	// IMP=0x00000000007dbafe
