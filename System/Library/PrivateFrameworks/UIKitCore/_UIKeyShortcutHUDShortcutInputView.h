...
- (void).cxx_destruct;	// IMP=0x0000000000036bfd
...
- (void)_updateInputLabelSpacing:(id)arg1;	// IMP=0x0000000000036839
- (void)_updateInputLabelStyle:(id)arg1;	// IMP=0x0000000000036794
- (void)setModifiersWidth:(double)arg1 inputWidth:(double)arg2;	// IMP=0x00000000000365dd
...
- (void)_commonInit;	// IMP=0x0000000000035921
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000358d5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000035878
