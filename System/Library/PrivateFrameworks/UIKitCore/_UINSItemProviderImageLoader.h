...
- (void).cxx_destruct;	// IMP=0x0000000000655e60
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x0000000000655df9
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000655c6f
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x0000000000655b8b
