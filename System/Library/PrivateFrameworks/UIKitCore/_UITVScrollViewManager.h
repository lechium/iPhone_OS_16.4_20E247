...
- (void).cxx_destruct;	// IMP=0x000000000089ad16
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x000000000089aa71
- (id)_customScrollingMaskForScrollView:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x000000000089a8e7
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x000000000089a899
- (void)_scroll:(id)arg1 toContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000089a565
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x000000000089a496
- (void)_tearDown:(id)arg1;	// IMP=0x000000000089a415
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x000000000089a13b
- (void)dealloc;	// IMP=0x0000000000899fec
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x0000000000899e73
