...
- (void).cxx_destruct;	// IMP=0x0000000000f3eafc
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000000f3e766
- (double)legibilityStrength;	// IMP=0x0000000000f3e758
- (void)_updateAccessoryImage;	// IMP=0x0000000000f3e342
- (double)extraRightPadding;	// IMP=0x0000000000f3e2c5
- (id)contentsImage;	// IMP=0x0000000000f3e24d
- (id)_contentsImage;	// IMP=0x0000000000f3dd61
- (id)_accessoryImage;	// IMP=0x0000000000f3dd0a
- (_Bool)_needsAccessoryImage;	// IMP=0x0000000000f3dcf6
- (struct CGSize)_batteryOffsetWithBackground:(id)arg1;	// IMP=0x0000000000f3dc07
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000f3db59
