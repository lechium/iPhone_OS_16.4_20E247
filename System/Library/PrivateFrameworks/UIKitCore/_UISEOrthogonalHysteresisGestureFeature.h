...
- (void).cxx_destruct;	// IMP=0x0000000000828a86
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000008287e0
- (id)initWithSettings:(id)arg1 touchedEdgesProvider:(id)arg2;	// IMP=0x000000000082874b
