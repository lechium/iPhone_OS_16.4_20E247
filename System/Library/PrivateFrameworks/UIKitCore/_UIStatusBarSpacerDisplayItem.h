...
- (void).cxx_destruct;	// IMP=0x0000000000f82294
@property(nonatomic) struct CGSize size; // @synthesize size=_size;
@property(retain, nonatomic) NSArray *constraints; // @synthesize constraints=_constraints;
@property(retain, nonatomic) UILayoutGuide *layoutGuide; // @synthesize layoutGuide=_layoutGuide;
- (void)_applyConstraintsIfNeeded;	// IMP=0x0000000000f821ac
- (void)setContainerView:(id)arg1;	// IMP=0x0000000000f820d7
- (void)applyUpdate:(id)arg1;	// IMP=0x0000000000f81ee8
- (id)initWithIdentifier:(id)arg1 item:(id)arg2;	// IMP=0x0000000000f81ea7
