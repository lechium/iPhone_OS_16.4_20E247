...
- (void).cxx_destruct;	// IMP=0x0000000000f9e222
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000f9e15f
- (void)jiggleWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9dc80
- (void)animateUnlockWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9d91d
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f9d907
- (void)resetLock;	// IMP=0x0000000000f9d84d
@property(readonly, nonatomic) _Bool prefersBaselineAlignment;
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f9d63d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f9d52e
