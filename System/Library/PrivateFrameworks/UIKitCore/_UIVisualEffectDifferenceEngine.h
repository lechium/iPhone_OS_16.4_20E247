...
- (void).cxx_destruct;	// IMP=0x0000000000101d77
...
- (id)description;	// IMP=0x0000000000101b7e
- (id)describeMergeTable;	// IMP=0x0000000000101a5b
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000001019a4
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x000000000010181d
- (void)_calculateMerge;	// IMP=0x0000000000100ffa
- (void)_calculateLCSSTable;	// IMP=0x0000000000100dd5
- (void)_calculatePrefixAndSuffix;	// IMP=0x0000000000100bf0
- (void)_reset;	// IMP=0x0000000000100bc3
- (void)dealloc;	// IMP=0x0000000000100b89
