...
- (void).cxx_destruct;	// IMP=0x0000000000c4b6df
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x0000000000c4b4c1
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x0000000000c4b4af
- (id)_currentTitleColor;	// IMP=0x0000000000c4b463
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000c4b422
