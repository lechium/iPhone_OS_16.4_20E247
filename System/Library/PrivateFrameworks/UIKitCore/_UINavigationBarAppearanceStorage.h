...
+ (long long)typicalBarPosition;	// IMP=0x006000000015807f
- (void).cxx_destruct;	// IMP=0x0000000000158509
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x0000000000158338
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x00000000001581fd
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x00000000001580eb
