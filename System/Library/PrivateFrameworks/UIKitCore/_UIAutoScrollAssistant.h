...
- (void).cxx_destruct;	// IMP=0x00000000012e933b
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x00000000012e9210
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x00000000012e9183
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x00000000012e910d
- (void)displayLinkFired:(id)arg1;	// IMP=0x00000000012e8ee7
- (_Bool)_scrollContinuous;	// IMP=0x00000000012e8e80
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x00000000012e8de4
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x00000000012e8bb6
- (id)initWithScrollView:(id)arg1;	// IMP=0x00000000012e8a7d
