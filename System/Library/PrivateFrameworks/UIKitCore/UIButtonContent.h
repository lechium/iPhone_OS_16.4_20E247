...
- (void).cxx_destruct;	// IMP=0x000000000059875b
...
- (_Bool)updateVariableLengthStringForView:(id)arg1;	// IMP=0x00000000005985f9
- (id)description;	// IMP=0x000000000059855e
@property(retain, nonatomic) _UIGraphicsLetterpressStyle *letterpressStyle;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005983a7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000059814a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000597f6b
