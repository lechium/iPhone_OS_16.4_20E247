...
- (void).cxx_destruct;	// IMP=0x0000000000b6d94f
...
- (void)layoutSubviews;	// IMP=0x0000000000b6d357
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000b6d322
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000b6c7a9
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000b6c679
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b6c194
