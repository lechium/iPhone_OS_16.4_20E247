...
+ (id)endingSelectionRectWithRect:(struct CGRect)arg1;	// IMP=0x00600000001fa577
+ (id)startingSelectionRectWithRect:(struct CGRect)arg1;	// IMP=0x00600000001fa539
+ (id)selectionRectWithRect:(struct CGRect)arg1;	// IMP=0x00600000001fa508
