...
- (void).cxx_destruct;	// IMP=0x0000000000e3bd88
...
- (id)initWithLeadingDelta:(double)arg1 trailingDelta:(double)arg2;	// IMP=0x0000000000e3bce0
- (id)init;	// IMP=0x0000000000e3bc60
