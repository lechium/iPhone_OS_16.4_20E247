...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x006000000139b02f
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x006000000139afb3
