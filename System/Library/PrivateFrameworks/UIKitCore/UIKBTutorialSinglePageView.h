...
- (void).cxx_destruct;	// IMP=0x0000000000811708
...
- (void)configPageView;	// IMP=0x00000000008104eb
- (void)layoutSubviews;	// IMP=0x00000000008104d9
- (id)initWithImageView:(id)arg1;	// IMP=0x000000000081039f
