...
- (void).cxx_destruct;	// IMP=0x0000000000ba4c4f
...
- (void)complete;	// IMP=0x0000000000ba4bf4
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x0000000000ba4a16
