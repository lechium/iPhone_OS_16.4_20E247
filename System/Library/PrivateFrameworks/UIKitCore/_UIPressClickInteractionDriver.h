...
@interface _UIPressClickInteractionDriver : NSObject <UIGestureRecognizerDelegate>
{
...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x001000000061b6fc
+ (_Bool)requiresForceCapability;	// IMP=0x001000000061b6f4
- (void).cxx_destruct;	// IMP=0x000000000061bef1
...
- (void)_handlePressGesture:(id)arg1;	// IMP=0x000000000061bc19
- (void)_removeFromView;	// IMP=0x000000000061bb84
- (void)_addToView:(id)arg1;	// IMP=0x000000000061b9e4
@property(nonatomic) unsigned long long driverStyle;
- (void)cancelInteraction;	// IMP=0x000000000061b8c8
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x000000000061b750
...
- (id)init;	// IMP=0x000000000061b4b9
