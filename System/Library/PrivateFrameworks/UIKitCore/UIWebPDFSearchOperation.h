...
- (void)cancel;	// IMP=0x000000000152176c
- (void)main;	// IMP=0x000000000152162d
- (void)_search;	// IMP=0x0000000001520eef
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x00000000015209f0
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x00000000015206b0
- (void)_notifyDelegateOfStatus;	// IMP=0x0000000001520535
- (_Bool)_hitSearchLimit;	// IMP=0x000000000152050a
- (void)dealloc;	// IMP=0x00000000015204a2
- (id)init;	// IMP=0x000000000152041d
