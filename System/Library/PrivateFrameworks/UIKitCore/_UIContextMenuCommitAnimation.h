...
- (void).cxx_destruct;	// IMP=0x000000000032cc24
...
- (void)_prepareAnimationViews;	// IMP=0x000000000032c20f
- (void)_prepareSnapshots;	// IMP=0x000000000032beb7
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000032b204
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x000000000032b0de
