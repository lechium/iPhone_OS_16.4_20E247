...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000000cdd12c
- (void).cxx_destruct;	// IMP=0x0000000000cdd3f9
...
- (id)description;	// IMP=0x0000000000cdd24f
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000cdd192
- (id)init;	// IMP=0x0000000000cdd08d
