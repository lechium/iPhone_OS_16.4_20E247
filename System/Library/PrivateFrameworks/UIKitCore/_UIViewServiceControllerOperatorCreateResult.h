...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000132eb9c
- (void).cxx_destruct;	// IMP=0x000000000132ec19
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000132e92b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000132e77f
