...
- (void).cxx_destruct;	// IMP=0x00000000011e02a6
...
- (id)replacements;	// IMP=0x00000000011dffbd
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x00000000011dfef0
