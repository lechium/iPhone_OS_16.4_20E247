...
- (void).cxx_destruct;	// IMP=0x00000000003ff5e6
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x00000000003ff4a9
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x00000000003ff479
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003ff389
