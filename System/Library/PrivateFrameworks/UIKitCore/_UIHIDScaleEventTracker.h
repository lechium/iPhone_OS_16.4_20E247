...
- (void)_setCompositePhase:(unsigned long long)arg1 withEvent:(struct __IOHIDEvent *)arg2;	// IMP=0x0000000000f0c584
- (void)reset;	// IMP=0x0000000000f0c577
- (void)updateWithHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000f0c430
