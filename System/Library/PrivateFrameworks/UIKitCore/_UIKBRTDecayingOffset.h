...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000ca2368
- (void)reset;	// IMP=0x0000000000ca2322
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000ca22e0
