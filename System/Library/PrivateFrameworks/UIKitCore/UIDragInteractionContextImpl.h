...
- (void).cxx_destruct;	// IMP=0x000000000061c73a
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000061c560
- (void)_api_addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000061c54e
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x000000000061c45f
