...
@interface _UIPreviewActionSheetView : UIView <UIGestureRecognizerDelegate>
{
...
- (void).cxx_destruct;	// IMP=0x0000000000da715d
...
- (void)_performActionForPreviewAction:(id)arg1 interfaceAction:(id)arg2;	// IMP=0x0000000000da6f92
- (void)_setupViewHierarchy;	// IMP=0x0000000000da64a2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000da6473
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000da642b
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 items:(id)arg3 contentInsets:(struct UIEdgeInsets)arg4;	// IMP=0x0000000000da6349
