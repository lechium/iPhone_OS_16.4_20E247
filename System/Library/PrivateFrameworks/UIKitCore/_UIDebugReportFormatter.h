...
+ (id)defaultFormatter;	// IMP=0x00600000007096e4
- (void).cxx_destruct;	// IMP=0x0000000000709b6e
...
- (id)stringFromReportComponents:(id)arg1;	// IMP=0x0000000000709747
- (id)init;	// IMP=0x00000000007096f6
