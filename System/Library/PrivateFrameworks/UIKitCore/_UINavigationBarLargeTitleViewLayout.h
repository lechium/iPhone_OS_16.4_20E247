...
- (void).cxx_destruct;	// IMP=0x00000000001b119d
...
- (void)updateLayoutData:(id)arg1 layoutWidth:(double)arg2;	// IMP=0x00000000001b108b
- (void)removeContent;	// IMP=0x00000000001b1043
- (struct CGSize)sizeFittingSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x00000000001b101b
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidth:(double)arg1;	// IMP=0x00000000001b0a6d
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidthSupportingMultiLineShrinkToFit:(double)arg1;	// IMP=0x00000000001b02bb
- (void)_invalidateTitleHeightCache;	// IMP=0x00000000001b0282
- (double)_textHeightForSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x00000000001b01fc
- (void)setContentHidden:(_Bool)arg1;	// IMP=0x00000000001b01db
- (void)setContentAlpha:(double)arg1;	// IMP=0x00000000001b0196
- (void)cleanupAfterLayoutTransitionCompleted;	// IMP=0x00000000001b0184
- (void)layoutViewsWithOffset:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x00000000001af7e6
- (void)layoutViewsWithOffsetSupportingMultiLineShrinkToFit:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x00000000001aec16
- (void)layoutViews;	// IMP=0x00000000001aebfc
- (void)_enforceLayoutOrdering;	// IMP=0x00000000001aeb9f
- (void)updateRestingTitleHeight;	// IMP=0x00000000001aea38
- (struct CGRect)_contentLayoutBounds;	// IMP=0x00000000001aea17
- (struct CGRect)_contentLayoutBoundsUsingRestingTitleHeight:(_Bool)arg1;	// IMP=0x00000000001ae942
- (id)initWithContentView:(id)arg1;	// IMP=0x00000000001ae7d3
- (id)description;	// IMP=0x00000000001ae63d
