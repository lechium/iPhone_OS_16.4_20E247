...
+ (id)subrangeWithSubstring:(id)arg1 basePosition:(id)arg2;	// IMP=0x0060000000d18942
- (void).cxx_destruct;	// IMP=0x0000000000d18a4f
...
- (id)description;	// IMP=0x0000000000d189ca
