...
- (void).cxx_destruct;	// IMP=0x0000000000634992
...
- (void)unmarkText;	// IMP=0x000000000063487d
- (id)textRangeFromPosition:(id)arg1 toPosition:(id)arg2;	// IMP=0x0000000000634875
- (id)textInRange:(id)arg1;	// IMP=0x000000000063486d
- (void)setMarkedText:(id)arg1 selectedRange:(struct _NSRange)arg2;	// IMP=0x0000000000634867
- (void)setBaseWritingDirection:(long long)arg1 forRange:(id)arg2;	// IMP=0x0000000000634861
- (id)selectionRectsForRange:(id)arg1;	// IMP=0x0000000000634854
- (void)replaceRange:(id)arg1 withText:(id)arg2;	// IMP=0x000000000063484e
- (id)positionWithinRange:(id)arg1 farthestInDirection:(long long)arg2;	// IMP=0x0000000000634846
- (id)positionFromPosition:(id)arg1 offset:(long long)arg2;	// IMP=0x000000000063483e
- (id)positionFromPosition:(id)arg1 inDirection:(long long)arg2 offset:(long long)arg3;	// IMP=0x0000000000634836
- (long long)offsetFromPosition:(id)arg1 toPosition:(id)arg2;	// IMP=0x000000000063482e
- (struct CGRect)firstRectForRange:(id)arg1;	// IMP=0x0000000000634810
- (long long)comparePosition:(id)arg1 toPosition:(id)arg2;	// IMP=0x0000000000634808
- (id)closestPositionToPoint:(struct CGPoint)arg1 withinRange:(id)arg2;	// IMP=0x0000000000634800
- (id)closestPositionToPoint:(struct CGPoint)arg1;	// IMP=0x00000000006347f8
- (id)characterRangeByExtendingPosition:(id)arg1 inDirection:(long long)arg2;	// IMP=0x00000000006347f0
- (id)characterRangeAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000006347e8
- (struct CGRect)caretRectForPosition:(id)arg1;	// IMP=0x00000000006347ca
- (long long)baseWritingDirectionForPosition:(id)arg1 inDirection:(long long)arg2;	// IMP=0x00000000006347bd
@property(nonatomic) long long keyboardAppearance;
@property(nonatomic) _Bool acceptsInitialEmojiKeyboard;
@property(nonatomic) _Bool forceDisableDictation;
- (void)takeTraitsFrom:(id)arg1;	// IMP=0x00000000006346e1
- (void)deleteBackward;	// IMP=0x00000000006346db
- (void)insertText:(id)arg1;	// IMP=0x00000000006346d5
@property(readonly, nonatomic) _Bool hasText;
- (id)_ui_findNavigatorResponder;	// IMP=0x00000000006346c4
- (_Bool)_alwaysRequireInlineCandidateView;	// IMP=0x0000000000634691
- (_Bool)_disallowsPresentationOfKeyboardShortcutHUD;	// IMP=0x0000000000634689
- (void)_didChangeInputModes:(id)arg1;	// IMP=0x00000000006345b6
- (void)_willChangeInputModes:(id)arg1;	// IMP=0x00000000006345a5
- (id)textInputMode;	// IMP=0x000000000063459d
- (id)textInputContextIdentifier;	// IMP=0x0000000000634595
- (id)nextFirstResponder;	// IMP=0x000000000063453a
- (void)becomeFirstResponderAndFocusFindField;	// IMP=0x000000000063441f
- (id)inputAccessoryViewController;	// IMP=0x00000000006343aa
- (id)inputAccessoryView;	// IMP=0x00000000006343a2
- (id)inputDashboardViewController;	// IMP=0x000000000063432d
- (id)inputView;	// IMP=0x00000000006342a3
- (id)nextResponder;	// IMP=0x0000000000634248
- (unsigned long long)hostingTypeForTraitCollection:(id)arg1;	// IMP=0x0000000000634197
- (id)initWithFindNavigatorViewController:(id)arg1;	// IMP=0x0000000000634020
