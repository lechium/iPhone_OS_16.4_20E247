...
- (void).cxx_destruct;	// IMP=0x0000000000828709
@property(readonly, nonatomic) NSDictionary *subfeatures; // @synthesize subfeatures=_subfeatures;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x0000000000828618
- (id)debugDictionary;	// IMP=0x00000000008284c1
- (void)featureDidChangeState:(id)arg1;	// IMP=0x0000000000828404
- (id)initWithSettings:(id)arg1 createFeatureBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000828351
