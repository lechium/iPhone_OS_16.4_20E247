...
- (void).cxx_destruct;	// IMP=0x00000000002b3691
...
- (id)_dirtyItems;	// IMP=0x00000000002b360c
- (void)_reset;	// IMP=0x00000000002b359c
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000002b348b
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000002b33a7
- (id)behaviorsForItem:(id)arg1;	// IMP=0x00000000002b3299
- (id)init;	// IMP=0x00000000002b3224
