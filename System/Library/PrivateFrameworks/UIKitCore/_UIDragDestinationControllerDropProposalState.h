...
- (void).cxx_destruct;	// IMP=0x00000000003d8306
...
- (_Bool)_hasDropActionTarget;	// IMP=0x00000000003d81f8
@property(readonly, nonatomic) NSIndexPath *effectiveIndexPath;
- (void)updateFromDropProposal:(id)arg1;	// IMP=0x00000000003d81a1
- (void)didPerformDrop;	// IMP=0x00000000003d8181
- (id)description;	// IMP=0x00000000003d8049
- (id)init;	// IMP=0x00000000003d7fc4
