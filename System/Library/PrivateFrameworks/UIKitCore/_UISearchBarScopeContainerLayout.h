...
- (void).cxx_destruct;	// IMP=0x00000000001fa4c8
...
- (id)description;	// IMP=0x00000000001fa18b
- (void)applyLayout;	// IMP=0x00000000001fa0d9
- (void)updateLayout;	// IMP=0x00000000001f9d4f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f9caf
- (double)scopeControlHeight;	// IMP=0x00000000001f9c4a
