...
+ (id)animatorWithViewController:(id)arg1;	// IMP=0x0010000001539896
- (void).cxx_destruct;	// IMP=0x0000000001539eeb
...
- (void)performAllCompletions;	// IMP=0x0000000001539d20
- (void)performAllAnimations;	// IMP=0x0000000001539b87
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000001539afb
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000001539a6f
