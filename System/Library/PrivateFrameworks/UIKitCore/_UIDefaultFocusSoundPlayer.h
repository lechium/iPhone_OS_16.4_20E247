...
+ (id)sharedInstance;	// IMP=0x001000000074fc5a
- (void).cxx_destruct;	// IMP=0x000000000075057a
...
- (void)_playSystemSound:(unsigned int)arg1 withVolume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000074ffb6
- (void)playSoundWithFocusSound:(long long)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000074fec8
- (void)playSoundWithURL:(id)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000074fd5c
- (void)dealloc;	// IMP=0x000000000074fcbf
- (void)_registerForSystemSoundsIfNecessary;	// IMP=0x000000000074fa66
- (id)_init;	// IMP=0x000000000074f897
