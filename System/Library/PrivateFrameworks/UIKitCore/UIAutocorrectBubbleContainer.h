...
- (void).cxx_destruct;	// IMP=0x0000000000d6628d
...
- (void)performReset;	// IMP=0x0000000000d65f7e
- (_Bool)isViewAnimating;	// IMP=0x0000000000d65ee5
- (void)reset;	// IMP=0x0000000000d65eae
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000d65b8b
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000d65b2c
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000d65b1a
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000d6573e
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000d650fc
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000d64d21
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000d64772
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000d646b2
- (id)init;	// IMP=0x0000000000d64638
