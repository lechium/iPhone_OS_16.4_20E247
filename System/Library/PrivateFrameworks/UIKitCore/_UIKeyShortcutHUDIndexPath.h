...
+ (id)hudIndexPathWithClient:(id)arg1 indexPath:(id)arg2;	// IMP=0x00600000004a097f
- (void).cxx_destruct;	// IMP=0x00000000004a0bee
...
- (unsigned long long)hash;	// IMP=0x00000000004a0b4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004a0a07
