...
- (void).cxx_destruct;	// IMP=0x00000000013912eb
...
- (id)debugDescription;	// IMP=0x00000000013910fd
- (id)transformer;	// IMP=0x00000000013910e8
- (void)setTransformer:(id)arg1;	// IMP=0x00000000013910d4
- (void)invalidateAndStopImmediately:(_Bool)arg1;	// IMP=0x0000000001390f64
- (void)invalidate;	// IMP=0x0000000001390f4d
- (_Bool)_performAnimationFromCurrentValue:(id)arg1;	// IMP=0x0000000001390cc4
- (id)velocityTarget:(_Bool)arg1;	// IMP=0x000000000139097d
@property(nonatomic) id velocity;
- (void)setVelocity:(id)arg1 target:(_Bool)arg2;	// IMP=0x0000000001390634
@property(retain, nonatomic) UIViewRunningAnimationEntry *animationEntry;
- (void)invalidateIfPossible;	// IMP=0x00000000013903fe
- (id)initWithInvalidationCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000001390346
- (_Bool)animatePropertyWithCurrentValue:(id)arg1 targetValue:(id)arg2 preTickShouldRemoveCallback:(CDUnknownBlockType)arg3 newValueCallback:(CDUnknownBlockType)arg4 removedCallback:(CDUnknownBlockType)arg5;	// IMP=0x0000000001390263
