...
+ (id)configuration;	// IMP=0x0060000000975302
+ (id)languagesWithReducedFontSize;	// IMP=0x00600000009752b2
...
- (_Bool)usesReducedFontSize;	// IMP=0x00000000009757bf
- (double)candidateDefaultFontSize;	// IMP=0x00000000009757b1
- (id)candidateFontWithSize:(double)arg1 language:(id)arg2;	// IMP=0x0000000000975646
- (id)candidateFontWithSize:(double)arg1;	// IMP=0x0000000000975589
...
- (id)extendedScrolledState;	// IMP=0x000000000097555e
- (id)extendedState;	// IMP=0x0000000000975556
- (id)initialState;	// IMP=0x0000000000975314
