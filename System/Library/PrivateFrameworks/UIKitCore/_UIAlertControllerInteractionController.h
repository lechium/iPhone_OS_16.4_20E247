...
- (void).cxx_destruct;	// IMP=0x00000000000716d1
...
- (void)interactionProgress:(id)arg1 didEnd:(_Bool)arg2;	// IMP=0x0000000000071665
- (void)interactionProgressDidUpdate:(id)arg1;	// IMP=0x000000000007161c
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x00000000000714a8
