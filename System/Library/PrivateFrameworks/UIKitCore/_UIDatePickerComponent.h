...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 desiredUnits:(long long)arg3;	// IMP=0x0060000000dfbad0
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2;	// IMP=0x0060000000dfbab4
- (void).cxx_destruct;	// IMP=0x0000000000dfc4af
...
- (id)description;	// IMP=0x0000000000dfc23e
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000dfc1a1
