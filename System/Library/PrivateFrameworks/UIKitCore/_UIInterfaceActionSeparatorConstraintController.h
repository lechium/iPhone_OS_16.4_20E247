...
- (void).cxx_destruct;	// IMP=0x0000000000052b72
...
- (_Bool)_isFixedWidth;	// IMP=0x0000000000052b30
- (void)_updateConstantSizedConstraints;	// IMP=0x0000000000052a74
- (void)separatorViewDidUpdateConstraints;	// IMP=0x0000000000052a62
@property(nonatomic) double constantAxisDimension; // @synthesize constantAxisDimension=_constantAxisDimension;
- (id)initWithSeparatorView:(id)arg1;	// IMP=0x0000000000052731
