...
+ (_Bool)isEnabled;	// IMP=0x0060000000c9ca4f
- (void).cxx_destruct;	// IMP=0x0000000000ca1ec6
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000ca17b4
- (void)_updateDriftView;	// IMP=0x0000000000c9ff27
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000c9fe44
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000c9fe36
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000c9fe28
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000c9f3d0
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000c9e9d2
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000c9e5a3
- (void)_updateHistory;	// IMP=0x0000000000c9e55a
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000c9e1ed
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000c9def3
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000c9db19
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000c9d875
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000c9d61b
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000c9d301
- (void)reset;	// IMP=0x0000000000c9d0ae
- (void)_resetFeedback;	// IMP=0x0000000000c9cfe5
- (void)dealloc;	// IMP=0x0000000000c9cfa7
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000c9cf56
- (id)init;	// IMP=0x0000000000c9ca7a
