...
- (void).cxx_destruct;	// IMP=0x0000000000831159
...
- (id)description;	// IMP=0x000000000083100d
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x0000000000830e87
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000830e4a
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000830ccb
