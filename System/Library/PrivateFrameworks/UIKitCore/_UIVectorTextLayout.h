...
- (void).cxx_destruct;	// IMP=0x00000000013d39b3
...
- (void)_layoutIfNeeded;	// IMP=0x00000000013d2be8
- (id)layoutDescription;	// IMP=0x00000000013d21c5
- (id)description;	// IMP=0x00000000013d20b1
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000013d1ff4
...
- (void)resetLayout;	// IMP=0x00000000013d1e8e
- (_Bool)hasLayout;	// IMP=0x00000000013d1e80
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x00000000013d1dae
