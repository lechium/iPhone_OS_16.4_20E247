...
+ (id)detailWithTitle:(id)arg1 detail:(id)arg2;	// IMP=0x00600000012b8b85
- (void).cxx_destruct;	// IMP=0x00000000012b8c71
...
- (void)_updateForInspectedView:(id)arg1;	// IMP=0x00000000012b8c21
