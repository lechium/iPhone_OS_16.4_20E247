...
- (void).cxx_destruct;	// IMP=0x00000000003bbe3b
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003bbd9d
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003bbd45
- (void)startWithAnimator:(id)arg1;	// IMP=0x00000000003bad0b
- (void)start;	// IMP=0x00000000003bacf7
...
- (id)description;	// IMP=0x00000000003bac13
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x00000000003ba9a6
