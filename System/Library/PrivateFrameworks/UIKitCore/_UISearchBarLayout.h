...
- (void).cxx_destruct;	// IMP=0x00000000001f95a7
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000001f9258
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001f91fe
@property(readonly, copy) NSString *description;
- (void)cleanUpLayout;	// IMP=0x00000000001f8362
- (void)applyScopeContainerSublayout;	// IMP=0x00000000001f8300
- (void)applyLayout;	// IMP=0x00000000001f79e1
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x00000000001f7942
- (double)minimumLayoutWidth;	// IMP=0x00000000001f7900
- (void)updateLayout;	// IMP=0x00000000001f74e7
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x00000000001f7434
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000001f73cb
- (void)prepareSublayouts;	// IMP=0x00000000001f739d
- (void)prepareScopeContainerLayout;	// IMP=0x00000000001f7268
- (void)prepareSearchContainerLayout;	// IMP=0x00000000001f6fb3
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x00000000001f6f27
- (void)setUpSearchContainerLayout;	// IMP=0x00000000001f6ea8
- (void)setUpScopeContainerLayout;	// IMP=0x00000000001f6e29
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f6006
