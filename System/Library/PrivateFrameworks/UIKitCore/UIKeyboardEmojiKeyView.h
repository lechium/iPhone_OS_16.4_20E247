...
- (void).cxx_destruct;	// IMP=0x0000000000b54319
...
- (long long)updateToCategoryWithOffsetPercentage:(double)arg1;	// IMP=0x0000000000b542e4
- (void)updateToCategory:(long long)arg1;	// IMP=0x0000000000b542de
