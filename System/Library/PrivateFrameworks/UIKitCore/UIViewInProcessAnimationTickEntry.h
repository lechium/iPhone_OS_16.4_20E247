...
- (void).cxx_destruct;	// IMP=0x00000000013a87d2
...
- (id)initWithPreferredFrameRateRange:(struct CAFrameRateRange)arg1 updateReason:(unsigned int)arg2 velocityUsableForVFD:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;	// IMP=0x00000000013a86e3
