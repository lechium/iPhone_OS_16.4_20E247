...
- (void).cxx_destruct;	// IMP=0x0000000000d3672e
...
- (void)updateControlWithDirection:(long long)arg1 travelProgress:(double)arg2 isRTL:(_Bool)arg3;	// IMP=0x0000000000d36477
- (void)controlActionUpOutside:(id)arg1;	// IMP=0x0000000000d36414
- (void)controlActionUpInside:(id)arg1 forEvent:(id)arg2;	// IMP=0x0000000000d3617c
- (void)controlActionDown:(id)arg1;	// IMP=0x0000000000d360de
- (void)performDelegateRedoAndUpdateHUDIfNeeded;	// IMP=0x0000000000d36063
- (void)performDelegateUndoAndUpdateHUDIfNeeded;	// IMP=0x0000000000d35fe8
- (void)updateHUDControlState;	// IMP=0x0000000000d35cdc
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000d35c68
- (_Bool)availableOfControl:(id)arg1;	// IMP=0x0000000000d35ae4
- (id)controlForType:(long long)arg1;	// IMP=0x0000000000d3595d
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000d358ea
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000d357ea
- (id)createSeparatorView;	// IMP=0x0000000000d356af
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2 mode:(long long)arg3 sceneBounds:(struct CGRect)arg4;	// IMP=0x0000000000d320b4
