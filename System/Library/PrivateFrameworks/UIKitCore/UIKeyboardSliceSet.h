...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000000cdc90d
- (void).cxx_destruct;	// IMP=0x0000000000cdd05a
...
- (id)description;	// IMP=0x0000000000cdcd7a
- (void)addSlice:(id)arg1;	// IMP=0x0000000000cdcd64
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000cdc75a
