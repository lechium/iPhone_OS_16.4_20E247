...
- (void).cxx_destruct;	// IMP=0x0000000001475845
...
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000014756ed
- (void)setModifierGroupRequestHandler:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000014756a2
- (id)modifierGroupRequestHandlerForKey:(id)arg1;	// IMP=0x000000000147568c
- (void)setPresentationModifier:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000001475641
- (id)presentationModifierForKey:(id)arg1;	// IMP=0x000000000147562b
- (void)setAnimatableProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000147551b
- (id)animatablePropertyForKey:(id)arg1 createIfNecessary:(_Bool)arg2;	// IMP=0x000000000147525e
- (id)animatablePropertyKeys;	// IMP=0x0000000001475163
- (void)_invalidateIfPossible;	// IMP=0x000000000147511e
- (_Bool)_canInvalidate;	// IMP=0x00000000014750bb
- (id)initWithView:(id)arg1;	// IMP=0x0000000001474fce
