...
- (void).cxx_destruct;	// IMP=0x0000000001033dfb
...
- (void)_endOrFail;	// IMP=0x0000000001033d1c
- (void)_begin;	// IMP=0x0000000001033d05
- (void)reset;	// IMP=0x0000000001033cad
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000001033c9b
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000001033c89
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000001033a8d
- (void)dealloc;	// IMP=0x0000000001033a2e
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000001033703
