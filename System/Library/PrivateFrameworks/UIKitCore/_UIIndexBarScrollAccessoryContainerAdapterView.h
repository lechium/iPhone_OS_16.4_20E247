...
- (void).cxx_destruct;	// IMP=0x00000000013d5ae5
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000013d5ac8
- (void)update;	// IMP=0x00000000013d5aab
...
- (id)initWithContents:(id)arg1 delegatingToView:(id)arg2;	// IMP=0x00000000013d5900
