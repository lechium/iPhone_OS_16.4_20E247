...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0060000000fd4ca9
- (void).cxx_destruct;	// IMP=0x0000000000fd4fc7
...
- (id)description;	// IMP=0x0000000000fd4e66
