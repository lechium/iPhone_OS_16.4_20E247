...
- (void).cxx_destruct;	// IMP=0x0000000000cb714d
...
- (void)showModelessInputTip;	// IMP=0x0000000000cb702b
- (_Bool)shouldShowModelessInputTip;	// IMP=0x0000000000cb6f60
- (void)triggerAttemptToShowModelessTipFlag;	// IMP=0x0000000000cb6f01
- (void)userInteractionEndedDuringModelessInputTipDictationStoppedSignal;	// IMP=0x0000000000cb6ebc
- (void)processUserInteractionEnded;	// IMP=0x0000000000cb6e37
- (void)processSoftwareKeyboardInteraction;	// IMP=0x0000000000cb6dad
- (void)resetDictationTipModelessHandlerSignalFlags;	// IMP=0x0000000000cb6d6c
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000cb6cf4
