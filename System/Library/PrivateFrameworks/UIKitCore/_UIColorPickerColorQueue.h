...
- (void).cxx_destruct;	// IMP=0x0000000000833268
...
- (void)_pickerDidSelectColor:(id)arg1 colorspace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x000000000083313a
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x000000000083306d
- (void)_displayLinkFired;	// IMP=0x000000000083301d
- (id)init;	// IMP=0x0000000000832eda
