...
- (void).cxx_destruct;	// IMP=0x000000000028bea4
...
- (void)_logOrientationPreferencesChangeWithOldSupportedOrientations:(unsigned long long)arg1 newSupportedOrientations:(unsigned long long)arg2 oldPreferredOrientation:(long long)arg3 newPreferredOrientation:(long long)arg4 animationSettings:(id)arg5 fenced:(_Bool)arg6;	// IMP=0x000000000028b97f
- (void)window:(id)arg1 didUpdateSupportedOrientations:(unsigned long long)arg2 preferredOrientation:(long long)arg3 prefersAnimation:(_Bool)arg4;	// IMP=0x000000000028b139
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x000000000028acd1
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x000000000028abaf
- (void)updateUserInterfaceStyle;	// IMP=0x000000000028aba9
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x000000000028aa06
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x000000000028a8c3
- (void)_windowDrivingSystemAppearanceDidChange:(id)arg1;	// IMP=0x000000000028a8ac
- (void)_handleWindowVisibilityNotification:(id)arg1;	// IMP=0x000000000028a5e2
- (id)_findWindowDrivingSystemAppearance;	// IMP=0x000000000028a284
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (void)dealloc;	// IMP=0x0000000000289f7a
- (id)initWithScene:(id)arg1;	// IMP=0x0000000000289dd8
