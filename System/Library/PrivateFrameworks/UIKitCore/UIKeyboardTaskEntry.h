...
- (void).cxx_destruct;	// IMP=0x0000000000c33744
@property(readonly, retain, nonatomic) NSArray *originatingStack; // @synthesize originatingStack=__creationStack;
- (void)execute:(id)arg1;	// IMP=0x0000000000c335d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c33597
- (id)initWithTask:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c334d4
