...
- (void).cxx_destruct;	// IMP=0x0000000000135235
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001350f4
- (void)_setPackage:(id)arg1;	// IMP=0x00000000001348d8
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000001347c6
