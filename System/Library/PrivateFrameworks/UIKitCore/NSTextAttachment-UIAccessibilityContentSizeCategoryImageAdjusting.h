...
+ (id)textAttachmentWithImage:(id)arg1;	// IMP=0x00100000008e982a
+ (id)_imageFromAttachment:(id)arg1;	// IMP=0x00100000011632f4
+ (_Bool)_attachmentHasImage:(id)arg1;	// IMP=0x001000000116318d
