...
- (void).cxx_destruct;	// IMP=0x000000000073fe14
...
- (id)captureSnapshot;	// IMP=0x000000000073fbff
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x000000000073f33d
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000073f032
- (id)init;	// IMP=0x000000000073efab
