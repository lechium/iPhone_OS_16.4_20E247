...
+ (id)settingsControllerModule;	// IMP=0x0040000000cb02a0
+ (_Bool)pointerSlipMatchesContentSlip;	// IMP=0x0040000000cb0298
...
- (void)setDefaultValues;	// IMP=0x0000000000cb0175
