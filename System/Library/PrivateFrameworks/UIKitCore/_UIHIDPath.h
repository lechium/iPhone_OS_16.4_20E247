...
- (void).cxx_destruct;	// IMP=0x0000000000f0b210
...
- (void)applyTransform:(struct CGAffineTransform)arg1;	// IMP=0x0000000000f0b126
- (void)updateWithHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000f0ad1d
- (id)init;	// IMP=0x0000000000f0ace1
