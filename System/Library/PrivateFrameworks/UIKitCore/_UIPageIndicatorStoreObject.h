...
- (void).cxx_destruct;	// IMP=0x0000000000cacad5
...
- (id)description;	// IMP=0x0000000000cac9e7
- (id)splitAtIndex:(long long)arg1 withImage:(id)arg2 active:(_Bool)arg3;	// IMP=0x0000000000cac7da
- (_Bool)validPageWithinBound:(long long)arg1;	// IMP=0x0000000000cac7c3
- (void)invalidateLayoutInfo;	// IMP=0x0000000000cac77f
- (void)_copyImagesFromObject:(id)arg1;	// IMP=0x0000000000cac6bb
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) struct CGSize resolvedSize;
- (id)initWithStartIndex:(long long)arg1 endIndex:(long long)arg2;	// IMP=0x0000000000cac5d1
