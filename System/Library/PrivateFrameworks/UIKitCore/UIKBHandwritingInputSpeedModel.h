...
- (void).cxx_destruct;	// IMP=0x0000000000a35186
...
- (void)updatePreferences;	// IMP=0x0000000000a34f69
- (double)timeoutForNextPage;	// IMP=0x0000000000a34dab
- (double)smoothValueFromArray:(id)arg1;	// IMP=0x0000000000a34c60
- (double)speedForCurrentStroke;	// IMP=0x0000000000a34936
- (void)endCharacter;	// IMP=0x0000000000a3481c
- (void)endStroke;	// IMP=0x0000000000a347f3
- (void)addPoint:(struct CGPoint)arg1 timestamp:(double)arg2;	// IMP=0x0000000000a3475f
- (void)beginStroke;	// IMP=0x0000000000a3465d
- (id)init;	// IMP=0x0000000000a34596
