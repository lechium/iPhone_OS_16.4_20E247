...
- (void).cxx_destruct;	// IMP=0x000000000109eac2
@property(readonly) UIButton *button; // @synthesize button=_button;
@property(readonly) UILabel *label;
@property(nonatomic) double rightMargin;
@property(nonatomic) long long textAlignment;
@property(copy, nonatomic) NSString *text;
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000109e8dc
- (void)layoutSubviews;	// IMP=0x000000000109e767
- (void)tintColorDidChange;	// IMP=0x000000000109e653
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000109e4cc
