...
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00100000002faf67
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2;	// IMP=0x00100000002faef8
- (void).cxx_destruct;	// IMP=0x00000000002fe3e0
...
- (_Bool)_verifyForUpdates:(id)arg1;	// IMP=0x00000000002fc8c8
- (id)_sectionUpdatesForDiffResults:(id)arg1 deletedSections:(id)arg2 insertedSections:(id)arg3;	// IMP=0x00000000002fc23e
- (id)_itemUpdatesForDiffResults:(id)arg1 sectionBoundaryMoves:(id)arg2 deletedSections:(id)arg3 insertedSections:(id)arg4;	// IMP=0x00000000002fb812
- (id)_computeSectionBoundaryMovesForItemDiffer:(id)arg1;	// IMP=0x00000000002fb740
- (id)_computeUpdatesForIdentifierBasedDiff;	// IMP=0x00000000002fb027
- (void)_computeUpdates;	// IMP=0x00000000002faff5
- (id)description;	// IMP=0x00000000002fa8df
- (id)initWithBeforeDataSource:(id)arg1 afterDataSource:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00000000002fa818
