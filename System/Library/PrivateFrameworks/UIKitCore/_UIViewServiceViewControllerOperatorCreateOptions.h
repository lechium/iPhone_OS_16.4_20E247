...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000132e64d
- (void).cxx_destruct;	// IMP=0x000000000132e72b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000132e253
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000132df6b
