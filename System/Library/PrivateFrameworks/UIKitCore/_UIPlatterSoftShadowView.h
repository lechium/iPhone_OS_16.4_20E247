...
- (void).cxx_destruct;	// IMP=0x0000000000018373
...
- (void)_updateForShadowPath;	// IMP=0x000000000001810f
- (id)initWithFrame:(struct CGRect)arg1 shadowPath:(id)arg2;	// IMP=0x0000000000017f9e
