...
- (void).cxx_destruct;	// IMP=0x000000000120f9f3
...
- (void)setDefaultResult;	// IMP=0x000000000120f560
- (void)setNoResult;	// IMP=0x000000000120f545
- (void)setAttachmentResult:(id)arg1;	// IMP=0x000000000120f4ec
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x000000000120f4d3
- (void)setStringResult:(id)arg1;	// IMP=0x000000000120f429
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x000000000120f3be
