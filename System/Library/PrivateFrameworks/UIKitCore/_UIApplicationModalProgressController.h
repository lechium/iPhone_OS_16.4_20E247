...
+ (id)instanceForScene:(id)arg1;	// IMP=0x006000000058375e
+ (id)sharedInstance;	// IMP=0x00600000005836d9
- (void).cxx_destruct;	// IMP=0x0000000000585e61
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000584b13
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000584b01
- (void)displayForDownloadingURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000584aea
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 preDisplayTestBlock:(CDUnknownBlockType)arg5 dismissalHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000005846d0
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000584032
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 replacementDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000583ec4
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000583d88
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x0000000000583d69
- (void)_hideTimerAction:(id)arg1;	// IMP=0x0000000000583d2c
- (void)_showTimerAction:(id)arg1;	// IMP=0x0000000000583c5c
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x0000000000583c0c
- (void)_reset;	// IMP=0x0000000000583b88
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x0000000000583b38
- (id)init;	// IMP=0x0000000000583a26
