...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0010000000fe29b2
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0010000000fe2203
- (void).cxx_destruct;	// IMP=0x0000000000fe60c2
...
- (id)description;	// IMP=0x0000000000fe5c22
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000fe588c
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000fe5349
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000fe50b9
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000fe4ec2
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000fe499a
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000fe477c
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000fe44c2
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000fe3dc2
- (_Bool)updatePlacement;	// IMP=0x0000000000fe3ce5
- (void)resetToPreferredPlacement;	// IMP=0x0000000000fe3ccf
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000fe3b45
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000fe38a3
- (void)_updateStatuses;	// IMP=0x0000000000fe37c4
- (void)prepareForDataUpdate;	// IMP=0x0000000000fe37ad
- (void)prepareForOverflowDataUpdate;	// IMP=0x0000000000fe3797
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000fe27ed
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000fe2609
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000fe257c
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000fe2545
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000fe24c1
