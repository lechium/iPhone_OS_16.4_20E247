...
- (void).cxx_destruct;	// IMP=0x000000000085f2e1
...
- (void)clearTimer;	// IMP=0x000000000085f1ef
- (void)startTimer;	// IMP=0x000000000085eefa
- (void)secondDelayElapsed:(id)arg1;	// IMP=0x000000000085ee9f
- (void)setState:(long long)arg1;	// IMP=0x000000000085edf3
- (void)_resetGestureRecognizer;	// IMP=0x000000000085eda6
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000085ed55
