...
+ (id)sharedInstance;	// IMP=0x0060000000cc8893
- (void).cxx_destruct;	// IMP=0x0000000000cc96bc
...
- (void)configureOneFingerForcePressRecognizer:(id)arg1;	// IMP=0x0000000000cc93fc
- (void)configureTwoFingerTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000cc93a1
- (void)configureTwoFingerPanGestureRecognizer:(id)arg1;	// IMP=0x0000000000cc9346
- (id)addLongPressTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000cc92a6
- (id)addTwoFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000cc9222
- (id)addOneFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000cc916e
- (_Bool)_longPressAllowedForView:(id)arg1;	// IMP=0x0000000000cc9152
- (_Bool)allowOneFingerDeepPress;	// IMP=0x0000000000cc914a
- (double)oneFingerForcePressAllowableMovement;	// IMP=0x0000000000cc913c
- (_Bool)oneFingerForcePressShouldCancelTouchesInView;	// IMP=0x0000000000cc9134
- (_Bool)oneFingerForcePressShouldFailWithoutForce;	// IMP=0x0000000000cc912c
- (double)oneFingerForcePressMinimumDuration;	// IMP=0x0000000000cc911e
- (void)redisableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000cc8fdd
- (void)enableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000cc8e89
- (void)didRemoveSelectionController;	// IMP=0x0000000000cc8e83
- (void)willRemoveSelectionController;	// IMP=0x0000000000cc8dda
- (void)_cleanupDeadGesturesIfNecessary;	// IMP=0x0000000000cc8cc4
- (id)selectionController;	// IMP=0x0000000000cc8c74
- (void)dealloc;	// IMP=0x0000000000cc8abd
- (void)removeDeallocationHandler:(id)arg1;	// IMP=0x0000000000cc8aa0
- (id)addDeallocationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000cc89e2
- (id)init;	// IMP=0x0000000000cc8944
- (_Bool)shouldAddForceGesture;	// IMP=0x0000000000cc88f9
- (Class)textInteractionClass;	// IMP=0x0000000000cc88e8
