...
+ (id)infoWithView:(id)arg1;	// IMP=0x0010000000700ec6
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x0010000000700e6c
+ (id)infoWithItem:(id)arg1;	// IMP=0x0010000000700e1e
- (void).cxx_destruct;	// IMP=0x00000000007021a1
...
- (id)description;	// IMP=0x00000000007020f6
- (void)invalidateFocusedRegion;	// IMP=0x00000000007020d0
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x0000000000702012
- (id)_createFocusedRegion;	// IMP=0x0000000000701345
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000700ff7
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x0000000000700f15
