...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000c34da5
- (void).cxx_destruct;	// IMP=0x0000000000c34f4b
...
- (void)dealloc;	// IMP=0x0000000000c34e44
