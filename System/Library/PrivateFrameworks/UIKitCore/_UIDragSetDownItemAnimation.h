...
- (void).cxx_destruct;	// IMP=0x00000000014b986f
...
- (void)_setCenterAndVelocityFromDroppedItem:(id)arg1;	// IMP=0x00000000014b934e
- (void)updateDroppedItem:(id)arg1;	// IMP=0x00000000014b91f7
- (void)updateTargetedDropPreview:(id)arg1;	// IMP=0x00000000014b8b69
- (void)updateAnimationTargeting;	// IMP=0x00000000014b8489
@property(readonly, nonatomic) long long previewMode;
- (_Bool)needsReparenting;	// IMP=0x00000000014b83ee
- (CDUnknownBlockType)animationCompletionHandler;	// IMP=0x00000000014b826c
- (void)performSpringAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000014b804b
- (void)performTrackingAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000014b7e2e
- (double)estimatedFractionCompleteOfAnimation;	// IMP=0x00000000014b7d38
- (void)updateCurrentTargetFrame;	// IMP=0x00000000014b7b73
- (void)reparentRetargetingContainerViewInTargetContainer;	// IMP=0x00000000014b71d3
- (void)configureCrossfadingAnimationToTargetedPreview;	// IMP=0x00000000014b5aca
- (void)configureSystemDefaultAnimation;	// IMP=0x00000000014b561d
- (void)configureAnimation;	// IMP=0x00000000014b55c5
@property(readonly, nonatomic) UIWindow *targetContainerWindow;
- (void)animationCompleted;	// IMP=0x00000000014b54a2
- (void)animationReachedTarget;	// IMP=0x00000000014b5452
- (void)beginAnimation;	// IMP=0x00000000014b5409
- (void)prepareToBeginAnimation;	// IMP=0x00000000014b52bd
- (void)prepareAnimationInWindow;	// IMP=0x00000000014b4f7f
- (id)initWithDragItem:(id)arg1 droppedItem:(id)arg2 window:(id)arg3 defaultAnimation:(_Bool)arg4 sourceAnimation:(_Bool)arg5 delegate:(id)arg6;	// IMP=0x00000000014b4e3d
