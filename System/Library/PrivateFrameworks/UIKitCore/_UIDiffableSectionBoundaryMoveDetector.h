...
- (void).cxx_destruct;	// IMP=0x00000000009632a0
...
- (id)_computeMovePairsFoundation;	// IMP=0x0000000000962984
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x0000000000962875
