...
- (void).cxx_destruct;	// IMP=0x00000000010881ca
...
- (id)cellForTargetContainerInTableView:(id)arg1;	// IMP=0x0000000001088009
- (id)initWithDragItem:(id)arg1 target:(id)arg2;	// IMP=0x0000000001087f91
