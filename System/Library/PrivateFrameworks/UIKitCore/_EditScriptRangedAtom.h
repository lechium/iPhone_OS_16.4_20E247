...
+ (id)atomWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0060000000b37ebe
- (void).cxx_destruct;	// IMP=0x0000000000b37f56
...
- (id)description;	// IMP=0x0000000000b37e08
- (id)initWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0000000000b37d77
