...
- (void).cxx_destruct;	// IMP=0x000000000109903f
...
- (void)_translateSourceIndexPath:(CDUnknownBlockType)arg1;	// IMP=0x0000000001098fc6
@property(readonly, nonatomic) struct CGSize previewSize;
- (id)initWithDragItem:(id)arg1 sourceIndexPath:(id)arg2;	// IMP=0x0000000001098eb9
