...
- (void).cxx_destruct;	// IMP=0x0000000000266630
...
- (void)recordDictationTipReplacementText:(id)arg1;	// IMP=0x0000000000266592
- (void)startRecodingReplacementText:(id)arg1;	// IMP=0x0000000000266580
- (void)finalizeRecordedText;	// IMP=0x00000000002663f4
- (void)recordDictationTipText:(id)arg1;	// IMP=0x0000000000266351
- (void)startRecodingText:(id)arg1;	// IMP=0x0000000000266296
- (void)resetHandler;	// IMP=0x000000000026623e
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000266185
