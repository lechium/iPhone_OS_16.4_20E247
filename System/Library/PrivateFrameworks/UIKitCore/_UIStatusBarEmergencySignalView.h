...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0010000000f91788
+ (double)_fontSizeForIconSize:(long long)arg1;	// IMP=0x0010000000f91768
- (void).cxx_destruct;	// IMP=0x0000000000f92276
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f91e4c
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f91d28
- (void)_iconSizeDidChange;	// IMP=0x0000000000f91b88
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f91b41
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f91ae9
- (void)_commonInit;	// IMP=0x0000000000f917a8
