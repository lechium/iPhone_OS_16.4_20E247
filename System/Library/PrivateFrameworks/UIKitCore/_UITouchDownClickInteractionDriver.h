...
@interface _UITouchDownClickInteractionDriver : NSObject <UIGestureRecognizerDelegate>
{
...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x0010000000ed2d8c
+ (_Bool)requiresForceCapability;	// IMP=0x0010000000ed2d84
- (void).cxx_destruct;	// IMP=0x0000000000ed3366
...
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000ed3084
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000ed3060
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000ed2f81
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000ed2f79
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000ed2ec7
- (void)cancelInteraction;	// IMP=0x0000000000ed2e85
...
- (id)init;	// IMP=0x0000000000ed2cfb
