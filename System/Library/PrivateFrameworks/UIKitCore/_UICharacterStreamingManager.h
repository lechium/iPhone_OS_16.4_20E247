...
- (void).cxx_destruct;	// IMP=0x000000000126217c
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x000000000126202d
- (void)_displayLinkFired:(id)arg1;	// IMP=0x000000000126176c
- (void)_startStreamingAnimations;	// IMP=0x0000000001261654
- (void)_stopStreamingAnimation;	// IMP=0x00000000012615de
- (void)setWords:(id)arg1;	// IMP=0x000000000126150c
- (void)commitFinalResults;	// IMP=0x00000000012614bc
- (id)initWithTextView:(id)arg1;	// IMP=0x000000000126144c
