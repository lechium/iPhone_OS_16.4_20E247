...
- (void).cxx_destruct;	// IMP=0x0000000000d3803c
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000d37e3c
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000d37ca5
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000d36807
