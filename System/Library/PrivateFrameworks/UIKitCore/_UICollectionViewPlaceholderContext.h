...
- (void).cxx_destruct;	// IMP=0x00000000003d1ebe
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003d1d85
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000003d1d13
@property(readonly, copy) NSString *description;
- (void)setNeedsCellUpdate;	// IMP=0x00000000003d1bfe
- (_Bool)commitInsertionWithDataSourceUpdates:(CDUnknownBlockType)arg1;	// IMP=0x00000000003d1b84
- (_Bool)deletePlaceholder;	// IMP=0x00000000003d1b1d
- (id)initWithOriginalInsertionIndexPath:(id)arg1 dragItem:(id)arg2 reuseIdentifier:(id)arg3 delegate:(id)arg4 cellUpdateHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000003d19f1
