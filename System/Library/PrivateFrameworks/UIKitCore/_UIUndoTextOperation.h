...
- (void).cxx_destruct;	// IMP=0x000000000123d212
...
- (_Bool)supportsCoalescing;	// IMP=0x000000000123d1c7
- (void)undoRedo;	// IMP=0x000000000123d1c1
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x000000000123d134
