...
- (void).cxx_destruct;	// IMP=0x0000000000f0aca3
...
- (void)dispatchUpdateWithPressure:(double)arg1 stillEstimated:(_Bool)arg2;	// IMP=0x0000000000f0aa4a
- (void)removeTouchable:(id)arg1;	// IMP=0x0000000000f0aa34
- (void)addTouchable:(id)arg1;	// IMP=0x0000000000f0a9da
- (id)initWithLiveTouch:(id)arg1 freezeTouch:(id)arg2 contextID:(id)arg3;	// IMP=0x0000000000f0a923
