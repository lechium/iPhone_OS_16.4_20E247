...
- (void).cxx_destruct;	// IMP=0x00000000004fad67
...
- (void)_wasUsed;	// IMP=0x00000000004facc2
- (SEL)action;	// IMP=0x00000000004fac84
- (id)target;	// IMP=0x00000000004fac37
- (void)_setOwningNavigationItem:(id)arg1;	// IMP=0x00000000004faba5
