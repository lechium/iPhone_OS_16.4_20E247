...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x001000000044656e
+ (_Bool)requiresForceCapability;	// IMP=0x0010000000446566
- (void).cxx_destruct;	// IMP=0x0000000000447478
...
- (void)_gestureRecognizerFailed:(id)arg1;	// IMP=0x00000000004473cb
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000004473c3
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000004472ca
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x000000000044712d
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000004470a9
- (void)_notifyDelegateOfUpdatedClickDownProgress:(double)arg1 forceAdjustedClickDownDuration:(double)arg2;	// IMP=0x0000000000446f5d
- (void)_updateForActiveGestureRecognizer;	// IMP=0x0000000000446cc4
- (void)_asyncGestureBegan;	// IMP=0x0000000000446c66
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000446a7f
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000446804
- (void)cancelInteraction;	// IMP=0x000000000044677c
...
- (id)init;	// IMP=0x000000000044604e
