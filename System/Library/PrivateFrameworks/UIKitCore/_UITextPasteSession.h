...
- (void).cxx_destruct;	// IMP=0x000000000120c02c
...
- (void)animationCompleted;	// IMP=0x000000000120bef0
- (void)animationStarted;	// IMP=0x000000000120beb6
- (id)positionedPasteResult;	// IMP=0x000000000120bdc7
