...
+ (id)descriptorWithIntensity:(float)arg1 sharpness:(float)arg2 audio:(id)arg3 volume:(float)arg4;	// IMP=0x00600000006b4527
- (void).cxx_destruct;	// IMP=0x00000000006b4624
