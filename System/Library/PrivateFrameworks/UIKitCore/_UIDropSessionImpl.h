...
- (void).cxx_destruct;	// IMP=0x000000000064d01f
...
- (void)_itemsNeedUpdate:(id)arg1;	// IMP=0x000000000064cfa8
- (id)_createItemsOfClass:(Class)arg1 synchronouslyIfPossible:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000064c655
- (id)_internalSession;	// IMP=0x000000000064c647
...
- (void)requestVisibleItems:(CDUnknownBlockType)arg1;	// IMP=0x000000000064c199
- (id)loadObjectsOfClass:(Class)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000064c0c4
- (_Bool)canLoadObjectsOfClass:(Class)arg1;	// IMP=0x000000000064c069
- (_Bool)hasItemsConformingToTypeIdentifiers:(id)arg1;	// IMP=0x000000000064c004
...
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x000000000064bf49
@property(readonly, nonatomic) NSArray *items;
@property(readonly) NSProgress *progress;
- (id)initWithSessionDestination:(id)arg1;	// IMP=0x000000000064bb88
