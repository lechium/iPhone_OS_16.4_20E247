...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _supportsAlwaysOnDisplay;	// 26 = 0x1a
    _Bool _supportsBacklightEnvironment;	// 27 = 0x1b
...
+ (id)mainBundleInfoParser;	// IMP=0x00600000007bc252
- (void).cxx_destruct;	// IMP=0x00000000007bd35c
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x00000000007bd216
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x00000000007bd149
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000007bcd71
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x00000000007bc5db
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000000007bc34e
- (id)_initWithBundle:(id)arg1;	// IMP=0x00000000007bc2f8
