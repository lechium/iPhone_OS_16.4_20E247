...
- (void).cxx_destruct;	// IMP=0x0000000000846cb6
@property(readonly, copy) NSString *description;
- (double)timestampForDelivery;	// IMP=0x0000000000846b78
- (long long)phaseForDelivery;	// IMP=0x0000000000846b5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000846a76
- (id)init;	// IMP=0x0000000000846a20
