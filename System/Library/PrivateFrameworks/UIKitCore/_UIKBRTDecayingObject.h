...
- (void).cxx_destruct;	// IMP=0x0000000000ca22d0
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ca21cb
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x0000000000ca21ab
- (void)startOrUpdateDecay;	// IMP=0x0000000000ca217f
- (void)updateDecay;	// IMP=0x0000000000ca213a
- (void)reset;	// IMP=0x0000000000ca2104
- (void)resetDecayTo:(double)arg1;	// IMP=0x0000000000ca20ad
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x0000000000ca206a
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x0000000000ca2027
