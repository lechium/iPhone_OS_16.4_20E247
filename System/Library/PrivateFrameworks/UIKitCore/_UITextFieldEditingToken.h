...
- (void).cxx_destruct;	// IMP=0x0000000001219f94
...
- (_Bool)endEditing;	// IMP=0x0000000001219ce2
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x0000000001219c3e
