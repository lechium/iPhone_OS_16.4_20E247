...
- (void).cxx_destruct;	// IMP=0x0000000000635d01
...
- (void)_tick:(id)arg1;	// IMP=0x0000000000635bb8
- (void)setupDisplayLink;	// IMP=0x0000000000635a58
- (void)interactionDidFinish:(id)arg1;	// IMP=0x0000000000635a1b
- (_Bool)shouldAllowInteraction:(id)arg1 withContext:(id)arg2;	// IMP=0x00000000006359b6
