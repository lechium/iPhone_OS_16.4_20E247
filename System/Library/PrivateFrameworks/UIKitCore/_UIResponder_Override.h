...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0060000000eba5d5
- (void).cxx_destruct;	// IMP=0x0000000000ebaa2c
...
- (id)description;	// IMP=0x0000000000eba810
- (void)dealloc;	// IMP=0x0000000000eba769
