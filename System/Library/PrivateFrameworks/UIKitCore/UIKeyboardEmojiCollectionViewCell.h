...
- (void).cxx_destruct;	// IMP=0x0000000000b4f40b
...
- (id)debugDescription;	// IMP=0x0000000000b4f2b1
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000b4edc3
@property(nonatomic) long long emojiFontSize;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b4df25
