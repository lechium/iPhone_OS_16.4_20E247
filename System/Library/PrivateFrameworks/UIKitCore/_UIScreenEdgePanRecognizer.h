...
- (void).cxx_destruct;	// IMP=0x00000000008760df
...
- (unsigned long long)_targetEdges;	// IMP=0x0000000000875f39
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x0000000000875df0
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x0000000000875cf6
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000874fa9
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000008747ae
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000874723
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000874693
- (long long)_type;	// IMP=0x0000000000874686
- (void)_setState:(long long)arg1;	// IMP=0x0000000000874492
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x00000000008743fd
- (void)dealloc;	// IMP=0x00000000008743c1
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000874362
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x000000000087416b
