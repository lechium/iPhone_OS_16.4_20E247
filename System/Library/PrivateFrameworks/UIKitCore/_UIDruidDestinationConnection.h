...
- (void).cxx_destruct;	// IMP=0x0000000000661e95
...
- (oneway void)dragEnded;	// IMP=0x0000000000661a1a
- (oneway void)handOffDroppedItems:(id)arg1 withFence:(id)arg2;	// IMP=0x0000000000661757
- (oneway void)performDropWithItemCollection:(id)arg1 dataProviderEndpoint:(id)arg2 visibleDroppedItems:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000000006610c0
- (oneway void)addedItemCollection:(id)arg1;	// IMP=0x0000000000660f2d
- (oneway void)requestDragPreviewsForIndexSet:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000660c7f
- (void)requestVisibleItems:(CDUnknownBlockType)arg1;	// IMP=0x0000000000660c69
- (void)enableKeyboardIfNeeded;	// IMP=0x0000000000660c53
- (void)requestDropWithOperation:(unsigned long long)arg1;	// IMP=0x0000000000660b8a
- (void)takePotentialDrop:(id)arg1;	// IMP=0x0000000000660aaf
- (void)sawDragEndEvent;	// IMP=0x0000000000660a08
- (void)dirtyItems:(id)arg1;	// IMP=0x000000000066096e
- (id)initWithSessionIdentifier:(unsigned int)arg1 systemPolicy:(_Bool)arg2;	// IMP=0x000000000065fe69
