...
- (void).cxx_destruct;	// IMP=0x0000000000dc9f6b
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000dc9dba
- (void)stopAnimation;	// IMP=0x0000000000dc9d51
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000dc9bd8
- (id)init;	// IMP=0x0000000000dc9bca
