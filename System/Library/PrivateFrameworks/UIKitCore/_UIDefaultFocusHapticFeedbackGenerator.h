...
- (void).cxx_destruct;	// IMP=0x000000000074a81c
...
- (void)performHapticFeedbackForFocusUpdateInContext:(id)arg1;	// IMP=0x000000000074a60b
- (id)initWithScreen:(id)arg1;	// IMP=0x000000000074a590
