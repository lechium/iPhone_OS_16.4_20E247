...
+ (id)newTransitionDescriptorForStops:(id)arg1;	// IMP=0x0060000000100464
- (void).cxx_destruct;	// IMP=0x0000000000100b35
...
- (id)description;	// IMP=0x0000000000100786
- (void)uniqueFilterNames;	// IMP=0x0000000000100599
- (id)copyForTransitionToDescriptor:(id)arg1;	// IMP=0x00000000000fff71
- (void)addOverlay:(id)arg1;	// IMP=0x00000000000fff5b
- (void)addUnderlay:(id)arg1;	// IMP=0x00000000000fff18
@property(retain, nonatomic) UIView<_UIVisualEffectViewParticipating> *containerView;
- (void)addViewEffect:(id)arg1;	// IMP=0x00000000000ffe81
- (void)addFilterEntry:(id)arg1;	// IMP=0x00000000000ffe3e
- (id)init;	// IMP=0x00000000000ffd6e
