...
- (void).cxx_destruct;	// IMP=0x00000000007c5d60
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000007c5c48
- (id)initWithSceneLayer:(id)arg1;	// IMP=0x00000000007c5af9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000007c5a72
