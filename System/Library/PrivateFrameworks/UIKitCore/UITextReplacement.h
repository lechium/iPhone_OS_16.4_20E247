...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x00600000011dd8d1
- (void).cxx_destruct;	// IMP=0x00000000011ddc19
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x00000000011ddb7a
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x00000000011dd99e
