...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0060000000aa6663
- (void).cxx_destruct;	// IMP=0x0000000000aa6956
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x0000000000aa68b1
- (struct CGPoint)getLocationInWindow;	// IMP=0x0000000000aa6891
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x0000000000aa6805
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000aa6779
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0000000000aa66d6
