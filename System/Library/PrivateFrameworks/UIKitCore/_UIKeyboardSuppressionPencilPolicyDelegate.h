...
- (void).cxx_destruct;	// IMP=0x000000000094e384
...
- (_Bool)_shouldSuppressForDelegate:(id)arg1;	// IMP=0x000000000094e2a5
- (id)_recognitionLocaleIdentifier;	// IMP=0x000000000094e143
