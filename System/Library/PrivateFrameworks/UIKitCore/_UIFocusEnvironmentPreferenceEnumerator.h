...
- (void).cxx_destruct;	// IMP=0x00000000006ff3e3
...
- (_Bool)_shouldInferDefaultPreferenceForEnvironmentInContext:(id)arg1;	// IMP=0x00000000006ff314
- (void)enumeratePreferencesForEnvironment:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000006fec2b
- (id)initWithEnumerationMode:(long long)arg1;	// IMP=0x00000000006febea
- (id)init;	// IMP=0x00000000006febd6
