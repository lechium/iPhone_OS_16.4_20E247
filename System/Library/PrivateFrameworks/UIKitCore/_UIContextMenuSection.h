...
+ (id)sectionWithMenu:(id)arg1;	// IMP=0x0060000000317ae6
- (void).cxx_destruct;	// IMP=0x0000000000317c9e
...
- (unsigned long long)hash;	// IMP=0x0000000000317c58
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000317bfd
