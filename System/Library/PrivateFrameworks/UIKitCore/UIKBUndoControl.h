...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0060000000d30c8c
- (void).cxx_destruct;	// IMP=0x0000000000d31f9b
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d31e0f
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000d31dfa
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000d31d87
- (unsigned int)_secureName;	// IMP=0x0000000000d31d6d
- (void)configureSecurePasteButtonInRootView:(id)arg1;	// IMP=0x0000000000d318e4
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000d30dc8
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000d30c18
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d30b8f
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d30808
- (void)updateUndoControlStyle;	// IMP=0x0000000000d30460
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000d30360
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000d2ff3d
