...
- (void)loadView;	// IMP=0x0000000000798e75
- (void)dealloc;	// IMP=0x0000000000798e35
- (id)initWithDOMHTMLInputElement:(id)arg1 datePickerMode:(long long)arg2;	// IMP=0x0000000000798da9
