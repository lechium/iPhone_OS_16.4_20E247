...
- (void).cxx_destruct;	// IMP=0x000000000107044c
...
- (id)description;	// IMP=0x00000000010702e5
- (void)performWithEnforcedContainerSize:(struct CGSize)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000010702b2
- (struct CGRect)containerBounds;	// IMP=0x000000000107027c
@property(readonly, nonatomic) struct CGSize containerSize;
@property(readonly, nonatomic) struct CGRect contentFrame;
- (void)layoutIfNeeded;	// IMP=0x000000000107008a
- (void)setNeedsLayout;	// IMP=0x0000000001070055
- (struct CGRect)_updateAccessories:(id)arg1 previousAccessories:(id)arg2 withLayout:(id)arg3 edge:(unsigned long long)arg4;	// IMP=0x000000000106ef61
- (void)_updateFromPreviousConfiguration:(id)arg1;	// IMP=0x000000000106eb6b
@property(readonly, nonatomic) UICellAccessoryConfiguration *currentConfiguration;
- (id)_configurationWithIdentifier:(id)arg1;	// IMP=0x000000000106eb1c
- (void)updateContainerView:(id)arg1;	// IMP=0x000000000106e99b
- (id)initWithContainerView:(id)arg1;	// IMP=0x000000000106e909
