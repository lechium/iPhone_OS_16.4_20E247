...
+ (double)defaultDuration;	// IMP=0x00600000004d5559
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x00600000004d551b
+ (id)timingCurveProvider;	// IMP=0x00600000004d5502
- (void).cxx_destruct;	// IMP=0x00000000004d5656
...
- (id)description;	// IMP=0x00000000004d5468
