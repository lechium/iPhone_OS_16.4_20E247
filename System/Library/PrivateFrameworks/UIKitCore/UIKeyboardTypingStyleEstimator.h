...
- (void).cxx_destruct;	// IMP=0x0000000000d24639
@property(nonatomic) __weak id <UIKeyboardTypingStyleEstimatorDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)currentTypingStyleEstimation;	// IMP=0x0000000000d24608
- (void)tapTypedKey;	// IMP=0x0000000000d245f1
- (void)cancelContinuousPath;	// IMP=0x0000000000d2451e
- (void)endedContinuousPath;	// IMP=0x0000000000d243ce
- (void)beganContinuousPath;	// IMP=0x0000000000d2436d
- (void)_setTypingStyleEstimation:(unsigned long long)arg1;	// IMP=0x0000000000d2420b
