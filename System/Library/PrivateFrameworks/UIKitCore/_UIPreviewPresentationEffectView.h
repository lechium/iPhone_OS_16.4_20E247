...
{
    _Bool _shouldRasterizeForTransition;	// 144 = 0x90
    UIColor *_shadowColor;	// 152 = 0x98
}

- (void).cxx_destruct;	// IMP=0x0000000000db9f87
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x0000000000db9907
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000db96df
