...
+ (id)_summaryImageForDebugInfoArray:(id)arg1 forFocusMovementWithInfo:(id)arg2 scaleFactor:(double)arg3;	// IMP=0x006000000070b04a
- (void).cxx_destruct;	// IMP=0x000000000070bd9b
...
- (id)_drawImage;	// IMP=0x000000000070a48d
- (struct CGRect)_rectContainingAllFocusRegions;	// IMP=0x000000000070a295
@property(readonly, nonatomic) struct CGPoint imageAnchorPoint; // @synthesize imageAnchorPoint=_imageAnchorPoint;
@property(readonly, nonatomic) UIImage *image; // @synthesize image=_image;
- (id)initWithSnapshot:(id)arg1 focusMapSearchInfo:(id)arg2;	// IMP=0x000000000070a111
