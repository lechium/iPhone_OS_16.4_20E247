...
- (void).cxx_destruct;	// IMP=0x000000000149b99e
...
- (void)startRecodingText:(id)arg1;	// IMP=0x000000000149b8b2
- (void)resetHandler;	// IMP=0x000000000149b870
- (void)recordDictationTipText:(id)arg1;	// IMP=0x000000000149b7cc
- (void)finalizeRecordedText;	// IMP=0x000000000149b630
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000149b577
