...
- (void).cxx_destruct;	// IMP=0x0000000000455d8e
...
- (_Bool)_isSupportedInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000455d69
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000455cae
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000455b8a
- (id)initWithInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000455ade
