...
- (id)ui_allSupplementalCandidates;	// IMP=0x003000000011744f
...
- (long long)sourceForAutocorrection;	// IMP=0x003000000097dc08
- (void)updateLabelsWithSmartPunctuation:(id)arg1;	// IMP=0x003000000097d942
@end
