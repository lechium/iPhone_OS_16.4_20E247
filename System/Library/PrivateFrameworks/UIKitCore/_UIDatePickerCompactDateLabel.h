...
- (void).cxx_destruct;	// IMP=0x000000000040afa9
...
- (void)setEnabled:(_Bool)arg1;	// IMP=0x000000000040a97a
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x000000000040a7a4
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x000000000040a5bf
- (void)_didTapTextLabel;	// IMP=0x000000000040a26d
- (void)activateLabel;	// IMP=0x000000000040a25b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000409a79
