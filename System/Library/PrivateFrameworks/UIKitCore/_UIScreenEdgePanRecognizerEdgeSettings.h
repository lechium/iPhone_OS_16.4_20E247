...
+ (id)settingsControllerModule;	// IMP=0x0060000000873267
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x0060000000873247
...
- (void)setDefaultValues;	// IMP=0x0000000000873092
