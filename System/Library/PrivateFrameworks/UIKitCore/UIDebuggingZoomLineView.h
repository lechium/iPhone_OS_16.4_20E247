...
- (void).cxx_destruct;	// IMP=0x00000000012c93a7
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000012c91ba
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000012c9025
- (void)updateLabelFrame;	// IMP=0x00000000012c8ce4
