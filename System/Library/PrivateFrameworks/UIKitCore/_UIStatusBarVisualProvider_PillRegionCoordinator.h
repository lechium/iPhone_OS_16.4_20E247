...
- (void).cxx_destruct;	// IMP=0x00000000010694f4
...
- (_Bool)handledUpdateOfActionable:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3;	// IMP=0x00000000010693c3
- (void)updateRegion:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3 cornerRadius:(double)arg4;	// IMP=0x00000000010691dc
- (id)animationForBackgroundActivityPillWithDuration:(double)arg1 scale:(double)arg2;	// IMP=0x0000000001068fa6
- (id)animationForBackgroundActivityPill;	// IMP=0x0000000001068f89
- (id)animationForBackgroundActivityIcon;	// IMP=0x0000000001068e07
- (void)_hideActivityDetailAndUpdate:(_Bool)arg1;	// IMP=0x0000000001068d26
- (void)updatePill;	// IMP=0x0000000001068d0a
- (void)_updateBackgroundActivityWithEntry:(id)arg1 timeEntry:(id)arg2 needsUpdate:(_Bool)arg3;	// IMP=0x00000000010688f6
- (void)updateDataForBackgroundActivity:(id)arg1;	// IMP=0x0000000001068558
