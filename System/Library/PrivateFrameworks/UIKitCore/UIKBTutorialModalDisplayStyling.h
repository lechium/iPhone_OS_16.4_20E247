...
- (void).cxx_destruct;	// IMP=0x0000000000810361
...
- (id)backgroundBlurEffects:(long long)arg1;	// IMP=0x000000000081025e
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000810164
