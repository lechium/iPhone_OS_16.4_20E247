...
- (void).cxx_destruct;	// IMP=0x0000000000f8e5ee
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f8e58f
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f8e2ba
@property(copy, nonatomic) NSString *text;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f8de6e
