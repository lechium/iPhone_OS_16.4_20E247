...
- (void).cxx_destruct;	// IMP=0x0000000000f71257
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000f71061
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000f7104f
- (void)_create_nameView;	// IMP=0x0000000000f70ff5
- (id)dependentEntryKeys;	// IMP=0x0000000000f70f5b
