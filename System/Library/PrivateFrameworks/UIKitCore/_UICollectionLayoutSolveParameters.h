...
- (void).cxx_destruct;	// IMP=0x00000000002b4fd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b4f28
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b4d7a
- (id)init;	// IMP=0x00000000002b4747
