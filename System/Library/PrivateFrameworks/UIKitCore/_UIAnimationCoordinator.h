...
- (void).cxx_destruct;	// IMP=0x0000000000581dbb
...
- (void)animationEnded:(_Bool)arg1;	// IMP=0x0000000000581d05
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000581a00
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000005819f5
- (void)finishInteractiveAnimation;	// IMP=0x000000000058195f
- (void)cancelInteractiveAnimation;	// IMP=0x00000000005818c9
- (void)updateInteractiveProgress:(double)arg1;	// IMP=0x00000000005817f2
- (void)animateInteractively;	// IMP=0x00000000005816ff
- (void)animate;	// IMP=0x000000000058166d
- (void)_updateTransitionContext;	// IMP=0x0000000000581541
@property(readonly, retain, nonatomic) NSMutableDictionary *stash;
- (void)dealloc;	// IMP=0x0000000000581272
