...
- (void).cxx_destruct;	// IMP=0x0000000000594e88
...
- (void)animateTransition:(id)arg1;	// IMP=0x000000000059456b
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000594559
- (void)dealloc;	// IMP=0x0000000000594519
