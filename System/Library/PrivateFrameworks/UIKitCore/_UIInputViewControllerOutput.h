...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009db7ea
- (void).cxx_destruct;	// IMP=0x00000000009dcb8c
...
- (id)description;	// IMP=0x00000000009dc6aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009dc1c1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009dbf6c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009dbcaf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009dbba8
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x00000000009dbb85
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x00000000009dba92
- (void)deleteBackward;	// IMP=0x00000000009db9d7
- (void)insertText:(id)arg1;	// IMP=0x00000000009db965
- (id)_currentKeyboardOutput;	// IMP=0x00000000009db8bc
- (void)_pushNewKeyboardOutput;	// IMP=0x00000000009db7f2
