...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000071de0
- (int)textEffectsVisibilityLevel;	// IMP=0x0000000000071dd5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000071d34
