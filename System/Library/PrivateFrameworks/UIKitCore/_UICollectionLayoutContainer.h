...
- (void).cxx_destruct;	// IMP=0x00000000002ae756
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ae61b
...
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 insetsEnvironment:(id)arg3;	// IMP=0x00000000002ae3ff
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2;	// IMP=0x00000000002ae368
