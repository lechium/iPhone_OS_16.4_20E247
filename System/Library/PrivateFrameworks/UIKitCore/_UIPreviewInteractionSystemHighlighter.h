...
- (void).cxx_destruct;	// IMP=0x0000000000dd91df
...
- (id)_newSnapshotViewForPreviewingContext:(id)arg1 afterScreenUpdates:(_Bool)arg2;	// IMP=0x0000000000dd906f
- (void)finalizeHighlightForPreviewingContext:(id)arg1;	// IMP=0x0000000000dd8fc7
- (id)highlightShouldBeginInContainerView:(id)arg1 presentationContainerView:(id)arg2 previewingContext:(id)arg3;	// IMP=0x0000000000dd8aba
- (void)prepareHighlightWithPreviewingContext:(id)arg1;	// IMP=0x0000000000dd8a18
