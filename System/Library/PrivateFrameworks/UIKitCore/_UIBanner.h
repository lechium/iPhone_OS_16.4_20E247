...
- (void).cxx_destruct;	// IMP=0x0000000000f39802
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f3968e
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f39612
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f39596
- (void)dismiss;	// IMP=0x0000000000f393a8
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x0000000000f39122
- (void)present;	// IMP=0x0000000000f38f87
