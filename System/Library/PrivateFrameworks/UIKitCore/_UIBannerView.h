...
- (void).cxx_destruct;	// IMP=0x0000000000f38f12
...
- (void)setHighlighted:(_Bool)arg1 initialPress:(_Bool)arg2;	// IMP=0x0000000000f38d02
- (void)layoutSubviews;	// IMP=0x0000000000f38a2a
- (void)updateConstraints;	// IMP=0x0000000000f38445
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f37f55
