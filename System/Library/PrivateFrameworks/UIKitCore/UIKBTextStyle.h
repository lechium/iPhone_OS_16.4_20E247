...
+ (id)styleWithTextColor:(id)arg1;	// IMP=0x0010000000a85db0
+ (id)styleWithFontName:(id)arg1 withFontSize:(double)arg2;	// IMP=0x0010000000a85cd8
- (void).cxx_destruct;	// IMP=0x0000000000a86d96
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a86a4d
- (void)overlayWithStyle:(id)arg1;	// IMP=0x0000000000a8658a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a8632c
- (id)description;	// IMP=0x0000000000a85ebf
- (id)init;	// IMP=0x0000000000a85e71
