...
+ (id)beginLoupeSessionAtPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 fromView:(id)arg3;	// IMP=0x0060000000f712b0
- (void).cxx_destruct;	// IMP=0x0000000000f71edf
...
- (void)dealloc;	// IMP=0x0000000000f71e0a
- (void)didMoveToPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 tracksCaret:(_Bool)arg3;	// IMP=0x0000000000f71b05
- (struct CGPoint)_locationInContainerCoordinateSpace:(struct CGPoint)arg1;	// IMP=0x0000000000f71a45
