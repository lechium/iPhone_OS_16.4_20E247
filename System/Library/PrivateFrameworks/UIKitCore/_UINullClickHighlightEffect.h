...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x00100000002340a7
- (void).cxx_destruct;	// IMP=0x0000000000234192
...
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x00000000002340f4
