...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x000000000044ab6c
- (void)finishFirstHalfRotation;	// IMP=0x000000000044a6e2
- (void)rotateSnapshots;	// IMP=0x000000000044a005
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x0000000000449382
- (_Bool)_isFooterTranslucent;	// IMP=0x000000000044933d
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000004492c0
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x000000000044900c
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x0000000000448fec
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x0000000000448d09
- (void)dealloc;	// IMP=0x0000000000448ca0
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x0000000000448a54
