...
- (void).cxx_destruct;	// IMP=0x00000000012a73f1
...
- (void)didReceiveGesture:(id)arg1;	// IMP=0x00000000012a7024
- (void)toggleFullscreen;	// IMP=0x00000000012a6ef8
- (void)viewDidLayoutSubviews;	// IMP=0x00000000012a6969
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000012a6643
