...
- (void).cxx_destruct;	// IMP=0x000000000078267b
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x0000000000781e4f
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x0000000000781d1e
- (_Bool)supportsBackButtons;	// IMP=0x0000000000781d16
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x0000000000781ceb
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x0000000000781a5d
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000781741
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x000000000077ffac
- (void)_selectGestureChanged:(id)arg1;	// IMP=0x000000000077ff46
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x000000000077feaf
- (id)contentView;	// IMP=0x000000000077fe1b
- (id)backIndicatorView;	// IMP=0x000000000077fe09
