...
- (void).cxx_destruct;	// IMP=0x00000000007305d2
...
- (id)description;	// IMP=0x0000000000730404
- (void)drawVisualRepresentationInContext:(struct CGContext *)arg1 imageFrame:(struct CGRect)arg2;	// IMP=0x0000000000730211
- (id)visualRepresentationColor;	// IMP=0x000000000072ffea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000072ff4d
