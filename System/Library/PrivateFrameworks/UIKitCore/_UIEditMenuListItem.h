...
+ (id)itemWithTitle:(id)arg1;	// IMP=0x0060000000d7cc87
+ (id)itemWithMenuElement:(id)arg1;	// IMP=0x0060000000d7c80d
- (void).cxx_destruct;	// IMP=0x0000000000d7ce33
...
- (_Bool)hidesImageForTraitCollection:(id)arg1;	// IMP=0x0000000000d7cd4b
- (_Bool)hidesTitleForTraitCollection:(id)arg1;	// IMP=0x0000000000d7cccb
