...
- (void).cxx_destruct;	// IMP=0x000000000098bf4a
...
- (id)traitCollection;	// IMP=0x000000000098bc92
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000098ba67
- (void)layoutSubviews;	// IMP=0x000000000098b8b8
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x000000000098b0bd
- (_Bool)shouldExtendUpwards;	// IMP=0x000000000098ae78
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x000000000098a809
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x000000000098a521
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x000000000098a0a2
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x00000000009897e9
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x0000000000989764
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009896a4
