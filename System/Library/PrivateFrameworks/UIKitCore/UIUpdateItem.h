...
- (void).cxx_destruct;	// IMP=0x0000000001124ea9
...
- (long long)compareIndexPathsForMoves:(id)arg1;	// IMP=0x0000000001124c39
- (long long)inverseCompareIndexPaths:(id)arg1;	// IMP=0x0000000001124c13
- (long long)compareIndexPaths:(id)arg1;	// IMP=0x0000000001124bf0
- (id)description;	// IMP=0x00000000011248c6
- (id)_moveDestinationDescription;	// IMP=0x00000000011248b9
