...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x006000000019156e
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x0000000000191c35
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x0000000000191bd3
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x0000000000191bbe
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x0000000000191ba9
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x0000000000191b7f
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x0000000000191a84
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x0000000000191a78
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x0000000000191a1a
...
- (double)leftBackTitleMarginLetterpressPadding;	// IMP=0x00000000001918a7
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x00000000001917ef
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x00000000001917bc
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x0000000000191641
- (id)initWithIdiom:(long long)arg1;	// IMP=0x0000000000191604
