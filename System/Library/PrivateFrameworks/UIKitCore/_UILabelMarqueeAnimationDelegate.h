...
- (void).cxx_destruct;	// IMP=0x00000000013afd55
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000013afb2d
- (void)animationDidStart:(id)arg1;	// IMP=0x00000000013af852
- (id)initWithLabel:(id)arg1;	// IMP=0x00000000013af7ee
