...
- (void).cxx_destruct;	// IMP=0x00000000010679a4
- (id)reorderSeparatorView:(_Bool)arg1;	// IMP=0x00000000010678a0
- (id)reorderControl:(_Bool)arg1;	// IMP=0x00000000010677fc
- (id)editControl:(_Bool)arg1;	// IMP=0x00000000010676e1
@property(readonly, nonatomic) _Bool wantsMaskingWhileAnimatingDisabled;
- (void)dealloc;	// IMP=0x000000000106762e
- (id)initWithTableViewCell:(id)arg1 editingStyle:(long long)arg2;	// IMP=0x00000000010675bf
