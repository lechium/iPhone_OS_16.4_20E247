...
- (void).cxx_destruct;	// IMP=0x0000000000280871
...
- (id)_textViewDefaults:(long long)arg1;	// IMP=0x00000000002803b9
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x000000000028036d
- (id)_labelDefaults:(long long)arg1;	// IMP=0x000000000028025e
- (id)_genericDefaults:(long long)arg1;	// IMP=0x00000000002800ef
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x000000000027fed4
