...
+ (id)contextForTransition:(int)arg1;	// IMP=0x00600000001b65eb
- (void).cxx_destruct;	// IMP=0x00000000001b816a
...
- (void)_updateIncomingLayoutWidthToMatchOutgoingLayout;	// IMP=0x00000000001b7fe6
- (void)_animateAsTwoPartsWithoutOverlap:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x00000000001b7fcc
- (void)_animateAsTwoPartsWithOverlapIfNecessaryPartOne:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x00000000001b7f44
- (void)_animateAsTwoPartsWithOverlap:(double)arg1 partOne:(CDUnknownBlockType)arg2 partTwo:(CDUnknownBlockType)arg3;	// IMP=0x00000000001b7db1
- (void)_removeAllClippingViews;	// IMP=0x00000000001b7c63
- (void)_addClippingView:(id)arg1;	// IMP=0x00000000001b7bf8
...
- (void)cancel;	// IMP=0x00000000001b791b
- (void)complete;	// IMP=0x00000000001b776b
- (void)_resetContentAndLargeTitleViewCompleted:(_Bool)arg1;	// IMP=0x00000000001b771c
- (void)setAllLargeTitleLayoutsVisible;	// IMP=0x00000000001b76dd
- (void)animate;	// IMP=0x00000000001b76cb
- (void)_animateBackgroundView;	// IMP=0x00000000001b7502
- (_Bool)shouldPerformTwoPartCrossfadeTransition;	// IMP=0x00000000001b74b8
- (void)_animateFromBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x00000000001b7017
- (void)_prepareToBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x00000000001b6d21
- (void)prepare;	// IMP=0x00000000001b6a89
- (void)recordUpdates:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b66e4
- (id)description;	// IMP=0x00000000001b6561
- (void)setBackgroundView:(id)arg1 isBarBackground:(_Bool)arg2;	// IMP=0x00000000001b652b
