...
- (void).cxx_destruct;	// IMP=0x00000000012c495c
...
- (void)_sliderDidChangeValue:(id)arg1;	// IMP=0x00000000012c47b1
- (void)_prototypingSettingDidChange;	// IMP=0x00000000012c443b
- (void)_tapRecognizerDidRecognizer:(id)arg1;	// IMP=0x00000000012c4354
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000012c3fd6
