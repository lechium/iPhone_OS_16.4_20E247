...
+ (id)touchStateTaskForTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0010000000c1f68a
- (void).cxx_destruct;	// IMP=0x0000000000c1f92c
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000c1f7f2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c1f7a5
- (id)initWithTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c1f6fa
