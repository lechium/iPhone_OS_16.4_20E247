...
+ (id)layoutForSource:(id)arg1 inTarget:(id)arg2 withSize:(struct CGSize)arg3;	// IMP=0x006000000097fe9c
- (void).cxx_destruct;	// IMP=0x00000000009828c0
...
- (id)description;	// IMP=0x0000000000982700
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000098261a
- (_Bool)hasContents;	// IMP=0x0000000000982600
