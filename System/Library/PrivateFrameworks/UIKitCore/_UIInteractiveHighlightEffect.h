...
- (void).cxx_destruct;	// IMP=0x0000000000db49e2
...
- (void)dealloc;	// IMP=0x0000000000db48bf
- (void)finalizeEffect;	// IMP=0x0000000000db48a6
- (void)applyBackgroundEffectWithMagnitude:(double)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000db482b
