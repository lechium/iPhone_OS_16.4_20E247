...
- (void).cxx_destruct;	// IMP=0x0000000000dbc024
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000dbbe18
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000dbbc92
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000dbbc0e
- (id)init;	// IMP=0x0000000000dbbb5c
