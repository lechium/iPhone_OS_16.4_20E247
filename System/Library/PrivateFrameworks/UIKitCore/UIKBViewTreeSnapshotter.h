...
+ (id)snapshotterForKeyboardView:(id)arg1 afterScreenUpdates:(_Bool)arg2;	// IMP=0x0060000000b9a25c
- (void).cxx_destruct;	// IMP=0x0000000000b9a59d
@property(readonly, nonatomic) UIView *snapshotView; // @synthesize snapshotView=_snapshotView;
- (void)dealloc;	// IMP=0x0000000000b9a43b
