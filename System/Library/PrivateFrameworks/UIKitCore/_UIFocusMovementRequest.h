...
- (void).cxx_destruct;	// IMP=0x000000000075199c
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x000000000075167b
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x0000000000751572
- (id)init;	// IMP=0x00000000007514eb
