...
- (void).cxx_destruct;	// IMP=0x0000000000d2fec8
...
- (void)createDynamicColors;	// IMP=0x0000000000d2f3ba
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000d2f39c
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d2f2c8
