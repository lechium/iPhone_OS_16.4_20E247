...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000001483315
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x006000000148323c
- (void).cxx_destruct;	// IMP=0x0000000001483896
...
- (_Bool)_allowsHitTesting;	// IMP=0x000000000148384b
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x0000000001483842
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x00000000014837cd
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x000000000148345a
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x0000000001483432
