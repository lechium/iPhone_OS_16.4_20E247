...
- (void).cxx_destruct;	// IMP=0x0000000000779064
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x0000000000778c95
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x0000000000778864
