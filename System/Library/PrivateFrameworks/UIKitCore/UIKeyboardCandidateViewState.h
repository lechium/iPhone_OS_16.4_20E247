...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x001000000097aabc
- (void).cxx_destruct;	// IMP=0x000000000097ace0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000097a929
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000097a84a
