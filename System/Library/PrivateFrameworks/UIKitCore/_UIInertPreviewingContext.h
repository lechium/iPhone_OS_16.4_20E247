...
- (void).cxx_destruct;	// IMP=0x0000000000d91e0f
...
- (void)unregister;	// IMP=0x0000000000d91d7e
- (struct CGRect)preferredSourceViewRectInCoordinateSpace:(id)arg1;	// IMP=0x0000000000d91d66
@property(readonly, nonatomic) UIGestureRecognizer *previewingGestureRecognizerForFailureRelationship;
- (id)initWithSourceView:(id)arg1;	// IMP=0x0000000000d91caa
