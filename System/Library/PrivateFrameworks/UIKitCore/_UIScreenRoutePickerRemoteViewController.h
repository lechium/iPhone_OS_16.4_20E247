...
+ (id)exportedInterface;	// IMP=0x0010000000919a4c
+ (id)serviceViewControllerInterface;	// IMP=0x0010000000919a2c
- (void).cxx_destruct;	// IMP=0x0000000000919d09
...
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000919bc7
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x0000000000919b86
- (void)_dismissViewController;	// IMP=0x0000000000919ad0
- (void)invalidate;	// IMP=0x0000000000919a6c
