...
+ (id)groupWithHighPriority:(long long)arg1 lowPriority:(long long)arg2 bluetoothPaddingInset:(double)arg3;	// IMP=0x0040000000f7b6f3
+ (id)activityItemDisplayIdentifier;	// IMP=0x0040000000f7b6da
- (void).cxx_destruct;	// IMP=0x0000000000f7be8e
