...
- (void).cxx_destruct;	// IMP=0x0000000000f16c9f
- (void)dealloc;	// IMP=0x0000000000f16c53
- (void)eventFetcherDidReceiveEvents:(id)arg1;	// IMP=0x0000000000f16c32
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000000f1681f
