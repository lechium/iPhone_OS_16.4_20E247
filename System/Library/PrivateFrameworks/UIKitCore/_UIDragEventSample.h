...
+ (id)sampleFromHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0060000000f10c93
- (void).cxx_destruct;	// IMP=0x0000000000f11518
...
- (id)description;	// IMP=0x0000000000f1142f
- (id)hitTestWithEvent:(id)arg1;	// IMP=0x0000000000f1132e
