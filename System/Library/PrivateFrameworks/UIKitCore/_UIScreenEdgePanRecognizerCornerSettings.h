...
+ (id)settingsControllerModule;	// IMP=0x0060000000873eb0
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x0060000000873e90
...
- (void)setDefaultValues;	// IMP=0x0000000000873ded
