...
- (void).cxx_destruct;	// IMP=0x000000000107dc76
...
- (void)invalidate;	// IMP=0x000000000107db6d
- (void)dealloc;	// IMP=0x000000000107db2f
- (id)_initWithReason:(id)arg1 options:(unsigned long long)arg2 controller:(id)arg3;	// IMP=0x000000000107da8a
