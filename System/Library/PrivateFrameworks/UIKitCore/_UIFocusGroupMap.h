...
- (void).cxx_destruct;	// IMP=0x000000000125e4b2
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace; // @synthesize coordinateSpace=_coordinateSpace;
- (id)visualDescription;	// IMP=0x000000000125e254
- (id)description;	// IMP=0x000000000125e1b2
- (id)focusGroupForItem:(id)arg1;	// IMP=0x000000000125e0e8
...
- (id)_indexEnvironment:(id)arg1;	// IMP=0x000000000125d86d
- (void)_indexItems:(id)arg1;	// IMP=0x000000000125d4fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000125d207
- (id)initWithItems:(id)arg1 standInItemsMap:(id)arg2 coordinateSpace:(id)arg3;	// IMP=0x000000000125cfb5
- (id)initWithItems:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x000000000125cf9e
