...
- (void).cxx_destruct;	// IMP=0x000000000109b0d9
...
- (_Bool)deletePlaceholder;	// IMP=0x000000000109af41
- (_Bool)commitInsertionWithDataSourceUpdates:(CDUnknownBlockType)arg1;	// IMP=0x000000000109ade2
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000109ac2e
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x000000000109aa7a
- (id)initWithDelegate:(id)arg1 dragItem:(id)arg2 reuseIdentifier:(id)arg3 rowHeight:(double)arg4 cellUpdateHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000109a978
