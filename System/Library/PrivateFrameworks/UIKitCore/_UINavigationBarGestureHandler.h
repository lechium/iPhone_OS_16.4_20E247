...
- (void).cxx_destruct;	// IMP=0x0000000000175cc5
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x0000000000175b54
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000175aa6
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x00000000001759e4
