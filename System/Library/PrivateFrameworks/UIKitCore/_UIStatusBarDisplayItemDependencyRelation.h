...
- (void).cxx_destruct;	// IMP=0x0000000000fe6bbd
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000fe6a31
- (id)type;	// IMP=0x0000000000fe6a0a
- (id)itemStates;	// IMP=0x0000000000fe697f
- (_Bool)isFulfilled;	// IMP=0x0000000000fe691d
