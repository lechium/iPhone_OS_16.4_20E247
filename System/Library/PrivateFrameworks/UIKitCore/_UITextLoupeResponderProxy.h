...
+ (id)_proxyWithResponder:(id)arg1;	// IMP=0x006000000119deeb
- (void).cxx_destruct;	// IMP=0x000000000119e018
...
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x000000000119df55
- (id)nextResponder;	// IMP=0x000000000119df3c
