...
+ (id)placeholderEntryWithEntryBefore:(id)arg1 after:(id)arg2;	// IMP=0x0060000000776e09
+ (id)entryWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x0060000000776ce4
+ (id)entryWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x0060000000776bea
- (void).cxx_destruct;	// IMP=0x0000000000777109
...
- (id)description;	// IMP=0x0000000000776fb4
...
- (id)initWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x0000000000776d50
- (id)initWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x0000000000776c4f
