...
- (void).cxx_destruct;	// IMP=0x00000000007223e2
...
- (void)_searchForFocusRegionsInContext:(id)arg1;	// IMP=0x00000000007220cd
- (id)_preferredFocusRegionCoordinateSpace;	// IMP=0x0000000000721faa
@property(readonly, nonatomic) id <UIFocusItemContainer> focusItemContainer;
@property(readonly, nonatomic) __weak id <UIFocusEnvironment> parentFocusEnvironment;
- (void)updateFocusIfNeeded;	// IMP=0x0000000000721f0b
- (void)setNeedsFocusUpdate;	// IMP=0x0000000000721ece
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000721e48
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x0000000000721dd1
@property(readonly, copy, nonatomic) NSArray *preferredFocusEnvironments;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000721acd
- (id)_itemContainer;	// IMP=0x0000000000721ab7
- (id)_owningEnvironment;	// IMP=0x0000000000721aa1
- (id)initWithEnvironmentContainer:(id)arg1;	// IMP=0x00000000007219b1
- (id)initWithOwningEnvironment:(id)arg1 itemContainer:(id)arg2;	// IMP=0x0000000000721957
