...
- (void).cxx_destruct;	// IMP=0x00000000012caa1d
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000012ca3ef
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000012ca35e
