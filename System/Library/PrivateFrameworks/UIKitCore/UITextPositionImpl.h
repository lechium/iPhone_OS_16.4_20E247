...
+ (id)wrapWebVisiblePosition:(id)arg1;	// IMP=0x0060000000d1732d
- (void).cxx_destruct;	// IMP=0x0000000000d177f3
@property(retain, nonatomic) WebVisiblePosition *webVisiblePosition; // @synthesize webVisiblePosition=_webVisiblePosition;
- (id)description;	// IMP=0x0000000000d17414
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d17383
