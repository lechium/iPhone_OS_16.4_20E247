...
- (id)description;	// IMP=0x0000000000db1aeb
@property(readonly, nonatomic, getter=isSteady) _Bool steady;
- (void)updateFromDisplayLink:(id)arg1;	// IMP=0x0000000000db1a2d
- (void)update:(double)arg1;	// IMP=0x0000000000db19e8
- (id)initWithValue:(double)arg1;	// IMP=0x0000000000db198b
- (id)init;	// IMP=0x0000000000db192b
