...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a88a9d
- (void)renderEffectWithRenderer:(id)arg1 traits:(id)arg2;	// IMP=0x0000000000a88a82
...
- (struct CGColor *)CGColor;	// IMP=0x0000000000a88a4e
