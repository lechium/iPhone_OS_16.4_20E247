...
- (_Bool)_shouldFailInResponseToPresses:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000af4a64
- (void)cancelPendingHoldToAction;	// IMP=0x0000000000af4a21
- (void)scheduleHoldToAction;	// IMP=0x0000000000af49e8
- (void)holdToAction:(id)arg1;	// IMP=0x0000000000af4963
- (void)cancelPendingTooSlowForDoubleTap;	// IMP=0x0000000000af4920
- (void)scheduleTooSlowForDoubleTap;	// IMP=0x0000000000af48f2
- (void)tooSlowForDoubleTap:(id)arg1;	// IMP=0x0000000000af48af
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000af47a1
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000af46ff
- (void)reset;	// IMP=0x0000000000af466d
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000af463e
