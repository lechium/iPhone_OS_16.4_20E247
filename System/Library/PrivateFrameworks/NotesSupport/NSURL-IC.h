...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x0000000000023d6e
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x0010000000023971
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x001000000002315b
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x0010000000022eb4
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x0010000000023d76
@end
