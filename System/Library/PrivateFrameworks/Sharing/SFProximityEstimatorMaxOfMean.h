...
- (int)_estimateRSSIForSFBLEDevice:(id)arg1;	// IMP=0x00000000000fb4cb
- (id)description;	// IMP=0x00000000000fb3dc
- (void)dealloc;	// IMP=0x00000000000fb36d
- (id)initWithProximityInfo:(id)arg1;	// IMP=0x00000000000fb259
