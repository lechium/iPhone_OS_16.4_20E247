...
- (void).cxx_destruct;	// IMP=0x000000000006ac13
...
- (unsigned long long)hash;	// IMP=0x000000000006ab44
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006a989
- (id)description;	// IMP=0x000000000006a85c
- (id)maAssetQueryDescription;	// IMP=0x000000000006a6b3
- (id)initWithDeviceAssetQuery:(id)arg1 installedOnly:(_Bool)arg2 imperfectMatch:(_Bool)arg3 fallback:(_Bool)arg4;	// IMP=0x000000000006a56d
