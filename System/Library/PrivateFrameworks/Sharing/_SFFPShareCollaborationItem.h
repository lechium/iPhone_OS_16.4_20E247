...
- (void).cxx_destruct;	// IMP=0x0000000000059648
...
- (void)loadCopyRepresentationURLWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000591ff
- (id)_defaultLoadingOptionsSummary;	// IMP=0x00000000000591a2
@property(readonly, nonatomic) _Bool hasSeparateSendCopyRepresentation;
@property(readonly, nonatomic) _Bool isCollaborativeURL;
- (void)_loadSendCopyRepresentationIfNeeded;	// IMP=0x00000000000590da
- (void)_loadMetadataIfNeeded;	// IMP=0x0000000000058e8f
@property(readonly, copy, nonatomic) NSString *additionalContentIdentifier;
- (id)initWithFileURL:(id)arg1 itemProvider:(id)arg2 activityItem:(id)arg3 defaultCollaboration:(_Bool)arg4 managedFileURL:(id)arg5;	// IMP=0x0000000000058b0e
