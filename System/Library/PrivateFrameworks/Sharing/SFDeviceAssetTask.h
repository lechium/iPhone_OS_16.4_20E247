...
- (void).cxx_destruct;	// IMP=0x000000000006caaf
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006c59a
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x000000000006c2db
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x000000000006bb4c
- (_Bool)completeIfPossible;	// IMP=0x000000000006b61a
- (void)cancelTimeout;	// IMP=0x000000000006b5d0
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b3d9
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b323
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b290
- (void)createQueryParameters;	// IMP=0x000000000006af68
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x000000000006ac23
