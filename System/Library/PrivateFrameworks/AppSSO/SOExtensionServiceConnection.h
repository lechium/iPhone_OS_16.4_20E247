...
- (void).cxx_destruct;	// IMP=0x00000000000025b4
...
- (void)beginAuthorizationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000022bc
- (_Bool)_connectToService;	// IMP=0x0000000000001db3
- (id)initWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000001ce0
