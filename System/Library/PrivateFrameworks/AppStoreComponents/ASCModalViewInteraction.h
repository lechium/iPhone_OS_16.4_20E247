...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x000000000003f3c3
- (void)invalidate;	// IMP=0x000000000003f113
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003ec35
- (void)dealloc;	// IMP=0x000000000003ebf7
- (id)initWithView:(id)arg1;	// IMP=0x000000000003eb79
