...
- (void).cxx_destruct;	// IMP=0x000000000000d895
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000d708
- (void)disappearIfNeeded;	// IMP=0x000000000000d53e
@property(readonly, nonatomic) _Bool canDisappear;
- (void)appearIfNeeded;	// IMP=0x000000000000ce95
@property(readonly, nonatomic) _Bool canAppear;
- (void)viewDidRetryFailedRequest;	// IMP=0x000000000000c6a7
- (void)viewDidFailRequest:(id)arg1 withError:(id)arg2;	// IMP=0x000000000000c322
- (void)viewDidEndRenderWithPredicate:(id)arg1;	// IMP=0x000000000000c0cb
- (void)viewDidAction;	// IMP=0x000000000000bee3
- (void)viewDidSetHidden;	// IMP=0x000000000000bd86
- (void)viewDidMoveToWindow;	// IMP=0x000000000000ba8c
- (void)hostWillEnterForeground;	// IMP=0x000000000000b9b4
- (void)hostDidEnterBackground;	// IMP=0x000000000000b8dc
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000b1e2
- (id)initWithView:(id)arg1;	// IMP=0x000000000000b13c
- (id)initWithView:(id)arg1 metrics:(id)arg2 notificationCenter:(id)arg3;	// IMP=0x000000000000afc8
