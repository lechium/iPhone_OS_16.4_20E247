...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002237c
- (void).cxx_destruct;	// IMP=0x0000000000022e93
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002289c
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022710
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002257f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000022384
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x000000000002222b
