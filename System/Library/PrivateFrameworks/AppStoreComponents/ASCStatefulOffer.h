...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000051cfd
- (void).cxx_destruct;	// IMP=0x0000000000052e34
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000052594
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000052225
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005221a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005200e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000051d05
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000051b43
