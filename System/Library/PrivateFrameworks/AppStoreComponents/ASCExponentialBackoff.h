...
- (void).cxx_destruct;	// IMP=0x000000000001e94b
...
- (void)reset;	// IMP=0x000000000001e887
- (double)nextSleepTimeInterval;	// IMP=0x000000000001e7a5
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000001e729
