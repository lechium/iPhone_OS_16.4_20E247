...
- (id)description;	// IMP=0x0000000000048a85
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000488f2
- (unsigned long long)hash;	// IMP=0x0000000000048840
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048835
- (id)initWithMetadata:(id)arg1 theme:(id)arg2;	// IMP=0x000000000004877c
