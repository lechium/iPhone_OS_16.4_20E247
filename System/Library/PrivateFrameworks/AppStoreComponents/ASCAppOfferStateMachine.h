...
- (void).cxx_destruct;	// IMP=0x0000000000015348
...
- (void)invalidateTemporaryStateForcingUpdate:(_Bool)arg1;	// IMP=0x0000000000015193
- (void)installTemporaryWaitingState;	// IMP=0x0000000000014f0b
- (id)performActionWithActivity:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000014e4f
- (void)offerStatusTextDidChange:(id)arg1;	// IMP=0x0000000000014d72
- (void)offerStateDidChange:(id)arg1 withMetadata:(id)arg2 flags:(long long)arg3;	// IMP=0x0000000000014a00
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001484e
- (void)removeDelegate:(id)arg1;	// IMP=0x0000000000014738
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000144bf
- (void)dealloc;	// IMP=0x00000000000142bf
- (id)initWithOffer:(id)arg1 stateCenter:(id)arg2;	// IMP=0x00000000000141fe
