...
- (void).cxx_destruct;	// IMP=0x000000000004c3b6
...
- (void)finishAllWithError:(id)arg1;	// IMP=0x000000000004c273
- (void)cancelAll;	// IMP=0x000000000004c229
- (void)enumerateBinaryPromises:(CDUnknownBlockType)arg1 andPromises:(CDUnknownBlockType)arg2;	// IMP=0x000000000004bf04
- (void)addPromise:(id)arg1;	// IMP=0x000000000004bc22
- (_Bool)containsPromise:(id)arg1;	// IMP=0x000000000004ba99
@property(readonly, nonatomic) _Bool hasPromises;
- (void)addBinaryPromise:(id)arg1;	// IMP=0x000000000004b545
- (_Bool)containsBinaryPromise:(id)arg1;	// IMP=0x000000000004b345
@property(readonly, nonatomic) NSMutableArray *promises;
@property(readonly, nonatomic) NSMutableArray *binaryPromises;
- (void)withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000004b1b9
- (id)init;	// IMP=0x000000000004b163
