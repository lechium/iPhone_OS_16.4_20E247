...
+ (id)sharedContext;	// IMP=0x004000000004c3e9
...
- (id)description;	// IMP=0x000000000004c8a7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c677
- (unsigned long long)hash;	// IMP=0x000000000004c597
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x000000000004c4e0
