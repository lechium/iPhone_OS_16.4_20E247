...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001553f
- (void).cxx_destruct;	// IMP=0x00000000000164d8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000015d59
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000015a3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015a31
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000015859
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015547
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x000000000001539a
