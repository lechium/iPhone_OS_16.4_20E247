...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000009c2f
- (void).cxx_destruct;	// IMP=0x000000000000aef7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000a564
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000a1a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a19c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000009f5c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000009c37
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0000000000009a5e
