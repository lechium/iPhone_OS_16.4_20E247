...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000b01ef
- (void).cxx_destruct;	// IMP=0x00000000000b225c
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000b1e3c
- (void)layoutSubviews;	// IMP=0x00000000000b16d3
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000b1118
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b10cb
- (double)minimumHeaderWidth;	// IMP=0x00000000000b0d81
