...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000008a059
- (void).cxx_destruct;	// IMP=0x000000000008a7e1
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000008a518
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000008a3fd
