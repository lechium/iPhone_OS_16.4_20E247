...
- (void).cxx_destruct;	// IMP=0x00000000000b29f5
@property(nonatomic) double lineSpacing; // @synthesize lineSpacing=_lineSpacing;
@property(copy, nonatomic) NSArray *labelViews; // @synthesize labelViews=_labelViews;
- (void)layoutSubviews;	// IMP=0x00000000000b273a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b2536
