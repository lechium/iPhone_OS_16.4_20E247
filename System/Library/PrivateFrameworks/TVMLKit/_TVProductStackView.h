...
+ (id)productStackViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000a34d7
- (void).cxx_destruct;	// IMP=0x00000000000a598d
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000a54b3
- (void)layoutSubviews;	// IMP=0x00000000000a4c05
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000a45cc
- (id)preferredFocusEnvironments;	// IMP=0x00000000000a4523
