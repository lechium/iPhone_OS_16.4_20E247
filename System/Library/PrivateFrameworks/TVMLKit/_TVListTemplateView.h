...
- (void).cxx_destruct;	// IMP=0x00000000001190bc
...
- (void)layoutSubviews;	// IMP=0x000000000011800f
@property(readonly, nonatomic) long long listAlignment;
- (void)adjustScrollForListView:(id)arg1;	// IMP=0x0000000000117e82
- (id)preferredFocusEnvironments;	// IMP=0x0000000000117e09
- (void)setOverlayBlurOffset:(double)arg1;	// IMP=0x0000000000117c99
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000001176fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000117629
