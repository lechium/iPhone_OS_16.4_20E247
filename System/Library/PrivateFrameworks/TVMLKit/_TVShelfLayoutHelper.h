...
- (void).cxx_destruct;	// IMP=0x0000000000062866
...
- (void)_freeBuffers;	// IMP=0x00000000000627b2
- (void)_compute;	// IMP=0x0000000000061a85
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000619e7
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000619ac
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000061971
- (void)dealloc;	// IMP=0x0000000000061933
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x00000000000618bf
