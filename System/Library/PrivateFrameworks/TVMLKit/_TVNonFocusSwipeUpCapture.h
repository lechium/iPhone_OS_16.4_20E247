...
- (void).cxx_destruct;	// IMP=0x00000000001034e3
...
- (void)_onPan:(id)arg1;	// IMP=0x000000000010311e
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000010308d
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000102fc0
