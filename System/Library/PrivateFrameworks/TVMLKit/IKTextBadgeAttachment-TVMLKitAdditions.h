...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x0030000000010dd1
- (void)tv_setImage:(id)arg1;	// IMP=0x0030000000010af0
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x0030000000010984
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x00300000000108d8
- (id)tv_imageProxy;	// IMP=0x00300000000108c7
@end
