...
- (void).cxx_destruct;	// IMP=0x0000000000017bf3
...
- (id)appTraitCollection;	// IMP=0x00000000000171be
- (_Bool)appIsPrivileged;	// IMP=0x0000000000017173
- (_Bool)appIsTrusted;	// IMP=0x0000000000017128
- (id)userDefaultsStorage;	// IMP=0x000000000001710f
- (id)vendorStorage;	// IMP=0x0000000000017107
- (id)vendorIdentifier;	// IMP=0x00000000000170ff
- (_Bool)shouldIgnoreJSValidation;	// IMP=0x00000000000170f7
- (id)localStorage;	// IMP=0x00000000000170e5
- (id)appLaunchParams;	// IMP=0x0000000000016f55
- (id)bagBootURLKey;	// IMP=0x0000000000016f12
- (id)offlineJSURL;	// IMP=0x0000000000016ecf
- (id)appJSCachePath;	// IMP=0x0000000000016e8c
- (id)appLocalJSURL;	// IMP=0x0000000000016e49
- (id)appJSURL;	// IMP=0x0000000000016e06
- (id)appIdentifier;	// IMP=0x0000000000016daf
- (id)activeDocument;	// IMP=0x0000000000016d1c
@property(readonly, nonatomic) _Bool supportsPictureInPicturePlayback;
- (id)initWithLaunchContext:(id)arg1;	// IMP=0x0000000000016c7d
