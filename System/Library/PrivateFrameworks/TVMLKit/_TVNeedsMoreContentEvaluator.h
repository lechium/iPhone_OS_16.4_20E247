...
- (void).cxx_destruct;	// IMP=0x000000000011347e
...
- (void)reset;	// IMP=0x0000000000113422
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000113137
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000112fe4
- (id)init;	// IMP=0x0000000000112fd6
