...
- (void).cxx_destruct;	// IMP=0x0000000000036d0f
@property(nonatomic) __weak UIView<TVAuxiliaryViewSelecting> *selectingView; // @synthesize selectingView=_selectingView;
- (struct UIEdgeInsets)selectionMarginsForSize:(struct CGSize)arg1;	// IMP=0x0000000000036c85
- (void)layoutSubviews;	// IMP=0x0000000000036a0e
