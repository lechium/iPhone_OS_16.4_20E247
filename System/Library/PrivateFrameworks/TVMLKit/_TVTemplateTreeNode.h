...
- (void).cxx_destruct;	// IMP=0x000000000006d332
...
- (void)addDerivedTemplateNode:(id)arg1;	// IMP=0x000000000006d292
@property(readonly, copy, nonatomic) NSArray *derivedTemplateNodes;
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2 abstract:(_Bool)arg3;	// IMP=0x000000000006d1b5
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2;	// IMP=0x000000000006d1a0
