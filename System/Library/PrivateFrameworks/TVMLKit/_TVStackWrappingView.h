...
- (void).cxx_destruct;	// IMP=0x0000000000092458
...
- (id)preferredFocusEnvironments;	// IMP=0x000000000009229a
- (void)configureSupplementaryCellLayoutAttributesWithAutomaticInsets:(struct UIEdgeInsets)arg1 sectionIndex:(long long)arg2;	// IMP=0x00000000000919c6
- (void)layoutSubviews;	// IMP=0x000000000009110f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000090e8c
