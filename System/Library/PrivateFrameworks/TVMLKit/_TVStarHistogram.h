...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003c7fe
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003c516
- (void).cxx_destruct;	// IMP=0x000000000003db98
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000003d13e
- (_Bool)canBecomeFocused;	// IMP=0x000000000003d136
