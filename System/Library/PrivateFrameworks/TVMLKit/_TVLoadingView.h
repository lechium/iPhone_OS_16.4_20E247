...
- (void).cxx_destruct;	// IMP=0x000000000001a1ae
...
- (void)_showSpinner;	// IMP=0x0000000000019f62
- (_Bool)canBecomeFocused;	// IMP=0x0000000000019f5a
- (void)layoutSubviews;	// IMP=0x0000000000019b39
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000199f4
