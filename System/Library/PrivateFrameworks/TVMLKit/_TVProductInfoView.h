...
+ (id)productInfoViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000cfcfe
- (void).cxx_destruct;	// IMP=0x00000000000d20ff
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000d1bf1
- (void)layoutSubviews;	// IMP=0x00000000000d1012
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000d0844
- (id)preferredFocusEnvironments;	// IMP=0x00000000000d0744
- (_Bool)canBecomeFocused;	// IMP=0x00000000000d069b
