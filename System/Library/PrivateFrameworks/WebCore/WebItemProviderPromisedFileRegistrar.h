...
- (id).cxx_construct;	// IMP=0x0000000002751bb0
- (void).cxx_destruct;	// IMP=0x0000000002751b70
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *typeIdentifier;
- (void)registerItemProvider:(id)arg1;	// IMP=0x00000000027519b0
- (id)initWithType:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000002751910
