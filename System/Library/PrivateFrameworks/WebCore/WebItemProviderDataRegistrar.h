...
- (id).cxx_construct;	// IMP=0x00000000027517b0
- (void).cxx_destruct;	// IMP=0x0000000002751770
@property(readonly, copy) NSString *description;
- (void)registerItemProvider:(id)arg1;	// IMP=0x00000000027515b0
...
- (id)initWithData:(id)arg1 type:(id)arg2;	// IMP=0x00000000027514c0
