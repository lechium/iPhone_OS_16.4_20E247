...
- (id).cxx_construct;	// IMP=0x00000000027518f0
- (void).cxx_destruct;	// IMP=0x00000000027518d0
@property(readonly, copy) NSString *description;
- (void)registerItemProvider:(id)arg1;	// IMP=0x0000000002751850
...
- (id)initWithObject:(id)arg1;	// IMP=0x00000000027517c0
