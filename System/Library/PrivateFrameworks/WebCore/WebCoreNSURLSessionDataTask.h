...
- (id).cxx_construct;	// IMP=0x0000000002749390
- (void).cxx_destruct;	// IMP=0x0000000002749270
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x0000000002749170
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x0000000002749070
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x0000000002748f70
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x0000000002748b90
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x0000000002748620
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x00000000027484e0
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x0000000002748490
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x0000000002748030
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x0000000002748020
- (id)_timingData;	// IMP=0x0000000002748010
- (void)dealloc;	// IMP=0x0000000002747e10
- (void)resume;	// IMP=0x0000000002747d70
- (void)suspend;	// IMP=0x0000000002747cd0
- (void)cancel;	// IMP=0x0000000002747c00
...
- (void)_cancel;	// IMP=0x0000000002747960
- (void)_restart;	// IMP=0x0000000002747360
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000002747350
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x0000000002747220
