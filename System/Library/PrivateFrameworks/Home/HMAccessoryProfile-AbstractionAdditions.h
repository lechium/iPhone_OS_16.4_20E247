...
+ (id)_profilesWithNonStandardTileUI;	// IMP=0x001000000006f806
- (id)hf_setTileSize:(id)arg1;	// IMP=0x0010000000064566
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00100000000644ec
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0010000000064490
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0010000000064335
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00100000000aac45
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001c2fa0
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c2ec3
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c2e2d
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c2dda
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c2d87
- (_Bool)hf_isValidObject;	// IMP=0x001000000020045b
