...
- (id)hf_associatedAccessories;	// IMP=0x0020000000064906
- (id)hf_containedProfiles;	// IMP=0x00200000000648f4
- (id)hf_containedCharacteristics;	// IMP=0x0020000000064888
- (id)hf_containedServices;	// IMP=0x0020000000064825
- (Class)hf_itemClass;	// IMP=0x0020000000064814
- (id)hf_accessoryLikeObject;	// IMP=0x00200000000646ee
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001c403e
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3fcb
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3f35
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3ee2
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3e8f
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x0020000000239f47
- (id)hf_preferredMediaUser;	// IMP=0x0020000000239edb
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x0020000000239d11
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x0020000000239ca0
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0020000000239bfc
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0020000000239be5
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000239b89
...
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x0020000000239ab6
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x0020000000239a3a
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x0020000000239994
- (id)hf_siriLanguageOptionsManager;	// IMP=0x002000000023973c
- (id)hf_mediaAccessoryCommonSettingsManager;	// IMP=0x00200000002394b7
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x0020000000238bc7
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x0020000000238259
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x0020000000238251
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x0020000000238249
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x0020000000238241
...
- (_Bool)hf_offersAutomation;	// IMP=0x002000000023731b
...
- (id)hf_rootAccessoryLikeHomeKitObject;	// IMP=0x00200000002978e1
