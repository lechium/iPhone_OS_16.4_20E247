...
- (_Bool)hf_fake8021xNetworkSymptom;	// IMP=0x00200000000884d7
...
- (id)hf_roleForAccessory:(id)arg1;	// IMP=0x00200000001695a7
- (id)hf_accessoryForRole:(id)arg1;	// IMP=0x00200000001693a0
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001c3b90
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3aca
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3a34
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c3994
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001c38f4
- (_Bool)hf_isValidObject;	// IMP=0x002000000020019e
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x0020000000236f03
- (id)hf_preferredMediaUser;	// IMP=0x0020000000236e6d
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x0020000000236cc0
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x0020000000236cb3
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0020000000236be8
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x0020000000236ab5
@property(readonly, nonatomic) _Bool hf_canSpanMultipleRooms;
@property(readonly, nonatomic) HMRoom *hf_safeRoom;
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x002000000023689d
...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00200000002365c0
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0020000000236452
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x00200000002363f6
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000236310
...
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x0020000000236269
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x0020000000236169
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x0020000000236069
- (id)hf_siriLanguageOptionsManager;	// IMP=0x0020000000235df6
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x0020000000235c5f
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x0020000000235bbe
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x0020000000235bb6
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x0020000000235ad8
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x00200000002359e5
