...
- (void).cxx_destruct;	// IMP=0x0000000000212b0f
...
- (id)controlPanelItemForControlItems:(id)arg1;	// IMP=0x00000000002129cb
- (id)initWithFilter:(CDUnknownBlockType)arg1 displayResultsGenerator:(CDUnknownBlockType)arg2;	// IMP=0x0000000000212912
