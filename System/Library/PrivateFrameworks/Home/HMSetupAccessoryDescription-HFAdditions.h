...
- (void)hf_updateWithDiscoveredAccessory:(id)arg1;	// IMP=0x00300000000dbc4b
...
- (_Bool)hf_isLogitechCircleViewDoorbell;	// IMP=0x00300000000db8c8
- (id)hf_home;	// IMP=0x00300000000db76e
@end
