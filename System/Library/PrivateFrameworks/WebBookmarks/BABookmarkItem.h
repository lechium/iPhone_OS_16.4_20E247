...
- (void).cxx_destruct;	// IMP=0x00000000000061d5
...
- (id)description;	// IMP=0x00000000000060c8
- (id)initWithBookmarkCollection:(id)arg1 bookmark:(id)arg2;	// IMP=0x0000000000006020
