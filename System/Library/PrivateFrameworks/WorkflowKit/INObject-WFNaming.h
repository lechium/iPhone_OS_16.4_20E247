...
- (id)wf_initWithIdentifier:(id)arg1 displayString:(id)arg2;	// IMP=0x00200000000d08cc
- (void)wf_transformUsingCodableAttribute:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x002000000022a756
