...
@class NSArray, NSData, NSError, NSSet, NSString, NSURL, VCSleepWorkflow, WFContextualActionContext, WFWorkflowReference, WFWorkflowRunDescriptor, WFWorkflowRunRequest, WFWorkflowRunningContext;
...
- (void)initializeWithDataVaultAccessForURLs:(NSSet *)arg1;
- (void)prewarmRunner;
@end
