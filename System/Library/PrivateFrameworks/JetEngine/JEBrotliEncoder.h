...
- (_Bool)compressStreamWithOperation:(long long)arg1 availableIn:(unsigned long long *)arg2 nextIn:(const char **)arg3 availableOut:(unsigned long long *)arg4 nextOut:(char **)arg5;	// IMP=0x000000000002da34
@property(readonly, nonatomic) _Bool isFinished;
- (void)dealloc;	// IMP=0x000000000002d94c
- (id)init;	// IMP=0x000000000002d8e0
