...
+ (id)treatmentActionWithField:(id)arg1 configuration:(id)arg2 topic:(id)arg3;	// IMP=0x006000000003056e
- (void).cxx_destruct;	// IMP=0x0000000000031a6c
- (id)performAction:(id)arg1 context:(id)arg2;	// IMP=0x000000000003120c
- (void)performActionWithContext:(id)arg1;	// IMP=0x0000000000030bea
- (id)initWithField:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000003075d
