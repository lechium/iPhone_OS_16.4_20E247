...
- (void).cxx_destruct;	// IMP=0x00000000000a6613
@property(copy, nonatomic) CDUnknownBlockType callHostBlock; // @synthesize callHostBlock=_callHostBlock;
- (void)dealloc;	// IMP=0x00000000000a636a
- (id)callAudioUnit:(id)arg1;	// IMP=0x00000000000a6239
- (id)initWithListenerEndpoint:(id)arg1;	// IMP=0x00000000000a6043
