...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000010c348
- (void).cxx_destruct;	// IMP=0x000000000010c320
...
- (void)dealloc;	// IMP=0x000000000010c231
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010bf77
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010be41
