...
- (void).cxx_destruct;	// IMP=0x0000000000051f86
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000051ee0
- (id)initWithKey:(id)arg1 object:(id)arg2;	// IMP=0x0000000000051e47
