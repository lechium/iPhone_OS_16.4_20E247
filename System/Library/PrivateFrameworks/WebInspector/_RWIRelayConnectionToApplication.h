...
- (void).cxx_destruct;	// IMP=0x0000000000003d66
...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000003bf0
- (void)_handleEvent:(id)arg1;	// IMP=0x0000000000003929
- (id)_deserializeMessage:(id)arg1;	// IMP=0x00000000000037f5
- (void)dealloc;	// IMP=0x00000000000037b7
- (void)close;	// IMP=0x0000000000003781
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000003635
