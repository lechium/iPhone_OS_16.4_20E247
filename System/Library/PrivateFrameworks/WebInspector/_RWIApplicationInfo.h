...
+ (id)identifierForPID:(int)arg1;	// IMP=0x0060000000001c50
- (void).cxx_destruct;	// IMP=0x000000000000266b
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x0000000000001fef
- (id)dictionaryRepresentation;	// IMP=0x0000000000001da1
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x0000000000001c75
