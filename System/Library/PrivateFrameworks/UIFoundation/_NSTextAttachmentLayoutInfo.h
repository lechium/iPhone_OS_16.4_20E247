...
- (void)invalidateAttachmentMeasurements;	// IMP=0x000000000010e115
- (void)_invalidateLocations;	// IMP=0x000000000010e0f3
...
- (id)textLayoutFragment;	// IMP=0x000000000010ded8
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x000000000010dd74
- (void)_queryLayout;	// IMP=0x000000000010dac3
- (void)dealloc;	// IMP=0x000000000010da64
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x000000000010d967
