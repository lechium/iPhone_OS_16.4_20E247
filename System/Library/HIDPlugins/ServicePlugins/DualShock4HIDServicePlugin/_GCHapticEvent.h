...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000016f6
...
- (id)description;	// IMP=0x00000000000015bc
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000013cd
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000133a
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001150
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001830
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000016fe
