...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0010000000002336
- (void).cxx_destruct;	// IMP=0x0000000000005fff
@property(nonatomic) _Bool extendedSupportEnabled; // @synthesize extendedSupportEnabled=_extendedSupportEnabled;
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005f0a
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x0000000000005dba
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005da1
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005cbc
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x0000000000005ac1
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000059dd
- (id)defaultHapticMotors;	// IMP=0x00000000000058fc
- (float)defaultHapticDispatchFrequency;	// IMP=0x00000000000058ee
- (void)dispatchHapticEvent;	// IMP=0x00000000000058ad
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x000000000000589b
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005784
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x0000000000005422
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x0000000000005259
- (void)dispatchOutputReport;	// IMP=0x0000000000004e53
- (void)setupRawReportHandling;	// IMP=0x00000000000041b5
- (void)requestPairingInfo;	// IMP=0x0000000000003e9e
- (void)requestSensorCalibrationInfo;	// IMP=0x0000000000002fc0
- (void)requestFirmwareInfo;	// IMP=0x000000000000296a
- (void)determineSupportMode;	// IMP=0x0000000000002664
- (id)initWithService:(unsigned int)arg1;	// IMP=0x00000000000023f0
