...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001622
...
- (id)description;	// IMP=0x00000000000014e8
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000012f9
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001266
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000107c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000175c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000162a
