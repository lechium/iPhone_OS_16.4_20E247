...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001a5a
...
- (id)description;	// IMP=0x0000000000001920
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001731
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000169e
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000014b4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001b94
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001a62
