...
- (void).cxx_destruct;	// IMP=0x0000000000242725
...
- (void)main;	// IMP=0x0000000000242199
- (id)initWithHomeManager:(id)arg1 timeout:(double)arg2;	// IMP=0x0000000000242128
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000242113
