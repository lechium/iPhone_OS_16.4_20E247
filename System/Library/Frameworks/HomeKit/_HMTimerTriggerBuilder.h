...
+ (void)initialize;	// IMP=0x00100000000ad34b
- (void).cxx_destruct;	// IMP=0x00000000000ad2d6
- (void)updateSignificantEventOffset:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ad0ef
- (void)_setSignificantEventOffset:(id)arg1;	// IMP=0x00000000000ad073
@property(copy, nonatomic) NSDateComponents *significantEventOffset;
- (void)updateSignificantEvent:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000acc0e
@property(copy, nonatomic) NSString *significantEvent;
- (void)updateRecurrence:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ac93e
@property(copy, nonatomic) NSDateComponents *recurrence;
- (void)updateTimeZone:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ac681
@property(copy, nonatomic) NSTimeZone *timeZone;
- (void)updateFireDate:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ac359
@property(copy, nonatomic) NSDate *fireDate;
@property(readonly, copy, nonatomic) NSDate *fireDateIfSet;
- (Class)class;	// IMP=0x00000000000ac1fd
- (id)recurrenceCalendar;	// IMP=0x00000000000ad3a5
