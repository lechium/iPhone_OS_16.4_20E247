...
- (void)requestAccessWithQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000025a39
- (unsigned long long)queryAuthorizationStatus;	// IMP=0x0000000000025a11
