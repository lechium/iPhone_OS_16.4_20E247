...
+ (id)effectivePredicate:(id)arg1;	// IMP=0x00600000000e4cb8
+ (id)validatePredicate:(id)arg1 error:(id *)arg2;	// IMP=0x00600000000e4c14
+ (id)fetchRequestFromCNFetchRequest:(id)arg1 managedConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x00600000000e4a09
+ (long long)resolvedSortOrderFromContactSortOrder:(long long)arg1;	// IMP=0x00600000000e49a5
- (void).cxx_destruct;	// IMP=0x00000000000e4972
...
- (id)initWithPredicate:(id)arg1 keysToFetch:(id)arg2 shouldSort:(_Bool)arg3 sortOrder:(unsigned int)arg4 unifiedFetch:(_Bool)arg5 batchSize:(unsigned long long)arg6 managedConfiguration:(id)arg7 options:(unsigned long long)arg8;	// IMP=0x00000000000e47d2
