...
- (void).cxx_destruct;	// IMP=0x00000000000c39a0
@property(readonly, copy, nonatomic) NSString *parentGroupIdentifier; // @synthesize parentGroupIdentifier=_parentGroupIdentifier;
- (struct __CFArray *)cn_copyGroupsInAddressBook:(void *)arg1 error:(struct __CFError **)arg2;	// IMP=0x00000000000c38a6
- (id)initWithParentGroupIdentifier:(id)arg1;	// IMP=0x00000000000c37f1
