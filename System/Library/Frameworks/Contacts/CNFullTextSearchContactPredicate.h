...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002a2fe
- (void).cxx_destruct;	// IMP=0x000000000002a750
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002a518
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002a306
- (id)initWithSearchString:(id)arg1 containerIdentifiers:(id)arg2 groupIdentifiers:(id)arg3;	// IMP=0x000000000002a1f4
- (id)sgContactMatchesWithSortOrder:(long long)arg1 mutableObjects:(_Bool)arg2 service:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000b97a7
