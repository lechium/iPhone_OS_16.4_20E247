...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00600000000cf833
+ (id)os_log;	// IMP=0x00600000000ce952
- (void).cxx_destruct;	// IMP=0x00000000000cfa37
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000cf83b
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000ceb9b
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000ceb93
- (void)resetAllData;	// IMP=0x00000000000ceaeb
