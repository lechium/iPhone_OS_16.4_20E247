...
+ (id)os_log;	// IMP=0x0060000000111d6d
- (void).cxx_destruct;	// IMP=0x0000000000112966
...
- (void)resetPrimaryiCloudContainer;	// IMP=0x00000000001128d3
- (void)resetAccountCache;	// IMP=0x00000000001128bf
- (id)cnAccountForContainer:(id)arg1;	// IMP=0x0000000000112763
- (id)accountForContainer:(id)arg1;	// IMP=0x00000000001124cf
- (id)onWorkQueue_findPrimaryiCloudContainer;	// IMP=0x000000000011227c
- (void)dealloc;	// IMP=0x0000000000112044
- (void)contactStoreDidChange;	// IMP=0x0000000000111fbd
- (void)accountStoreDidChange;	// IMP=0x0000000000111f36
- (id)initWithContactStore:(id)arg1;	// IMP=0x0000000000111dc9
