...
+ (id)descriptorForAllSupportedKeys;	// IMP=0x00100000000b2c3e
+ (id)adapterWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00100000000b2bd2
- (void).cxx_destruct;	// IMP=0x00000000000b4030
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000b3dfa
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b3ac3
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000b3aaf
...
- (id)initWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00000000000b2f71
