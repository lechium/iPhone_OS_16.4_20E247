...
- (id)objectsRepresentedByBatch:(id)arg1;	// IMP=0x0000000000109415
- (id)batchesToRepresentObjects:(id)arg1 suggestedBatchSize:(unsigned long long)arg2;	// IMP=0x00000000001093fd
