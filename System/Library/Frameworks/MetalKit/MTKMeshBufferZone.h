...
- (void).cxx_destruct;	// IMP=0x0000000000013d89
...
- (void)destroyBuffer:(id)arg1;	// IMP=0x0000000000013c3b
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x00000000000138df
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x000000000001379c
