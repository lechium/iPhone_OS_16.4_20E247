...
- (void).cxx_destruct;	// IMP=0x0000000000010a93
...
- (void)addPresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010a4f
@property(nonatomic) struct CGSize size;
@property(nonatomic) unsigned long long pixelFormat;
@property(readonly) id <MTLTexture> texture;
- (void)presentAtTime:(double)arg1;	// IMP=0x000000000001088f
- (void)presentAfterMinimumDuration:(double)arg1;	// IMP=0x000000000001086b
- (void)present;	// IMP=0x0000000000010849
- (id)initWithDevice:(id)arg1 pixelFormat:(unsigned long long)arg2 size:(struct CGSize)arg3 drawableID:(unsigned long long)arg4;	// IMP=0x00000000000107a6
