...
- (void).cxx_destruct;	// IMP=0x000000000003cf3f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003ce48
- (unsigned long long)hash;	// IMP=0x000000000003cdb7
- (id)description;	// IMP=0x000000000003cd24
- (id)initWithRequest:(id)arg1 observationsCacheKey:(id)arg2;	// IMP=0x000000000003cc7c
