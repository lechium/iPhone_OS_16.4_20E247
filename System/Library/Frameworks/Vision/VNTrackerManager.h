...
- (void).cxx_destruct;	// IMP=0x00000000000f8f12
- (void)_releaseTracker_NO_LOCK_DO_NOT_EXECUTE_DIRECTLY:(id)arg1;	// IMP=0x00000000000f8da1
- (id)_createTracker:(id)arg1 type:(id)arg2 options:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000f8bfb
- (id)_getTracker:(id)arg1;	// IMP=0x00000000000f8b00
- (long long)_maximumTrackersOfType:(id)arg1;	// IMP=0x00000000000f8aa4
- (id)init;	// IMP=0x00000000000f861c
