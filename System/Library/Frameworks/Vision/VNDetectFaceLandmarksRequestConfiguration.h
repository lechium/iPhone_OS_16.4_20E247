...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x00600000001175bb
- (void).cxx_destruct;	// IMP=0x00000000001175a8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001173e3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000117329
