...
- (void).cxx_destruct;	// IMP=0x00000000001cdf08
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001cde33
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001cddc6
