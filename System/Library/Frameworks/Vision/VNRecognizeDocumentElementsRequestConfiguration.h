...
- (void).cxx_destruct;	// IMP=0x000000000020a62c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020a4f0
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000020a403
