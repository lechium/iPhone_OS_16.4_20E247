...
- (void).cxx_destruct;	// IMP=0x000000000028f025
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x000000000028eeb7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000028edd8
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000028ed11
