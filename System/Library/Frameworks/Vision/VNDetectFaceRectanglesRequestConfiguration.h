...
- (void).cxx_destruct;	// IMP=0x00000000001deb07
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001de85f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001de75f
