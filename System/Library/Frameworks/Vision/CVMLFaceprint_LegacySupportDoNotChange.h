...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a9a3b
- (void).cxx_destruct;	// IMP=0x00000000001a9a08
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a9959
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a9700
