...
- (void).cxx_destruct;	// IMP=0x00000000001460b5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000145f7e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000145f2c
