...
- (void).cxx_destruct;	// IMP=0x000000000012ea4a
- (id)processVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 warningRecorder:(id)arg4 requestUUID:(id)arg5 error:(id *)arg6;	// IMP=0x000000000012ce15
- (id)_VNPointsFromCGPoints:(const void *)arg1;	// IMP=0x000000000012ccb6
- (struct __CVBuffer *)_createCroppedAndScaledBufferFromVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 error:(id *)arg4;	// IMP=0x000000000012ca71
- (void)dealloc;	// IMP=0x000000000012c9ff
- (id)initWithFrameAnalysisSpacing:(CDStruct_1b6d18a9)arg1 trajectoryLength:(long long)arg2;	// IMP=0x000000000012c083
