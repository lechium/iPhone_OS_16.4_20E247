...
- (void).cxx_destruct;	// IMP=0x000000000022370c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022355f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000022346b
