...
- (void).cxx_destruct;	// IMP=0x000000000004f0b2
...
- (id)description;	// IMP=0x000000000004ee9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004eddd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000004ed8e
