...
- (void).cxx_destruct;	// IMP=0x0000000000036403
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000362ca
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000003624a
