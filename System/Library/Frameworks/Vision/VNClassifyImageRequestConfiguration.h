...
- (void).cxx_destruct;	// IMP=0x00000000000c980c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c96c1
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000c965e
