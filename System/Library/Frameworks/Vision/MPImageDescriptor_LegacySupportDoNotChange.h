...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001aae32
- (void).cxx_destruct;	// IMP=0x00000000001aadff
...
- (void)dealloc;	// IMP=0x00000000001aac9e
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001aa9bc
- (unsigned long long)serializedLength;	// IMP=0x00000000001aa99c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001aa97a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001aa4b9
