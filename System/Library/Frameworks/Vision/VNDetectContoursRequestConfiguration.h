...
- (void).cxx_destruct;	// IMP=0x000000000020937b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002091b1
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002090eb
