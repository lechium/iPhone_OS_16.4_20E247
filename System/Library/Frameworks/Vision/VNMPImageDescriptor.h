...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001dd2ad
+ (unsigned long long)currentVersion;	// IMP=0x00100000001dd2a2
- (void).cxx_destruct;	// IMP=0x00000000001dd27a
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x00000000001dcf7f
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x00000000001dcf15
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x00000000001dce92
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dce8a
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dcbd2
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dcbca
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001dca00
- (unsigned long long)hash;	// IMP=0x00000000001dc8ec
- (void)dealloc;	// IMP=0x00000000001dc8ac
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000001dc564
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001dc2f2
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dc03b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001dbab3
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x00000000001dba84
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001db853
