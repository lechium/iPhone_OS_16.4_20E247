...
- (void)releaseAllocations;	// IMP=0x000000000020f69f
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x000000000020f5d3
- (void)dealloc;	// IMP=0x000000000020f560
- (void)resetBoxBounds;	// IMP=0x000000000020f54f
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x000000000020f51e
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020f509
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020f4f6
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020f4e6
