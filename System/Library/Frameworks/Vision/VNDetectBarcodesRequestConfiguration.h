...
- (void).cxx_destruct;	// IMP=0x00000000000f7be5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f7a9f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000f7a0d
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x00000000000f7922
