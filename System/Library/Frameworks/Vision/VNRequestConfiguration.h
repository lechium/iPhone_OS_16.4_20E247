...
- (void).cxx_destruct;	// IMP=0x0000000000098b17
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009895c
- (id)description;	// IMP=0x000000000009868a
@property(readonly, copy, nonatomic) VNProcessingDevice *resolvedProcessingDevice;
- (id)_allPropertyNames;	// IMP=0x00000000000984c9
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000098416
