...
- (id).cxx_construct;	// IMP=0x000000000003561c
- (void).cxx_destruct;	// IMP=0x00000000000355ed
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x00000000000350d5
- (_Bool)ICShouldBeCanceled;	// IMP=0x00000000000350cd
- (void)dealloc;	// IMP=0x0000000000035051
- (id)init;	// IMP=0x0000000000034f14
