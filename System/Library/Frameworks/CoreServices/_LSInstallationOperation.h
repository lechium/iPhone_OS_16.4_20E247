...
- (void).cxx_destruct;	// IMP=0x000000000016176f
...
- (id)redactedDescription;	// IMP=0x00000000001616fc
- (id)description;	// IMP=0x00000000001616ae
- (id)initWithBundleID:(id)arg1 installType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000001615fa
