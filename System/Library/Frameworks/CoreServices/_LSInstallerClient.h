...
+ (id)revertInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000016099b
+ (id)installerWithBundleID:(id)arg1 bundleURL:(id)arg2 options:(id)arg3 callbackBlock:(CDUnknownBlockType)arg4;	// IMP=0x00100000001608b9
+ (id)unInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000001607f9
- (void).cxx_destruct;	// IMP=0x0000000000161548
...
- (void)_invalidate;	// IMP=0x0000000000160c75
- (void)_waitForAllCallbackMessagesToExecute;	// IMP=0x0000000000160c1f
- (void)_beginOperation;	// IMP=0x0000000000160bd0
@property(readonly) _Bool allCallbacksDeleviered; // @synthesize allCallbacksDeleviered=_allCallbacksDeleviered;
- (void)callbackDeliveryComplete;	// IMP=0x0000000000160b3c
- (void)updateCallbackWithData:(id)arg1;	// IMP=0x0000000000160a5b
- (id)initWithMICall:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000016064e
