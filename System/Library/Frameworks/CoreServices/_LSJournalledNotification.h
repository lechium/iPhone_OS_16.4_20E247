...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016eee7
- (void).cxx_destruct;	// IMP=0x000000000016f1ba
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016f03e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016ef9d
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x000000000016eeef
