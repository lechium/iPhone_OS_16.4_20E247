...
@interface LSBundleRecordBuilder
{
    ...
    NSString *_identityUsageDescription;	// 760 = 0x2f8
    NSDictionary *_localizedIdentityUsageDescription;	// 768 = 0x300
    NSDictionary *_localizedStrings;	// 776 = 0x308
    NSDictionary *_unlocalizedNamesWithContext;	// 784 = 0x310
    NSArray *_managedPersonas;	// 792 = 0x318
...
- (void).cxx_destruct;	// IMP=0x0000000000082430
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008138c
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x00000000000812b5
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007e71e
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x000000000007e22c
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x000000000007dfd9
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000007cea5
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x000000000007afbf
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x000000000007ad47
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x000000000007aa50
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x000000000007a8e5
- (void)parseIconFilenamesFromDict:(id)arg1;	// IMP=0x000000000007a80b
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x000000000007a166
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x000000000007a0f9
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x0000000000079fc6
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x0000000000079d39
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x00000000000799b2
- (id)_LSKeyTypeMap;	// IMP=0x00000000000797bc
- (id)_LSPlistRaritiesMap;	// IMP=0x00000000000795ac
- (id)_LSBundleFlagMap;	// IMP=0x000000000007906a
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x0000000000078e19
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x0000000000078a24
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x0000000000078a14
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x0000000000078a04
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x00000000000789f4
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x00000000000789e3
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x00000000000788d0
