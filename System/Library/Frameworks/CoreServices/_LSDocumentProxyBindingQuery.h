...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c82fe
- (void).cxx_destruct;	// IMP=0x00000000000c85cd
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c8424
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c8306
- (unsigned long long)hash;	// IMP=0x00000000000c81f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c800b
- (_Bool)_requiresDatabaseMappingEntitlement;	// IMP=0x00000000000c8003
- (void)_enumerateWithXPCConnection:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c7833
- (id)initWithDocumentProxy:(id)arg1 style:(unsigned char)arg2 handlerRank:(id)arg3;	// IMP=0x00000000000c7746
