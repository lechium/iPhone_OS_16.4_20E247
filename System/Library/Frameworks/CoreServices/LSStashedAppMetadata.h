...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000029023
- (void).cxx_destruct;	// IMP=0x00000000000296ff
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x0000000000029290
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000291eb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002902b
