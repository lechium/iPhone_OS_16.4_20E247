...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000045832
- (unsigned long long)hash;	// IMP=0x0000000000045807
- (id)initWithBundleID:(id)arg1 isPlaceholder:(_Bool)arg2;	// IMP=0x0000000000045791
