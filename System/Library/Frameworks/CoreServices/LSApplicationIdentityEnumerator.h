...
- (void).cxx_destruct;	// IMP=0x0000000000019995
- (id)nextObject;	// IMP=0x00000000000197e2
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x00000000000194b1
