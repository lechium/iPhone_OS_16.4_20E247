...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000004edf6
+ (id)plugInClasses;	// IMP=0x006000000004ed8a
- (void).cxx_destruct;	// IMP=0x000000000004f0a0
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x000000000004eff7
