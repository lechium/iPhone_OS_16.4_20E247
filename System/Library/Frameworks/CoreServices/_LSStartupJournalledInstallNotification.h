...
- (void).cxx_destruct;	// IMP=0x0000000000164968
...
- (void)dispatchToObserver:(id)arg1 forInstallProgressService:(id)arg2;	// IMP=0x00000000001647db
- (id)initWithNotification:(int)arg1 appProxies:(id)arg2 plugins:(_Bool)arg3;	// IMP=0x0000000000164752
