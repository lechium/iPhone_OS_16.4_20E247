...
- (id).cxx_construct;	// IMP=0x00000000000dbb57
- (void).cxx_destruct;	// IMP=0x00000000000dbb16
@property(retain) LSApplicationRecord *parentApplicationRecord; // @synthesize parentApplicationRecord=_parentApplicationRecord;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dba7b
- (_Bool)_getObject:(id *)arg1 atIndex:(unsigned long long)arg2 context:(struct LSContext *)arg3;	// IMP=0x00000000000db9d8
- (_Bool)_prepareWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x00000000000db7b8
