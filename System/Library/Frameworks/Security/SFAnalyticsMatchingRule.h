...
- (unsigned int)doAction:(id)arg1 logger:(id)arg2;	// IMP=0x0000000000040eaa
- (_Bool)shouldRatelimit:(id)arg1;	// IMP=0x0000000000040d03
- (_Bool)matchAttributes:(id)arg1 logger:(id)arg2;	// IMP=0x0000000000040a50
- (id)lastMatchTimeKey;	// IMP=0x00000000000409c3
- (_Bool)isSubsetMatch:(id)arg1 target:(id)arg2;	// IMP=0x0000000000040764
- (_Bool)valueMatch:(id)arg1 target:(id)arg2;	// IMP=0x00000000000403b2
- (id)initWithSFARule:(id)arg1 logger:(id)arg2;	// IMP=0x0000000000040278
