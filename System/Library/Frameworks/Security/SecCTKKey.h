...
+ (id)fromKeyRef:(struct __SecKey *)arg1;	// IMP=0x00100000000a030d
- (void).cxx_destruct;	// IMP=0x00000000000a02da
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009ffa1
- (id)performOperation:(long long)arg1 data:(id)arg2 algorithms:(id)arg3 parameters:(id)arg4 error:(id *)arg5;	// IMP=0x000000000009fded
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009fdbf
- (id)initFromKey:(id)arg1;	// IMP=0x000000000009fcf4
- (id)initWithAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x000000000009f429
