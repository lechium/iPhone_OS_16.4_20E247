...
+ (id)typeForValue:(id)arg1;	// IMP=0x006000000003d6ac
+ (id)typeForEncoding:(const char *)arg1;	// IMP=0x006000000003d141
...
- (void)getBytes:(void *)arg1 forObject:(id)arg2;	// IMP=0x000000000003d048
- (id)objectWithBytes:(const void *)arg1;	// IMP=0x000000000003ce61
...
- (id)initWithCode:(long long)arg1 encoding:(id)arg2 name:(id)arg3 className:(id)arg4 size:(unsigned long long)arg5 flags:(unsigned long long)arg6;	// IMP=0x000000000003cd5b
