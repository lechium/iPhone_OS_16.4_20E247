...
- (void).cxx_destruct;	// IMP=0x000000000001303a
...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x0000000000012e87
- (unsigned int)hostHash;	// IMP=0x0000000000012e5c
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0000000000012cb0
