...
- (void).cxx_destruct;	// IMP=0x0000000000100e44
...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x0000000000100709
- (id)executeRequest;	// IMP=0x0000000000100313
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x000000000010029c
- (id)processReply:(id)arg1;	// IMP=0x00000000000ff2a8
- (id)acmeRequest;	// IMP=0x00000000000fec33
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x00000000000febf5
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x00000000000fe59a
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x00000000000fe532
- (id)attestationChainPEMRepresentation;	// IMP=0x00000000000fe46a
- (id)createCertificate;	// IMP=0x00000000000fe347
- (id)createAttestation;	// IMP=0x00000000000fdfd1
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x00000000000fdc19
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x00000000000fdbaf
- (_Bool)deviceAttestationSupported;	// IMP=0x00000000000fdba7
- (id)createCSR;	// IMP=0x00000000000fdab0
- (id)createKeyPair;	// IMP=0x00000000000fd9d5
- (id)sanitizeParameters;	// IMP=0x00000000000fd8a4
- (id)sanitizeSubject;	// IMP=0x00000000000fd7ad
- (id)serialNumber;	// IMP=0x00000000000fd6b6
- (void)dealloc;	// IMP=0x00000000000fd615
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x00000000000fd549
