...
- (void).cxx_destruct;	// IMP=0x000000000007e820
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007e6c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000007e4b0
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000007e280
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000007de50
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000007db10
- (void)tintColorDidChange;	// IMP=0x000000000007ce00
- (float)valueForYWithLocation:(double)arg1;	// IMP=0x000000000007c340
- (float)valueForXWithLocation:(double)arg1;	// IMP=0x000000000007c2b0
- (struct CGRect)graphFrame;	// IMP=0x000000000007be90
- (void)updateGraph;	// IMP=0x000000000007baa0
- (void)updateCompressionTriangle;	// IMP=0x000000000007a870
- (void)updateCompressionExpansionPaths;	// IMP=0x0000000000079f80
