...
- (void)dealloc;	// IMP=0x0000000000014064
- (void)stopIndicator;	// IMP=0x0000000000013fef
- (void)startIndicator;	// IMP=0x0000000000013f7d
- (void)updateConstraints;	// IMP=0x0000000000013d42
- (void)createInitialConstraints;	// IMP=0x0000000000013b13
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000013765
