...
- (void).cxx_destruct;	// IMP=0x00000000000a1082
@property(readonly, nonatomic) _Bool shouldUpdate; // @synthesize shouldUpdate=_shouldUpdate;
- (id)importAllIntoCalendar:(id)arg1;	// IMP=0x00000000000a0c94
- (id)importEvent:(id)arg1 intoCalendar:(id)arg2;	// IMP=0x00000000000a0b40
...
- (id)initWithICSData:(id)arg1 eventStore:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000a0503
