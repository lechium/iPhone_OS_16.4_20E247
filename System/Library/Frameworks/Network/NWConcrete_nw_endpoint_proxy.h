...
@interface NWConcrete_nw_endpoint_proxy : NSObject
{
    ...
    unsigned int privacy_proxy_detected_unreachable_host:1;	// 88 = 0x58
    ...
    unsigned int overrode_to_https:1;	// 89 = 0x59
    ...
    unsigned int is_https_scheme:1;	// 90 = 0x5a
}

- (void).cxx_destruct;	// IMP=0x00000000002b5cd0
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b55f0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000002b4710
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000002b3e30
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000002b2ea0
- (void)dealloc;	// IMP=0x00000000002b2e70
- (id)init;	// IMP=0x00000000002b2bf0
