...
- (id).cxx_construct;	// IMP=0x0000000000581910
- (void).cxx_destruct;	// IMP=0x00000000005818c0
- (id)redactedDescription;	// IMP=0x00000000005815d0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000581460
