...
- (void).cxx_destruct;	// IMP=0x00000000004abb80
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x00000000004abb30
- (id)description;	// IMP=0x00000000004abb10
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x00000000004ab720
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x00000000004aad70
