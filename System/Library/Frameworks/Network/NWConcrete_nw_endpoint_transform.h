...
- (void).cxx_destruct;	// IMP=0x00000000006e4000
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000006e3920
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000006e3410
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000006e2e50
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000006e25d0
- (void)dealloc;	// IMP=0x00000000006e25a0
- (id)init;	// IMP=0x00000000006e2320
