...
- (void).cxx_destruct;	// IMP=0x0000000000046020
...
- (id)snapshot;	// IMP=0x0000000000045c10
- (void)reset;	// IMP=0x0000000000045bb0
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x00000000000457c0
- (id)description;	// IMP=0x0000000000045720
- (void)dealloc;	// IMP=0x0000000000045690
- (id)initWithName:(id)arg1;	// IMP=0x00000000000454c0
