...
- (id)description;	// IMP=0x00000000006cc430
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006cc420
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006cc3c0
- (void)dealloc;	// IMP=0x00000000006cc380
- (id)init;	// IMP=0x00000000006cc100
