...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000020528c
- (void).cxx_destruct;	// IMP=0x00000000002055c0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000020541c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000205294
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002051cd
