...
- (void).cxx_destruct;	// IMP=0x00000000001dc607
...
- (_Bool)matchesElement:(id)arg1;	// IMP=0x00000000001dc2f4
- (id)initWithElementName:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001dc23b
- (id)initWithTagSpecification:(id)arg1;	// IMP=0x00000000001dbefc
