...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000b5eda
- (void).cxx_destruct;	// IMP=0x00000000000b60ee
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b5fca
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b5ee2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b5e4c
