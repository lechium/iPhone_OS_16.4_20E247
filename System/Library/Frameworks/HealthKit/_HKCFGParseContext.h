...
- (void).cxx_destruct;	// IMP=0x000000000001a61e
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x000000000001a040
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019c3d
- (void)decrementRecursiveDepth;	// IMP=0x000000000001a04a
- (void)incrementRecursiveDepth;	// IMP=0x0000000000019c47
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x00000000000191c8
