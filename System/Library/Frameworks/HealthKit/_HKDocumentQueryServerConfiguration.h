...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000239839
- (void).cxx_destruct;	// IMP=0x0000000000239a94
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000239970
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000239841
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002397aa
