...
- (void).cxx_destruct;	// IMP=0x000000000013e9cb
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000013e863
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000013e7f8
