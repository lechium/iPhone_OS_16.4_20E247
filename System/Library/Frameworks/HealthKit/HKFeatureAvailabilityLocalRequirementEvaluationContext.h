...
- (void).cxx_destruct;	// IMP=0x00000000001f257d
...
- (id)featureStatusForFeatureWithIdentifier:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001f234c
- (id)isWatchAppInstalledWithBundleIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001f2218
- (id)onboardingRecordForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001f20e4
- (id)onboardingEligibilityForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001f1fb0
