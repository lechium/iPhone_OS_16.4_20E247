...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000132686
- (void).cxx_destruct;	// IMP=0x0000000000132b09
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001328b6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013268e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001325c6
