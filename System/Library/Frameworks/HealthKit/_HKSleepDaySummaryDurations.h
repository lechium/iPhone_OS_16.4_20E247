...
+ (id)durationsFromSleepPeriods:(id)arg1 dateInterval:(id)arg2;	// IMP=0x00600000001df8a2
...
- (id)initWithInBedDuration:(double)arg1 sleepDuration:(double)arg2 unspecifiedSleepDuration:(double)arg3 coreSleepDuration:(double)arg4 deepSleepDuration:(double)arg5 remSleepDuration:(double)arg6 awakeDuration:(double)arg7;	// IMP=0x00000000001df805
