...
+ (id)ruleIdentifier;	// IMP=0x001000000005c24f
- (void).cxx_destruct;	// IMP=0x000000000005c3eb
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000005c2b5
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000005c25c
