...
+ (id)ruleIdentifier;	// IMP=0x00100000001335d5
- (void).cxx_destruct;	// IMP=0x000000000013372a
@property(retain, nonatomic) NSString *modelNumberPrefix; // @synthesize modelNumberPrefix=_modelNumberPrefix;
- (_Bool)evaluate;	// IMP=0x000000000013363b
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000001335e2
