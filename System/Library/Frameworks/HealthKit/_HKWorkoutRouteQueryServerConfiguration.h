...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000bb756
- (void).cxx_destruct;	// IMP=0x00000000000bb9af
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bb886
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bb75e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bb6c8
