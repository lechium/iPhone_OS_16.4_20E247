...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000d95bb
- (void).cxx_destruct;	// IMP=0x00000000000d9a85
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d9854
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d95c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d9463
