...
+ (id)nodeWithChildren:(id)arg1 rule:(id)arg2 rangeOfString:(struct _NSRange)arg3;	// IMP=0x006000000001a4db
- (void).cxx_destruct;	// IMP=0x000000000001a656
@property(readonly, nonatomic) _HKCFGReplacementRule *rule; // @synthesize rule=_rule;
- (id)evaluate;	// IMP=0x000000000001a6ab
