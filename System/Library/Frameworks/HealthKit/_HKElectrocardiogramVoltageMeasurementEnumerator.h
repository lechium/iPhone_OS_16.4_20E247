...
- (id).cxx_construct;	// IMP=0x000000000024d964
- (void).cxx_destruct;	// IMP=0x000000000024d933
- (id)nextObject;	// IMP=0x000000000024d814
- (id)initWithElectrocardiogram:(id)arg1 leadIMicroVoltsBegin:(__wrap_iter_9551a0eb)arg2 end:(__wrap_iter_9551a0eb)arg3;	// IMP=0x000000000024d68d
