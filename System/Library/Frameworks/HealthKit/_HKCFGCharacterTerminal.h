...
- (void).cxx_destruct;	// IMP=0x00000000000a454a
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000a4519
- (id)_label;	// IMP=0x00000000000a450c
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x000000000001bdcd
