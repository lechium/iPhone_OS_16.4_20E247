...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x00600000000a3427
- (void).cxx_destruct;	// IMP=0x00000000000a3a61
...
- (id)description;	// IMP=0x00000000000a3a44
