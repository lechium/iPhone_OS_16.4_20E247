...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000006c21b
- (void).cxx_destruct;	// IMP=0x000000000006c51d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006c370
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006c223
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006c15b
