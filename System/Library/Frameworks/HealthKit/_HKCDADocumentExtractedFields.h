...
- (void).cxx_destruct;	// IMP=0x00000000000ae6fd
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000ae521
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000ae31f
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000ae27f
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000adfbf
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000adf57
