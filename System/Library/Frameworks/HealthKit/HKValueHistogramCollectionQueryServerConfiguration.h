...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001fa9f9
- (void).cxx_destruct;	// IMP=0x00000000001fac75
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001fab55
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001faa01
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fa985
