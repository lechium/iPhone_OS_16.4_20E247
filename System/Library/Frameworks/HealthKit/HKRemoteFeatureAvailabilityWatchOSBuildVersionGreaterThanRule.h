...
+ (id)ruleIdentifier;	// IMP=0x00100000001181dc
- (void).cxx_destruct;	// IMP=0x0000000000118381
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x0000000000118242
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000001181e9
