...
+ (Class)ruleClassForRawValue:(id)arg1;	// IMP=0x0060000000100048
- (void).cxx_destruct;	// IMP=0x0000000000100888
@property(nonatomic) __weak id <HKRemoteFeatureAvailabilityDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (_Bool)evaluate;	// IMP=0x0000000000254722
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000002546fe
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000000010078e
