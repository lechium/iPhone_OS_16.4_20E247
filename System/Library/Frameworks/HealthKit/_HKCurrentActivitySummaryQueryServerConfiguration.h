...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000005b6c
- (void).cxx_destruct;	// IMP=0x0000000000018658
@property(copy, nonatomic) NSDictionary *collectionIntervals; // @synthesize collectionIntervals=_collectionIntervals;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013e467
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003214
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013e402
