...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001dab7b
- (void).cxx_destruct;	// IMP=0x00000000001daf04
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dad22
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001dab83
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001daaa5
