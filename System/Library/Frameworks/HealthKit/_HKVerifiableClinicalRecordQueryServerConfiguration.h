...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000014f1ac
- (void).cxx_destruct;	// IMP=0x000000000014f412
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014f32f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014f1b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014f136
