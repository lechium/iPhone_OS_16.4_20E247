...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018727
- (void).cxx_destruct;	// IMP=0x0000000000011f6b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000912db
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002764
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009121b
