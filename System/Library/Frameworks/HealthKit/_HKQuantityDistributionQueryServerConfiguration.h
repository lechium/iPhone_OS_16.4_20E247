...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000017a909
- (void).cxx_destruct;	// IMP=0x000000000017ad7e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000017ab22
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017a911
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017a803
