...
+ (void)initialize;	// IMP=0x006000000028d782
- (id)description;	// IMP=0x0000000000290e7c
- (id)createSetOfManagedObjectIDsForGlobalIDsInRelationship:(id)arg1 withValue:(id)arg2 withGlobalIDToLocalIDURIMap:(id)arg3 andTransactionLog:(id)arg4;	// IMP=0x0000000000290aa7
- (void)dealloc;	// IMP=0x000000000028d842
- (id)init;	// IMP=0x000000000028d7d7
