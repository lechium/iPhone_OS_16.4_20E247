...
- (void)ubiquityIdentityChanged:(id)arg1;	// IMP=0x0000000000341754
- (void)_applicationResumed:(id)arg1;	// IMP=0x000000000034167f
- (void)containerDeleteDetected:(id)arg1;	// IMP=0x000000000034155e
- (id)description;	// IMP=0x0000000000340e32
- (void)dealloc;	// IMP=0x0000000000340daf
- (id)initWithProcessingQueue:(id)arg1 localPeerID:(id)arg2 storeName:(id)arg3 andUbiquityRootLocation:(id)arg4;	// IMP=0x0000000000340d11
- (id)init;	// IMP=0x0000000000340cc2
