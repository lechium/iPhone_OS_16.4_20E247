...
+ (id)entityPath;	// IMP=0x00400000001693a0
+ (id)fetchZoneIDsAssignedToObjectsWithIDs:(id)arg1 fromStore:(id)arg2 inContext:(id)arg3 error:(id *)arg4;	// IMP=0x0040000000168d8b
