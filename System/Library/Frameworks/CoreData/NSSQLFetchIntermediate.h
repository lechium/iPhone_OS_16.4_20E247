...
- (id)fetchIntermediateForKeypathExpression:(id)arg1;	// IMP=0x000000000019904d
- (id)generateSQLStringInContext:(id)arg1;	// IMP=0x0000000000198a17
- (id)selectIntermediate;	// IMP=0x0000000000198114
- (_Bool)isFunctionScoped;	// IMP=0x00000000001980a4
- (id)fetchIntermediate;	// IMP=0x000000000019809b
- (void)dealloc;	// IMP=0x0000000000197fd6
- (id)initWithScope:(id)arg1;	// IMP=0x0000000000197f6c
