...
- (void)dealloc;	// IMP=0x00000000002d59d8
- (id)initWithStack:(id)arg1 andStoreMetadata:(id)arg2;	// IMP=0x00000000002d598b
- (id)initWithStoreName:(id)arg1 andUbiquityRootLocation:(id)arg2 withLocalPeerID:(id)arg3;	// IMP=0x00000000002d58fa
- (id)init;	// IMP=0x00000000002d5891
