...
- (long long)context:(id)arg1 shouldHandleInaccessibleFault:(id)arg2 forObjectID:(id)arg3 andTrigger:(id)arg4;	// IMP=0x000000000025cc16
@property(readonly, copy) NSString *description;
- (void)respondToStoreTransactionStateChangeNotification:(id)arg1;	// IMP=0x000000000025c7aa
- (void)main;	// IMP=0x0000000000259553
- (id)retainedDelegate;	// IMP=0x00000000002569ec
@property NSObject<_PFUbiquityRecordImportOperationDelegate> *delegate;
- (void)cancel;	// IMP=0x0000000000256855
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256843
- (id)copy;	// IMP=0x00000000002567ff
- (void)dealloc;	// IMP=0x00000000002566e0
- (id)init;	// IMP=0x0000000000256544
