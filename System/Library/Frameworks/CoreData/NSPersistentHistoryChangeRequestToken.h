...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c68f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c8ae
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c697
- (void)dealloc;	// IMP=0x000000000000c62b
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c500
