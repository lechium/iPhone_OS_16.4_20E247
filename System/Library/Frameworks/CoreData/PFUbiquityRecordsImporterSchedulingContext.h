...
- (id)description;	// IMP=0x000000000034090f
- (void)dealloc;	// IMP=0x0000000000340895
- (id)initWithPendingLogLocations:(id)arg1;	// IMP=0x000000000034085a
- (id)init;	// IMP=0x00000000003407ce
