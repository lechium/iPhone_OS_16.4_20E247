...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000ab77
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000af3c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ab7f
- (void)dealloc;	// IMP=0x000000000000ab13
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000aa65
