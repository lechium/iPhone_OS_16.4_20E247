...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004c272
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004c0e6
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x004000000004a239
+ (id)entityPath;	// IMP=0x0040000000046ff7
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004ba65
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000004b8a5
- (id)createRecordFromSystemFields;	// IMP=0x00000000000471d2
