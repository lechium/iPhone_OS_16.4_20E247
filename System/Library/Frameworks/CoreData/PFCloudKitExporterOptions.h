...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002721ae
- (id)copy;	// IMP=0x0000000000272165
- (void)dealloc;	// IMP=0x000000000027210c
- (id)initWithDatabase:(id)arg1 options:(id)arg2;	// IMP=0x0000000000272098
