...
- (void)dealloc;	// IMP=0x00000000000edec9
- (_Bool)_isDeallocating;	// IMP=0x00000000000edea0
- (_Bool)_tryRetain;	// IMP=0x00000000000ede98
- (unsigned long long)retainCount;	// IMP=0x00000000000ede8b
- (oneway void)release;	// IMP=0x00000000000ede5d
- (id)retain;	// IMP=0x00000000000ede50
