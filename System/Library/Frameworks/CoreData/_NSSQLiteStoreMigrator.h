...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x00600000002271ae
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x0060000000227184
...
- (void)dealloc;	// IMP=0x0000000000227514
