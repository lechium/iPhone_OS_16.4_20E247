...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000227172
- (id)copy;	// IMP=0x000000000022712e
- (void)dealloc;	// IMP=0x00000000002270c5
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x0000000000227021
