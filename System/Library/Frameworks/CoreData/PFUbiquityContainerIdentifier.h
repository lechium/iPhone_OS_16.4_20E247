...
- (void)accommodatePresentedItemDeletionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000331e13
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000003315dc
- (id)initWithLocalPeerID:(id)arg1 storeName:(id)arg2 andUbiquityRootLocation:(id)arg3;	// IMP=0x0000000000331579
- (id)init;	// IMP=0x0000000000331532
