...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001a5a09
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a58e5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a572d
- (void)dealloc;	// IMP=0x00000000001a568f
