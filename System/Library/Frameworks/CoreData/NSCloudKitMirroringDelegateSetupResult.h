...
- (void)dealloc;	// IMP=0x000000000033098d
- (id)initWithRequest:(id)arg1 storeIdentifier:(id)arg2 success:(_Bool)arg3 error:(id)arg4 container:(id)arg5 database:(id)arg6;	// IMP=0x0000000000330914
