...
- (void)dealloc;	// IMP=0x00000000002e96b4
- (id)initWithStore:(id)arg1 metadataContext:(id)arg2 databaseScope:(long long)arg3 metricsClient:(id)arg4;	// IMP=0x00000000002e9604
