...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000005ce2f
+ (int)migrationDebugLevel;	// IMP=0x006000000005ce16
- (void)dealloc;	// IMP=0x000000000005ceb1
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x000000000005ce48
