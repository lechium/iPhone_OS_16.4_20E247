...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000266e87
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x0000000000266c95
...
- (void)dealloc;	// IMP=0x0000000000266bbb
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000026694b
