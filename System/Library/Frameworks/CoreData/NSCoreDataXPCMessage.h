...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000031537
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000031706
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000315b9
- (void)dealloc;	// IMP=0x000000000003153f
