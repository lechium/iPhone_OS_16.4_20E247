...
- (id)description;	// IMP=0x0000000000335ddc
- (void)dealloc;	// IMP=0x0000000000335d5d
- (id)initWithMetadataStoreFileLocation:(id)arg1;	// IMP=0x0000000000335ce5
- (id)init;	// IMP=0x0000000000335ca6
