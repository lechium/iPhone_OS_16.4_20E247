...
- (id)managedObjectContext;	// IMP=0x00000000002d4435
- (void)dealloc;	// IMP=0x00000000002d43d4
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x00000000002d42e6
