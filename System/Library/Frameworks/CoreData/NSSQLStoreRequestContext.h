...
- (void)executeEpilogue;	// IMP=0x0000000000062724
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x000000000006222f
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x0000000000062201
- (void)executePrologue;	// IMP=0x00000000000621fb
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x0000000000062058
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000061eea
