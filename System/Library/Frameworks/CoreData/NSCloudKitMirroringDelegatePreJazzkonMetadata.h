...
- (void).cxx_destruct;	// IMP=0x00000000003393b7
- (id)description;	// IMP=0x00000000003382a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003380d8
- (void)dealloc;	// IMP=0x0000000000338069
- (id)initWithStore:(id)arg1;	// IMP=0x0000000000338017
