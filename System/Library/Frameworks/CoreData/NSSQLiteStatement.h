...
- (id)bindIntarrays;	// IMP=0x00000000002068af
- (id)bindVariables;	// IMP=0x00000000002067dc
- (id)sqlString;	// IMP=0x0000000000206798
- (id)entity;	// IMP=0x000000000020678e
- (void)dealloc;	// IMP=0x000000000020670f
- (id)initWithEntity:(id)arg1;	// IMP=0x0000000000206694
- (id)description;	// IMP=0x0000000000206622
- (id)initWithEntity:(id)arg1 sqlString:(id)arg2;	// IMP=0x00000000002065c0
