...
- (void).cxx_destruct;	// IMP=0x00000000002bb7b6
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x00000000002bb754
- (void)applicationDidActivate:(id)arg1;	// IMP=0x00000000002bb746
- (void)dealloc;	// IMP=0x00000000002bb6c5
- (id)init;	// IMP=0x00000000002baf63
