...
- (id)description;	// IMP=0x0000000000140a38
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000140964
- (void)dealloc;	// IMP=0x00000000001408f2
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x00000000001407e4
