...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b61c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b855
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b624
- (void)dealloc;	// IMP=0x000000000000b5b8
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000b2d1
