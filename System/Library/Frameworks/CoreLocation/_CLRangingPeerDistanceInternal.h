...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000095657
- (void)dealloc;	// IMP=0x00000000000955e8
- (id)initWithPeer:(id)arg1 date:(id)arg2 distanceMeters:(id)arg3 accuracyMeters:(id)arg4 initiator:(_Bool)arg5 shouldUnlock:(_Bool)arg6;	// IMP=0x00000000000954f0
