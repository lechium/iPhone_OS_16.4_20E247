...
- (void)createConnection;	// IMP=0x0000000000032296
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x00000000000321d1
- (void)dealloc;	// IMP=0x0000000000032142
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x0000000000032039
