...
- (void)createConnection;	// IMP=0x000000000000ca8a
- (void)didUpdateLocations:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c804
- (void)didUpdateLocations:(id)arg1;	// IMP=0x000000000000c565
- (void)dealloc;	// IMP=0x000000000000c4bc
- (id)initWithQueue:(id)arg1 locationManagerRoutine:(id)arg2;	// IMP=0x000000000000c2fd
