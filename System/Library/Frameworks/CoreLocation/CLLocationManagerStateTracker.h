...
+ (const char *)trackerStateTypeName;	// IMP=0x0060000000011236
+ (unsigned long long)trackerStateSize;	// IMP=0x006000000001122b
- (void *)identifier;	// IMP=0x0000000000011243
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x0000000000011074
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010cc4
...
- (void)dealloc;	// IMP=0x000000000000e40d
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000df9b
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000df86
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000df25
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000df10
