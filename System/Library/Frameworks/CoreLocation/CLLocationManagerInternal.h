...
- (void).cxx_destruct;	// IMP=0x00000000000119e4
...
- (void)dealloc;	// IMP=0x0000000000011806
- (void)invalidate;	// IMP=0x00000000000117f1
- (void)performCourtesyPromptIfNeeded;	// IMP=0x00000000000117b8
- (void)cancelLingeringRangingRequest;	// IMP=0x0000000000011781
- (_Bool)hasLingeringRangingRequest;	// IMP=0x000000000001168c
- (void)cancelRangingRequest;	// IMP=0x000000000001162b
- (void)cancelLocationRequest;	// IMP=0x00000000000115e8
- (void)stopUpdatingLocationAutoPaused;	// IMP=0x00000000000115a7
- (_Bool)showsBackgroundLocationIndicator;	// IMP=0x0000000000011591
- (void)setShowsBackgroundLocationIndicator:(_Bool)arg1;	// IMP=0x0000000000011563
- (_Bool)allowsBackgroundLocationUpdates;	// IMP=0x000000000001154d
- (void)setAllowsBackgroundLocationUpdates:(_Bool)arg1;	// IMP=0x000000000001151f
- (int)PausesLocationUpdatesAutomatically;	// IMP=0x0000000000011509
- (void)setPausesLocationUpdatesAutomatically:(int)arg1;	// IMP=0x00000000000114c1
- (id)initWithInfo:(id)arg1 bundleIdentifier:(id)arg2 bundlePath:(id)arg3 websiteIdentifier:(id)arg4 delegate:(id)arg5 silo:(id)arg6;	// IMP=0x0000000000011254
