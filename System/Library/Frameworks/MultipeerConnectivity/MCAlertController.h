...
- (void)dealloc;	// IMP=0x000000000000f273
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000000f1de
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000f17f
- (void)dismiss;	// IMP=0x000000000000f141
- (void)show;	// IMP=0x000000000000efef
