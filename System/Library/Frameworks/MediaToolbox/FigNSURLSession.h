...
- (void)dealloc;	// IMP=0x00000000002ca345
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x00000000002ca1bc
- (void)debug;	// IMP=0x00000000002ca15e
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x00000000002ca048
