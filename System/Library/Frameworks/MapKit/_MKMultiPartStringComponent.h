...
- (void).cxx_destruct;	// IMP=0x000000000007e10e
...
- (id)description;	// IMP=0x000000000007e023
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000007df8a
