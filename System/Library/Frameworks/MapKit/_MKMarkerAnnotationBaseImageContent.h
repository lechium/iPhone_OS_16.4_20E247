...
- (void).cxx_destruct;	// IMP=0x0000000000194d71
...
- (id)initWithFillColor:(id)arg1 strokeColor:(id)arg2 strokeWidth:(double)arg3 blendMode:(int)arg4 baseImageType:(long long)arg5;	// IMP=0x0000000000194c7f
