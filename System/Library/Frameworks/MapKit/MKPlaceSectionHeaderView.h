...
- (void).cxx_destruct;	// IMP=0x0000000000006be5
...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000006865
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x0000000000006333
- (void)updateContent;	// IMP=0x0000000000006293
- (void)createConstraints;	// IMP=0x0000000000005432
- (_Bool)shouldStack;	// IMP=0x00000000000050b9
- (void)_updateConstraints;	// IMP=0x0000000000004d1c
- (void)contentSizeDidChange;	// IMP=0x0000000000004d0b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000004a54
