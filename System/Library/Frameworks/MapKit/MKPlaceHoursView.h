...
- (void).cxx_destruct;	// IMP=0x0000000000220bee
...
- (_Bool)_shouldCollapseTopMessageLabel;	// IMP=0x0000000000220b08
- (void)_collapseAllLabelsFromOptions;	// IMP=0x0000000000220910
- (void)_updateHoursView;	// IMP=0x000000000021f0f4
- (void)_updateOptionsForCollapsingToSingleLineAndColor;	// IMP=0x000000000021f074
- (id)_standardLabel;	// IMP=0x000000000021ef5d
- (void)infoCardThemeChanged;	// IMP=0x000000000021ee8c
- (_Bool)wantsDefaultClipping;	// IMP=0x000000000021ee84
- (void)applyRulesForTopAndBottomLabel;	// IMP=0x000000000021e85a
- (void)setTopLabel:(id)arg1;	// IMP=0x000000000021e700
@property(readonly, nonatomic) _MKUILabel *topLabel;
- (void)_contentSizeDidChange;	// IMP=0x000000000021e365
- (id)hoursGrayColor;	// IMP=0x000000000021e327
- (void)_commonInit;	// IMP=0x000000000021dcd7
- (id)initWithBusinessHours:(id)arg1;	// IMP=0x000000000021dc0c
