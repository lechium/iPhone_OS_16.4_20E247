...
- (void).cxx_destruct;	// IMP=0x00000000000b9f3a
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000b9e3c
- (void)keyDown:(id)arg1;	// IMP=0x00000000000b9d3d
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000b9c80
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000b9b98
