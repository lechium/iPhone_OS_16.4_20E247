...
- (void).cxx_destruct;	// IMP=0x00000000000d71bc
...
- (void)applyToPlaceInfo:(id)arg1;	// IMP=0x00000000000d6f14
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x00000000000d6efe
@property(readonly, nonatomic) GEOMapServiceTraits *traits;
- (void)cancel;	// IMP=0x00000000000d6ed2
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 queue:(id)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000000d6a9e
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d6a84
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d6a6d
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d6a27
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d6202
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d61af
@property(readonly, copy) NSString *description;
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000d60ab
