...
- (void).cxx_destruct;	// IMP=0x00000000001b2cd3
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001b2aed
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x00000000001b2811
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x00000000001b2255
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001b1ace
- (void)setUnits:(id)arg1;	// IMP=0x00000000001b1878
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001b176f
- (void)clearCaches:(id)arg1;	// IMP=0x00000000001b1752
- (id)init;	// IMP=0x00000000001b154c
