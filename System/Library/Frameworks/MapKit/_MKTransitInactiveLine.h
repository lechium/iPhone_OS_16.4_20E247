...
- (void).cxx_destruct;	// IMP=0x00000000000a0bf6
...
- (id)initWithTransitLine:(id)arg1 blocked:(_Bool)arg2 serviceResumesDate:(id)arg3 timeZone:(id)arg4 referenceDate:(id)arg5 departuresSequence:(id)arg6;	// IMP=0x00000000000a0aba
