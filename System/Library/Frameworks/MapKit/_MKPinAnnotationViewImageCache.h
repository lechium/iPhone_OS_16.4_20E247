...
- (id).cxx_construct;	// IMP=0x000000000022a415
- (void).cxx_destruct;	// IMP=0x000000000022a38d
- (void)flush;	// IMP=0x000000000022a29b
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x0000000000229e6d
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x0000000000229c45
- (id)init;	// IMP=0x0000000000229a18
