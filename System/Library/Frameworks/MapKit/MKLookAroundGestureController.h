...
- (void).cxx_destruct;	// IMP=0x00000000001c01e5
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000001c0116
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000001c009c
- (void)_handleZoom:(id)arg1;	// IMP=0x00000000001bf9ea
- (void)_handlePan:(id)arg1;	// IMP=0x00000000001bedd4
- (void)_handleSingleNavigate:(id)arg1;	// IMP=0x00000000001be772
- (void)_moveBackToReplayTap;	// IMP=0x00000000001be36a
- (id)initWithLookAroundView:(id)arg1;	// IMP=0x00000000001be124
