...
- (void).cxx_destruct;	// IMP=0x00000000000981c0
...
- (void)_buildRows;	// IMP=0x0000000000098142
- (void)_setNeedsBuildRows;	// IMP=0x0000000000098138
- (_Bool)_needsBuildRows;	// IMP=0x000000000009812f
- (id)linesToShow;	// IMP=0x00000000000980f6
- (_Bool)hasFilteredLines;	// IMP=0x00000000000980bd
- (_Bool)hasFilteredRows;	// IMP=0x000000000009807b
- (unsigned long long)numberOfRows;	// IMP=0x0000000000098046
- (void)incrementPagingFilter;	// IMP=0x0000000000097fec
- (id)initWithMapItem:(id)arg1 system:(id)arg2;	// IMP=0x0000000000097e17
- (id)init;	// IMP=0x0000000000097ded
