...
- (void).cxx_destruct;	// IMP=0x00000000001941a0
@property(readonly, nonatomic) MKTransitSystemFilterView *filterView; // @synthesize filterView=_filterView;
@property(retain, nonatomic) NSString *titleText;
- (void)_contentSizeDidChange;	// IMP=0x00000000001940c2
- (void)_setupConstraints;	// IMP=0x0000000000193c3c
- (void)_setupSubviews;	// IMP=0x0000000000193a84
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000193a12
