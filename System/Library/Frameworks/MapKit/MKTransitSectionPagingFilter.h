...
+ (_Bool)_newStationCardUIEnabled;	// IMP=0x0060000000068492
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x0060000000068480
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x006000000006845b
+ (id)defaultFilterForInactiveLines;	// IMP=0x00600000000683da
+ (id)defaultFilterForDepartures;	// IMP=0x0060000000068359
