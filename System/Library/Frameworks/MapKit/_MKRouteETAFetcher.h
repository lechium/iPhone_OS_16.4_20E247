...
- (void).cxx_destruct;	// IMP=0x0000000000157193
...
- (void)_didUpdateETAResult;	// IMP=0x0000000000157114
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x00000000001570c0
- (_Bool)isValidETA:(id)arg1;	// IMP=0x0000000000157017
- (void)expireETAsIfNoLongerValid;	// IMP=0x0000000000156d8c
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000156c96
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x0000000000156a50
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015638a
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000156323
- (void)_resetState;	// IMP=0x00000000001562b6
- (void)dealloc;	// IMP=0x0000000000155faf
- (id)init;	// IMP=0x0000000000155eea
