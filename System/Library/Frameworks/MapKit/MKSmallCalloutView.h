...
- (void).cxx_destruct;	// IMP=0x000000000025232a
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x00000000002522f1
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000002518a5
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000250b5a
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000024fcac
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000024f976
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x000000000024f77a
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x000000000024f6db
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x000000000024f6ba
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x000000000024f6a9
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000024f67a
- (void)beginMapsTransitionMovingSideways;	// IMP=0x000000000024f5e5
- (void)reset;	// IMP=0x000000000024f581
- (void)dealloc;	// IMP=0x000000000024f50c
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000024f25e
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x000000000024deea
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000024de48
