...
- (void).cxx_destruct;	// IMP=0x0000000000044b32
@property(retain, nonatomic) MKMapItemView *mapItemView; // @synthesize mapItemView=_mapItemView;
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000044ad1
- (double)mapViewHeight;	// IMP=0x0000000000044ac3
@property(retain, nonatomic) UIImage *map;
- (void)infoCardThemeChanged;	// IMP=0x00000000000448d7
@property(nonatomic, getter=isBottomHairlineHidden) _Bool bottomHairlineHidden;
- (void)_contentSizeDidChange;	// IMP=0x00000000000447c4
- (double)titleHeight;	// IMP=0x0000000000044772
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000043b30
- (_Bool)useImageView;	// IMP=0x0000000000043b28
- (_Bool)hasTitle;	// IMP=0x0000000000043b20
