...
- (void).cxx_destruct;	// IMP=0x000000000017edf1
- (void)_configureBalloonForDataIconImageKeys:(id)arg1 scale:(double)arg2;	// IMP=0x000000000017e546
- (_Bool)updateCalloutViewIfNeededAnimated:(_Bool)arg1;	// IMP=0x000000000017dba9
- (void)_addAnchorDotViewIfNeeded;	// IMP=0x000000000017d98d
- (_Bool)shouldShowCallout;	// IMP=0x000000000017d842
...
- (_Bool)_balloonCalloutShouldOriginateFromSmallSize:(double *)arg1;	// IMP=0x000000000017d747
@property(readonly, nonatomic, getter=_balloonCalloutStyle) long long balloonCalloutStyle;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000017d61c
- (void)_resolveBalloonAttributesIfNecessary;	// IMP=0x000000000017ca1b
- (void)prepareForReuse;	// IMP=0x000000000017c95a
- (id)initWithAnnotation:(id)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000017c8fe
