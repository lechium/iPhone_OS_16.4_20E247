...
- (void).cxx_destruct;	// IMP=0x00000000000ac9e3
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
@property(nonatomic) double zoomFraction; // @synthesize zoomFraction=_zoomFraction;
- (void)updateConstraints;	// IMP=0x00000000000abc59
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000abc07
- (void)didMoveToWindow;	// IMP=0x00000000000ababe
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000aac53
