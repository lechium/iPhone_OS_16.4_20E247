...
- (void).cxx_destruct;	// IMP=0x00000000000fd9a6
...
- (void)main;	// IMP=0x00000000000fc84a
- (id)initWithUrl:(id)arg1 size:(struct CGSize)arg2 contentSizeCategory:(id)arg3 name:(id)arg4 downloadCache:(id)arg5 gradientCache:(id)arg6 isRTL:(_Bool)arg7 screenScale:(double)arg8 cacheId:(id)arg9;	// IMP=0x00000000000fc669
