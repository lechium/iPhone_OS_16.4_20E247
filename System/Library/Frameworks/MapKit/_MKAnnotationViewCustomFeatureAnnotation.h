...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000edbf1
- (void).cxx_destruct;	// IMP=0x00000000000ee04b
...
- (void)setCustomFeature:(id)arg1;	// IMP=0x00000000000edd80
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000edcb2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000edbf9
