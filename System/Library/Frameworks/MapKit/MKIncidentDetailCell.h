...
- (void).cxx_destruct;	// IMP=0x00000000001a537a
@property(retain, nonatomic) NSDate *lastUpdated; // @synthesize lastUpdated=_lastUpdated;
@property(retain, nonatomic) UIImage *icon; // @synthesize icon=_icon;
@property(copy, nonatomic) NSString *title; // @synthesize title=_title;
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x00000000001a52f3
- (void)_updateLastUpdatedLabel;	// IMP=0x00000000001a50b0
@property(copy, nonatomic) NSString *incidentDescription;
- (void)didMoveToWindow;	// IMP=0x00000000001a4f90
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000001a4ecc
- (void)dealloc;	// IMP=0x00000000001a4e57
- (void)_updateConstraintValues;	// IMP=0x00000000001a4d23
- (void)updateConstraints;	// IMP=0x00000000001a499a
- (void)_setConstraints;	// IMP=0x00000000001a418e
- (void)infoCardThemeChanged;	// IMP=0x00000000001a4029
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x00000000001a3902
