...
- (double)pointOffsetForDistanceOffset:(double)arg1;	// IMP=0x00000000000ed537
- (struct CGPoint)pointInLayer:(id)arg1 bound:(struct CGRect)arg2;	// IMP=0x00000000000ed405
- (CDStruct_c3b9c2ee)coordinate;	// IMP=0x00000000000ed3e8
