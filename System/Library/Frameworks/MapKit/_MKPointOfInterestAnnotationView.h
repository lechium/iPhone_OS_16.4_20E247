...
- (void).cxx_destruct;	// IMP=0x00000000001bdb66
@property(nonatomic) __weak MKMapView *mapView; // @synthesize mapView=_mapView;
- (_Bool)updateCalloutViewIfNeededAnimated:(_Bool)arg1;	// IMP=0x00000000001bd2f7
- (long long)_baseImageType;	// IMP=0x00000000001bd22e
- (void)_addAnchorDotView;	// IMP=0x00000000001bd098
...
- (_Bool)_isMetroArea;	// IMP=0x00000000001bd00e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001bcef8
- (void)_resolveBalloonAttributes;	// IMP=0x00000000001bcad2
- (void)_updateAnchorOffset;	// IMP=0x00000000001bca20
- (void)_updateFromMap;	// IMP=0x00000000001bc976
- (void)setAnnotation:(id)arg1;	// IMP=0x00000000001bc93a
- (_Bool)shouldShowCallout;	// IMP=0x00000000001bc8f2
- (id)initWithAnnotation:(id)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001bc851
