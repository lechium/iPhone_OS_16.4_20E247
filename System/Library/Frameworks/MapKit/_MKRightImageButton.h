...
- (void).cxx_destruct;	// IMP=0x00000000000ffdbc
- (_Bool)isHighlighted;	// IMP=0x00000000000ffdac
@property(readonly, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
@property(readonly, nonatomic) _MKUILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000ffcee
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000ffcd9
@property(retain, nonatomic) UIImage *image;
@property(retain, nonatomic) NSString *title;
- (void)updateConstraints;	// IMP=0x00000000000ff996
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000ff927
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000ff86e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ff465
