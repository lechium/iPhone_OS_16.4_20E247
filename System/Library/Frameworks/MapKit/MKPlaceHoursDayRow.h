...
- (void).cxx_destruct;	// IMP=0x0000000000080935
...
- (void)hoursViewDidUpdate:(id)arg1;	// IMP=0x00000000000806ec
- (void)_setUpConstraints;	// IMP=0x00000000000803e5
- (void)_setUpViewsForPlaceHoursDayRow;	// IMP=0x0000000000080372
- (id)initWithBusinessHours:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x00000000000802ae
