...
- (void).cxx_destruct;	// IMP=0x00000000001ca535
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ca4ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ca3a8
- (unsigned long long)hash;	// IMP=0x00000000001ca358
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x00000000001ca2b1
