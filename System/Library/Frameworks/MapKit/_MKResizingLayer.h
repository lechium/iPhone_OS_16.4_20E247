...
- (void).cxx_destruct;	// IMP=0x0000000000077b87
@property(nonatomic) _Bool needsLayoutOnBoundsChange; // @synthesize needsLayoutOnBoundsChange=_needsLayoutOnBoundsChange;
- (void)setContentsScale:(double)arg1;	// IMP=0x00000000000779d3
- (void)setMask:(id)arg1;	// IMP=0x00000000000778b2
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000775f4
- (void)sizeSublayerToBounds:(id)arg1;	// IMP=0x000000000007759b
