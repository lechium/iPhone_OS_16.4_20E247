...
- (void).cxx_destruct;	// IMP=0x00000000000fc607
...
- (void)cancel;	// IMP=0x00000000000fc498
- (_Bool)isFinished;	// IMP=0x00000000000fc488
- (_Bool)isExecuting;	// IMP=0x00000000000fc478
- (void)markOperationAsComplete;	// IMP=0x00000000000fc340
- (void)main;	// IMP=0x00000000000fbb84
- (void)start;	// IMP=0x00000000000fbad6
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x00000000000fb9e2
