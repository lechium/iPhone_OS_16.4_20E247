...
- (void).cxx_destruct;	// IMP=0x000000000018bfa7
...
- (void)reset;	// IMP=0x000000000018bc6c
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x000000000018bb8f
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x000000000018b856
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x000000000018b317
