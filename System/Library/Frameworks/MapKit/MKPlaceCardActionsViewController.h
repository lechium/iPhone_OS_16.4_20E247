...
- (void).cxx_destruct;	// IMP=0x0000000000077527
...
- (id)infoCardChildUnactionableUIElements;	// IMP=0x00000000000773da
- (id)infoCardChildPossibleActions;	// IMP=0x00000000000771cf
- (void)placeCardActionSectionView:(id)arg1 buttonWithActionItemPressed:(id)arg2;	// IMP=0x00000000000770d5
- (void)sectionView:(id)arg1 didSelectRow:(id)arg2 atIndex:(unsigned long long)arg3;	// IMP=0x0000000000076e92
- (void)_setUpSectionViews;	// IMP=0x00000000000764df
- (id)_makePlaceActionButton;	// IMP=0x00000000000764aa
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000007644c
- (void)viewDidLoad;	// IMP=0x000000000007636a
- (id)init;	// IMP=0x000000000007632b
