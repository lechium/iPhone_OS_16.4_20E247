...
- (void).cxx_destruct;	// IMP=0x000000000002d907
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002d78a
- (void)invalidate;	// IMP=0x000000000002d774
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002d624
