...
- (void).cxx_destruct;	// IMP=0x000000000005e3e5
...
- (id)initWithPaused:(_Bool)arg1 attributedTo:(id)arg2 definition:(id)arg3 renderBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000005e284
