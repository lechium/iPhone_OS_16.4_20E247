...
+ (id)sortedRingRatioDirectives;	// IMP=0x0060000000002883
+ (id)activityRingSizingDirectiveWithIdentifier:(id)arg1 width:(double)arg2 outerRingOffset:(double)arg3 ringThickness:(double)arg4 ringInterspacing:(double)arg5;	// IMP=0x0060000000002ca4
...
- (id)description;	// IMP=0x0000000000003246
