...
- (void).cxx_destruct;	// IMP=0x000000000001b7af
@property(nonatomic) __weak id <SLRemoteComposeViewControllerDelegateProtocol> delegate; // @synthesize delegate=_delegate;
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000001b77a
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x000000000001b6cf
