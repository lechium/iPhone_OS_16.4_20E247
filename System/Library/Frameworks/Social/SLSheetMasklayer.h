...
- (void).cxx_destruct;	// IMP=0x000000000001f181
...
- (void)updateMaskWithBounds:(struct CGRect)arg1 maskRect:(struct CGRect)arg2;	// IMP=0x000000000001edfc
- (void)animateSheetMaskFromOldSheetFrame:(struct CGRect)arg1 toSheetFrame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x000000000001e009
- (void)restoreSheetCutout;	// IMP=0x000000000001df71
- (void)removeSheetCutout;	// IMP=0x000000000001deda
- (void)removeAllAnimations;	// IMP=0x000000000001de42
- (id)initWithBackgroundColor:(id)arg1 cornerRadius:(double)arg2;	// IMP=0x000000000001d962
