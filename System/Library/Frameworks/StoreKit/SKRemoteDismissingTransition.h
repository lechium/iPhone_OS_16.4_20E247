...
- (void).cxx_destruct;	// IMP=0x0000000000015c09
...
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000015bd4
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000015bc2
- (void)dismissRemoteViewController:(id)arg1;	// IMP=0x0000000000015ad5
- (id)initWithViewController:(id)arg1;	// IMP=0x0000000000015a6d
