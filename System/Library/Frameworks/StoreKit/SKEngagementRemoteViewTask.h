...
- (void).cxx_destruct;	// IMP=0x000000000002fe45
...
- (void)_presentViewController:(id)arg1;	// IMP=0x000000000002faf5
- (void)_unblock;	// IMP=0x000000000002fa82
- (void)preferredContentSizeDidChange:(struct CGSize)arg1;	// IMP=0x000000000002f9ae
- (void)engagementTaskDidFinishWithResult:(id)arg1 resultData:(id)arg2 error:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000002f7ec
- (void)presentEngagement;	// IMP=0x000000000002f2c0
- (id)initWithRequestData:(id)arg1 presentingViewController:(id)arg2 windowScene:(id)arg3;	// IMP=0x000000000002f1d6
