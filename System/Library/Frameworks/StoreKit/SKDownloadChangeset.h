...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x001000000000686b
- (void).cxx_destruct;	// IMP=0x0000000000006d9e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006bd2
- (id)copyXPCEncoding;	// IMP=0x0000000000006b15
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000006909
