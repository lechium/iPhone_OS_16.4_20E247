...
- (void).cxx_destruct;	// IMP=0x00000000000016e6
@property(nonatomic) __weak id <NCSizeObservingViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000015da
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000014e7
