...
- (void)remNotifications:(id)arg1;	// IMP=0x000000000001552a
- (void)addNotifications:(id)arg1;	// IMP=0x00000000000154e8
- (_Bool)interestedInNotification:(id)arg1;	// IMP=0x00000000000154a1
- (void)dealloc;	// IMP=0x0000000000015431
@property(readonly) int pid; // @dynamic pid;
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000001537c
