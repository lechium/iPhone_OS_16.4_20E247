...
- (void)_actuallyUpdateDebugLabelTextWithCurrentResolution:(id)arg1 currentVideoDynamicRange:(id)arg2;	// IMP=0x00000000000710b7
- (void)_updateDebugLabelText;	// IMP=0x0000000000070e89
- (id)_currentVideoDynamicRange;	// IMP=0x0000000000070c76
- (id)_currentDisplay;	// IMP=0x00000000000709e3
- (id)_currentEnabledVideoTrack;	// IMP=0x0000000000070772
- (void)dealloc;	// IMP=0x0000000000070550
- (id)init;	// IMP=0x000000000007039f
