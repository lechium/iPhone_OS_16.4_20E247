...
- (void).cxx_destruct;	// IMP=0x000000000008921d
...
- (id)_customControlsViewIfLoaded;	// IMP=0x0000000000088d8e
- (id)_playbackControlsViewsForControlItems:(id)arg1 withType:(long long)arg2;	// IMP=0x00000000000889e8
- (id)_playbackControlsViewItems;	// IMP=0x0000000000088793
- (void)_animateKeyboardAvoidance:(long long)arg1 duration:(double)arg2;	// IMP=0x000000000008860c
- (void)_updateLayoutMargins;	// IMP=0x000000000008835f
- (void)_setupInitialLayout;	// IMP=0x0000000000087ee1
- (void)_updateDoubleRowLayoutEnabled;	// IMP=0x0000000000087bfc
- (void)_updateAreVolumeAndTransportControlsVisible;	// IMP=0x0000000000087a50
- (void)reevaluateHiddenStateForContainersAndSubviews;	// IMP=0x00000000000878be
- (void)_updatePlaybackControlsContainerVisibilityAnimated:(_Bool)arg1 additionalActions:(CDUnknownBlockType)arg2;	// IMP=0x0000000000086dab
- (void)updateDisplayControlsVisibilityIncludedButtons:(id)arg1;	// IMP=0x00000000000869bf
- (void)_collapse:(_Bool)arg1 view:(id)arg2;	// IMP=0x0000000000086967
- (void)_collapse:(_Bool)arg1 views:(id)arg2;	// IMP=0x000000000008682b
- (id)_displayModeViewsToRemoveDuringAnimation;	// IMP=0x000000000008677f
- (id)_audioViewsToRemoveDuringAnimation;	// IMP=0x00000000000866d3
- (id)_currentArrangedDisplayModeViews;	// IMP=0x0000000000086628
- (id)_currentArrangedAudioModeViews;	// IMP=0x000000000008657d
- (id)_preferredArrangedDisplayModeViews;	// IMP=0x00000000000864cc
- (id)_preferredArrangedAudioModeViews;	// IMP=0x000000000008641b
- (void)_updateVolumeControlsWithSize:(struct CGSize)arg1;	// IMP=0x0000000000085c1e
- (void)_updateTransportControlsFrame;	// IMP=0x00000000000856ef
- (void)_showPlaybackControlsAnimated:(_Bool)arg1;	// IMP=0x00000000000856db
- (void)layoutSubviews;	// IMP=0x0000000000083526
- (void)avkit_intrinsicContentSizeOfSubviewWasInvalidated:(id)arg1;	// IMP=0x0000000000083514
- (void)avkit_reevaluateHiddenStateOfItem:(id)arg1;	// IMP=0x00000000000833d9
- (void)safeAreaInsetsDidChange;	// IMP=0x0000000000083398
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000083357
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000083292
- (void)didMoveToWindow;	// IMP=0x000000000008324d
- (void)setPrefersVolumeSliderExpanded:(_Bool)arg1 prefersVolumeButtonIncluded:(_Bool)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000082fd2
- (void)showPlaybackControls:(_Bool)arg1 immediately:(_Bool)arg2;	// IMP=0x0000000000082e9c
@property(readonly, nonatomic) _Bool hasVisibleSubview;
- (void)animateAlongsideVisibilityAnimationsWithAnimationCoordinator:(id)arg1 appearingViews:(id)arg2 disappearingViews:(id)arg3;	// IMP=0x0000000000082a79
- (void)setCustomControlItems:(id)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x0000000000082812
...
- (void)setIncludedContainers:(long long)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x0000000000082552
- (void)setupInitialLayout;	// IMP=0x000000000008242d
- (void)dealloc;	// IMP=0x000000000008232a
- (id)initWithFrame:(struct CGRect)arg1 styleSheet:(id)arg2;	// IMP=0x000000000008156c
