...
+ (id)sizesResolvingFirstPrioritizedSize:(id)arg1 secondPrioritizedSize:(id)arg2 inAvailableWidth:(double)arg3;	// IMP=0x00600000000bcde4
- (void).cxx_destruct;	// IMP=0x00000000000bcd9b
...
- (id)removeLastSizeOfPriority:(unsigned long long)arg1;	// IMP=0x00000000000bcbb1
- (void)addSize:(struct CGSize)arg1 withPriority:(unsigned long long)arg2;	// IMP=0x00000000000bcabe
- (id)init;	// IMP=0x00000000000bc9f2
