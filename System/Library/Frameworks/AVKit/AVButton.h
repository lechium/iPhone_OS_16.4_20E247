...
@interface AVButton : UIButton
{
    ...
    _Bool _wasForcePressTriggered;	// 28 = 0x1c
    _Bool _secondGeneration;	// 29 = 0x1d
...
+ (id)buttonWithAccessibilityIdentifier:(id)arg1 accessibilityLabel:(id)arg2 isSecondGeneration:(_Bool)arg3;	// IMP=0x0010000000114c12
+ (id)buttonWithAccessibilityIdentifier:(id)arg1 isSecondGeneration:(_Bool)arg2;	// IMP=0x0010000000114bb0
- (void).cxx_destruct;	// IMP=0x000000000011444e
...
- (double)_imageViewAlpha;	// IMP=0x0000000000113eb4
- (id)_preferredFont;	// IMP=0x0000000000113e1c
- (id)_preferredImageName;	// IMP=0x0000000000113dd0
- (void)_updateBackgroundEffectViewIsHidden;	// IMP=0x0000000000113c8e
- (void)_updateEdgeInsets;	// IMP=0x0000000000113b6e
- (void)_updateTintColorIfNeeded;	// IMP=0x0000000000113a94
- (void)_updateImageIfNeeded;	// IMP=0x0000000000113a48
- (void)_updateLayoutItem;	// IMP=0x0000000000113953
- (void)_resetTrackedState;	// IMP=0x00000000001138ab
- (void)_handleUserInteractionGestureRecognizer:(id)arg1;	// IMP=0x000000000011382f
- (struct CGSize)_preferredLayoutSize;	// IMP=0x000000000011375a
- (void)layoutAttributesDidChange;	// IMP=0x0000000000113701
- (void)layoutSubviews;	// IMP=0x000000000011361a
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000011351e
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000001134cf
- (struct CGRect)hitRect;	// IMP=0x00000000001133d4
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000001131ca
- (id)accessibilityLabel;	// IMP=0x000000000011315e
- (void)setTitle:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x0000000000112fb6
- (void)setImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x0000000000112b90
- (void)cancelTrackingWithEvent:(id)arg1;	// IMP=0x0000000000112b13
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000112a96
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000001127d6
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000112614
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000011247d
- (void)setEnabled:(_Bool)arg1;	// IMP=0x0000000000112356
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000000011167e
- (struct CGSize)minimumSize;	// IMP=0x000000000011166c
