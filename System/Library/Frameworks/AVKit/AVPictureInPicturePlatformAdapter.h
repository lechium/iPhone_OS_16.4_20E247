...
@interface AVPictureInPicturePlatformAdapter : NSObject
{
    ...
    _Bool _canPausePlaybackWhenExitingPictureInPicture;	// 19 = 0x13
...
+ (id)imageSymbolConfiguration;	// IMP=0x001000000000cf93
+ (id)stopPictureInPictureButtonImageName;	// IMP=0x001000000000cf74
+ (id)startPictureInPictureButtonImageName;	// IMP=0x001000000000cf55
+ (_Bool)isPictureInPictureSupported;	// IMP=0x001000000000cf2a
- (void).cxx_destruct;	// IMP=0x000000000000b84f
...
- (void)_setupPipAdapter;	// IMP=0x000000000000b5f1
- (void)_removeSecondScreenConnection;	// IMP=0x000000000000b3b0
- (void)pictureInPictureViewControllerViewWillDisappear:(id)arg1;	// IMP=0x000000000000b2b0
- (void)pictureInPictureViewControllerViewDidAppear:(id)arg1;	// IMP=0x000000000000b1ad
- (_Bool)pictureInPictureProxyCanIssueOptionalCommand:(id)arg1;	// IMP=0x000000000000b190
- (void)pictureInPictureProxy:(id)arg1 didReceiveTestingCommand:(id)arg2;	// IMP=0x000000000000b020
- (void)pictureInPictureProxy:(id)arg1 didReceivePlaybackCommand:(id)arg2;	// IMP=0x000000000000a8f2
- (void)pictureInPictureProxy:(id)arg1 didUpdateResourcesUsageReductionReasons:(unsigned long long)arg2 oldReasons:(unsigned long long)arg3;	// IMP=0x000000000000a7d3
- (id)pictureInPictureProxyViewControllerWindowForTransitionAnimation:(id)arg1;	// IMP=0x000000000000a783
- (long long)pictureInPictureProxyInterfaceOrientationForTransitionAnimation:(id)arg1;	// IMP=0x000000000000a715
- (void)pictureInPictureProxyPictureInPictureInterruptionEnded:(id)arg1;	// IMP=0x000000000000a619
- (void)pictureInPictureProxyPictureInPictureInterruptionBegan:(id)arg1;	// IMP=0x000000000000a51d
- (void)pictureInPictureProxy:(id)arg1 didStopPictureInPictureWithAnimationType:(long long)arg2 reason:(long long)arg3;	// IMP=0x000000000000a3fa
- (void)pictureInPictureProxy:(id)arg1 willStopPictureInPictureWithAnimationType:(long long)arg2 reason:(long long)arg3;	// IMP=0x000000000000a276
- (void)pictureInPictureProxy:(id)arg1 restoreUserInterfaceForPictureInPictureStopWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000a114
- (void)pictureInPictureProxy:(id)arg1 failedToStartPictureInPictureWithAnimationType:(long long)arg2 error:(id)arg3;	// IMP=0x0000000000009ff9
- (void)pictureInPictureProxy:(id)arg1 didStartPictureInPictureWithAnimationType:(long long)arg2;	// IMP=0x0000000000009f09
- (void)pictureInPictureProxy:(id)arg1 willStartPictureInPictureWithAnimationType:(long long)arg2;	// IMP=0x0000000000009df0
- (struct CGRect)pictureInPictureProxyViewFrameForTransitionAnimation:(id)arg1;	// IMP=0x0000000000009dc1
- (void)_startObservingForPlaybackStateUpdates;	// IMP=0x0000000000009a4d
- (void)_startObservation;	// IMP=0x0000000000009641
- (void)_createProxyIfNeeded;	// IMP=0x00000000000093b1
- (void)_updateProxyPlaybackState;	// IMP=0x00000000000091e0
- (long long)_proxyControlsStyle;	// IMP=0x00000000000091b4
- (void)_updatePictureInPictureShouldStartWhenEnteringBackground;	// IMP=0x0000000000008df0
- (_Bool)_isFullScreen;	// IMP=0x0000000000008b8d
- (void)updateLayoutDependentBehaviors;	// IMP=0x0000000000008ac2
...
- (void)stopPictureInPictureAndRestoreUserInterface:(_Bool)arg1;	// IMP=0x000000000000801d
- (void)startPictureInPicture;	// IMP=0x0000000000007e53
- (void)dealloc;	// IMP=0x0000000000007dd6
- (id)initWithSource:(id)arg1;	// IMP=0x0000000000007bc4
@property(readonly, nonatomic, getter=isContentSourceSupported) _Bool contentSourceSupported;
- (void)_setRoutingVideoToHostedWindow:(_Bool)arg1 pictureInPictureViewController:(id)arg2 source:(id)arg3;	// IMP=0x00000000000a402f
- (void)_updateStatusUsingProposedStatus:(long long)arg1;	// IMP=0x00000000000a3822
- (void)_updateStatus;	// IMP=0x00000000000a37f1
- (void)_setStatusAndNotifyDelegateIfNeeded:(long long)arg1;	// IMP=0x00000000000a36cf
