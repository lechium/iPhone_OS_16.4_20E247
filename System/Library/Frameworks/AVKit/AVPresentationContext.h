...
+ (_Bool)supportsInteractiveCounterRotationDismissals;	// IMP=0x0040000000026e88
- (void).cxx_destruct;	// IMP=0x0000000000026e10
...
- (id)toView;	// IMP=0x0000000000026ca8
...
- (id)presentingView;	// IMP=0x000000000002695b
...
- (id)fromView;	// IMP=0x00000000000267a0
...
- (id)initWithPresentationController:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000263e3
