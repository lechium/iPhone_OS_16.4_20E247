...
+ (id)avkit_autoOption;	// IMP=0x0020000000121b25
+ (id)avkit_offOption;	// IMP=0x0020000000121b14
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x001000000001a611
...
- (id)avkit_title;	// IMP=0x0010000000121a2a
