...
- (void).cxx_destruct;	// IMP=0x00000000000a845e
...
- (id)init;	// IMP=0x00000000000a829b
- (void)layoutSublayers;	// IMP=0x00000000000a7ff1
- (id)initWithDisplayScale:(double)arg1 placeholderImage:(struct CGImage *)arg2 opaque:(_Bool)arg3 videoRectWhenPIPBegan:(struct CGRect)arg4;	// IMP=0x00000000000a7f35
