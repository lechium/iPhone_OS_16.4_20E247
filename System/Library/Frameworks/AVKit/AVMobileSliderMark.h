...
+ (id)liveEdgeMarkAtValue:(float)arg1;	// IMP=0x006000000003f302
+ (id)interstitialMarkAtValue:(float)arg1;	// IMP=0x006000000003f258
...
- (id)initWithStartValue:(float)arg1 endValue:(float)arg2 filledColor:(id)arg3 unfilledColor:(id)arg4 markWithType:(unsigned long long)arg5;	// IMP=0x000000000003f137
