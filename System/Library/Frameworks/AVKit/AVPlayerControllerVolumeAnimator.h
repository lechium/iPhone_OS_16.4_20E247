...
- (void).cxx_destruct;	// IMP=0x000000000001ecb9
...
- (void)restoreVolumeIfNeeded;	// IMP=0x000000000001ebc6
- (void)setProgressAwayFromZero:(double)arg1;	// IMP=0x000000000001e9f7
- (void)setProgressTowardsZero:(double)arg1;	// IMP=0x000000000001e887
- (_Bool)canAnimateVolumeAwayFromZero;	// IMP=0x000000000001e77d
- (_Bool)canAnimateVolumeTowardsZero;	// IMP=0x000000000001e673
- (_Bool)currentRouteHasVolumeControl;	// IMP=0x000000000001e628
- (id)initWithPlayerController:(id)arg1;	// IMP=0x000000000001e5bd
