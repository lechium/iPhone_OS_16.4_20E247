...
+ (id)airMessageParser;	// IMP=0x00400000000e180b
- (void).cxx_destruct;	// IMP=0x00000000000e0340
...
- (id)partsWithData:(id)arg1;	// IMP=0x00000000000e0092
- (id)init;	// IMP=0x00000000000dfed3
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x00000000000dfde2
