...
- (void).cxx_destruct;	// IMP=0x00000000000be788
...
- (void)_updateZoomingView;	// IMP=0x00000000000be1a2
- (void)_handleDoubleTapGestureRecognizer:(id)arg1;	// IMP=0x00000000000be0bb
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000000be070
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000be012
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000bded9
- (void)willRemoveBehavior:(id)arg1;	// IMP=0x00000000000bded3
- (void)willAddBehavior:(id)arg1;	// IMP=0x00000000000bdecd
- (void)didRemoveBehavior:(id)arg1;	// IMP=0x00000000000bdc72
- (void)didAddBehavior:(id)arg1;	// IMP=0x00000000000bd93c
- (void)viewDidLoad;	// IMP=0x00000000000bd8c0
- (id)makePlaybackContentContainerWithFrame:(struct CGRect)arg1 activeContentView:(id)arg2;	// IMP=0x00000000000bd70a
@property(readonly, nonatomic) AVPlaybackContentContainerView *activeContentView;
- (void)dealloc;	// IMP=0x00000000000bd602
- (id)initWithAVKitOwner:(id)arg1;	// IMP=0x00000000000bd55b
