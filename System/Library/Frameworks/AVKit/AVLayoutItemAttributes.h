...
- (void).cxx_destruct;	// IMP=0x0000000000116cd6
...
- (id)debugDescription;	// IMP=0x0000000000116a39
- (unsigned long long)hash;	// IMP=0x00000000001169f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011691f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001166e8
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (id)init;	// IMP=0x00000000001165dc
