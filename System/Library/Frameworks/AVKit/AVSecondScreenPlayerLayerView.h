...
+ (Class)layerClass;	// IMP=0x00600000000eb0b2
- (void).cxx_destruct;	// IMP=0x00000000000eb036
...
- (void)stopShowingContentFromActiveSourcePlayerLayer;	// IMP=0x00000000000eaef6
- (void)startShowingContentFromSourcePlayerLayer:(id)arg1;	// IMP=0x00000000000ead85
- (void)dealloc;	// IMP=0x00000000000ead47
