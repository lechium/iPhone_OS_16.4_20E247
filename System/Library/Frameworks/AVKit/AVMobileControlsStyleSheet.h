...
- (void).cxx_destruct;	// IMP=0x000000000007e38a
...
- (struct UIEdgeInsets)playbackControlsViewLayoutMarginsForView:(id)arg1 keyboardHeight:(double)arg2 isFullScreen:(_Bool)arg3;	// IMP=0x000000000007d980
...
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x000000000007d886
