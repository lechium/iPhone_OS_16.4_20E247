...
+ (Class)layerClass;	// IMP=0x001000000011bb92
- (void).cxx_destruct;	// IMP=0x000000000011b30e
...
- (void)layoutAttributesDidChange;	// IMP=0x000000000011b10b
...
- (id)_includedItemsFromSubviews:(id)arg1 inStackLayout:(id)arg2 thatFitSize:(struct CGSize)arg3;	// IMP=0x000000000011a67e
- (void)_removeArrangedSubview:(id)arg1;	// IMP=0x000000000011a5a3
- (void)_insertArrangedSubview:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x000000000011a4ea
- (void)_applyShapeStyle;	// IMP=0x000000000011a10f
- (void)_updateStackLayoutIfNeeded;	// IMP=0x0000000000119a62
@property(readonly, copy) NSString *debugDescription;
- (void)reevaluateHiddenStateOfAllItems;	// IMP=0x00000000001198aa
- (void)setRowSpacing:(double)arg1 afterRow:(unsigned long long)arg2;	// IMP=0x00000000001197c1
- (_Bool)hasVisibleArrangedSubview;	// IMP=0x0000000000119640
@property(nonatomic) struct NSDirectionalEdgeInsets contentLayoutMargins;
- (void)setArrangedSubviews:(id)arg1;	// IMP=0x00000000001190c2
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000119050
- (id)backgroundColor;	// IMP=0x0000000000119000
- (void)setNeedsLayout;	// IMP=0x0000000000118fba
- (double)layoutHeightThatFitsRowsStartingWithRow:(unsigned long long)arg1;	// IMP=0x0000000000118f33
- (id)prioritizedSizeThatFitsSize:(struct CGSize)arg1;	// IMP=0x0000000000118eb7
- (void)layoutSubviews;	// IMP=0x00000000001188cd
- (id)init;	// IMP=0x000000000011889b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000011858f
