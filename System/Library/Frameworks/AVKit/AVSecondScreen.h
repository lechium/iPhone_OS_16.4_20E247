...
- (void).cxx_destruct;	// IMP=0x0000000000036974
...
- (_Bool)_isWindowSceneAvailable;	// IMP=0x0000000000036865
- (void)_updatePreferredDisplayCriteria;	// IMP=0x0000000000036793
@property(readonly, nonatomic) struct CGRect sceneBounds;
- (_Bool)isAvailable;	// IMP=0x00000000000366f0
- (void)setState:(long long)arg1;	// IMP=0x00000000000364b0
- (void)connectWithSecondScreenConnection:(id)arg1;	// IMP=0x0000000000035fac
- (void)dealloc;	// IMP=0x0000000000035ea5
- (id)initWithScene:(id)arg1;	// IMP=0x0000000000035b5f
