...
- (void).cxx_destruct;	// IMP=0x000000000003b839
...
- (double)rate;	// IMP=0x000000000003b7ae
- (long long)timeControlStatus;	// IMP=0x000000000003b7a3
- (long long)status;	// IMP=0x000000000003b798
- (_Bool)isPlaying;	// IMP=0x000000000003b790
