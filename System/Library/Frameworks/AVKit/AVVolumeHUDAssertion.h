...
- (void).cxx_destruct;	// IMP=0x00000000000d95b1
...
- (id)_systemController;	// IMP=0x00000000000d9514
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d9203
- (id)initWithSceneIdentifier:(id)arg1 clientIdentifier:(id)arg2;	// IMP=0x00000000000d9166
