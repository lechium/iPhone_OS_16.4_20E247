...
- (void).cxx_destruct;	// IMP=0x0000000000117975
...
- (void)linkFired:(id)arg1;	// IMP=0x00000000001177ea
- (void)invalidate;	// IMP=0x0000000000117781
- (void)startDisplayLinkUpdatesForObserver:(id)arg1 framesPerSecond:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000117619
