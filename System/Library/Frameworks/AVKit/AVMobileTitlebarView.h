...
@class AVButton, AVMobileChromelessControlsStyleSheet, AVMobileContentTag, AVMobileContentTagView, CAGradientLayer, NSString, UILabel, UIView;
...
- (void).cxx_destruct;	// IMP=0x00000000000073fe
...
- (void)_infoAffordancePressed:(id)arg1;	// IMP=0x0000000000007339
- (void)avkit_intrinsicContentSizeOfSubviewWasInvalidated:(id)arg1;	// IMP=0x0000000000007327
- (void)layoutSubviews;	// IMP=0x00000000000060ca
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000005ec5
- (void)didMoveToWindow;	// IMP=0x0000000000005e99
- (id)initWithStyleSheet:(id)arg1;	// IMP=0x0000000000005a5d
