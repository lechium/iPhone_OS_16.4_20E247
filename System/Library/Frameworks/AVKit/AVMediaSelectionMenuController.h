...
- (void).cxx_destruct;	// IMP=0x000000000001e25d
...
- (void)_updateSelectionStateForMenu:(id)arg1 selectedIndex:(unsigned long long)arg2;	// IMP=0x000000000001dfc5
- (id)_menuForOptions:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000000001db09
- (id)_displayNameForMediaSelectionOption:(id)arg1;	// IMP=0x000000000001da2e
@property(readonly, nonatomic) UIMenu *legibleOptionsMenu;
@property(readonly, nonatomic) UIMenu *audibleOptionsMenu;
- (id)initWithAudibleOptions:(id)arg1 legibleOptions:(id)arg2;	// IMP=0x000000000001d750
