...
- (void).cxx_destruct;	// IMP=0x00000000000e304f
...
- (void)_updateStatusBarBackgroundGradientViewAlpha;	// IMP=0x00000000000e2847
- (void)didMoveToSuperview;	// IMP=0x00000000000e2806
- (void)didMoveToWindow;	// IMP=0x00000000000e27c5
- (void)layoutSubviews;	// IMP=0x00000000000e2203
- (void)removeAllSublayerTransformAnimations;	// IMP=0x00000000000e2199
- (void)setVideoGravity:(long long)arg1 removingAllSublayerTransformAnimations:(_Bool)arg2;	// IMP=0x00000000000e20e2
@property(readonly, nonatomic) AVPlaybackContentContainerView *activeContentView;
- (void)dealloc;	// IMP=0x00000000000e1c03
- (id)initWithFrame:(struct CGRect)arg1 playerLayerView:(id)arg2 contentOverlayView:(id)arg3;	// IMP=0x00000000000e1a27
- (id)initWithFrame:(struct CGRect)arg1 activeContentView:(id)arg2;	// IMP=0x00000000000e1979
