...
- (void)_handleValueChangeForKeyPath:(id)arg1 ofObject:(id)arg2 oldValue:(id)arg3 newValue:(id)arg4 context:(void *)arg5;	// IMP=0x00000000000328ee
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000327cf
- (void)stopObserving;	// IMP=0x000000000003266c
- (void)startObserving:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000322c9
- (id)initWithObservedObject:(id)arg1 observer:(id)arg2 keyPaths:(id)arg3 retainingObservedObject:(_Bool)arg4 includeInitialValue:(_Bool)arg5 includeChanges:(_Bool)arg6 changesBlock:(CDUnknownBlockType)arg7;	// IMP=0x000000000003216a
