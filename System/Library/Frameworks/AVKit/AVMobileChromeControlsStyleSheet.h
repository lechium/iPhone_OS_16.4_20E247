...
- (void).cxx_destruct;	// IMP=0x000000000004cd8e
...
- (double)standardPaddingInline;	// IMP=0x000000000004cb60
- (double)standardPaddingFullScreen;	// IMP=0x000000000004cb4e
- (struct UIEdgeInsets)embeddedInlineInsets;	// IMP=0x000000000004cb2e
- (struct UIEdgeInsets)portraitFullscreenInsets;	// IMP=0x000000000004cb0e
- (struct UIEdgeInsets)landscapeFullscreenInsets;	// IMP=0x000000000004caee
...
- (id)initWithTraitCollection:(id)arg1 shouldUseCompactFullScreenSize:(_Bool)arg2;	// IMP=0x000000000004c45f
