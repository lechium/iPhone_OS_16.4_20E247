...
- (void).cxx_destruct;	// IMP=0x000000000004ba6c
...
- (_Bool)_subviewIsCustomMenuItemView:(id)arg1;	// IMP=0x000000000004b626
...
- (void)_updateCustomContentTransitioningInfoPanelLayout;	// IMP=0x000000000004ad9f
- (void)_updateVolumeControllerLayout;	// IMP=0x000000000004ad99
- (id)_scrubInstructionsAttributedText;	// IMP=0x000000000004ab26
- (void)_updateScrubInstructionsFrame;	// IMP=0x000000000004a69e
- (void)_updateScrubInstructionsLabelsText;	// IMP=0x000000000004a4c6
- (void)_showScrubInstructions;	// IMP=0x000000000004a2a5
- (void)_updateFontSizes;	// IMP=0x000000000004a070
- (unsigned long long)_layoutItemDisplayPriorityForSubview:(id)arg1;	// IMP=0x0000000000049d61
- (double)_rowSpacingForDoubleRowLayoutAfterRow:(unsigned long long)arg1;	// IMP=0x0000000000049bcf
- (void)_layoutSingleRowViews;	// IMP=0x00000000000494a4
- (void)_layoutDoubleRowViews;	// IMP=0x00000000000485c8
- (double)_doubleRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x00000000000480f0
- (double)_singeRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x0000000000047d0f
- (void)endScrubbing:(id)arg1;	// IMP=0x0000000000047baa
- (void)scrubberValueChanged:(id)arg1;	// IMP=0x0000000000047b25
- (void)beginScrubbing:(id)arg1;	// IMP=0x0000000000047a51
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (void)scrubberSlowKnobMovementDetected:(id)arg1;	// IMP=0x0000000000047799
- (void)avkit_reevaluateHiddenStateOfItem:(id)arg1;	// IMP=0x0000000000047681
- (void)layoutSubviews;	// IMP=0x0000000000046cda
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000046c99
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000046943
- (double)layoutHeightThatFitsRowsStartingWithRow:(unsigned long long)arg1;	// IMP=0x00000000000468ec
- (void)reevaluateHiddenStateOfAllItems;	// IMP=0x00000000000468af
- (float)volumeControlsControllerTransportBarHeight:(id)arg1;	// IMP=0x00000000000463f7
- (id)initWithFrame:(struct CGRect)arg1 styleSheet:(id)arg2;	// IMP=0x00000000000458a7
