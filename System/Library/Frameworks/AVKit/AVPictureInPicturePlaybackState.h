...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042019
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004200e
- (id)initWithElapsedTime:(double)arg1 timelineDuration:(double)arg2 timelineRate:(double)arg3 paused:(_Bool)arg4;	// IMP=0x0000000000041f1e
