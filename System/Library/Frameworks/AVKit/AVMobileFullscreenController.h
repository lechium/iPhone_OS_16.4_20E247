...
- (void).cxx_destruct;	// IMP=0x000000000008d9cc
...
- (void)updatePresentationStateTo:(unsigned long long)arg1;	// IMP=0x000000000008d85b
- (void)enterFullscreen:(id)arg1;	// IMP=0x000000000008d801
- (void)exitFullscreen:(id)arg1;	// IMP=0x000000000008d7a7
- (id)initWithPlayerViewController:(id)arg1;	// IMP=0x000000000008d783
