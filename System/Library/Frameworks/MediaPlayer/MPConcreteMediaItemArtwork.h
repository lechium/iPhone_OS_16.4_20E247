...
- (void).cxx_destruct;	// IMP=0x000000000013afd9
@property(readonly, nonatomic) MPArtworkCatalog *artworkCatalog;
- (struct CGRect)bounds;	// IMP=0x000000000013ae72
- (id)initWithArtworkCatalog:(id)arg1;	// IMP=0x000000000013ae5e
- (id)initWithArtworkCatalog:(id)arg1 allowsNetworking:(_Bool)arg2;	// IMP=0x000000000013ad88
