...
- (void).cxx_destruct;	// IMP=0x000000000027744a
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x000000000027735a
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x0000000000277269
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x0000000000276f50
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x0000000000276d5e
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x0000000000276a44
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x0000000000275e78
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x000000000027515f
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x0000000000274a6e
- (void)_parse;	// IMP=0x0000000000274875
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x000000000027463f
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x0000000000274559
