...
- (void).cxx_destruct;	// IMP=0x000000000031e573
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x000000000031e3e0
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x000000000031e269
- (id)initWithDownload:(id)arg1;	// IMP=0x000000000031e159
