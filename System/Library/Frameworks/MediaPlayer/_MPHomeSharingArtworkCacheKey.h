...
- (unsigned long long)hash;	// IMP=0x0000000000267520
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026743a
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x00000000002673df
