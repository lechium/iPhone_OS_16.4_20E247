...
- (void).cxx_destruct;	// IMP=0x000000000006a22b
...
- (id)nextObject;	// IMP=0x000000000006a0a4
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x0000000000069b46
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000006916e
