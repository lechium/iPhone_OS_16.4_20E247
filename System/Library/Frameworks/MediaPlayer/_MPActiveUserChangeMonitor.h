...
- (void).cxx_destruct;	// IMP=0x000000000026aaba
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x000000000026a873
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000026a623
- (void)ingestNotificationName:(id)arg1;	// IMP=0x000000000026a24b
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000026a0ec
