...
- (void).cxx_destruct;	// IMP=0x00000000001b3fdb
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x00000000001b3d19
- (id)_parsedElements:(id)arg1;	// IMP=0x00000000001b3aee
- (id)_parsedSectionedCollection;	// IMP=0x00000000001b331c
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x00000000001b31bb
