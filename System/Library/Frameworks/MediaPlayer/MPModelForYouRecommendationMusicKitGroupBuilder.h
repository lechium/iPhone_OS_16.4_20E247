...
+ (id)allSupportedItemProperties;	// IMP=0x00600000001f6b9e
+ (id)allSupportedGroupProperties;	// IMP=0x00600000001f6aa3
- (void).cxx_destruct;	// IMP=0x00000000001f5057
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001f4cba
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001f4b94
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001f4a6e
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001f477e
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001f4636
