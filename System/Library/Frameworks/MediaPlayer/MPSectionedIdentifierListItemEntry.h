...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000079a80
+ (id)itemEntryWithSectionIdentifier:(id)arg1 itemIdentifier:(id)arg2;	// IMP=0x0010000000079a6b
+ (id)itemEntryWithSectionIdentifier:(id)arg1 itemIdentifier:(id)arg2 generationPrefix:(id)arg3;	// IMP=0x0010000000079930
...
- (long long)_generationNumber;	// IMP=0x000000000007979e
- (void)prepareForDealloc;	// IMP=0x0000000000079734
- (id)newClonedEntry;	// IMP=0x00000000000794f1
...
- (void)setUserCloned;	// IMP=0x0000000000078f2e
- (void)setUserMoved;	// IMP=0x0000000000078f1d
- (void)setUserRemoved;	// IMP=0x0000000000078f0c
- (void)setDataSourceMoved;	// IMP=0x0000000000078efb
- (void)setDataSourceCloned;	// IMP=0x0000000000078eea
- (_Bool)isDataSourceRemoved;	// IMP=0x0000000000078e77
- (void)setDataSourceRemoved;	// IMP=0x0000000000078e04
- (id)stringRepresentation;	// IMP=0x0000000000078ced
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)_stateDumpObject;	// IMP=0x00000000000788b0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000787a2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000078682
