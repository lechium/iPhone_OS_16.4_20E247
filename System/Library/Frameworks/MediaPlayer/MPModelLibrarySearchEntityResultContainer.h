...
- (id).cxx_construct;	// IMP=0x000000000027f89b
- (void).cxx_destruct;	// IMP=0x000000000027f86a
...
- (id)initWithEntityQueryResult:(shared_ptr_274c5e8b)arg1 forScope:(id)arg2 entityTranslationContext:(id)arg3;	// IMP=0x000000000027f76b
