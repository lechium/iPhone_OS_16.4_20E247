...
+ (id)allSupportedProperties;	// IMP=0x0060000000185af7
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000185bc8
