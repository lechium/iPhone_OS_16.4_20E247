...
- (void).cxx_destruct;	// IMP=0x00000000002621af
...
- (void)resolveError:(id)arg1;	// IMP=0x000000000026218a
- (id)initWithStoreAccountIdentifier:(id)arg1;	// IMP=0x000000000026211c
