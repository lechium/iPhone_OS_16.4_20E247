...
+ (id)allSupportedItemProperties;	// IMP=0x006000000024a228
+ (id)allSupportedGroupProperties;	// IMP=0x006000000024a14e
- (void).cxx_destruct;	// IMP=0x00000000002496fd
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000249219
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x0000000000249104
