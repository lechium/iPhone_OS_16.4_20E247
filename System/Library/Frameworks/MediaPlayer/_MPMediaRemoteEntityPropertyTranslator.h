...
+ (id)translatorWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044a97
+ (id)translatorWithKeyPath:(id)arg1;	// IMP=0x0010000000044a5c
- (void).cxx_destruct;	// IMP=0x0000000000044b4e
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x0000000000044aef
