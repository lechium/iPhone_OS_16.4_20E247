...
+ (id)endEntry;	// IMP=0x001000000006a530
+ (id)startEntry;	// IMP=0x001000000006a50f
...
- (id)trackingEntryResult;	// IMP=0x000000000006a4f5
- (id)itemResult;	// IMP=0x000000000006a4ed
