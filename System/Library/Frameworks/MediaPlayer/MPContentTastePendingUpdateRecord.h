...
- (void).cxx_destruct;	// IMP=0x00000000002d66c8
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d6655
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d65ef
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d655b
