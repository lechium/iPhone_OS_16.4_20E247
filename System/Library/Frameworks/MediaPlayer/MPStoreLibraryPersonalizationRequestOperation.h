...
+ (id)personalizedResponseForContentDescriptor:(id)arg1 requestedProperties:(id)arg2;	// IMP=0x00600000001a5d44
- (void).cxx_destruct;	// IMP=0x00000000001a3e29
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPStoreLibraryPersonalizationRequest *request; // @synthesize request=_request;
- (void)execute;	// IMP=0x00000000001a2a9d
- (void)cancel;	// IMP=0x00000000001a2a54
