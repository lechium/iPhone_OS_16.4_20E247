...
- (void).cxx_destruct;	// IMP=0x000000000017558b
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x00000000001754d7
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x00000000001754c1
