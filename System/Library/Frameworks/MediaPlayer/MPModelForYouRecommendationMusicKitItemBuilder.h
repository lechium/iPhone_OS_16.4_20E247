...
+ (id)allSupportedProperties;	// IMP=0x0060000000238cad
- (void).cxx_destruct;	// IMP=0x00000000002389fe
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x00000000002387e9
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x000000000023875a
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000237bad
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x0000000000237aa8
