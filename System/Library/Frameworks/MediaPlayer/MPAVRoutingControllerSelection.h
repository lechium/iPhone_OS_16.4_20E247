...
- (void).cxx_destruct;	// IMP=0x000000000008beda
...
- (id)description;	// IMP=0x000000000008be27
- (id)initWithRoutes:(id)arg1 selectionOperation:(long long)arg2;	// IMP=0x000000000008bdb1
