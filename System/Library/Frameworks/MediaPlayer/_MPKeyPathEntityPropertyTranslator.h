...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x001000000019fe35
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000019fda3
- (void).cxx_destruct;	// IMP=0x000000000019fd7b
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x000000000019fd29
