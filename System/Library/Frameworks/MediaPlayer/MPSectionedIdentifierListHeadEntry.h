...
+ (id)headEntryWithSectionIdentifier:(id)arg1;	// IMP=0x00100000000785f3
- (void).cxx_destruct;	// IMP=0x00000000000785a0
...
- (void)setBranchDepth:(long long)arg1;	// IMP=0x00000000000784aa
- (id)nextEntries;	// IMP=0x0000000000078403
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)initWithPositionKey:(id)arg1 sectionIdentifier:(id)arg2;	// IMP=0x0000000000078298
