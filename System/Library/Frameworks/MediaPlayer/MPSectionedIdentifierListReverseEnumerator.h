...
- (void).cxx_destruct;	// IMP=0x000000000006b5ba
...
- (id)_startEntryProxy;	// IMP=0x000000000006b4a2
- (id)nextObject;	// IMP=0x000000000006b3bd
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000006a9ed
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000006a61d
