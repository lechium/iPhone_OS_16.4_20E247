...
- (void)addToLocalDeviceLibraryGlobalPlaylistWithID:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
...
- (void)performStoreArtistLibraryImport:(MPStoreItemLibraryImport *)arg1 withCompletion:(void (^)(NSError *))arg2;
