...
- (id).cxx_construct;	// IMP=0x000000000004b047
- (void).cxx_destruct;	// IMP=0x000000000004b01e
...
- (void)dataStatus:(id)arg1 dataStatusInfo:(id)arg2;	// IMP=0x000000000004af04
- (void)dealloc;	// IMP=0x000000000004aec8
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000004ae50
