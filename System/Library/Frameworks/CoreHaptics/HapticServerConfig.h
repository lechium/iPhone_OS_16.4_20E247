...
- (id).cxx_construct;	// IMP=0x0000000000007c51
- (void).cxx_destruct;	// IMP=0x0000000000007bfe
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000056c2
