...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001143e
...
- (void)dealloc;	// IMP=0x000000000001166a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000011517
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011446
