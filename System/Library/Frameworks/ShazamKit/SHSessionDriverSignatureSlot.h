...
@interface SHSessionDriverSignatureSlot : NSObject
{
    ...
    SHSignature *_generatedSignature;	// 40 = 0x28
}
...
- (long long)appendBuffer:(id)arg1 atTime:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000004a3a
...
- (void)reset;	// IMP=0x000000000000483b
- (id)initWithMaximumSignatureDuration:(double)arg1;	// IMP=0x0000000000004796
