...
+ (double)nextEventForRange:(id)arg1 atMatchOffset:(double)arg2;	// IMP=0x006000000000ea29
+ (double)countdownForMatchedMediaItem:(id)arg1;	// IMP=0x006000000000e711
+ (id)blankMediaItemWhenNothingIsInScope:(id)arg1;	// IMP=0x006000000000e4db
...
- (id)earliestInscopeRangeForMatchedMediaItem:(id)arg1;	// IMP=0x000000000000e2b4
- (id)sortMediaItems:(id)arg1;	// IMP=0x000000000000e0b9
@property(readonly, nonatomic) NSArray *inScopeMediaItems;
@property(readonly, nonatomic) NSNumber *timeToNextMediaItemScopeChange;
- (void)cancelTimerSource;	// IMP=0x000000000000db41
- (void)startTimerForNextEvent;	// IMP=0x000000000000d8a9
- (_Bool)finished;	// IMP=0x000000000000d876
- (void)stopGenerating;	// IMP=0x000000000000d864
- (void)startGenerating;	// IMP=0x000000000000d852
- (id)initWithMatch:(id)arg1;	// IMP=0x000000000000d6db
- (void)dealloc;	// IMP=0x000000000000d69d
