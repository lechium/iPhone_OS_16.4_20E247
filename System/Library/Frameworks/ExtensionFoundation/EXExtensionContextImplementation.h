...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x001000000000fa20
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000fa18
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x001000000000f991
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000f841
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x001000000000f7bb
+ (id)_extensionContextHostProtocolWithAllowedPayloadCompletionClasses:(id)arg1 AllowedErrorClasses:(id)arg2;	// IMP=0x001000000000f428
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x001000000000f1f3
- (void).cxx_destruct;	// IMP=0x00000000000126e8
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000122c6
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x00000000000122bb
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012152
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011ecb
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011d60
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011a22
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000117a8
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x00000000000114ce
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000010b90
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010b85
- (_Bool)_isHost;	// IMP=0x0000000000010b52
- (void)dealloc;	// IMP=0x0000000000010afd
- (void)invalidate;	// IMP=0x00000000000109ed
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000000104d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010457
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001044c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000102f8
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x000000000000fce6
