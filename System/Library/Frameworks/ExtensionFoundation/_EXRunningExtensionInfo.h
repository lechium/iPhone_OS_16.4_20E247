...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x001000000001a4a7
+ (void)notifyExtensionMainCalled;	// IMP=0x001000000001a476
- (void).cxx_destruct;	// IMP=0x000000000001a7a9
...
- (id)initForCurrentProcess;	// IMP=0x000000000001a522
