...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x0000000000023313
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x0000000000022fc3
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x0000000000022ed7
- (id)initWithResourceDir:(id)arg1;	// IMP=0x0000000000022e75
- (void)dealloc;	// IMP=0x0000000000022e08
