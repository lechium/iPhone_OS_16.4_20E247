...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002ab012
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002aaedd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002aadaf
- (id)description;	// IMP=0x00000000002aad18
- (void)dealloc;	// IMP=0x00000000002aacab
