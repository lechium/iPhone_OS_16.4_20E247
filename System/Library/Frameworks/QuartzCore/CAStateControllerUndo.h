...
- (void)dealloc;	// IMP=0x0000000000026eac
- (void)addTransition:(id)arg1;	// IMP=0x0000000000026e6f
- (void)willAddLayer:(id)arg1;	// IMP=0x0000000000026e69
- (void)addElement:(id)arg1;	// IMP=0x0000000000026e2c
