...
- (void).cxx_destruct;	// IMP=0x0000000000ec988c
- (id)init;	// IMP=0x0000000000ec983d
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x0000000000ec9789
