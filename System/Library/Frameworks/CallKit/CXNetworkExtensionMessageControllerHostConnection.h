...
- (void).cxx_destruct;	// IMP=0x00000000000581c8
...
- (void)sendNetworkExtensionPushToTalkMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000000057f7a
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000000057e09
- (void)invalidate;	// IMP=0x0000000000057da9
...
- (void)dealloc;	// IMP=0x0000000000057cc7
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000005788c
