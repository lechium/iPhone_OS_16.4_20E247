...
- (void).cxx_destruct;	// IMP=0x000000000004da6a
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000004d869
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x000000000004d763
- (oneway void)removeCall:(id)arg1;	// IMP=0x000000000004d6f1
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x000000000004d67f
...
- (void)dealloc;	// IMP=0x000000000004d42d
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x000000000004cdfe
- (id)init;	// IMP=0x000000000004cdf0
