...
- (void).cxx_destruct;	// IMP=0x00000000000d7200
...
- (id)description;	// IMP=0x00000000000d718d
...
- (void)cancel;	// IMP=0x00000000000d713a
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x00000000000d70aa
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x00000000000d6fb9
