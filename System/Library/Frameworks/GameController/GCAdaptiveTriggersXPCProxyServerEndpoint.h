...
- (void).cxx_destruct;	// IMP=0x000000000009e223
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000009e121
- (void)invalidateConnection;	// IMP=0x000000000009e06e
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x000000000009df70
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000009dec7
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000009daa1
- (void)invalidateClient;	// IMP=0x000000000009d9e0
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x000000000009d924
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000009d824
