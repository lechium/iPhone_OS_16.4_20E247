...
- (void).cxx_destruct;	// IMP=0x00000000000920da
...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x0000000000091d3d
- (void)dealloc;	// IMP=0x0000000000091ce4
- (id)init;	// IMP=0x0000000000091cb9
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000916a6
