...
- (void).cxx_destruct;	// IMP=0x000000000008e8d9
...
- (void)processChangedElements:(id)arg1 atTimestamp:(unsigned long long)arg2;	// IMP=0x000000000008df2b
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2 slidingWindowTotalDuration:(double)arg3 slidingWindowSegmentDuration:(double)arg4 deadzone:(double)arg5 sensitivity:(int)arg6;	// IMP=0x000000000008dd42
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000008dd0f
