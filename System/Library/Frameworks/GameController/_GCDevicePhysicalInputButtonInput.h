...
- (void)invokeCallbacksForInputChangedState:(unsigned char)arg1 withElement:(id)arg2;	// IMP=0x0000000000017774
...
- (id)init;	// IMP=0x0000000000017417
- (id)initWith:(id)arg1 context:(id)arg2;	// IMP=0x00000000000172c1
- (id)initWithParams:(struct _GCDevicePhysicalInputButtonInputParams)arg1;	// IMP=0x000000000001726a
