...
- (void).cxx_destruct;	// IMP=0x000000000009cd70
- (void)stopAllHaptics;	// IMP=0x000000000009cc55
- (_Bool)hasClients;	// IMP=0x000000000009cc38
- (void)unregisterHapticClient:(id)arg1;	// IMP=0x000000000009cc22
- (void)registerHapticClient:(id)arg1;	// IMP=0x000000000009cc0c
- (id)initWithIdentifier:(id)arg1 clientConnection:(id)arg2;	// IMP=0x000000000009ca3b
