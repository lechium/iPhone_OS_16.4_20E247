...
- (double)lastEventTimestamp;	// IMP=0x000000000009f729
- (_Bool)isSnapshot;	// IMP=0x000000000009f6cf
- (id)popTransaction;	// IMP=0x000000000009f366
- (void)setDevice:(id)arg1;	// IMP=0x000000000009f244
- (void)dealloc;	// IMP=0x000000000009f06d
- (id)initWithFacade:(id)arg1 elements:(id)arg2;	// IMP=0x000000000009eef0
