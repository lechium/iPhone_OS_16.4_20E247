...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000e3f69
...
- (id)debugDescription;	// IMP=0x00000000000e3f11
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e3e41
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e3d4b
