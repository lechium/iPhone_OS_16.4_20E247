...
- (void).cxx_destruct;	// IMP=0x0000000000022a54
...
- (id)observeKeyboardEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000226b7
- (void)dealloc;	// IMP=0x000000000002265e
- (id)init;	// IMP=0x0000000000022633
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x0000000000022303
