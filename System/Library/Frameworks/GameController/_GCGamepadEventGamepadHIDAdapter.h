...
- (void).cxx_destruct;	// IMP=0x00000000000729a4
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x0000000000072607
- (void)dealloc;	// IMP=0x00000000000725ae
- (id)init;	// IMP=0x0000000000072583
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000722ad
