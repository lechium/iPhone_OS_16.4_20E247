...
- (void).cxx_destruct;	// IMP=0x00000000000d467e
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d45b2
- (void)invalidateConnection;	// IMP=0x00000000000d44ff
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d4456
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000d43a8
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000d3fb7
- (void)invalidateClient;	// IMP=0x00000000000d3ef6
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000d3e5c
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000d3ddc
