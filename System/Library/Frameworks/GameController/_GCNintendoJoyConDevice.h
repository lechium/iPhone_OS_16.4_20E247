...
- (void).cxx_destruct;	// IMP=0x0000000000033895
...
- (void)playerIndicatorXPCProxyServerEndpoint:(id)arg1 didReceivePlayerIndexChange:(long long)arg2;	// IMP=0x00000000000336bf
- (void)activateLogical;	// IMP=0x00000000000336a8
@property(readonly) NSSet *underlyingDevices;
- (id)propertyForKey:(id)arg1;	// IMP=0x0000000000033636
...
- (void)setDriverConnection:(id)arg1;	// IMP=0x0000000000032cf9
- (id)init;	// IMP=0x0000000000032cce
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2 type:(unsigned char)arg3;	// IMP=0x0000000000032a70
- (id)makeControllerForClient:(id)arg1;	// IMP=0x0000000000033ce2
- (void)_removeClient:(id)arg1;	// IMP=0x0000000000033bca
- (void)_addClient:(id)arg1;	// IMP=0x0000000000033932
...
- (void)propagateBattery:(id)arg1;	// IMP=0x0000000000034a72
- (id)readBattery;	// IMP=0x00000000000348c8
...
- (void)homeButtonLongPressGesture:(_Bool)arg1;	// IMP=0x0000000000034e76
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x0000000000034f0c
- (id)hapticDriver;	// IMP=0x0000000000034f68
