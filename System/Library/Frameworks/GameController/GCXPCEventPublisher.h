...
- (void).cxx_destruct;	// IMP=0x000000000004d144
...
- (void)sendEvent:(id)arg1 toSubscriber:(id)arg2;	// IMP=0x000000000004ce1a
- (void)sendEvent:(id)arg1;	// IMP=0x000000000004c9ed
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000000004c587
- (id)initWithStreamName:(id)arg1 isStatefulEventPublisher:(_Bool)arg2;	// IMP=0x000000000004c247
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000000004c233
