...
- (void).cxx_destruct;	// IMP=0x0000000000071b16
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000071a4a
- (void)invalidateConnection;	// IMP=0x0000000000071997
- (void)fetchProfileWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000718ee
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000071537
- (void)invalidateClient;	// IMP=0x0000000000071487
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForProfile:(id)arg1;	// IMP=0x00000000000713cb
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x0000000000071325
