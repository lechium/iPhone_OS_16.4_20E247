...
- (void).cxx_destruct;	// IMP=0x000000000009d7b1
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000009d6e7
- (void)invalidateConnection;	// IMP=0x000000000009d643
- (void)refreshStatuses;	// IMP=0x000000000009d516
- (void)newStatuses:(id)arg1;	// IMP=0x000000000009d3f8
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x000000000009d2aa
- (void)setController:(id)arg1;	// IMP=0x000000000009d204
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000009cfdc
- (id)init;	// IMP=0x000000000009cfb1
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000009cdc4
