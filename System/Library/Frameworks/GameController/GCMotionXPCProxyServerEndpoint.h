...
- (void).cxx_destruct;	// IMP=0x0000000000026ba8
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000026add
- (void)invalidateConnection;	// IMP=0x0000000000026a2a
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000026981
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x00000000000268d7
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000264e7
- (void)invalidateClient;	// IMP=0x0000000000026426
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x000000000002638c
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x000000000002630c
