...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000b5585
- (void).cxx_destruct;	// IMP=0x00000000000b584c
- (id)materializeWithContext:(id)arg1;	// IMP=0x00000000000b57a0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b5732
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b5649
- (id)init;	// IMP=0x00000000000b5626
- (id)initWithConfiguration:(id)arg1 source:(id)arg2;	// IMP=0x00000000000b558d
