...
- (void).cxx_destruct;	// IMP=0x000000000000a740
- (id)elementEnumerator;	// IMP=0x000000000000a71e
- (id)elementForAlias:(id)arg1;	// IMP=0x000000000000a6b4
- (id)elementAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000a685
- (unsigned long long)count;	// IMP=0x000000000000a663
