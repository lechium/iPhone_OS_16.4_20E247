...
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000006370e
- (id)airData;	// IMP=0x00000000000636e0
- (oneway void)release;	// IMP=0x000000000006362e
- (void)dealloc;	// IMP=0x0000000000063583
- (id)initWithURL:(id)arg1 device:(id)arg2 options:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x0000000000062d17
- (id)initWithLibrary:(struct MTLLibraryData *)arg1 binaryData:(id)arg2 device:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000062aec
