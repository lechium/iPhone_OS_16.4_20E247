...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000e0577
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000e04f8
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000e047d
- (void)dealloc;	// IMP=0x00000000000e041d
