...
- (id)description;	// IMP=0x00000000000eae00
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000eac1b
- (void)dealloc;	// IMP=0x00000000000eabd1
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x00000000000eab49
