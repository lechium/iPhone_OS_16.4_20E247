...
- (id)description;	// IMP=0x000000000005c36c
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x000000000005c203
- (id)describe;	// IMP=0x000000000005c176
- (void)dealloc;	// IMP=0x000000000005c12f
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x000000000005c0b1
