...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000e0067
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000dffa4
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000dff29
- (void)dealloc;	// IMP=0x00000000000dfead
