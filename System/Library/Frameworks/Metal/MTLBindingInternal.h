...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000ea605
- (id)dataTypeDescription;	// IMP=0x00000000000ea5f4
...
- (void)dealloc;	// IMP=0x00000000000ea2c1
@property(readonly) MTLStructType *structType; // @dynamic structType;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6 typeDescription:(id)arg7;	// IMP=0x00000000000ea1f9
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6;	// IMP=0x00000000000ea146
