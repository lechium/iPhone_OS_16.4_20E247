...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000064e49
@property(readonly) unsigned long long textureDataType;
@property(readonly, getter=isDepthTexture) _Bool depthTexture;
@property(readonly) unsigned long long textureType;
- (id)initWithName:(id)arg1 access:(unsigned long long)arg2 isActive:(_Bool)arg3 locationIndex:(unsigned long long)arg4 arraySize:(unsigned long long)arg5 dataType:(unsigned long long)arg6 textureType:(unsigned long long)arg7 isDepthTexture:(_Bool)arg8;	// IMP=0x0000000000064d28
