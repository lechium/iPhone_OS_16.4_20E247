...
+ (id)fromProto:(id)arg1;	// IMP=0x0060000000033e6e
+ (id)toProto:(id)arg1;	// IMP=0x0060000000033c57
- (void).cxx_destruct;	// IMP=0x000000000003412c
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000033943
- (id)init;	// IMP=0x0000000000033914
