...
+ (CDUnknownFunctionPointerType)recognizeFuncForCFStringEncoding:(unsigned int)arg1;	// IMP=0x00600000004c72c3
+ (id)detectorForCFStringEncoding:(unsigned int)arg1 allowBackupDetectors:(_Bool)arg2;	// IMP=0x00600000004c7228
...
- (unsigned long long)recognizeString:(const char *)arg1 withDataLength:(unsigned long long)arg2 intoBuffer:(id)arg3;	// IMP=0x00000000004c72af
- (double)multiBytesRatio;	// IMP=0x00000000004c71a4
- (double)_singleByte_confidence;	// IMP=0x00000000004c70d2
- (double)_ASCII_confidence;	// IMP=0x00000000004c7046
- (double)confidenceWith2Chars;	// IMP=0x00000000004c6fa7
- (double)confidence;	// IMP=0x00000000004c6e94
- (id)initWithNSStringEncoding:(unsigned long long)arg1 CFStringEncoding:(unsigned int)arg2 recognizeFunc:(CDUnknownFunctionPointerType)arg3;	// IMP=0x00000000004c6e04
- (unsigned long long)maxSkipBytes;	// IMP=0x00000000004c6dbf
- (double)bytesRatio;	// IMP=0x00000000004c6d72
- (void)softReset;	// IMP=0x00000000004c6d26
- (void)reset;	// IMP=0x00000000004c6cc8
