...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000043a072
...
- (void)dealloc;	// IMP=0x000000000043a433
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000043a336
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000043a07a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000439fb8
- (id)init;	// IMP=0x0000000000439f4a
