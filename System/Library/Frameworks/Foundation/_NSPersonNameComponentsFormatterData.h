...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005e2db5
...
- (void)dealloc;	// IMP=0x00000000005e3035
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005e2eb2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005e2dbd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005e2c51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005e2be8
