...
- (_Bool)classNameAllowed:(Class)arg1;	// IMP=0x0000000000478b8a
- (void)setAllowedClassNames:(id)arg1;	// IMP=0x0000000000478b55
- (id)allowedClassNames;	// IMP=0x0000000000478b3e
- (void)dealloc;	// IMP=0x0000000000478aca
- (id)init;	// IMP=0x0000000000478aa1
