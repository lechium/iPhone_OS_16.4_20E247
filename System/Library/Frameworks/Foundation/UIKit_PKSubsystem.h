...
+ (id)initForPlugInKit;	// IMP=0x00100000005e91d3
+ (id)initForPlugInKitWithOptions:(id)arg1;	// IMP=0x00100000005e91ba
+ (id)sharedInstance;	// IMP=0x00100000005e9122
...
- (void)endUsing:(id)arg1;	// IMP=0x00000000005e911c
- (void)beginUsing:(id)arg1 withBundle:(id)arg2;	// IMP=0x00000000005e8f01
- (void)dealloc;	// IMP=0x00000000005e8ea3
