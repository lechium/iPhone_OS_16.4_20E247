...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00600000004656f5
...
- (void)dealloc;	// IMP=0x0000000000465697
- (id)initWithIndex:(long long)arg1 specifierRangeInFormatString:(struct _NSRange)arg2 replacementRangeInResult:(struct _NSRange)arg3 replacementKind:(long long)arg4 argument:(id)arg5;	// IMP=0x00000000004655ea
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000004652ec
