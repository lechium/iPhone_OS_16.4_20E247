...
+ (id)classesForKey;	// IMP=0x006000000005e450
- (void).cxx_destruct;	// IMP=0x000000000005e62a
@property(copy, nonatomic) CalLocation *calLocation; // @synthesize calLocation=_calLocation;
- (id)createStructuredLocation;	// IMP=0x000000000005e5a5
- (id)initWithStructuredLocation:(id)arg1;	// IMP=0x000000000005e510
