...
- (void).cxx_destruct;	// IMP=0x000000000012bd7f
...
- (void)finishWithURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000012bb68
- (void)generateNewValidURLForOriginalURL:(id)arg1;	// IMP=0x000000000012b816
