...
+ (id)classesForKey;	// IMP=0x006000000001105b
- (void).cxx_destruct;	// IMP=0x00000000000118eb
...
- (id)createAttendee:(id *)arg1;	// IMP=0x00000000000114a8
- (id)initWithParticipant:(id)arg1;	// IMP=0x0000000000011326
