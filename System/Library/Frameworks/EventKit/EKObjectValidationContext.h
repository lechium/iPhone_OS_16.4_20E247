...
- (void).cxx_destruct;	// IMP=0x00000000000c2f9b
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x00000000000c2ee2
- (id)initWithRootObject:(id)arg1;	// IMP=0x00000000000c2e77
