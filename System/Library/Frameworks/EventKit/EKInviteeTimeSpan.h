...
- (void).cxx_destruct;	// IMP=0x00000000001383b7
...
- (id)description;	// IMP=0x00000000001381b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013809a
- (id)init;	// IMP=0x000000000013802f
