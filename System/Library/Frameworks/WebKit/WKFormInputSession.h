...
- (id).cxx_construct;	// IMP=0x00000000008ebf6e
- (void).cxx_destruct;	// IMP=0x00000000008ebefb
- (void)reloadFocusedElementContextView;	// IMP=0x00000000008ebedd
- (void)invalidate;	// IMP=0x00000000008ebe96
@property(readonly, nonatomic) _Bool requiresStrongPasswordAssistance;
@property(copy, nonatomic) NSArray *suggestions;
- (void)endEditing;	// IMP=0x00000000008ebdcf
...
- (id)initWithContentView:(id)arg1 focusedElementInfo:(id)arg2 requiresStrongPasswordAssistance:(_Bool)arg3;	// IMP=0x00000000008ebae6
