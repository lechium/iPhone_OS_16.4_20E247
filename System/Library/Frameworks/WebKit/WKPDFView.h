...
+ (_Bool)web_requiresCustomSnapshotting;	// IMP=0x0010000000455489
- (id).cxx_construct;	// IMP=0x0000000000456b7a
- (void).cxx_destruct;	// IMP=0x00000000004569b7
- (void)clearAllDecoratedFoundText;	// IMP=0x0000000000456970
- (void)decorateFoundTextRange:(id)arg1 inDocument:(id)arg2 usingStyle:(long long)arg3;	// IMP=0x00000000004568f4
- (void)performTextSearchWithQueryString:(id)arg1 usingOptions:(id)arg2 resultAggregator:(id)arg3;	// IMP=0x0000000000456834
- (long long)compareFoundRange:(id)arg1 toRange:(id)arg2 inDocument:(id)arg3;	// IMP=0x000000000045674b
- (void)scrollRangeToVisible:(id)arg1 inDocument:(id)arg2;	// IMP=0x0000000000456745
@property(readonly, nonatomic) _Bool supportsTextReplacement;
@property(readonly) UITextRange *selectedTextRange;
- (id)dataDetectionContextForActionSheetAssistant:(id)arg1 positionInformation:(const void *)arg2;	// IMP=0x00000000004566c8
- (RetainPtr_f649c0c3)actionSheetAssistant:(id)arg1 decideActionsForElement:(id)arg2 defaultActions:(RetainPtr_f649c0c3)arg3;	// IMP=0x0000000000456606
- (_Bool)actionSheetAssistant:(id)arg1 shouldIncludeAppLinkActionsForElement:(id)arg2;	// IMP=0x00000000004565a9
- (void)shareSheetDidDismiss:(id)arg1;	// IMP=0x0000000000456566
- (void)actionSheetAssistant:(id)arg1 shareElementWithURL:(id)arg2 rect:(struct CGRect)arg3;	// IMP=0x000000000045628f
- (void)actionSheetAssistant:(id)arg1 openElementAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000456243
- (void)actionSheetAssistant:(id)arg1 performAction:(_Bool)arg2;	// IMP=0x000000000045613f
...
- (void)pdfHostViewControllerExtensionProcessDidCrash:(id)arg1;	// IMP=0x0000000000456045
- (void)pdfHostViewController:(id)arg1 didLongPressPageIndex:(long long)arg2 atLocation:(struct CGPoint)arg3 withAnnotationRect:(struct CGRect)arg4;	// IMP=0x0000000000455ff5
- (void)pdfHostViewController:(id)arg1 didLongPressURL:(id)arg2 atLocation:(struct CGPoint)arg3 withAnnotationRect:(struct CGRect)arg4;	// IMP=0x0000000000455fe0
- (void)_showActionSheetForURL:(id)arg1 atLocation:(struct CGPoint)arg2 withAnnotationRect:(struct CGRect)arg3;	// IMP=0x0000000000455c7f
- (void)pdfHostViewController:(id)arg1 goToPageIndex:(long long)arg2 withViewFrustum:(struct CGRect)arg3;	// IMP=0x0000000000455c41
- (void)pdfHostViewController:(id)arg1 goToURL:(id)arg2;	// IMP=0x0000000000455c26
- (void)_goToURL:(id)arg1 atLocation:(struct CGPoint)arg2;	// IMP=0x00000000004559ed
- (id)_URLWithPageIndex:(long long)arg1;	// IMP=0x0000000000455977
- (void)pdfHostViewController:(id)arg1 findStringUpdate:(unsigned long long)arg2 done:(_Bool)arg3;	// IMP=0x00000000004557d1
- (void)pdfHostViewController:(id)arg1 documentDidUnlockWithPassword:(id)arg2;	// IMP=0x0000000000455752
- (void)pdfHostViewController:(id)arg1 updatePageCount:(long long)arg2;	// IMP=0x0000000000455702
...
- (void)web_snapshotRectInContentViewCoordinates:(struct CGRect)arg1 snapshotWidth:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000045557d
- (void)web_beginAnimatedResizeWithUpdates:(CDUnknownBlockType)arg1;	// IMP=0x0000000000455532
- (void)web_scrollViewDidZoom:(id)arg1;	// IMP=0x0000000000455515
- (void)web_scrollViewDidEndZooming:(id)arg1 withView:(id)arg2 atScale:(double)arg3;	// IMP=0x00000000004554f8
- (void)web_scrollViewWillBeginZooming:(id)arg1 withView:(id)arg2;	// IMP=0x00000000004554db
- (void)web_scrollViewDidScroll:(id)arg1;	// IMP=0x00000000004554be
@property(readonly, nonatomic) UIView *web_contentView;
- (void)web_hideFindUI;	// IMP=0x0000000000455465
- (void)web_findString:(id)arg1 options:(unsigned long long)arg2 maxCount:(unsigned long long)arg3;	// IMP=0x0000000000455397
- (void)_focusOnSearchResultWithOptions:(unsigned long long)arg1;	// IMP=0x00000000004551b8
- (_Bool)_computeFocusedSearchResultIndexWithOptions:(unsigned long long)arg1 didWrapAround:(_Bool *)arg2;	// IMP=0x00000000004550ea
- (void)web_countStringMatches:(id)arg1 options:(unsigned long long)arg2 maxCount:(unsigned long long)arg3;	// IMP=0x0000000000454fc0
- (void)_findString:(id)arg1 withOptions:(unsigned long long)arg2 maxCount:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000454ee4
- (void)_resetFind;	// IMP=0x0000000000454e1e
- (void)web_didSameDocumentNavigation:(unsigned int)arg1;	// IMP=0x0000000000454dc8
- (void)_scrollToURLFragment:(id)arg1;	// IMP=0x0000000000454d0c
- (void)web_setFixedOverlayView:(id)arg1;	// IMP=0x0000000000454cc5
- (void)web_computedContentInsetDidChange;	// IMP=0x0000000000454cb1
- (void)web_setOverlaidAccessoryViewsInset:(struct CGSize)arg1;	// IMP=0x0000000000454c88
- (void)web_setMinimumSize:(struct CGSize)arg1;	// IMP=0x0000000000454bf2
- (void)_updateLayoutAnimated:(_Bool)arg1;	// IMP=0x0000000000454b9d
- (void)_movePageNumberIndicatorToPoint:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000454a8c
- (struct CGPoint)_offsetForPageNumberIndicator;	// IMP=0x00000000004549a9
- (void)web_setContentProviderData:(id)arg1 suggestedFilename:(id)arg2;	// IMP=0x0000000000454668
- (id)web_initWithFrame:(struct CGRect)arg1 webView:(id)arg2 mimeType:(id)arg3;	// IMP=0x0000000000454569
- (id)_contentView;	// IMP=0x000000000045453f
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000454522
- (_Bool)web_handleKeyEvent:(id)arg1;	// IMP=0x0000000000454487
- (void)dealloc;	// IMP=0x000000000045433b
- (void)_wk_requestDocumentForPrintFormatter:(id)arg1;	// IMP=0x0000000000456eb8
- (unsigned long long)_wk_pageCountForPrintFormatter:(id)arg1;	// IMP=0x0000000000456e66
@property(readonly, nonatomic) _Bool _wk_printFormatterRequiresMainThread;
- (struct CGPDFDocument *)_ensureDocumentForPrinting;	// IMP=0x0000000000456d7a
