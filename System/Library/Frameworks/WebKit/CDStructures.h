...
struct ObjectIdentifier<IPC::Connection::AsyncReplyIDType> {
    unsigned long long m_identifier;
};
...
struct ObjectIdentifier<WebCore::GraphicsLayer::PlatformLayerIDType> {
    unsigned long long m_identifier;
};
...
struct ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>> {
    struct ObjectIdentifier<WebCore::FrameIdentifierType> _field1;
    struct ObjectIdentifier<WebCore::ProcessIdentifierType> _field2;
};

struct ProcessQualified<WTF::ObjectIdentifier<WebCore::GraphicsLayer::PlatformLayerIDType>> {
    struct ObjectIdentifier<WebCore::GraphicsLayer::PlatformLayerIDType> m_object;
...
struct optional<WebCore::ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>>> {
    union {
        char _field1;
        struct ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>> _field2;
    } _field1;
    _Bool _field2;
};
...
typedef struct optional<WebCore::ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>>> {
    union {
        char _field1;
        struct ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>> _field2;
    } _field1;
