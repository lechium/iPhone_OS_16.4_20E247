...
- (id).cxx_construct;	// IMP=0x00000000008ec1ac
- (void).cxx_destruct;	// IMP=0x00000000008ec142
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x00000000008ebf8a
