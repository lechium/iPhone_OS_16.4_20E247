...
- (id).cxx_construct;	// IMP=0x000000000020c0b8
- (void).cxx_destruct;	// IMP=0x000000000020c071
...
- (void)dealloc;	// IMP=0x000000000020be09
- (id)initWithPage:(void *)arg1;	// IMP=0x000000000020bd38
