...
- (void)assertion:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x00000000003a7e3e
- (void)assertionWillInvalidate:(id)arg1;	// IMP=0x00000000003a7d08
- (void)dealloc;	// IMP=0x00000000003a7cbe
