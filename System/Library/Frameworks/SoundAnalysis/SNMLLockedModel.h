...
- (id).cxx_construct;	// IMP=0x00000000000202b1
- (void).cxx_destruct;	// IMP=0x000000000002028b
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000201d2
