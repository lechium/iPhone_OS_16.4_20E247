...
- (void).cxx_destruct;	// IMP=0x000000000008eb91
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008e94b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 thresholdedHistoryIn:(id)arg3 detectedHistoryIn:(id)arg4;	// IMP=0x000000000008e849
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008e82f
