...
- (id).cxx_construct;	// IMP=0x00000000000179e0
- (void).cxx_destruct;	// IMP=0x00000000000179af
- (_Bool)adaptToSystemConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016ebc
- (id)resultsFromBox:(void *)arg1 renderedWithFrameCount:(int)arg2;	// IMP=0x00000000000169ef
- (id)sharedProcessorConfiguration;	// IMP=0x00000000000169e7
