...
- (void).cxx_destruct;	// IMP=0x000000000008eeb6
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008ecf1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 thresholdedHistoryOut:(id)arg4 detectedHistoryOut:(id)arg5;	// IMP=0x000000000008ebcf
