...
- (void).cxx_destruct;	// IMP=0x00000000000882f2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000088168
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000088066
