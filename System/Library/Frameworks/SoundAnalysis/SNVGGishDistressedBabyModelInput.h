...
- (void).cxx_destruct;	// IMP=0x0000000000088033
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000087e89
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000087db2
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000087d9b
