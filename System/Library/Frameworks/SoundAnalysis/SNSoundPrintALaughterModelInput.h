...
- (void).cxx_destruct;	// IMP=0x00000000000951d8
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000009502e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000094f57
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000094f40
