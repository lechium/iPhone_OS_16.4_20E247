...
- (void).cxx_destruct;	// IMP=0x0000000000095497
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000009530d
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x000000000009520b
