...
- (void).cxx_destruct;	// IMP=0x000000000008b57d
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008b3d3
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008b2fc
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008b2e5
