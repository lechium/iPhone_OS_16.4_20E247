...
- (void).cxx_destruct;	// IMP=0x00000000000988f0
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000987b8
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFinal_output:(id)arg1 classLabel:(id)arg2;	// IMP=0x00000000000986ff
