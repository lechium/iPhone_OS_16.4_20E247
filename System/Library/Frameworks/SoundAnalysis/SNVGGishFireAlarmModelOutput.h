...
- (void).cxx_destruct;	// IMP=0x000000000008b83c
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008b6b2
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x000000000008b5b0
