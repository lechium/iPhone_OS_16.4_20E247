...
- (void).cxx_destruct;	// IMP=0x000000000007d001
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000007cf1b
- (id)initWithModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x000000000007cd63
