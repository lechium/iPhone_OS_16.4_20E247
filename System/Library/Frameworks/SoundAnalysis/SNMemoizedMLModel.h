...
+ (id)new;	// IMP=0x0010000000048502
- (id).cxx_construct;	// IMP=0x0000000000048bc4
- (void).cxx_destruct;	// IMP=0x0000000000048b51
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000048668
@property(readonly) MLModelDescription *modelDescription;
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000484a6
- (id)init;	// IMP=0x000000000004844a
