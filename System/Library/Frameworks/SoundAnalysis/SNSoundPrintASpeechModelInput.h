...
- (void).cxx_destruct;	// IMP=0x0000000000093494
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000932ea
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000093213
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000931fc
