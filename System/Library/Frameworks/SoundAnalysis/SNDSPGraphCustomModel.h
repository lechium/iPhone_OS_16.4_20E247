...
- (id).cxx_construct;	// IMP=0x000000000006503d
- (void).cxx_destruct;	// IMP=0x0000000000064fcb
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000646a1
