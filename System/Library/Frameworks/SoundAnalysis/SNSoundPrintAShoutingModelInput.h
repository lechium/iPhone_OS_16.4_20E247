...
- (void).cxx_destruct;	// IMP=0x0000000000091750
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000915a6
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000000914cf
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000914b8
