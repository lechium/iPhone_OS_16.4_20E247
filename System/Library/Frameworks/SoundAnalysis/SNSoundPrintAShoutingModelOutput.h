...
- (void).cxx_destruct;	// IMP=0x0000000000091a0f
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000091885
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000091783
