...
- (void).cxx_destruct;	// IMP=0x0000000000096380
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000009627a
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFixedLengthEmbedding:(id)arg1 framewiseEmbedding:(id)arg2;	// IMP=0x00000000000961c1
