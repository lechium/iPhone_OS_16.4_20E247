...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000020f18
- (void).cxx_destruct;	// IMP=0x0000000000021440
...
- (id)description;	// IMP=0x0000000000021059
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000020fff
- (unsigned long long)hash;	// IMP=0x0000000000020fc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020f76
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000020f20
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020e98
- (id)init;	// IMP=0x0000000000020e34
