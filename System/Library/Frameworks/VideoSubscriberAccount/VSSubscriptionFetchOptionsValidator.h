...
- (void).cxx_destruct;	// IMP=0x000000000003e6c5
@property(retain, nonatomic) VSSubscriptionPredicateFactory *predicateFactory; // @synthesize predicateFactory=_predicateFactory;
- (id)standardizedFetchOptionsFromOptions:(id)arg1 withSecurityTask:(id)arg2;	// IMP=0x000000000003d64c
- (id)subscriptionFetchOptionsAllowedForSecurityTask:(id)arg1;	// IMP=0x000000000003ceed
