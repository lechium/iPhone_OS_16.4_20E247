...
- (void).cxx_destruct;	// IMP=0x000000000007ac2e
...
- (void)transitionToDoneState;	// IMP=0x000000000007aa99
- (void)transitionToFetchingScriptState;	// IMP=0x000000000007a525
- (void)transitionToEnqueueingNextUrlState;	// IMP=0x000000000007a316
- (void)start;	// IMP=0x000000000007a186
- (id)initWithApp:(id)arg1 urls:(id)arg2;	// IMP=0x0000000000079f83
