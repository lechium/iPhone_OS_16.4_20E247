...
- (void).cxx_destruct;	// IMP=0x000000000004a42d
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000049efb
- (void)setValue:(id)arg1 forBinding:(id)arg2;	// IMP=0x0000000000049d60
- (id)valueForBinding:(id)arg1;	// IMP=0x0000000000049b84
- (void)tearDownBinding:(id)arg1;	// IMP=0x00000000000495f6
- (void)establishBinding:(id)arg1 withInfo:(id)arg2;	// IMP=0x0000000000049351
- (id)_infoForBinding:(id)arg1;	// IMP=0x000000000004927d
- (void)dealloc;	// IMP=0x0000000000049095
- (id)initWithBoundObject:(id)arg1;	// IMP=0x0000000000048fcc
- (id)init;	// IMP=0x0000000000048f5d
