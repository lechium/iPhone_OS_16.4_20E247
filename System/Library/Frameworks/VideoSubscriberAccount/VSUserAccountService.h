...
- (void).cxx_destruct;	// IMP=0x000000000002e5e1
...
- (void)userAccountRegistry:(id)arg1 willPerformMigrationIfRequiredWithBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000002e398
- (id)_securityTaskForCurrentConnection;	// IMP=0x000000000002e37f
- (id)init;	// IMP=0x000000000002e1b9
