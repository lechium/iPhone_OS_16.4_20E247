...
- (id)_faultWhileAccessingPrimitiveValueForKey:(id)arg1;	// IMP=0x00000000000399f5
- (void)_notifyWhileSettingPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000039968
