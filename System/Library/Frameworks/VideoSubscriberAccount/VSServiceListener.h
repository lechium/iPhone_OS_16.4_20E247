...
- (void).cxx_destruct;	// IMP=0x0000000000078eca
...
- (void)connectionHandlerDidFinish:(id)arg1;	// IMP=0x0000000000078e4e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000789e1
- (void)_removeConnectionHandler:(id)arg1;	// IMP=0x0000000000078946
- (void)_addConnectionHandler:(id)arg1;	// IMP=0x00000000000788ab
- (id)init;	// IMP=0x0000000000078855
