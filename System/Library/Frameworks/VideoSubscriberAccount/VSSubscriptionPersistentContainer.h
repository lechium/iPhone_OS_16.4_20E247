...
- (void).cxx_destruct;	// IMP=0x000000000006881f
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x0000000000068766
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000068752
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x00000000000683d7
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x000000000006791c
- (void)_removePersistentStore;	// IMP=0x0000000000067803
- (id)init;	// IMP=0x0000000000067481
