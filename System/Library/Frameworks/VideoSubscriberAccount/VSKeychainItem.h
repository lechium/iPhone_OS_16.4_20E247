...
- (void).cxx_destruct;	// IMP=0x0000000000045cdd
...
- (id)description;	// IMP=0x0000000000045807
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x000000000004572d
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x00000000000456a1
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x00000000000455a4
- (id)changedValues;	// IMP=0x0000000000045268
- (id)committedValueForKey:(id)arg1;	// IMP=0x00000000000451e5
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x0000000000045167
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000044f4e
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x0000000000044e3a
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x0000000000044c81
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x0000000000044963
- (id)init;	// IMP=0x00000000000448f4
