...
- (id)vs_JSONValueTransformer;	// IMP=0x00300000000295ff
...
- (id)vs_propertyListValueTransformer;	// IMP=0x0030000000028f64
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x0030000000028df7
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0030000000028b64
@end
