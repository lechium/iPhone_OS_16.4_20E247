...
- (id).cxx_construct;	// IMP=0x0000000000176656
...
- (void)requestMutation:(id)arg1;	// IMP=0x000000000017614f
- (void)notifyClientsOfCustomPropertyChange:(struct AudioObjectPropertyAddress)arg1;	// IMP=0x0000000000176054
