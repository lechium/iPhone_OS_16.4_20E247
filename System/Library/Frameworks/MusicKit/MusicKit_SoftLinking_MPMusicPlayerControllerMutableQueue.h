...
- (void).cxx_destruct;	// IMP=0x000000000000292e
- (void)removeItemWithIdentifier:(id)arg1;	// IMP=0x0000000000002918
- (void)insertQueueDescriptor:(id)arg1 afterItemWithIdentifier:(id)arg2;	// IMP=0x000000000000289f
@property(readonly, nonatomic) MPMusicPlayerControllerMutableQueue *_underlyingMutableQueue;
- (id)_initWithUnderlyingMutableQueue:(id)arg1;	// IMP=0x0000000000002826
