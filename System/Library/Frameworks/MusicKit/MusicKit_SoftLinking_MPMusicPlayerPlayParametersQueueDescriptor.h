...
- (void).cxx_destruct;	// IMP=0x00000000000042ab
...
- (void)setEndTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x0000000000004233
- (void)setStartTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x00000000000041d9
@property(readonly, nonatomic) MPMusicPlayerPlayParametersQueueDescriptor *_underlyingQueueDescriptor;
- (id)initWithPlayParametersQueue:(id)arg1;	// IMP=0x0000000000003d72
