...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x0060000000007dcb
- (void).cxx_destruct;	// IMP=0x0000000000009f3c
...
- (id)description;	// IMP=0x0000000000009b5e
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x0000000000008442
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x000000000000804f
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000007ead
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x0000000000007e1d
