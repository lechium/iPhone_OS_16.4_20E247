...
- (void).cxx_destruct;	// IMP=0x00000000001c1f70
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x00000000001c1de3
- (void)_updateLayoutMetrics;	// IMP=0x00000000001c1416
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000001c1174
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000000001c0e4a
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x00000000001c0e1b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c0d46
