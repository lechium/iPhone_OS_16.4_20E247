...
- (void).cxx_destruct;	// IMP=0x000000000003555f
...
- (double)desiredHeight;	// IMP=0x000000000003549b
- (void)viewWillLayoutSubviews;	// IMP=0x000000000003521b
- (void)viewDidLoad;	// IMP=0x000000000003508f
- (id)initWithAvatarViewController:(id)arg1 name:(id)arg2 layoutAttributes:(id)arg3;	// IMP=0x0000000000034fb7
