...
- (void).cxx_destruct;	// IMP=0x000000000024838e
...
- (void)invalidate;	// IMP=0x000000000024828a
- (void)invalidateSearch;	// IMP=0x0000000000248230
- (void)invalidateResults;	// IMP=0x00000000002481aa
- (void)reloadWithRequest:(id)arg1;	// IMP=0x0000000000247ecd
- (void)reload;	// IMP=0x0000000000247d38
- (void)setNetworkActivityIndicatorVisible:(_Bool)arg1;	// IMP=0x0000000000247d32
@property(readonly, nonatomic) CNContactFilter *effectiveFilter;
- (id)indexPathForContact:(id)arg1;	// IMP=0x0000000000247bc2
- (id)completeContactFromContact:(id)arg1 fromMainStoreOnly:(_Bool)arg2 keysToFetch:(id)arg3;	// IMP=0x0000000000247a1d
...
- (id)preferredForNameMeContactIdentifier;	// IMP=0x0000000000247999
...
- (void)dealloc;	// IMP=0x0000000000247857
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000247713
- (id)initWithStore:(id)arg1;	// IMP=0x000000000024752f
