...
+ (id)layoutAttributesForSettings;	// IMP=0x00600000000bdb4c
+ (id)layoutAttributesForBuddy;	// IMP=0x00600000000bdaaf
+ (id)settingsHeaderFont;	// IMP=0x00600000000bd988
+ (id)buddyHeaderFont;	// IMP=0x00600000000bd837
- (void).cxx_destruct;	// IMP=0x00000000000bd80f
...
- (id)initWithTopToAvatarPadding:(double)arg1 headerFont:(id)arg2 avatarViewSize:(struct CGSize)arg3 avatarViewToNamePadding:(double)arg4 backgroundColor:(id)arg5;	// IMP=0x00000000000bd6f1
