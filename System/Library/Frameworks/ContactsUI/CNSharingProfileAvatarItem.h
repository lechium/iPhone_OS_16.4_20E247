...
- (void).cxx_destruct;	// IMP=0x00000000000ed485
...
- (id)initWithImageProvider:(CDUnknownBlockType)arg1 originalImageProvider:(CDUnknownBlockType)arg2 type:(long long)arg3;	// IMP=0x00000000000ed35a
- (id)initWithImageProvider:(CDUnknownBlockType)arg1 type:(long long)arg2;	// IMP=0x00000000000ed342
