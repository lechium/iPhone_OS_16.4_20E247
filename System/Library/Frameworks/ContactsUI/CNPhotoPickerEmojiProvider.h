...
- (void).cxx_destruct;	// IMP=0x00000000001a0ff1
...
- (id)loadItemsForSize:(struct CGSize)arg1 scale:(double)arg2 RTL:(_Bool)arg3 renderingQueue:(id)arg4 callbackQueue:(id)arg5 itemDelegate:(id)arg6;	// IMP=0x00000000001a0d34
- (id)initWithVisualIdentity:(id)arg1;	// IMP=0x00000000001a0c4b
