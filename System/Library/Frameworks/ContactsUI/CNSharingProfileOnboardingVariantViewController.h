...
- (void).cxx_destruct;	// IMP=0x00000000000e49a5
...
- (void)photoPickerVariantListControllerDidCancel:(id)arg1;	// IMP=0x00000000000e47e0
- (void)photoPickerVariantListController:(id)arg1 didSelectProviderItem:(id)arg2;	// IMP=0x00000000000e4765
- (void)didTapBack:(id)arg1;	// IMP=0x00000000000e4719
- (void)didTapPose:(id)arg1;	// IMP=0x00000000000e46cd
- (void)didTapContinue:(id)arg1;	// IMP=0x00000000000e4690
- (void)didTapSetupLater:(id)arg1;	// IMP=0x00000000000e4644
- (void)updateOriginalItem:(id)arg1;	// IMP=0x00000000000e45d2
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000e4508
- (void)viewDidLoad;	// IMP=0x00000000000e3c1f
- (id)initWithVariantsManager:(id)arg1 originalItem:(id)arg2 selectedVariantIdentifier:(id)arg3;	// IMP=0x00000000000e3b14
