...
+ (id)fmfHandleFromContactProperty:(id)arg1;	// IMP=0x00100000001bcf46
+ (id)fmfHandlesFromContact:(id)arg1;	// IMP=0x00100000001bcaad
...
- (void)notifySharingStatusDidChange;	// IMP=0x00000000001bb9a5
- (id)callerIDFuture;	// IMP=0x00000000001bb8cb
- (id)callerID:(id *)arg1;	// IMP=0x00000000001bb864
- (void)initiateIDSRequest;	// IMP=0x00000000001baff9
- (id)endOfDayDate;	// IMP=0x00000000001baf60
- (void)stopSharingLocation;	// IMP=0x00000000001badda
- (void)shareLocationUntilEndDate:(id)arg1;	// IMP=0x00000000001baacc
- (CDUnknownBlockType)actionsMenuProvider;	// IMP=0x00000000001baa49
- (void)perform:(id)arg1;	// IMP=0x00000000001baa43
@property(readonly, nonatomic) _Bool isSharing;
@property(readonly, nonatomic) _Bool canShare;
- (id)initWithIDSAvailabilityProvider:(id)arg1 fmfSession:(id)arg2 schedulerProvider:(id)arg3;	// IMP=0x00000000001ba64f
- (id)initWithIDSAvailabilityProvider:(id)arg1;	// IMP=0x00000000001ba582
