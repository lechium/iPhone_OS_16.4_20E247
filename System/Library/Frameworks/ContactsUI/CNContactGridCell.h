...
+ (double)actionsLeftMargin;	// IMP=0x00600000001cfefa
- (void).cxx_destruct;	// IMP=0x00000000001cfde4
...
- (void)_updateActionsMask;	// IMP=0x00000000001cfad9
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000001cfa16
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000001cf44e
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000001ce95b
- (void)_createViewsIfNeeded;	// IMP=0x00000000001ce63a
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000001ce624
