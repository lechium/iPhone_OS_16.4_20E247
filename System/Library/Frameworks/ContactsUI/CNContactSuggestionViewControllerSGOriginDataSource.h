...
+ (id)dateFormatter;	// IMP=0x001000000019243c
+ (id)contactSuggestionTypeBySuggestionType;	// IMP=0x001000000019240c
- (void).cxx_destruct;	// IMP=0x00000000001923fc
@property(retain, nonatomic) SGOrigin *origin; // @synthesize origin=_origin;
@property(readonly, nonatomic) NSURL *url;
- (id)contactNameFromPerson:(id)arg1;	// IMP=0x00000000001922b4
...
- (id)initWithSGOrigin:(id)arg1;	// IMP=0x00000000001917ad
