...
- (void).cxx_destruct;	// IMP=0x00000000000df897
...
- (struct CGRect)_sourceRectInContainerView:(id)arg1;	// IMP=0x00000000000df1b0
- (void)transitionDidEnd:(_Bool)arg1;	// IMP=0x00000000000df10e
- (void)performTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x00000000000dedbd
- (void)setupTransitionFromView:(id)arg1 toView:(id)arg2 withContainerView:(id)arg3;	// IMP=0x00000000000de934
- (void)prepareTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x00000000000de3e2
- (id)initWithCardViewController:(id)arg1 headerView:(id)arg2 sourceView:(id)arg3 highlightedView:(id)arg4 sourceRect:(struct CGRect)arg5 backgroundVisualEffectView:(id)arg6 isDismissing:(_Bool)arg7;	// IMP=0x00000000000de2bd
