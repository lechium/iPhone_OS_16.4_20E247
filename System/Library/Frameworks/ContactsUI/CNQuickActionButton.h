...
- (void).cxx_destruct;	// IMP=0x00000000001bfc34
...
- (void)onLongPress:(id)arg1;	// IMP=0x00000000001bf8b2
- (void)performAction;	// IMP=0x00000000001bf7d5
- (void)updateConstraints;	// IMP=0x00000000001bf39c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001bede5
