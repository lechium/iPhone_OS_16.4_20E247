...
- (void).cxx_destruct;	// IMP=0x00000000001c933d
...
- (void)cancel;	// IMP=0x00000000001c8bae
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 idsAvailabilityProvider:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x00000000001c883b
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2;	// IMP=0x00000000001c875a
