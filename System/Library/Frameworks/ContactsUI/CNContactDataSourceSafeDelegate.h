...
- (void).cxx_destruct;	// IMP=0x0000000000247521
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x0000000000247453
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002473d8
