...
+ (double)heightForHeaderWithContainerSize:(struct CGSize)arg1 withTitle:(id)arg2 layoutAttributes:(id)arg3 hasAvatar:(_Bool)arg4;	// IMP=0x00600000001f004b
- (void).cxx_destruct;	// IMP=0x00000000001efff8
...
- (void)viewWillLayoutSubviews;	// IMP=0x00000000001efb4a
- (void)viewDidLoad;	// IMP=0x00000000001ef986
- (id)initWithAvatarCarouselViewController:(id)arg1 headerTitle:(id)arg2 layoutAttributes:(id)arg3;	// IMP=0x00000000001ef8ae
