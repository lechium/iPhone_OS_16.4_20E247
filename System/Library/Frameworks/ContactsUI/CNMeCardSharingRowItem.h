...
- (void).cxx_destruct;	// IMP=0x00000000001b0a80
...
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2 confirmationHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001b0977
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2;	// IMP=0x00000000001b0962
