...
- (void).cxx_destruct;	// IMP=0x00000000001dc63f
...
- (void)didTapAvatarView:(id)arg1;	// IMP=0x00000000001dc47e
- (void)updateForChangedImageAnimated:(_Bool)arg1;	// IMP=0x00000000001dc3ac
- (void)reload;	// IMP=0x00000000001dc260
- (void)updateWithAvatarProvider:(id)arg1;	// IMP=0x00000000001dc209
- (void)viewWillLayoutSubviews;	// IMP=0x00000000001dbef7
- (void)viewDidLoad;	// IMP=0x00000000001dbe59
- (void)loadView;	// IMP=0x00000000001dbbfe
- (id)initWithAvatarProvider:(id)arg1;	// IMP=0x00000000001dbaf1
