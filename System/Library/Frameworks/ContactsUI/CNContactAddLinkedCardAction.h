...
- (void).cxx_destruct;	// IMP=0x000000000006f8a3
...
- (_Bool)contactViewController:(id)arg1 shouldPerformDefaultActionForContact:(id)arg2 propertyKey:(id)arg3 labeledValue:(id)arg4;	// IMP=0x000000000006f807
- (void)contactPicker:(id)arg1 didSelectContact:(id)arg2;	// IMP=0x000000000006f630
- (void)contactPickerDidCancel:(id)arg1;	// IMP=0x000000000006f585
- (void)peoplePickerLinkButtonTapped;	// IMP=0x000000000006f4ac
- (void)performActionWithSender:(id)arg1;	// IMP=0x000000000006f0e1
