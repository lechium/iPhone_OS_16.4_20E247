...
- (void).cxx_destruct;	// IMP=0x0000000000286afb
@property(readonly, copy, nonatomic) CDUnknownBlockType actionBlock; // @synthesize actionBlock=_actionBlock;
- (void)performAction;	// IMP=0x0000000000286a80
- (id)initWithActionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000286a0d
