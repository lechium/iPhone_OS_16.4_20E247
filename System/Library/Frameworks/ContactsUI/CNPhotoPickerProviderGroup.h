...
+ (id)addItemsGroupWithProviders:(id)arg1 environment:(id)arg2;	// IMP=0x001000000003e8cb
+ (id)emojiGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x001000000003e84c
+ (id)animojiGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x001000000003e7cd
+ (id)suggestionsGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x001000000003e74e
+ (id)injectedItemsGroupWithEnvironment:(id)arg1;	// IMP=0x001000000003e701
- (void).cxx_destruct;	// IMP=0x000000000003dfb2
...
- (void)providerItemDidUpdate:(id)arg1;	// IMP=0x000000000003dd9c
- (_Bool)hasAddedProviderItems;	// IMP=0x000000000003dd4b
- (void)removeAllAddedProviderItems;	// IMP=0x000000000003dd14
- (long long)removeProviderItem:(id)arg1;	// IMP=0x000000000003d936
- (long long)addProviderItem:(id)arg1;	// IMP=0x000000000003d7fb
- (id)providerItemAtIndex:(long long)arg1;	// IMP=0x000000000003d781
- (long long)numberOfItems;	// IMP=0x000000000003d73d
- (void)prepareDisplayItems:(id)arg1;	// IMP=0x000000000003d675
- (void)reloadDisplayItemsNotifyDelegate:(_Bool)arg1;	// IMP=0x000000000003d478
- (id)itemsForProviderIdentifier:(id)arg1;	// IMP=0x000000000003d3f5
- (id)suggestionsProviderPrecedingFacesProvider;	// IMP=0x000000000003d2d3
- (void)loadProvidersItemsForSize:(struct CGSize)arg1 itemsPerRow:(double)arg2 scale:(double)arg3 RTL:(_Bool)arg4;	// IMP=0x000000000003d17f
- (id)initWithProviders:(id)arg1 groupType:(long long)arg2 environment:(id)arg3 allowAddItem:(_Bool)arg4;	// IMP=0x000000000003cfc3
