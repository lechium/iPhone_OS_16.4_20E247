...
- (id)newAccessoryDisclosureIndicatorViewForVibrationPickerCell;	// IMP=0x000000000021a3e0
- (id)newBackgroundViewForSelectedVibrationPickerCell:(_Bool)arg1;	// IMP=0x000000000021a3ce
...
- (id)newAccessoryDisclosureIndicatorViewForTonePickerCell;	// IMP=0x000000000021a0ad
- (id)newBackgroundViewForSelectedTonePickerCell:(_Bool)arg1;	// IMP=0x0000000000219f9e
