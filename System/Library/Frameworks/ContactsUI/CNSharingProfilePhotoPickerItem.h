...
- (void).cxx_destruct;	// IMP=0x00000000001b4161
...
- (id)compositeImageWithSize:(struct CGSize)arg1;	// IMP=0x00000000001b40a8
- (id)originalImageWithSize:(struct CGSize)arg1;	// IMP=0x00000000001b400b
