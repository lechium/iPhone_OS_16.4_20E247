...
- (void).cxx_destruct;	// IMP=0x00000000000828f2
...
- (id)initWithTitle:(id)arg1;	// IMP=0x000000000008281f
- (id)initWithImageInsetPercentage:(double)arg1 imageProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000082786
