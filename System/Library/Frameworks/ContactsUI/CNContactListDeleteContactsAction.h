...
+ (id)actionForContact:(id)arg1 configuration:(id)arg2;	// IMP=0x006000000010d528
+ (id)descriptorForRequiredKeys;	// IMP=0x006000000010d3f7
+ (id)log;	// IMP=0x006000000010d3c7
- (void).cxx_destruct;	// IMP=0x000000000010ce3e
...
- (void)performUndoAction;	// IMP=0x000000000010cd08
- (_Bool)editRequiresAuthorizationCheckForActions:(id)arg1;	// IMP=0x000000000010ccb6
- (_Bool)editRequiresAuthorization;	// IMP=0x000000000010cc63
- (void)showDeleteFailureAlert;	// IMP=0x000000000010ca7e
- (id)alertTitle;	// IMP=0x000000000010c7da
- (void)performAction;	// IMP=0x000000000010c51e
- (_Bool)shouldReloadListOnCompletion;	// IMP=0x000000000010c516
- (id)initWithContacts:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000010c2b9
