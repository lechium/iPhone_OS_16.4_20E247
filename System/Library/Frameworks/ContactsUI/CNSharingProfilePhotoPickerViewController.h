...
- (void).cxx_destruct;	// IMP=0x0000000000085701
...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000000008531a
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x00000000000851d5
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x00000000000851b8
- (void)didSelectCustomizeButton:(id)arg1;	// IMP=0x000000000008516c
@property(retain, nonatomic) NSData *memojiMetadata;
@property(retain, nonatomic) PRMonogramColor *monogramColor;
- (void)updatePreviewForSelectedItem;	// IMP=0x0000000000084fe0
- (void)updateWithContact:(id)arg1 fromFullPhotoPicker:(_Bool)arg2;	// IMP=0x0000000000084dcc
- (id)buildItems;	// IMP=0x0000000000084b77
- (void)reloadItems;	// IMP=0x0000000000084b24
- (double)previewEdgeSize;	// IMP=0x0000000000084b02
- (void)reloadData;	// IMP=0x0000000000084a27
- (void)updateInteritemSpacing;	// IMP=0x0000000000084886
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000084606
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000008447b
- (double)previewToSelectorSpacing;	// IMP=0x000000000008446d
- (void)setupConstraints;	// IMP=0x0000000000083ebc
- (void)viewDidLoad;	// IMP=0x0000000000083a48
- (id)initWithContact:(id)arg1 avatarRecord:(id)arg2 avatarItemProviderConfiguration:(id)arg3 logger:(id)arg4;	// IMP=0x000000000008393d
