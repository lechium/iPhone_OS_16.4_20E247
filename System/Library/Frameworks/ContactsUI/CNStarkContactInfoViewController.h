...
+ (id)descriptorForRequiredKeys;	// IMP=0x001000000014f340
- (void).cxx_destruct;	// IMP=0x000000000014f298
...
- (void)geminiDataSourceDidUpdate:(id)arg1;	// IMP=0x000000000014f09c
- (_Bool)shouldShowGemini;	// IMP=0x000000000014f01e
- (void)setupLayoutConstraints;	// IMP=0x000000000014ec3d
- (void)updateViewConstraints;	// IMP=0x000000000014ebb4
- (void)resetLayoutConstraints;	// IMP=0x000000000014eb02
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000014ea06
- (void)updateViews;	// IMP=0x000000000014e6bf
- (void)setupViews;	// IMP=0x000000000014df2a
- (void)viewDidLoad;	// IMP=0x000000000014ded4
- (id)initWithContact:(id)arg1;	// IMP=0x000000000014dcc3
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000014dc69
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014dc18
- (id)init;	// IMP=0x000000000014dbdb
