...
+ (id)propertyTransportButtonWithDelegate:(id)arg1;	// IMP=0x00100000001528e9
+ (id)quickActionButtonWithDelegate:(id)arg1;	// IMP=0x001000000015263d
- (void).cxx_destruct;	// IMP=0x0000000000152531
...
- (void)stateUpdated;	// IMP=0x0000000000151c1d
- (void)updateForFocusedState:(_Bool)arg1;	// IMP=0x0000000000151bef
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000151b43
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000151a9d
- (void)notifyDelegateAboutUserChoice;	// IMP=0x0000000000151a32
- (void)choose;	// IMP=0x0000000000151a20
- (void)deselect;	// IMP=0x00000000001519f0
- (void)select;	// IMP=0x00000000001519a4
- (void)clickGestureDidUpdate:(id)arg1;	// IMP=0x000000000015191f
- (void)actionViewTouchUp:(id)arg1;	// IMP=0x000000000015190d
- (void)actionViewTouchDown:(id)arg1;	// IMP=0x00000000001518fb
- (void)actionViewTapped:(id)arg1;	// IMP=0x00000000001518e9
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000001518d7
- (_Bool)canBecomeFocused;	// IMP=0x00000000001518c5
- (void)setupClickGestureRecognizer;	// IMP=0x0000000000151840
- (void)setupConstraints;	// IMP=0x00000000001512c7
- (void)setupButton;	// IMP=0x0000000000151040
- (void)setupLabel;	// IMP=0x0000000000150f7c
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000150efe
