...
+ (id)descriptorForContactPropertiesSupportingPredicateEvaluation;	// IMP=0x0010000000246489
- (void).cxx_destruct;	// IMP=0x00000000002460e0
...
- (void)_selectedProperties:(id)arg1;	// IMP=0x000000000024586a
- (void)_selectedContacts:(id)arg1;	// IMP=0x00000000002455bf
- (void)_selectedProperty:(id)arg1;	// IMP=0x000000000024542c
- (void)_selectedContact:(id)arg1;	// IMP=0x0000000000245344
- (id)descriptorsForKeysRequiredByDelegate;	// IMP=0x00000000002452b2
- (void)contactNavigationControllerDidCancel:(id)arg1;	// IMP=0x0000000000245275
- (void)contactNavigationController:(id)arg1 didCompleteWithNewContact:(id)arg2;	// IMP=0x0000000000245203
- (void)contactNavigationControllerDidComplete:(id)arg1;	// IMP=0x0000000000245167
- (_Bool)contactNavigationController:(id)arg1 presentViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000244fdd
- (_Bool)contactNavigationControllerShouldDismissSearchOnSelection:(id)arg1;	// IMP=0x0000000000244fd5
- (_Bool)contactNavigationController:(id)arg1 shouldPerformDefaultActionForContactProperty:(id)arg2;	// IMP=0x0000000000244df7
- (_Bool)contactNavigationControllerShouldShowContactsOnKeyCommands:(id)arg1;	// IMP=0x0000000000244def
- (_Bool)contactNavigationController:(id)arg1 shouldShowCardForContact:(id)arg2;	// IMP=0x0000000000244bf4
- (_Bool)contactNavigationController:(id)arg1 shouldSelectContact:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x00000000002441f3
- (_Bool)contactSuggestionViewController:(id)arg1 shouldSelectContact:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x00000000002438b2
- (_Bool)contactNavigationController:(id)arg1 canSelectContact:(id)arg2;	// IMP=0x0000000000243639
- (_Bool)contactNavigationControllerShouldAddNewContact:(id)arg1;	// IMP=0x00000000002435c0
- (void)invalidate;	// IMP=0x00000000002435ba
- (void)invalidateSelectionAnimated:(_Bool)arg1;	// IMP=0x0000000000243409
@property(readonly, nonatomic) UIBarButtonItem *addContactBarButtonItem;
@property(readonly, nonatomic) UINavigationController *navigationController;
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000024331b
- (void)_updatePromptWithViewSize:(struct CGSize)arg1 transitionCoordinator:(id)arg2;	// IMP=0x0000000000243224
- (id)_validatePredicatesWithError:(id *)arg1;	// IMP=0x0000000000242fa2
- (void)setupWithOptions:(id)arg1 readyBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000241814
- (id)init;	// IMP=0x000000000024177d
