...
+ (_Bool)supportsPropertyGroupItem:(id)arg1;	// IMP=0x001000000022112f
+ (_Bool)isSupportedGroupItem:(id)arg1;	// IMP=0x001000000022111b
- (void).cxx_destruct;	// IMP=0x0000000000220fc9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000220ead
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000220dfc
@property(readonly, copy, nonatomic) NSString *_cnui_IDSIDRepresentation;
- (id)initWithPropertyGroupItem:(id)arg1;	// IMP=0x0000000000220b81
