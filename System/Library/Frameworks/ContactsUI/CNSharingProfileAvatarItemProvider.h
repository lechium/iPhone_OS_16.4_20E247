...
+ (id)compositeImageForImage:(id)arg1 backgroundImage:(id)arg2;	// IMP=0x006000000016ab51
+ (id)monogramImageItemWithContact:(id)arg1 monogramColor:(id)arg2 renderer:(id)arg3 RTL:(_Bool)arg4;	// IMP=0x006000000016a980
+ (id)contactImageItemWithContact:(id)arg1 renderer:(id)arg2 logger:(id)arg3 type:(long long)arg4;	// IMP=0x006000000016a8a8
+ (id)silhouetteImageItemWithRenderer:(id)arg1;	// IMP=0x006000000016a7fb
+ (id)descriptorForRequiredKeys;	// IMP=0x006000000016a7cb
- (void).cxx_destruct;	// IMP=0x000000000016a71f
...
- (void)clearCachedItems;	// IMP=0x000000000016a529
@property(retain, nonatomic) NSData *memojiMetadata;
- (id)animojColor;	// IMP=0x000000000016a391
@property(retain, nonatomic) PRMonogramColor *monogramColor;
- (void)updateWithContact:(id)arg1 fromFullPhotoPicker:(_Bool)arg2;	// IMP=0x000000000016a250
- (void)buildItems;	// IMP=0x0000000000169dac
- (_Bool)contactHasImageOfPhotoType:(id)arg1;	// IMP=0x0000000000169d37
@property(readonly, nonatomic) NSArray *avatarItems;
- (void)pickRandomColors;	// IMP=0x0000000000169b71
- (id)initWithContact:(id)arg1 avatarRecord:(id)arg2 logger:(id)arg3;	// IMP=0x0000000000169a03
