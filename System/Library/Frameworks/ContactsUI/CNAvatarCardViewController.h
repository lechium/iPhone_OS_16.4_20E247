...
- (void).cxx_destruct;	// IMP=0x000000000010ba58
...
- (void)contactActionsController:(id)arg1 didUpdateWithMenu:(id)arg2;	// IMP=0x000000000010b7f0
- (void)contactActionsController:(id)arg1 didSelectAction:(id)arg2;	// IMP=0x000000000010b6b1
...
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x000000000010aff6
- (void)dismissViewControllerForCardActionsView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000010afe2
- (id)viewControllerForCardActionsView:(id)arg1;	// IMP=0x000000000010af19
- (void)cardActionsView:(id)arg1 didShowActions:(id)arg2;	// IMP=0x000000000010aec0
- (id)cardActionsView:(id)arg1 orderedPropertiesForProperties:(id)arg2 category:(id)arg3;	// IMP=0x000000000010ade4
- (void)refreshActions;	// IMP=0x000000000010ada7
- (void)_updatePreferredSize;	// IMP=0x000000000010abac
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x000000000010aae4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000010aa6b
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000010aa01
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000010a94c
- (void)updateActionsViewBackgroundColor;	// IMP=0x000000000010a877
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000010a836
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000010a7ad
- (void)updateActionsControllerHeightConstraint;	// IMP=0x000000000010a703
- (void)didAddActionsViewToHierarchy;	// IMP=0x000000000010a446
- (void)willAddActionsViewToHierarchy;	// IMP=0x000000000010a3a6
...
- (id)viewForTouchContinuation;	// IMP=0x000000000010a28c
- (id)actionsView;	// IMP=0x000000000010a1ca
@property(nonatomic) _Bool bypassActionValidation;
@property(copy, nonatomic) NSArray *actionCategories;
- (struct CGRect)_photoFrameInView:(id)arg1;	// IMP=0x0000000000109f74
@property(nonatomic) _Bool dismissesBeforePerforming;
@property(nonatomic) _Bool actionsReversed;
- (void)contentSizeCategoryDidChange:(id)arg1;	// IMP=0x0000000000109d63
- (void)updateViewConstraints;	// IMP=0x0000000000109abd
- (void)viewDidLoad;	// IMP=0x0000000000108dd4
- (void)dealloc;	// IMP=0x0000000000108d5f
- (id)initWithContacts:(id)arg1;	// IMP=0x0000000000108aab
