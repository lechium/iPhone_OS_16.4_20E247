...
+ (id)builderWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4 photoPickerConfiguration:(id)arg5;	// IMP=0x00600000001c568c
- (void).cxx_destruct;	// IMP=0x00000000001c564e
...
- (id)build;	// IMP=0x00000000001c533c
- (id)emojiContentGroup;	// IMP=0x00000000001c5214
- (id)animojiContentGroup;	// IMP=0x00000000001c50c3
- (id)photoContentGroup;	// IMP=0x00000000001c4e4c
- (id)injectedItemsGroup;	// IMP=0x00000000001c4de9
- (id)addItemsContentGroup;	// IMP=0x00000000001c4c86
@property(readonly, nonatomic) _Bool includesAnyPhotoContent;
- (id)initWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4;	// IMP=0x00000000001c4b0b
