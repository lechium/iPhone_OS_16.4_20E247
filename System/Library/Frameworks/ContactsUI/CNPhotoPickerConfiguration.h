...
+ (id)gameCenterConfiguration;	// IMP=0x0040000000287f33
+ (id)contactsConfiguration;	// IMP=0x0040000000287edf
+ (id)defaultConfiguration;	// IMP=0x0040000000287ecd
