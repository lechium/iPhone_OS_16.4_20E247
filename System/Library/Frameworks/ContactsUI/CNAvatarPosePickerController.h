...
- (void).cxx_destruct;	// IMP=0x000000000021230f
...
- (void)photoPickerVariantListControllerDidCancel:(id)arg1;	// IMP=0x000000000021222f
- (void)photoPickerVariantListController:(id)arg1 didSelectProviderItem:(id)arg2;	// IMP=0x0000000000212171
- (id)posePickerViewController;	// IMP=0x0000000000211fa5
- (id)initWithAnimojiProviderItem:(id)arg1 variantsManager:(id)arg2;	// IMP=0x0000000000211e64
- (id)initWithAvatarRecord:(id)arg1 variantsManager:(id)arg2;	// IMP=0x0000000000211dde
