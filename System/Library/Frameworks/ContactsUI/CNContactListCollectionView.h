...
- (void).cxx_destruct;	// IMP=0x000000000019ca23
...
- (void)deselectItemAtIndexPath:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000019c944
- (void)selectItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(unsigned long long)arg3;	// IMP=0x000000000019c903
- (void)updateSelectedContactCount;	// IMP=0x000000000019c7cb
- (unsigned long long)globalIndexForItemAtIndexPath:(id)arg1;	// IMP=0x000000000019c5c4
- (id)init;	// IMP=0x000000000019c565
