...
+ (id)cellNibForContacts;	// IMP=0x00600000000ccd3f
+ (id)cellNibForActions;	// IMP=0x00600000000cccdc
- (void).cxx_destruct;	// IMP=0x00000000000cca68
...
- (void)trackHighlight:(id)arg1;	// IMP=0x00000000000cc5e3
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000cc5c1
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000cc54e
- (void)reloadData;	// IMP=0x00000000000cbb5b
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x00000000000cb9e6
- (void)prepareForReuse;	// IMP=0x00000000000cb970
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000cb925
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000cb90e
- (void)awakeFromNib;	// IMP=0x00000000000cb761
- (void)_updateFonts;	// IMP=0x00000000000cb611
