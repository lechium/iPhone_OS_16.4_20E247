...
- (void).cxx_destruct;	// IMP=0x000000000019059e
...
- (void)setPreferredForName;	// IMP=0x000000000019031b
- (void)setPreferredForImage;	// IMP=0x0000000000190113
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x000000000018f983
- (void)dealloc;	// IMP=0x000000000018f941
- (id)initWithContact:(id)arg1;	// IMP=0x000000000018f912
