...
+ (double)heightForButtonsViewWithButtonCount:(long long)arg1;	// IMP=0x001000000028730d
+ (double)buttonHeight;	// IMP=0x0010000000287281
...
- (struct CGRect)actionButtonsViewFrameForButtonCount:(long long)arg1;	// IMP=0x0000000000286fec
- (id)initWithContainerSize:(struct CGSize)arg1 insets:(struct UIEdgeInsets)arg2 buttonCount:(long long)arg3;	// IMP=0x0000000000286f62
