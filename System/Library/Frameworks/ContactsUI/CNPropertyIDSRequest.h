...
+ (_Bool)fakeResponseForHandle:(id)arg1;	// IMP=0x0010000000108a50
+ (id)sharedWorkQueue;	// IMP=0x0010000000108a20
- (void).cxx_destruct;	// IMP=0x0000000000107e4e
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x0000000000107889
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x00000000001077c4
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x00000000001076f2
- (void)cleanupDelegate;	// IMP=0x000000000010764d
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000001074c2
