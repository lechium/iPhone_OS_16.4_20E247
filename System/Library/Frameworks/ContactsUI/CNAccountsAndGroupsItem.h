...
- (void).cxx_destruct;	// IMP=0x000000000015d2b3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015cfd8
@property(readonly, nonatomic) UIImage *groupSymbol;
@property(readonly, nonatomic) NSString *contactCountString;
- (long long)localizedCompare:(id)arg1;	// IMP=0x000000000015ce0b
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x000000000015caee
- (void)setSelected:(_Bool)arg1 affectingChildren:(_Bool)arg2;	// IMP=0x000000000015c79f
...
- (id)initWithType:(long long)arg1 nameProvider:(CDUnknownBlockType)arg2;	// IMP=0x000000000015c3dd
