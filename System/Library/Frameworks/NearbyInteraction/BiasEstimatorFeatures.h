...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000bd92
...
- (unsigned long long)hash;	// IMP=0x000000000000cc13
- (id)populateOrderedInputFeature;	// IMP=0x000000000000c7b0
- (id)description;	// IMP=0x000000000000c46a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000bd9a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000bd4a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b7cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b560
- (id)initWithBiasEstimatorFeatures:(id)arg1;	// IMP=0x000000000000b1ed
