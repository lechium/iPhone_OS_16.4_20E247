...
- (id)init;	// IMP=0x0000000000019bb5
- (id)initWithFineRangingSupport:(_Bool)arg1 coarseRangingSupport:(_Bool)arg2 aoaSupport:(_Bool)arg3 syntheticApertureSupport:(_Bool)arg4;	// IMP=0x0000000000019b4a
- (id)initWithFineRangingSupport:(_Bool)arg1 aoaSupport:(_Bool)arg2 syntheticApertureSupport:(_Bool)arg3;	// IMP=0x0000000000019b30
