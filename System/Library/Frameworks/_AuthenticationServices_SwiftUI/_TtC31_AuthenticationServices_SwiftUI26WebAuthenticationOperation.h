...
- (void).cxx_destruct;	// IMP=0x00000000000080d0
- (id)init;	// IMP=0x0000000000008060
- (_Bool)isFinished;	// IMP=0x0000000000007bb0
- (_Bool)isExecuting;	// IMP=0x0000000000007b00
- (_Bool)isAsynchronous;	// IMP=0x0000000000007af0
- (void)cancel;	// IMP=0x0000000000007ac0
- (void)start;	// IMP=0x0000000000007830
