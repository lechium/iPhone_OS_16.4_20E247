...
- (id)_un_contentSizeRatio;	// IMP=0x003000000000306d
...
- (id)_un_customSectionIdentifiers;	// IMP=0x0030000000002cd1
- (id)_un_extensionContainerBundleIdentifier;	// IMP=0x0030000000002b02
@end
