...
- (void).cxx_destruct;	// IMP=0x0000000000043aba
...
- (void)trackGestureTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2;	// IMP=0x0000000000043775
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x00000000000436dc
- (id)init;	// IMP=0x0000000000043686
