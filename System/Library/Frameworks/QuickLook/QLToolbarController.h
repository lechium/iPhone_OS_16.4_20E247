...
- (void)setAccessoryView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000001a11f
...
- (void)setPreferredSuperview:(id)arg1 preferredParentViewForSafeAreaInset:(id)arg2;	// IMP=0x0000000000019f1a
- (void)updateLayout;	// IMP=0x0000000000019c2c
- (void)restoreOriginalConfiguration;	// IMP=0x0000000000019bf5
- (void)restoreOriginalToolbar;	// IMP=0x0000000000019b7b
- (void)_embedAccessoryView;	// IMP=0x0000000000019a51
- (double)_toolbarExtensionHeight;	// IMP=0x00000000000199f4
- (double)_totalHeight;	// IMP=0x0000000000019958
- (void)_layoutAccessoryView:(id)arg1;	// IMP=0x00000000000197de
- (double)_originalToolbarHeightIncludingSafeAreaBottomInset:(_Bool)arg1;	// IMP=0x000000000001973f
- (double)_computeClippingExtensionContainerHeightForCurrentHiddenProgress;	// IMP=0x00000000000196e3
- (double)_computeClippingExtensionContainerBottomConstraint;	// IMP=0x000000000001966e
- (double)_toolbarSafeAreaInsetBottom;	// IMP=0x0000000000019574
- (_Bool)_tryToSetUp:(_Bool)arg1;	// IMP=0x0000000000018d80
- (id)init;	// IMP=0x0000000000018d37
