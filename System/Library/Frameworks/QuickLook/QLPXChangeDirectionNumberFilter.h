...
- (double)updatedOutput;	// IMP=0x0000000000043efd
- (double)initialOutputForInput:(double)arg1;	// IMP=0x0000000000043ef4
- (id)initWithInput:(double)arg1;	// IMP=0x0000000000043eaa
