...
- (void).cxx_destruct;	// IMP=0x00000000000460a2
...
- (id)URLRequestForContentID:(id)arg1;	// IMP=0x0000000000045da7
- (void)_registerURL:(id)arg1 forContentID:(id)arg2;	// IMP=0x0000000000045ce4
- (id)newAttachmentURLWithID:(id)arg1 mimeType:(id)arg2 encoding:(unsigned long long)arg3;	// IMP=0x0000000000045c3d
- (void)_processAttachment:(id)arg1 withID:(id)arg2;	// IMP=0x000000000004599f
- (void)computePreview:(CDUnknownBlockType)arg1;	// IMP=0x000000000004582d
- (id)initWithData:(id)arg1 encoding:(unsigned long long)arg2 mimeType:(id)arg3 attachments:(id)arg4;	// IMP=0x0000000000045754
