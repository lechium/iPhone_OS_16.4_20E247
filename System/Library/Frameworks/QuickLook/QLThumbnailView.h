...
- (void).cxx_destruct;	// IMP=0x000000000007c06b
...
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000007bf2d
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000007bcc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000007bc2f
