...
- (void).cxx_destruct;	// IMP=0x0000000000033732
...
- (void)_didDetermineFileSize:(id)arg1 fileTypeString:(id)arg2;	// IMP=0x00000000000335b1
- (void)_didGenerateThumbnail:(id)arg1;	// IMP=0x00000000000334f4
- (void)_finishIfNeeded;	// IMP=0x00000000000334c6
- (void)main;	// IMP=0x00000000000332a4
- (id)initWithListCell:(id)arg1 index:(unsigned long long)arg2 item:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000000331bc
