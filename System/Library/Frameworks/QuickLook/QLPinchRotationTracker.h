...
- (void)update;	// IMP=0x0000000000047b96
...
- (void)trackRotation:(double)arg1;	// IMP=0x0000000000047b34
- (void)trackScale:(double)arg1;	// IMP=0x0000000000047b13
- (void)trackGestureLocation:(struct CGPoint)arg1;	// IMP=0x0000000000047ad9
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x00000000000479a1
- (id)init;	// IMP=0x000000000004794e
