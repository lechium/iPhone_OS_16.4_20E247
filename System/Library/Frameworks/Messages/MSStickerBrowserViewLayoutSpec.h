...
+ (id)specWithSizeClass:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x0060000000013ce2
...
- (id)initWithSize:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x0000000000013db6
