...
- (void).cxx_destruct;	// IMP=0x000000000000f4df
@property(retain, nonatomic) CALayer *borderLayer; // @synthesize borderLayer=_borderLayer;
- (void)setAnimating:(_Bool)arg1;	// IMP=0x000000000000f47f
- (void)showCellBorder:(_Bool)arg1;	// IMP=0x000000000000f414
...
- (void)layoutSubviews;	// IMP=0x000000000000ee6c
- (void)prepareForReuse;	// IMP=0x000000000000eddd
