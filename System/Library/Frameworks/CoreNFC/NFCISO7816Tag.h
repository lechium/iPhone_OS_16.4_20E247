...
- (void)sendCommandAPDU:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000017b5c
@property(readonly, retain, nonatomic) NSString *initialSelectedAID;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017aed
