...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000007227
- (void).cxx_destruct;	// IMP=0x0000000000008d29
...
- (id)description;	// IMP=0x00000000000089ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000083ec
- (id)validateConfiguration;	// IMP=0x000000000000804b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007853
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000722f
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2 options:(id)arg3;	// IMP=0x0000000000007184
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2;	// IMP=0x0000000000006df5
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000006dde
- (id)initWithCustomPasswordConfiguration:(id)arg1 context:(id)arg2;	// IMP=0x00000000000040c8
