...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000062fd
- (unsigned long long)hash;	// IMP=0x00000000000060d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005e3d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005c4e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000005acd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005951
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005944
- (id)dictionaryRepresentation;	// IMP=0x00000000000050bc
- (id)description;	// IMP=0x000000000000500d
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x0000000000050833
- (id)initWithObjectValue:(id)arg1;	// IMP=0x00000000000507ba
