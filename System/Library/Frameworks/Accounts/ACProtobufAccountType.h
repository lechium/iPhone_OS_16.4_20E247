...
- (void).cxx_destruct;	// IMP=0x0000000000054f20
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000054c8b
- (unsigned long long)hash;	// IMP=0x0000000000054b28
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000548bf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000054704
- (void)copyTo:(id)arg1;	// IMP=0x00000000000545b0
- (void)writeTo:(id)arg1;	// IMP=0x000000000005445d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000054450
- (id)dictionaryRepresentation;	// IMP=0x0000000000053cab
- (id)description;	// IMP=0x0000000000053bfc
