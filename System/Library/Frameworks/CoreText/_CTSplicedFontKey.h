...
- (id)description;	// IMP=0x0000000000086922
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000866b8
- (unsigned long long)hash;	// IMP=0x00000000000866ae
- (void)dealloc;	// IMP=0x000000000008665d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000086652
