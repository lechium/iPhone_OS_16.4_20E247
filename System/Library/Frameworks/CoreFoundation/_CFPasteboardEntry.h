...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x000000000006be9c
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000006bb73
- (unsigned char)resolveLocalPromisedData;	// IMP=0x000000000006bac8
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x000000000006b99f
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x000000000006b867
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x000000000006b4b5
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(unsigned char)arg1;	// IMP=0x000000000006b35a
@property(readonly) unsigned char hasLocalPromise;
- (const struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x000000000006b209
- (id)_createXPCData;	// IMP=0x000000000006b1b4
- (void)setData:(struct __CFData *)arg1;	// IMP=0x000000000006b11e
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x000000000006af74
- (void)dealloc;	// IMP=0x000000000006aea4
- (id)initWithFlavorName:(const struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x000000000006ae08
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x00000000000923c7
