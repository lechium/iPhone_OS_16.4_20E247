...
- (void).cxx_destruct;	// IMP=0x0000000000077b44
...
- (id)rightAccessory;	// IMP=0x0000000000077998
- (id)leftAccessory;	// IMP=0x0000000000077954
- (id)rightIcon;	// IMP=0x0000000000077910
- (id)leftIcon;	// IMP=0x00000000000778cc
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000076d84
