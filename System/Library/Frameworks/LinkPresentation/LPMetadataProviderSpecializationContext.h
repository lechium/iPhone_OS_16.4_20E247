...
- (void).cxx_destruct;	// IMP=0x0000000000063149
...
- (void)ensureEventWithSpecialization:(unsigned long long)arg1;	// IMP=0x000000000006309f
- (id)initWithURL:(id)arg1 MIMEType:(id)arg2 webView:(id)arg3 hasLoadedResource:(_Bool)arg4 shouldFetchSubresources:(_Bool)arg5 allowedSpecializations:(unsigned long long)arg6;	// IMP=0x0000000000062f49
