...
- (void).cxx_destruct;	// IMP=0x000000000008e7a5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008e6a8
- (id)stringValue;	// IMP=0x000000000008e5f0
- (id)initWithHandle:(id)arg1 nameComponents:(id)arg2;	// IMP=0x000000000008e528
