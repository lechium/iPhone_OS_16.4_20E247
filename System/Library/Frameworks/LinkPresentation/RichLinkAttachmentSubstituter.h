...
- (void).cxx_destruct;	// IMP=0x0000000000086cfc
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x0000000000086c6e
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x000000000008661a
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x000000000008630d
- (id)init;	// IMP=0x000000000008629f
