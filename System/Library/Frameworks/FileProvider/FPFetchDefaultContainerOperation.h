...
- (void).cxx_destruct;	// IMP=0x00000000000efc33
@property(copy, nonatomic) CDUnknownBlockType fetchCompletionBlock; // @synthesize fetchCompletionBlock=_fetchCompletionBlock;
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000000efb57
- (void)actionMain;	// IMP=0x00000000000ef88c
- (id)initForApplicationRecord:(id)arg1 providerDomain:(id)arg2;	// IMP=0x00000000000ef76c
