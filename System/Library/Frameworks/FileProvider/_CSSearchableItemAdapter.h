...
+ (id)fp_queryFetchAttributes;	// IMP=0x00100000000b94f5
- (void).cxx_destruct;	// IMP=0x00000000000bb350
...
- (id)fp_appContainerBundleIdentifier;	// IMP=0x00000000000bb1ae
- (id)sharingCurrentUserPermissions;	// IMP=0x00000000000bb157
@property(readonly, nonatomic, getter=isMostRecentVersionDownloaded) _Bool mostRecentVersionDownloaded;
- (_Bool)isRecursivelyDownloaded;	// IMP=0x00000000000bb06d
@property(readonly, nonatomic, getter=isDownloaded) _Bool downloaded;
@property(readonly) _Bool isCollaborationInvitation;
- (id)formerIdentifier;	// IMP=0x00000000000bade0
@property(readonly, copy) NSString *fp_parentDomainIdentifier;
- (_Bool)isInPinnedFolder;	// IMP=0x00000000000bad14
- (_Bool)isPinned;	// IMP=0x00000000000bac9f
- (id)collaborationIdentifier;	// IMP=0x00000000000bac48
...
- (id)tags;	// IMP=0x00000000000b9fdc
...
- (id)containerSubitemCount;	// IMP=0x00000000000b9bcf
- (id)sharingCurrentUserRole;	// IMP=0x00000000000b9b7f
...
- (id)initWithSearchableItem:(id)arg1;	// IMP=0x00000000000b9474
