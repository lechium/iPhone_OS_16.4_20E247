...
- (void)runFPCKForDomainWithID:(NSString *)arg1 databasesBackupsPath:(NSDictionary *)arg2 url:(NSURL *)arg3 options:(unsigned long long)arg4 reason:(unsigned long long)arg5 completionHandler:(void (^)(NSString *, FPCKStats *, NSDictionary *, NSError *))arg6;
...
- (void)addDomain:(NSFileProviderDomain *)arg1 forProviderIdentifier:(NSString *)arg2 byImportingDirectoryAtURL:(FPSandboxingURLWrapper *)arg3 nonWrappedURL:(NSURL *)arg4 completionHandler:(void (^)(NSString *, NSError *))arg5;
