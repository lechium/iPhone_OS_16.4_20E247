...
- (void).cxx_destruct;	// IMP=0x00000000000822ef
...
- (void)finishEnumeratingWithError:(id)arg1;	// IMP=0x0000000000081e9c
- (void)finishEnumeratingUpToPage:(id)arg1;	// IMP=0x00000000000819c7
- (void)didEnumerateItems:(id)arg1;	// IMP=0x000000000008141e
- (id)initWithObservedItemID:(id)arg1 domainContext:(id)arg2 nsFileProviderRequest:(id)arg3;	// IMP=0x00000000000813b2
