...
- (void).cxx_destruct;	// IMP=0x0000000000119d62
@property(readonly, copy, nonatomic) NSDate *contentModificationDate;
@property(readonly, copy, nonatomic) NSNumber *documentSize;
- (id)cloudContainerIdentifier;	// IMP=0x0000000000119ca6
- (_Bool)isContainerPristine;	// IMP=0x0000000000119c90
- (_Bool)isContainer;	// IMP=0x0000000000119c7a
...
- (id)providerID;	// IMP=0x0000000000119c0c
...
- (id)collaborationIdentifier;	// IMP=0x0000000000119b04
...
- (id)initWithOriginalDocumentItem:(id)arg1 alternateContentsURL:(id)arg2;	// IMP=0x0000000000119746
