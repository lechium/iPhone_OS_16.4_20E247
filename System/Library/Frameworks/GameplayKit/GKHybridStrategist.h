...
- (id)bestMoveForActivePlayer;	// IMP=0x000000000003264a
- (_Bool)validateRandomSource;	// IMP=0x00000000000325d5
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x000000000003248e
- (void)dealloc;	// IMP=0x0000000000032440
- (id)init;	// IMP=0x00000000000323b5
