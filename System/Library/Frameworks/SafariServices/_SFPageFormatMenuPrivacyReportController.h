...
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000017816
- (void)profileConnectionDidReceiveRestrictionChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000017804
- (void)_dismissPromptIfTrackerProtectionEnabled;	// IMP=0x00000000000177a7
- (void)_initializeManagedProfileConnection;	// IMP=0x0000000000017733
- (void)_presentPrivacyReport;	// IMP=0x0000000000017537
- (_Bool)_presentPromptToTurnOnTrackingProtection;	// IMP=0x000000000001735b
@property(readonly, nonatomic) _SFSettingsAlertItem *alertItem;
- (void)dealloc;	// IMP=0x0000000000016c64
- (id)initWithDocument:(id)arg1;	// IMP=0x0000000000016be6
