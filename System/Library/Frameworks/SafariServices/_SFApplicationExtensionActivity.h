...
- (void).cxx_destruct;	// IMP=0x00000000000c1459
...
- (_Bool)validateExtensionHasSameContainerAsHostApp:(id)arg1;	// IMP=0x00000000000c12a2
- (void)activityDidFinish:(_Bool)arg1 items:(id)arg2 error:(id)arg3;	// IMP=0x00000000000c1083
