...
- (void).cxx_destruct;	// IMP=0x00000000000d0160
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000d010d
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000d001a
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000000cffaa
- (id)initWithProtocol:(id)arg1;	// IMP=0x00000000000cfd95
