...
- (void).cxx_destruct;	// IMP=0x00000000000a8ffa
...
- (void)checkURL:(id)arg1;	// IMP=0x00000000000a8dca
- (void)auditUsageIfNeeded;	// IMP=0x00000000000a8b97
@property(readonly, nonatomic) NSString *stringAsAuditKey;
@property(readonly, nonatomic) _Bool shouldAudit;
- (id)initWithHostAppIdentifier:(id)arg1;	// IMP=0x00000000000a8a2b
