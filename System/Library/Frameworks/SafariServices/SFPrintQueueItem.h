...
- (void).cxx_destruct;	// IMP=0x000000000005cc39
...
- (void)completeWithResult:(long long)arg1;	// IMP=0x000000000005cbfd
- (void)dealloc;	// IMP=0x000000000005cbce
- (id)initWithFrameHandle:(id)arg1 initiatedByWebContent:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000005cb19
