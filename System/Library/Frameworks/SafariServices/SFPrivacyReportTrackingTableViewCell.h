...
- (void).cxx_destruct;	// IMP=0x000000000011d8e4
...
- (void)_updateCountViews;	// IMP=0x000000000011d637
- (id)initWithDetailLabel:(_Bool)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000011c6d8
