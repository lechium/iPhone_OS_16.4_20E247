...
+ (double)defaultHeightInsideQuickboard;	// IMP=0x0040000000104277
+ (double)defaultHeight;	// IMP=0x004000000010426e
+ (double)defaultTopOffset;	// IMP=0x0040000000104265
- (void).cxx_destruct;	// IMP=0x00000000001042f9
...
- (void)updateWithDomain:(id)arg1 isSecure:(_Bool)arg2 showsNotSecureAnnotation:(_Bool)arg3;	// IMP=0x0000000000104280
