...
- (void).cxx_destruct;	// IMP=0x0000000000181a44
...
- (_Bool)allowsSelfSizing;	// IMP=0x00000000001819bd
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000181932
- (void)_useStrongPasswordButtonAction:(id)arg1;	// IMP=0x00000000001818db
- (long long)keyboardAppearance;	// IMP=0x00000000001818be
- (void)setKeyboardAppearance:(long long)arg1;	// IMP=0x00000000001818a1
- (id)initWithInputViewStyle:(long long)arg1 keyboardType:(long long)arg2;	// IMP=0x00000000001813fa
