...
- (void).cxx_destruct;	// IMP=0x000000000009f171
...
- (id)viewForLastBaselineLayout;	// IMP=0x000000000009f100
- (void)_tappedDownloadButton:(id)arg1;	// IMP=0x000000000009f0e0
- (id)initWithTappedDownloadBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000009ea34
