...
+ (id)accountCellDataWithSavedAccount:(id)arg1 warning:(id)arg2 searchPattern:(id)arg3 savedAccountIsOnlySavedAccountForHighLevelDomain:(_Bool)arg4;	// IMP=0x0060000000003c47
- (void).cxx_destruct;	// IMP=0x0000000000003efa
...
- (unsigned long long)hash;	// IMP=0x0000000000003e79
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003dd9
@property(readonly, copy, nonatomic) NSString *highLevelDomain;
- (id)initWithSavedAccount:(id)arg1 warning:(id)arg2 searchPattern:(id)arg3 savedAccountIsOnlySavedAccountForHighLevelDomain:(_Bool)arg4;	// IMP=0x0000000000003ce0
