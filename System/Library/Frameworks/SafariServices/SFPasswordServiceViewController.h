...
+ (id)_remoteViewControllerInterface;	// IMP=0x00000000001467bd
- (void).cxx_destruct;	// IMP=0x0000000000146967
@property(readonly, nonatomic) NSString *applicationIdentifier; // @synthesize applicationIdentifier=_applicationIdentifier;
- (void)_willAppearInRemoteViewController;	// IMP=0x00000000001467dd
