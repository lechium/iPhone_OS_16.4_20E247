...
- (void).cxx_destruct;	// IMP=0x0000000000040322
...
- (void)_updateTitle;	// IMP=0x000000000004016a
- (void)_selectDetailType:(long long)arg1;	// IMP=0x00000000000400fb
- (void)_addSegmentForDetailType:(long long)arg1;	// IMP=0x000000000003ff3b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000003f8e1
