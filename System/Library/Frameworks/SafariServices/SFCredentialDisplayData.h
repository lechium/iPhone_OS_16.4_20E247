...
+ (id)descriptionForPasswordWithUser:(id)arg1 creationDate:(id)arg2;	// IMP=0x00600000000db20d
- (void).cxx_destruct;	// IMP=0x00000000000db49e
...
- (id)initWithMatch:(id)arg1 detail:(id)arg2 creationDate:(id)arg3;	// IMP=0x00000000000db39e
