...
- (void).cxx_destruct;	// IMP=0x00000000000303c9
...
- (void)updateWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000000300d0
- (void)_updateProgressSubscriptionWithData:(id)arg1;	// IMP=0x000000000002fe3a
- (void)_didLoseProgress:(id)arg1;	// IMP=0x000000000002fc69
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000002fbdf
- (void)_didGainProgress:(id)arg1;	// IMP=0x000000000002fb2e
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000002fac1
