...
- (void).cxx_destruct;	// IMP=0x000000000011f78a
...
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x000000000011f6da
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000011f5b4
- (void)_updateTopSpacing;	// IMP=0x000000000011f52b
- (void)_updateTopConstraints;	// IMP=0x000000000011f4c4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000011e8f7
