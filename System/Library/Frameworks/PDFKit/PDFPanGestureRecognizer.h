...
- (struct CGPoint)locationOfFirstTouchInView:(id)arg1;	// IMP=0x000000000008c41b
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000008c26a
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000008bf81
- (void)reset;	// IMP=0x000000000008bf33
