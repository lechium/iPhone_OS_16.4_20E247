...
- (void)foundResults:(id)arg1 forDocument:(id)arg2;	// IMP=0x000000000001fe9c
- (void)foundResults:(id)arg1 forPage:(id)arg2;	// IMP=0x000000000001fd1d
- (_Bool)cancelFind;	// IMP=0x000000000001fd10
- (void)invalidate;	// IMP=0x000000000001fd06
- (id)initWithSearchString:(id)arg1 aggregator:(id)arg2;	// IMP=0x000000000001fc69
