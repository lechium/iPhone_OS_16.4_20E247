...
- (void).cxx_destruct;	// IMP=0x00000000000055b9
- (void)_notifyPropertyChanged:(long long)arg1;	// IMP=0x00000000000054c7
...
- (void)dealloc;	// IMP=0x0000000000005158
- (id)init;	// IMP=0x0000000000005017
