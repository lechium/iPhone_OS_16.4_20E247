...
- (id)bufferForAttribute:(long long)arg1;	// IMP=0x00000000001158c7
- (void)dealloc;	// IMP=0x0000000000115861
- (id)description;	// IMP=0x00000000001155f7
...
- (void)buildTessellationVertexDescriptorIfNeeded;	// IMP=0x0000000000115201
