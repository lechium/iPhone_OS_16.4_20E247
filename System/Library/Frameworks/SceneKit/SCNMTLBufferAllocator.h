...
- (id)newSubBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 renderContext:(id)arg3;	// IMP=0x00000000000e14d5
- (id)_newSubBuffer;	// IMP=0x00000000000e12b6
- (void)dealloc;	// IMP=0x00000000000e126c
- (id)initWithDevice:(id)arg1 fixedSizeElement:(unsigned long long)arg2 buffersize:(unsigned long long)arg3 name:(id)arg4;	// IMP=0x00000000000e11a6
