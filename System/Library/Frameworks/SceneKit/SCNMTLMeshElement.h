...
- (void)setPrimitiveRange:(CDStruct_912cb5d2)arg1;	// IMP=0x0000000000115cb4
@property(readonly, nonatomic) long long effectivePrimitiveCount;
@property(readonly, nonatomic) long long primitiveCount;
- (void)setupWithElement:(struct __C3DMeshElement *)arg1;	// IMP=0x0000000000115ac4
- (id)description;	// IMP=0x0000000000115a38
- (void)dealloc;	// IMP=0x00000000001159f8
