...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002d8f74
...
- (void)dealloc;	// IMP=0x00000000002d9083
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002d9032
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002d8f7c
