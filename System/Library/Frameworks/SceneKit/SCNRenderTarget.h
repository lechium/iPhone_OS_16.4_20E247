...
- (id)ciImage;	// IMP=0x000000000008eb0f
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000008e990
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008e88b
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000008e7d8
- (void)dealloc;	// IMP=0x000000000008e780
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008e726
