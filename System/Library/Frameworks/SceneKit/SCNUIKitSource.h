...
- (void)dealloc;	// IMP=0x0000000000284982
- (_Bool)isOpaque;	// IMP=0x0000000000284972
- (id)textureSource;	// IMP=0x0000000000284883
- (id)prepareWindowIfNeeded;	// IMP=0x0000000000284630
- (_Bool)supportsMetal;	// IMP=0x0000000000284628
- (id)init;	// IMP=0x00000000002845f9
