...
@interface SCNMTLRenderContext : NSObject
{
    ...
    } _deferredRendering;	// 15296 = 0x3bc0
    struct {
        unsigned long long hash;
        SCNMTLRenderPipeline *pipeline;
    } _compositeRendering[2];	// 15472 = 0x3c70
    SCNMTLRenderPipeline *_downSamplePipeline;	// 15504 = 0x3c90
    struct {
        id <MTLTexture> backgroundTexture;
        id <MTLTexture> overlayTexture;
        id <MTLTexture> stencilDepthTexture;
    } _skCompositing;	// 15512 = 0x3c98
    struct {
    ...
    _Bool _showsAuthoringEnvironment;	// 15584 = 0x3ce0
    struct {
        _Bool collectEnabled;
        NSMutableDictionary *errors;
    } _compilationIssues;	// 15592 = 0x3ce8
    struct {
    ...
    } _counters;	// 15608 = 0x3cf8
    struct {
        unsigned long long passHash;
        struct __C3DMaterial *material;
    } _renderGraph;	// 15624 = 0x3d08
    id <SCNMTLRenderContextResourceManagerMonitor> _resourceManagerMonitor;	// 15640 = 0x3d18
    id <SCNMTLRenderContextCommandBufferStatusMonitor> _commandBufferStatusMonitor;	// 15648 = 0x3d20
    id _commandBufferScheduledHandlers;	// 15656 = 0x3d28
    id _commandBufferCompletedHandlers;	// 15664 = 0x3d30
    id _drawablePresentedHandlers;	// 15672 = 0x3d38
    _Bool enablesDeferredShading;	// 15680 = 0x3d40
    MTLRenderPassDescriptor *_clientRenderPassDescriptor;	// 15688 = 0x3d48
    id <MTLRenderCommandEncoder> _clientRenderCommandEncoder;	// 15696 = 0x3d50
    id <MTLCommandBuffer> _clientCommandBuffer;	// 15704 = 0x3d58
    unsigned long long _debugOptions;	// 15712 = 0x3d60
    double _contentScaleFactor;	// 15720 = 0x3d68
    id <MTLCommandQueue> _clientCommandQueue;	// 15728 = 0x3d70
    NSString *_generatedTexturePath;	// 15736 = 0x3d78
}

+ (void)registerBindings;	// IMP=0x00100000000d2656
- (id).cxx_construct;	// IMP=0x00000000000d8f91
- (void).cxx_destruct;	// IMP=0x00000000000d8f4f
...
- (void)addDrawablePresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d8cc6
- (void)addCommandBufferCompletedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d8bb3
- (void)addCommandBufferScheduledHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d8aa0
- (unsigned long long)cubeArrayTypeIfSupported;	// IMP=0x00000000000d8a88
- (struct __C3DMaterial *)getCurrentPassMaterial;	// IMP=0x00000000000d8a7b
- (unsigned long long)getCurrentPassHash;	// IMP=0x00000000000d8a6e
- (void)setCurrentPassMaterial:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000d8a61
- (void)setCurrentPassHash:(unsigned long long)arg1;	// IMP=0x00000000000d8a54
- (void)writeBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x00000000000d89c6
- (void)endRenderCommandEncoding;	// IMP=0x00000000000d894f
- (void)renderSKSceneWithRenderer:(id)arg1 overlay:(_Bool)arg2 atTime:(double)arg3;	// IMP=0x00000000000d82f6
- (MISSING_TYPE *)renderSize;	// IMP=0x00000000000d82e8
- (float)renderTime;	// IMP=0x00000000000d82da
- (void)_drawFullScreenTexture:(id)arg1 over:(_Bool)arg2;	// IMP=0x00000000000d7f80
- (void)_drawShadowMaps;	// IMP=0x00000000000d7866
- (void)_drawPBRTextures;	// IMP=0x00000000000d6f54
...
- (void)endDeferredLighting;	// IMP=0x00000000000d6f0b
- (void)renderLight:(struct __C3DNode *)arg1 lightType:(int)arg2 lightData:(struct __C3DLightRuntimeData *)arg3;	// IMP=0x00000000000d6b80
- (void)beginDeferredLighting;	// IMP=0x00000000000d68a0
- (void)drawFullScreenQuadForPass:(struct __C3DFXPass *)arg1;	// IMP=0x00000000000d677d
- (void)resetVolatileMeshElements;	// IMP=0x00000000000d6583
- (void)unmapVolatileMeshElement:(struct __C3DMeshElement *)arg1;	// IMP=0x00000000000d650b
- (struct __C3DMeshElement *)createVolatileMeshElementOfType:(BOOL)arg1 primitiveCount:(long long)arg2 bytesPerIndex:(long long)arg3;	// IMP=0x00000000000d6320
- (void)_recycleMTLBufferToPool:(id)arg1;	// IMP=0x00000000000d6286
- (id)_newMTLBufferFromPoolWithLength:(unsigned long long)arg1;	// IMP=0x00000000000d61a8
- (void)resetVolatileMeshes;	// IMP=0x00000000000d6071
- (void)unmapVolatileMesh:(struct __C3DMesh *)arg1 modifiedVerticesCount:(long long)arg2;	// IMP=0x00000000000d5f58
- (_Bool)mapVolatileMesh:(struct __C3DMesh *)arg1 verticesCount:(long long)arg2;	// IMP=0x00000000000d5d43
- (void)drawWireframeOverlayForElements:(CDStruct_d65e47c4 *)arg1 range:(CDStruct_912cb5d2)arg2 store:(struct __C3DRendererElementStore *)arg3 passInstance:(struct __C3DFXPassInstance *)arg4;	// IMP=0x00000000000d23a3
...
- (void)drawRenderElement:(struct __C3DRendererElement *)arg1 withPass:(struct __C3DFXPass *)arg2;	// IMP=0x00000000000cf189
- (void)_prepareMaterialTextures:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000cf0cb
- (void)stopProcessingRendererElements:(_Bool)arg1;	// IMP=0x00000000000cefb8
- (void)startProcessingRendererElementsWithEngineIterationContext:(CDStruct_65434d98 *)arg1;	// IMP=0x00000000000ce347
- (void)processRendererElements:(CDStruct_d65e47c4 *)arg1 count:(unsigned int)arg2 engineIterationContext:(CDStruct_65434d98 *)arg3;	// IMP=0x00000000000cd823
- (void)renderMesh:(struct __C3DMesh *)arg1 meshElement:(struct __C3DMeshElement *)arg2 withProgram:(struct __C3DFXMetalProgram *)arg3 engineContext:(struct __C3DEngineContext *)arg4 transform:(union C3DMatrix4x4)arg5 color:(const struct C3DColor4 *)arg6 rasterizerStates:(struct __C3DRasterizerStates *)arg7 blendState:(struct __C3DBlendStates *)arg8 texture:(struct __C3DImage *)arg9 depthBias:(_Bool)arg10;	// IMP=0x00000000000cd497
- (void)renderVideoBackground:(struct __C3DImageProxy *)arg1 engineContext:(struct __C3DEngineContext *)arg2 slot:(struct __C3DEffectSlot *)arg3;	// IMP=0x00000000000ccc53
- (void)renderBackground:(struct __C3DEffectSlot *)arg1 engineContext:(struct __C3DEngineContext *)arg2 passInstance:(struct __C3DFXPassInstance *)arg3;	// IMP=0x00000000000cc1f5
- (float)_zFarForSkyboxRenderingProjectionMatrix:(const union C3DMatrix4x4 *)arg1 defaultZFar:(float)arg2;	// IMP=0x00000000000cc1d6
- (void)_updateProjectionMatrixForOrthographicSkyboxRenderingIfNeeded:(union C3DMatrix4x4 *)arg1;	// IMP=0x00000000000cbf1d
- (void)_drawPatchForMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000cbd4e
- (void)_drawMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000cba27
- (void)_setMeshBuffers:(id)arg1;	// IMP=0x00000000000cb774
- (void)_setSceneBufferAtVertexIndex:(long long)arg1 fragmentIndex:(long long)arg2;	// IMP=0x00000000000cb716
- (void)popDebugGroup;	// IMP=0x00000000000cb6f6
- (void)pushDebugGroup:(id)arg1;	// IMP=0x00000000000cb6d6
- (void)setRasterizerStates:(struct __C3DRasterizerStates *)arg1;	// IMP=0x00000000000cb531
- (void)_logLightingInformation;	// IMP=0x00000000000cb4da
- (id)radianceTextureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000cb410
- (id)irradianceTextureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000cb2db
- (id)textureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000cb2b8
- (id)newRenderTargetWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000cb01d
- (void)endRenderPass;	// IMP=0x00000000000caf6a
- (void)beginRenderPass:(id)arg1 renderEncoder:(void *)arg2 parameters:(CDStruct_365d5154)arg3;	// IMP=0x00000000000cae3b
...
- (void)_createResourceCommandBufferIfNeeded;	// IMP=0x00000000000cab23
- (void)_clearRenderCaches;	// IMP=0x00000000000caae2
- (void *)_clusterInfo;	// IMP=0x00000000000caad5
- (void)_setReflectionProbeArrayTexture:(id)arg1;	// IMP=0x00000000000caac8
- (id)_reflectionProbeArrayTexture;	// IMP=0x00000000000caabb
- (id)_finalRenderTexture;	// IMP=0x00000000000ca92d
@property(readonly, nonatomic) CAMetalLayer *layerTarget;
@property(readonly, nonatomic) id <MTLTexture> textureTarget;
- (void)endFrameWaitingUntilCompleted:(_Bool)arg1 status:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000000ca0dd
- (void)endFrameSceneSpecifics;	// IMP=0x00000000000ca0af
- (void)beginFrame:(id)arg1;	// IMP=0x00000000000c9ccf
...
- (struct __C3DEngineStats *)stats;	// IMP=0x00000000000c9ca1
- (void)_clearUnusedBindingPoints;	// IMP=0x00000000000c9ad8
...
- (_Bool)supportsMTLFeatureSet:(unsigned long long)arg1;	// IMP=0x00000000000c986f
...
- (void)dealloc;	// IMP=0x00000000000c93fc
- (id)initWithDevice:(id)arg1 engineContext:(struct __C3DEngineContext *)arg2;	// IMP=0x00000000000c8de0
- (void)_reduceStatsOfConstantBuffer:(id)arg1;	// IMP=0x00000000000c8dac
- (struct __C3DFXPass *)_createPassWithVertex:(id)arg1 fragment:(id)arg2;	// IMP=0x00000000000c8cd4
- (id)renderTargetInfo;	// IMP=0x00000000000fedc5
- (void)viewports:(const void **)arg1:(long long *)arg2;	// IMP=0x00000000000fed95
- (_Bool)constantOffsetAndSize:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x00000000000fed63
- (const char *)constantData:(int)arg1;	// IMP=0x00000000000fed31
- (id)sampler:(int)arg1:(id)arg2;	// IMP=0x00000000000fecff
- (id)buffer:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x00000000000feccd
- (id)texture:(int)arg1:(id)arg2;	// IMP=0x00000000000fec9b
- (unsigned long long)colorPixelFormatAtIndex:(long long)arg1;	// IMP=0x00000000000fee19
- (unsigned long long)depthStencilPixelFormat;	// IMP=0x00000000000fedd6
- (_Bool)vrrEnabled;	// IMP=0x00000000000fedce
