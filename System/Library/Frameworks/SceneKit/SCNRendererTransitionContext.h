...
- (void)dealloc;	// IMP=0x0000000000197b82
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x0000000000197a10
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001979bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019791a
