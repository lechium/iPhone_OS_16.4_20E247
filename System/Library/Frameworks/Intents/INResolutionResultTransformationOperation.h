...
- (_Bool)isExecuting;	// IMP=0x00000000001c16d6
- (_Bool)isFinished;	// IMP=0x00000000001c16c6
- (void)start;	// IMP=0x00000000001c15ca
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001c14d3
