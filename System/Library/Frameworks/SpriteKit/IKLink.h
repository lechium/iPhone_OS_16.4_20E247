...
- (void).cxx_destruct;	// IMP=0x000000000002d54e
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002d238
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002d1d9
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002d104
