...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a4e42
- (id).cxx_construct;	// IMP=0x00000000001a4c82
- (void).cxx_destruct;	// IMP=0x00000000001a4bd7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a4834
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a434c
