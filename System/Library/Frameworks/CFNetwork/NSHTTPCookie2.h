...
- (void).cxx_destruct;	// IMP=0x0000000000084782
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084463
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084458
- (id)description;	// IMP=0x000000000008424c
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x0000000000084011
