...
- (id)uploadTaskWithStreamedRequest:(id)arg1;	// IMP=0x00000000001c077f
- (id)dataTaskWithRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001c0704
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x00000000001c069c
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001c066b
- (void)dealloc;	// IMP=0x00000000001c0621
