...
- (void).cxx_destruct;	// IMP=0x000000000015a4bc
- (id)finish:(int)arg1;	// IMP=0x000000000015a2f4
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015996f
