...
- (void).cxx_destruct;	// IMP=0x000000000012d067
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x000000000012c6b1
- (long long)_flags;	// IMP=0x000000000012c196
- (id)initWithCookie:(id)arg1;	// IMP=0x000000000012c004
