...
- (void).cxx_destruct;	// IMP=0x00000000000f039f
...
- (id)numberFromCString:(const char *)arg1;	// IMP=0x00000000000f0064
- (void)extractAndSetModelDetailsFromArchive:(void *)arg1;	// IMP=0x00000000000ef571
