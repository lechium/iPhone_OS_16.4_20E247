...
+ (id)sharedHandle;	// IMP=0x00600000001557da
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x000000000015559f
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000155450
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000155304
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001551b8
- (const void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000155170
- (const void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000015512b
- (const void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001550e6
- (const void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001550a1
- (id)init;	// IMP=0x0000000000154df1
