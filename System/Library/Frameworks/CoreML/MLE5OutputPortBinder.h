...
- (id)_makeFeatureValueAndReturnError:(id *)arg1;	// IMP=0x00000000000fe164
@property(readonly) MLFeatureValue *featureValue;
- (_Bool)bindAndReturnError:(id *)arg1;	// IMP=0x00000000000fdcbe
- (id)initWithPort:(struct e5rt_io_port *)arg1 featureDescription:(id)arg2;	// IMP=0x00000000000fdc18
