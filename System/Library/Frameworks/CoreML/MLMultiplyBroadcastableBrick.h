...
- (void).cxx_destruct;	// IMP=0x000000000007a193
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000797eb
- (_Bool)hasGPUSupport;	// IMP=0x00000000000797e3
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000795a2
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000079281
