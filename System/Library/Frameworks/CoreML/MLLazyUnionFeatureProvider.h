...
- (void).cxx_destruct;	// IMP=0x00000000000abde7
...
- (id)unionFeatureProvider;	// IMP=0x00000000000abad6
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000aba49
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFeaturesFrom:(id)arg1 addedToFeaturesFrom:(id)arg2;	// IMP=0x00000000000ab8e9
