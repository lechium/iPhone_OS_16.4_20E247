...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000028a2c
- (_Bool)hasGPUSupport;	// IMP=0x0000000000028a24
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000287b7
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000028503
