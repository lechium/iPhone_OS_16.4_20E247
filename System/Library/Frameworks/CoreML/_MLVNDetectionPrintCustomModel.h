...
- (void).cxx_destruct;	// IMP=0x000000000013f9de
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000013f218
- (id)featureValueFromDetectionPrint:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000013efe1
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x000000000013e158
