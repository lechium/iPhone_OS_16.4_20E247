...
- (void).cxx_destruct;	// IMP=0x000000000002b642
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002affe
- (_Bool)hasGPUSupport;	// IMP=0x000000000002aff6
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002ad89
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002a9e3
