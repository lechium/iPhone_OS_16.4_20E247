...
- (void).cxx_destruct;	// IMP=0x00000000000137d3
...
- (void)putBack:(id)arg1;	// IMP=0x00000000000136ae
- (id)takeOut;	// IMP=0x00000000000135aa
- (id)initWithE5BundleAtURL:(id)arg1 functionName:(id)arg2 outputDescriptionsByName:(id)arg3;	// IMP=0x00000000000133f3
