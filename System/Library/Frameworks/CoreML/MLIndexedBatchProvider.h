...
- (void).cxx_destruct;	// IMP=0x000000000015d122
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x000000000015d07b
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 indices:(id)arg2 error:(id *)arg3;	// IMP=0x000000000015cfcc
