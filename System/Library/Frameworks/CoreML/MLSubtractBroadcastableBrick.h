...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000001f460
- (_Bool)hasGPUSupport;	// IMP=0x000000000001f458
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000001f217
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000001eef6
