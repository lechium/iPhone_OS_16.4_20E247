...
- (void).cxx_destruct;	// IMP=0x00000000000bc551
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000bbf93
- (id)featureValueFromScenePrint:(id)arg1 elementSize:(unsigned long long)arg2;	// IMP=0x00000000000bbbd5
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000bb436
