...
- (void).cxx_destruct;	// IMP=0x0000000000021f67
...
- (_Bool)bindFeatureValue:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000215d3
- (id)initWithPort:(struct e5rt_io_port *)arg1;	// IMP=0x0000000000021596
