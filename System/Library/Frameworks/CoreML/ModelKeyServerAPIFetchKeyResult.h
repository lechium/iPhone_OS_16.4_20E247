...
- (void).cxx_destruct;	// IMP=0x00000000000236b7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002350f
- (unsigned long long)hash;	// IMP=0x000000000002343b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000232a3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000023171
- (void)copyTo:(id)arg1;	// IMP=0x000000000002308e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000022fda
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000022fcd
- (id)dictionaryRepresentation;	// IMP=0x0000000000022e0c
- (id)description;	// IMP=0x0000000000022d5d
- (void)clearOneofValuesForKey;	// IMP=0x0000000000022cfd
- (int)StringAsKey:(id)arg1;	// IMP=0x0000000000022c6b
- (id)keyAsString:(int)arg1;	// IMP=0x0000000000022c22
