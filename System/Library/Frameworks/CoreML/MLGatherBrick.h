...
- (void).cxx_destruct;	// IMP=0x00000000000f1ac4
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000f1121
- (_Bool)hasGPUSupport;	// IMP=0x00000000000f1119
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000f0eac
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000f0b87
