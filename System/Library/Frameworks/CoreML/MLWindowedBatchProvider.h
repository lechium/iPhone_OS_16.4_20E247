...
- (void).cxx_destruct;	// IMP=0x000000000015cfbc
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x000000000015cf5c
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 startIndex:(long long)arg2 windowLength:(long long)arg3 error:(id *)arg4;	// IMP=0x000000000015cda1
