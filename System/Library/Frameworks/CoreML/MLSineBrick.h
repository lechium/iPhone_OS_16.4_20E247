...
- (void).cxx_destruct;	// IMP=0x000000000007178d
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000007156d
- (_Bool)hasGPUSupport;	// IMP=0x0000000000071565
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000007142c
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000071416
