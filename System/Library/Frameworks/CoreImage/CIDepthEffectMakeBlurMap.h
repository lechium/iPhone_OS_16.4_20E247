...
+ (id)customAttributes;	// IMP=0x00600000001b26db
...
- (id)outputImage;	// IMP=0x00000000001b70ef
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b6567
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x00000000001b4ff2
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x00000000001b4c4c
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x00000000001b449f
- (id)blurMapV2:(id)arg1;	// IMP=0x00000000001b43cd
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x00000000001b430d
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x00000000001b3efd
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x00000000001b3d0d
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x00000000001b373e
- (_Bool)needToRunFaceMask;	// IMP=0x00000000001b3631
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x00000000001b34c9
- (id)lensModelParams:(id)arg1;	// IMP=0x00000000001b3295
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x00000000001b3042
- (float)intrinsicMatrixFocalLength;	// IMP=0x00000000001b2ff5
- (struct CGSize)originalShiftMapSize;	// IMP=0x00000000001b2f1c
- (id)calibrationData;	// IMP=0x00000000001b2ee5
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001b2e85
