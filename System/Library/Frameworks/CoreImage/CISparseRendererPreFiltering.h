...
- (id)outputImage;	// IMP=0x00000000001134d9
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x0000000000113271
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x0000000000112de8
- (id)_kernel:(_Bool)arg1;	// IMP=0x0000000000112d1f
