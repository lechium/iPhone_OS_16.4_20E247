...
+ (id)customAttributes;	// IMP=0x00600000001679e8
...
- (id)outputImage;	// IMP=0x000000000016802c
- (_Bool)_isIdentity;	// IMP=0x0000000000167eb8
- (struct vec2)_scale;	// IMP=0x0000000000167e3d
