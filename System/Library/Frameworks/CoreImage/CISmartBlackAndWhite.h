...
+ (id)customAttributes;	// IMP=0x006000000015fac7
...
- (id)outputImage;	// IMP=0x0000000000160039
- (id)_kernel;	// IMP=0x0000000000160019
- (id)hueArrayImage:(float *)arg1;	// IMP=0x000000000015f914
- (float *)createHueArray;	// IMP=0x000000000015f7c0
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x000000000015f483
