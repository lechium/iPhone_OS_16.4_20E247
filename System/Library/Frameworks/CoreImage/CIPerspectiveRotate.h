...
+ (id)customAttributes;	// IMP=0x0060000000284cac
- (id).cxx_construct;	// IMP=0x0000000000285747
...
- (id)outputImage;	// IMP=0x00000000002852bf
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x0000000000284f4b
