...
+ (id)customAttributes;	// IMP=0x00600000000e855e
...
- (id)outputImage;	// IMP=0x00000000000e88e6
- (id)cpuParams;	// IMP=0x00000000000e8726
- (id)kernel;	// IMP=0x00000000000e86c9
- (id)mtlKernel;	// IMP=0x00000000000e865c
