...
+ (id)customAttributes;	// IMP=0x00600000000a4757
...
- (id)outputImage;	// IMP=0x00000000000a4d5f
- (id)_geomKernel;	// IMP=0x00000000000a4d3f
- (id)_colorKernel;	// IMP=0x00000000000a4d1f
