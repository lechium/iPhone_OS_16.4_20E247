...
- (id)outputImage;	// IMP=0x0000000000112b29
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x0000000000112181
- (id)noiseColorKernel;	// IMP=0x0000000000112103
- (id)_noiseGeneratorKernel;	// IMP=0x0000000000112096
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x0000000000111f92
