...
+ (id)customAttributes;	// IMP=0x00600000001b1d8e
...
- (id)outputImage;	// IMP=0x00000000001b2206
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x00000000001b1eff
