...
+ (id)customAttributes;	// IMP=0x006000000000a73e
...
- (id)outputImage;	// IMP=0x000000000000ab49
- (id)_kernel;	// IMP=0x000000000000ab29
- (id)_kernelMix;	// IMP=0x000000000000ab09
- (id)_kernelWarpT;	// IMP=0x000000000000aae9
- (id)_kernelWarpS;	// IMP=0x000000000000aac9
