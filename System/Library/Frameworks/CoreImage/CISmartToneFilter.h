...
+ (id)customAttributes;	// IMP=0x000000000016286d
...
- (id)outputImage;	// IMP=0x0000000000163316
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000163275
- (id)_kernelRH;	// IMP=0x0000000000163255
- (id)_kernelH;	// IMP=0x0000000000163235
- (id)_kernelC;	// IMP=0x0000000000163215
- (id)_kernelBpos;	// IMP=0x00000000001631f5
- (id)_kernelBneg;	// IMP=0x00000000001631d5
- (void)dealloc;	// IMP=0x0000000000163158
- (_Bool)_isIdentity;	// IMP=0x0000000000163022
