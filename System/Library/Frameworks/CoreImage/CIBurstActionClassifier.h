...
- (_Bool)isBurstAction;	// IMP=0x000000000001dabb
- (float)predictResult;	// IMP=0x000000000001d9e9
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001d971
- (void)scaleVector;	// IMP=0x000000000001d81d
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001d7b4
- (id)init;	// IMP=0x000000000001d769
