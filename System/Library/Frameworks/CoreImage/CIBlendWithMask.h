...
+ (id)customAttributes;	// IMP=0x0060000000018b01
...
- (id)outputImage;	// IMP=0x0000000000018cc4
- (float)_maskFillColorValue;	// IMP=0x0000000000018c42
- (id)_kernelB0;	// IMP=0x0000000000018c22
- (id)_kernel;	// IMP=0x0000000000018c02
