...
+ (id)customAttributes;	// IMP=0x0060000000101227
...
- (id)outputImage;	// IMP=0x00000000000ff512
- (id)_CIPageCurlTransNoEmap;	// IMP=0x00000000000ff4f2
- (id)_CIPageCurlTransition;	// IMP=0x00000000000ff4d2
