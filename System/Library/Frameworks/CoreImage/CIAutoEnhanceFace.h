...
- (struct CGRect)faceRect;	// IMP=0x00000000001c9098
- (id)description;	// IMP=0x00000000001c905a
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001c8cb8
