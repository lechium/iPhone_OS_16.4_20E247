...
+ (id)customAttributes;	// IMP=0x00600000000fc2e7
...
- (id)outputImage;	// IMP=0x00000000000fc5b9
- (_Bool)_doMinimum;	// IMP=0x00000000000fc5b1
- (_Bool)_isIdentity;	// IMP=0x00000000000fc564
