...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001ddd3
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001dd64
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001dceb
