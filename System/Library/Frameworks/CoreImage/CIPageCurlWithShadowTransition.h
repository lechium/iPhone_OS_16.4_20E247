...
+ (id)customAttributes;	// IMP=0x0060000000102fe3
...
- (id)outputImage;	// IMP=0x0000000000101529
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x0000000000101509
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000001014e9
