...
+ (id)customAttributes;	// IMP=0x0060000000046860
...
- (id)outputImage;	// IMP=0x0000000000046fd0
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000046f0b
- (_Bool)_isIdentity;	// IMP=0x0000000000046c21
- (id)_kernelRGB;	// IMP=0x000000000004681d
- (id)_kernel;	// IMP=0x00000000000467fd
