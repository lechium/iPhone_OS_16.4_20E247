...
+ (id)customAttributes;	// IMP=0x0060000000042976
...
- (id)outputImage;	// IMP=0x0000000000042f1b
- (_Bool)_checkInputs;	// IMP=0x0000000000042df7
- (id)curvesImage;	// IMP=0x0000000000042bd3
- (id)_kernel;	// IMP=0x0000000000042b90
- (void)dealloc;	// IMP=0x00000000000428d7
