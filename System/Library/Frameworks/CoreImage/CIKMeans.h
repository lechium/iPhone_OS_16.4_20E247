...
+ (id)customAttributes;	// IMP=0x00600000001464d7
...
- (id)outputImage;	// IMP=0x0000000000146f1e
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x0000000000146cb1
- (id)_kernelKmeans;	// IMP=0x0000000000146c91
- (id)_combine:(id)arg1;	// IMP=0x00000000001467b8
