...
+ (id)customAttributes;	// IMP=0x00600000001ba5d7
...
- (id)outputImage;	// IMP=0x00000000001bae7c
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001ba9e5
