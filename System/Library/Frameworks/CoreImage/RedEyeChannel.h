...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x00000000001df63c
- (id)filterNameForChannel:(int)arg1;	// IMP=0x00000000001df619
- (id)outputImage;	// IMP=0x00000000001df2d2
