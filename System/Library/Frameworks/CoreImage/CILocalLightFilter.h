...
+ (id)customAttributes;	// IMP=0x00600000000ed1b1
- (id)outputImage;	// IMP=0x00000000000ed55c
- (id)_polyKernel;	// IMP=0x00000000000ed53c
- (id)_shadowKernel;	// IMP=0x00000000000ed51c
