...
+ (id)customAttributes;	// IMP=0x006000000010bf54
...
- (id)outputImage;	// IMP=0x000000000010c5fb
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x000000000010c1b4
- (id)_kernelV;	// IMP=0x000000000010c157
- (id)_kernelH;	// IMP=0x000000000010c0fa
