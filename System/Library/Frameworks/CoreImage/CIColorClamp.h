...
+ (id)customAttributes;	// IMP=0x0060000000040050
...
- (id)outputImage;	// IMP=0x000000000004023c
- (id)_kernelAlphaPreserving;	// IMP=0x000000000004000d
- (id)_kernel;	// IMP=0x000000000003ffed
