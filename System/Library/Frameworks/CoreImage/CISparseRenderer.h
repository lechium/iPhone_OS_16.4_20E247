...
+ (id)customAttributes;	// IMP=0x0000000000113676
...
- (id)outputImage;	// IMP=0x00000000001146ef
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001145b9
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000114483
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x0000000000114397
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x000000000011427b
- (id)baseVecsLUTGenerator;	// IMP=0x000000000011420e
- (id)stepsLUTGenerator;	// IMP=0x00000000001141a1
- (_Bool)_useD2XRenderer;	// IMP=0x0000000000114080
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x00000000001137ea
