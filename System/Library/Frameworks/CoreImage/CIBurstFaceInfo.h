...
- (float)overlapWithSwRect:(struct CGRect)arg1;	// IMP=0x000000000001e3a4
- (float)overlapWithHwRect:(struct CGRect)arg1;	// IMP=0x000000000001e2d3
- (struct CGRect)swFaceRect;	// IMP=0x000000000001e214
- (struct CGRect)hwFaceRect;	// IMP=0x000000000001e155
- (id)init;	// IMP=0x000000000001e046
