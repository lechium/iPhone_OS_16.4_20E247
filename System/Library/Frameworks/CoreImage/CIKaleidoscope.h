...
+ (id)customAttributes;	// IMP=0x00600000000d5608
...
- (id)outputImage;	// IMP=0x00000000000d4dc1
- (struct CGRect)_outputExtent;	// IMP=0x00000000000d46dc
- (id)_kernel;	// IMP=0x00000000000d46bc
