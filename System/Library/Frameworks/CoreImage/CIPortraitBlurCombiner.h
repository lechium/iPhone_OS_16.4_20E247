...
- (id)outputImage;	// IMP=0x0000000000116858
- (id)_ourBlendKernelMetal;	// IMP=0x00000000001167fb
- (id)nonMetalKernelYCC;	// IMP=0x000000000011679e
- (id)nonMetalKernel;	// IMP=0x0000000000116741
- (id)_blendKernel:(_Bool)arg1;	// IMP=0x0000000000116678
