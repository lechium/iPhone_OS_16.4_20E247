...
+ (id)customAttributes;	// IMP=0x00600000000a5f31
- (id)outputImage;	// IMP=0x00000000000a653b
- (id)_focalPlanePreProcessorKernelPow2;	// IMP=0x00000000000a64bd
- (id)_focalPlanePreProcessorKernel;	// IMP=0x00000000000a643f
