...
+ (id)customAttributes;	// IMP=0x0060000000115245
...
- (id)outputImage;	// IMP=0x0000000000115752
- (double)effectiveScale;	// IMP=0x00000000001156be
- (id)sensorSize;	// IMP=0x000000000011559a
