...
- (_Bool)compute;	// IMP=0x0000000000127223
- (void)dealloc;	// IMP=0x00000000001271e8
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x0000000000127096
