...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x000000000003a013
- (void)dealloc;	// IMP=0x0000000000039fa3
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x0000000000039cf5
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x0000000000039b36
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x00000000000396ea
