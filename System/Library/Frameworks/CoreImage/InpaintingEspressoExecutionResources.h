...
+ (void)tearDownEspressoContext:(void **)arg1 andPlan:(void **)arg2;	// IMP=0x006000000017bd90
...
- (id)description;	// IMP=0x000000000017bec6
- (void)freeEspressoResources;	// IMP=0x000000000017bd4a
- (void)updateWithModelResourceDescriptor:(id)arg1 modelResourceFileName:(id)arg2 network:(CDStruct_2bc666a5)arg3 plan:(void *)arg4 context:(void *)arg5 inputBlobNames:(id)arg6 outputBlobNames:(id)arg7 membraneModel:(_Bool)arg8 modelInputPixelFormat:(int)arg9 modelOutputPixelFormat:(int)arg10;	// IMP=0x000000000017bcd1
- (void)dealloc;	// IMP=0x000000000017bc93
- (void)deregisterFilterUsage;	// IMP=0x000000000017bc74
- (void)registerFilterUsage;	// IMP=0x000000000017bc55
- (void)releaseModelIfNoLongerNeeded;	// IMP=0x000000000017bc11
- (_Bool)isModelInitialized;	// IMP=0x000000000017bc03
- (_Bool)initializeModelForResourceDescriptor:(id)arg1 resourceFileName:(id)arg2 inputBlobNames:(id)arg3 outputBlobNames:(id)arg4 cpuOnlyModel:(_Bool)arg5 membraneModel:(_Bool)arg6 modelInputPixelFormat:(int)arg7 modelOutputPixelFormat:(int)arg8 error:(id *)arg9;	// IMP=0x000000000017baf0
- (_Bool)initializeInpaintingModelForResourceDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000017b9c5
- (_Bool)descriptorIsAMembraneModel:(id)arg1 error:(id *)arg2;	// IMP=0x000000000017b977
- (_Bool)parseModelResourceDescriptor:(id)arg1 extractMembraneInfo:(_Bool *)arg2 inputPixelFormat:(int *)arg3 outputPixelFormat:(int *)arg4 andResourceFileName:(id *)arg5 error:(id *)arg6;	// IMP=0x000000000017b7fb
- (id)CIImageProcessorDigestObject;	// IMP=0x000000000017b7e2
- (id)init;	// IMP=0x000000000017b7a0
