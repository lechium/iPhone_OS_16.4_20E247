...
- (id)outputImage;	// IMP=0x0000000000083084
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x0000000000082f82
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x0000000000082e16
