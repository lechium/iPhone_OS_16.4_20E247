...
- (id).cxx_construct;	// IMP=0x0000000000187ad6
- (void).cxx_destruct;	// IMP=0x0000000000187a58
...
- (void)computeTransform;	// IMP=0x00000000001869c7
- (void)computeGuides;	// IMP=0x0000000000185e33
- (void)clusterLineSegments;	// IMP=0x000000000018445e
- (void)extractLineSegments;	// IMP=0x0000000000183dab
- (void)rangeLimitGradientMap;	// IMP=0x0000000000183b06
- (void)thresholdGradientMap;	// IMP=0x000000000018392d
- (void)normalizeGradientMap;	// IMP=0x00000000001835cb
- (void)createGradientMap;	// IMP=0x0000000000183299
- (void)standardizeImage;	// IMP=0x000000000018307d
- (double)confidence;	// IMP=0x0000000000182ff8
- (_Bool)compute;	// IMP=0x0000000000182791
- (void)dealloc;	// IMP=0x0000000000182750
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x00000000001825dc
