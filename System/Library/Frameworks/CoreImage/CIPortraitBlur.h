...
+ (id)customAttributes;	// IMP=0x006000000010d191
...
- (id)outputImage;	// IMP=0x000000000010f2d8
- (id)outputImageV3;	// IMP=0x000000000010f130
- (id)outputImageV2;	// IMP=0x000000000010f06d
- (id)outputImage:(_Bool)arg1;	// IMP=0x000000000010d714
- (id)_ourBlendKernelMetal;	// IMP=0x000000000010d6b7
- (id)_ourBlendKernel;	// IMP=0x000000000010d65a
- (id)_kernelsWithShapes;	// IMP=0x000000000010d5fd
- (id)_kernelWithShapesMetal;	// IMP=0x000000000010d5a0
- (id)_kernelMetal;	// IMP=0x000000000010d543
- (id)_kernel;	// IMP=0x000000000010d4e6
