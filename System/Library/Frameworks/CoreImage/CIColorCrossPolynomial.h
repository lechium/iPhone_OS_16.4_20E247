...
+ (id)customAttributes;	// IMP=0x0060000000047bb6
...
- (id)outputImage;	// IMP=0x0000000000047f3c
- (_Bool)_isIdentity;	// IMP=0x0000000000047f34
- (id)_kernel;	// IMP=0x0000000000047b96
