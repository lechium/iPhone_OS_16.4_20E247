...
+ (id)customAttributes;	// IMP=0x00600000001af85b
- (id)outputImage;	// IMP=0x00000000001afc25
- (_Bool)_isIdentity;	// IMP=0x00000000001afbcb
- (id)kernel;	// IMP=0x00000000001af83b
