...
+ (id)customAttributes;	// IMP=0x006000000010888d
...
- (id)outputImage;	// IMP=0x0000000000108b90
- (id)_paddedTileKernel;	// IMP=0x000000000010886d
- (id)_grainBlendAndMixKernel;	// IMP=0x000000000010884d
- (id)_interpolateGrainKernel;	// IMP=0x000000000010882d
