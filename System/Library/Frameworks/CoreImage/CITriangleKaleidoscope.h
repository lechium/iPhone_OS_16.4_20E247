...
+ (id)customAttributes;	// IMP=0x0060000000177666
...
- (id)outputImage;	// IMP=0x00000000001779cf
- (id)_geomKernel;	// IMP=0x00000000001779af
- (id)_colorKernel;	// IMP=0x000000000017798f
