...
+ (id)defaultVersionString;	// IMP=0x0060000000029839
...
- (_Bool)isAction;	// IMP=0x0000000000034bcb
- (_Bool)isPortrait;	// IMP=0x0000000000034b96
- (_Bool)isFaceDetectionForced;	// IMP=0x0000000000034b77
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x000000000003478f
- (id)bestImageIdentifiers;	// IMP=0x000000000003074c
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x0000000000030248
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x000000000002fa25
- (void)computeAllImageScores;	// IMP=0x000000000002e276
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x000000000002df0b
- (float)computeCameraTravelDistance;	// IMP=0x000000000002d9e0
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x000000000002d34d
- (int)computeEmotion:(id)arg1;	// IMP=0x000000000002d1ed
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002d067
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000002cb7b
- (void)processClusters:(_Bool)arg1;	// IMP=0x000000000002a668
- (float)computeActionSelectionThreshold;	// IMP=0x000000000002a29a
- (void)dealloc;	// IMP=0x000000000002a039
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000029954
- (id)burstDocumentDirectory;	// IMP=0x00000000000298b5
