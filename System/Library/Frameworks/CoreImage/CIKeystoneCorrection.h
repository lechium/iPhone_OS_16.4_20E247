...
+ (id)customAttributes;	// IMP=0x006000000028577d
- (id).cxx_construct;	// IMP=0x0000000000285fd9
...
- (id)outputImage;	// IMP=0x0000000000285e6b
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x0000000000285b3e
- (void)computeCameraIntrinsics;	// IMP=0x0000000000285a03
