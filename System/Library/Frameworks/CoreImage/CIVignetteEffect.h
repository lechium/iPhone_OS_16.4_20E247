...
+ (id)customAttributes;	// IMP=0x006000000017fdc2
...
- (id)outputImage;	// IMP=0x0000000000180197
- (id)_negkernel;	// IMP=0x0000000000180177
- (id)_poskernel;	// IMP=0x0000000000180157
- (_Bool)_isIdentity;	// IMP=0x0000000000180122
