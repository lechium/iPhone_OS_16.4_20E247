...
- (void).cxx_destruct;	// IMP=0x00000000001ba0b6
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000001b97c6
- (void)invalidate:(id)arg1;	// IMP=0x00000000001b9444
