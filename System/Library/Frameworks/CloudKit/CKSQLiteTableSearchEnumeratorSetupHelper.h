...
- (void).cxx_destruct;	// IMP=0x00000000000670d7
...
- (void)setupStatement:(id)arg1;	// IMP=0x0000000000066f32
- (void)orderDescendingByProperty:(id)arg1;	// IMP=0x0000000000066eb8
- (void)orderAscendingByProperty:(id)arg1;	// IMP=0x0000000000066e3e
