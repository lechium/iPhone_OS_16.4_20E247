...
- (void).cxx_destruct;	// IMP=0x000000000000bdd6
...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000bbb0
@property(readonly, nonatomic, getter=isDeletable) _Bool deletable;
- (void)libraryDidChange;	// IMP=0x000000000000bafd
@property(nonatomic) ALAssetsLibrary *library;
- (void)dealloc;	// IMP=0x000000000000ba72
- (id)initWithManagedAsset:(id)arg1 library:(id)arg2;	// IMP=0x000000000000b9eb
