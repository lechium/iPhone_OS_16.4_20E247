...
- (void)dealloc;	// IMP=0x000000000000a6c5
- (void)registerAlbum:(id)arg1 assetGroupPrivate:(id)arg2;	// IMP=0x000000000000a5fd
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000000009d56
@property(readonly, retain, nonatomic) PLPhotoLibrary *photoLibrary; // @synthesize photoLibrary=_photoLibrary;
- (id)initWithAssetsLibrary:(id)arg1;	// IMP=0x0000000000009c2f
