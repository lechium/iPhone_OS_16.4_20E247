...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c2a6
- (void)libraryDidChange;	// IMP=0x000000000000c294
@property(nonatomic) ALAssetsLibrary *library;
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000c21b
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000c1ae
- (void)populateAssets;	// IMP=0x000000000000c190
- (void)updateAlbumFiltering;	// IMP=0x000000000000c144
- (void)resetAssets;	// IMP=0x000000000000c0fe
- (int)albumFilter;	// IMP=0x000000000000c083
- (void)dealloc;	// IMP=0x000000000000bfcf
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000bef3
