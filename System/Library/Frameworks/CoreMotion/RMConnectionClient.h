...
- (void).cxx_destruct;	// IMP=0x000000000013094c
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000130934
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x0000000000130920
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x000000000013046a
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x000000000013021c
