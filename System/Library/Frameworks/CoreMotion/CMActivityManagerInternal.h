...
- (void)simulateMotionStateYouthWithState:(long long)arg1;	// IMP=0x0000000000198ad9
- (void)simulateMotionState:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x00000000001988e1
- (void)overrideOscarSideband:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x00000000001986e9
- (void)stopActivityUpdatesPrivate;	// IMP=0x0000000000198541
- (void)startActivityUpdatesWithHandlerPrivate:(CDUnknownBlockType)arg1;	// IMP=0x00000000001983c6
- (void)disconnect;	// IMP=0x0000000000198396
- (void)connect;	// IMP=0x00000000001979ac
- (void)dealloc;	// IMP=0x000000000019792a
- (id)init;	// IMP=0x00000000001978dc
