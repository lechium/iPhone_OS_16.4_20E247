...
- (void)setSpecifierValue:(id)arg1 specifier:(id)arg2;	// IMP=0x0010000000007220
- (id)specifierValue:(id)arg1;	// IMP=0x00100000000070e0
- (id)_specifierForItem:(id)arg1;	// IMP=0x0010000000006d80
- (void)_filterContentForSearchText:(id)arg1;	// IMP=0x0010000000006750
- (_Bool)_isFiltering;	// IMP=0x00100000000066c0
- (_Bool)_isSearchBarEmpty;	// IMP=0x0010000000006610
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x0010000000005ef0
- (id)specifiers;	// IMP=0x0010000000005df0
- (long long)tableViewStyle;	// IMP=0x0010000000005dd0
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000005db0
- (void)viewDidLoad;	// IMP=0x0010000000005950
- (void)dealloc;	// IMP=0x00100000000058b0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000055b0
