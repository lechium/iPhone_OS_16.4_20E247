...
@class MISSING_TYPE, _TtC5Files17DOCNodeSourcePair;

@interface _TtC5Files15DOCMetadataView : UIStackView
{
    MISSING_TYPE *nodeSourcePair;	// 8 = 0x8
...
+ (Class)layerClass;	// IMP=0x0020000000336110
- (void).cxx_destruct;	// IMP=0x00400000003382d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000338240
- (void)didMoveToWindow;	// IMP=0x0010000000336a20
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000336850
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000336640
- (id)init;	// IMP=0x0010000000336320
...
@property(nonatomic, retain) _TtC5Files17DOCNodeSourcePair *nodeSourcePair; // @synthesize nodeSourcePair;
