...
+ (void)setSharedManagerWith:(id)arg1 to:(id)arg2;	// IMP=0x002000000005b270
+ (void)clearSharedControllerFor:(id)arg1;	// IMP=0x001000000005b1a0
+ (id)sharedManagerFor:(id)arg1;	// IMP=0x001000000005b0c0
- (void).cxx_destruct;	// IMP=0x004000000005bbe0
- (id)init;	// IMP=0x001000000005bb60
