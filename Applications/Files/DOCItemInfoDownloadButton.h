...
- (void).cxx_destruct;	// IMP=0x0020000000003f29
...
- (void)userDidTapDownloadButton;	// IMP=0x00100000000036cb
- (void)updateForState;	// IMP=0x00100000000036c5
- (void)tintColorDidChange;	// IMP=0x00100000000034bb
- (void)commonInit;	// IMP=0x0010000000003149
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000030fd
