...
@interface BCSCoachingMessageView : UIView
{
    ...
    NSLayoutConstraint *;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x002000000001c036
- (void)layoutSubviews;	// IMP=0x001000000001bd94
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000001bc40
@property(copy, nonatomic) NSString *message;
- (id)init;	// IMP=0x001000000001b422
