...
@interface BCSShadowAction : NSObject
{
    ...
    id <BCSActionDelegate> delegate;	// 32 = 0x20
    ...
    MISSING_TYPE *_url;	// 80 = 0x50
    LSAppLink *_appLink;	// 88 = 0x58
    id <BCSAction> _originalAction;	// 96 = 0x60
}

- (void).cxx_destruct;	// IMP=0x00200000000033e3
...
- (void)showActionPicker;	// IMP=0x00100000000032d8
- (void)performDefaultAction;	// IMP=0x00100000000032d2
- (void)performAction;	// IMP=0x0010000000003274
...
- (id)initWithURL:(id)arg1 appLink:(id)arg2 originalAction:(id)arg3;	// IMP=0x0010000000002f93
