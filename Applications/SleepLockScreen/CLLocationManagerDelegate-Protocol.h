...
@class CLBeaconIdentityConstraint, CLBeaconRegion, CLHeading, CLLocation, CLLocationManager, CLRegion, CLVisit, MISSING_TYPE, NSArray, NSError;
...
- (MISSING_TYPE *)locationManager:didStartMonitoringForRegion: /* Error: Ran out of types for this method. */;
