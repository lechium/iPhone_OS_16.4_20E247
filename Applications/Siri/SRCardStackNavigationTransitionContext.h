...
- (void).cxx_destruct;	// IMP=0x002000000006aa1c
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x001000000006a7d2
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x001000000006a737
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006a6c4
