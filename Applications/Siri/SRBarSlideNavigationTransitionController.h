...
- (void).cxx_destruct;	// IMP=0x002000000000962f
...
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x001000000000942d
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x0010000000009372
