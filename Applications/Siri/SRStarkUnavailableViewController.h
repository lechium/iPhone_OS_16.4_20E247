...
- (void).cxx_destruct;	// IMP=0x002000000002d348
@property(nonatomic) __weak id <SRStarkItemControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)autoDismissalReason;	// IMP=0x001000000002d301
- (long long)autoDismissalStrategy;	// IMP=0x001000000002d2d8
- (void)viewDidLoad;	// IMP=0x001000000002d14d
- (void)loadView;	// IMP=0x001000000002d0d8
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 shouldSynthesizeTitles:(_Bool)arg3;	// IMP=0x001000000002cff5
