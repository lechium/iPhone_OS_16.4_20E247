...
+ (id)configuration;	// IMP=0x0040000000078006
+ (id)new;	// IMP=0x0010000000077ffe
...
- (id)identifierForService:(long long)arg1;	// IMP=0x00100000000780a4
- (id)domainForService:(long long)arg1;	// IMP=0x001000000007806b
- (id)init;	// IMP=0x0010000000077ff0
- (id)_init;	// IMP=0x0010000000077f42
