...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003e1f2
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x001000000003df63
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 beginningFrame:(struct CGRect)arg3 endingFrame:(struct CGRect)arg4;	// IMP=0x001000000003ded6
