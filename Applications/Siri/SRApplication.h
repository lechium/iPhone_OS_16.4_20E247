...
+ (id)sharedApplication;	// IMP=0x002000000003e3c6
- (void).cxx_destruct;	// IMP=0x002000000003e4a9
@property(nonatomic) __weak id <SRApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x001000000003e46b
- (long long)_frontMostAppOrientation;	// IMP=0x001000000003e45a
- (long long)launchOrientation;	// IMP=0x001000000003e449
