...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000078b65
- (id)debugDescription;	// IMP=0x00100000000786f7
- (id)_debugDescriptionForProperty:(id)arg1 integerValue:(long long)arg2;	// IMP=0x001000000007865c
- (id)_debugDescriptionForProperty:(id)arg1 boolValue:(_Bool)arg2;	// IMP=0x0010000000078633
- (id)_debugDescriptionForProperty:(id)arg1 formattedValue:(id)arg2;	// IMP=0x001000000007860b
- (id)initWithDeviceIsPad:(_Bool)arg1 navigationStackIsPopping:(_Bool)arg2 navigationStackSize:(long long)arg3 navigationBarHasContent:(_Bool)arg4 multiLevelViewHasContent:(_Bool)arg5 editableUtteranceViewHasContent:(_Bool)arg6 compactViewHasContent:(_Bool)arg7 siriViewControllerIsEditing:(_Bool)arg8 keyboardHasContent:(_Bool)arg9;	// IMP=0x001000000007858b
