...
- (void).cxx_destruct;	// IMP=0x00200000000766e3
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x00100000000763d1
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0010000000075738
- (id)init;	// IMP=0x0010000000074caf
