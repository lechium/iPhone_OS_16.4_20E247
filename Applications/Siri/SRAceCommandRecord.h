...
- (void).cxx_destruct;	// IMP=0x00200000000881aa
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00100000000880e0
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0010000000087bf9
- (void)incrementNumberOfStoppedActions;	// IMP=0x0010000000087bc7
- (void)incrementNumberOfStartedActions;	// IMP=0x0010000000087b95
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000087a6b
