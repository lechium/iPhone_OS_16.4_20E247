...
@class MISSING_TYPE, UIPointerInteraction, UIPointerRegion, UIPointerRegionRequest, UIPointerStyle;
@protocol UIPointerInteractionAnimating;

@protocol UIPointerInteractionDelegate <NSObject>

@optional
- (MISSING_TYPE *)pointerInteraction:willExitRegion:animator: /* Error: Ran out of types for this method. */;
