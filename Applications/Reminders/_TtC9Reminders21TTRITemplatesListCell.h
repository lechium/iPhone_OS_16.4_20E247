...
- (void).cxx_destruct;	// IMP=0x00400000003bc9b0
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000003bc970
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000003bc860
@property(nonatomic, copy) NSArray *accessibilityCustomActions;
@property(nonatomic, copy) NSString *accessibilityLabel;
@property(nonatomic, copy) NSArray *accessibilityElements;
@property(nonatomic) _Bool isAccessibilityElement;
- (void)_bridgedUpdateConfigurationUsingState:(id)arg1;	// IMP=0x00100000003bbb80
