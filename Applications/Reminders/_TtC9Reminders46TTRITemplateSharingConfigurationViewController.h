...
- (void).cxx_destruct;	// IMP=0x00400000001f4bd0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000001f4b70
- (void)didTapShowPreview:(id)arg1;	// IMP=0x00100000001f44e0
- (void)didTapCommit:(id)arg1;	// IMP=0x00100000001f4460
- (void)didTapCancel:(id)arg1;	// IMP=0x00100000001f4440
- (void)viewWillLayoutSubviews;	// IMP=0x00100000001f43b0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000001f41c0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00100000001f4100
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001f40c0
- (void)viewDidLoad;	// IMP=0x00100000001f3f40
- (void)loadView;	// IMP=0x00100000001f3270
@property(nonatomic, readonly) _Bool canBecomeFirstResponder;
@property(nonatomic, readonly) NSUndoManager *undoManager;
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001f3120
