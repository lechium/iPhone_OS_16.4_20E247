...
+ (void)logDeviceList:(id)arg1;	// IMP=0x00200000000077f4
...
- (id)loggableDescription;	// IMP=0x00100000000077e2
- (_Bool)shouldBeHidden;	// IMP=0x00100000000077da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000077cf
- (id)initWithName:(id)arg1;	// IMP=0x00100000000077b5
- (id)initWithName:(id)arg1 upgradable:(_Bool)arg2 upgraded:(_Bool)arg3;	// IMP=0x0010000000007734
