...
- (void).cxx_destruct;	// IMP=0x002000000002cf1c
...
- (void)scheduleDeletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000002cce2
- (id)pdfDocument;	// IMP=0x001000000002cbf5
- (void)processImageIdentifier:(id)arg1;	// IMP=0x001000000002cab9
- (void)_loadUneditedImageIfNecessaryWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000002c7dd
- (id)requestCGImageBackedUneditedImageForUIBlocking;	// IMP=0x001000000002c683
- (void)requestCGImageBackedUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002c37e
- (id)requestUneditedImageForUIBlocking;	// IMP=0x001000000002c224
- (void)requestUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002c0ea
- (id)requestOutputImageForUIBlocking;	// IMP=0x001000000002bf90
- (id)requestOutputImageForSavingBlocking;	// IMP=0x001000000002be11
- (void)requestOutputImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002bcf6
- (void)requestOutputImageInTransition:(_Bool)arg1 forSaving:(CDUnknownBlockType)arg2;	// IMP=0x001000000002bae4
- (void)requestOutputImageForSaving:(CDUnknownBlockType)arg1;	// IMP=0x001000000002bacd
- (id)_outputImageOnCurrentUneditedImage;	// IMP=0x001000000002b91e
- (void)_resumeHighQualityQueueIfNecessary;	// IMP=0x001000000002b8b8
- (void)dealloc;	// IMP=0x001000000002b7ea
- (id)initWithScreenshot:(id)arg1;	// IMP=0x001000000002b663
