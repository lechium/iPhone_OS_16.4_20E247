...
- (void).cxx_destruct;	// IMP=0x0020000000030d6a
...
- (_Bool)rulerHostWantsSharedRuler;	// IMP=0x0010000000030c9b
- (id)rulerHostingView;	// IMP=0x0010000000030c89
...
- (void)logDidEndEditingWithOverlay;	// IMP=0x0010000000030ae6
- (void)logDidEnterEditingWithOverlay;	// IMP=0x0010000000030ae0
- (void)updateUndoState;	// IMP=0x0010000000030ada
