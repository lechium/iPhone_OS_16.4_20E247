...
- (void).cxx_destruct;	// IMP=0x002000000003b985
...
- (void)createMiniMapView;	// IMP=0x001000000003b865
- (void)createThumbnailView;	// IMP=0x001000000003b755
- (_Bool)shouldUseMiniMapView;	// IMP=0x001000000003b701
- (_Bool)shouldShowThumbnailOptionView;	// IMP=0x001000000003b6c3
- (_Bool)isShowingThumbnailOptionView;	// IMP=0x001000000003b69e
@property(nonatomic) _Bool shouldUpdate;
- (void)layoutSubviews;	// IMP=0x001000000003b409
