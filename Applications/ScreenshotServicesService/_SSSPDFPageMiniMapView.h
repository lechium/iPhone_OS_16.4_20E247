...
+ (struct CGAffineTransform)_transformToConvertToRect:(struct CGRect)arg1 fromRect:(struct CGRect)arg2;	// IMP=0x0040000000030359
+ (struct CGPoint)adjustedTranslationForProposedRect:(struct CGRect)arg1 originalRect:(struct CGRect)arg2 scaledContentViewBounds:(struct CGRect)arg3;	// IMP=0x001000000002f8c0
- (void).cxx_destruct;	// IMP=0x0020000000030745
...
- (struct CGRect)convertRectToPageViewSpace:(struct CGRect)arg1 fromView:(id)arg2;	// IMP=0x00100000000301a4
- (struct CGRect)convertRectFromPageViewSpace:(struct CGRect)arg1 toView:(id)arg2;	// IMP=0x001000000002fffa
- (struct CGRect)visibleRectInPageViewSpace;	// IMP=0x001000000002fe55
- (void)userDidPanSelectionRect:(id)arg1;	// IMP=0x001000000002fa95
- (_Bool)isDraggingVisibleRect;	// IMP=0x001000000002f870
- (void)updatePDFViewFromVisibleRegionView;	// IMP=0x001000000002f654
- (void)updateVisibleRegionViewFromPDFView;	// IMP=0x001000000002f17b
- (void)annotationsDidChange;	// IMP=0x001000000002eebe
- (void)visibleRegionRectDidChange;	// IMP=0x001000000002ee87
- (id)pageImageForSize:(struct CGSize)arg1;	// IMP=0x001000000002ec4a
- (id)pageView;	// IMP=0x001000000002ebe3
- (id)pdfPage;	// IMP=0x001000000002eb71
- (void)setNeedsPageImageUpdate;	// IMP=0x001000000002eb39
- (void)_removePDFNotifications;	// IMP=0x001000000002e99b
- (void)_setupPDFNotificationsIfPossible;	// IMP=0x001000000002e823
- (void)layoutSubviews;	// IMP=0x001000000002e57d
- (void)dealloc;	// IMP=0x001000000002e511
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000002e3b3
