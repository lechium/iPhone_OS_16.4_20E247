...
- (void).cxx_destruct;	// IMP=0x0040000000073ee0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000073df0
- (void)addButtonTapped;	// IMP=0x0010000000073d90
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000073bd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000073bb0
