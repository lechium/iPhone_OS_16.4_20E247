...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000080a7f
+ (id)handoffRunRequestWithActionIdentifier:(id)arg1 input:(id)arg2 serializedParameters:(id)arg3 processedParameters:(id)arg4;	// IMP=0x00100000000809d5
+ (id)handoffRunRequestWithActionIdentifier:(id)arg1 input:(id)arg2 serializedParameters:(id)arg3;	// IMP=0x00100000000809c0
- (void).cxx_destruct;	// IMP=0x0020000000080982
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000080709
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000805f1
- (id)initWithActionIdentifier:(id)arg1 input:(id)arg2 serializedParameters:(id)arg3 processedParameters:(id)arg4;	// IMP=0x00100000000804a7
