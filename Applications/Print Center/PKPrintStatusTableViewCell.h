...
- (void).cxx_destruct;	// IMP=0x00200000000025e2
@property(retain, nonatomic) UILabel *hostLabel; // @synthesize hostLabel=_hostLabel;
@property(retain, nonatomic) UILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (void)layoutSubviews;	// IMP=0x0010000000001eb8
- (struct UIEdgeInsets)layoutMargins;	// IMP=0x0010000000001e22
@property(nonatomic) _Bool showActive;
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x0010000000001b18
