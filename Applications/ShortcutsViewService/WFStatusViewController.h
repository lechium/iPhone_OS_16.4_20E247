...
+ (id)requestIdentifierForContext:(id)arg1;	// IMP=0x00200000000072c9
- (void).cxx_destruct;	// IMP=0x00200000000070b5
...
- (void)presentableDidAppearAsBanner:(id)arg1;	// IMP=0x0010000000006ede
@property(readonly, nonatomic) UIViewController *viewController;
@property(readonly, nonatomic) _Bool providesHostedContent;
- (void)systemDismissedBanner;	// IMP=0x0010000000006ec7
...
- (id)systemApertureElementProvider;	// IMP=0x00100000000068ea
- (long long)preferredLayoutModeForRunningContext:(id)arg1;	// IMP=0x0010000000006877
- (void)startCollapseTimerIfNecessary;	// IMP=0x00100000000067bf
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000006757
@property(readonly, nonatomic) NSNumberFormatter *percentageFormatter; // @synthesize percentageFormatter=_percentageFormatter;
- (void)updatePercentageSubtitleWithValue:(double)arg1;	// IMP=0x00100000000063f0
- (struct CGSize)sensorIntersectionSizeForLabelAtCenter:(struct CGPoint)arg1 size:(struct CGSize)arg2 visibleGlyphFrame:(struct CGRect)arg3;	// IMP=0x001000000000618a
- (void)viewWillLayoutSubviews;	// IMP=0x0010000000005310
...
- (id)subtitleFont;	// IMP=0x001000000000509d
- (id)titleFont;	// IMP=0x0010000000005082
- (id)tintColorFromIcon:(id)arg1;	// IMP=0x0010000000004d4a
- (void)setCompletingSuccessfully:(_Bool)arg1;	// IMP=0x0010000000004cdd
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000004cd5
- (void)dealloc;	// IMP=0x0010000000004c7b
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2 progress:(id)arg3;	// IMP=0x0010000000004835
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2;	// IMP=0x0010000000004820
