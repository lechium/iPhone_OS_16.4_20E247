...
- (void).cxx_destruct;	// IMP=0x0020000000004c3b
...
- (_Bool)matches:(id)arg1;	// IMP=0x0010000000004b65
- (void)cancelTimeoutTimer;	// IMP=0x0010000000004b33
- (void)startTimeoutTimerWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004a00
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000004884
