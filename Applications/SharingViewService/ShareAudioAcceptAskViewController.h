...
- (void).cxx_destruct;	// IMP=0x00200000001a3a51
...
- (void)updateProductID:(unsigned int)arg1;	// IMP=0x00100000001a363d
- (void)handleCancelButton:(id)arg1;	// IMP=0x00100000001a357c
- (void)handleJoinButton:(id)arg1;	// IMP=0x00100000001a34bb
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001a3437
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001a317a
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x00100000001a30eb
