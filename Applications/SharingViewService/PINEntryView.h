...
@class MISSING_TYPE, NSArray, NSString, UIColor, UITextInputPasswordRules;
...
- (void).cxx_destruct;	// IMP=0x002000000017719d
...
- (void)insertText:(id)arg1;	// IMP=0x0010000000176fb4
- (void)deleteBackward;	// IMP=0x0010000000176f2e
- (_Bool)canBecomeFirstResponder;	// IMP=0x0010000000176f26
@property(nonatomic) long long autocorrectionType;
@property(nonatomic) long long autocapitalizationType;
- (void)_updateLabels;	// IMP=0x0010000000176a7a
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000176a2c
