...
- (void).cxx_destruct;	// IMP=0x0020000000183379
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x0010000000183198
- (void)_handlePINEntered:(id)arg1;	// IMP=0x001000000018303e
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0010000000182c7d
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000182bc9
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000182af8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000018287f
