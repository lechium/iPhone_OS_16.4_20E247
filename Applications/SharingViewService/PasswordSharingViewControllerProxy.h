...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x0040000000174809
- (void).cxx_destruct;	// IMP=0x0020000000174358
...
- (void)setDisplayNameIsDevice:(_Bool)arg1;	// IMP=0x00100000001742c3
- (_Bool)displayNameIsDevice;	// IMP=0x00100000001742b3
...
- (void)handleButtonActions:(id)arg1;	// IMP=0x00100000001740cc
- (void)showAuthUIWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2 animated:(_Bool)arg3;	// IMP=0x00100000001740a8
- (void)_sessionHandleProgress:(unsigned int)arg1 info:(id)arg2;	// IMP=0x0010000000173e33
- (void)_sessionStart;	// IMP=0x001000000017398e
- (void)_handleDeviceNoLongerNeedsPassword;	// IMP=0x00100000001738c1
- (void)_deviceLost:(id)arg1;	// IMP=0x00100000001737bb
- (void)_deviceFound:(id)arg1;	// IMP=0x0010000000173587
- (void)_deviceDiscoveryEnsureStarted;	// IMP=0x0010000000173438
- (void)showDoneUI:(int)arg1;	// IMP=0x0010000000172ee0
- (void)ensureStoppedWithDismiss:(_Bool)arg1 reason:(int)arg2;	// IMP=0x0010000000172d82
- (void)ensureStoppedWithDismiss:(_Bool)arg1;	// IMP=0x0010000000172d6b
- (void)dismiss:(int)arg1;	// IMP=0x0010000000172ad1
- (void)invalidateTouchDelayTimer;	// IMP=0x0010000000172993
- (void)activateTouchDelayTimer;	// IMP=0x0010000000172782
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000172686
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00100000001723f6
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000171ebf
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x0010000000171df7
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000171916
