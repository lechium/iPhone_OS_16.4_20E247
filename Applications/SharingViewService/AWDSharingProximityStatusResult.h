...
- (void).cxx_destruct;	// IMP=0x00200000001853ee
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018529e
- (unsigned long long)hash;	// IMP=0x00100000001851d6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000185078
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000184f71
- (void)copyTo:(id)arg1;	// IMP=0x0010000000184e97
- (void)writeTo:(id)arg1;	// IMP=0x0010000000184dac
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000184959
- (id)dictionaryRepresentation;	// IMP=0x001000000018473c
- (id)description;	// IMP=0x001000000018468d
