...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x0040000000195521
- (void).cxx_destruct;	// IMP=0x00200000001962e7
...
- (void)announceNotificationsCompleted;	// IMP=0x001000000019616e
- (void)pushStatusViewController;	// IMP=0x001000000019608b
- (void)presentInitialStatusViewController;	// IMP=0x0010000000195fcc
- (_Bool)updateViewForLevelLeft:(double)arg1 levelRight:(double)arg2 levelCase:(double)arg3 refind:(_Bool)arg4 missingAssets:(_Bool)arg5 reload:(_Bool)arg6;	// IMP=0x001000000019584d
- (_Bool)updateViewForLevelLeft:(double)arg1 levelRight:(double)arg2 levelCase:(double)arg3 refind:(_Bool)arg4 missingAssets:(_Bool)arg5;	// IMP=0x0010000000195835
- (_Bool)updateViewForLevelLeft:(double)arg1 levelRight:(double)arg2 levelCase:(double)arg3 refind:(_Bool)arg4;	// IMP=0x001000000019581e
- (_Bool)updateViewForLevelLeft:(double)arg1 levelRight:(double)arg2 levelCase:(double)arg3;	// IMP=0x001000000019580a
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x0010000000195789
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000195781
- (void)dismiss:(int)arg1;	// IMP=0x0010000000195529
