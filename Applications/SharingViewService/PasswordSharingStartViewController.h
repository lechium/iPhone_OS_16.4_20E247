...
- (void).cxx_destruct;	// IMP=0x00200000001756d4
...
- (void)handleTapOutsideView:(id)arg1;	// IMP=0x00100000001755c0
- (void)handleDismissButtonPressed:(id)arg1;	// IMP=0x0010000000175538
- (void)handleAllowButtonPressed:(id)arg1;	// IMP=0x00100000001752a7
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0010000000175224
- (void)configureUIElementsForHotspot;	// IMP=0x0010000000174fbb
- (void)configureUIElementsDefault;	// IMP=0x0010000000174ade
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000174a28
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000174981
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000174811
