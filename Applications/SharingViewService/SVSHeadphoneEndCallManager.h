...
- (void).cxx_destruct;	// IMP=0x002000000016ed41
...
- (void)setStatusToDone;	// IMP=0x001000000016ece6
- (void)setConfigForDoubleTap;	// IMP=0x001000000016eccb
- (void)setConfigForSingleTap;	// IMP=0x001000000016ecb0
- (_Bool)isStatusUnknown;	// IMP=0x001000000016e9f1
- (id)initWithBluetoothAddress:(id)arg1;	// IMP=0x001000000016e8fe
