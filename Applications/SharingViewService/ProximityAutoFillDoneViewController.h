...
- (void).cxx_destruct;	// IMP=0x00200000001844a4
@property(retain, nonatomic) NSError *error; // @synthesize error=_error;
- (void)handleReportButton:(id)arg1;	// IMP=0x00100000001843f1
- (void)handleDoneButtonPressed:(id)arg1;	// IMP=0x0010000000184364
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000183e0e
