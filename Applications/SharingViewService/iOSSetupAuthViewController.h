...
- (void).cxx_destruct;	// IMP=0x002000000016c6f3
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x001000000016c4b4
- (void)_handlePINEntered:(id)arg1;	// IMP=0x001000000016c35b
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x001000000016bfd2
- (void)handleDismissButton:(id)arg1;	// IMP=0x001000000016bf23
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000016bf1b
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000016be4a
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000016bb97
