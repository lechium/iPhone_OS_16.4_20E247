...
- (void).cxx_destruct;	// IMP=0x00200000001b8890
...
- (id)pickerView:(id)arg1 attributedTitleForRow:(long long)arg2 forComponent:(long long)arg3;	// IMP=0x00100000001b86ee
- (long long)pickerView:(id)arg1 numberOfRowsInComponent:(long long)arg2;	// IMP=0x00100000001b86d1
- (long long)numberOfComponentsInPickerView:(id)arg1;	// IMP=0x00100000001b86c6
- (void)handleDismissButton:(id)arg1;	// IMP=0x00100000001b863e
- (void)handleChooseButton:(id)arg1;	// IMP=0x00100000001b8402
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001b837e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001b82d4
