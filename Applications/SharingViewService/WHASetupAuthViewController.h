...
- (void).cxx_destruct;	// IMP=0x00200000001b7445
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x00100000001b7265
- (void)_handlePINEntered:(id)arg1;	// IMP=0x00100000001b710c
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x00100000001b6d83
- (void)handleDismissButton:(id)arg1;	// IMP=0x00100000001b6cd4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001b6c03
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001b6928
