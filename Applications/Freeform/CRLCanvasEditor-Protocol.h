...
@class CRLCanvasEditorHelper, CRLCanvasLayout, CRLCanvasRep, CRLCanvasSelection, CRLInsertionContext, CRLInteractiveCanvasController, CRLPasteboard, CRLPasteboardController, CRLSelectionPath, NSArray, NSObject, NSSet, _TtC8Freeform10CRLCommand, _TtC8Freeform12CRLBoardItem;
