...
- (MISSING_TYPE *)collectionView:targetIndexPathForMoveOfItemFromOriginalIndexPath:atCurrentIndexPath:toProposedIndexPath: /* Error: Ran out of types for this method. */;
