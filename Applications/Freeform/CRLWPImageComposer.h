...
- (void).cxx_destruct;	// IMP=0x002000000039bd6b
...
- (id)overlayImage:(id)arg1 usingFrame:(struct CGRect)arg2;	// IMP=0x001000000039b8ef
- (id)initWithBaseImage:(id)arg1 screenScale:(double)arg2;	// IMP=0x001000000039b801
