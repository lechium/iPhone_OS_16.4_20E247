...
struct map<unsigned long, CRLWPFontMetricsCacheEntry, std::less<unsigned long>, std::allocator<std::pair<const unsigned long, CRLWPFontMetricsCacheEntry>>> {
    struct __tree<std::__value_type<unsigned long, CRLWPFontMetricsCacheEntry>, std::__map_value_compare<unsigned long, std::__value_type<unsigned long, CRLWPFontMetricsCacheEntry>, std::less<unsigned long>, true>, std::allocator<std::__value_type<unsigned long, CRLWPFontMetricsCacheEntry>>> {
        void *__begin_node_;
        ...
        struct __compressed_pair<unsigned long, std::__map_value_compare<unsigned long, std::__value_type<unsigned long, CRLWPFontMetricsCacheEntry>, std::less<unsigned long>, true>> {
            unsigned long long __value_;
        } __pair3_;
    } __tree_;
};
...
struct map<unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>, std::less<unsigned long>, std::allocator<std::pair<const unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>>>> {
    struct __tree<std::__value_type<unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>>, std::__map_value_compare<unsigned long, std::__value_type<unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>>, std::less<unsigned long>, true>, std::allocator<std::__value_type<unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>>>> {
        void *__begin_node_;
        ...
        struct __compressed_pair<unsigned long, std::__map_value_compare<unsigned long, std::__value_type<unsigned long, std::shared_ptr<CRLWPParagraphTypesetter>>, std::less<unsigned long>, true>> {
            unsigned long long __value_;
        } __pair3_;
    } __tree_;
};
...
struct unordered_map<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>, CGPointHash, CGPointEquality, std::allocator<std::pair<const CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>>> {
    struct __hash_table<std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, std::__unordered_map_hasher<CGPoint, std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CGPointHash, CGPointEquality, true>, std::__unordered_map_equal<CGPoint, std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CGPointEquality, CGPointHash, true>, std::allocator<std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>>> {
        ...
        struct __compressed_pair<unsigned long, std::__unordered_map_hasher<CGPoint, std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CGPointHash, CGPointEquality, true>> {
            unsigned long long __value_;
        } __p2_;
        struct __compressed_pair<float, std::__unordered_map_equal<CGPoint, std::__hash_value_type<CGPoint, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CGPointEquality, CGPointHash, true>> {
            float __value_;
        } __p3_;
    } __table_;
};
...
struct unordered_map<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>, CRLBezierPathPointerHash, CRLBezierPathPointerEquality, std::allocator<std::pair<CRLBezierPath *const, std::set<CRLBezierHitTesterPointInfo, PointCompare>>>> {
    struct __hash_table<std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, std::__unordered_map_hasher<CRLBezierPath *, std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CRLBezierPathPointerHash, CRLBezierPathPointerEquality, true>, std::__unordered_map_equal<CRLBezierPath *, std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CRLBezierPathPointerEquality, CRLBezierPathPointerHash, true>, std::allocator<std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>>> {
        ...
        struct __compressed_pair<unsigned long, std::__unordered_map_hasher<CRLBezierPath *, std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CRLBezierPathPointerHash, CRLBezierPathPointerEquality, true>> {
            unsigned long long __value_;
        } __p2_;
        struct __compressed_pair<float, std::__unordered_map_equal<CRLBezierPath *, std::__hash_value_type<CRLBezierPath *, std::set<CRLBezierHitTesterPointInfo, PointCompare>>, CRLBezierPathPointerEquality, CRLBezierPathPointerHash, true>> {
            float __value_;
        } __p3_;
    } __table_;
};
...
struct unordered_map<unsigned long, CRLBezierPath *, std::hash<unsigned long>, std::equal_to<unsigned long>, std::allocator<std::pair<const unsigned long, CRLBezierPath *>>> {
    struct __hash_table<std::__hash_value_type<unsigned long, CRLBezierPath *>, std::__unordered_map_hasher<unsigned long, std::__hash_value_type<unsigned long, CRLBezierPath *>, std::hash<unsigned long>, std::equal_to<unsigned long>, true>, std::__unordered_map_equal<unsigned long, std::__hash_value_type<unsigned long, CRLBezierPath *>, std::equal_to<unsigned long>, std::hash<unsigned long>, true>, std::allocator<std::__hash_value_type<unsigned long, CRLBezierPath *>>> {
        ...
        struct __compressed_pair<unsigned long, std::__unordered_map_hasher<unsigned long, std::__hash_value_type<unsigned long, CRLBezierPath *>, std::hash<unsigned long>, std::equal_to<unsigned long>, true>> {
            unsigned long long __value_;
        } __p2_;
        struct __compressed_pair<float, std::__unordered_map_equal<unsigned long, std::__hash_value_type<unsigned long, CRLBezierPath *>, std::equal_to<unsigned long>, std::hash<unsigned long>, true>> {
            float __value_;
        } __p3_;
    } __table_;
};
