...
@class MISSING_TYPE, NSArray, NSIndexPath, UICollectionView, UIDragPreviewParameters;
...
- (MISSING_TYPE *)collectionView:itemsForAddingToDragSession:atIndexPath:point: /* Error: Ran out of types for this method. */;
@end
