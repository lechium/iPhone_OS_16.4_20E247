...
+ (id)_exportedInterface;	// IMP=0x0020000000001e87
+ (id)_remoteViewControllerInterface;	// IMP=0x0010000000001e7d
...
- (id)_healthPrivacyHostViewController;	// IMP=0x0010000000001e6b
- (void)_finishWithError:(id)arg1;	// IMP=0x0010000000001df0
- (void)_finishRequestWithError:(id)arg1;	// IMP=0x0010000000001d94
- (void)_configureAlertControllerWithSourceName:(id)arg1 sampleType:(id)arg2 effectiveDate:(id)arg3;	// IMP=0x001000000000170a
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000001688
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000000015fd
- (void)_hostDidTerminate;	// IMP=0x001000000000157d
- (void)_configureApplicationStateMonitor;	// IMP=0x0010000000001357
- (void)_hostApplicationStateDidChange:(unsigned int)arg1;	// IMP=0x0010000000001289
- (void)setRequestRecord:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000010d5
