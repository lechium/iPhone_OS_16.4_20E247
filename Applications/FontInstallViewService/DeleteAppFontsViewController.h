...
- (void).cxx_destruct;	// IMP=0x0020000000003019
...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0010000000002dd0
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0010000000002d68
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0010000000002d5d
- (void)dontDelete:(id)arg1;	// IMP=0x0010000000002d27
- (void)doDelete:(id)arg1;	// IMP=0x0010000000002cee
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000002cbf
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000000279b
- (void)viewDidLoad;	// IMP=0x001000000000276c
