...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x0020000000003b20
- (void).cxx_destruct;	// IMP=0x0020000000004332
...
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000003fab
- (void)handleButtonActions:(id)arg1;	// IMP=0x0010000000003eca
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003b30
- (_Bool)_shouldRemoveViewFromHierarchyOnDisappear;	// IMP=0x0010000000003b28
- (void)presentAlert;	// IMP=0x0010000000002eb6
- (void)beginDiscoveryForCandidateRoute;	// IMP=0x0010000000002d91
- (_Bool)fetchCandidateOutputDevice;	// IMP=0x0010000000002ba6
- (void)configurePresentation;	// IMP=0x0010000000002b5f
- (id)connectionWithEndpoint:(id)arg1;	// IMP=0x0010000000002855
- (void)presentErrorAlert;	// IMP=0x0010000000002533
- (void)dismiss;	// IMP=0x0010000000002490
- (_Bool)prefersStatusBarHidden;	// IMP=0x0010000000002488
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000002447
