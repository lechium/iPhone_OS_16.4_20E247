...
- (void).cxx_destruct;	// IMP=0x002000000000a05f
...
- (void)_launchTargetAppIfNecessary;	// IMP=0x0010000000009834
- (void)_launchTargetApp;	// IMP=0x00100000000097bc
- (void)_switchToNowPlaying;	// IMP=0x001000000000970f
- (void)scene:(id)arg1 openURLContexts:(id)arg2;	// IMP=0x0010000000009621
- (void)sceneDidEnterBackground:(id)arg1;	// IMP=0x00100000000095b8
- (void)sceneWillEnterForeground:(id)arg1;	// IMP=0x0010000000009585
- (void)sceneWillResignActive:(id)arg1;	// IMP=0x0010000000009546
- (void)sceneDidBecomeActive:(id)arg1;	// IMP=0x0010000000009492
- (void)sceneDidDisconnect:(id)arg1;	// IMP=0x00100000000093f8
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x00100000000092f8
- (void)dealloc;	// IMP=0x001000000000928d
- (void)setScene:(id)arg1;	// IMP=0x00100000000090f5
