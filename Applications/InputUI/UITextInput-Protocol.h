...
@class MISSING_TYPE, NSArray, NSAttributedString, NSDictionary, NSString, UIMenu, UITextPlaceholder, UITextPosition, UITextRange, UIView;
...
- (MISSING_TYPE *)updateFloatingCursorAtPoint: /* Error: Ran out of types for this method. */;
