...
@class NGChromeViewController, NSArray, NSString, UILabel;
...
- (void).cxx_destruct;	// IMP=0x002000000058dab9
...
- (_Bool)showsMapView;	// IMP=0x001000000058da77
- (id)fullscreenViewController;	// IMP=0x001000000058da6e
- (void)_displayIncompatibilityMessage;	// IMP=0x001000000058d964
- (void)viewDidLoad;	// IMP=0x001000000058d738
- (void)loadView;	// IMP=0x001000000058d6bf
