...
+ (id)rowsGroupContainingRows:(out id *)arg1 withContent:(CDUnknownBlockType)arg2 get:(CDUnknownBlockType)arg3 set:(CDUnknownBlockType)arg4;	// IMP=0x004000000012f876
- (void).cxx_destruct;	// IMP=0x0020000000130212
...
- (void)update;	// IMP=0x00100000001300ed
@property(readonly, nonatomic) _Bool canDeselectRows;
- (unsigned long long)selectedRowsCount;	// IMP=0x001000000012ff6b
@property(readonly, nonatomic) NSArray *rows;
- (void)checkmarkRowWillInvalidate:(id)arg1;	// IMP=0x001000000012feb1
- (void)checkmarkRowDidChangeChecked:(id)arg1;	// IMP=0x001000000012fe31
- (void)addRow:(id)arg1;	// IMP=0x001000000012fd9e
- (id)addRowWithTitle:(id)arg1 subtitle:(id)arg2 value:(id)arg3;	// IMP=0x001000000012fcd2
- (id)addRowWithTitle:(id)arg1 value:(id)arg2;	// IMP=0x001000000012fcbb
- (id)weakRows;	// IMP=0x001000000012fcad
- (void)dealloc;	// IMP=0x001000000012fc66
- (id)_initWithHeldRows;	// IMP=0x001000000012fc27
- (id)init;	// IMP=0x001000000012fbd4
- (id)_relinquishOwnershipOfHeldRows;	// IMP=0x001000000012f83a
