...
- (void).cxx_destruct;	// IMP=0x00200000005bd4cc
...
- (id)initWithPublisher:(id)arg1;	// IMP=0x00100000005bd247
- (id)initWithCuratedCollection:(id)arg1 refinedMapItems:(id)arg2;	// IMP=0x00100000005bd192
