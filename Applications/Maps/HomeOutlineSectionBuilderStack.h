...
- (void).cxx_destruct;	// IMP=0x0020000000a6f182
...
- (void)_pop;	// IMP=0x0010000000a6efc7
- (void)_setTopIdentifier:(id)arg1;	// IMP=0x0010000000a6ef81
- (void)_pushItem:(id)arg1 index:(long long)arg2;	// IMP=0x0010000000a6eee5
- (id)initWithSectionIdentifier:(id)arg1 sectionIndex:(long long)arg2;	// IMP=0x0010000000a6eccf
