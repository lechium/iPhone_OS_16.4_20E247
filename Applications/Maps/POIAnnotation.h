...
- (void).cxx_destruct;	// IMP=0x0020000000b0c2c2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b0c18d
- (id)debugDictionary;	// IMP=0x0010000000b0c012
...
- (id)feature;	// IMP=0x0010000000b0bee4
- (id)initWithItem:(id)arg1 defaultLocale:(id)arg2;	// IMP=0x0010000000b0b052
