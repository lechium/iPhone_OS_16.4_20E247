...
+ (id)cachesWithRoute:(id)arg1 context:(id)arg2;	// IMP=0x0040000000594152
- (void).cxx_destruct;	// IMP=0x0020000000595963
...
- (void)_roadForCoordinate:(CDStruct_c3b9c2ee)arg1 course:(double)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00100000005955b4
- (void)_calculateRoadTileGroupedManeuversWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000594f9e
- (void)_calculateRouteGroupedManeuvers;	// IMP=0x00100000005948a8
- (void)_updateGroupedManeuverCounts;	// IMP=0x0010000000594398
- (void)recalculateGroupedManeuversCaches;	// IMP=0x001000000059430f
- (id)init;	// IMP=0x00100000005940a2
