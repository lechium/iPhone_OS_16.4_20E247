...
- (void).cxx_destruct;	// IMP=0x0020000000373073
...
- (_Bool)needsReloadFromPreviousItemSnapshot:(id)arg1;	// IMP=0x0010000000372fda
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000372eed
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000372ecc
- (id)initWithIdentifierPath:(id)arg1 viewModel:(id)arg2;	// IMP=0x0010000000372dd4
