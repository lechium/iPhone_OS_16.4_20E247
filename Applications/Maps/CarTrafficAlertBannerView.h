...
- (void).cxx_destruct;	// IMP=0x0020000000b77b0b
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0010000000b77ab8
- (void)updateFromBannerItem;	// IMP=0x0010000000b77724
- (id)initWithTarget:(id)arg1 item:(id)arg2 aperturePresentation:(_Bool)arg3;	// IMP=0x0010000000b76c1f
