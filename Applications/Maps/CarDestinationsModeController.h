...
- (void).cxx_destruct;	// IMP=0x00200000006a4954
...
- (void)destinationsCard:(id)arg1 didSelectRecent:(id)arg2;	// IMP=0x00100000006a42de
- (void)destinationsCard:(id)arg1 didSelectSuggestion:(id)arg2;	// IMP=0x00100000006a4268
- (void)destinationsCardDidSelectSavedPlaces:(id)arg1;	// IMP=0x00100000006a4224
- (void)configureCard:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000006a4069
- (id)desiredCards;	// IMP=0x00100000006a4002
@property(readonly, nonatomic) _Bool shouldTimeoutAfterDisconnect;
@property(readonly, nonatomic) long long autohideBehavior;
- (_Bool)showsMapView;	// IMP=0x00100000006a3fe7
- (id)mapView;	// IMP=0x00100000006a3f97
- (id)init;	// IMP=0x00100000006a3f2e
