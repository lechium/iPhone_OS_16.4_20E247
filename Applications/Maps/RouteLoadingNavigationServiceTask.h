...
- (void).cxx_destruct;	// IMP=0x002000000077f3bd
...
- (void)_createResultOnIsolationQueueWithRoutes:(id)arg1 error:(id)arg2 traceRecordingData:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000077eccd
- (void)_handleNilNavdTicketOnIsolationQueueWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000077e9b9
- (void)_createNavigationServiceTicketOnIsolationQueueWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000077e321
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000077e144
- (void)cancel;	// IMP=0x001000000077df9f
@property(readonly, nonatomic) Result *result;
@property(readonly, nonatomic) _Bool inProgress;
- (void)dealloc;	// IMP=0x001000000077dc6b
- (id)initWithNavigationService:(id)arg1 routeRequestDetailsBuilder:(id)arg2;	// IMP=0x001000000077dad4
