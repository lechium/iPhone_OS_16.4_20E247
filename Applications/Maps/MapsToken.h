...
- (void).cxx_destruct;	// IMP=0x0000000000b6d23b
...
- (id)description;	// IMP=0x0010000000b6d13d
- (void)dealloc;	// IMP=0x0010000000b6d0dc
- (id)initWithDelegate:(id)arg1 tokenGroupName:(id)arg2 userInfo:(id)arg3;	// IMP=0x0010000000b6cfdd
