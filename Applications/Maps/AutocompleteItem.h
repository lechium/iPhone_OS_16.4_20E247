...
+ (id)keysForServerCompletion:(id)arg1;	// IMP=0x00200000001f1bca
- (void).cxx_destruct;	// IMP=0x00200000001f2404
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x00100000001f2314
...
- (id)_searchItemForString:(id)arg1;	// IMP=0x00100000001f20ea
- (id)initWithPersonalizedItem:(id)arg1 matchInfo:(id)arg2;	// IMP=0x00100000001f1981
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 matchInfo:(id)arg4;	// IMP=0x00100000001f1961
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 hasPriorityOverride:(_Bool)arg4 priorityOverride:(long long)arg5 matchInfo:(id)arg6;	// IMP=0x00100000001f0e0e
- (id)initWithServerCompletion:(id)arg1 hasPriorityOverride:(_Bool)arg2 priorityOverride:(long long)arg3 serverResultScoreMetadata:(id)arg4;	// IMP=0x00100000001f0c6e
- (id)init;	// IMP=0x00100000001f0c60
