...
- (void).cxx_destruct;	// IMP=0x002000000080dc14
...
- (void)collectionHandlerContentUpdated:(id)arg1;	// IMP=0x001000000080db9d
- (void)collectionHandlerInfoUpdated:(id)arg1;	// IMP=0x001000000080db97
- (void)removeContentFromMapView;	// IMP=0x001000000080db36
- (void)addContentToMapView;	// IMP=0x001000000080da42
- (id)_searchResults;	// IMP=0x001000000080d84f
- (id)initWithCollection:(id)arg1 selectedMapItem:(id)arg2;	// IMP=0x001000000080d770
- (id)initWithCollection:(id)arg1;	// IMP=0x001000000080d75c
