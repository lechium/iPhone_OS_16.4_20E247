...
+ (id)statusWithApplication:(id)arg1 rideOptions:(id)arg2 expirationDate:(id)arg3 userActivity:(id)arg4 rideOptionStatusError:(unsigned long long)arg5;	// IMP=0x0040000000b4cd7a
+ (id)statusWithApplication:(id)arg1 error:(unsigned long long)arg2;	// IMP=0x0010000000b4cd28
+ (id)statusWithApplication:(id)arg1 loadingRideOptions:(_Bool)arg2;	// IMP=0x0010000000b4ccd6
+ (id)statusWithApplication:(id)arg1;	// IMP=0x0010000000b4cc6f
- (void).cxx_destruct;	// IMP=0x0010000000b4cf64
...
- (id)description;	// IMP=0x0010000000b4ce5c
- (id)_init;	// IMP=0x0010000000b4cc16
