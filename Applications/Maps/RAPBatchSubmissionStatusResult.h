...
- (void).cxx_destruct;	// IMP=0x0020000000487701
...
- (void)_setupResultWithRAPInfos:(id)arg1;	// IMP=0x0010000000487464
- (id)initWithRAPInfos:(id)arg1;	// IMP=0x00100000004873e6
