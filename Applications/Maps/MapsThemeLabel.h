...
- (void).cxx_destruct;	// IMP=0x0020000000551043
...
- (void)_updateTextColor;	// IMP=0x0010000000550f4d
- (void)_updateAttributedText;	// IMP=0x0010000000550e33
- (void)updateTheme;	// IMP=0x0010000000550dbf
- (void)didMoveToWindow;	// IMP=0x0010000000550d51
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000550c2f
