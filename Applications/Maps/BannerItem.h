...
- (void).cxx_destruct;	// IMP=0x0020000000255f16
@property(readonly, copy, nonatomic) IPCGuidanceStateReply *guidanceState; // @synthesize guidanceState=_guidanceState;
- (void)updateFromGuidanceState:(id)arg1;	// IMP=0x0010000000255e5a
@property(readonly, copy, nonatomic) NSString *uniqueId;
- (id)description;	// IMP=0x0010000000255e0b
- (id)initWithGuidanceState:(id)arg1;	// IMP=0x0010000000255d98
