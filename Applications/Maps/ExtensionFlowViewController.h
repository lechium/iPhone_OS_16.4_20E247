...
@class ExtensionFlowHeaderView, MISSING_TYPE, NSLayoutConstraint, NSMutableArray, NSString, UINavigationController, UIScrollView, UIView, UIViewController;
...
- (void).cxx_destruct;	// IMP=0x0020000000603056
...
- (void)setupHeaderView;	// IMP=0x0010000000602dd9
- (MISSING_TYPE *)_setMaskOnNavigationBar: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000602bbd
- (void)setupContainerViewWithRootViewController:(id)arg1;	// IMP=0x0010000000602694
- (void)setScrollContentOffset:(struct CGPoint)arg1;	// IMP=0x0010000000602636
- (void)popViewController;	// IMP=0x00100000006025ec
- (_Bool)viewControllerUseExtensionFlowHeader:(id)arg1;	// IMP=0x0010000000602583
- (void)pushViewController:(id)arg1;	// IMP=0x001000000060229b
- (void)handleDismissAction:(id)arg1;	// IMP=0x00100000006020fd
- (void)viewDidLoad;	// IMP=0x0010000000602024
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000601f15
- (id)init;	// IMP=0x0010000000601eff
