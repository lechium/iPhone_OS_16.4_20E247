...
+ (void)_finishByPromotingQuickLinkFromArray:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00200000009f6c13
+ (void)requestProviderMatchingMapItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000009f5a55
- (void).cxx_destruct;	// IMP=0x00000000009f759c
...
- (void)discoverAppClip;	// IMP=0x00100000009f72ad
- (void)updateSecondaryButton;	// IMP=0x00100000009f7187
- (void)extensionContentDidChange;	// IMP=0x00100000009f7142
...
- (void)presentSecondaryActionIfPossible;	// IMP=0x00100000009f6f5a
@property(readonly, nonatomic) UIViewController *controllerForSecondaryAction;
- (id)initWithQuickLink:(id)arg1 remainingQuickLinks:(id)arg2;	// IMP=0x00100000009f6e27
