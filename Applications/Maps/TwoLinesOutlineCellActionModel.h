...
- (void).cxx_destruct;	// IMP=0x0020000000816e2b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000816ce1
- (unsigned long long)hash;	// IMP=0x0010000000816ca2
- (id)initWithButtonTitle1:(id)arg1 buttonTitle2:(id)arg2 delegate:(id)arg3;	// IMP=0x0010000000816bc3
