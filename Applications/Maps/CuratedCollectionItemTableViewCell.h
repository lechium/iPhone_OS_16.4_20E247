...
+ (double)estimatedCellHeight;	// IMP=0x002000000092fb48
+ (id)reuseIdentifier;	// IMP=0x001000000092fb3e
- (void).cxx_destruct;	// IMP=0x0020000000933269
...
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x0010000000932fa4
- (void)setupReviewLabel;	// IMP=0x0010000000932b6e
- (void)_tappedAppClip;	// IMP=0x0010000000932af6
- (id)menuForAddButton;	// IMP=0x001000000093265e
- (void)_tappedAddToUserCollection:(id)arg1;	// IMP=0x0010000000932448
- (void)_tappedAddToUserCollectionButton:(id)arg1;	// IMP=0x0010000000932369
- (void)addToUserCollection:(id)arg1;	// IMP=0x001000000093228d
- (void)_setupConstraints;	// IMP=0x0010000000931a36
- (void)_createSubviews;	// IMP=0x0010000000930aa2
- (void)_loadPOIImage;	// IMP=0x0010000000930846
- (void)_loadImageIfNeeded;	// IMP=0x001000000093040e
- (void)configureWithModel:(id)arg1;	// IMP=0x001000000092fe19
- (void)prepareForReuse;	// IMP=0x001000000092fc54
- (void)layoutSubviews;	// IMP=0x001000000092fbfe
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x001000000092fb56
