...
- (void)mirrorPrimaryManeuver:(id)arg1;	// IMP=0x00100000007b69cd
@property(readonly, nonatomic) UIView *viewToAlignTextLeadingWithPrimarySign;
- (void)_setManeuverGuidanceInfo:(id)arg1 mirroredPrimary:(_Bool)arg2;	// IMP=0x00100000007b6941
- (void)_updateLabelText;	// IMP=0x00100000007b6878
- (void)_setupSubviews;	// IMP=0x00100000007b6703
- (id)_defaultSignLayoutDelegate;	// IMP=0x00100000007b66ea
