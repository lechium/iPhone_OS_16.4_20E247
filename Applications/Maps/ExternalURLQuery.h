...
- (void).cxx_destruct;	// IMP=0x00200000007e0500
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007e0462
- (_Bool)isEqualToExternalURLQuery:(id)arg1;	// IMP=0x00100000007e0178
- (unsigned long long)hash;	// IMP=0x00100000007dfee8
- (id)description;	// IMP=0x00100000007dfd8a
- (id)initWithQuery:(id)arg1 coordinate:(struct CLLocationCoordinate2D)arg2 muid:(unsigned long long)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5;	// IMP=0x00100000007dfca1
