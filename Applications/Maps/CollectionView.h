...
- (void).cxx_destruct;	// IMP=0x0020000000a83d19
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0010000000a83b3f
- (_Bool)textField:(id)arg1 shouldChangeCharactersInRange:(struct _NSRange)arg2 replacementString:(id)arg3;	// IMP=0x0010000000a83a22
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0010000000a839e6
- (id)_effectiveTraitCollection;	// IMP=0x0010000000a838d0
- (void)_effectiveContentSizeCategoryDidChange:(id)arg1;	// IMP=0x0010000000a837c8
- (id)_effectiveContentSizeCategory;	// IMP=0x0010000000a83724
- (_Bool)_shouldTextContainerHeightMatchNewCollectionLabel;	// IMP=0x0010000000a836e0
- (_Bool)_shouldWrapText;	// IMP=0x0010000000a83694
- (void)_updateNumberOfLines;	// IMP=0x0010000000a8360f
- (void)_updateFonts;	// IMP=0x0010000000a8354c
- (id)_subtitleFont;	// IMP=0x0010000000a834e9
- (id)_titleFont;	// IMP=0x0010000000a83440
- (long long)_subtitleNumberOfLines;	// IMP=0x0010000000a83428
- (long long)_titleNumberOfLines;	// IMP=0x0010000000a833df
- (void)_updateContent;	// IMP=0x0010000000a82ad3
- (id)_textAttachmentSpacer;	// IMP=0x0010000000a82a5c
- (void)collectionHandlerContentUpdated:(id)arg1;	// IMP=0x0010000000a82a56
- (void)collectionHandlerInfoUpdated:(id)arg1;	// IMP=0x0010000000a82a44
- (void)imagePickerControllerDidCancel:(id)arg1;	// IMP=0x0010000000a82a28
- (void)imagePickerController:(id)arg1 didFinishPickingMediaWithInfo:(id)arg2;	// IMP=0x0010000000a82945
- (void)collectionImageViewButtonSelected:(id)arg1;	// IMP=0x0010000000a8283e
- (void)_updateConstraintConstants;	// IMP=0x0010000000a826fd
- (void)_updateConstraints;	// IMP=0x0010000000a81133
- (double)_verticalMargin;	// IMP=0x0010000000a809ba
- (double)_imageWidth;	// IMP=0x0010000000a80964
- (void)dealloc;	// IMP=0x0010000000a808dc
- (_Bool)becomeFirstResponder;	// IMP=0x0010000000a808bf
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000a807a9
- (void)commonInit;	// IMP=0x0010000000a7ff37
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000a7fecb
- (id)initWithCollectionViewSize:(unsigned long long)arg1;	// IMP=0x0010000000a7fe30
