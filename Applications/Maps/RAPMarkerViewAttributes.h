...
- (void).cxx_destruct;	// IMP=0x0020000000a1f284
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a1f1e6
- (id)initWithTitle:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0010000000a1f12d
