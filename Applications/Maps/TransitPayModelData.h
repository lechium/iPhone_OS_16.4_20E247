...
- (void).cxx_destruct;	// IMP=0x0010000000312e1c
...
- (id)description;	// IMP=0x0010000000312a64
- (_Bool)hasAllNeededText;	// IMP=0x00100000003129a1
- (_Bool)canPresentEducationScreen;	// IMP=0x0010000000312917
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 actionTitle:(id)arg3 image:(id)arg4 paymentMethod:(id)arg5 topUpPassUniqueID:(id)arg6 isForRemoteDevice:(_Bool)arg7;	// IMP=0x0010000000312798
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 actionTitle:(id)arg3 image:(id)arg4 suggestionType:(int)arg5 paymentMethods:(id)arg6;	// IMP=0x0010000000312698
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 actionTitle:(id)arg3 image:(id)arg4 suggestionType:(int)arg5 paymentMethods:(id)arg6 educationScreenTitle:(id)arg7 educationScreenAssetURLs:(id)arg8 educationScreenText:(id)arg9 topUpPassUniqueID:(id)arg10 isForRemoteDevice:(_Bool)arg11;	// IMP=0x00100000003124fa
- (id)analyticsValue;	// IMP=0x001000000029659c
