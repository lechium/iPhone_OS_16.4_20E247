...
- (void).cxx_destruct;	// IMP=0x0020000000877119
...
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 composedRouteStep:(id)arg3 listItem:(id)arg4;	// IMP=0x0010000000876fdd
- (id)_commentsPlaceholderText;	// IMP=0x0010000000876f75
- (id)commentsTitle;	// IMP=0x0010000000876f5c
- (void)fillIndexesForResponse:(id)arg1 problemAticRouteIndex:(id)arg2 correction:(id)arg3;	// IMP=0x0010000000876a3f
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000008763e3
- (unsigned long long)maximumNumberOfPhotos;	// IMP=0x00100000008763d8
