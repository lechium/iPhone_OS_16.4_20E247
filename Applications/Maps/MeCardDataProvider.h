...
- (void).cxx_destruct;	// IMP=0x002000000069aa80
...
- (void)shortcutManagerMeCardDidChange:(id)arg1;	// IMP=0x001000000069aa4d
- (void)_updateMeCardAndNotifyObservers:(_Bool)arg1;	// IMP=0x001000000069a804
@property(readonly, nonatomic) GEOObserverHashTable *observers;
- (id)init;	// IMP=0x001000000069a6ee
