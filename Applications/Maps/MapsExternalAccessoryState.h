...
+ (id)allKeys;	// IMP=0x0040000000694bd9
- (void).cxx_destruct;	// IMP=0x0020000000695cea
...
- (_Bool)isEqualToState:(id)arg1;	// IMP=0x0010000000695ae5
@property(readonly, nonatomic) CDStruct_8024420c engineTypes;
- (void)updateWithInfo:(id)arg1;	// IMP=0x00100000006953ac
- (id)_augmentVehicleInfo:(id)arg1;	// IMP=0x001000000069523a
- (void)_augmentMutableVehicleInfo:(id)arg1;	// IMP=0x0010000000694f9a
- (id)initWithAccessory:(id)arg1;	// IMP=0x0010000000694d54
- (id)descriptionForKey:(id)arg1;	// IMP=0x0010000000694c29
