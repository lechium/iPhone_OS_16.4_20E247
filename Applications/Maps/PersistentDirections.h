...
- (void).cxx_destruct;	// IMP=0x00200000009990e6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000998e11
- (unsigned long long)hash;	// IMP=0x0010000000998d1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000998b20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000099898e
- (void)copyTo:(id)arg1;	// IMP=0x001000000099886b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000998760
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000998462
- (id)dictionaryRepresentation;	// IMP=0x001000000099820f
- (id)description;	// IMP=0x0010000000998160
