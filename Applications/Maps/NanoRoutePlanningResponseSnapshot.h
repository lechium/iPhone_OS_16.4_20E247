...
@class MISSING_TYPE, NSArray, NSDate, NSString, NSUUID;
...
@interface NanoRoutePlanningResponseSnapshot : NSObject
{
    ...
    MISSING_TYPE *_selectedRouteIdentifier;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00200000002267a9
...
- (id)deltaFromSnapshot:(id)arg1;	// IMP=0x001000000022627a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000022611f
- (id)init;	// IMP=0x00100000002260b9
