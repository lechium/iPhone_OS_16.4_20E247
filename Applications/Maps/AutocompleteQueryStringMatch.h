...
- (void).cxx_destruct;	// IMP=0x00200000003d144b
...
- (id);	// IMP=0x00100000003d1418
- (id)initWithQueryTerms:(id)arg1 stringTerms:(id)arg2 matchingTerms:(id)arg3 totalMatchLength:(unsigned long long)arg4 fractionOfMatch:(double)arg5;	// IMP=0x00100000003d1317
- (id)init;	// IMP=0x00100000003d12ec
