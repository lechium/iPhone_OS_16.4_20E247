...
- (void).cxx_destruct;	// IMP=0x00200000007a5332
...
- (void)mapsForegrounded;	// IMP=0x00100000007a523b
- (void)mapsBackgrounded;	// IMP=0x00100000007a5229
- (void)endSession;	// IMP=0x00100000007a4eee
- (void)captureIntent:(int)arg1 withFailure:(int)arg2;	// IMP=0x00100000007a4e40
- (void)captureStatusIssue:(long long)arg1;	// IMP=0x00100000007a4e36
...
- (id)init;	// IMP=0x00100000007a4d0c
