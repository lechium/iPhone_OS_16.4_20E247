...
- (void).cxx_destruct;	// IMP=0x00200000001da88c
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000001da2e3
- (id)_alternateMapViewContext;	// IMP=0x00100000001da2d1
- (_Bool)isComplete;	// IMP=0x00100000001da01b
...
- (void)setCorrectedName:(id)arg1;	// IMP=0x00100000001d9d49
