...
- (void).cxx_destruct;	// IMP=0x00200000007e3028
...
- (_Bool)tableView:(id)arg1 shouldHighlightRowAtIndexPath:(id)arg2;	// IMP=0x00100000007e2c9d
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x00100000007e2bd1
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00100000007e27f9
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00100000007e27ee
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00100000007e27e3
- (double)tableView:(id)arg1 estimatedHeightForRowAtIndexPath:(id)arg2;	// IMP=0x00100000007e276d
- (void)datePickerChanged;	// IMP=0x00100000007e26ef
- (void)stepperChanged:(id)arg1;	// IMP=0x00100000007e25bd
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000007e2451
- (void)configureNavBar;	// IMP=0x00100000007e23ca
- (void)configureTableView;	// IMP=0x00100000007e21f1
- (void)viewDidLoad;	// IMP=0x00100000007e219b
- (id)initWithDate:(id)arg1 partySize:(unsigned long long)arg2 minimumPartySize:(unsigned long long)arg3 maximumPartySize:(unsigned long long)arg4 analyticsCaptor:(id)arg5 timeZone:(id)arg6 analyticsBookingSession:(id)arg7;	// IMP=0x00100000007e204c
