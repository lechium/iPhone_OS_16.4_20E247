...
+ (Class)stepViewClass;	// IMP=0x002000000066fe6e
+ (Class)_contentViewClass;	// IMP=0x001000000066fe5c
- (void).cxx_destruct;	// IMP=0x0020000000670208
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000670063
- (void)prepareForReuse;	// IMP=0x0010000000670017
- (void)configureWithItem:(id)arg1;	// IMP=0x001000000066fffa
@property(readonly, nonatomic) TransitDirectionsListItem *transitListItem;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000066fe8f
