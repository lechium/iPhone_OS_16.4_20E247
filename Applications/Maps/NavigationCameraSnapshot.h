...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000b579e9
- (void).cxx_destruct;	// IMP=0x0020000000b57f3a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000b57bf8
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000b57b12
- (id)init;	// IMP=0x0010000000b57ab3
- (id)initWithCamera:(id)arg1 tracePlaybackTimeFraction:(double)arg2 puckLocation:(id)arg3;	// IMP=0x0010000000b579f1
