...
- (void).cxx_destruct;	// IMP=0x002000000012db8c
...
- (id)initWithTransitLine:(id)arg1;	// IMP=0x001000000012d7aa
- (id)initWithIdentifier:(id)arg1 name:(id)arg2;	// IMP=0x001000000012d6ff
- (id)initWithLabelMarker:(id)arg1 system:(id)arg2;	// IMP=0x001000000012d666
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x001000000012d652
