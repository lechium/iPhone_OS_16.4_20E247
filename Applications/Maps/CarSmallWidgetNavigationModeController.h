...
- (void).cxx_destruct;	// IMP=0x002000000021b276
...
- (void)navigationService:(id)arg1 didArriveAtWaypoint:(id)arg2 endOfLegIndex:(unsigned long long)arg3;	// IMP=0x001000000021b094
- (void)resignTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x001000000021afe7
- (void)becomeTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x001000000021af85
@property(readonly, nonatomic) __weak GuidanceObserver *guidanceObserver;
- (_Bool)showsMapView;	// IMP=0x001000000021a8d3
- (id)fullscreenViewController;	// IMP=0x001000000021a8ca
- (void)_setupGuidanceCard;	// IMP=0x001000000021a7ce
