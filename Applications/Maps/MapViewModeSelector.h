...
- (void).cxx_destruct;	// IMP=0x002000000029656a
...
- (_Bool)updateSegmentsIfNeededToFitWidth:(double)arg1;	// IMP=0x0010000000296430
@property(nonatomic) long long selectedViewMode;
- (id)initWithDesiredViewModes:(id)arg1;	// IMP=0x0010000000295cc1
- (id)init;	// IMP=0x0010000000295ca8
