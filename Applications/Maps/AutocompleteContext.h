...
- (void).cxx_destruct;	// IMP=0x00200000005a5979
...
- (void)autocompleteMatchInfoDidUpdate:(id)arg1;	// IMP=0x00100000005a58c0
- (void)setMatchInfo:(id)arg1 forObject:(id)arg2;	// IMP=0x00100000005a5766
- (id)matchInfoForObject:(id)arg1;	// IMP=0x00100000005a55fc
- (id)initWithQueryString:(id)arg1;	// IMP=0x00100000005a5489
- (id)init;	// IMP=0x00100000005a545e
