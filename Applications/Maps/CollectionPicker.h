...
- (void).cxx_destruct;	// IMP=0x002000000018044a
...
- (void)collectionPickerViewController:(id)arg1 unselectCollection:(id)arg2;	// IMP=0x00100000001803a3
- (void)collectionPickerViewController:(id)arg1 selectCollection:(id)arg2;	// IMP=0x001000000017ffce
- (void)cleanControllers;	// IMP=0x001000000017ff95
@property(readonly, nonatomic) UIViewController *viewController;
- (id)initWithCollectionEditSession:(id)arg1 sourceView:(id)arg2 sourceRect:(struct CGRect)arg3;	// IMP=0x001000000017fa92
