...
- (void).cxx_destruct;	// IMP=0x0020000000b93c63
- (id)tableParts;	// IMP=0x0010000000b93ad7
...
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000b938e4
- (id)initWithReport:(id)arg1 question:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000b93805
