...
+ (double)heightForItem:(id)arg1 width:(double)arg2 maximumHeight:(double)arg3;	// IMP=0x00400000004b55e0
- (void).cxx_destruct;	// IMP=0x00200000004b5f77
...
- (void)setItem:(id)arg1;	// IMP=0x00100000004b5909
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000004b4bc3
