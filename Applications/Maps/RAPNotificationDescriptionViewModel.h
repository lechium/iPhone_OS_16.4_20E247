...
- (void).cxx_destruct;	// IMP=0x0020000000187f62
- (_Bool)shouldDisplayLink;	// IMP=0x0010000000187ed8
...
- (id)initWithRAPNotificationDetailsViewModel:(id)arg1;	// IMP=0x0010000000187cf1
