...
- (void).cxx_destruct;	// IMP=0x0020000000a56da8
...
- (CDStruct_0af47fae)cornerMaskForCarCardLayout:(CDStruct_de0926f2)arg1;	// IMP=0x0010000000a56baf
- (id)backgroundViewForCarCardLayout:(CDStruct_de0926f2)arg1 scale:(double)arg2 userInterfaceStyle:(long long)arg3;	// IMP=0x0010000000a56ba7
- (void)locationManagerApprovalDidChange:(id)arg1;	// IMP=0x0010000000a56aff
- (void)_buttonTapped:(id)arg1;	// IMP=0x0010000000a56ab3
- (void)viewDidLoad;	// IMP=0x0010000000a5668f
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000a56530
