...
- (void).cxx_destruct;	// IMP=0x0020000000326d77
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x0010000000326936
- (_Bool)_isRecursivelyComplete;	// IMP=0x00100000003268e2
...
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 arrivalPoint:(struct CLLocationCoordinate2D)arg3;	// IMP=0x00100000003264ea
