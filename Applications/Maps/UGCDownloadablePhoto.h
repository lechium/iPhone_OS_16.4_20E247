...
- (void).cxx_destruct;	// IMP=0x0020000000b12325
@property(readonly, nonatomic) _Bool needsObfuscationWhenRenderedInFullScreen;
- (id)largestPhoto;	// IMP=0x0010000000b122a4
- (id)bestPhotoForSize:(struct CGSize)arg1 options:(id)arg2;	// IMP=0x0010000000b12224
- (id)bestPhotoForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0010000000b121a4
- (id)bestPhotoForFrameSize:(struct CGSize)arg1 displayScale:(double)arg2 options:(id)arg3;	// IMP=0x0010000000b12124
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b1203e
@property(readonly, nonatomic) _Bool needsToBeDownloaded;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) NSURL *url;
@property(readonly, nonatomic) UIImage *image;
- (id)initWithGEORPEnrichmentImage:(id)arg1;	// IMP=0x0010000000b11f43
