...
- (void).cxx_destruct;	// IMP=0x0020000000b2c47a
@property(retain, nonatomic) NSUUID *updateIdentifier; // @synthesize updateIdentifier=_updateIdentifier;
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000b2c3c9
@property(nonatomic) __weak UIImage *image;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000b2c211
