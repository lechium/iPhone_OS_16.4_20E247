...
- (void).cxx_destruct;	// IMP=0x00200000004f16b7
...
- (id)initWithGEOMapItem:(id)arg1;	// IMP=0x00100000004f0e18
- (id)initWithPersonalizedItem:(id)arg1;	// IMP=0x00100000004f0dad
- (id)init;	// IMP=0x00100000004f0d6b
