...
- (void).cxx_destruct;	// IMP=0x00200000007645b4
@property(retain, nonatomic) NSError *error; // @synthesize error=_error;
@property(readonly, nonatomic) SearchInfo *searchInfo; // @synthesize searchInfo=_searchInfo;
- (void)loadSearchResultsWithRouteInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000763ce7
- (_Bool)hasValidSearchResults;	// IMP=0x0010000000763c17
@property(readonly, nonatomic) GEOFeatureStyleAttributes *styleAttributes;
@property(readonly, nonatomic) NSString *subtitle;
@property(readonly, nonatomic) NSString *title;
- (id)initWithSearchInfo:(id)arg1 error:(id)arg2;	// IMP=0x00100000007639ca
