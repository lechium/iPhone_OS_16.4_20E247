...
- (void).cxx_destruct;	// IMP=0x00200000006178a2
...
- (id)_addGuideForEdge:(unsigned long long)arg1;	// IMP=0x0010000000616c44
- (id)initWithHostView:(id)arg1;	// IMP=0x0010000000616be0
