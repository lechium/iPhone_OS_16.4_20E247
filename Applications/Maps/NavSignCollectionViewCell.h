...
- (void).cxx_destruct;	// IMP=0x00200000009c89cf
@property(readonly, nonatomic) NavManeuverSignView *navSignView; // @synthesize navSignView=_navSignView;
- (void)prepareForReuse;	// IMP=0x00100000009c8975
- (void)_configureConstraints;	// IMP=0x00100000009c866d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000009c850b
