...
@class MISSING_TYPE, UIBarButtonItem, UIPopoverController, UISplitViewController, UIViewController;
...
- (MISSING_TYPE *)splitViewController:showDetailViewController:sender: /* Error: Ran out of types for this method. */;
