...
- (void).cxx_destruct;	// IMP=0x0020000000b491d4
@property(readonly, nonatomic) CRRecentContact *recentContact; // @synthesize recentContact=_recentContact;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b490e0
@property(readonly) unsigned long long hash;
- (id)initWithRecentContact:(id)arg1 backgroundModel:(id)arg2;	// IMP=0x0010000000b48fde
