...
- (void).cxx_destruct;	// IMP=0x0020000000a2b7d7
...
- (void)plusButtonTapped:(id)arg1;	// IMP=0x0010000000a2b508
- (void)minusButtonTapped:(id)arg1;	// IMP=0x0010000000a2b4d6
- (void)updateLabel;	// IMP=0x0010000000a2b3bf
- (void)setupConstraints;	// IMP=0x0010000000a2ad75
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000a2a9f4
