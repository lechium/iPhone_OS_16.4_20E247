...
- (void).cxx_destruct;	// IMP=0x00200000007db4fd
...
- (void)_applicationDidEnterBackground:(id)arg1;	// IMP=0x00100000007db491
- (void)_applicationWillEnterForeground:(id)arg1;	// IMP=0x00100000007db474
- (void)shortcutsProviderUpdated:(id)arg1;	// IMP=0x00100000007db356
- (void)_clearFocusableItems;	// IMP=0x00100000007db264
@property(readonly, nonatomic) NSArray *carFocusOrderSequences;
- (void)resignTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x00100000007db16b
- (void)becomeTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x00100000007daf37
- (_Bool)showsMapView;	// IMP=0x00100000007daf2f
- (id)fullscreenViewController;	// IMP=0x00100000007daf26
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000007daee5
- (void)_addNoContentView;	// IMP=0x00100000007dad61
- (void)_addSearchCategoriesView;	// IMP=0x00100000007dabdd
- (void)_addShortcutsView;	// IMP=0x00100000007daa63
- (void)_updateWidgetContents;	// IMP=0x00100000007da654
@property(readonly, nonatomic) _Bool modeHandlesGestures;
- (void)dealloc;	// IMP=0x00100000007da5ee
- (id)init;	// IMP=0x00100000007da415
