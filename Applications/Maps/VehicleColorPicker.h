...
- (void).cxx_destruct;	// IMP=0x00200000004b4b61
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000004b4869
- (void)pressedCell:(id)arg1;	// IMP=0x00100000004b4690
- (id)initWithColors:(id)arg1 colorsPerRow:(unsigned long long)arg2 colorEdgeInsets:(struct UIEdgeInsets)arg3 selectedIndex:(id)arg4 contrastColor:(id)arg5 delegate:(id)arg6;	// IMP=0x00100000004b3949
