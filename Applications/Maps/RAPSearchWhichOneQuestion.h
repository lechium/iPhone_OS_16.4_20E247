...
- (void).cxx_destruct;	// IMP=0x002000000017f11b
...
- (_Bool)_hasSearchRelatedFollowupQuestion;	// IMP=0x001000000017f083
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000017eac2
- (id)_alternateAuxiliaryControlsRecording;	// IMP=0x001000000017ea72
- (_Bool)_isRecursivelyComplete;	// IMP=0x001000000017ea1e
- (_Bool)isComplete;	// IMP=0x001000000017ea09
