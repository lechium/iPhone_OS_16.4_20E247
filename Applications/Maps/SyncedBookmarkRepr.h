...
+ (Class)placesType;	// IMP=0x0020000000bb33c4
- (void).cxx_destruct;	// IMP=0x0010000000bb591d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000bb54fa
- (unsigned long long)hash;	// IMP=0x0010000000bb4dfa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000bb4ae1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000bb473c
- (void)copyTo:(id)arg1;	// IMP=0x0010000000bb44ef
- (void)writeTo:(id)arg1;	// IMP=0x0010000000bb4215
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000bb4208
- (id)dictionaryRepresentation;	// IMP=0x0010000000bb3484
- (id)description;	// IMP=0x0010000000bb33d5
- (id)placesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000bb33a7
- (unsigned long long)placesCount;	// IMP=0x0010000000bb338a
- (void)addPlaces:(id)arg1;	// IMP=0x0010000000bb3320
- (void)clearPlaces;	// IMP=0x0010000000bb3303
- (int)StringAsDirectionsMode:(id)arg1;	// IMP=0x0010000000bb3238
- (id)directionsModeAsString:(int)arg1;	// IMP=0x0010000000bb31ef
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000bb2df5
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000bb2dac
- (id)richMapsActivity;	// IMP=0x001000000099a685
