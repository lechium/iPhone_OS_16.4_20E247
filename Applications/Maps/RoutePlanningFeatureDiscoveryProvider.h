...
- (void).cxx_destruct;	// IMP=0x0020000000964681
...
- (void)source:(id)arg1 didUpdateAvailability:(_Bool)arg2;	// IMP=0x0010000000964511
- (id)_bestModelForCurrentState;	// IMP=0x0010000000964185
- (_Bool)_updateCurrentModelAndNotify:(_Bool)arg1;	// IMP=0x0010000000963f4f
- (_Bool)updateWithTransportType:(long long)arg1 routeCollection:(id)arg2;	// IMP=0x0010000000963b84
- (id)init;	// IMP=0x0010000000963922
