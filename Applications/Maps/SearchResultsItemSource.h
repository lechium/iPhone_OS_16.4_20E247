...
- (void).cxx_destruct;	// IMP=0x002000000090fa23
...
- (id)description;	// IMP=0x001000000090f934
- (id)keysForSearchResult:(id)arg1;	// IMP=0x001000000090f550
- (void)_updateSearchResults:(id)arg1;	// IMP=0x001000000090f01f
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000090ebf7
- (id)allItems;	// IMP=0x001000000090ead1
- (void)dealloc;	// IMP=0x001000000090e974
- (id)init;	// IMP=0x001000000090e8eb
