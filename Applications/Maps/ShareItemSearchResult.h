...
- (void).cxx_destruct;	// IMP=0x002000000088f18b
...
- (void)_setupCustomFeatureForMapItem;	// IMP=0x001000000088f036
- (void)_setupCustomFeatureStore;	// IMP=0x001000000088effb
- (id)mapItem;	// IMP=0x001000000088efab
...
- (void)setActivityProviderDelegate:(id)arg1;	// IMP=0x001000000088ead4
@property(readonly, nonatomic) NSArray *activityProviders; // @synthesize activityProviders=_activityProviders;
- (id)initWithSearchResult:(id)arg1 contact:(id)arg2 includePrintActivity:(_Bool)arg3 applicationActivities:(id)arg4;	// IMP=0x001000000088e882
