...
- (id)description;	// IMP=0x0010000000293bc7
- (double)valueAtTime:(double)arg1;	// IMP=0x0010000000293aaf
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(double)arg4;	// IMP=0x0010000000292f05
