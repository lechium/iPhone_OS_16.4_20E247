...
- (void).cxx_destruct;	// IMP=0x00200000001379e8
- (void)_reloadFavorites;	// IMP=0x0010000000137499
- (id)allItems;	// IMP=0x0010000000137373
- (void)userDefaultsDidChange:(id)arg1;	// IMP=0x00100000001372ae
- (void)queryContentsDidChangeWithQuery:(id)arg1;	// IMP=0x00100000001370d5
- (id)init;	// IMP=0x0010000000136db6
