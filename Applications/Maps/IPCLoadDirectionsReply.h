...
- (void).cxx_destruct;	// IMP=0x002000000027ca7b
...
- (id)description;	// IMP=0x001000000027c966
- (id)dictionaryValue;	// IMP=0x001000000027c7c2
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000027c648
