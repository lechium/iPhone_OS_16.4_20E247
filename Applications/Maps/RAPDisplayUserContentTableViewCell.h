...
- (void).cxx_destruct;	// IMP=0x0020000000b906aa
- (void)userDataDidUpdate;	// IMP=0x0010000000b90698
@property(retain, nonatomic) NSString *emailString;
@property(retain, nonatomic) NSString *nameString;
- (void)_retrieveUserInformation;	// IMP=0x0010000000b904f7
- (void)_configureViews;	// IMP=0x0010000000b8fcc9
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0010000000b8fc68
