...
- (void).cxx_destruct;	// IMP=0x002000000073ae73
...
- (id)_geoBusinessHours;	// IMP=0x001000000073add3
- (void)_setupSubmissionParameters:(id)arg1;	// IMP=0x001000000073ac8d
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000073aac5
- (_Bool)isComplete;	// IMP=0x001000000073aa92
@property(readonly, nonatomic) RAPCommentQuestion *commentQuestion; // @synthesize commentQuestion=_commentQuestion;
- (int)closureTypeAction;	// IMP=0x001000000073a902
- (void)_captureAnalytics;	// IMP=0x001000000073a88e
