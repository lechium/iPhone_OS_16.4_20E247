...
- (void).cxx_destruct;	// IMP=0x00200000006425d5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000006423db
- (unsigned long long)hash;	// IMP=0x001000000064230d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000064217c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000642044
- (void)copyTo:(id)arg1;	// IMP=0x0010000000641f61
- (void)writeTo:(id)arg1;	// IMP=0x0010000000641e89
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000641e7c
- (id)dictionaryRepresentation;	// IMP=0x0010000000641985
- (id)description;	// IMP=0x00100000006418d6
- (int)StringAsOrigin:(id)arg1;	// IMP=0x0010000000641827
- (id)originAsString:(int)arg1;	// IMP=0x00100000006417de
