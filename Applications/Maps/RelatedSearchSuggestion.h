...
- (void).cxx_destruct;	// IMP=0x00200000008fdde2
...
- (void)_parseComponents;	// IMP=0x00100000008fd7c8
@property(readonly, nonatomic) NSString *displayString;
- (void)_parseSubtitutes;	// IMP=0x00100000008fd3b4
- (id)initWithResultDisplayHeader:(id)arg1 substitutes:(id)arg2 visibleTime:(double)arg3 showCloseButton:(_Bool)arg4;	// IMP=0x00100000008fd2d0
