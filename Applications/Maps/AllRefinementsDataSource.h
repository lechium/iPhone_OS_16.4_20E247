...
- (void).cxx_destruct;	// IMP=0x0020000000af056f
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0010000000af03fe
- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3;	// IMP=0x0010000000af036f
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x0010000000af02fd
- (id)layoutSectionForSectionIndex:(long long)arg1 layoutEnvironment:(id)arg2;	// IMP=0x0010000000aef4e6
- (void)displayRefinements;	// IMP=0x0010000000aef191
- (void)setupDataSource;	// IMP=0x0010000000aee253
- (id)initWithCollectionView:(id)arg1 viewModel:(id)arg2 scrollViewDelegate:(id)arg3 selectionSequenceNumber:(id)arg4 analyticsDelegate:(id)arg5;	// IMP=0x0010000000aee0d1
