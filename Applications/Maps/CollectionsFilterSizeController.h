...
- (double)defaultHeight;	// IMP=0x0010000000a95ce3
- (double)minimumInterItemSpacingForSectionAtIndex:(long long)arg1;	// IMP=0x0010000000a95cc2
- (double)minimumLineSpacingForSectionAtIndex:(long long)arg1;	// IMP=0x0010000000a95c97
- (struct UIEdgeInsets)insetForFilterAtIndex:(long long)arg1;	// IMP=0x0010000000a95c78
- (struct CGSize)sizeForFilter:(id)arg1;	// IMP=0x0010000000a95ac3
- (id)initWithCollectionsFilterDisplayStyle:(long long)arg1 inContext:(long long)arg2;	// IMP=0x0010000000a958e5
