...
- (void).cxx_destruct;	// IMP=0x002000000079e028
...
- (id)_collectionItemImage;	// IMP=0x001000000079de1e
@property(readonly, copy, nonatomic) NSString *imageAttribution;
- (void)cancelImageDownload;	// IMP=0x001000000079da79
- (void)loadImageForSize:(struct CGSize)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000079d8a7
...
- (id)initWithMKPlaceCollectionMapItem:(id)arg1 usingAttribution:(id)arg2 itemDescription:(id)arg3 itemInUserCollection:(_Bool)arg4 appClip:(id)arg5;	// IMP=0x001000000079d40e
