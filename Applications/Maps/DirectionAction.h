...
- (void).cxx_destruct;	// IMP=0x0020000000a1f0fc
...
- (int)analyticsLaunchActionType;	// IMP=0x0010000000a1f085
- (_Bool)isCompatibleWithRestorationTask;	// IMP=0x0010000000a1f07d
- (_Bool)isCompatibleWithNavigation;	// IMP=0x0010000000a1f00f
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)initWithDirectionItem:(id)arg1 timePoint:(id)arg2 source:(unsigned long long)arg3;	// IMP=0x0010000000a1ee38
