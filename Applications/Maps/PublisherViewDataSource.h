...
- (void).cxx_destruct;	// IMP=0x0020000000b8fb7e
...
- (void)curatedCollectionSyncManagerDidUpdateCachedCollections:(id)arg1;	// IMP=0x0010000000b8f9b4
- (void)curatedCollectionSyncManagerDidUpdateSyncedCollections:(id)arg1;	// IMP=0x0010000000b8f977
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000b8f8c4
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0010000000b8f6cd
- (void)dismissedCollections;	// IMP=0x0010000000b8f690
- (void)updateCollections:(id)arg1 usingBatchIdentifiers:(id)arg2;	// IMP=0x0010000000b8f5a3
- (double)collectionView:(id)arg1 layout:(id)arg2 minimumInteritemSpacingForSectionAtIndex:(long long)arg3;	// IMP=0x0010000000b8f506
- (double)collectionView:(id)arg1 layout:(id)arg2 minimumLineSpacingForSectionAtIndex:(long long)arg3;	// IMP=0x0010000000b8f469
- (struct UIEdgeInsets)collectionView:(id)arg1 layout:(id)arg2 insetForSectionAtIndex:(long long)arg3;	// IMP=0x0010000000b8f39d
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0010000000b8f1b1
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 referenceSizeForHeaderInSection:(long long)arg3;	// IMP=0x0010000000b8ef57
- (void)didRouteToAddressFilter:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0010000000b8ebd3
- (void)didRouteToKeywordFilter:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0010000000b8e84f
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x0010000000b8e49a
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2 itemIdentifier:(id)arg3;	// IMP=0x0010000000b8e2d4
- (void)filterDataFetchStarted;	// IMP=0x0010000000b8e19a
- (void)didTapTryAgainOnErrorView;	// IMP=0x0010000000b8e043
- (void)clearPublisherData;	// IMP=0x0010000000b8e006
- (void)displayCollections:(CDUnknownBlockType)arg1;	// IMP=0x0010000000b8de6c
- (long long)presentationStyle;	// IMP=0x0010000000b8de61
- (void)dealloc;	// IMP=0x0010000000b8ddec
- (id)initWithCollectionView:(id)arg1 usingCuratedCollections:(id)arg2 usingPlaceCollectionIds:(id)arg3 withResultFilters:(id)arg4 withAPIController:(id)arg5 withCollectionRoutingDelegate:(id)arg6 usingAnalyticsManager:(id)arg7 usingPublisherActionsManager:(id)arg8;	// IMP=0x0010000000b8d88f
