...
- (void).cxx_destruct;	// IMP=0x0020000000bb2d3b
...
- (void)paymentSetupViewController:(id)arg1 didFinishAddingPaymentPasses:(id)arg2 error:(id)arg3;	// IMP=0x0010000000bb2a69
- (void)performActionSetupViewControllerDidFinish:(id)arg1;	// IMP=0x0010000000bb2a57
- (void)performActionSetupViewControllerDidCancel:(id)arg1;	// IMP=0x0010000000bb29d8
@property(readonly, nonatomic) _Bool wantsAllRouteCollectionChanges;
- (void)_tearDown;	// IMP=0x0010000000bb291e
- (void)_updateAvailability;	// IMP=0x0010000000bb1cb3
- (id)_suggestionsFromPBSuggestions:(id)arg1;	// IMP=0x0010000000bb1953
- (id)_modelFromData:(id)arg1;	// IMP=0x0010000000bb0ece
- (void)_fetchInsightsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000bb0955
- (void)updateFeatureEligibilityWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000bb04a3
- (void)transitPassManagerDidChange:(id)arg1;	// IMP=0x0010000000bb0491
- (void)setTransportType:(long long)arg1 routeCollection:(id)arg2;	// IMP=0x0010000000bb019b
@property(readonly, nonatomic, getter=isAvailable) _Bool available;
- (id)initWithPriority:(long long)arg1 delegate:(id)arg2;	// IMP=0x0010000000baff28
