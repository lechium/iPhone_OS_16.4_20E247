...
- (void).cxx_destruct;	// IMP=0x0020000000b4948a
@property(readonly, nonatomic) SearchResult *searchResult; // @synthesize searchResult=_searchResult;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b49396
@property(readonly) unsigned long long hash;
- (id)initWithSearchResult:(id)arg1 backgroundModel:(id)arg2;	// IMP=0x0010000000b491e7
