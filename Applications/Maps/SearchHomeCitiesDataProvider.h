...
- (void).cxx_destruct;	// IMP=0x002000000053764f
...
- (id)headerAccessibilityIdentifier;	// IMP=0x00100000005375ee
- (id)initWithObjects:(id)arg1 type:(long long)arg2 identifier:(id)arg3 title:(id)arg4;	// IMP=0x001000000053749f
