...
- (void).cxx_destruct;	// IMP=0x0020000000681561
...
- (void)didTapDoneButton:(id)arg1;	// IMP=0x001000000068149f
- (void)didTapButton:(id)arg1;	// IMP=0x00100000006813e6
- (void)_updateButtonLayoutToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 animated:(_Bool)arg3;	// IMP=0x0010000000680eb2
- (void)_setCornerRadii;	// IMP=0x0010000000680c4a
- (void)_updateButtonLayoutToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0010000000680c35
- (void)_updateButtonLayoutAnimated:(_Bool)arg1;	// IMP=0x0010000000680be2
- (void)_setupConstraints;	// IMP=0x001000000067f5e9
- (id)optionsMenu;	// IMP=0x001000000067efd4
- (void)_setupViews;	// IMP=0x001000000067e43f
- (void)updateTheme;	// IMP=0x001000000067e339
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000067e250
- (void)setMinimizedButtonEnabled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x001000000067e1e0
@property(nonatomic, getter=isMinimizedButtonEnabled) _Bool minimizedButtonEnabled;
- (void)setMaximizedButtonEnabled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x001000000067e1aa
@property(nonatomic, getter=isMaximizedButtonEnabled) _Bool maximizedButtonEnabled;
- (void)_setAlternateButtonEnabled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x001000000067e095
- (void)_setAlternateButtonEnabled:(_Bool)arg1;	// IMP=0x001000000067e081
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x001000000067de6b
- (void);	// IMP=0x001000000067de15
- (void)loadView;	// IMP=0x001000000067dd6c
- (void)dealloc;	// IMP=0x001000000067dcec
- (id)initWithShowsMinimizeButton:(_Bool)arg1 groupButtonsIfNeeded:(_Bool)arg2;	// IMP=0x001000000067dc89
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000067dc81
