...
@interface LookAroundChromeOverlay : NSObject
{
    ...
    MISSING_TYPE *_overlayAlpha;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00200000000e3298
...
- (void)enterLookAroundPIP:(id)arg1;	// IMP=0x00100000000e31f7
- (void)enterLookAroundForMapItem:(id)arg1 lookAroundView:(id)arg2;	// IMP=0x00100000000e3157
- (void)showLookAroundPreviewForMapItem:(id)arg1 willChangeHidden:(_Bool)arg2 animated:(_Bool)arg3;	// IMP=0x00100000000e3141
@property(nonatomic) double alpha;
- (void)_updateAlpha;	// IMP=0x00100000000e30b3
- (void)setHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00100000000e2d69
@property(nonatomic, getter=isHidden) _Bool hidden;
- (id)view;	// IMP=0x00100000000e2d36
- (void)_updateLayout;	// IMP=0x00100000000e2c73
- (void)_updateConstraintsIfNeeded;	// IMP=0x00100000000e2997
- (void)_invalidateConstraints;	// IMP=0x00100000000e2952
- (void)_installInContentView:(id)arg1;	// IMP=0x00100000000e285b
