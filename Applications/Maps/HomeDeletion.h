...
- (void).cxx_destruct;	// IMP=0x0020000000a913b5
...
- (id)description;	// IMP=0x0010000000a91233
- (void)markAsCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x0010000000a911e0
- (void)markAsTentativelyDeleted;	// IMP=0x0010000000a911ca
- (id)initWithObject:(id)arg1 indexPath:(id)arg2 identifierPath:(id)arg3 contextualActionCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000a910dd
