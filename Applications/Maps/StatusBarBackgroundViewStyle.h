...
+ (id)defaultBlurredStyleWithDefaultColorProvider:(CDUnknownBlockType)arg1;	// IMP=0x00400000003bc86d
- (void).cxx_destruct;	// IMP=0x00200000003bcf2d
...
- (unsigned long long)hash;	// IMP=0x00100000003bce26
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000003bcc37
- (id)description;	// IMP=0x00100000003bcb63
- (id)initWithVariableBlurRadius:(double)arg1 defaultColorProvider:(CDUnknownBlockType)arg2 disableBlur:(_Bool)arg3;	// IMP=0x00100000003bcad6
- (id)initWithGaussianBlurRadius:(double)arg1 defaultColorProvider:(CDUnknownBlockType)arg2 disableBlur:(_Bool)arg3;	// IMP=0x00100000003bca49
- (id)initWithBlurStyle:(long long)arg1 groupName:(id)arg2 defaultColorProvider:(CDUnknownBlockType)arg3 disableBlur:(_Bool)arg4;	// IMP=0x00100000003bc98b
- (id)initWithColor:(id)arg1;	// IMP=0x00100000003bc918
