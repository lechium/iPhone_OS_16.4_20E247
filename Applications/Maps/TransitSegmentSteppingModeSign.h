...
- (void).cxx_destruct;	// IMP=0x002000000052ec11
...
- (id)initWithWalkingSegment:(id)arg1 stepIndexRange:(struct _NSRange)arg2;	// IMP=0x001000000052e647
- (id)initWithStep:(id)arg1 stepIndexRange:(struct _NSRange)arg2;	// IMP=0x001000000052e531
