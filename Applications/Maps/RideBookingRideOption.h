...
- (void).cxx_destruct;	// IMP=0x001000000065aed2
...
- (id)description;	// IMP=0x001000000065adf2
- (id)initWithApplication:(id)arg1 optionName:(id)arg2 paymentMethods:(id)arg3 estimatedPickupDate:(id)arg4 passengersChoice:(id)arg5;	// IMP=0x001000000065ac79
