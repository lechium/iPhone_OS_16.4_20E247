...
- (void).cxx_destruct;	// IMP=0x002000000054aa56
...
- (void)recordItemInHistoryWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000054a4ee
- (void)recordItemInHistory;	// IMP=0x001000000054a4da
- (id)initWithTicket:(id)arg1 searchResults:(id)arg2 auxiliaryControlsOrigin:(long long)arg3 hasRefinedMapItems:(_Bool)arg4 tracksRAPReportingOnly:(_Bool)arg5 completionTitle:(id)arg6;	// IMP=0x001000000054a395
