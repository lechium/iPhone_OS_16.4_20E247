...
- (void).cxx_destruct;	// IMP=0x0010000000b4a135
@property(readonly, nonatomic) id <GEOTransitLine> transitLine; // @synthesize transitLine=_transitLine;
- (id)accessoryModels;	// IMP=0x0010000000b4a10f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b49fea
@property(readonly) unsigned long long hash;
- (id)initWithTransitLine:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000b49dea
