...
- (void).cxx_destruct;	// IMP=0x00200000007e5654
...
- (void)smallDropDownOutlineCell:(id)arg1 didSelectItemAtIndex:(long long)arg2;	// IMP=0x00100000007e55be
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007e523c
@property(readonly) unsigned long long hash;
- (id)initWithSuggestions:(id)arg1 currentSuggestion:(id)arg2 delegate:(id)arg3;	// IMP=0x00100000007e5138
