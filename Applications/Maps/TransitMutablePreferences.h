...
- (void)setMode:(long long)arg1 disabled:(_Bool)arg2;	// IMP=0x0020000000b3aa31
- (void)toggleModeEnabled:(long long)arg1;	// IMP=0x0010000000b3a9d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b3a95e
