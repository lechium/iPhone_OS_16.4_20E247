...
- (void).cxx_destruct;	// IMP=0x002000000027c617
...
- (id)description;	// IMP=0x001000000027c504
- (id)dictionaryValue;	// IMP=0x001000000027c382
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000027c1fa
