...
+ (id)taskForURL:(id)arg1 referringURL:(id)arg2 sourceApplication:(id)arg3 sceneOptions:(id)arg4 mkOptions:(id)arg5 windowSize:(struct CGSize)arg6;	// IMP=0x00400000003a2fa8
- (void).cxx_destruct;	// IMP=0x00200000003a3c6b
...
- (void)taskFailed;	// IMP=0x00100000003a3b0d
- (void)taskFinished:(id)arg1;	// IMP=0x00100000003a3acc
- (id)urlScheme;	// IMP=0x00100000003a39ce
- (void)_sendAnalytics;	// IMP=0x00100000003a3912
- (void)_populateSessionAnalytics;	// IMP=0x00100000003a3729
- (id)initWithURL:(id)arg1 referringURL:(id)arg2 sourceApplication:(id)arg3 sceneOptions:(id)arg4 mkOptions:(id)arg5;	// IMP=0x00100000003a35ff
