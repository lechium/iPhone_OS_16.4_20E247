...
- (void).cxx_destruct;	// IMP=0x0020000000a7fde7
...
- (unsigned long long)_guidanceUpdate:(id)arg1 isDifferentFromGuidanceUpdate:(id)arg2;	// IMP=0x0010000000a7fb2f
- (_Bool)_shouldGuidanceUpdateDisplayPersistently:(id)arg1;	// IMP=0x0010000000a7fabe
- (void)_updateIdleTimerState;	// IMP=0x0000000000a7f75d
- (void)_notifyShouldUndim;	// IMP=0x0010000000a7f5bb
- (_Bool)_isInPocket;	// IMP=0x0010000000a7f561
- (void)updateConfiguration;	// IMP=0x0010000000a7f54f
- (void)updateGuidanceState:(id)arg1;	// IMP=0x0010000000a7f145
- (void)pocketStateManager:(id)arg1 didUpdateState:(long long)arg2;	// IMP=0x0010000000a7eedc
- (void)screenLayoutDidChange;	// IMP=0x0010000000a7ed2d
- (void)dealloc;	// IMP=0x0010000000a7ebeb
- (id)initWithIdleStateHandler:(CDUnknownBlockType)arg1 undimHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a7e9ee
