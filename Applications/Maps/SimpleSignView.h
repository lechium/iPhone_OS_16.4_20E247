...
- (void).cxx_destruct;	// IMP=0x002000000062fe5f
...
- (void)layoutSubviews;	// IMP=0x001000000062fb66
@property(readonly, nonatomic) UIImageView *shieldImageView;
@property(readonly, nonatomic) GuidanceManeuverView *maneuverView;
- (void)updateStyleForTheme;	// IMP=0x001000000062f5f5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000062f446
