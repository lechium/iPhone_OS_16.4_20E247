...
+ (id)sharedInstance;	// IMP=0x002000000019105b
- (void).cxx_destruct;	// IMP=0x0020000000191cde
...
- (void)virtualGarage:(id)arg1 didUpdateUnpairedVehicles:(id)arg2;	// IMP=0x0010000000191bc5
- (void)virtualGarageDidUpdate:(id)arg1;	// IMP=0x0010000000191a8c
- (void)_updateLinkAndNotifyObservers:(_Bool)arg1;	// IMP=0x00100000001919cd
@property(readonly, nonatomic) GEOObserverHashTable *observers;
- (void)_loadUnpairedVehicles;	// IMP=0x00100000001916ed
- (void)_loadGarage;	// IMP=0x0010000000191470
- (id)retrieveSubtitleText;	// IMP=0x0010000000191358
@property(readonly, nonatomic) long long userProfileLinkType;
- (id)createUserProfileLink;	// IMP=0x001000000019113c
- (id)init;	// IMP=0x00100000001910b0
