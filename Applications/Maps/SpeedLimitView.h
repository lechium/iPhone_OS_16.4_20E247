...
- (void).cxx_destruct;	// IMP=0x00200000006085c9
...
- (id)_stringWithSpeedLimit:(unsigned long long)arg1;	// IMP=0x0010000000608456
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000006083d6
- (void)_updateShield;	// IMP=0x0010000000607ff0
@property(readonly, nonatomic) _Bool hasContent;
- (void)setSpeedLimit:(unsigned long long)arg1 shieldType:(long long)arg2;	// IMP=0x0010000000607e8d
@property(readonly, nonatomic) UIImageView *speedLimitImageView; // @synthesize speedLimitImageView=_speedLimitImageView;
- (void)didMoveToWindow;	// IMP=0x0010000000607da7
@property(readonly, nonatomic) long long shieldSize;
- (void)_maps_commonInit;	// IMP=0x0010000000607a83
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000607a26
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000006079da
