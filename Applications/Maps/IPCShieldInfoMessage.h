...
+ (id)ipcMessageForShieldInfo:(id)arg1;	// IMP=0x001000000092ee07
- (void).cxx_destruct;	// IMP=0x0010000000b8001c
...
- (id)description;	// IMP=0x0010000000b7fea2
- (id)dictionaryValue;	// IMP=0x0010000000b7fd23
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000b7fc00
- (id)shieldInfo;	// IMP=0x001000000092eed5
