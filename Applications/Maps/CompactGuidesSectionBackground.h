...
+ (id)decorationViewKind;	// IMP=0x00400000006d4391
- (void).cxx_destruct;	// IMP=0x00200000006d5113
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000006d4fe5
- (void)updateBackgroundUI;	// IMP=0x00100000006d4e40
- (void)setupGradientBackground;	// IMP=0x00100000006d49f0
- (void)setupHairlines;	// IMP=0x00100000006d4410
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000006d439e
