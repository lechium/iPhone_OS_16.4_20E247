...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000592598
+ (id)requestForPlaceholderDirections;	// IMP=0x001000000059217e
+ (id)requestForDirectionsWithCompanionRouteDetails:(id)arg1 companionRouteContext:(id)arg2;	// IMP=0x0010000000592008
+ (id)requestWithWaypoints:(id)arg1 viaTransportType:(unsigned long long)arg2 traits:(id)arg3 companionRouteContext:(id)arg4;	// IMP=0x0010000000591e85
- (void).cxx_destruct;	// IMP=0x0020000000592dfb
...
- (id)debugDescription;	// IMP=0x0010000000592b8e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000059298a
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000005925a0
- (void)_populateCopy:(id)arg1;	// IMP=0x00100000005924d2
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000059249e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000059246a
- (id)snapshot;	// IMP=0x00100000005923e9
...
- (id)requestedCompanionRouteDetails;	// IMP=0x00100000005921cf
- (id)init;	// IMP=0x0010000000591d7c
