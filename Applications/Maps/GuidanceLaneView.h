...
- (void).cxx_destruct;	// IMP=0x0020000000784750
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x001000000078443b
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000078436c
- (id)_defaultInvalidArrowColor;	// IMP=0x00100000007842fd
- (id)_validArrowColor;	// IMP=0x00100000007842e8
- (id)_preferredArrowColor;	// IMP=0x0010000000784289
- (_Bool)_markFirstDirectionAsValid;	// IMP=0x0010000000784281
- (_Bool)_highlightFirstDirection;	// IMP=0x001000000078419f
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000784187
- (void)_updateLanePaths;	// IMP=0x0010000000784114
- (id)accessibilityIdentifier;	// IMP=0x0010000000784027
- (id)initWithLaneInfo:(id)arg1 maneuverHasPreferredLane:(_Bool)arg2 drawingBiasDirection:(unsigned long long)arg3 laneStyle:(unsigned long long)arg4;	// IMP=0x0010000000783e47
