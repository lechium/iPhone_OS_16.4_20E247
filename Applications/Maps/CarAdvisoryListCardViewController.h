...
- (void).cxx_destruct;	// IMP=0x002000000061ec71
...
- (unsigned long long)numberOfItems;	// IMP=0x001000000061eaff
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x001000000061ea16
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x001000000061e9f9
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x001000000061e8b1
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x001000000061e814
- (double)tableView:(id)arg1 heightForRowAtIndexPath:(id)arg2;	// IMP=0x001000000061e806
- (id)uniqueName;	// IMP=0x001000000061e7ec
- (void)viewDidLoad;	// IMP=0x001000000061e488
- (id)initWithRoute:(id)arg1 delegate:(id)arg2;	// IMP=0x001000000061e32e
