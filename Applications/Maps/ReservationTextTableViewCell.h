...
- (void).cxx_destruct;	// IMP=0x00200000001ae806
...
- (void)setupConstraints;	// IMP=0x00100000001ad4f7
- (void)updateConstraints;	// IMP=0x00100000001ad04e
- (void)secondaryButtonSelected:(id)arg1;	// IMP=0x00100000001ad002
- (void)primaryButtonSelected:(id)arg1;	// IMP=0x00100000001acfb6
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00100000001acb71
