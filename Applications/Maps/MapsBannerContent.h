...
- (void).cxx_destruct;	// IMP=0x00200000002a8462
- (id)footerView;	// IMP=0x00100000002a8458
...
- (id)initWithHeaderView:(id)arg1 iconView:(id)arg2 leadingTopView:(id)arg3 trailingTopView:(id)arg4 bottomView:(id)arg5 footerView:(id)arg6;	// IMP=0x00100000002a811b
