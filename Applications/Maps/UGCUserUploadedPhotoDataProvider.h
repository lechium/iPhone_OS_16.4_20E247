...
- (void).cxx_destruct;	// IMP=0x0020000000a6c4dc
...
- (void)_setupPhotos;	// IMP=0x0010000000a6c08b
- (void)fetchNextBatchRequestIfNeeded;	// IMP=0x0010000000a6bfd2
@property(readonly, nonatomic) _Bool hasReachedTotalCount;
@property(readonly, nonatomic) _Bool hasDataToShow;
- (id)initWithLookupResult:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000a6bece
