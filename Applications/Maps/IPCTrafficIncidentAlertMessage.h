...
- (void).cxx_destruct;	// IMP=0x0020000000b47298
...
- (id)description;	// IMP=0x0010000000b47085
- (id)dictionaryValue;	// IMP=0x0010000000b46e66
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000b46cdb
