...
- (void).cxx_destruct;	// IMP=0x00200000003c786d
...
- (id)_titleOfResolvedItem:(id)arg1 withSearchCompletion:(id)arg2;	// IMP=0x00100000003c7796
- (void)_calculateStrings;	// IMP=0x00000000003c7396
- (id)initWithLocalSearchCompletion:(id)arg1;	// IMP=0x00100000003c731b
