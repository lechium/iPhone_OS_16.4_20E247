...
- (void).cxx_destruct;	// IMP=0x0020000000416823
...
- (void)navSignLabel:(id)arg1 didSelectAlternate:(unsigned long long)arg2;	// IMP=0x001000000041651a
- (id)debugDescription;	// IMP=0x001000000041646b
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3;	// IMP=0x00100000004163e3
- (void)_updateShieldView;	// IMP=0x001000000041622b
- (void)_setNeedsUpdateShield;	// IMP=0x00100000004161a5
...
- (void)configureForArrivalWithSignID:(id)arg1 titles:(id)arg2 details:(id)arg3 maneuverType:(int)arg4;	// IMP=0x0010000000415cf4
- (void)configureForProceedToRouteWithSignID:(id)arg1 displayString:(id)arg2;	// IMP=0x0010000000415b04
- (void)setManeuverGuidanceInfo:(id)arg1 hasArrived:(_Bool)arg2;	// IMP=0x0010000000415a06
- (void)_updateLabelText;	// IMP=0x00100000004156a5
- (void)_updateConstraints;	// IMP=0x0010000000414c84
- (void)_setupConstraints;	// IMP=0x0010000000413e35
- (void)_setupSubviews;	// IMP=0x0010000000413b9f
- (void)refreshSign;	// IMP=0x0010000000413a39
- (id)_defaultSignLayoutDelegate;	// IMP=0x0010000000413a20
- (void)updateTheme;	// IMP=0x00100000004138fb
- (void)clearContent;	// IMP=0x0010000000413870
