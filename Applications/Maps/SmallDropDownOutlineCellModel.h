...
- (void).cxx_destruct;	// IMP=0x0020000000ab426b
...
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x0010000000ab4218
@property(readonly, nonatomic) UICollectionViewCellRegistration *cellRegistration;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ab4067
@property(readonly) unsigned long long hash;
- (id)initWithButtonTitle:(id)arg1 dropDownTitles:(id)arg2 selectedIndex:(long long)arg3 delegate:(id)arg4 backgroundModel:(id)arg5;	// IMP=0x0010000000ab3f26
