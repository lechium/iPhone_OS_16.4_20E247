...
- (void).cxx_destruct;	// IMP=0x0020000000b6cd8a
...
- (void)_handleTimer;	// IMP=0x0010000000b6cc70
- (void)_invalidateTimer;	// IMP=0x0010000000b6cbeb
- (void)_scheduleTimer;	// IMP=0x0010000000b6c9bd
- (void)_handleGesture:(id)arg1;	// IMP=0x0010000000b6c96e
- (void)_handleEvent:(id)arg1;	// IMP=0x0010000000b6c6d6
- (void)_setupEventTap;	// IMP=0x0010000000b6c44d
- (void)dealloc;	// IMP=0x0010000000b6c3cd
- (id)initWithView:(id)arg1 idleTimeout:(double)arg2;	// IMP=0x0010000000b6c335
- (id)initWithView:(id)arg1;	// IMP=0x0010000000b6c31b
- (id)initWithWindow:(id)arg1 idleTimeout:(double)arg2;	// IMP=0x0010000000b6c283
- (id)initWithWindow:(id)arg1;	// IMP=0x0010000000b6c269
