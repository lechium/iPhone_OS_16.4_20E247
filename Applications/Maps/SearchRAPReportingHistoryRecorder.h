...
- (void).cxx_destruct;	// IMP=0x00200000009ae346
...
- (void)recordItemInHistory;	// IMP=0x00100000009ae278
- (id)initWithTicket:(id)arg1 auxiliaryControlsOrigin:(long long)arg2;	// IMP=0x00100000009ae202
