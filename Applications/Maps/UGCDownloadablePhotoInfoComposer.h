...
+ (id)downloadablePhotoForUGCPhoto:(id)arg1;	// IMP=0x00200000001ecc7c
+ (id)downloadablePhotoForGeoMapItemPhotoInfo:(id)arg1;	// IMP=0x00100000001ecbea
- (void).cxx_destruct;	// IMP=0x00200000001ecd51
...
- (id)initWithIdentifier:(id)arg1 url:(id)arg2 timeoutInterval:(double)arg3;	// IMP=0x00100000001ecb42
