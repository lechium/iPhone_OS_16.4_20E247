...
- (void).cxx_destruct;	// IMP=0x0020000000b4a497
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b4a315
@property(readonly) unsigned long long hash;
- (id)initWithMapItem:(id)arg1 currentLocation:(id)arg2 distanceUnit:(long long)arg3 backgroundModel:(id)arg4;	// IMP=0x0010000000b4a166
