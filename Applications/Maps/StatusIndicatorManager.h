...
- (void).cxx_destruct;	// IMP=0x0020000000283676
...
- (void)updateIndicatorType;	// IMP=0x0010000000283533
- (void)locationManagerApprovalDidChange:(id)arg1;	// IMP=0x00100000002832ce
- (void)airplaneModeChanged;	// IMP=0x00100000002832bc
- (void)dealloc;	// IMP=0x0010000000283247
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000028306b
