...
- (void).cxx_destruct;	// IMP=0x0020000000a78be5
...
- (void)_setMapRotationRadians:(double)arg1;	// IMP=0x0010000000a78b93
- (void)_setMapPitchRadians:(double)arg1;	// IMP=0x0010000000a789ca
- (id);	// IMP=0x0010000000a782fc
- (void)_updateAccuracy;	// IMP=0x0010000000a780a2
- (void)_updateCourse;	// IMP=0x0010000000a77fa4
- (void)_updateFillColor;	// IMP=0x0010000000a77e92
