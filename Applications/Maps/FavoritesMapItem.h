...
- (void).cxx_destruct;	// IMP=0x0010000000136b1f
...
- (_Bool)shows;	// IMP=0x0010000000136a13
...
- (id)initWithSearchResult:(id)arg1;	// IMP=0x0010000000136777
- (id)initWithMapItem:(id)arg1 title:(id)arg2;	// IMP=0x00100000001365c9
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x0010000000136d56
...
- (long long)priorityOverride;	// IMP=0x0010000000136bde
