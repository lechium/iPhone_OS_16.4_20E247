...
- (void).cxx_destruct;	// IMP=0x00200000001e79ef
...
- (id)itemMatchingLocation:(id)arg1;	// IMP=0x00100000001e77c9
@property(readonly, nonatomic) NSArray *allKeysetsForEndLocations;
@property(readonly, nonatomic) NSSet *keysForStartLocation;
- (id)allItems;	// IMP=0x00100000001e72b1
- (void)setStartLocation:(id)arg1 endLocations:(id)arg2;	// IMP=0x00100000001e6eb4
- (void)setStartLocation:(id)arg1 endLocation:(id)arg2;	// IMP=0x00100000001e6daf
- (void)_updateItemVisibility;	// IMP=0x00100000001e6bee
- (void)clearStartAndEndLocations;	// IMP=0x00100000001e6ab7
- (id)init;	// IMP=0x00100000001e6a2e
