...
- (void).cxx_destruct;	// IMP=0x0020000000372085
...
- (id)differenceUnionWithDifference:(id)arg1;	// IMP=0x0010000000371e76
- (id)initWithReloadedItems:(id)arg1 insertedItems:(id)arg2 deletedItems:(id)arg3;	// IMP=0x0010000000371d90
