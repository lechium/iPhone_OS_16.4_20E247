...
- (void).cxx_destruct;	// IMP=0x002000000055139e
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x0010000000551187
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x001000000055111b
@property(readonly, nonatomic) DrivePreferences *drivePreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x0010000000551074
