...
- (void).cxx_destruct;	// IMP=0x0020000000368d18
...
- (id)layoutSectionForWorldwideUsingTraitsEnvironment:(id)arg1 usingWidth:(double)arg2;	// IMP=0x00100000003688e7
- (id)layoutSectionForCompactCollectionsUsingTraitsEnvironment:(id)arg1 usingWidth:(double)arg2;	// IMP=0x0010000000368405
- (void)initializeSizeControllerUsingTraitEnvironment:(id)arg1;	// IMP=0x001000000036837f
- (void)setupConfiguration;	// IMP=0x00100000003682f5
- (id)layoutForSectionUsingTraitsEnvironment:(id)arg1 usingWidth:(double)arg2;	// IMP=0x0010000000368272
- (id)initWithSectionKind:(long long)arg1 usingMaxWidth:(double)arg2 usingTraitEnvironment:(id)arg3;	// IMP=0x00100000003681ee
