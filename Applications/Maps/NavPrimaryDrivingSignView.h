...
- (void).cxx_destruct;	// IMP=0x00200000006b4b18
...
- (id)debugDescription;	// IMP=0x00100000006b49cf
- (void)_animateTransitioningFromOldLaneGuidance:(id)arg1;	// IMP=0x00100000006b450b
- (void)_animateShowingLaneGuidanceView;	// IMP=0x00100000006b41d6
- (void)hideLaneGuidanceAnimated:(_Bool)arg1;	// IMP=0x00100000006b3fbf
- (void)showLaneGuidance:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00100000006b3b03
- (void)updateLaneGuidance:(id)arg1;	// IMP=0x00100000006b3abb
- (_Bool)highlightedLanesNotInVisibleRange;	// IMP=0x00100000006b3a3d
@property(readonly, nonatomic) UIView *viewForSecondarySignTextToAlignLeading;
@property(nonatomic) _Bool debugHighlightLanes;
- (void)clearContent;	// IMP=0x00100000006b380d
- (id)accessibilityIdentifier;	// IMP=0x00100000006b37fb
- (void)_updateLabelText;	// IMP=0x00100000006b35ff
- (void)_updateConstraints;	// IMP=0x00100000006b313c
- (void)_setupConstraints;	// IMP=0x00100000006b2d08
- (void)refreshSign;	// IMP=0x00100000006b2c52
- (void)_setupSubviews;	// IMP=0x00100000006b2b93
- (id)_defaultSignLayoutDelegate;	// IMP=0x00100000006b2b7a
