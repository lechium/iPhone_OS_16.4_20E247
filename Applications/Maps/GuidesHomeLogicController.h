...
- (void).cxx_destruct;	// IMP=0x002000000073ecc6
...
- (void)scrollToSelectedFilter;	// IMP=0x001000000073eadc
- (id)routeToSelectedGuidesHomeFilterAtIndexPath:(id)arg1;	// IMP=0x001000000073e952
- (id)routeToSelectedAllCollectionsFilterAtIndexPath:(id)arg1;	// IMP=0x001000000073e94a
- (id)routeToSelectedFilterAtIndexPath:(id)arg1;	// IMP=0x001000000073e942
- (id)selectedFilterIndexPath;	// IMP=0x001000000073e8f2
- (void)initializeSectionsUsingMaxWidth:(double)arg1 traitEnvironment:(id)arg2;	// IMP=0x001000000073d43c
- (id)itemsForSectionAtIndex:(unsigned long long)arg1;	// IMP=0x001000000073cffd
- (id)filterValueAtIndex:(unsigned long long)arg1;	// IMP=0x001000000073cf46
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x001000000073ce9e
- (id)allSections;	// IMP=0x001000000073ce56
- (void)appendBatchOfCollections:(id)arg1;	// IMP=0x001000000073cd52
- (void)updateFilteredCollectionsFromResults:(id)arg1 collectionIds:(id)arg2;	// IMP=0x001000000073c967
- (void)willDisplayCellAtIndexpath:(id)arg1;	// IMP=0x001000000073c86a
- (void)initializeFonts;	// IMP=0x001000000073c7be
- (id)initWithGuidesHomeResult:(id)arg1 maxWidth:(double)arg2 traitEnvironment:(id)arg3 guideFetcher:(id)arg4 guideConsumer:(id)arg5 guideLocation:(id)arg6;	// IMP=0x001000000073c67c
