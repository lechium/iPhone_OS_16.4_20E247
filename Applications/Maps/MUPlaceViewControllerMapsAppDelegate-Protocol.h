...
@class CNContact, CNContactViewController, GEOAppleMediaServicesResult, GEOGuideLocation, GEOMapServiceTraits, GEOPlaceCollection, GEOSearchCategory, MKLookAroundView, MKMapItem, MKPlaceActionEnvironment, MKPlaceCardActionItem, MUActivityViewController, MUPlacePhotoGalleryViewController, MUPlaceViewController, NSArray, NSDictionary, NSNumber, NSString, NSURL, UIImage, UIMenu, UIMenuElement, UINavigationController, UIView, UIViewController, _MXExtension;
...
- (void)placeViewController:(MUPlaceViewController *)arg1 didSelectAddRatingsWithObserver:(id <MKActivityObserving>)arg2 overallState:(long long)arg3 originTarget:(NSString *)arg4;
- (void)placeViewController:(MUPlaceViewController *)arg1 didSelectAddPhotosWithObserver:(id <MKActivityObserving>)arg2 sourceView:(UIView *)arg3 entryPoint:(long long)arg4 originTarget:(NSString *)arg5;
