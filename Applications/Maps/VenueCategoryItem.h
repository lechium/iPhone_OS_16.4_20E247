...
- (void).cxx_destruct;	// IMP=0x00200000005f9da9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005f9ba4
- (id)initWithSearchCategory:(id)arg1 venueIdentifier:(id)arg2 displayMode:(int)arg3 isAutoCompleteCategory:(_Bool)arg4 shouldFrameMapViewport:(_Bool)arg5;	// IMP=0x00100000005f9aee
