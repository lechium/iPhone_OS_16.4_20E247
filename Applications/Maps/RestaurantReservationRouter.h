...
- (void).cxx_destruct;	// IMP=0x0020000000b3f0ab
...
- (void)updateSessionAsInstallCompletedIfNeeded:(id)arg1;	// IMP=0x0010000000b3f01c
- (id)reservationExtensionFlowViewController;	// IMP=0x0010000000b3ef37
- (id)alertControllerForExtensionPermission;	// IMP=0x0010000000b3ea3e
- (void)requester:(id)arg1 userCurrentBookingRequestDidFailWithError:(id)arg2;	// IMP=0x0010000000b3e92a
- (void)requesterUserCurrentBookingRequestDidComplete:(id)arg1;	// IMP=0x0010000000b3e723
- (void)discoverActiveReservationEvents;	// IMP=0x0010000000b3e69e
- (void)discoverGuest;	// IMP=0x0010000000b3e661
- (void)discoverAvailableBookings;	// IMP=0x0010000000b3e43c
- (void)requesterReservationDefaultsRequestDidComplete:(id)arg1;	// IMP=0x0010000000b3e37c
- (void)discoverDefaults;	// IMP=0x0010000000b3e33f
- (void)resolve;	// IMP=0x0010000000b3e271
- (id)initWithExtension:(id)arg1 appStoreApp:(id)arg2 mapItem:(id)arg3 presenter:(id)arg4;	// IMP=0x0010000000b3e149
