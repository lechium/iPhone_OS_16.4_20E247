...
+ (id)defaultRouteAttributesForNavigationOfType:(int)arg1;	// IMP=0x00400000001ddbfd
- (void).cxx_destruct;	// IMP=0x00200000001df082
...
- (void)_handleDirectionsResponse:(id)arg1 forRequest:(id)arg2 waypoints:(id)arg3 error:(id)arg4 directionsError:(id)arg5;	// IMP=0x00100000001de989
- (void)cancel;	// IMP=0x00100000001de8fd
- (void)loadNewRouteSet;	// IMP=0x00100000001de5ba
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x00100000001de454
- (id)_directionsRequestParameters;	// IMP=0x00100000001dddea
- (void)_setupFeedbackIfNeeded;	// IMP=0x00100000001ddcf2
- (id)initWithWaypoints:(id)arg1 type:(int)arg2 currentLocation:(id)arg3 fromCurrentLocation:(_Bool)arg4 withFeedback:(id)arg5;	// IMP=0x00100000001ddb32
- (id)init;	// IMP=0x00100000001ddaf3
- (void)dealloc;	// IMP=0x00100000001ddaa0
