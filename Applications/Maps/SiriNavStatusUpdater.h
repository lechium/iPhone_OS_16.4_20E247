...
- (void).cxx_destruct;	// IMP=0x002000000085123c
@property(readonly, nonatomic) MNNavigationService *navigationService; // @synthesize navigationService=_navigationService;
- (void)_updateSiriNavStatusForNewNavigationServiceState:(unsigned long long)arg1;	// IMP=0x0010000000851149
- (void);	// IMP=0x0010000000851134
- (id)initWithNavigationService:(id)arg1;	// IMP=0x0010000000850fff
