...
- (void).cxx_destruct;	// IMP=0x00200000004fbe9a
...
- (void)collectionListCard:(id)arg1 didSelectCollection:(id)arg2;	// IMP=0x00100000004fbc12
- (void)collectionManager:(id)arg1 contentDidChange:(id)arg2;	// IMP=0x00100000004fbbfd
- (void)_updateCollections:(id)arg1;	// IMP=0x00100000004fbb26
- (void)configureCard:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000004fb96b
- (id)desiredCards;	// IMP=0x00100000004fb904
- (void)resignTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x00100000004fb8b1
- (void)becomeTopContextInChromeViewController:(id)arg1 withAnimation:(id)arg2;	// IMP=0x00100000004fb7f7
...
- (_Bool)showsMapView;	// IMP=0x00100000004fb7cc
- (id)init;	// IMP=0x00100000004fb738
