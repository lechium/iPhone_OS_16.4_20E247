...
- (void).cxx_destruct;	// IMP=0x00200000008809b6
...
- (id)initWithResultIndex:(unsigned long long)arg1 businessId:(unsigned long long)arg2 localSearchProviderId:(unsigned int)arg3 query:(id)arg4;	// IMP=0x00100000008808b9
