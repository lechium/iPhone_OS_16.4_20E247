...
- (void).cxx_destruct;	// IMP=0x00200000008779de
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000008776e1
- (_Bool)hasCorrectionForRouteStep:(id)arg1 transitListItem:(id)arg2;	// IMP=0x00100000008776ae
- (_Bool)isComplete;	// IMP=0x0010000000877681
- (void)saveCorrection:(id)arg1;	// IMP=0x001000000087753c
- (id)_correctionforComposedRouteStep:(id)arg1 listItem:(id)arg2;	// IMP=0x001000000087732d
- (id)instructionCorrectionQuestionForStep:(id)arg1 listItem:(id)arg2;	// IMP=0x001000000087725b
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 direction:(id)arg3;	// IMP=0x00100000008771d9
