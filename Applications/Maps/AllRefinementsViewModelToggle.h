...
- (void).cxx_destruct;	// IMP=0x002000000092f86c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000092f758
- (id)initWithDisplayName:(id)arg1 isSelected:(_Bool)arg2 data:(id)arg3 refinementKey:(id)arg4;	// IMP=0x001000000092f677
