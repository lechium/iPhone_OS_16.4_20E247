...
- (void).cxx_destruct;	// IMP=0x002000000038b6b9
...
- (void)adjustTextFieldContainerPositionWithKeyboardFrame:(struct CGRect)arg1;	// IMP=0x001000000038b4b0
- (void)keyboardDidChangeFrameNotification:(id)arg1;	// IMP=0x001000000038b23e
- (void)keyboardWillChangeFrame:(id)arg1;	// IMP=0x001000000038b03a
- (void)mapViewDidStartUserInteraction:(id)arg1;	// IMP=0x001000000038afa7
@property(readonly, copy, nonatomic) NSString *editedValue;
- (void)textDidChange:(id)arg1;	// IMP=0x001000000038ae36
- (id)backgroundColor;	// IMP=0x001000000038a41c
- (void)dealloc;	// IMP=0x001000000038a3a7
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x001000000038a33d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000038a2d3
- (void)viewDidLoad;	// IMP=0x0010000000389a12
- (id)initWithCamera:(id)arg1 showCrosshair:(_Bool)arg2 textFieldTitle:(id)arg3 textFieldPlaceholder:(id)arg4 textFieldText:(id)arg5 textFieldEditBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000003898d5
