...
- (void).cxx_destruct;	// IMP=0x0020000000b49a6f
@property(readonly, nonatomic) SharedTripSummary *sharedTripSummary; // @synthesize sharedTripSummary=_sharedTripSummary;
- (id)accessoryModels;	// IMP=0x0010000000b49a49
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b49924
@property(readonly) unsigned long long hash;
- (id)initWithSharedTripSummary:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000b4974d
