...
- (void).cxx_destruct;	// IMP=0x0010000000b937df
...
- (id)auxilaryTaskForClass:(Class)arg1;	// IMP=0x0010000000b935cc
- (void)addTasks:(id)arg1;	// IMP=0x0010000000b93365
@property(readonly, copy, nonatomic) NSArray *tasks;
- (id)initWithPlatformController:(id)arg1;	// IMP=0x0010000000b9323d
