...
- (void).cxx_destruct;	// IMP=0x00200000008b75c6
- (void);	// IMP=0x00100000008b75b2
@property(nonatomic) __weak id <SearchMeCardLabelsOperationDelegate> delegate; // @synthesize delegate=_delegate;
- (id)_meCardLabelResultsForMeCard:(id)arg1;	// IMP=0x00100000008b70bc
- (void)main;	// IMP=0x00100000008b6ece
- (id)initWithSearchQuery:(id)arg1 context:(id)arg2;	// IMP=0x00100000008b6e2c
