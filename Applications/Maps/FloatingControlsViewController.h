...
- (void).cxx_destruct;	// IMP=0x00200000004922d5
...
- (void)didChangeFocusedVenue:(id)arg1;	// IMP=0x00100000004920f6
- (int)currentMapViewTargetForAnalytics;	// IMP=0x0010000000492051
- (int)currentUITargetForAnalytics;	// IMP=0x0010000000491fac
- (void)_updateAlphaAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000491dbf
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000491d74
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000491d5f
- (void)mapView:(id)arg1 didChangeUserTrackingMode:(long long)arg2 animated:(_Bool)arg3 fromTrackingButton:(_Bool)arg4;	// IMP=0x0010000000491d45
- (void)mapView:(id)arg1 didChangeMapType:(unsigned long long)arg2;	// IMP=0x0010000000491d3f
- (void)mapView:(id)arg1 regionDidChangeAnimated:(_Bool)arg2;	// IMP=0x0010000000491d22
- (double)compassDiameter;	// IMP=0x0010000000491cd2
- (double)compassMargin;	// IMP=0x0010000000491cc0
- (void)_addSubview:(id)arg1 withConstraints:(id)arg2;	// IMP=0x0010000000491c15
- (long long)_sanitizedControlsFromControls:(long long)arg1;	// IMP=0x0010000000491c0c
- (void)setSearchSession:(id)arg1;	// IMP=0x0010000000491c06
- (void)refreshControls;	// IMP=0x0010000000491c00
- (void)hideControlsIfNeeded:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000491bcf
- (void)showControlsIfNeeded:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000491bbb
- (_Bool)shouldShow:(long long)arg1 withControlOptions:(long long)arg2;	// IMP=0x0010000000491b93
- (_Bool)shouldHide:(long long)arg1 withControlOptions:(long long)arg2;	// IMP=0x0010000000491b66
- (id)controlsStackViewIfLoaded;	// IMP=0x0010000000491b07
- (void)_updateCompassInsets;	// IMP=0x001000000049175a
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000491719
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000491589
- (void)viewDidLoad;	// IMP=0x001000000049147f
