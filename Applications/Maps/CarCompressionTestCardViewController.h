...
- (void).cxx_destruct;	// IMP=0x002000000061c1c8
...
- (void)_incrementPriority;	// IMP=0x001000000061be53
- (void)_disappearAndReturn;	// IMP=0x001000000061bde0
- (void)_dismiss;	// IMP=0x001000000061bd94
- (void)_decreaseHeight;	// IMP=0x001000000061bd5e
- (void)_increaseHeight;	// IMP=0x001000000061bd28
- (void)viewDidLayoutSubviews;	// IMP=0x001000000061ba98
- (void)_updateLabel;	// IMP=0x001000000061b948
- (id)_buttonWithTitle:(id)arg1;	// IMP=0x001000000061b83e
- (void)viewDidLoad;	// IMP=0x0010000000619f73
- (id)init;	// IMP=0x0010000000619f22
