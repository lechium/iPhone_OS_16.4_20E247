...
+ (id)headerFooterViewClasses;	// IMP=0x0020000000b6bcda
+ (id)cellClasses;	// IMP=0x0010000000b6bb76
- (void).cxx_destruct;	// IMP=0x0020000000b6c1b9
...
- (void)didExpandSection:(id)arg1;	// IMP=0x0010000000b6c028
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x0010000000b6beb7
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x0010000000b6bd46
- (void)tableViewDismissed;	// IMP=0x0010000000b6bab2
- (id)rideOptionStatusAtIndexPath:(id)arg1;	// IMP=0x0010000000b6b885
- (void)_configureRideOptionsSources:(id)arg1;	// IMP=0x0010000000b6b02f
- (void)configureWithRideBookingRideOptionState:(id)arg1;	// IMP=0x0010000000b6af12
- (void)prepareOutlineSections;	// IMP=0x0010000000b6a818
- (void)dealloc;	// IMP=0x0010000000b6a721
- (id)initWithCollectionView:(id)arg1;	// IMP=0x0010000000b6a39c
