...
- (void).cxx_destruct;	// IMP=0x002000000037b519
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x001000000037b407
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2 customSelectedRouteText:(id)arg3;	// IMP=0x001000000037b348
