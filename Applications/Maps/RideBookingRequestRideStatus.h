...
+ (id)statusWithApplication:(id)arg1 rideOption:(id)arg2 startingWaypointCoordinate:(struct CLLocationCoordinate2D)arg3 origin:(id)arg4 destination:(id)arg5 loadingRequestRideStatus:(_Bool)arg6 etaMinutesAtStartWaypoint:(id)arg7;	// IMP=0x004000000079a794
+ (id)statusWithApplication:(id)arg1 error:(unsigned long long)arg2;	// IMP=0x001000000079a728
- (void).cxx_destruct;	// IMP=0x001000000079ab70
...
- (id)description;	// IMP=0x001000000079a9fb
