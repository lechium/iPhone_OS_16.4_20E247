...
+ (long long)itemProviderVisibilityForRepresentationWithTypeIdentifier:(id)arg1;	// IMP=0x00200000000e69ef
+ (id)writableTypeIdentifiersForItemProvider;	// IMP=0x00100000000e68bf
+ (id)dragAndDropItemWithObject:(id)arg1;	// IMP=0x00100000000e5728
- (void).cxx_destruct;	// IMP=0x00200000000e7128
...
- (id)traitsForMapItemResolver:(id)arg1;	// IMP=0x00100000000e7044
- (id)loadDataWithTypeIdentifier:(id)arg1 forItemProviderCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e69f7
@property(readonly, nonatomic) NSItemProvider *itemProvider;
@property(readonly, nonatomic) id <NSItemProviderWriting> itemProviderWriting;
- (void)_resolveMapItem;	// IMP=0x00100000000e6449
- (void)_didResolveMapItem:(id)arg1;	// IMP=0x00100000000e63d1
- (id)initWithPersonalizedItem:(id)arg1;	// IMP=0x00100000000e61af
- (id)initWithRecentContact:(id)arg1;	// IMP=0x00100000000e60f7
- (id)initWithAddress:(id)arg1;	// IMP=0x00100000000e5fe9
- (id)initWithMapItem:(id)arg1;	// IMP=0x00100000000e5f0d
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x00100000000e5d44
- (id)init;	// IMP=0x00100000000e5d19
