...
- (void)ifSearch:(CDUnknownBlockType)arg1 ifRoute:(CDUnknownBlockType)arg2 ifPlaceDisplay:(CDUnknownBlockType)arg3 ifTransitLineItem:(CDUnknownBlockType)arg4;	// IMP=0x002000000069aed3
@property(readonly, nonatomic) NSData *archivedSharedTripData;
@property(readonly, nonatomic) _Bool navigationWasInterrupted;
- (id)routeInformationSource;	// IMP=0x001000000069ae79
