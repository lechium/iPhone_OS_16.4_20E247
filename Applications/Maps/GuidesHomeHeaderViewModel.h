...
- (void).cxx_destruct;	// IMP=0x0010000000b1c866
...
- (void)publisherLogoImageWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000b1c708
- (id)initWithGuideLocation:(id)arg1 featuredGuide:(id)arg2 sectionTitle:(id)arg3;	// IMP=0x0010000000b1c1de
- (void)collectionImageForSize:(struct CGSize)arg1 onCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000b1c8e6
