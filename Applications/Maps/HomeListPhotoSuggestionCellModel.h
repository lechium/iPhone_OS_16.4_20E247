...
- (void).cxx_destruct;	// IMP=0x0020000000ae7638
@property(readonly, nonatomic) MapsSuggestionsEntry *entry; // @synthesize entry=_entry;
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x0010000000ae7619
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ae7546
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) NSString *subtitle;
@property(readonly, nonatomic) NSString *title;
- (id)initWithEntry:(id)arg1;	// IMP=0x0010000000ae7447
