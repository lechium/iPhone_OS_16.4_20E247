...
- (void).cxx_destruct;	// IMP=0x00200000009b32a9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009b3280
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009b2ffc
- (id)initWithMapItem:(id)arg1 disambiguationRadiusMeters:(float)arg2;	// IMP=0x00100000009b2f9c
- (id)initWithMapItem:(id)arg1;	// IMP=0x00100000009b2f46
- (id)initWithGeoMapItem:(id)arg1 disambiguationRadiusMeters:(float)arg2;	// IMP=0x00100000009b2f13
- (id)initWithGeoMapItem:(id)arg1;	// IMP=0x00100000009b2e97
- (id)init;	// IMP=0x00100000009b2e89
