...
- (void).cxx_destruct;	// IMP=0x0020000000a4c324
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000a4c24a
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x0010000000a4c242
- (void)updateFocusIfNeeded;	// IMP=0x0010000000a4c1fb
- (void)setNeedsFocusUpdate;	// IMP=0x0010000000a4c1a5
@property(readonly, nonatomic) id <UIFocusItemContainer> focusItemContainer;
@property(readonly, copy, nonatomic) NSArray *preferredFocusEnvironments;
@property(readonly, nonatomic) __weak id <UIFocusEnvironment> parentFocusEnvironment;
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) _Bool canBecomeFocused;
- (id)initWithRoute:(id)arg1 containingView:(id)arg2 frame:(struct CGRect)arg3 delegate:(id)arg4;	// IMP=0x0010000000a4bf8d
