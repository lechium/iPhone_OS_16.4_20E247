...
- (void).cxx_destruct;	// IMP=0x0020000000b4971c
@property(readonly, nonatomic) MapsSuggestionsEntry *entry; // @synthesize entry=_entry;
- (id)accessoryModels;	// IMP=0x0010000000b496f6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b495d1
@property(readonly) unsigned long long hash;
- (id)initWithMapsSuggestionsEntry:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000b4949d
