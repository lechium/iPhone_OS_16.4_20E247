...
- (void).cxx_destruct;	// IMP=0x0020000000863ce3
@property(nonatomic, getter=isCollapsed) _Bool collapsed; // @synthesize collapsed=_collapsed;
@property(nonatomic, getter=isFooter) _Bool footer; // @synthesize footer=_footer;
@property(readonly, nonatomic) UILabel *textLabel; // @synthesize textLabel=_textLabel;
- (void)_updateForFooter;	// IMP=0x0010000000863c44
- (void)setHidden:(_Bool)arg1;	// IMP=0x0010000000863bf9
- (void)_updateForCollapsed;	// IMP=0x0010000000863b32
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000863711
