...
- (void).cxx_destruct;	// IMP=0x00200000008ae8b0
...
- (id)initWithSearchCategory:(id)arg1 parentMuid:(unsigned long long)arg2 displayMode:(int)arg3;	// IMP=0x00100000008ae812
