...
- (void).cxx_destruct;	// IMP=0x002000000037e482
- (void)wasDismissedByUser;	// IMP=0x001000000037e45c
@property(readonly, nonatomic) unsigned long long bannerType;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x001000000037e262
- (void)updateFromBannerItem;	// IMP=0x001000000037dddc
- (id)initWithTarget:(id)arg1 item:(id)arg2 aperturePresentation:(_Bool)arg3;	// IMP=0x001000000037d7df
