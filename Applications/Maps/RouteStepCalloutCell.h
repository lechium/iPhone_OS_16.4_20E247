...
+ (id)cellWithRoute:(id)arg1 stepIndex:(unsigned long long)arg2 type:(unsigned int)arg3;	// IMP=0x004000000034d994
- (void).cxx_destruct;	// IMP=0x002000000034e160
...
- (void)drawInRect:(struct CGRect)arg1;	// IMP=0x001000000034df3c
- (_Bool)rotate;	// IMP=0x001000000034dec3
- (_Bool)shouldRotateWithCallout:(id)arg1;	// IMP=0x001000000034de60
- (struct CGRect)_frameForType:(unsigned int)arg1;	// IMP=0x001000000034dbb6
...
- (id)initWithRoute:(id)arg1 stepIndex:(unsigned long long)arg2 type:(unsigned int)arg3;	// IMP=0x001000000034d9f1
