...
- (void).cxx_destruct;	// IMP=0x0020000000286c1a
...
- (void)setActivityProviderDelegate:(id)arg1;	// IMP=0x0010000000286baf
...
- (id)initWithPublisher:(id)arg1;	// IMP=0x0010000000286931
- (id)initWithPlaceCollection:(id)arg1 refinedMapItems:(id)arg2;	// IMP=0x00100000002867fc
