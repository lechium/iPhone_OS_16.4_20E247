...
- (void).cxx_destruct;	// IMP=0x002000000030576f
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x0010000000305558
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x00100000003054ef
@property(readonly, nonatomic) CyclePreferences *cyclePreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x0010000000305448
