...
- (void).cxx_destruct;	// IMP=0x002000000040c42e
...
- (void)invalidateCachedShadow;	// IMP=0x001000000040c3b2
- (void)layoutSubviews;	// IMP=0x001000000040ba23
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000040b9e2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000040b978
