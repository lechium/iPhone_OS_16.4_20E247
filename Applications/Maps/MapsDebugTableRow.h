...
+ (void)registerCellsInCollectionView:(id)arg1;	// IMP=0x0020000000ba3e0e
+ (id)reuseIdentifier;	// IMP=0x0010000000ba33c4
- (void).cxx_destruct;	// IMP=0x0020000000ba4586
...
- (void)configureCollectionViewCell:(id)arg1;	// IMP=0x0010000000ba421a
- (id)cellForCollectionView:(id)arg1 forIndexPath:(id)arg2;	// IMP=0x0010000000ba407b
...
- (void)configureCell:(id)arg1;	// IMP=0x0010000000ba3790
- (id)cellForTableView:(id)arg1;	// IMP=0x0010000000ba35c5
- (void)_clearAllControlTargetsForReuse;	// IMP=0x0010000000ba347e
- (void)addControlThatNeedsClearingTargetOnReuse:(id)arg1;	// IMP=0x0010000000ba3424
- (void)invalidate;	// IMP=0x0010000000ba3383
- (void)dealloc;	// IMP=0x0010000000ba3345
- (id)init;	// IMP=0x0010000000ba330d
