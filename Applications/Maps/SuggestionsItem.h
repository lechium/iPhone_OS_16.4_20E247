...
- (void).cxx_destruct;	// IMP=0x002000000016649a
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x00100000001663bf
...
- (id)suggestion;	// IMP=0x0010000000165c75
...
- (id)initWithSuggestion:(id)arg1 order:(unsigned short)arg2 sourceType:(long long)arg3 sourceSubtype:(long long)arg4 hasPriorityOverride:(_Bool)arg5 priorityOverride:(long long)arg6;	// IMP=0x00100000001658a0
