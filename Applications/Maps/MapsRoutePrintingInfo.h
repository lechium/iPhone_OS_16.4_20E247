...
- (void).cxx_destruct;	// IMP=0x00200000005373b3
...
- (id)initWithNumberOfPages:(long long)arg1 routeStepCells:(id)arg2 routeStepCalloutCells:(id)arg3;	// IMP=0x00100000005372b5
