...
- (void).cxx_destruct;	// IMP=0x0020000000377dba
...
- (void)_finishedResolvingItems;	// IMP=0x0010000000377960
- (void)_resolveAppClips;	// IMP=0x0010000000377437
- (void)_resolveThirdPartyLinks:(id)arg1 withGroup:(id)arg2;	// IMP=0x0010000000376e0b
- (void)_resolveMediaLink:(id)arg1 withGroup:(id)arg2;	// IMP=0x00100000003769a1
- (void)_resolveCollectionDetails;	// IMP=0x0010000000376181
- (void)cancel;	// IMP=0x001000000037603b
- (void)resolveCollection;	// IMP=0x0010000000375b11
- (void)_commonInitWithCuratedCollectionIdentifier:(id)arg1;	// IMP=0x0010000000375ac3
- (id)initWithFullyClientizedCuratedCollection:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000003759be
- (id)initWithCuratedCollectionIdentifier:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x001000000037591e
- (id)initWithCuratedCollectionIdentifier:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000375885
