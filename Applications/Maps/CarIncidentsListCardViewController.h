...
- (void).cxx_destruct;	// IMP=0x00200000005dd712
...
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00100000005dd4eb
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00100000005dd427
- (double)tableView:(id)arg1 heightForRowAtIndexPath:(id)arg2;	// IMP=0x00100000005dd419
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00100000005dd3fc
- (id)uniqueName;	// IMP=0x00100000005dd3e2
- (void)_refreshDataSource;	// IMP=0x00100000005dd182
- (void)viewDidLayoutSubviews;	// IMP=0x00100000005dd141
- (void)viewDidLoad;	// IMP=0x00100000005dce0c
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000005dcda0
