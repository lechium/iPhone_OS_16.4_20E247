...
- (void).cxx_destruct;	// IMP=0x0020000000373b60
...
- (id)childSnapshotWithIdentifier:(id)arg1;	// IMP=0x0010000000373abb
- (id)nodeSnapshotAtIdentifierPath:(id)arg1;	// IMP=0x00100000003739d0
- (_Bool)needsReloadFromPreviousItemSnapshot:(id)arg1;	// IMP=0x001000000037392a
@property(readonly, nonatomic) NSString *recursiveDescription;
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000003734c2
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003734a1
- (id)initWithIdentifierPath:(id)arg1 viewModel:(id)arg2 childSnapshots:(id)arg3 expanded:(_Bool)arg4;	// IMP=0x001000000037309b
