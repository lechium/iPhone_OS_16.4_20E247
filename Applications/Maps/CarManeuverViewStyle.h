...
+ (id)styleWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0020000000a1227c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a12889
...
- (_Bool)_isDisplayedInWidget;	// IMP=0x0010000000a122d5
@property(readonly, nonatomic) _Bool displaysShield;
- (id)initWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0010000000a12222
