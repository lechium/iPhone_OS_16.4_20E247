...
- (void).cxx_destruct;	// IMP=0x0020000000b8d851
...
- (void)cancel;	// IMP=0x0010000000b8d6e3
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000b8ce19
@property(readonly, nonatomic) Result *result;
@property(readonly, nonatomic) _Bool inProgress;
- (id)initWithTracePath:(id)arg1;	// IMP=0x0010000000b8c9ee
