...
- (void).cxx_destruct;	// IMP=0x002000000006b606
...
- (void)updateProgress:(unsigned long long)arg1;	// IMP=0x001000000006b485
- (void)checkForFileTransferProgress;	// IMP=0x001000000006b011
- (void)listenForLogTransferProgress;	// IMP=0x001000000006afc6
- (void)layoutSubviews;	// IMP=0x001000000006a83d
- (void)dealloc;	// IMP=0x001000000006a7d2
- (void)notifyDownload:(id)arg1;	// IMP=0x001000000006a6e8
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x001000000006a43b
