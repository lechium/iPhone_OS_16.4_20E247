...
- (void).cxx_destruct;	// IMP=0x002000000003e56b
...
- (Class)pairingControllerClass;	// IMP=0x001000000003e48c
- (void)controllerCancelled:(id)arg1;	// IMP=0x001000000003e458
- (id)init;	// IMP=0x001000000003e348
