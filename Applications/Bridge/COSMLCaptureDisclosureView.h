...
- (void)tappedLearnMore:(id)arg1;	// IMP=0x001000000009fa23
- (void)layoutSubviews;	// IMP=0x001000000009f81e
- (void)userToggledSwitch:(id)arg1;	// IMP=0x001000000009f7e9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000009f337
