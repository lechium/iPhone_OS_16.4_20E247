...
- (void).cxx_destruct;	// IMP=0x002000000008ad07
...
- (void)updateWithSummary:(id)arg1;	// IMP=0x001000000008aa88
- (void)updateWithConfidences:(id)arg1;	// IMP=0x001000000008a51f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000089b78
