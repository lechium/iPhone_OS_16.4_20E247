...
- (void).cxx_destruct;	// IMP=0x00200000000641dc
...
- (id)_gzipCompressData:(id)arg1;	// IMP=0x0010000000064002
@property(readonly, nonatomic) NSData *gzipContent;
@property(readonly, nonatomic) NSString *mimeType;
- (id)initWithContent:(id)arg1 filename:(id)arg2 bucket:(id)arg3 gzip:(_Bool)arg4;	// IMP=0x0010000000063e8b
