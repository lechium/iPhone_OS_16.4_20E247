...
- (id)description;	// IMP=0x00100000000a094c
- (void)divideConfidencesBy:(long long)arg1;	// IMP=0x00100000000a0900
- (void)addConfidences:(id)arg1;	// IMP=0x00100000000a0805
- (id)initWithObservationTime:(double)arg1;	// IMP=0x00100000000a07c2
- (id)initWithObservationTime:(double)arg1 none:(double)arg2 invalid:(double)arg3 lr:(double)arg4 ll:(double)arg5 rr:(double)arg6 rl:(double)arg7 palm:(double)arg8 dock:(double)arg9;	// IMP=0x00100000000a070c
