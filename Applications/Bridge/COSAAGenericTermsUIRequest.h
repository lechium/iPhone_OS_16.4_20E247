...
+ (id)deviceModelHeaderName;	// IMP=0x00400000000f4e80
+ (id)pairedClientInfoHeaderName;	// IMP=0x00100000000f4e73
+ (id)clientInfoHeaderForDevice:(id)arg1;	// IMP=0x00100000000f4b66
- (void).cxx_destruct;	// IMP=0x00200000000f5297
...
- (id)initWithGizmoDevice:(id)arg1 showWarranty:(_Bool)arg2;	// IMP=0x00100000000f4e8d
