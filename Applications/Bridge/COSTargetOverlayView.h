...
- (void).cxx_destruct;	// IMP=0x00200000000fc155
...
- (void)_checkForProximateAgaveDevice;	// IMP=0x00100000000fbbc7
- (void)_configureMetrics;	// IMP=0x00100000000fba3d
- (void)_updateSubviews;	// IMP=0x00100000000fb8f8
- (void)_setupSubviews;	// IMP=0x00100000000fb56e
- (void)_updateProgressViewFrame;	// IMP=0x00100000000fb457
- (void)setScanningProgress:(double)arg1 key:(id)arg2;	// IMP=0x00100000000fb3c1
- (void)layoutSubviews;	// IMP=0x00100000000fb380
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000fb2ca
