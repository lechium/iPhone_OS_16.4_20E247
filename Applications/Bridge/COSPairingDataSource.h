...
+ (_Bool)useConnectedDevice;	// IMP=0x0040000000010d23
- (void).cxx_destruct;	// IMP=0x0020000000012710
...
- (void)loadSpecifiers;	// IMP=0x0010000000011354
- (id)specifiersForSpecifier:(id)arg1 observer:(id)arg2;	// IMP=0x0010000000011282
- (void)confirmUnpairingForSpecifier:(id)arg1;	// IMP=0x0010000000011224
- (id)deviceUserAppleID:(id)arg1;	// IMP=0x00100000000111d4
- (void)confirmMigration:(id)arg1;	// IMP=0x0010000000011176
- (void)confirmUnpairingMissingForSpecifier:(id)arg1;	// IMP=0x0010000000011118
- (void)tinkeriForgot;	// IMP=0x00100000000110e3
- (void)jumpToFindMyApp;	// IMP=0x00100000000110ae
