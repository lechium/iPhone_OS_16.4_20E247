...
+ (id)storeAccountWithDSID:(id)arg1 altDSID:(id)arg2 username:(id)arg3;	// IMP=0x00400000001301d7
+ (id)satelliteStoreAccountForFamilyMember:(id)arg1;	// IMP=0x00100000001300b5
- (void).cxx_destruct;	// IMP=0x0020000000130a01
...
- (void)authenticateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000001303ef
- (id)initWithContext:(id)arg1;	// IMP=0x001000000012ffea
