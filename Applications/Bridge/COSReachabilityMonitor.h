...
+ (id)sharedMonitor;	// IMP=0x00400000000f5352
...
- (void)stopMonitoring;	// IMP=0x00100000000f54b7
- (void)startMonitoring;	// IMP=0x00100000000f54b1
- (void)dealloc;	// IMP=0x00100000000f544a
- (id)init;	// IMP=0x00100000000f53a7
