...
- (void).cxx_destruct;	// IMP=0x0020000000098bec
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x0010000000097ca5
- (id)initWithContext:(id)arg1 privateDataUpdateCoordinator:(id)arg2;	// IMP=0x0010000000097bc7
