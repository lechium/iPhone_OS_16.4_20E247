...
- (void).cxx_destruct;	// IMP=0x00200000000dbfb2
...
- (id)cachedArticleIDs;	// IMP=0x00100000000dbdf9
- (id)_editorialEntryIDForIdentifier:(id)arg1;	// IMP=0x00100000000dbdca
- (void)addOrderedEditorialItemIDs:(id)arg1;	// IMP=0x00100000000dbd17
- (void)removeItemWithIdentifier:(id)arg1;	// IMP=0x00100000000dbc3a
- (void)addEditorialItem:(id)arg1;	// IMP=0x00100000000dbb1f
- (void)loadLocalCachesFromStore;	// IMP=0x00100000000db684
- (id)initWithLocalStore:(id)arg1;	// IMP=0x00100000000db619
