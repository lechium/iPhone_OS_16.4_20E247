...
- (void).cxx_destruct;	// IMP=0x00200000000396c3
...
- (_Bool)accessibilityIgnoresInvertColors;	// IMP=0x00100000000395b9
- (unsigned long long)accessibilityTraits;	// IMP=0x001000000003954f
- (id)_accessibilityElementHelp;	// IMP=0x00100000000394c3
- (id)accessibilityHint;	// IMP=0x0010000000039437
- (id)accessibilityLabel;	// IMP=0x00100000000392e5
- (id)accessibilityElements;	// IMP=0x00100000000392dd
- (_Bool)isAccessibilityElement;	// IMP=0x00100000000392d5
- (void);	// IMP=0x001000000003927f
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x001000000003924f
- (void)layoutSubviews;	// IMP=0x0010000000038b85
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000388d9
