...
+ (void)signalsFromCoreDuetWithQualityOfService:(long long)arg1 safariBlockoutDuration:(double)arg2 resultsBlock:(CDUnknownBlockType)arg3;	// IMP=0x004000000002adb9
+ (id)coreDuetKnowledgeStore;	// IMP=0x001000000002ad54
+ (void)externalSignalJSONData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002a640
- (void).cxx_destruct;	// IMP=0x002000000002f97f
...
- (id)auditCandidates:(id)arg1 autoSubscriptionAddedDateByTagId:(id)arg2 multiplierProvider:(CDUnknownBlockType)arg3;	// IMP=0x001000000002f17f
- (_Bool)shouldRejectTagID:(id)arg1 withAggregate:(id)arg2 baseline:(id)arg3 currentDate:(id)arg4 addedDate:(id)arg5 maxIdleTime:(double)arg6 minEvents:(double)arg7 minRate:(double)arg8 baseRate:(double)arg9 multiplier:(double)arg10;	// IMP=0x001000000002ef85
- (_Bool)shouldAcceptAggregate:(id)arg1 withCtr:(double)arg2 minEvents:(double)arg3 minClicks:(double)arg4 minRate:(double)arg5 baseRate:(double)arg6 multiplier:(double)arg7;	// IMP=0x001000000002ee92
- (double)ctrForTagID:(id)arg1 withAggregate:(id)arg2 baselineAggregate:(id)arg3;	// IMP=0x001000000002ed2f
- (double)metricMultiplierForTagID:(id)arg1 withPriorFactorExponent:(double)arg2 tagFavorabilityExponent:(double)arg3;	// IMP=0x001000000002eb54
- (void)_considerExternalSignals:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e136
- (void)_considerInternalSignals:(CDUnknownBlockType)arg1;	// IMP=0x001000000002dbeb
- (id)processSafariSignals:(id)arg1;	// IMP=0x001000000002d7fa
- (id)processExternalAppUsageSignals:(id)arg1;	// IMP=0x001000000002d48b
- (void)processAppSignals:(id)arg1 safariSignals:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000002c009
- (void)considerCoreDuet:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ba25
- (id)maybeConsiderPortrait;	// IMP=0x001000000002a2fe
- (void)considerLocation:(CDUnknownBlockType)arg1;	// IMP=0x0010000000029d6a
- (void)_considerInternalAppUsage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000297d8
- (void)_findValidAutoFavoritesWithCandidates:(id)arg1 channelsAllowedProvider:(CDUnknownBlockType)arg2 topicsAllowedProvider:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000028ed6
- (void)_processSignals:(CDUnknownBlockType)arg1;	// IMP=0x001000000002604e
- (void)operationWillFinishWithError:(id)arg1;	// IMP=0x0010000000025f56
- (void)performOperation;	// IMP=0x0010000000025ef2
- (void)prepareOperation;	// IMP=0x0010000000025e58
- (_Bool)validateOperation;	// IMP=0x0010000000025c39
