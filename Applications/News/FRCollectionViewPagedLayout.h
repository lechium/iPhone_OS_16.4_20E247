...
- (id)adjustLayoutAttributeForPageOffset:(id)arg1;	// IMP=0x00100000000515e5
- (struct CGSize)collectionViewContentSize;	// IMP=0x00100000000513a0
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0010000000051308
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0010000000051101
