...
- (void).cxx_destruct;	// IMP=0x00200000000dd3d9
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x00100000000dc57d
- (id)initWithFeldsparContext:(id)arg1 dataProviderFactory:(id)arg2;	// IMP=0x00100000000dc4e4
