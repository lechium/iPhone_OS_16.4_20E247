...
- (void).cxx_destruct;	// IMP=0x00200000000656e7
...
- (id)ts_fetchArticlesWithURL:(id)arg1;	// IMP=0x00100000000653d9
- (id)initWithFeldsparContext:(id)arg1 assetManager:(id)arg2;	// IMP=0x00100000000652f2
