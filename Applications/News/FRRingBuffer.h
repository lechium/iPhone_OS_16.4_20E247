...
- (void).cxx_destruct;	// IMP=0x00200000000d206b
...
- (id)description;	// IMP=0x00100000000d1ecf
@property(readonly, nonatomic) NSDictionary *dictionary;
- (void)insertValue:(double)arg1;	// IMP=0x00100000000d1986
- (id)initWithCapacity:(unsigned long long)arg1 dictionary:(id)arg2;	// IMP=0x00100000000d1598
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x00100000000d1521
