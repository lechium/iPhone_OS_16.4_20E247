...
- (void).cxx_destruct;	// IMP=0x00200000000960bb
...
- (void)_setHasUserBeenPresubscribed:(_Bool)arg1;	// IMP=0x001000000009602f
- (_Bool)_hasUserBeenPresubscribed;	// IMP=0x0010000000095fdd
- (void)_subscribeToFeedIDs:(id)arg1 preSubscribedNotificationsChannelIDs:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000095a36
- (void)subscriptionControllerDidResetToEmpty:(id)arg1;	// IMP=0x00100000000959cc
- (void)presubscribeToChannelsIfNeededWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000095451
- (id)initWithAppConfigurationManager:(id)arg1 tagController:(id)arg2 subscriptionController:(id)arg3 purchaseController:(id)arg4 notificationManager:(id)arg5;	// IMP=0x001000000009533b
- (id)init;	// IMP=0x00100000000951f6
