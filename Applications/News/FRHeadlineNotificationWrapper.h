...
- (void).cxx_destruct;	// IMP=0x002000000008abf1
...
- (id)headlineNotification_dictionaryRepresentation;	// IMP=0x001000000008aa04
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000008a86c
- (id)initWithHeadline:(id)arg1;	// IMP=0x001000000008a3a3
