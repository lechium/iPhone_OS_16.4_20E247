...
- (id)_fetchedResults:(id)arg1;	// IMP=0x00100000000c8d09
- (id)articles;	// IMP=0x00100000000c8c5f
- (id)filteredArticles;	// IMP=0x00100000000c8bad
@property(readonly, nonatomic) NSArray *filteredTopics;
@property(readonly, nonatomic) NSArray *filteredChannels;
- (id)articleResultAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000c88b0
- (id)channelResultAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000c8810
- (id)topicResultAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000c8770
- (id)topHitArticle;	// IMP=0x00100000000c86a4
- (id)topHitChannelOrTopic;	// IMP=0x00100000000c7eb2
- (id)topHitChannel;	// IMP=0x00100000000c7e62
- (id)topHitTopic;	// IMP=0x00100000000c7e12
- (unsigned long long)numberOfTopHitResults;	// IMP=0x00100000000c7dab
- (unsigned long long)numberOfArticleResults;	// IMP=0x00100000000c7d67
- (unsigned long long)numberOfChannelResults;	// IMP=0x00100000000c7d23
- (unsigned long long)numberOfTopicResults;	// IMP=0x00100000000c7cdf
- (_Bool)hasArticleResults;	// IMP=0x00100000000c7cc6
- (_Bool)hasChannelResults;	// IMP=0x00100000000c7cad
- (_Bool)hasTopicResults;	// IMP=0x00100000000c7c94
- (_Bool)hasTopHit;	// IMP=0x00100000000c7c28
- (_Bool)hasSearchResults;	// IMP=0x00100000000c7bdb
- (id)initWithTopicResults:(id)arg1 channelResults:(id)arg2 articleResults:(id)arg3 searchString:(id)arg4 searchMethod:(long long)arg5 startDate:(id)arg6 endDate:(id)arg7;	// IMP=0x00100000000c7aaa
