...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000005305c
- (void).cxx_destruct;	// IMP=0x002000000005315e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000052e0c
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000052a93
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000052067
