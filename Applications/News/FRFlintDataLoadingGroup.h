...
- (void).cxx_destruct;	// IMP=0x0020000000090fba
...
- (id)initWithLoadJSONOnce:(id)arg1 loadFontsOnce:(id)arg2 loadAssetURLsOnce:(id)arg3 loadAssetsOnce:(id)arg4 loadLinkedContentOnce:(id)arg5;	// IMP=0x0010000000090e86
