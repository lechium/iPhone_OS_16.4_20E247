...
- (void).cxx_destruct;	// IMP=0x00200000000e3925
...
- (void)downloadEditorialItemWithIDs:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e3245
- (id)initWithTagController:(id)arg1 editorialItemEntryManager:(id)arg2;	// IMP=0x00100000000e315e
