...
+ (double)cardMarginForSize:(struct CGSize)arg1;	// IMP=0x00200000000ccb07
...
- (long long)calculatePotentialMaxVisibleRowThatWouldBeFullyPopulated;	// IMP=0x00100000000cd076
- (struct CGPoint)centerForRow:(long long)arg1 column:(long long)arg2;	// IMP=0x00100000000ccf46
- (struct CGRect)boundsForIndex:(long long)arg1;	// IMP=0x00100000000ccef3
- (struct CGPoint)centerForIndex:(long long)arg1;	// IMP=0x00100000000ccebf
- (CDStruct_912cb5d2)positionOfIndex:(long long)arg1;	// IMP=0x00100000000cce97
@property(readonly, nonatomic) double contentHeight;
- (double)adjustedWidthOfViewPort;	// IMP=0x00100000000ccd89
- (double)contentSideMargin;	// IMP=0x00100000000cccff
@property(readonly, nonatomic) long long rowCount;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ccba4
