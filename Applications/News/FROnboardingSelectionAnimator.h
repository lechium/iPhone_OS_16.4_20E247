...
- (void).cxx_destruct;	// IMP=0x0020000000081188
...
- (void)updateTickWithAnimationEngine:(id)arg1 sessionTimeAtLastTick:(double)arg2 currentSessionTime:(double)arg3;	// IMP=0x0010000000080ff4
- (void)updateCellWithCurrentStateOfItem:(id)arg1;	// IMP=0x0010000000080ce2
- (void)addedToAnimationEngine:(id)arg1;	// IMP=0x0010000000080cc7
- (void)restartDimple;	// IMP=0x0010000000080cb0
- (id)init;	// IMP=0x0010000000080644
