...
+ (id)workQueue;	// IMP=0x00200000000a1874
- (void).cxx_destruct;	// IMP=0x00200000000a371f
...
- (void)readingHistory:(id)arg1 didAddHeadline:(id)arg2 fromGroupType:(long long)arg3 swipedToArticle:(_Bool)arg4 withOnScreenChecker:(CDUnknownBlockType)arg5;	// IMP=0x00100000000a3149
- (void)_processEvent:(id)arg1;	// IMP=0x00100000000a2a9e
- (void)eventCenter:(id)arg1 asyncEventDidFire:(id)arg2;	// IMP=0x00100000000a2a89
- (void)eventCenter:(id)arg1 eventDidFire:(id)arg2;	// IMP=0x00100000000a2a74
- (id)processEventsForFeatures:(id)arg1;	// IMP=0x00100000000a25e2
- (id)headlineFeaturesFromArticleHostViewExposureEvents;	// IMP=0x00100000000a20e3
@property(readonly, nonatomic) CDUnknownBlockType issueLookup;
@property(readonly, nonatomic) CDUnknownBlockType headlineLookup;
- (void)beginMonitoring;	// IMP=0x00100000000a1b05
- (id)init;	// IMP=0x00100000000a19c0
- (id)initWithPersonalizationDataSource:(id)arg1 readingHistory:(id)arg2 contentContext:(id)arg3;	// IMP=0x00100000000a188d
