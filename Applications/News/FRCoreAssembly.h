...
- (void).cxx_destruct;	// IMP=0x00200000000439d9
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x0010000000041d23
- (id)initWithCloudContext:(id)arg1 configurationManager:(id)arg2 appActivityMonitor:(id)arg3;	// IMP=0x0010000000041c6c
