...
- (void).cxx_destruct;	// IMP=0x002000000009a5e8
...
- (void)updateTickWithAnimationEngine:(id)arg1 sessionTimeAtLastTick:(double)arg2 currentSessionTime:(double)arg3;	// IMP=0x001000000009a006
- (void)updateCellWithCurrentStateOfItem:(id)arg1;	// IMP=0x0010000000099edd
- (void)addedToAnimationEngine:(id)arg1;	// IMP=0x0010000000099e4e
- (id)init;	// IMP=0x0010000000099d7a
