...
- (void).cxx_destruct;	// IMP=0x002000000003b797
...
- (void)addFeedSubscriptionModificationEvent:(id)arg1;	// IMP=0x001000000003b6ba
- (void)endSession;	// IMP=0x001000000003b254
- (void)addToInitialSubscribedTagIDs:(id)arg1;	// IMP=0x001000000003afee
- (id)init;	// IMP=0x001000000003af79
