...
- (void).cxx_destruct;	// IMP=0x00200000000e21a7
...
- (void)_updateValuesWithPercentComplete:(double)arg1;	// IMP=0x00100000000e1fef
- (void)updateTickWithAnimationEngine:(id)arg1 sessionTimeAtLastTick:(double)arg2 currentSessionTime:(double)arg3;	// IMP=0x00100000000e1f45
- (void)updateCellWithCurrentStateOfItem:(id)arg1;	// IMP=0x00100000000e1e15
- (void)addedToAnimationEngine:(id)arg1;	// IMP=0x00100000000e1d9e
- (id)init;	// IMP=0x00100000000e1ccf
