...
- (void)updateForCurrentTraitCollection;	// IMP=0x00100000000088d0
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0010000000008750
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000000086f0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2 bag:(id)arg3 sceneAwareVariant:(_Bool)arg4;	// IMP=0x0010000000008050
