...
- (void).cxx_destruct;	// IMP=0x002000000000f49a
...
- (void)getDefaultMetricsControllerWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f384
- (id)initWithConfigurationDictionary:(id)arg1;	// IMP=0x001000000000f2ca
