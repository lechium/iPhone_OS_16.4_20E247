...
- (void).cxx_destruct;	// IMP=0x002000000000fb45
@property(nonatomic) __weak id <ServiceAccountPageEmbeddedParent> embeddedParent; // @synthesize embeddedParent=_embeddedParent;
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000fa80
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x001000000000fa0b
