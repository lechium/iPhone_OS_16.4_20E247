...
- (void).cxx_destruct;	// IMP=0x002000000000f6b4
@property(nonatomic) __weak id <ServiceAccountPageEmbeddedParent> embeddedParent; // @synthesize embeddedParent=_embeddedParent;
- (void)storePage:(id)arg1 finishedWithSuccess:(_Bool)arg2;	// IMP=0x001000000000f66a
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000f5d2
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x001000000000f55d
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000000f4ad
