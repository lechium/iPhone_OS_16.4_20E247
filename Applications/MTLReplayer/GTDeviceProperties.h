...
+ (id)hardwareUUID;	// IMP=0x00200000000636ca
+ (id)bootSessionUUID;	// IMP=0x0010000000063624
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000006361c
- (void).cxx_destruct;	// IMP=0x002000000006345e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000630e2
- (id)initForEmbeddedSystem;	// IMP=0x0010000000062cd6
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006298d
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000062591
- (id)init;	// IMP=0x0010000000062527
