...
- (void).cxx_destruct;	// IMP=0x0020000000012154
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000011e89
- (_Bool)canBecomeFocused;	// IMP=0x0010000000011e81
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1;	// IMP=0x0010000000011cd0
- (id)initWithWallpaper:(id)arg1 wallpaperPreferences:(id)arg2;	// IMP=0x0010000000010bab
