...
- (void).cxx_destruct;	// IMP=0x00200000000094c1
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000000093be
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000009152
- (_Bool)canBecomeFocused;	// IMP=0x001000000000914a
- (void)_tappyTap;	// IMP=0x00100000000090ce
- (id)initWithModel:(id)arg1;	// IMP=0x0010000000008589
