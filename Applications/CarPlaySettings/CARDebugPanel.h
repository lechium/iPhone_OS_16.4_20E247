...
- (void)viewDidLoad;	// IMP=0x001000000000cd1c
- (id)cellSpecifiers;	// IMP=0x001000000000cc35
- (id)cellSpecifier;	// IMP=0x001000000000cade
- (id)initWithPanelController:(id)arg1;	// IMP=0x001000000000c96e
