...
+ (id)allModes;	// IMP=0x004000000001b295
+ (id)modeWithFullTitle:(id)arg1 footer:(id)arg2 muteType:(unsigned long long)arg3 announceType:(long long)arg4;	// IMP=0x001000000001b15d
- (void).cxx_destruct;	// IMP=0x002000000001b4e6
...
- (id)initWithFullTitle:(id)arg1 footer:(id)arg2 muteType:(unsigned long long)arg3 announceType:(long long)arg4;	// IMP=0x001000000001b1e4
