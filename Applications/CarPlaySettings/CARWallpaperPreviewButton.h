...
- (void).cxx_destruct;	// IMP=0x0020000000017a09
...
- (void)_updateMaterialForInterfaceStyle:(long long)arg1;	// IMP=0x0010000000017796
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000017718
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000000176a0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000017622
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000016738
