...
+ (id)sharedInstance;	// IMP=0x0020000000034dfb
+ (_Bool)shouldSetupAttentionAwareIdleTimer;	// IMP=0x0010000000034c84
- (void).cxx_destruct;	// IMP=0x00200000000354ad
...
- (void)_attentionLost;	// IMP=0x0010000000035337
- (void)pause;	// IMP=0x0010000000035243
- (void)start;	// IMP=0x001000000003514f
- (id)init;	// IMP=0x0010000000034e50
