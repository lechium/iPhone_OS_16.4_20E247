...
+ (id)sharedController;	// IMP=0x0020000000001def
- (void).cxx_destruct;	// IMP=0x0020000000002709
@property(retain, nonatomic) LUIUIUpdateSupport *uiUpdateSupport; // @synthesize uiUpdateSupport=_uiUpdateSupport;
- (void)loginWithUsername:(id)arg1 password:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000001f25
- (id)init;	// IMP=0x0010000000001e44
