...
- (void).cxx_destruct;	// IMP=0x002000000000bbb8
...
- (id)compile;	// IMP=0x001000000000b91d
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000b530
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x001000000000b405
