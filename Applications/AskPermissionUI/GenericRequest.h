...
- (void).cxx_destruct;	// IMP=0x0020000000009ea3
...
- (id)compile;	// IMP=0x0010000000009c08
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000981c
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x00100000000096f1
