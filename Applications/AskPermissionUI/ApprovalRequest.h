...
+ (id)createUniqueIDFromRequestID:(id)arg1 andCreatedDate:(id)arg2;	// IMP=0x0020000000008b48
- (void).cxx_destruct;	// IMP=0x002000000000959a
...
- (id)compile;	// IMP=0x0010000000008cc5
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x0010000000006e72
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000006df1
- (id)initWithRequestStorageItem:(id)arg1;	// IMP=0x0010000000006afb
- (id)initWithApproverStorageItem:(id)arg1;	// IMP=0x0010000000006877
- (id)initWithApproverDSID:(id)arg1 createdDate:(id)arg2 modifiedDate:(id)arg3 requestIdentifier:(id)arg4 uniqueIdentifier:(id)arg5 canSendViaMessages:(_Bool)arg6 itemBundleID:(id)arg7 itemDescription:(id)arg8 itemIdentifier:(id)arg9 itemTitle:(id)arg10 localizations:(id)arg11 offerName:(id)arg12 mocked:(_Bool)arg13 previewURL:(id)arg14 productType:(id)arg15 productTypeName:(id)arg16 productURL:(id)arg17 requesterName:(id)arg18 requesterDSID:(id)arg19 requestInfo:(id)arg20 status:(long long)arg21;	// IMP=0x001000000000654c
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000005129
