...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001c4b
+ (id)contextWithData:(id)arg1;	// IMP=0x0010000000002198
- (void).cxx_destruct;	// IMP=0x001000000000215a
...
- (id)debugDescription;	// IMP=0x0010000000001fe9
- (id)description;	// IMP=0x0010000000001f20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000001e8b
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000001d49
- (id)initWithEventType:(id)arg1;	// IMP=0x0010000000001c53
- (id)dataRepresentation;	// IMP=0x00100000000022cd
