...
- (void).cxx_destruct;	// IMP=0x002000000009f440
...
- (void)setShowNoContentString:(_Bool)arg1;	// IMP=0x001000000009eec8
- (id)initWithFrame:(struct CGRect)arg1 style:(long long)arg2;	// IMP=0x001000000009ee2e
