...
@class CLBeaconIdentityConstraint, CLBeaconRegion, CLHeading, CLLocation, CLLocationManager, CLRegion, MISSING_TYPE, NSArray, NSError;

@protocol CLLocationManagerDelegate <NSObject>

@optional
- (MISSING_TYPE *)locationManager:didVisit: /* Error: Ran out of types for this method. */;
