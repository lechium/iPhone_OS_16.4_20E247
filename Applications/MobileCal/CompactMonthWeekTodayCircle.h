...
+ (double)roundedRectDayNumberBaselineOffsetWithOverlay:(_Bool)arg1 fontSize:(double)arg2 overlayFontSize:(double)arg3;	// IMP=0x00400000000c104b
+ (id)dayOverlayFontForSize:(double)arg1;	// IMP=0x00100000000c1032
+ (id)dayNumberFontForSize:(double)arg1;	// IMP=0x00100000000c1019
+ (double)topOffset;	// IMP=0x00100000000c0653
+ (struct CGSize)roundedRectSizeForNumberString:(id)arg1 overlayString:(id)arg2 fontSize:(double)arg3 overlayFontSize:(double)arg4;	// IMP=0x00100000000c039c
+ (double)roundedRectHeightWithOverlay:(_Bool)arg1 fontSize:(double)arg2 overlayFontSize:(double)arg3;	// IMP=0x00100000000c036c
+ (double)circleDiameterWithOverlayLarge;	// IMP=0x00100000000c035e
+ (double)circleDiameterWithOverlay;	// IMP=0x00100000000c0350
+ (double)circleDiameterCompressed;	// IMP=0x00100000000c0342
+ (double)circleDiameter;	// IMP=0x00100000000c0334
- (void).cxx_destruct;	// IMP=0x00200000000c1853
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000000c161a
- (id)backgroundColor;	// IMP=0x00100000000c1601
- (void)layoutSubviews;	// IMP=0x00100000000c1312
- (id)_dayNumberFontForSize:(double)arg1;	// IMP=0x00100000000c0f35
- (void)_updateTextColor;	// IMP=0x00100000000c0dea
- (void)updateOverlay;	// IMP=0x00100000000c0b57
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00100000000c0661
@property(readonly, nonatomic) struct CGRect dayNumberFrame;
- (id)overlayString;	// IMP=0x00100000000c05f8
- (id)dayNumberString;	// IMP=0x00100000000c05e3
- (id)initWithCalendarDate:(id)arg1;	// IMP=0x00100000000c00a6
