...
- (void).cxx_destruct;	// IMP=0x002000000009390a
...
- (void)animateTransition:(id)arg1;	// IMP=0x0010000000092d4b
- (double)transitionDuration:(id)arg1;	// IMP=0x0010000000092cfb
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x0010000000092c16
