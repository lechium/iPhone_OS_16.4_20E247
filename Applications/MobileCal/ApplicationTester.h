...
+ (_Bool)testingSessionStarted;	// IMP=0x00200000000a9647
- (void).cxx_destruct;	// IMP=0x00200000000a99d8
@property(retain, nonatomic) CalendarModel *model; // @synthesize model=_model;
- (Class)_testClassForTestName:(id)arg1;	// IMP=0x00100000000a987e
@property(readonly, nonatomic) NSString *extendedLaunchTestName;
- (_Bool)application:(id)arg1 runTest:(id)arg2 options:(id)arg3;	// IMP=0x00100000000a9653
- (id)initWithModel:(id)arg1;	// IMP=0x00100000000a95dc
