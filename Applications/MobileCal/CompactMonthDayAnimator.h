...
+ (Class)monthDayTransitionViewClass;	// IMP=0x002000000014b3db
- (void).cxx_destruct;	// IMP=0x002000000014be75
...
- (void)animateTransition:(id)arg1;	// IMP=0x001000000014b534
- (double)transitionDuration:(id)arg1;	// IMP=0x001000000014b4e4
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x001000000014b3ec
