...
- (void).cxx_destruct;	// IMP=0x002000000004082f
@property(nonatomic) _Bool hasEverCompletedFetch; // @synthesize hasEverCompletedFetch=_hasEverCompletedFetch;
- (void)_timeZoneChanged:(id)arg1;	// IMP=0x0010000000040661
- (id)_calendarOccurrencesCollectionFromPredicate:(id)arg1;	// IMP=0x0010000000040394
- (void)_fetchUpcomingOccurrences:(id)arg1;	// IMP=0x001000000003fc6b
- (void)reloadEvents:(id)arg1;	// IMP=0x001000000003faf1
...
- (id)_selectedCalendars;	// IMP=0x001000000003f741
- (id)collectionForDayType:(long long)arg1;	// IMP=0x001000000003f70e
- (id)initWithEventStore:(id)arg1;	// IMP=0x001000000003f62e
