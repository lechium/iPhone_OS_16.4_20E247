...
+ (id)testWithSplitViewController:(id)arg1;	// IMP=0x002000000000963a
- (void).cxx_destruct;	// IMP=0x0020000000009dce
...
- (void)performScrollTestWithScrollView:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000000999a
- (void)showContactListWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000097a7
- (void)prepareForNextTest;	// IMP=0x00100000000097a1
- (void)willStartTest;	// IMP=0x0010000000009724
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000970f
