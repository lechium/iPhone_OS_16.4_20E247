...
- (void).cxx_destruct;	// IMP=0x0020000000010ebf
...
- (void)startSearchQueryWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000010d00
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x0010000000010920
