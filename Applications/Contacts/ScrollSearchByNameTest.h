...
- (void).cxx_destruct;	// IMP=0x002000000000ff0b
...
- (void)startSearchQueryWithOptions:(id)arg1;	// IMP=0x001000000000fb81
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000f9f0
