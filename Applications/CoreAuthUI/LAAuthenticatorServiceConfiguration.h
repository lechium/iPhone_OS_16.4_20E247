...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000011143
- (void).cxx_destruct;	// IMP=0x0020000000012c45
...
- (id)description;	// IMP=0x001000000001290b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000012308
- (id)validateConfiguration;	// IMP=0x0010000000011f67
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001176f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001114b
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2 options:(id)arg3;	// IMP=0x00100000000110a0
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2;	// IMP=0x0010000000010d11
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000010cfa
