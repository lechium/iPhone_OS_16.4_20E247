...
+ (id)backOffStateWithTitle:(id)arg1 subtitle:(id)arg2;	// IMP=0x004000000002127e
+ (id)activeStateWithTitle:(id)arg1 subtitle:(id)arg2 accessoryView:(id)arg3;	// IMP=0x00100000000211df
- (void).cxx_destruct;	// IMP=0x0020000000021642
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000213f9
- (id)withStyle:(id)arg1;	// IMP=0x0010000000021308
- (id)initWithRawValue:(long long)arg1 title:(id)arg2 subtitle:(id)arg3 accessoryView:(id)arg4 style:(id)arg5;	// IMP=0x00100000000210ca
