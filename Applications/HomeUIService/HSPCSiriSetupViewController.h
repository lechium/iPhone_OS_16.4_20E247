...
- (void).cxx_destruct;	// IMP=0x002000000002f751
...
- (_Bool)_siriEnabledOnCurrentDevice;	// IMP=0x001000000002f6fb
- (id)_disableVoiceRecognition;	// IMP=0x001000000002f419
- (void)_launchSiriPrivacySheet;	// IMP=0x001000000002f36d
- (id)commitConfiguration;	// IMP=0x001000000002f34d
- (void)_handleFooterLabelTouchForOpenURL:(id)arg1;	// IMP=0x001000000002f1e7
- (void)viewDidLoad;	// IMP=0x001000000002eeea
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000002ec97
