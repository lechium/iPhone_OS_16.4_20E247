...
- (void).cxx_destruct;	// IMP=0x002000000005b5de
...
- (void)updateSetupPayload:(id)arg1;	// IMP=0x001000000005b4bb
@property(readonly, nonatomic) NSString *pairingStatusDescription;
@property(readonly, nonatomic) NSString *pairingStatusTitle;
- (void)pairingController:(id)arg1 didTransitionToPhase:(unsigned long long)arg2 statusTitle:(id)arg3 statusDescription:(id)arg4;	// IMP=0x001000000005b162
- (id)cancelPairingWithError:(id)arg1;	// IMP=0x001000000005aebb
- (id)cancelPairing;	// IMP=0x001000000005adb1
- (id)startPairingWithHome:(id)arg1;	// IMP=0x001000000005aaf1
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2 accessoryAlreadyStaged:(_Bool)arg3;	// IMP=0x001000000005a6f8
- (id)initWithPairingContext:(id)arg1 accessoryAlreadyStaged:(_Bool)arg2;	// IMP=0x001000000005a6de
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2;	// IMP=0x001000000005a6c9
- (void)dealloc;	// IMP=0x001000000005a65b
