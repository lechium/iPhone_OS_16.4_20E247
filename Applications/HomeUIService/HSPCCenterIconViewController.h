...
- (void).cxx_destruct;	// IMP=0x00200000000025a0
...
- (id)commitConfiguration;	// IMP=0x001000000000250d
@property(readonly, nonatomic) id <HFIconDescriptor> iconDescriptor;
- (void)viewDidLoad;	// IMP=0x00100000000023f2
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x00100000000022e4
