...
- (void).cxx_destruct;	// IMP=0x0020000000012292
...
- (_Bool)_shouldEnableShareSiriAnalytics;	// IMP=0x001000000001200f
...
- (id)_enableSiriWithUserConfirmation;	// IMP=0x0010000000010552
- (id)_disableSiri;	// IMP=0x0010000000010177
- (void)_launchSiriPrivacySheet;	// IMP=0x00100000000100cb
- (void)_handleFooterLabelTouchForOpenURL:(id)arg1;	// IMP=0x001000000000ff65
- (CDUnknownBlockType)dismissButtonBlock;	// IMP=0x001000000000fef8
- (id)commitConfiguration;	// IMP=0x001000000000fdf7
- (void)viewDidLoad;	// IMP=0x001000000000f5d9
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000000f0bd
