...
- (void).cxx_destruct;	// IMP=0x0020000000051a46
...
- (id)_enableAirPlay;	// IMP=0x00100000000513bd
- (id)_applyOnboardingSelectionsIfNeeded;	// IMP=0x0010000000051182
- (id)_applyOnboardingSelections;	// IMP=0x0010000000050d3d
- (void)viewDidLoad;	// IMP=0x00100000000505ee
- (id)commitConfiguration;	// IMP=0x00100000000505ce
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x0010000000050286
