...
- (void).cxx_destruct;	// IMP=0x002000000003df9b
...
- (void)updatePairingStatus:(id)arg1;	// IMP=0x001000000003ded3
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000003de69
- (void)viewDidLoad;	// IMP=0x001000000003da6c
- (id)commitConfiguration;	// IMP=0x001000000003da4c
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000003d8f2
