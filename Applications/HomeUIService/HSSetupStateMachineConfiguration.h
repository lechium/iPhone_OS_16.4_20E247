...
@class HFAccessoryItem, HMAccessory, HMAccessoryCategory, HMCameraProfile, HMHome, HMSetupAccessoryDescription, HMSiriEndpointOnboardingSelections, MTSDeviceSetupRequest, NSArray, NSError, NSString;
...
+ (id)writeConfigurationState:(long long)arg1 toService:(id)arg2;	// IMP=0x0010000000027740
+ (id)writeVisibilityState:(id)arg1 toInputSourceService:(id)arg2;	// IMP=0x001000000002739d
+ (id)disableServices:(id)arg1;	// IMP=0x001000000002722a
+ (id)enableServices:(id)arg1;	// IMP=0x00100000000270b7
+ (id)configureServices:(id)arg1 withNames:(id)arg2;	// IMP=0x0010000000026deb
+ (id)configureService:(id)arg1 withName:(id)arg2;	// IMP=0x0010000000026bfb
- (void).cxx_destruct;	// IMP=0x001000000001ad17
...
- (id)initWithError:(id)arg1;	// IMP=0x001000000001a768
- (id)initWithAccessory:(id)arg1;	// IMP=0x001000000001a6a7
- (id)initWithHome:(id)arg1;	// IMP=0x001000000001a638
- (id)updateUserGivenAccessoryName:(id)arg1;	// IMP=0x001000000001a4af
- (_Bool)requiresOwnerToPair;	// IMP=0x001000000001a024
@property(readonly, nonatomic, getter=isSetupInitiatedByOtherMatterEcosystem) _Bool setupInitiatedByOtherMatterEcosystem;
- (id)configureAccessoryWithName:(id)arg1;	// IMP=0x0010000000026022
- (id)configureAccessoryName;	// IMP=0x0010000000025f42
- (id)configureRoom;	// IMP=0x00100000000259bb
- (id)validateNames:(id)arg1;	// IMP=0x00100000000258d6
- (id)validateName:(id)arg1;	// IMP=0x0010000000025405
