...
- (void).cxx_destruct;	// IMP=0x002000000002ea3a
- (void)_startListeningToMemoryPressureEvents;	// IMP=0x001000000002e6cd
- (void)dealloc;	// IMP=0x001000000002e678
- (void)start;	// IMP=0x001000000002e64a
- (void)protectedDataDidBecomeAvailable:(id)arg1;	// IMP=0x001000000002e644
- (void)_migrate;	// IMP=0x001000000002e453
- (void)_clearNavTracesDirectory;	// IMP=0x001000000002e269
- (void)_stopMonitoringSignificantLocationChanges;	// IMP=0x001000000002e1be
- (void)_turnOffCoreRoutineMonitoringOn3DTouchDevices;	// IMP=0x001000000002e11d
- (void)_main;	// IMP=0x001000000002dfad
