...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002fac5
- (void).cxx_destruct;	// IMP=0x0020000000030291
...
- (id)objectForJSON;	// IMP=0x00100000000300a5
- (id)nameForJSON;	// IMP=0x0010000000030093
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002fbf0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002facd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002f995
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002f835
- (id);	// IMP=0x001000000002f71d
