...
- (void).cxx_destruct;	// IMP=0x00200000000447f1
@property(copy) NavdDoomStorage *internalStorage; // @synthesize internalStorage=_internalStorage;
- (void)unregisterObserver:(id)arg1;	// IMP=0x001000000004287f
- (void)registerObserver:(id)arg1;	// IMP=0x0010000000042751
- (id)nameForJSON;	// IMP=0x0010000000042737
- (id)objectForJSON;	// IMP=0x001000000004260b
- (void)engineRunner:(id)arg1 stoppedWithEntries:(id)arg2;	// IMP=0x00100000000402fc
- (void)engineRunner:(id)arg1 step:(id)arg2 jsonDict:(id)arg3;	// IMP=0x001000000003f797
- (void)engineRunner:(id)arg1 receivedEntries:(id)arg2;	// IMP=0x001000000003f604
- (void)engineRunner:(id)arg1 startedBecauseOfTrigger:(id)arg2;	// IMP=0x001000000003f471
- (void)actionCircuit:(id)arg1 step:(id)arg2 jsonDict:(id)arg3;	// IMP=0x001000000003f24c
- (void)actionCircuitDidAct:(id)arg1;	// IMP=0x001000000003efb2
@property(readonly, nonatomic) NSString *uniqueName;
- (void)triggerFired:(id)arg1;	// IMP=0x001000000003ee02
- (id)initFromResourceDepot:(id)arg1 triggers:(id)arg2 conditions:(id)arg3 storage:(id)arg4 routesUpdater:(id)arg5 guard:(id)arg6 alerter:(id)arg7 visitMonitor:(id)arg8;	// IMP=0x001000000003c49f
