...
+ (id)eventStreamUUIDForDevice:(int)arg1;	// IMP=0x0040000000005f1c
...
- (id)description;	// IMP=0x0010000000005ea9
@property(readonly, nonatomic) NSString *mountPath;
- (_Bool)setupForPath:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000005cda
