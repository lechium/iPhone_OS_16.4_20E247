...
- (void).cxx_destruct;	// IMP=0x00200000000049a5
...
- (void)dispose;	// IMP=0x0010000000004801
- (_Bool)didProcessBarrierEventUUID:(id)arg1;	// IMP=0x00100000000046e7
- (void)didProcessEventID:(unsigned long long)arg1;	// IMP=0x00100000000046d8
- (id)waitableBarrier;	// IMP=0x001000000000437d
@property(readonly, nonatomic) NSString *rootParent;
- (id)description;	// IMP=0x0010000000004321
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x0010000000004162
- (id)initWithPath:(id)arg1 fd:(int)arg2 reader:(id)arg3 sinceEventID:(unsigned long long)arg4 streamUUID:(id)arg5 ignoreOwnEvents:(_Bool)arg6 delegate:(id)arg7 purpose:(id)arg8;	// IMP=0x0010000000004036
