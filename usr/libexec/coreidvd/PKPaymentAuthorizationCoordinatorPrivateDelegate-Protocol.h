...
@class MISSING_TYPE, NSError, PKAccountServicePaymentMethod, PKApplePayTrustSignature, PKDisbursementVoucher, PKPaymentAuthorizationCoordinator, PKServiceProviderPurchase;
...
- (MISSING_TYPE *)paymentAuthorizationCoordinator:didAuthorizePeerPaymentQuote:handler: /* Error: Ran out of types for this method. */;
