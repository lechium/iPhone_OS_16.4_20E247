...
- (void).cxx_destruct;	// IMP=0x0020000000031356
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000310c6
- (unsigned long long)hash;	// IMP=0x0010000000030fb7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000030d87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000030bcc
- (void)copyTo:(id)arg1;	// IMP=0x0010000000030a89
- (void)writeTo:(id)arg1;	// IMP=0x0010000000030961
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000030954
- (id)dictionaryRepresentation;	// IMP=0x0010000000030638
- (id)description;	// IMP=0x0010000000030589
