...
- (void).cxx_destruct;	// IMP=0x00200000000375ab
...
- (void)terminate;	// IMP=0x0010000000037474
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x00100000000372cc
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000036c6b
- (void)resetDataStoreForSyncSession:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000036a7c
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x0010000000036a74
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0010000000036a52
- (void)lateSetupForSession:(id)arg1;	// IMP=0x001000000003658c
- (id)init;	// IMP=0x0010000000036509
