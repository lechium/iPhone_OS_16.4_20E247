...
- (void).cxx_destruct;	// IMP=0x00200000000040ce
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000003e85
- (unsigned long long)hash;	// IMP=0x0010000000003d61
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003b3d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000039ae
- (void)copyTo:(id)arg1;	// IMP=0x0010000000003873
- (void)writeTo:(id)arg1;	// IMP=0x0010000000003735
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000003728
- (id)dictionaryRepresentation;	// IMP=0x0010000000003112
- (id)description;	// IMP=0x0010000000003063
