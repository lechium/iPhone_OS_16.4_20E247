...
+ (long long)cpuTime;	// IMP=0x0040000000034c9d
+ (long long)dirtyMemory;	// IMP=0x0010000000034c26
+ (long long)wallTime;	// IMP=0x0010000000034bbf
+ (id)nowMinusPrevious:(id)arg1;	// IMP=0x0010000000034ae0
...
- (id)description;	// IMP=0x0010000000034d17
- (double)cpuTimeMs;	// IMP=0x0010000000034a8f
- (id)init;	// IMP=0x00100000000349a6
