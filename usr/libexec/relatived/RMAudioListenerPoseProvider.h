...
- (void).cxx_destruct;	// IMP=0x0020000000002cb4
...
- (void)stopProducingData;	// IMP=0x0010000000002bdd
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002b1e
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000002a7b
