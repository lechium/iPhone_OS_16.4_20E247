...
- (void).cxx_destruct;	// IMP=0x0020000000005414
...
- (void)stopProducingData;	// IMP=0x0010000000005330
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000005056
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000004f68
