...
- (void).cxx_destruct;	// IMP=0x0020000000002a53
...
- (id)initWithUniqueIdentifier:(id)arg1 tempestOptions:(id)arg2 forceSessionRestart:(_Bool)arg3;	// IMP=0x0010000000002955
