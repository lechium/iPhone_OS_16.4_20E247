...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000b6bdc
+ (id)entityName;	// IMP=0x00100000000b6777
- (void)bindTo:(id)arg1;	// IMP=0x00200000000b69a5
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000b6784
