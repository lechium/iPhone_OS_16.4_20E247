...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000080f88
- (void).cxx_destruct;	// IMP=0x0020000000080feb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000080ee1
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000080e09
- (_Bool)requiresMescal;	// IMP=0x0010000000080cd9
- (_Bool)needsCooldown;	// IMP=0x0010000000080b35
- (_Bool)isExpired;	// IMP=0x0010000000080a09
- (id)dictionaryRepresentation;	// IMP=0x0010000000080606
- (id)identifier;	// IMP=0x00100000000805b6
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000008005d
- (id)initWithEndpointConfig:(id)arg1;	// IMP=0x001000000007ffe3
