...
- (void).cxx_destruct;	// IMP=0x002000000018f3f6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018eecc
- (unsigned long long)hash;	// IMP=0x001000000018ece8
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018e958
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018e695
- (void)copyTo:(id)arg1;	// IMP=0x001000000018e47a
- (void)writeTo:(id)arg1;	// IMP=0x001000000018e271
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018e264
- (id)dictionaryRepresentation;	// IMP=0x001000000018d630
- (id)description;	// IMP=0x001000000018d581
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000018d2b4
- (id)typeAsString:(int)arg1;	// IMP=0x001000000018d26b
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (int)StringAsAction:(id)arg1;	// IMP=0x001000000018d152
- (id)actionAsString:(int)arg1;	// IMP=0x001000000018d109
@property(nonatomic) _Bool hasAction;
- (void);	// IMP=0x001000000018d0c4
