...
- (void).cxx_destruct;	// IMP=0x002000000011bce7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011ba4e
- (unsigned long long)hash;	// IMP=0x001000000011b959
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011b75d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011b5cb
- (void)copyTo:(id)arg1;	// IMP=0x001000000011b4a8
- (void)writeTo:(id)arg1;	// IMP=0x001000000011b39d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011b390
- (id)dictionaryRepresentation;	// IMP=0x001000000011aeaf
- (id)description;	// IMP=0x001000000011ae00
