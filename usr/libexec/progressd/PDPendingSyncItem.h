...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x002000000010b7f4
+ (id)identityColumnName;	// IMP=0x001000000010b188
+ (id)entityName;	// IMP=0x001000000010b15c
- (void).cxx_destruct;	// IMP=0x002000000010c6e0
...
- (void)bindTo:(id)arg1;	// IMP=0x001000000010b616
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x001000000010b41e
- (id)initWithObject:(id)arg1 state:(long long)arg2;	// IMP=0x001000000010b2b0
