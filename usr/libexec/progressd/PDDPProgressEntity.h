...
- (void).cxx_destruct;	// IMP=0x002000000007dbd4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007d994
- (unsigned long long)hash;	// IMP=0x001000000007d889
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007d689
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007d4fe
- (void)copyTo:(id)arg1;	// IMP=0x001000000007d3db
- (void)writeTo:(id)arg1;	// IMP=0x001000000007d2c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007d2bc
- (id)dictionaryRepresentation;	// IMP=0x001000000007cd76
- (id)description;	// IMP=0x001000000007ccc7
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000007cb1d
- (id)typeAsString:(int)arg1;	// IMP=0x001000000007cad4
