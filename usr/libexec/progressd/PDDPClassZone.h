...
- (void).cxx_destruct;	// IMP=0x0020000000134e86
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000134d37
- (unsigned long long)hash;	// IMP=0x0010000000134c7a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000134b14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000134a13
- (void)copyTo:(id)arg1;	// IMP=0x0010000000134953
- (void)writeTo:(id)arg1;	// IMP=0x0010000000134889
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000013487c
- (id)dictionaryRepresentation;	// IMP=0x001000000013441c
- (id)description;	// IMP=0x001000000013436d
