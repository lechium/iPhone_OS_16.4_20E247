...
- (void).cxx_destruct;	// IMP=0x0020000000116fb2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000116d66
- (unsigned long long)hash;	// IMP=0x0010000000116c5c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000116a71
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001168f4
- (void)copyTo:(id)arg1;	// IMP=0x00100000001167d4
- (void)writeTo:(id)arg1;	// IMP=0x00100000001166b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001166a8
- (id)dictionaryRepresentation;	// IMP=0x0010000000116053
- (id)description;	// IMP=0x0010000000115fa4
@property(readonly, nonatomic) _Bool hasClassId;
@property(readonly, nonatomic) _Bool hasScheduleDate;
- (int)StringAsScheduleAction:(id)arg1;	// IMP=0x0010000000115f18
- (id)scheduleActionAsString:(int)arg1;	// IMP=0x0010000000115ec3
...
- (int)StringAsScheduledEntityType:(id)arg1;	// IMP=0x0010000000115dfd
- (id)scheduledEntityTypeAsString:(int)arg1;	// IMP=0x0010000000115da8
