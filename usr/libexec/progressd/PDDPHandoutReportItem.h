...
+ (Class)additionalReportsType;	// IMP=0x002000000018f98b
- (void).cxx_destruct;	// IMP=0x0020000000191586
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000191129
- (unsigned long long)hash;	// IMP=0x0010000000190fa4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000190cd3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000190957
- (void)copyTo:(id)arg1;	// IMP=0x001000000019073b
- (void)writeTo:(id)arg1;	// IMP=0x00100000001904ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001904a0
- (id)dictionaryRepresentation;	// IMP=0x001000000018fa60
- (id)description;	// IMP=0x001000000018f9b1
@property(readonly, nonatomic) _Bool hasReportItemId;
- (id)additionalReportsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000018f96e
- (unsigned long long)additionalReportsCount;	// IMP=0x001000000018f951
- (void)addAdditionalReports:(id)arg1;	// IMP=0x001000000018f8e7
- (void)clearAdditionalReports;	// IMP=0x001000000018f8ca
...
- (int)StringAsGranularity:(id)arg1;	// IMP=0x001000000018f721
- (id)granularityAsString:(int)arg1;	// IMP=0x001000000018f6d8
@property(nonatomic) _Bool hasGranularity;
@property(nonatomic) int granularity; // @synthesize granularity=_granularity;
- (int)StringAsType:(id)arg1;	// IMP=0x001000000018f5a9
- (id)typeAsString:(int)arg1;	// IMP=0x001000000018f560
