...
+ (Class)adminRequestAccountIdsType;	// IMP=0x002000000003e022
- (void).cxx_destruct;	// IMP=0x002000000003fdc5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000003f8d4
- (unsigned long long)hash;	// IMP=0x001000000003f711
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003f3ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003f041
- (void)copyTo:(id)arg1;	// IMP=0x001000000003edea
- (void)writeTo:(id)arg1;	// IMP=0x001000000003eb21
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000003eb14
- (id)dictionaryRepresentation;	// IMP=0x001000000003e0f7
- (id)description;	// IMP=0x001000000003e048
@property(readonly, nonatomic) _Bool hasAdminNote;
- (id)adminRequestAccountIdsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000003e005
- (unsigned long long)adminRequestAccountIdsCount;	// IMP=0x001000000003dfe8
- (void)addAdminRequestAccountIds:(id)arg1;	// IMP=0x000000000003df7e
- (void)clearAdminRequestAccountIds;	// IMP=0x001000000003df61
...
- (int)StringAsApprovalStatus:(id)arg1;	// IMP=0x001000000003ddff
- (id)approvalStatusAsString:(int)arg1;	// IMP=0x001000000003ddb6
...
- (int)StringAsRequestStatus:(id)arg1;	// IMP=0x001000000003dc87
- (id)requestStatusAsString:(int)arg1;	// IMP=0x001000000003dc3e
@property(nonatomic) _Bool hasRequestStatus;
@property(nonatomic) int requestStatus; // @synthesize requestStatus=_requestStatus;
- (int)StringAsType:(id)arg1;	// IMP=0x001000000003dae5
- (id)typeAsString:(int)arg1;	// IMP=0x001000000003da9c
