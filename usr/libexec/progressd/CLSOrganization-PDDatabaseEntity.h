...
+ (id)searchColumnName;	// IMP=0x0020000000059297
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00100000000591d4
+ (id)entityName;	// IMP=0x0010000000058c56
- (id)tokensForSearchableColumn:(id)arg1 withValue:(id)arg2 tokenize:(_Bool)arg3;	// IMP=0x002000000005937f
...
- (void)bindTo:(id)arg1;	// IMP=0x0010000000058ece
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x0010000000058c63
