...
- (void).cxx_destruct;	// IMP=0x0020000000162d10
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000162b94
- (unsigned long long)hash;	// IMP=0x0010000000162af1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000162991
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000162879
- (void)copyTo:(id)arg1;	// IMP=0x00100000001627b6
- (void)writeTo:(id)arg1;	// IMP=0x0010000000162702
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001626f5
- (id)dictionaryRepresentation;	// IMP=0x0010000000162477
- (id)description;	// IMP=0x00100000001623c8
