...
+ (Class)stringListValueType;	// IMP=0x0020000000178c07
- (void).cxx_destruct;	// IMP=0x002000000017a338
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000017a00a
- (unsigned long long)hash;	// IMP=0x0010000000179e10
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000179c2d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000179954
- (void)copyTo:(id)arg1;	// IMP=0x00100000001797ba
- (void)writeTo:(id)arg1;	// IMP=0x0010000000179591
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000179584
- (id)dictionaryRepresentation;	// IMP=0x0010000000178db8
- (id)description;	// IMP=0x0010000000178d09
...
- (id)stringListValueAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000178bea
- (unsigned long long)stringListValuesCount;	// IMP=0x0010000000178bcd
- (void)addStringListValue:(id)arg1;	// IMP=0x0010000000178b63
- (void)clearStringListValues;	// IMP=0x0010000000178b46
@property(readonly, nonatomic) _Bool hasStringValue;
@property(nonatomic) _Bool hasEncryptionScheme;
- (int)StringAsType:(id)arg1;	// IMP=0x001000000017894b
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000178902
