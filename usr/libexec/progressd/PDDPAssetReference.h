...
+ (Class)classIdsType;	// IMP=0x002000000013f74f
- (void).cxx_destruct;	// IMP=0x002000000014268e
// Error: Property attributes should begin with the type ('T') attribute, property name: durationSeconds
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000141ece
- (unsigned long long)hash;	// IMP=0x0010000000141a93
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001414e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000140f04
- (void)copyTo:(id)arg1;	// IMP=0x0010000000140b33
- (void)writeTo:(id)arg1;	// IMP=0x0010000000140709
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001406fc
- (id)dictionaryRepresentation;	// IMP=0x001000000013f93f
- (id)description;	// IMP=0x001000000013f890
...
- (id)classIdsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000013f732
- (unsigned long long)classIdsCount;	// IMP=0x001000000013f715
- (void)addClassIds:(id)arg1;	// IMP=0x001000000013f6ab
- (void)clearClassIds;	// IMP=0x001000000013f68e
...
- (int)StringAsParentEntityType:(id)arg1;	// IMP=0x001000000013f4ae
- (id)parentEntityTypeAsString:(int)arg1;	// IMP=0x001000000013f465
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000013f28f
- (id)typeAsString:(int)arg1;	// IMP=0x001000000013f246
