...
- (void).cxx_destruct;	// IMP=0x002000000006b1cd
...
- (void)run;	// IMP=0x001000000006ae2e
- (void)clampToPredefinedTimePeriod:(unsigned long long)arg1;	// IMP=0x001000000006acfd
- (id)initWithIdentifier:(id)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000006abf4
