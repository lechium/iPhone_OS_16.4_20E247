...
- (void).cxx_destruct;	// IMP=0x00200000000f3cd2
...
- (id)description;	// IMP=0x00100000000f394c
- (_Bool)_entitiesChangedSince:(id)arg1 database:(id)arg2;	// IMP=0x00100000000f2254
- (void)_sendClientEntitiesChangedAdded:(id)arg1 updated:(id)arg2 deleted:(id)arg3 updatedMatchingPredicate:(id)arg4 updatedNotMatchingPredicate:(id)arg5;	// IMP=0x00100000000f20d7
- (_Bool)_entityCountsChangedSince:(id)arg1 database:(id)arg2;	// IMP=0x00100000000f1dcc
- (id)observedTableName;	// IMP=0x00100000000f19a9
