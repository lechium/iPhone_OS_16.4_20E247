...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000f68d4
+ (id)entityName;	// IMP=0x00100000000f6258
- (void)bindTo:(id)arg1;	// IMP=0x00200000000f6591
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000f6265
