...
- (void).cxx_destruct;	// IMP=0x00200000000645c5
...
- (id)description;	// IMP=0x001000000006430a
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x00100000000642ec
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x001000000006422e
- (id)initWithAttributes:(id)arg1;	// IMP=0x0010000000063ef2
