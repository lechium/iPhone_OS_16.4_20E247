...
- (void).cxx_destruct;	// IMP=0x002000000013475c
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x0010000000134500
- (void)_releaseTimerFired;	// IMP=0x0010000000134491
- (void)_holdTimerFired;	// IMP=0x0010000000134422
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x00100000001343b8
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x0010000000133fda
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x0010000000133efe
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x0010000000133e25
- (void)dealloc;	// IMP=0x0010000000133d92
- (id)initWithThreadKey:(id)arg1;	// IMP=0x0010000000133c0c
