...
+ (id)context:(long long)arg1;	// IMP=0x0040000000011d8b
- (void).cxx_destruct;	// IMP=0x0020000000012010
...
- (id)description;	// IMP=0x0010000000011dfe
- (id)init;	// IMP=0x0010000000011dc3
