...
- (void).cxx_destruct;	// IMP=0x00100000001132f6
...
- (id)description;	// IMP=0x001000000011308c
...
// Error: Property attributes should begin with the type ('T') attribute, property name: isCommandKeyPressed
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000112b02
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x00100000001129a2
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000113329
