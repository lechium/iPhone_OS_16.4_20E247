...
- (void).cxx_destruct;	// IMP=0x00200000000e848d
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000e83d2
- (void)previousSegment;	// IMP=0x00100000000e8346
- (void)nextSegment;	// IMP=0x00100000000e82d3
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000e8078
