...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x004000000001593e
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00100000000158a0
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000015802
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000015764
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00100000000156c6
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x00100000000156aa
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x00100000000155dd
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x001000000001553f
- (void).cxx_destruct;	// IMP=0x0020000000015d49
...
- (id)description;	// IMP=0x0010000000015b55
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x0010000000015b2d
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x0010000000015ab4
- (void)setInfo:(id)arg1;	// IMP=0x0010000000015a69
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x0010000000015a2d
- (_Bool)isSystemServerEvent;	// IMP=0x0010000000015a1f
- (_Bool)isBrailleEvent;	// IMP=0x0010000000015a11
- (_Bool)isExternalDeviceEvent;	// IMP=0x0010000000015a03
- (_Bool)isTouchEvent;	// IMP=0x00100000000159f5
- (_Bool)isKeyEvent;	// IMP=0x00100000000159e7
- (double)time;	// IMP=0x00100000000159dc
- (id)initWithType:(long long)arg1;	// IMP=0x00100000000154ee
