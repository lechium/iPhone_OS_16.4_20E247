...
+ (id)sharedDaemon;	// IMP=0x00200000000414dc
- (void).cxx_destruct;	// IMP=0x0020000000044895
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x0010000000044654
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000044325
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004400c
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x0010000000043e80
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x001000000004397e
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x00100000000438b4
- (void)_updateErrorFlags;	// IMP=0x001000000004376b
- (void)_prefsChanged;	// IMP=0x001000000004362f
- (void);	// IMP=0x001000000004343d
- (id)keychainStateString;	// IMP=0x001000000004319d
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000042f4f
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x0010000000042e2b
- (void)invalidate;	// IMP=0x0010000000042a2a
- (void)activate;	// IMP=0x0010000000042003
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0010000000041757
- (id)init;	// IMP=0x0010000000041531
