...
- (void).cxx_destruct;	// IMP=0x0020000000057e4e
...
- (id)description;	// IMP=0x0010000000057d09
- (void)invalidate;	// IMP=0x0010000000057a92
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000057894
