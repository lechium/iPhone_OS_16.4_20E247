...
@class MISSING_TYPE, NSDictionary, NSString, RPCompanionLinkAssertion, RPCompanionLinkClient, RPDiscovery, RPServer, RPSession;
...
- (MISSING_TYPE *)companionLinkSendRequestID:request:destinationID:options:responseHandler: /* Error: Ran out of types for this method. */;
