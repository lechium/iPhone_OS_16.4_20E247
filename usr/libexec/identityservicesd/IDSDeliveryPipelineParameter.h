...
@interface IDSDeliveryPipelineParameter : NSObject
{
    ...
    _Bool _wantsFirewallDonation;	// 13 = 0xd
    _Bool _wantsDeliveryStatus;	// 14 = 0xe
    _Bool _wantsCertifiedDelivery;	// 15 = 0xf
    _Bool _usedMMCS;	// 16 = 0x10
...
- (void).cxx_destruct;	// IMP=0x00200000005c0a20
...
- (id)description;	// IMP=0x00100000005c00a0
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x00100000005c0010
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000005bf8a0
