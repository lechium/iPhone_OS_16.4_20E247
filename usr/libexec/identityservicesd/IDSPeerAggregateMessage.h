...
- (void).cxx_destruct;	// IMP=0x00200000000af880
...
- (id)messageBody;	// IMP=0x00100000000ae050
- (id)requiredKeys;	// IMP=0x00100000000adf70
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ad950
- (unsigned long long)sizeOfKeysWithValues;	// IMP=0x00100000000ad4a0
- (void)logFailureInfo;	// IMP=0x00100000000acc40
- (_Bool)expectingMoreResponses;	// IMP=0x00100000000acc00
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x00100000000ab5e0
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00100000000aa980
- (void)callAllAckBlocks;	// IMP=0x00100000000aa730
- (void)clearAllPendingResponseTokens;	// IMP=0x00100000000aa6b0
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00100000000aa440
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00100000000aa300
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00100000000aa170
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x00100000000aa0b0
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000000a9960
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x00100000000a9890
- (id)init;	// IMP=0x00100000000a97f0
