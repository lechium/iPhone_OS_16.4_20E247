...
- (void).cxx_destruct;	// IMP=0x00200000001835f0
...
- (id)description;	// IMP=0x00100000001834d0
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x00100000001833c0
