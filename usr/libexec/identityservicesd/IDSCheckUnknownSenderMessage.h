...
- (void).cxx_destruct;	// IMP=0x00200000002ebc40
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000002eb740
- (_Bool)wantsHTTPGet;	// IMP=0x00100000002eb720
- (id)additionalQueryStringParameters;	// IMP=0x00100000002eb510
- (id)additionalMessageHeaders;	// IMP=0x00100000002eb2a0
- (id)bagKey;	// IMP=0x00100000002eb280
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002eafc0
