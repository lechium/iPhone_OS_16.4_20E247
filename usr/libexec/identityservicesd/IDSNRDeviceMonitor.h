...
- (void).cxx_destruct;	// IMP=0x00200000000072e0
...
- (id)init;	// IMP=0x00100000000071d0
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000007130
