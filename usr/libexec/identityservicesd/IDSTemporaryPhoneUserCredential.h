...
- (void).cxx_destruct;	// IMP=0x00200000006ca480
...
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00100000006ca240
- (long long)realm;	// IMP=0x00100000006ca220
- (id)initWithPhoneAuthenticationCertificate:(id)arg1;	// IMP=0x00100000006ca060
