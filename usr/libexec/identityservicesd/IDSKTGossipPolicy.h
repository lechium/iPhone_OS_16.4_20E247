...
- (void).cxx_destruct;	// IMP=0x00200000003fe450
...
- (void)_storeGossipRecipients;	// IMP=0x00100000003fde90
- (void)_loadGossipRecipients;	// IMP=0x00100000003fd420
- (void)markSelfVerifyBecauseOfPeer;	// IMP=0x00100000003fd3d0
- (_Bool)shouldSelfVerifyBecauseOfPeer;	// IMP=0x00100000003fd300
- (void)markGossipForURI:(id)arg1;	// IMP=0x00100000003fd1a0
- (_Bool)shouldGossipToURI:(id)arg1;	// IMP=0x00100000003fd060
- (_Bool)havePreviouslyGossipedToURI:(id)arg1;	// IMP=0x00100000003fcff0
- (void)resetGossipState;	// IMP=0x00100000003fcf90
- (id)initWithGossipSpecification:(id)arg1;	// IMP=0x00100000003fcc70
