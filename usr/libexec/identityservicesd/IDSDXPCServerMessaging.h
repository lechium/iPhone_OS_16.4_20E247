...
- (void).cxx_destruct;	// IMP=0x0020000000454220
...
- (void)handler:(id)arg1 receivedOfflineMessagePendingForTopic:(id)arg2 messageContext:(id)arg3;	// IMP=0x0010000000453e60
- (void)handler:(id)arg1 didReceiveMessage:(id)arg2 forTopic:(id)arg3 fromID:(id)arg4 messageContext:(id)arg5;	// IMP=0x0010000000452950
- (void)sendCertifiedDeliveryReceipt:(id)arg1;	// IMP=0x0010000000452500
- (void)sendMessageData:(id)arg1 onTopic:(id)arg2 withOptions:(id)arg3 identifier:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0010000000451680
- (void)setupServerMessagingClient:(id)arg1 withUUID:(id)arg2 forTopic:(id)arg3;	// IMP=0x0010000000450ea0
- (void)_recalculateTopics;	// IMP=0x0010000000450cf0
- (id)_topics;	// IMP=0x0010000000450c50
- (id)_commands;	// IMP=0x0010000000450c00
- (_Bool)_entitledForTopic:(id)arg1;	// IMP=0x00100000004509e0
- (id)initWithQueue:(id)arg1 connection:(id)arg2 messageDelivery:(id)arg3 pushHandler:(id)arg4;	// IMP=0x001000000044ffd0
