...
@class IDSMPFullLegacyIdentity, IDSMPPublicLegacyIdentity, IMTimer, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSError, NSNumber, NSSet, NSString, NSUUID, _IDSSessionConnection;
...
@interface IDSDSessionSharedState : NSObject
{
    ...
    MISSING_TYPE *_remoteUnauthenticatedPublicIdentity;	// 288 = 0x120
    id <IDSDSession> _delegate;	// 296 = 0x128
    CDStruct_eff2b79e _encryptionStateStruct;	// 304 = 0x130
}

- (void).cxx_destruct;	// IMP=0x00200000005a85b0
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x00100000005a6f40
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00100000005a6e70
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000005a6e00
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x00100000005a6680
- (_Bool)supportsReinitiate;	// IMP=0x00100000005a6580
- (void)_endSessionTimedOut;	// IMP=0x00100000005a6420
- (void)_endSessionTimerFiredOnMain;	// IMP=0x00100000005a6350
- (void)setEndSessionTimeoutTimer;	// IMP=0x00100000005a60e0
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x00100000005a5ef0
- (void)_clearPacketLossTimer;	// IMP=0x00100000005a5d70
- (void)_connectionTimedOut;	// IMP=0x00100000005a5c20
- (void)_connectionTimerFiredOnMain;	// IMP=0x00100000005a5b50
- (void)setConnectionTimer;	// IMP=0x00100000005a56e0
- (void)_clearConnectionTimer;	// IMP=0x00100000005a54f0
- (void)_clearInvitationTimer;	// IMP=0x00100000005a5300
- (void)_inviteTimedOut;	// IMP=0x00100000005a5140
- (void)_inviteTimerFiredOnMain;	// IMP=0x00100000005a5070
- (void)setInvitationTimer;	// IMP=0x00100000005a4df0
- (void)clearAllTimers;	// IMP=0x00100000005a4d90
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x00100000005a24a0
