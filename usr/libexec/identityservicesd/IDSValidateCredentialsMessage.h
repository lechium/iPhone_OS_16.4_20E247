...
- (void).cxx_destruct;	// IMP=0x00200000001a33d0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000001a2f50
- (id)bagKey;	// IMP=0x00100000001a2f30
- (id)requiredKeys;	// IMP=0x00100000001a2ed0
- (id)messageBody;	// IMP=0x00100000001a2c30
- (id)additionalMessageHeaders;	// IMP=0x00100000001a29e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a2770
