...
- (void)setHardwareVersion:(id)arg1;	// IMP=0x0010000000019040
- (id)hardwareVersion;	// IMP=0x0010000000019020
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000018ad0
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000018ab0
- (id)bagKey;	// IMP=0x0010000000018a90
- (id)requiredKeys;	// IMP=0x0010000000018a30
- (id)messageBody;	// IMP=0x0010000000017f50
- (id)additionalMessageHeaders;	// IMP=0x0010000000017d00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017950
