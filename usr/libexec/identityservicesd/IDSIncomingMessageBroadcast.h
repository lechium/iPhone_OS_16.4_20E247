...
- (void).cxx_destruct;	// IMP=0x002000000013c5e0
...
- (id)initWithBroadcastBlock:(CDUnknownBlockType)arg1 needsClientAck:(_Bool)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned int)arg6;	// IMP=0x001000000013c140
- (id)init;	// IMP=0x001000000013c070
