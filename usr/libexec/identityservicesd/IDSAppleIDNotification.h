...
- (void).cxx_destruct;	// IMP=0x00200000002ae3a0
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x00100000002ae000
- (void)addSession:(id)arg1;	// IMP=0x00100000002adf80
- (void)addServiceType:(id)arg1;	// IMP=0x00100000002adf20
- (void)addAlias:(id)arg1;	// IMP=0x00100000002adeb0
- (id)init;	// IMP=0x00100000002adda0
