...
- (void).cxx_destruct;	// IMP=0x0020000000066970
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000066400
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x00100000000663b0
- (void)_endSession;	// IMP=0x0010000000066010
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x0010000000065b60
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0010000000065af0
- (void)_sendToConnectedSocket;	// IMP=0x0010000000064b80
- (_Bool)_queueNextOutgoingData;	// IMP=0x00100000000639b0
- (void)_processBytesAvailable;	// IMP=0x0010000000062400
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x0010000000061410
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000061010
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0010000000060720
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0010000000060230
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000600b0
...
- (void)endSession;	// IMP=0x001000000005f5d0
- (void)dealloc;	// IMP=0x001000000005f4c0
- (void)start;	// IMP=0x001000000005f250
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x001000000005ebe0
