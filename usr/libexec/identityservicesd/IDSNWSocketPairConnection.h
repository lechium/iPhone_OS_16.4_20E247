...
- (void).cxx_destruct;	// IMP=0x00200000007313e0
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x0010000000730860
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x0010000000730120
- (double)lastSocketActivityTime;	// IMP=0x0010000000730100
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000072f920
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000072f8b0
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x001000000072e3d0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x001000000072e370
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x001000000072d3c0
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000072d300
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x001000000072d260
- (void)endSession;	// IMP=0x001000000072cf60
- (void)dealloc;	// IMP=0x001000000072ce50
- (void)start;	// IMP=0x001000000072bc60
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x001000000072b980
