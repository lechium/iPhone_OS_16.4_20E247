...
+ (id)newDeviceIdentifierWithBluetoothUUID:(id)arg1;	// IMP=0x0020000000006820
- (void).cxx_destruct;	// IMP=0x0020000000006890
@property(readonly, nonatomic) NSUUID *nrDeviceIdentifier; // @synthesize nrDeviceIdentifier=_nrDeviceIdentifier;
- (id)initWithUUID:(id)arg1;	// IMP=0x00100000000067d0
