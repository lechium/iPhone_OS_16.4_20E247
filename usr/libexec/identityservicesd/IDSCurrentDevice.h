...
+ (id)sharedInstance;	// IMP=0x0040000000537bd0
- (void).cxx_destruct;	// IMP=0x0020000000538310
- (void)regenerateDeviceIdentifier;	// IMP=0x0010000000538170
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x0010000000537e70
...
- (id)init;	// IMP=0x0010000000537c90
