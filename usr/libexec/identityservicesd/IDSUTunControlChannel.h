...
- (void).cxx_destruct;	// IMP=0x0020000000213c80
...
- (void)resumeOTRNegotiation;	// IMP=0x0010000000213860
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x0010000000213820
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000002137d0
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000213790
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000212bf0
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x0010000000212b80
- (void)_destroyFairplayDeviceSession;	// IMP=0x0010000000212b70
- (void)_destroyFairplayHostSession;	// IMP=0x0010000000212b60
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x0010000000212a90
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x0010000000212a40
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00100000002129f0
- (MISSING_TYPE *)processFairplayHostSessionInfo: /* Error: Ran out of types for this method. */;	// IMP=0x00100000002129a0
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x0010000000212980
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x0010000000212960
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x0010000000212950
- (void)dealloc;	// IMP=0x0010000000212900
- (void)invalidate;	// IMP=0x0010000000212890
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00100000002127e0
- (void)sendMessage:(id)arg1;	// IMP=0x0010000000212730
- (void)_checkSendNewMessage;	// IMP=0x0010000000210ff0
- (void)_clearChannel;	// IMP=0x0010000000210e30
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x0010000000210dd0
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x0010000000210b50
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x0010000000210a80
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x001000000020f4e0
- (void)writeToConnection;	// IMP=0x001000000020e8f0
- (void)readFromConnection;	// IMP=0x001000000020c870
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x001000000020c840
- (void)simulateDecryptionFailure;	// IMP=0x001000000020c750
- (void)_cleanupConnection;	// IMP=0x001000000020c6a0
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000020c3b0
- (id)description;	// IMP=0x001000000020c2a0
