...
- (void).cxx_destruct;	// IMP=0x0020000000208eb0
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x0010000000208af0
- (void)sendMonitorMessage;	// IMP=0x00100000002081a0
- (void)checkConnectivityState:(id)arg1;	// IMP=0x0010000000207d80
- (id)init;	// IMP=0x0010000000207cf0
