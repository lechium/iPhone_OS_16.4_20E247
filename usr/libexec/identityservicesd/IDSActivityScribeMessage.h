...
- (void).cxx_destruct;	// IMP=0x002000000018ffc0
...
- (void)handleResponseHeaders:(id)arg1;	// IMP=0x001000000018fa10
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000018f930
- (id)messageBody;	// IMP=0x001000000018eca0
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x001000000018ec00
- (id)topic;	// IMP=0x001000000018ebe0
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x001000000018ebc0
- (_Bool)wantsResponse;	// IMP=0x001000000018eba0
- (_Bool)isIDSMessage;	// IMP=0x001000000018eb80
- (_Bool)highPriority;	// IMP=0x001000000018eb60
- (_Bool)wantsAPSRetries;	// IMP=0x001000000018eb40
- (_Bool)wantsIDSProtocolVersion;	// IMP=0x001000000018eb20
- (_Bool)isWebTunnelMessage;	// IMP=0x001000000018eb00
- (_Bool)wantsCompressedBody;	// IMP=0x001000000018eae0
- (_Bool)wantsBinaryPush;	// IMP=0x001000000018eac0
- (long long)responseCommand;	// IMP=0x001000000018eaa0
- (long long)command;	// IMP=0x001000000018ea80
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018e850
