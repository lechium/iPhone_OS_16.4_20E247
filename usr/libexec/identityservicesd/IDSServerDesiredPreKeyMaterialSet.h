...
- (void).cxx_destruct;	// IMP=0x0020000000731b60
...
- (id)materialDataByID;	// IMP=0x0010000000731860
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000731780
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long forParticipantID;
- (id)initWithUUID:(id)arg1 publicPreKeyData:(id)arg2 wrapMode:(long long)arg3 creationDate:(id)arg4;	// IMP=0x0010000000731570
- (id)initWithPublicPreKeyData:(id)arg1 wrapMode:(long long)arg2 creationDate:(id)arg3;	// IMP=0x0010000000731480
