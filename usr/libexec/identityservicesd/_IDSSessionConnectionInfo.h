...
- (void).cxx_destruct;	// IMP=0x002000000045eb40
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x001000000045e0f0
- (void)_addRemotePacketOutage;	// IMP=0x001000000045e040
- (id)description;	// IMP=0x001000000045df30
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x001000000045d840
