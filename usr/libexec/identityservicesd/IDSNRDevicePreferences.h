...
- (void)deviceSetupCompleted;	// IMP=0x0010000000006ff0
- (void)deviceSetupStarted;	// IMP=0x0010000000006fe0
- (void)cancel;	// IMP=0x0010000000006fd0
- (void)removeAllQuickRelayRequests;	// IMP=0x0010000000006fc0
- (void)removeQuickRelayRequest;	// IMP=0x0010000000006fb0
- (void)addQuickRelayRequest;	// IMP=0x0010000000006fa0
- (void)removePreferWiFiRequest;	// IMP=0x0010000000006f90
- (void)addPreferWiFiRequest;	// IMP=0x0010000000006f80
- (id)init;	// IMP=0x0010000000006f50
- (id)initWithDeviceIdentifier:(id)arg1;	// IMP=0x0010000000006f00
