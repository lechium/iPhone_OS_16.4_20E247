...
- (void).cxx_destruct;	// IMP=0x00200000004c2240
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x00100000004c19d0
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x00100000004c1510
- (id)init;	// IMP=0x00100000004c1480
