...
- (void).cxx_destruct;	// IMP=0x002000000038b5b0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000038af10
- (double)anisetteHeadersTimeout;	// IMP=0x001000000038aef0
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x001000000038aee0
- (id)messageBody;	// IMP=0x001000000038a470
- (id)requiredKeys;	// IMP=0x001000000038a390
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x001000000038a370
- (id)bagKey;	// IMP=0x001000000038a350
- (_Bool)requiresPushTokenKeys;	// IMP=0x001000000038a330
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x001000000038a250
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000389e50
