...
- (void).cxx_destruct;	// IMP=0x002000000000ea10
...
- (id)copyLinkStatsDict;	// IMP=0x001000000000e710
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000000e2b0
- (void)_processIncomingPacket;	// IMP=0x001000000000e2a0
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000000e220
- (unsigned long long)sendPacketBuffer:(CDStruct_dc2926a3 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000e1b0
- (void)start;	// IMP=0x001000000000e1a0
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)invalidate;	// IMP=0x001000000000e150
- (void)dealloc;	// IMP=0x001000000000e100
- (id)initWithPipe:(id)arg1 withDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000e050
