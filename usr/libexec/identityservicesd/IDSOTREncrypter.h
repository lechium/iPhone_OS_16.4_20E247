...
- (void).cxx_destruct;	// IMP=0x00200000004da290
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00100000004d9580
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00100000004d8830
- (id)initWithOTRController:(id)arg1 OTRToken:(id)arg2;	// IMP=0x00100000004d8740
