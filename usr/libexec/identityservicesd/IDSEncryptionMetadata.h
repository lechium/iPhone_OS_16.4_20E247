...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00100000002251a0
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x0010000000225110
- (id)init;	// IMP=0x00100000002250b0
