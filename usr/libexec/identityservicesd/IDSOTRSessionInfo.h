...
- (void).cxx_destruct;	// IMP=0x002000000044b430
...
- (void)_negotiationTimerFiredOnMain;	// IMP=0x001000000044b170
- (void)setNegotiationTimer;	// IMP=0x001000000044ae90
- (void)_handleNegotiationTimeout;	// IMP=0x001000000044a550
- (void)removeNegotiationTimer;	// IMP=0x001000000044a310
- (void)dealloc;	// IMP=0x001000000044a2a0
- (id)initWithToken:(id)arg1;	// IMP=0x001000000044a1e0
