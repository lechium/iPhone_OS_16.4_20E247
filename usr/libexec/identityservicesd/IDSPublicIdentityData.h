...
- (void).cxx_destruct;	// IMP=0x002000000047eb50
...
- (id)initWithPublicLegacyIdentityData:(id)arg1 publicNGMIdentityData:(id)arg2 publicNGMPrekeyData:(id)arg3 NGMVersion:(id)arg4;	// IMP=0x001000000047e970
