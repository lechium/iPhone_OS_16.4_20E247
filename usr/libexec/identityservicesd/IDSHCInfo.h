...
- (void *)remoteContext;	// IMP=0x00100000002f0fe0
- (void *)localContext;	// IMP=0x00100000002f0fc0
- (void)setRemoteContext:(void *)arg1;	// IMP=0x00100000002f0dc0
- (void)setLocalContext:(void *)arg1;	// IMP=0x00100000002f0bc0
- (void)invalidate;	// IMP=0x00100000002f0930
