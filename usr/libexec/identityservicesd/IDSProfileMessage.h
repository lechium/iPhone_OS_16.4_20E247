...
- (void).cxx_destruct;	// IMP=0x00200000001674d0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000167250
- (id)additionalMessageHeaders;	// IMP=0x0010000000166c10
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x0010000000166460
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x00100000001662d0
- (long long)responseCommand;	// IMP=0x00100000001662b0
- (long long)command;	// IMP=0x0010000000166290
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000166270
- (_Bool)wantsCompressedBody;	// IMP=0x0010000000166250
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000166230
- (_Bool)wantsBagKey;	// IMP=0x0010000000166210
- (void)dealloc;	// IMP=0x0010000000166030
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000165e40
- (id)init;	// IMP=0x0010000000165cf0
