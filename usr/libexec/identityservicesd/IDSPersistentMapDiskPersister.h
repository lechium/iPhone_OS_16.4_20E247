...
- (void).cxx_destruct;	// IMP=0x00200000005bd080
...
- (void)purgeData;	// IMP=0x00100000005bca80
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000005bb740
- (id)data;	// IMP=0x00100000005bac70
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x00100000005ba9f0
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x00100000005ba900
