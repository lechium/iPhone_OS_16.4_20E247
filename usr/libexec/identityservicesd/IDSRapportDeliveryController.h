...
+ (id)sharedInstance;	// IMP=0x00200000001a3490
- (void).cxx_destruct;	// IMP=0x00200000001a4fb0
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x00100000001a4c00
- (unsigned int)_nextMessageID;	// IMP=0x00100000001a4be0
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000001a3720
- (void)dealloc;	// IMP=0x00100000001a36c0
- (id)init;	// IMP=0x00100000001a3630
- (id)initWithRapportClient:(id)arg1;	// IMP=0x00100000001a3550
