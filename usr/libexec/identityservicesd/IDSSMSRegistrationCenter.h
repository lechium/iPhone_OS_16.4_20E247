...
+ (id)sharedInstance;	// IMP=0x002000000028d0d0
- (void).cxx_destruct;	// IMP=0x0020000000293650
...
- (void)_postPendingConsentAlerts;	// IMP=0x0010000000292f70
- (void)requestUserConsentToValidatePhoneNumberForCTPNR:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000291e50
- (void)_sendABCForFailureForIdentifier:(id)arg1 WithEvent:(long long)arg2 context:(id)arg3;	// IMP=0x0010000000291bb0
- (void)_resetRateLimitersForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x0010000000291b30
- (_Bool)_hasThresholdReachedForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x0010000000291a50
- (void)validator:(id)arg1 handleABCEvent:(long long)arg2;	// IMP=0x00100000002918a0
- (void)validator:(id)arg1 failedIdentificationWithRegistrationError:(long long)arg2;	// IMP=0x00100000002917a0
- (void)validator:(id)arg1 identifiedPhoneNumber:(id)arg2 token:(id)arg3 phoneBookNumber:(id)arg4;	// IMP=0x0010000000291490
- (id)_identifierForValidator:(id)arg1;	// IMP=0x0010000000291170
- (void)_notifyNeedsNewIdentification;	// IMP=0x0010000000290e00
- (void)_notifySuccess:(id)arg1 token:(id)arg2 identifier:(id)arg3;	// IMP=0x001000000028fec0
- (void)_notifyFailureWithError:(long long)arg1 registration:(id)arg2 identifier:(id)arg3;	// IMP=0x001000000028f460
- (void)removeListener:(id)arg1;	// IMP=0x001000000028f400
- (void)addListener:(id)arg1;	// IMP=0x001000000028f340
- (void)_noteRegistrationAttemptForIdentifier:(id)arg1 withRegistrationInfo:(id)arg2;	// IMP=0x001000000028ee90
- (void)notePhoneNumberRegistrationReset;	// IMP=0x001000000028ec80
- (void)cancelActionsForRegistrationInfo:(id)arg1;	// IMP=0x001000000028ebd0
- (void)_clearConsentDenialsForUniqueIdentifier:(id)arg1;	// IMP=0x001000000028ea20
- (void)clearConsentDenialsForPhoneUser:(id)arg1;	// IMP=0x001000000028e990
- (void)clearConsentDenialsForRegistration:(id)arg1;	// IMP=0x001000000028e900
- (void)_cleanupUntrackedValidators;	// IMP=0x001000000028e410
- (void)sendRegistration:(id)arg1;	// IMP=0x001000000028d790
- (void)dealloc;	// IMP=0x001000000028d510
- (id)initWithRestoreMonitor:(id)arg1 systemMonitor:(id)arg2;	// IMP=0x001000000028d2a0
- (id)init;	// IMP=0x001000000028d1e0
