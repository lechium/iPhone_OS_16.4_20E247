...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000007b440
- (void).cxx_destruct;	// IMP=0x002000000007b7c0
...
- (id)description;	// IMP=0x001000000007b660
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000007b500
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000007b460
