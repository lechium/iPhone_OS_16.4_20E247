...
- (void).cxx_destruct;	// IMP=0x0020000000213fc0
...
- (id)description;	// IMP=0x0010000000213e90
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x0010000000213da0
