...
- (void).cxx_destruct;	// IMP=0x00200000005bda70
...
- (void)purgeData;	// IMP=0x00100000005bd6e0
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000005bd5d0
- (id)data;	// IMP=0x00100000005bd530
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00100000005bd1d0
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000005bd0e0
