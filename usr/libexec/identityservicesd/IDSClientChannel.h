...
- (void).cxx_destruct;	// IMP=0x002000000005e870
...
- (void)osChannelInfoLog;	// IMP=0x001000000005e4c0
- (void)invalidate;	// IMP=0x001000000005e4b0
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x001000000005e480
- (_Bool)writePacketBuffer:(CDStruct_dc2926a3 *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x001000000005e450
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x001000000005e420
- (void)connectWithProtocoHandler;	// IMP=0x001000000005e410
- (_Bool)connectWithTransportThread;	// IMP=0x001000000005e3f0
- (id)initWithDestination:(id)arg1;	// IMP=0x001000000005e310
