...
- (void).cxx_destruct;	// IMP=0x0020000000571520
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000571250
- (id)bagKey;	// IMP=0x0010000000571230
- (id)messageBody;	// IMP=0x0010000000570f00
- (id)additionalMessageHeaders;	// IMP=0x0010000000570b80
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000570960
