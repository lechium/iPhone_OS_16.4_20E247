...
- (void).cxx_destruct;	// IMP=0x002000000000fbf0
...
- (id)messageBody;	// IMP=0x001000000000f070
- (id)requiredKeys;	// IMP=0x001000000000eff0
- (id)bagKey;	// IMP=0x001000000000efd0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000eec0
