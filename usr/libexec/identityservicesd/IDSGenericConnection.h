...
- (void).cxx_destruct;	// IMP=0x00200000005e4a80
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000005e2fd0
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000005e2860
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00100000005e2640
- (void)invalidate;	// IMP=0x00100000005e1c70
- (void)dealloc;	// IMP=0x00100000005e1b60
- (void)_closeSockets;	// IMP=0x00100000005e1450
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000005e1000
- (id)flagsString;	// IMP=0x00100000005e0f00
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000005e0ee0
- (id)description;	// IMP=0x00100000005e0970
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00100000005e0570
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00100000005e0150
