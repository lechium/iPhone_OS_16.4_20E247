...
- (void).cxx_destruct;	// IMP=0x0020000000095b90
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000956f0
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x00100000000955d0
