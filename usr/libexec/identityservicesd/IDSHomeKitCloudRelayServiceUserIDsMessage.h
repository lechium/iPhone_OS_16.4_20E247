...
- (void).cxx_destruct;	// IMP=0x00200000006de4b0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000006de080
- (id)messageBody;	// IMP=0x00100000006ddef0
- (id)bagKey;	// IMP=0x00100000006dded0
- (id)additionalMessageHeaders;	// IMP=0x00100000006ddca0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006ddb60
