...
- (void).cxx_destruct;	// IMP=0x002000000002d340
...
- (id)initWithUser:(id)arg1 phoneSignature:(id)arg2 certificateSigningRequest:(id)arg3 pushToken:(id)arg4;	// IMP=0x001000000002d160
