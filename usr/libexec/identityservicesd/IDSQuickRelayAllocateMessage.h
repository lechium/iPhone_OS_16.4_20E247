...
- (void).cxx_destruct;	// IMP=0x002000000059aae0
...
// Error: Property attributes should begin with the type ('T') attribute, property name: infoAttribute
...
- (id)description;	// IMP=0x0010000000599020
- (unsigned long long)requestLength;	// IMP=0x00100000005988b0
- (unsigned long long)_recipientDataSize;	// IMP=0x0010000000597450
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000597410
- (_Bool)wantsAPSRetries;	// IMP=0x00100000005973f0
- (id)messageBody;	// IMP=0x00100000005960a0
- (id)requiredKeys;	// IMP=0x0010000000595f90
- (long long)responseCommand;	// IMP=0x0010000000595f70
- (long long)command;	// IMP=0x0010000000595f50
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x0010000000595f30
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000595f10
- (_Bool)wantsCompressedBody;	// IMP=0x0010000000595ef0
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000595ed0
- (_Bool)wantsBagKey;	// IMP=0x0010000000595eb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000595120
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000588b70
- (id)init:(id)arg1;	// IMP=0x0010000000588950
