...
- (void).cxx_destruct;	// IMP=0x0020000000454750
...
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000454680
- (id)messageBody;	// IMP=0x0010000000454480
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004543c0
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x0010000000454290
