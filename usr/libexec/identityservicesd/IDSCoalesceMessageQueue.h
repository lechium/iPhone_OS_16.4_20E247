...
- (void).cxx_destruct;	// IMP=0x00200000002a3c20
...
- (unsigned long long)count;	// IMP=0x00100000002a3ad0
- (_Bool)isEmpty;	// IMP=0x00100000002a3a70
- (id)initWithTopic:(id)arg1 sendMode:(id)arg2;	// IMP=0x00100000002a3970
