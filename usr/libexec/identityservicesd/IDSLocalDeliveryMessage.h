...
@interface IDSLocalDeliveryMessage : NSObject
{
    ...
    MISSING_TYPE *_expirationDate;	// 80 = 0x50
...
- (id)socketPairMessage;	// IMP=0x00100000002ed340
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000002ed2e0
- (void)kickProgressBlock;	// IMP=0x00100000002ed130
- (id)init;	// IMP=0x00100000002ecea0
