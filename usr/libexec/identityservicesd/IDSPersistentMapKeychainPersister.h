...
- (void).cxx_destruct;	// IMP=0x00200000005ba8b0
...
- (void)purgeData;	// IMP=0x00100000005ba630
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000005ba220
- (id)data;	// IMP=0x00100000005b9e80
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00100000005b9cf0
