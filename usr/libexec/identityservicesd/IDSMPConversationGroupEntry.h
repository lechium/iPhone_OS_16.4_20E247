...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x00400000001bd080
- (void).cxx_destruct;	// IMP=0x00200000001bdb30
...
- (id)description;	// IMP=0x00100000001bd7c0
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x00100000001bd440
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00100000001bce40
