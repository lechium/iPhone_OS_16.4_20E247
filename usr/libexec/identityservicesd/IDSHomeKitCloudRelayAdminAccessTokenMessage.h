...
- (void).cxx_destruct;	// IMP=0x00200000004e6410
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000004e6010
- (id)bagKey;	// IMP=0x00100000004e5ff0
- (id)messageBody;	// IMP=0x00100000004e5d20
- (id)additionalMessageHeaders;	// IMP=0x00100000004e59a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004e5730
