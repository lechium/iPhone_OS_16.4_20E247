...
- (void).cxx_destruct;	// IMP=0x0020000000720d50
...
- (id)description;	// IMP=0x0010000000720c30
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x0010000000720b40
