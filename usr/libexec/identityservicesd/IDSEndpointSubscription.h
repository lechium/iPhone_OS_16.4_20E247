...
- (void).cxx_destruct;	// IMP=0x0020000000016310
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x00100000000160f0
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x0010000000015b30
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x00100000000157f0
- (id)resolvedEndpoints;	// IMP=0x0010000000015530
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014e40
- (id)peerIDManager;	// IMP=0x0010000000014e10
- (id)description;	// IMP=0x0010000000014d00
- (void)dealloc;	// IMP=0x0010000000014c80
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x0010000000014ad0
