...
- (id)initWithUsedLastResortCache:(_Bool)arg1 usedCachedData:(_Bool)arg2;	// IMP=0x0010000000224fd0
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x0010000000224f70
- (id)init;	// IMP=0x0010000000224f10
- (id)initWithEncryptionType:(long long)arg1 usedLastResortCache:(_Bool)arg2 usedCachedData:(_Bool)arg3;	// IMP=0x0010000000224e50
