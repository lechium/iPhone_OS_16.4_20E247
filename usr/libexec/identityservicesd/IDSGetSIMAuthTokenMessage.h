...
- (void).cxx_destruct;	// IMP=0x002000000073da10
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000073d590
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x001000000073d570
- (id)bagKey;	// IMP=0x001000000073d550
- (id)requiredKeys;	// IMP=0x001000000073d4f0
- (id)messageBody;	// IMP=0x001000000073cd60
- (id)additionalMessageHeaders;	// IMP=0x001000000073cb10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000073c800
