...
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x0020000000575640
...
- (id)initWithMessage:(id)arg1 fromID:(id)arg2 topic:(id)arg3 guid:(id)arg4 isLocal:(_Bool)arg5;	// IMP=0x00100000005752e0
