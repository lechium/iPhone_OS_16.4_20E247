...
- (void).cxx_destruct;	// IMP=0x00100000006f4530
...
- (id)debugDescription;	// IMP=0x00100000006eff40
- (id)description;	// IMP=0x00100000006ef9c0
- (id)_userStore;	// IMP=0x00100000006ef920
- (id)_user;	// IMP=0x00100000006ef8a0
- (void)voidPassword;	// IMP=0x00100000006ef530
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x00100000006ef2f0
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006ed490
...
- (id)_userID;	// IMP=0x00100000006eaf00
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x00100000006ead80
- (void)addCandidateEmail:(id)arg1;	// IMP=0x00100000006eac60
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x00100000006eabe0
- (_Bool)removeFromKeychain;	// IMP=0x00100000006eab80
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000006e46a0
- (id)init;	// IMP=0x00100000006e4610
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x00100000006e4510
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006e44f0
- (id)_keychain_comparisonValue;	// IMP=0x0010000000394070
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x0010000000393e10
