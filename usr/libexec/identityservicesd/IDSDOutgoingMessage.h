...
@interface IDSDOutgoingMessage : NSObject
{
    ...
    _Bool _wantsFirewallDonation;	// 257 = 0x101
    NSNumber *_pushPriority;	// 264 = 0x108
    NSNumber *_sendMode;	// 272 = 0x110
}

- (void).cxx_destruct;	// IMP=0x00200000005750d0
