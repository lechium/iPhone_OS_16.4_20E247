...
- (void).cxx_destruct;	// IMP=0x002000000000fda3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000f246
- (unsigned long long)hash;	// IMP=0x001000000000ebb6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e0c6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000d989
- (void)copyTo:(id)arg1;	// IMP=0x001000000000d377
- (void)writeTo:(id)arg1;	// IMP=0x001000000000cd6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000cd60
- (id)dictionaryRepresentation;	// IMP=0x001000000000afad
- (id)description;	// IMP=0x001000000000aefe
