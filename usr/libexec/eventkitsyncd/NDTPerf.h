...
+ (long long)cpuTime;	// IMP=0x0040000000056b71
+ (long long)dirtyMemory;	// IMP=0x0010000000056afa
+ (long long)wallTime;	// IMP=0x0010000000056a93
+ (id)nowMinusPrevious:(id)arg1;	// IMP=0x00100000000569b4
...
- (id)description;	// IMP=0x0010000000056beb
- (double)cpuTimeMs;	// IMP=0x0010000000056963
- (id)init;	// IMP=0x001000000005687a
