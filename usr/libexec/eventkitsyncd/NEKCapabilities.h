...
+ (id)instance;	// IMP=0x004000000003c630
- (void).cxx_destruct;	// IMP=0x002000000003ca7e
@property(retain, nonatomic) NSMutableDictionary *cache; // @synthesize cache=_cache;
- (void)_changed:(id)arg1;	// IMP=0x001000000003ca03
- (_Bool)_query:(id)arg1;	// IMP=0x001000000003c89b
@property(readonly, nonatomic) _Bool canUseDataTransfer;
@property(readonly, nonatomic) _Bool canUseLzfse;
- (void)dealloc;	// IMP=0x001000000003c764
- (id)init;	// IMP=0x001000000003c685
