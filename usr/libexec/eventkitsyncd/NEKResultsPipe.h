...
- (void).cxx_destruct;	// IMP=0x002000000006b208
@property(readonly, nonatomic) _Bool isDeferrable; // @synthesize isDeferrable=_isDeferrable;
- (void)markAsDeferrable;	// IMP=0x001000000006b1c4
- (void)markAsTruncated;	// IMP=0x001000000006b190
@property(readonly, nonatomic) _Bool isTruncated;
- (void)markAsNotEffectivelyEmpty;	// IMP=0x001000000006b125
@property(readonly, nonatomic) _Bool isEffectivelyEmpty;
@property(readonly, nonatomic) CDUnknownBlockType completion;
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006aeaf
- (void)sealCompletions;	// IMP=0x001000000006ae6e
- (id)initWithFIFOLength:(long long)arg1 name:(id)arg2;	// IMP=0x001000000006ade8
