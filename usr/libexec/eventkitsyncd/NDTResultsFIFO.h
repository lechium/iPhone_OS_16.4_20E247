...
- (void).cxx_destruct;	// IMP=0x002000000004086b
...
- (id)description;	// IMP=0x00100000000406aa
- (void)terminateIfNotFinished;	// IMP=0x00100000000405ca
- (void)terminate;	// IMP=0x00100000000404fe
- (id)pop;	// IMP=0x00100000000403ed
- (void)conditionalPop:(CDUnknownBlockType)arg1;	// IMP=0x000000000004012b
- (void)finish;	// IMP=0x0010000000040071
- (_Bool)push:(id)arg1;	// IMP=0x001000000003fe23
- (id)initWithFIFOLength:(long long)arg1 name:(id)arg2;	// IMP=0x001000000003fd50
- (id)init;	// IMP=0x001000000003fd37
