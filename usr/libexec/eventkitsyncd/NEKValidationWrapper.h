...
+ (_Bool)validationEnabled;	// IMP=0x0020000000013174
+ (id)validationWrapperForPb:(id)arg1;	// IMP=0x0010000000013041
+ (id)validationWrapperForSameSpan:(id)arg1;	// IMP=0x0010000000012f82
+ (id)validationWrapperForRightNow;	// IMP=0x0010000000012eae
- (void).cxx_destruct;	// IMP=0x0020000000013ce3
...
- (void)validate;	// IMP=0x0010000000013aa9
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000013749
@property(readonly, nonatomic) NSString *sequencer;
@property(readonly, nonatomic) NSString *objectIdentifier;
@property(readonly, nonatomic) long long changeType;
- (void)_countEvents;	// IMP=0x001000000001317c
