...
- (void).cxx_destruct;	// IMP=0x00200000000485c8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004821e
- (unsigned long long)hash;	// IMP=0x00100000000480ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000047e8b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000047cb0
- (void)copyTo:(id)arg1;	// IMP=0x0010000000047b4d
- (void)writeTo:(id)arg1;	// IMP=0x0010000000047a01
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000479f4
- (id)dictionaryRepresentation;	// IMP=0x00100000000471b5
- (id)description;	// IMP=0x0010000000047106
