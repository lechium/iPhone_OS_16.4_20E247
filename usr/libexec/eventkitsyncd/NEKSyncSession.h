...
- (void).cxx_destruct;	// IMP=0x00200000000567fa
...
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x00100000000565b5
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x00100000000564ca
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000557eb
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x00100000000551c2
- (void)dealloc;	// IMP=0x0010000000055188
- (id)init;	// IMP=0x0010000000055096
