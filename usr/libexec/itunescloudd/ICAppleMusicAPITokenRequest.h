...
- (void).cxx_destruct;	// IMP=0x00200000000913ca
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000091236
- (unsigned long long)hash;	// IMP=0x0010000000091160
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000090fc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000090e9b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000090db4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000090ac2
- (id)dictionaryRepresentation;	// IMP=0x001000000009092d
- (id)description;	// IMP=0x001000000009087e
