...
- (void).cxx_destruct;	// IMP=0x00200000000ed826
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000ed776
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000ed6d3
