...
- (void).cxx_destruct;	// IMP=0x00200000000458d7
...
- (void)main;	// IMP=0x0010000000045354
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x0010000000045233
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x00100000000451cf
