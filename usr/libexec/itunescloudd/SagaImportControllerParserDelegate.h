...
- (void).cxx_destruct;	// IMP=0x002000000011d7db
...
- (void)parser:(id)arg1 didEndContainerCode:(unsigned int)arg2;	// IMP=0x001000000011d6d8
- (void)parser:(id)arg1 didParseDataCode:(unsigned int)arg2 bytes:(char *)arg3 contentLength:(unsigned int)arg4;	// IMP=0x001000000011d5d1
- (void)parser:(id)arg1 didStartContainerCode:(unsigned int)arg2 contentLength:(unsigned int)arg3;	// IMP=0x001000000011d5a2
- (_Bool)parser:(id)arg1 shouldParseCodeAsContainer:(unsigned int)arg2;	// IMP=0x001000000011d54c
- (_Bool)parser:(id)arg1 shouldParseCode:(unsigned int)arg2;	// IMP=0x001000000011d45b
- (void)parserDidStart:(id)arg1;	// IMP=0x001000000011d43d
- (id)init;	// IMP=0x001000000011d3d7
