...
- (void).cxx_destruct;	// IMP=0x002000000006e14f
...
- (id)debugDescription;	// IMP=0x001000000006df64
- (_Bool)isValid;	// IMP=0x001000000006df5b
- (id)initWithSong:(id)arg1;	// IMP=0x001000000006dbb7
