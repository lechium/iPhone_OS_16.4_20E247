...
- (void).cxx_destruct;	// IMP=0x0020000000043c5f
...
- (id)_createBag;	// IMP=0x0010000000043c02
- (void)userNotificationCenter:(id)arg1 didReceiveNotificationResponse:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000043adc
- (void)userNotificationCenter:(id)arg1 didChangeSettings:(id)arg2;	// IMP=0x0010000000043901
- (id)init;	// IMP=0x00100000000437b2
