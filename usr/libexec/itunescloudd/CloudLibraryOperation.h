...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000823fa
- (void).cxx_destruct;	// IMP=0x0020000000082363
...
- (id)description;	// IMP=0x0010000000082237
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008219f
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000820c3
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x0010000000081f69
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000081f07
- (id)init;	// IMP=0x0010000000081ec7
