...
- (void)unfavoritePlaylistWithGlobalID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)unfavoriteArtistWithCloudLibraryID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)unfavoriteAlbumWithCloudLibraryID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)unfavoriteEntityWithSagaID:(long long)arg1 entityType:(long long)arg2 time:(NSDate *)arg3 configuration:(ICConnectionConfiguration *)arg4 completionHandler:(void (^)(NSError *))arg5;
- (void)unfavoriteEntityWithStoreID:(long long)arg1 entityType:(long long)arg2 time:(NSDate *)arg3 configuration:(ICConnectionConfiguration *)arg4 completionHandler:(void (^)(NSError *))arg5;
- (void)favoriteArtistWithCloudLibraryID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)favoriteAlbumWithCloudLibraryID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)favoriteEntityWithSagaID:(long long)arg1 entityType:(long long)arg2 time:(NSDate *)arg3 configuration:(ICConnectionConfiguration *)arg4 completionHandler:(void (^)(NSError *))arg5;
- (void)favoritePlaylistWithGlobalID:(NSString *)arg1 time:(NSDate *)arg2 configuration:(ICConnectionConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)favoriteEntityWithStoreID:(long long)arg1 entityType:(long long)arg2 time:(NSDate *)arg3 configuration:(ICConnectionConfiguration *)arg4 completionHandler:(void (^)(NSError *))arg5;
