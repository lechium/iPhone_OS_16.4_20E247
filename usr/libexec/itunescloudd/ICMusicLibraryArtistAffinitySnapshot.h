...
- (void).cxx_destruct;	// IMP=0x0020000000071c93
...
- (id)debugDescription;	// IMP=0x0010000000071a4b
- (float)legacyScore;	// IMP=0x0010000000071933
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000071640
