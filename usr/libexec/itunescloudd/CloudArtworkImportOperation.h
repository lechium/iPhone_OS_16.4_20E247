...
- (void).cxx_destruct;	// IMP=0x00200000000bbe28
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000bb9f0
- (void)cancel;	// IMP=0x00100000000bb997
- (void)start;	// IMP=0x00100000000bb03a
- (id)description;	// IMP=0x00100000000baf6a
- (void)callCompletionHandlers;	// IMP=0x00100000000badde
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000bad40
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000bac16
