...
- (void).cxx_destruct;	// IMP=0x0020000000020729
- (void)cancel;	// IMP=0x00100000000206e0
- (void)main;	// IMP=0x001000000001fcbd
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 dictionary:(id)arg3;	// IMP=0x001000000001fb00
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001fa7a
