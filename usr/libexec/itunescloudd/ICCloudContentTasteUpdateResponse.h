...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x0040000000043db0
- (void).cxx_destruct;	// IMP=0x0020000000043d88
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x0010000000043c93
