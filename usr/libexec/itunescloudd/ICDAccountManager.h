...
- (void).cxx_destruct;	// IMP=0x0020000000106b45
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x0010000000106a57
- (id)_buildStateChange;	// IMP=0x0010000000106855
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x001000000010628c
- (void)updateState;	// IMP=0x001000000010607f
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000105e1b
