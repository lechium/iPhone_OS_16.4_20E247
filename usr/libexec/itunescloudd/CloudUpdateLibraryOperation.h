...
- (void).cxx_destruct;	// IMP=0x00200000001041ee
...
- (void)_clearAllCloudIDs;	// IMP=0x0010000000103f64
- (id)_determineResultsURLWhenReadyWithUpdateID:(id)arg1 retryTimeout:(double)arg2 responseStatusCode:(out long long *)arg3;	// IMP=0x0010000000103873
- (_Bool)_updateLibrary;	// IMP=0x001000000010250b
- (void)_prepareLibraryForInitialUpdate;	// IMP=0x0010000000102408
- (_Bool)_uploadLibrary;	// IMP=0x00100000000ff68a
- (_Bool)_ensureDeviceIsRegistered;	// IMP=0x00100000000ff56f
- (void)main;	// IMP=0x00100000000fdbeb
- (void)cancel;	// IMP=0x00100000000fdaa1
@property(readonly, nonatomic) float progress;
@property(readonly, nonatomic, getter=isInitialUpdate) _Bool initialUpdate;
- (void)dealloc;	// IMP=0x00100000000fda31
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 reason:(long long)arg3 updateTaskHelper:(id)arg4;	// IMP=0x00100000000fd99c
