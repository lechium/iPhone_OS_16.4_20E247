...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x004000000009c864
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x001000000009c7a7
- (void).cxx_destruct;	// IMP=0x002000000009c75e
...
- (id)description;	// IMP=0x001000000009c66f
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x001000000009c556
