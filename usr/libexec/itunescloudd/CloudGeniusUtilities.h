...
- (void).cxx_destruct;	// IMP=0x002000000009278d
...
- (void)_initializeMappings;	// IMP=0x001000000009159f
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x001000000009151a
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x0010000000091504
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x001000000009147f
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x0010000000091469
- (id)init;	// IMP=0x001000000009141d
