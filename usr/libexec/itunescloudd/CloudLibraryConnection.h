...
- (void).cxx_destruct;	// IMP=0x00200000000d72b1
...
- (void)disconnect;	// IMP=0x00100000000d71f7
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000d70f0
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d5b40
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d5a64
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000d593d
