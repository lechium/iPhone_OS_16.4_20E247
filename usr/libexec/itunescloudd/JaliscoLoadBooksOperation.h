...
- (void).cxx_destruct;	// IMP=0x00200000000c2c8c
...
- (id)metadataFilter;	// IMP=0x00100000000c2c02
- (id)queryFilter;	// IMP=0x00100000000c2b95
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000c2b72
- (void)main;	// IMP=0x00100000000c24a1
