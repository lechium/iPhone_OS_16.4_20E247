...
- (void).cxx_destruct;	// IMP=0x0020000000066890
...
- (id)initWithArtworkImporter:(id)arg1 clientIdentity:(id)arg2 operationQueue:(id)arg3 artistPersistentIDsToUpdate:(id)arg4 albumArtistPersistentIDsToUpdate:(id)arg5;	// IMP=0x0010000000066639
