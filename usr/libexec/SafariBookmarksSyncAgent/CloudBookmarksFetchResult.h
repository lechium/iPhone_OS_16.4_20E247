...
- (void).cxx_destruct;	// IMP=0x0020000000040134
...
- (void)addDeletedRecordID:(id)arg1;	// IMP=0x00100000000400b3
- (void)addRecord:(id)arg1;	// IMP=0x001000000003ff20
...
- (id)init;	// IMP=0x001000000003fb25
