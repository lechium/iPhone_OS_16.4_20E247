...
- (void).cxx_destruct;	// IMP=0x00200000000a2de4
- (void)addItem:(id)arg1;	// IMP=0x00100000000a29d2
...
- (unsigned long long)_sizeOfRecordUpdateBatch:(id)arg1;	// IMP=0x00100000000a23de
@property(readonly, nonatomic) _Bool isFull;
@property(readonly, nonatomic) _Bool isEmpty;
- (id)init;	// IMP=0x00100000000a2015
