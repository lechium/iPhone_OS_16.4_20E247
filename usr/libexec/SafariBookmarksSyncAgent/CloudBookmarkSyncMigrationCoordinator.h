...
- (void).cxx_destruct;	// IMP=0x0020000000072048
...
- (void)resetToNonMigratedStateInOperationGroup:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000071dfe
- (void)_didFinishMigrationWithError:(id)arg1;	// IMP=0x0010000000071b1b
- (void)_beginMigrationAsPrimaryMigrator:(_Bool)arg1 inOperationGroup:(id)arg2;	// IMP=0x0010000000071872
- (void)beginMigratingAsPrimaryMigrator:(_Bool)arg1 inOperationGroup:(id)arg2 willBeginMigrationHandler:(CDUnknownBlockType)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000712f1
@property(nonatomic) long long localMigrationState;
- (id)initWithBookmarkStore:(id)arg1 databaseCoordinator:(id)arg2 accountStore:(id)arg3;	// IMP=0x0010000000071102
- (id)init;	// IMP=0x00100000000710f4
