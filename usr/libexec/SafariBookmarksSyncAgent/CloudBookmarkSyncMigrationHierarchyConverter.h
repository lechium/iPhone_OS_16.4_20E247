...
- (void).cxx_destruct;	// IMP=0x00200000000a0afe
...
- (id)_cloudKitRecordNameForBookmarkDAVServerSyncId:(id)arg1;	// IMP=0x00100000000a09db
- (void)_convertItem:(void *)arg1;	// IMP=0x00100000000a064a
- (_Bool)convertRecordsForMigration;	// IMP=0x00100000000a02d9
- (void)dealloc;	// IMP=0x00100000000a029a
- (id)initWithDatabase:(void *)arg1 databaseAccessor:(id)arg2;	// IMP=0x00100000000a0209
