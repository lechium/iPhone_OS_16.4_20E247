...
- (void).cxx_destruct;	// IMP=0x0020000000021731
@property(nonatomic) __weak id <DRSessionViewDelegate> delegate; // @synthesize delegate=_delegate;
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00100000000216af
- (void)layoutSubviews;	// IMP=0x0010000000021663
@property(readonly, nonatomic) DRFlockContainer *flockContainer;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000215c8
