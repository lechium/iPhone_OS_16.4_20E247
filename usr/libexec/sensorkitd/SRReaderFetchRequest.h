...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000b9a0
@property _Bool bypassHoldingPeriod; // @synthesize bypassHoldingPeriod=_bypassHoldingPeriod;
- (void)setTo:(double)arg1;	// IMP=0x001000000000bba0
- (double)to;	// IMP=0x001000000000bb90
@property double from; // @synthesize from=_from;
@property(readonly, copy) NSString *description;
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000ba40
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000b9b0
@property(retain, nonatomic) NSString *deviceIdentifier;
@property(retain, nonatomic) NSString *bundleIdentifier;
@property(retain, nonatomic) NSString *sensor;
- (void)dealloc;	// IMP=0x001000000000b890
- (id)init;	// IMP=0x001000000000b840
