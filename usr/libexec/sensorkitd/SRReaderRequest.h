...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000b210
...
- (void)dealloc;	// IMP=0x001000000000b380
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000b290
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000b220
