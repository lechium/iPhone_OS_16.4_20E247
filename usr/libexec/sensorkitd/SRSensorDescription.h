...
@interface SRSensorDescription : NSObject
{
    ...
    double _roundingInterval;	// 144 = 0x90
    NSString *_legacySampleClass;	// 152 = 0x98
    NSSet *_additions;	// 160 = 0xa0
    NSDictionary *_supportedPlatforms;	// 168 = 0xa8
}

+ (id)sensorDescriptionsForAuthorizationService:(id)arg1;	// IMP=0x0040000000033830
+ (id)sensorDescriptionForDeletionRecordFromDescription:(id)arg1;	// IMP=0x0010000000033300
+ (id)sensorDescriptionForSensor:(id)arg1;	// IMP=0x0010000000032f60
+ (void)initialize;	// IMP=0x0010000000032f10
...
- (id)description;	// IMP=0x0010000000033750
- (void)dealloc;	// IMP=0x0010000000033650
@property(readonly) _Bool supportsCurrentPlatform;
- (_Bool)supportsPlatform:(id)arg1;	// IMP=0x00100000000335d0
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000032f90
