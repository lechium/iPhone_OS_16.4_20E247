...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000b9d3
- (void).cxx_destruct;	// IMP=0x002000000000bf8b
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000ba9d
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000b941
