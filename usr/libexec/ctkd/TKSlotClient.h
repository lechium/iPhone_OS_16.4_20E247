...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000bfdd
- (void).cxx_destruct;	// IMP=0x002000000000c2a9
@property(readonly, nonatomic) NSString *slotType; // @synthesize slotType=_slotType;
- (void)dealloc;	// IMP=0x001000000000c245
@property(readonly, nonatomic) id <TKProtocolSlotClientNotification> notification;
- (void)reportChangesForSlotType:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000c0bc
