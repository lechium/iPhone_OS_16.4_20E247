...
- (void).cxx_destruct;	// IMP=0x0020000000002e61
...
- (void)run;	// IMP=0x0010000000002841
- (void)ensureSlotWatcherIsRunning;	// IMP=0x00100000000027bc
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x001000000000257a
...
- (void)initializeSandBox;	// IMP=0x0010000000002460
