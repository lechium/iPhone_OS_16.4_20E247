...
- (void).cxx_destruct;	// IMP=0x00200000000127ab
...
- (void)dealloc;	// IMP=0x0010000000012661
- (void)releaseTokenWithTokenID:(id)arg1;	// IMP=0x0010000000012529
- (_Bool)configureWithError:(id *)arg1;	// IMP=0x001000000001235f
- (id)acquireTokenWithSlot:(id)arg1 AID:(id)arg2 tokenID:(id *)arg3 error:(id *)arg4;	// IMP=0x0010000000011dd7
- (id)acquireTokenWithTokenID:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000011893
@property(readonly, nonatomic) TKTokenDriverHostContext *context;
- (id)contextWithError:(id *)arg1;	// IMP=0x001000000001094f
@property(readonly, nonatomic) _Bool valid;
- (void)invalidate;	// IMP=0x0010000000010882
- (void)keepAlive:(_Bool)arg1;	// IMP=0x001000000001073e
@property(readonly, nonatomic) NSString *classID;
- (id)description;	// IMP=0x00100000000104f5
- (id)initWithExtension:(id)arg1 cache:(id)arg2;	// IMP=0x001000000001045c
