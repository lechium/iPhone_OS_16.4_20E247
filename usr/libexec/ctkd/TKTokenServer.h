...
- (void).cxx_destruct;	// IMP=0x002000000000ffbd
...
- (id)pairingNotification:(id *)arg1;	// IMP=0x001000000000ff6a
- (void)stop;	// IMP=0x001000000000fe0a
- (void)start;	// IMP=0x001000000000fd05
- (void)dealloc;	// IMP=0x001000000000fca0
- (id)initWithTokenServer:(id)arg1 tokenRegistry:(id)arg2;	// IMP=0x001000000000faed
- (void)hostTokenRegistry:(id)arg1 removedToken:(id)arg2;	// IMP=0x001000000000f7e2
- (void)hostTokenRegistry:(id)arg1 addedToken:(id)arg2;	// IMP=0x001000000000f1cd
- (void)getEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f160
- (void)startWatchingWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000000eacf
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000e844
