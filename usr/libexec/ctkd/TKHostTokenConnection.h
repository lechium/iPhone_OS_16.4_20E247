...
- (void).cxx_destruct;	// IMP=0x0020000000001716
@property(readonly, nonatomic) TKHostToken *token; // @synthesize token=_token;
- (void)dealloc;	// IMP=0x001000000000159e
@property(readonly, nonatomic) NSString *slotName;
@property(readonly, nonatomic) NSXPCListenerEndpoint *endpoint;
- (id)initWithDriver:(id)arg1 slot:(id)arg2 AID:(id)arg3 registry:(id)arg4 error:(id *)arg5;	// IMP=0x001000000000124b
- (id)initWithToken:(id)arg1;	// IMP=0x00100000000011bb
