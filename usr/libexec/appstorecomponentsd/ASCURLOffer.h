...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001c536
- (void).cxx_destruct;	// IMP=0x002000000001d3ca
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001ccf2
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001ca00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001c9f5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001c82d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001c53e
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001c3c9
