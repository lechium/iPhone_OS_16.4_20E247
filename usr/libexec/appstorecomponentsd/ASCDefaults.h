...
+ (id)daemonDefaults;	// IMP=0x0020000000009db7
- (void).cxx_destruct;	// IMP=0x002000000000a99a
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x001000000000a8f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000a7ec
- (unsigned long long)hash;	// IMP=0x001000000000a771
...
- (id)objectForKey:(id)arg1;	// IMP=0x0010000000009f16
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000009e96
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000009e23
