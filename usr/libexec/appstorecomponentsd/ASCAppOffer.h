...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000005863
- (void).cxx_destruct;	// IMP=0x0020000000007181
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000655b
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000060a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000006099
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005dbd
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000586b
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x0010000000005607
