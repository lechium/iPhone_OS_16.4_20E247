...
- (void).cxx_destruct;	// IMP=0x004000000008f010
- (id)init;	// IMP=0x001000000008efb0
- (id)cookieForUrlWithName:(id)arg1:(id)arg2;	// IMP=0x001000000008ef20
- (id)cookiesForUrl:(id)arg1;	// IMP=0x001000000008ec40
