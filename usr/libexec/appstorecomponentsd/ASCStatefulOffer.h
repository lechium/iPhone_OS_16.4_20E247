...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001aa90
- (void).cxx_destruct;	// IMP=0x002000000001bbc7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001b327
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001afb8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001afad
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001ada1
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001aa98
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x001000000001a8d6
