...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000084e7
- (void).cxx_destruct;	// IMP=0x00200000000091f9
...
- (id)makeURLWithSubstitutions:(id)arg1;	// IMP=0x0010000000009029
- (id)description;	// IMP=0x0010000000008e9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000008b0a
- (unsigned long long)hash;	// IMP=0x00100000000089c1
@property(readonly, copy, nonatomic) NSString *URLTemplate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000008902
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000087a9
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000084ef
- (id)initWithURLTemplate:(id)arg1 width:(double)arg2 height:(double)arg3 decoration:(id)arg4 preferredCrop:(id)arg5 preferredFormat:(id)arg6;	// IMP=0x00100000000083b4
