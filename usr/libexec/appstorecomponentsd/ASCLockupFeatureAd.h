...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000e407
- (void).cxx_destruct;	// IMP=0x002000000000ef1e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e927
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e79b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000e60a
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000e40f
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x001000000000e2b6
