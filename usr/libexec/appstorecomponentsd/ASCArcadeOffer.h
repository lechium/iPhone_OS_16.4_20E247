...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000073bc
- (void).cxx_destruct;	// IMP=0x0020000000008355
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007bd6
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000078b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000078ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000076d6
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000073c4
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000007217
