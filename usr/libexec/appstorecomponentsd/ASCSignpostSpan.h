...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000019f37
- (void).cxx_destruct;	// IMP=0x002000000001a783
...
- (id)description;	// IMP=0x001000000001a608
- (void)endEmitting;	// IMP=0x001000000001a4f8
- (void)beginEmitting;	// IMP=0x001000000001a437
- (void)addSupplementaryTag:(unsigned long long)arg1;	// IMP=0x001000000001a3c1
@property(readonly, copy, nonatomic) NSDateInterval *dateRange;
@property(readonly, copy, nonatomic) NSSet *supplementaryTags;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001a10b
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000019f3f
- (id)init;	// IMP=0x0010000000019ecc
