...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000a7ea1
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000a7e9b
- (void)stop;	// IMP=0x00100000000a7e95
- (void)pause;	// IMP=0x00100000000a7e8f
- (void)start;	// IMP=0x00100000000a7e89
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000a7e7b
