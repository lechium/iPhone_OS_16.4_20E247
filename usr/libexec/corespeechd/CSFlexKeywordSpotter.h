...
- (void).cxx_destruct;	// IMP=0x002000000001051b
...
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x00100000000103da
- (void)reset;	// IMP=0x001000000001031b
- (void)speechRecognizer:(id)arg1 didRecognizePartialResultNbest:(id)arg2;	// IMP=0x001000000000f99a
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x001000000000f8f7
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x001000000000f854
- (void)processAudioChunk:(id)arg1;	// IMP=0x001000000000f66e
- (void)startKeywordSpottingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ef17
- (id)init;	// IMP=0x001000000000eeb7
