...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0010000000035b9c
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0010000000035b2a
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x0010000000035abd
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000035a4b
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x0010000000032f2f
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000038164
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000034dfb
- (id)_sha256:(id)arg1;	// IMP=0x001000000004ed7b
- (id)_sha1:(id)arg1;	// IMP=0x001000000004ec8a
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004eae1
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004eaad
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004ea94
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004ea7b
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004ea62
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004ea45
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004ea25
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004e201
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004de33
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004ddcd
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004dd99
...
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000084e3c
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x00100000000c4f6f
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x00100000000c4f0a
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x00100000000c4ee8
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c4e36
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c4d84
...
- (id)nldaConfigFile;	// IMP=0x00100000000c4be7
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x00100000000c4aed
