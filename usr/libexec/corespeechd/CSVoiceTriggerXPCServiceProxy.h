...
+ (id)sharedInstance;	// IMP=0x00400000000098e4
...
- (id)fetchVoiceTriggerStats;	// IMP=0x001000000000ae24
- (void)notifyServiceConnectionLost;	// IMP=0x001000000000abaa
- (void)notifyVoiceTriggeredSiriSessionCancelled;	// IMP=0x001000000000ab2b
- (void)setRaiseToSpeakBypassing:(_Bool)arg1 timeout:(double)arg2;	// IMP=0x001000000000a51c
- (void)setPhraseSpotterBypassing:(_Bool)arg1 timeout:(double)arg2;	// IMP=0x0010000000009f0d
- (void)enableVoiceTrigger:(_Bool)arg1 withAssertion:(id)arg2 timestamp:(double)arg3;	// IMP=0x001000000000999f
- (id)_fetchAssertionMonitor;	// IMP=0x0010000000009965
- (void)unregisterObserver:(id)arg1;	// IMP=0x001000000000994f
- (void)registerObserver:(id)arg1;	// IMP=0x0010000000009939
- (id)initWithAssertionMonitor:(id)arg1;	// IMP=0x0010000000009814
- (id)init;	// IMP=0x0010000000009800
