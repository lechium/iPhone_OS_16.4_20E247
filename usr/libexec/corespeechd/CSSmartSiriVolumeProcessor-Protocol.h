...
@class CSAsset, CSSmartSiriVolumeEstimate, MISSING_TYPE, NSDictionary, NSNumber;
...
- (MISSING_TYPE *)initWithSamplingRate:asset: /* Error: Ran out of types for this method. */;
@end
