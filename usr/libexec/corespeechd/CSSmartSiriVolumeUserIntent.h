...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000c70b9
- (void)storeASVStateInformation;	// IMP=0x00100000000c7066
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000c7045
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000c7024
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000c6ed8
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000c6dd0
