...
- (void).cxx_destruct;	// IMP=0x002000000005c9ee
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x001000000005c485
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x001000000005c47f
- (_Bool)_shouldReportBoron;	// IMP=0x001000000005c447
- (_Bool)_popRemoteVADSignal;	// IMP=0x001000000005c3c8
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x001000000005c342
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000005bfc6
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x001000000005bf17
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005bf00
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000005bb7a
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005b590
- (void)_resetAlignBuffer;	// IMP=0x001000000005b567
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000005b067
- (id)init;	// IMP=0x001000000005af79
