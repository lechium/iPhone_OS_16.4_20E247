...
+ (id)sharedMonitor;	// IMP=0x0040000000024f05
- (void).cxx_destruct;	// IMP=0x002000000002511d
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x00100000000250e5
- (void)startMonitoring;	// IMP=0x0010000000024fb9
- (id)init;	// IMP=0x0010000000024f5a
