...
- (void).cxx_destruct;	// IMP=0x0020000000097176
...
- (void)audioStreamProvider:(id)arg1 didHardwareConfigurationChange:(long long)arg2;	// IMP=0x0010000000096f01
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x0010000000096e3b
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2 lastForwardedSampleCount:(unsigned long long)arg3;	// IMP=0x0010000000096e25
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x0010000000096d5f
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x0010000000096a92
- (void)updateAudioStreamStartTimeInSampleCount:(unsigned long long)arg1;	// IMP=0x00100000000965cb
- (_Bool)isNarrowBand;	// IMP=0x0010000000096587
- (id)recordSettings;	// IMP=0x0010000000096537
- (_Bool)isStreaming;	// IMP=0x0010000000096422
- (void)stopAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095f77
- (void)startAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095c9a
- (void)prepareAudioStreamWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095c11
- (_Bool)prepareAudioStreamSyncWithRequest:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000095b91
- (void)dealloc;	// IMP=0x0010000000095a31
- (id)initWithAudioStreamProvider:(id)arg1 streamName:(id)arg2 streamRequest:(id)arg3;	// IMP=0x0010000000095830
