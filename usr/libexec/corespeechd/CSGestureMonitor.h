...
+ (id)sharedInstance;	// IMP=0x004000000004ee53
...
- (_Bool)isTriggerHandheld;	// IMP=0x001000000004eed9
- (void)_stopMonitoring;	// IMP=0x001000000004eed3
- (void)_startMonitoringWithQueue:(id)arg1;	// IMP=0x001000000004eecd
