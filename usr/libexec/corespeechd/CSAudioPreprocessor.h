...
- (void).cxx_destruct;	// IMP=0x0020000000098240
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x0010000000098102
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x0010000000098029
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x0010000000097ff5
- (id)_fetchCurrentMetrics;	// IMP=0x0010000000097e3b
- (void)_reportMetrics;	// IMP=0x0010000000097dc0
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x0010000000097dba
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x0010000000097d5a
- (void)flush;	// IMP=0x0010000000097c22
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x00100000000979ee
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000977b6
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x0010000000097680
