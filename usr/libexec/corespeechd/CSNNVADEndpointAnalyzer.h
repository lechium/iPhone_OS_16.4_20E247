...
- (void).cxx_destruct;	// IMP=0x002000000004da8b
...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000004d904
- (void)stopEndpointer;	// IMP=0x001000000004d885
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000004d806
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000004d787
- (void)reset;	// IMP=0x001000000004d708
- (void)preheat;	// IMP=0x001000000004d689
- (id)init;	// IMP=0x001000000004d5d2
