...
- (void).cxx_destruct;	// IMP=0x00200000000bd2a7
...
- (id)metrics;	// IMP=0x00100000000bd211
- (void)flush;	// IMP=0x00100000000bd188
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000bce9a
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000bcbdd
- (id)init;	// IMP=0x00100000000bcbae
