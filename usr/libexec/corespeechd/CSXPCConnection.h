...
- (void).cxx_destruct;	// IMP=0x00200000000d574d
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d5535
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00100000000d54da
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00100000000d5430
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d5272
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d5141
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d4ffc
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d4e84
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d4c04
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00100000000d4b3d
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00100000000d49c2
- (void)activateConnection;	// IMP=0x00100000000d48b9
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00100000000d4673
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000d4454
