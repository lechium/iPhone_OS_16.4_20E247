...
- (void).cxx_destruct;	// IMP=0x002000000008486c
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000846e3
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x0010000000083c87
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x0010000000083c81
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x0010000000083c7b
- (void)stopAudioStream;	// IMP=0x0010000000083b70
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000839fb
- (long long)getBestSampleCountWithOption:(id)arg1;	// IMP=0x0010000000083723
- (_Bool)isRecording;	// IMP=0x001000000008366f
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000083640
- (_Bool)injectAudio:(id)arg1;	// IMP=0x0010000000083611
- (void)stop;	// IMP=0x001000000008354c
- (void)start;	// IMP=0x0010000000083474
- (void)dealloc;	// IMP=0x00100000000833ba
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000832c8
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x0010000000083214
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x0010000000083195
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x001000000008318b
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x0010000000082ff4
