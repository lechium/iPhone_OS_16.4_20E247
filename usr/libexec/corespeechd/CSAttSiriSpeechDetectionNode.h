...
- (void).cxx_destruct;	// IMP=0x0020000000021e50
...
- (void)_startActivation;	// IMP=0x0010000000021ab8
- (void)attSiriNode:(id)arg1 didUpdateOSDFeatures:(id)arg2 withFrameDurationMs:(double)arg3;	// IMP=0x001000000002186b
- (void)stop;	// IMP=0x0010000000021812
- (void)pause;	// IMP=0x001000000002180c
- (void)start;	// IMP=0x0010000000021799
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000216df
- (void)addReceiver:(id)arg1;	// IMP=0x001000000002164a
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x001000000002157d
