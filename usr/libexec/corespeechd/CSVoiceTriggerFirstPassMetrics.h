...
+ (id)CSVoiceTriggerFirstPassMetricsWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x0040000000088d13
- (void).cxx_destruct;	// IMP=0x0020000000088d62
...
- (id)_initWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x0010000000088c66
