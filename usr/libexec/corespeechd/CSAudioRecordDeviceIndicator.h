...
- (void).cxx_destruct;	// IMP=0x00200000000e9932
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x00100000000e98fa
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x00100000000e975c
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00100000000e9693
