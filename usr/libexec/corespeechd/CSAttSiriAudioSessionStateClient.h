...
- (void).cxx_destruct;	// IMP=0x002000000000b6f9
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x001000000000b278
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x001000000000b198
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x001000000000b096
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000000af23
