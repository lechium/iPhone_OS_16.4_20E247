...
@class CESRXPCActivity, CSActivationXPCListener, CSAttSiriConnectionManager, CSAudioInjectionXPCListener, CSBenchmarkXPCListener, CSCoreSpeechServicesListener, CSDarwinVoiceTriggerHandlerPool, CSSpeechModelTrainingXPCManager, CSVoiceIdXPCListener, CSVoiceTriggerXPCListener, CSXPCActivity, CSXPCListener;
...
@interface CSHostDaemon : NSObject
{
    ...
    CSXPCActivity *_csXPCActivity;	// 112 = 0x70
}

+ (id)sharedDaemon;	// IMP=0x00400000000d63bf
- (void).cxx_destruct;	// IMP=0x00200000000d6d02
...
- (void)_daemonWillShutdown;	// IMP=0x00100000000d6af1
- (void)_setupDistnoteHandlers;	// IMP=0x00100000000d6aeb
- (void)_setupNotifyHandlers;	// IMP=0x00100000000d695b
- (void)_daemonDidLaunch;	// IMP=0x00100000000d6727
- (void)shutdown;	// IMP=0x00100000000d670f
- (void)didLaunch;	// IMP=0x00100000000d66fd
- (id)init;	// IMP=0x00100000000d6414
