...
- (void).cxx_destruct;	// IMP=0x00200000000d74b3
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000d740a
- (void)report;	// IMP=0x00100000000d7162
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000d6ea5
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000d6dba
