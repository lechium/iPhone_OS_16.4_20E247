...
- (void).cxx_destruct;	// IMP=0x00200000000de671
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000de50d
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000ddec0
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000ddeba
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000ddeb4
- (void)stopAudioStream;	// IMP=0x00100000000ddd94
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000ddc0a
- (_Bool)isRecording;	// IMP=0x00100000000ddb56
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ddb27
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000ddaf8
- (void)stop;	// IMP=0x00100000000dda33
- (void)start;	// IMP=0x00100000000dd95b
- (void)dealloc;	// IMP=0x00100000000dd8a1
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000dd7af
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000dd6fb
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000dd68f
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000dd687
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000dd51f
