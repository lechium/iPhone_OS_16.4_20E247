...
- (void).cxx_destruct;	// IMP=0x0020000000018df8
...
- (id)description;	// IMP=0x0010000000018d5b
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000018cbd
