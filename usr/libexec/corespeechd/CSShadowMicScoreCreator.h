...
- (void).cxx_destruct;	// IMP=0x00200000000bf975
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x00100000000bf669
- (void)_calculateSpeechVoicingLevel;	// IMP=0x00100000000bf3ce
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x00100000000bf389
- (void)calculateShadowMicScore;	// IMP=0x00100000000beff6
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00100000000befe0
- (id)init;	// IMP=0x00100000000bef59
