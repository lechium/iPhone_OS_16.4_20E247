...
@interface CSRemoteDeviceProtocolInfo : NSObject
{
    ...
    MISSING_TYPE *_deviceProductType;	// 32 = 0x20
    unsigned long long _deviceCategory;	// 40 = 0x28
}

+ (id)localDeviceProtocolInfo;	// IMP=0x00400000000610d4
+ (id)defaultProtocolInfo;	// IMP=0x0010000000061089
- (void).cxx_destruct;	// IMP=0x0020000000061565
...
- (id)description;	// IMP=0x00100000000614f1
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000061219
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x0010000000060fbe
