...
{
    MISSING_TYPE *_didReportEndpointDelay;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0020000000034dd3
...
- (void)_reportUEIUserSpeakingContext;	// IMP=0x0010000000034cf3
- (void)reportEndpointDelayIfNeed;	// IMP=0x0010000000034ced
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x0010000000034a41
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x00100000000349fd
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x00100000000349c7
- (void)reset;	// IMP=0x001000000003490d
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x00100000000347c3
