...
- (void).cxx_destruct;	// IMP=0x002000000006d42c
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x001000000006ce51
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x001000000006cdb3
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x001000000006cad9
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x001000000006ca63
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x001000000006c890
- (void)CSFirstUnlockMonitor:(id)arg1 didReceiveFirstUnlock:(_Bool)arg2;	// IMP=0x001000000006c7c6
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x001000000006c730
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x001000000006c673
...
- (void)reset;	// IMP=0x001000000006c65b
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x001000000006c377
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000006b6d2
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000006b6ca
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x001000000006b6c4
- (void)stopEndpointer;	// IMP=0x001000000006b62e
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000006b586
- (void)terminateProcessing;	// IMP=0x001000000006b513
- (void)preheat;	// IMP=0x001000000006b50d
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x001000000006b199
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x001000000006a96f
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x001000000006a95e
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x00100000000689c8
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000682db
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x001000000006800d
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x0010000000067f64
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x0010000000067eb7
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000006778d
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x001000000006746b
- (id)init;	// IMP=0x0010000000066cb9
