...
+ (id)entityName;	// IMP=0x00200000001619b4
- (id)internalRepresentation;	// IMP=0x002000000016150d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000160c1a
