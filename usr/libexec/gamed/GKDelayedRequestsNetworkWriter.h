...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0020000000116e1e
- (void).cxx_destruct;	// IMP=0x00200000001172c9
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000116f2c
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0010000000116e8e
