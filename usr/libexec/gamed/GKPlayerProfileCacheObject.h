...
@class GKAchievementPointsListCacheObject, GKChallengeListCacheObject, GKFriendListCacheObject, GKFriendRecommendationListCacheObject, GKFriendRequestListCacheObject, GKGameListCacheObject, GKGameRecommendationListCacheObject, NSDate, NSNumber, NSSet, NSString;

@interface GKPlayerProfileCacheObject
{
}

+ (id)entityName;	// IMP=0x002000000014f175
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014d4a2
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014d3fd
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x001000000014d315
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014d049
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x001000000014cda7
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000014c129
+ (id)uniqueAttributeName;	// IMP=0x001000000014c11c
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x00100000001508b0
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x001000000015088a
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x0010000000150256
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0010000000150022
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x001000000014fc21
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x001000000014fa1a
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x001000000014f825
+ (id)selfPlayerID;	// IMP=0x001000000014f7ce
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x001000000014f500
+ (id)_familiarityLookup;	// IMP=0x001000000014f30c
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x001000000014f182
- (id)internalRepresentation;	// IMP=0x001000000014efbe
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x001000000014ede0
- (void)updateContactsIntegrationInformationFromServerRepresentation:(id)arg1;	// IMP=0x001000000014ec79
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x001000000014dd11
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x001000000014d88a
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000014d875
- (void)deleteCachedImage:(id)arg1;	// IMP=0x001000000014c8ac
- (void)deleteCachedAvatars;	// IMP=0x001000000014c5e7
- (void)clearImages;	// IMP=0x001000000014c2b8
...
- (void)invalidate;	// IMP=0x001000000014c1ac
