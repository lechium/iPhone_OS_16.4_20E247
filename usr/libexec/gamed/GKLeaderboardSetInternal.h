...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d75b8
- (void).cxx_destruct;	// IMP=0x00100000001d797b
...
- (unsigned long long)hash;	// IMP=0x00100000001d787e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d77aa
