...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d6c8b
- (void).cxx_destruct;	// IMP=0x00200000001d745e
...
- (unsigned long long)hash;	// IMP=0x00100000001d712a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d7056
@property(readonly, nonatomic) unsigned long long maxRange;
@property(retain, nonatomic) NSString *localizedTitle;
@property(retain, nonatomic) NSString *category;
- (id);	// IMP=0x00100000001d755b
