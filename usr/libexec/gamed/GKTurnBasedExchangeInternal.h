...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000175222
- (void).cxx_destruct;	// IMP=0x002000000017574e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017556a
- (unsigned long long)hash;	// IMP=0x001000000017554d
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001c4b91
