...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000131027
- (void).cxx_destruct;	// IMP=0x00200000001315f2
...
- (unsigned long long)hash;	// IMP=0x001000000013148e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000131214
