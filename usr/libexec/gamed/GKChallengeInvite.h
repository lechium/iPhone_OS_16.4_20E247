...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000175e4b
- (void).cxx_destruct;	// IMP=0x00200000001776cf
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000176a10
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000175f32
- (id)initWithChallenge:(id)arg1;	// IMP=0x0010000000175ec7
- (id)challengeInternalObject;	// IMP=0x0010000000175ebf
- (id)description;	// IMP=0x0010000000175e53
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000175d66
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000175b5c
