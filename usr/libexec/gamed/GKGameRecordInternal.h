...
+ (id)secureCodedPropertyKeys;	// IMP=0x00200000001eff26
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x00100000001efce7
+ (id)_gameProperties;	// IMP=0x00100000001c123b
+ (id)propertiesToFetch;	// IMP=0x00100000001c0e93
- (void).cxx_destruct;	// IMP=0x00200000001f02a8
...
- (void)updateWithGame:(id)arg1;	// IMP=0x00100000001efd59
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001c1338
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001c0b5f
