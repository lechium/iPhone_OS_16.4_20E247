...
+ (id)entityName;	// IMP=0x002000000015815b
- (id)internalRepresentation;	// IMP=0x0020000000157e59
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000157832
