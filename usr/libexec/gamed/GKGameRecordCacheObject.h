...
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x0040000000157131
+ (id)fetchSortDescriptors;	// IMP=0x0010000000157002
+ (id)entityName;	// IMP=0x0010000000156ff5
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x00100000001552db
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x0010000000154f14
- (id)internalRepresentation;	// IMP=0x0020000000156e50
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x0010000000156bb4
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x0010000000156101
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000001553d3
