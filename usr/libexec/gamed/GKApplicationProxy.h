...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0040000000115103
- (void).cxx_destruct;	// IMP=0x002000000011573f
...
- (id)bundleURL;	// IMP=0x00100000001153b7
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000001150a9
- (id)initWithProxy:(id)arg1;	// IMP=0x0010000000115041
