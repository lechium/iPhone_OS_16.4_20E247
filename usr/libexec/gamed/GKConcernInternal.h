...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000011b58b
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000011b583
- (void).cxx_destruct;	// IMP=0x002000000011b7cc
...
- (unsigned long long)hash;	// IMP=0x001000000011b755
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011b685
