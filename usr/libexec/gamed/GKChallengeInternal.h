...
+ (id)internalRepresentation;	// IMP=0x0040000000004070
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000003c14
- (void).cxx_destruct;	// IMP=0x0020000000004792
...
- (id)descriptionSubstitutionMap;	// IMP=0x0010000000004616
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x00100000000041f8
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x001000000000408a
- (id)serverRepresentation;	// IMP=0x0010000000004078
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003fc3
- (unsigned long long)hash;	// IMP=0x0010000000003f7f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000003e4d
