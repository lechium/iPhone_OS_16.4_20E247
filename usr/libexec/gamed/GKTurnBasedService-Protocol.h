...
@class GKMatchRequestInternal, GKPlayerInternal, GKTurnBasedMatchInternal, MISSING_TYPE, NSArray, NSData, NSDictionary, NSString;
...
- (MISSING_TYPE *)getTurnBasedMatchesAndCompatibleBundleID:handler: /* Error: Ran out of types for this method. */;
