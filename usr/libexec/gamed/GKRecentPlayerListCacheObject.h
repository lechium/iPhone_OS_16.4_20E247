...
+ (Class)entryClass;	// IMP=0x00400000001619ce
+ (id)entityName;	// IMP=0x00100000001619c1
- (id)internalRepresentation;	// IMP=0x0020000000161c66
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000001619df
