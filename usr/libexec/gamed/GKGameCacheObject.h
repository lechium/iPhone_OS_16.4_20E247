...
+ (id)entityName;	// IMP=0x0020000000153995
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000151314
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000151155
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x0010000000150f96
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x0010000000150c9b
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000150b9c
+ (id)fetchSortDescriptors;	// IMP=0x0010000000150abd
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0010000000150ab0
+ (id)uniqueAttributeName;	// IMP=0x0010000000150aa3
- (id)gameDescriptor;	// IMP=0x0020000000153585
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x00100000001534e5
- (id)internalRepresentation;	// IMP=0x0010000000153340
- (_Bool)storePiecesExpired;	// IMP=0x00100000001532f3
- (_Bool)storePiecesValid;	// IMP=0x00100000001532c0
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000152ada
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000015215d
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x00100000001518c3
- (_Bool)isValid;	// IMP=0x0010000000151831
