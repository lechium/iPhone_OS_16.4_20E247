...
+ (long long)coalescingDelay;	// IMP=0x00200000000fed0e
+ (id)bagKey;	// IMP=0x00100000000fed01
- (void).cxx_destruct;	// IMP=0x00200000000fffab
...
- (id)requestIdentifier;	// IMP=0x00100000000ffe03
- (id)taskInfo;	// IMP=0x00100000000ffc88
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000ff997
- (id)postBody;	// IMP=0x00100000000ff909
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000ff8f4
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000ff8e1
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000ff479
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000ff1a3
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000fedc5
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000fed19
