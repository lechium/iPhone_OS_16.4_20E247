...
- (void).cxx_destruct;	// IMP=0x0020000000237e1f
...
- (id)sortSuggestions:(id)arg1 usingSortedContactsAssociationIDs:(id)arg2 suggestionMap:(id)arg3;	// IMP=0x00100000002378be
- (id)modifySuggestions:(id)arg1;	// IMP=0x0010000000236ec4
- (id)initWithSettings:(id)arg1 networkRequester:(id)arg2 cachedSortedAssociationIDs:(id)arg3 transactionGroupProvider:(CDUnknownBlockType)arg4 featureEnabledBlock:(CDUnknownBlockType)arg5;	// IMP=0x0010000000236db8
