...
- (void).cxx_destruct;	// IMP=0x00200000001d6183
...
- (void)_performTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00100000001d5dfa
- (id)_validateTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00100000001d5599
- (id)missingTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00100000001d5567
- (_Bool)_setCurrentState:(id)arg1;	// IMP=0x00100000001d52a9
@property(retain) NSString *currentState; // @synthesize currentState=_currentState;
- (_Bool)applyState:(id)arg1;	// IMP=0x00100000001d5285
- (id)init;	// IMP=0x00100000001d5213
