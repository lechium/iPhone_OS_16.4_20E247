...
+ (id)entityName;	// IMP=0x0040000000154f07
- (id)internalRepresentation;	// IMP=0x0020000000154eff
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000154c23
