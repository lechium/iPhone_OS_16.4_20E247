...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d81be
- (void).cxx_destruct;	// IMP=0x00200000001d849b
...
- (id)description;	// IMP=0x00100000001d8099
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x00100000001d7f63
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d7cf6
