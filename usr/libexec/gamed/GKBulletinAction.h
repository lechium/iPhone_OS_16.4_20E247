...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001f71ce
- (void).cxx_destruct;	// IMP=0x00200000001f7661
...
- (id)description;	// IMP=0x00100000001f745f
@property(readonly) NSDictionary *actionDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001f71d6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001f6e8a
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001f6b59
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000001f6a95
- (id)init;	// IMP=0x00100000001f6a5b
