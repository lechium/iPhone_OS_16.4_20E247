...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000c2083
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000000c1e4a
- (void).cxx_destruct;	// IMP=0x00100000000c27da
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000000c2681
...
- (unsigned long long)hash;	// IMP=0x00100000000c257b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c243f
- (id)serverRepresentation;	// IMP=0x00100000000c2262
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000c2163
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000c208b
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x00100000000c2871
