...
+ (id)entityName;	// IMP=0x0040000000157677
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000157155
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x002000000015741a
