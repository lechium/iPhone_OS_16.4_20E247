...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00200000001167e2
- (void).cxx_destruct;	// IMP=0x0020000000116ded
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001168f0
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0010000000116852
