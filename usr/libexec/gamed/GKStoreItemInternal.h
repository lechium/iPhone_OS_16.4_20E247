...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001ef410
- (void).cxx_destruct;	// IMP=0x00100000001efc61
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ef796
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x00100000001ef6cd
- (_Bool)isValid;	// IMP=0x00100000001ef69a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001ef5ed
- (unsigned long long)hash;	// IMP=0x00100000001ef5d0
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001c21c2
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000001c1c2b
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001c1784
