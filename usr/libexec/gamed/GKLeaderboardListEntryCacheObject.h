...
+ (id)entityName;	// IMP=0x0040000000158372
- (id)internalRepresentation;	// IMP=0x00200000001585e5
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000015837f
