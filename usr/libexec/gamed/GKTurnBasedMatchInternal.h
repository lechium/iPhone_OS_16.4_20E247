...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001732a0
- (void).cxx_destruct;	// IMP=0x00200000001748f1
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000001745a5
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x0010000000173c34
- (long long)previousParticipantIndex;	// IMP=0x00100000001739bd
- (long long)localPlayerParticipantIndex;	// IMP=0x001000000017392b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000173790
- (unsigned long long)hash;	// IMP=0x001000000017374c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001c3d34
