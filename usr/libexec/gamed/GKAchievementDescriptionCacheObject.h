...
+ (id)entityName;	// IMP=0x002000000015426b
- (id)internalRepresentation;	// IMP=0x0020000000153f26
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000153b3f
