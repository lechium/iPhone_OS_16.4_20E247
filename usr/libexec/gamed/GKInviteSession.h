...
- (void).cxx_destruct;	// IMP=0x00200000001b8f8e
...
- (_Bool)shouldBeCleared;	// IMP=0x00100000001b897d
- (void)removeAllResponses;	// IMP=0x00100000001b87d9
- (void)addResponse:(id)arg1;	// IMP=0x00100000001b8789
- (void)removeAllInvitees;	// IMP=0x00100000001b8431
- (id)allInvitees;	// IMP=0x00100000001b8411
- (id)referencesForInvitee:(id)arg1;	// IMP=0x00100000001b83ae
- (void)removeInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000001b7953
- (void)addInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000001b77d2
- (void)performSync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b77c1
- (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b7619
- (id)initWithSessionToken:(id)arg1;	// IMP=0x00100000001b75bf
- (id)init;	// IMP=0x00100000001b74aa
