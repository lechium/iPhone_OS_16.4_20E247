...
+ (id)bagKey;	// IMP=0x0020000000101f10
- (void).cxx_destruct;	// IMP=0x0020000000102661
...
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000001024ef
@property(readonly, copy) NSString *description;
- (id)requestIdentifier;	// IMP=0x0010000000102380
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000010236d
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000010228a
- (id)taskInfo;	// IMP=0x001000000010216a
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x001000000010206a
- (id)initWithTask:(id)arg1;	// IMP=0x0010000000101fbe
- (id)postBody;	// IMP=0x0010000000101f1d
