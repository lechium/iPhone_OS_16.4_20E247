...
+ (id)sharedManager;	// IMP=0x0020000000105511
- (void).cxx_destruct;	// IMP=0x0020000000105c89
...
- (void)accountController:(id)arg1 accountAdded:(id)arg2;	// IMP=0x00100000001059d3
- (void)fetchIDSDataForHandles:(id)arg1 service:(id)arg2 infoTypes:(unsigned long long)arg3 performingBlockPerBatch:(CDUnknownBlockType)arg4;	// IMP=0x00100000001056cd
- (_Bool)isReady;	// IMP=0x0010000000105682
- (void)dealloc;	// IMP=0x001000000010563d
- (id)init;	// IMP=0x0010000000105566
