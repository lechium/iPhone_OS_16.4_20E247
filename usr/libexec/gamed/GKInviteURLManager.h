...
+ (id)sharedManager;	// IMP=0x00400000000cb8be
- (void).cxx_destruct;	// IMP=0x00200000000cbde1
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000000cbb22
- (id)init;	// IMP=0x00100000000cba6e
