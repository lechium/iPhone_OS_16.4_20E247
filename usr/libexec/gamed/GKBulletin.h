...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f5df4
+ (_Bool)shouldProcessNotification;	// IMP=0x00100000001f5aa6
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001f5693
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001f4a43
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001f4278
+ (id)syncQueue;	// IMP=0x00100000001f41f7
+ (id)cacheTransactionGroup;	// IMP=0x00100000001f7689
- (void).cxx_destruct;	// IMP=0x00200000001f6860
...
// Error: Property attributes should begin with the type ('T') attribute, property name: gameName
...
- (id)description;	// IMP=0x00100000001f63d4
- (void)reportMetricsForActionID:(id)arg1 withAdditionalFields:(id)arg2;	// IMP=0x00100000001f61e6
- (void)handleAction:(id)arg1;	// IMP=0x00100000001f5fc0
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00100000001f5c45
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00100000001f586e
- (id)dataFrom64String:(id)arg1;	// IMP=0x00100000001f569b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001f5115
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001f4bc2
