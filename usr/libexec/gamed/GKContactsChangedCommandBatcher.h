...
- (void).cxx_destruct;	// IMP=0x00200000001cded0
...
- (void)finishWithContext:(id)arg1;	// IMP=0x00100000001cdd60
- (void)finish;	// IMP=0x00100000001cdc25
- (id)executeCommandsWithContext:(id)arg1;	// IMP=0x00100000001cd497
- (void)addCommand:(id)arg1 withContext:(id)arg2;	// IMP=0x00100000001cd3dd
- (_Bool)shouldExecuteCommands;	// IMP=0x00100000001cd37c
- (void)addCommand:(id)arg1;	// IMP=0x00100000001cd1c8
- (void)visitUpdateContactEvent:(id)arg1;	// IMP=0x00100000001cd107
- (void)visitDropEverythingEvent:(id)arg1;	// IMP=0x00100000001cd0ce
- (void)visitDeleteContactEvent:(id)arg1;	// IMP=0x00100000001cd031
- (void)visitAddContactEvent:(id)arg1;	// IMP=0x00100000001ccf70
- (id)initWithPlayerProvider:(id)arg1 meContactID:(id)arg2 batchSize:(unsigned long long)arg3 batchStartCommand:(id)arg4 batchEndCommand:(id)arg5 finishedCommand:(id)arg6;	// IMP=0x00100000001cce35
- (id)initWithPlayerProvider:(id)arg1 meContactID:(id)arg2 batchSize:(unsigned long long)arg3 finishedCommand:(id)arg4;	// IMP=0x00100000001ccd69
