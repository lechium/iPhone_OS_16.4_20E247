...
@class GKPlayerInternal, NSData, NSDictionary, NSNumber, NSString;
...
@interface GKInviteInternal
{
    ...
    NSNumber *_declineReason;	// 160 = 0xa0
}

+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001307e6
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0010000000130757
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x001000000013059e
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x001000000012ffa3
- (void).cxx_destruct;	// IMP=0x0020000000130f3b
@property(nonatomic) NSNumber *declineReason; // @synthesize declineReason=_declineReason;
...
- (id)descriptionSubstitutionMap;	// IMP=0x0010000000130c64
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000130b89
- (unsigned long long)hash;	// IMP=0x0010000000130b45
- (id)init;	// IMP=0x0010000000130786
