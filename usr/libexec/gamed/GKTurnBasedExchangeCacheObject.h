...
+ (id)entityName;	// IMP=0x0040000000168ce9
- (id)internalRepresentation;	// IMP=0x0020000000169667
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x0010000000168cf6
