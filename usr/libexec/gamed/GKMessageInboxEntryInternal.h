...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000245046
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000244efb
- (void).cxx_destruct;	// IMP=0x0020000000245176
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000244e31
