...
- (void).cxx_destruct;	// IMP=0x002000000005a551
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x001000000005a3a9
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x001000000005a397
- (void)deactivate;	// IMP=0x001000000005a309
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x001000000005a291
- (id)initWithClient:(id)arg1;	// IMP=0x001000000005a226
