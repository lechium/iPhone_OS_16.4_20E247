...
- (void).cxx_destruct;	// IMP=0x002000000001cd9b
...
- (id)itemAttributes;	// IMP=0x001000000001ccb1
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000001cbf5
- (id)initWithDescriptor:(id)arg1 value:(id)arg2;	// IMP=0x001000000001cb5c
