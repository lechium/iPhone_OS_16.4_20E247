...
- (void)_decrementQueueSize;	// IMP=0x001000000001c855
- (_Bool)_incrementQueueSize;	// IMP=0x001000000001c834
@property(readonly, copy) NSString *debugDescription;
- (id)nextCalculation;	// IMP=0x001000000001c64c
- (id)initWithDelay:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000001c600
