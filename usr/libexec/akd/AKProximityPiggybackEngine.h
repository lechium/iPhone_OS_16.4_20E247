...
- (void).cxx_destruct;	// IMP=0x002000000006a3bb
...
- (void)invalidate;	// IMP=0x001000000006a33d
- (void)activate;	// IMP=0x001000000006a2f1
- (void)prepareWithController:(id)arg1 queue:(id)arg2;	// IMP=0x001000000006a2b1
- (void)dealloc;	// IMP=0x001000000006a238
- (id)initWithPresenceSID:(id)arg1;	// IMP=0x001000000006a1cd
