...
@class AKAuthorization, AKAuthorizationCredentialStateRequest, AKAuthorizationRevokeUpgradeContext, AKAuthorizationUserResponse, AKCredentialRequestContext, MISSING_TYPE, NSDictionary, NSString, NSXPCListenerEndpoint;
...
- (MISSING_TYPE *)establishConnectionWithStateBroadcastHandlerEndpoint:completion: /* Error: Ran out of types for this method. */;
