...
- (_Bool)createSnapshotWithError:(id *)arg1;	// IMP=0x0010000000007ea4
- (void)dealloc;	// IMP=0x0010000000007e32
- (id)initWithBundleID:(id)arg1 snapshotTo:(id)arg2 onlyV1AppIfPresent:(_Bool)arg3 placeholderOnly:(_Bool)arg4;	// IMP=0x0010000000007d7a
