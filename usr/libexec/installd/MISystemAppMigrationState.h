...
+ (id)defaultManager;	// IMP=0x00400000000448d6
- (void).cxx_destruct;	// IMP=0x0020000000044ece
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044c87
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000044798
