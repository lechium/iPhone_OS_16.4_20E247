...
+ (id)installerForURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x004000000001d912
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0010000000022f2f
- (_Bool)_installInstallable:(id)arg1 containingSymlink:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0010000000021d56
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0010000000021857
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0010000000021430
- (id)_discoverInstallableWithError:(id *)arg1;	// IMP=0x0010000000020377
- (_Bool)_writeLockBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000020287
- (id)_identifiersToLockForBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000020007
- (id)_bundleInDirectory:(id)arg1 withBundleID:(id)arg2 error:(id *)arg3;	// IMP=0x001000000001f7e6
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x001000000001f2c6
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x001000000001eac4
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x001000000001dd15
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x001000000001dab8
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x001000000001da46
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x001000000001d9ce
- (void)dealloc;	// IMP=0x001000000001d82d
- (id)initWithURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x001000000001d73d
- (id)init;	// IMP=0x001000000001d734
