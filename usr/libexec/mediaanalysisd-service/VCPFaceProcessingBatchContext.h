...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000007d18b
- (void).cxx_destruct;	// IMP=0x002000000007d9ae
...
- (_Bool)downloadTimedout;	// IMP=0x001000000007d743
- (void)updateLastestDownloadTimestamp;	// IMP=0x001000000007d61f
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x001000000007d3d3
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000007d236
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000007cf7d
