...
+ (id)entryWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x004000000000f7f2
...
- (id)initWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x001000000000f740
