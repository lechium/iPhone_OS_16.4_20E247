...
+ (id)taskWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x0040000000062092
- (void).cxx_destruct;	// IMP=0x002000000006406c
...
- (int)mainInternal;	// IMP=0x0010000000062c58
- (void)_reportCoreAnalyticsWithAsset:(id)arg1 analysis:(id)arg2 analysisStatus:(long long)arg3 processingInterval:(double)arg4 extendedAnalysisStatus:(id)arg5;	// IMP=0x001000000006260f
- (void)publishLivePhotoEffectsAnalysis:(id)arg1 toAsset:(id)arg2;	// IMP=0x00100000000621ca
@property(readonly, nonatomic) double cost;
- (id)initWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x0010000000061f56
