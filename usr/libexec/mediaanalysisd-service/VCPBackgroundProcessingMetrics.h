...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x004000000006704b
- (void).cxx_destruct;	// IMP=0x0020000000067c83
- (int)persist;	// IMP=0x0010000000067521
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x001000000006726d
- (void)dealloc;	// IMP=0x0010000000066fbf
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000066560
