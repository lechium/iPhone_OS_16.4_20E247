...
- (void).cxx_destruct;	// IMP=0x00200000000dd48c
...
- (void)main;	// IMP=0x00100000000dd3ef
- (int)mainInternal;	// IMP=0x00100000000dd3e4
- (_Bool)isCancelled;	// IMP=0x00100000000dd394
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000dd2e0
- (id)init;	// IMP=0x00100000000dd2d2
