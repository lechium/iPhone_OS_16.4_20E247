...
+ (id)entryWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x0040000000055f61
- (void).cxx_destruct;	// IMP=0x0020000000056079
...
- (id)initWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x0010000000055ed0
