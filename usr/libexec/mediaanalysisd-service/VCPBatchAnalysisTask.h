...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x004000000006b89f
- (void).cxx_destruct;	// IMP=0x002000000006c796
...
- (int)mainInternal;	// IMP=0x001000000006bf9b
- (_Bool)containsAsset:(id)arg1;	// IMP=0x001000000006bd20
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x001000000006bc83
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x001000000006b904
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x001000000006b7d0
