...
+ (id)sharedManager;	// IMP=0x00400000000a1468
- (void).cxx_destruct;	// IMP=0x00200000000a19b5
...
- (CDUnknownBlockType)getJobScheduler;	// IMP=0x00100000000a18b9
- (void)registerQueueGroupWithName:(id)arg1 andNumberOfQueues:(unsigned long long)arg2;	// IMP=0x00100000000a14bd
- (id)init;	// IMP=0x00100000000a13e5
