...
+ (id)resourceWithResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5;	// IMP=0x004000000007ce75
- (void).cxx_destruct;	// IMP=0x002000000007cf55
...
- (id)initWithResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5;	// IMP=0x001000000007cda0
