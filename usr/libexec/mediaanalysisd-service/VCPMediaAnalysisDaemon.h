...
- (void).cxx_destruct;	// IMP=0x0020000000003542
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x001000000000330a
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002fbd
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000002ae6
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000025a0
- (id)init;	// IMP=0x0010000000002420
