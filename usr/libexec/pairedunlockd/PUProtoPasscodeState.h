...
- (void).cxx_destruct;	// IMP=0x0020000000009d28
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000009bec
- (unsigned long long)hash;	// IMP=0x0010000000009b69
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000009a45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000998b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000098fe
- (void)writeTo:(id)arg1;	// IMP=0x0010000000009851
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000009844
- (id)dictionaryRepresentation;	// IMP=0x0010000000009271
- (id)description;	// IMP=0x00100000000091c2
