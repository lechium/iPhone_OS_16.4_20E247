...
- (void).cxx_destruct;	// IMP=0x00400000000d10a0
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x00100000000d1010
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x00100000000d0fe0
- (id)initToMemory;	// IMP=0x00100000000d0fb0
- (void)close;	// IMP=0x00100000000d0f80
- (void)open;	// IMP=0x00100000000d0c50
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x00100000000d0ae0
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x00100000000d0600
- (id)init;	// IMP=0x00100000000d0560
