...
- (id)init;	// IMP=0x001000000000a010
- (id)initWithAvailableUpdateCount:(long long)arg1 shouldNotifyOfChanges:(_Bool)arg2 bundleIDs:(id)arg3 result:(_Bool)arg4;	// IMP=0x0010000000009f90
