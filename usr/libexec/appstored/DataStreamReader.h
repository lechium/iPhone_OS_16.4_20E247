...
- (void).cxx_destruct;	// IMP=0x00200000001d9212
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000001d9149
- (void)close;	// IMP=0x00100000001d90ff
