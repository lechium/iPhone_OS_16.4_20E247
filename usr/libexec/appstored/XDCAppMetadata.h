...
- (void).cxx_destruct;	// IMP=0x0020000000184e34
- (unsigned long long)hash;	// IMP=0x00100000001849fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000184315
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000183cbd
- (void)writeTo:(id)arg1;	// IMP=0x00100000001837dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001837d0
- (id)dictionaryRepresentation;	// IMP=0x00100000001825c5
- (id)description;	// IMP=0x0010000000182516
