...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000000b6005
- (void).cxx_destruct;	// IMP=0x00200000000b66e1
@property(retain, nonatomic) _TtC9appstored6LogKey *logKey; // @synthesize logKey=_logKey;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000b61b2
...
- (id)init;	// IMP=0x00100000000b5d7d
