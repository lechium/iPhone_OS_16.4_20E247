...
- (void).cxx_destruct;	// IMP=0x00200000000b2728
...
- (void)main;	// IMP=0x00100000000ae8bc
- (void)completeWithError:(id)arg1;	// IMP=0x00100000000ae867
- (void)completeWithSuccess;	// IMP=0x00100000000ae6f5
@property(readonly, nonatomic) NSArray *jobResults;
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000ad7a7
