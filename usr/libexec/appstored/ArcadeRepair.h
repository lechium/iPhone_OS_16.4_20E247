...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x0020000000099429
- (void).cxx_destruct;	// IMP=0x0020000000099a68
@property(nonatomic) __weak id <ApplicationRepairDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000099431
