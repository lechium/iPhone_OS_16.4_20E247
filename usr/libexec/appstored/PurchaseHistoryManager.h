...
- (void).cxx_destruct;	// IMP=0x00200000000a6f9d
- (void)_handleAccountChangedNotification;	// IMP=0x00100000000a6729
- (void)pushService:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00100000000a5f72
- (id)init;	// IMP=0x00100000000a448d
