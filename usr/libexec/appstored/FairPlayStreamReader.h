...
- (void).cxx_destruct;	// IMP=0x002000000018e6c5
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000018e101
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000018ddd3
- (void)close;	// IMP=0x001000000018dd71
- (void)open;	// IMP=0x001000000018dd25
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x001000000018db69
