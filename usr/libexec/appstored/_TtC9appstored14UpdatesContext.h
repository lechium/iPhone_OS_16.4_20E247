...
- (void).cxx_destruct;	// IMP=0x004000000004d200
@property(nonatomic, readonly) NSString *humanReadableReason;
@property(nonatomic, readonly) CDUnknownBlockType callbackHandler;
- (id)initWithReason:(long long)arg1 requestToken:(id)arg2 logKey:(id)arg3 callbackHandler:(CDUnknownBlockType)arg4 includeMetrics:(_Bool)arg5 isVPPLookup:(_Bool)arg6 userInitiated:(_Bool)arg7;	// IMP=0x001000000004ce10
- (id)initWithReason:(long long)arg1;	// IMP=0x001000000004cd50
- (id)init;	// IMP=0x001000000004cce0
