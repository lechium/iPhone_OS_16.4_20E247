...
- (void).cxx_destruct;	// IMP=0x002000000020ddc9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000020d6a2
- (unsigned long long)hash;	// IMP=0x001000000020d583
- (id)description;	// IMP=0x001000000020d432
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020d356
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020d14d
