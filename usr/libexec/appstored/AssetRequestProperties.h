...
@class MISSING_TYPE, NSArray, NSNumber, NSString, NSUUID, _TtC9appstored6LogKey;
...
@interface AssetRequestProperties : NSObject
{
    ...
    _TtC9appstored6LogKey *_logKey;	// 112 = 0x70
    ...
    MISSING_TYPE *_taskPriority;	// 168 = 0xa8
    NSString *_variantID;	// 176 = 0xb0
}

- (void).cxx_destruct;	// IMP=0x002000000016e6c9
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016e472
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016e460
- (id)init;	// IMP=0x001000000016e3ed
