...
@class IXAppInstallCoordinator, LSApplicationRecord, MISSING_TYPE, NSError, NSURL;
...
- (MISSING_TYPE *)coordinatorShouldBeginRestoringUserData: /* Error: Ran out of types for this method. */;
