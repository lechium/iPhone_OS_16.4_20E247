...
+ (id)defaultProperties;	// IMP=0x0020000000139598
+ (Class)databaseEntityClass;	// IMP=0x0010000000139587
- (void).cxx_destruct;	// IMP=0x001000000013968a
...
- (id)purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x0010000000139656
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000139558
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) long long softwarePlatform;
- (void)setUpdateState:(long long)arg1;	// IMP=0x00100000001393d4
@property(nonatomic, getter=isPerDevice) _Bool perDevice;
- (void)setMetricsData:(id)arg1;	// IMP=0x0010000000139361
...
- (id)rawUpdateDictionary;	// IMP=0x0010000000139221
...
- (id)initWithUpdateDictionary:(id)arg1;	// IMP=0x0010000000138152
- (id)init;	// IMP=0x0010000000138123
- (id)purchase_purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x00100000001bf00d
