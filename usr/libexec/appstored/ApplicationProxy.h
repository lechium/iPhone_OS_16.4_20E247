...
+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x004000000023fbab
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x001000000023e130
+ (id)proxyForItemID:(id)arg1;	// IMP=0x001000000023df28
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x001000000023dedb
+ (id)proxyForBundle:(id)arg1;	// IMP=0x001000000023de8e
+ (id)proxyMatchingBundleID:(id)arg1 orItemID:(id)arg2;	// IMP=0x001000000023d57c
- (void).cxx_destruct;	// IMP=0x00200000002401ae
...
- (id)description;	// IMP=0x001000000023fe98
- (id)validLocationProxy;	// IMP=0x001000000023fe8f
...
- (id)initWithBundleURL:(id)arg1;	// IMP=0x001000000023e5f3
- (id)initWithBundlePath:(id)arg1;	// IMP=0x001000000023e599
- (id)initWithBundleID:(id)arg1;	// IMP=0x001000000023e386
- (id)initWithBundle:(id)arg1;	// IMP=0x001000000023e330
- (id)initWithItemID:(id)arg1 error:(id *)arg2;	// IMP=0x001000000023dd06
- (id)initWithBundleURL:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x001000000023db73
- (_Bool)validateEligibilityForUpdatesWithLogKey:(id)arg1;	// IMP=0x001000000023d918
- (id)initWithBundleID:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x001000000023d712
