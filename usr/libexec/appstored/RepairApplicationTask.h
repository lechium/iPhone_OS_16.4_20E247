...
- (void).cxx_destruct;	// IMP=0x002000000010374f
- (void)repair:(id)arg1 needsToReleaseBlockingCallerWithReason:(id)arg2;	// IMP=0x00100000001036b5
- (void)repair:(id)arg1 wantsToRelaunchApplication:(id)arg2;	// IMP=0x001000000010348e
- (void)main;	// IMP=0x0010000000102b74
