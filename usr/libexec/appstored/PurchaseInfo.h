...
@class ACAccount, AMSBuyParams, AMSProcessInfo, ASDPurchase, IXAppInstallCoordinator, MISSING_TYPE, NSDictionary, NSNumber, NSString, NSURL, NSUUID, StoreItemResponse, XDCDevice, XPCRequestToken, _TtC9appstored6LogKey;
...
@interface PurchaseInfo
{
    ...
    MISSING_TYPE *_signpostID;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x00200000001c7d53
...
- (void)updateLogKey;	// IMP=0x00100000001c7b6e
@property(readonly, getter=isUserInitiated) _Bool userInitiated;
- (void)updateGeneratedProperties;	// IMP=0x00100000001c77ca
- (id)init;	// IMP=0x00100000001c7762
