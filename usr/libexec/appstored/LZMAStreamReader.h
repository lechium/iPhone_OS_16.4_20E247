...
- (void).cxx_destruct;	// IMP=0x00200000000eab0c
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000ea730
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000ea452
- (void)open;	// IMP=0x00100000000ea406
- (void)close;	// IMP=0x00100000000ea3a4
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x00100000000ea0ed
