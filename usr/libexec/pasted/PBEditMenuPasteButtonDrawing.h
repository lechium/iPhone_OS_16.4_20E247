...
- (void).cxx_destruct;	// IMP=0x00200000000206c5
- (void)drawInContext:(struct CGContext *)arg1 atPoint:(struct CGPoint)arg2;	// IMP=0x001000000002062a
@property(readonly, nonatomic) struct CGSize drawingSize;
- (void)dealloc;	// IMP=0x00100000000205c3
- (id)initWithStyle:(id)arg1 tag:(id)arg2;	// IMP=0x001000000001fe5f
