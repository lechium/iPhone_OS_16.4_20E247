...
- (void).cxx_destruct;	// IMP=0x00200000000275f0
...
- (unsigned long long)freePurgableDiskSpace:(unsigned long long)arg1 urgency:(int)arg2;	// IMP=0x0010000000027502
- (unsigned long long)purgableDiskSpaceForUrgency:(int)arg1;	// IMP=0x001000000002747f
- (_Bool)_shouldPurgeForUrgency:(int)arg1;	// IMP=0x0010000000027377
- (int)minimumUregency;	// IMP=0x0010000000027358
