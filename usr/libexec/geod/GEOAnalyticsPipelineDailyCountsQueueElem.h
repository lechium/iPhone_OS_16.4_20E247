...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002cba0
- (unsigned long long)hash;	// IMP=0x001000000002cb25
- (id)copy;	// IMP=0x001000000002cac6
- (id)initWithType:(int)arg1 usageString:(id)arg2 usageBool:(id)arg3 appId:(id)arg4 createTime:(id)arg5;	// IMP=0x001000000002c9c3
