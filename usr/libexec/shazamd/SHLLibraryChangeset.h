...
- (void).cxx_destruct;	// IMP=0x0020000000013e5c
...
- (id)description;	// IMP=0x0010000000013ccd
- (void)mergeChangeset:(id)arg1;	// IMP=0x0010000000013bc7
- (void)deleteGroups:(id)arg1;	// IMP=0x0010000000013a80
- (void)addGroups:(id)arg1;	// IMP=0x001000000001374e
- (void)deleteTracks:(id)arg1;	// IMP=0x0010000000013607
- (void)addTracks:(id)arg1;	// IMP=0x00100000000134c0
...
- (id)init;	// IMP=0x00100000000130e9
