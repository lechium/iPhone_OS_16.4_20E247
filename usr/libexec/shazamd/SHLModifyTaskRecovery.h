...
- (void).cxx_destruct;	// IMP=0x0020000000025ba5
...
- (id)recoverTaskFromLimitExceededError;	// IMP=0x0010000000025ac7
- (id)recoverTaskFromPartialError;	// IMP=0x00100000000256ca
@property(readonly, nonatomic) NSArray *recoverableTasks;
- (id)initWithOriginalTask:(id)arg1 savedGroups:(id)arg2 savedTracks:(id)arg3 deletedIDs:(id)arg4 error:(id)arg5;	// IMP=0x001000000002543c
