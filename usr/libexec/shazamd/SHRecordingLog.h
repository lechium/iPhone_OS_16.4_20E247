...
+ (void)powerlogCallingProcessBundleID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;	// IMP=0x0000000000026fe0
- (void).cxx_destruct;	// IMP=0x0020000000027018
...
- (void)detachedTapForClient:(long long)arg1;	// IMP=0x0010000000026ec3
- (void)attachedTapForClient:(long long)arg1;	// IMP=0x0010000000026e39
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000026dce
