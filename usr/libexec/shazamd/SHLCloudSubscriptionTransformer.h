...
- (void).cxx_destruct;	// IMP=0x002000000002f113
...
- (id)newSubscriptionForZoneID:(id)arg1;	// IMP=0x001000000002f031
- (id)cloudBackedOperationForZones:(id)arg1 container:(id)arg2;	// IMP=0x001000000002e598
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000002e513
