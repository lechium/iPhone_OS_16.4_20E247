...
- (void).cxx_destruct;	// IMP=0x002000000004574e
- (void);	// IMP=0x001000000004573a
@property(retain, nonatomic) SHLCloudModifyTaskTransformer *taskTransformer; // @synthesize taskTransformer=_taskTransformer;
- (void)scheduleModifyTask:(id)arg1;	// IMP=0x0010000000045160
@property(readonly, nonatomic) NSArray *preconditions;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000044f25
