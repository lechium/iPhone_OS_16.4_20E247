...
- (void).cxx_destruct;	// IMP=0x00200000000130c1
...
- (id)initWithType:(long long)arg1 scope:(long long)arg2 callingProcessIdentifier:(id)arg3 sessionIdentifier:(id)arg4;	// IMP=0x0010000000012fe8
