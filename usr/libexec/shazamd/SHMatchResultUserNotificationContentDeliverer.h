...
- (void).cxx_destruct;	// IMP=0x002000000000db83
...
- (void)deliverContentForMatchedMediaItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000d89a
- (void)deliverContentForNoMatchWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000d6af
- (id)initWithContentProvider:(id)arg1;	// IMP=0x001000000000d644
