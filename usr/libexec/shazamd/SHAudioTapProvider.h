...
- (void).cxx_destruct;	// IMP=0x00200000000102f9
...
- (id)tapForSource:(long long)arg1;	// IMP=0x00100000000100a8
- (id)tapsForAvailableSources;	// IMP=0x001000000000fe6f
- (id)initWithAudioRecordingManager:(id)arg1 clientCredentials:(id)arg2;	// IMP=0x001000000000fdd6
