...
- (void).cxx_destruct;	// IMP=0x0020000000003caf
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003528
- (void)listen;	// IMP=0x00100000000034eb
- (id)initWithServiceProvider:(id)arg1 listener:(id)arg2;	// IMP=0x001000000000340c
