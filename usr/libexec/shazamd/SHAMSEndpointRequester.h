...
- (void).cxx_destruct;	// IMP=0x002000000000a78c
...
- (id)sessionConfiguration;	// IMP=0x001000000000a4bd
- (void)performRequest:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000a15e
- (_Bool)isTokenFailureError:(id)arg1;	// IMP=0x001000000000a0cf
- (void)handleResult:(id)arg1 callback:(CDUnknownBlockType)arg2 error:(id)arg3;	// IMP=0x0010000000009ea0
- (void)invalidate;	// IMP=0x0010000000009e63
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2;	// IMP=0x0010000000009d93
