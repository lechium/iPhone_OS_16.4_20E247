...
- (void).cxx_destruct;	// IMP=0x0020000000044f17
...
- (_Bool)stopRecordingWithError:(id *)arg1;	// IMP=0x0010000000044edd
- (void)startRecordingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044ec8
