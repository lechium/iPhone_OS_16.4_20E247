...
- (void).cxx_destruct;	// IMP=0x0020000000026d7c
...
- (void)stopRecognitionForRequestID:(id)arg1;	// IMP=0x0010000000026aa8
- (void)stopRecognition;	// IMP=0x0010000000026a39
- (void)_stop;	// IMP=0x00100000000268b6
- (_Bool)finishSessionConditionsMetForRequest:(id)arg1 response:(id)arg2;	// IMP=0x00100000000266fe
- (void)session:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x0010000000026508
- (_Bool)session:(id)arg1 shouldAttemptToMatchSignature:(id)arg2;	// IMP=0x00100000000263cd
- (_Bool)isRunning;	// IMP=0x001000000002639a
- (id)responseSignatureForRequest:(id)arg1;	// IMP=0x00100000000262a1
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x0010000000025ce2
- (id)initWithAudioTap:(id)arg1 audioRecordingManager:(id)arg2 catalog:(id)arg3;	// IMP=0x0010000000025bee
