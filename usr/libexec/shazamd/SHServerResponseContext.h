...
- (void).cxx_destruct;	// IMP=0x00200000000057ed
...
- (void)sh_setCampaignTokenForClientIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000005614
- (void)sh_setDefaultValuesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000054a6
