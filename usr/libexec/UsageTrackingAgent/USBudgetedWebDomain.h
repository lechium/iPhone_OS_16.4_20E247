...
- (_Bool)_validateBudget:(id)arg1 andEvent:(id)arg2 error:(out id *)arg3;	// IMP=0x00200000000022cc
- (_Bool)validateEvent:(inout id *)arg1 error:(out id *)arg2;	// IMP=0x0010000000002267
- (_Bool)validateBudget:(inout id *)arg1 error:(out id *)arg2;	// IMP=0x0010000000002202
