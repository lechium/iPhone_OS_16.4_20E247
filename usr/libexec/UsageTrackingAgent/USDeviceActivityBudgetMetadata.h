...
- (void).cxx_destruct;	// IMP=0x00200000000206c0
...
- (id)initWithActivity:(id)arg1 budgetID:(id)arg2 clientIdentifier:(id)arg3 extensionIdentifier:(id)arg4 intervalDidStart:(_Bool)arg5;	// IMP=0x0010000000020540
