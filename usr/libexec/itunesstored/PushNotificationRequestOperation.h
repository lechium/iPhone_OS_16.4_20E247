...
- (_Bool)_loadResponseWithAccountIdentifier:(id)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x002000000008d334
- (void)run;	// IMP=0x001000000008caee
@property(copy) NSString *userAgent;
@property(readonly) SSURLConnectionResponse *URLResponse;
- (void)dealloc;	// IMP=0x001000000008c985
- (id)initWithPushNotificationParameters:(id)arg1;	// IMP=0x001000000008c927
