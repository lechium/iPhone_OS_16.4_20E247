...
- (void).cxx_destruct;	// IMP=0x00200000001a1fb6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a1b8a
- (id)description;	// IMP=0x00100000001a1b3c
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x00100000001a1756
