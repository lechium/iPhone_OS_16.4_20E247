...
- (void).cxx_destruct;	// IMP=0x00200000000e3341
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e324d
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000e31f3
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000e3199
- (id)init;	// IMP=0x00100000000e3124
