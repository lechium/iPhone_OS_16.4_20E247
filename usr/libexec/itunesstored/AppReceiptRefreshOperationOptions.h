...
- (void).cxx_destruct;	// IMP=0x00200000001ab596
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ab46c
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x00100000001ab404
