...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000091a1f
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x001000000009173d
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000914da
- (void)run;	// IMP=0x0010000000091478
- (void)dealloc;	// IMP=0x0010000000091412
