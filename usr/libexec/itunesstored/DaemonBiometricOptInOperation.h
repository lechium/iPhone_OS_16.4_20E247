...
- (void).cxx_destruct;	// IMP=0x002000000006e8de
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x001000000006e216
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006d39f
- (void)run;	// IMP=0x001000000006d302
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x001000000006d15a
