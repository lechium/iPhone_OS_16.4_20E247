...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x0020000000108356
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x0020000000109993
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x001000000010982b
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x0010000000108f24
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010819f
- (void)dealloc;	// IMP=0x0010000000108130
- (id)init;	// IMP=0x00100000001080e2
