...
+ (id)defaultProperties;	// IMP=0x0020000000187595
+ (Class)databaseEntityClass;	// IMP=0x0010000000187584
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00200000001875bc
@property(copy, nonatomic) NSData *policyData;
@property(readonly, nonatomic) SSDownloadPolicy *downloadPolicy;
- (void)dealloc;	// IMP=0x00100000001872ee
