...
- (void).cxx_destruct;	// IMP=0x00200000000a51f9
...
- (id)_track;	// IMP=0x00100000000a4e65
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x00100000000a4e5f
- (void)_persistKeys;	// IMP=0x00100000000a4e59
- (id)_pastisKeyServerURL;	// IMP=0x00100000000a4d8c
- (id)_pastisCertificateURL;	// IMP=0x00100000000a4cbf
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x00100000000a4cb7
- (void)persistKeys;	// IMP=0x00100000000a4cb1
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x00100000000a4c92
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x00100000000a4b17
