...
- (void).cxx_destruct;	// IMP=0x00200000001d408f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001d3f75
- (unsigned long long)hash;	// IMP=0x00100000001d3ec4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d3d96
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d3cb6
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d3bf1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d3be4
- (id)dictionaryRepresentation;	// IMP=0x00100000001d3632
- (id)description;	// IMP=0x00100000001d3583
