...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x00400000000420e3
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x0010000000042096
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x0010000000043357
- (id)_temporaryIdentifier;	// IMP=0x0010000000043308
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x00100000000432ac
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x0010000000043227
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x0010000000042e59
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x0010000000042d72
- (void)setFailedWithError:(id)arg1;	// IMP=0x0010000000042c8e
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x00100000000428af
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x00100000000426b1
- (id)copyPaymentTransaction;	// IMP=0x001000000004212f
- (void)dealloc;	// IMP=0x0010000000042048
