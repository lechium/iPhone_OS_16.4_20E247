...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000188aee
- (void)dealloc;	// IMP=0x0010000000188aa4
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000188a4d
