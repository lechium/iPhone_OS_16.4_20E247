...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008f241
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x001000000008ef5f
- (void)run;	// IMP=0x001000000008ecab
- (void)dealloc;	// IMP=0x001000000008ec45
