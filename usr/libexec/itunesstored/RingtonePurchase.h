...
+ (id)entityFromContext:(id)arg1;	// IMP=0x0040000000069ba3
- (void)_assignToContact:(id)arg1 inContactStore:(id)arg2 withSoundIdentifier:(id)arg3;	// IMP=0x0020000000069f95
- (void)_assignToPersonWithID:(int)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000069f21
- (void)_assignToContactWithID:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000069e31
- (void)loadFromPurchase:(id)arg1;	// IMP=0x0010000000069d21
- (void)applyUserActionWithToneIdentifier:(id)arg1;	// IMP=0x0010000000069bf0
