...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001a15e4
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001a15bd
- (void)dealloc;	// IMP=0x00100000001a1565
