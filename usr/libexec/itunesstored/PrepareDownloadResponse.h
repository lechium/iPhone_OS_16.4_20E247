...
- (void).cxx_destruct;	// IMP=0x002000000017e8bb
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000017dca8
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000017d610
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000017d2b9
- (id)sessionConfiguration;	// IMP=0x001000000017d0e1
