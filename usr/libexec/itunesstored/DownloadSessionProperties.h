...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002938b
- (unsigned long long)hash;	// IMP=0x0010000000029381
- (id)description;	// IMP=0x001000000002931b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002925b
- (void)dealloc;	// IMP=0x0010000000029203
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000291a1
