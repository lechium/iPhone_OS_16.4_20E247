...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x00200000001aab1a
+ (void)initialize;	// IMP=0x00100000001aaaec
...
- (id)description;	// IMP=0x00100000001ab282
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ab188
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x00100000001aaf1a
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x00100000001aad6f
- (void)dealloc;	// IMP=0x00100000001aad02
