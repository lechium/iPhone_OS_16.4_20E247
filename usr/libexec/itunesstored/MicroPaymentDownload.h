...
+ (id)propertiesForDownloadEntities;	// IMP=0x004000000019883a
+ (id)downloadEntityFromContext:(id)arg1;	// IMP=0x00100000001987ed
- (void)awakeFromInsert;	// IMP=0x0020000000198d14
- (void)setValuesWithAssetDictionary:(id)arg1;	// IMP=0x00100000001989f4
- (id)copySKDownload;	// IMP=0x00100000001988a5
