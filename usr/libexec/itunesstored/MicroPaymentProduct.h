...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0040000000064e0f
...
- (id)copyProduct;	// IMP=0x0010000000064a3e
- (void)dealloc;	// IMP=0x00100000000649bc
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000642fb
