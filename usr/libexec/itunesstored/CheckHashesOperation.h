...
- (void)run;	// IMP=0x002000000011e230
@property(readonly) long long numberOfBytesToHash;
@property(readonly) NSArray *hashes;
@property(readonly) NSString *filePath;
- (void)dealloc;	// IMP=0x001000000011e18b
- (id)initWithFilePath:(id)arg1 hashes:(id)arg2 bytesToHash:(long long)arg3;	// IMP=0x001000000011e0f5
