...
- (void)addRefreshed:(id)arg1;	// IMP=0x001000000011febb
- (void)addRevoked:(id)arg1;	// IMP=0x001000000011fe5f
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000011fd84
- (void)dealloc;	// IMP=0x001000000011fd1e
