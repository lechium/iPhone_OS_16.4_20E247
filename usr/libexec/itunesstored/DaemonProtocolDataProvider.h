...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001b36cc
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001b3638
- (void)dealloc;	// IMP=0x00100000001b35f6
