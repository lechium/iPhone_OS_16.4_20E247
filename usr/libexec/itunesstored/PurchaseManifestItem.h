...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000fe4c
...
- (void)dealloc;	// IMP=0x001000000000fd03
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000fcac
- (id)init;	// IMP=0x001000000000fc60
