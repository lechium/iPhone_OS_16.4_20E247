...
- (void).cxx_destruct;	// IMP=0x00200000001e0a2b
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001e08ff
- (id)description;	// IMP=0x00100000001e07e8
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001e06df
