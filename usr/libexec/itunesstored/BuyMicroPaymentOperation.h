...
- (void).cxx_destruct;	// IMP=0x0020000000045bb9
...
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x00100000000451c6
- (id)_appProxy;	// IMP=0x0010000000044d71
- (void)run;	// IMP=0x0010000000044135
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x0010000000044051
...
- (void)setClientAuditTokenData:(id)arg1;	// IMP=0x0010000000043d1d
...
- (id)clientAuditTokenData;	// IMP=0x0010000000043960
