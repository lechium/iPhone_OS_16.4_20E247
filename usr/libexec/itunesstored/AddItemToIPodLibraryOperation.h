...
- (void)_setInsertedItemPersistentIdentifier:(long long)arg1;	// IMP=0x00200000000ab6da
- (id)_libraryItem;	// IMP=0x00100000000ab685
- (void)run;	// IMP=0x00100000000ab490
@property(readonly) NSNumber *insertedItemPersistentIdentifier;
@property(readonly) IPodLibraryItem *IPodLibraryItem;
- (void)dealloc;	// IMP=0x00100000000ab38a
- (id)initWithIPodLibraryItem:(id)arg1;	// IMP=0x00100000000ab32c
