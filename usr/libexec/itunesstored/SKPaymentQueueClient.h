...
- (void).cxx_destruct;	// IMP=0x00200000000a9fa3
...
- (id);	// IMP=0x00100000000a9da8
- (id)copyXPCEncoding;	// IMP=0x00100000000a9cb3
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000a9adc
