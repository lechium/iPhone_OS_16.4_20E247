...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000013204
- (void).cxx_destruct;	// IMP=0x0020000000013737
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001356b
- (id)copyXPCEncoding;	// IMP=0x00100000000134ae
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000132a2
