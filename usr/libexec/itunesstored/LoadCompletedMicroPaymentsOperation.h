...
- (void).cxx_destruct;	// IMP=0x0020000000069518
- (void)_runForIdentity:(id)arg1;	// IMP=0x0010000000068ac1
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x001000000006853a
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x001000000006830c
- (void)run;	// IMP=0x0010000000067f1d
