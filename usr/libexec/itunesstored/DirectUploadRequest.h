...
- (void).cxx_destruct;	// IMP=0x00200000001a145f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a12f9
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00100000001a102b
