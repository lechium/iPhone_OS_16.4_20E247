...
- (void).cxx_destruct;	// IMP=0x00200000000d4e40
...
- (_Bool)_shouldSkipInitialDialog:(id)arg1;	// IMP=0x00100000000d465e
- (_Bool)_shouldAuthenticateForButton:(id)arg1;	// IMP=0x00100000000d45a0
- (_Bool)_isLocalizationAlreadyConfiguredForAuthContext:(id)arg1;	// IMP=0x00100000000d44ec
- (void)_handleSelectedButton:(id)arg1;	// IMP=0x00100000000d41f9
- (_Bool)_copySelectedButton:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000d3ecd
- (id)_copyButtonToSkipDialog:(id)arg1;	// IMP=0x00100000000d3d2a
- (id)_copyAuthenticationContext;	// IMP=0x00100000000d32b3
- (_Bool)_copyAccountIdentifier:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000d2e66
- (void)run;	// IMP=0x00100000000d2921
...
- (id)initWithDialog:(id)arg1;	// IMP=0x00100000000d25de
- (id)init;	// IMP=0x00100000000d23a7
