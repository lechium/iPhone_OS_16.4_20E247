...
+ (id)_unrecoverableErrors;	// IMP=0x0020000000152d6f
- (void).cxx_destruct;	// IMP=0x0020000000152ebd
@property(copy, nonatomic) NSString *serviceErrorMessage; // @synthesize serviceErrorMessage=_serviceErrorMessage;
- (void)setServiceErrorLabel:(id)arg1;	// IMP=0x0010000000152e95
- (id)serviceErrorLabel;	// IMP=0x0010000000152e8b
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x0010000000152cec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000152c3a
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x001000000015280b
