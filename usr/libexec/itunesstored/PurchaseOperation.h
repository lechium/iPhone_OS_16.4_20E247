...
+ (double)_randomDouble;	// IMP=0x0020000000027418
+ (void)reportAnonymousPings:(id)arg1;	// IMP=0x0010000000018189
- (void).cxx_destruct;	// IMP=0x0020000000027fff
...
- (id)_URLBagContext;	// IMP=0x0010000000027cbd
- (_Bool)_shouldUseClientAuthentication;	// IMP=0x00100000000277e7
- (_Bool)_shouldSendSBSyncData;	// IMP=0x0010000000027731
- (_Bool)_shouldSendKeyBagSyncData;	// IMP=0x0010000000027541
- (void)_setMoveToiOS;	// IMP=0x0010000000027452
- (_Bool)_shouldDisableReversePush;	// IMP=0x001000000002703a
- (void)_setChangedBuyParameters:(id)arg1 fromDataProvider:(id)arg2;	// IMP=0x0010000000026ed0
- (void)_scoreDeviceRetryFailedV2Score;	// IMP=0x0010000000026a01
- (void)_scoreDevice;	// IMP=0x001000000002613b
- (void)_runPurchaseRequest;	// IMP=0x0010000000024957
- (void)_runDialogOperationForDialog:(id)arg1;	// IMP=0x0010000000022753
- (id)_recordEngagementEventWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0010000000021b3d
- (long long)_purchaseType;	// IMP=0x0010000000021a75
- (id)_priceFromBuyParams;	// IMP=0x0010000000021971
- (void)_performAutoEnrollmentCheck;	// IMP=0x0010000000020bb2
- (void)_performApplePayClassicCheck;	// IMP=0x001000000001f9e8
- (void)_performMachineDataActionForURLResponse:(id)arg1;	// IMP=0x001000000001f53d
- (void)_performDelayedGotoForOperation:(id)arg1;	// IMP=0x001000000001f3a7
- (id)_newRequestParameters;	// IMP=0x001000000001eb7a
- (id)_newPurchaseRequestOperation;	// IMP=0x001000000001d153
- (void)_handleFailureForOperation:(id)arg1;	// IMP=0x001000000001c16e
- (id)_fairPlaySubscriptionController;	// IMP=0x001000000001c112
- (id);	// IMP=0x001000000001c07f
- (id)_countryCode;	// IMP=0x001000000001bc5e
- (void)_continueTouchIDSessionWithDialog:(id)arg1;	// IMP=0x001000000001ba30
- (_Bool)_clientIsViewService;	// IMP=0x001000000001b8b9
- (id)_buyParamProductType;	// IMP=0x001000000001b63f
- (void)_addFairPlayToRequestProperties:(id)arg1 withAccountIdentifier:(unsigned long long)arg2;	// IMP=0x001000000001b639
- (id)_accountWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000001b514
- (id)_account;	// IMP=0x001000000001b3d5
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;	// IMP=0x001000000001b1b3
- (void)sender:(id)arg1 shouldContinueTouchIDSession:(_Bool)arg2;	// IMP=0x001000000001b194
- (void)sender:(id)arg1 didFallbackToPassword:(_Bool)arg2;	// IMP=0x001000000001b175
- (void)operation:(id)arg1 willSendRequest:(id)arg2;	// IMP=0x001000000001b0b9
- (void)operation:(id)arg1 shouldAuthenticateWithContext:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001afc3
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x001000000001ac3b
- (id)uniqueKey;	// IMP=0x001000000001ac2e
- (void)run;	// IMP=0x0010000000018f0c
- (id)authenticatedAccountDSID;	// IMP=0x0010000000018e88
...
- (id)initWithPurchase:(id)arg1;	// IMP=0x0010000000017c65
- (id)init;	// IMP=0x0010000000017c51
