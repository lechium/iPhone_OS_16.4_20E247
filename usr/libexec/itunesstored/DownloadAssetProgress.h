...
- (void).cxx_destruct;	// IMP=0x00200000001e20d1
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001e1f66
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001e1f5c
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001e1dbb
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001e1d3f
