...
+ (id)defaultProperties;	// IMP=0x00000000000876bd
+ (Class)databaseEntityClass;	// IMP=0x00100000000876ac
- (void).cxx_destruct;	// IMP=0x0020000000087a0a
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x001000000008737a
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x0010000000086bc3
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0010000000086652
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x00100000000860c7
