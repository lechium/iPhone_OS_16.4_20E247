...
- (void).cxx_destruct;	// IMP=0x002000000012048c
- (long long)_keyboardType;	// IMP=0x001000000012042d
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0010000000120418
- (void)run;	// IMP=0x0010000000120376
@property(copy) CDUnknownBlockType tokenBlock;
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x001000000011ff80
