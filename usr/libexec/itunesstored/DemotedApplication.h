...
- (void).cxx_destruct;	// IMP=0x00200000000340c3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000033f29
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000339a0
- (id)initWithApplication:(id)arg1;	// IMP=0x001000000003380f
