...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018fa82
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018fa1d
- (unsigned long long)hash;	// IMP=0x001000000018fa13
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x001000000018f9ec
@property(copy, nonatomic) NSString *statusDescription;
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x001000000018f987
@property(nonatomic) long long sessionState;
- (void)setSessionPropertyValues:(id)arg1;	// IMP=0x001000000018f8bd
@property(nonatomic) float percentComplete;
@property(nonatomic) _Bool needsPowerAssertion;
@property(nonatomic) _Bool canBePaused;
- (void)setBlocksOtherDownloads:(_Bool)arg1;	// IMP=0x001000000018f7c1
- (_Bool)blocksOtherDownloads;	// IMP=0x001000000018f6b3
- (void)dealloc;	// IMP=0x001000000018f65b
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000018f620
- (id)init;	// IMP=0x001000000018f5a5
