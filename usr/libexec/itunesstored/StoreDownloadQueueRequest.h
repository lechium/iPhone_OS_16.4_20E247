...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c0d2f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c0c05
- (unsigned long long)hash;	// IMP=0x00100000000c0bef
- (id)description;	// IMP=0x00100000000c0b8f
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000c0adc
