...
- (void).cxx_destruct;	// IMP=0x002000000004df53
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x001000000004dd90
- (void)_disconnect;	// IMP=0x001000000004dc77
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x001000000004db2a
- (void)dealloc;	// IMP=0x000000000004d9be
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000004d641
