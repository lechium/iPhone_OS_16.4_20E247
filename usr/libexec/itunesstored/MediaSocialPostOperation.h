...
- (void).cxx_destruct;	// IMP=0x002000000019e8e7
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x001000000019e7f0
- (id)_requestBodyDictionary;	// IMP=0x001000000019e06b
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x001000000019dea8
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x001000000019d892
- (void)run;	// IMP=0x001000000019c9f2
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x001000000019c45e
- (id)initWithPostDescription:(id)arg1;	// IMP=0x001000000019c2d8
