...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00200000000a6b71
- (void)run;	// IMP=0x00100000000a65c2
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x00100000000a646a
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x00100000000a63e2
- (id)init;	// IMP=0x00100000000a63cc
