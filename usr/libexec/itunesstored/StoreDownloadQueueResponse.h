...
- (void).cxx_destruct;	// IMP=0x0010000000012768
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x0010000000012664
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x001000000001236e
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x00100000000121ba
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x0010000000011295
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000011280
- (id)init;	// IMP=0x001000000001126e
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0010000000011216
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x0010000000171ffb
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000171700
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x0010000000171697
