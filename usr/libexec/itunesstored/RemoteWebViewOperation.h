...
- (void).cxx_destruct;	// IMP=0x0020000000184ebd
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x0010000000184d08
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0010000000184b07
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0010000000184934
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x0010000000184771
- (void)run;	// IMP=0x00100000001842b4
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x0010000000184223
