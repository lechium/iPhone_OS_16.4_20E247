...
- (void).cxx_destruct;	// IMP=0x0020000000087d23
...
- (id)initWithIdentifier:(id)arg1 keyIdentifier:(id)arg2 nonce:(id)arg3 signature:(id)arg4 timestamp:(id)arg5;	// IMP=0x0010000000087a4c
