...
- (void).cxx_destruct;	// IMP=0x002000000002916e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029022
- (unsigned long long)hash;	// IMP=0x001000000002900c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028f45
