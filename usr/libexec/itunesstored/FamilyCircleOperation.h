...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000011061
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x00100000000106f9
- (id)_cachePath;	// IMP=0x001000000001066d
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000001047f
- (void)run;	// IMP=0x001000000000fee8
- (void)dealloc;	// IMP=0x001000000000fe82
