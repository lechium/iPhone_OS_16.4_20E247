...
- (void).cxx_destruct;	// IMP=0x0020000000183419
- (id)_requestURL;	// IMP=0x00100000001832d8
- (void)main;	// IMP=0x001000000018289e
@property(readonly, copy) NSArray *statusPollRequests;
@property(copy) CDUnknownBlockType responseBlock;
- (id)initWithStatusPollRequests:(id)arg1;	// IMP=0x00100000001826ef
