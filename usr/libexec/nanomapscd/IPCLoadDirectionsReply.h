...
- (void).cxx_destruct;	// IMP=0x002000000003749f
...
- (id)description;	// IMP=0x001000000003738a
- (id)dictionaryValue;	// IMP=0x00100000000371e6
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000003706c
