...
- (void).cxx_destruct;	// IMP=0x00200000000176ea
...
- (id)description;	// IMP=0x00100000000174d7
- (id)dictionaryValue;	// IMP=0x00100000000172b8
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001712d
