...
+ (id)ipcMessageForShieldInfo:(id)arg1;	// IMP=0x001000000003ffe5
- (void).cxx_destruct;	// IMP=0x00100000000378ce
...
- (id)description;	// IMP=0x0010000000037754
- (id)dictionaryValue;	// IMP=0x00100000000375d5
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000374b2
- (id)shieldInfo;	// IMP=0x00100000000400b3
