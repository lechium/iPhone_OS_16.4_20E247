...
- (void).cxx_destruct;	// IMP=0x002000000003703b
...
- (id)description;	// IMP=0x0010000000036f28
- (id)dictionaryValue;	// IMP=0x0010000000036da6
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000036c1e
