...
+ (id)updatedGuidanceWithPreviousGuidance:(id)arg1 currentGuidance:(id)arg2;	// IMP=0x00400000000307d0
- (void).cxx_destruct;	// IMP=0x00200000000319bb
...
- (void)_setNeedsChangeNotification;	// IMP=0x00100000000316d7
- (void)_notifyObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000315a0
- (id)description;	// IMP=0x0010000000030fae
- (void)removeGuidanceObserver:(id)arg1;	// IMP=0x0010000000030f98
- (void)addGuidanceObserver:(id)arg1;	// IMP=0x0010000000030f82
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2;	// IMP=0x0010000000030e7a
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2 shieldInfo:(id)arg3;	// IMP=0x0010000000030ce4
@property(retain, nonatomic) MKServerFormattedString *minorText;
@property(retain, nonatomic) MKServerFormattedString *majorText;
- (id)initWithSignID:(id)arg1 maneuverArtwork:(id)arg2 majorTextAlternatives:(id)arg3 minorTextAlternatives:(id)arg4 shieldInfo:(id)arg5;	// IMP=0x0010000000030956
