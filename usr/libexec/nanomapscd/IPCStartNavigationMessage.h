...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000003eda2
- (void).cxx_destruct;	// IMP=0x002000000003f3d3
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000003f252
- (id)description;	// IMP=0x001000000003f1a3
- (id)dictionaryValue;	// IMP=0x001000000003efd5
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000003edf4
