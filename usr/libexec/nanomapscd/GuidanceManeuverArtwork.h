...
+ (id)artworkWithManeuver:(int)arg1;	// IMP=0x0040000000015c68
- (void).cxx_destruct;	// IMP=0x0020000000015f81
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015e12
- (unsigned long long)hash;	// IMP=0x0010000000015daa
@property(readonly, nonatomic) _Bool isArriveManeuver;
@property(readonly, nonatomic) _Bool isStartRouteManeuver;
- (id)initWithManeuver:(int)arg1 junction:(id)arg2 drivingSide:(int)arg3 artworkDataSource:(id)arg4;	// IMP=0x0010000000015c9d
- (_Bool)isValue:(id)arg1 equalTo:(id)arg2;	// IMP=0x0010000000015bd0
