...
- (void).cxx_destruct;	// IMP=0x0020000000018296
...
- (id)description;	// IMP=0x0010000000018059
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0010000000018005
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0010000000017f4e
@property(readonly) int pid;
- (void)dead;	// IMP=0x0010000000017e75
- (void)dying;	// IMP=0x0010000000017e2a
- (void)dealloc;	// IMP=0x0010000000017deb
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x0010000000017437
