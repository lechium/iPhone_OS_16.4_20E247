...
- (void).cxx_destruct;	// IMP=0x00200000000173d3
...
- (id)description;	// IMP=0x00100000000171db
- (unsigned long long)hash;	// IMP=0x0010000000017197
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000170e9
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x0010000000016f63
