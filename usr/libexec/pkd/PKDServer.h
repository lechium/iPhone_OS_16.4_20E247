...
+ (id)server;	// IMP=0x0020000000001b98
- (void).cxx_destruct;	// IMP=0x0020000000003074
...
- (void)stop;	// IMP=0x0010000000002ca2
- (void)unholdClient:(id)arg1;	// IMP=0x0010000000002a06
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0010000000002728
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0010000000002689
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x00100000000023bd
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000001ce0
- (void)removedPlugIns:(id)arg1;	// IMP=0x0010000000001c02
- (void)run;	// IMP=0x0010000000001ba9
- (id)initWithConnection:(id)arg1 queue:(id)arg2 database:(id)arg3 proxyFactory:(id)arg4;	// IMP=0x00100000000016c1
- (id)initForService:(const char *)arg1 database:(id)arg2 proxyFactory:(id)arg3;	// IMP=0x00100000000015ee
- (void)_startSandbox;	// IMP=0x00100000000015e8
