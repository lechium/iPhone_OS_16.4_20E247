...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x0040000000006ffc
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x0010000000006a7d
+ (void)disableTTRsEntirely;	// IMP=0x0010000000006906
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x00100000000067cd
+ (id)keyname:(id)arg1;	// IMP=0x0010000000006757
- (void).cxx_destruct;	// IMP=0x0020000000007446
...
- (void)trigger;	// IMP=0x0010000000007189
- (void)clearRetryTimestamp;	// IMP=0x00100000000069f4
- (void)updateRetryTimestamp;	// IMP=0x0010000000006913
- (_Bool)isRateLimited;	// IMP=0x00100000000067ef
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x0010000000006606
