...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x0010000000056c4a
- (void).cxx_destruct;	// IMP=0x001000000004acf2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004a9b8
- (unsigned long long)hash;	// IMP=0x001000000004a857
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004a58e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004a35e
- (void)copyTo:(id)arg1;	// IMP=0x001000000004a1bb
- (void)writeTo:(id)arg1;	// IMP=0x001000000004a035
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004a028
- (id)dictionaryRepresentation;	// IMP=0x0010000000049a6a
- (id)description;	// IMP=0x00100000000499bb
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x00100000000498f7
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x00100000000498ae
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x0010000000056a01
