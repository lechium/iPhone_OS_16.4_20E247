...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x0040000000057a85
- (void).cxx_destruct;	// IMP=0x002000000005856f
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x0010000000057cd8
