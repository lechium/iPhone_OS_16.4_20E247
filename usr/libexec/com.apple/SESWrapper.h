...
- (void).cxx_destruct;	// IMP=0x002000000006a5a5
...
- (void)dealloc;	// IMP=0x001000000006a42b
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x0010000000069b96
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x0010000000068f65
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 env:(id)arg3 duplicate:(_Bool)arg4;	// IMP=0x00100000000680bc
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x001000000006611f
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006513e
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x00100000000650c0
- (unsigned long long)srpPublicKeySize;	// IMP=0x0010000000065066
- (unsigned long long)srpKeySize;	// IMP=0x0010000000064ff0
- (id)srpInitBlob;	// IMP=0x0010000000064e68
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x0010000000064bf6
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x0010000000064b11
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x0010000000064954
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x00100000000648f3
- (id)initWithRequest:(id)arg1;	// IMP=0x00100000000648df
