...
@interface EscrowGenericRequest
{
    ...
    MISSING_TYPE *_escrowRecord;	// 64 = 0x40
    ...
    LakituAccount *_cachedCurrentAccount;	// 240 = 0xf0
    NSString *_requestDSID;	// 248 = 0xf8
}

- (void).cxx_destruct;	// IMP=0x002000000001cedc
...
- (id)additionalHeaders;	// IMP=0x001000000001caed
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x001000000001ca3b
- (id)urlString;	// IMP=0x001000000001c98b
- (id)urlRequest;	// IMP=0x001000000001c851
- (id)authorizationHeader;	// IMP=0x001000000001c741
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x001000000001c544
- (id)bodyDictionary;	// IMP=0x001000000001c223
- (id)validateInput;	// IMP=0x001000000001bed4
...
- (id)currentAccount;	// IMP=0x001000000001ba55
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x001000000001b881
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000001b3b1
