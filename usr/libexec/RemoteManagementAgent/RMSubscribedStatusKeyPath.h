...
+ (id)fetchRequestWithKeyPaths:(id)arg1;	// IMP=0x002000000008f458
- (id)reportDetails;	// IMP=0x002000000008f4ff
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x001000000008f0ea
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x001000000008f04d
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000008ee33
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000008ec19
- (void)awakeFromInsert;	// IMP=0x001000000008ebb2
