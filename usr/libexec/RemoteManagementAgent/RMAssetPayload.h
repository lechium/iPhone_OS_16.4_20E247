...
- (id)reportDetails;	// IMP=0x001000000000a29e
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000a61b
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000a377
