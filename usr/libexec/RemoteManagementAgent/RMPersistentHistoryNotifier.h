...
+ (id)sharedQueryQueue;	// IMP=0x0040000000061eae
- (void).cxx_destruct;	// IMP=0x0020000000063842
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000062738
- (void)_delayedQuery;	// IMP=0x00100000000623ff
- (void)_scheduleQueryForTransactions;	// IMP=0x00100000000622da
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x00100000000621f6
- (void)start;	// IMP=0x0010000000061f55
- (void)dealloc;	// IMP=0x0010000000061e06
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000061d64
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x0010000000061cc3
