...
+ (id)newListenerWithDelegate:(id)arg1;	// IMP=0x002000000002d0ff
- (void).cxx_destruct;	// IMP=0x002000000002d6fc
...
- (void)triggerAggregatingTimerAction;	// IMP=0x001000000002d51f
- (void)didReceiveNotification:(id)arg1;	// IMP=0x001000000002d466
- (void)stopListening;	// IMP=0x001000000002d3da
- (void)startListening;	// IMP=0x001000000002d255
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000002d148
