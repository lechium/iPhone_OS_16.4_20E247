...
- (void)markPending;	// IMP=0x0020000000022822
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x00100000000224d2
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x001000000002215f
- (void)markQueued;	// IMP=0x00100000000220fc
