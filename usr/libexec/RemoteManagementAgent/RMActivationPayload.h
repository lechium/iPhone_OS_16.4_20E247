...
- (id)reportDetails;	// IMP=0x0010000000008f43
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000009b62
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000009223
