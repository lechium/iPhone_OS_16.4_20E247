...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x002000000002177a
- (id)reportDetails;	// IMP=0x0020000000021fc6
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000021a5b
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x00100000000217ea
