...
- (void).cxx_destruct;	// IMP=0x0020000000091ee8
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000091ccd
- (id)initWithPersistentContainer:(id)arg1 allowedToRun:(_Bool)arg2;	// IMP=0x0010000000091c57
