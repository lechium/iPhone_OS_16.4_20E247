...
- (void).cxx_destruct;	// IMP=0x0020000000089aa6
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000008988b
- (id)initWithPersistentContainer:(id)arg1 allowedToRun:(_Bool)arg2;	// IMP=0x0010000000089815
