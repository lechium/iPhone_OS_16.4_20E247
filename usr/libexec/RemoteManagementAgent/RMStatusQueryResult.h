...
- (void).cxx_destruct;	// IMP=0x0010000000075f4e
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x0010000000075203
- (id)init;	// IMP=0x001000000007519f
