...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x0020000000051bd8
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x0010000000051b31
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x0010000000051aae
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(short)arg2;	// IMP=0x00100000000519f9
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x0010000000051952
- (id)reportDetails;	// IMP=0x0020000000051c7f
- (void)awakeFromInsert;	// IMP=0x00100000000518bd
