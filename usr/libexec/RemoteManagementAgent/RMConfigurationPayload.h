...
- (id)reportDetails;	// IMP=0x0010000000022f58
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000002367b
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000230b3
