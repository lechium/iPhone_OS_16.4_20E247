...
- (void).cxx_destruct;	// IMP=0x002000000005bd69
...
- (_Bool)containsIdentifier:(id)arg1;	// IMP=0x001000000005bb9b
- (_Bool)removeIdentifier:(id)arg1;	// IMP=0x001000000005b948
- (void)updateTimeOnIdentifier:(id)arg1;	// IMP=0x001000000005b7b7
- (_Bool)addIdentifierIfNotPresent:(id)arg1;	// IMP=0x001000000005b072
- (id)initWithTimeout:(double)arg1;	// IMP=0x001000000005afb7
