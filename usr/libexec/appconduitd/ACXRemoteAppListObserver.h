...
- (void).cxx_destruct;	// IMP=0x0020000000044bfe
...
- (unsigned long long)hash;	// IMP=0x0010000000044bc2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000044ab7
- (id)initWithObserver:(id)arg1 queue:(id)arg2;	// IMP=0x00100000000449d0
