...
@interface ACXServerInstallOperation : NSObject
{
    ...
    MISSING_TYPE *_transferStartTime;	// 144 = 0x90
    NSURL *_appURL;	// 152 = 0x98
    long long _appSize;	// 160 = 0xa0
    ACXIDSSocketManager *_socketManager;	// 168 = 0xa8
}

+ (id)installOperationForURL:(id)arg1 watchAppBundleIdentifier:(id)arg2 companionAppBundleID:(id)arg3 isPlaceholder:(_Bool)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;	// IMP=0x002000000003ff05
+ (id)installOperationForCompanionAppBundleIdentifier:(id)arg1 watchAppBundleIdentifier:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;	// IMP=0x001000000003fe80
- (void).cxx_destruct;	// IMP=0x00200000000437fc
...
- (void)socketDidCloseWithError:(id)arg1;	// IMP=0x001000000004353d
- (void)receivedDictionaryOrData:(id)arg1;	// IMP=0x0010000000041c83
- (void)_onQueue_startInstall;	// IMP=0x00100000000419f0
- (void)_onQueue_doTransferAndInstall;	// IMP=0x0010000000041597
- (void)_onQueue_prepForTransferAndInstall;	// IMP=0x0010000000040c26
- (id)_onQueue_sendCancelMessage;	// IMP=0x0010000000040b13
- (id)_makeTempDirectoryWithError:(id *)arg1;	// IMP=0x0010000000040a22
- (void)_onQueue_callCompletion:(id)arg1;	// IMP=0x0010000000040783
- (void)_onQueue_callProgressBlockWithPhase:(unsigned long long)arg1 percent:(double)arg2;	// IMP=0x001000000004066c
- (void)_onQueue_disarmWatchdog;	// IMP=0x00100000000405e7
- (void)_onQueue_armWatchdog;	// IMP=0x00100000000403ec
- (void)cancel;	// IMP=0x0010000000040360
- (void)beginWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000003ffbd
- (void)dealloc;	// IMP=0x001000000003fd91
- (id)initWithWatchAppBundleID:(id)arg1 companionAppBundleID:(id)arg2 isPlaceholder:(_Bool)arg3 appURL:(id)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;	// IMP=0x001000000003fc7f
- (id)initWithCompanionBundleID:(id)arg1 watchAppBundleID:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;	// IMP=0x001000000003fba3
- (void)_commonInit:(_Bool)arg1;	// IMP=0x001000000003fa94
