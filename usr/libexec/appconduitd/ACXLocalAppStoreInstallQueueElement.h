...
- (void).cxx_destruct;	// IMP=0x00200000000331d1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003307a
- (unsigned long long)hash;	// IMP=0x001000000003300c
- (id)initWithApp:(id)arg1 isUserInitiated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032f58
