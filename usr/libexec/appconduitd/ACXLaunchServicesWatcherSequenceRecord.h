...
- (void).cxx_destruct;	// IMP=0x002000000001340e
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000131ae
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000012ec1
- (id)initWithLSSequenceNumber:(unsigned long long)arg1 acxSequenceNumber:(unsigned long long)arg2 counterpartIdentifiers:(id)arg3;	// IMP=0x0010000000012e38
