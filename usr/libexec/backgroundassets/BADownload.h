...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000038778
+ (id)classesForSerialization;	// IMP=0x00100000000093c7
- (void).cxx_destruct;	// IMP=0x001000000003a494
...
- (id)debugDescription;	// IMP=0x0010000000039dde
- (id)description;	// IMP=0x0010000000039ce4
- (unsigned long long)hash;	// IMP=0x0010000000039c57
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000039b13
- (id)copyAsNonEssential;	// IMP=0x0010000000039ae1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000395cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000390ef
- (id)initPrivatelyWithApplicationGroupIdentifier:(id)arg1;	// IMP=0x0010000000038e9d
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000387e8
- (id)init;	// IMP=0x0010000000038780
- (void)_removePowerAssertionAndActivity;	// IMP=0x0010000000009352
- (void)_addPowerAssertionAndActivityWithIdentifier:(id)arg1;	// IMP=0x00100000000091f9
- (void)setApplicationInformationForRestrictedDownload:(id)arg1;	// IMP=0x001000000000919f
- (_Bool)startDownloadWithDelegate:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000009144
- (void)cancelDownloadSilently;	// IMP=0x00100000000090ec
- (void)cancelDownload;	// IMP=0x0010000000009094
- (void)pauseDownload;	// IMP=0x001000000000903c
- (void)demoteToBackground;	// IMP=0x0010000000008fe4
- (void)promoteToForeground;	// IMP=0x0010000000008f8c
- (long long)compare:(id)arg1;	// IMP=0x0010000000009536
