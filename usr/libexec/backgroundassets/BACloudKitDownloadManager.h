...
- (void).cxx_destruct;	// IMP=0x0020000000030de5
...
- (id)_newOperationQuery;	// IMP=0x00100000000309a3
- (void)_downloadActualAsset;	// IMP=0x0010000000030032
- (_Bool)_consumeAvailableDownloadSize;	// IMP=0x001000000002fdb5
- (void)_downloadSucceededWithURL:(id)arg1;	// IMP=0x001000000002fc2a
- (void)_downloadFailedWithError:(id)arg1;	// IMP=0x001000000002faa0
- (void)cancelDownload;	// IMP=0x001000000002fa63
- (void)pauseDownload;	// IMP=0x001000000002f93b
- (_Bool)startDownloadWithError:(id *)arg1;	// IMP=0x001000000002eda6
- (id)initWithDownload:(id)arg1 withDelegate:(id)arg2;	// IMP=0x001000000002ec7b
