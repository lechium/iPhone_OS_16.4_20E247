...
- (void).cxx_destruct;	// IMP=0x0020000000011cc8
...
- (void)startAsyncDownloadNotifyingOnQueue:(id)arg1 sessionConfiguration:(id)arg2 bytesReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000011207
- (void)cancel;	// IMP=0x001000000001102e
- (void)invalidate;	// IMP=0x0010000000010f82
- (id)_initWithURLRequest:(id)arg1 withResumeData:(id)arg2 withDestinationDirectory:(id)arg3 inBackground:(_Bool)arg4 withAuthenticationHandler:(CDUnknownBlockType)arg5 withRedirectResponseHandler:(CDUnknownBlockType)arg6;	// IMP=0x0010000000010b5d
- (id)initWithResumeData:(id)arg1 withDestinationDirectory:(id)arg2 inBackground:(_Bool)arg3 withAuthenticationHandler:(CDUnknownBlockType)arg4 withRedirectResponseHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000010b34
- (id)initWithURLRequest:(id)arg1 withDestinationDirectory:(id)arg2 inBackground:(_Bool)arg3 withAuthenticationHandler:(CDUnknownBlockType)arg4 withRedirectResponseHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000010b0e
- (id)initWithURLRequest:(id)arg1 withDestinationDirectory:(id)arg2 inBackground:(_Bool)arg3 withAuthenticationHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000010aeb
- (id)initWithURLRequest:(id)arg1 withDestinationDirectory:(id)arg2 inBackground:(_Bool)arg3;	// IMP=0x0010000000010ac5
- (id)init;	// IMP=0x0010000000010ab7
