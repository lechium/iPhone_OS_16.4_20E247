...
- (void).cxx_destruct;	// IMP=0x00200000001984fa
...
- (id)description;	// IMP=0x00100000001983f3
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x001000000019812c
- (id)initWithInvitation:(id)arg1 recipientHandle:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000019807d
