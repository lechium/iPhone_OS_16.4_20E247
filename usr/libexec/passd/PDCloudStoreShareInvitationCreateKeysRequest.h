...
- (void).cxx_destruct;	// IMP=0x0020000000198a87
...
- (id)description;	// IMP=0x00100000001988ff
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x001000000019860d
- (id)initWithHandle:(id)arg1 permission:(long long)arg2 zoneName:(id)arg3 containerName:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x001000000019852b
