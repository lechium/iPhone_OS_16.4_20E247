...
- (void).cxx_destruct;	// IMP=0x00200000003dfba7
@property(readonly, nonatomic) unsigned long long passType; // @synthesize passType=_passType;
- (void)setNFCEnabled:(_Bool)arg1;	// IMP=0x00100000003dfb94
- (_Bool)isNFCEnabled;	// IMP=0x00100000003dfb8b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000003df7f3
