...
- (void).cxx_destruct;	// IMP=0x00200000000cab87
...
- (unsigned long long)hash;	// IMP=0x00100000000caa8a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ca9dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ca90a
