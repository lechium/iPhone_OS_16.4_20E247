...
- (void).cxx_destruct;	// IMP=0x00200000001d0efd
...
- (id)description;	// IMP=0x00100000001d0d24
- (_Bool)hasContainerDatabase;	// IMP=0x00100000001d0d16
- (_Bool)hasCloudStoreZones;	// IMP=0x00100000001d0b9d
