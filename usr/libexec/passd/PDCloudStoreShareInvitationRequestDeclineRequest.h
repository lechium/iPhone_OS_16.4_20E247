...
- (void).cxx_destruct;	// IMP=0x00200000001994dc
...
- (id)description;	// IMP=0x0010000000199358
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x0010000000199086
- (id)initWithHandle:(id)arg1 zoneName:(id)arg2 containerName:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000198fa8
