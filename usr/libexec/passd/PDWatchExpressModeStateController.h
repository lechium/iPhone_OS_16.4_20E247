...
- (void).cxx_destruct;	// IMP=0x0020000000376eb9
...
- (void)receivedXPCEvent:(id)arg1 forEventStream:(id)arg2;	// IMP=0x0010000000376afa
- (void)_updateExpressModeEnablement;	// IMP=0x0010000000376a46
- (void)_updateExpressAvailabilityListeners;	// IMP=0x00100000003769db
- (void)_requestUpdateExpressStatus:(unsigned long long)arg1;	// IMP=0x00100000003767ad
- (void)_logControllerState;	// IMP=0x00100000003766b5
- (void)_unregisterForExpressAvailabilityChanges;	// IMP=0x0010000000376642
- (void)_registerForExpressAvailabilityChanges;	// IMP=0x0010000000376599
- (void)setExpressModeAllowed:(_Bool)arg1;	// IMP=0x00100000003764c6
- (id)initWithExpressPassInformation:(id)arg1 inLostMode:(_Bool)arg2;	// IMP=0x00100000003763c0
