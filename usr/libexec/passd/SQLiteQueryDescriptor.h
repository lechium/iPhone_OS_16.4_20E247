...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x0010000000092c0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000092b59
- (void)dealloc;	// IMP=0x0010000000092b01
