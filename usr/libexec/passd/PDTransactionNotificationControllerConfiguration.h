...
- (void).cxx_destruct;	// IMP=0x00200000002a9ba5
...
- (id)description;	// IMP=0x00100000002a9856
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x00100000002a97cb
- (id)passUniqueIdentifier;	// IMP=0x00100000002a97b5
