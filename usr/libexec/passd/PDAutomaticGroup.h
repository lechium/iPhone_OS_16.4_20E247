...
+ (id)createAutomaticGroupForPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x00400000003de961
- (void).cxx_destruct;	// IMP=0x00200000003df764
...
- (_Bool)updateOrderWithCatalogGroup:(id)arg1;	// IMP=0x00100000003df2d4
- (_Bool)removePass:(id)arg1;	// IMP=0x00100000003df135
- (_Bool)addPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x00100000003dec1e
