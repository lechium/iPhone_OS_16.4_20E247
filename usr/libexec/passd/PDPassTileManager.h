...
@interface PDPassTileManager : NSObject
{
    ...
    id <PDPassTileManagerDelegate>;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x002000000039ff18
- (void)vehicleReportDidChangeForCarKeyWithAppletIdentifier:(id)arg1 keyIdentifier:(id)arg2;	// IMP=0x001000000039fa0d
- (id)init;	// IMP=0x001000000039eece
