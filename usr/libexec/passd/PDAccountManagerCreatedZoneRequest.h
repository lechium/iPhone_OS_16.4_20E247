...
- (void).cxx_destruct;	// IMP=0x002000000045248e
...
- (void)callCompletionsWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00100000004521f2
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000004521b2
- (_Bool)coalesceWithRequest:(id)arg1;	// IMP=0x0010000000451ed0
- (id)requestIdentifier;	// IMP=0x0010000000451e56
- (unsigned long long)requestType;	// IMP=0x0010000000451e4b
- (id)initWithZoneAccountIdentifier:(id)arg1 containerName:(id)arg2 zoneName:(id)arg3;	// IMP=0x0010000000451d77
