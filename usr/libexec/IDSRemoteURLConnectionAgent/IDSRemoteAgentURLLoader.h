...
+ (_Bool)shouldAssertWiFi;	// IMP=0x0020000000002029
- (void).cxx_destruct;	// IMP=0x00200000000026a0
...
- (void)cancel;	// IMP=0x001000000000248e
- (void)load;	// IMP=0x001000000000225c
- (void)dealloc;	// IMP=0x001000000000222d
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000002031
