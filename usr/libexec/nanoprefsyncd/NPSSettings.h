...
+ (id)bbAppsSettings;	// IMP=0x00400000000294aa
+ (id)preprocessItemSyncGroups:(id)arg1 forDomain:(id)arg2 key:(id)arg3;	// IMP=0x00100000000264f0
+ (_Bool)domainShouldSyncFirst:(id)arg1 key:(id)arg2;	// IMP=0x001000000002633e
- (void).cxx_destruct;	// IMP=0x002000000002954c
...
- (void)loadSettingsBundles;	// IMP=0x0010000000026ab6
- (id)_settingBundlesInDirectories:(id)arg1;	// IMP=0x00100000000265fa
