...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x004000000006702b
- (void).cxx_destruct;	// IMP=0x0020000000067c63
- (int)persist;	// IMP=0x0010000000067501
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x001000000006724d
- (void)dealloc;	// IMP=0x0010000000066f9f
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000066540
