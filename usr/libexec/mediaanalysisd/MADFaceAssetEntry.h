...
+ (id)entryWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x004000000006ce51
- (void).cxx_destruct;	// IMP=0x002000000006cf3c
...
- (id)initWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x001000000006cdc0
