...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000007d16b
- (void).cxx_destruct;	// IMP=0x002000000007d98e
...
- (_Bool)downloadTimedout;	// IMP=0x001000000007d723
- (void)updateLastestDownloadTimestamp;	// IMP=0x001000000007d5ff
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x001000000007d3b3
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000007d216
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000007cf5d
