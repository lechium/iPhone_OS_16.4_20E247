...
+ (id)entryWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x004000000000f7d2
- (void).cxx_destruct;	// IMP=0x002000000000f88b
...
- (id)initWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x001000000000f720
