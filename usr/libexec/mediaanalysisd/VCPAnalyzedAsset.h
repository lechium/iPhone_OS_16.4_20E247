...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x004000000001ceb3
- (void).cxx_destruct;	// IMP=0x002000000001d083
...
- (_Bool)isDegraded;	// IMP=0x001000000001cffe
- (_Bool)isDeletePending;	// IMP=0x001000000001cff0
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x001000000001cfdf
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x001000000001cd30
