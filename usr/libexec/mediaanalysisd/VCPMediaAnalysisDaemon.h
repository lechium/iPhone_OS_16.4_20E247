...
- (void).cxx_destruct;	// IMP=0x0020000000003522
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x00100000000032ea
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002f9d
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000002ac6
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000002580
