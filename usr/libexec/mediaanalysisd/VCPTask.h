...
- (void).cxx_destruct;	// IMP=0x00200000000dd46c
...
- (void)main;	// IMP=0x00100000000dd3cf
- (int)mainInternal;	// IMP=0x00100000000dd3c4
- (_Bool)isCancelled;	// IMP=0x00100000000dd374
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000dd2c0
- (id)init;	// IMP=0x00100000000dd2b2
