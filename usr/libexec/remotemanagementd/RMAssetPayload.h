...
- (id)reportDetails;	// IMP=0x001000000000a2be
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000a63b
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000a397
