...
- (id)reportDetails;	// IMP=0x0010000000008f63
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000009b82
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000009243
