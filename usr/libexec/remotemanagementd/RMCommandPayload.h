...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x002000000002179a
- (id)reportDetails;	// IMP=0x0020000000021fe6
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000021a7b
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000002180a
