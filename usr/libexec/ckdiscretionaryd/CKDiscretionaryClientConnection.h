...
- (void).cxx_destruct;	// IMP=0x0020000000006a08
...
- (void)cleanup;	// IMP=0x0010000000006518
- (void)finishOperationID:(id)arg1;	// IMP=0x001000000000616b
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxy:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000000544b
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x0010000000004ef6
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000004d67
