...
- (void).cxx_destruct;	// IMP=0x0020000000004787
...
- (void)complete;	// IMP=0x0010000000004447
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x0010000000004196
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x0010000000003ee5
- (id)_schedulerTaskIdentifier;	// IMP=0x0010000000003de3
- (void)dealloc;	// IMP=0x0010000000003acf
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0010000000002a95
