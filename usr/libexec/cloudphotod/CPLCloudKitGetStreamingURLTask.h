...
- (void).cxx_destruct;	// IMP=0x002000000012436c
...
- (void)_fetchStreamingURL;	// IMP=0x00100000001235cc
- (void)runOperations;	// IMP=0x001000000012353c
- (_Bool)shouldRequestEncryptedStream;	// IMP=0x00100000001234e3
- (id)_streamOperationForKey:(id)arg1 operationType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000122aab
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 timeRange:(CDStruct_e83c9415)arg4 target:(id)arg5 transportScopeMapping:(id)arg6 cache:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;	// IMP=0x00100000001228cb
