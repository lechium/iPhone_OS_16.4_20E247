...
- (void).cxx_destruct;	// IMP=0x00200000000566e5
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0010000000056511
- (id)initWithResource:(id)arg1;	// IMP=0x001000000005631a
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000056194
