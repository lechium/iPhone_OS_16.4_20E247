...
- (void).cxx_destruct;	// IMP=0x00200000000b7d00
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *messages; // @synthesize messages=_messages;
- (void)runOperations;	// IMP=0x00100000000b78b7
- (id)initWithController:(id)arg1 messages:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b77db
