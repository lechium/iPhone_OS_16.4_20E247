...
- (void).cxx_destruct;	// IMP=0x00200000000383ec
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038262
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x0010000000038120
