...
- (void).cxx_destruct;	// IMP=0x00200000000bd23f
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x00100000000bce92
- (id)operationDescription;	// IMP=0x00100000000bce8a
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000bce82
