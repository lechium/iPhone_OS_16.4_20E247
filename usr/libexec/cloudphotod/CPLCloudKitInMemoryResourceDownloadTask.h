...
- (void).cxx_destruct;	// IMP=0x0020000000132f85
...
- (void)_startDownload;	// IMP=0x00100000001325ea
- (void)_fetchPlaceholderRecordAndStartDownload;	// IMP=0x00100000001323d3
- (void)runOperations;	// IMP=0x001000000013227b
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 record:(id)arg3 keys:(id)arg4 operationType:(long long)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000131999
- (id)initWithController:(id)arg1 resource:(id)arg2 record:(id)arg3 target:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000001317ea
