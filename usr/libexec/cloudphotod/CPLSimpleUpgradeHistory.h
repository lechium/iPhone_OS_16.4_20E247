...
- (void).cxx_destruct;	// IMP=0x0020000000075784
...
- (void)resetVersionHasChanged;	// IMP=0x00100000000753f3
...
- (void)noteDatabaseWasUpgradedToVersion:(long long)arg1 fromVersion:(long long)arg2;	// IMP=0x00100000000750a2
- (id)_valueForKey:(id)arg1 class:(Class)arg2;	// IMP=0x0010000000075047
- (id)initWithLibraryIdentifier:(id)arg1;	// IMP=0x001000000007473a
- (void)_save;	// IMP=0x00100000000745e6
- (id)_defaultsKey;	// IMP=0x00100000000745c9
