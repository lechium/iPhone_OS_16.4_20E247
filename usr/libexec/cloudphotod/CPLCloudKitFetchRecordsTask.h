...
- (void).cxx_destruct;	// IMP=0x00200000001249c8
...
- (void)runOperations;	// IMP=0x0010000000124942
- (id)initWithController:(id)arg1 scopedIdentifiers:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000124834
