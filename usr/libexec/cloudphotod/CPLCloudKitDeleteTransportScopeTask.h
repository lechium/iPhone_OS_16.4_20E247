...
- (void).cxx_destruct;	// IMP=0x00200000000c9bfe
...
- (void)runOperations;	// IMP=0x00100000000c9026
- (void)_didFinishDeleteWithError:(id)arg1;	// IMP=0x00100000000c8d08
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x00100000000c8bac
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000c8aca
