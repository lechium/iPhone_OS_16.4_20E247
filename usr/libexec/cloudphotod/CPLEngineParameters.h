...
- (void).cxx_destruct;	// IMP=0x002000000001b2de
...
- (_Bool)matchesParameters:(id)arg1;	// IMP=0x001000000001b108
- (id)redactedDescription;	// IMP=0x001000000001b054
- (id)description;	// IMP=0x001000000001afa0
@property(readonly, nonatomic) id asPlist;
- (id)initWithPlist:(id)arg1;	// IMP=0x001000000001abce
- (id)initWithClientLibraryBaseURL:(id)arg1 cloudLibraryStateStorageURL:(id)arg2 cloudLibraryResourceStorageURL:(id)arg3 libraryIdentifier:(id)arg4 options:(unsigned long long)arg5;	// IMP=0x001000000001aab9
