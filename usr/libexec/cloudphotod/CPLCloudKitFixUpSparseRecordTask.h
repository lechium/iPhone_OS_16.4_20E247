...
- (void).cxx_destruct;	// IMP=0x00200000000fd98c
@property(readonly, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *tasks; // @synthesize tasks=_tasks;
- (void)runOperations;	// IMP=0x00100000000fd79d
- (void)_updateSparseRecords:(id)arg1 currentUserRecordID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000fc57b
- (void)_fetchSparseRecordsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000fc318
- (id)initWithController:(id)arg1 tasks:(id)arg2 transportScopeMapping:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000fc230
