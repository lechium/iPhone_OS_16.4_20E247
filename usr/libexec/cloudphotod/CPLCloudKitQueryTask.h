...
- (void).cxx_destruct;	// IMP=0x00200000000c386d
...
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000c1eb7
- (void)runOperations;	// IMP=0x00100000000c1e35
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x00100000000c1dbb
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 scope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000c1c0a
