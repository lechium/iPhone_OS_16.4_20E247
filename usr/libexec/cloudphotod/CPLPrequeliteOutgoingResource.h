...
- (void).cxx_destruct;	// IMP=0x002000000004658f
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x00100000000463ea
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x00100000000462df
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x0010000000045fe2
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000045e8e
