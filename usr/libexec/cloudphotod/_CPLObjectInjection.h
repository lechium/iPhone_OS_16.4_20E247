...
- (void).cxx_destruct;	// IMP=0x0020000000052bb1
...
- (id)bindValuesToKeepAlive;	// IMP=0x0010000000052b85
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x00100000000528ad
- (id)initWithVariables:(id)arg1 object:(id)arg2 sql:(id)arg3;	// IMP=0x00100000000527f6
