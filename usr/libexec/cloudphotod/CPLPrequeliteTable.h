...
+ (id)tableWithName:(id)arg1;	// IMP=0x0020000000050b6a
- (void).cxx_destruct;	// IMP=0x0020000000050d69
@property(readonly, nonatomic) NSString *tableName; // @synthesize tableName=_tableName;
- (id)redactedDescription;	// IMP=0x0010000000050d36
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000050cf7
@property(readonly, nonatomic) NSString *injectedTableName;
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1;	// IMP=0x0010000000050bb3
