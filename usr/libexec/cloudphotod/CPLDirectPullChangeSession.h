...
+ (id)selfCrashResetReason;	// IMP=0x00200000000a6c4d
- (void).cxx_destruct;	// IMP=0x00200000000a6d19
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a5f3c
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a4df3
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a3bb9
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a3338
- (id)clientWorkDescription;	// IMP=0x00100000000a332b
