...
- (void).cxx_destruct;	// IMP=0x00200000000f44d5
...
- (void)runOperations;	// IMP=0x00100000000f41e1
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 scopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000f40d4
