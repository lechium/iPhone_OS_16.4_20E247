...
- (void).cxx_destruct;	// IMP=0x0020000000143c82
...
- (void)runOperations;	// IMP=0x00100000001438bd
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1 currentUserID:(id)arg2;	// IMP=0x0010000000143641
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1;	// IMP=0x001000000014356f
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000143462
