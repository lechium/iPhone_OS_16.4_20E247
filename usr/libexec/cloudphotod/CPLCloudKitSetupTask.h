...
- (void).cxx_destruct;	// IMP=0x00200000000c1ac5
...
- (void)runOperations;	// IMP=0x00100000000c1aa3
- (void)fetchUserRecord;	// IMP=0x00100000000c19e2
- (void)fetchDerivativesFilter;	// IMP=0x00100000000c1704
- (void)fetchDisabledFeatures;	// IMP=0x00100000000c1299
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000c1203
