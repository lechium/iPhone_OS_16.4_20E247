...
- (void).cxx_destruct;	// IMP=0x00200000000c7f7e
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x00100000000c7c25
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x00100000000c7901
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x00100000000c78ab
