...
- (void).cxx_destruct;	// IMP=0x0020000000138c93
...
- (void)auxiliaryOperationDidFinishWithError:(id)arg1;	// IMP=0x0010000000138b69
- (void)launchAuxiliaryOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3;	// IMP=0x00100000001389f8
- (void)operationDidFinishWithError:(id)arg1;	// IMP=0x0010000000138990
- (void)updateProgress:(double)arg1;	// IMP=0x001000000013895b
- (void)updateContextWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001388f3
- (void)updateOneBatch;	// IMP=0x00100000001388be
- (void)operationDidFinish:(id)arg1 error:(id)arg2;	// IMP=0x0010000000138849
- (void)launchOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3 sourceBundleIdentifiers:(id)arg4;	// IMP=0x001000000013875d
- (void)dispatchAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001385d4
- (void)runOperations;	// IMP=0x001000000013825a
- (void)runAuxiliaryOperation;	// IMP=0x0010000000137dbe
- (void)_fetchAndMoveNextBatchWithUserRecordID:(id)arg1;	// IMP=0x00100000001377df
- (void)_moveBatchRecordWithNames:(id)arg1 userRecordID:(id)arg2 operationID:(id)arg3 moveBatchID:(id)arg4 hasMore:(_Bool)arg5;	// IMP=0x001000000013714b
- (void)_sendExitFeedbackWithSourceRecordIDs:(id)arg1 destinationRecordIDs:(id)arg2 moveError:(id)arg3 operationID:(id)arg4 moveBatchID:(id)arg5;	// IMP=0x0010000000136d0d
- (id)initWithController:(id)arg1 stagedScope:(id)arg2 stagingScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000136ad2
