...
- (void).cxx_destruct;	// IMP=0x00200000000ec966
- (void)runOperations;	// IMP=0x00100000000ec200
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x00100000000ec184
- (double)timeoutIntervalForRequest;	// IMP=0x00100000000ec176
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ec0bb
