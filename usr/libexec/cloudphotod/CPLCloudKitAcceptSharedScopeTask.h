...
- (void).cxx_destruct;	// IMP=0x00200000000d22cf
- (void)_acceptShareWithMetadata:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d19d9
- (void)_fetchMetadataForShareURL:(id)arg1 currentUserID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d08ea
- (void)_acceptShareWithURL:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d079d
- (void)_updateScopeParticipantsWithCKShare:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000d067e
- (void)_updateScopeAndFlagsWithCKRecord:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000d0566
- (void)runOperations;	// IMP=0x00100000000cfd75
- (id)initWithController:(id)arg1 scope:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000cfcb8
