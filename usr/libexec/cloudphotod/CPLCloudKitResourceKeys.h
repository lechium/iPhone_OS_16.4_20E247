...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x0040000000110b31
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x0010000000110adc
- (void).cxx_destruct;	// IMP=0x0020000000110fe5
...
- (id)redactedDescription;	// IMP=0x0010000000110e3d
- (id)description;	// IMP=0x0010000000110dc0
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x0010000000110bc5
