...
- (void).cxx_destruct;	// IMP=0x0020000000004ef4
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000048bf
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003b06
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003a8d
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x001000000000395e
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000033e3
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00100000000032fd
- (void)unregisterFromPushNotifications;	// IMP=0x0010000000003266
- (void)stopWaitingForPushNotifications;	// IMP=0x0010000000003180
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002ad8
- (id)init;	// IMP=0x001000000000287b
