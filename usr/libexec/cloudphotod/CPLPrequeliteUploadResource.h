...
- (void).cxx_destruct;	// IMP=0x00200000000608b1
...
- (id)resource;	// IMP=0x00100000000606cb
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000604e5
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006036a
