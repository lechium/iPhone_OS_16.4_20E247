...
- (void).cxx_destruct;	// IMP=0x0010000000003702
...
- (void)clearCache;	// IMP=0x00100000000035e1
- (void)scheduleCacheOperation:(unsigned long long)arg1;	// IMP=0x00100000000034c1
- (void)start;	// IMP=0x00100000000033ad
- (id)initWithServiceName:(id)arg1;	// IMP=0x001000000000307b
- (id)generateStoreUnitWithRequest:(id)arg1 validationToken:(id *)arg2;	// IMP=0x001000000000433e
- (void)clearCachedItemsForBundeID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000042e6
- (void)generateImageWithRequest:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003b60
- (void)fetchCacheConfigurationWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003936
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003777
