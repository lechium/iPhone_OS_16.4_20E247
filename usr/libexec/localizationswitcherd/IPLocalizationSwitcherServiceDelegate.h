...
- (void).cxx_destruct;	// IMP=0x00200000000023fd
...
- (void)preferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x0010000000001e61
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001deb
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001d75
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001c27
