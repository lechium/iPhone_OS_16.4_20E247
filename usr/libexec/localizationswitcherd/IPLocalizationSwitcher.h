...
- (void)preferredLanguagesForBundleID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000029e6
- (void)notifyPreferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x0010000000002974
- (void)setPreferredLanguage:(id)arg1 forBundleID:(id)arg2 andRelaunchWithReply:(CDUnknownBlockType)arg3;	// IMP=0x001000000000287f
