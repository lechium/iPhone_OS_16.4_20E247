...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000001dc76
- (void).cxx_destruct;	// IMP=0x002000000001e2a7
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000001e126
- (id)description;	// IMP=0x001000000001e077
- (id)dictionaryValue;	// IMP=0x001000000001dea9
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001dcc8
