...
- (void).cxx_destruct;	// IMP=0x002000000000dcdb
...
- (id)description;	// IMP=0x001000000000dbc6
- (id)dictionaryValue;	// IMP=0x001000000000da22
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000d8a8
