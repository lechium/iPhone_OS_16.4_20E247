...
+ (Class)placesType;	// IMP=0x00200000000144bc
- (void).cxx_destruct;	// IMP=0x0020000000016a15
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000165f2
- (unsigned long long)hash;	// IMP=0x0010000000015ef2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015bd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000015834
- (void)copyTo:(id)arg1;	// IMP=0x00100000000155e7
- (void)writeTo:(id)arg1;	// IMP=0x001000000001530d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000015300
- (id)dictionaryRepresentation;	// IMP=0x001000000001457c
- (id)description;	// IMP=0x00100000000144cd
- (id)placesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000001449f
- (unsigned long long)placesCount;	// IMP=0x0010000000014482
- (void)addPlaces:(id)arg1;	// IMP=0x0010000000014418
- (void)clearPlaces;	// IMP=0x00100000000143fb
- (int)StringAsDirectionsMode:(id)arg1;	// IMP=0x0010000000014330
- (id)directionsModeAsString:(int)arg1;	// IMP=0x00100000000142e7
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000013eed
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000013ea4
