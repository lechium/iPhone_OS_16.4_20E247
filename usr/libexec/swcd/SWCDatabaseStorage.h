...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000013deb
- (void).cxx_destruct;	// IMP=0x002000000001488b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000013e99
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000013df3
