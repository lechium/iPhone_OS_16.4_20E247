...
- (void).cxx_destruct;	// IMP=0x00100000000103d7
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000fffa
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000fe12
- (id)init;	// IMP=0x001000000000fd51
- (void)_loadEnterpriseData;	// IMP=0x001000000001040a
