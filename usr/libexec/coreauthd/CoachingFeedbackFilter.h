...
- (void)_dispatchPendingBlocks;	// IMP=0x0010000000002d42
- (void)dispatchNowOrWhenFeedbackDurationAchieved:(_Bool)arg1 finish:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002b0f
- (void)_doneWaiting;	// IMP=0x0010000000002a50
- (void)_sendFeedback:(long long)arg1;	// IMP=0x001000000000278a
- (double)_timeoutForFeedback:(long long)arg1;	// IMP=0x0010000000002764
- (void)scheduleFeedback:(long long)arg1;	// IMP=0x001000000000252d
- (id)initWithDelegate:(id)arg1 feedbackSet:(id)arg2 feedbackDuration:(double)arg3 iconDuration:(double)arg4;	// IMP=0x0010000000002463
