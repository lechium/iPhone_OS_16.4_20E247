...
+ (id)taskWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0020000000001ba0
...
- (_Bool)_deferIfNeeded;	// IMP=0x0010000000002650
- (id)_restorationExitStatusForResult:(unsigned long long)arg1;	// IMP=0x00100000000025b0
- (void)_completeWithResult:(unsigned long long)arg1;	// IMP=0x00100000000020d0
@property(readonly, copy) NSString *description;
- (id)initWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000001cb0
