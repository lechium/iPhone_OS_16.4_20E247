...
- (void).cxx_destruct;	// IMP=0x002000000007c87a
...
- (void)begin:(id)arg1;	// IMP=0x001000000007bb29
- (void)cancel;	// IMP=0x001000000007bb1f
- (id)initWithStore:(id)arg1;	// IMP=0x001000000007baac
