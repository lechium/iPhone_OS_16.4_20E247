...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000027236
+ (id)archiveBasePath;	// IMP=0x0010000000027072
+ (void)deleteArchives;	// IMP=0x0010000000026ffa
+ (id)archivePathForQuery:(id)arg1;	// IMP=0x0010000000026f00
- (void).cxx_destruct;	// IMP=0x0020000000027799
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000273ed
- (struct _MDPlistContainer *)decodeMDPlistContainerWithCoder:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000002734d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002723e
- (id)initWithQuery:(id)arg1 withResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5 withStore:(id)arg6;	// IMP=0x00100000000270c0
