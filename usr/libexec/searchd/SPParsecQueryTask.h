...
- (void).cxx_destruct;	// IMP=0x002000000002d720
...
- (void)query:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 withAlternativeResults:(id)arg5 suggestionsAreBlended:(_Bool)arg6;	// IMP=0x001000000002c2ff
- (id)findLocalCopies:(id)arg1 alternativeResults:(id)arg2 withQueryString:(id)arg3;	// IMP=0x0010000000028fdf
- (void)archiveWithQuery:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5;	// IMP=0x0010000000028e36
- (void)geoUserSessionEntityString:(id)arg1;	// IMP=0x0010000000028dc4
- (void)_setScore:forResult: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000028daf
- (void)queryDidFinishLoading:(id)arg1;	// IMP=0x0010000000028b72
- (void)cancel;	// IMP=0x0010000000028887
- (void)finished;	// IMP=0x0010000000027c0e
- (id)initWithStore:(id)arg1 resultPipe:(id)arg2 queue:(id)arg3 visibleApps:(id)arg4 hiddenApps:(id)arg5;	// IMP=0x0010000000027a93
- (void)dealloc;	// IMP=0x0010000000027a59
- (void)resumeWithArchive:(id)arg1;	// IMP=0x0010000000027957
- (id)unarchiveWithQuery:(id)arg1;	// IMP=0x001000000002783f
- (void)resumeWithTimeout:(double)arg1;	// IMP=0x00100000000277ed
