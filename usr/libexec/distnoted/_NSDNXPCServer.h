...
- (id)createEndpoint;	// IMP=0x0020000000001874
- (id)allClients;	// IMP=0x0010000000001836
- (void)start;	// IMP=0x0010000000001655
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000015db
- (void)invalidate;	// IMP=0x0010000000001489
- (id)__invalidate;	// IMP=0x0010000000001446
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x001000000000143a
- (id)dispatchQueue;	// IMP=0x0010000000001430
...
- (void)dealloc;	// IMP=0x0010000000001249
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x0010000000001194
