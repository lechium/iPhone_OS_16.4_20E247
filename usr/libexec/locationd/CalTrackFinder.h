...
- (void)_clearBuffers;	// IMP=0x00100000008a514d
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x00100000008a4f05
- (void)_closeCurrentTrack;	// IMP=0x00100000008a458b
- (void)_closeTrackCheckPedometer;	// IMP=0x00100000008a3d47
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x00100000008a3623
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x00100000008a328e
- (void)_closeTrackCheckGpsLocation;	// IMP=0x00100000008a30b3
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x00100000008a25c4
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x00100000008a2560
- (id)_filterGpsLocationBuffer;	// IMP=0x00100000008a1ffc
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x00100000008a1eb2
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x00100000008a1c40
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x00100000008a1b67
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x00100000008a14fe
- (void)stop;	// IMP=0x00100000008a1432
- (void)dealloc;	// IMP=0x00100000008a13b7
- (id)init;	// IMP=0x00100000008a1226
