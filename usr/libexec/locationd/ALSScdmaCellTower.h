...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000a96cf3
- (unsigned long long)hash;	// IMP=0x0010000000a96c25
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a96b20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a96a33
- (void)copyTo:(id)arg1;	// IMP=0x0010000000a96990
- (void)writeTo:(id)arg1;	// IMP=0x0010000000a968ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000a968a0
- (id)dictionaryRepresentation;	// IMP=0x0010000000a961f6
- (id)description;	// IMP=0x0010000000a9617f
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000a9609c
