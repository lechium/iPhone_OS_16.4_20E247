...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001fb719
...
- (id)description;	// IMP=0x00100000001fbc42
- (id)jsonObject;	// IMP=0x00100000001fba4b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001fb970
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001fb85d
- (void)dealloc;	// IMP=0x00100000001fb822
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x00100000001fb721
