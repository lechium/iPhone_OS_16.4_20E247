...
- (unsigned long long)tropicalSavannaTreeId;	// IMP=0x00100000008d7ddc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000008d7be9
- (unsigned long long)hash;	// IMP=0x00100000008d73d2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000008d7178
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008d6fe7
- (void)copyTo:(id)arg1;	// IMP=0x00100000008d6e94
- (void)writeTo:(id)arg1;	// IMP=0x00100000008d6cf1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000008d6ce4
- (id)dictionaryRepresentation;	// IMP=0x00100000008d63ba
- (id)description;	// IMP=0x00100000008d6343
@property(nonatomic) _Bool hasTropicalSavannaTreeId;
- (void)setTropicalSavannaTreeId:(unsigned long long)arg1;	// IMP=0x00100000008d62f5
@property(nonatomic) _Bool hasTropicalSavannaBranchCount;
- (int)StringAsTropicalSavannaProximity:(id)arg1;	// IMP=0x00100000008d61e0
- (id)tropicalSavannaProximityAsString:(int)arg1;	// IMP=0x00100000008d61a7
...
- (struct CLDaemonLocationPrivate)daemonLocationPrivate;	// IMP=0x00100000008a937e
- (id)initWithDaemonLocationPrivate:(const void *)arg1;	// IMP=0x00100000008a8e64
