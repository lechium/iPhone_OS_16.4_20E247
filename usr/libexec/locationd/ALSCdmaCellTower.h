...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000077d01d
- (unsigned long long)hash;	// IMP=0x001000000077cee6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000077cd34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000077cbdc
- (void)copyTo:(id)arg1;	// IMP=0x001000000077cac2
- (void)writeTo:(id)arg1;	// IMP=0x001000000077c981
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000077c974
- (id)dictionaryRepresentation;	// IMP=0x001000000077c0b6
- (id)description;	// IMP=0x001000000077c03f
...
- (void)dealloc;	// IMP=0x001000000077bd9c
