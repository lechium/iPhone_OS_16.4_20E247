...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000066f6fe
- (unsigned long long)hash;	// IMP=0x001000000066ee66
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000066eb60
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000066e97d
- (void)copyTo:(id)arg1;	// IMP=0x001000000066e7d8
- (void)writeTo:(id)arg1;	// IMP=0x001000000066e5cd
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000066e5c0
- (id)dictionaryRepresentation;	// IMP=0x001000000066da26
- (id)description;	// IMP=0x001000000066d9af
