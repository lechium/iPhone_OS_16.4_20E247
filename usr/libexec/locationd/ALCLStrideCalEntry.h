...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001059f0
- (unsigned long long)hash;	// IMP=0x001000000010523c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010506d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000104f2d
- (void)copyTo:(id)arg1;	// IMP=0x0010000000104e2b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000104ca5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000104c98
- (id)dictionaryRepresentation;	// IMP=0x00100000001042dd
- (id)description;	// IMP=0x0010000000104266
