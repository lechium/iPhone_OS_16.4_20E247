...
+ (id)getSilo;	// IMP=0x0020000000b45538
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000b4551f
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000b454c2
...
- (void)smoothLocations:(id)arg1 workoutActivity:(int)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000b4614f
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000b45881
- (void)dealloc;	// IMP=0x0010000000b45852
- (void)endService;	// IMP=0x0010000000b4573c
- (void)beginService;	// IMP=0x0010000000b455d1
- (id)init;	// IMP=0x0010000000b45594
