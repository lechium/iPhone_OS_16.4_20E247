...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002e8c0f
- (unsigned long long)hash;	// IMP=0x00100000002e7e8b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002e7a06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002e773c
- (void)copyTo:(id)arg1;	// IMP=0x00100000002e74b0
- (void)writeTo:(id)arg1;	// IMP=0x00100000002e71a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002e7194
- (id)dictionaryRepresentation;	// IMP=0x00100000002e5c22
- (id)description;	// IMP=0x00100000002e5bab
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00100000002e5a11
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000002e59d6
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000002e4ecc
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000002e4b04
