...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b513d
- (unsigned long long)hash;	// IMP=0x00100000001b4d2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b4c14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b4b3c
- (void)copyTo:(id)arg1;	// IMP=0x00100000001b4aa2
- (void)writeTo:(id)arg1;	// IMP=0x00100000001b49b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001b49a8
- (id)dictionaryRepresentation;	// IMP=0x00100000001b4376
- (id)description;	// IMP=0x00100000001b42ff
