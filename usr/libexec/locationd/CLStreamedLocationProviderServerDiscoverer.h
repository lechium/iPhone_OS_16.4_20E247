...
- (void)findCandidateServersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ff5bd
- (id)deviceWithEffectiveID:(id)arg1;	// IMP=0x00100000000ff3a2
- (void)invalidate;	// IMP=0x00100000000ff276
- (void)dealloc;	// IMP=0x00100000000ff238
- (id)initOnQueue:(id)arg1;	// IMP=0x00100000000fec6c
