...
+ (_Bool)isSupported;	// IMP=0x00200000002fa48d
+ (id)getSilo;	// IMP=0x00100000002f85ae
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000002f8595
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000002f8538
- (id).cxx_construct;	// IMP=0x00200000002fbccb
- (void).cxx_destruct;	// IMP=0x00100000002fbca3
...
- (double)calculateDistance:(id)arg1 b:(id)arg2;	// IMP=0x00100000002fb728
- (void)onManagerNotification:(const int *)arg1 data:(const void *)arg2;	// IMP=0x00100000002fb5a4
- (void)checkLocationServicesStatus;	// IMP=0x00100000002fb478
- (void)requestExpensiveLocation:(_Bool)arg1;	// IMP=0x00100000002fb32a
- (void)onLocationUnknownTimer;	// IMP=0x00100000002fb208
- (void)updateLocationUnknown;	// IMP=0x00100000002fb14a
- (void)handleNewLocation:(id)arg1;	// IMP=0x00100000002fa580
- (void)sendUpdateToRDIfAllowed:(id)arg1;	// IMP=0x00100000002fa495
- (void)locationManager:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00100000002fa366
- (void)locationManagerDidChangeAuthorization:(id)arg1;	// IMP=0x00100000002fa24a
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;	// IMP=0x00100000002f9934
- (_Bool)locationIsUsable:(id)arg1;	// IMP=0x00100000002f936b
- (void)refreshSettings;	// IMP=0x00100000002f8f1f
- (void)endService;	// IMP=0x00100000002f8d5c
- (void)beginService;	// IMP=0x00100000002f8647
- (id)init;	// IMP=0x00100000002f860a
