...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010a385
- (unsigned long long)hash;	// IMP=0x0010000000109f0e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000109e42
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000109d8f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000109d1a
- (void)writeTo:(id)arg1;	// IMP=0x0010000000109c5d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000109c50
- (id)dictionaryRepresentation;	// IMP=0x001000000010969b
- (id)description;	// IMP=0x0010000000109624
- (int)StringAsFEpochType:(id)arg1;	// IMP=0x00100000001095bd
- (id)fEpochTypeAsString:(int)arg1;	// IMP=0x0010000000109584
