...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000117068
- (unsigned long long)hash;	// IMP=0x0010000000116bb3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001169a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000116846
- (void)copyTo:(id)arg1;	// IMP=0x0010000000116723
- (void)writeTo:(id)arg1;	// IMP=0x001000000011659d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000116590
- (id)dictionaryRepresentation;	// IMP=0x0010000000115795
- (id)description;	// IMP=0x001000000011571e
@property(nonatomic) _Bool hasIsVehicleConnected;
@property(nonatomic) _Bool hasStartTime;
@property(nonatomic) _Bool hasEstExitTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000001155d7
- (id)exitStateAsString:(int)arg1;	// IMP=0x001000000011559e
...
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x0010000000115434
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000001153fb
...
- (int)StringAsMountedState:(id)arg1;	// IMP=0x0010000000115349
- (id)mountedStateAsString:(int)arg1;	// IMP=0x001000000011530a
@property(nonatomic) _Bool hasMountedState;
@property(nonatomic) int mountedState; // @synthesize mountedState=_mountedState;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x0010000000115238
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000001151ff
@property(nonatomic) _Bool hasConfidence;
- (void);	// IMP=0x00100000001151d0
@property(nonatomic) int confidence; // @synthesize confidence=_confidence;
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000114c68
- (id)typeAsString:(int)arg1;	// IMP=0x00100000001148a0
