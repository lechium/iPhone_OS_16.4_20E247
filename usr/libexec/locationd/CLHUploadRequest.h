...
- (id)description;	// IMP=0x0010000000a3c7d1
- (id)jsonObject;	// IMP=0x0010000000a3c76d
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000a3c546
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000a3c4f6
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000a3c45c
- (void)dealloc;	// IMP=0x0010000000a3c404
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000a3c37e
