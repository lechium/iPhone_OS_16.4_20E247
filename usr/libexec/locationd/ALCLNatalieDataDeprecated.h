...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000008a75eb
- (unsigned long long)hash;	// IMP=0x00100000008a7172
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000008a6fcb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008a6ea4
- (void)copyTo:(id)arg1;	// IMP=0x00100000008a6daf
- (void)writeTo:(id)arg1;	// IMP=0x00100000008a6c6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000008a6c60
- (id)dictionaryRepresentation;	// IMP=0x00100000008a5fd5
- (id)description;	// IMP=0x00100000008a5f5e
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000008a58b8
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000008a54f3
