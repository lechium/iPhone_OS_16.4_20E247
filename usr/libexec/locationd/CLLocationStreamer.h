...
+ (_Bool)isSupported;	// IMP=0x002000000039b952
+ (id)getSilo;	// IMP=0x001000000039b8f6
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x001000000039b8dd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x001000000039b880
- (id).cxx_construct;	// IMP=0x002000000039e6e1
- (void).cxx_destruct;	// IMP=0x001000000039e650
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x001000000039e3d9
- (void)successfullySentMessage:(id)arg1;	// IMP=0x001000000039e2f3
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x001000000039e1e7
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x001000000039ddd8
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x001000000039daed
- (void)sendMotionState;	// IMP=0x001000000039d942
- (void)stopMotionAlarm;	// IMP=0x001000000039d815
- (void)startMotionAlarm;	// IMP=0x001000000039d6f0
- (void)reevaluateMotionSubscription;	// IMP=0x001000000039d513
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x001000000039cfc9
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5 hasMapMatching:(_Bool)arg6;	// IMP=0x001000000039cbac
- (void)stopLocation;	// IMP=0x001000000039c5bc
- (void)unregisterAllLocationNotifications;	// IMP=0x001000000039c536
- (void)sendAliveAgainMessage;	// IMP=0x001000000039c3a4
- (void)endService;	// IMP=0x001000000039c27f
- (void)beginService;	// IMP=0x001000000039b9f7
- (id)init;	// IMP=0x001000000039b9ba
