...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000079f78e
- (unsigned long long)hash;	// IMP=0x001000000079f67a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000079f4f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000079f3cc
- (void)copyTo:(id)arg1;	// IMP=0x001000000079f2e5
- (void)writeTo:(id)arg1;	// IMP=0x001000000079f199
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000079f18c
- (id)dictionaryRepresentation;	// IMP=0x001000000079e844
- (id)description;	// IMP=0x001000000079e7cd
