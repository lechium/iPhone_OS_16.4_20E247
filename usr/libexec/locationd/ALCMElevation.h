...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ea1e6
- (unsigned long long)hash;	// IMP=0x00100000000ea04d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000e9f41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e9e68
- (void)copyTo:(id)arg1;	// IMP=0x00100000000e9dcd
- (void)writeTo:(id)arg1;	// IMP=0x00100000000e9ced
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000e9ce0
- (id)dictionaryRepresentation;	// IMP=0x00100000000e9635
- (id)description;	// IMP=0x00100000000e95be
- (int)StringAsSource:(id)arg1;	// IMP=0x00100000000e9577
- (id)sourceAsString:(int)arg1;	// IMP=0x00100000000e9538
@property(nonatomic) _Bool hasSource;
@property(nonatomic) int source; // @synthesize source=_source;
- (int)StringAsRawGradeType:(id)arg1;	// IMP=0x00100000000e9448
- (id)rawGradeTypeAsString:(int)arg1;	// IMP=0x00100000000e940f
...
- (int)StringAsGradeType:(id)arg1;	// IMP=0x00100000000e92d2
- (id)gradeTypeAsString:(int)arg1;	// IMP=0x00100000000e9299
