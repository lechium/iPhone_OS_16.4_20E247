...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000148c33
- (unsigned long long)hash;	// IMP=0x0010000000148b9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000148aa8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001489de
- (void)copyTo:(id)arg1;	// IMP=0x0010000000148952
- (void)writeTo:(id)arg1;	// IMP=0x0010000000148889
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000014887c
- (id)dictionaryRepresentation;	// IMP=0x0010000000148298
- (id)description;	// IMP=0x0010000000148221
