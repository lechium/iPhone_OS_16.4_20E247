...
- (void)onScenarioTrigger:(id)arg1;	// IMP=0x001000000068a7d6
- (void)onVisit:(id)arg1;	// IMP=0x001000000068a5af
- (id)initWithFenceMonitor:(void *)arg1;	// IMP=0x001000000068a565
