...
- (void)sensorWriter:(id)arg1 didReceiveUpdateToConfigurationRequests:(id)arg2;	// IMP=0x0010000000a1c5d7
- (id)classNameForSensorIdentifier:(id)arg1;	// IMP=0x0010000000a1c557
- (void)sensorWriterWillStartMonitoring:(id)arg1;	// IMP=0x0010000000a1c1f4
