...
+ (_Bool)isSupported;	// IMP=0x0020000000af4e52
+ (id)getSilo;	// IMP=0x0010000000af4df6
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000af4ddd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000af4d80
- (id).cxx_construct;	// IMP=0x0020000000af712e
- (void).cxx_destruct;	// IMP=0x0010000000af70e9
...
- (void)stopLocation;	// IMP=0x0010000000af6eb7
- (void)activateRapportLinkIfNecessary;	// IMP=0x0010000000af66c7
- (void)registerRequestHandlers;	// IMP=0x0010000000af5de2
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x0010000000af5793
- (void)toggleLocationUpdates:(_Bool)arg1 inFitnessSession:(_Bool)arg2 inAirborneSession:(_Bool)arg3 emergencyEnablementAssertionActive:(_Bool)arg4;	// IMP=0x0010000000af55b4
- (void)endService;	// IMP=0x0010000000af5167
- (void)beginService;	// IMP=0x0010000000af4ee3
- (id)init;	// IMP=0x0010000000af4ea6
