...
- (void)fireAlarm:(id)arg1 error:(int)arg2;	// IMP=0x00100000003dbe53
- (void)onNotification:(int)arg1 withData:(id)arg2;	// IMP=0x00100000003dbe4d
- (id)initWithMotionAlarmSubscription:(void *)arg1;	// IMP=0x00100000003dbe10
