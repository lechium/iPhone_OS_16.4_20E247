...
struct CLDaemonLocationPrivate {
    ...
    double _field44;
    _Bool _field45;
    struct SatelliteReport _field46;
    int _field47;
...
struct array<CLBarometerCalibrationContextManager *, 9UL> {
    CLBarometerCalibrationContextManager *__elems_[9];
};
