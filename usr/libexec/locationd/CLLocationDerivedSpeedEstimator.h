...
@class CLLocation, CLSilo, CLTimer, MISSING_TYPE, NSDate, NSString, SBSStatusBarStyleOverridesAssertion;
...
+ (_Bool)isSupportedForDerivedSpeedEstimate;	// IMP=0x00200000001d075c
+ (_Bool)isSupportedForAnalytics;	// IMP=0x00100000001d0730
+ (_Bool)isSupported;	// IMP=0x00100000001d06e7
- (MISSING_TYPE *).cxx_construct;	// IMP=0x00200000001d4133
- (void).cxx_destruct;	// IMP=0x00100000001d40ef
...
- (void)submitLatencyMetrics;	// IMP=0x00100000001d405f
- (void)submitFalseDetectionMetricsWithType:(unsigned long long)arg1;	// IMP=0x00100000001d4059
- (void)logLatencyMetricsInternal;	// IMP=0x00100000001d4053
- (void)clearStatusBarColorAndText;	// IMP=0x00100000001d3f7a
- (void)setStatusBarWithLabel:(id)arg1;	// IMP=0x00100000001d3aea
- (void)updateStatusBarLabel;	// IMP=0x00100000001d3938
- (void)onMotionStateNotification:(int)arg1 data:(union NotificationData)arg2;	// IMP=0x00100000001d383e
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00100000001d357e
- (void)handleMotionStateNotification:(union NotificationData *)arg1;	// IMP=0x00100000001d2b35
- (void)handleVehicularStateChanged;	// IMP=0x00100000001d2ab2
- (_Bool)_feedLocation:(id)arg1;	// IMP=0x00100000001d16b4
- (void)_invalidateSpeedEstimate;	// IMP=0x00100000001d166f
- (void)_onScanTimer;	// IMP=0x00100000001d1414
- (_Bool)feedLocation:(const struct CLDaemonLocation *)arg1;	// IMP=0x00100000001d137f
- (void)dealloc;	// IMP=0x00100000001d12cb
- (void)invalidate;	// IMP=0x00100000001d129d
- (void)unregisterForNotifications;	// IMP=0x00100000001d1221
- (void)updateWsbClient:(_Bool)arg1;	// IMP=0x00100000001d11ff
- (void)stopWsbClient;	// IMP=0x00100000001d1118
- (void)startWsbClient;	// IMP=0x00100000001d0ff7
- (void)registerForNotifications;	// IMP=0x00100000001d0c3b
- (id)initInUniverse:(id)arg1;	// IMP=0x00100000001d07eb
- (id)init;	// IMP=0x00100000001d0780
