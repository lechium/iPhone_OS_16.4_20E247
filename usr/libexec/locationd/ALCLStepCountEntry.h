...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000106c00
- (unsigned long long)hash;	// IMP=0x001000000010689f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010677c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010669b
- (void)copyTo:(id)arg1;	// IMP=0x00100000001065f8
- (void)writeTo:(id)arg1;	// IMP=0x0010000000106501
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001064f4
- (id)dictionaryRepresentation;	// IMP=0x0010000000105dc4
- (id)description;	// IMP=0x0010000000105d4d
