...
- (id)debugDescriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000ee81
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000ee31
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000ed1b
- (id)succinctDescription;	// IMP=0x001000000000eccb
- (id)succinctDescriptionBuilder;	// IMP=0x001000000000ec39
...
- (id)_lock_applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x001000000000e016
- (id)applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2 allowPlaceholder:(_Bool)arg3;	// IMP=0x001000000000dea2
- (id)applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x001000000000de8d
- (id)init;	// IMP=0x001000000000ddb8
