...
- (void).cxx_destruct;	// IMP=0x002000000001fb1a
...
- (void)syncCoordinator:(id)arg1 beginSyncSession:(id)arg2;	// IMP=0x001000000001f8dc
- (_Bool)handlePotentialPairedSyncForComplicationsFailedWithIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x001000000001f7a9
- (void)handlePairedSyncForComplicationsAckWithIdentifier:(id)arg1 success:(_Bool)arg2;	// IMP=0x001000000001f5cd
@property(readonly) NSString *state;
- (id)init;	// IMP=0x001000000001f3da
