...
- (void).cxx_destruct;	// IMP=0x002000000000488c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000046df
- (unsigned long long)hash;	// IMP=0x001000000000462a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000044d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000043c9
- (void)copyTo:(id)arg1;	// IMP=0x001000000000430a
- (void)writeTo:(id)arg1;	// IMP=0x0010000000004245
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000004238
- (id)dictionaryRepresentation;	// IMP=0x0010000000003d3b
- (id)description;	// IMP=0x0010000000003c8c
