...
+ (id)fromProto:(id)arg1;	// IMP=0x0040000000003546
+ (id)toProto:(id)arg1;	// IMP=0x001000000000332f
- (void).cxx_destruct;	// IMP=0x0020000000003804
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000301b
- (id)init;	// IMP=0x0010000000002fec
