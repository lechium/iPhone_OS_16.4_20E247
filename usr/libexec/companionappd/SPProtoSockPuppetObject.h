...
- (void).cxx_destruct;	// IMP=0x002000000000657c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000006286
- (unsigned long long)hash;	// IMP=0x0010000000005f1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005c71
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000005a87
- (void)copyTo:(id)arg1;	// IMP=0x00100000000058e5
- (void)writeTo:(id)arg1;	// IMP=0x0010000000005729
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000571c
- (id)dictionaryRepresentation;	// IMP=0x0010000000004c37
- (id)description;	// IMP=0x0010000000004b88
