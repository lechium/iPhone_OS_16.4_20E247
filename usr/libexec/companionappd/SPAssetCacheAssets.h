...
+ (MISSING_TYPE *)fromProto: /* Error: Ran out of types for this method. */;	// IMP=0x004000000000765c
+ (id)toProto:(id)arg1;	// IMP=0x0010000000007491
- (void).cxx_destruct;	// IMP=0x0020000000007880
@property(retain, nonatomic) NSMutableArray *assets; // @synthesize assets=_assets;
- (void)addAsset:(id)arg1;	// IMP=0x001000000000747b
- (id)init;	// IMP=0x0010000000007415
