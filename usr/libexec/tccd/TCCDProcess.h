...
+ (id)identifierForInvalidCode;	// IMP=0x0040000000050e87
- (void).cxx_destruct;	// IMP=0x0020000000052052
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000051e60
- (unsigned long long)hash;	// IMP=0x0010000000051e32
- (_Bool)_initializeUsingResponsibleIdentity:(id)arg1;	// IMP=0x0010000000051e2a
- (_Bool)_initializeUsingTaskForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000051baa
...
- (_Bool)hasEntitlement:(id)arg1 containsServiceAllOrService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000051a54
- (_Bool)hasEntitlement:(id)arg1 containsService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000051747
- (id)description;	// IMP=0x0010000000051626
- (id)dictionaryValueForEntitlement:(id)arg1;	// IMP=0x0010000000051515
- (id)arrayValueForEntitlement:(id)arg1;	// IMP=0x00100000000513df
- (_Bool)boolValueForEntitlement:(id)arg1;	// IMP=0x00100000000512ac
@property(readonly) NSString *responsiblePath; // @synthesize responsiblePath=_responsiblePath;
- (void)dealloc;	// IMP=0x0010000000051247
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1 responsibleIdentity:(id)arg2;	// IMP=0x0010000000050f15
- (id)logHandle;	// IMP=0x0010000000050e94
