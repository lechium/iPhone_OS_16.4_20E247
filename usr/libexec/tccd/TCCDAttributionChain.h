...
- (void).cxx_destruct;	// IMP=0x0020000000055b6c
...
- (id)attributedBundleUsingOutermostBundle:(_Bool)arg1 computedStaticCodeRef:(const void **)arg2 computedNonIdentifiableBundleURL:(id *)arg3;	// IMP=0x0010000000055810
...
- (id)description;	// IMP=0x001000000005560d
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2 processInfo:(id)arg3;	// IMP=0x0010000000054ffe
- (id)createProcessFromAuditToken:(CDStruct_4c969caf)arg1 processInfo:(id)arg2;	// IMP=0x0010000000054fba
- (void)getAuditToken:(CDStruct_4c969caf *)arg1 fromMessage:(id)arg2;	// IMP=0x0010000000054faa
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2;	// IMP=0x0010000000054f95
- (id)initWithMessage:(id)arg1;	// IMP=0x0010000000054f7e
