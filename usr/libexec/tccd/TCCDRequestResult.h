...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x004000000004eea3
- (void).cxx_destruct;	// IMP=0x002000000004f935
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x001000000004f469
- (id)description;	// IMP=0x001000000004f455
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x001000000004f1ad
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x001000000004efe5
- (id)init;	// IMP=0x001000000004ef94
