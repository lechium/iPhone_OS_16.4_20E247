...
+ (id)defaultLocalizedResourcesBundlePath;	// IMP=0x0040000000044aa1
+ (id)requestDenyNotificationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000043727
+ (id)requestDenyNotificationTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000004370b
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000436ef
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000436d3
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000436b7
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000004369b
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000004367f
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000043663
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000043647
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000004362b
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000004360f
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000435f3
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000435d7
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000435bb
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x0010000000043593
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x001000000004351b
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x0010000000043455
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x001000000004310f
+ (id)serviceAll;	// IMP=0x001000000004308d
+ (id)allServices;	// IMP=0x001000000003f883
- (void).cxx_destruct;	// IMP=0x00100000000454df
...
- (id)localizedTextWithKey:(id)arg1;	// IMP=0x0010000000044c72
- (long long)developmentAuthorizationValue;	// IMP=0x001000000004475a
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0010000000044691
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0010000000044623
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x00100000000445f7
- (long long)compare:(id)arg1;	// IMP=0x0010000000044566
- (id)descriptionDictionary;	// IMP=0x0010000000043c5e
- (id)description;	// IMP=0x0010000000043c4c
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x0010000000043743
- (unsigned long long)accessActionStatusForAuthorizationValue:(unsigned long long)arg1;	// IMP=0x0010000000009aa3
