...
@interface TCCDRequestContext : NSObject
{
    ...
    unsigned long long _usageStringPolicy;	// 80 = 0x50
...
- (void).cxx_destruct;	// IMP=0x001000000004ce9e
...
- (id)initForSyncRequestForSubjectBundleIdentifier:(id)arg1 service:(id)arg2;	// IMP=0x001000000004cac8
- (id)init;	// IMP=0x001000000004caaf
- (void)dealloc;	// IMP=0x001000000004c9e3
- (id)initWithRequestMessage:(id)arg1 forServer:(id)arg2 error:(id *)arg3;	// IMP=0x001000000004c469
- (void)presentAsynchronousDenialNotificationForService:(id)arg1;	// IMP=0x001000000003afe2
- (void)presentAsynchronousDenialNotificationWithMessage:(id)arg1 buttonTitle:(id)arg2;	// IMP=0x001000000003a894
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 allowButtonTitle:(id)arg3 denyButtonTitle:(id)arg4 updatingResult:(id)arg5;	// IMP=0x001000000003c3c7
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 allowButtonTitle:(id)arg3 denyButtonTitle:(id)arg4 limitedAllowButtonTitle:(id)arg5 updatingResult:(id)arg6;	// IMP=0x001000000003c3a4
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 allowButtonTitle:(id)arg3 denyButtonTitle:(id)arg4 limitedAllowButtonTitle:(id)arg5 withTimeoutInSeconds:(unsigned int)arg6 updatingResult:(id)arg7;	// IMP=0x001000000003b18e
