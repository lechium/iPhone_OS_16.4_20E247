...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000008947
- (void).cxx_destruct;	// IMP=0x0020000000009080
...
- (id)syncId;	// IMP=0x0010000000008e96
@property(readonly, copy) NSString *clientIdentifierForCurrentPlatform;
- (id)_description;	// IMP=0x0010000000008d9e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000008c4f
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000008a08
- (id)initWithServiceIdentifier:(id)arg1 mainClientIdentifier:(id)arg2 replicaClientIdentifier:(id)arg3 clientType:(int)arg4;	// IMP=0x001000000000894f
