...
- (void).cxx_destruct;	// IMP=0x0020000000057989
...
- (void)display;	// IMP=0x00100000000575af
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x00100000000574b9
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x00100000000573ac
