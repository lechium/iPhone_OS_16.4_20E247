...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0010000000020e82
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0010000000020c4d
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000206d9
- (long long)versionFromTask:(id)arg1;	// IMP=0x001000000002067d
- (void)updateDb:(long long)arg1;	// IMP=0x001000000002041c
- (void)reschedule;	// IMP=0x001000000002031d
