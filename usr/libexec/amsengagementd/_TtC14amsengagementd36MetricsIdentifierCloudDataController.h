...
- (void)dataSourceDidChange:(id)arg1;	// IMP=0x00200000000f9840
- (void)dataSourceAccountDidChange:(id)arg1;	// IMP=0x00100000000f97b0
- (id)recordIdentifierForKey:(id)arg1;	// IMP=0x00100000000fa180
- (id)keyForRecordIdentifier:(id)arg1;	// IMP=0x00100000000fa0e0
- (id)createRecordForKey:(id)arg1 recordType:(id)arg2;	// IMP=0x00100000000fa060
- (id)identifierRecordType;	// IMP=0x00100000000f9930
- (id)identifierStoreRecordType;	// IMP=0x00100000000f9900
