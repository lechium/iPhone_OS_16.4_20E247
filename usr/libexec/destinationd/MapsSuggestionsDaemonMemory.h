...
- (id).cxx_construct;	// IMP=0x002000000002b7b4
- (void).cxx_destruct;	// IMP=0x001000000002b72c
...
- (void)clear;	// IMP=0x001000000002b6ac
- (id)mapsAppFeeler;	// IMP=0x001000000002b69e
- (id)signalPack;	// IMP=0x001000000002b639
- (_Bool)setSignalPack:(id)arg1;	// IMP=0x001000000002b587
- (id)signalPipeline;	// IMP=0x001000000002b579
- (void)clearETAs;	// IMP=0x001000000002b35e
- (id)getETAForDestinationKey:(id)arg1;	// IMP=0x001000000002b0f5
- (_Bool)setETA:(id)arg1 destinationKey:(id)arg2;	// IMP=0x001000000002ab90
- (_Bool)removeEntries:(id)arg1 sourceName:(id)arg2;	// IMP=0x001000000002a77d
- (_Bool)replaceEntries:(id)arg1 sourceName:(id)arg2;	// IMP=0x001000000002a4c3
- (id)entriesForSourceName:(id)arg1;	// IMP=0x001000000002a31e
- (id)sourceNames;	// IMP=0x001000000002a1d9
...
- (id)init;	// IMP=0x001000000002976c
