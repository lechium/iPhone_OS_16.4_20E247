...
+ (_Bool)isEnabled;	// IMP=0x0020000000006981
- (void).cxx_destruct;	// IMP=0x0020000000006b99
- (double)updateSignals;	// IMP=0x0010000000006aa0
- (id)initWithDelegate:(id)arg1 name:(id)arg2;	// IMP=0x00100000000069a5
- (_Bool)canProduceSignalType:(long long)arg1;	// IMP=0x0010000000006998
