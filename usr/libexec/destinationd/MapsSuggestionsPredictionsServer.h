...
- (id).cxx_construct;	// IMP=0x002000000001ab74
- (void).cxx_destruct;	// IMP=0x001000000001ab2f
@property(nonatomic) __weak MapsSuggestionsDaemonMemory *memory; // @synthesize memory=_memory;
- (void)_debugPrintOverviewOfConnections;	// IMP=0x001000000001ab02
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000019a00
- (id)initWithMemory:(id)arg1;	// IMP=0x00100000000197ac
