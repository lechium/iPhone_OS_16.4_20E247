...
- (void).cxx_destruct;	// IMP=0x0020000000002d6d
...
- (unsigned long long)deltaDeliveryRequirements;	// IMP=0x0010000000002d15
- (id)mergeableDeltasForMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000228e
- (_Bool)mergeDeltas:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000001e49
- (id)stateVector;	// IMP=0x0010000000001d88
- (id)initWithStreamCRDT:(id)arg1 locationRow:(id)arg2 database:(id)arg3 queue:(id)arg4 maxDeltaSize:(long long)arg5 sessionContext:(id)arg6;	// IMP=0x0010000000001c7c
