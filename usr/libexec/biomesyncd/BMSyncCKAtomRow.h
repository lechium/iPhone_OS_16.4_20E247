...
- (void).cxx_destruct;	// IMP=0x0010000000020304
...
- (id)description;	// IMP=0x0010000000020182
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000020177
- (unsigned long long)hash;	// IMP=0x0010000000020138
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000200a7
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 valueVersion:(long long)arg6 valueData:(id)arg7;	// IMP=0x001000000001fea0
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 bookmark:(id)arg6;	// IMP=0x001000000001fca1
- (id)initWithFMResultSet:(id)arg1;	// IMP=0x0010000000020358
