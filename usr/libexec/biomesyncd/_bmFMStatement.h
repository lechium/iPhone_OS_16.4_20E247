...
- (void).cxx_destruct;	// IMP=0x0020000000047754
...
- (id)description;	// IMP=0x001000000004766b
- (void)reset;	// IMP=0x0010000000047649
- (void)close;	// IMP=0x001000000004761f
- (void)dealloc;	// IMP=0x00100000000475e1
