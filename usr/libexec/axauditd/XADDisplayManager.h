...
+ (id)sharedManager;	// IMP=0x0020000000009a04
- (void).cxx_destruct;	// IMP=0x002000000000a6a3
...
- (void)setCursorFrameForElement:(id)arg1;	// IMP=0x001000000000a1d8
- (void)hideVisualsSynchronously;	// IMP=0x001000000000a057
- (void)setCursorFrame:(struct CGRect)arg1 withPath:(struct CGPath *)arg2 withContextId:(unsigned int)arg3 element:(id)arg4 forceRefresh:(_Bool)arg5;	// IMP=0x0010000000009c4e
- (void)setCursorStyle:(unsigned long long)arg1;	// IMP=0x0010000000009b4d
- (struct CGRect)_adjustFrameToFitScreen:(struct CGRect)arg1;	// IMP=0x0010000000009b35
- (id)init;	// IMP=0x0010000000009a89
