...
- (void).cxx_destruct;	// IMP=0x004000000015b940
- (id)init;	// IMP=0x001000000015b8e0
- (void)messageService:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x001000000015b810
