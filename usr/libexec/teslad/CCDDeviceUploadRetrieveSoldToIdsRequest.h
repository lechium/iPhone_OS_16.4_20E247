...
- (void).cxx_destruct;	// IMP=0x00200000000033b9
@property(retain, nonatomic) DEPDeviceUploadOrganization *organization; // @synthesize organization=_organization;
- (id)requestBody;	// IMP=0x00100000000032ca
- (id)endpointPath;	// IMP=0x00100000000032b6
- (id)httpMethod;	// IMP=0x00100000000032a9
- (long long)requestType;	// IMP=0x001000000000329e
