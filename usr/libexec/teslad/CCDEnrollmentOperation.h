...
- (void).cxx_destruct;	// IMP=0x00200000000045a4
...
- (id)errorForStatusCode:(long long)arg1 responseData:(id)arg2;	// IMP=0x00100000000044ca
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 outError:(id *)arg3;	// IMP=0x00100000000044c2
- (void)completeOperationWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x0010000000004343
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 statusCode:(long long)arg3 retryNeeded:(_Bool *)arg4 outError:(id *)arg5;	// IMP=0x0010000000004211
