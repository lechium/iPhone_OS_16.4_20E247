...
- (void).cxx_destruct;	// IMP=0x00200000000091b2
...
- (void)load;	// IMP=0x0010000000009184
- (id)initWithCommand:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000008fe5
