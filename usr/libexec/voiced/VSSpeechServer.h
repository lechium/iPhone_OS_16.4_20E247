...
- (void).cxx_destruct;	// IMP=0x0020000000010d75
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000001091b
- (void)scheduleBackgroundTasks;	// IMP=0x001000000000fc46
- (void)resume;	// IMP=0x001000000000fc30
- (void)dealloc;	// IMP=0x001000000000fbd6
- (id)init;	// IMP=0x001000000000fb40
