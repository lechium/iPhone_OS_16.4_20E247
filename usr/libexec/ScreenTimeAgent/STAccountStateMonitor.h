...
- (void).cxx_destruct;	// IMP=0x0020000000004595
...
- (void)reloadAccountState:(_Bool)arg1;	// IMP=0x0010000000003433
- (void)debouncer:(id)arg1 didDebounce:(id)arg2;	// IMP=0x001000000000341f
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000002c5a
- (void)dealloc;	// IMP=0x0010000000002bdc
