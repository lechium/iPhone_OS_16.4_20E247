...
@class MISSING_TYPE, NSArray, NSDateInterval, NSDictionary, NSNumber, NSSecurityScopedURLWrapper, NSString, NSURL, STIntroductionModel;
...
- (MISSING_TYPE *)primaryiCloudCardDAVAccountIdentifierWithCompletionHandler: /* Error: Ran out of types for this method. */;
