...
- (void).cxx_destruct;	// IMP=0x00200000000ae2ea
...
- (unsigned long long)hash;	// IMP=0x00100000000ae1d2
- (_Bool)isEqualToDowntimeStateEvent:(id)arg1;	// IMP=0x00100000000ae01f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000adfbc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000adf80
@property(readonly) _Bool enabled;
- (id)initWithIdentifier:(id)arg1 downtimeConfigurationState:(long long)arg2 downtimeDate:(id)arg3 userID:(id)arg4;	// IMP=0x00100000000ade51
