...
- (void).cxx_destruct;	// IMP=0x0020000000099291
...
- (id)_sendData:(id)arg1 toDestinations:(id)arg2 payloadUUID:(id)arg3 expectResponse:(_Bool)arg4 withError:(id *)arg5;	// IMP=0x001000000009893c
- (void)main;	// IMP=0x00100000000981aa
- (id)initWithPayload:(id)arg1 destinations:(id)arg2 service:(id)arg3;	// IMP=0x00100000000980cc
