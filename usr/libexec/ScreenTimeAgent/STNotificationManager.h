...
+ (id)sharedNotificationManager;	// IMP=0x0020000000056c72
- (void).cxx_destruct;	// IMP=0x0020000000057762
...
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x0010000000057440
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00100000000570de
- (void)_connectToAPNS;	// IMP=0x0010000000056ef1
- (void)_updateAPNSConnection;	// IMP=0x0010000000056e57
- (void)registerWithTopic:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000056d3c
- (id)init;	// IMP=0x0010000000056cc7
