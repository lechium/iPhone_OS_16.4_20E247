...
- (void).cxx_destruct;	// IMP=0x0020000000029e32
...
- (unsigned long long)hash;	// IMP=0x0010000000029d90
- (_Bool)isEqualToCoreDataObservationFilter:(id)arg1;	// IMP=0x0010000000029ca4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029c41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000029bf0
- (id)initWithPredicate:(id)arg1 primaryType:(long long)arg2 secondaryType:(long long)arg3;	// IMP=0x0010000000029b5b
