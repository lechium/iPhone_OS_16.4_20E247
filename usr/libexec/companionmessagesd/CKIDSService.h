...
- (void).cxx_destruct;	// IMP=0x0020000000005eed
...
- (_Bool)sendFile:(id)arg1 onService:(id)arg2;	// IMP=0x0010000000005d2c
- (_Bool)sendProtobufData:(id)arg1 type:(unsigned long long)arg2 service:(id)arg3 fireAndForget:(_Bool)arg4 includeInactiveDevices:(_Bool)arg5;	// IMP=0x0010000000005826
- (id)init;	// IMP=0x00100000000056a7
