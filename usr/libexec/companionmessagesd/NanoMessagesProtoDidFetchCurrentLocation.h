...
- (void).cxx_destruct;	// IMP=0x002000000000458a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000435d
- (unsigned long long)hash;	// IMP=0x0010000000003b74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003918
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000003783
- (void)copyTo:(id)arg1;	// IMP=0x001000000000361b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000003499
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000348c
- (id)dictionaryRepresentation;	// IMP=0x0010000000002bd4
- (id)description;	// IMP=0x0010000000002b25
