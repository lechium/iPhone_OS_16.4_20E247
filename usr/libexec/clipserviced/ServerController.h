...
+ (id)sharedController;	// IMP=0x0020000000001494
- (void).cxx_destruct;	// IMP=0x0020000000001994
@property(retain, nonatomic) NSXPCListener *listener; // @synthesize listener=_listener;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001766
- (void)start;	// IMP=0x00100000000016fa
- (id)init;	// IMP=0x00100000000014e9
