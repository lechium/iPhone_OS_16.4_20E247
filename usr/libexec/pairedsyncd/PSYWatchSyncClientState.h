...
- (void).cxx_destruct;	// IMP=0x002000000000ddc7
...
- (id)description;	// IMP=0x001000000000dc27
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000da5c
- (unsigned long long)hash;	// IMP=0x001000000000d994
- (id)plistRepresentation;	// IMP=0x001000000000d72f
...
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000000d4ed
- (id)initWithSyncSessionState:(unsigned long long)arg1 syncSessionType:(unsigned long long)arg2 migrationSync:(_Bool)arg3 activities:(id)arg4 completedActivities:(id)arg5;	// IMP=0x001000000000d42c
