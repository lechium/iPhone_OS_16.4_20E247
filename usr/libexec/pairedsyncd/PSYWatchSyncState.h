...
- (void).cxx_destruct;	// IMP=0x002000000001951f
...
- (id)description;	// IMP=0x00100000000193cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000019239
- (unsigned long long)hash;	// IMP=0x00100000000191c8
- (id)plistRepresentation;	// IMP=0x0010000000019036
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x0010000000018ef3
- (id)initWithActivityLabel:(id)arg1 globalProgress:(long long)arg2 syncProgressState:(unsigned long long)arg3;	// IMP=0x0010000000018e6a
