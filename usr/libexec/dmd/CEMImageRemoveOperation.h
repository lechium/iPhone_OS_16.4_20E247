...
- (void).cxx_destruct;	// IMP=0x00200000000071a1
...
- (void)main;	// IMP=0x001000000000702e
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000006f8c
