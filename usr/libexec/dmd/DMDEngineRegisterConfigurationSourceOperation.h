...
- (void).cxx_destruct;	// IMP=0x002000000004e294
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x001000000004e0f0
- (void)main;	// IMP=0x001000000004d887
