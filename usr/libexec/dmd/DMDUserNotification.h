...
- (void).cxx_destruct;	// IMP=0x00200000000859b2
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x00100000000858c9
- (struct __CFUserNotification *)notificationRef;	// IMP=0x00100000000858bf
- (void)dealloc;	// IMP=0x0010000000085880
- (id)init;	// IMP=0x001000000008581e
