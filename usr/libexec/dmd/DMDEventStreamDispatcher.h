...
- (void).cxx_destruct;	// IMP=0x0020000000051b00
...
- (void)_dispatchToListenerForKey:(id)arg1 inMap:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000000518ce
- (void)_registerListener:(id)arg1 forKeys:(id)arg2 inMap:(id)arg3;	// IMP=0x0010000000051667
- (void)_registerEventStreamHandlers;	// IMP=0x0010000000050c0d
- (id)initWithListeners:(id)arg1;	// IMP=0x001000000005084c
