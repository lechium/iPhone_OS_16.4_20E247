...
- (void).cxx_destruct;	// IMP=0x00200000000526f3
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x001000000005248d
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000051e7f
- (id)init;	// IMP=0x0010000000051e29
