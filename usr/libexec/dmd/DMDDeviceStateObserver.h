...
- (void)networkDidChange;	// IMP=0x0010000000041f9a
- (void)keybagLockStateDidChange;	// IMP=0x0010000000041f62
- (void)stopObservingChanges;	// IMP=0x0010000000041f2a
- (void)startObservingChanges;	// IMP=0x0010000000041d93
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0010000000041cb3
