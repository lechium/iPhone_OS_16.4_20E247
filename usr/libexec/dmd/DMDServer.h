...
+ (id)sharedServer;	// IMP=0x002000000007b40a
- (void).cxx_destruct;	// IMP=0x002000000007b69b
...
- (void)invalidate;	// IMP=0x001000000007b572
- (void)run;	// IMP=0x001000000007b45f
- (id)init;	// IMP=0x001000000007b104
