...
- (void).cxx_destruct;	// IMP=0x002000000004c531
...
- (id)processDeclarationPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000048f81
- (id)processCommandPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000478b0
- (_Bool)updateActiveRestrictionsInContext:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004704b
- (_Bool)preprocessDatabaseInContext:(id)arg1 forOrganization:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000046790
- (void)performDatabaseModificationOperationWithManagedObjectContext:(id)arg1;	// IMP=0x0010000000045e90
