...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000dc1f
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000d73f
- (void)_registerPredicateObserver;	// IMP=0x001000000000d282
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x001000000000c949
- (id)metadata;	// IMP=0x001000000000c818
- (void)updateObserverRegistration;	// IMP=0x001000000000c806
- (void)invalidate;	// IMP=0x001000000000c64a
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000c0ad
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x001000000000bfbc
