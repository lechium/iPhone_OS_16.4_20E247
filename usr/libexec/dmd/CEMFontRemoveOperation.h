...
- (void).cxx_destruct;	// IMP=0x0020000000006693
...
- (void)main;	// IMP=0x0010000000006520
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x001000000000647e
