...
- (void).cxx_destruct;	// IMP=0x0020000000075a46
@property(readonly, nonatomic) DMDPolicyPersistence *policyPersistence; // @synthesize policyPersistence=_policyPersistence;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000758dc
- (id)initWithPolicyPersistence:(id)arg1;	// IMP=0x0010000000075871
