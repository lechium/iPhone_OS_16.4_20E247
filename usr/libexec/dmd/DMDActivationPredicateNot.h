...
- (void).cxx_destruct;	// IMP=0x002000000001093e
...
- (id)metadata;	// IMP=0x001000000001080f
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0010000000010643
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 subPredicateObserver:(id)arg3 predicate:(id)arg4;	// IMP=0x00100000000105b9
