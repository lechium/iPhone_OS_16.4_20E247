...
- (void).cxx_destruct;	// IMP=0x002000000021ba19
...
- (id)dictionaryRepresentation;	// IMP=0x001000000021b955
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x001000000021b873
