...
- (void).cxx_destruct;	// IMP=0x002000000025b514
- (oneway void)sendContext:(id)arg1;	// IMP=0x001000000025b402
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x001000000025b365
