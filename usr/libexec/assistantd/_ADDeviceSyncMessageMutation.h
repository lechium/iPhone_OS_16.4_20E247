...
- (void).cxx_destruct;	// IMP=0x0020000000085269
- (void)setCommandPullSnapshotResponse:(id)arg1;	// IMP=0x0010000000085247
- (id)getCommandPullSnapshotResponse;	// IMP=0x001000000008520f
- (void)setCommandPullSnapshotRequest:(id)arg1;	// IMP=0x00100000000851ed
- (id)getCommandPullSnapshotRequest;	// IMP=0x00100000000851b5
- (void)setCommandPullDeltaResponse:(id)arg1;	// IMP=0x0010000000085193
- (id)getCommandPullDeltaResponse;	// IMP=0x001000000008515b
- (void)setCommandPullDeltaRequest:(id)arg1;	// IMP=0x001000000008513b
- (id)getCommandPullDeltaRequest;	// IMP=0x0010000000085103
- (void)setCommandPullGenerationsResponse:(id)arg1;	// IMP=0x00100000000850e3
- (id)getCommandPullGenerationsResponse;	// IMP=0x00100000000850ab
- (void)setCommandPullGenerationsRequest:(id)arg1;	// IMP=0x001000000008508b
- (id)getCommandPullGenerationsRequest;	// IMP=0x0010000000085053
- (void)setCommandPushGenerationsResponse:(id)arg1;	// IMP=0x0010000000085033
- (id)getCommandPushGenerationsResponse;	// IMP=0x0010000000084ffb
- (void)setCommandPushGenerationsRequest:(id)arg1;	// IMP=0x0010000000084fdb
- (id)getCommandPushGenerationsRequest;	// IMP=0x0010000000084fa3
- (void)setType:(long long)arg1;	// IMP=0x0010000000084f95
- (long long)getType;	// IMP=0x0010000000084f73
- (void)setSequence:(unsigned long long)arg1;	// IMP=0x0010000000084f65
- (unsigned long long)getSequence;	// IMP=0x0010000000084f43
- (_Bool)isDirty;	// IMP=0x0010000000084f38
- (id)initWithBase:(id)arg1;	// IMP=0x0010000000084ecd
