...
@class AFAudioPlaybackRequest, AFCompanionDeviceInfo, AFDeleteSiriHistoryContext, AFMyriadAdvertisementContext, AFRequestInfo, AFSpeechRecognition, AFVoiceInfo, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSURL, NSUUID;
...
- (MISSING_TYPE *)setAnnounceNotificationsInCarPlayType: /* Error: Ran out of types for this method. */;
