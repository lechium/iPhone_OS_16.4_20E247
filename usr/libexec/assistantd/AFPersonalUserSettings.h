...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000014e73e
- (void).cxx_destruct;	// IMP=0x002000000014e9c3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000014e7f4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000014e746
