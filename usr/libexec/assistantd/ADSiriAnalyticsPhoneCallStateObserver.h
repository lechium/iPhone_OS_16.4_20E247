...
- (void);	// IMP=0x00200000001fedfd
- (void)pollConditionStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000001fed0b
- (void)callObserver:(id)arg1 callStateDidChangeFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x00100000001feb70
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00100000001feab0
