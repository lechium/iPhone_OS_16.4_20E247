...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x00200000002b48a7
+ (id)locallyPairedPeerInfo;	// IMP=0x00100000002b3f10
+ (id)_queue;	// IMP=0x00100000002b3e83
- (void).cxx_destruct;	// IMP=0x00200000002b4c9d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002b49e7
- (unsigned long long)hash;	// IMP=0x00100000002b49d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002b49c6
- (id)afPeerInfo;	// IMP=0x00100000002b4697
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x00100000002b4580
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x00100000002b41f6
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x00100000002b4189
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x00100000002b416f
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x00100000002b405e
