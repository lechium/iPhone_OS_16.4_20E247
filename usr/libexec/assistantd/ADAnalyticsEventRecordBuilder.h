...
- (void).cxx_destruct;	// IMP=0x00200000001135bb
- (id)build;	// IMP=0x0010000000113392
- (void)setValue:(id)arg1 forColumnName:(id)arg2;	// IMP=0x001000000011321f
- (void)reset;	// IMP=0x0010000000113199
