...
- (void).cxx_destruct;	// IMP=0x0020000000089815
...
- (long long)_announceNotificationRequestTypeForNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3;	// IMP=0x001000000008964a
- (id)initWithNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000089556
