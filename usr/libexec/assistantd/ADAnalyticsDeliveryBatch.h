...
- (void).cxx_destruct;	// IMP=0x00200000001e71b7
...
- (id)analyticsDictionary;	// IMP=0x00100000001e6ec8
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00100000001e6eba
- (void)markSucceeded;	// IMP=0x00100000001e6eb0
- (void)markEndTime;	// IMP=0x00100000001e6e77
- (void)markStartTime;	// IMP=0x00100000001e6e3e
- (_Bool)hasFailureType;	// IMP=0x00100000001e6e30
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00100000001e6db1
