...
- (void).cxx_destruct;	// IMP=0x002000000011f741
...
- (void)reset;	// IMP=0x001000000011f6df
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000011f620
