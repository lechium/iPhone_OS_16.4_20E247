...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000000f5ff4
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a6aa7
- (void).cxx_destruct;	// IMP=0x00100000000f9094
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f8869
- (unsigned long long)hash;	// IMP=0x00100000000f84e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f7ebc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f78f6
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f750d
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f70b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f70ac
- (id)dictionaryRepresentation;	// IMP=0x00100000000f61d1
- (id)description;	// IMP=0x00100000000f6122
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000f5fd7
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000000f5fba
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00100000000f5f50
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000000f5f33
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c434d
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000133250
