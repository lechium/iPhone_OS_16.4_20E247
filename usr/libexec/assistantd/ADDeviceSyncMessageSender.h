...
- (void).cxx_destruct;	// IMP=0x00200000001fb86c
@property(readonly, copy, nonatomic) NSString *deviceIdentifier; // @synthesize deviceIdentifier=_deviceIdentifier;
- (void)sendMessage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001fb799
- (id)initWithDeviceIdentifier:(id)arg1 messagingService:(id)arg2;	// IMP=0x00100000001fb6f5
