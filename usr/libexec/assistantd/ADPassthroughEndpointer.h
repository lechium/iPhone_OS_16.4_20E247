...
- (void).cxx_destruct;	// IMP=0x0020000000118439
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00100000001183e9
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x001000000011839b
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x00100000001182d5
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x001000000011823e
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x001000000011819a
