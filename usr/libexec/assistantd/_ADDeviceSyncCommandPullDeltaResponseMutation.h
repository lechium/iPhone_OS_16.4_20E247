...
- (void).cxx_destruct;	// IMP=0x00200000000b28cb
- (void)setIncrementalChanges:(id)arg1;	// IMP=0x00100000000b28ab
- (id)getIncrementalChanges;	// IMP=0x00100000000b2873
- (_Bool)isDirty;	// IMP=0x00100000000b2868
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000b27fd
