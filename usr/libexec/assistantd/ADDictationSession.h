...
- (void).cxx_destruct;	// IMP=0x00200000000db59c
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000db261
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000daf6c
- (void)dealloc;	// IMP=0x00100000000daca4
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000dab99
- (id)init;	// IMP=0x00100000000dab8b
