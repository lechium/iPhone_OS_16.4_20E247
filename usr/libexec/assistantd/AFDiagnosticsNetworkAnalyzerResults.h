...
- (void).cxx_destruct;	// IMP=0x00200000001b980b
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001b9c5e
- (id)metricValue;	// IMP=0x00100000001b9875
