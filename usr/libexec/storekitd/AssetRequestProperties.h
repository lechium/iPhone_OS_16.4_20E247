...
- (void).cxx_destruct;	// IMP=0x00200000000825a7
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000820b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000820a3
- (id)init;	// IMP=0x0010000000082030
