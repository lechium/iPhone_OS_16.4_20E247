...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x00400000000a146d
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x00100000000a13e9
+ (void)removeAllTaskInfo;	// IMP=0x00100000000a13ae
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x00100000000a1246
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x00100000000a1234
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x00100000000a1135
- (void).cxx_destruct;	// IMP=0x00200000000a16df
...
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000a11a0
