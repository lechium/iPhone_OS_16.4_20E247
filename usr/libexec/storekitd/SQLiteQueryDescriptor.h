...
- (void).cxx_destruct;	// IMP=0x002000000007ae41
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000007a6e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007a5f3
- (id)initWithEntityClass:(Class)arg1 memoryEntityClass:(Class)arg2;	// IMP=0x001000000007a5ab
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x001000000007a597
