...
- (void).cxx_destruct;	// IMP=0x0020000000008033
...
- (void)main;	// IMP=0x0010000000006f6d
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 client:(id)arg3;	// IMP=0x0010000000006e7c
