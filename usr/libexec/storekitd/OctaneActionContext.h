...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x0040000000070799
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x0010000000070735
- (void).cxx_destruct;	// IMP=0x00200000000707e9
...
- (id)init;	// IMP=0x0010000000070693
