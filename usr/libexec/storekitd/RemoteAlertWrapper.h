...
- (void).cxx_destruct;	// IMP=0x0020000000009220
...
- (void)activateForTargetXPCConnection:(id)arg1 sceneID:(id)arg2 shouldDismissOnUILock:(_Bool)arg3 userInfo:(id)arg4;	// IMP=0x0010000000008ec1
- (id)initWithServiceName:(id)arg1 viewControllerClassName:(id)arg2;	// IMP=0x0010000000008e06
