...
@interface InAppTransactionTask
{
    ...
    _Bool _isProcessingInterruptedBuy;	// 30 = 0x1e
...
- (void).cxx_destruct;	// IMP=0x0020000000021a19
...
- (void)_latestTransactionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000020f2a
- (void)_cacheLegacyTransaction;	// IMP=0x0010000000020b3f
- (id)_processPurchaseResult:(id)arg1 authorizationResult:(id)arg2;	// IMP=0x001000000001fd24
- (void)purchase:(id)arg1 handleEngagementRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001f85e
- (void)purchase:(id)arg1 handleDialogRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001f56c
- (void)purchase:(id)arg1 handleAuthenticateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001f27a
- (id)_authenticateWithAccountInfo:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001eb36
- (void)clearTransactionCache;	// IMP=0x001000000001eae4
- (id)_buyParams;	// IMP=0x001000000001da13
- (void)main;	// IMP=0x001000000001b74e
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3 apiVersion:(long long)arg4;	// IMP=0x001000000001b63b
- (id)initWithBuyParams:(id)arg1 client:(id)arg2 apiVersion:(long long)arg3;	// IMP=0x001000000001b53a
