...
- (void).cxx_destruct;	// IMP=0x00200000000051f8
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004926
- (id)initWithClient:(id)arg1 status:(id)arg2 logKey:(id)arg3;	// IMP=0x001000000000486f
