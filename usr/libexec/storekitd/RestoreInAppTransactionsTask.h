...
- (void).cxx_destruct;	// IMP=0x0020000000059e0f
...
- (id)_authenticateAccount:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000596a0
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x001000000005934e
- (void)main;	// IMP=0x0010000000058e1e
- (id)initWithClient:(id)arg1;	// IMP=0x0010000000058d7f
