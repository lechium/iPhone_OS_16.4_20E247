...
- (void)_updateStatisticsFromSnapshots;	// IMP=0x001000000000666a
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x0010000000006482
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x0010000000006317
