...
- (id)_lib_receiptName;	// IMP=0x0010000000098ff5
...
- (_Bool)sk_canMakeExternalPurchaseForCountryCodes:(id)arg1;	// IMP=0x00100000000b6540
- (id)sk_firstExternalLinkURLForCountryCodes:(id)arg1 mode:(long long)arg2;	// IMP=0x00100000000b5960
