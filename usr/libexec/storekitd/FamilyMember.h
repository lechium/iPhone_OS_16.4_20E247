...
- (void).cxx_destruct;	// IMP=0x0020000000069313
- (_Bool);	// IMP=0x001000000006930a
...
- (id)description;	// IMP=0x001000000006902e
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000689e3
