...
- (void).cxx_destruct;	// IMP=0x002000000002921f
...
- (id)compile;	// IMP=0x0010000000028f84
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000028b97
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x0010000000028a6c
