...
- (void).cxx_destruct;	// IMP=0x002000000002750a
...
- (id)compile;	// IMP=0x001000000002726f
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000026e83
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x0010000000026d58
