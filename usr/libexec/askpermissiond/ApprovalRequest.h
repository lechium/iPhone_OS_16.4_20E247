...
+ (id)createUniqueIDFromRequestID:(id)arg1 andCreatedDate:(id)arg2;	// IMP=0x00200000000261af
- (void).cxx_destruct;	// IMP=0x0020000000026c01
...
- (id)compile;	// IMP=0x001000000002632c
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x00100000000244d9
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000024458
- (id)initWithRequestStorageItem:(id)arg1;	// IMP=0x0010000000024162
- (id)initWithApproverStorageItem:(id)arg1;	// IMP=0x0010000000023ede
- (id)initWithApproverDSID:(id)arg1 createdDate:(id)arg2 modifiedDate:(id)arg3 requestIdentifier:(id)arg4 uniqueIdentifier:(id)arg5 canSendViaMessages:(_Bool)arg6 itemBundleID:(id)arg7 itemDescription:(id)arg8 itemIdentifier:(id)arg9 itemTitle:(id)arg10 localizations:(id)arg11 offerName:(id)arg12 mocked:(_Bool)arg13 previewURL:(id)arg14 productType:(id)arg15 productTypeName:(id)arg16 productURL:(id)arg17 requesterName:(id)arg18 requesterDSID:(id)arg19 requestInfo:(id)arg20 status:(long long)arg21;	// IMP=0x0010000000023bb3
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000022790
