...
- (void).cxx_destruct;	// IMP=0x00200000000c64b1
...
- (_Bool)_dataMigrationIsComplete;	// IMP=0x00100000000c6435
- (_Bool)_canAccessDatabase;	// IMP=0x00100000000c62c7
- (id)_criterionForSpecialNotifications:(id)arg1;	// IMP=0x00100000000c615a
- (id)_criterionForExcludedDateRanges:(id)arg1;	// IMP=0x00100000000c5dec
- (id)_criterionForCutOffDates:(id)arg1 sinceDate:(id)arg2;	// IMP=0x00100000000c5c9f
- (id)_criterionForDismissedMessages:(id)arg1;	// IMP=0x00100000000c5b5e
- (id)_criterionForObservedMailboxesInAccount:(id)arg1 favoritesReader:(id)arg2;	// IMP=0x00100000000c58bf
- (id)_criteriaForAccountIDs:(id)arg1 clearedInfo:(id)arg2 since:(id)arg3 favoritesReader:(id)arg4;	// IMP=0x00100000000c4d2e
- (id)_notificationMessagesForAccountIDs:(id)arg1 count:(unsigned long long)arg2 clearedInfo:(id)arg3 sinceDate:(id)arg4;	// IMP=0x00100000000c43e7
- (_Bool)_performUpgrade;	// IMP=0x00100000000c3c66
- (id)_lastClearedInfo;	// IMP=0x00100000000c3c02
- (void)_markUpgradeComplete;	// IMP=0x00100000000c3b30
- (_Bool)_hasBeenUpgraded;	// IMP=0x00100000000c3aca
- (void)_upgrade;	// IMP=0x00100000000c3a1a
- (void)_verifyDatabaseAccessAndPerformUpgrade;	// IMP=0x00100000000c3961
- (void)performUpgradeIfNecessary;	// IMP=0x00100000000c38ca
- (id)initWithDelegate:(id)arg1 systemUserNotificationCenter:(id)arg2 conversationSubscriptionProvider:(id)arg3 favoritesReader:(id)arg4 vipReader:(id)arg5 prioritySenderProvider:(id)arg6 activeAccounts:(id)arg7;	// IMP=0x00100000000c3730
