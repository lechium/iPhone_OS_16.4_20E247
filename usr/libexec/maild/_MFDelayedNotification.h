...
- (void).cxx_destruct;	// IMP=0x00200000000698c9
...
- (void)process;	// IMP=0x0010000000069859
- (_Bool)isProcessing;	// IMP=0x001000000006984e
- (void)invalidate;	// IMP=0x0010000000069843
- (_Bool)isInvalidated;	// IMP=0x0010000000069838
- (id)initWithNotificationMessage:(id)arg1 identifier:(id)arg2 submissionDate:(double)arg3 context:(id)arg4;	// IMP=0x0010000000069714
