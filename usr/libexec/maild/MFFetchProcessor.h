...
@class EFCancelationToken, FavoritesPersistence, MFInvocationQueue, MISSING_TYPE, NSArray, NSCountedSet, NSMutableSet, NSSet, NSString;
...
+ (id)intelligentSkeletonFetchProcessor;	// IMP=0x004000000007ec67
+ (id)powernapProcessor;	// IMP=0x001000000007eab2
+ (id)processorWithName:(id)arg1 condition:(id)arg2;	// IMP=0x001000000007ea25
+ (void)initialize;	// IMP=0x001000000007e749
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x0020000000081438
...
- (id)_mailboxesToFetch;	// IMP=0x001000000008090c
- (void)_fetchCompleted:(id)arg1;	// IMP=0x00100000000802c2
- (void)_finishRequest;	// IMP=0x0010000000080254
- (void)_cancelCurrentInvocations;	// IMP=0x001000000007fed9
- (id)_observeChangesInConditions;	// IMP=0x001000000007fd21
- (_Bool)_processEligibleMailboxesAndWait;	// IMP=0x001000000007f165
- (_Bool)_runSynchronously:(long long)arg1;	// IMP=0x001000000007edae
- (void)runSynchronouslyWithDuration:(double)arg1;	// IMP=0x001000000007ed71
- (void)_setRequestLimiterLimit:(unsigned long long)arg1;	// IMP=0x001000000007ed67
- (void)dealloc;	// IMP=0x001000000007e9b1
- (id)initWithName:(id)arg1 condition:(id)arg2;	// IMP=0x001000000007e7e9
