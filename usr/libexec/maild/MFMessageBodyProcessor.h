...
+ (id)powernapProcessor;	// IMP=0x002000000008c938
+ (void)initialize;	// IMP=0x001000000008c8f1
- (void).cxx_destruct;	// IMP=0x002000000008e095
...
- (id)_mailboxesToDownload;	// IMP=0x001000000008d8f3
- (_Bool)_shouldContinueProcessing;	// IMP=0x001000000008d70c
- (void)_runSynchronously;	// IMP=0x001000000008d2c0
@property(readonly, nonatomic) MailPersistentStorage *persistentStorage;
- (_Bool)mailboxMessageBodyProcessorShouldContinueProcessing:(id)arg1;	// IMP=0x001000000008d294
- (void)runWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000008d23d
- (_Bool)runSynchronouslyWithDuration:(long long)arg1;	// IMP=0x001000000008cce1
- (_Bool)runSynchronously;	// IMP=0x001000000008ccc8
- (id)initWithName:(id)arg1 accountsProvider:(id)arg2 deviceStorage:(id)arg3 condition:(id)arg4;	// IMP=0x001000000008cb46
