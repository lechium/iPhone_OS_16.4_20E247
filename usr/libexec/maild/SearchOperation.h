...
- (void).cxx_destruct;	// IMP=0x00200000000d53e9
...
- (void)dealloc;	// IMP=0x00100000000d529c
- (id)baseCriterionFromSources:(id)arg1;	// IMP=0x00100000000d4fe3
- (id)initWithManager:(id)arg1 sources:(id)arg2 searchContext:(id)arg3;	// IMP=0x00100000000d4cab
