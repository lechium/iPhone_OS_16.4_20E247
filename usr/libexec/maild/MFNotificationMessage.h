...
@class CNContactStore, MFLibraryMessage, MFMailboxUid, MISSING_TYPE, MailAccount, NSDate, NSSet, NSString;
...
@interface MFNotificationMessage : NSObject
{
    ...
    MISSING_TYPE *_nanoMessageId;	// 88 = 0x58
...
+ (id)notificationIDForMessage:(id)arg1;	// IMP=0x00200000000b2f70
...
- (_Bool)_isInFavoriteMailbox;	// IMP=0x00100000000b40f8
- (id)_displaySubject;	// IMP=0x00100000000b3fb9
- (id)_displaySender;	// IMP=0x00100000000b3b76
- (id)_summaryForRemindMe;	// IMP=0x00100000000b3a77
- (id)initWithFavoritesReader:(id)arg1 vipReader:(id)arg2 libraryMessage:(id)arg3 contactStore:(id)arg4 remindMeDate:(id)arg5;	// IMP=0x00100000000b3551
- (id)initWithFavoritesReader:(id)arg1 vipReader:(id)arg2 libraryMessage:(id)arg3 contactStore:(id)arg4 suppressionContexts:(id)arg5 summary:(id)arg6;	// IMP=0x00100000000b304c
