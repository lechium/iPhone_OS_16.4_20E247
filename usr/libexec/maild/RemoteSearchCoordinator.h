...
+ (id)log;	// IMP=0x00200000000d2a65
- (void).cxx_destruct;	// IMP=0x00200000000d384e
...
- (void)_addSearchOperations:(unsigned long long)arg1;	// IMP=0x00100000000d33de
- (void)remoteSearchOperation:(id)arg1 didFindResults:(_Bool)arg2;	// IMP=0x00100000000d30e7
- (_Bool)remoteSearchOperationShouldStopEarly:(id)arg1;	// IMP=0x00100000000d3006
- (void)cancel;	// IMP=0x00100000000d2fa0
- (void)performSearch;	// IMP=0x00100000000d2d3b
- (id)initWithAccount:(id)arg1 searchContext:(id)arg2 logIdentifier:(id)arg3 progress:(id)arg4;	// IMP=0x00100000000d2b42
