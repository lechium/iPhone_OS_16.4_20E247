...
- (void).cxx_destruct;	// IMP=0x0020000000061e6a
...
- (void)cancel;	// IMP=0x0010000000061dd9
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x0010000000061d09
- (id)initWithFavoriteItem:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 countDidChange:(CDUnknownBlockType)arg4;	// IMP=0x00100000000617e8
