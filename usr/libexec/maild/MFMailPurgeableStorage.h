...
- (void).cxx_destruct;	// IMP=0x0020000000088bdc
...
- (long long)nonPurgeableSpace;	// IMP=0x0010000000088208
- (id)library;	// IMP=0x00100000000881ef
- (id)initWithAccountsProvider:(id)arg1;	// IMP=0x0010000000088169
