...
+ (_Bool)observesVehicularReports;	// IMP=0x002000000000abac
- (void).cxx_destruct;	// IMP=0x002000000000b4c7
...
- (void)_checkVehicleState;	// IMP=0x001000000000b097
- (void)airplaneModeChanged;	// IMP=0x000000000000af66
- (void)scheduleVehicleStateCheckWithDelay:(double)arg1;	// IMP=0x001000000000ad93
...
- (void)dealloc;	// IMP=0x001000000000ab0e
- (id)initWithRadiosPreferences:(id)arg1 vehicleStateClass:(Class)arg2;	// IMP=0x001000000000a738
