...
- (void).cxx_destruct;	// IMP=0x0020000000004c00
...
- (id)_nextNightModeChangeDate;	// IMP=0x0010000000004866
- (_Bool)_shouldScheduleTimerForNextNightModeChange;	// IMP=0x0010000000004791
- (void)_timeDidChangeSignificantly;	// IMP=0x00100000000046e3
- (void)_handleLocationUpdateToLocation:(id)arg1;	// IMP=0x0010000000004536
- (void)_updateNightMode;	// IMP=0x00100000000043a4
- (void)_updateNightModeForNextSunsetOrSunrise;	// IMP=0x0010000000004307
- (_Bool)_isNightForLocation:(id)arg1;	// IMP=0x0010000000004240
- (void)_stop;	// IMP=0x0010000000004183
- (void)_start;	// IMP=0x0010000000003f14
- (void)locationManager:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0010000000003eb2
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;	// IMP=0x0010000000003e63
- (void)sessionDidDisconnect:(id)arg1;	// IMP=0x0010000000003db0
- (void)sessionDidConnect:(id)arg1;	// IMP=0x0010000000003cfd
- (void)dealloc;	// IMP=0x0010000000003cbf
@property(nonatomic) _Bool nightMode; // @synthesize nightMode=_nightMode;
- (id)initWithSessionStatus:(id)arg1;	// IMP=0x0010000000003bcb
