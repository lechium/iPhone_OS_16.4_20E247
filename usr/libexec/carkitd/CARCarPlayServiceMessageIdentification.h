...
+ (unsigned long long)identifier;	// IMP=0x002000000002185b
- (void).cxx_destruct;	// IMP=0x00200000000222f7
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000022064
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000021866
@property(readonly, copy) NSString *description;
- (id)initWithDisplayName:(id)arg1 modelName:(id)arg2 PPID:(id)arg3 authenticationSerialNumber:(id)arg4 accessoryProtocols:(id)arg5 supportsWiredCarPlay:(_Bool)arg6 supportsWiredToWirelessPairing:(_Bool)arg7 supportsEnhancedIntegration:(_Bool)arg8;	// IMP=0x0010000000021588
