...
- (void).cxx_destruct;	// IMP=0x002000000002ee6a
...
- (void)orientationManagerDidUpdateInterfaceOrientation:(long long)arg1;	// IMP=0x001000000002ed45
- (void)orientationManagerDidUpdateDeviceOrientation:(long long)arg1;	// IMP=0x001000000002ecf9
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000002eb8e
- (id)initWithApplicationLauncher:(id)arg1 orientationManager:(id)arg2 siriInterface:(id)arg3 systemConfiguration:(id)arg4 axManager:(id)arg5 touchGesturePerformer:(id)arg6;	// IMP=0x001000000002ea13
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000002e7e9
- (void)unloadAccessibility;	// IMP=0x001000000002e692
- (void)invalidate;	// IMP=0x001000000002e4d2
- (void)dealloc;	// IMP=0x001000000002e3a5
