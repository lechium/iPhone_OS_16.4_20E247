...
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x00200000000259af
...
- (id)_snapshotForTargetApplicationWithError:(id *)arg1;	// IMP=0x0010000000025870
- (id)_snapshotForApplicationContainingElement:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000025621
- (void)_processKeyboardEvent:(id)arg1;	// IMP=0x0010000000025572
- (void)_processDeviceOrientationEvent:(id)arg1;	// IMP=0x001000000002545a
- (void)_recognizedGestures:(id)arg1;	// IMP=0x0010000000024dd7
- (void)_recognizedEventTypeName:(id)arg1 atAbsoluteTime:(double)arg2 withStartSnapshot:(id)arg3 endSnapshot:(id)arg4;	// IMP=0x0010000000024b9c
- (id)_recordedEventNames:(id)arg1 timestamp:(double)arg2 duration:(double)arg3 startLocation:(id)arg4 startElementSnapshot:(id)arg5 startApplicationSnapshot:(id)arg6 endLocation:(id)arg7 endElementSnapshot:(id)arg8 endApplicationSnapshot:(id)arg9;	// IMP=0x00100000000249fc
- (void)_reportDeferredActionForEventCount:(id)arg1;	// IMP=0x001000000002493a
- (_Bool)_reportCurrentActionWaitForTimeInterval:(double *)arg1;	// IMP=0x001000000002474d
- (void)_processHandEvent:(id)arg1;	// IMP=0x001000000002413a
- (void)_processButtonUpEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000023fb9
- (void)_processButtonDownEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000023cb5
- (void)_processButtonUpEvent:(id)arg1;	// IMP=0x0010000000023c3b
- (void)_processButtonDownEvent:(id)arg1;	// IMP=0x0010000000023bc1
- (void)_releasePendingEvents:(double)arg1;	// IMP=0x0010000000023a40
- (id)stringForHandEventType:(unsigned int)arg1;	// IMP=0x001000000002384d
- (id)_elementSnapshotForLocation:(struct CGPoint)arg1 rootElementSnapshot:(id *)arg2;	// IMP=0x0010000000023450
- (void)_handleHIDEventReceived:(id)arg1;	// IMP=0x0010000000023028
- (void)stopRecording;	// IMP=0x0010000000022c54
- (void)_registerForKeyEventNotification;	// IMP=0x00100000000227b8
- (void)startRecordingProcessPID:(int)arg1 applicationSnapshotAttributes:(id)arg2 applicationSnapshotParameters:(id)arg3 elementSnapshotAttributes:(id)arg4 elementSnapshotParameters:(id)arg5 simpleTargetGestureNames:(id)arg6;	// IMP=0x0010000000021ea9
- (void)dealloc;	// IMP=0x0010000000021de1
- (id)initWithAXManager:(id)arg1;	// IMP=0x0010000000021d83
- (id)initWithError:(id *)arg1;	// IMP=0x0010000000021cc7
