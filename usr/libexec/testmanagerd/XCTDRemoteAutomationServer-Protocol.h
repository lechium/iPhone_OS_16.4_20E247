...
@class CLLocation, NSArray, NSDictionary, NSNumber, NSString, NSURL, NSUUID, NSValue, XCAXAuditConfiguration, XCAccessibilityElement, XCDeviceEvent, XCSynthesizedEventRecord, XCTCapabilities, XCTScreenshotRequest, XCTSpindumpRequestSpecification, XCTTailspinRequest;
