...
- (void).cxx_destruct;	// IMP=0x002000000001cd52
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x001000000001cc7d
- (id)init;	// IMP=0x001000000001cc05
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x001000000001cb6f
- (void)invalidate;	// IMP=0x001000000001ca2d
- (void)dealloc;	// IMP=0x001000000001c97b
