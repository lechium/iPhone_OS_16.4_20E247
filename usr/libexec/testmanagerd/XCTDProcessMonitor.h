...
+ (id)processStateDescriptor;	// IMP=0x002000000002088c
+ (id)predicatesForBundleIDs:(id)arg1;	// IMP=0x00100000000206bf
+ (id)stateSnapshotFromRBSState:(id)arg1 forRBSBundle:(id)arg2 pid:(int)arg3;	// IMP=0x00100000000203f6
- (void).cxx_destruct;	// IMP=0x0020000000021b1e
...
- (id)bundleIDForPID:(int)arg1 error:(id *)arg2;	// IMP=0x0010000000021a06
- (id)processSpecifierForPID:(int)arg1 error:(id *)arg2;	// IMP=0x00100000000219ba
- (void)startMonitoringApplicationWithBundleID:(id)arg1 path:(id)arg2;	// IMP=0x001000000002092a
- (void)guardIsValid:(CDUnknownBlockType)arg1;	// IMP=0x0010000000020381
- (void)invalidate;	// IMP=0x0010000000020292
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000002021f
- (id)initWithDelegate:(id)arg1 processMonitor:(id)arg2 processHandleClass:(Class)arg3;	// IMP=0x001000000002011c
