...
- (void).cxx_destruct;	// IMP=0x0020000000037892
...
- (void)_queue_logStatus;	// IMP=0x00100000000370f9
- (void)_queue_closeTestSession:(id)arg1;	// IMP=0x0010000000036f85
- (void)closeTestSession:(id)arg1;	// IMP=0x0010000000036eb6
- (void)closeIDESession:(id)arg1;	// IMP=0x00100000000369d7
- (void)closeTargetBootstrapSession:(id)arg1;	// IMP=0x001000000003677b
- (void)_queue_fulfillTestConnectionRequest:(CDUnknownBlockType)arg1 usingIDESession:(id)arg2;	// IMP=0x0010000000036640
- (void)_queue_fulfillLegacyTestConnectionRequest:(CDUnknownBlockType)arg1 usingIDESession:(id)arg2;	// IMP=0x00100000000362ba
- (void)_queue_handleRequestForSessionWithIdentifier:(id)arg1;	// IMP=0x00100000000360b6
- (void)_queue_advertiseAvailabilityToTargetWithPID:(int)arg1;	// IMP=0x0010000000035e07
- (void)_queue_processTargetSessionRequests;	// IMP=0x00100000000359a9
- (void)_queue_requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000035567
- (void)requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x001000000003547b
- (void)_queue_processPendingTransferObservationBlocks;	// IMP=0x00100000000350c5
- (void)setObserverForConnectionTransferToTargetWithPID:(int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000034ed2
- (void)connectionTransferToTargetWithPID:(int)arg1 completedWithSuccess:(_Bool)arg2 error:(id)arg3;	// IMP=0x0010000000034cb2
- (void)requestSerializedTransportForSessionIdentifier:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000034ac0
- (void)requestLegacySocketForSessionIdentifier:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000348ce
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000345ad
- (void)addTargetBootstrapSession:(id)arg1;	// IMP=0x001000000003428a
- (void)setIDESession:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000033f44
- (void)controlSession:(id)arg1 didAuthorizeProcessID:(int)arg2;	// IMP=0x0010000000033ead
- (void)addControlSession:(id)arg1;	// IMP=0x0010000000033cc7
- (void)remoteAutomationSessionDidClose:(id)arg1;	// IMP=0x0010000000033b90
- (void)serverDidHandleDisconnectForSocket:(int)arg1;	// IMP=0x0010000000033b8a
- (void)serverReceivedConnectionForServiceType:(unsigned long long)arg1 overSocket:(int)arg2 effectiveUserIdentifier:(unsigned int)arg3 disconnectionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000003384e
- (void)reportSelfDiagnosisIssue:(id)arg1 description:(id)arg2;	// IMP=0x0010000000033779
- (void)setupSignalHandlers;	// IMP=0x0010000000033440
- (void)run;	// IMP=0x0010000000033257
- (void)startAcceptingTargetConnectionsFromListener:(id)arg1;	// IMP=0x0010000000033133
- (void)startAcceptingTestConnectionsFromListener:(id)arg1;	// IMP=0x001000000003300f
- (id)init;	// IMP=0x0010000000032e2d
