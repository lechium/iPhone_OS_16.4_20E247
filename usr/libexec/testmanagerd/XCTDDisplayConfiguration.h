...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x0020000000042649
+ (id)sharedDisplayMonitor;	// IMP=0x00100000000425f4
- (void).cxx_destruct;	// IMP=0x0020000000042ebd
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x0010000000042676
