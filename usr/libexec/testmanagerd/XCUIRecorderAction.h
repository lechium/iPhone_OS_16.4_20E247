...
- (void).cxx_destruct;	// IMP=0x002000000000a785
...
- (id)gestureNamesWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009d8e
- (id)eventTypeNameWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009cc6
