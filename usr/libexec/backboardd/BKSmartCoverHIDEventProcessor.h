...
+ (_Bool)isSmartCoverSupported;	// IMP=0x002000000006ea27
- (void).cxx_destruct;	// IMP=0x002000000006e7c4
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000006e54c
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x001000000006e48c
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x001000000006dced
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x001000000006dc64
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x001000000006dc2f
- (id)initWithContext:(id)arg1;	// IMP=0x001000000006d9ec
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x001000000006d8c1
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x001000000006d592
