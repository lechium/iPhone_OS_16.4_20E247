...
- (void).cxx_destruct;	// IMP=0x0020000000031aff
- (struct CGPoint)currentTranslation;	// IMP=0x0000000000031ae7
- (_Bool)isComplete;	// IMP=0x0010000000031ac5
- (void)applyForTime:(double)arg1;	// IMP=0x0010000000031a30
- (id)initWithRelativeTranslation:(struct CGPoint)arg1 animationSettings:(id)arg2;	// IMP=0x00100000000317b7
