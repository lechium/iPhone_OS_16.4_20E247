...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002ed59
+ (id)classesRequiredToDecode;	// IMP=0x001000000002ecd3
- (void).cxx_destruct;	// IMP=0x002000000002ecab
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002eb05
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002e995
- (void)dealloc;	// IMP=0x001000000002e90b
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x001000000002e818
