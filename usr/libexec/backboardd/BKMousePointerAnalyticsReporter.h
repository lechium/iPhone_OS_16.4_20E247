...
- (void).cxx_destruct;	// IMP=0x002000000000ae3c
...
- (void)mousePointerGlobalDevicePreferencesDidChange:(id)arg1;	// IMP=0x001000000000ada7
- (void)availableDevicesDidChange;	// IMP=0x001000000000ad11
- (void)evaluatePeriodicReportingTrigger;	// IMP=0x001000000000ac48
- (id)init;	// IMP=0x001000000000ab3e
