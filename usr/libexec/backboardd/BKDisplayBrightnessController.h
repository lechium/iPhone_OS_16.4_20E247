...
+ (id)sharedInstance;	// IMP=0x002000000008b454
- (void).cxx_destruct;	// IMP=0x002000000008ab10
- (void)orientationManager:(id)arg1 userInterfaceOrientationMayHaveChanged:(long long)arg2 isDeviceOrientationLocked:(_Bool)arg3;	// IMP=0x001000000008aaa3
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x001000000008aa88
- (void)clientDied:(id)arg1;	// IMP=0x001000000008a9f8
- (void)setBacklightFeatures:(id)arg1 forPID:(int)arg2;	// IMP=0x001000000008a8bd
- (void)setBacklightLocked:(_Bool)arg1 forReason:(id)arg2;	// IMP=0x001000000008a6f7
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000008a67f
- (id)propertyForKey:(id)arg1;	// IMP=0x001000000008a618
@property(nonatomic) int displayBrightnessCurve;
- (void)setAutoBrightnessEnabled:(_Bool)arg1;	// IMP=0x001000000008a565
...
- (void)setBrightnessLevel:(float)arg1 reason:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000089ff0
@property(readonly, nonatomic) float brightnessLevel;
@property(readonly, nonatomic) float unentitledBrightnessLevel;
- (void)setMinimumBrightnessLevel:(float)arg1 fadeDuration:(float)arg2;	// IMP=0x0010000000089e04
- (unsigned char)backlightArchitectureVersion;	// IMP=0x0010000000089d84
- (id)suppressBrightnessNotificationsForReason:(id)arg1;	// IMP=0x0010000000089d15
- (void)dealloc;	// IMP=0x0010000000089c9a
- (id)_initWithBrightnessSystem:(id)arg1 systemShellSentinel:(id)arg2 orientationManager:(id)arg3;	// IMP=0x0010000000089a4c
