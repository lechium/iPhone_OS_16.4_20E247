...
- (void)_thread_startRunLoop;	// IMP=0x00100000000020a9
- (void)_thread_displayLinkFired;	// IMP=0x001000000000208b
- (void)invalidate;	// IMP=0x0010000000002034
- (id)initWithDisplayLinkClass:(Class)arg1 display:(id)arg2 target:(id)arg3 action:(SEL)arg4;	// IMP=0x0010000000001dcc
