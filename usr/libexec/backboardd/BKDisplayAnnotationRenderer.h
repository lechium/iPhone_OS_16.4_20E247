...
- (void)regenerateLayerTree;	// IMP=0x001000000003223d
- (void)sizeLayerToFitAtScale:(double)arg1;	// IMP=0x00100000000321a7
- (void)styleSheetDidChange;	// IMP=0x0010000000031ef5
- (void)didRemoveSubannotations;	// IMP=0x0010000000031ee3
- (void)didRemoveAnnotation;	// IMP=0x0010000000031eac
- (void)locationDidChange;	// IMP=0x0010000000031b5b
- (void)didAddAnnotation;	// IMP=0x0010000000031b49
