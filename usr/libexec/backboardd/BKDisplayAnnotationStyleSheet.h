...
- (void).cxx_destruct;	// IMP=0x0020000000024572
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x001000000002438c
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x00100000000242dc
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x001000000002425e
