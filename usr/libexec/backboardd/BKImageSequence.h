...
- (void).cxx_destruct;	// IMP=0x002000000003041d
...
- (void)_loadAllImages;	// IMP=0x001000000003035b
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x00100000000300ad
- (id)_idiomSuffix;	// IMP=0x00100000000300a0
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x001000000002fd5c
- (id)allImages;	// IMP=0x001000000002fd2d
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x001000000002fd1b
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x001000000002fbec
