...
- (void).cxx_destruct;	// IMP=0x002000000000c61f
...
- (void)resetForCancel;	// IMP=0x001000000000c51d
- (id)description;	// IMP=0x001000000000c3a3
- (id)initWithService:(id)arg1;	// IMP=0x001000000000c1e0
