...
- (void).cxx_destruct;	// IMP=0x002000000009643f
...
- (id)initWithRegion:(id)arg1 relativeRegion:(id)arg2 edge:(unsigned int)arg3 edgePosition:(double)arg4;	// IMP=0x0010000000096363
