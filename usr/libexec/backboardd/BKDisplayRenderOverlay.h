...
- (void).cxx_destruct;	// IMP=0x002000000002aff0
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000002aea5
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000002ae55
- (id)succinctDescriptionBuilder;	// IMP=0x001000000002aded
- (id)succinctDescription;	// IMP=0x001000000002ad9d
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ad24
- (id)_persistenceData;	// IMP=0x001000000002acae
- (void)_cleanup;	// IMP=0x001000000002aca8
- (void)_freeze;	// IMP=0x001000000002aca2
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000002ac9c
- (void)_stopAnimating;	// IMP=0x001000000002ac96
- (void)_startAnimating;	// IMP=0x001000000002ac90
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000002ac88
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000002ab3e
- (void)freeze;	// IMP=0x001000000002a904
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000002a730
...
- (void)dealloc;	// IMP=0x001000000002a4d4
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x001000000002a424
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x0010000000029f47
