...
- (void).cxx_destruct;	// IMP=0x002000000008ec4f
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000008ebf6
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x001000000008ea51
- (id)init;	// IMP=0x001000000008ea01
