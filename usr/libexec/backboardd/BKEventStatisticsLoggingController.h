...
+ (id)workQueue;	// IMP=0x0020000000066917
- (void).cxx_destruct;	// IMP=0x002000000006625a
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x00100000000661f6
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x001000000006616b
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x0010000000066155
- (void)dealloc;	// IMP=0x0010000000065fce
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0010000000065e02
