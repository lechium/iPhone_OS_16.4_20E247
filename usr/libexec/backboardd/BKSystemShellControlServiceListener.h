...
- (void).cxx_destruct;	// IMP=0x002000000009a4c1
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x001000000009a275
- (void)activate;	// IMP=0x001000000009a25f
- (id)initWithSentinel:(id)arg1;	// IMP=0x001000000009a0fb
