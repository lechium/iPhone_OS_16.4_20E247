...
- (_Bool)_shouldSendSampleEventWithTimestamp:(double)arg1 samplingInterval:(double)arg2;	// IMP=0x001000000006470e
- (_Bool)_passesThresholdForX:(float)arg1 y:(float)arg2 z:(float)arg3;	// IMP=0x001000000006468d
- (void)_queue_invalidate;	// IMP=0x001000000006465e
- (void)handleOrientationEvent:(long long)arg1 orientationLocked:(_Bool)arg2;	// IMP=0x0010000000064658
- (void)handleAccelerometerEventWithTimestamp:(double)arg1 x:(float)arg2 y:(float)arg3 z:(float)arg4 samplingInterval:(double)arg5;	// IMP=0x0010000000064652
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0010000000064565
