...
- (void).cxx_destruct;	// IMP=0x002000000002e7e7
...
- (id)initWithIdentifier:(id)arg1 forReason:(id)arg2 contextRelativePointerPosition:(id)arg3 displayUUID:(id)arg4 restrictingToPID:(int)arg5 invalidationBlock:(CDUnknownBlockType)arg6;	// IMP=0x001000000002e6eb
