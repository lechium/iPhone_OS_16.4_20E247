...
- (void).cxx_destruct;	// IMP=0x002000000003178f
@property(readonly, nonatomic) BKMousePointerController *mousePointerController;
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000031731
- (id)init;	// IMP=0x001000000003164d
