...
- (void).cxx_destruct;	// IMP=0x0020000000087cc2
...
- (void)removeService:(id)arg1;	// IMP=0x0010000000087c4d
- (void)addService:(id)arg1;	// IMP=0x0010000000087bd9
- (void)_resetServiceStatus;	// IMP=0x0010000000087a12
- (id)description;	// IMP=0x0010000000087924
