...
+ (id)sharedInstance;	// IMP=0x00200000000352f6
- (void).cxx_destruct;	// IMP=0x00200000000351e6
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x0010000000034f07
- (void)systemShellWillBootstrap;	// IMP=0x0010000000034e7c
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x0010000000034e31
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000034da6
- (void)addObserver:(id)arg1;	// IMP=0x0010000000034d1b
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
@property(readonly, copy) NSString *description;
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x0010000000034a98
