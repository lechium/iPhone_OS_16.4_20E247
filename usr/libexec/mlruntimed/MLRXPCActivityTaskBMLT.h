...
@interface MLRXPCActivityTaskBMLT : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00200000000025be
...
@property(nonatomic) _Bool dynamicallyRegistered; // @synthesize dynamicallyRegistered=_dynamicallyRegistered;
...
- (void)stop;	// IMP=0x001000000000254b
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002479
- (id)createTaskScheduler;	// IMP=0x0010000000002449
- (id)criteria;	// IMP=0x0010000000002313
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) _Bool bypassDiagnosticsUsage; // @dynamic bypassDiagnosticsUsage;
