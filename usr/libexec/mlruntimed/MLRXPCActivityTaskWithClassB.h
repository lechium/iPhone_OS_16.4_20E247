...
- (void).cxx_destruct;	// IMP=0x0020000000003ac9
...
- (void)stop;	// IMP=0x0010000000003a56
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003984
- (id)createTaskScheduler;	// IMP=0x0010000000003954
- (id)criteria;	// IMP=0x001000000000385f
