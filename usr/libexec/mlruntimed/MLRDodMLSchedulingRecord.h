...
- (void).cxx_destruct;	// IMP=0x002000000000c5e3
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000c476
- (id)description;	// IMP=0x001000000000c3f8
- (id)initWithPluginID:(id)arg1;	// IMP=0x001000000000c291
