...
- (void).cxx_destruct;	// IMP=0x002000000001c18b
...
- (void)stop;	// IMP=0x001000000001c118
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001c046
- (id)createTaskScheduler;	// IMP=0x001000000001c016
- (id)criteria;	// IMP=0x001000000001bf24
