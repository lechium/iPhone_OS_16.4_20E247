...
- (void).cxx_destruct;	// IMP=0x002000000000e75e
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000e6e9
- (id)description;	// IMP=0x001000000000e66b
- (id)initWithTaskID:(id)arg1;	// IMP=0x001000000000e569
