...
- (void)stop;	// IMP=0x00100000000036f2
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000035ee
- (id)createTaskScheduler;	// IMP=0x00100000000035be
- (id)criteria;	// IMP=0x0010000000003469
