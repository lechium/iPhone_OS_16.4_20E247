...
- (void).cxx_destruct;	// IMP=0x002000000001e95b
...
- (void)stop;	// IMP=0x001000000001e8e8
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001e816
- (id)createTaskScheduler;	// IMP=0x001000000001e7e6
- (id)criteria;	// IMP=0x000000000001e6f1
