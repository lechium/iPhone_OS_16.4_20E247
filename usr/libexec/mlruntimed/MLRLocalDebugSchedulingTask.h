...
- (void).cxx_destruct;	// IMP=0x002000000000c24f
...
- (id)description;	// IMP=0x001000000000c0d0
- (id)initWithBundleIdentifier:(id)arg1 taskSource:(long long)arg2 maxTimeLimit:(double)arg3;	// IMP=0x001000000000c0a7
- (id)initWithBundleIdentifier:(id)arg1 taskSource:(long long)arg2 maxTimeLimit:(double)arg3 recipePath:(id)arg4 recordUUIDs:(id)arg5 attachments:(id)arg6;	// IMP=0x001000000000bfbf
