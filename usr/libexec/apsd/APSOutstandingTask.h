...
- (void).cxx_destruct;	// IMP=0x0020000000002605
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x00100000000024f8
- (id)initWithDNSTask:(id)arg1;	// IMP=0x0010000000002485
