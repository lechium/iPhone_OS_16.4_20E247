...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001badb
- (void).cxx_destruct;	// IMP=0x002000000001bd2a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001bc89
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001bae3
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x001000000001b9d0
