...
- (void).cxx_destruct;	// IMP=0x00200000000686ce
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x0010000000068659
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x00100000000685c9
