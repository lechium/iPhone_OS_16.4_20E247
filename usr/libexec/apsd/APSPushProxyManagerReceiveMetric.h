...
- (void).cxx_destruct;	// IMP=0x002000000003f0ff
...
- (id)initWithGuid:(id)arg1 messageCommand:(long long)arg2 topic:(id)arg3 isNearby:(_Bool)arg4;	// IMP=0x001000000003ee8b
