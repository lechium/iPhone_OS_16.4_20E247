...
- (void).cxx_destruct;	// IMP=0x0020000000043931
...
- (void)_clearState;	// IMP=0x00100000000437e9
- (void)_fireMetricIfNeeded;	// IMP=0x00100000000436bf
- (void)_timerFired:(id)arg1;	// IMP=0x001000000004368e
- (void)noteReceivedLiveMessage;	// IMP=0x001000000004367c
- (void)noteSystemWillSleep;	// IMP=0x001000000004366a
- (void)noteReceivedStoredMessage;	// IMP=0x001000000004361a
- (void)noteDidConnect;	// IMP=0x00100000000435aa
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x00100000000434f5
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000000433ef
- (id)init;	// IMP=0x0010000000043273
