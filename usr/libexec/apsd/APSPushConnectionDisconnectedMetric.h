...
- (void).cxx_destruct;	// IMP=0x002000000001c357
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 error:(unsigned int)arg4 sslError:(unsigned int)arg5 genericError:(id)arg6;	// IMP=0x001000000001bffb
