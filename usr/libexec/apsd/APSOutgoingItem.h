...
- (void).cxx_destruct;	// IMP=0x0020000000088aeb
...
- (_Bool);	// IMP=0x0010000000088a8a
- (id)initWithSendBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2 timeout:(double)arg3;	// IMP=0x00100000000889b8
