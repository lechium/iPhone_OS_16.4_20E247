...
- (void).cxx_destruct;	// IMP=0x002000000005558f
...
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5 hwVersion:(id)arg6 swVersion:(id)arg7 swBuild:(id)arg8;	// IMP=0x00100000000553dc
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5;	// IMP=0x00100000000553a8
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 keepAliveState:(id)arg3;	// IMP=0x0010000000055383
