...
- (void).cxx_destruct;	// IMP=0x002000000001bfd3
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 reason:(unsigned int)arg4;	// IMP=0x001000000001bd5d
