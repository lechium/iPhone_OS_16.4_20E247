...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x004000000006e481
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000006e138
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x001000000006df2d
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x001000000006dd0f
+ (void)initialize;	// IMP=0x001000000006dcb8
- (void).cxx_destruct;	// IMP=0x002000000006ff73
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000006fd34
- (_Bool)_isExpired;	// IMP=0x001000000006fcd4
- (_Bool)_isLoaded;	// IMP=0x001000000006fccb
...
- (id)bagExpiryInterval;	// IMP=0x001000000006fbc6
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x001000000006fa6a
...
- (id)activeInterval;	// IMP=0x001000000006f8f1
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x001000000006f2bd
- (void)_failWithError:(id)arg1;	// IMP=0x001000000006f19e
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x001000000006ef1d
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000006edcb
- (id)pendingCompletionBocks;	// IMP=0x001000000006edbd
- (void)dealloc;	// IMP=0x001000000006ed7e
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x001000000006e744
