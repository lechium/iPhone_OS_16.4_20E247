...
- (void).cxx_destruct;	// IMP=0x0020000000014289
...
- (id)initWithGuid:(id)arg1 topic:(id)arg2 changedReason:(long long)arg3 didCauseFilterChange:(_Bool)arg4;	// IMP=0x0010000000014015
