...
- (id)description;	// IMP=0x001000000004318f
- (_Bool)isUnset;	// IMP=0x0010000000043172
- (void)clear;	// IMP=0x0010000000043156
- (_Bool)isUnderLimit;	// IMP=0x001000000004312c
- (void)note;	// IMP=0x00100000000430dd
- (_Bool)_checkIsExpired;	// IMP=0x001000000004306f
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x0010000000043023
