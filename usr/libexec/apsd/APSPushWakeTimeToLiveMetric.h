...
- (void).cxx_destruct;	// IMP=0x002000000000417d
...
- (id)initWithGuid:(id)arg1 connectedOnWake:(_Bool)arg2 everConnected:(_Bool)arg3 timeToFullyConnect:(id)arg4 timeToLastFromStorage:(id)arg5;	// IMP=0x0010000000003e83
