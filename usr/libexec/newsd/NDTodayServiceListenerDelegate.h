...
- (void).cxx_destruct;	// IMP=0x002000000000bf8a
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000bc8e
- (id)initWithContentContext:(id)arg1 fetchQueue:(id)arg2;	// IMP=0x001000000000bba7
