...
- (void).cxx_destruct;	// IMP=0x0020000000019476
...
- (void)trigger;	// IMP=0x001000000001922b
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x00100000000191a1
- (void)run;	// IMP=0x001000000001918f
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000001915d
- (id)initWithLabel:(id)arg1 delay:(unsigned long long)arg2 operationQueue:(id)arg3;	// IMP=0x0010000000018d57
