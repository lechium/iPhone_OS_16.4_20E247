...
- (void).cxx_destruct;	// IMP=0x0020000000010798
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000010642
- (unsigned long long)hash;	// IMP=0x00100000000105fe
...
- (_Bool)_onQueue_isReachable;	// IMP=0x00100000000101ba
@property(readonly) _Bool supportsNewProtocol;
@property(readonly) _Bool supportsPCSKeySync;
@property(readonly) NSUUID *pairingID;
- (void)removeObserver:(id)arg1;	// IMP=0x001000000000ffd2
- (void)addObserver:(id)arg1;	// IMP=0x001000000000fecf
- (id)initForSimulatorWithNRDevice:(id)arg1;	// IMP=0x001000000000fd66
- (id)init;	// IMP=0x001000000000fcdf
