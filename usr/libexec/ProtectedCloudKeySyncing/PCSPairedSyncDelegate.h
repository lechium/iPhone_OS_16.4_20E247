...
+ (id)sharedSyncDelegate;	// IMP=0x0020000000010bbf
- (void).cxx_destruct;	// IMP=0x002000000001105c
...
- (void)syncCoordinator:(id)arg1 beginSyncSession:(id)arg2;	// IMP=0x0010000000010d22
- (_Bool)syncingIsRestrictedForPairingID:(id)arg1;	// IMP=0x0010000000010d1a
- (id)init;	// IMP=0x0010000000010c65
