...
+ (id)sharedManager;	// IMP=0x0020000000011084
- (void).cxx_destruct;	// IMP=0x0020000000011e9e
...
- (void)setSimulatedDevices:(id)arg1;	// IMP=0x0010000000011b25
@property(readonly) NSArray *allDevices;
- (id)deviceForNRDevice:(id)arg1;	// IMP=0x00100000000118c2
- (id)deviceForPairingID:(id)arg1;	// IMP=0x001000000001151f
- (id)deviceForIDSIdentifier:(id)arg1;	// IMP=0x00100000000112fa
- (id)currentActivePairedDevice;	// IMP=0x0010000000011150
- (id)init;	// IMP=0x00100000000110d9
