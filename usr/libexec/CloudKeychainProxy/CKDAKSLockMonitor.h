...
+ (id)monitor;	// IMP=0x00200000000020da
- (void).cxx_destruct;	// IMP=0x0020000000002003
...
- (void)_onqueueRecheck;	// IMP=0x0010000000001e82
- (void)recheck;	// IMP=0x0010000000001e37
- (void)connectTo:(id)arg1;	// IMP=0x0010000000001e0c
- (void)notifyListener;	// IMP=0x0010000000001da5
- (void)handleNotification:(const char *)arg1;	// IMP=0x0010000000001d59
- (id)init;	// IMP=0x0010000000001bec
