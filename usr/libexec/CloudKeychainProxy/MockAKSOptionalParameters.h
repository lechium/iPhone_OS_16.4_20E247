...
- (void).cxx_destruct;	// IMP=0x002000000000ed45
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000ec53
- (unsigned long long)hash;	// IMP=0x001000000000ebe6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000eaee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000ea2a
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e9a7
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e92d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e7bf
- (id)dictionaryRepresentation;	// IMP=0x001000000000e715
- (id)description;	// IMP=0x001000000000e666
