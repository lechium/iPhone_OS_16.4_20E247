...
- (void).cxx_destruct;	// IMP=0x0040000000313060
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x0010000000312590
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000312490
- (id)init;	// IMP=0x0010000000311210
