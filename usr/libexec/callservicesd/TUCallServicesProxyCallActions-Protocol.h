...
@class IDSDestination, NSArray, NSString, NSUUID, TUAnswerRequest, TUCallScreenShareAttributes, TUDialRequest, TUProxyCall;
...
- (oneway void)pullRelayingCallsFromClientAndDisconnectCallsWithUPI:(NSArray *)arg1;
