...
- (void).cxx_destruct;	// IMP=0x00100000000d85af
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d83b4
- (unsigned long long)hash;	// IMP=0x00100000000d82ad
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d80df
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d7f8d
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d7e8b
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d7d89
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d7d7c
- (id)dictionaryRepresentation;	// IMP=0x00100000000d773d
- (id)description;	// IMP=0x00100000000d768e
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x00100000001c0b6d
