...
- (void).cxx_destruct;	// IMP=0x0020000000060c20
...
- (id)groupUUID;	// IMP=0x0010000000060674
- (id)UUID;	// IMP=0x0010000000060662
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x00100000000603f6
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000602d0
