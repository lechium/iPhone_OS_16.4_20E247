...
- (void).cxx_destruct;	// IMP=0x00200000000b2571
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000b216b
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000b2070
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000b1fc1
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000b1cd9
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000b1c42
- (id)init;	// IMP=0x00100000000b1bb8
