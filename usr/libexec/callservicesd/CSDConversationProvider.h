...
- (void).cxx_destruct;	// IMP=0x00200000001cbc80
...
- (void)isPseudonymHandleForProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001cbb62
- (void)revokePseudonymHandle:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001cbab6
- (void)renewPseudonymHandle:(id)arg1 expirationDate:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001cb99f
- (void)generatePseudonymHandleForConversationWithExpiryDuration:(double)arg1 URI:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001cb6ed
- (id)callerIDAccount;	// IMP=0x00100000001cb69d
- (void)registerWithIDSWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001cb60a
- (id)tuConversationProvider;	// IMP=0x00100000001cb4e1
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000001cb384
