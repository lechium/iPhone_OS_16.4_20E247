...
- (void).cxx_destruct;	// IMP=0x00100000001733b3
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x00100000001731d9
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x00100000001731d1
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x00100000001730c5
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x0010000000172e19
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000172dab
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000172c4a
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000172b5b
