...
+ (id)makePairedHostDeviceRouteController;	// IMP=0x00200000002e2a40
+ (id)makeLocalRouteController;	// IMP=0x00100000002e2a20
- (void).cxx_destruct;	// IMP=0x00400000002e4890
- (id)init;	// IMP=0x00100000002e4830
- (void)handleUpdatedPairedHostDeviceRoutes:(id)arg1;	// IMP=0x00100000002e4440
- (void)clearState;	// IMP=0x00100000002e3f30
- (void)pickRouteWithUniqueIdentifier:(id)arg1 shouldWaitUntilAvailable:(_Bool)arg2;	// IMP=0x00100000002e3be0
