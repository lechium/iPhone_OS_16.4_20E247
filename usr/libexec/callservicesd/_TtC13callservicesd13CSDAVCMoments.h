...
- (void).cxx_destruct;	// IMP=0x004000000033d030
- (id)init;	// IMP=0x001000000033cfd0
- (id)newRequestWithMediaType:(unsigned char)arg1 mode:(unsigned char)arg2 requesteeID:(id)arg3;	// IMP=0x001000000033cf50
...
- (id)initWithStreamToken:(long long)arg1 requesterID:(id)arg2 delegate:(id)arg3 dispatchQueue:(id)arg4;	// IMP=0x001000000033cd90
