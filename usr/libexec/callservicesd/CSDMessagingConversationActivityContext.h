...
+ (id)activityContextWithTUActivityContext:(id)arg1;	// IMP=0x0010000000051e84
- (void).cxx_destruct;	// IMP=0x001000000007a99d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007a866
- (unsigned long long)hash;	// IMP=0x001000000007a7e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007a6b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007a5cc
- (void)copyTo:(id)arg1;	// IMP=0x001000000007a529
- (void)writeTo:(id)arg1;	// IMP=0x001000000007a492
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007a485
- (id)dictionaryRepresentation;	// IMP=0x001000000007a22c
- (id)description;	// IMP=0x001000000007a17d
