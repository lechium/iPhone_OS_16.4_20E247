...
- (void).cxx_destruct;	// IMP=0x0020000000168f2d
...
- (void)performBlockAfterFirstUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000168c4d
- (void)_handleDeviceFirstUnlockNotification;	// IMP=0x0010000000168a7d
- (void)_refreshHasBeenUnlocked;	// IMP=0x0010000000168931
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000016891a
- (id)initWithNotifyObserver:(id)arg1 queue:(id)arg2;	// IMP=0x001000000016876b
