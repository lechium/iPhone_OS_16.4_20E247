...
+ (Class)remoteParticipantHandlesType;	// IMP=0x00200000000a998c
- (void).cxx_destruct;	// IMP=0x00100000000adb9d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ad35d
- (unsigned long long)hash;	// IMP=0x00100000000acde1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ac688
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ac08f
- (void)copyTo:(id)arg1;	// IMP=0x00100000000abc20
- (MISSING_TYPE *)writeTo: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000ab705
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ab6f8
- (id)dictionaryRepresentation;	// IMP=0x00100000000a9bf1
- (id)description;	// IMP=0x00100000000a9b42
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000a996f
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x00100000000a9952
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x00100000000a98e8
- (void)clearRemoteParticipantHandles;	// IMP=0x00100000000a98cb
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000013f5b8
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x001000000013e755
- (void)updateRelayCall:(id)arg1;	// IMP=0x001000000013e250
...
- (void)setService:(int)arg1;	// IMP=0x001000000013dd18
- (int)service;	// IMP=0x001000000013dd06
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x001000000013d812
