...
+ (Class)emergencyHandlesType;	// IMP=0x0020000000086aec
+ (Class)prioritizedSenderIdentitiesType;	// IMP=0x0010000000086a1a
+ (Class)emergencyLabeledHandlesType;	// IMP=0x00100000000868fd
+ (Class)handoffIdentifierType;	// IMP=0x0010000000086700
- (void).cxx_destruct;	// IMP=0x0010000000089c95
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000894fa
- (unsigned long long)hash;	// IMP=0x00100000000892c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000088ef6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000887cd
- (void)copyTo:(id)arg1;	// IMP=0x0010000000088383
- (void)writeTo:(id)arg1;	// IMP=0x0010000000087e19
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000087e0c
- (id)dictionaryRepresentation;	// IMP=0x0010000000086bac
- (id)description;	// IMP=0x0010000000086afd
- (id)emergencyHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000086acf
- (unsigned long long)emergencyHandlesCount;	// IMP=0x0010000000086ab2
- (void)addEmergencyHandles:(id)arg1;	// IMP=0x0010000000086a48
- (void)clearEmergencyHandles;	// IMP=0x0010000000086a2b
- (id)prioritizedSenderIdentitiesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000869fd
- (unsigned long long)prioritizedSenderIdentitiesCount;	// IMP=0x00100000000869e0
- (void)addPrioritizedSenderIdentities:(id)arg1;	// IMP=0x0010000000086976
- (void)clearPrioritizedSenderIdentities;	// IMP=0x0010000000086959
@property(nonatomic) _Bool hasSupportsRecents;
- (id)emergencyLabeledHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000868e0
- (unsigned long long)emergencyLabeledHandlesCount;	// IMP=0x00100000000868c3
- (void)addEmergencyLabeledHandles:(id)arg1;	// IMP=0x0010000000086859
- (void)clearEmergencyLabeledHandles;	// IMP=0x001000000008683c
- (void)setProtoSupportedHandleTypes:(unsigned int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0010000000086825
- (unsigned int)protoSupportedHandleTypeAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000086758
- (void)addProtoSupportedHandleType:(unsigned int)arg1;	// IMP=0x0010000000086745
- (void)clearProtoSupportedHandleTypes;	// IMP=0x0010000000086734
...
- (id)handoffIdentifierAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000866e3
- (unsigned long long)handoffIdentifiersCount;	// IMP=0x00100000000866c6
- (void)addHandoffIdentifier:(id)arg1;	// IMP=0x001000000008665c
- (void)clearHandoffIdentifiers;	// IMP=0x001000000008663f
...
- (void)dealloc;	// IMP=0x00100000000863dc
...
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000000b3207
