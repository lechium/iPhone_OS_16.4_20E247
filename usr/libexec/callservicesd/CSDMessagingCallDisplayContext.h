...
+ (Class)contactIdentifiersType;	// IMP=0x00200000001454ee
- (void).cxx_destruct;	// IMP=0x0010000000146e99
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000146982
- (unsigned long long)hash;	// IMP=0x00100000001467eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001464b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001460e3
- (void)copyTo:(id)arg1;	// IMP=0x0010000000145e81
- (void)writeTo:(id)arg1;	// IMP=0x0010000000145bd9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000145bcc
- (id)dictionaryRepresentation;	// IMP=0x00100000001455ae
- (id)description;	// IMP=0x00100000001454ff
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001454d1
- (unsigned long long)contactIdentifiersCount;	// IMP=0x00100000001454b4
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x001000000014544a
- (void)clearContactIdentifiers;	// IMP=0x001000000014542d
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x0010000000168f6b
