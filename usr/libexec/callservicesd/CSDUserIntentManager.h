...
- (void).cxx_destruct;	// IMP=0x0040000000205c10
- (id)init;	// IMP=0x0010000000205bb0
- (_Bool)validateUserIntentForCallSource:(id)arg1;	// IMP=0x0010000000205b50
- (void)donateUserIntentForCallProviderIdentifier:(id)arg1;	// IMP=0x0010000000205450
- (id)initWithQueue:(id)arg1;	// IMP=0x0010000000205410
