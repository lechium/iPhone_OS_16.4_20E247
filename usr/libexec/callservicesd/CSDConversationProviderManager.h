...
+ (id)errorForDisabledPseudonyms;	// IMP=0x00200000001ace76
+ (id)errorForUnregisteredProviderIdentifier:(id)arg1;	// IMP=0x00100000001acd89
+ (id)sharedInstance;	// IMP=0x00100000001ab300
- (void).cxx_destruct;	// IMP=0x00200000001ad2bb
...
- (void)createProcessMonitorIfNecessary:(id)arg1 forClient:(id)arg2;	// IMP=0x00100000001acf34
- (id)serviceForProvider:(id)arg1;	// IMP=0x00100000001ac9c3
- (void)doesHandle:(id)arg1 correspondToConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ac7d3
- (void)revokePseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ac64f
- (void)renewPseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 expirationDate:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001ac4a4
- (void)generatePseudonymHandleForConversationProvider:(id)arg1 expiryDuration:(double)arg2 URI:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001ac23d
- (id)tuConversationProviderForIdentifier:(id)arg1;	// IMP=0x00100000001ac19e
- (id)conversationProviderForIdentifier:(id)arg1;	// IMP=0x00100000001ac0f8
- (void)registerConversationProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001ab8e1
- (id)providerIdentifiersForClient:(id)arg1;	// IMP=0x00100000001ab7b3
- (void)startTrackingClient:(id)arg1 forProviderIdentifier:(id)arg2;	// IMP=0x00100000001ab461
- (id)init;	// IMP=0x00100000001ab385
