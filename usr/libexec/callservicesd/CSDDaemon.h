...
- (void).cxx_destruct;	// IMP=0x00200000000976f3
...
- (void)propertiesDidChangeForConfiguration:(id)arg1;	// IMP=0x0010000000097367
- (void)_setUpSandbox;	// IMP=0x001000000009734c
- (id)_setUpTemporaryDirectory;	// IMP=0x00100000000971e0
- (void)_setUpLanguageChangeListener;	// IMP=0x0010000000097113
@property(readonly, copy) NSString *debugDescription;
- (void)_observeSignal:(int)arg1 usingHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000096e49
- (void)dealloc;	// IMP=0x0010000000096cc7
- (id)init;	// IMP=0x0010000000095322
