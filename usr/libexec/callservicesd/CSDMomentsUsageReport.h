...
- (id)init;	// IMP=0x0040000000277730
@property(nonatomic, readonly) NSString *description;
- (id)initWithAvailability:(int)arg1 photoRequestSuccessCount:(long long)arg2 photoRequestFailureCount:(long long)arg3 medianRequestDuration:(double)arg4 meanRequestDuration:(double)arg5;	// IMP=0x0010000000277430
