...
- (void).cxx_destruct;	// IMP=0x0010000000139c62
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000139a6e
- (unsigned long long)hash;	// IMP=0x001000000013993a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000013970a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001395a4
- (void)copyTo:(id)arg1;	// IMP=0x0010000000139474
- (void)writeTo:(id)arg1;	// IMP=0x0010000000139329
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000013931c
- (id)dictionaryRepresentation;	// IMP=0x00100000001389b8
- (id)description;	// IMP=0x0010000000138909
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000138691
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000138648
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x00100000000148aa
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x0010000000014774
- (_Bool)wantsVideo;	// IMP=0x0010000000014762
