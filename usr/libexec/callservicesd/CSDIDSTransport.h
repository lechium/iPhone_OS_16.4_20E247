...
- (void).cxx_destruct;	// IMP=0x00200000001fbe0f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001fbc43
- (unsigned long long)hash;	// IMP=0x00100000001fbb2d
- (_Bool)isEqualToTransport:(id)arg1;	// IMP=0x00100000001fb92c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001fb8cf
- (id)description;	// IMP=0x00100000001fb6a2
- (id)initWithDestination:(id)arg1;	// IMP=0x00100000001fb629
- (id)initWithSocket:(int)arg1;	// IMP=0x00100000001fb5e7
