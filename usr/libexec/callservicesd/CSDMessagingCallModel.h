...
// Error: Property attributes should begin with the type ('T') attribute, property name: supportsUnambiguousMultiPartyState
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000049e15
- (unsigned long long)hash;	// IMP=0x0010000000049d3f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000049b65
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000049a6b
- (void)copyTo:(id)arg1;	// IMP=0x0010000000049994
- (void)writeTo:(id)arg1;	// IMP=0x0010000000049881
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000049874
- (id)dictionaryRepresentation;	// IMP=0x0010000000049078
- (id)description;	// IMP=0x0010000000048fc9
