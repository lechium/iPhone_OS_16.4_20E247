...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x00100000000a3412
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x00100000000a2d75
- (void).cxx_destruct;	// IMP=0x001000000013c4a5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000013c0cc
- (unsigned long long)hash;	// IMP=0x001000000013bd91
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000013ba8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013b846
- (void)copyTo:(id)arg1;	// IMP=0x001000000013b67b
- (void)writeTo:(id)arg1;	// IMP=0x001000000013b4c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000013b4b8
- (id)dictionaryRepresentation;	// IMP=0x001000000013ac62
- (id)description;	// IMP=0x001000000013abb3
