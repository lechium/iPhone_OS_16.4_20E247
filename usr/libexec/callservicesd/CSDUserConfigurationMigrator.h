...
- (void).cxx_destruct;	// IMP=0x0020000000149dfc
@property(readonly, nonatomic) TUUserConfiguration *userConfiguration; // @synthesize userConfiguration=_userConfiguration;
- (void)migrateConversationLinkBaseURL;	// IMP=0x0010000000149ba9
- (void)migrateAnnounceCalls;	// IMP=0x001000000014995e
- (void)perform;	// IMP=0x0010000000149930
- (id)init;	// IMP=0x00100000001498da
