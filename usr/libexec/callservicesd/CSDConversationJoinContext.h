...
@interface CSDConversationJoinContext : NSObject
{
    ...
    _Bool _supportsLeaveContext;	// 20 = 0x14
    _Bool _uPlusOneScrenShareAvailable;	// 21 = 0x15
    _Bool _video;	// 22 = 0x16
    _Bool _lightweight;	// 23 = 0x17
    ...
    TUConversationProvider *_provider;	// 64 = 0x40
    NSSet *_invitationPreferences;	// 72 = 0x48
    unsigned long long _sharePlayProtocolVersion;	// 80 = 0x50
    TUConversationParticipantAssociation *_participantAssociation;	// 88 = 0x58
    NSString *_collaborationIdentifier;	// 96 = 0x60
    TUConversationActivity *_activity;	// 104 = 0x68
}

- (void).cxx_destruct;	// IMP=0x002000000006f3b0
...
// Error: Property attributes should begin with the type ('T') attribute, property name: videoPaused
// Property attributes: (null)

- (_Bool)isVideoPaused;	// IMP=0x001000000006f1c0
...
- (id)description;	// IMP=0x001000000006e810
