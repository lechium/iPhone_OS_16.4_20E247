...
- (void).cxx_destruct;	// IMP=0x00200000001452f3
...
- (void)_updateSessionPreferences;	// IMP=0x0010000000144b6b
@property(readonly, copy, nonatomic) NSString *UUID;
@property(readonly, copy, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000144a27
- (id)initWithSessionProvider:(id)arg1;	// IMP=0x0010000000144992
- (id)init;	// IMP=0x0010000000144908
