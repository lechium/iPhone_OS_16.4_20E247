...
@property(readonly, nonatomic) unsigned long long idsFirewallBatchSize;
@property(readonly, nonatomic) unsigned long long idsFirewallCHExpiryTimeDays;
@property(readonly, nonatomic, getter=isGuestModeSupported) _Bool guestModeSupported;
@property(readonly, nonatomic) double neighborhoodActivityConduitTimeout;
@property(readonly, nonatomic, getter=isUPlusNDowngradeAvailable) _Bool uPlusNDowngradeAvailable;
@property(readonly, nonatomic) unsigned long long maxRemoteMirageParticipants;
@property(readonly, nonatomic, getter=isGFTDowngradeToOneToOneAvailable) _Bool gftDowngradeToOneToOneAvailable;
@property(readonly, nonatomic, getter=isExpanseConduitProxyEnabled) _Bool expanseConduitProxyEnabled;
