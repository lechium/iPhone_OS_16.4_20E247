...
- (void).cxx_destruct;	// IMP=0x0020000000171b13
...
- (unsigned long long)hash;	// IMP=0x0010000000171600
- (_Bool)isEqualToParticipant:(id)arg1;	// IMP=0x00100000001710ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000171091
- (_Bool)pseudonym;	// IMP=0x0010000000171023
...
- (id)description;	// IMP=0x00100000001706e5
- (id)initWithIDSDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000170526
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3;	// IMP=0x0010000000170511
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3 senderCorrelationIdentifier:(id)arg4;	// IMP=0x001000000017037b
