...
+ (Class)invitedHandlesType;	// IMP=0x00200000000065d0
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x00100000000060ef
- (void).cxx_destruct;	// IMP=0x00100000000085d4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000008190
- (unsigned long long)hash;	// IMP=0x0010000000007e46
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007b5f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000077be
- (void)copyTo:(id)arg1;	// IMP=0x00100000000075a0
- (void)writeTo:(id)arg1;	// IMP=0x001000000000730d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000007300
- (id)dictionaryRepresentation;	// IMP=0x00100000000068e2
- (id)description;	// IMP=0x0010000000006833
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x00100000000067d1
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x001000000000677c
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000065b3
- (unsigned long long)invitedHandlesCount;	// IMP=0x0010000000006596
- (void)addInvitedHandles:(id)arg1;	// IMP=0x001000000000652c
- (void)clearInvitedHandles;	// IMP=0x001000000000650f
