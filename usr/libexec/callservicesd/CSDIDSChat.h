...
+ (id)faceTimeAppUUID;	// IMP=0x00200000000755f4
- (void).cxx_destruct;	// IMP=0x002000000007a07c
...
- (void)conference:(id)arg1 didReceiveData:(id)arg2 forCallID:(long long)arg3;	// IMP=0x0010000000079dcd
- (void)conference:(id)arg1 changedBytesOfDataUsed:(long long)arg2;	// IMP=0x0010000000079d6b
- (void)conference:(id)arg1 outputLevelChangedTo:(float)arg2;	// IMP=0x0010000000079d04
- (void)conference:(id)arg1 inputLevelChangedTo:(float)arg2;	// IMP=0x0010000000079c9d
- (void)conference:(id)arg1 outputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0010000000079c23
- (void)conference:(id)arg1 inputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0010000000079ba9
- (void)conference:(id)arg1 remoteMediaStalled:(_Bool)arg2;	// IMP=0x0010000000079ad5
- (void)remoteVideoPausedForConference:(id)arg1;	// IMP=0x0010000000079a79
- (void)receivedFirstRemoteFrameForConference:(id)arg1;	// IMP=0x0010000000079962
- (void)sendingAudioChangedForConference:(id)arg1;	// IMP=0x0010000000079906
- (void)mutedChangedForConference:(id)arg1;	// IMP=0x00100000000798aa
- (void)conference:(id)arg1 endedWithReason:(long long)arg2 error:(id)arg3;	// IMP=0x001000000007978e
- (void)conferenceStarted:(id)arg1;	// IMP=0x00100000000794fa
- (void)conferenceFinishedPreparing:(id)arg1;	// IMP=0x00100000000790c0
- (void)session:(id)arg1 receivedData:(id)arg2;	// IMP=0x0010000000078ff8
- (void)session:(id)arg1 receivedInvitationCancelWithData:(id)arg2;	// IMP=0x0010000000078f2e
- (void)session:(id)arg1 receivedInvitationDeclineWithData:(id)arg2;	// IMP=0x0010000000078e64
- (void)session:(id)arg1 receivedInvitationAcceptWithData:(id)arg2;	// IMP=0x001000000007853d
- (void)session:(id)arg1 endedWithReason:(int)arg2;	// IMP=0x0010000000078424
- (void)session:(id)arg1 invitationSentToPushTokens:(id)arg2 shouldBreakBeforeMake:(_Bool)arg3;	// IMP=0x0010000000078302
- (void)sessionStarted:(id)arg1;	// IMP=0x00100000000780a0
- (void)_handlePushTokensInvited:(id)arg1 didSendInvitation:(_Bool)arg2 didCancelInvitation:(_Bool)arg3;	// IMP=0x0010000000077f6f
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x0010000000077f17
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x0010000000077ebe
- (void)prepareConference;	// IMP=0x0010000000077c25
- (void)startConnectionWithTransport:(id)arg1;	// IMP=0x0010000000077a7a
...
- (void)sendDataUnreliably:(id)arg1;	// IMP=0x0010000000077404
- (void)cancelInvitationWithLocalHangup;	// IMP=0x001000000007730b
- (void)cancelInvitationWithDeclinedElsewhere;	// IMP=0x001000000007720f
- (void)cancelInvitationWithAnsweredElsewhere;	// IMP=0x0010000000077113
- (void)end;	// IMP=0x0010000000076e1c
- (void)cancelOrDeclineInvitation;	// IMP=0x0010000000076ce9
- (void)answerWithVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x0010000000076be3
- (void)startWithVideoAspectRatioDescriptor:(id)arg1 inviteCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000076b17
- (int)deviceRole;	// IMP=0x0010000000076afe
- (id)capabilities;	// IMP=0x00100000000768ff
- (void)_setLocalAspectRatiosForVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000007679b
- (void)_setDateEndedIfNecessary;	// IMP=0x0010000000076527
...
- (id)initOutgoingWithSession:(id)arg1 UUID:(id)arg2 remoteHandle:(id)arg3 wantsVideo:(_Bool)arg4 isRelaying:(_Bool)arg5;	// IMP=0x00100000000759fe
- (id)initIncomingWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3 remoteInviteDictionary:(id)arg4;	// IMP=0x001000000007589a
- (id)initWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3;	// IMP=0x00100000000756fa
