...
- (void).cxx_destruct;	// IMP=0x002000000006a001
@property(retain, nonatomic) id <CSDCallHistoryControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)allCallHistoryDeleted;	// IMP=0x0010000000069f4c
- (void)recentCallsDeleted:(id)arg1;	// IMP=0x0010000000069e28
- (id)init;	// IMP=0x0010000000069df9
