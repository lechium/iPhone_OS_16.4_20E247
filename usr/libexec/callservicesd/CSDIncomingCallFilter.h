...
- (void).cxx_destruct;	// IMP=0x0020000000141cf7
...
- (void)callsChangedForCallCenterObserver:(id)arg1;	// IMP=0x0010000000141aa5
@property(nonatomic, getter=isOnEmergencyCall) _Bool onEmergencyCall; // @synthesize onEmergencyCall=_onEmergencyCall;
- (id)_callDirectoryPhoneNumberVariantsForSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x00100000001417a3
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x001000000014151b
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1;	// IMP=0x0010000000141483
- (_Bool)_doNotDisturbAllowsCallFromSourceAddress:(id)arg1 providerIdentifier:(id)arg2;	// IMP=0x001000000014117b
- (id)_callFilterIdentifier;	// IMP=0x0010000000141128
- (CDUnknownBlockType)_callFilterBlock;	// IMP=0x0010000000140e69
- (id)initWithDataSource:(id)arg1 deviceLockObserver:(id)arg2 callCenterObserver:(id)arg3 callDirectoryStoreBuilder:(CDUnknownBlockType)arg4 queue:(id)arg5;	// IMP=0x0010000000140ac3
- (id)init;	// IMP=0x00100000001407f2
