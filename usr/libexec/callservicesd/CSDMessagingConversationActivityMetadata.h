...
- (void).cxx_destruct;	// IMP=0x0020000000174372
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000174178
- (unsigned long long)hash;	// IMP=0x0010000000174077
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000173ea7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000173d51
- (void)copyTo:(id)arg1;	// IMP=0x0010000000173c4a
- (void)writeTo:(id)arg1;	// IMP=0x0010000000173b49
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000173b3c
- (id)dictionaryRepresentation;	// IMP=0x00100000001735ae
- (id)description;	// IMP=0x00100000001734ff
