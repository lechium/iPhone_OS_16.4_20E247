...
- (void).cxx_destruct;	// IMP=0x002000000001018b
...
- (void)dealloc;	// IMP=0x001000000000fdc2
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f139
- (_Bool)_validateOutputSize;	// IMP=0x001000000000efa4
- (_Bool)_validateOrientation;	// IMP=0x001000000000ee7b
- (_Bool)_validateMetadata;	// IMP=0x001000000000ecf3
- (_Bool)_validateSource;	// IMP=0x001000000000eac2
- (void)_validate;	// IMP=0x001000000000e95a
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000e921
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000e7c4
