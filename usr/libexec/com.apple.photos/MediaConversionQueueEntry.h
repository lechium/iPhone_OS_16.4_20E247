...
- (void).cxx_destruct;	// IMP=0x002000000000a69a
...
- (_Bool)allRequestsAreBackground;	// IMP=0x001000000000a4bb
- (_Bool)allRequestsAreOptional;	// IMP=0x001000000000a41c
- (_Bool)allRequestsHaveRequestPriority:(long long)arg1;	// IMP=0x001000000000a376
- (long long)compareProcessingOrderToEntry:(id)arg1;	// IMP=0x001000000000a187
@property(readonly) NSArray *clientRequestsSnapshot;
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x0010000000009fe8
- (id)requestIdentifiersForConnectionIdentifier:(id)arg1;	// IMP=0x0010000000009f0a
- (id)anyDestinationURLCollection;	// IMP=0x0010000000009e37
- (id)clientRequestForIdentifier:(id)arg1;	// IMP=0x0010000000009d23
- (id)removeAndReturnClientRequestWithIdentifier:(id)arg1 remainingRequestCount:(long long *)arg2;	// IMP=0x0010000000009ae6
- (_Bool)clientRequestIsDuplicate:(id)arg1 identicalDestination:(_Bool *)arg2;	// IMP=0x00100000000099f9
- (void)didDequeueAndStartProcessingQueueEntry;	// IMP=0x00100000000099e0
- (void)withLockEnumerateClientRequests:(CDUnknownBlockType)arg1;	// IMP=0x0010000000009934
- (void)addClientRequest:(id)arg1;	// IMP=0x0010000000009855
- (id)description;	// IMP=0x0010000000009784
- (void)dealloc;	// IMP=0x001000000000965b
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x0010000000009527
