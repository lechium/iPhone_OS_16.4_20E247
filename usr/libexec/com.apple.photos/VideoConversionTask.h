...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x002000000001908e
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000019086
- (void).cxx_destruct;	// IMP=0x0020000000018fd6
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000018d31
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000018cbc
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000018c47
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000018c41
- (void)cancel;	// IMP=0x0010000000018c3b
- (void)performConversion;	// IMP=0x0010000000018bbe
- (void)didEnqueue;	// IMP=0x0010000000018b5c
- (_Bool)wantsResultAsData;	// IMP=0x0010000000018ae7
- (void)updateResultTracker;	// IMP=0x0010000000018994
- (void)callCompletionHandler;	// IMP=0x0010000000018699
- (void)loadAsset;	// IMP=0x001000000001850c
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x001000000001820c
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x00100000000180bc
