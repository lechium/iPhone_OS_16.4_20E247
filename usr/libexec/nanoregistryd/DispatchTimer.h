...
- (void).cxx_destruct;	// IMP=0x00200000000082c8
...
- (void)fireTimer;	// IMP=0x00100000000081cb
- (void)scheduleTimer;	// IMP=0x001000000000809c
@property(readonly, nonatomic, getter=isWaking) _Bool waking;
- (void)invalidate;	// IMP=0x0010000000008026
- (void)dealloc;	// IMP=0x0010000000007fdf
- (id)initWithIdentifier:(id)arg1 delay:(double)arg2 gracePeriod:(double)arg3 handlerQueue:(id)arg4 handlerBlock:(CDUnknownBlockType)arg5;	// IMP=0x0010000000007eef
