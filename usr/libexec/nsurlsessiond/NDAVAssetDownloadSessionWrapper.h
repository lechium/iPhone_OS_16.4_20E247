...
- (void).cxx_destruct;	// IMP=0x002000000000eeb9
...
- (void)assetDownloadSession:(id)arg1 willDownloadVariants:(id)arg2;	// IMP=0x001000000000ed4b
- (void)assetDownloadSession:(id)arg1 didUpdateProgressWithExpectedBytes:(unsigned long long)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x001000000000ecf8
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x001000000000ec6d
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x001000000000eba3
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x001000000000eaaf
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x001000000000e9e5
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x001000000000e957
- (void)startLoadingMetadata;	// IMP=0x001000000000e906
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x001000000000e87b
- (void)cancel;	// IMP=0x001000000000e80e
- (void)suspend;	// IMP=0x001000000000e7a1
- (void)resume;	// IMP=0x001000000000e6f6
- (void)releasePowerAssertion;	// IMP=0x001000000000e60c
- (void);	// IMP=0x001000000000e372
- (void)disavowSession;	// IMP=0x001000000000e2c5
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000d83a
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000d651
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x001000000000d636
