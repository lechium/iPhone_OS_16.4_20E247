...
- (void).cxx_destruct;	// IMP=0x002000000000c450
...
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000000c199
- (id)initWithMessage:(id)arg1 accountStore:(id)arg2;	// IMP=0x001000000000bfd7
