...
- (void).cxx_destruct;	// IMP=0x0020000000016ebb
...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x0010000000016dd7
@property(readonly, nonatomic) NSDate *expiration;
- (_Bool)isFamilyCircleFresh;	// IMP=0x0010000000016d14
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x0010000000016cd0
- (id)familyCircleIfFresh;	// IMP=0x0010000000016c6a
- (id)initWithFamilyCircle:(id)arg1 serverTag:(id)arg2 cacheDate:(id)arg3 maxAge:(double)arg4;	// IMP=0x0010000000016ba3
