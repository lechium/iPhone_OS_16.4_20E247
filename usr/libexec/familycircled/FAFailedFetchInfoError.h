...
+ (id)errorWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x004000000000a49b
- (void).cxx_destruct;	// IMP=0x002000000000a636
...
- (id)initWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x001000000000a50b
