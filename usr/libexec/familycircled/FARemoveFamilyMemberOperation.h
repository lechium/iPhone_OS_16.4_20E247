...
- (void).cxx_destruct;	// IMP=0x0020000000001fdd
...
- (id)removeMember;	// IMP=0x0010000000001dd9
- (id)initWithNetworkService:(id)arg1 dsidOfMemberToRemove:(id)arg2;	// IMP=0x0010000000001d61
