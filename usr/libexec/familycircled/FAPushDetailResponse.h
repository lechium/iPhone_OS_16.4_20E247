...
- (void).cxx_destruct;	// IMP=0x002000000001c0e3
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001c053
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x001000000001bfe1
- (id)description;	// IMP=0x001000000001bf4c
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001bb2a
