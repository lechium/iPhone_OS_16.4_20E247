...
+ (id)sharedInstance;	// IMP=0x0040000000016534
- (void).cxx_destruct;	// IMP=0x0020000000016b7b
...
- (id)performBlockForKey:(id)arg1 force:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0010000000016622
- (id)init;	// IMP=0x0010000000016589
