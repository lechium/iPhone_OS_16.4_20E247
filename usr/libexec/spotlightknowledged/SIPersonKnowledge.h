...
- (void).cxx_destruct;	// IMP=0x0020000000019b97
...
- (id)normalizedPhoneNumbers;	// IMP=0x001000000001943b
...
- (id)initWithHandle:(id)arg1;	// IMP=0x0010000000018706
- (id)initWithContactIdentifier:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 values:(id)arg4;	// IMP=0x0010000000017bde
- (id)initWithValues:(id)arg1 firstNames:(id)arg2 lastNames:(id)arg3;	// IMP=0x0010000000016880
