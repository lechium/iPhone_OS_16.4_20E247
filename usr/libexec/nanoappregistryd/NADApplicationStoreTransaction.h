...
- (void)_flushCommandQueue;	// IMP=0x0010000000003669
- (void)rollback;	// IMP=0x0010000000003602
- (_Bool)commit:(id *)arg1;	// IMP=0x0010000000003585
- (void)setSequenceNumber:(id)arg1 UUID:(id)arg2;	// IMP=0x00100000000033fc
- (void)removeApplicationWithBundleIdentifier:(id)arg1;	// IMP=0x00100000000032fa
- (void)insertApplication:(id)arg1;	// IMP=0x00100000000031ae
- (void)removeAllEntities;	// IMP=0x00100000000030fc
- (id)initWithApplicationStore:(id)arg1;	// IMP=0x0010000000003040
