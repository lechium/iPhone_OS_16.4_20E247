...
- (_Bool)fileManager:(id)arg1 shouldProceedAfterError:(id)arg2 movingItemAtURL:(id)arg3 toURL:(id)arg4;	// IMP=0x001000000000d35c
- (void)migrate;	// IMP=0x001000000000d098
- (id)initWithSourceURL:(id)arg1 destinationURL:(id)arg2;	// IMP=0x001000000000cfdf
