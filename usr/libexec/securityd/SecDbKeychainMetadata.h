...
- (void).cxx_destruct;	// IMP=0x002000000010fac4
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000010f712
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x001000000010f511
