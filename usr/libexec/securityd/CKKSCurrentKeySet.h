...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000aae2e
- (void).cxx_destruct;	// IMP=0x00200000000aadae
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000aaa2c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000aa733
- (id)description;	// IMP=0x00100000000aa49b
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000aa402
