...
+ (id)decryptCKKSItemToAttributes:(id)arg1 keyCache:(id)arg2 ckksOperationalDependencies:(id)arg3 error:(id *)arg4;	// IMP=0x0020000000079951
- (void).cxx_destruct;	// IMP=0x0020000000077ae3
...
- (void)_onqueueHandleIQEDelete:(id)arg1 class:(const struct SecDbClass *)arg2 viewState:(id)arg3;	// IMP=0x0010000000076fc6
- (_Bool)_onqueueHandleIQEChange:(id)arg1 item:(struct SecDbItem *)arg2 viewState:(id)arg3 sortedForThisView:(_Bool)arg4 keyCache:(id)arg5;	// IMP=0x0010000000075c1c
- (void)_onqueueHandleIQEChange:(id)arg1 attributes:(id)arg2 class:(const struct SecDbClass *)arg3 viewState:(id)arg4 sortedForThisView:(_Bool)arg5 keyCache:(id)arg6;	// IMP=0x0010000000075a0d
- (void)_onqueueGenerateNewUUIDPersistentRefOnSecItem:(struct SecDbItem *)arg1 viewState:(id)arg2;	// IMP=0x001000000007586d
- (_Bool)fixMismatchedViewItems:(id)arg1;	// IMP=0x001000000007558f
- (_Bool)loadAndProcessEntries:(id)arg1 withActionFilter:(id)arg2;	// IMP=0x0010000000075295
- (void)main;	// IMP=0x00100000000742bf
- (_Bool)_onqueueUpdateIQE:(id)arg1 withState:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000074116
- (void)_onqueueHandleMismatchedViewItem:(id)arg1 secDbClass:(const struct SecDbClass *)arg2 attributes:(id)arg3 intendedView:(id)arg4 viewState:(id)arg5 keyCache:(id)arg6;	// IMP=0x0010000000073959
- (_Bool)intransaction:(id)arg1 processQueueEntries:(id)arg2;	// IMP=0x001000000007218a
- (_Bool)processNewCurrentItemPointers:(id)arg1 viewState:(id)arg2;	// IMP=0x0010000000071ddb
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 pendingClassAItemsRemainingState:(id)arg3 errorState:(id)arg4 handleMismatchedViewItems:(_Bool)arg5;	// IMP=0x0010000000071c76
- (id)init;	// IMP=0x0010000000071c68
