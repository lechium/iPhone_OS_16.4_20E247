...
@class MISSING_TYPE, NSString, SECC2MPError;
...
@interface SECC2MPNetworkEvent : PBCodable
{
    ...
    MISSING_TYPE *_timestampRequestStart;	// 96 = 0x60
...
- (void).cxx_destruct;	// IMP=0x00200000001b618a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b58d9
- (unsigned long long)hash;	// IMP=0x00100000001b52b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b4a14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b4445
- (void)copyTo:(id)arg1;	// IMP=0x00100000001b3f37
- (void)writeTo:(id)arg1;	// IMP=0x00100000001b39fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001b39ee
- (id)dictionaryRepresentation;	// IMP=0x00100000001b2d77
- (id)description;	// IMP=0x00100000001b2cc8
