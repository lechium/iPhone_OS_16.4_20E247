...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000cb484
- (void).cxx_destruct;	// IMP=0x00200000000cb45c
...
- (id)asPathStep;	// IMP=0x00100000000cb323
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000cb28a
