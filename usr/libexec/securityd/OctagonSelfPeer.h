...
- (void).cxx_destruct;	// IMP=0x0020000000045216
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x001000000004511c
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x0010000000044ea9
