...
- (void).cxx_destruct;	// IMP=0x0020000000096536
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x0010000000095ef5
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x0010000000095d95
- (void)groupStart;	// IMP=0x0010000000095915
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x00100000000957ff
- (id)init;	// IMP=0x00100000000957f1
