...
- (void).cxx_destruct;	// IMP=0x00200000001fe5a4
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00100000001fe3b1
- (void)requestSyncWith:(id)arg1;	// IMP=0x00100000001fe2de
- (void)finish;	// IMP=0x00100000001fca43
- (void)restart;	// IMP=0x00100000001fca15
- (void)start;	// IMP=0x00100000001fc5bc
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00100000001fc534
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00100000001fc2bf
- (unsigned long long)currentTrustBitmask;	// IMP=0x00100000001fc1b0
