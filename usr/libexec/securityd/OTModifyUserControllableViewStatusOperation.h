...
- (void).cxx_destruct;	// IMP=0x0020000000026425
...
- (void)performWithStatus:(int)arg1;	// IMP=0x00100000000260e9
- (void)groupStart;	// IMP=0x0010000000025bbf
- (id)initWithDependencies:(id)arg1 intendedViewStatus:(int)arg2 intendedState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x0010000000025abf
