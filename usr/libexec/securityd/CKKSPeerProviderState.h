...
+ (id)createFromProvider:(id)arg1;	// IMP=0x0040000000134420
+ (id)noPeersState:(id)arg1;	// IMP=0x0010000000134306
- (void).cxx_destruct;	// IMP=0x00200000001342b2
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001332bd
- (id)description;	// IMP=0x001000000013318b
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x0010000000132e9a
