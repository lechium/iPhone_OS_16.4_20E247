...
- (void).cxx_destruct;	// IMP=0x0020000000084279
...
- (void)proceedAfterFetch;	// IMP=0x0010000000083d27
- (void)groupStart;	// IMP=0x0010000000083a32
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000008396c
