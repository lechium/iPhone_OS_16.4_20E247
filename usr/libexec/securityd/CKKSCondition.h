...
- (void).cxx_destruct;	// IMP=0x00200000001d3b91
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x00100000001d3ac5
- (void)fulfill;	// IMP=0x00100000001d3a42
- (id)initToChain:(id)arg1;	// IMP=0x00100000001d39c2
- (id)init;	// IMP=0x00100000001d39ae
