...
+ (_Bool)triggerOSFaults;	// IMP=0x0040000000003436
+ (_Bool)watchdogrusage:(struct rusage_info_v6 *)arg1;	// IMP=0x001000000000340d
+ (id)watchdog;	// IMP=0x00100000000033aa
- (void).cxx_destruct;	// IMP=0x002000000000309c
@property(readonly) _Bool diskUsageHigh; // @synthesize diskUsageHigh=_diskUsageHigh;
- (_Bool)setWatchdogParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002e10
- (id)watchdogParameters;	// IMP=0x0010000000002c7a
- (void)activateTimer;	// IMP=0x0010000000002ac0
- (void)runWatchdog;	// IMP=0x00100000000027d6
- (unsigned long long)secondsFromMachTime:(unsigned long long)arg1;	// IMP=0x0010000000002784
- (id)init;	// IMP=0x001000000000270e
