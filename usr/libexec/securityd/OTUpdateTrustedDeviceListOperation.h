...
- (void).cxx_destruct;	// IMP=0x002000000008a645
...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2;	// IMP=0x001000000008a34b
- (void)groupStart;	// IMP=0x0010000000089e6f
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 authenticationErrorState:(id)arg4 errorState:(id)arg5 retryFlag:(id)arg6;	// IMP=0x0010000000089d2f
