...
- (void).cxx_destruct;	// IMP=0x002000000017609a
...
- (void)groupStart;	// IMP=0x001000000017573c
- (id)initWithDependencies:(id)arg1 stateIfHSA2:(id)arg2 stateIfNotHSA2:(id)arg3 stateIfNoAccount:(id)arg4 errorState:(id)arg5;	// IMP=0x0010000000175622
