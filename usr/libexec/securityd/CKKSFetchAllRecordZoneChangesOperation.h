...
- (void).cxx_destruct;	// IMP=0x00200000000c8ca5
...
- (void)cancel;	// IMP=0x00100000000c896b
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c855b
- (void)performFetch;	// IMP=0x00100000000c79ae
- (void)groupStart;	// IMP=0x00100000000c77a4
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000c721d
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000c6fdd
- (id)init;	// IMP=0x00100000000c6fcf
