...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c653d
- (void).cxx_destruct;	// IMP=0x00200000001c64ff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c62a0
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c5ec9
- (id)description;	// IMP=0x00100000001c5e36
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001c5bd3
