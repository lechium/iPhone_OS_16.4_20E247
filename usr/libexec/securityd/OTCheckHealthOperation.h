...
@class MISSING_TYPE, NSOperation, NSString, OTDeviceInformation, OTEscrowMoveRequestContext, OTOperationDependencies;
...
@interface OTCheckHealthOperation
{
    ...
    MISSING_TYPE *_deps;	// 48 = 0x30
    NSOperation *_finishOp;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x0020000000047a24
...
- (void)handleRepairSuggestions:(_Bool)arg1 postEscrowCFU:(_Bool)arg2 resetOctagon:(_Bool)arg3 leaveTrust:(_Bool)arg4 moveRequest:(id)arg5;	// IMP=0x00100000000476a2
- (void)groupStart;	// IMP=0x0010000000046c3c
- (_Bool)checkIfPasscodeIsSetForDevice;	// IMP=0x0010000000046c34
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 skipRateLimitedCheck:(_Bool)arg5;	// IMP=0x0010000000046b32
