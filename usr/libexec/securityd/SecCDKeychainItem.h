...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x0010000000042811
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x00100000000420de
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x0010000000041c63
- (id)primaryKeys;	// IMP=0x0010000000041c4d
...
- (id)description;	// IMP=0x0010000000041a79
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000419a8
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x001000000004162c
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x00100000000414db
