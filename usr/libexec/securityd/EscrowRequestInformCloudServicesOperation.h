...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x00200000001dfa1d
- (void).cxx_destruct;	// IMP=0x00200000001df9db
...
- (void)main;	// IMP=0x00100000001df0a0
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x00100000001defda
