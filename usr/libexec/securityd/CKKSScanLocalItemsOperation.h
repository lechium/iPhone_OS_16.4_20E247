...
- (void).cxx_destruct;	// IMP=0x00200000000c0cfc
...
- (_Bool)areEquivalent:(struct SecDbItem *)arg1 ckksItem:(id)arg2 keyCache:(id)arg3;	// IMP=0x00100000000c0653
- (void)main;	// IMP=0x00100000000bf49b
- (void)retriggerMissingMirrorEntries:(id)arg1 databaseProvider:(id)arg2;	// IMP=0x00100000000bf38f
- (void)fixUUIDlessItemsInZone:(id)arg1 primaryKeys:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00100000000bf1ba
- (void)onboardItemsInView:(id)arg1 uuids:(id)arg2 itemClass:(id)arg3 databaseProvider:(id)arg4;	// IMP=0x00100000000beea9
- (_Bool)onboardItemToCKKS:(struct SecDbItem *)arg1 viewState:(id)arg2 keyCache:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000beab8
- (_Bool)executeQuery:(id)arg1 readWrite:(_Bool)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000be799
- (id)queryPredicatesForViewMapping:(id)arg1;	// IMP=0x00100000000bdbc5
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 errorState:(id)arg3 ckoperationGroup:(id)arg4;	// IMP=0x00100000000bda7c
- (id)init;	// IMP=0x00100000000bda6e
