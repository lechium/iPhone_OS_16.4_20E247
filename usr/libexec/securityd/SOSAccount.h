...
+ (id)urlForSOSAccountSettings;	// IMP=0x00200000001ec905
+ (unsigned int)ghostBustGetRampSettings;	// IMP=0x00100000001ec888
+ (id)accountFromData:(id)arg1 factory:(struct SOSDataSourceFactory *)arg2 error:(id *)arg3;	// IMP=0x00100000001fb9bc
+ (id)accountFromDER:(const char **)arg1 end:(const char *)arg2 factory:(struct SOSDataSourceFactory *)arg3 error:(id *)arg4;	// IMP=0x00100000001fa9e6
+ (void)performOnQuietAccountQueue:(CDUnknownBlockType)arg1;	// IMP=0x00100000001fef47
- (void).cxx_destruct;	// IMP=0x00200000001e8197
...
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x00100000001e7b39
- (id)performRingUpdate;	// IMP=0x00100000001e7a5d
- (id)performBackup;	// IMP=0x00100000001e7981
- (void)triggerRingUpdate;	// IMP=0x00100000001e78a7
- (void)triggerRingUpdateNow:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e75c5
- (void)triggerBackupForPeers:(id)arg1;	// IMP=0x00100000001e7471
- (void)addRingUpdateFlag;	// IMP=0x00100000001e73ef
- (void)addBackupFlag;	// IMP=0x00100000001e736d
- (void)setupStateMachine;	// IMP=0x00100000001e6e0a
- (void)_onQueueRecordRetiredPeersInCircle;	// IMP=0x00100000001e6c99
- (void)keyStatusFor:(int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e6c1a
- (int)getPublicKeyStatusForKey:(int)arg1 error:(id *)arg2;	// IMP=0x00100000001e6724
- (void)setPublicKeyStatus:(int)arg1 forKey:(int)arg2;	// IMP=0x00100000001e66ac
- (_Bool)_onQueueEnsureInBackupRings:(struct __CFString *)arg1;	// IMP=0x00100000001e63e3
- (_Bool)isInCircle:(struct __CFError **)arg1;	// IMP=0x00100000001e63a4
- (int)getCircleStatus:(struct __CFError **)arg1;	// IMP=0x00100000001e6302
- (void)flattenToSaveBlock;	// IMP=0x00100000001e6246
- (_Bool)sosEvaluateIfNeeded;	// IMP=0x00100000001e5e76
- (id)sosIsEnabledString;	// IMP=0x00100000001e5e4b
- (_Bool)sosIsEnabled;	// IMP=0x00100000001e5df0
- (void)sosIsEnabledCB:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e5da4
- (void)sosEnable;	// IMP=0x00100000001e5ced
- (void)sosDisable;	// IMP=0x00100000001e5bfa
- (void)sosEnableValidityCheck;	// IMP=0x00100000001e5ae6
- (void)removeV0Peers:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e5a58
- (void)setWatchdogParmeters:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e58e5
- (void)getWatchdogParameters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e5769
- (void);	// IMP=0x00100000001e5722
- (void)rpcTriggerBackup:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e562e
- (void)rpcTriggerSync:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e5448
- (void)importInitialSyncCredentials:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e53a4
- (void)initialSyncCredentials:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e4fbe
- (void)joinCircleWithBlob:(id)arg1 version:(int)arg2 complete:(CDUnknownBlockType)arg3;	// IMP=0x00100000001e4e50
- (void)circleJoiningBlob:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e4c7c
- (void)accountStatus:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e4b1a
- (id)accountStatusInternal;	// IMP=0x00100000001e4722
- (void)iCloudIdentityStatus:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e4694
- (void)iCloudIdentityStatus_internal:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e407f
- (void)ghostBustInfo:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e3e32
- (void)ghostBustTriggerTimed:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e3dd5
- (void)ghostBustPeriodic:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e3d38
- (void)ghostBust:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e3bdf
- (void)ghostBustSchedule;	// IMP=0x00100000001e3b9b
- (void)ghostBustFollowup;	// IMP=0x00100000001e3aa9
- (_Bool)ghostBustCheckDate;	// IMP=0x00100000001e3a54
- (id)ghostBustGetDate;	// IMP=0x00100000001e3987
- (void)circleHash:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e38a4
- (void)myPeerInfo:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e3752
- (void)stashAccountCredential:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e35f8
- (void)validatedStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e3503
- (_Bool)syncWaitAndFlush:(struct __CFError **)arg1;	// IMP=0x00100000001e3253
- (void)assertStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e31a2
- (void)stashedCredentialPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e30f1
- (void)rateLimitingPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e307e
- (void)setBypass:(_Bool)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001e2fc7
- (void)kvsPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e2f23
- (void)userPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x00100000001e2e72
- (_Bool)getAccountInBypassMode;	// IMP=0x00100000001e2e60
- (void)setAccountInBypassMode:(_Bool)arg1;	// IMP=0x00100000001e2e4e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001e2b9e
- (void)startStateMachine;	// IMP=0x00100000001e2b61
- (id)initWithGestalt:(struct __CFDictionary *)arg1 factory:(struct SOSDataSourceFactory *)arg2;	// IMP=0x00100000001e288a
- (void)ensureOctagonPeerKeys;	// IMP=0x00100000001e27d9
- (_Bool)ensureFactoryCircles;	// IMP=0x00100000001e247e
...
- (void)dealloc;	// IMP=0x00100000001e213d
- (id)encodedData:(id *)arg1;	// IMP=0x00100000001fa8b2
- (void)performTransaction:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00100000001fee2e
- (void)performTransaction:(CDUnknownBlockType)arg1;	// IMP=0x00100000001fee17
- (void)performTransaction_Locked:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00100000001fed82
- (void)performTransaction_Locked:(CDUnknownBlockType)arg1;	// IMP=0x00100000001fed6b
