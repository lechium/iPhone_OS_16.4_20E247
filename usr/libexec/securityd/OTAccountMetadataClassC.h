...
+ (Class)tlkSharesForVouchedIdentityType;	// IMP=0x002000000002ab8e
+ (id)loadFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a74b8
+ (_Bool)deleteFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a7255
- (void).cxx_destruct;	// IMP=0x002000000002ab08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000002a68c
- (unsigned long long)hash;	// IMP=0x001000000002a476
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002a0f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000029cd6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000029a45
- (void)writeTo:(id)arg1;	// IMP=0x0010000000029720
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000028f73
- (id)dictionaryRepresentation;	// IMP=0x0010000000028a95
- (id)description;	// IMP=0x00100000000289e6
...
- (id)tlkSharesForVouchedIdentityAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000288cf
- (unsigned long long)tlkSharesForVouchedIdentitysCount;	// IMP=0x00100000000288b2
- (void)addTlkSharesForVouchedIdentity:(id)arg1;	// IMP=0x0010000000028848
- (void)clearTlkSharesForVouchedIdentitys;	// IMP=0x001000000002882b
...
- (int)StringAsCdpState:(id)arg1;	// IMP=0x001000000002875a
- (id)cdpStateAsString:(int)arg1;	// IMP=0x0010000000028711
@property(nonatomic) _Bool hasCdpState;
@property(nonatomic) int cdpState; // @synthesize cdpState=_cdpState;
- (int)StringAsAttemptedJoin:(id)arg1;	// IMP=0x0010000000028616
- (id)attemptedJoinAsString:(int)arg1;	// IMP=0x00100000000285cd
...
- (int)StringAsTrustState:(id)arg1;	// IMP=0x0010000000028488
- (id)trustStateAsString:(int)arg1;	// IMP=0x001000000002843f
...
- (int)StringAsIcloudAccountState:(id)arg1;	// IMP=0x00100000000282c9
- (id)icloudAccountStateAsString:(int)arg1;	// IMP=0x0010000000028280
...
- (id)parsedSecureElementIdentity;	// IMP=0x00100000000a6b30
- (void)setOctagonSecureElementIdentity:(id)arg1;	// IMP=0x00100000000a6a4b
- (id)getTLKSharesPairedWithVoucher;	// IMP=0x00100000000a6836
- (void)setTLKSharesPairedWithVoucher:(id)arg1;	// IMP=0x00100000000a65f1
- (id)getTPSyncingPolicy;	// IMP=0x00100000000a6551
- (void)setTPSyncingPolicy:(id)arg1;	// IMP=0x00100000000a6491
- (_Bool)saveToKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a62f3
