...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x002000000015b150
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x001000000015ae36
- (void).cxx_destruct;	// IMP=0x00200000001d675f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001d6510
- (unsigned long long)hash;	// IMP=0x00100000001d63b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d6156
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d5fb8
- (void)copyTo:(id)arg1;	// IMP=0x00100000001d5e61
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d5cfc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d57b5
- (id)dictionaryRepresentation;	// IMP=0x00100000001d54ca
- (id)description;	// IMP=0x00100000001d541b
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x001000000015ab6a
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x001000000015a547
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x001000000015ad7d
