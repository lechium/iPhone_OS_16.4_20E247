...
- (void).cxx_destruct;	// IMP=0x002000000017ac79
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000017ab2a
- (unsigned long long)hash;	// IMP=0x001000000017aa75
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017a918
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000017a814
- (void)copyTo:(id)arg1;	// IMP=0x001000000017a754
- (void)writeTo:(id)arg1;	// IMP=0x001000000017a68c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000017a3ae
- (id)dictionaryRepresentation;	// IMP=0x001000000017a242
- (id)description;	// IMP=0x001000000017a193
