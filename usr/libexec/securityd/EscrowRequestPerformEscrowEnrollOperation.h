...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00200000000bd958
- (void).cxx_destruct;	// IMP=0x00200000000bd428
...
- (void)groupStart;	// IMP=0x00100000000bcae1
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00100000000bc94e
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00100000000bc876
