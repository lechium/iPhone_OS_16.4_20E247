...
@class CKKSCondition, CKKSResultOperation, MISSING_TYPE, NSDate, NSOperationQueue, NSString;
...
- (void).cxx_destruct;	// IMP=0x00200000000b0579
...
- (void)cancel;	// IMP=0x00100000000b033f
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000afd85
- (void)trigger;	// IMP=0x00100000000afcc0
- (void)_onqueueTimerTick;	// IMP=0x00100000000af97b
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000af8ab
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000af82f
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000af650
- (MISSING_TYPE *)makeOperationDependency;	// IMP=0x00100000000af583
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000af4fc
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000af320
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000af2c5
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000af2a1
