...
- (void).cxx_destruct;	// IMP=0x0020000000173281
...
- (void)cancel;	// IMP=0x001000000017318f
- (void)groupStart;	// IMP=0x0010000000172c24
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x00100000001728f3
- (id)init;	// IMP=0x00100000001728e5
