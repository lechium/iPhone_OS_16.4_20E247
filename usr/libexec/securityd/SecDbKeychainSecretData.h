...
- (void).cxx_destruct;	// IMP=0x002000000010ffae
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000010fcc1
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x001000000010fad4
