...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003bcc5
- (void).cxx_destruct;	// IMP=0x002000000003bc92
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003bbd3
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003b996
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x001000000003b8b5
