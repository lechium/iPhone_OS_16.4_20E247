...
+ (id)trust;	// IMP=0x004000000021ecc2
- (void).cxx_destruct;	// IMP=0x002000000021ec8f
...
- (void)dealloc;	// IMP=0x001000000021ea64
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x001000000021e985
- (id)init;	// IMP=0x001000000021e89a
