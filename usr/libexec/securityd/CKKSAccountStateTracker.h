...
@interface CKKSAccountStateTracker : NSObject
{
    ...
    MISSING_TYPE *_ckdeviceIDError;	// 72 = 0x48
...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x00200000000393b7
+ (id)getCircleStatus;	// IMP=0x0010000000039293
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x00100000000391f4
- (void).cxx_destruct;	// IMP=0x0020000000036f73
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0010000000036bfc
- (void)triggerOctagonStatusFetch;	// IMP=0x0010000000036a00
- (id)checkForAllDeliveries;	// IMP=0x00100000000368e0
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x00100000000368a2
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x0010000000036889
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x0010000000036838
- (void)recheckCKAccountStatus;	// IMP=0x001000000003678c
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0010000000036644
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00100000000364b7
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0010000000036093
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0010000000035f04
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0010000000035d1a
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0010000000035c1a
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0010000000035a95
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x00100000000357d3
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x00100000000356e5
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x0010000000035549
- (void)dealloc;	// IMP=0x00100000000354ce
- (void)performInitialDispatches;	// IMP=0x0010000000035444
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x0010000000034f98
