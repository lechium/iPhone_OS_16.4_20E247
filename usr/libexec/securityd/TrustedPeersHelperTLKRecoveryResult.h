...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c695a
- (void).cxx_destruct;	// IMP=0x00200000001c6932
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c6806
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c6668
- (id)description;	// IMP=0x00100000001c65ea
- (id)initWithSuccessfulKeyUUIDs:(id)arg1 totalTLKSharesRecovered:(long long)arg2 tlkRecoveryErrors:(id)arg3;	// IMP=0x00100000001c6545
