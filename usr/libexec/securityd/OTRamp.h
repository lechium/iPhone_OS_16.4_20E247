...
- (void).cxx_destruct;	// IMP=0x0020000000136460
...
- (void)setLastFetch:(id)arg1;	// IMP=0x0010000000136427
- (id)lastFetch;	// IMP=0x0010000000136413
...
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x00100000001355f6
- (void)fetchRampRecord:(unsigned long long)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000135327
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x001000000013515d
