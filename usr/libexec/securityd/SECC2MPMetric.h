...
- (void).cxx_destruct;	// IMP=0x00200000000acd7e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000acacf
- (unsigned long long)hash;	// IMP=0x00100000000ac994
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ac781
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ac5e7
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ac4a6
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ac364
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000abdc0
- (id)dictionaryRepresentation;	// IMP=0x00100000000aba65
- (id)description;	// IMP=0x00100000000ab9b6
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000ab7d8
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000ab76c
