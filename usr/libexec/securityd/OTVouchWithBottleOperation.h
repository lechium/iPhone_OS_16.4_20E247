...
- (void).cxx_destruct;	// IMP=0x0020000000082c8d
...
- (id);	// IMP=0x0010000000082b99
@property(retain, nonatomic) NSString *bottleID; // @synthesize bottleID=_bottleID;
@property(retain) NSString<OctagonStateString> *nextState; // @synthesize nextState=_nextState;
@property(readonly) NSString<OctagonStateString> *intendedState; // @synthesize intendedState=_intendedState;
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x0010000000082923
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x00100000000827b6
- (void)groupStart;	// IMP=0x0010000000082300
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x00100000000821b2
