...
+ (Class)internalTestConfigType;	// IMP=0x00200000001cbe94
- (void).cxx_destruct;	// IMP=0x00200000001cba2a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001cb656
- (unsigned long long)hash;	// IMP=0x00100000001cb515
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001cb29f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001caf83
- (void)copyTo:(id)arg1;	// IMP=0x00100000001cada1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001cab63
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001cab56
- (id)dictionaryRepresentation;	// IMP=0x00100000001ca78f
- (id)description;	// IMP=0x00100000001ca6e0
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001ca6c3
- (unsigned long long)internalTestConfigsCount;	// IMP=0x00100000001ca6a6
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x00100000001ca63c
- (void)clearInternalTestConfigs;	// IMP=0x00100000001ca61f
