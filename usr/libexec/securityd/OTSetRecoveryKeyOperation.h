...
- (void).cxx_destruct;	// IMP=0x00200000000b33fa
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000b3160
- (void)groupStart;	// IMP=0x00100000000b2d9f
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000b2cfd
