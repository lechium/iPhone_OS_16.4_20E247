...
- (void).cxx_destruct;	// IMP=0x002000000016206e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000161f64
- (unsigned long long)hash;	// IMP=0x0010000000161ec9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000161da3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000161cc8
- (void)copyTo:(id)arg1;	// IMP=0x0010000000161c28
- (void)writeTo:(id)arg1;	// IMP=0x0010000000161b7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000161b6f
- (id)dictionaryRepresentation;	// IMP=0x0010000000161a29
- (id)description;	// IMP=0x001000000016197a
