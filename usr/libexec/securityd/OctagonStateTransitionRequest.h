...
- (void).cxx_destruct;	// IMP=0x00200000001aec09
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000001aeab3
- (id)_onqueueStart;	// IMP=0x00100000001aea2e
- (id)description;	// IMP=0x00100000001ae964
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x00100000001ae868
