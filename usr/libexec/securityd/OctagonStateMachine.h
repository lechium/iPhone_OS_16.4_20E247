...
- (void).cxx_destruct;	// IMP=0x002000000011dcf5
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 transitionOp:(id)arg4 reply:(CDUnknownBlockType)arg5;	// IMP=0x001000000011d56b
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000011d423
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x001000000011d411
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000011d06d
- (void)_onqueueRegisterMultiStateArrivalWatcher:(id)arg1;	// IMP=0x001000000011cf31
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x001000000011ce7f
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x001000000011cdcd
- (void)handleExternalRequest:(id)arg1;	// IMP=0x001000000011cd1b
- (void)haltOperation;	// IMP=0x001000000011cc6f
- (void)startOperation;	// IMP=0x001000000011cbfe
- (_Bool)isPaused;	// IMP=0x001000000011cb34
- (void)testReleaseStateMachinePause:(id)arg1;	// IMP=0x001000000011ca82
- (void)testPauseStateMachineAfterEntering:(id)arg1;	// IMP=0x001000000011c9d0
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x001000000011c038
- (void)_onqueueRecheckConditions;	// IMP=0x001000000011b6ff
- (id)possiblePendingFlags;	// IMP=0x001000000011b6af
- (id)dumpPendingFlags;	// IMP=0x001000000011b58a
- (void)disablePendingFlags;	// IMP=0x001000000011b519
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x001000000011b2f2
- (void)_onqueueHandlePendingFlagLater:(id)arg1;	// IMP=0x001000000011b218
- (void)handlePendingFlag:(id)arg1;	// IMP=0x001000000011b166
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x001000000011b0c1
- (void)handleFlag:(id)arg1;	// IMP=0x001000000011b00f
- (void)_onqueuePokeStateMachine;	// IMP=0x001000000011afba
- (void)pokeStateMachine;	// IMP=0x001000000011af49
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x001000000011ade2
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x001000000011a8ea
- (id)_onqueueNextStateMachineTransition;	// IMP=0x001000000011a489
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x001000000011a3d2
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x001000000011a099
- (id)pendingFlagsString;	// IMP=0x001000000011a018
@property(readonly) NSDictionary *stateConditions;
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8;	// IMP=0x00100000001199a6
