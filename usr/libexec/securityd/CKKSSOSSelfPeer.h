...
- (void).cxx_destruct;	// IMP=0x00200000000b7b42
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x00100000000b7a4e
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x00100000000b794f
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x00100000000b76ff
