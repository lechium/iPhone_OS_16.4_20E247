...
- (void).cxx_destruct;	// IMP=0x00000000000d17db
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000d14c4
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000d1357
- (void)groupStart;	// IMP=0x00100000000d0f25
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000d0e20
