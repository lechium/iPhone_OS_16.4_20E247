...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c5bcb
- (void).cxx_destruct;	// IMP=0x00200000001c5b82
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c5987
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c5780
- (id)description;	// IMP=0x00100000001c5629
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x00100000001c5527
