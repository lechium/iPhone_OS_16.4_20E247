...
- (void).cxx_destruct;	// IMP=0x0020000000004372
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004227
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000000407a
- (void)unlockWithError:(id)arg1;	// IMP=0x0010000000003dfb
- (id)initWithURL:(id)arg1;	// IMP=0x0010000000003d2c
