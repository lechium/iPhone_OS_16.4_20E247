...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006d188
- (void).cxx_destruct;	// IMP=0x002000000006d590
...
- (id)description;	// IMP=0x001000000006d3c1
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006d297
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006d190
- (id)init;	// IMP=0x001000000006d159
