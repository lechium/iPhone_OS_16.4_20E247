...
- (void).cxx_destruct;	// IMP=0x0020000000058fe0
...
- (id)description;	// IMP=0x0010000000058b35
- (id)encodeAsData;	// IMP=0x001000000005828b
- (id)initWithData:(id)arg1;	// IMP=0x001000000005786c
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000005775e
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x00100000000576d8
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000057502
