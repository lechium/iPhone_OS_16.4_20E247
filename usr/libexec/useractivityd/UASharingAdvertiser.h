...
- (void).cxx_destruct;	// IMP=0x0020000000091fb7
...
- (id)statusString;	// IMP=0x0010000000090ab5
- (_Bool)pasteboardBitValue;	// IMP=0x00100000000908e2
- (_Bool)pasteboardAvailible;	// IMP=0x00100000000906fe
- (void)removeIOPowerManagerUserIdleNotifications;	// IMP=0x00100000000906ab
- (void)scheduleIOPowerManagerUserIdleNotifications;	// IMP=0x0010000000090655
@property _Bool userIsCurrent; // @synthesize userIsCurrent=_userIsCurrent;
- (_Bool)resume;	// IMP=0x00100000000903f1
- (_Bool)suspend;	// IMP=0x0010000000090316
- (_Bool)active;	// IMP=0x001000000009028a
- (_Bool)okToSuspendAdvertising;	// IMP=0x00100000000901b9
- (_Bool)scheduleAdvertisementUpdate;	// IMP=0x00100000000901a4
- (_Bool)scheduleAdvertisementUpdate:(double)arg1;	// IMP=0x001000000009013a
- (void)activityAdvertiser:(id)arg1 pairedDevicesChangedNotification:(id)arg2;	// IMP=0x001000000008fd76
- (void)activityAdvertiser:(id)arg1 didSendPayloadForActivityIdentifier:(id)arg2 toDevice:(id)arg3 error:(id)arg4;	// IMP=0x001000000008fa22
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 handoffCommand:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000008c945
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000008ba2e
- (id)dataForMoreAppSuggestions;	// IMP=0x001000000008af87
- (void)setShouldAdvertiseAutoPullActivityList:(_Bool)arg1;	// IMP=0x001000000008aeba
@property(copy) NSSet *pairedDevices; // @synthesize pairedDevices=_pairedDevices;
- (void)_updatePairedDeviceCapabilities;	// IMP=0x001000000008a2b8
- (void)_refreshPairedSFPeerDevices;	// IMP=0x0010000000089ef2
...
- (id)sfActivityAdvertiser;	// IMP=0x0010000000089bb7
- (_Bool)removeSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000089af3
- (_Bool)addSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000089a26
@property(readonly, copy) NSSet *sfActivityAdvertisers;
- (_Bool)peerDeviceCanAcceptNewerPayload:(id)arg1;	// IMP=0x0010000000089508
- (void)_periodicIdleUpdate;	// IMP=0x0010000000089016
- (void)removeAdvertisement;	// IMP=0x0010000000088b15
- (void)moveAdvertisementToNonActive;	// IMP=0x0010000000088a56
- (_Bool)_updateAdvertisement;	// IMP=0x0010000000087a7e
- (_Bool)advertiseItem:(id)arg1 force:(_Bool)arg2;	// IMP=0x001000000008555a
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000084bcc
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 sfAdvertiser:(id)arg3;	// IMP=0x0010000000084967
- (_Bool)_advertisePayload:(id)arg1;	// IMP=0x0010000000084952
- (void)advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000084866
- (void)updateAdvertisingPowerAssertion:(double)arg1;	// IMP=0x00100000000845d6
- (id)mostRecentAdvertisedBytesTime;	// IMP=0x00100000000845c4
- (id)currentAdvertisedBytes;	// IMP=0x00100000000844bf
- (void)setAdvertisableItems:(id)arg1;	// IMP=0x0010000000083e58
- (id)advertisingItems;	// IMP=0x0010000000083d9f
- (_Bool)advertising;	// IMP=0x0010000000083d6c
- (id)advertisableItems;	// IMP=0x0010000000083d00
- (id)initWithManager:(id)arg1 advertiser:(id)arg2;	// IMP=0x001000000008377f
