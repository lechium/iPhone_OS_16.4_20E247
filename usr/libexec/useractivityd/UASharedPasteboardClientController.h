...
- (void).cxx_destruct;	// IMP=0x002000000003abde
...
- (MISSING_TYPE *)localPBStatus;	// IMP=0x001000000003a159
- (id)statusString;	// IMP=0x001000000003a14c
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x0010000000039cb5
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000039134
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000003844a
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000037874
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000035a9a
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x001000000003593f
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x001000000003592d
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032ee3
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030db1
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030aa6
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x00100000000309b2
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x001000000003073f
- (void)clearLocalPasteboardInformation;	// IMP=0x0010000000030672
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002ffb5
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fee7
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fe75
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fd56
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002f9ad
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002f690
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002f539
- (id)items;	// IMP=0x001000000002f527
- (void)startConnection:(int)arg1;	// IMP=0x001000000002f492
...
- (id)uuid;	// IMP=0x001000000002f215
- (void)dealloc;	// IMP=0x001000000002f14d
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002ea7d
