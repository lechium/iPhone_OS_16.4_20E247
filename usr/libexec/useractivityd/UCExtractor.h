...
- (void).cxx_destruct;	// IMP=0x002000000003f8e1
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003f86d
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x001000000003f737
