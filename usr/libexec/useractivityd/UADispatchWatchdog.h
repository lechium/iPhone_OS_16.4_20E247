...
- (void).cxx_destruct;	// IMP=0x002000000001c011
...
- (void)_triggerWatchdog;	// IMP=0x001000000001bddb
- (void)cancel;	// IMP=0x001000000001bce7
- (void)poke;	// IMP=0x001000000001bc5a
- (void)start;	// IMP=0x001000000001ba44
- (void)dealloc;	// IMP=0x001000000001b9e1
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b91d
