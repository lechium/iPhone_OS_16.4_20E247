...
- (void).cxx_destruct;	// IMP=0x002000000006af95
...
- (void)shutdownStream;	// IMP=0x001000000006acd7
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x001000000006ac14
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000006a482
- (id)headerForData:(id)arg1;	// IMP=0x001000000006a3ba
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000006a030
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x0010000000069e9a
