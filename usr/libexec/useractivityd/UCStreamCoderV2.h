...
- (void).cxx_destruct;	// IMP=0x002000000001b6c2
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001b223
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001b1b3
- (id)packMessage:(id)arg1;	// IMP=0x001000000001b18e
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001b0ac
- (void)packager:(id)arg1 gotData:(id)arg2 forPacket:(long long)arg3;	// IMP=0x001000000001ac11
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001a9b8
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000194ee
- (void)calculateTimeRemaining;	// IMP=0x00100000000192cc
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x0010000000018c2f
- (void)removeReceivedItems:(id)arg1;	// IMP=0x0010000000018975
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x00100000000186c5
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000018422
- (void)cancelReceive;	// IMP=0x0010000000018367
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x0010000000018182
- (void)sendHeartbeat;	// IMP=0x001000000001807d
- (void)sendTotalSendSize;	// IMP=0x0010000000017f63
- (void)sendPasteboardDataResponse;	// IMP=0x0010000000017dbb
- (void)sendFileArchiveRequest;	// IMP=0x00100000000178b6
- (void)sendPasteboardDataRequest;	// IMP=0x00100000000177cb
- (void)sendPasteboardInfoResponse;	// IMP=0x0010000000017624
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000017596
- (void)handleHeartbeat:(id)arg1;	// IMP=0x00100000000174eb
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x001000000001738b
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x0010000000016be3
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x001000000001677f
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x0010000000016461
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x0010000000015d38
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x0010000000015cb4
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x0010000000015c30
- (void)recvStop:(id)arg1;	// IMP=0x0010000000015a9a
- (void)sendStopWithError:(long long)arg1;	// IMP=0x0010000000015912
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x001000000001543e
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x00100000000152ba
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000151ab
- (void)removeObject:(id)arg1;	// IMP=0x00100000000150f9
- (void)storeObject:(id)arg1;	// IMP=0x0010000000015047
- (void)dealloc;	// IMP=0x0010000000014e34
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x00100000000149c3
