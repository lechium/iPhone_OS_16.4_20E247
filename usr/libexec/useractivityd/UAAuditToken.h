...
- (id)debugDescription;	// IMP=0x00100000000836b1
- (id)description;	// IMP=0x00100000000835bd
- (const char *)objCType;	// IMP=0x00100000000835b0
- (void)getValue:(void *)arg1;	// IMP=0x0010000000083593
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000083238
