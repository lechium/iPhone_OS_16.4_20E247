...
- (void).cxx_destruct;	// IMP=0x002000000003d4dc
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003d1d7
- (long long)tryWriteMessage;	// IMP=0x001000000003cb32
- (long long)tryWriteRawData;	// IMP=0x001000000003c81c
- (long long)handleSpaceAvailable;	// IMP=0x001000000003c7c3
- (void)handleMessageRead;	// IMP=0x001000000003c688
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003c614
- (void)processHeader;	// IMP=0x001000000003c504
- (void)handleBytesAvailable;	// IMP=0x001000000003c12d
- (void)handleOpenCompleted;	// IMP=0x001000000003c030
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003bde7
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003bac5
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003b8c6
- (void);	// IMP=0x001000000003b696
- (void)tryStop;	// IMP=0x001000000003b54c
- (void)stop;	// IMP=0x001000000003b434
- (void)start;	// IMP=0x001000000003b00e
- (long long)queueCount;	// IMP=0x001000000003af8f
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003ad98
