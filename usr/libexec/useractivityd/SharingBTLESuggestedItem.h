...
+ (id)statusString;	// IMP=0x0040000000069ba0
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x00100000000643a7
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x0010000000064278
- (void).cxx_destruct;	// IMP=0x0020000000069d96
...
- (id)description;	// IMP=0x0010000000069a64
- (void)setWhen:(id)arg1;	// IMP=0x001000000006995e
- (id)when;	// IMP=0x0010000000069887
- (id)statusString;	// IMP=0x00100000000692fa
- (void)clearPayload;	// IMP=0x00100000000690d6
- (void)resignCurrent;	// IMP=0x0010000000069066
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000066f90
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000066a04
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x0010000000065dc6
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x0010000000065d22
