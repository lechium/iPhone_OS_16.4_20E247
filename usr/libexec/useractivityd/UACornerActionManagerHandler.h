...
- (void).cxx_destruct;	// IMP=0x00200000000146e5
...
- (id)statusString;	// IMP=0x0010000000014594
- (_Bool)terminate;	// IMP=0x0010000000014431
- (_Bool)resume;	// IMP=0x0010000000014312
- (_Bool)suspend;	// IMP=0x00100000000141ed
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000013f64
