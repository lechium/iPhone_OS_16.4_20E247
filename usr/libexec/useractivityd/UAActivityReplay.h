...
- (void).cxx_destruct;	// IMP=0x00200000000459b8
...
- (_Bool)terminate;	// IMP=0x0010000000045368
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000451fe
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000451f8
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000044f2f
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000044f27
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000042a67
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x001000000004211e
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x0010000000041e2d
- (id)sharingAdvertiser;	// IMP=0x0010000000041c4c
- (id)sharingReceiver;	// IMP=0x0010000000041a6b
- (void)dealloc;	// IMP=0x00100000000417de
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000041240
