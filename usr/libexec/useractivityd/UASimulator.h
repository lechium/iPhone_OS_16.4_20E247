...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x0020000000092828
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x0010000000092820
- (void).cxx_destruct;	// IMP=0x0020000000094040
...
- (id)statusString;	// IMP=0x0010000000093e9c
- (_Bool)terminate;	// IMP=0x0010000000093bcb
- (_Bool)suspend;	// IMP=0x0010000000093adc
- (_Bool)resume;	// IMP=0x00100000000939ed
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x0010000000093862
- (_Bool)active;	// IMP=0x001000000009382f
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x0010000000092bcb
- (void)dealloc;	// IMP=0x0010000000092b00
- (id)initWithController:(id)arg1;	// IMP=0x0010000000092100
