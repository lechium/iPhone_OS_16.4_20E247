...
- (void).cxx_destruct;	// IMP=0x002000000002e955
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e43e
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002d560
- (void)dealloc;	// IMP=0x001000000002d41b
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002d2ae
- (id)stateAsString;	// IMP=0x001000000002d27c
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002d0bf
