...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x004000000000477c
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000043a5
- (void).cxx_destruct;	// IMP=0x00200000000050ba
...
- (void)invalidate;	// IMP=0x0010000000004cde
- (void)dealloc;	// IMP=0x0010000000004690
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000004447
