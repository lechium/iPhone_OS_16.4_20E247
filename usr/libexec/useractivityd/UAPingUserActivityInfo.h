...
- (void).cxx_destruct;	// IMP=0x0020000000005394
@property(copy) CDUnknownBlockType wasContinuedBlock; // @synthesize wasContinuedBlock=_wasContinuedBlock;
- (id)statusString;	// IMP=0x001000000000529c
- (id)initFromPing:(id)arg1;	// IMP=0x0010000000005209
- (id)initWithPayloadSize:(unsigned long long)arg1;	// IMP=0x00100000000050f8
