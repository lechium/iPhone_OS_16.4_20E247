...
+ (id)options;	// IMP=0x0020000000044638
- (void).cxx_destruct;	// IMP=0x0020000000045507
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004532e
- (unsigned long long)hash;	// IMP=0x001000000004523c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004506e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000044f19
- (void)copyTo:(id)arg1;	// IMP=0x0010000000044e19
- (void)writeTo:(id)arg1;	// IMP=0x0010000000044d15
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000044d08
- (id)dictionaryRepresentation;	// IMP=0x001000000004482e
- (id)description;	// IMP=0x001000000004477f
