...
- (void).cxx_destruct;	// IMP=0x0020000000034439
...
- (id)protoBuffer;	// IMP=0x0010000000034194
- (Class)responseClass;	// IMP=0x0010000000034183
- (id)initWithBundleID:(id)arg1 identifier:(id)arg2 segmentIdentifiers:(id)arg3 replaceExisting:(_Bool)arg4 privateSegment:(_Bool)arg5;	// IMP=0x0010000000034084
