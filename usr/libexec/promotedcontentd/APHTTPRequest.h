...
- (void).cxx_destruct;	// IMP=0x00100000000dcecb
...
- (void)setRequestHeader:(id)arg1 withValue:(id)arg2;	// IMP=0x00100000000dcd4b
- (id)initWithURL:(id)arg1 HTTPMethod:(long long)arg2 HTTPHeaders:(id)arg3 HTTPBody:(id)arg4 serviceName:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000000dcbcb
- (id)initWithURL:(id)arg1 HTTPMethod:(long long)arg2 HTTPHeaders:(id)arg3 HTTPBody:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000dcbaf
