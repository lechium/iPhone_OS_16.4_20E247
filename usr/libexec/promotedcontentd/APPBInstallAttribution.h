...
- (void).cxx_destruct;	// IMP=0x002000000006896c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000068772
- (unsigned long long)hash;	// IMP=0x001000000006865b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000068487
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000068321
- (void)copyTo:(id)arg1;	// IMP=0x00100000000681ff
- (void)writeTo:(id)arg1;	// IMP=0x00100000000680d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000680cc
- (id)dictionaryRepresentation;	// IMP=0x0010000000067a67
- (id)description;	// IMP=0x00100000000679b8
