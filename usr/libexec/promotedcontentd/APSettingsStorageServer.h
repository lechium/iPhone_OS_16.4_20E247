...
+ (id)baseServerURL;	// IMP=0x002000000010797a
- (void).cxx_destruct;	// IMP=0x0020000000108c9b
...
- (id)headers;	// IMP=0x0010000000108c36
@property(readonly, nonatomic) NSURL *url; // @synthesize url=_url;
@property _Bool didFetchFromServer; // @synthesize didFetchFromServer=_didFetchFromServer;
- (void)synchronize;	// IMP=0x0010000000108c12
- (void)setValue:(id)arg1 forKey:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000108bc6
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000108bb1
- (id)valueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000108a19
- (id)valueForKey:(id)arg1;	// IMP=0x0010000000108a05
- (id)initWithURL:(id)arg1 headers:(id)arg2 defaultValues:(id)arg3;	// IMP=0x00100000001088f9
- (void)retrieveServerData;	// IMP=0x00100000001086b9
- (void)fetchNewServerData;	// IMP=0x0010000000107bf5
- (id)initWithDefaultValues:(id)arg1;	// IMP=0x0010000000107b81
