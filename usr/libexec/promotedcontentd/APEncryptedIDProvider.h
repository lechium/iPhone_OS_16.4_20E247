...
+ (id)provider;	// IMP=0x0040000000053c05
- (void).cxx_destruct;	// IMP=0x0020000000053fd9
...
- (id)encryptedIDsForIDAccountPrivate:(id)arg1;	// IMP=0x0010000000053d90
- (void)_encryptIDs;	// IMP=0x0010000000053d13
- (void)userAccountChanged;	// IMP=0x0010000000053cb8
@property(readonly, nonatomic) id <APEncryptedIDProtocol> encryptedIDs;
- (id)init;	// IMP=0x0010000000053c5a
