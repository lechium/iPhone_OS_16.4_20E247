...
- (void).cxx_destruct;	// IMP=0x002000000001c901
...
- (id)restoreCapDataArrayFromPlist:(id)arg1;	// IMP=0x001000000001c69f
- (void)_clearCapDownloadDataProperties;	// IMP=0x001000000001c66c
- (_Bool)capDataFromKeyChain:(id)arg1 adamID:(id)arg2;	// IMP=0x001000000001b9e1
- (_Bool)_loadAllDataFromKeychainForKey:(id)arg1 clickCountData:(id *)arg2 downloadData:(id *)arg3;	// IMP=0x001000000001b6af
- (void)loadCapData:(id)arg1;	// IMP=0x001000000001b438
