...
+ (Class)infoType;	// IMP=0x00200000000be195
+ (id)options;	// IMP=0x00100000000bde58
- (void).cxx_destruct;	// IMP=0x00200000000bf72e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000bf406
- (unsigned long long)hash;	// IMP=0x00100000000bf229
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000bf038
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bed75
- (void)copyTo:(id)arg1;	// IMP=0x00100000000bebd2
- (void)writeTo:(id)arg1;	// IMP=0x00100000000be9c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000be9bc
- (id)dictionaryRepresentation;	// IMP=0x00100000000be255
- (id)description;	// IMP=0x00100000000be1a6
- (id)infoAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000be178
- (unsigned long long)infosCount;	// IMP=0x00100000000be15b
- (void)addInfo:(id)arg1;	// IMP=0x00100000000be0f1
- (void)clearInfos;	// IMP=0x00100000000be0d4
@property(nonatomic) _Bool hasEventTime;
- (int)StringAsEvent:(id)arg1;	// IMP=0x00100000000bdfc2
- (id)eventAsString:(int)arg1;	// IMP=0x00100000000bdf79
