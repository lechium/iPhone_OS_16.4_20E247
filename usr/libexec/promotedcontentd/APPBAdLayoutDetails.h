...
+ (Class)elementsType;	// IMP=0x002000000003f481
- (void).cxx_destruct;	// IMP=0x00200000000409c3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004066b
- (unsigned long long)hash;	// IMP=0x0010000000040560
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000040360
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004007a
- (void)copyTo:(id)arg1;	// IMP=0x001000000003fed5
- (void)writeTo:(id)arg1;	// IMP=0x001000000003fcc1
- (_Bool);	// IMP=0x001000000003fcb4
- (id)dictionaryRepresentation;	// IMP=0x001000000003f556
- (id)description;	// IMP=0x001000000003f4a7
@property(readonly, nonatomic) _Bool hasStyle;
- (id)elementsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000003f464
- (unsigned long long)elementsCount;	// IMP=0x001000000003f447
- (void)addElements:(id)arg1;	// IMP=0x001000000003f3dd
- (void)clearElements;	// IMP=0x001000000003f3c0
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000003f219
- (id)typeAsString:(int)arg1;	// IMP=0x001000000003f1cb
