...
+ (id)options;	// IMP=0x002000000005dc6c
- (void).cxx_destruct;	// IMP=0x0020000000060035
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000005fcca
- (unsigned long long)hash;	// IMP=0x001000000005f661
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005f2ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000005f07f
- (void)copyTo:(id)arg1;	// IMP=0x001000000005ee81
- (void)writeTo:(id)arg1;	// IMP=0x001000000005ec81
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000005ec74
- (id)dictionaryRepresentation;	// IMP=0x001000000005e24a
- (id)description;	// IMP=0x001000000005e19b
- (int)StringAsDownloadType:(id)arg1;	// IMP=0x001000000005e109
- (id)downloadTypeAsString:(int)arg1;	// IMP=0x001000000005e0c0
...
- (int)StringAsRunState:(id)arg1;	// IMP=0x001000000005def1
- (id)runStateAsString:(int)arg1;	// IMP=0x001000000005dea8
