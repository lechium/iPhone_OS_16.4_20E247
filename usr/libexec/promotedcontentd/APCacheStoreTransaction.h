...
- (void).cxx_destruct;	// IMP=0x00200000000e5b8d
...
- (_Bool)_commit;	// IMP=0x00100000000e5906
- (_Bool)commit;	// IMP=0x00100000000e57fa
- (void)addOperation:(id)arg1;	// IMP=0x00100000000e5788
- (unsigned long long)count;	// IMP=0x00100000000e5744
- (id)initWithCacheStore:(id)arg1;	// IMP=0x00100000000e56cc
