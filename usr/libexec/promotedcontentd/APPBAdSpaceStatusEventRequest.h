...
+ (id)options;	// IMP=0x0020000000079118
- (void).cxx_destruct;	// IMP=0x002000000007b9a2
...
- (id);	// IMP=0x001000000007b7f1
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007b5db
- (unsigned long long)hash;	// IMP=0x001000000007b211
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007ae74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007abf0
- (void)copyTo:(id)arg1;	// IMP=0x001000000007a9da
- (void)writeTo:(id)arg1;	// IMP=0x001000000007a7c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007a7b8
- (id)dictionaryRepresentation;	// IMP=0x0010000000079b68
- (id)description;	// IMP=0x0010000000079ab9
...
- (int)StringAsStatusCode:(id)arg1;	// IMP=0x00100000000795a0
- (id)statusCodeAsString:(int)arg1;	// IMP=0x0010000000079363
