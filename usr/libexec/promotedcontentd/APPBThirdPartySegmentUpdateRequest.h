...
+ (Class)segmentIdentifiersType;	// IMP=0x002000000009e67a
+ (id)options;	// IMP=0x001000000009e3a0
- (void).cxx_destruct;	// IMP=0x002000000009fbe9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009f895
- (unsigned long long)hash;	// IMP=0x001000000009f759
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009f518
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009f227
- (void)copyTo:(id)arg1;	// IMP=0x001000000009f067
- (void)writeTo:(id)arg1;	// IMP=0x001000000009ee29
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009ee1c
- (id)dictionaryRepresentation;	// IMP=0x001000000009e7ad
- (id)description;	// IMP=0x001000000009e6fe
...
- (id)segmentIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x001000000009e65d
- (unsigned long long)segmentIdentifiersCount;	// IMP=0x001000000009e640
- (void)addSegmentIdentifiers:(id)arg1;	// IMP=0x001000000009e5d6
- (void)clearSegmentIdentifiers;	// IMP=0x001000000009e5b9
@property(nonatomic) _Bool hasResetSegmentMembership;
- (int)StringAsRunState:(id)arg1;	// IMP=0x001000000009e4dc
- (id)runStateAsString:(int)arg1;	// IMP=0x001000000009e493
