...
- (void)_cancelFireRequests;	// IMP=0x0010000000004101
- (void)cancelPreviousFireRequests;	// IMP=0x001000000000407a
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x0010000000003d8c
- (void)fireImmediately;	// IMP=0x0010000000003c6a
- (void)requestFire;	// IMP=0x0010000000003928
- (void)dealloc;	// IMP=0x0010000000003874
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x0010000000003757
