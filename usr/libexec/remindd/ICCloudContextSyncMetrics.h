...
- (void).cxx_destruct;	// IMP=0x002000000004872f
...
- (void)finishWithSuccess:(_Bool)arg1;	// IMP=0x0010000000048581
- (id)dictionaryRepresentation;	// IMP=0x0010000000047e8a
- (id)initWithSyncReason:(id)arg1;	// IMP=0x0010000000047df5
