...
@class APSAppTokenInfo, APSConnection, APSOutgoingMessage, APSURLToken, APSURLTokenInfo, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (MISSING_TYPE *)connection:didReceiveIncomingMessage: /* Error: Ran out of types for this method. */;
