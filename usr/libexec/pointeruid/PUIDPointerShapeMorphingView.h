...
- (void).cxx_destruct;	// IMP=0x0020000000022b25
@property(readonly, copy, nonatomic) UIBezierPath *path; // @synthesize path=_path;
- (void)_resetToStableStateWithPath:(id)arg1;	// IMP=0x0010000000022794
- (void)setPath:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001e22b
- (void)dealloc;	// IMP=0x001000000001e1e2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001dbb7
