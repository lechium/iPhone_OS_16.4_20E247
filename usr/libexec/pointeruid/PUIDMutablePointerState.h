...
- (id)description;	// IMP=0x001000000002c99c
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002c96c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002c935
