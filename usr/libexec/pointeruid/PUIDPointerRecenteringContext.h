...
- (void).cxx_destruct;	// IMP=0x00200000000164e6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000016391
- (unsigned long long)hash;	// IMP=0x001000000001634b
- (id)initWithContextRelativePointerPosition:(id)arg1 displayUUID:(id)arg2 restrictingToPID:(int)arg3;	// IMP=0x0010000000016296
