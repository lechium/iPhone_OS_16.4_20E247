...
- (void).cxx_destruct;	// IMP=0x002000000001121c
...
- (void)startAutomaticRegionExitTimerWithDelayInterval:(double)arg1 fireHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000010f96
- (void)invalidateAutomaticRegionExitTimer;	// IMP=0x0010000000010f64
- (id)init;	// IMP=0x0010000000010ee1
