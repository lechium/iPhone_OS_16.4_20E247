...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000060bf
- (void).cxx_destruct;	// IMP=0x0020000000007459
...
- (id)description;	// IMP=0x00100000000072c5
- (_Bool)setPhaseProportionsForLoadingPhase:(id)arg1 installingPhase:(id)arg2 postProcessingPhase:(id)arg3 error:(id *)arg4;	// IMP=0x0010000000006ed3
@property(readonly, copy, nonatomic) NSDictionary *progressProportionsDictionaryForLaunchServices;
- (unsigned long long)hash;	// IMP=0x0010000000006bdb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000066a3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000064e8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000006300
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000060f6
- (id)init;	// IMP=0x00100000000060c7
