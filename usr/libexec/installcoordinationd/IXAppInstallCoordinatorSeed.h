...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000060c01
- (void).cxx_destruct;	// IMP=0x00200000000612e8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006113c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000060f61
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000060c09
