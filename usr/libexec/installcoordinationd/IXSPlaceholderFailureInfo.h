...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d71c
- (void).cxx_destruct;	// IMP=0x002000000003da4f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003d89b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003d724
