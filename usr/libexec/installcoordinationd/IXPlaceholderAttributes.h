...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000011e6c
- (void).cxx_destruct;	// IMP=0x0020000000013b4d
...
- (id)description;	// IMP=0x0010000000013957
- (id)infoPlistContent;	// IMP=0x00100000000135f5
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x00100000000133ae
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0010000000012c24
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x0010000000012b8d
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000012ad8
- (id)_plistKeys;	// IMP=0x0010000000012a26
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001279e
- (unsigned long long)hash;	// IMP=0x00100000000124f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000011e74
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000011b6d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001181a
- (id)init;	// IMP=0x00100000000117eb
