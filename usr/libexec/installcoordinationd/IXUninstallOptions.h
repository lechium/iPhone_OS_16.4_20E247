...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000056e4
...
- (id)description;	// IMP=0x0010000000005da2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005957
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000587c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000057a0
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000056ec
- (id)init;	// IMP=0x0010000000005652
