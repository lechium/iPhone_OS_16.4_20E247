...
- (void).cxx_destruct;	// IMP=0x002000000003a66b
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x001000000003a29a
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x001000000003a1bf
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x001000000003a0c6
