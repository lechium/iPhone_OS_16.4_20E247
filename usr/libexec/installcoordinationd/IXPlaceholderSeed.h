...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000035a8c
- (void).cxx_destruct;	// IMP=0x0020000000035c21
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000035a94
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000035920
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000035751
