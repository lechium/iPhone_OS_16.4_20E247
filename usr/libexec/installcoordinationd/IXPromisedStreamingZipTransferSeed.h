...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000e5c1
- (void).cxx_destruct;	// IMP=0x002000000000e73c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e5c9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000e44d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000e2ce
