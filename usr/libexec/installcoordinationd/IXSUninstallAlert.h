...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x004000000003c348
- (void).cxx_destruct;	// IMP=0x002000000003c3de
...
- (void)dealloc;	// IMP=0x001000000003c301
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x001000000003c192
- (id)localizedStringForKey:(id)arg1 withFormatHint:(id)arg2;	// IMP=0x001000000003c0ad
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003c09b
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003ba7c
- (void)_configureOptionalButtonForConfiguration:(id)arg1;	// IMP=0x001000000003b742
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x001000000003b1fb
- (void)_processUserNotification:(struct __CFUserNotification *)arg1 withConfiguration:(id)arg2 response:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000003aa65
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x001000000003a8ed
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x001000000003a6a9
