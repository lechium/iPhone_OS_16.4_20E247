...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d0fe
- (void).cxx_destruct;	// IMP=0x002000000003d251
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003d106
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003cfb8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003ce4e
