...
@interface SHSheetRemoteConnectionContext : NSObject
{
    ...
    _Bool _instantShareSheet;	// 11 = 0xb
...
- (void).cxx_destruct;	// IMP=0x0020000000172906
...
- (id)createContextDictionary;	// IMP=0x0010000000172417
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000001720b1
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x001000000017203e
