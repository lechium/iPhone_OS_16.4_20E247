...
- (void).cxx_destruct;	// IMP=0x0020000000022c21
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000021b7d
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000021b65
- (id)description;	// IMP=0x0010000000021a83
- (id)initWithDevice:(id)arg1;	// IMP=0x00100000000219f1
