...
@class MISSING_TYPE, NSArray, NSString, SDBonjourBrowser;
...
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x002000000017c9cc
...
- (void)stop;	// IMP=0x001000000017c942
- (void)start;	// IMP=0x001000000017c85b
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x001000000017c825
@property(readonly, copy) NSArray *nodes;
- (void)dealloc;	// IMP=0x001000000017c7d1
- (id)initWithWorkgroup:(id)arg1;	// IMP=0x001000000017c754
