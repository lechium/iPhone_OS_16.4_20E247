...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000da41
- (void).cxx_destruct;	// IMP=0x002000000000ec71
...
- (unsigned int)imageSlotID;	// IMP=0x001000000000eb4c
- (_Bool)load;	// IMP=0x001000000000eaf1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e30a
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (double)slotTextHeight;	// IMP=0x001000000000e0ea
- (void)setSlotTextHeight:(double)arg1;	// IMP=0x001000000000e0db
- (unsigned int)labelSlotID;	// IMP=0x001000000000e0d2
- (void)setLabelSlotID:(unsigned int)arg1;	// IMP=0x001000000000e0c9
@property(readonly, nonatomic) unsigned int iconImageSlotID;
- (void)setIconImageSlotID:(unsigned int)arg1;	// IMP=0x001000000000e0b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000df25
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000dada
- (id)initWithActivity:(id)arg1;	// IMP=0x001000000000da49
