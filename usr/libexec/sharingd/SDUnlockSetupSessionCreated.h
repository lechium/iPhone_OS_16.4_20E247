...
- (void).cxx_destruct;	// IMP=0x00200000001b0808
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b05d9
- (unsigned long long)hash;	// IMP=0x00100000001b0482
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b0250
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b00b9
- (void)copyTo:(id)arg1;	// IMP=0x00100000001aff69
- (void)writeTo:(id)arg1;	// IMP=0x00100000001afe05
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001afdf8
- (id)dictionaryRepresentation;	// IMP=0x00100000001af517
- (id)description;	// IMP=0x00100000001af468
