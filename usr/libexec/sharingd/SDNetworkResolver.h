...
- (void).cxx_destruct;	// IMP=0x00200000000dd5bd
...
- (void)stop;	// IMP=0x00100000000dd501
- (int)start;	// IMP=0x00100000000dd1c7
- (void)mount;	// IMP=0x00100000000dd1c1
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x00100000000dceea
- (void)mountDiskImageAsync;	// IMP=0x00100000000dcee4
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x00100000000dcdc3
- (void)dealloc;	// IMP=0x00100000000dcd89
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00100000000dcd03
