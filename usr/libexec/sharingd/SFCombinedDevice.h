...
- (void).cxx_destruct;	// IMP=0x00200000000964e3
...
- (_Bool)stateIsNearby;	// IMP=0x00100000000960fa
- (_Bool)stateIsMedium;	// IMP=0x00100000000960c9
- (_Bool)stateIsClose;	// IMP=0x00100000000960b7
- (void)resetTicks;	// IMP=0x0010000000095f20
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000095765
- (_Bool)canTransition:(int)arg1;	// IMP=0x001000000009566f
- (id)description;	// IMP=0x0010000000095364
