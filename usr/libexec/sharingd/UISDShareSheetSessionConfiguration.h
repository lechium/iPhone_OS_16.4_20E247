...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d46d
- (void).cxx_destruct;	// IMP=0x002000000003dc56
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003d8ed
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003d475
