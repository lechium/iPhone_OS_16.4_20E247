...
- (void).cxx_destruct;	// IMP=0x00200000001aeffc
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001ae7db
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001ae212
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ae1fa
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x00100000001ada9f
- (void)sendAWDLInfo;	// IMP=0x00100000001ada8b
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ad9ee
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ad902
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ad8f0
- (void)_start;	// IMP=0x00100000001ad8de
- (void)start;	// IMP=0x00100000001ad857
- (id)getAppName;	// IMP=0x00000000001ad84f
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001ad849
- (void)connectionActivated;	// IMP=0x00100000001ad843
- (void)invalidate;	// IMP=0x00100000001ad74a
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001ad6ae
