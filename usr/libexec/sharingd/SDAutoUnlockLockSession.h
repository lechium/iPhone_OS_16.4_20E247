...
- (void).cxx_destruct;	// IMP=0x0020000000233fce
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x0010000000232f23
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x0010000000232f0e
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x0010000000232e67
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x0010000000232bb5
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x0010000000232357
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x0010000000231f17
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000231b7c
- (void)consumeAuthTokenIfReady;	// IMP=0x001000000023148a
- (void)startAWDL;	// IMP=0x0010000000230a56
- (void)handleConfirmationACK;	// IMP=0x00100000002307e1
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x001000000023030d
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x001000000022f9f9
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x001000000022f6a3
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x001000000022efb0
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000022eb59
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000022e913
- (void)handleWiFiRequestInvalidated;	// IMP=0x001000000022e8b7
- (void);	// IMP=0x001000000022e7b3
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x001000000022e6f4
- (void)handleAWDLUp;	// IMP=0x001000000022e535
- (void)handlePeerOutOfRange;	// IMP=0x001000000022e24b
- (void)handlePeerInRange;	// IMP=0x001000000022df63
- (_Bool)peerInRange:(id)arg1;	// IMP=0x001000000022ddc5
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x001000000022d891
- (void)invalidateConfirmationTimer;	// IMP=0x001000000022d7bb
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x001000000022d516
- (void)handleTimerFired;	// IMP=0x001000000022d045
- (void)invalidateTimerIfReady;	// IMP=0x001000000022cffa
- (id)aksPeerAvailable;	// IMP=0x001000000022ce16
- (void)deviceConnected:(id)arg1;	// IMP=0x001000000022ca4d
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x001000000022c774
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x001000000022c713
- (void)connectionActivated;	// IMP=0x001000000022c56b
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x001000000022be5b
- (id)getAppName;	// IMP=0x001000000022be53
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x001000000022bd25
- (_Bool)isAcceptor;	// IMP=0x001000000022bd1d
- (id)attemptResults;	// IMP=0x001000000022b0d9
- (void)logResults;	// IMP=0x001000000022a279
- (void)displayConfigChanged:(id)arg1;	// IMP=0x001000000022a1dd
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x001000000022a141
- (void)removeObservers;	// IMP=0x001000000022a0ee
- (void)addObservers;	// IMP=0x0010000000229ff4
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x0010000000229ea3
- (void)_handleCanceledAfterSuccess;	// IMP=0x0010000000229d9c
- (void)handleCanceledAfterSuccess;	// IMP=0x0010000000229d15
- (void)lockKeyBagIfNeeded;	// IMP=0x0010000000229c38
- (void)cancelWiFiRequest;	// IMP=0x0010000000229a46
- (void)_cancel;	// IMP=0x00100000002296fb
- (void)cancel;	// IMP=0x0010000000229674
- (void)tearDownAWDLIfNecessary;	// IMP=0x00100000002294a0
- (void)completeAttemptIfNecessary;	// IMP=0x00100000002292de
- (void)invalidateNoDisconnect;	// IMP=0x00100000002292af
- (void)invalidate;	// IMP=0x0010000000229089
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000228c7c
