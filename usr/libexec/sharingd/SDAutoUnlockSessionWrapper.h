...
- (void).cxx_destruct;	// IMP=0x00200000000fa3c0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000fa11a
- (unsigned long long)hash;	// IMP=0x00100000000f9f9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f9d02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f9b1c
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f99a4
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f9829
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f981c
- (id)dictionaryRepresentation;	// IMP=0x00100000000f9034
- (id)description;	// IMP=0x00100000000f8f85
