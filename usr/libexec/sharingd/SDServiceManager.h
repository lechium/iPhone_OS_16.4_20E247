...
- (void).cxx_destruct;	// IMP=0x00200000001a2f5f
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000001a2e86
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001a2c5a
- (void)disableService:(id)arg1;	// IMP=0x00100000001a2bd0
- (void)enableService:(id)arg1;	// IMP=0x00100000001a2b52
- (id)streamHandlerForService:(id)arg1;	// IMP=0x00100000001a2aef
- (void)stop;	// IMP=0x00100000001a2880
- (void)start;	// IMP=0x00100000001a282d
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000001a2736
