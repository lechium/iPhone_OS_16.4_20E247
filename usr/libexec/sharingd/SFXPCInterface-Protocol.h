...
@class MISSING_TYPE, NSData, NSDictionary, NSError, NSString, NSUUID, SFDevice, SFEventMessage, SFRemoteTextSessionInfo, SFRequestMessage, SFResponseMessage;
...
- (MISSING_TYPE *)deviceDiscoveryDeviceChanged:changes: /* Error: Ran out of types for this method. */;
