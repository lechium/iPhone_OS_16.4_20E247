...
- (void).cxx_destruct;	// IMP=0x00200000000ae36a
...
- (void)dealloc;	// IMP=0x00100000000ae279
- (void)stop;	// IMP=0x00100000000ae22a
- (void)start;	// IMP=0x00100000000ae1b7
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00100000000ade75
- (id)init;	// IMP=0x00100000000ade27
