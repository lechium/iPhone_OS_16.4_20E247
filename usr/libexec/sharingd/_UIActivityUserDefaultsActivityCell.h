...
+ (id)bodyShortFont;	// IMP=0x00400000001b1930
- (void).cxx_destruct;	// IMP=0x00200000001b209d
...
- (void)_updateImageDarkening;	// IMP=0x00100000001b1c4a
- (void)prepareForReuse;	// IMP=0x00100000001b1aca
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00100000001b0ac1
