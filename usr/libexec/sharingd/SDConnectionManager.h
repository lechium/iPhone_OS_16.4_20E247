...
+ (id)sharedManager;	// IMP=0x00200000000f5b91
- (void).cxx_destruct;	// IMP=0x00200000000f6de6
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00100000000f6bec
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000000f6bd6
- (void)appleAccountSignedOut;	// IMP=0x00100000000f6b5e
- (void)appleAccountSignedIn;	// IMP=0x00100000000f6ae6
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f6a60
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000f67b1
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000f6471
- (void)cleanUpConnections;	// IMP=0x00100000000f614d
- (void)start;	// IMP=0x00100000000f5d33
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00100000000f5be6
