...
- (void).cxx_destruct;	// IMP=0x0020000000228a93
...
- (void)cancel;	// IMP=0x001000000022893e
- (void)resolve;	// IMP=0x00100000002284b1
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0010000000228101
- (void)notifyClient:(int)arg1;	// IMP=0x00100000002280ad
- (void)dealloc;	// IMP=0x001000000022806f
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x0010000000227f3b
