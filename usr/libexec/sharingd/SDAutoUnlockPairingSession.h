...
- (void).cxx_destruct;	// IMP=0x00200000000103c5
...
- (void)idsController:(id)arg1 didReceiveProtoData:(id)arg2 forType:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x001000000000fef2
- (void)handleTimerFired;	// IMP=0x001000000000fdbe
- (void)invalidateResponseTimer;	// IMP=0x001000000000fce8
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x001000000000fae5
- (id)dataFromUUID:(id)arg1;	// IMP=0x001000000000fa5c
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x001000000000f87c
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x001000000000f864
- (void)handleMessage:(id)arg1 fromDeviceID:(id)arg2 type:(unsigned short)arg3;	// IMP=0x001000000000f85e
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000000f858
- (void)start;	// IMP=0x001000000000f852
@property(readonly, nonatomic) SDUnlockTransport *transport;
- (void)invalidate;	// IMP=0x001000000000f669
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000000f536
- (id)init;	// IMP=0x001000000000f4de
