...
- (void).cxx_destruct;	// IMP=0x00200000000c8ef9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000c8c9b
- (unsigned long long)hash;	// IMP=0x00100000000c8a36
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c8783
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c85c5
- (void)copyTo:(id)arg1;	// IMP=0x00100000000c8458
- (void)writeTo:(id)arg1;	// IMP=0x00100000000c82d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000c82c4
- (id)dictionaryRepresentation;	// IMP=0x00100000000c791a
- (id)description;	// IMP=0x00100000000c786b
