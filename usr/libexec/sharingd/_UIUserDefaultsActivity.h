...
- (void).cxx_destruct;	// IMP=0x0020000000057f2d
...
- (void)_prepareActivityViewControllerIfNeeded;	// IMP=0x0010000000057cdc
- (void)_cleanup;	// IMP=0x0010000000057cc8
- (void)_settingsViewControllerDidDismiss:(id)arg1;	// IMP=0x0010000000057cb4
- (void)activityDidFinish:(_Bool)arg1 items:(id)arg2 error:(id)arg3;	// IMP=0x0010000000057bfa
- (id)activityViewController;	// IMP=0x0010000000057bcc
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0010000000057bc4
- (id)_actionImage;	// IMP=0x0010000000057b04
- (id)_activityImage;	// IMP=0x00100000000578f4
- (id)activityTitle;	// IMP=0x001000000005787d
- (id)activityType;	// IMP=0x0010000000057869
- (id)initWithUserDefaults:(id)arg1 activityCategory:(long long)arg2;	// IMP=0x00100000000577cf
