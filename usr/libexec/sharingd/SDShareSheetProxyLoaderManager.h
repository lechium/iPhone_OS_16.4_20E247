...
- (void).cxx_destruct;	// IMP=0x0020000000173eae
...
- (void)proxyLoader:(id)arg1 didLoadProxiesWithResult:(id)arg2;	// IMP=0x0010000000173b51
- (void)_didFinishLoadingLoader:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0010000000173919
- (void)_scheduleLoadingBlock:(CDUnknownBlockType)arg1 synchronously:(_Bool)arg2;	// IMP=0x00100000001738fe
- (id)_existingLoaderForSectionType:(long long)arg1;	// IMP=0x001000000017374a
- (void)loadProxySection:(id)arg1;	// IMP=0x0010000000173492
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x0010000000173379
