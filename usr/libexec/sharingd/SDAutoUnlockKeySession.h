...
- (void).cxx_destruct;	// IMP=0x002000000001a46c
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000019faa
- (void)logAutoUnlockStart;	// IMP=0x0010000000019fa4
- (void)invalidateAssertionTimer;	// IMP=0x0010000000019ece
- (void)restartAssertionTimer;	// IMP=0x0010000000019cbf
- (void)releaseIdleSleepAssertion;	// IMP=0x0010000000019c20
- (void)declareSystemActivityAssertion;	// IMP=0x001000000001998c
- (void)sendConfirmationACK;	// IMP=0x001000000001976a
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000019302
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000019004
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000018d09
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000186f9
- (void)handleCleanUpAWDL;	// IMP=0x001000000001866b
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x001000000001821d
- (void)createAuthTokenIfReady;	// IMP=0x0010000000017a17
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x00100000000177f0
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000017525
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0010000000017035
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000016a78
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000000162f8
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x001000000001625b
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000161a3
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000015fc3
- (void)createWiFiRequest;	// IMP=0x0010000000015841
- (void)alertOfUnlock;	// IMP=0x0010000000015725
- (void)promptForApproval;	// IMP=0x001000000001571f
- (void)systemIsActive:(id)arg1;	// IMP=0x001000000001556b
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000015314
- (void)removeObservers;	// IMP=0x00100000000152c1
- (void)addObservers;	// IMP=0x00100000000151c4
- (void)postBeganUnlockingNotification;	// IMP=0x0010000000015131
- (void)beginAKSSession;	// IMP=0x001000000001512b
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000014f67
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014f61
- (_Bool)keyInState;	// IMP=0x0010000000014dc1
- (void)_invalidate;	// IMP=0x0010000000014b2e
- (void)invalidateOnQueue;	// IMP=0x0010000000014aef
- (void)invalidate;	// IMP=0x0010000000014a6e
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x00100000000147c8
