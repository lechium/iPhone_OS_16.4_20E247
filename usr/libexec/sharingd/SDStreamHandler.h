...
- (void).cxx_destruct;	// IMP=0x002000000016ffef
...
- (void)setInData:(id)arg1;	// IMP=0x001000000016ff38
- (id)inData;	// IMP=0x001000000016ff24
...
- (id)trimHeader:(id)arg1;	// IMP=0x001000000016fc84
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x001000000016fbe4
- (void)handleMessageWritten:(id)arg1;	// IMP=0x001000000016fafd
- (void)handleSpaceForMessage;	// IMP=0x001000000016f62e
- (void)resetReadState;	// IMP=0x001000000016f5ea
- (void)handleMessageRead;	// IMP=0x001000000016f575
- (void)handleHeaderRead;	// IMP=0x001000000016f455
- (void)handleBytesForMessage;	// IMP=0x001000000016f179
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x001000000016f112
- (id)messageWithData:(id)arg1;	// IMP=0x001000000016f091
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000016ed84
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000016ed43
- (void)handleSpaceForStream;	// IMP=0x001000000016ea49
- (void)handleBytesForStream;	// IMP=0x001000000016e773
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x001000000016e5f0
- (void)handleSpaceAvailable;	// IMP=0x001000000016e4dd
- (void)handleBytesAvailable;	// IMP=0x001000000016e3ca
- (void)handleOpenedStream:(id)arg1;	// IMP=0x001000000016e1af
- (void)setTCPProperties:(id)arg1;	// IMP=0x001000000016e0bc
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000016df38
- (_Bool)evaluateCert;	// IMP=0x001000000016dc4c
- (void)applySSLSettings:(id)arg1;	// IMP=0x001000000016d8ec
- (void)invalidateOpenTimer;	// IMP=0x001000000016d85a
- (void)openTimerFired:(id)arg1;	// IMP=0x001000000016d694
- (void)startOpenTimer;	// IMP=0x001000000016d5bd
- (void)logTransfer;	// IMP=0x001000000016d3eb
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x001000000016d0c7
- (void)stopIfReady;	// IMP=0x001000000016d085
- (void)stop;	// IMP=0x001000000016d045
- (void)start;	// IMP=0x001000000016cd6a
- (void)dealloc;	// IMP=0x001000000016ccae
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x001000000016cb04
