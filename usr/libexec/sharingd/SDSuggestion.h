...
- (void).cxx_destruct;	// IMP=0x0020000000013f9d
...
- (void)_requestSandboxExtensionForDonatedImage:(id)arg1;	// IMP=0x0010000000013cec
- (id)createPeopleSuggestion;	// IMP=0x0010000000013b05
- (id)_caseSensitiveBundleIDFromBundleID:(id)arg1;	// IMP=0x0010000000013a7b
- (void)_configure;	// IMP=0x0010000000012af0
- (id)initWithSuggestion:(id)arg1;	// IMP=0x0010000000012a75
