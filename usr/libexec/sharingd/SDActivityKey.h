...
- (void).cxx_destruct;	// IMP=0x002000000016956a
...
- (unsigned long long)hash;	// IMP=0x001000000016937a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001692b4
- (id)description;	// IMP=0x00100000001691b7
- (void)dealloc;	// IMP=0x0010000000169100
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x0010000000168f17
