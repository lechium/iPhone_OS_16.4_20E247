...
- (void).cxx_destruct;	// IMP=0x002000000000bfa0
- (id)_parseURLFromAlertParameterWithName:(id)arg1;	// IMP=0x001000000000bee0
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000000bb41
