...
- (void).cxx_destruct;	// IMP=0x002000000000b763
...
- (id)urlRequest;	// IMP=0x001000000000b485
- (id)urlString;	// IMP=0x001000000000b42e
- (id)initWithAccount:(id)arg1 store:(id)arg2;	// IMP=0x001000000000b38c
