...
- (void).cxx_destruct;	// IMP=0x0020000000001487
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000012f9
- (id)initWithServiceName:(id)arg1 queryController:(id)arg2;	// IMP=0x001000000000119d
