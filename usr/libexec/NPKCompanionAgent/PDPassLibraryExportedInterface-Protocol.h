...
@class MISSING_TYPE, NSArray, NSData, NSOrderedSet, NSString, PKAddSecureElementPassConfiguration, PKCatalog, PKDisplayProfile, PKGroupsControllerSnapshotFetchOptions, PKPaymentMarket, PKPaymentSetupConfiguration;
...
- (MISSING_TYPE *)getPassesAndCatalogOfPassTypes:limitResults:withHandler: /* Error: Ran out of types for this method. */;
