...
@class MISSING_TYPE, PSYServiceSyncSession, PSYSyncCoordinator;

@protocol PSYSyncCoordinatorDelegate <NSObject>

@optional
- (MISSING_TYPE *)syncCoordinatorDidReceiveStartSyncCommand: /* Error: Ran out of types for this method. */;
