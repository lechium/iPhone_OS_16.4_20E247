...
- (void).cxx_destruct;	// IMP=0x002000000007051e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000006fde6
- (unsigned long long)hash;	// IMP=0x001000000006f48f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006ee0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006e973
- (void)copyTo:(id)arg1;	// IMP=0x001000000006e5bf
- (void)writeTo:(id)arg1;	// IMP=0x001000000006e1dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000006e1d0
- (id)dictionaryRepresentation;	// IMP=0x001000000006d00c
- (id)description;	// IMP=0x001000000006cf5d
