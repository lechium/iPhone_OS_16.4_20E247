...
- (void).cxx_destruct;	// IMP=0x0020000000077043
...
- (void)databaseController:(id)arg1 saltVersionIdentifierChanged:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000762be
- (id)initWithZoneDataManager:(id)arg1 tokenController:(id)arg2 databaseController:(id)arg3;	// IMP=0x00100000000760d9
