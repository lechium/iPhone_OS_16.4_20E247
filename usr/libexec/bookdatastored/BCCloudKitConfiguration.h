...
+ (id)configuration;	// IMP=0x002000000001620b
- (void).cxx_destruct;	// IMP=0x0020000000016502
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x00100000000163f3
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x00100000000163eb
