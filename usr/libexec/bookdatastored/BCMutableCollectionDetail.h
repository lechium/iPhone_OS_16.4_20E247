...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000007c7c2
- (void).cxx_destruct;	// IMP=0x002000000007cb3c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000007c907
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000007c7ca
- (id)configuredRecordFromAttributes;	// IMP=0x001000000007c59b
- (id)zoneName;	// IMP=0x001000000007c587
- (id)identifier;	// IMP=0x001000000007c575
- (id)recordType;	// IMP=0x001000000007c568
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x001000000007c250
- (id)initWithCloudData:(id)arg1;	// IMP=0x001000000007c00f
- (id)initWithCollectionID:(id)arg1;	// IMP=0x001000000007bf4d
