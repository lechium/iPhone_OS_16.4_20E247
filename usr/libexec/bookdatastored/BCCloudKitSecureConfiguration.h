...
+ (id)configuration;	// IMP=0x002000000003a030
- (void).cxx_destruct;	// IMP=0x000000000003a2cf
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x001000000003a1c0
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x001000000003a1b8
