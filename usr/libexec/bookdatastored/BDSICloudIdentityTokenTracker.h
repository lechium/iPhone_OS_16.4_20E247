...
- (void).cxx_destruct;	// IMP=0x00200000000155b6
...
- (void)acknowledgeiCloudIdentity;	// IMP=0x0010000000015187
- (_Bool)didUnacknowledgediCloudLogoutOccur;	// IMP=0x0010000000014e47
- (void)forceUpdateTokenWithString:(id)arg1;	// IMP=0x0010000000014dc4
- (void)fetchCurrentToken;	// IMP=0x0010000000014d53
- (id)initWithContainerURL:(id)arg1 trackingLiverpool:(_Bool)arg2;	// IMP=0x0010000000014bf2
