...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003950f
- (void).cxx_destruct;	// IMP=0x0020000000039f77
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000398c8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000039517
- (id)configuredRecordFromAttributes;	// IMP=0x0010000000038fd1
- (id)zoneName;	// IMP=0x0010000000038ea7
- (id)identifier;	// IMP=0x0010000000038e95
- (id)recordType;	// IMP=0x0010000000038e88
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x0010000000038725
- (id)initWithCloudData:(id)arg1;	// IMP=0x00100000000382e5
- (id)initWithAssetID:(id)arg1;	// IMP=0x0010000000038223
