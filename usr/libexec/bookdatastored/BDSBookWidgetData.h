...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003362c
- (void).cxx_destruct;	// IMP=0x0020000000034472
...
- (id)description;	// IMP=0x0010000000034241
- (_Bool)hasSignificantDifferenceWith:(id)arg1;	// IMP=0x0010000000033b2d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000033979
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000337a1
- (id)initWithAssetID:(id)arg1 title:(id)arg2 pageProgressionDirection:(id)arg3 coverURL:(id)arg4 readingProgress:(id)arg5 libraryAssetType:(id)arg6;	// IMP=0x001000000003377e
- (id)initWithAssetID:(id)arg1 title:(id)arg2 pageProgressionDirection:(id)arg3 coverURL:(id)arg4 readingProgress:(id)arg5 totalDuration:(id)arg6 libraryAssetType:(id)arg7;	// IMP=0x0010000000033634
