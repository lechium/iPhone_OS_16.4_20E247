...
- (void).cxx_destruct;	// IMP=0x002000000002522d
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000025082
- (id)description;	// IMP=0x0010000000025032
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3;	// IMP=0x0010000000024f8f
