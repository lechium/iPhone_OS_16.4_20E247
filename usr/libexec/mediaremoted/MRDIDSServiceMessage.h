...
- (void).cxx_destruct;	// IMP=0x0020000000024f51
...
- (_Bool)replyWithData:(id)arg1 priority:(long long)arg2;	// IMP=0x0010000000024ecb
- (id)initWithID:(id)arg1 data:(id)arg2 device:(id)arg3 service:(id)arg4;	// IMP=0x0010000000024dd0
