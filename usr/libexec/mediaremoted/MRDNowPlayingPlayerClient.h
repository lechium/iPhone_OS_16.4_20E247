...
- (void).cxx_destruct;	// IMP=0x001000000001dbcf
...
- (void)_onQueue_popState;	// IMP=0x001000000001d15f
- (void)_onQueue_pushState;	// IMP=0x001000000001d040
- (void)_onQueue_playbackQueueContentItemsArtworkDidChange:(id)arg1;	// IMP=0x001000000001cf8c
- (void)_onQueue_playbackQueueContentItemsDidChange:(id)arg1;	// IMP=0x001000000001ced8
- (void)_onQueue_playbackQueueCapabilitiesDidChange:(unsigned long long)arg1;	// IMP=0x001000000001ce87
- (void)_onQueue_playbackQueueDidChange:(id)arg1 nowPlayingItemChanged:(_Bool)arg2;	// IMP=0x001000000001cdf6
- (void)_onQueue_supportedCommandsDidChange:(id)arg1;	// IMP=0x001000000001cd6b
- (void)_onQueue_playbackStateDidChanged:(id)arg1;	// IMP=0x001000000001cc61
- (void)_onQueue_pictureInPictureEnabledDidChanged:(_Bool)arg1;	// IMP=0x001000000001cc10
- (void)_onQueue_isPlayingDidChange:(_Bool)arg1;	// IMP=0x001000000001cb8f
- (void)_onQueue_canBeNowPlayingDidChange:(_Bool)arg1;	// IMP=0x001000000001cb3e
- (void)_handleNowPlayingAppDidChange:(id)arg1;	// IMP=0x001000000001ca4a
- (id)playbackQueueForRequest:(id)arg1 cachingPolicy:(unsigned int)arg2 playerPath:(id)arg3 partiallyCachedItems:(id *)arg4;	// IMP=0x001000000001c73c
- (id)_sortSnapshots:(id)arg1;	// IMP=0x001000000001c708
@property(readonly, nonatomic) NSArray *snapshots;
- (id)snapshotForIsPlaying:(_Bool)arg1;	// IMP=0x001000000001c58c
- (id)snapshotsForIsPlaying:(_Bool)arg1;	// IMP=0x001000000001c350
- (id)snapshotForPlaybackState:(unsigned int)arg1;	// IMP=0x001000000001c217
- (void)notifyArtworkChangedForContentItems:(id)arg1;	// IMP=0x001000000001c12d
- (void)_onQueue_updatePlaybackQueue:(id)arg1 fromRequest:(id)arg2;	// IMP=0x001000000001bb72
- (void)updatePlaybackQueue:(id)arg1 fromRequest:(id)arg2;	// IMP=0x001000000001ba99
- (void)updatePlaybackQueue:(id)arg1;	// IMP=0x001000000001ba85
- (void)updatePlayer:(id)arg1;	// IMP=0x001000000001b985
- (void)updateClient:(id)arg1;	// IMP=0x001000000001b8ab
...
- (id)_onQueue_lastPlayingDate;	// IMP=0x001000000001b6a2
...
- (_Bool)_onQueue_isPlaying;	// IMP=0x001000000001b07b
@property(readonly, nonatomic) _Bool isPlaying;
@property(nonatomic) unsigned long long playbackQueueCapabilities;
- (id)_onQueue_playbackState;	// IMP=0x001000000001aabc
...
- (void)updateLastPlayingDate:(id)arg1;	// IMP=0x001000000001a4d4
- (void)updatePlaybackState:(unsigned int)arg1 date:(id)arg2;	// IMP=0x001000000001a212
...
- (id)description;	// IMP=0x0010000000018b99
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000018991
- (id)activeContent;	// IMP=0x00100000000188ee
- (_Bool)isActiveStream;	// IMP=0x00100000000188dc
