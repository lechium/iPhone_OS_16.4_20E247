...
- (void).cxx_destruct;	// IMP=0x00200000000130d7
...
- (void)clearRoutedCommands;	// IMP=0x001000000001305e
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000012e6b
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0010000000012c41
