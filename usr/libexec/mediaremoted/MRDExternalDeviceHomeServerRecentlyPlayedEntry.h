...
- (void).cxx_destruct;	// IMP=0x00200000000498f3
// Error: Property attributes should begin with the type ('T') attribute, property name: dictionaryRepresentation
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000049142
- (id)description;	// IMP=0x0010000000049039
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000048e4d
