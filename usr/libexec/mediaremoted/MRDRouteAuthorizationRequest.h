...
- (void).cxx_destruct;	// IMP=0x0020000000101e56
...
- (void)cancel;	// IMP=0x0010000000101e36
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x0010000000101e24
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x0010000000101d37
