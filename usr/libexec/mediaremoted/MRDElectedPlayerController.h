...
- (void).cxx_destruct;	// IMP=0x00200000000c5cbe
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x00100000000c58a5
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00100000000c5584
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x00100000000c51d7
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x00100000000c4d2f
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x00100000000c4734
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00100000000c45e3
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00100000000c44ca
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x00100000000c434b
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x00100000000c4240
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x00100000000c41a6
@property(retain, nonatomic) NSString *activeSystemEndpointOutputDeviceUID;
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x00100000000c4046
- (id)initWithOriginClient:(id)arg1;	// IMP=0x00100000000c3c40
