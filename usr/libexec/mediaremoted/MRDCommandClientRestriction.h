...
+ (id)restrictedTo:(id)arg1 by:(id)arg2;	// IMP=0x00200000000bec23
- (void).cxx_destruct;	// IMP=0x00200000000bf095
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bef30
- (id)description;	// IMP=0x00100000000bece6
