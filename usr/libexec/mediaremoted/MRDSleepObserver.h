...
- (void).cxx_destruct;	// IMP=0x00200000000f1ed9
...
- (void)notifyDelegateOfWake;	// IMP=0x00100000000f1e12
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f1d76
- (id)init;	// IMP=0x00100000000f1aa5
