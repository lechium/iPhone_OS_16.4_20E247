...
- (void).cxx_destruct;	// IMP=0x0020000000102723
...
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x00100000001024a4
- (void)_notifyDelegate;	// IMP=0x0010000000102407
- (void)_updateSuggestionCountIfNeeded;	// IMP=0x0010000000102132
- (id)init;	// IMP=0x0010000000101fb1
