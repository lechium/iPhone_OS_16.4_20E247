...
- (void).cxx_destruct;	// IMP=0x002000000007a2b7
...
- (_Bool)_onQueue_calculateShouldShowLockScreenForReason:(id *)arg1;	// IMP=0x001000000007a047
- (void)_onQueue_reevaluateShouldShowLockScreenForReason:(id)arg1;	// IMP=0x0010000000079d85
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x0010000000079bbb
- (void)_handleElectedPlayerDidChangeNotification:(id)arg1;	// IMP=0x00100000000799cf
- (void)_handleLayoutDidChangeNotification:(id)arg1;	// IMP=0x0010000000079919
- (void)lockScreenContentControllerStateDidChange:(id)arg1;	// IMP=0x00100000000798b1
- (void)personalDeviceControllerStateDidChange:(id)arg1;	// IMP=0x00100000000797c4
- (void)_onSerialQueue_restoreElectedPlayer;	// IMP=0x00100000000796d6
...
- (id)init;	// IMP=0x0010000000078be8
