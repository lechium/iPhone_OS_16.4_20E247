...
- (void).cxx_destruct;	// IMP=0x0020000000076d40
...
- (id)_coealesceItems:(id)arg1;	// IMP=0x001000000007695c
@property(readonly, nonatomic) MRNowPlayingState *state;
- (id)description;	// IMP=0x001000000007509c
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000075031
