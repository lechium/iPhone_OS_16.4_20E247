...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x004000000010754d
- (void).cxx_destruct;	// IMP=0x0020000000107718
...
- (unsigned long long)sampleRate;	// IMP=0x00100000001076a6
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x001000000010762f
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000010759d
