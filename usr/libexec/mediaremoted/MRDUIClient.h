...
- (void).cxx_destruct;	// IMP=0x00200000000c979f
...
- (void)dealloc;	// IMP=0x00100000000c96e4
- (id)description;	// IMP=0x00100000000c96a3
- (id)initWithConnection:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000c9600
