...
@class MISSING_TYPE, NSDate, NSString, NSXPCConnection;
...
- (void).cxx_destruct;	// IMP=0x00200000000dd961
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x00100000000dd41e
- (void)_checkConnectionStatus;	// IMP=0x00100000000dcf51
- (_Bool)_canSendMessage;	// IMP=0x00100000000dce6b
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000dcdb0
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000000dcad5
- (id)description;	// IMP=0x00100000000dca4a
- (id)_initWithLabel:(id)arg1;	// IMP=0x00100000000dc999
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000dc8df
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000dc814
