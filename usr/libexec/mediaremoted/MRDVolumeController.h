...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000000127e8
- (void).cxx_destruct;	// IMP=0x00200000000128e2
...
- (void)setIsMuted:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00100000000128b5
- (void)adjustVolume:(long long)arg1 error:(id *)arg2;	// IMP=0x00100000000128af
- (void)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000128a9
- (void)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000128a3
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x0010000000012838
