...
- (void).cxx_destruct;	// IMP=0x0020000000046a9c
...
- (void)_onQueue_beginTimerWithInterval:(double)arg1;	// IMP=0x00100000000467ae
- (void)_onQueue_recalculateStateForReason:(id)arg1;	// IMP=0x00100000000461be
- (void)_onQueue_restoreState;	// IMP=0x0010000000045e3c
- (void)_handlePersonalDeviceChangeNotification:(id)arg1;	// IMP=0x0010000000045dd4
- (id)init;	// IMP=0x0010000000045bfc
