...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x0040000000045a27
- (void).cxx_destruct;	// IMP=0x0020000000045bec
...
- (id)_extendedInfo;	// IMP=0x0010000000045ba1
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000045a78
