...
- (void).cxx_destruct;	// IMP=0x00200000000ff146
...
- (id)_newIOKitDeviceProperties;	// IMP=0x00100000000fef8a
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x00100000000fec07
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x00100000000feaf8
- (id)deviceProperties;	// IMP=0x00100000000feab9
- (void)dealloc;	// IMP=0x00100000000fea7a
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x00100000000fe933
