...
+ (id)sharedMonitor;	// IMP=0x00200000000ff179
- (void).cxx_destruct;	// IMP=0x00200000000ffd24
...
- (void)dealloc;	// IMP=0x00100000000ffcbe
- (void)scheduleLayoutChangeForReason:(id)arg1;	// IMP=0x00100000000ffaa2
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000000ff6e2
@property(readonly, nonatomic) _Bool controlCenterVisible;
@property(readonly, nonatomic) _Bool lockScreenVisible;
- (id)_fbsDisplayMonitorConfiguration;	// IMP=0x00100000000ff45f
- (id)init;	// IMP=0x00100000000ff1ce
